...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agrifoodrpservice/remove-azagrifoodrpservicefarmbeatsmodel
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAgriFoodRpServiceFarmBeatsModel -FarmBeatsResourceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAgriFoodRpServiceFarmBeatsModel -InputObject <IAgriFoodRpServiceIdentity>
