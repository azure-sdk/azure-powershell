...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/get-azagfoodplatformrpservicefarmbeatsextension
schema: 2.0.0
---

# Get-AzAgFoodPlatformRpServiceFarmBeatsExtension
...
### List (Default)
```
Get-AzAgFoodPlatformRpServiceFarmBeatsExtension [-ExtensionCategory <String[]>]
 [-FarmBeatsExtensionId <String[]>] [-FarmBeatsExtensionName <String[]>] [-MaxPageSize <Int32>]
 [-PublisherId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAgFoodPlatformRpServiceFarmBeatsExtension -Id <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAgFoodPlatformRpServiceFarmBeatsExtension -InputObject <IAgFoodPlatformRpServiceIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Models.Api20210901Preview.IFarmBeatsExtension
