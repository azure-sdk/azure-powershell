...
Module Guid: 61681b1a-483a-4cc6-a4f3-80941739c4c7
...
### [New-AzAgFoodPlatformRpServiceExtension](New-AzAgFoodPlatformRpServiceExtension.md)
Install or Update extension.
AdditionalApiProperties are merged patch and if the extension is updated to a new version then the obsolete entries will be auto deleted from AdditionalApiProperties.
