...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/get-azagfoodplatformrpserviceextension
schema: 2.0.0
---

# Get-AzAgFoodPlatformRpServiceExtension
...
### List (Default)
```
Get-AzAgFoodPlatformRpServiceExtension -FarmBeatsResourceName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzAgFoodPlatformRpServiceExtension -FarmBeatsResourceName <String> -Id <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAgFoodPlatformRpServiceExtension -InputObject <IAgFoodPlatformRpServiceIdentity>
