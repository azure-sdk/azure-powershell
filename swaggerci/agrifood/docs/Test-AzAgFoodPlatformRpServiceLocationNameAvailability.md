...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/test-azagfoodplatformrpservicelocationnameavailability
schema: 2.0.0
---

# Test-AzAgFoodPlatformRpServiceLocationNameAvailability
...
```
Test-AzAgFoodPlatformRpServiceLocationNameAvailability [-SubscriptionId <String>] [-Name <String>]
 [-Type <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Check
```
Test-AzAgFoodPlatformRpServiceLocationNameAvailability -Body <ICheckNameAvailabilityRequest>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzAgFoodPlatformRpServiceLocationNameAvailability -InputObject <IAgFoodPlatformRpServiceIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Models.Api30.ICheckNameAvailabilityRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Models.Api30.ICheckNameAvailabilityRequest

### Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Models.IAgFoodPlatformRpServiceIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Models.Api30.ICheckNameAvailabilityResponse
