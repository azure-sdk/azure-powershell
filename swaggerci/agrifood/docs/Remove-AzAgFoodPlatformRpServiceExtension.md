...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/remove-azagfoodplatformrpserviceextension
schema: 2.0.0
---

# Remove-AzAgFoodPlatformRpServiceExtension
...
### Delete (Default)
```
Remove-AzAgFoodPlatformRpServiceExtension -FarmBeatsResourceName <String> -Id <String>
...
### DeleteViaIdentity
```
Remove-AzAgFoodPlatformRpServiceExtension -InputObject <IAgFoodPlatformRpServiceIdentity>
