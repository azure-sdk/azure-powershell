...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/get-azagfoodplatformrpserviceprivateendpointconnection
schema: 2.0.0
---

# Get-AzAgFoodPlatformRpServicePrivateEndpointConnection
...
### List (Default)
```
Get-AzAgFoodPlatformRpServicePrivateEndpointConnection -FarmBeatsResourceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAgFoodPlatformRpServicePrivateEndpointConnection -FarmBeatsResourceName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAgFoodPlatformRpServicePrivateEndpointConnection -InputObject <IAgFoodPlatformRpServiceIdentity>
