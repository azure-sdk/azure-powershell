...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/remove-azagfoodplatformrpserviceprivateendpointconnection
schema: 2.0.0
---

# Remove-AzAgFoodPlatformRpServicePrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzAgFoodPlatformRpServicePrivateEndpointConnection -FarmBeatsResourceName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzAgFoodPlatformRpServicePrivateEndpointConnection -InputObject <IAgFoodPlatformRpServiceIdentity>
