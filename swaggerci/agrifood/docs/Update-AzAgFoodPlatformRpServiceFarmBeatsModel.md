...
online version: https://docs.microsoft.com/en-us/powershell/module/az.agfoodplatformrpservice/update-azagfoodplatformrpservicefarmbeatsmodel
schema: 2.0.0
---
...
```
Update-AzAgFoodPlatformRpServiceFarmBeatsModel -FarmBeatsResourceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IdentityType <ResourceIdentityType>] [-Location <String>]
 [-PublicNetworkAccess <PublicNetworkAccess>] [-SensorIntegrationEnabled <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAgFoodPlatformRpServiceFarmBeatsModel -InputObject <IAgFoodPlatformRpServiceIdentity>
 [-IdentityType <ResourceIdentityType>] [-Location <String>] [-PublicNetworkAccess <PublicNetworkAccess>]
 [-SensorIntegrationEnabled <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Support.ResourceIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AgFoodPlatformRpService.Support.PublicNetworkAccess
Parameter Sets: (All)
Aliases:
...
### -SensorIntegrationEnabled
Sensor integration enable state.
Allowed values are True, None
