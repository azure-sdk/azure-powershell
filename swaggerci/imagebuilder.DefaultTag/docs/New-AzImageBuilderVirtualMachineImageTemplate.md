...
New-AzImageBuilderVirtualMachineImageTemplate -ImageTemplateName <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-AutoRunState <AutoRunState>] [-BuildTimeoutInMinute <Int32>]
 [-Customize <IImageTemplateCustomizer[]>] [-Distribute <IImageTemplateDistributor[]>]
 [-ErrorHandlingOnCustomizerError <OnBuildError>] [-ErrorHandlingOnValidationError <OnBuildError>]
 [-IdentityType <ResourceIdentityType>] [-IdentityUserAssignedIdentity <Hashtable>]
 [-ManagedResourceTag <Hashtable>] [-SourceType <String>] [-StagingResourceGroup <String>] [-Tag <Hashtable>]
 [-ValidateContinueDistributeOnFailure] [-ValidateInVMValidation <IImageTemplateInVMValidator[]>]
 [-ValidateSourceValidationOnly] [-VMBootState <VMBootOptimizationState>] [-VMProfileOsdiskSizeGb <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.AutoRunState
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateCustomizer[]
Parameter Sets: (All)
Aliases:
...
If there is a customizer error and this field is set to 'cleanup', the build VM and associated network resources will be cleaned up.
This is the default behavior.
If there is a customizer error and this field is set to 'abort', the build VM will be preserved.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError
Parameter Sets: (All)
Aliases:
...
If there is a validation error and this field is set to 'cleanup', the build VM and associated network resources will be cleaned up.
This is the default behavior.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateInVMValidator[]
Parameter Sets: (All)
Aliases:
