...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplate _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ImageTemplate();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Enabling this field will trigger an automatic build on image template creation or update.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.AutoRunState))]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.AutoRunState AutoRunState { get => _parametersBody.AutoRunState ?? ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.AutoRunState)""); set => _parametersBody.AutoRunState = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateCustomizer[] Customize { get => _parametersBody.Customize ?? null /* arrayOf */; set => _parametersBody.Customize = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributor[] Distribute { get => _parametersBody.Distribute ?? null /* arrayOf */; set => _parametersBody.Distribute = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If there is a customizer error and this field is set to 'cleanup', the build VM and associated network resources will be cleaned up. This is the default behavior. If there is a customizer error and this field is set to 'abort', the build VM will be preserved.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError))]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError ErrorHandlingOnCustomizerError { get => _parametersBody.ErrorHandlingOnCustomizerError ?? ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError)""); set => _parametersBody.ErrorHandlingOnCustomizerError = value; }
        ...
        /// VM will be preserved.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If there is a validation error and this field is set to 'cleanup', the build VM and associated network resources will be cleaned up. This is the default behavior. If there is a validation error and this field is set to 'abort', the build VM will be preserved.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError) })]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError))]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError ErrorHandlingOnValidationError { get => _parametersBody.ErrorHandlingOnValidationError ?? ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.OnBuildError)""); set => _parametersBody.ErrorHandlingOnValidationError = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IUserAssignedIdentities IdentityUserAssignedIdentity { get => _parametersBody.IdentityUserAssignedIdentity ?? null /* object */; set => _parametersBody.IdentityUserAssignedIdentity = value; }
        ...
        /// </summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ExportAs(typeof(global::System.Collections.Hashtable))]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Tags that will be applied to the resource group and/or resources created by the service.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePropertiesManagedResourceTags ManagedResourceTag { get => _parametersBody.ManagedResourceTag ?? null /* object */; set => _parametersBody.ManagedResourceTag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateInVMValidator[] ValidateInVMValidation { get => _parametersBody.ValidateInVMValidation ?? null /* arrayOf */; set => _parametersBody.ValidateInVMValidation = value; }
        ...
        /// in `subnetId`.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource id of a pre-existing subnet on which Azure Container Instance will be deployed for Isolated Builds. This field may be specified only if `subnetId` is also specified and must be on the same Virtual Network as the subnet specified in `subnetId`.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string VnetConfigContainerInstanceSubnetId { get => _parametersBody.VnetConfigContainerInstanceSubnetId ?? null; set => _parametersBody.VnetConfigContainerInstanceSubnetId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Size of the proxy virtual machine used to pass traffic to the build VM and validation VM. This must not be specified if `containerInstanceSubnetId` is specified because no proxy virtual machine is deployed in that case. Omit or specify empty string to use the default (Standard_A1_v2).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource id of a pre-existing subnet on which the build VM and validation VM will be deployed")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
