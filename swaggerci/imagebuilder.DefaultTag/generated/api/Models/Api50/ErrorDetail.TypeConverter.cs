...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api50
{
    ...
    public partial class ErrorDetailTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ErrorDetail" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api50.IErrorDetail ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api50.IErrorDetail).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
