...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201
{
    ...
    public partial class ImageTemplateVMProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateVMProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateVMProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfig Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateVMProfileInternal.VnetConfig { get => (this._vnetConfig = this._vnetConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.VirtualNetworkConfig()); set { {_vnetConfig = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfig _vnetConfig;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfig VnetConfig { get => (this._vnetConfig = this._vnetConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.VirtualNetworkConfig()); set => this._vnetConfig = value; }
        ...
        public string VnetConfigContainerInstanceSubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfigInternal)VnetConfig).ContainerInstanceSubnetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfigInternal)VnetConfig).ContainerInstanceSubnetId = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string VnetConfigProxyVMSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfigInternal)VnetConfig).ProxyVMSize; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfigInternal)VnetConfig).ProxyVMSize = value ?? null; }

        /// <summary>
        /// Resource id of a pre-existing subnet on which the build VM and validation VM will be deployed
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string VnetConfigSubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfigInternal)VnetConfig).SubnetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfigInternal)VnetConfig).SubnetId = value ?? null; }
...

    {
        ...
        /// virtual network needs to be used.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IVirtualNetworkConfig VnetConfig { get; set; }
        /// <summary>
        /// Resource id of a pre-existing subnet on which Azure Container Instance will be deployed for Isolated Builds. This field
        /// may be specified only if `subnetId` is also specified and must be on the same Virtual Network as the subnet specified
        /// in `subnetId`.
