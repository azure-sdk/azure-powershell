...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201
{
    ...
    public partial class Operation :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperation,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.OperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Description = value ?? null; }

        /// <summary>For example: read, write, delete, or listKeys/action</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Operation; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Operation = value ?? null; }

        /// <summary>Friendly name of the resource provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Provider = value ?? null; }

        /// <summary>The resource type on which the operation is performed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplayInternal)Display).Resource = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.OperationDisplay()); set { {_display = value;} } }
    ...
    {
        /// <summary>The object that describes the operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IOperationDisplay Display { get; set; }
        /// <summary>The friendly name of the operation</summary>
        string DisplayDescription { get; set; }
        /// <summary>For example: read, write, delete, or listKeys/action</summary>
        string DisplayOperation { get; set; }
