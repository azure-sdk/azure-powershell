...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201
{
    ...
    public partial class ImageTemplateSharedImageDistributor :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateSharedImageDistributor,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateSharedImageDistributorInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IDistributeVersioner Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateSharedImageDistributorInternal.Versioning { get => (this._versioning = this._versioning ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.DistributeVersioner()); set { {_versioning = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ITargetRegion[] _targetRegion;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ITargetRegion[] TargetRegion { get => this._targetRegion; set => this._targetRegion = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IDistributeVersioner _versioning;

        /// <summary>Describes how to generate new x.y.z version number for distribution.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IDistributeVersioner Versioning { get => (this._versioning = this._versioning ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.DistributeVersioner()); set => this._versioning = value; }
        ...
        public string VersioningScheme { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IDistributeVersionerInternal)Versioning).Scheme; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IDistributeVersionerInternal)Versioning).Scheme = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributor
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ITargetRegion) })]
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ITargetRegion[] TargetRegion { get; set; }
        /// <summary>Version numbering scheme to be used.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ITargetRegion[] TargetRegion { get; set; }
        /// <summary>Describes how to generate new x.y.z version number for distribution.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IDistributeVersioner Versioning { get; set; }
        /// <summary>Version numbering scheme to be used.</summary>
        string VersioningScheme { get; set; }
