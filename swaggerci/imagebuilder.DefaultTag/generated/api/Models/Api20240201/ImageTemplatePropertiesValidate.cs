...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201
{
    ...
    public partial class ImageTemplatePropertiesValidate :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePropertiesValidate,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePropertiesValidateInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateInVMValidator[] _inVMValidation;

        /// <summary>List of validations to be performed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateInVMValidator[] InVMValidation { get => this._inVMValidation; set => this._inVMValidation = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateInVMValidator[] InVMValidation { get; set; }
        /// <summary>
        /// If this field is set to true, the image specified in the 'source' section will directly be validated. No separate build
        /// will be run to generate and then validate a customized image.
        /// </summary>
