...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201
{
    ...
    public partial class ImageTemplatePlatformImageSource :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePlatformImageSource,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePlatformImageSourceInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePlatformImageSourceInternal.ExactVersion { get => this._exactVersion; set { {_exactVersion = value;} } }

        /// <summary>Internal Acessors for PlanInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlan Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplatePlatformImageSourceInternal.PlanInfo { get => (this._planInfo = this._planInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.PlatformImagePurchasePlan()); set { {_planInfo = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlan _planInfo;

        /// <summary>Optional configuration of purchase plan for platform image.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlan PlanInfo { get => (this._planInfo = this._planInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.PlatformImagePurchasePlan()); set => this._planInfo = value; }
        ...
        public string PlanInfoPlanName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlanInternal)PlanInfo).PlanName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlanInternal)PlanInfo).PlanName = value ?? null; }

        /// <summary>Product of the purchase plan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string PlanInfoPlanProduct { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlanInternal)PlanInfo).PlanProduct; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlanInternal)PlanInfo).PlanProduct = value ?? null; }

        /// <summary>Publisher of the purchase plan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string PlanInfoPlanPublisher { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlanInternal)PlanInfo).PlanPublisher; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlanInternal)PlanInfo).PlanPublisher = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateSourceInternal
    {
        ...
        string Offer { get; set; }
        /// <summary>Optional configuration of purchase plan for platform image.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IPlatformImagePurchasePlan PlanInfo { get; set; }
        /// <summary>Name of the purchase plan.</summary>
        string PlanInfoPlanName { get; set; }
        /// <summary>Product of the purchase plan.</summary>
        string PlanInfoPlanProduct { get; set; }
