...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201
{
    ...
    public partial class ImageTemplateVhdDistributor :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateVhdDistributor,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateVhdDistributorInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributor"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributor __imageTemplateDistributor = new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.ImageTemplateDistributor();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorArtifactTags ArtifactTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal)__imageTemplateDistributor).ArtifactTag; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal)__imageTemplateDistributor).ArtifactTag = value ?? null /* model class */; }

        /// <summary>The name to be used for the associated RunOutput.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string RunOutputName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal)__imageTemplateDistributor).RunOutputName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal)__imageTemplateDistributor).RunOutputName = value ; }

        /// <summary>Type of distribution.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal)__imageTemplateDistributor).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal)__imageTemplateDistributor).Type = value ; }
    ...
    internal partial interface IImageTemplateVhdDistributorInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20240201.IImageTemplateDistributorInternal
    {
        /// <summary>
        /// Optional Azure Storage URI for the distributed VHD blob. Omit to use the default (empty string) in which case VHD would
        /// be published to the storage account in the staging resource group.
