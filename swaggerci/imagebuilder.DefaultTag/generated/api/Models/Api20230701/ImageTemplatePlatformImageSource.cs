...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701
{
    ...
    public partial class ImageTemplatePlatformImageSource :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplatePlatformImageSource,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplatePlatformImageSourceInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSource"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSource __imageTemplateSource = new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ImageTemplateSource();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplatePlatformImageSourceInternal.ExactVersion { get => this._exactVersion; set { {_exactVersion = value;} } }

        /// <summary>Internal Acessors for PlanInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlan Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplatePlatformImageSourceInternal.PlanInfo { get => (this._planInfo = this._planInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.PlatformImagePurchasePlan()); set { {_planInfo = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlan _planInfo;

        /// <summary>Optional configuration of purchase plan for platform image.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlan PlanInfo { get => (this._planInfo = this._planInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.PlatformImagePurchasePlan()); set => this._planInfo = value; }
        ...
        public string PlanInfoPlanName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlanInternal)PlanInfo).PlanName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlanInternal)PlanInfo).PlanName = value ?? null; }

        /// <summary>Product of the purchase plan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string PlanInfoPlanProduct { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlanInternal)PlanInfo).PlanProduct; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlanInternal)PlanInfo).PlanProduct = value ?? null; }

        /// <summary>Publisher of the purchase plan.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string PlanInfoPlanPublisher { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlanInternal)PlanInfo).PlanPublisher; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlanInternal)PlanInfo).PlanPublisher = value ?? null; }
        ...
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSourceInternal)__imageTemplateSource).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSourceInternal)__imageTemplateSource).Type = value ; }
    ...
    public partial interface IImageTemplatePlatformImageSource :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSource
    {
        /// <summary>
        /// Image version from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        /// This readonly field differs from 'version', only if the value specified in 'version' field is 'latest'.
    ...
    internal partial interface IImageTemplatePlatformImageSourceInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSourceInternal
    {
        /// <summary>
        /// Image version from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        /// This readonly field differs from 'version', only if the value specified in 'version' field is 'latest'.
        ...
        string Offer { get; set; }
        /// <summary>Optional configuration of purchase plan for platform image.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IPlatformImagePurchasePlan PlanInfo { get; set; }
        /// <summary>Name of the purchase plan.</summary>
        string PlanInfoPlanName { get; set; }
        /// <summary>Product of the purchase plan.</summary>
        string PlanInfoPlanProduct { get; set; }
