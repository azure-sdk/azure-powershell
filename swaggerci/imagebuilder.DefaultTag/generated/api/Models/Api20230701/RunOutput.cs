...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701
{
    ...
    public partial class RunOutput :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        ...
        public string ArtifactId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ArtifactId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ArtifactId = value ?? null; }

        /// <summary>The location URI of the artifact.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string ArtifactUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ArtifactUri; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ArtifactUri = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputProperties Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.RunOutputProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ProvisioningState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.RunOutputProperties()); set => this._property = value; }

        /// <summary>Provisioning state of the resource</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Support.ProvisioningState? ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputPropertiesInternal)Property).ProvisioningState; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api30.IResourceInternal
    {
        ...
        string ArtifactUri { get; set; }
        /// <summary>The properties of the run output</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IRunOutputProperties Property { get; set; }
        /// <summary>Provisioning state of the resource</summary>
