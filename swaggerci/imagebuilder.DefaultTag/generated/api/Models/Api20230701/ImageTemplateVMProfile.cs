...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701
{
    ...
    public partial class ImageTemplateVMProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateVMProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateVMProfileInternal
    {

        /// <summary>Internal Acessors for VnetConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfig Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateVMProfileInternal.VnetConfig { get => (this._vnetConfig = this._vnetConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.VirtualNetworkConfig()); set { {_vnetConfig = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfig _vnetConfig;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfig VnetConfig { get => (this._vnetConfig = this._vnetConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.VirtualNetworkConfig()); set => this._vnetConfig = value; }
        ...
        public string VnetConfigProxyVMSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfigInternal)VnetConfig).ProxyVMSize; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfigInternal)VnetConfig).ProxyVMSize = value ?? null; }

        /// <summary>Resource id of a pre-existing subnet.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inlined)]
        public string VnetConfigSubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfigInternal)VnetConfig).SubnetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfigInternal)VnetConfig).SubnetId = value ?? null; }
...

    {
        ...
        /// virtual network needs to be used.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IVirtualNetworkConfig VnetConfig { get; set; }
        /// <summary>
        /// Size of the proxy virtual machine used to pass traffic to the build VM and validation VM. Omit or specify empty string
        /// to use the default (Standard_A1_v2).
        /// </summary>
