...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701
{
    ...
    public partial class ImageTemplateSharedImageDistributor :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSharedImageDistributor,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSharedImageDistributorInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributor"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributor __imageTemplateDistributor = new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ImageTemplateDistributor();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorArtifactTags ArtifactTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal)__imageTemplateDistributor).ArtifactTag; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal)__imageTemplateDistributor).ArtifactTag = value ?? null /* model class */; }
        ...
        /// <summary>Internal Acessors for Versioning</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IDistributeVersioner Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateSharedImageDistributorInternal.Versioning { get => (this._versioning = this._versioning ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.DistributeVersioner()); set { {_versioning = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string RunOutputName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal)__imageTemplateDistributor).RunOutputName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal)__imageTemplateDistributor).RunOutputName = value ; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ITargetRegion[] _targetRegion;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ITargetRegion[] TargetRegion { get => this._targetRegion; set => this._targetRegion = value; }

        /// <summary>Type of distribution.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal)__imageTemplateDistributor).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal)__imageTemplateDistributor).Type = value ; }

        /// <summary>Backing field for <see cref="Versioning" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IDistributeVersioner _versioning;

        /// <summary>Describes how to generate new x.y.z version number for distribution.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IDistributeVersioner Versioning { get => (this._versioning = this._versioning ?? new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.DistributeVersioner()); set => this._versioning = value; }
        ...
        public string VersioningScheme { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IDistributeVersionerInternal)Versioning).Scheme; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IDistributeVersionerInternal)Versioning).Scheme = value ?? null; }
    ...
    public partial interface IImageTemplateSharedImageDistributor :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributor
    {
        /// <summary>
        /// Flag that indicates whether created image version should be excluded from latest. Omit to use the default (false).
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ITargetRegion) })]
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ITargetRegion[] TargetRegion { get; set; }
        /// <summary>Version numbering scheme to be used.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IImageTemplateSharedImageDistributorInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateDistributorInternal
    {
        /// <summary>
        /// Flag that indicates whether created image version should be excluded from latest. Omit to use the default (false).
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ITargetRegion[] TargetRegion { get; set; }
        /// <summary>Describes how to generate new x.y.z version number for distribution.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IDistributeVersioner Versioning { get; set; }
        /// <summary>Version numbering scheme to be used.</summary>
        string VersioningScheme { get; set; }
