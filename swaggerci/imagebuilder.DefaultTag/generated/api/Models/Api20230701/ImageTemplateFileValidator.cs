...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701
{
    ...
    public partial class ImageTemplateFileValidator :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateFileValidator,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateFileValidatorInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidator"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidator __imageTemplateInVMValidator = new Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.ImageTemplateInVMValidator();
        ...
        public string Name { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidatorInternal)__imageTemplateInVMValidator).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidatorInternal)__imageTemplateInVMValidator).Name = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Origin(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidatorInternal)__imageTemplateInVMValidator).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidatorInternal)__imageTemplateInVMValidator).Type = value ; }
    ...
    public partial interface IImageTemplateFileValidator :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidator
    {
        /// <summary>
        /// The absolute path to a file (with nested directory structures already created) where the file (from sourceUri) will be
        /// uploaded to in the VM
    ...
    internal partial interface IImageTemplateFileValidatorInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20230701.IImageTemplateInVMValidatorInternal
    {
        /// <summary>
        /// The absolute path to a file (with nested directory structures already created) where the file (from sourceUri) will be
        /// uploaded to in the VM
