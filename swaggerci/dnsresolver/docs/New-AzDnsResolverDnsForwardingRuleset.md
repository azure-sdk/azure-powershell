...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dnsresolver/new-azdnsresolverdnsforwardingruleset
schema: 2.0.0
---
...
```
New-AzDnsResolverDnsForwardingRuleset -Name <String> -ResourceGroupName <String>
