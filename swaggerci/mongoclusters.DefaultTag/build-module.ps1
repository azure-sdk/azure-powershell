...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.MongoCluster.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.MongoCluster.psd1'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.MongoCluster.format.ps1xml'
