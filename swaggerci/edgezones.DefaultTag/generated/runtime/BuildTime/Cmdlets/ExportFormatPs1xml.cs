...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support";
