...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesForTesting.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesForTesting.Support";
