...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models
{
    ...
    public partial class EdgeZonesIdentity
    {
        ...
        internal EdgeZonesIdentity(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject json)
        {
            ...
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)SubscriptionId;}
            {_azureExtendedZoneName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("azureExtendedZoneName"), out var __jsonAzureExtendedZoneName) ? (string)__jsonAzureExtendedZoneName : (string)AzureExtendedZoneName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._azureExtendedZoneName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString(this._azureExtendedZoneName.ToString()) : null, "azureExtendedZoneName" ,container.Add );
