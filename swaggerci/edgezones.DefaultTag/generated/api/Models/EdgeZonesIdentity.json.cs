...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models
{
    ...
    public partial class EdgeZonesIdentity
    {
        ...
        internal EdgeZonesIdentity(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject json)
        {
            ...
            {_extendedZoneName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("extendedZoneName"), out var __jsonExtendedZoneName) ? (string)__jsonExtendedZoneName : (string)ExtendedZoneName;}
