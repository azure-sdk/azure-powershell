...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview
{
    ...
    public partial class MyModel
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview.IMyModel.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview.IMyModel.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview.IMyModel FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject json ? new MyModel(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject into a new instance of <see cref="MyModel" />.
        /// </summary>
        ...
        internal MyModel(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject json)
        {
            ...
            {_age = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNumber>("age"), out var __jsonAge) ? (double)__jsonAge : Age;}
            {_isAlive = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonBoolean>("isAlive"), out var __jsonIsAlive) ? (bool)__jsonIsAlive : IsAlive;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MyModel" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MyModel" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNumber(this._age), "age" ,container.Add );
            AddIf( (Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonBoolean(this._isAlive), "isAlive" ,container.Add );
