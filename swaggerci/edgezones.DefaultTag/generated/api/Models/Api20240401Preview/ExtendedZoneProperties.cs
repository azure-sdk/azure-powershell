...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview
{
    ...
    public partial class ExtendedZoneProperties :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZoneProperties,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for Geography</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.Geography { get => this._geography; set { {_geography = value;} } }

        /// <summary>Internal Acessors for GeographyGroup</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.GeographyGroup { get => this._geographyGroup; set { {_geographyGroup = value;} } }

        /// <summary>Internal Acessors for HomeLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.HomeLocation { get => this._homeLocation; set { {_homeLocation = value;} } }

        /// <summary>Internal Acessors for Latitude</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.Latitude { get => this._latitude; set { {_latitude = value;} } }

        /// <summary>Internal Acessors for Longitude</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.Longitude { get => this._longitude; set { {_longitude = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for RegionCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.RegionCategory { get => this._regionCategory; set { {_regionCategory = value;} } }

        /// <summary>Internal Acessors for RegionType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.RegionType { get => this._regionType; set { {_regionType = value;} } }

        /// <summary>Internal Acessors for RegionalDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.RegionalDisplayName { get => this._regionalDisplayName; set { {_regionalDisplayName = value;} } }

        /// <summary>Internal Acessors for RegistrationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.RegistrationState? Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Models.Api20240401Preview.IExtendedZonePropertiesInternal.RegistrationState { get => this._registrationState; set { {_registrationState = value;} } }

        /// <summary>Backing field for <see cref="ProvisioningState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.ProvisioningState? _provisioningState;

        /// <summary>
        /// Status of the last operation performed by the subscription on the Edge Zone resource
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.ProvisioningState? ProvisioningState { get => this._provisioningState; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.RegistrationState? _registrationState;

        /// <summary>Indicates the Azure Extended Zone registration’s approval status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.RegistrationState? RegistrationState { get => this._registrationState; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.ProvisioningState) })]
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.ProvisioningState? ProvisioningState { get;  }
        /// <summary>Category of region for the Azure Extended Zone.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Runtime.Info(
        Required = true,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.RegistrationState) })]
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.RegistrationState? RegistrationState { get;  }
...

    {
        ...
        /// Status of the last operation performed by the subscription on the Edge Zone resource
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.ProvisioningState? ProvisioningState { get; set; }
        /// <summary>Category of region for the Azure Extended Zone.</summary>
        ...
        /// <summary>Indicates the Azure Extended Zone registration’s approval status.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeZonesTest.Support.RegistrationState? RegistrationState { get; set; }
