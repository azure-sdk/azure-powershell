...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview
{
    ...
    public partial class AzureExtendedZoneProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject into a new instance of <see cref="AzureExtendedZoneProperties" />.
        /// </summary>
        ...
        internal AzureExtendedZoneProperties(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject json)
        {
            ...
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)ProvisioningState;}
            {_registrationState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("registrationState"), out var __jsonRegistrationState) ? (string)__jsonRegistrationState : (string)RegistrationState;}
            {_displayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("displayName"), out var __jsonDisplayName) ? (string)__jsonDisplayName : (string)DisplayName;}
            {_regionalDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("regionalDisplayName"), out var __jsonRegionalDisplayName) ? (string)__jsonRegionalDisplayName : (string)RegionalDisplayName;}
            {_regionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("regionType"), out var __jsonRegionType) ? (string)__jsonRegionType : (string)RegionType;}
            {_regionCategory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("regionCategory"), out var __jsonRegionCategory) ? (string)__jsonRegionCategory : (string)RegionCategory;}
            {_geography = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("geography"), out var __jsonGeography) ? (string)__jsonGeography : (string)Geography;}
            {_geographyGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("geographyGroup"), out var __jsonGeographyGroup) ? (string)__jsonGeographyGroup : (string)GeographyGroup;}
            {_longitude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("longitude"), out var __jsonLongitude) ? (string)__jsonLongitude : (string)Longitude;}
            {_latitude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("latitude"), out var __jsonLatitude) ? (string)__jsonLatitude : (string)Latitude;}
            {_homeLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonString>("homeLocation"), out var __jsonHomeLocation) ? (string)__jsonHomeLocation : (string)HomeLocation;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview.IAzureExtendedZoneProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview.IAzureExtendedZoneProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Models.Api20240401Preview.IAzureExtendedZoneProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonObject json ? new AzureExtendedZoneProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureExtendedZoneProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureExtendedZoneProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Runtime.Json.JsonNode" />.
        /// </returns>
