...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>Resource creation was canceled.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Deleting State</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Provisioning State</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Provisioning = @"Provisioning";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Updating State</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.EdgeZones.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
