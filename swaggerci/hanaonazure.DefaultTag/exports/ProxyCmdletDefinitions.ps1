...
.Link
https://learn.microsoft.com/powershell/module/az.hana/get-azhanaproviderinstance
#>
...
Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IProviderInstance
.Link
https://learn.microsoft.com/powershell/module/az.hana/new-azhanaproviderinstance
#>
...
INPUTOBJECT <IHanaIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Subscription ID which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://learn.microsoft.com/powershell/module/az.hana/remove-azhanasapmonitor
#>
...
INPUTOBJECT <IHanaIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Subscription ID which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://learn.microsoft.com/powershell/module/az.hana/update-azhanasapmonitor
#>
