...
online version: https://docs.microsoft.com/en-us/powershell/module/az.application/update-azapplicationpermission
schema: 2.0.0
---

# Update-AzApplicationPermission
...
### Refresh (Default)
```
Update-AzApplicationPermission -ApplicationName <String> -ResourceGroupName <String>
...
### RefreshViaIdentity
```
Update-AzApplicationPermission -InputObject <IApplicationIdentity> [-DefaultProfile <PSObject>] [-AsJob]
