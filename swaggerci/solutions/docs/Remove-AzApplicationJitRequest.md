...
online version: https://docs.microsoft.com/en-us/powershell/module/az.application/remove-azapplicationjitrequest
schema: 2.0.0
---

# Remove-AzApplicationJitRequest
...
### Delete (Default)
```
Remove-AzApplicationJitRequest -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzApplicationJitRequest -InputObject <IApplicationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
