...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetBySubscriptionIdAndTrackingId=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/events/{eventTrackingId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzResourceHealthEvent_GetViaIdentity")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEvent))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Description(@"Service health event in the subscription by event tracking id")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/events/{eventTrackingId}", ApiVersion = "2025-04-01")]
    public partial class GetAzResourceHealthEvent_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies from when to return events (default is 3 days), based on the lastUpdateTime property. For example, queryStartTime = 7/24/2020 OR queryStartTime=7%2F24%2F2020")]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Specifies from when to return events (default is 3 days), based on the lastUpdateTime property. For example, queryStartTime = 7/24/2020 OR queryStartTime=7%2F24%2F2020",
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEvent">Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEvent</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEvent> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        {
            var telemetryInfo = Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Module.Instance.GetTelemetryInfo?.Invoke(__correlationId);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzResourceHealthEvent_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzResourceHealthEvent_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.EventGetBySubscriptionIdAndTrackingIdViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("QueryStartTime") ? QueryStartTime : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.EventGetBySubscriptionIdAndTrackingId(this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("QueryStartTime") ? QueryStartTime : null, InputObject.SubscriptionId ?? null, InputObject.EventTrackingId ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Module.Instance.SanitizeOutput?.Invoke(sendToPipeline, __correlationId);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEvent> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEvent
