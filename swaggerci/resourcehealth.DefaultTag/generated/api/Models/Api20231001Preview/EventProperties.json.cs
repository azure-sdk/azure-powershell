...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview
{
    ...
    public partial class EventProperties
    {
        ...
        internal EventProperties(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject json)
        {
            ...
            {_article = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("article"), out var __jsonArticle) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.EventPropertiesArticle.FromJson(__jsonArticle) : Article;}
            {_recommendedAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("recommendedActions"), out var __jsonRecommendedActions) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.EventPropertiesRecommendedActions.FromJson(__jsonRecommendedActions) : RecommendedAction;}
            {_additionalInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("additionalInformation"), out var __jsonAdditionalInformation) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.EventPropertiesAdditionalInformation.FromJson(__jsonAdditionalInformation) : AdditionalInformation;}
            ...
            {_eventSubType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("eventSubType"), out var __jsonEventSubType) ? (string)__jsonEventSubType : (string)EventSubType;}
            ...
            {_link = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("links"), out var __jsonLinks) ? If( __jsonLinks as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.ILink[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.ILink) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.Link.FromJson(__u) )) ))() : null : Link;}
            ...
            {_impact = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("impact"), out var __jsonImpact) ? If( __jsonImpact as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IImpact[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IImpact) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.Impact.FromJson(__p) )) ))() : null : Impact;}
            {_faq = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("faqs"), out var __jsonFaqs) ? If( __jsonFaqs as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IFaq[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IFaq) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.Faq.FromJson(__k) )) ))() : null : Faq;}
            ...
            {_maintenanceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("maintenanceId"), out var __jsonMaintenanceId) ? (string)__jsonMaintenanceId : (string)MaintenanceId;}
            {_maintenanceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("maintenanceType"), out var __jsonMaintenanceType) ? (string)__jsonMaintenanceType : (string)MaintenanceType;}
            {_argQuery = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("argQuery"), out var __jsonArgQuery) ? (string)__jsonArgQuery : (string)ArgQuery;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IEventProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IEventProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20231001Preview.IEventProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._eventSubType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._eventSubType.ToString()) : null, "eventSubType" ,container.Add );
            ...
            AddIf( null != (((object)this._maintenanceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._maintenanceId.ToString()) : null, "maintenanceId" ,container.Add );
            AddIf( null != (((object)this._maintenanceType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._maintenanceType.ToString()) : null, "maintenanceType" ,container.Add );
            AddIf( null != (((object)this._argQuery)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._argQuery.ToString()) : null, "argQuery" ,container.Add );
