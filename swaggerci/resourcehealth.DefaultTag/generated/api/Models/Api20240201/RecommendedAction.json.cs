...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20240201
{
    ...
    public partial class RecommendedAction
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20240201.IRecommendedAction.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20240201.IRecommendedAction.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20240201.IRecommendedAction FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode node)
        {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject into a new instance of <see cref="RecommendedAction" />.
        /// </summary>
        ...
        internal RecommendedAction(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject json)
        {
            ...
            {_action = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("action"), out var __jsonAction) ? (string)__jsonAction : (string)Action;}
            {_actionUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("actionUrl"), out var __jsonActionUrl) ? (string)__jsonActionUrl : (string)ActionUrl;}
            {_actionUrlComment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("_ActionUrl.Comment"), out var __jsonActionUrlComment) ? (string)__jsonActionUrlComment : (string)ActionUrlComment;}
            {_actionUrlText = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("actionUrlText"), out var __jsonActionUrlText) ? (string)__jsonActionUrlText : (string)ActionUrlText;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RecommendedAction" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RecommendedAction" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._actionUrlComment)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._actionUrlComment.ToString()) : null, "_ActionUrl.Comment" ,container.Add );
