...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501
{
    ...
    public partial class EventProperties
    {
        ...
        internal EventProperties(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject json)
        {
            ...
            {_article = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("article"), out var __jsonArticle) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.EventPropertiesArticle.FromJson(__jsonArticle) : Article;}
            {_recommendedAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("recommendedActions"), out var __jsonRecommendedActions) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.EventPropertiesRecommendedActions.FromJson(__jsonRecommendedActions) : RecommendedAction;}
            {_additionalInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("additionalInformation"), out var __jsonAdditionalInformation) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.EventPropertiesAdditionalInformation.FromJson(__jsonAdditionalInformation) : AdditionalInformation;}
            ...
            {_link = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("links"), out var __jsonLinks) ? If( __jsonLinks as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.ILink[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.ILink) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.Link.FromJson(__u) )) ))() : null : Link;}
            ...
            {_impact = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("impact"), out var __jsonImpact) ? If( __jsonImpact as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IImpact[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IImpact) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.Impact.FromJson(__p) )) ))() : null : Impact;}
            {_faq = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("faqs"), out var __jsonFaqs) ? If( __jsonFaqs as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IFaq[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IFaq) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.Faq.FromJson(__k) )) ))() : null : Faq;}
            ...
            {_eventTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("eventTags"), out var __jsonEventTags) ? If( __jsonEventTags as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : EventTag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IEventProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IEventProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250501.IEventProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                var __h = new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.XNodeArray();
                foreach( var __i in this._eventTag )
                {
                    AddIf(null != (((object)__i)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(__i.ToString()) : null ,__h.Add);
                }
                container.Add("eventTags",__h);
            }
