...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401
{
    ...
    public partial class EventProperties
    {
        ...
        internal EventProperties(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject json)
        {
            ...
            {_article = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("article"), out var __jsonArticle) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.EventPropertiesArticle.FromJson(__jsonArticle) : Article;}
            {_recommendedAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("recommendedActions"), out var __jsonRecommendedActions) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.EventPropertiesRecommendedActions.FromJson(__jsonRecommendedActions) : RecommendedAction;}
            {_additionalInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject>("additionalInformation"), out var __jsonAdditionalInformation) ? Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.EventPropertiesAdditionalInformation.FromJson(__jsonAdditionalInformation) : AdditionalInformation;}
            ...
            {_isEventSensitive = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonBoolean>("isEventSensitive"), out var __jsonIsEventSensitive) ? (bool?)__jsonIsEventSensitive : IsEventSensitive;}
            ...
            {_reason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("reason"), out var __jsonReason) ? (string)__jsonReason : (string)Reason;}
            {_link = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("links"), out var __jsonLinks) ? If( __jsonLinks as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.ILink[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.ILink) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.Link.FromJson(__u) )) ))() : null : Link;}
            ...
            {_impact = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("impact"), out var __jsonImpact) ? If( __jsonImpact as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IImpact[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IImpact) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.Impact.FromJson(__p) )) ))() : null : Impact;}
            {_faq = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray>("faqs"), out var __jsonFaqs) ? If( __jsonFaqs as Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IFaq[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IFaq) (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.Faq.FromJson(__k) )) ))() : null : Faq;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEventProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEventProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20250401.IEventProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._isEventSensitive ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonBoolean((bool)this._isEventSensitive) : null, "isEventSensitive" ,container.Add );
            ...
            AddIf( null != (((object)this._reason)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._reason.ToString()) : null, "reason" ,container.Add );
            if (null != this._link)
            {
