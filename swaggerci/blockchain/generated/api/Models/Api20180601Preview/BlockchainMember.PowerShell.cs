...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview
{
    ...
    public partial class BlockchainMember
    {
        ...
        internal BlockchainMember(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("ValidatorNodesSku"))
            {
            ...
            if (content.Contains("Consortium"))
            {
            ...
            if (content.Contains("ConsortiumManagementAccountAddress"))
            {
            ...
            if (content.Contains("ConsortiumRole"))
            {
            ...
            if (content.Contains("ConsortiumMemberDisplayName"))
            {
            ...
            if (content.Contains("RootContractAddress"))
            {
            ...
            if (content.Contains("ValidatorNodeSkuCapacity"))
            {
        ...
        /// <returns>an instance of the <see cref="BlockchainMember" /> model class.</returns>
