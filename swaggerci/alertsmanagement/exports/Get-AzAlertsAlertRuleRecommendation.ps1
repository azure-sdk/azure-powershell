...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.alerts/get-azalertsalertrulerecommendation
#>
function Get-AzAlertsAlertRuleRecommendation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Alerts.Models.Api202301Preview.IDisplayInformationItem])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Alerts.Category('Query')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Alerts.private\Get-AzAlertsAlertRuleRecommendation_List';
            List1 = 'Az.Alerts.private\Get-AzAlertsAlertRuleRecommendation_List1';
        }
