...
online version: https://learn.microsoft.com/powershell/module/az.manufacturingplatform/new-azmanufacturingplatformmanufacturingdataservice
schema: 2.0.0
---

# New-AzManufacturingPlatformManufacturingDataService
...
```
New-AzManufacturingPlatformManufacturingDataService -MdsResourceName <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-AadApplicationId <String>] [-AksAdminGroupId <String>]
 [-AmlProfileCustomNerServiceUri <String>] [-AmlProfileId <String>] [-CmkProfileKeyUri <String>]
 [-ContinuousExportPeriod <Int32>] [-DenyAssignmentExclusion <IDenyAssignmentExclusion[]>] [-EnableCopilot]
 [-EnableDiagnosticSetting] [-EnableTeamsNotification] [-FabricProfileKeyUri <String>]
 [-FabricProfileOneLakePath <String>] [-FabricProfileOneLakeUri <String>]
 ...
 [-RedundancyState <RedundancyState>] [-ResourceState <ResourceState>] [-SkuCapacity <Int32>]
 [-SkuFamily <String>] [-SkuName <String>] [-SkuSize <String>] [-SkuTier <SkuTier>] [-Tag <Hashtable>]
 [-UserManagedAdxProfileId <String>] [-UserManagedDatabaseProfileCosmosId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManufacturingPlatform.Support.RedundancyState
Parameter Sets: (All)
Aliases:
