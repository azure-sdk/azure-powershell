...
New-AzManufacturingPlatformManufacturingDataService -MdsResourceName <String> -ResourceGroupName <String>
 ...
 [-CmkProfileKeyUri <String>] [-DenyAssignmentExclusion <IDenyAssignmentExclusion[]>] [-EnableCopilot]
 ...
 [-OpenAiProfileGptModelVersion <String>] [-RedundancyState <RedundancyState>]
