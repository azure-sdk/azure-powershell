...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManufacturingPlatform.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ManufacturingPlatform.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ManufacturingPlatform.Support";
