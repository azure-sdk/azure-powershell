...
online version: https://learn.microsoft.com/powershell/module/az.softwareplanrp/remove-azsoftwareplanrphybridusebenefit
schema: 2.0.0
---

# Remove-AzSoftwarePlanRpHybridUseBenefit
...
### Delete (Default)
```
Remove-AzSoftwarePlanRpHybridUseBenefit -PlanId <String> -Scope <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSoftwarePlanRpHybridUseBenefit -InputObject <ISoftwarePlanRpIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
