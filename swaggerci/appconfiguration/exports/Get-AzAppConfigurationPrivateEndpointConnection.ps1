...
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/get-azappconfigurationprivateendpointconnection
#>
function Get-AzAppConfigurationPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230301.IPrivateEndpointConnection])]
