...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IOperationDefinition
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IOperationDefinition])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List1 = 'Az.AppConfiguration.private\Get-AzAppConfigurationOperation_List1';
        }
