...
Update-AzAppConfigurationStore -ConfigStoreName <String> -ResourceGroupName <String>
 ...
 [-Property <IAny>] [-SkuName <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Update-AzAppConfigurationStore -InputObject <IAppConfigurationIdentity> [-IdentityType <IdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-Property <IAny>] [-SkuName <String>] [-Tag <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IAny
Parameter Sets: (All)
Aliases:
