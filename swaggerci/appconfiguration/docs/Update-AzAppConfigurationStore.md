...
```
Update-AzAppConfigurationStore -ConfigStoreName <String> -ResourceGroupName <String>
 -ConfigStoreUpdateParameter <IConfigurationStoreUpdateParametersAutoGenerated> [-SubscriptionId <String>]
...
Update-AzAppConfigurationStore -InputObject <IAppConfigurationIdentity>
 -ConfigStoreUpdateParameter <IConfigurationStoreUpdateParametersAutoGenerated> [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IConfigurationStoreUpdateParametersAutoGenerated
