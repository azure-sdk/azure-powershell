...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appconfigurationtest/clear-azappconfigurationtestconfigurationstoredeleted
schema: 2.0.0
---

# Clear-AzAppConfigurationTestConfigurationStoreDeleted
...
### Purge (Default)
```
Clear-AzAppConfigurationTestConfigurationStoreDeleted -ConfigStoreName <String> -Location <String>
...
### PurgeViaIdentity
```
Clear-AzAppConfigurationTestConfigurationStoreDeleted -InputObject <IAppConfigurationTestIdentity>
