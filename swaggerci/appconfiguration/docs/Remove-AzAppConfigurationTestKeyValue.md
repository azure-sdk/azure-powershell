...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appconfigurationtest/remove-azappconfigurationtestkeyvalue
schema: 2.0.0
---

# Remove-AzAppConfigurationTestKeyValue
...
### Delete (Default)
```
Remove-AzAppConfigurationTestKeyValue -ConfigStoreName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzAppConfigurationTestKeyValue -InputObject <IAppConfigurationTestIdentity>
