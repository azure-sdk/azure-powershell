...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appconfigurationtest/remove-azappconfigurationtestconfigurationstore
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAppConfigurationTestConfigurationStore -ConfigStoreName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzAppConfigurationTestConfigurationStore -InputObject <IAppConfigurationTestIdentity>
