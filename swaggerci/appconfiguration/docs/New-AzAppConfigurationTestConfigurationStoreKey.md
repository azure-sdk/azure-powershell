...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appconfigurationtest/new-azappconfigurationtestconfigurationstorekey
schema: 2.0.0
---

# New-AzAppConfigurationTestConfigurationStoreKey
...
```
New-AzAppConfigurationTestConfigurationStoreKey -ConfigStoreName <String> -ResourceGroupName <String>
...
```
New-AzAppConfigurationTestConfigurationStoreKey -InputObject <IAppConfigurationTestIdentity>
...
```
New-AzAppConfigurationTestConfigurationStoreKey -InputObject <IAppConfigurationTestIdentity> [-Id <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Models.Api20220501.IRegenerateKeyParameters
