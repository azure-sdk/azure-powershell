...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appconfigurationtest/new-azappconfigurationtestkeyvalue
schema: 2.0.0
---

# New-AzAppConfigurationTestKeyValue
...
```
New-AzAppConfigurationTestKeyValue -ConfigStoreName <String> -Name <String> -ResourceGroupName <String>
