...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appconfigurationtest/remove-azappconfigurationtestprivateendpointconnection
schema: 2.0.0
---

# Remove-AzAppConfigurationTestPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzAppConfigurationTestPrivateEndpointConnection -ConfigStoreName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzAppConfigurationTestPrivateEndpointConnection -InputObject <IAppConfigurationTestIdentity>
