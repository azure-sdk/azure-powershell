...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support.ConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
