...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.AppConfigurationTest.Support";
