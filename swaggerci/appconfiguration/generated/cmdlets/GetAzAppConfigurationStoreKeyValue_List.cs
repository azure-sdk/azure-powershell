...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAppConfigurationStoreKeyValue_List", SupportsShouldProcess = true)]
    ...
    public partial class GetAzAppConfigurationStoreKeyValue_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ListKeyValueParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api202005012.IListKeyValueParameters _listKeyValueParameter;

        /// <summary>The parameters used to list a configuration store key-value</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters used to list a configuration store key-value", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The parameters used to list a configuration store key-value",
        SerializedName = @"listKeyValueParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api202005012.IListKeyValueParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api202005012.IListKeyValueParameters ListKeyValueParameter { get => this._listKeyValueParameter; set => this._listKeyValueParameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAppConfigurationStoreKeyValue_List" /> cmdlet class.
        /// </summary>
        public GetAzAppConfigurationStoreKeyValue_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConfigurationStoresListKeyValue(SubscriptionId, ResourceGroupName, ConfigStoreName, ListKeyValueParameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ConfigStoreName=ConfigStoreName,body=ListKeyValueParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api202005012.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ConfigStoreName=ConfigStoreName, body=ListKeyValueParameter })
                    {
