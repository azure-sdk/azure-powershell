...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAppConfigurationStore_CreateViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class NewAzAppConfigurationStore_CreateViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConfigStoreCreationParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IConfigurationStore _configStoreCreationParameter;

        /// <summary>
        /// The configuration store along with all resource properties. The Configuration Store will have all information to begin
        /// utilizing it.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The configuration store along with all resource properties. The Configuration Store will have all information to begin utilizing it.", ValueFromPipeline = true)]
        ...
        SerializedName = @"configStoreCreationParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IConfigurationStore) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IConfigurationStore ConfigStoreCreationParameter { get => this._configStoreCreationParameter; set => this._configStoreCreationParameter = value; }
        ...
        /// <returns>a duplicate instance of NewAzAppConfigurationStore_CreateViaIdentity1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.NewAzAppConfigurationStore_CreateViaIdentity1 Clone()
        {
            var clone = new NewAzAppConfigurationStore_CreateViaIdentity1();
            ...
            clone.ConfigStoreCreationParameter = this.ConfigStoreCreationParameter;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAppConfigurationStore_CreateViaIdentity1" /> cmdlet class.
        /// </summary>
        public NewAzAppConfigurationStore_CreateViaIdentity1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConfigurationStoresCreate1ViaIdentity(InputObject.Id, ConfigStoreCreationParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConfigurationStoresCreate1(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ConfigStoreName ?? null, ConfigStoreCreationParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ConfigStoreCreationParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20220501Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConfigStoreCreationParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConfigStoreCreationParameter })
                    {
