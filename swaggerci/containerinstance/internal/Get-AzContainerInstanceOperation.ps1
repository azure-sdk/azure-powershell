...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IOperation
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerinstance/get-azcontainerinstanceoperation
#>
function Get-AzContainerInstanceOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IOperation])]
