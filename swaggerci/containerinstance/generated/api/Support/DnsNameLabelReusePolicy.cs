...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support
{
        ...
        System.IEquatable<DnsNameLabelReusePolicy>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.DnsNameLabelReusePolicy DefaultValueIfNotSelectedAndMeansTheObjectSDomainNameLabelIsNotSecuredAgainstSubdomainTakeover = @"Default value if not selected and means the object's domain name label is not secured against subdomain takeover.";

        /// <summary>TenantReuse</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.DnsNameLabelReusePolicy DefaultValueIfSelectedAndMeansTheObjectSDomainNameLabelCanBeReusedWithinTheSameTenant = @"Default value if selected and means the object's domain name label can be reused within the same tenant.";

        /// <summary>ResourceGroupReuse</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.DnsNameLabelReusePolicy ObjectSDomainNameLabelCanBeReusedWithinTheSameResourceGroup = @"Object's domain name label can be reused within the same resource group.";

        /// <summary>SubscriptionReuse</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.DnsNameLabelReusePolicy ObjectSDomainNameLabelCanBeReusedWithinTheSameSubscription = @"Object's domain name label can be reused within the same subscription.";

        /// <summary>NoReuse</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.DnsNameLabelReusePolicy ObjectSDomainNameLabelCannotBeReusedWithinTheSameResourceGroupSubscriptionOrTenant = @"Object's domain name label cannot be reused within the same resource group, subscription, or tenant.";
