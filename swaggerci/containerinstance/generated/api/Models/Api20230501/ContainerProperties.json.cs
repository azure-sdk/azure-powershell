...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501
{
    ...
    public partial class ContainerProperties
    {
        ...
        internal ContainerProperties(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_instanceView = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("instanceView"), out var __jsonInstanceView) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ContainerPropertiesInstanceView.FromJson(__jsonInstanceView) : InstanceView;}
            {_resource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("resources"), out var __jsonResources) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ResourceRequirements.FromJson(__jsonResources) : Resource;}
            {_livenessProbe = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("livenessProbe"), out var __jsonLivenessProbe) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ContainerProbe.FromJson(__jsonLivenessProbe) : LivenessProbe;}
            {_readinessProbe = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("readinessProbe"), out var __jsonReadinessProbe) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ContainerProbe.FromJson(__jsonReadinessProbe) : ReadinessProbe;}
            ...
            {_port = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("ports"), out var __jsonPorts) ? If( __jsonPorts as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IContainerPort[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IContainerPort) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ContainerPort.FromJson(__p) )) ))() : null : Port;}
            {_environmentVariable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("environmentVariables"), out var __jsonEnvironmentVariables) ? If( __jsonEnvironmentVariables as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IEnvironmentVariable[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IEnvironmentVariable) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.EnvironmentVariable.FromJson(__k) )) ))() : null : EnvironmentVariable;}
            {_volumeMount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("volumeMounts"), out var __jsonVolumeMounts) ? If( __jsonVolumeMounts as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IVolumeMount[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IVolumeMount) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.VolumeMount.FromJson(__f) )) ))() : null : VolumeMount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IContainerProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IContainerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IContainerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
