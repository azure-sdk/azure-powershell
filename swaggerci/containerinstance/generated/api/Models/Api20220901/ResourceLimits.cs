...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901
{
    ...
    public partial class ResourceLimits :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IResourceLimits,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IResourceLimitsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResource _gpu;

        /// <summary>The GPU limit of this container instance.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResource Gpu { get => (this._gpu = this._gpu ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.GpuResource()); set => this._gpu = value; }
        ...
        public int? GpuCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResourceInternal)Gpu).Count; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResourceInternal)Gpu).Count = value ?? default(int); }

        /// <summary>The SKU of the GPU resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku? GpuSku { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResourceInternal)Gpu).Sku; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResourceInternal)Gpu).Sku = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku)""); }
...

    {
        ...
        double? Cpu { get; set; }
        /// <summary>The GPU limit of this container instance.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IGpuResource Gpu { get; set; }
        /// <summary>The count of the GPU resource.</summary>
        int? GpuCount { get; set; }
        /// <summary>The SKU of the GPU resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku? GpuSku { get; set; }
