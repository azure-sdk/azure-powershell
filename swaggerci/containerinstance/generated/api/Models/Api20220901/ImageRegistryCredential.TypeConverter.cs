...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901
{
    ...
    public partial class ImageRegistryCredentialTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ImageRegistryCredential" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IImageRegistryCredential ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IImageRegistryCredential).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
