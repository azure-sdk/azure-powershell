...
online version: https://learn.microsoft.com/powershell/module/az.containerinstance/add-azcontainerinstancecontainer
schema: 2.0.0
---
...
### Attach (Default)
```
Add-AzContainerInstanceContainer -GroupName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AttachViaIdentity
```
Add-AzContainerInstanceContainer -InputObject <IContainerInstanceIdentity> [-DefaultProfile <PSObject>]
