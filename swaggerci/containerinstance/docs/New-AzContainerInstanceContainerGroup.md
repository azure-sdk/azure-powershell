...
New-AzContainerInstanceContainerGroup -Name <String> -ResourceGroupName <String> -Container <IContainer[]>
 ...
 [-DnsConfigOption <String>] [-DnsConfigSearchDomain <String>] [-EncryptionPropertyIdentity <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IContainer[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IDeploymentExtensionSpec[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IImageRegistryCredential[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IInitContainerDefinition[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IPort[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IContainerGroupSubnetId[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20220901.IVolume[]
Parameter Sets: (All)
Aliases:
