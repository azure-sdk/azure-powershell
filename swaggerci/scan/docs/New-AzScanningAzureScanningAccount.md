...
online version: https://docs.microsoft.com/en-us/powershell/module/az.scanning/new-azscanningazurescanningaccount
schema: 2.0.0
---

# New-AzScanningAzureScanningAccount
...
```
New-AzScanningAzureScanningAccount -AccountName <String> -ResourceGroupName <String> -AadClientId <String>
