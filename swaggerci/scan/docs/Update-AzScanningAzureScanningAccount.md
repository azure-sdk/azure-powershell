...
online version: https://docs.microsoft.com/en-us/powershell/module/az.scanning/update-azscanningazurescanningaccount
schema: 2.0.0
---

# Update-AzScanningAzureScanningAccount
...
```
Update-AzScanningAzureScanningAccount -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AadClientId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzScanningAzureScanningAccount -InputObject <IScanningIdentity> [-AadClientId <String>]
