...
namespace Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Provisioning = @"Provisioning";

        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Scanning.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
