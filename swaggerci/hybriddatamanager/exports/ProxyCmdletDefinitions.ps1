...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IDataStoreType])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IJobDefinition])]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IJob])]
...
Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.IHybridIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IPublicKey
.Notes
COMPLEX PARAMETER PROPERTIES
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IPublicKey])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
INPUTOBJECT <IHybridIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Subscription Id
.Link
https://docs.microsoft.com/en-us/powershell/module/az.hybrid/invoke-azhybridretryjobdefinitionjob
#>
function Invoke-AzHybridRetryJobDefinitionJob {
...
begin {
    try {
        ...
        $mapping = @{
            Retry = 'Az.Hybrid.private\Invoke-AzHybridRetryJobDefinitionJob_Retry';
            RetryViaIdentity = 'Az.Hybrid.private\Invoke-AzHybridRetryJobDefinitionJob_RetryViaIdentity';
        }
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IResourceTags]))]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.JobDefinitionState])]
    [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.JobDefinitionState]
    # State of the job definition.
    ${JobDefinitionState},
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.ISchedule[]]
...
INPUTOBJECT <IHybridIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Subscription Id
.Link
https://docs.microsoft.com/en-us/powershell/module/az.hybrid/skip-azhybridjobdefinitionjob
#>
function Skip-AzHybridJobDefinitionJob {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Skip = 'Az.Hybrid.private\Skip-AzHybridJobDefinitionJob_Skip';
            SkipViaIdentity = 'Az.Hybrid.private\Skip-AzHybridJobDefinitionJob_SkipViaIdentity';
        }
        if (('Skip') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
INPUTOBJECT <IHybridIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Subscription Id
.Link
https://docs.microsoft.com/en-us/powershell/module/az.hybrid/stop-azhybridjobdefinition
#>
function Stop-AzHybridJobDefinition {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.Hybrid.private\Stop-AzHybridJobDefinition_Cancel';
            CancelViaIdentity = 'Az.Hybrid.private\Stop-AzHybridJobDefinition_CancelViaIdentity';
        }
