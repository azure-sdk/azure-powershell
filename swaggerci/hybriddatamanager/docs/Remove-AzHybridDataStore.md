...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/remove-azhybriddatastore
schema: 2.0.0
---

# Remove-AzHybridDataStore
...
### Delete (Default)
```
Remove-AzHybridDataStore -DataManagerName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridDataStore -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
