...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/invoke-azhybridretryjobdefinitionjob
schema: 2.0.0
---

# Invoke-AzHybridRetryJobDefinitionJob
...
### Retry (Default)
```
Invoke-AzHybridRetryJobDefinitionJob -DataManagerName <String> -DataServiceName <String>
 -JobDefinitionName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-AzHybridRetryJobDefinitionJob -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [-PassThru]
