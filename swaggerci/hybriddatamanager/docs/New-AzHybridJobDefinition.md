...
New-AzHybridJobDefinition -DataManagerName <String> -DataServiceName <String> -Name <String>
 ...
 [-JobDefinitionSchemaVersion <String>] [-JobDefinitionState <JobDefinitionState>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Support.JobDefinitionState
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.ISchedule[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IJobDefinition
