...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/new-azhybriddatamanager
schema: 2.0.0
---

# New-AzHybridDataManager
...
```
New-AzHybridDataManager -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-Etag <String>] [-SkuName <String>] [-SkuTier <String>] [-Tag <Hashtable>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Hybrid.Models.Api20210501.IDataManager
