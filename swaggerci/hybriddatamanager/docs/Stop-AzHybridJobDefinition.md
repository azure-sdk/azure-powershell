...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/stop-azhybridjobdefinition
schema: 2.0.0
---

# Stop-AzHybridJobDefinition
...
### Cancel (Default)
```
Stop-AzHybridJobDefinition -DataManagerName <String> -DataServiceName <String> -Name <String>
...
### CancelViaIdentity
```
Stop-AzHybridJobDefinition -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
