...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybrid/skip-azhybridjobdefinitionjob
schema: 2.0.0
---

# Skip-AzHybridJobDefinitionJob
...
### Skip (Default)
```
Skip-AzHybridJobDefinitionJob -DataManagerName <String> -DataServiceName <String> -JobDefinitionName <String>
...
### SkipViaIdentity
```
Skip-AzHybridJobDefinitionJob -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [-PassThru]
