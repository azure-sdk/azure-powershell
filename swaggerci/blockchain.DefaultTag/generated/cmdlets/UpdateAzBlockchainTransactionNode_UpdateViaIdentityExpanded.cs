...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}", ApiVersion = "2018-06-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IFirewallRule[] FirewallRule { get => _transactionNodeBody.FirewallRule ?? null /* arrayOf */; set => _transactionNodeBody.FirewallRule = value; }
        ...
        public string Password { get => _transactionNodeBody.Password ?? null; set => _transactionNodeBody.Password = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.ITransactionNode">Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.ITransactionNode</see>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.TransactionNodesUpdateViaIdentity(InputObject.Id, _transactionNodeBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.TransactionNodesUpdate(InputObject.BlockchainMemberName ?? null, InputObject.TransactionNodeName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, _transactionNodeBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_transactionNodeBody})
                    {
