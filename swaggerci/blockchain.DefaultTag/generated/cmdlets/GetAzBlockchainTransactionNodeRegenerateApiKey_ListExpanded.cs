...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}/regenerateApiKeys", ApiVersion = "2018-06-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string KeyName { get => _apiKeyBody.KeyName ?? null; set => _apiKeyBody.KeyName = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Value { get => _apiKeyBody.Value ?? null; set => _apiKeyBody.Value = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKeyCollection">Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKeyCollection</see>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TransactionNodesListRegenerateApiKeys(BlockchainMemberName, TransactionNodeName, SubscriptionId, ResourceGroupName, _apiKeyBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BlockchainMemberName=BlockchainMemberName,TransactionNodeName=TransactionNodeName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=_apiKeyBody})
                    {
