...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IBlockchainMemberUpdateTags Tag { get => _blockchainMemberBody.Tag ?? null /* object */; set => _blockchainMemberBody.Tag = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BlockchainMembersUpdateViaIdentity(InputObject.Id, _blockchainMemberBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BlockchainMembersUpdate(InputObject.BlockchainMemberName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, _blockchainMemberBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_blockchainMemberBody})
                    {
