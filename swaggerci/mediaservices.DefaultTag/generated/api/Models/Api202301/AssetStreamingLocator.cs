...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301
{
    ...
    public partial class AssetStreamingLocator :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.AssetName { get => this._assetName; set { {_assetName = value;} } }

        /// <summary>Internal Acessors for Created</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.Created { get => this._created; set { {_created = value;} } }

        /// <summary>Internal Acessors for DefaultContentKeyPolicyName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.DefaultContentKeyPolicyName { get => this._defaultContentKeyPolicyName; set { {_defaultContentKeyPolicyName = value;} } }

        /// <summary>Internal Acessors for EndTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.EndTime { get => this._endTime; set { {_endTime = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for StreamingLocatorId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.StreamingLocatorId { get => this._streamingLocatorId; set { {_streamingLocatorId = value;} } }

        /// <summary>Internal Acessors for StreamingPolicyName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetStreamingLocatorInternal.StreamingPolicyName { get => this._streamingPolicyName; set { {_streamingPolicyName = value;} } }
