...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301
{
    ...
    public partial class StreamingPolicyContentKeys
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyContentKeys.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyContentKeys.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyContentKeys FromJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject json ? new StreamingPolicyContentKeys(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject into a new instance of <see cref="StreamingPolicyContentKeys" />.
        /// </summary>
        ...
        internal StreamingPolicyContentKeys(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject json)
        {
            ...
            {_defaultKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("defaultKey"), out var __jsonDefaultKey) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.DefaultKey.FromJson(__jsonDefaultKey) : DefaultKey;}
            {_keyToTrackMapping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonArray>("keyToTrackMappings"), out var __jsonKeyToTrackMappings) ? If( __jsonKeyToTrackMappings as Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyContentKey[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyContentKey) (Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.StreamingPolicyContentKey.FromJson(__u) )) ))() : null : KeyToTrackMapping;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="StreamingPolicyContentKeys" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="StreamingPolicyContentKeys" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._defaultKey ? (Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode) this._defaultKey.ToJson(null,serializationMode) : null, "defaultKey" ,container.Add );
            if (null != this._keyToTrackMapping)
            {
                var __w = new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.XNodeArray();
                foreach( var __x in this._keyToTrackMapping )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("keyToTrackMappings",__w);
            }
