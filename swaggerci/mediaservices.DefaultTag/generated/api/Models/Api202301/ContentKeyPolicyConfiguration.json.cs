...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301
{
    ...
    public partial class ContentKeyPolicyConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject into a new instance of <see cref="ContentKeyPolicyConfiguration" />.
        /// </summary>
        ...
        internal ContentKeyPolicyConfiguration(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IContentKeyPolicyConfiguration.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IContentKeyPolicyConfiguration interface is
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IContentKeyPolicyConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IContentKeyPolicyConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("@odata.type") )
            {
                ...
                {
                    return new ContentKeyPolicyClearKeyConfiguration(json);
                }
                case "#Microsoft.Media.ContentKeyPolicyUnknownConfiguration":
                {
                    return new ContentKeyPolicyUnknownConfiguration(json);
                }
                case "#Microsoft.Media.ContentKeyPolicyWidevineConfiguration":
                {
                    return new ContentKeyPolicyWidevineConfiguration(json);
                }
                case "#Microsoft.Media.ContentKeyPolicyPlayReadyConfiguration":
                {
                    return new ContentKeyPolicyPlayReadyConfiguration(json);
                }
                case "#Microsoft.Media.ContentKeyPolicyFairPlayConfiguration":
                {
                    return new ContentKeyPolicyFairPlayConfiguration(json);
                }
            }
            return new ContentKeyPolicyConfiguration(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ContentKeyPolicyConfiguration" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ContentKeyPolicyConfiguration" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode" />.
        /// </returns>
