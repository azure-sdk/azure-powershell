...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301
{
    ...
    public partial class StreamingPolicyFairPlayConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyFairPlayConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyFairPlayConfigurationInternal
    {

        /// <summary>Backing field for <see cref="AllowPersistentLicense" /> property.</summary>
        private bool _allowPersistentLicense;

        /// <summary>All license to be persistent or not</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        public bool AllowPersistentLicense { get => this._allowPersistentLicense; set => this._allowPersistentLicense = value; }
        ...
        /// <summary>Creates an new <see cref="StreamingPolicyFairPlayConfiguration" /> instance.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IJsonSerializable
    {
        ...
        bool AllowPersistentLicense { get; set; }
        /// <summary>
        /// Template for the URL of the custom service delivering licenses to end user players. Not required when using Azure Media
        /// Services for issuing licenses. The template supports replaceable tokens that the service will update at runtime with the
        /// value specific to the request. The currently supported token values are {AlternativeMediaId}, which is replaced with the
    ...
    /// Class to specify configurations of FairPlay in Streaming Policy
    internal partial interface IStreamingPolicyFairPlayConfigurationInternal
