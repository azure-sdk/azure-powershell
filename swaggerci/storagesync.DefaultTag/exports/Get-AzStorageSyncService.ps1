...
.Link
https://learn.microsoft.com/powershell/module/az.storagesync/get-azstoragesyncservice
#>
function Get-AzStorageSyncService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IStorageSyncService])]
