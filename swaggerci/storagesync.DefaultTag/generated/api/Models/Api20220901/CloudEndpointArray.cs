...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901
{
    ...
    public partial class CloudEndpointArray :
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointArray,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointArrayInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable
    {

        /// <summary>Backing field for <see cref="Value" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpoint[] _value;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpoint[] Value { get => this._value; set => this._value = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointArrayInternal)this).XmsRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSRequestIdHeader0) is string __headerXMSRequestIdHeader0 ? __headerXMSRequestIdHeader0 : (string)null;
            }
            if (headers.TryGetValues("x-ms-correlation-request-id", out var __xMSCorrelationRequestIdHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointArrayInternal)this).XmsCorrelationRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSCorrelationRequestIdHeader1) is string __headerXMSCorrelationRequestIdHeader1 ? __headerXMSCorrelationRequestIdHeader1 : (string)null;
            }
        }
    }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpoint) })]
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpoint[] Value { get; set; }
