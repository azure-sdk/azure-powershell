...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901
{
    ...
    public partial class CloudEndpointAfsShareMetadataCertificatePublicKeys :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointAfsShareMetadataCertificatePublicKeysInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointAfsShareMetadataCertificatePublicKeysInternal.FirstKey { get => this._firstKey; set { {_firstKey = value;} } }

        /// <summary>Internal Acessors for SecondKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointAfsShareMetadataCertificatePublicKeysInternal.SecondKey { get => this._secondKey; set { {_secondKey = value;} } }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointAfsShareMetadataCertificatePublicKeysInternal)this).XmsRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSRequestIdHeader0) is string __headerXMSRequestIdHeader0 ? __headerXMSRequestIdHeader0 : (string)null;
            }
            if (headers.TryGetValues("x-ms-correlation-request-id", out var __xMSCorrelationRequestIdHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointAfsShareMetadataCertificatePublicKeysInternal)this).XmsCorrelationRequestId = System.Linq.Enumerable.FirstOrDefault(__xMSCorrelationRequestIdHeader1) is string __headerXMSCorrelationRequestIdHeader1 ? __headerXMSCorrelationRequestIdHeader1 : (string)null;
            }
        }
    }
