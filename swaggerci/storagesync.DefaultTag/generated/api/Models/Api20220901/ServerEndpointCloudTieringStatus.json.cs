...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901
{
    ...
    public partial class ServerEndpointCloudTieringStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointCloudTieringStatus.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointCloudTieringStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointCloudTieringStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode node)
        {
        ...
        internal ServerEndpointCloudTieringStatus(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject json)
        {
            ...
            {_spaceSaving = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("spaceSavings"), out var __jsonSpaceSavings) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.CloudTieringSpaceSavings.FromJson(__jsonSpaceSavings) : SpaceSaving;}
            {_cachePerformance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("cachePerformance"), out var __jsonCachePerformance) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.CloudTieringCachePerformance.FromJson(__jsonCachePerformance) : CachePerformance;}
            {_filesNotTiering = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("filesNotTiering"), out var __jsonFilesNotTiering) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.CloudTieringFilesNotTiering.FromJson(__jsonFilesNotTiering) : FilesNotTiering;}
            {_volumeFreeSpacePolicyStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("volumeFreeSpacePolicyStatus"), out var __jsonVolumeFreeSpacePolicyStatus) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.CloudTieringVolumeFreeSpacePolicyStatus.FromJson(__jsonVolumeFreeSpacePolicyStatus) : VolumeFreeSpacePolicyStatus;}
            {_datePolicyStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("datePolicyStatus"), out var __jsonDatePolicyStatus) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.CloudTieringDatePolicyStatus.FromJson(__jsonDatePolicyStatus) : DatePolicyStatus;}
            {_lowDiskMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("lowDiskMode"), out var __jsonLowDiskMode) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.CloudTieringLowDiskMode.FromJson(__jsonLowDiskMode) : LowDiskMode;}
