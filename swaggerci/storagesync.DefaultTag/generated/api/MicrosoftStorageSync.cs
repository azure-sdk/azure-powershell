...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync
{
    ...
    public partial class MicrosoftStorageSync
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,null /* deserializeFromResponse doesn't support '-header-' /home/cloudtest/.autorest/@autorest_powershell@3.0.522/node_modules/@autorest/powershell/dist/llcsharp/schema/object.js*/);
                            break;
                        }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api50.PrivateEndpointConnection.FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                        default:
                        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        public async global::System.Threading.Tasks.Task PrivateEndpointConnectionsListByStorageSyncService(string subscriptionId, string resourceGroupName, string storageSyncServiceName, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api50.IPrivateEndpointConnectionListResult>, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IStorageSyncError>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.ISendAsync sender)
        {
            var apiVersion = @"2022-09-01";
            // Constant Parameters
            using( NoSynchronizationContext )
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api50.PrivateEndpointConnectionListResult.FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode.Parse(body.Result)) .ReadHeaders(_response.Headers)));
                            break;
                        }
                        default:
                        {
        ...
        public async global::System.Threading.Tasks.Task PrivateLinkResourcesListByStorageSyncService(string resourceGroupName, string storageSyncServiceName, string subscriptionId, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api50.IPrivateLinkResourceListResult>, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IStorageSyncError>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.ISendAsync sender)
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.HeaderParametersAdded); if( eventListener.Token.IsCancellationRequested ) { return; }
                // make the call
                await this.PrivateLinkResourcesListByStorageSyncService_Call(request,onOk,onDefault,eventListener,sender);
            }
        }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api50.PrivateLinkResourceListResult.FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                        default:
                        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onDefault(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api50.ErrorResponse.FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                    }
                }
        ...
        public async global::System.Threading.Tasks.Task StorageSyncServicesCheckNameAvailability(string locationName, string subscriptionId, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICheckNameAvailabilityParameters body, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICheckNameAvailabilityResult>, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IStorageSyncError>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.ISendAsync sender)
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Events.BodyContentSet); if( eventListener.Token.IsCancellationRequested ) { return; }
                // make the call
                await this.StorageSyncServicesCheckNameAvailability_Call(request,onOk,onDefault,eventListener,sender);
            }
        }
