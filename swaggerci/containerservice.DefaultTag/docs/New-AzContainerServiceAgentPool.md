...
New-AzContainerServiceAgentPool -Name <String> -ResourceGroupName <String> -ResourceName <String>
 ...
 [-GpuProfileDriver <GpuDriver>] [-GpuProfileDriverType <DriverType>] [-HostGroupId <String>]
 [-KubeDnsOverrideCacheDurationInSecond <Int32>]
 [-KubeDnsOverrideForwardDestination <LocalDnsForwardDestination>]
 [-KubeDnsOverrideForwardPolicy <LocalDnsForwardPolicy>] [-KubeDnsOverrideMaxConcurrent <Int32>]
 [-KubeDnsOverrideProtocol <LocalDnsProtocol>] [-KubeDnsOverrideQueryLogging <LocalDnsQueryLogging>]
 [-KubeDnsOverrideServeStale <LocalDnsServeStale>] [-KubeDnsOverrideServeStaleDurationInSecond <Int32>]
 ...
 [-LinuxOSConfigTransparentHugePageEnabled <String>] [-LocalDnsProfileMode <LocalDnsMode>] [-MaxCount <Int32>]
 [-MaxPod <Int32>] [-MessageOfTheDay <String>] [-MinCount <Int32>] [-Mode <AgentPoolMode>]
 ...
 [-PropertiesType <AgentPoolType>] [-ProximityPlacementGroupId <String>] [-ScaleAutoscale <IAny>]
 [-ScaleDownMode <ScaleDownMode>] [-ScaleManual <IManualScaleProfile[]>]
 [-ScaleSetEvictionPolicy <ScaleSetEvictionPolicy>] [-ScaleSetPriority <ScaleSetPriority>]
 [-SecurityProfileEnableSecureBoot] [-SecurityProfileEnableVtpm]
 [-SecurityProfileSshAccess <AgentPoolSshAccess>] [-SpotMaxPrice <Single>] [-Tag <Hashtable>]
 [-UpgradeSettingDrainTimeoutInMinute <Int32>] [-UpgradeSettingMaxBlockedNode <String>]
 [-UpgradeSettingMaxSurge <String>] [-UpgradeSettingMaxUnavailable <String>]
 [-UpgradeSettingNodeSoakDurationInMinute <Int32>]
 [-UpgradeSettingUndrainableNodeBehavior <UndrainableNodeBehavior>]
 [-VirtualMachineNodesStatus <IVirtualMachineNodes[]>] [-VMSize <String>]
 [-VnetDnsOverrideCacheDurationInSecond <Int32>]
 [-VnetDnsOverrideForwardDestination <LocalDnsForwardDestination>]
 [-VnetDnsOverrideForwardPolicy <LocalDnsForwardPolicy>] [-VnetDnsOverrideMaxConcurrent <Int32>]
 [-VnetDnsOverrideProtocol <LocalDnsProtocol>] [-VnetDnsOverrideQueryLogging <LocalDnsQueryLogging>]
 [-VnetDnsOverrideServeStale <LocalDnsServeStale>] [-VnetDnsOverrideServeStaleDurationInSecond <Int32>]
 [-VnetSubnetId <String>] [-WindowProfileDisableOutboundNat] [-WorkloadRuntime <WorkloadRuntime>]
...
When it's not specified, default is Install.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.GpuDriver
Parameter Sets: (All)
Aliases:
...
### -KubeDnsOverrideCacheDurationInSecond
...
### -KubeDnsOverrideForwardDestination
Destination server for DNS queries to be forwarded from localDNS.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination
Parameter Sets: (All)
Aliases:
...
### -KubeDnsOverrideForwardPolicy
Forward policy for selecting upstream DNS server.
See [forward plugin](https://coredns.io/plugins/forward) for more information.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy
Parameter Sets: (All)
Aliases:
...
### -KubeDnsOverrideProtocol
Enforce TCP or prefer UDP protocol for connections from localDNS to upstream DNS server.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol
Parameter Sets: (All)
Aliases:
...
### -KubeDnsOverrideQueryLogging
Log level for DNS queries in localDNS.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging
Parameter Sets: (All)
Aliases:
...
### -KubeDnsOverrideServeStale
Policy for serving stale data.
See [cache plugin](https://coredns.io/plugins/cache) for more information.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale
Parameter Sets: (All)
Aliases:
...
### -KubeDnsOverrideServeStaleDurationInSecond
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.ISysctlConfig
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsMode
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IPortRange[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IIPTag[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.IAny
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IManualScaleProfile[]
Parameter Sets: (All)
Aliases:
...
If not specified, the default is maxSurge.
This must always be greater than or equal to maxSurge.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IVirtualMachineNodes[]
Parameter Sets: (All)
Aliases:
...
### -VnetDnsOverrideCacheDurationInSecond
Cache max TTL in seconds.
See [cache plugin](https://coredns.io/plugins/cache) for more information.
...
### -VnetDnsOverrideForwardDestination
Destination server for DNS queries to be forwarded from localDNS.
...
### -VnetDnsOverrideServeStaleDurationInSecond
Serve stale duration in seconds.
See [cache plugin](https://coredns.io/plugins/cache) for more information.
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IAgentPool
