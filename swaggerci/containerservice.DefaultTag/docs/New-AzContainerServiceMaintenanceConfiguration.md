...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IDateSpan[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ITimeSpan[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ITimeInWeek[]
Parameter Sets: (All)
Aliases:
