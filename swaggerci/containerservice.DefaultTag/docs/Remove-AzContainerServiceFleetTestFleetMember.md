...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleettest/remove-azcontainerservicefleettestfleetmember
schema: 2.0.0
---

# Remove-AzContainerServiceFleetTestFleetMember
...
### Delete (Default)
```
Remove-AzContainerServiceFleetTestFleetMember -FleetName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetTestFleetMember -InputObject <IContainerServiceFleetTestIdentity>
