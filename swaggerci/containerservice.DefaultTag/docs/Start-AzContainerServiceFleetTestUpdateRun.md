...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleettest/start-azcontainerservicefleettestupdaterun
schema: 2.0.0
---

# Start-AzContainerServiceFleetTestUpdateRun
...
### Start (Default)
```
Start-AzContainerServiceFleetTestUpdateRun -FleetName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzContainerServiceFleetTestUpdateRun -InputObject <IContainerServiceFleetTestIdentity>
