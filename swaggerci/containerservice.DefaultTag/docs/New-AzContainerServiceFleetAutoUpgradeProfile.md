...
```
New-AzContainerServiceFleetAutoUpgradeProfile -FleetName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-StartUpdateRun <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GenerateViaIdentity
```
New-AzContainerServiceFleetAutoUpgradeProfile -InputObject <IContainerServiceFleetIdentity>
 [-StartUpdateRun <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded, Generate
Aliases:
