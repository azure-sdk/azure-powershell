...
New-AzContainerServiceFleetAutoUpgradeProfile -FleetName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-Disabled] [-NodeImageSelectionCustomNodeImageVersion <INodeImageVersion[]>]
 [-NodeImageSelectionType <NodeImageSelectionType>] [-UpdateStrategyId <String>] [-DefaultProfile <PSObject>]
