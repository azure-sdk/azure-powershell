...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/invoke-azcontainerservicerebalanceloadbalancer
schema: 2.0.0
---

# Invoke-AzContainerServiceRebalanceLoadBalancer
...
### RebalanceExpanded (Default)
```
Invoke-AzContainerServiceRebalanceLoadBalancer -ResourceGroupName <String> -ResourceName <String>
...
### RebalanceViaIdentity
```
Invoke-AzContainerServiceRebalanceLoadBalancer -InputObject <IContainerServiceIdentity>
 -Parameter <IRebalanceLoadBalancersRequestBody> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RebalanceViaIdentityExpanded
```
Invoke-AzContainerServiceRebalanceLoadBalancer -InputObject <IContainerServiceIdentity>
...
Parameter Sets: RebalanceViaIdentity, RebalanceViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String[]
Parameter Sets: RebalanceExpanded, RebalanceViaIdentityExpanded
Aliases:
...
Parameter Sets: Rebalance, RebalanceViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Rebalance, RebalanceExpanded
Aliases:
