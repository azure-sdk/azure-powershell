...
New-AzContainerServiceManagedCluster -ResourceGroupName <String> -ResourceName <String> -Location <String>
 ...
 [-ContainerInsightSyslogPort <Int32>] [-CostAnalysisEnabled] [-CreationDataSourceResourceId <String>]
 ...
 [-NodeRestrictionEnabled] [-OidcIssuerProfileEnabled] [-OpenTelemetryLogEnabled]
 [-OpenTelemetryLogPort <Int32>] [-OpenTelemetryMetricEnabled] [-OpenTelemetryMetricPort <Int32>]
