...
New-AzContainerServiceManagedCluster -ResourceGroupName <String> -ResourceName <String> -Location <String>
 ...
 [-ApiServerAccessProfileSubnetId <String>] [-AppMonitoringEnabled] [-AppMonitoringOpenTelemetryMetricEnabled]
 ...
 [-ContainerInsightEnabled] [-ContainerInsightLogAnalyticsWorkspaceResourceId <String>] [-CostAnalysisEnabled]
 [-CreationDataSourceResourceId <String>] [-DefenderLogAnalyticsWorkspaceResourceId <String>]
 [-DisableLocalAccount] [-DiskCsiDriverEnabled] [-DiskCsiDriverVersion <String>]
 [-DiskEncryptionSetId <String>] [-DnsPrefix <String>] [-EnableNamespaceResource] [-EnablePodSecurityPolicy]
 ...
 [-KubernetesVersion <String>] [-KubeStateMetricAnnotationsAllowList <String>]
 [-KubeStateMetricLabelsAllowlist <String>] [-LinuxProfileAdminUsername <String>] [-MetricEnabled]
 [-NetworkProfile <IContainerServiceNetworkProfile>] [-NodeProvisioningProfileMode <NodeProvisioningMode>]
 [-NodeResourceGroup <String>] [-NodeResourceGroupProfileRestrictionLevel <RestrictionLevel>]
 [-NodeRestrictionEnabled] [-OidcIssuerProfileEnabled] [-OverrideSettingForceUpgrade]
 ...
 [-WebAppRoutingDnsZoneResourceId <String[]>] [-WebAppRoutingEnabled] [-WindowHostLogEnabled]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IManagedClusterAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
### -AppMonitoringOpenTelemetryMetricEnabled
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IIstioEgressGateway[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IIstioIngressGateway[]
Parameter Sets: (All)
Aliases:
...
### -CostAnalysisEnabled
The Managed Cluster sku.tier must be set to 'Standard' to enable this feature.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IContainerServiceNetworkProfile
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IManagedClusterPodIdentity[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IManagedClusterPodIdentityException[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IPrivateLinkResource[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240102Preview.IManagedCluster
