...
New-AzContainerServiceManagedCluster -ResourceGroupName <String> -ResourceName <String> -Location <String>
 ...
 [-ApiServerAccessProfileEnablePrivateClusterPublicFqdn] [-ApiServerAccessProfileEnableVnetIntegration]
 [-ApiServerAccessProfilePrivateDnsZone <String>] [-ApiServerAccessProfileSubnetId <String>]
 ...
 [-DiskCsiDriverEnabled] [-DiskEncryptionSetId <String>] [-DnsPrefix <String>] [-EnableRbac]
