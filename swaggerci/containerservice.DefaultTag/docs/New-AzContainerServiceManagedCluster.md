...
New-AzContainerServiceManagedCluster -ResourceGroupName <String> -ResourceName <String> -Location <String>
 ...
 [-OidcIssuerProfileEnabled] [-OverrideSettingForceUpgrade] [-OverrideSettingUntil <DateTime>]
 [-PluginCertChainObjectName <String>] [-PluginCertObjectName <String>] [-PluginKeyObjectName <String>]
 [-PluginKeyVaultId <String>] [-PluginRootCertObjectName <String>]
 ...
 [-SecurityMonitoringEnabled] [-ServiceMeshProfileMode <ServiceMeshMode>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IIstioEgressGateway[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IIstioIngressGateway[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IContainerServiceNetworkProfile
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentity[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityException[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IPrivateLinkResource[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedCluster
