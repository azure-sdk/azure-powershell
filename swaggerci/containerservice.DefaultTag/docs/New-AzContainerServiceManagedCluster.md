...
New-AzContainerServiceManagedCluster -ResourceGroupName <String> -ResourceName <String> -Location <String>
 ...
 [-ComponentProxyRedirectionMechanism <ProxyRedirectionMechanism>] [-ContainerInsightDisableCustomMetric]
 [-ContainerInsightDisablePrometheusMetricsScraping] [-ContainerInsightEnabled]
 [-ContainerInsightLogAnalyticsWorkspaceResourceId <String>] [-ContainerInsightSyslogPort <Int64>]
 [-CostAnalysisEnabled] [-CreationDataSourceResourceId <String>]
...
### -ComponentProxyRedirectionMechanism
Mode of traffic redirection.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ProxyRedirectionMechanism
Parameter Sets: (All)
Aliases:
