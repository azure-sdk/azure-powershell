...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleetfortesting/remove-azcontainerservicefleetfortestingupdaterun
schema: 2.0.0
---

# Remove-AzContainerServiceFleetForTestingUpdateRun
...
### Delete (Default)
```
Remove-AzContainerServiceFleetForTestingUpdateRun -FleetName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetForTestingUpdateRun -InputObject <IContainerServiceFleetForTestingIdentity>
