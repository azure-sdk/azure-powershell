...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/invoke-azcontainerservicerotatemanagedclustercertificate
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-AzContainerServiceRotateManagedClusterCertificate -ResourceGroupName <String> -ResourceName <String>
...
### RotateViaIdentity
```
Invoke-AzContainerServiceRotateManagedClusterCertificate -InputObject <IContainerServiceIdentity>
