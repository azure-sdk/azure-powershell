...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleettest/remove-azcontainerservicefleettestupdaterun
schema: 2.0.0
---

# Remove-AzContainerServiceFleetTestUpdateRun
...
### Delete (Default)
```
Remove-AzContainerServiceFleetTestUpdateRun -FleetName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetTestUpdateRun -InputObject <IContainerServiceFleetTestIdentity>
