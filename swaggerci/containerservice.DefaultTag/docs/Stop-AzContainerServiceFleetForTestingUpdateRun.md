...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleetfortesting/stop-azcontainerservicefleetfortestingupdaterun
schema: 2.0.0
---

# Stop-AzContainerServiceFleetForTestingUpdateRun
...
### Stop (Default)
```
Stop-AzContainerServiceFleetForTestingUpdateRun -FleetName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzContainerServiceFleetForTestingUpdateRun -InputObject <IContainerServiceFleetForTestingIdentity>
