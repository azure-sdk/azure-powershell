...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/update-azcontainerservicemanagednamespace
schema: 2.0.0
---

# Update-AzContainerServiceManagedNamespace
...
```
Update-AzContainerServiceManagedNamespace -Name <String> -ResourceGroupName <String> -ResourceName <String>
...
```
Update-AzContainerServiceManagedNamespace -InputObject <IContainerServiceIdentity> [-Tag <Hashtable>]
