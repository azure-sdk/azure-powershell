...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleetfortesting/remove-azcontainerservicefleetfortestingfleetmember
schema: 2.0.0
---

# Remove-AzContainerServiceFleetForTestingFleetMember
...
### Delete (Default)
```
Remove-AzContainerServiceFleetForTestingFleetMember -FleetName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetForTestingFleetMember -InputObject <IContainerServiceFleetForTestingIdentity>
