...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleetfortesting/start-azcontainerservicefleetfortestingupdaterun
schema: 2.0.0
---

# Start-AzContainerServiceFleetForTestingUpdateRun
...
### Start (Default)
```
Start-AzContainerServiceFleetForTestingUpdateRun -FleetName <String> -Name <String>
...
### StartViaIdentity
```
Start-AzContainerServiceFleetForTestingUpdateRun -InputObject <IContainerServiceFleetForTestingIdentity>
