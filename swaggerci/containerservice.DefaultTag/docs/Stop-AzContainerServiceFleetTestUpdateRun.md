...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleettest/stop-azcontainerservicefleettestupdaterun
schema: 2.0.0
---

# Stop-AzContainerServiceFleetTestUpdateRun
...
### Stop (Default)
```
Stop-AzContainerServiceFleetTestUpdateRun -FleetName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzContainerServiceFleetTestUpdateRun -InputObject <IContainerServiceFleetTestIdentity>
