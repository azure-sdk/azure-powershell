...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleettest/new-azcontainerservicefleettestupdaterun
schema: 2.0.0
---

# New-AzContainerServiceFleetTestUpdateRun
...
```
New-AzContainerServiceFleetTestUpdateRun -FleetName <String> -Name <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetTest.Support.NodeImageSelectionType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetTest.Support.ManagedClusterUpgradeType
Parameter Sets: (All)
Aliases:
