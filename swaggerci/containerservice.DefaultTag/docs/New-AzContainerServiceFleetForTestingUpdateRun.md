...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleetfortesting/new-azcontainerservicefleetfortestingupdaterun
schema: 2.0.0
---
...
```
New-AzContainerServiceFleetForTestingUpdateRun -FleetName <String> -Name <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Support.NodeImageSelectionType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Models.Api20240401.IUpdateStage[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Support.ManagedClusterUpgradeType
Parameter Sets: (All)
Aliases:
