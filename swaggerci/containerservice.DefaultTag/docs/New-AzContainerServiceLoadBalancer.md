...
New-AzContainerServiceLoadBalancer -Name <String> -ResourceGroupName <String> -ResourceName <String>
 ...
 [-PrimaryAgentPoolName <String>] [-ServiceLabelSelectorMatchExpression <ILabelSelectorRequirement[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.ILabelSelectorRequirement[]
Parameter Sets: (All)
Aliases:
