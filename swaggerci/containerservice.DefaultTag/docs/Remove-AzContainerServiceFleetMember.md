...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleet/remove-azcontainerservicefleetmember
schema: 2.0.0
---

# Remove-AzContainerServiceFleetMember
...
### Delete (Default)
```
Remove-AzContainerServiceFleetMember -FleetName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetMember -InputObject <IContainerServiceFleetIdentity> [-IfMatch <String>]
