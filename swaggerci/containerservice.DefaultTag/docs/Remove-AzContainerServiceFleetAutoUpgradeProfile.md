...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleet/remove-azcontainerservicefleetautoupgradeprofile
schema: 2.0.0
---

# Remove-AzContainerServiceFleetAutoUpgradeProfile
...
### Delete (Default)
```
Remove-AzContainerServiceFleetAutoUpgradeProfile -FleetName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetAutoUpgradeProfile -InputObject <IContainerServiceFleetIdentity>
