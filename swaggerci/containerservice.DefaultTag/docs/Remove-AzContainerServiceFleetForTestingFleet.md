...
online version: https://learn.microsoft.com/powershell/module/az.containerservicefleetfortesting/remove-azcontainerservicefleetfortestingfleet
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerServiceFleetForTestingFleet -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetForTestingFleet -InputObject <IContainerServiceFleetForTestingIdentity>
