...
online version: https://learn.microsoft.com/powershell/module/az.containerservice/remove-azcontainerserviceprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerServicePrivateEndpointConnection -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerServicePrivateEndpointConnection -InputObject <IContainerServiceIdentity>
