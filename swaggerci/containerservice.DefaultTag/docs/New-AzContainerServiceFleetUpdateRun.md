...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageVersion[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IUpdateStage[]
Parameter Sets: (All)
Aliases:
