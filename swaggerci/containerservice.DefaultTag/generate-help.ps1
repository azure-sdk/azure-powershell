...
$modulePsd1 = Get-Item -Path (Join-Path $PSScriptRoot './Az.ContainerServiceFleet.psd1')
$modulePath = $modulePsd1.FullName
$moduleName = $modulePsd1.BaseName

# Load DLL to use build-time cmdlets
Import-Module -Name $modulePath
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.ContainerServiceFleet.private.dll')
