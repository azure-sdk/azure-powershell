# How-To
This document describes how to develop for `Az.ContainerServiceFleetForTesting`.

## Building `Az.ContainerServiceFleetForTesting`
...
## Testing `Az.ContainerServiceFleetForTesting`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.ContainerServiceFleetForTesting` into the session.
