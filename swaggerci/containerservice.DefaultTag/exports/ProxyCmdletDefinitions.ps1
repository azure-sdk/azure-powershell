...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ProxyRedirectionMechanism])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.ProxyRedirectionMechanism]
