...
Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.ICredentialResult
.Link
https://learn.microsoft.com/powershell/module/az.containerservice/get-azcontainerservicenamespacecredential
#>
function Get-AzContainerServiceNamespaceCredential {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.ICredentialResult])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerService.private\Get-AzContainerServiceNamespaceCredential_List';
        }
        if (('List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IContainerServiceIdentity>: Identity Parameter
  ...
  [Version <String>]: Safeguards version
.Link
https://learn.microsoft.com/powershell/module/az.containerservice/get-azcontainerservicenamespace
#>
function Get-AzContainerServiceNamespace {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerService.private\Get-AzContainerServiceNamespace_Get';
            GetViaIdentity = 'Az.ContainerService.private\Get-AzContainerServiceNamespace_GetViaIdentity';
            List = 'Az.ContainerService.private\Get-AzContainerServiceNamespace_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IContainerServiceIdentity>: Identity Parameter
  ...
  [Version <String>]: Safeguards version
.Link
https://learn.microsoft.com/powershell/module/az.containerservice/remove-azcontainerservicenamespace
#>
function Remove-AzContainerServiceNamespace {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Delete', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Delete', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerService.private\Remove-AzContainerServiceNamespace_Delete';
            DeleteViaIdentity = 'Az.ContainerService.private\Remove-AzContainerServiceNamespace_DeleteViaIdentity';
        }
        if (('Delete') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IContainerServiceIdentity>: Identity Parameter
  ...
  [Version <String>]: Safeguards version
.Link
https://learn.microsoft.com/powershell/module/az.containerservice/update-azcontainerservicenamespace
#>
function Update-AzContainerServiceNamespace {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.INamespace])]
[CmdletBinding(DefaultParameterSetName='UpdateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ContainerService.private\Update-AzContainerServiceNamespace_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ContainerService.private\Update-AzContainerServiceNamespace_UpdateViaIdentityExpanded';
        }
        if (('UpdateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
