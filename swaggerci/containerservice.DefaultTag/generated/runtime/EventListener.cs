...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Runtime
{
    ...
    {
        Task Validate(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Runtime.IEventListener listener);
    }
    ...
    internal static partial class Extensions
    {
        ...
        public static async Task AssertNotNull(this IEventListener instance, string parameterName, object value)
        {
            if (value == null)
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' should not be null", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        ...
        {
            await (inst as Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleetForTesting.Runtime.IValidates)?.Validate(instance);
        }
