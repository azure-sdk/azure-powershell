...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support
{
        ...
        System.IEquatable<NodeOSUpgradeChannel>
    {
        ...
        /// be unpatched initially and will be patched at some point by the OS's infrastructure. Behavior of this option depends on
        /// the OS in question. Ubuntu and Mariner apply security patches through unattended upgrade roughly once a day around 06:00
        /// UTC. Windows does not apply security patches automatically and so for them this option is equivalent to None till further
        /// notice
        /// </summary>
