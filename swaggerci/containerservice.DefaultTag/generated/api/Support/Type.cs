...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support
{
        ...
        System.IEquatable<Type>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type First = @"First";

        /// <summary>Fourth week of the month.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type Fourth = @"Fourth";

        /// <summary>Last week of the month.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type Last = @"Last";

        /// <summary>Second week of the month.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type Second = @"Second";

        /// <summary>Third week of the month.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type Third = @"Third";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
