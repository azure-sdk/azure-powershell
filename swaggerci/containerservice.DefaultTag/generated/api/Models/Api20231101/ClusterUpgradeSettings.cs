...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101
{
    ...
    public partial class ClusterUpgradeSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IClusterUpgradeSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IClusterUpgradeSettingsInternal
    {

        /// <summary>Internal Acessors for OverrideSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IUpgradeOverrideSettings Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IClusterUpgradeSettingsInternal.OverrideSetting { get => (this._overrideSetting = this._overrideSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.UpgradeOverrideSettings()); set { {_overrideSetting = value;} } }

        /// <summary>Backing field for <see cref="OverrideSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IUpgradeOverrideSettings _overrideSetting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IUpgradeOverrideSettings OverrideSetting { get => (this._overrideSetting = this._overrideSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.UpgradeOverrideSettings()); set => this._overrideSetting = value; }
    ...
    {
        /// <summary>Settings for overrides.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IUpgradeOverrideSettings OverrideSetting { get; set; }
        /// <summary>
        /// Whether to force upgrade the cluster. Note that this option instructs upgrade operation to bypass upgrade protections
        /// such as checking for deprecated API usage. Enable this option only with caution.
        /// </summary>
