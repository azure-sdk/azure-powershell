...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101
{
    ...
    public partial class ManagedClusterAzureMonitorProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileMetrics _metric;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileMetrics Metric { get => (this._metric = this._metric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.ManagedClusterAzureMonitorProfileMetrics()); set => this._metric = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileMetrics Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileInternal.Metric { get => (this._metric = this._metric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.ManagedClusterAzureMonitorProfileMetrics()); set { {_metric = value;} } }

        /// <summary>Internal Acessors for MetricKubeStateMetric</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileKubeStateMetrics Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileInternal.MetricKubeStateMetric { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetric; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetric = value; }
...

    {
        ...
        /// for an overview.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231101.IManagedClusterAzureMonitorProfileMetrics Metric { get; set; }
        /// <summary>
        /// Whether to enable or disable the Azure Managed Prometheus addon for Prometheus monitoring. See aka.ms/AzureManagedPrometheus-aks-enable
        /// for details on enabling and disabling.
        /// </summary>
