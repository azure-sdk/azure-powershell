...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240401
{
    ...
    public partial class FleetHubProfile
    {
        ...
        internal FleetHubProfile(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_apiServerAccessProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject>("apiServerAccessProfile"), out var __jsonApiServerAccessProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240401.ApiServerAccessProfile.FromJson(__jsonApiServerAccessProfile) : ApiServerAccessProfile;}
            {_agentProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject>("agentProfile"), out var __jsonAgentProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240401.AgentProfile.FromJson(__jsonAgentProfile) : AgentProfile;}
            {_dnsPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("dnsPrefix"), out var __jsonDnsPrefix) ? (string)__jsonDnsPrefix : (string)DnsPrefix;}
            {_fqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("fqdn"), out var __jsonFqdn) ? (string)__jsonFqdn : (string)Fqdn;}
            ...
            {_portalFqdn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("portalFqdn"), out var __jsonPortalFqdn) ? (string)__jsonPortalFqdn : (string)PortalFqdn;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240401.IFleetHubProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240401.IFleetHubProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240401.IFleetHubProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonNode node)
        {
