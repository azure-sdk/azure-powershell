...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901
{
    ...
    public partial class MachineProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachinePropertiesInternal
    {

        /// <summary>Internal Acessors for Network</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineNetworkProperties Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachinePropertiesInternal.Network { get => (this._network = this._network ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.MachineNetworkProperties()); set { {_network = value;} } }

        /// <summary>Internal Acessors for NetworkIPAddress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineIPAddress[] Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachinePropertiesInternal.NetworkIPAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineNetworkPropertiesInternal)Network).IPAddress; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineNetworkPropertiesInternal)Network).IPAddress = value; }

        /// <summary>Internal Acessors for ResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachinePropertiesInternal.ResourceId { get => this._resourceId; set { {_resourceId = value;} } }

        /// <summary>Backing field for <see cref="Network" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineNetworkProperties _network;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineNetworkProperties Network { get => (this._network = this._network ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.MachineNetworkProperties()); }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineIPAddress[] NetworkIPAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IMachineNetworkPropertiesInternal)Network).IPAddress; }
