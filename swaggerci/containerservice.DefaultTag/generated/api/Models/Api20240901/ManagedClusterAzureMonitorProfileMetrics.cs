...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901
{
    ...
    public partial class ManagedClusterAzureMonitorProfileMetrics :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileMetricsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetrics _kubeStateMetric;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetrics KubeStateMetric { get => (this._kubeStateMetric = this._kubeStateMetric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.ManagedClusterAzureMonitorProfileKubeStateMetrics()); set => this._kubeStateMetric = value; }
        ...
        public string KubeStateMetricAnnotationsAllowList { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetricsInternal)KubeStateMetric).MetricAnnotationsAllowList; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetricsInternal)KubeStateMetric).MetricAnnotationsAllowList = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string KubeStateMetricLabelsAllowlist { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetricsInternal)KubeStateMetric).MetricLabelsAllowlist; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetricsInternal)KubeStateMetric).MetricLabelsAllowlist = value ?? null; }

        /// <summary>Internal Acessors for KubeStateMetric</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetrics Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileMetricsInternal.KubeStateMetric { get => (this._kubeStateMetric = this._kubeStateMetric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.ManagedClusterAzureMonitorProfileKubeStateMetrics()); set { {_kubeStateMetric = value;} } }
...

    {
        ...
        /// pod that is deployed with the addon. See aka.ms/AzureManagedPrometheus-optional-parameters for details.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240901.IManagedClusterAzureMonitorProfileKubeStateMetrics KubeStateMetric { get; set; }
        /// <summary>
        /// Comma-separated list of Kubernetes annotation keys that will be used in the resource's labels metric (Example: 'namespaces=[kubernetes.io/team,...],pods=[kubernetes.io/team],...').
        /// By default the metric contains only resource name and namespace labels.
        /// </summary>
