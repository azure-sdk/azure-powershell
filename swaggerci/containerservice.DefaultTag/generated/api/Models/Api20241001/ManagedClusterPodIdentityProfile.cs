...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001
{
    ...
    public partial class ManagedClusterPodIdentityProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentity[] _userAssignedIdentity;

        /// <summary>The pod identities to use in the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentity[] UserAssignedIdentity { get => this._userAssignedIdentity; set => this._userAssignedIdentity = value; }

        /// <summary>Backing field for <see cref="UserAssignedIdentityException" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityException[] _userAssignedIdentityException;

        /// <summary>The pod identity exceptions to allow.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityException[] UserAssignedIdentityException { get => this._userAssignedIdentityException; set => this._userAssignedIdentityException = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentity) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentity[] UserAssignedIdentity { get; set; }
        /// <summary>The pod identity exceptions to allow.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityException) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20241001.IManagedClusterPodIdentityException[] UserAssignedIdentityException { get; set; }
