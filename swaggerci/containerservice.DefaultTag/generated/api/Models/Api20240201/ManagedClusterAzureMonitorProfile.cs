...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201
{
    ...
    public partial class ManagedClusterAzureMonitorProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileInternal
    {
        ...
        public string KubeStateMetricAnnotationsAllowList { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetricAnnotationsAllowList; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetricAnnotationsAllowList = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string KubeStateMetricLabelsAllowlist { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetricLabelsAllowlist; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetricLabelsAllowlist = value ?? null; }

        /// <summary>Backing field for <see cref="Metric" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetrics _metric;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetrics Metric { get => (this._metric = this._metric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.ManagedClusterAzureMonitorProfileMetrics()); set => this._metric = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? MetricEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).Enabled = value ?? default(bool); }

        /// <summary>Internal Acessors for Metric</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetrics Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileInternal.Metric { get => (this._metric = this._metric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.ManagedClusterAzureMonitorProfileMetrics()); set { {_metric = value;} } }

        /// <summary>Internal Acessors for MetricKubeStateMetric</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileKubeStateMetrics Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileInternal.MetricKubeStateMetric { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetric; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetricsInternal)Metric).KubeStateMetric = value; }
...

    {
        ...
        /// for an overview.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileMetrics Metric { get; set; }
        /// <summary>
        /// Whether to enable or disable the Azure Managed Prometheus addon for Prometheus monitoring. See aka.ms/AzureManagedPrometheus-aks-enable
        /// for details on enabling and disabling.
        /// </summary>
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240201.IManagedClusterAzureMonitorProfileKubeStateMetrics MetricKubeStateMetric { get; set; }
