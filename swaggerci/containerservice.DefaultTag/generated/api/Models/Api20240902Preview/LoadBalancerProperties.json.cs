...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview
{
    ...
    public partial class LoadBalancerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.ILoadBalancerProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.ILoadBalancerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.ILoadBalancerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Json.JsonNode node)
        {
        ...
        internal LoadBalancerProperties(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Json.JsonObject json)
        {
            ...
            {_serviceLabelSelector = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Json.JsonObject>("serviceLabelSelector"), out var __jsonServiceLabelSelector) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.LabelSelector.FromJson(__jsonServiceLabelSelector) : ServiceLabelSelector;}
            {_serviceNamespaceSelector = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Json.JsonObject>("serviceNamespaceSelector"), out var __jsonServiceNamespaceSelector) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.LabelSelector.FromJson(__jsonServiceNamespaceSelector) : ServiceNamespaceSelector;}
            {_nodeSelector = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Json.JsonObject>("nodeSelector"), out var __jsonNodeSelector) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.LabelSelector.FromJson(__jsonNodeSelector) : NodeSelector;}
