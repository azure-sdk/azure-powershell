...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview
{
    ...
    public partial class ManagedClusterPodIdentityException :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.IManagedClusterPodIdentityExceptionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.IManagedClusterPodIdentityExceptionPodLabels _podLabel;

        /// <summary>The pod labels to match.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.IManagedClusterPodIdentityExceptionPodLabels PodLabel { get => (this._podLabel = this._podLabel ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.ManagedClusterPodIdentityExceptionPodLabels()); set => this._podLabel = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.IManagedClusterPodIdentityExceptionPodLabels) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240902Preview.IManagedClusterPodIdentityExceptionPodLabels PodLabel { get; set; }
