...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701
{
    ...
    public partial class TrustedAccessRoleBinding :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingProperties Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.TrustedAccessRoleBindingProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.TrustedAccessRoleBindingProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).ProvisioningState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.TrustedAccessRoleBindingProperties()); set => this._property = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.TrustedAccessRoleBindingProvisioningState? ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).ProvisioningState; }

        /// <summary>
        /// A list of roles to bind, each item is a resource type qualified role name. For example: 'Microsoft.MachineLearningServices/workspaces/reader'.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string[] Role { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).Role; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).Role = value ; }

        /// <summary>The ARM resource ID of source resource that trusted access is configured for.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string SourceResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).SourceResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingPropertiesInternal)Property).SourceResourceId = value ; }
    ...
    {
        /// <summary>Properties for trusted access role binding</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ITrustedAccessRoleBindingProperties Property { get; set; }
        /// <summary>The current provisioning state of trusted access role binding.</summary>
