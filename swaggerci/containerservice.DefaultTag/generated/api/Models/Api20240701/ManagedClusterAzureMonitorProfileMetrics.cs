...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.IManagedClusterAzureMonitorProfileMetricsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.IManagedClusterAzureMonitorProfileKubeStateMetrics _kubeStateMetric;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.IManagedClusterAzureMonitorProfileKubeStateMetrics KubeStateMetric { get => (this._kubeStateMetric = this._kubeStateMetric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ManagedClusterAzureMonitorProfileKubeStateMetrics()); set => this._kubeStateMetric = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.IManagedClusterAzureMonitorProfileKubeStateMetrics Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.IManagedClusterAzureMonitorProfileMetricsInternal.KubeStateMetric { get => (this._kubeStateMetric = this._kubeStateMetric ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.ManagedClusterAzureMonitorProfileKubeStateMetrics()); set { {_kubeStateMetric = value;} } }
...

    {
        ...
        /// pod that is deployed with the addon. See aka.ms/AzureManagedPrometheus-optional-parameters for details.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240701.IManagedClusterAzureMonitorProfileKubeStateMetrics KubeStateMetric { get; set; }
        /// <summary>
        /// Comma-separated list of Kubernetes annotation keys that will be used in the resource's labels metric (Example: 'namespaces=[kubernetes.io/team,...],pods=[kubernetes.io/team],...').
        /// By default the metric contains only resource name and namespace labels.
        /// </summary>
