...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview
{
    ...
    public partial class AutoUpgradeProfileProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeProfileProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeProfilePropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeNodeImageSelection Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeProfilePropertiesInternal.NodeImageSelection { get => (this._nodeImageSelection = this._nodeImageSelection ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.AutoUpgradeNodeImageSelection()); set { {_nodeImageSelection = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Support.AutoUpgradeProfileProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeProfilePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="NodeImageSelection" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeNodeImageSelection _nodeImageSelection;

        /// <summary>The node image upgrade to be applied to the target clusters in auto upgrade.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeNodeImageSelection NodeImageSelection { get => (this._nodeImageSelection = this._nodeImageSelection ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.AutoUpgradeNodeImageSelection()); set => this._nodeImageSelection = value; }
...

    {
        ...
        bool? Disabled { get; set; }
        /// <summary>The node image upgrade to be applied to the target clusters in auto upgrade.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250401Preview.IAutoUpgradeNodeImageSelection NodeImageSelection { get; set; }
        /// <summary>The node image upgrade type.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Support.AutoUpgradeNodeImageSelectionType? NodeImageSelectionType { get; set; }
        /// <summary>The provisioning state of the AutoUpgradeProfile resource.</summary>
