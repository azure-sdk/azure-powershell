...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview
{
    ...
    public partial class ComponentsByRelease :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IComponentsByRelease,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IComponentsByReleaseInternal
    {

        /// <summary>Backing field for <see cref="Component" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IComponent[] _component;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IComponent[] Component { get => this._component; set => this._component = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IComponent) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IComponent[] Component { get; set; }
        /// <summary>The Kubernetes version (major.minor).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
