...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview
{
    ...
    public partial class ContainerServiceLinuxProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceLinuxProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceLinuxProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceSshConfiguration Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceLinuxProfileInternal.Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ContainerServiceSshConfiguration()); set { {_ssh = value;} } }

        /// <summary>Backing field for <see cref="Ssh" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceSshConfiguration _ssh;

        /// <summary>The SSH configuration for Linux-based VMs running on Azure.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceSshConfiguration Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ContainerServiceSshConfiguration()); set => this._ssh = value; }
...

    {
        ...
        string AdminUsername { get; set; }
        /// <summary>The SSH configuration for Linux-based VMs running on Azure.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceSshConfiguration Ssh { get; set; }
        /// <summary>
        /// The list of SSH public keys used to authenticate with Linux-based VMs. A maximum of 1 key may be specified.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IContainerServiceSshPublicKey[] SshPublicKey { get; set; }
