...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview
{
    ...
    public partial class ManagedClusterMetricsProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterMetricsProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterMetricsProfileInternal
    {

        /// <summary>Backing field for <see cref="CostAnalysis" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterCostAnalysis _costAnalysis;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterCostAnalysis CostAnalysis { get => (this._costAnalysis = this._costAnalysis ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ManagedClusterCostAnalysis()); set => this._costAnalysis = value; }
    ...
    {
        /// <summary>The cost analysis configuration for the cluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterCostAnalysis CostAnalysis { get; set; }
        /// <summary>
        /// The Managed Cluster sku.tier must be set to 'Standard' or 'Premium' to enable this feature. Enabling this will add Kubernetes
        /// Namespace and Deployment details to the Cost Analysis views in the Azure portal. If not specified, the default is false.
        /// For more information see aka.ms/aks/docs/cost-analysis.
