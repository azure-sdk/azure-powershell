...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview
{
    ...
    public partial class ManagedClusterNatGatewayProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterNatGatewayProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterNatGatewayProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterManagedOutboundIPProfile _managedOutboundIPProfile;

        /// <summary>Profile of the managed outbound IP resources of the cluster NAT gateway.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterManagedOutboundIPProfile ManagedOutboundIPProfile { get => (this._managedOutboundIPProfile = this._managedOutboundIPProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ManagedClusterManagedOutboundIPProfile()); set => this._managedOutboundIPProfile = value; }
...

    {
        ...
        int? IdleTimeoutInMinute { get; set; }
        /// <summary>Profile of the managed outbound IP resources of the cluster NAT gateway.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IManagedClusterManagedOutboundIPProfile ManagedOutboundIPProfile { get; set; }
        /// <summary>
        /// The desired number of outbound IPs created/managed by Azure. Allowed values must be in the range of 1 to 16 (inclusive).
        /// The default value is 1.
        /// </summary>
