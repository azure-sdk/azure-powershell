...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview
{
    ...
    public partial class LabelSelector :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ILabelSelector,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ILabelSelectorInternal
    {

        /// <summary>Backing field for <see cref="MatchExpression" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ILabelSelectorRequirement[] _matchExpression;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ILabelSelectorRequirement[] MatchExpression { get => this._matchExpression; set => this._matchExpression = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.ILabelSelectorRequirement[] MatchExpression { get; set; }
        /// <summary>
        /// matchLabels is an array of {key=value} pairs. A single {key=value} in the matchLabels map is equivalent to an element
        /// of matchExpressions, whose key field is `key`, the operator is `In`, and the values array contains only `value`. The requirements
        /// are ANDed.
