...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview
{
    ...
    public partial class KubernetesVersion :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionInternal
    {

        /// <summary>Backing field for <see cref="Capability" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionCapabilities _capability;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionCapabilities Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionInternal.Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.KubernetesVersionCapabilities()); set { {_capability = value;} } }

        /// <summary>Backing field for <see cref="PatchVersion" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionPatchVersions _patchVersion;

        /// <summary>Patch versions of Kubernetes release</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionPatchVersions PatchVersion { get => (this._patchVersion = this._patchVersion ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.KubernetesVersionPatchVersions()); set => this._patchVersion = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionPatchVersions) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionPatchVersions PatchVersion { get; set; }
        /// <summary>major.minor version of Kubernetes release</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>Capabilities on this Kubernetes version.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240702Preview.IKubernetesVersionCapabilities Capability { get; set; }
