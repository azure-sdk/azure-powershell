...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview
{
    ...
    public partial class OperationValueDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IOperationValueDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IOperationValueDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IOperationValueDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IOperationValueDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IOperationValueDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IOperationValueDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
