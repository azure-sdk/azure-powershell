...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview
{
    ...
    public partial class ManagedClusterIngressProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileWebAppRouting Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileInternal.WebAppRouting { get => (this._webAppRouting = this._webAppRouting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.ManagedClusterIngressProfileWebAppRouting()); set { {_webAppRouting = value;} } }

        /// <summary>Internal Acessors for WebAppRoutingIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IUserAssignedIdentity Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileInternal.WebAppRoutingIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileWebAppRoutingInternal)WebAppRouting).Identity; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileWebAppRoutingInternal)WebAppRouting).Identity = value; }

        /// <summary>Backing field for <see cref="WebAppRouting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileWebAppRouting _webAppRouting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get => (this._webAppRouting = this._webAppRouting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.ManagedClusterIngressProfileWebAppRouting()); set => this._webAppRouting = value; }
...

    {
        ...
        string IdentityResourceId { get; set; }
        /// <summary>Web App Routing settings for the ingress profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240302Preview.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get; set; }
        /// <summary>
        /// Resource IDs of the DNS zones to be associated with the Web App Routing add-on. Used only when Web App Routing is enabled.
        /// Public and private DNS zones can be in different resource groups, but all public DNS zones must be in the same resource
        /// group and all private DNS zones must be in the same resource group.
