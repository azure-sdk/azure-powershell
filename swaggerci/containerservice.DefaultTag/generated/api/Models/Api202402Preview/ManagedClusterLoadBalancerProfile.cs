...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview
{
    ...
    public partial class ManagedClusterLoadBalancerProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IResourceReference[] _effectiveOutboundIP;

        /// <summary>The effective outbound IP resources of the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IResourceReference[] EffectiveOutboundIP { get => this._effectiveOutboundIP; set => this._effectiveOutboundIP = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileManagedOutboundIPs _managedOutboundIP;

        /// <summary>Desired managed outbound IPs for the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileManagedOutboundIPs ManagedOutboundIP { get => (this._managedOutboundIP = this._managedOutboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ManagedClusterLoadBalancerProfileManagedOutboundIPs()); set => this._managedOutboundIP = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileOutboundIPPrefixes _outboundIPPrefix;

        /// <summary>Desired outbound IP Prefix resources for the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileOutboundIPPrefixes OutboundIPPrefix { get => (this._outboundIPPrefix = this._outboundIPPrefix ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ManagedClusterLoadBalancerProfileOutboundIPPrefixes()); set => this._outboundIPPrefix = value; }

        /// <summary>A list of public IP prefix resources.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IResourceReference[] OutboundIPPrefixPublicIpprefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileOutboundIPPrefixesInternal)OutboundIPPrefix).PublicIPPrefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileOutboundIPPrefixesInternal)OutboundIPPrefix).PublicIPPrefix = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IResourceReference[] EffectiveOutboundIP { get; set; }
        /// <summary>Enable multiple standard load balancers per AKS cluster or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        int? IdleTimeoutInMinute { get; set; }
        /// <summary>Desired managed outbound IPs for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileManagedOutboundIPs ManagedOutboundIP { get; set; }
        /// <summary>
        /// The desired number of IPv4 outbound IPs created/managed by Azure for the cluster load balancer. Allowed values must be
        /// in the range of 1 to 100 (inclusive). The default value is 1.
        /// </summary>
        ...
        int? ManagedOutboundIPCountIpv6 { get; set; }
        /// <summary>Desired outbound IP resources for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileOutboundIPs OutboundIP { get; set; }
        /// <summary>Desired outbound IP Prefix resources for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterLoadBalancerProfileOutboundIPPrefixes OutboundIPPrefix { get; set; }
        /// <summary>A list of public IP prefix resources.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IResourceReference[] OutboundIPPrefixPublicIpprefix { get; set; }
        /// <summary>A list of public IP resources.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IResourceReference[] OutboundIPPublicIP { get; set; }
