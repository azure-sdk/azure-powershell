...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview
{
    ...
    public partial class CommandResultProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal.ExitCode { get => this._exitCode; set { {_exitCode = value;} } }

        /// <summary>Internal Acessors for FinishedAt</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal.FinishedAt { get => this._finishedAt; set { {_finishedAt = value;} } }

        /// <summary>Internal Acessors for Log</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal.Log { get => this._log; set { {_log = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Reason</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal.Reason { get => this._reason; set { {_reason = value;} } }

        /// <summary>Internal Acessors for StartedAt</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ICommandResultPropertiesInternal.StartedAt { get => this._startedAt; set { {_startedAt = value;} } }
