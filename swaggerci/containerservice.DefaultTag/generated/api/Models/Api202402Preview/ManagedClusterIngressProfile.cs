...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview
{
    ...
    public partial class ManagedClusterIngressProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterIngressProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterIngressProfileInternal
    {
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get => (this._webAppRouting = this._webAppRouting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.ManagedClusterIngressProfileWebAppRouting()); set => this._webAppRouting = value; }
...

    {
        ...
        string IdentityResourceId { get; set; }
        /// <summary>Web App Routing settings for the ingress profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202402Preview.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get; set; }
        /// <summary>
        /// Resource IDs of the DNS zones to be associated with the Web App Routing add-on. Used only when Web App Routing is enabled.
        /// Public and private DNS zones can be in different resource groups, but all public DNS zones must be in the same resource
        /// group and all private DNS zones must be in the same resource group.
