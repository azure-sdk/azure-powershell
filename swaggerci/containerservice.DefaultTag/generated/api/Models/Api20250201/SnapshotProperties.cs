...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201
{
    ...
    public partial class SnapshotProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ICreationData Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.CreationData { get => (this._creationData = this._creationData ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.CreationData()); set { {_creationData = value;} } }

        /// <summary>Internal Acessors for EnableFips</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.EnableFips { get => this._enableFips; set { {_enableFips = value;} } }

        /// <summary>Internal Acessors for KubernetesVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.KubernetesVersion { get => this._kubernetesVersion; set { {_kubernetesVersion = value;} } }

        /// <summary>Internal Acessors for NodeImageVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.NodeImageVersion { get => this._nodeImageVersion; set { {_nodeImageVersion = value;} } }

        /// <summary>Internal Acessors for OSSku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Ossku? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.OSSku { get => this._oSSku; set { {_oSSku = value;} } }

        /// <summary>Internal Acessors for OSType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.OSType? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.OSType { get => this._oSType; set { {_oSType = value;} } }

        /// <summary>Internal Acessors for VMSize</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250201.ISnapshotPropertiesInternal.VMSize { get => this._vMSize; set { {_vMSize = value;} } }
