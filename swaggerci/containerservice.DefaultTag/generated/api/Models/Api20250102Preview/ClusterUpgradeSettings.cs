...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview
{
    ...
    public partial class ClusterUpgradeSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IClusterUpgradeSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IClusterUpgradeSettingsInternal
    {

        /// <summary>Internal Acessors for OverrideSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettings Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IClusterUpgradeSettingsInternal.OverrideSetting { get => (this._overrideSetting = this._overrideSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.UpgradeOverrideSettings()); set { {_overrideSetting = value;} } }

        /// <summary>Backing field for <see cref="OverrideSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettings _overrideSetting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettings OverrideSetting { get => (this._overrideSetting = this._overrideSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.UpgradeOverrideSettings()); set => this._overrideSetting = value; }
        ...
        public bool? OverrideSettingForceUpgrade { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettingsInternal)OverrideSetting).ForceUpgrade; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettingsInternal)OverrideSetting).ForceUpgrade = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public global::System.DateTime? OverrideSettingUntil { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettingsInternal)OverrideSetting).Until; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettingsInternal)OverrideSetting).Until = value ?? default(global::System.DateTime); }
    ...
    {
        /// <summary>Settings for overrides.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IUpgradeOverrideSettings OverrideSetting { get; set; }
        /// <summary>
        /// Whether to force upgrade the cluster. Note that this option instructs upgrade operation to bypass upgrade protections
        /// such as checking for deprecated API usage. Enable this option only with caution.
        /// </summary>
