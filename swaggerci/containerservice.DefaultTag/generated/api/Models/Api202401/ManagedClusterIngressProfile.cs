...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401
{
    ...
    public partial class ManagedClusterIngressProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileWebAppRouting Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileInternal.WebAppRouting { get => (this._webAppRouting = this._webAppRouting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterIngressProfileWebAppRouting()); set { {_webAppRouting = value;} } }

        /// <summary>Internal Acessors for WebAppRoutingIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IUserAssignedIdentity Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileInternal.WebAppRoutingIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileWebAppRoutingInternal)WebAppRouting).Identity; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileWebAppRoutingInternal)WebAppRouting).Identity = value; }

        /// <summary>Backing field for <see cref="WebAppRouting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileWebAppRouting _webAppRouting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get => (this._webAppRouting = this._webAppRouting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterIngressProfileWebAppRouting()); set => this._webAppRouting = value; }
...

    {
        ...
        /// App Routing settings for the ingress profile. You can find an overview and onboarding guide for this feature at https://learn.microsoft.com/en-us/azure/aks/app-routing?tabs=default%2Cdeploy-app-default.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get; set; }
        /// <summary>
        /// Resource IDs of the DNS zones to be associated with the Application Routing add-on. Used only when Application Routing
        /// add-on is enabled. Public and private DNS zones can be in different resource groups, but all public DNS zones must be
        /// in the same resource group and all private DNS zones must be in the same resource group.
