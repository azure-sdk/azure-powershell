...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401
{
    ...
    public partial class ManagedClusterLoadBalancerProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] _effectiveOutboundIP;

        /// <summary>The effective outbound IP resources of the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] EffectiveOutboundIP { get => this._effectiveOutboundIP; set => this._effectiveOutboundIP = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileManagedOutboundIPs _managedOutboundIP;

        /// <summary>Desired managed outbound IPs for the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileManagedOutboundIPs ManagedOutboundIP { get => (this._managedOutboundIP = this._managedOutboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterLoadBalancerProfileManagedOutboundIPs()); set => this._managedOutboundIP = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileManagedOutboundIPs Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileInternal.ManagedOutboundIP { get => (this._managedOutboundIP = this._managedOutboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterLoadBalancerProfileManagedOutboundIPs()); set { {_managedOutboundIP = value;} } }

        /// <summary>Internal Acessors for OutboundIP</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPs Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileInternal.OutboundIP { get => (this._outboundIP = this._outboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterLoadBalancerProfileOutboundIPs()); set { {_outboundIP = value;} } }

        /// <summary>Internal Acessors for OutboundIPPrefix</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPPrefixes Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileInternal.OutboundIPPrefix { get => (this._outboundIPPrefix = this._outboundIPPrefix ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterLoadBalancerProfileOutboundIPPrefixes()); set { {_outboundIPPrefix = value;} } }

        /// <summary>Backing field for <see cref="OutboundIP" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPs _outboundIP;

        /// <summary>Desired outbound IP resources for the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPs OutboundIP { get => (this._outboundIP = this._outboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterLoadBalancerProfileOutboundIPs()); set => this._outboundIP = value; }

        /// <summary>Backing field for <see cref="OutboundIPPrefix" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPPrefixes _outboundIPPrefix;

        /// <summary>Desired outbound IP Prefix resources for the cluster load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPPrefixes OutboundIPPrefix { get => (this._outboundIPPrefix = this._outboundIPPrefix ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterLoadBalancerProfileOutboundIPPrefixes()); set => this._outboundIPPrefix = value; }

        /// <summary>A list of public IP prefix resources.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] OutboundIPPrefixPublicIpprefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPPrefixesInternal)OutboundIPPrefix).PublicIPPrefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPPrefixesInternal)OutboundIPPrefix).PublicIPPrefix = value ?? null /* arrayOf */; }

        /// <summary>A list of public IP resources.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] OutboundIPPublicIP { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPsInternal)OutboundIP).PublicIP; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPsInternal)OutboundIP).PublicIP = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] EffectiveOutboundIP { get; set; }
        /// <summary>Enable multiple standard load balancers per AKS cluster or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        int? IdleTimeoutInMinute { get; set; }
        /// <summary>Desired managed outbound IPs for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileManagedOutboundIPs ManagedOutboundIP { get; set; }
        /// <summary>
        /// The desired number of IPv4 outbound IPs created/managed by Azure for the cluster load balancer. Allowed values must be
        /// in the range of 1 to 100 (inclusive). The default value is 1.
        /// </summary>
        ...
        int? ManagedOutboundIPCountIpv6 { get; set; }
        /// <summary>Desired outbound IP resources for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPs OutboundIP { get; set; }
        /// <summary>Desired outbound IP Prefix resources for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterLoadBalancerProfileOutboundIPPrefixes OutboundIPPrefix { get; set; }
        /// <summary>A list of public IP prefix resources.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] OutboundIPPrefixPublicIpprefix { get; set; }
        /// <summary>A list of public IP resources.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IResourceReference[] OutboundIPPublicIP { get; set; }
