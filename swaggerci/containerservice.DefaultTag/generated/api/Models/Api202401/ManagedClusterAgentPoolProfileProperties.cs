...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401
{
    ...
    public partial class ManagedClusterAgentPoolProfileProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfileProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ICreationData _creationData;

        /// <summary>
        /// CreationData to be used to specify the source Snapshot ID if the node pool will be created/upgraded using a snapshot.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ICreationData CreationData { get => (this._creationData = this._creationData ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.CreationData()); set => this._creationData = value; }
        ...
        public string CreationDataSourceResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ICreationDataInternal)CreationData).SourceResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ICreationDataInternal)CreationData).SourceResourceId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfig _kubeletConfig;

        /// <summary>The Kubelet configuration on the agent pool nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfig KubeletConfig { get => (this._kubeletConfig = this._kubeletConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.KubeletConfig()); set => this._kubeletConfig = value; }

        /// <summary>Allowed list of unsafe sysctls or unsafe sysctl patterns (ending in `*`).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string[] KubeletConfigAllowedUnsafeSysctl { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).AllowedUnsafeSysctl; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).AllowedUnsafeSysctl = value ?? null /* arrayOf */; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? KubeletConfigCpuCfsQuota { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).CpuCfsQuota; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).CpuCfsQuota = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? KubeletConfigFailSwapOn { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).FailSwapOn; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).FailSwapOn = value ?? default(bool); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? KubeletConfigPodMaxPid { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).PodMaxPid; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfigInternal)KubeletConfig).PodMaxPid = value ?? default(int); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfig _linuxOSConfig;

        /// <summary>The OS configuration of Linux agent nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfig LinuxOSConfig { get => (this._linuxOSConfig = this._linuxOSConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.LinuxOSConfig()); set => this._linuxOSConfig = value; }

        /// <summary>The size in MB of a swap file that will be created on each node.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? LinuxOSConfigSwapFileSizeMb { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).SwapFileSizeMb; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).SwapFileSizeMb = value ?? default(int); }

        /// <summary>Sysctl settings for Linux agent nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ISysctlConfig LinuxOSConfigSysctl { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).Sysctl; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).Sysctl = value ?? null /* model class */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string LinuxOSConfigTransparentHugePageDefrag { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageDefrag; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageDefrag = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string LinuxOSConfigTransparentHugePageEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfigInternal)LinuxOSConfig).TransparentHugePageEnabled = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ICreationData Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.CreationData { get => (this._creationData = this._creationData ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.CreationData()); set { {_creationData = value;} } }

        /// <summary>Internal Acessors for CurrentOrchestratorVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.CurrentOrchestratorVersion { get => this._currentOrchestratorVersion; set { {_currentOrchestratorVersion = value;} } }

        /// <summary>Internal Acessors for KubeletConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfig Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.KubeletConfig { get => (this._kubeletConfig = this._kubeletConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.KubeletConfig()); set { {_kubeletConfig = value;} } }

        /// <summary>Internal Acessors for LinuxOSConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfig Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.LinuxOSConfig { get => (this._linuxOSConfig = this._linuxOSConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.LinuxOSConfig()); set { {_linuxOSConfig = value;} } }

        /// <summary>Internal Acessors for NetworkProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.NetworkProfile { get => (this._networkProfile = this._networkProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.AgentPoolNetworkProfile()); set { {_networkProfile = value;} } }

        /// <summary>Internal Acessors for NodeImageVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.NodeImageVersion { get => this._nodeImageVersion; set { {_nodeImageVersion = value;} } }

        /// <summary>Internal Acessors for PowerState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPowerState Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.PowerState { get => (this._powerState = this._powerState ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.PowerState()); set { {_powerState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for UpgradeSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettings Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesInternal.UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.AgentPoolUpgradeSettings()); set { {_upgradeSetting = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfile _networkProfile;

        /// <summary>Network-related settings of an agent pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfile NetworkProfile { get => (this._networkProfile = this._networkProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.AgentPoolNetworkProfile()); set => this._networkProfile = value; }

        /// <summary>
        /// The port ranges that are allowed to access. The specified ranges are allowed to overlap.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPortRange[] NetworkProfileAllowedHostPort { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfileInternal)NetworkProfile).AllowedHostPort; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfileInternal)NetworkProfile).AllowedHostPort = value ?? null /* arrayOf */; }

        /// <summary>
        /// The IDs of the application security groups which agent pool will associate when created.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string[] NetworkProfileApplicationSecurityGroup { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfileInternal)NetworkProfile).ApplicationSecurityGroup; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfileInternal)NetworkProfile).ApplicationSecurityGroup = value ?? null /* arrayOf */; }

        /// <summary>IPTags of instance-level public IPs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IIPTag[] NetworkProfileNodePublicIPTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfileInternal)NetworkProfile).NodePublicIPTag; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfileInternal)NetworkProfile).NodePublicIPTag = value ?? null /* arrayOf */; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesNodeLabels _nodeLabel;

        /// <summary>The node labels to be persisted across all nodes in agent pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesNodeLabels NodeLabel { get => (this._nodeLabel = this._nodeLabel ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterAgentPoolProfilePropertiesNodeLabels()); set => this._nodeLabel = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPowerState _powerState;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPowerState PowerState { get => (this._powerState = this._powerState ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.PowerState()); set => this._powerState = value; }

        /// <summary>Tells whether the cluster is Running or Stopped</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Code? PowerStateCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPowerStateInternal)PowerState).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPowerStateInternal)PowerState).Code = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Code)""); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesTags _tag;

        /// <summary>The tags to be persisted on the agent pool virtual machine scale set.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ManagedClusterAgentPoolProfilePropertiesTags()); set => this._tag = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettings _upgradeSetting;

        /// <summary>Settings for upgrading the agentpool</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettings UpgradeSetting { get => (this._upgradeSetting = this._upgradeSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.AgentPoolUpgradeSettings()); set => this._upgradeSetting = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? UpgradeSettingDrainTimeoutInMinute { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).DrainTimeoutInMinute; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).DrainTimeoutInMinute = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string UpgradeSettingMaxSurge { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxSurge; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).MaxSurge = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? UpgradeSettingNodeSoakDurationInMinute { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).NodeSoakDurationInMinute; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettingsInternal)UpgradeSetting).NodeSoakDurationInMinute = value ?? default(int); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ISysctlConfig) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ISysctlConfig LinuxOSConfigSysctl { get; set; }
        /// <summary>
        /// Valid values are 'always', 'defer', 'defer+madvise', 'madvise' and 'never'. The default is 'madvise'. For more information
        /// see [Transparent Hugepages](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html#admin-guide-transhuge).
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPortRange) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPortRange[] NetworkProfileAllowedHostPort { get; set; }
        /// <summary>
        /// The IDs of the application security groups which agent pool will associate when created.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IIPTag) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IIPTag[] NetworkProfileNodePublicIPTag { get; set; }
        /// <summary>The version of node image</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesNodeLabels) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesNodeLabels NodeLabel { get; set; }
        /// <summary>
        /// This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIPPrefixName}
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IManagedClusterAgentPoolProfilePropertiesTags Tag { get; set; }
        /// <summary>The type of Agent Pool.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        /// CreationData to be used to specify the source Snapshot ID if the node pool will be created/upgraded using a snapshot.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ICreationData CreationData { get; set; }
        /// <summary>This is the ARM ID of the source object to be used to create the target object.</summary>
        string CreationDataSourceResourceId { get; set; }
        /// <summary>
        /// If orchestratorVersion is a fully specified version <major.minor.patch>, this field will be exactly equal to it. If orchestratorVersion
        ...
        string HostGroupId { get; set; }
        /// <summary>The Kubelet configuration on the agent pool nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IKubeletConfig KubeletConfig { get; set; }
        /// <summary>Allowed list of unsafe sysctls or unsafe sysctl patterns (ending in `*`).</summary>
        string[] KubeletConfigAllowedUnsafeSysctl { get; set; }
        /// <summary>
        /// The maximum number of container log files that can be present for a container. The number must be ≥ 2.
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.KubeletDiskType? KubeletDiskType { get; set; }
        /// <summary>The OS configuration of Linux agent nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ILinuxOSConfig LinuxOSConfig { get; set; }
        /// <summary>The size in MB of a swap file that will be created on each node.</summary>
        int? LinuxOSConfigSwapFileSizeMb { get; set; }
        /// <summary>Sysctl settings for Linux agent nodes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.ISysctlConfig LinuxOSConfigSysctl { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.AgentPoolMode? Mode { get; set; }
        /// <summary>Network-related settings of an agent pool.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolNetworkProfile NetworkProfile { get; set; }
        /// <summary>
        /// The port ranges that are allowed to access. The specified ranges are allowed to overlap.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IPortRange[] NetworkProfileAllowedHostPort { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.AgentPoolType? Type { get; set; }
        /// <summary>Settings for upgrading the agentpool</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202401.IAgentPoolUpgradeSettings UpgradeSetting { get; set; }
        /// <summary>
        /// The amount of time (in minutes) to wait on eviction of pods and graceful termination per node. This eviction wait time
        /// honors waiting on pod disruption budgets. If this time is exceeded, the upgrade fails. If not specified, the default is
        /// 30 minutes.
