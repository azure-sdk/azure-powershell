...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpdateInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelection Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpdateInternal.NodeImageSelection { get => (this._nodeImageSelection = this._nodeImageSelection ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.NodeImageSelection()); set { {_nodeImageSelection = value;} } }

        /// <summary>Internal Acessors for Upgrade</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpgradeSpec Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpdateInternal.Upgrade { get => (this._upgrade = this._upgrade ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.ManagedClusterUpgradeSpec()); set { {_upgrade = value;} } }

        /// <summary>Backing field for <see cref="NodeImageSelection" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelection _nodeImageSelection;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelection NodeImageSelection { get => (this._nodeImageSelection = this._nodeImageSelection ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.NodeImageSelection()); set => this._nodeImageSelection = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageVersion[] NodeImageSelectionCustomNodeImageVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelectionInternal)NodeImageSelection).CustomNodeImageVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelectionInternal)NodeImageSelection).CustomNodeImageVersion = value ?? null /* arrayOf */; }

        /// <summary>The node image upgrade type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Support.NodeImageSelectionType? NodeImageSelectionType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelectionInternal)NodeImageSelection).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelectionInternal)NodeImageSelection).Type = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Support.NodeImageSelectionType)""); }

        /// <summary>Backing field for <see cref="Upgrade" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpgradeSpec _upgrade;

        /// <summary>The upgrade to apply to the ManagedClusters.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpgradeSpec Upgrade { get => (this._upgrade = this._upgrade ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.ManagedClusterUpgradeSpec()); set => this._upgrade = value; }

        /// <summary>The Kubernetes version to upgrade the member clusters to.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Inlined)]
        public string UpgradeKubernetesVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpgradeSpecInternal)Upgrade).KubernetesVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpgradeSpecInternal)Upgrade).KubernetesVersion = value ?? null; }
    ...
    {
        /// <summary>The node image upgrade to be applied to the target nodes in update run.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.INodeImageSelection NodeImageSelection { get; set; }
        /// <summary>
        /// Custom node image versions to upgrade the nodes to. This field is required if node image selection type is Custom. Otherwise,
        /// it must be empty. For each node image family (e.g., 'AKSUbuntu-1804gen2containerd'), this field can contain at most one
        /// version (e.g., only one of 'AKSUbuntu-1804gen2containerd-2023.01.12' or 'AKSUbuntu-1804gen2containerd-2023.02.12', not
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Support.NodeImageSelectionType? NodeImageSelectionType { get; set; }
        /// <summary>The upgrade to apply to the ManagedClusters.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250123Preview.IManagedClusterUpgradeSpec Upgrade { get; set; }
        /// <summary>The Kubernetes version to upgrade the member clusters to.</summary>
        string UpgradeKubernetesVersion { get; set; }
        /// <summary>ManagedClusterUpgradeType is the type of upgrade to be applied.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Support.ManagedClusterUpgradeType UpgradeType { get; set; }
