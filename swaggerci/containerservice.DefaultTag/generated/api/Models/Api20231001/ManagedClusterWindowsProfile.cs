...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001
{
    ...
    public partial class ManagedClusterWindowsProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IManagedClusterWindowsProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IManagedClusterWindowsProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfile _gmsaProfile;

        /// <summary>The Windows gMSA Profile in the Managed Cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfile GmsaProfile { get => (this._gmsaProfile = this._gmsaProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.WindowsGmsaProfile()); set => this._gmsaProfile = value; }
        ...
        public string GmsaProfileDnsServer { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfileInternal)GmsaProfile).DnsServer; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfileInternal)GmsaProfile).DnsServer = value ?? null; }

        /// <summary>Specifies whether to enable Windows gMSA in the managed cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? GmsaProfileEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfileInternal)GmsaProfile).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfileInternal)GmsaProfile).Enabled = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string GmsaProfileRootDomainName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfileInternal)GmsaProfile).RootDomainName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfileInternal)GmsaProfile).RootDomainName = value ?? null; }

        /// <summary>Backing field for <see cref="LicenseType" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LicenseType? _licenseType;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LicenseType? LicenseType { get => this._licenseType; set => this._licenseType = value; }

        /// <summary>Internal Acessors for GmsaProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IManagedClusterWindowsProfileInternal.GmsaProfile { get => (this._gmsaProfile = this._gmsaProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.WindowsGmsaProfile()); set { {_gmsaProfile = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LicenseType? LicenseType { get; set; }
...

    {
        ...
        bool? EnableCsiProxy { get; set; }
        /// <summary>The Windows gMSA Profile in the Managed Cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.IWindowsGmsaProfile GmsaProfile { get; set; }
        /// <summary>
        /// Specifies the DNS server for Windows gMSA. <br><br> Set it to empty if you have configured the DNS server in the vnet
        /// which is used to create the managed cluster.
        /// </summary>
