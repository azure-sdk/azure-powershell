...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001
{
    ...
    public partial class SnapshotProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ICreationData Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.CreationData { get => (this._creationData = this._creationData ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.CreationData()); set { {_creationData = value;} } }

        /// <summary>Internal Acessors for EnableFips</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.EnableFips { get => this._enableFips; set { {_enableFips = value;} } }

        /// <summary>Internal Acessors for KubernetesVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.KubernetesVersion { get => this._kubernetesVersion; set { {_kubernetesVersion = value;} } }

        /// <summary>Internal Acessors for NodeImageVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.NodeImageVersion { get => this._nodeImageVersion; set { {_nodeImageVersion = value;} } }

        /// <summary>Internal Acessors for OSSku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Ossku? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.OSSku { get => this._oSSku; set { {_oSSku = value;} } }

        /// <summary>Internal Acessors for OSType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.OSType? Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.OSType { get => this._oSType; set { {_oSType = value;} } }

        /// <summary>Internal Acessors for VMSize</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20231001.ISnapshotPropertiesInternal.VMSize { get => this._vMSize; set { {_vMSize = value;} } }
