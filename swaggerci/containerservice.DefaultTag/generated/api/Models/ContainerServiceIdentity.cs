...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models
{
    ...
    public partial class ContainerServiceIdentity :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.IContainerServiceIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="ManagedNamespaceName" /> property.</summary>
        private string _managedNamespaceName;

        /// <summary>The name of the managed namespace.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public string ManagedNamespaceName { get => this._managedNamespaceName; set => this._managedNamespaceName = value; }
        ...
        /// <summary>Safeguards version</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public string Version { get => this._version; set => this._version = value; }

        /// <summary>Creates an new <see cref="ContainerServiceIdentity" /> instance.</summary>
        public ContainerServiceIdentity()
        {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string ManagedNamespaceName { get; set; }
        /// <summary>The mode of the mesh.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IContainerServiceIdentityInternal
