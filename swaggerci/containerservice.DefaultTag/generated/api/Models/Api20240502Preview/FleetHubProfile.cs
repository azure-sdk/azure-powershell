...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview
{
    ...
    public partial class FleetHubProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfileInternal
    {

        /// <summary>Backing field for <see cref="AgentProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfile _agentProfile;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfile AgentProfile { get => (this._agentProfile = this._agentProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.AgentProfile()); set => this._agentProfile = value; }
        ...
        public string AgentProfileSubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfileInternal)AgentProfile).SubnetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfileInternal)AgentProfile).SubnetId = value ?? null; }

        /// <summary>The virtual machine size of the Fleet hub.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Inlined)]
        public string AgentProfileVMSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfileInternal)AgentProfile).VMSize; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfileInternal)AgentProfile).VMSize = value ?? null; }

        /// <summary>Backing field for <see cref="ApiServerAccessProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IApiServerAccessProfile _apiServerAccessProfile;

        /// <summary>The access profile for the Fleet hub API server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IApiServerAccessProfile ApiServerAccessProfile { get => (this._apiServerAccessProfile = this._apiServerAccessProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.ApiServerAccessProfile()); set => this._apiServerAccessProfile = value; }

        /// <summary>Whether to create the Fleet hub as a private cluster or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Inlined)]
        public bool? ApiServerAccessProfileEnablePrivateCluster { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IApiServerAccessProfileInternal)ApiServerAccessProfile).EnablePrivateCluster; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IApiServerAccessProfileInternal)ApiServerAccessProfile).EnablePrivateCluster = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfileInternal.AgentProfile { get => (this._agentProfile = this._agentProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.AgentProfile()); set { {_agentProfile = value;} } }

        /// <summary>Internal Acessors for ApiServerAccessProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IApiServerAccessProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfileInternal.ApiServerAccessProfile { get => (this._apiServerAccessProfile = this._apiServerAccessProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.ApiServerAccessProfile()); set { {_apiServerAccessProfile = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfileInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for KubernetesVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfileInternal.KubernetesVersion { get => this._kubernetesVersion; set { {_kubernetesVersion = value;} } }

        /// <summary>Internal Acessors for PortalFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IFleetHubProfileInternal.PortalFqdn { get => this._portalFqdn; set { {_portalFqdn = value;} } }
    ...
    {
        /// <summary>The agent profile for the Fleet hub.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IAgentProfile AgentProfile { get; set; }
        /// <summary>
        /// The ID of the subnet which the Fleet hub node will join on startup. If this is not specified, a vnet and subnet will be
        /// generated and used.
        /// </summary>
        ...
        string AgentProfileVMSize { get; set; }
        /// <summary>The access profile for the Fleet hub API server.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20240502Preview.IApiServerAccessProfile ApiServerAccessProfile { get; set; }
        /// <summary>Whether to create the Fleet hub as a private cluster or not.</summary>
        bool? ApiServerAccessProfileEnablePrivateCluster { get; set; }
        /// <summary>Whether to enable apiserver vnet integration for the Fleet hub or not.</summary>
        bool? ApiServerAccessProfileEnableVnetIntegration { get; set; }
