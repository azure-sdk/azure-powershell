...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview
{
    ...
    public partial class MeshUpgradeProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshUpgradeProfileInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IValidates
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ICompatibleVersions[] CompatibleWith { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevisionInternal)Property).CompatibleWith; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevisionInternal)Property).CompatibleWith = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevision Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshUpgradeProfileInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.MeshRevision()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevision _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevision Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.MeshRevision()); set => this._property = value; }

        /// <summary>The revision of the mesh release.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string Revision { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevisionInternal)Property).Revision; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevisionInternal)Property).Revision = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string[] Upgrade { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevisionInternal)Property).Upgrade; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevisionInternal)Property).Upgrade = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api50.IResource
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ICompatibleVersions) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ICompatibleVersions[] CompatibleWith { get; set; }
        /// <summary>The revision of the mesh release.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api50.IResourceInternal
    {
        ...
        /// Holds information on upgrades and compatibility for given major.minor mesh release.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IMeshRevision Property { get; set; }
        /// <summary>The revision of the mesh release.</summary>
        string Revision { get; set; }
        /// <summary>List of revisions available for upgrade of a specific mesh revision</summary>
        string[] Upgrade { get; set; }
