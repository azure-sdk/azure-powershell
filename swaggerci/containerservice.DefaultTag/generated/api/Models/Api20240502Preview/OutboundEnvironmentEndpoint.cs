...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview
{
    ...
    public partial class OutboundEnvironmentEndpoint :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IOutboundEnvironmentEndpointInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IEndpointDependency[] _endpoint;

        /// <summary>The endpoints that AKS agent nodes connect to</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IEndpointDependency[] Endpoint { get => this._endpoint; set => this._endpoint = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IEndpointDependency) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.IEndpointDependency[] Endpoint { get; set; }
