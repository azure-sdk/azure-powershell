...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview
{
    ...
    public partial class TrustedAccessRoleRule :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRule,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRuleInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRuleInternal.ApiGroup { get => this._apiGroup; set { {_apiGroup = value;} } }

        /// <summary>Internal Acessors for NonResourceUrL</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRuleInternal.NonResourceUrL { get => this._nonResourceUrL; set { {_nonResourceUrL = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRuleInternal.Resource { get => this._resource; set { {_resource = value;} } }

        /// <summary>Internal Acessors for ResourceName</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRuleInternal.ResourceName { get => this._resourceName; set { {_resourceName = value;} } }

        /// <summary>Internal Acessors for Verb</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240502Preview.ITrustedAccessRoleRuleInternal.Verb { get => this._verb; set { {_verb = value;} } }
