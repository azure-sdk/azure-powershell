...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview
{
    ...
    public partial class ManagedClusterWindowsProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IManagedClusterWindowsProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IManagedClusterWindowsProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfile _gmsaProfile;

        /// <summary>The Windows gMSA Profile in the Managed Cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfile GmsaProfile { get => (this._gmsaProfile = this._gmsaProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.WindowsGmsaProfile()); set => this._gmsaProfile = value; }
        ...
        public string GmsaProfileDnsServer { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfileInternal)GmsaProfile).DnsServer; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfileInternal)GmsaProfile).DnsServer = value ?? null; }

        /// <summary>Specifies whether to enable Windows gMSA in the managed cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public bool? GmsaProfileEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfileInternal)GmsaProfile).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfileInternal)GmsaProfile).Enabled = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string GmsaProfileRootDomainName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfileInternal)GmsaProfile).RootDomainName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfileInternal)GmsaProfile).RootDomainName = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IManagedClusterWindowsProfileInternal.GmsaProfile { get => (this._gmsaProfile = this._gmsaProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.WindowsGmsaProfile()); set { {_gmsaProfile = value;} } }
...

    {
        ...
        bool? EnableCsiProxy { get; set; }
        /// <summary>The Windows gMSA Profile in the Managed Cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240602Preview.IWindowsGmsaProfile GmsaProfile { get; set; }
        /// <summary>
        /// Specifies the DNS server for Windows gMSA. <br><br> Set it to empty if you have configured the DNS server in the vnet
        /// which is used to create the managed cluster.
        /// </summary>
