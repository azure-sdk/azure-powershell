...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models
{
    ...
    public partial class ContainerServiceFleetIdentity
    {
        ...
        internal ContainerServiceFleetIdentity(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)SubscriptionId;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)ResourceGroupName;}
            {_fleetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("fleetName"), out var __jsonFleetName) ? (string)__jsonFleetName : (string)FleetName;}
            {_autoUpgradeProfileName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("autoUpgradeProfileName"), out var __jsonAutoUpgradeProfileName) ? (string)__jsonAutoUpgradeProfileName : (string)AutoUpgradeProfileName;}
            {_fleetMemberName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("fleetMemberName"), out var __jsonFleetMemberName) ? (string)__jsonFleetMemberName : (string)FleetMemberName;}
            {_updateRunName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("updateRunName"), out var __jsonUpdateRunName) ? (string)__jsonUpdateRunName : (string)UpdateRunName;}
            {_updateStrategyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("updateStrategyName"), out var __jsonUpdateStrategyName) ? (string)__jsonUpdateStrategyName : (string)UpdateStrategyName;}
