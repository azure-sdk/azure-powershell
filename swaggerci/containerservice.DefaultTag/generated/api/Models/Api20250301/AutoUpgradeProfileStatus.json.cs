...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301
{
    ...
    public partial class AutoUpgradeProfileStatus
    {
        ...
        internal AutoUpgradeProfileStatus(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_lastTriggerError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject>("lastTriggerError"), out var __jsonLastTriggerError) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api50.ErrorDetail.FromJson(__jsonLastTriggerError) : LastTriggerError;}
            ...
            {_lastTriggerStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString>("lastTriggerStatus"), out var __jsonLastTriggerStatus) ? (string)__jsonLastTriggerStatus : (string)LastTriggerStatus;}
            {_lastTriggerUpgradeVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonArray>("lastTriggerUpgradeVersions"), out var __jsonLastTriggerUpgradeVersions) ? If( __jsonLastTriggerUpgradeVersions as Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : LastTriggerUpgradeVersion;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAutoUpgradeProfileStatus.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAutoUpgradeProfileStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAutoUpgradeProfileStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonNode node)
        {
