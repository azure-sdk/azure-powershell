...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301
{
    ...
    public partial class FleetHubProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfileInternal
    {

        /// <summary>Backing field for <see cref="AgentProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfile _agentProfile;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfile AgentProfile { get => (this._agentProfile = this._agentProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.AgentProfile()); set => this._agentProfile = value; }
        ...
        public string AgentProfileSubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfileInternal)AgentProfile).SubnetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfileInternal)AgentProfile).SubnetId = value ?? null; }

        /// <summary>The virtual machine size of the Fleet hub.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Inlined)]
        public string AgentProfileVMSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfileInternal)AgentProfile).VMSize; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfileInternal)AgentProfile).VMSize = value ?? null; }

        /// <summary>Backing field for <see cref="ApiServerAccessProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IApiServerAccessProfile _apiServerAccessProfile;

        /// <summary>The access profile for the Fleet hub API server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IApiServerAccessProfile ApiServerAccessProfile { get => (this._apiServerAccessProfile = this._apiServerAccessProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.ApiServerAccessProfile()); set => this._apiServerAccessProfile = value; }

        /// <summary>Whether to create the Fleet hub as a private cluster or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Inlined)]
        public bool? ApiServerAccessProfileEnablePrivateCluster { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IApiServerAccessProfileInternal)ApiServerAccessProfile).EnablePrivateCluster; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IApiServerAccessProfileInternal)ApiServerAccessProfile).EnablePrivateCluster = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfileInternal.AgentProfile { get => (this._agentProfile = this._agentProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.AgentProfile()); set { {_agentProfile = value;} } }

        /// <summary>Internal Acessors for ApiServerAccessProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IApiServerAccessProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfileInternal.ApiServerAccessProfile { get => (this._apiServerAccessProfile = this._apiServerAccessProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.ApiServerAccessProfile()); set { {_apiServerAccessProfile = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfileInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for KubernetesVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfileInternal.KubernetesVersion { get => this._kubernetesVersion; set { {_kubernetesVersion = value;} } }

        /// <summary>Internal Acessors for PortalFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IFleetHubProfileInternal.PortalFqdn { get => this._portalFqdn; set { {_portalFqdn = value;} } }
    ...
    {
        /// <summary>The agent profile for the Fleet hub.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IAgentProfile AgentProfile { get; set; }
        /// <summary>
        /// The ID of the subnet which the Fleet hub node will join on startup. If this is not specified, a vnet and subnet will be
        /// generated and used.
        /// </summary>
        ...
        string AgentProfileVMSize { get; set; }
        /// <summary>The access profile for the Fleet hub API server.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.Api20250301.IApiServerAccessProfile ApiServerAccessProfile { get; set; }
        /// <summary>Whether to create the Fleet hub as a private cluster or not.</summary>
        bool? ApiServerAccessProfileEnablePrivateCluster { get; set; }
        /// <summary>Whether to enable apiserver vnet integration for the Fleet hub or not.</summary>
        bool? ApiServerAccessProfileEnableVnetIntegration { get; set; }
