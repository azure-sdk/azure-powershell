...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview
{
    ...
    public partial class ManagedClusterPoolUpgradeProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManagedClusterPoolUpgradeProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManagedClusterPoolUpgradeProfileInternal
    {
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IComponentsByReleases ComponentsByRelease { get => (this._componentsByRelease = this._componentsByRelease ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.ComponentsByReleases()); set => this._componentsByRelease = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IComponentsByReleases Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManagedClusterPoolUpgradeProfileInternal.ComponentsByRelease { get => (this._componentsByRelease = this._componentsByRelease ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.ComponentsByReleases()); set { {_componentsByRelease = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManagedClusterPoolUpgradeProfileUpgradesItem[] _upgrade;

        /// <summary>List of orchestrator types and versions available for upgrade.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManagedClusterPoolUpgradeProfileUpgradesItem[] Upgrade { get => this._upgrade; set => this._upgrade = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManagedClusterPoolUpgradeProfileUpgradesItem[] Upgrade { get; set; }
