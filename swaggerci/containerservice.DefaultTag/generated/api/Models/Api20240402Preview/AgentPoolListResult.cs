...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview
{
    ...
    public partial class AgentPoolListResult :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPoolListResult,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPoolListResultInternal
    {

        /// <summary>Internal Acessors for NextLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPoolListResultInternal.NextLink { get => this._nextLink; set { {_nextLink = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPool[] _value;

        /// <summary>The list of agent pools.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPool[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPool) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAgentPool[] Value { get; set; }
