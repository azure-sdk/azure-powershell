...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview
{
    ...
    public partial class VirtualMachinesProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IVirtualMachinesProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IVirtualMachinesProfileInternal
    {

        /// <summary>Internal Acessors for Scale</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfile Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IVirtualMachinesProfileInternal.Scale { get => (this._scale = this._scale ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.ScaleProfile()); set { {_scale = value;} } }

        /// <summary>Backing field for <see cref="Scale" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfile _scale;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfile Scale { get => (this._scale = this._scale ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.ScaleProfile()); set => this._scale = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAutoScaleProfile[] ScaleAutoscale { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfileInternal)Scale).Autoscale; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfileInternal)Scale).Autoscale = value ?? null /* arrayOf */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManualScaleProfile[] ScaleManual { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfileInternal)Scale).Manual; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfileInternal)Scale).Manual = value ?? null /* arrayOf */; }
    ...
    {
        /// <summary>Specifications on how to scale a VirtualMachines agent pool.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfile Scale { get; set; }
        /// <summary>
        /// Specifications on how to auto-scale the VirtualMachines agent pool within a predefined size range. Currently, at most
        /// one AutoScaleProfile is allowed.
        /// </summary>
