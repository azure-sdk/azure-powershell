...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview
{
    ...
    public partial class ScaleProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IScaleProfileInternal
    {

        /// <summary>Backing field for <see cref="Autoscale" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAutoScaleProfile[] _autoscale;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAutoScaleProfile[] Autoscale { get => this._autoscale; set => this._autoscale = value; }

        /// <summary>Backing field for <see cref="Manual" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManualScaleProfile[] _manual;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManualScaleProfile[] Manual { get => this._manual; set => this._manual = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IAutoScaleProfile[] Autoscale { get; set; }
        /// <summary>
        /// Specifications on how to scale the VirtualMachines agent pool to a fixed size. Currently, at most one ManualScaleProfile
        /// is allowed.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240402Preview.IManualScaleProfile[] Manual { get; set; }
