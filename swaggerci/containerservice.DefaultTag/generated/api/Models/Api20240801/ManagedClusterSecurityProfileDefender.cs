...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801
{
    ...
    public partial class ManagedClusterSecurityProfileDefender :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefender,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderSecurityMonitoring Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderInternal.SecurityMonitoring { get => (this._securityMonitoring = this._securityMonitoring ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.ManagedClusterSecurityProfileDefenderSecurityMonitoring()); set { {_securityMonitoring = value;} } }

        /// <summary>Backing field for <see cref="SecurityMonitoring" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderSecurityMonitoring _securityMonitoring;

        /// <summary>
        /// Microsoft Defender threat detection for Cloud settings for the security profile.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderSecurityMonitoring SecurityMonitoring { get => (this._securityMonitoring = this._securityMonitoring ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.ManagedClusterSecurityProfileDefenderSecurityMonitoring()); set => this._securityMonitoring = value; }
        ...
        public bool? SecurityMonitoringEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderSecurityMonitoringInternal)SecurityMonitoring).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderSecurityMonitoringInternal)SecurityMonitoring).Enabled = value ?? default(bool); }
...

    {
        ...
        /// Microsoft Defender threat detection for Cloud settings for the security profile.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IManagedClusterSecurityProfileDefenderSecurityMonitoring SecurityMonitoring { get; set; }
        /// <summary>Whether to enable Defender threat detection</summary>
        bool? SecurityMonitoringEnabled { get; set; }
