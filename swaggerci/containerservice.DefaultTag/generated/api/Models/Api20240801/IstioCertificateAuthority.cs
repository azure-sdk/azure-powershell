...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801
{
    ...
    public partial class IstioCertificateAuthority :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioCertificateAuthority,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioCertificateAuthorityInternal
    {

        /// <summary>Internal Acessors for Plugin</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioPluginCertificateAuthority Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioCertificateAuthorityInternal.Plugin { get => (this._plugin = this._plugin ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IstioPluginCertificateAuthority()); set { {_plugin = value;} } }

        /// <summary>Backing field for <see cref="Plugin" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioPluginCertificateAuthority _plugin;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioPluginCertificateAuthority Plugin { get => (this._plugin = this._plugin ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IstioPluginCertificateAuthority()); set => this._plugin = value; }
    ...
    {
        /// <summary>Plugin certificates information for Service Mesh.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240801.IIstioPluginCertificateAuthority Plugin { get; set; }
        /// <summary>Certificate chain object name in Azure Key Vault.</summary>
        string PluginCertChainObjectName { get; set; }
        /// <summary>Intermediate certificate object name in Azure Key Vault.</summary>
        string PluginCertObjectName { get; set; }
