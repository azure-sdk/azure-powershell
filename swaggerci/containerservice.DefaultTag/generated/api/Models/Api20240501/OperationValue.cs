...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class OperationValue :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValue,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.OperationValueDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplayInternal)Display).Description; }

        /// <summary>The display name of the operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplayInternal)Display).Operation; }

        /// <summary>The resource provider for the operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplayInternal)Display).Provider; }

        /// <summary>The display name of the resource the operation applies to.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplayInternal)Display).Resource; }

        /// <summary>Internal Acessors for Display</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplay Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.OperationValueDisplay()); set { {_display = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Origin</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueInternal.Origin { get => this._origin; set { {_origin = value;} } }
    ...
    {
        /// <summary>Describes the properties of a Operation Value Display.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IOperationValueDisplay Display { get; set; }
        /// <summary>The description of the operation.</summary>
