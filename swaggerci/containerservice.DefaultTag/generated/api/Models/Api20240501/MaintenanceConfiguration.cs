...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class MaintenanceConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IMaintenanceConfigurationInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IMaintenanceConfigurationProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IMaintenanceConfigurationProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.MaintenanceConfigurationProperties()); set => this._property = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ISubResource
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDateSpan) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDateSpan[] MaintenanceWindowNotAllowedDate { get; set; }
        /// <summary>
        /// The date the maintenance window activates. If the current date is before this date, the maintenance window is inactive
        /// and will not be used for upgrades. If not specified, the maintenance window will be active right away.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ITimeSpan) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ITimeSpan[] NotAllowedTime { get; set; }
        /// <summary>Specifies on which day of the week the maintenance occurs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ITimeInWeek) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ITimeInWeek[] TimeInWeek { get; set; }
        /// <summary>Specifies on which day of the week the maintenance occurs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ISubResourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IMaintenanceWindow MaintenanceWindow { get; set; }
        /// <summary>Length of maintenance window range from 4 to 24 hours.</summary>
        int? MaintenanceWindowDurationHour { get; set; }
        /// <summary>
        /// Date ranges on which upgrade is not allowed. 'utcOffset' applies to this field. For example, with 'utcOffset: +02:00'
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ISchedule MaintenanceWindowSchedule { get; set; }
        /// <summary>
        /// The date the maintenance window activates. If the current date is before this date, the maintenance window is inactive
        /// and will not be used for upgrades. If not specified, the maintenance window will be active right away.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ITimeSpan[] NotAllowedTime { get; set; }
        /// <summary>Properties of a default maintenance configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IMaintenanceConfigurationProperties Property { get; set; }
        /// <summary>Specifies on which day of the week the maintenance occurs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.WeekDay? RelativeMonthlyDayOfWeek { get; set; }
        /// <summary>Specifies the number of months between each set of occurrences.</summary>
        int? RelativeMonthlyIntervalMonth { get; set; }
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAbsoluteMonthlySchedule ScheduleAbsoluteMonthly { get; set; }
        /// <summary>For schedules like: 'recur every day' or 'recur every 3 days'.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDailySchedule ScheduleDaily { get; set; }
        /// <summary>
        /// For schedules like: 'recur every month on the first Monday' or 'recur every 3 months on last Friday'.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IRelativeMonthlySchedule ScheduleRelativeMonthly { get; set; }
        /// <summary>For schedules like: 'recur every Monday' or 'recur every 3 weeks on Wednesday'.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IWeeklySchedule ScheduleWeekly { get; set; }
        /// <summary>The system metadata relating to this resource.</summary>
