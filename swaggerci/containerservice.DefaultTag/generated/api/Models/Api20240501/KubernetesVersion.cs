...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class KubernetesVersion :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionInternal
    {

        /// <summary>Backing field for <see cref="Capability" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionCapabilities _capability;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionCapabilities Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.KubernetesVersionCapabilities()); set => this._capability = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionPatchVersions _patchVersion;

        /// <summary>Patch versions of Kubernetes release</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionPatchVersions PatchVersion { get => (this._patchVersion = this._patchVersion ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.KubernetesVersionPatchVersions()); set => this._patchVersion = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionPatchVersions) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionPatchVersions PatchVersion { get; set; }
        /// <summary>major.minor version of Kubernetes release</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>Capabilities on this Kubernetes version.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IKubernetesVersionCapabilities Capability { get; set; }
