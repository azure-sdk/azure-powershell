...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ManagedClusterIngressProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterIngressProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterIngressProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterIngressProfileWebAppRouting _webAppRouting;
...

    {
        ...
        /// App Routing settings for the ingress profile. You can find an overview and onboarding guide for this feature at https://learn.microsoft.com/en-us/azure/aks/app-routing?tabs=default%2Cdeploy-app-default.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterIngressProfileWebAppRouting WebAppRouting { get; set; }
        /// <summary>
        /// Resource IDs of the DNS zones to be associated with the Application Routing add-on. Used only when Application Routing
        /// add-on is enabled. Public and private DNS zones can be in different resource groups, but all public DNS zones must be
        /// in the same resource group and all private DNS zones must be in the same resource group.
