...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ManagedClusterIngressProfileWebAppRouting :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterIngressProfileWebAppRouting,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterIngressProfileWebAppRoutingInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentity _identity;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentity Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.UserAssignedIdentity()); }
        ...
        public string IdentityClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentityInternal)Identity).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentityInternal)Identity).ClientId = value ?? null; }

        /// <summary>The object ID of the user assigned identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string IdentityObjectId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentityInternal)Identity).ObjectId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentityInternal)Identity).ObjectId = value ?? null; }

        /// <summary>The resource ID of the user assigned identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string IdentityResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentityInternal)Identity).ResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentityInternal)Identity).ResourceId = value ?? null; }
...

    {
        ...
        /// for more instructions.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IUserAssignedIdentity Identity { get; set; }
        /// <summary>The client ID of the user assigned identity.</summary>
        string IdentityClientId { get; set; }
        /// <summary>The object ID of the user assigned identity.</summary>
        string IdentityObjectId { get; set; }
