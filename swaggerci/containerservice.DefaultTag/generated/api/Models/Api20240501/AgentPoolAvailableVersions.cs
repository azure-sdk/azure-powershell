...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class AgentPoolAvailableVersions :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsInternal.Name { get => this._name; set { {_name = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsProperties _property;

        /// <summary>Properties of agent pool available versions.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.AgentPoolAvailableVersionsProperties()); set => this._property = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem[] AgentPoolVersion { get; set; }
        /// <summary>The ID of the agent pool version list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        string Name { get; set; }
        /// <summary>Properties of agent pool available versions.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAgentPoolAvailableVersionsProperties Property { get; set; }
        /// <summary>Type of the agent pool version list.</summary>
        string Type { get; set; }
