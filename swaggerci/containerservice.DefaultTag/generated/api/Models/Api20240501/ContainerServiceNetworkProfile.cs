...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ContainerServiceNetworkProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceNetworkProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterLoadBalancerProfile _loadBalancerProfile;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterNatGatewayProfile _natGatewayProfile;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IResourceReference[] LoadBalancerProfileEffectiveOutboundIP { get; set; }
        /// <summary>Enable multiple standard load balancers per AKS cluster or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"effectiveOutboundIPs",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IResourceReference) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IResourceReference[] NatGatewayProfileEffectiveOutboundIP { get; set; }
        /// <summary>
        /// Desired outbound flow idle timeout in minutes. Allowed values are in the range of 4 to 120 (inclusive). The default value
        /// is 4 minutes.
        /// </summary>
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.IPFamily[] IPFamily { get; set; }
        /// <summary>Profile of the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterLoadBalancerProfile LoadBalancerProfile { get; set; }
        /// <summary>
        /// The desired number of allocated SNAT ports per VM. Allowed values are in the range of 0 to 64000 (inclusive). The default
        /// value is 0 which results in Azure dynamically allocating ports.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterLoadBalancerProfileManagedOutboundIPs LoadBalancerProfileManagedOutboundIP { get; set; }
        /// <summary>Desired outbound IP resources for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterLoadBalancerProfileOutboundIPs LoadBalancerProfileOutboundIP { get; set; }
        /// <summary>Desired outbound IP Prefix resources for the cluster load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterLoadBalancerProfileOutboundIPPrefixes LoadBalancerProfileOutboundIPPrefix { get; set; }
        /// <summary>
        /// The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more
        /// information about the differences between load balancer SKUs.
        /// </summary>
        ...
        int? ManagedOutboundIPProfileCount { get; set; }
        /// <summary>Profile of the cluster NAT gateway.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterNatGatewayProfile NatGatewayProfile { get; set; }
        /// <summary>The effective outbound IP resources of the cluster NAT gateway.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IResourceReference[] NatGatewayProfileEffectiveOutboundIP { get; set; }
        /// <summary>
        /// Desired outbound flow idle timeout in minutes. Allowed values are in the range of 4 to 120 (inclusive). The default value
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterManagedOutboundIPProfile NatGatewayProfileManagedOutboundIPProfile { get; set; }
        /// <summary>Network dataplane used in the Kubernetes cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.NetworkDataplane? NetworkDataplane { get; set; }
        /// <summary>This cannot be specified if networkPlugin is anything other than 'azure'.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.NetworkMode? NetworkMode { get; set; }
