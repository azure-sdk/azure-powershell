...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ManagedClusterSecurityProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileInternal
    {

        /// <summary>Backing field for <see cref="AzureKeyVaultKm" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAzureKeyVaultKms _azureKeyVaultKm;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAzureKeyVaultKms AzureKeyVaultKm { get => (this._azureKeyVaultKm = this._azureKeyVaultKm ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.AzureKeyVaultKms()); set => this._azureKeyVaultKm = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public string AzureKeyVaultKmKeyId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAzureKeyVaultKmsInternal)AzureKeyVaultKm).KeyId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAzureKeyVaultKmsInternal)AzureKeyVaultKm).KeyId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileDefender _defender;

        /// <summary>Microsoft Defender settings for the security profile.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileDefender Defender { get => (this._defender = this._defender ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ManagedClusterSecurityProfileDefender()); set => this._defender = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileImageCleaner _imageCleaner;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileWorkloadIdentity _workloadIdentity;
...

    {
        ...
        /// the security profile.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAzureKeyVaultKms AzureKeyVaultKm { get; set; }
        /// <summary>Whether to enable Azure Key Vault key management service. The default is false.</summary>
        bool? AzureKeyVaultKmEnabled { get; set; }
        /// <summary>
        /// Identifier of Azure Key Vault key. See [key identifier format](https://docs.microsoft.com/en-us/azure/key-vault/general/about-keys-secrets-certificates#vault-name-and-object-name)
        ...
        string AzureKeyVaultKmKeyVaultResourceId { get; set; }
        /// <summary>Microsoft Defender settings for the security profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileDefender Defender { get; set; }
        /// <summary>
        /// Resource ID of the Log Analytics workspace to be associated with Microsoft Defender. When Microsoft Defender is enabled,
        /// this field is required and must be a valid workspace resource ID. When Microsoft Defender is disabled, leave the field
        /// empty.
        ...
        /// <summary>Image Cleaner settings for the security profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileImageCleaner ImageCleaner { get; set; }
        /// <summary>Whether to enable Image Cleaner on AKS cluster.</summary>
        bool? ImageCleanerEnabled { get; set; }
        /// <summary>Image Cleaner scanning interval in hours.</summary>
        int? ImageCleanerIntervalHour { get; set; }
        ...
        /// cloud resources securely with Azure AD. See https://aka.ms/aks/wi for more details.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterSecurityProfileWorkloadIdentity WorkloadIdentity { get; set; }
        /// <summary>Whether to enable workload identity.</summary>
        bool? WorkloadIdentityEnabled { get; set; }
