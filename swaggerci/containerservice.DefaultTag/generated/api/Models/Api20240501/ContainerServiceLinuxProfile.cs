...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ContainerServiceLinuxProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceLinuxProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceLinuxProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceSshConfiguration _ssh;

        /// <summary>The SSH configuration for Linux-based VMs running on Azure.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceSshConfiguration Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ContainerServiceSshConfiguration()); set => this._ssh = value; }
...

    {
        ...
        string AdminUsername { get; set; }
        /// <summary>The SSH configuration for Linux-based VMs running on Azure.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceSshConfiguration Ssh { get; set; }
        /// <summary>
        /// The list of SSH public keys used to authenticate with Linux-based VMs. A maximum of 1 key may be specified.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IContainerServiceSshPublicKey[] SshPublicKey { get; set; }
