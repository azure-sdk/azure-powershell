...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ManagedClusterStorageProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileInternal
    {

        /// <summary>Backing field for <see cref="BlobCsiDriver" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileBlobCsiDriver _blobCsiDriver;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileDiskCsiDriver _diskCsiDriver;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileFileCsiDriver _fileCsiDriver;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileSnapshotController _snapshotController;
    ...
    {
        /// <summary>AzureBlob CSI Driver settings for the storage profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileBlobCsiDriver BlobCsiDriver { get; set; }
        /// <summary>Whether to enable AzureBlob CSI Driver. The default value is false.</summary>
        bool? BlobCsiDriverEnabled { get; set; }
        /// <summary>AzureDisk CSI Driver settings for the storage profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileDiskCsiDriver DiskCsiDriver { get; set; }
        /// <summary>Whether to enable AzureDisk CSI Driver. The default value is true.</summary>
        bool? DiskCsiDriverEnabled { get; set; }
        /// <summary>AzureFile CSI Driver settings for the storage profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileFileCsiDriver FileCsiDriver { get; set; }
        /// <summary>Whether to enable AzureFile CSI Driver. The default value is true.</summary>
        bool? FileCsiDriverEnabled { get; set; }
        /// <summary>Snapshot Controller settings for the storage profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterStorageProfileSnapshotController SnapshotController { get; set; }
        /// <summary>Whether to enable Snapshot Controller. The default value is true.</summary>
        bool? SnapshotControllerEnabled { get; set; }
