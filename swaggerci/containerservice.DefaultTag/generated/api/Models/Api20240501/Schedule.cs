...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class Schedule :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.ISchedule,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IScheduleInternal
    {

        /// <summary>Backing field for <see cref="AbsoluteMonthly" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAbsoluteMonthlySchedule _absoluteMonthly;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAbsoluteMonthlySchedule AbsoluteMonthly { get => (this._absoluteMonthly = this._absoluteMonthly ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.AbsoluteMonthlySchedule()); set => this._absoluteMonthly = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDailySchedule _daily;

        /// <summary>For schedules like: 'recur every day' or 'recur every 3 days'.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDailySchedule Daily { get => (this._daily = this._daily ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.DailySchedule()); set => this._daily = value; }

        /// <summary>Specifies the number of days between each set of occurrences.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? DailyIntervalDay { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDailyScheduleInternal)Daily).IntervalDay; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDailyScheduleInternal)Daily).IntervalDay = value ?? default(int); }

        /// <summary>Internal Acessors for AbsoluteMonthly</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAbsoluteMonthlySchedule Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IScheduleInternal.AbsoluteMonthly { get => (this._absoluteMonthly = this._absoluteMonthly ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.AbsoluteMonthlySchedule()); set { {_absoluteMonthly = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IRelativeMonthlySchedule _relativeMonthly;

        /// <summary>
        /// For schedules like: 'recur every month on the first Monday' or 'recur every 3 months on last Friday'.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IRelativeMonthlySchedule RelativeMonthly { get => (this._relativeMonthly = this._relativeMonthly ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.RelativeMonthlySchedule()); set => this._relativeMonthly = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IWeeklySchedule _weekly;

        /// <summary>For schedules like: 'recur every Monday' or 'recur every 3 weeks on Wednesday'.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IWeeklySchedule Weekly { get => (this._weekly = this._weekly ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.WeeklySchedule()); set => this._weekly = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Inlined)]
        public int? WeeklyIntervalWeek { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IWeeklyScheduleInternal)Weekly).IntervalWeek; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IWeeklyScheduleInternal)Weekly).IntervalWeek = value ?? default(int); }
...

    {
        ...
        /// For schedules like: 'recur every month on the 15th' or 'recur every 3 months on the 20th'.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IAbsoluteMonthlySchedule AbsoluteMonthly { get; set; }
        /// <summary>The date of the month.</summary>
        int? AbsoluteMonthlyDayOfMonth { get; set; }
        /// <summary>Specifies the number of months between each set of occurrences.</summary>
        int? AbsoluteMonthlyIntervalMonth { get; set; }
        /// <summary>For schedules like: 'recur every day' or 'recur every 3 days'.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IDailySchedule Daily { get; set; }
        /// <summary>Specifies the number of days between each set of occurrences.</summary>
        int? DailyIntervalDay { get; set; }
        /// <summary>
        /// For schedules like: 'recur every month on the first Monday' or 'recur every 3 months on last Friday'.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IRelativeMonthlySchedule RelativeMonthly { get; set; }
        /// <summary>Specifies on which day of the week the maintenance occurs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.WeekDay? RelativeMonthlyDayOfWeek { get; set; }
        /// <summary>Specifies the number of months between each set of occurrences.</summary>
        int? RelativeMonthlyIntervalMonth { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.Type? RelativeMonthlyWeekIndex { get; set; }
        /// <summary>For schedules like: 'recur every Monday' or 'recur every 3 weeks on Wednesday'.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IWeeklySchedule Weekly { get; set; }
        /// <summary>Specifies on which day of the week the maintenance occurs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.WeekDay? WeeklyDayOfWeek { get; set; }
        /// <summary>Specifies the number of weeks between each set of occurrences.</summary>
        int? WeeklyIntervalWeek { get; set; }
