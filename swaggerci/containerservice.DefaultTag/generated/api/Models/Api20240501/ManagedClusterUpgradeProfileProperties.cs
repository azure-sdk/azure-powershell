...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501
{
    ...
    public partial class ManagedClusterUpgradeProfileProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterUpgradeProfileProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterUpgradeProfilePropertiesInternal
    {

        /// <summary>Backing field for <see cref="AgentPoolProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile[] _agentPoolProfile;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile[] AgentPoolProfile { get => this._agentPoolProfile; set => this._agentPoolProfile = value; }

        /// <summary>Backing field for <see cref="ControlPlaneProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile _controlPlaneProfile;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile[] AgentPoolProfile { get; set; }
        /// <summary>The Kubernetes version (major.minor.patch).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfileUpgradesItem) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfileUpgradesItem[] ControlPlaneProfileUpgrade { get; set; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile[] AgentPoolProfile { get; set; }
        /// <summary>The list of available upgrade versions for the control plane.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20240501.IManagedClusterPoolUpgradeProfile ControlPlaneProfile { get; set; }
        /// <summary>The Kubernetes version (major.minor.patch).</summary>
        string ControlPlaneProfileKubernetesVersion { get; set; }
        /// <summary>The Agent Pool name.</summary>
        string ControlPlaneProfileName { get; set; }
