...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview
{
    ...
    public partial class ManagedClusterPoolUpgradeProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IManagedClusterPoolUpgradeProfileInternal
    {

        /// <summary>Backing field for <see cref="ComponentsByRelease" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IComponentsByRelease[] _componentsByRelease;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IComponentsByRelease[] ComponentsByRelease { get => this._componentsByRelease; set => this._componentsByRelease = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IManagedClusterPoolUpgradeProfileUpgradesItem[] _upgrade;

        /// <summary>List of orchestrator types and versions available for upgrade.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IManagedClusterPoolUpgradeProfileUpgradesItem[] Upgrade { get => this._upgrade; set => this._upgrade = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IComponentsByRelease[] ComponentsByRelease { get; set; }
        /// <summary>The Kubernetes version (major.minor.patch).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api202502Preview.IManagedClusterPoolUpgradeProfileUpgradesItem[] Upgrade { get; set; }
