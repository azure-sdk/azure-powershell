...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RebalanceLoadBalancers=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/rebalanceLoadBalancers"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Import, @"AzContainerServiceManagedCluster_LoadViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/rebalanceLoadBalancers", ApiVersion = "2025-01-02-preview")]
    public partial class ImportAzContainerServiceManagedCluster_LoadViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IRebalanceLoadBalancersRequestBody _parameter;

        /// <summary>
        /// The names of the load balancers to rebalance. If set to empty, all load balancers will be rebalanced.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The names of the load balancers to rebalance. If set to empty, all load balancers will be rebalanced.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IRebalanceLoadBalancersRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IRebalanceLoadBalancersRequestBody Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>a duplicate instance of ImportAzContainerServiceManagedCluster_LoadViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets.ImportAzContainerServiceManagedCluster_LoadViaIdentity Clone()
        {
            var clone = new ImportAzContainerServiceManagedCluster_LoadViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzContainerServiceManagedCluster_LoadViaIdentity" /> cmdlet class.
        /// </summary>
        public ImportAzContainerServiceManagedCluster_LoadViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedClustersRebalanceLoadBalancers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ManagedClustersRebalanceLoadBalancersViaIdentity(InputObject.Id, Parameter, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ManagedClustersRebalanceLoadBalancers(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, Parameter, onDefault, this, Pipeline);
                    }
