...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ResetServicePrincipalProfile=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/resetServicePrincipalProfile"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzContainerServiceManagedClusterServicePrincipalProfile_Reset", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Description(@"This action cannot be performed on a cluster that is not using a service principal")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/resetServicePrincipalProfile", ApiVersion = "2025-01-02-preview")]
    public partial class ResetAzContainerServiceManagedClusterServicePrincipalProfile_Reset : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IManagedClusterServicePrincipalProfile _parameter;

        /// <summary>
        /// Information about a service principal identity for the cluster to use for manipulating Azure APIs.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Information about a service principal identity for the cluster to use for manipulating Azure APIs.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Information about a service principal identity for the cluster to use for manipulating Azure APIs.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IManagedClusterServicePrincipalProfile) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.IManagedClusterServicePrincipalProfile Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of ResetAzContainerServiceManagedClusterServicePrincipalProfile_Reset
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets.ResetAzContainerServiceManagedClusterServicePrincipalProfile_Reset Clone()
        {
            var clone = new ResetAzContainerServiceManagedClusterServicePrincipalProfile_Reset();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedClustersResetServicePrincipalProfile' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ManagedClustersResetServicePrincipalProfile(SubscriptionId, ResourceGroupName, ResourceName, Parameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ResourceName=ResourceName,body=Parameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzContainerServiceManagedClusterServicePrincipalProfile_Reset" /> cmdlet
        /// class.
        /// </summary>
        public ResetAzContainerServiceManagedClusterServicePrincipalProfile_Reset()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, body=Parameter })
                    {
