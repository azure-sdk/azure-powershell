...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByManagedCluster=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/loadBalancers"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerServiceLoadBalancer_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Description(@"Gets a list of load balancers in the specified managed cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/loadBalancers", ApiVersion = "2025-01-02-preview")]
    public partial class GetAzContainerServiceLoadBalancer_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.ILoadBalancerListResult">Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.ILoadBalancerListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.ILoadBalancerListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzContainerServiceLoadBalancer_List" /> cmdlet class.
        /// </summary>
        public GetAzContainerServiceLoadBalancer_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LoadBalancersListByManagedCluster(SubscriptionId, ResourceGroupName, ResourceName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250102Preview.ILoadBalancerListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LoadBalancersListByManagedCluster_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
