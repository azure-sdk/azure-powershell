...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IAgentPool _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.AgentPool();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Artifact streaming speeds up the cold-start of containers on a node through on-demand image loading. To use this feature, container images must also enable artifact streaming on ACR. If not specified, the default is false.")]
        ...
        public global::System.Management.Automation.SwitchParameter ArtifactStreamingProfileEnabled { get => _parametersBody.ArtifactStreamingProfileEnabled ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.ArtifactStreamingProfileEnabled = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "AKS will associate the specified agent pool with the Capacity Reservation Group.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a daemonset along with host services to sync custom certificate authorities from user-provided list of base64 encoded certificates into node trust stores. Defaults to false.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter EnableCustomCaTrust { get => _parametersBody.EnableCustomCaTrust ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.EnableCustomCaTrust = value; }
        ...
        /// value is 31.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The Gateway agent pool associates one public IPPrefix for each static egress gateway to provide public egress. The size of Public IPPrefix should be selected by the user. Each node in the agent pool is assigned with one IP from the IPPrefix. The IPPrefix size thus serves as a cap on the size of the Gateway agent pool. Due to Azure public IPPrefix size limitation, the valid value range is [28, 31] (/31 = 2 nodes/IPs, /30 = 4 nodes/IPs, /29 = 8 nodes/IPs, /28 = 16 nodes/IPs). The default value is 31.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int GatewayProfilePublicIPPrefixSize { get => _parametersBody.GatewayProfilePublicIPPrefixSize ?? default(int); set => _parametersBody.GatewayProfilePublicIPPrefixSize = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Whether to install GPU drivers. When it's not specified, default is Install.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.GpuDriver))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.GpuDriver GpuProfileDriver { get => _parametersBody.GpuProfileDriver ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.GpuDriver)""); set => _parametersBody.GpuProfileDriver = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.DriverType))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.DriverType GpuProfileDriverType { get => _parametersBody.GpuProfileDriverType ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.DriverType)""); set => _parametersBody.GpuProfileDriverType = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Cache max TTL in seconds. See [cache plugin](https://coredns.io/plugins/cache) for more information.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int KubeDnsOverrideCacheDurationInSecond { get => _parametersBody.KubeDnsOverrideCacheDurationInSecond ?? default(int); set => _parametersBody.KubeDnsOverrideCacheDurationInSecond = value; }

        /// <summary>Destination server for DNS queries to be forwarded from localDNS.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Destination server for DNS queries to be forwarded from localDNS.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination KubeDnsOverrideForwardDestination { get => _parametersBody.KubeDnsOverrideForwardDestination ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination)""); set => _parametersBody.KubeDnsOverrideForwardDestination = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Forward policy for selecting upstream DNS server. See [forward plugin](https://coredns.io/plugins/forward) for more information.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy KubeDnsOverrideForwardPolicy { get => _parametersBody.KubeDnsOverrideForwardPolicy ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy)""); set => _parametersBody.KubeDnsOverrideForwardPolicy = value; }

        /// <summary>
        /// Maximum number of concurrent queries. See [forward plugin](https://coredns.io/plugins/forward) for more information.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of concurrent queries. See [forward plugin](https://coredns.io/plugins/forward) for more information.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int KubeDnsOverrideMaxConcurrent { get => _parametersBody.KubeDnsOverrideMaxConcurrent ?? default(int); set => _parametersBody.KubeDnsOverrideMaxConcurrent = value; }

        /// <summary>
        /// Enforce TCP or prefer UDP protocol for connections from localDNS to upstream DNS server.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Enforce TCP or prefer UDP protocol for connections from localDNS to upstream DNS server.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol KubeDnsOverrideProtocol { get => _parametersBody.KubeDnsOverrideProtocol ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol)""); set => _parametersBody.KubeDnsOverrideProtocol = value; }

        /// <summary>Log level for DNS queries in localDNS.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Log level for DNS queries in localDNS.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging KubeDnsOverrideQueryLogging { get => _parametersBody.KubeDnsOverrideQueryLogging ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging)""); set => _parametersBody.KubeDnsOverrideQueryLogging = value; }

        /// <summary>
        /// Policy for serving stale data. See [cache plugin](https://coredns.io/plugins/cache) for more information.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Policy for serving stale data. See [cache plugin](https://coredns.io/plugins/cache) for more information.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale KubeDnsOverrideServeStale { get => _parametersBody.KubeDnsOverrideServeStale ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale)""); set => _parametersBody.KubeDnsOverrideServeStale = value; }

        /// <summary>
        /// Serve stale duration in seconds. See [cache plugin](https://coredns.io/plugins/cache) for more information.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Serve stale duration in seconds. See [cache plugin](https://coredns.io/plugins/cache) for more information.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int KubeDnsOverrideServeStaleDurationInSecond { get => _parametersBody.KubeDnsOverrideServeStaleDurationInSecond ?? default(int); set => _parametersBody.KubeDnsOverrideServeStaleDurationInSecond = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies the default seccomp profile applied to all workloads. If not specified, 'Unconfined' will be used by default.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.SeccompDefault))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.SeccompDefault KubeletConfigSeccompDefault { get => _parametersBody.KubeletConfigSeccompDefault ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.SeccompDefault)""); set => _parametersBody.KubeletConfigSeccompDefault = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.ISysctlConfig LinuxOSConfigSysctl { get => _parametersBody.LinuxOSConfigSysctl ?? null /* object */; set => _parametersBody.LinuxOSConfigSysctl = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Mode of enablement for localDNS.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsMode))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsMode LocalDnsProfileMode { get => _parametersBody.LocalDnsProfileMode ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsMode)""); set => _parametersBody.LocalDnsProfileMode = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A base64-encoded string which will be written to /etc/motd after decoding. This allows customization of the message of the day for Linux nodes. It must not be specified for Windows nodes. It must be a static string (i.e., will be printed raw and not be executed as a script).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MessageOfTheDay { get => _parametersBody.MessageOfTheDay ?? null; set => _parametersBody.MessageOfTheDay = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The port ranges that are allowed to access. The specified ranges are allowed to overlap.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IPortRange[] NetworkProfileAllowedHostPort { get => _parametersBody.NetworkProfileAllowedHostPort ?? null /* arrayOf */; set => _parametersBody.NetworkProfileAllowedHostPort = value; }

        /// <summary>
        /// The IDs of the application security groups which agent pool will associate when created.
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The IDs of the application security groups which agent pool will associate when created.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] NetworkProfileApplicationSecurityGroup { get => _parametersBody.NetworkProfileApplicationSecurityGroup ?? null /* arrayOf */; set => _parametersBody.NetworkProfileApplicationSecurityGroup = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IIPTag[] NetworkProfileNodePublicIPTag { get => _parametersBody.NetworkProfileNodePublicIPTag ?? null /* arrayOf */; set => _parametersBody.NetworkProfileNodePublicIPTag = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] NodeInitializationTaint { get => _parametersBody.NodeInitializationTaint ?? null /* arrayOf */; set => _parametersBody.NodeInitializationTaint = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IManagedClusterAgentPoolProfilePropertiesNodeLabels NodeLabel { get => _parametersBody.NodeLabel ?? null /* object */; set => _parametersBody.NodeLabel = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies the OS SKU used by the agent pool. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Both patch version <major.minor.patch> and <major.minor> are supported. When <major.minor> is specified, the latest supported patch version is chosen automatically. Updating the agent pool with the same <major.minor> once it has been created will not trigger an upgrade, even if a newer patch version is available. As a best practice, you should upgrade all node pools in an AKS cluster to the same Kubernetes version. The node pool version must have the same major version as the control plane. The node pool minor version must be within two minor versions of the control plane version. The node pool version cannot be greater than the control plane version. For more information see [upgrading a node pool](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#upgrade-a-node-pool).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The IP allocation mode for pods in the agent pool. Must be used with podSubnetId. The default is 'DynamicIndividual'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.PodIPAllocationMode))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.PodIPAllocationMode PodIPAllocationMode { get => _parametersBody.PodIPAllocationMode ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.PodIPAllocationMode)""); set => _parametersBody.PodIPAllocationMode = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifications on how to auto-scale the VirtualMachines agent pool within a predefined size range.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.IAny ScaleAutoscale { get => _parametersBody.ScaleAutoscale ?? null /* object */; set => _parametersBody.ScaleAutoscale = value; }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifications on how to scale the VirtualMachines agent pool to a fixed size.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IManualScaleProfile[] ScaleManual { get => _parametersBody.ScaleManual ?? null /* arrayOf */; set => _parametersBody.ScaleManual = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Secure Boot is a feature of Trusted Launch which ensures that only signed operating systems and drivers can boot. For more details, see aka.ms/aks/trustedlaunch. If not specified, the default is false.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter SecurityProfileEnableSecureBoot { get => _parametersBody.SecurityProfileEnableSecureBoot ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.SecurityProfileEnableSecureBoot = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "vTPM is a Trusted Launch feature for configuring a dedicated secure vault for keys and measurements held locally on the node. For more details, see aka.ms/aks/trustedlaunch. If not specified, the default is false.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter SecurityProfileEnableVtpm { get => _parametersBody.SecurityProfileEnableVtpm ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.SecurityProfileEnableVtpm = value; }

        /// <summary>SSH access method of an agent pool.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "SSH access method of an agent pool.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.AgentPoolSshAccess))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.AgentPoolSshAccess SecurityProfileSshAccess { get => _parametersBody.SecurityProfileSshAccess ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.AgentPoolSshAccess)""); set => _parametersBody.SecurityProfileSshAccess = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IManagedClusterAgentPoolProfilePropertiesTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int UpgradeSettingDrainTimeoutInMinute { get => _parametersBody.UpgradeSettingDrainTimeoutInMinute ?? default(int); set => _parametersBody.UpgradeSettingDrainTimeoutInMinute = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is maxSurge. This must always be greater than or equal to maxSurge. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UpgradeSettingMaxBlockedNode { get => _parametersBody.UpgradeSettingMaxBlockedNode ?? null; set => _parametersBody.UpgradeSettingMaxBlockedNode = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is 10%. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This can either be set to an integer (e.g. '1') or a percentage (e.g. '5%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is 0. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UpgradeSettingMaxUnavailable { get => _parametersBody.UpgradeSettingMaxUnavailable ?? null; set => _parametersBody.UpgradeSettingMaxUnavailable = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The amount of time (in minutes) to wait after draining a node and before reimaging it and moving on to next node. If not specified, the default is 0 minutes.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int UpgradeSettingNodeSoakDurationInMinute { get => _parametersBody.UpgradeSettingNodeSoakDurationInMinute ?? default(int); set => _parametersBody.UpgradeSettingNodeSoakDurationInMinute = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.UndrainableNodeBehavior))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.UndrainableNodeBehavior UpgradeSettingUndrainableNodeBehavior { get => _parametersBody.UpgradeSettingUndrainableNodeBehavior ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.UndrainableNodeBehavior)""); set => _parametersBody.UpgradeSettingUndrainableNodeBehavior = value; }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The status of nodes in a VirtualMachines agent pool.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Models.Api20250302Preview.IVirtualMachineNodes[] VirtualMachineNodesStatus { get => _parametersBody.VirtualMachineNodesStatus ?? null /* arrayOf */; set => _parametersBody.VirtualMachineNodesStatus = value; }
        ...
        SerializedName = @"cacheDurationInSeconds",
        PossibleTypes = new [] { typeof(int) })]
        public int VnetDnsOverrideCacheDurationInSecond { get => _parametersBody.VnetDnsOverrideCacheDurationInSecond ?? default(int); set => _parametersBody.VnetDnsOverrideCacheDurationInSecond = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination) })]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination VnetDnsOverrideForwardDestination { get => _parametersBody.VnetDnsOverrideForwardDestination ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardDestination)""); set => _parametersBody.VnetDnsOverrideForwardDestination = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy) })]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy VnetDnsOverrideForwardPolicy { get => _parametersBody.VnetDnsOverrideForwardPolicy ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsForwardPolicy)""); set => _parametersBody.VnetDnsOverrideForwardPolicy = value; }
        ...
        SerializedName = @"maxConcurrent",
        PossibleTypes = new [] { typeof(int) })]
        public int VnetDnsOverrideMaxConcurrent { get => _parametersBody.VnetDnsOverrideMaxConcurrent ?? default(int); set => _parametersBody.VnetDnsOverrideMaxConcurrent = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol) })]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol VnetDnsOverrideProtocol { get => _parametersBody.VnetDnsOverrideProtocol ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsProtocol)""); set => _parametersBody.VnetDnsOverrideProtocol = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging) })]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging VnetDnsOverrideQueryLogging { get => _parametersBody.VnetDnsOverrideQueryLogging ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsQueryLogging)""); set => _parametersBody.VnetDnsOverrideQueryLogging = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale) })]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale VnetDnsOverrideServeStale { get => _parametersBody.VnetDnsOverrideServeStale ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Support.LocalDnsServeStale)""); set => _parametersBody.VnetDnsOverrideServeStale = value; }
        ...
        SerializedName = @"serveStaleDurationInSeconds",
        PossibleTypes = new [] { typeof(int) })]
        public int VnetDnsOverrideServeStaleDurationInSecond { get => _parametersBody.VnetDnsOverrideServeStaleDurationInSecond ?? default(int); set => _parametersBody.VnetDnsOverrideServeStaleDurationInSecond = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The default value is false. Outbound NAT can only be disabled if the cluster outboundType is NAT Gateway and the Windows agent pool does not have node public IP enabled.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter WindowProfileDisableOutboundNat { get => _parametersBody.WindowProfileDisableOutboundNat ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.WindowProfileDisableOutboundNat = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AgentPoolsCreateOrUpdate(SubscriptionId, ResourceGroupName, ResourceName, Name, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, _parametersBody, onOk, onDefault, this, Pipeline);
