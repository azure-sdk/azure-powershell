...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/managedclustersnapshots"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzContainerServiceManagedClusterSnapshot_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Description(@"Gets a list of managed cluster snapshots in the specified subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerService.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/managedclustersnapshots", ApiVersion = "2024-09-02-preview")]
    public partial class GetAzContainerServiceManagedClusterSnapshot_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerService.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzContainerServiceManagedClusterSnapshot_List" /> cmdlet class.
        /// </summary>
        public GetAzContainerServiceManagedClusterSnapshot_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ManagedClusterSnapshotsList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ManagedClusterSnapshotsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
