...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwarecloudsimple/update-azvmwarecloudsimplededicatedcloudservice
schema: 2.0.0
---

# Update-AzVMwareCloudSimpleDedicatedCloudService
...
```
Update-AzVMwareCloudSimpleDedicatedCloudService -Name <String> -ResourceGroupName <String>
...
```
Update-AzVMwareCloudSimpleDedicatedCloudService -InputObject <IVMwareCloudSimpleIdentity> [-Tag <Hashtable>]
