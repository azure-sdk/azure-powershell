...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwarecloudsimple/get-azvmwarecloudsimplededicatedcloudnode
schema: 2.0.0
---

# Get-AzVMwareCloudSimpleDedicatedCloudNode
...
### List (Default)
```
Get-AzVMwareCloudSimpleDedicatedCloudNode [-SubscriptionId <String[]>] [-Filter <String>]
 [-SkipToken <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzVMwareCloudSimpleDedicatedCloudNode -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareCloudSimpleDedicatedCloudNode -InputObject <IVMwareCloudSimpleIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List1
```
Get-AzVMwareCloudSimpleDedicatedCloudNode -ResourceGroupName <String> [-SubscriptionId <String[]>]
