...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwarecloudsimple/remove-azvmwarecloudsimplededicatedcloudservice
schema: 2.0.0
---

# Remove-AzVMwareCloudSimpleDedicatedCloudService
...
### Delete (Default)
```
Remove-AzVMwareCloudSimpleDedicatedCloudService -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareCloudSimpleDedicatedCloudService -InputObject <IVMwareCloudSimpleIdentity>
