...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview
{
    ...
    public partial class GroupConnectivityInformation :
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformation,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal.CustomerVisibleFqdn { get => this._customerVisibleFqdn; set { {_customerVisibleFqdn = value;} } }

        /// <summary>Internal Acessors for GroupId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for InternalFqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal.InternalFqdn { get => this._internalFqdn; set { {_internalFqdn = value;} } }

        /// <summary>Internal Acessors for MemberName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal.MemberName { get => this._memberName; set { {_memberName = value;} } }

        /// <summary>Internal Acessors for PrivateLinkServiceArmRegion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal.PrivateLinkServiceArmRegion { get => this._privateLinkServiceArmRegion; set { {_privateLinkServiceArmRegion = value;} } }

        /// <summary>Internal Acessors for RedirectMapId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.IGroupConnectivityInformationInternal.RedirectMapId { get => this._redirectMapId; set { {_redirectMapId = value;} } }
