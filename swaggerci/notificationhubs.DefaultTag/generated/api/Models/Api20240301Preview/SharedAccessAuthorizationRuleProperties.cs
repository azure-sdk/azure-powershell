...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview
{
    ...
    public partial class SharedAccessAuthorizationRuleProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal.ClaimType { get => this._claimType; set { {_claimType = value;} } }

        /// <summary>Internal Acessors for ClaimValue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal.ClaimValue { get => this._claimValue; set { {_claimValue = value;} } }

        /// <summary>Internal Acessors for CreatedTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal.CreatedTime { get => this._createdTime; set { {_createdTime = value;} } }

        /// <summary>Internal Acessors for KeyName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal.KeyName { get => this._keyName; set { {_keyName = value;} } }

        /// <summary>Internal Acessors for ModifiedTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal.ModifiedTime { get => this._modifiedTime; set { {_modifiedTime = value;} } }

        /// <summary>Internal Acessors for Revision</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.ISharedAccessAuthorizationRulePropertiesInternal.Revision { get => this._revision; set { {_revision = value;} } }
