...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.NotificationHubsRp.Models.Api20240301Preview.INotificationHubPatchParametersTags]))]
