...
Update-AzNotificationHubsRpNotificationHub -NamespaceName <String> -NotificationHubName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-ApnsCertificate <String>]
 ...
 [-Name <String>] [-PackageSid <String>] [-PrivateKey <String>] [-ProjectId <String>]
...
Update-AzNotificationHubsRpNotificationHub -InputObject <INotificationHubsRpIdentity>
 [-ApnsCertificate <String>] [-ApnsCredentialPropertiesCertificateKey <String>]
 [-ApnsCredentialPropertiesEndpoint <String>] [-ApnsCredentialPropertiesThumbprint <String>] [-AppId <String>]
 [-AppName <String>] [-AppSecret <String>] [-AuthTokenUrl <String>] [-BaiduApiKey <String>]
 [-BaiduEndPoint <String>] [-BaiduSecretKey <String>] [-ClientEmail <String>] [-ClientId <String>]
 [-ClientSecret <String>] [-GcmEndpoint <String>] [-GoogleApiKey <String>] [-KeyId <String>]
 [-MpnsCertificate <String>] [-MpnsCredentialPropertiesCertificateKey <String>]
 [-MpnsCredentialPropertiesThumbprint <String>] [-Name <String>] [-PackageSid <String>] [-PrivateKey <String>]
 [-ProjectId <String>] [-RegistrationTtl <String>] [-SecretKey <String>] [-SkuCapacity <Int32>]
 [-SkuFamily <String>] [-SkuName <SkuName>] [-SkuSize <String>] [-SkuTier <String>] [-Subject <String>]
 [-Tag <Hashtable>] [-Token <String>] [-VapidPrivateKey <String>] [-VapidPublicKey <String>]
 [-WindowsLiveEndpoint <String>] [-WnsCertificate <String>] [-WnsCredentialPropertiesCertificateKey <String>]
 [-XiaomiCredentialPropertiesEndpoint <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
