...
online version: https://learn.microsoft.com/powershell/module/az.notificationhubsrp/remove-aznotificationhubsrpnotificationhubauthorizationrule
schema: 2.0.0
---

# Remove-AzNotificationHubsRpNotificationHubAuthorizationRule
...
### Delete (Default)
```
Remove-AzNotificationHubsRpNotificationHubAuthorizationRule -AuthorizationRuleName <String>
...
### DeleteViaIdentity
```
Remove-AzNotificationHubsRpNotificationHubAuthorizationRule -InputObject <INotificationHubsRpIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
