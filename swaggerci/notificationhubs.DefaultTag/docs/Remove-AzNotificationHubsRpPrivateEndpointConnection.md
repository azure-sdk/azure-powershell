...
online version: https://learn.microsoft.com/powershell/module/az.notificationhubsrp/remove-aznotificationhubsrpprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzNotificationHubsRpPrivateEndpointConnection -Name <String> -NamespaceName <String>
...
### DeleteViaIdentity
```
Remove-AzNotificationHubsRpPrivateEndpointConnection -InputObject <INotificationHubsRpIdentity>
