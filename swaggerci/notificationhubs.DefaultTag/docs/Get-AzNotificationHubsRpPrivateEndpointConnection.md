...
online version: https://learn.microsoft.com/powershell/module/az.notificationhubsrp/get-aznotificationhubsrpprivateendpointconnection
schema: 2.0.0
---

# Get-AzNotificationHubsRpPrivateEndpointConnection
...
### List (Default)
```
Get-AzNotificationHubsRpPrivateEndpointConnection -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzNotificationHubsRpPrivateEndpointConnection -Name <String> -NamespaceName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzNotificationHubsRpPrivateEndpointConnection -InputObject <INotificationHubsRpIdentity>
