...
online version: https://learn.microsoft.com/powershell/module/az.notificationhubsrp/new-aznotificationhubsrpnamespacekey
schema: 2.0.0
---

# New-AzNotificationHubsRpNamespaceKey
...
```
New-AzNotificationHubsRpNamespaceKey -AuthorizationRuleName <String> -NamespaceName <String>
 -ResourceGroupName <String> -PolicyKey <PolicyKeyType> [-SubscriptionId <String>]
...
```
New-AzNotificationHubsRpNamespaceKey -InputObject <INotificationHubsRpIdentity>
 -Parameter <IPolicyKeyResource> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzNotificationHubsRpNamespaceKey -InputObject <INotificationHubsRpIdentity> -PolicyKey <PolicyKeyType>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
