...
New-AzExternalIdentitiesConfigurationB2CTenant -ResourceGroupName <String> -ResourceName <String>
 ...
 [-CreateTenantPropertyDisplayName <String>] [-CreateTenantPropertyIsGoLocalTenant]
 [-SkuName <B2CResourceSkuname>] [-SkuTier <B2CResourceSkutier>] [-Tag <Hashtable>]
...
### -CreateTenantPropertyIsGoLocalTenant
