...
### List (Default)
```
Get-AzBillingInvoiceSection -BillingAccountName <String> -BillingProfileName <String> [-Count]
...
### GetViaIdentity
```
Get-AzBillingInvoiceSection -InputObject <IBillingIdentity> [-IncludeDeleted] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
