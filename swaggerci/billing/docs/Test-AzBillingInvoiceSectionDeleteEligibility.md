...
online version: https://learn.microsoft.com/powershell/module/az.billing/test-azbillinginvoicesectiondeleteeligibility
schema: 2.0.0
---

# Test-AzBillingInvoiceSectionDeleteEligibility
...
### Validate (Default)
```
Test-AzBillingInvoiceSectionDeleteEligibility -BillingAccountName <String> -BillingProfileName <String>
 -InvoiceSectionName <String> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ValidateViaIdentity
```
Test-AzBillingInvoiceSectionDeleteEligibility -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>]
