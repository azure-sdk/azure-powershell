...
### List1 (Default)
```
Get-AzBillingCustomer -BillingAccountName <String> [-Count] [-Expand <String>] [-Filter <String>]
...
### Get
```
Get-AzBillingCustomer -BillingAccountName <String> -BillingProfileName <String> -Name <String> [-Count]
...
### GetViaIdentity
```
Get-AzBillingCustomer -InputObject <IBillingIdentity> [-Count] [-Filter <String>] [-OrderBy <String>]
 [-Search <String>] [-Skip <Int64>] [-Top <Int64>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List
```
Get-AzBillingCustomer -BillingAccountName <String> -BillingProfileName <String> [-Count] [-Expand <String>]
 [-Filter <String>] [-OrderBy <String>] [-Search <String>] [-Skip <Int64>] [-Top <Int64>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
