...
### Get (Default)
```
Get-AzBillingProperty [-SubscriptionId <String[]>] [-IncludeBillingCountry] [-IncludeTransitionStatus]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBillingProperty -InputObject <IBillingIdentity> [-IncludeBillingCountry] [-IncludeTransitionStatus]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
