...
online version: https://learn.microsoft.com/powershell/module/az.billing/confirm-azbillingaccounttransition
schema: 2.0.0
---

# Confirm-AzBillingAccountTransition
...
### Confirm (Default)
```
Confirm-AzBillingAccountTransition -BillingAccountName <String> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ConfirmViaIdentity
```
Confirm-AzBillingAccountTransition -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
