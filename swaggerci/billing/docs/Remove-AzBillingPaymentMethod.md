...
online version: https://learn.microsoft.com/powershell/module/az.billing/remove-azbillingpaymentmethod
schema: 2.0.0
---

# Remove-AzBillingPaymentMethod
...
### Delete (Default)
```
Remove-AzBillingPaymentMethod -Name <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzBillingPaymentMethod -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [-PassThru]
