...
online version: https://learn.microsoft.com/powershell/module/az.billing/remove-azbillingsubscription
schema: 2.0.0
---

# Remove-AzBillingSubscription
...
### Delete (Default)
```
Remove-AzBillingSubscription -BillingAccountName <String> -Name <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzBillingSubscription -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
