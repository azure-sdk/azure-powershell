...
online version: https://learn.microsoft.com/powershell/module/az.billing/get-azbillingrecipienttransfer
schema: 2.0.0
---
...
### List (Default)
```
Get-AzBillingRecipientTransfer [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
