...
### List (Default)
```
Get-AzBillingProfile -BillingAccountName <String> [-Count] [-Filter <String>] [-IncludeDeleted]
...
### Get
```
Get-AzBillingProfile -BillingAccountName <String> -Name <String> [-Count] [-Filter <String>] [-IncludeDeleted]
 [-OrderBy <String>] [-Search <String>] [-Skip <Int64>] [-Top <Int64>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzBillingProfile -InputObject <IBillingIdentity> [-Count] [-Filter <String>] [-IncludeDeleted]
 [-OrderBy <String>] [-Search <String>] [-Skip <Int64>] [-Top <Int64>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
