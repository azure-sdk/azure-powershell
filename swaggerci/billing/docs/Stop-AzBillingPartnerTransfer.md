...
online version: https://learn.microsoft.com/powershell/module/az.billing/stop-azbillingpartnertransfer
schema: 2.0.0
---

# Stop-AzBillingPartnerTransfer
...
### Cancel (Default)
```
Stop-AzBillingPartnerTransfer -BillingAccountName <String> -CustomerName <String> -TransferName <String>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzBillingPartnerTransfer -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [-Confirm]
