...
Module Guid: ca9e73fe-f7fc-45f7-9cab-1238394fdd8c
...
### [Get-AzBillingPartnerTransfer](Get-AzBillingPartnerTransfer.md)
...
### [Get-AzBillingRecipientTransfer](Get-AzBillingRecipientTransfer.md)
Gets a transfer request by ID.
The caller must be the recipient of the transfer request.
...
### [Get-AzBillingTransfer](Get-AzBillingTransfer.md)
Gets a transfer request by ID.
The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

### [Invoke-AzBillingAcceptRecipientTransfer](Invoke-AzBillingAcceptRecipientTransfer.md)
Accepts a transfer request.

### [Invoke-AzBillingDeclineRecipientTransfer](Invoke-AzBillingDeclineRecipientTransfer.md)
...
### [Invoke-AzBillingInitiatePartnerTransfer](Invoke-AzBillingInitiatePartnerTransfer.md)
Sends a request to a user in a customer's billing account to transfer billing ownership of their subscriptions.
The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

### [Invoke-AzBillingInitiateTransfer](Invoke-AzBillingInitiateTransfer.md)
...
### [Stop-AzBillingPartnerTransfer](Stop-AzBillingPartnerTransfer.md)
Cancels a transfer request.
The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

### [Stop-AzBillingTransfer](Stop-AzBillingTransfer.md)
Cancels a transfer request.
The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.
...
### [Test-AzBillingRecipientTransfer](Test-AzBillingRecipientTransfer.md)
