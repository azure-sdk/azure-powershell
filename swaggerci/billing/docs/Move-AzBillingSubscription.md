...
```
Move-AzBillingSubscription -BillingAccountName <String> -Name <String> -DestinationInvoiceSectionId <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Move
```
Move-AzBillingSubscription -BillingAccountName <String> -Name <String> -Body <IMoveBillingSubscriptionRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MoveViaIdentity
```
Move-AzBillingSubscription -InputObject <IBillingIdentity> -Body <IMoveBillingSubscriptionRequest>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
