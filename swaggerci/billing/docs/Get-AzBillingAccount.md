...
### List (Default)
```
Get-AzBillingAccount [-Count] [-ExcludeAccountsWithoutBillingProfile] [-Filter <String>]
 [-IncludeAllBillingAccount] [-IncludeDeletedBillingAccount] [-IncludeTenantAccount] [-LegalOwnerOid <String>]
 [-LegalOwnerTid <String>] [-OrderBy <String>] [-Search <String>] [-Skip <Int64>] [-Top <Int64>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzBillingAccount -Name <String> [-Expand <String>] [-IncludeDeletedBillingAccount]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBillingAccount -InputObject <IBillingIdentity> [-Expand <String>] [-IncludeDeletedBillingAccount]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
