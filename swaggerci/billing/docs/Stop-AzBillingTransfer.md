...
online version: https://learn.microsoft.com/powershell/module/az.billing/stop-azbillingtransfer
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzBillingTransfer -BillingAccountName <String> -BillingProfileName <String> -InvoiceSectionName <String>
