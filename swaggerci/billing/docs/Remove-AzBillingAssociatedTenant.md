...
online version: https://learn.microsoft.com/powershell/module/az.billing/remove-azbillingassociatedtenant
schema: 2.0.0
---

# Remove-AzBillingAssociatedTenant
...
### Delete (Default)
```
Remove-AzBillingAssociatedTenant -BillingAccountName <String> -Name <String> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzBillingAssociatedTenant -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [-AsJob]
