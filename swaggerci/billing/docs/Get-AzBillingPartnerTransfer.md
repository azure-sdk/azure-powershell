...
online version: https://learn.microsoft.com/powershell/module/az.billing/get-azbillingpartnertransfer
schema: 2.0.0
---

# Get-AzBillingPartnerTransfer
...
### List (Default)
```
Get-AzBillingPartnerTransfer -BillingAccountName <String> -CustomerName <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzBillingPartnerTransfer -BillingAccountName <String> -CustomerName <String> -TransferName <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBillingPartnerTransfer -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
