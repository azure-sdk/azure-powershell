...
online version: https://learn.microsoft.com/powershell/module/az.billing/remove-azbillinginvoicesection
schema: 2.0.0
---

# Remove-AzBillingInvoiceSection
...
### Delete (Default)
```
Remove-AzBillingInvoiceSection -BillingAccountName <String> -BillingProfileName <String> -Name <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzBillingInvoiceSection -InputObject <IBillingIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
