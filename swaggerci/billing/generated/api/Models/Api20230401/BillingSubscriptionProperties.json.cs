...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401
{
    ...
    public partial class BillingSubscriptionProperties
    {
        ...
        internal BillingSubscriptionProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_beneficiary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("beneficiary"), out var __jsonBeneficiary) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Beneficiary.FromJson(__jsonBeneficiary) : Beneficiary;}
            {_enrollmentAccountSubscriptionDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("enrollmentAccountSubscriptionDetails"), out var __jsonEnrollmentAccountSubscriptionDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.EnrollmentAccountSubscriptionDetails.FromJson(__jsonEnrollmentAccountSubscriptionDetails) : EnrollmentAccountSubscriptionDetail;}
            {_nextBillingCycleDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("nextBillingCycleDetails"), out var __jsonNextBillingCycleDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.NextBillingCycleDetails.FromJson(__jsonNextBillingCycleDetails) : NextBillingCycleDetail;}
            {_reseller = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("reseller"), out var __jsonReseller) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Reseller.FromJson(__jsonReseller) : Reseller;}
            {_renewalTermDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("renewalTermDetails"), out var __jsonRenewalTermDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.RenewalTermDetails.FromJson(__jsonRenewalTermDetails) : RenewalTermDetail;}
            {_systemOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("systemOverrides"), out var __jsonSystemOverrides) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.SystemOverrides.FromJson(__jsonSystemOverrides) : SystemOverride;}
            ...
            {_consumptionCostCenter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("consumptionCostCenter"), out var __jsonConsumptionCostCenter) ? (string)__jsonConsumptionCostCenter : (string)ConsumptionCostCenter;}
            ...
            {_enrollmentAccountId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("enrollmentAccountId"), out var __jsonEnrollmentAccountId) ? (string)__jsonEnrollmentAccountId : (string)EnrollmentAccountId;}
            {_enrollmentAccountDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("enrollmentAccountDisplayName"), out var __jsonEnrollmentAccountDisplayName) ? (string)__jsonEnrollmentAccountDisplayName : (string)EnrollmentAccountDisplayName;}
            ...
            {_offerId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("offerId"), out var __jsonOfferId) ? (string)__jsonOfferId : (string)OfferId;}
            {_productCategory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("productCategory"), out var __jsonProductCategory) ? (string)__jsonProductCategory : (string)ProductCategory;}
            ...
            {_quantity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNumber>("quantity"), out var __jsonQuantity) ? (long?)__jsonQuantity : Quantity;}
            ...
            {_suspensionReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("suspensionReasons"), out var __jsonSuspensionReasons) ? If( __jsonSuspensionReasons as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.SubscriptionStatusReason[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.SubscriptionStatusReason) (__u is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString __t ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.SubscriptionStatusReason)(__t.ToString()) : ((Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.SubscriptionStatusReason)""))) ))() : null : SuspensionReason;}
            {_suspensionReasonDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("suspensionReasonDetails"), out var __jsonSuspensionReasonDetails) ? If( __jsonSuspensionReasonDetails as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionStatusDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionStatusDetails) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.BillingSubscriptionStatusDetails.FromJson(__p) )) ))() : null : SuspensionReasonDetail;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
