...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401
{
    ...
    public partial class BillingSubscriptionProperties
    {
        ...
        internal BillingSubscriptionProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_lastMonthCharge = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("lastMonthCharges"), out var __jsonLastMonthCharges) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonLastMonthCharges) : LastMonthCharge;}
            {_monthToDateCharge = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("monthToDateCharges"), out var __jsonMonthToDateCharges) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonMonthToDateCharges) : MonthToDateCharge;}
