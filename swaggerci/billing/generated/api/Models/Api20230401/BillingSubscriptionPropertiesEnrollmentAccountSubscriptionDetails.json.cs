...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401
{
    ...
    public partial class BillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject into a new instance of <see cref="BillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal BillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            __enrollmentAccountSubscriptionDetails = new Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.EnrollmentAccountSubscriptionDetails(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IBillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json ? new BillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails" /> into a <see
        ...
        /// <returns>
        /// a serialized instance of <see cref="BillingSubscriptionPropertiesEnrollmentAccountSubscriptionDetails" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode serializationMode)
        {
            ...
            __enrollmentAccountSubscriptionDetails?.ToJson(container, serializationMode);
