...
PRODUCTDETAIL <IProductDetails[]>: Request parameters to accept transfer.
  ...
  [ProductType <ProductType?>]: Type of the product that is transferred.
.Link
https://learn.microsoft.com/powershell/module/az.billing/test-azbillingrecipienttransfer
#>
function Test-AzBillingRecipientTransfer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IValidateTransferResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Validate = 'Az.Billing.private\Test-AzBillingRecipientTransfer_Validate';
            ValidateExpanded = 'Az.Billing.private\Test-AzBillingRecipientTransfer_ValidateExpanded';
            ValidateViaIdentity = 'Az.Billing.private\Test-AzBillingRecipientTransfer_ValidateViaIdentity';
            ValidateViaIdentityExpanded = 'Az.Billing.private\Test-AzBillingRecipientTransfer_ValidateViaIdentityExpanded';
        }
