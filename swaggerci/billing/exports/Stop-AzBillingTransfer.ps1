...
.Link
https://learn.microsoft.com/powershell/module/az.billing/stop-azbillingtransfer
#>
function Stop-AzBillingTransfer {
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.Billing.private\Stop-AzBillingTransfer_Cancel';
            CancelViaIdentity = 'Az.Billing.private\Stop-AzBillingTransfer_CancelViaIdentity';
        }
