...
.Link
https://learn.microsoft.com/powershell/module/az.billing/get-azbillingpartnertransfer
#>
function Get-AzBillingPartnerTransfer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Billing.private\Get-AzBillingPartnerTransfer_Get';
            GetViaIdentity = 'Az.Billing.private\Get-AzBillingPartnerTransfer_GetViaIdentity';
            List = 'Az.Billing.private\Get-AzBillingPartnerTransfer_List';
        }
