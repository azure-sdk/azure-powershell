...
INPUTOBJECT <IBillingIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID that uniquely identifies a billing subscription.
.Link
https://learn.microsoft.com/powershell/module/az.billing/stop-azbillingsubscription
#>
function Stop-AzBillingSubscription {
[OutputType([System.Boolean])]
...
param(
    ...
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CancellationReason])]
    [Microsoft.Azure.PowerShell.Cmdlets.Billing.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CancellationReason]
    # Cancellation reason.
    ${CancellationReason},
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.Billing.private\Stop-AzBillingSubscription_Cancel';
            CancelExpanded = 'Az.Billing.private\Stop-AzBillingSubscription_CancelExpanded';
            CancelViaIdentity = 'Az.Billing.private\Stop-AzBillingSubscription_CancelViaIdentity';
            CancelViaIdentityExpanded = 'Az.Billing.private\Stop-AzBillingSubscription_CancelViaIdentityExpanded';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
