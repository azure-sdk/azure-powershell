...
INPUTOBJECT <IBillingIdentity>: Identity Parameter
  ...
  [TransferName <String>]: The ID that uniquely identifies a transfer request.
.Link
https://learn.microsoft.com/powershell/module/az.billing/invoke-azbillingdeclinerecipienttransfer
#>
function Invoke-AzBillingDeclineRecipientTransfer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IRecipientTransferDetails])]
...
begin {
    try {
        ...
        $mapping = @{
            Decline = 'Az.Billing.private\Invoke-AzBillingDeclineRecipientTransfer_Decline';
            DeclineViaIdentity = 'Az.Billing.private\Invoke-AzBillingDeclineRecipientTransfer_DeclineViaIdentity';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
