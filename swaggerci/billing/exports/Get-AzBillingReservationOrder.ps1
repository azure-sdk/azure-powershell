...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billing/get-azbillingreservationorder
#>
function Get-AzBillingReservationOrder {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IReservationOrder])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Billing.private\Get-AzBillingReservationOrder_Get';
            GetViaIdentity = 'Az.Billing.private\Get-AzBillingReservationOrder_GetViaIdentity';
            List = 'Az.Billing.private\Get-AzBillingReservationOrder_List';
        }
