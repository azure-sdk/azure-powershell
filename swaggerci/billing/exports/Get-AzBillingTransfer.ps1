...
.Link
https://learn.microsoft.com/powershell/module/az.billing/get-azbillingtransfer
#>
function Get-AzBillingTransfer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.ITransferDetails])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Billing.private\Get-AzBillingTransfer_Get';
            GetViaIdentity = 'Az.Billing.private\Get-AzBillingTransfer_GetViaIdentity';
            List = 'Az.Billing.private\Get-AzBillingTransfer_List';
        }
