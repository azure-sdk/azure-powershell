...
.Link
https://learn.microsoft.com/powershell/module/az.billing/get-azbillingrecipienttransfer
#>
function Get-AzBillingRecipientTransfer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Billing.private\Get-AzBillingRecipientTransfer_Get';
            GetViaIdentity = 'Az.Billing.private\Get-AzBillingRecipientTransfer_GetViaIdentity';
            List = 'Az.Billing.private\Get-AzBillingRecipientTransfer_List';
        }
