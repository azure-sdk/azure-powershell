...
.Link
https://learn.microsoft.com/powershell/module/az.billing/remove-azbillingsubscription
#>
function Remove-AzBillingSubscription {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Billing.private\Remove-AzBillingSubscription_Delete';
            DeleteViaIdentity = 'Az.Billing.private\Remove-AzBillingSubscription_DeleteViaIdentity';
        }
