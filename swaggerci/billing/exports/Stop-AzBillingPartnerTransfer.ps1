...
.Link
https://learn.microsoft.com/powershell/module/az.billing/stop-azbillingpartnertransfer
#>
function Stop-AzBillingPartnerTransfer {
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.Billing.private\Stop-AzBillingPartnerTransfer_Cancel';
            CancelViaIdentity = 'Az.Billing.private\Stop-AzBillingPartnerTransfer_CancelViaIdentity';
        }
