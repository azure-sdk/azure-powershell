...
.Link
https://learn.microsoft.com/powershell/module/az.billing/invoke-azbillinginitiatetransfer
#>
function Invoke-AzBillingInitiateTransfer {
...
begin {
    try {
        ...
        $mapping = @{
            Initiate = 'Az.Billing.private\Invoke-AzBillingInitiateTransfer_Initiate';
            InitiateExpanded = 'Az.Billing.private\Invoke-AzBillingInitiateTransfer_InitiateExpanded';
            InitiateViaIdentity = 'Az.Billing.private\Invoke-AzBillingInitiateTransfer_InitiateViaIdentity';
            InitiateViaIdentityExpanded = 'Az.Billing.private\Invoke-AzBillingInitiateTransfer_InitiateViaIdentityExpanded';
        }
