...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview
{
    ...
    public partial class ConnectedClusterProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.AgentVersion { get => this._agentVersion; set { {_agentVersion = value;} } }

        /// <summary>Internal Acessors for ConnectivityStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Support.ConnectivityStatus? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.ConnectivityStatus { get => this._connectivityStatus; set { {_connectivityStatus = value;} } }

        /// <summary>Internal Acessors for KubernetesVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.KubernetesVersion { get => this._kubernetesVersion; set { {_kubernetesVersion = value;} } }

        /// <summary>Internal Acessors for LastConnectivityTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.LastConnectivityTime { get => this._lastConnectivityTime; set { {_lastConnectivityTime = value;} } }

        /// <summary>Internal Acessors for ManagedIdentityCertificateExpirationTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.ManagedIdentityCertificateExpirationTime { get => this._managedIdentityCertificateExpirationTime; set { {_managedIdentityCertificateExpirationTime = value;} } }

        /// <summary>Internal Acessors for Offering</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.Offering { get => this._offering; set { {_offering = value;} } }

        /// <summary>Internal Acessors for TotalCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.TotalCoreCount { get => this._totalCoreCount; set { {_totalCoreCount = value;} } }

        /// <summary>Internal Acessors for TotalNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20220501Preview.IConnectedClusterPropertiesInternal.TotalNodeCount { get => this._totalNodeCount; set { {_totalNodeCount = value;} } }
