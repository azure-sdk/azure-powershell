...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20211001
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="ConnectedClusterList" />
    /// </summary>
    public partial class ConnectedClusterListTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <see cref="sourceValue"/> parameter to the <see cref="ConnectedClusterList"
        /// type/>.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="ConnectedClusterList"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="ConnectedClusterList" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="ConnectedClusterList" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="ConnectedClusterList" />.</param>
        /// <returns>
        /// an instance of <see cref="ConnectedClusterList" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20211001.IConnectedClusterList ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20211001.IConnectedClusterList).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
