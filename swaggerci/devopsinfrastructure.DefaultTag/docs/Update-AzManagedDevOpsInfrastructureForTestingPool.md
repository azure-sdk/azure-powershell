...
online version: https://learn.microsoft.com/powershell/module/az.manageddevopsinfrastructurefortesting/update-azmanageddevopsinfrastructurefortestingpool
schema: 2.0.0
---
...
```
Update-AzManagedDevOpsInfrastructureForTestingPool -Name <String> -ResourceGroupName <String>
...
```
Update-AzManagedDevOpsInfrastructureForTestingPool
 -InputObject <IManagedDevOpsInfrastructureForTestingIdentity> [-AgentProfileKind <String>]
 [-AgentProfileResourcePrediction <IAny>] [-DevCenterProjectResourceId <String>] [-FabricProfileKind <String>]
 [-IdentityType <ManagedServiceIdentityType>] [-IdentityUserAssignedIdentity <Hashtable>]
 [-MaximumConcurrency <Int32>] [-OrganizationProfileKind <String>] [-ProvisioningState <ProvisioningState>]
 [-ResourcePredictionProfileKind <ResourcePredictionsProfileType>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructureForTesting.Models.IAny
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructureForTesting.Support.ManagedServiceIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructureForTesting.Support.ProvisioningState
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructureForTesting.Support.ResourcePredictionsProfileType
Parameter Sets: (All)
Aliases:
