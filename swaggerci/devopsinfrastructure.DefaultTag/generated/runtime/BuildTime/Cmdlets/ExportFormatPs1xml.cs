...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support";
