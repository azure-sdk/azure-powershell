...
using static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructureTest.Runtime.PowerShell.PsHelpers;
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"./Az.ManagedDevOpsInfrastructureTest.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: ManagedDevOpsInfrastructureTest cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Az.ManagedDevOpsInfrastructureTest.private.dll"}'");
                }
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Az.ManagedDevOpsInfrastructureTest.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule ManagedDevOpsInfrastructureTest".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
