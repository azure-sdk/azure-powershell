...
using static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructureForTesting.Runtime.PowerShell.PsHelpers;
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"./Az.ManagedDevOpsInfrastructureForTesting.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: ManagedDevOpsInfrastructureForTesting cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Az.ManagedDevOpsInfrastructureForTesting.private.dll"}'");
                }
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Az.ManagedDevOpsInfrastructureForTesting.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule ManagedDevOpsInfrastructureForTesting".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
