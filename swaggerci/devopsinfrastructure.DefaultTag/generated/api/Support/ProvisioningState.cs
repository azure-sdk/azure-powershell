...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>Represents a canceled operation.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Represents an operation under deletion.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Represents a failed operation.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Represents a pending operation.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Provisioning = @"Provisioning";

        /// <summary>Represents a succeeded operation.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Represents a pending operation.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
