...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121
{
    ...
    public partial class Quota :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaName Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.QuotaName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaName _name;

        /// <summary>The name of the quota.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.QuotaName()); }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The name of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long Limit { get; set; }
        /// <summary>The name of the quota.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20250121.IQuotaName Name { get; set; }
        /// <summary>The localized name of the resource.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The name of the resource.</summary>
        string NameValue { get; set; }
