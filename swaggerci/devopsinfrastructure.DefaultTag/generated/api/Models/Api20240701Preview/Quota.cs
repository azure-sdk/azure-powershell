...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview
{
    ...
    public partial class Quota :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaName Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.QuotaName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaName _name;

        /// <summary>The name of the quota.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.QuotaName()); }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The name of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long Limit { get; set; }
        /// <summary>The name of the quota.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedDevOpsInfrastructure.Models.Api20240701Preview.IQuotaName Name { get; set; }
        /// <summary>The localized name of the resource.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The name of the resource.</summary>
        string NameValue { get; set; }
