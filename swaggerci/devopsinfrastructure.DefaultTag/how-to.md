# How-To
This document describes how to develop for `Az.ManagedDevOpsInfrastructureTest`.

## Building `Az.ManagedDevOpsInfrastructureTest`
...
## Testing `Az.ManagedDevOpsInfrastructureTest`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.ManagedDevOpsInfrastructureTest` into the session.
