...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501
{
    ...
    public partial class CustomDomainConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICustomDomainConfigurationInternal
    {

        /// <summary>Backing field for <see cref="CertificateKeyVaultProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultProperties _certificateKeyVaultProperty;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultProperties CertificateKeyVaultProperty { get => (this._certificateKeyVaultProperty = this._certificateKeyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.CertificateKeyVaultProperties()); set => this._certificateKeyVaultProperty = value; }
        ...
        public string CertificateKeyVaultPropertyIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultPropertiesInternal)CertificateKeyVaultProperty).Identity; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultPropertiesInternal)CertificateKeyVaultProperty).Identity = value ?? null; }

        /// <summary>URL pointing to the Azure Key Vault secret that holds the certificate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string CertificateKeyVaultPropertyKeyVaultUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultPropertiesInternal)CertificateKeyVaultProperty).KeyVaultUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultPropertiesInternal)CertificateKeyVaultProperty).KeyVaultUrl = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultProperties Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICustomDomainConfigurationInternal.CertificateKeyVaultProperty { get => (this._certificateKeyVaultProperty = this._certificateKeyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.CertificateKeyVaultProperties()); set { {_certificateKeyVaultProperty = value;} } }

        /// <summary>Internal Acessors for CustomDomainVerificationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICustomDomainConfigurationInternal.CustomDomainVerificationId { get => this._customDomainVerificationId; set { {_customDomainVerificationId = value;} } }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICustomDomainConfigurationInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for SubjectName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICustomDomainConfigurationInternal.SubjectName { get => this._subjectName; set { {_subjectName = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICustomDomainConfigurationInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }
    ...
    {
        /// <summary>Certificate stored in Azure Key Vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ICertificateKeyVaultProperties CertificateKeyVaultProperty { get; set; }
        /// <summary>
        /// Resource ID of a managed identity to authenticate with Azure Key Vault, or System to use a system-assigned identity.
        /// </summary>
        string CertificateKeyVaultPropertyIdentity { get; set; }
