...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501
{
    ...
    public partial class AppLogsConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IAppLogsConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IAppLogsConfigurationInternal
    {
        ...
        public string LogAnalyticConfigurationCustomerId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).CustomerId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).CustomerId = value ?? null; }

        /// <summary>Log analytics customer key</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string LogAnalyticConfigurationSharedKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).SharedKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).SharedKey = value ?? null; }

        /// <summary>Backing field for <see cref="LogAnalyticsConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfiguration _logAnalyticsConfiguration;

        /// <summary>
        /// Log Analytics configuration, must only be provided when destination is configured as 'log-analytics'
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfiguration LogAnalyticsConfiguration { get => (this._logAnalyticsConfiguration = this._logAnalyticsConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.LogAnalyticsConfiguration()); set => this._logAnalyticsConfiguration = value; }

        /// <summary>Internal Acessors for LogAnalyticsConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfiguration Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IAppLogsConfigurationInternal.LogAnalyticsConfiguration { get => (this._logAnalyticsConfiguration = this._logAnalyticsConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.LogAnalyticsConfiguration()); set { {_logAnalyticsConfiguration = value;} } }
...

    {
        ...
        /// Log Analytics configuration, must only be provided when destination is configured as 'log-analytics'
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ILogAnalyticsConfiguration LogAnalyticsConfiguration { get; set; }
