...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview
{
    ...
    public partial class CustomDomainConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.ICustomDomainConfigurationInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.ICustomDomainConfigurationInternal.CustomDomainVerificationId { get => this._customDomainVerificationId; set { {_customDomainVerificationId = value;} } }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.ICustomDomainConfigurationInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for SubjectName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.ICustomDomainConfigurationInternal.SubjectName { get => this._subjectName; set { {_subjectName = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.ICustomDomainConfigurationInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }
