...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview
{
    ...
    public partial class TokenStore :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.ITokenStore,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.ITokenStoreInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.IBlobStorageTokenStore _azureBlobStorage;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.IBlobStorageTokenStore AzureBlobStorage { get => (this._azureBlobStorage = this._azureBlobStorage ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.BlobStorageTokenStore()); set => this._azureBlobStorage = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.IBlobStorageTokenStore Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.ITokenStoreInternal.AzureBlobStorage { get => (this._azureBlobStorage = this._azureBlobStorage ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.BlobStorageTokenStore()); set { {_azureBlobStorage = value;} } }
...

    {
        ...
        /// The configuration settings of the storage of the tokens if blob storage is used.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.IBlobStorageTokenStore AzureBlobStorage { get; set; }
        /// <summary>
        /// The name of the app secrets containing the SAS URL of the blob storage containing the tokens.
        /// </summary>
        string AzureBlobStorageSasUrlSettingName { get; set; }
