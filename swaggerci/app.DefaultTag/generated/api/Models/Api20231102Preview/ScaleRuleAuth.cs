...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview
{
    ...
    public partial class ScaleRuleAuth :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview.IScaleRuleAuth,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview.IScaleRuleAuthInternal
    {

        /// <summary>Backing field for <see cref="SecretId" /> property.</summary>
        private string _secretId;

        /// <summary>Resource id of the environment secret from which to pull the auth params.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        Required = false,
        ReadOnly = false,
        Description = @"Resource id of the environment secret from which to pull the auth params.",
