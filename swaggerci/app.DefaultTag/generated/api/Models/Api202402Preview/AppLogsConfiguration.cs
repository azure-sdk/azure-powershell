...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview
{
    ...
    public partial class AppLogsConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAppLogsConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAppLogsConfigurationInternal
    {
        ...
        public string LogAnalyticConfigurationCustomerId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).CustomerId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).CustomerId = value ?? null; }

        /// <summary>Boolean indicating whether to parse json string log into dynamic json columns</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public bool? LogAnalyticConfigurationDynamicJsonColumn { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).DynamicJsonColumn; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).DynamicJsonColumn = value ?? default(bool); }

        /// <summary>Log analytics customer key</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string LogAnalyticConfigurationSharedKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).SharedKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfigurationInternal)LogAnalyticsConfiguration).SharedKey = value ?? null; }

        /// <summary>Backing field for <see cref="LogAnalyticsConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfiguration _logAnalyticsConfiguration;

        /// <summary>
        /// Log Analytics configuration, must only be provided when destination is configured as 'log-analytics'
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfiguration LogAnalyticsConfiguration { get => (this._logAnalyticsConfiguration = this._logAnalyticsConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.LogAnalyticsConfiguration()); set => this._logAnalyticsConfiguration = value; }

        /// <summary>Internal Acessors for LogAnalyticsConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfiguration Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAppLogsConfigurationInternal.LogAnalyticsConfiguration { get => (this._logAnalyticsConfiguration = this._logAnalyticsConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.LogAnalyticsConfiguration()); set { {_logAnalyticsConfiguration = value;} } }
...

    {
        ...
        /// Log Analytics configuration, must only be provided when destination is configured as 'log-analytics'
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILogAnalyticsConfiguration LogAnalyticsConfiguration { get; set; }
