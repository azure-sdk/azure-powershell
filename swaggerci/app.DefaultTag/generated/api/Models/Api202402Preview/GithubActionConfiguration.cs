...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview
{
    ...
    public partial class GithubActionConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IGithubActionConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IGithubActionConfigurationInternal
    {

        /// <summary>Backing field for <see cref="AzureCredentials" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureCredentials _azureCredentials;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureCredentials AzureCredentials { get => (this._azureCredentials = this._azureCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.AzureCredentials()); set => this._azureCredentials = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IEnvironmentVariable[] _buildEnvironmentVariable;

        /// <summary>List of environment variables to be passed to the build.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IEnvironmentVariable[] BuildEnvironmentVariable { get => this._buildEnvironmentVariable; set => this._buildEnvironmentVariable = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureCredentials Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IGithubActionConfigurationInternal.AzureCredentials { get => (this._azureCredentials = this._azureCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.AzureCredentials()); set { {_azureCredentials = value;} } }

        /// <summary>Internal Acessors for RegistryInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IRegistryInfo Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IGithubActionConfigurationInternal.RegistryInfo { get => (this._registryInfo = this._registryInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.RegistryInfo()); set { {_registryInfo = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IRegistryInfo _registryInfo;

        /// <summary>Registry configurations.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IRegistryInfo RegistryInfo { get => (this._registryInfo = this._registryInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.RegistryInfo()); set => this._registryInfo = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string RegistryInfoRegistryUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IRegistryInfoInternal)RegistryInfo).RegistryUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IRegistryInfoInternal)RegistryInfo).RegistryUrl = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IEnvironmentVariable[] BuildEnvironmentVariable { get; set; }
        /// <summary>Context path</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>AzureCredentials configurations.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureCredentials AzureCredentials { get; set; }
        /// <summary>Client Id.</summary>
        string AzureCredentialsClientId { get; set; }
        /// <summary>Client Secret.</summary>
        string AzureCredentialsClientSecret { get; set; }
        ...
        string PublishType { get; set; }
        /// <summary>Registry configurations.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IRegistryInfo RegistryInfo { get; set; }
        /// <summary>registry secret.</summary>
        string RegistryInfoRegistryPassword { get; set; }
        /// <summary>registry server Url.</summary>
        string RegistryInfoRegistryUrl { get; set; }
