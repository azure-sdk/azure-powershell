...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview
{
    ...
    public partial class AzureStaticWebApps :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebApps,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsRegistration Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsInternal.Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.AzureStaticWebAppsRegistration()); set { {_registration = value;} } }

        /// <summary>Backing field for <see cref="Registration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsRegistration _registration;

        /// <summary>The configuration settings of the Azure Static Web Apps registration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsRegistration Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.AzureStaticWebAppsRegistration()); set => this._registration = value; }
        ...
        public string RegistrationClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsRegistrationInternal)Registration).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsRegistrationInternal)Registration).ClientId = value ?? null; }
...

    {
        ...
        bool? Enabled { get; set; }
        /// <summary>The configuration settings of the Azure Static Web Apps registration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IAzureStaticWebAppsRegistration Registration { get; set; }
        /// <summary>The Client ID of the app used for login.</summary>
        string RegistrationClientId { get; set; }
