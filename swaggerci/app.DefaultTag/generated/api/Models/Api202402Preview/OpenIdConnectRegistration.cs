...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview
{
    ...
    public partial class OpenIdConnectRegistration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectRegistration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectRegistrationInternal
    {

        /// <summary>Backing field for <see cref="ClientCredential" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectClientCredential _clientCredential;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectClientCredential ClientCredential { get => (this._clientCredential = this._clientCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.OpenIdConnectClientCredential()); set => this._clientCredential = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectClientCredential Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectRegistrationInternal.ClientCredential { get => (this._clientCredential = this._clientCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.OpenIdConnectClientCredential()); set { {_clientCredential = value;} } }

        /// <summary>Internal Acessors for OpenIdConnectConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectConfig Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectRegistrationInternal.OpenIdConnectConfiguration { get => (this._openIdConnectConfiguration = this._openIdConnectConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.OpenIdConnectConfig()); set { {_openIdConnectConfiguration = value;} } }

        /// <summary>Backing field for <see cref="OpenIdConnectConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectConfig _openIdConnectConfiguration;

        /// <summary>
        /// The configuration settings of the endpoints used for the custom Open ID Connect provider.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectConfig OpenIdConnectConfiguration { get => (this._openIdConnectConfiguration = this._openIdConnectConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.OpenIdConnectConfig()); set => this._openIdConnectConfiguration = value; }
    ...
    {
        /// <summary>The authentication credentials of the custom Open ID Connect provider.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectClientCredential ClientCredential { get; set; }
        /// <summary>
        /// The app setting that contains the client secret for the custom Open ID Connect provider.
        /// </summary>
        string ClientCredentialClientSecretSettingName { get; set; }
        ...
        /// The configuration settings of the endpoints used for the custom Open ID Connect provider.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IOpenIdConnectConfig OpenIdConnectConfiguration { get; set; }
        /// <summary>The endpoint to be used to make an authorization request.</summary>
        string OpenIdConnectConfigurationAuthorizationEndpoint { get; set; }
        /// <summary>The endpoint that provides the keys necessary to validate the token.</summary>
        string OpenIdConnectConfigurationCertificationUri { get; set; }
