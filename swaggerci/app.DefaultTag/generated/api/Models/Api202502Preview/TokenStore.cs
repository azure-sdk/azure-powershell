...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview
{
    ...
    public partial class TokenStore :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.ITokenStore,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.ITokenStoreInternal
    {

        /// <summary>Backing field for <see cref="AzureBlobStorage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStore _azureBlobStorage;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStore AzureBlobStorage { get => (this._azureBlobStorage = this._azureBlobStorage ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.BlobStorageTokenStore()); set => this._azureBlobStorage = value; }
        ...
        public string AzureBlobStorageBlobContainerUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).BlobContainerUri; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).BlobContainerUri = value ?? null; }

        /// <summary>
        /// The Client ID of a User-Assigned Managed Identity. Should not be used along with managedIdentityResourceId.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string AzureBlobStorageClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).ClientId = value ?? null; }

        /// <summary>
        /// The Resource ID of a User-Assigned Managed Identity. Should not be used along with clientId.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string AzureBlobStorageManagedIdentityResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).ManagedIdentityResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).ManagedIdentityResourceId = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string AzureBlobStorageSasUrlSettingName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).SasUrlSettingName; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStoreInternal)AzureBlobStorage).SasUrlSettingName = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStore Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.ITokenStoreInternal.AzureBlobStorage { get => (this._azureBlobStorage = this._azureBlobStorage ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.BlobStorageTokenStore()); set { {_azureBlobStorage = value;} } }
...

    {
        ...
        /// The configuration settings of the storage of the tokens if blob storage is used.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IBlobStorageTokenStore AzureBlobStorage { get; set; }
        /// <summary>
        /// The URI of the blob storage containing the tokens. Should not be used along with sasUrlSettingName.
        /// </summary>
        string AzureBlobStorageBlobContainerUri { get; set; }
