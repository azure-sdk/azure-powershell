...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview
{
    ...
    public partial class DaprAppHealth :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IDaprAppHealth,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IDaprAppHealthInternal
    {
        ...
        /// <summary>Backing field for <see cref="ProbeIntervalSecond" /> property.</summary>
        private int? _probeIntervalSecond;

        /// <summary>Interval for the health probe in seconds</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public int? ProbeIntervalSecond { get => this._probeIntervalSecond; set => this._probeIntervalSecond = value; }

        /// <summary>Backing field for <see cref="ProbeTimeoutMillisecond" /> property.</summary>
        private int? _probeTimeoutMillisecond;

        /// <summary>Timeout for the health probe in milliseconds</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public int? ProbeTimeoutMillisecond { get => this._probeTimeoutMillisecond; set => this._probeTimeoutMillisecond = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        int? ProbeIntervalSecond { get; set; }
        /// <summary>Timeout for the health probe in milliseconds</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        int? ProbeTimeoutMillisecond { get; set; }
        /// <summary>Threshold for the health probe</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
