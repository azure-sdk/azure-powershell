...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301
{
    ...
    public partial class CustomDomainConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.ICustomDomainConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.ICustomDomainConfigurationInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.ICustomDomainConfigurationInternal.CustomDomainVerificationId { get => this._customDomainVerificationId; set { {_customDomainVerificationId = value;} } }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.ICustomDomainConfigurationInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for SubjectName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.ICustomDomainConfigurationInternal.SubjectName { get => this._subjectName; set { {_subjectName = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.ICustomDomainConfigurationInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }
