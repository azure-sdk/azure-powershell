...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview
{
    ...
    public partial class CustomScaleRule :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomScaleRule,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomScaleRuleInternal
    {

        /// <summary>Backing field for <see cref="Auth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IScaleRuleAuth[] _auth;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IScaleRuleAuth[] Auth { get => this._auth; set => this._auth = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomScaleRuleMetadata _metadata;

        /// <summary>Metadata properties to describe custom scale rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomScaleRuleMetadata Metadata { get => (this._metadata = this._metadata ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.CustomScaleRuleMetadata()); set => this._metadata = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"auth",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IScaleRuleAuth) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IScaleRuleAuth[] Auth { get; set; }
        /// <summary>
        /// The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned
        /// identity.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomScaleRuleMetadata) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomScaleRuleMetadata Metadata { get; set; }
        /// <summary>
        /// Type of the custom scale rule
        /// eg: azure-servicebus, redis etc.
        /// </summary>
