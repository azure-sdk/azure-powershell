...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview
{
    ...
    public partial class LogAnalyticsConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ILogAnalyticsConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ILogAnalyticsConfigurationInternal
    {
        ...
        /// <summary>Backing field for <see cref="DynamicJsonColumn" /> property.</summary>
        private bool? _dynamicJsonColumn;

        /// <summary>Boolean indicating whether to parse json string log into dynamic json columns</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public bool? DynamicJsonColumn { get => this._dynamicJsonColumn; set => this._dynamicJsonColumn = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        bool? DynamicJsonColumn { get; set; }
        /// <summary>Log analytics customer key</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
