...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Updating = @"Updating";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState Waiting = @"Waiting";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointConnectionProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
