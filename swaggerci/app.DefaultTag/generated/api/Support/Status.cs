...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status Starting = @"Starting";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
