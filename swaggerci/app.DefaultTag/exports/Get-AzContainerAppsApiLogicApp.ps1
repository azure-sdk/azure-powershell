...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapilogicapp
#>
function Get-AzContainerAppsApiLogicApp {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiLogicApp_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiLogicApp_GetViaIdentity';
        }
