...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapimanagedenvironmentprivateendpointconnection
#>
function Remove-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection_Delete';
            DeleteViaIdentity = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection_DeleteViaIdentity';
        }
