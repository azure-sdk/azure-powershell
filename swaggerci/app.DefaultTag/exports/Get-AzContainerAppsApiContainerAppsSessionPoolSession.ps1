...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappssessionpoolsession
#>
function Get-AzContainerAppsApiContainerAppsSessionPoolSession {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppsSessionPoolSession_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppsSessionPoolSession_GetViaIdentity';
        }
