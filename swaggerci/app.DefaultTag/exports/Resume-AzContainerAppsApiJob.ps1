...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/resume-azcontainerappsapijob
#>
function Resume-AzContainerAppsApiJob {
...
begin {
    try {
        ...
        $mapping = @{
            Resume = 'Az.ContainerAppsApi.private\Resume-AzContainerAppsApiJob_Resume';
            ResumeViaIdentity = 'Az.ContainerAppsApi.private\Resume-AzContainerAppsApiJob_ResumeViaIdentity';
        }
