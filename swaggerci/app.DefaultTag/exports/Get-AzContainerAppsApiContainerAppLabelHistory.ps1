...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerapplabelhistory
#>
function Get-AzContainerAppsApiContainerAppLabelHistory {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.ILabelHistory])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppLabelHistory_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppLabelHistory_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppLabelHistory_List';
        }
