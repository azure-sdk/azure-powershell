...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/suspend-azcontainerappsapijob
#>
function Suspend-AzContainerAppsApiJob {
...
begin {
    try {
        ...
        $mapping = @{
            Suspend = 'Az.ContainerAppsApi.private\Suspend-AzContainerAppsApiJob_Suspend';
            SuspendViaIdentity = 'Az.ContainerAppsApi.private\Suspend-AzContainerAppsApiJob_SuspendViaIdentity';
        }
