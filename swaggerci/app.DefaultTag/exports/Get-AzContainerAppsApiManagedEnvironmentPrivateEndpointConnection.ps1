...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentprivateendpointconnection
#>
function Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IPrivateEndpointConnection])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection_List';
        }
