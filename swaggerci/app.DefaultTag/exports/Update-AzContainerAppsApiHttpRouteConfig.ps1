...
RULE <IHttpRouteRule[]>: Routing Rules for http route resource.
  ...
  [Target <IHttpRouteTarget[]>]: Targets- container apps, revisions, labels
    ContainerAppName <String>: Container App Name to route requests to
    [LabelName <String>]: Label/Revision to route requests to
    [RevisionName <String>]: Revision to route requests to
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IHttpRouteConfig])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.ICustomDomain[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IHttpRouteRule[]]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IHttpRouteConfigPatchTags]))]
