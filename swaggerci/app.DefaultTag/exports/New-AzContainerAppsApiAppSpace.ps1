...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapiappspace
#>
function New-AzContainerAppsApiAppSpace {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiAppSpace_CreateExpanded';
        }
