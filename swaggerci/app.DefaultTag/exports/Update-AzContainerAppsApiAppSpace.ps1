...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapiappspace
#>
function Update-AzContainerAppsApiAppSpace {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [System.String]
    # Optional - ARM resource Id of the primary App Space Resource in the App Space.
    # Used by Portal UX if present.
    ${PrimaryResourceId},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview.IAppSpacePatchTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiAppSpace_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiAppSpace_UpdateViaIdentityExpanded';
        }
