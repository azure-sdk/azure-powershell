...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapicontainerappsessionpoolsessionenvironmentvariable
#>
function Update-AzContainerAppsApiContainerAppSessionPoolSessionEnvironmentVariable {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiContainerAppSessionPoolSessionEnvironmentVariable_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiContainerAppSessionPoolSessionEnvironmentVariable_UpdateViaIdentityExpanded';
        }
