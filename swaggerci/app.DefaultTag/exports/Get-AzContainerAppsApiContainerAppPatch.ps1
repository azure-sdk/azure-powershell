...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IContainerAppsPatchResource
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerapppatch
#>
function Get-AzContainerAppsApiContainerAppPatch {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.IContainerAppsPatchResource])]
...
param(
    ...
    # For example, $filter=properties/patchApplyStatus eq 'Succeeded'
    ${Filter},
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppPatch_List';
        }
