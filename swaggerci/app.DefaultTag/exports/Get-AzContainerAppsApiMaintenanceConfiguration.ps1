...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimaintenanceconfiguration
#>
function Get-AzContainerAppsApiMaintenanceConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IMaintenanceConfigurationResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiMaintenanceConfiguration_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiMaintenanceConfiguration_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiMaintenanceConfiguration_List';
        }
