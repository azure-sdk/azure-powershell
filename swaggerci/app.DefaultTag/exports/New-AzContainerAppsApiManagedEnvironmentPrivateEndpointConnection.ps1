...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapimanagedenvironmentprivateendpointconnection
#>
function New-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection {
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointServiceConnectionStatus])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PrivateEndpointServiceConnectionStatus]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection_CreateExpanded';
        }
