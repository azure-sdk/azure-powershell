...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/add-azcontainerappsapicontainerappspatch
#>
function Add-AzContainerAppsApiContainerAppsPatch {
...
begin {
    try {
        ...
        $mapping = @{
            Apply = 'Az.ContainerAppsApi.private\Add-AzContainerAppsApiContainerAppsPatch_Apply';
            ApplyViaIdentity = 'Az.ContainerAppsApi.private\Add-AzContainerAppsApiContainerAppsPatch_ApplyViaIdentity';
        }
