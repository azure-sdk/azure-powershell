...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapicontainerapplabelhistory
#>
function Remove-AzContainerAppsApiContainerAppLabelHistory {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiContainerAppLabelHistory_Delete';
            DeleteViaIdentity = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiContainerAppLabelHistory_DeleteViaIdentity';
        }
