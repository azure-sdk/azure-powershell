...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapihttprouteconfig
#>
function Remove-AzContainerAppsApiHttpRouteConfig {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiHttpRouteConfig_Delete';
            DeleteViaIdentity = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiHttpRouteConfig_DeleteViaIdentity';
        }
