...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapimaintenanceconfiguration
#>
function Remove-AzContainerAppsApiMaintenanceConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiMaintenanceConfiguration_Delete';
            DeleteViaIdentity = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiMaintenanceConfiguration_DeleteViaIdentity';
        }
