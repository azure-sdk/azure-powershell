...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappsessionpool
#>
function Get-AzContainerAppsApiContainerAppSessionPool {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.ISessionPool])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppSessionPool_List';
            List1 = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppSessionPool_List1';
        }
