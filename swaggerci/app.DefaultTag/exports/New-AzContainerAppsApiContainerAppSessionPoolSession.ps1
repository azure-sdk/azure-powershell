...
SESSIONENVELOPE <ISession>: Session resource.
  ...
  [AuthConfigurationAuthEnabled <Boolean?>]: Is auth enabled for the session
  [AuthConfigurationJwtToken <String>]: JWT token for the session
  [CodeExecutionConfigurationEnvironment <String>]: The environment used for code execution.
  [CodeExecutionConfigurationToken <String>]: The token used for code execution.
  [ConnectionString <String>]: The connection string of the Session.
  [Endpoint <String>]: The endpoint of the Session.
  [ExpiryTime <DateTime?>]: The time when the Session will expire.
  [GeneratedTime <DateTime?>]: The time when the Session was generated.
  [Kind <ContainerType?>]: The kind of the Session.
  [PropertiesName <String>]: The name of the Session.
  [RequestedDurationInSecond <Int32?>]: The requested duration of the Session in seconds.
  [SshConfigurationAuthorizedPublicKey <String>]: The authorized public key.
  [SshConfigurationPassword <String>]: The password.
  [SshConfigurationUsername <String>]: The username.
  [Status <String>]: The status of the Session.
  [TimeElapsedInSecond <Int32?>]: The time elapsed in seconds since the Session was created.
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapicontainerappsessionpoolsession
#>
function New-AzContainerAppsApiContainerAppSessionPoolSession {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview.ISession])]
...
begin {
    try {
        ...
        $mapping = @{
            Generate = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiContainerAppSessionPoolSession_Generate';
            GenerateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiContainerAppSessionPoolSession_GenerateExpanded';
            GenerateViaIdentity = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiContainerAppSessionPoolSession_GenerateViaIdentity';
            GenerateViaIdentityExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiContainerAppSessionPoolSession_GenerateViaIdentityExpanded';
        }
