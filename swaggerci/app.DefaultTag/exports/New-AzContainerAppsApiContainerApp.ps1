...
begin {
    try {
        ...
        if (('CreateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.PipelineMock' -eq $_.Target.GetType().FullName) }
            if ($testPlayback) {
