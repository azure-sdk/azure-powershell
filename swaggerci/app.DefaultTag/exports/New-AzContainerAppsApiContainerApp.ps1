...
CONFIGURATION <IConfiguration>: Non versioned Container App configuration properties.
  ...
  [AppHealthEnabled <Boolean?>]: Boolean indicating if the health probe is enabled
  [AppHealthPath <String>]: Path for the health probe
  [AppHealthProbeIntervalSecond <Int32?>]: Interval for the health probe in seconds
  [AppHealthProbeTimeoutMillisecond <Int32?>]: Timeout for the health probe in milliseconds
  [AppHealthThreshold <Int32?>]: Threshold for the health probe
  ...
  [DaprMaxConcurrency <Int32?>]: Maximum number of concurrent requests, events handled by the Dapr sidecar
  [DotnetAutoConfigureDataProtection <Boolean?>]: Auto configure the ASP.NET Core Data Protection feature
  [IdentitySetting <IIdentitySettings[]>]: Optional settings for Managed Identities that are assigned to the Container App. If a Managed Identity is not specified here, default settings will be used.
  ...
  [JavaAgentEnabled <Boolean?>]: Enable java agent injection for the java app.
  [JavaEnableMetric <Boolean?>]: Enable jmx core metrics for the java app
  [LoggingLoggerSetting <ILoggerSetting[]>]: Settings of the logger for the java app.
    Level <Level>: The specified logger's log level.
  ...
  [RevisionTransitionThreshold <Int32?>]: Optional. The percent of the total number of replicas that must be brought up before revision transition occurs. Defaults to 100 when none is given. Value must be greater than 0 and less than or equal to 100.
  ...
  [TargetLabel <String>]: Required in labels revisions mode. Label to apply to newly created revision.

SCALERULE <IScaleRule[]>: Scaling rules.
  [AzureQueueAccountName <String>]: Storage account name. required if using managed identity to authenticate
  ...
  [AzureQueueIdentity <String>]: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
  ...
  [CustomIdentity <String>]: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
  ...
  [HttpIdentity <String>]: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
  ...
  [TcpIdentity <String>]: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IContainerApp])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Kind])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.Kind]
    # Metadata used to render different experiences for resources of the same type; e.g.
    # WorkflowApp is a kind of Microsoft.App/ContainerApps type.
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PatchingMode])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.PatchingMode]
    # Patching mode for the container app.
    # Null or default in this field will be interpreted as Automatic by RP.
    # Automatic mode will automatically apply available patches.
    # Manual mode will require the user to manually apply patches.
    # Disabled mode will stop patch detection and auto patching.
    ${PatchingConfigurationPatchingMode},
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IScaleRule[]]
    # Scaling rules.
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IContainer[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IVolume[]]
