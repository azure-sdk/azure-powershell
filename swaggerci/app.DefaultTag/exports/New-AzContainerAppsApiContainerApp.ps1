...
CONFIGURATION <IConfiguration>: Non versioned Container App configuration properties.
  ...
  [JavaAgentLogLevelSetting <ILogLevelSetting[]>]: Settings of the log level for the java app.
    Level <String>: The specified logger's log level.
