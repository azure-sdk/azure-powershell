...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/invoke-azcontainerappsapiinvokelogicapp
#>
function Invoke-AzContainerAppsApiInvokeLogicApp {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.IAny])]
...
param(
    ...
    [Parameter(Mandatory)]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.LogicAppsProxyMethod])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Header')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.LogicAppsProxyMethod]
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'Az.ContainerAppsApi.private\Invoke-AzContainerAppsApiInvokeLogicApp_Invoke';
            InvokeViaIdentity = 'Az.ContainerAppsApi.private\Invoke-AzContainerAppsApiInvokeLogicApp_InvokeViaIdentity';
        }
