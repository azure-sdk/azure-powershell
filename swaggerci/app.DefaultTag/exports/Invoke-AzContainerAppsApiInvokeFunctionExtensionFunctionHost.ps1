...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/invoke-azcontainerappsapiinvokefunctionextensionfunctionhost
#>
function Invoke-AzContainerAppsApiInvokeFunctionExtensionFunctionHost {
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'Az.ContainerAppsApi.private\Invoke-AzContainerAppsApiInvokeFunctionExtensionFunctionHost_Invoke';
            InvokeViaIdentity = 'Az.ContainerAppsApi.private\Invoke-AzContainerAppsApiInvokeFunctionExtensionFunctionHost_InvokeViaIdentity';
        }
