...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.ISessionPoolUpdatablePropertiesTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
