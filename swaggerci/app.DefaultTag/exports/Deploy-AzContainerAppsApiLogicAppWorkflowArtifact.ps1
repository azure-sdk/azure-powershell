...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IWorkflowArtifacts
.Inputs
...
WORKFLOWARTIFACT <IWorkflowArtifacts>: The workflow filter.
  [AppSetting <IAny>]: Application settings of the workflow.
  [File <IAny>]: Files of the app.
  [FilesToDelete <String[]>]: Files of the app to delete.
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/deploy-azcontainerappsapilogicappworkflowartifact
#>
function Deploy-AzContainerAppsApiLogicAppWorkflowArtifact {
...
begin {
    try {
        ...
        $mapping = @{
            Deploy = 'Az.ContainerAppsApi.private\Deploy-AzContainerAppsApiLogicAppWorkflowArtifact_Deploy';
            DeployExpanded = 'Az.ContainerAppsApi.private\Deploy-AzContainerAppsApiLogicAppWorkflowArtifact_DeployExpanded';
            DeployViaIdentity = 'Az.ContainerAppsApi.private\Deploy-AzContainerAppsApiLogicAppWorkflowArtifact_DeployViaIdentity';
            DeployViaIdentityExpanded = 'Az.ContainerAppsApi.private\Deploy-AzContainerAppsApiLogicAppWorkflowArtifact_DeployViaIdentityExpanded';
        }
