...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IAuthConfig])]
...
param(
    ...
    [System.String]
    # The URI of the blob storage containing the tokens.
    # Should not be used along with SAS Url.
    ${AzureBlobStorageBlobContainerUri},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [System.String]
    # The Client ID of a User-Assigned Managed Identity.
    # Should not be used along with Resource ID.
    ...
    # Should not be used along with Client ID.
    ...
    # Should not be used along with blob container URI.
