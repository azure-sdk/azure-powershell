...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapiappspaceresource
#>
function Update-AzContainerAppsApiAppSpaceResource {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview.IAppSpaceResourcePatchTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiAppSpaceResource_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiAppSpaceResource_UpdateViaIdentityExpanded';
        }
