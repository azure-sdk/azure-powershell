...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapiconnectedenvironment
#>
function Update-AzContainerAppsApiConnectedEnvironment {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IResourceTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiConnectedEnvironment_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ContainerAppsApi.private\Update-AzContainerAppsApiConnectedEnvironment_UpdateViaIdentityExpanded';
        }
