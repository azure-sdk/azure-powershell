...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappsbuildsbycontainerapp
#>
function Get-AzContainerAppsApiContainerAppsBuildsByContainerApp {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppsBuildsByContainerApp_List';
        }
