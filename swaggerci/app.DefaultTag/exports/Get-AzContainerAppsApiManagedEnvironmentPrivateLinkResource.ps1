...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentprivatelinkresource
#>
function Get-AzContainerAppsApiManagedEnvironmentPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IPrivateLinkResource])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiManagedEnvironmentPrivateLinkResource_List';
        }
