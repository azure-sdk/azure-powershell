...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapibuildsbybuilderresource
#>
function Get-AzContainerAppsApiBuildsByBuilderResource {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiBuildsByBuilderResource_List';
        }
