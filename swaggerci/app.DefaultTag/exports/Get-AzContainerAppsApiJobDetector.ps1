...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.IDiagnostics], [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230801Preview.IDiagnosticsCollection])]
