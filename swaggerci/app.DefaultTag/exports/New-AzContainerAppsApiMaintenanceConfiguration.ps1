...
SCHEDULEDENTRY <IScheduledEntry[]>: List of maintenance schedules for a managed environment.
  StartHourUtc <Int32>: Start hour after which managed environment maintenance can start from 0 to 23 hour.
  WeekDay <WeekDay>: Day of the week when a managed environment can be patched.
  [DurationHour <Int32?>]: Length of maintenance window range from 8 to 24 hours.
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapimaintenanceconfiguration
#>
function New-AzContainerAppsApiMaintenanceConfiguration {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.IScheduledEntry[]]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiMaintenanceConfiguration_CreateExpanded';
        }
