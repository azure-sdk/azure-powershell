...
LABEL <ILabel[]>: Labels for the Container App.
  [Name <String>]: Name of the label.
  [RevisionName <String>]: Name of the revision associated with the label.
  ...
  [TemplateInitContainer <IBaseContainer[]>]: List of specialized containers that run before app containers.
    ...
    [ResourceMemory <String>]: Required memory, e.g. "250Mb"
    [VolumeMount <IVolumeMount[]>]: Container volume mounts.
  [TemplateRevisionSuffix <String>]: User friendly suffix that is appended to the revision name
  ...
  [TemplateTerminationGracePeriodSecond <Int64?>]: Optional duration in seconds the Container App Instance needs to terminate gracefully. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). If this value is nil, the default grace period will be used instead. Set this value longer than the expected cleanup time for your process. Defaults to 30 seconds.
  ...
  [TrafficWeight <Int32?>]: Percent of the traffic that will be routed to the revision in this label.
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapicontainerapplabel
#>
function New-AzContainerAppsApiContainerAppLabel {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILabels])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Path')]
    [System.String]
    # Name of the Container App Labels collection.
    ${LabelsName},
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202402Preview.ILabel[]]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiContainerAppLabel_CreateExpanded';
        }
