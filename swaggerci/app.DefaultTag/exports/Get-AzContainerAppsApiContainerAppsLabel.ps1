...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappslabel
#>
function Get-AzContainerAppsApiContainerAppsLabel {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppsLabel_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppsLabel_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppsLabel_List';
        }
