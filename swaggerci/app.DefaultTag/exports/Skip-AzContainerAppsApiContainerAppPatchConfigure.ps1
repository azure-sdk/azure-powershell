...
PATCHSKIPCONFIG <IPatchSkipConfig>: The configuration for patcher to skip a patch or not.
  [Skip <Boolean?>]: The flag to indicate whether to skip the patch or not.
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/skip-azcontainerappsapicontainerapppatchconfigure
#>
function Skip-AzContainerAppsApiContainerAppPatchConfigure {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='SkipExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    ...
    [Parameter(ParameterSetName='SkipExpanded')]
    [Parameter(ParameterSetName='SkipViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
...
begin {
    try {
        ...
        $mapping = @{
            Skip = 'Az.ContainerAppsApi.private\Skip-AzContainerAppsApiContainerAppPatchConfigure_Skip';
            SkipExpanded = 'Az.ContainerAppsApi.private\Skip-AzContainerAppsApiContainerAppPatchConfigure_SkipExpanded';
            SkipViaIdentity = 'Az.ContainerAppsApi.private\Skip-AzContainerAppsApiContainerAppPatchConfigure_SkipViaIdentity';
            SkipViaIdentityExpanded = 'Az.ContainerAppsApi.private\Skip-AzContainerAppsApiContainerAppPatchConfigure_SkipViaIdentityExpanded';
        }
