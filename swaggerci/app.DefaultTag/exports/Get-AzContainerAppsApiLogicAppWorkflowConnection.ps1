...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapilogicappworkflowconnection
#>
function Get-AzContainerAppsApiLogicAppWorkflowConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IWorkflowEnvelope])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiLogicAppWorkflowConnection_List';
        }
