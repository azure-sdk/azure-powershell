...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapilogicappworkflow
#>
function Get-AzContainerAppsApiLogicAppWorkflow {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiLogicAppWorkflow_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiLogicAppWorkflow_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiLogicAppWorkflow_List';
        }
