...
INPUTOBJECT <IContainerAppsApiIdentity>: Identity Parameter
  ...
  [AppSpaceName <String>]: Name of the App Space.
  ...
  [SpaceResourceName <String>]: Name of the App Space Resource.
  [StorageName <String>]: Name of the storage.
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapiappspace
#>
function Get-AzContainerAppsApiAppSpace {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20231102Preview.IAppSpace])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpace_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpace_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpace_List';
            List1 = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpace_List1';
        }
