...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapihttprouteconfig
#>
function Get-AzContainerAppsApiHttpRouteConfig {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiHttpRouteConfig_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiHttpRouteConfig_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiHttpRouteConfig_List';
        }
