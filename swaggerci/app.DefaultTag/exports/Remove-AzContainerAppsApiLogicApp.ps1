...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapilogicapp
#>
function Remove-AzContainerAppsApiLogicApp {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiLogicApp_Delete';
            DeleteViaIdentity = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiLogicApp_DeleteViaIdentity';
        }
