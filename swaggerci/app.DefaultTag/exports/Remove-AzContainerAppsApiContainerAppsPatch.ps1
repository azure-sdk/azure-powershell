...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/remove-azcontainerappsapicontainerappspatch
#>
function Remove-AzContainerAppsApiContainerAppsPatch {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiContainerAppsPatch_Delete';
            DeleteViaIdentity = 'Az.ContainerAppsApi.private\Remove-AzContainerAppsApiContainerAppsPatch_DeleteViaIdentity';
        }
