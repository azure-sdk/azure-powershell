...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapiappspaceresource
#>
function Get-AzContainerAppsApiAppSpaceResource {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpaceResource_Get';
            GetViaIdentity = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpaceResource_GetViaIdentity';
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiAppSpaceResource_List';
        }
