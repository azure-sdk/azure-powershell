...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapilogicapp
#>
function New-AzContainerAppsApiLogicApp {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.ILogicApp])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiLogicApp_CreateExpanded';
        }
