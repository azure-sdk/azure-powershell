...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IHttpRouteConfig
.Notes
COMPLEX PARAMETER PROPERTIES

To create the parameters described below, construct a hash table containing the appropriate properties. For information on hash tables, run Get-Help about_Hash_Tables.

CUSTOMDOMAIN <ICustomDomainAutoGenerated[]>: Custom domain bindings for http Routes' hostnames.
...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapihttprouteconfig
#>
function New-AzContainerAppsApiHttpRouteConfig {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IHttpRouteConfig])]
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IHttpRouteRule[]]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerAppsApi.private\New-AzContainerAppsApiHttpRouteConfig_CreateExpanded';
        }
