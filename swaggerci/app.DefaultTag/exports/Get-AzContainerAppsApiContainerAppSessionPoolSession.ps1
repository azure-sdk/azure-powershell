...
.Link
https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerappsessionpoolsession
#>
function Get-AzContainerAppsApiContainerAppSessionPoolSession {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ContainerAppsApi.private\Get-AzContainerAppsApiContainerAppSessionPoolSession_List';
        }
