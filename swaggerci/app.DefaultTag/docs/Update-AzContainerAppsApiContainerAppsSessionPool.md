...
Update-AzContainerAppsApiContainerAppsSessionPool -ResourceGroupName <String> -SessionPoolName <String>
 ...
 [-IngressTargetPort <Int32>] [-LifecycleConfigurationCooldownPeriodInSecond <Int32>]
 [-LifecycleConfigurationLifecycleType <LifecycleType>]
 [-LifecycleConfigurationMaxAlivePeriodInSecond <Int32>] [-RegistryCredentialsIdentity <String>]
 [-RegistryCredentialsPasswordSecretRef <String>] [-RegistryCredentialsServer <String>]
...
Update-AzContainerAppsApiContainerAppsSessionPool -InputObject <IContainerAppsApiIdentity>
 [-CustomContainerTemplateContainer <ISessionContainer[]>] [-IdentityType <ManagedServiceIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-IngressTargetPort <Int32>]
 [-LifecycleConfigurationCooldownPeriodInSecond <Int32>]
 [-LifecycleConfigurationLifecycleType <LifecycleType>]
 [-LifecycleConfigurationMaxAlivePeriodInSecond <Int32>] [-RegistryCredentialsIdentity <String>]
 [-RegistryCredentialsPasswordSecretRef <String>] [-RegistryCredentialsServer <String>]
 [-RegistryCredentialsUsername <String>] [-ScaleConfigurationMaxConcurrentSession <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ISessionContainer[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.LifecycleType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.ISessionPoolSecret[]
Parameter Sets: (All)
Aliases:
