...
Update-AzContainerAppsApiContainerAppsSessionPool -ResourceGroupName <String> -SessionPoolName <String>
 ...
 [-SessionNetworkConfigurationStatus <SessionNetworkStatus>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.ISessionContainer[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20241002Preview.ISessionPoolSecret[]
Parameter Sets: (All)
Aliases:
