...
```
Update-AzContainerAppsApiConnectedEnvironment -Name <String> -ResourceGroupName <String>
...
```
Update-AzContainerAppsApiConnectedEnvironment -InputObject <IContainerAppsApiIdentity> [-Tag <Hashtable>]
