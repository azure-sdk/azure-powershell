...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapimanagedcertificate
schema: 2.0.0
---
...
```
Update-AzContainerAppsApiManagedCertificate -EnvironmentName <String> -Name <String>
...
```
Update-AzContainerAppsApiManagedCertificate -InputObject <IContainerAppsApiIdentity> [-Tag <Hashtable>]
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.IManagedCertificate
