...
New-AzContainerAppsApiContainerAppSourceControl -ContainerAppName <String> -ResourceGroupName <String>
 ...
 [-GithubActionConfigurationLabel <String>] [-GithubActionConfigurationOS <String>]
...
### -GithubActionConfigurationLabel
The label that will be assigned to the new revision created by the deployment.
