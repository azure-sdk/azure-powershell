...
New-AzContainerAppsApiContainerAppSourceControl -ContainerAppName <String> -ResourceGroupName <String>
 -SourceControlName <String> [-SubscriptionId <String>] [-XmsGithubAuxiliary <String>]
 ...
 [-AzureCredentialsTenantId <String>] [-Branch <String>]
 [-GithubActionConfigurationBuildEnvironmentVariable <IEnvironmentVariable[]>]
 [-GithubActionConfigurationContextPath <String>] [-GithubActionConfigurationDockerfilePath <String>]
...
### -GithubActionConfigurationDockerfilePath
Dockerfile path
