...
New-AzContainerAppsApiManagedEnvironment -EnvironmentName <String> -ResourceGroupName <String>
 ...
 [-DaprAiConnectionString <String>] [-DaprAiInstrumentationKey <String>] [-EncryptionEnabled]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240301.IWorkloadProfile[]
Parameter Sets: (All)
Aliases:
