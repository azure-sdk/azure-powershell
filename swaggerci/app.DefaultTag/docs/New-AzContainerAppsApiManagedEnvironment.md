...
New-AzContainerAppsApiManagedEnvironment -EnvironmentName <String> -ResourceGroupName <String>
 ...
 [-DaprAiInstrumentationKey <String>] [-DataDogConfigurationKey <String>] [-DataDogConfigurationSite <String>]
 [-DestinationConfigurationOtlpConfiguration <IOtlpConfiguration[]>] [-EncryptionEnabled]
