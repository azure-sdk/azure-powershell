...
New-AzContainerAppsApiManagedEnvironment -EnvironmentName <String> -ResourceGroupName <String>
 ...
 [-AppLogConfigurationDestination <String>] [-AuthIdentity <String>] [-AvailabilityZone <String[]>]
 ...
 [-InfrastructureResourceGroup <String>] [-IngressConfigurationHeaderCountLimit <Int32>]
 [-IngressConfigurationRequestIdleTimeout <Int32>] [-IngressConfigurationTerminationGracePeriodSecond <Int32>]
 [-IngressConfigurationWorkloadProfileName <String>] [-KeyVaultConfigurationKeyUrl <String>] [-Kind <String>]
 [-LogAnalyticConfigurationCustomerId <String>] [-LogAnalyticConfigurationDynamicJsonColumn]
 [-LogAnalyticConfigurationSharedKey <String>] [-LogConfigurationDestination <String[]>]
 [-MetricConfigurationDestination <String[]>] [-MetricConfigurationIncludeKeda] [-MtlEnabled]
 [-PublicNetworkAccess <PublicNetworkAccess>] [-ScaleMaxReplica <Int32>] [-ScaleMinReplica <Int32>]
...
### -AuthIdentity
Resource ID of a user-assigned managed identity to authenticate to the Key Vault.
The identity must be assigned to the managed environment, in the same tenant as the Key Vault, and it must have the following key permissions on the Key Vault: wrapkey, unwrapkey, get.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IOtlpConfiguration[]
Parameter Sets: (All)
Aliases:
...
### -IngressConfigurationHeaderCountLimit
Maximum number of headers per request allowed by the ingress.
Must be at least 1.
Defaults to 100.
...
### -IngressConfigurationRequestIdleTimeout
Duration (in minutes) before idle requests are timed out.
...
### -IngressConfigurationTerminationGracePeriodSecond
Time (in seconds) to allow active connections to complete on termination.
...
### -IngressConfigurationWorkloadProfileName
Name of the workload profile used by the ingress component.
Required.
...
### -KeyVaultConfigurationKeyUrl
Key URL pointing to a key in KeyVault.
Version segment of the Url is required.
...
### -ScaleMaxReplica
Maximum number of ingress replicas.
...
### -ScaleMinReplica
Minimum number of ingress replicas.
Must be at least 2.
Required.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202502Preview.IWorkloadProfile[]
Parameter Sets: (All)
Aliases:
