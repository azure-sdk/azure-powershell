...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapiappspaceresource
schema: 2.0.0
---

# New-AzContainerAppsApiAppSpaceResource
...
```
New-AzContainerAppsApiAppSpaceResource -AppSpaceName <String> -ResourceGroupName <String>
 -SpaceResourceName <String> -Location <String> [-SubscriptionId <String>]
