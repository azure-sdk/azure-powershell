...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/update-azcontainerappsapidotnetcomponent
schema: 2.0.0
---

# Update-AzContainerAppsApiDotNetComponent
...
```
Update-AzContainerAppsApiDotNetComponent -EnvironmentName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzContainerAppsApiDotNetComponent -InputObject <IContainerAppsApiIdentity>
 [-ComponentType <DotNetComponentType>] [-Configuration <IDotNetComponentConfigurationProperty[]>]
 [-ServiceBind <IDotNetComponentServiceBind[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
