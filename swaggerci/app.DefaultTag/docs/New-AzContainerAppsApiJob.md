...
New-AzContainerAppsApiJob -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-EventTriggerConfigReplicaCompletionCount <Int32>] [-IdentityType <ManagedServiceIdentityType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IIdentitySettings[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IRegistryCredentials[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IJobScaleRule[]
Parameter Sets: (All)
Aliases:
