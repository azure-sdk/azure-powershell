...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapicontainerapp
schema: 2.0.0
---
...
### List (Default)
```
Get-AzContainerAppsApiContainerApp [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiContainerApp -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiContainerApp -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```

### List1
```
Get-AzContainerAppsApiContainerApp -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.IContainerApp
