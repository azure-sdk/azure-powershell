...
Update-AzContainerAppsApiJavaComponent -EnvironmentName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-Configuration <IJavaComponentConfigurationProperty[]>] [-ServiceBind <IJavaComponentServiceBind[]>]
...
Update-AzContainerAppsApiJavaComponent -InputObject <IContainerAppsApiIdentity>
 ...
 [-ServiceBind <IJavaComponentServiceBind[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IJavaComponentConfigurationProperty[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IJavaComponentServiceBind[]
Parameter Sets: (All)
Aliases:
