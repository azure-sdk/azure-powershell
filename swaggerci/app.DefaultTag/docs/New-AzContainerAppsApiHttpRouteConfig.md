...
New-AzContainerAppsApiHttpRouteConfig -EnvironmentName <String> -HttpRouteName <String>
 ...
 [-CustomDomain <ICustomDomainAutoGenerated[]>] [-Rule <IHttpRouteRule[]>] [-Tag <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.ICustomDomainAutoGenerated[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20240802Preview.IHttpRouteRule[]
Parameter Sets: (All)
Aliases:
