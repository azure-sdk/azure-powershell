...
New-AzContainerAppsApiHttpRouteConfig -EnvironmentName <String> -HttpRouteName <String>
 -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>] [-CustomDomain <ICustomDomain[]>]
 [-Rule <IHttpRouteRule[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
