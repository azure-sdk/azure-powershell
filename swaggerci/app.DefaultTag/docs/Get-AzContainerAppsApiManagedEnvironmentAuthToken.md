...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentauthtoken
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentAuthToken
...
### Get (Default)
```
Get-AzContainerAppsApiManagedEnvironmentAuthToken -EnvironmentName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentAuthToken -InputObject <IContainerAppsApiIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.IEnvironmentAuthToken
