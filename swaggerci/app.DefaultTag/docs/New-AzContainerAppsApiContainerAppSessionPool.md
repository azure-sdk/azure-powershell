...
New-AzContainerAppsApiContainerAppSessionPool -ResourceGroupName <String> -SessionPoolName <String>
 ...
 [-CustomContainerTemplateContainer <ISessionContainer[]>] [-EnvironmentId <String>]
 ...
 [-LifecycleConfigurationMaxAlivePeriodInSecond <Int32>] [-ManagedIdentitySetting <IManagedIdentitySetting[]>]
 [-PoolManagementType <PoolManagementType>] [-RegistryCredentialsIdentity <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api202501.IManagedIdentitySetting[]
Parameter Sets: (All)
Aliases:
