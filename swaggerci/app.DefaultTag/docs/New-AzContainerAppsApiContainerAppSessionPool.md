...
New-AzContainerAppsApiContainerAppSessionPool -ResourceGroupName <String> -SessionPoolName <String>
 ...
 [-IngressTargetPort <Int32>] [-ManagedIdentitySetting <IManagedIdentitySetting[]>]
 ...
 [-SessionNetworkConfigurationStatus <SessionNetworkStatus>] [-SubnetId <String>] [-Tag <Hashtable>]
