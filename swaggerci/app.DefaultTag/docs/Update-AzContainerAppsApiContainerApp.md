...
Update-AzContainerAppsApiContainerApp -InputObject <IContainerAppsApiIdentity> -Location <String>
 ...
 [-TemplateRevisionSuffix <String>] [-TemplateTerminationGracePeriodSecond <Int64>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.IConfiguration
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20230401Preview.IScaleRule[]
Parameter Sets: (All)
Aliases:
