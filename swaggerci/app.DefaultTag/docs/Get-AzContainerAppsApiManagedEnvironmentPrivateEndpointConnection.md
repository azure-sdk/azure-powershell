...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentprivateendpointconnection
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection
...
### List (Default)
```
Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection -EnvironmentName <String>
...
### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentPrivateEndpointConnection -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
