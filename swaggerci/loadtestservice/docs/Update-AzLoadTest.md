...
online version: https://learn.microsoft.com/powershell/module/az.loadtest/update-azloadtest
schema: 2.0.0
---
...
Update-AzLoadTest -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-IdentityUserAssignedIdentity <Hashtable>] [-PropertiesEncryptionIdentityType <Type>] [-Tag <Hashtable>]
...
Update-AzLoadTest -InputObject <ILoadTestIdentity> [-Description <String>] [-EncryptionKeyUrl <String>]
 ...
 [-PropertiesEncryptionIdentityType <Type>] [-Tag <Hashtable>] [-Type <ManagedServiceIdentityType>]
