...
Test-AzLoadTestQuotaAvailability -Location <String> -QuotaBucketName <String> [-SubscriptionId <String>]
 [-CurrentQuota <Int32>] [-CurrentUsage <Int32>] [-LoadTestingQuotaBucketDimensionLocation <String>]
 [-LoadTestingQuotaBucketDimensionSubscriptionId <String>] [-NewQuota <Int32>] [-DefaultProfile <PSObject>]
...
Test-AzLoadTestQuotaAvailability -Location <String> -QuotaBucketName <String>
 -QuotaBucketRequest <ILoadTestingQuotaBucketContent> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzLoadTestQuotaAvailability -InputObject <ILoadTestIdentity>
 -QuotaBucketRequest <ILoadTestingQuotaBucketContent> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Test-AzLoadTestQuotaAvailability -InputObject <ILoadTestIdentity> [-CurrentQuota <Int32>]
 [-CurrentUsage <Int32>] [-LoadTestingQuotaBucketDimensionLocation <String>]
 [-LoadTestingQuotaBucketDimensionSubscriptionId <String>] [-NewQuota <Int32>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.ILoadTestingQuotaBucketContent
