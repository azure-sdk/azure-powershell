...
.Link
https://learn.microsoft.com/powershell/module/az.loadtest/get-azloadtestquota
#>
function Get-AzLoadTestQuota {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaResource])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.LoadTest.private\Get-AzLoadTestQuota_Get';
            GetViaIdentity = 'Az.LoadTest.private\Get-AzLoadTestQuota_GetViaIdentity';
            List = 'Az.LoadTest.private\Get-AzLoadTestQuota_List';
        }
...
INPUTOBJECT <ILoadTestIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.loadtest/get-azloadtest
#>
...
Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.ILoadTestResource
.Link
https://learn.microsoft.com/powershell/module/az.loadtest/new-azloadtest
#>
...
INPUTOBJECT <ILoadTestIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.loadtest/remove-azloadtest
#>
