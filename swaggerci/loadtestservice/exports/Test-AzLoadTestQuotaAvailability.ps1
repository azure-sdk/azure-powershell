...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.ILoadTestingQuotaAvailabilityResponse
.Notes
...
QUOTABUCKETREQUEST <ILoadTestingQuotaBucketContent>: Request object of new quota for a quota bucket.
  ...
  [LoadTestingQuotaBucketDimensionLocation <String>]: Location dimension for new quota request of the quota bucket.
  [LoadTestingQuotaBucketDimensionSubscriptionId <String>]: Subscription Id dimension for new quota request of the quota bucket.
  [NewQuota <Int32?>]: New quota limit of the quota bucket.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.loadtest/test-azloadtestquotaavailability
#>
function Test-AzLoadTestQuotaAvailability {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.ILoadTestingQuotaAvailabilityResponse])]
...
param(
    ...
    ${LoadTestingQuotaBucketDimensionLocation},
    ...
    ${LoadTestingQuotaBucketDimensionSubscriptionId},
