...
QUOTABUCKETREQUEST <IQuotaBucketRequest>: Quota Bucket Request.
  ...
  [CurrentQuota <Int32?>]: Current Quota of the quota bucket.
  [CurrentUsage <Int32?>]: Current Usage of the quota bucket.
  ...
  [NewQuota <Int32?>]: New Requested Quota of the quota bucket.
.Link
