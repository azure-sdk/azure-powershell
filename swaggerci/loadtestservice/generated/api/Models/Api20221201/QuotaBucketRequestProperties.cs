...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201
{
    ...
    public partial class QuotaBucketRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensions _dimension;

        /// <summary>Dimensions for new quota request of the quota bucket.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LoadTest.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensions Dimension { get => (this._dimension = this._dimension ?? new Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.QuotaBucketRequestPropertiesDimensions()); set => this._dimension = value; }
        ...
        public string DimensionLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).Location; set => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).Location = value ?? null; }

        /// <summary>Subscription Id dimension for new quota request of the quota bucket.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LoadTest.PropertyOrigin.Inlined)]
        public string DimensionSubscriptionId { get => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).SubscriptionId; set => ((Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensionsInternal)Dimension).SubscriptionId = value ?? null; }

        /// <summary>Internal Acessors for Dimension</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesDimensions Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.IQuotaBucketRequestPropertiesInternal.Dimension { get => (this._dimension = this._dimension ?? new Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.QuotaBucketRequestPropertiesDimensions()); set { {_dimension = value;} } }
