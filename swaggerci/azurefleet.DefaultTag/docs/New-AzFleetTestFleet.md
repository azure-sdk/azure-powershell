...
online version: https://learn.microsoft.com/powershell/module/az.fleettest/new-azfleettestfleet
schema: 2.0.0
---

# New-AzFleetTestFleet
...
```
New-AzFleetTestFleet -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-VMSizesProfile <IVMSizeProfile[]>] [-Zone <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20240501Preview.IBaseVirtualMachineProfile
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20240501Preview.IVMSizeProfile[]
Parameter Sets: (All)
Aliases:
