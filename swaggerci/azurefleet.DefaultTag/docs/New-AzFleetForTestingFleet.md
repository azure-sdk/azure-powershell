...
online version: https://learn.microsoft.com/powershell/module/az.fleetfortesting/new-azfleetfortestingfleet
schema: 2.0.0
---

# New-AzFleetForTestingFleet
...
```
New-AzFleetForTestingFleet -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-ComputeProfileBaseVirtualMachineProfile <IBaseVirtualMachineProfile>]
