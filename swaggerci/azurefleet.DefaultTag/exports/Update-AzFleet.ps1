...
COMPUTEPROFILEBASEVIRTUALMACHINEPROFILE <IBaseVirtualMachineProfile>: Base Virtual Machine Profile Properties to be specified according to "specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/{computeApiVersion}/virtualMachineScaleSet.json#/definitions/VirtualMachineScaleSetVMProfile"
  ...
  [SecurityPostureReferenceExcludeExtension <IVirtualMachineExtension[]>]: List of virtual machine extensions to exclude when applying the Security         Posture.
    ...
    [PropertiesType <String>]: Specifies the type of the extension; an example is "CustomScriptExtension".
    [ProtectedSetting <IVirtualMachineExtensionPropertiesProtectedSettings>]: The extension can contain either protectedSettings or         protectedSettingsFromKeyVault or no protected settings at all.
      [(Any) <Object>]: This indicates any property can be added to this object.
    [ProtectedSettingFromKeyVaultSecretUrl <String>]: The URL referencing a secret in a Key Vault.
    [ProvisionAfterExtension <String[]>]: Collection of extension names after which this extension needs to be         provisioned.
    [Publisher <String>]: The name of the extension handler publisher.
    [Setting <IVirtualMachineExtensionPropertiesSettings>]: Json formatted public settings for the extension.
      [(Any) <Object>]: This indicates any property can be added to this object.
    [SourceVaultId <String>]: Resource Id
    [SuppressFailure <Boolean?>]: Indicates whether failures stemming from the extension will be suppressed         (Operational failures such as not connecting to the VM will not be suppressed         regardless of this value). The default is false.
    [Tag <IVirtualMachineExtensionTags>]: Resource tags
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IBaseVirtualMachineProfile]
