...
ADDITIONALLOCATIONPROFILE <ILocationProfile[]>: The list of location profiles.
  ...
  [VirtualMachineProfileOverride <IBaseVirtualMachineProfile>]: An override for computeProfile.baseVirtualMachineProfile specific to this region.         This override is merged with the base virtual machine profile to define the final virtual machine profile for the resources deployed in this location.
    ...
    [StorageProfile <IVirtualMachineScaleSetStorageProfile>]: Specifies the storage settings for the virtual machine disks.
      [DataDisk <IVirtualMachineScaleSetDataDisk[]>]: Specifies the parameters that are used to add data disks to the virtual         machines in the scale set. For more information about disks, see [About disks         and VHDs for Azure virtual         machines](https://learn.microsoft.com/azure/virtual-machines/managed-disks-overview).
...
VMATTRIBUTE <IVMAttributes>: Attribute based Fleet.
  ...
  [LocalStorageSupport <VMAttributeSupport?>]: Specifies whether the VMSize supporting local storage should be used to build Fleet or not.         Included - Default if not specified as most Azure VMs support local storage.
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.ILocationProfile[]]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.ManagedServiceIdentityType])]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.ManagedServiceIdentityType]
    # The type of managed identity assigned to this resource.
    ${IdentityType},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api50.IManagedServiceIdentityUpdateUserAssignedIdentities]))]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy])]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.SpotAllocationStrategy])]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.SpotAllocationStrategy]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.EvictionPolicy])]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.EvictionPolicy]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IFleetUpdateTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizeProfile[]]
