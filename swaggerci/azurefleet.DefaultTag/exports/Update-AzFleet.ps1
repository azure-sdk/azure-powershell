...
VMATTRIBUTE <IVMAttributes>: Attribute based Fleet.
  ...
  [AcceleratorManufacturer <AcceleratorManufacturer[]>]: The accelerator manufacturers specified as a list. acceleratorSupport should be set to Included or Required to use this VMAttribute.
  [AcceleratorSupport <VMAttributeSupport?>]: Specifies whether the VMSize supporting accelerator should be used to build Fleet or not.
  [AcceleratorType <AcceleratorType[]>]: The accelerator types specified as a list. acceleratorSupport should be set to Included or Required to use this VMAttribute.
