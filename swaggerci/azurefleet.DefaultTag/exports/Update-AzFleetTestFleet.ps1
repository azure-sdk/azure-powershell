...
INPUTOBJECT <IFleetTestIdentity>: Identity Parameter
...
.Link
https://learn.microsoft.com/powershell/module/az.fleettest/update-azfleettestfleet
#>
function Update-AzFleetTestFleet {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api50.IManagedServiceIdentityUpdateUserAssignedIdentities]))]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20240501Preview.IFleetUpdateTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.FleetTest.private\Update-AzFleetTestFleet_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.FleetTest.private\Update-AzFleetTestFleet_UpdateViaIdentityExpanded';
        }
