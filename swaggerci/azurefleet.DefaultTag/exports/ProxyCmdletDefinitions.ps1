...
.Link
https://learn.microsoft.com/powershell/module/az.fleetfortesting/get-azfleetfortestingfleet
#>
function Get-AzFleetForTestingFleet {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.FleetForTesting.private\Get-AzFleetForTestingFleet_Get';
            GetViaIdentity = 'Az.FleetForTesting.private\Get-AzFleetForTestingFleet_GetViaIdentity';
            List = 'Az.FleetForTesting.private\Get-AzFleetForTestingFleet_List';
            List1 = 'Az.FleetForTesting.private\Get-AzFleetForTestingFleet_List1';
        }
...
VMSIZESPROFILE <IVMSizeProfile[]>: List of VM sizes supported for Compute Fleet
  ...
  [Rank <Int32?>]: The rank of the VM size. This is used with 'RegularPriorityAllocationStrategy.Prioritized'         The lower the number, the higher the priority. Starting with 0.
.Link
https://learn.microsoft.com/powershell/module/az.fleetfortesting/update-azfleetfortestingfleet
#>
function Update-AzFleetForTestingFleet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IFleet])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api50.IManagedServiceIdentityUpdateUserAssignedIdentities]))]
    [System.Collections.Hashtable]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IFleetUpdateTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.FleetForTesting.private\Update-AzFleetForTestingFleet_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.FleetForTesting.private\Update-AzFleetForTestingFleet_UpdateViaIdentityExpanded';
        }
