...
ADDITIONALLOCATIONPROFILE <ILocationProfile[]>: The list of location profiles.
  ...
  [VirtualMachineProfileOverride <IBaseVirtualMachineProfile>]: An override for computeProfile.baseVirtualMachineProfile specific to this region.         This override is merged with the base virtual machine profile to define the final virtual machine profile for the resources deployed in this location.
    ...
    [NetworkProfileNetworkApiVersion <NetworkApiVersion?>]: specifies the Microsoft.Network API version used when creating networking         resources in the Network Interface Configurations for Virtual Machine Scale Set         with orchestration mode 'Flexible'
    [NetworkProfileNetworkInterfaceConfiguration <IVirtualMachineScaleSetNetworkConfiguration[]>]: The list of network configurations.
      ...
      [AuxiliaryMode <NetworkInterfaceAuxiliaryMode?>]: Specifies whether the Auxiliary mode is enabled for the Network Interface         resource.
      [AuxiliarySku <NetworkInterfaceAuxiliarySku?>]: Specifies whether the Auxiliary sku is enabled for the Network Interface         resource.
      ...
      [IPConfiguration <IVirtualMachineScaleSetIPConfiguration[]>]: Specifies the IP configurations of the network interface.
        ...
        [DeleteOption <DeleteOptions?>]: Specify what happens to the public IP when the VM is deleted
        ...
        [DnsSettingDomainNameLabelScope <DomainNameLabelScopeTypes?>]: The Domain name label scope.The concatenation of the hashed domain name label         that generated according to the policy from domain name label scope and vm         index will be the domain name labels of the PublicIPAddress resources that will         be created
        ...
        [LoadBalancerBackendAddressPool <ISubResource[]>]: Specifies an array of references to backend address pools of load balancers. A         scale set can reference backend address pools of one public and one internal         load balancer. Multiple scale sets cannot use the same basic sku load balancer.
        [LoadBalancerInboundNatPool <ISubResource[]>]: Specifies an array of references to inbound Nat pools of the load balancers. A         scale set can reference inbound nat pools of one public and one internal load         balancer. Multiple scale sets cannot use the same basic sku load balancer.
        ...
        [PublicIPAddressVersion <IPVersion?>]: Available from Api-Version 2019-07-01 onwards, it represents whether the         specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible         values are: 'IPv4' and 'IPv6'.
    ...
    [OSProfile <IVirtualMachineScaleSetOSProfile>]: Specifies the operating system settings for the virtual machines in the scale         set.
      ...
      [WindowConfigurationAdditionalUnattendContent <IAdditionalUnattendContent[]>]: Specifies additional base-64 encoded XML formatted information that can be         included in the Unattend.xml file, which is used by Windows Setup.
        [ComponentName <AdditionalUnattendContentComponentName?>]: The component name. Currently, the only allowable value is         Microsoft-Windows-Shell-Setup.
        ...
        [PassName <AdditionalUnattendContentPassName?>]: The pass name. Currently, the only allowable value is OobeSystem.
    ...
    [ProxyAgentSettingMode <Mode?>]: Specifies the mode that ProxyAgent will execute on if the feature is enabled.         ProxyAgent will start to audit or monitor but not enforce access control over         requests to host endpoints in Audit mode, while in Enforce mode it will enforce         access control. The default value is Enforce mode.
    [SecurityPostureReferenceExcludeExtension <String[]>]: List of virtual machine extension names to exclude when applying the security         posture.
    ...
    [SecurityProfileSecurityType <SecurityTypes?>]: Specifies the SecurityType of the virtual machine. It has to be set to any         specified value to enable UefiSettings. The default behavior is: UefiSettings         will not be enabled unless this property is set.
    ...
    [StorageProfile <IVirtualMachineScaleSetStorageProfile>]: Specifies the storage settings for the virtual machine disks.
      [DataDisk <IVirtualMachineScaleSetDataDisk[]>]: Specifies the parameters that are used to add data disks to the virtual         machines in the scale set. For more information about disks, see [About disks         and VHDs for Azure virtual         machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).
      ...
      [DiskControllerType <DiskControllerTypes?>]: Specifies the disk controller type configured for the virtual machines in the scale set. Minimum api-version: 2022-08-01
      [Id <String>]: Resource Id
...
VMATTRIBUTE <IVMAttributes>: Attribute based Fleet.
  ...
  [AcceleratorManufacturer <AcceleratorManufacturer[]>]: The accelerator manufacturers specified as a list.         acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute.         If acceleratorSupport is "Excluded", this VMAttribute can not be used.
  [AcceleratorSupport <VMAttributeSupport?>]: Specifies whether the VMSize supporting accelerator should be used to build Fleet or not.         acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute.         If acceleratorSupport is "Excluded", this VMAttribute can not be used.
  [AcceleratorType <AcceleratorType[]>]: The accelerator types specified as a list. acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute.         If acceleratorSupport is "Excluded", this VMAttribute can not be used.
  [ArchitectureType <ArchitectureType[]>]: The VM architecture types specified as a list. Optional parameter.
  [BurstableSupport <VMAttributeSupport?>]: Specifies whether the VMSize supporting burstable capability should be used to build Fleet or not.
  [CpuManufacturer <CpuManufacturer[]>]: The VM CPU manufacturers specified as a list. Optional parameter.
  ...
  [ExcludedVMSize <String[]>]: Specifies which VMSizes should be excluded while building Fleet. Optional parameter.
  [LocalStorageDiskType <LocalStorageDiskType[]>]: The local storage disk types specified as a list. LocalStorageSupport should be set to "Included" or "Required" to use this VMAttribute.         If localStorageSupport is "Excluded", this VMAttribute can not be used.
  ...
  [LocalStorageSupport <VMAttributeSupport?>]: Specifies whether the VMSize supporting local storage should be used to build Fleet or not.
  ...
  [RdmaSupport <VMAttributeSupport?>]: Specifies whether the VMSize supporting RDMA (Remote Direct Memory Access) should be used to build Fleet or not.
  ...
  [VMCategory <VMCategory[]>]: The VM category specified as a list. Optional parameter.
...
.Link
https://learn.microsoft.com/powershell/module/az.fleettest/new-azfleettestfleet
#>
function New-AzFleetTestFleet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.IFleet])]
[CmdletBinding(DefaultParameterSetName='CreateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
    [Alias('FleetName')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Path')]
    [System.String]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.DefaultInfo(Script='(Get-AzContext).Subscription.Id')]
    [System.String]
    ...
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [System.String]
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.ILocationProfile[]]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType])]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType]
    # Type of managed service identity (where both SystemAssigned and UserAssigned types are allowed).
    ${IdentityType},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api50.IUserAssignedIdentities]))]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.RegularPriorityAllocationStrategy])]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.RegularPriorityAllocationStrategy]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.SpotAllocationStrategy])]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.SpotAllocationStrategy]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.EvictionPolicy])]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.EvictionPolicy]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api50.ITrackedResourceTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.IVMAttributes]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.IVMSizeProfile[]]
    ...
    [ValidateNotNull()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Azure')]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Runtime')]
    [System.Management.Automation.SwitchParameter]
    ...
    [ValidateNotNull()]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Category('Runtime')]
    [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.SendAsyncStep[]]
...
begin {
    try {
        ...
        if ($preTelemetryId -eq '') {
            ...
            [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.module]::Instance.Telemetry.Invoke('Create', $MyInvocation, $parameterSet, $PSCmdlet)
        } else {
        ...
        $mapping = @{
            CreateExpanded = 'Az.FleetTest.private\New-AzFleetTestFleet_CreateExpanded';
        }
        if (('CreateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
            [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
process {
    ...
    try {
        ...
        if ($preTelemetryId -eq '') {
            [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.module]::Instance.Telemetry.Invoke('Send', $MyInvocation, $parameterSet, $PSCmdlet)
            [Microsoft.WindowsAzure.Commands.Common.MetricHelper]::ClearTelemetryContext()
        }
