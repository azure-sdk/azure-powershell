...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview
{
    ...
    public partial class FleetPropertiesUpdate :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IFleetPropertiesUpdate,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IFleetPropertiesUpdateInternal
    {

        /// <summary>Backing field for <see cref="ComputeProfile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdate _computeProfile;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdate ComputeProfile { get => (this._computeProfile = this._computeProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.ComputeProfileUpdate()); set => this._computeProfile = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IVirtualMachineScaleSetVMProfile ComputeProfileBaseVirtualMachineProfile { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdateInternal)ComputeProfile).BaseVirtualMachineProfile; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdateInternal)ComputeProfile).BaseVirtualMachineProfile = value ?? null /* model class */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public string ComputeProfileComputeApiVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdateInternal)ComputeProfile).ComputeApiVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdateInternal)ComputeProfile).ComputeApiVersion = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public int? ComputeProfilePlatformFaultDomainCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdateInternal)ComputeProfile).PlatformFaultDomainCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdateInternal)ComputeProfile).PlatformFaultDomainCount = value ?? default(int); }

        /// <summary>Internal Acessors for ComputeProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IComputeProfileUpdate Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IFleetPropertiesUpdateInternal.ComputeProfile { get => (this._computeProfile = this._computeProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.ComputeProfileUpdate()); set { {_computeProfile = value;} } }

        /// <summary>Internal Acessors for RegularPriorityProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IRegularPriorityProfile Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IFleetPropertiesUpdateInternal.RegularPriorityProfile { get => (this._regularPriorityProfile = this._regularPriorityProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.RegularPriorityProfile()); set { {_regularPriorityProfile = value;} } }

        /// <summary>Internal Acessors for SpotPriorityProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.ISpotPriorityProfile Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.IFleetPropertiesUpdateInternal.SpotPriorityProfile { get => (this._spotPriorityProfile = this._spotPriorityProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240701Preview.SpotPriorityProfile()); set { {_spotPriorityProfile = value;} } }
