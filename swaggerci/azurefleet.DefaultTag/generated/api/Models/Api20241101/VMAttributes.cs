...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDouble _memoryInGiBPerVcpu;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDouble MemoryInGiBPerVcpu { get => (this._memoryInGiBPerVcpu = this._memoryInGiBPerVcpu ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.VMAttributeMinMaxDouble()); set => this._memoryInGiBPerVcpu = value; }

        /// <summary>Maximum value. Double.MaxValue(1.7976931348623157E+308)</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public double? MemoryInGiBPerVcpuMax { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDoubleInternal)MemoryInGiBPerVcpu).Max; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDoubleInternal)MemoryInGiBPerVcpu).Max = value ?? default(double); }

        /// <summary>Minimum value. default 0. Double.MinValue()</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public double? MemoryInGiBPerVcpuMin { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDoubleInternal)MemoryInGiBPerVcpu).Min; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDoubleInternal)MemoryInGiBPerVcpu).Min = value ?? default(double); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDouble Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributesInternal.MemoryInGiBPerVcpu { get => (this._memoryInGiBPerVcpu = this._memoryInGiBPerVcpu ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.VMAttributeMinMaxDouble()); set { {_memoryInGiBPerVcpu = value;} } }
...

    {
        ...
        /// The range of memory in GiB per vCPU specified from min to max. Optional parameter. Either Min or Max is required if specified.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMAttributeMinMaxDouble MemoryInGiBPerVcpu { get; set; }
        /// <summary>Maximum value. Double.MaxValue(1.7976931348623157E+308)</summary>
        double? MemoryInGiBPerVcpuMax { get; set; }
        /// <summary>Minimum value. default 0. Double.MinValue()</summary>
        double? MemoryInGiBPerVcpuMin { get; set; }
