...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101
{
    ...
    public partial class SpotPriorityProfile :
        Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.ISpotPriorityProfile,
        Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.ISpotPriorityProfileInternal
    {

        /// <summary>Backing field for <see cref="AllocationStrategy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.SpotAllocationStrategy? _allocationStrategy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.SpotAllocationStrategy? AllocationStrategy { get => this._allocationStrategy; set => this._allocationStrategy = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.EvictionPolicy? _evictionPolicy;

        /// <summary>Eviction Policy to follow when evicting Spot VMs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.EvictionPolicy? EvictionPolicy { get => this._evictionPolicy; set => this._evictionPolicy = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.SpotAllocationStrategy? AllocationStrategy { get; set; }
        /// <summary>Total capacity to achieve. It is currently in terms of number of VMs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.EvictionPolicy? EvictionPolicy { get; set; }
        /// <summary>
        /// Flag to enable/disable continuous goal seeking for the desired capacity and restoration of evicted Spot VMs.
        /// If maintain is enabled, AzureFleetRP will use all VM sizes in vmSizesProfile to create new VMs (if VMs are evicted deleted)
        /// or update existing VMs with new VM sizes (if VMs are evicted deallocated or failed to allocate due to capacity constraint)
