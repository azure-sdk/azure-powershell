...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101
{
    ...
    public partial class FleetTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Fleet" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.IFleet ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Models.Api20241101.IFleet).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
