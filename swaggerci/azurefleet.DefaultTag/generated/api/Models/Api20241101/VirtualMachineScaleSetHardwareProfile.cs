...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101
{
    ...
    public partial class VirtualMachineScaleSetHardwareProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVirtualMachineScaleSetHardwareProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVirtualMachineScaleSetHardwareProfileInternal
    {

        /// <summary>Internal Acessors for VMSizeProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizeProperties Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVirtualMachineScaleSetHardwareProfileInternal.VMSizeProperty { get => (this._vMSizeProperty = this._vMSizeProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.VMSizeProperties()); set { {_vMSizeProperty = value;} } }

        /// <summary>Backing field for <see cref="VMSizeProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizeProperties _vMSizeProperty;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizeProperties VMSizeProperty { get => (this._vMSizeProperty = this._vMSizeProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.VMSizeProperties()); set => this._vMSizeProperty = value; }
        ...
        public int? VMSizePropertyVcpUsAvailable { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizePropertiesInternal)VMSizeProperty).VCpUsAvailable; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizePropertiesInternal)VMSizeProperty).VCpUsAvailable = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public int? VMSizePropertyVcpUsPerCore { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizePropertiesInternal)VMSizeProperty).VCpUsPerCore; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizePropertiesInternal)VMSizeProperty).VCpUsPerCore = value ?? default(int); }
...

    {
        ...
        /// Customization](https://aka.ms/vmcustomization) for more details.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20241101.IVMSizeProperties VMSizeProperty { get; set; }
        /// <summary>
        /// Specifies the number of vCPUs available for the VM. When this property is not
        /// specified in the request body the default behavior is to set it to the value of
        /// vCPUs available for that VM size exposed in api response of [List all available
