...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901
{
    ...
    public partial class WindowsConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsConfigurationInternal
    {

        /// <summary>Backing field for <see cref="AdditionalUnattendContent" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IAdditionalUnattendContent[] _additionalUnattendContent;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IAdditionalUnattendContent[] AdditionalUnattendContent { get => this._additionalUnattendContent; set => this._additionalUnattendContent = value; }
        ...
        public bool? AutomaticByPlatformSettingBypassPlatformSafetyChecksOnUserSchedule { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AutomaticByPlatformSettingBypassPlatformSafetyChecksOnUserSchedule; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AutomaticByPlatformSettingBypassPlatformSafetyChecksOnUserSchedule = value ?? default(bool); }

        /// <summary>
        /// Specifies the reboot setting for all AutomaticByPlatform patch installation operations.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.WindowsVMGuestPatchAutomaticByPlatformRebootSetting? AutomaticByPlatformSettingRebootSetting { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AutomaticByPlatformSettingRebootSetting; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AutomaticByPlatformSettingRebootSetting = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.WindowsVMGuestPatchAutomaticByPlatformRebootSetting)""); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettings Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsConfigurationInternal.PatchSetting { get => (this._patchSetting = this._patchSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.PatchSettings()); set { {_patchSetting = value;} } }

        /// <summary>Internal Acessors for PatchSettingAutomaticByPlatformSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsVMGuestPatchAutomaticByPlatformSettings Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsConfigurationInternal.PatchSettingAutomaticByPlatformSetting { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AutomaticByPlatformSetting; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AutomaticByPlatformSetting = value; }

        /// <summary>Internal Acessors for WinRm</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmConfiguration Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsConfigurationInternal.WinRm { get => (this._winRm = this._winRm ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.WinRmConfiguration()); set { {_winRm = value;} } }

        /// <summary>Backing field for <see cref="PatchSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettings _patchSetting;

        /// <summary>[Preview Feature] Specifies settings related to VM Guest Patching on Windows.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettings PatchSetting { get => (this._patchSetting = this._patchSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.PatchSettings()); set => this._patchSetting = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.WindowsPatchAssessmentMode? PatchSettingAssessmentMode { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AssessmentMode; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).AssessmentMode = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.WindowsPatchAssessmentMode)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public bool? PatchSettingEnableHotpatching { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).EnableHotpatching; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).EnableHotpatching = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.WindowsVMGuestPatchMode? PatchSettingPatchMode { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).PatchMode; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettingsInternal)PatchSetting).PatchMode = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.WindowsVMGuestPatchMode)""); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmConfiguration _winRm;

        /// <summary>
        /// Specifies the Windows Remote Management listeners. This enables remote Windows PowerShell.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmConfiguration WinRm { get => (this._winRm = this._winRm ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.WinRmConfiguration()); set => this._winRm = value; }

        /// <summary>The list of Windows Remote Management listeners</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmListener[] WinRmListener { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmConfigurationInternal)WinRm).Listener; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmConfigurationInternal)WinRm).Listener = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IAdditionalUnattendContent[] AdditionalUnattendContent { get; set; }
        /// <summary>Enables customer to schedule patching without accidental upgrades</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        bool? EnableVMAgentPlatformUpdate { get; set; }
        /// <summary>[Preview Feature] Specifies settings related to VM Guest Patching on Windows.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IPatchSettings PatchSetting { get; set; }
        /// <summary>
        /// Specifies the mode of VM Guest patch assessment for the IaaS virtual machine.<br /><br /> Possible values are:<br /><br
        /// /> **ImageDefault** - You control the timing of patch assessments on a virtual machine.<br /><br /> **AutomaticByPlatform**
        /// - The platform will trigger periodic patch assessments. The property provisionVMAgent must be true.
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWindowsVMGuestPatchAutomaticByPlatformSettings PatchSettingAutomaticByPlatformSetting { get; set; }
        /// <summary>
        /// Enables customers to patch their Azure VMs without requiring a reboot. For enableHotpatching, the 'provisionVMAgent' must
        /// be set to true and 'patchMode' must be set to 'AutomaticByPlatform'.
        /// </summary>
        ...
        /// Specifies the Windows Remote Management listeners. This enables remote Windows PowerShell.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmConfiguration WinRm { get; set; }
        /// <summary>The list of Windows Remote Management listeners</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IWinRmListener[] WinRmListener { get; set; }
