...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901
{
    ...
    public partial class AdditionalUnattendContent :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IAdditionalUnattendContent,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IAdditionalUnattendContentInternal
    {

        /// <summary>Backing field for <see cref="ComponentName" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.ComponentNames? _componentName;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.ComponentNames? ComponentName { get => this._componentName; set => this._componentName = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PassNames? _passName;

        /// <summary>The pass name. Currently, the only allowable value is OobeSystem.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PassNames? PassName { get => this._passName; set => this._passName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.ComponentNames) })]
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.ComponentNames? ComponentName { get; set; }
        /// <summary>
        /// Specifies the XML formatted content that is added to the unattend.xml file for the specified path and component. The XML
        /// must be less than 4KB and must include the root element for the setting or feature that is being inserted.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PassNames) })]
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PassNames? PassName { get; set; }
        /// <summary>
        /// Specifies the name of the setting to which the content applies. Possible values are: FirstLogonCommands and AutoLogon.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(
