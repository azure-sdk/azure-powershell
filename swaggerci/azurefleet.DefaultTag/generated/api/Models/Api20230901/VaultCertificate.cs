...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901
{
    ...
    public partial class VaultCertificate :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IVaultCertificate,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20230901.IVaultCertificateInternal
    {
        ...
        /// this case, your certificate needs to be It is the Base64 encoding of the following JSON Object which is encoded in UTF-8:
        /// <br><br> {<br> "data":"<Base64-encoded-certificate>",<br> "dataType":"pfx",<br> "password":"<pfx-file-password>"<br>}
        /// <br> To install certificates on a virtual machine it is recommended to use the [Azure Key Vault virtual machine extension
        /// for Linux](https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-linux) or the [Azure Key Vault virtual
