...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview
{
    ...
    public partial class AdditionalUnattendContent :
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IAdditionalUnattendContent,
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IAdditionalUnattendContentInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentComponentName? _componentName;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentComponentName? ComponentName { get => this._componentName; set => this._componentName = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentPassName? _passName;

        /// <summary>The pass name. Currently, the only allowable value is OobeSystem.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentPassName? PassName { get => this._passName; set => this._passName = value; }

        /// <summary>Backing field for <see cref="SettingName" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.SettingNames? _settingName;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.SettingNames? SettingName { get => this._settingName; set => this._settingName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentComponentName) })]
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentComponentName? ComponentName { get; set; }
        /// <summary>
        /// Specifies the XML formatted content that is added to the unattend.xml file for
        /// the specified path and component. The XML must be less than 4KB and must
        /// include the root element for the setting or feature that is being inserted.
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentPassName) })]
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.AdditionalUnattendContentPassName? PassName { get; set; }
        /// <summary>
        /// Specifies the name of the setting to which the content applies. Possible values
        /// are: FirstLogonCommands and AutoLogon.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.SettingNames) })]
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.SettingNames? SettingName { get; set; }
