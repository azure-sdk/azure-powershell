...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview
{
    ...
    public partial class InstanceViewStatus :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IInstanceViewStatus,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IInstanceViewStatusInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes? _level;

        /// <summary>The level code.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes? Level { get => this._level; set => this._level = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes) })]
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes? Level { get; set; }
        /// <summary>The detailed status message, including for alerts and error messages.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.Info(
        Required = false,
        ReadOnly = false,
