...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IDiffDiskSettingsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.DiffDiskOptions? _option;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.DiffDiskOptions? Option { get => this._option; set => this._option = value; }

        /// <summary>Backing field for <see cref="Placement" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.DiffDiskPlacement? _placement;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.DiffDiskPlacement? Placement { get => this._placement; set => this._placement = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.DiffDiskOptions? Option { get; set; }
        /// <summary>
        /// Specifies the ephemeral disk placement for operating system disk. Possible
        /// values are: **CacheDisk,** **ResourceDisk.** The defaulting behavior is:
        /// **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk**
        ...
        **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk**
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.DiffDiskPlacement? Placement { get; set; }
