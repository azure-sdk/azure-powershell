...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview
{
    ...
    public partial class KeyVaultSecretReference :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IKeyVaultSecretReferenceInternal
    {

        /// <summary>Internal Acessors for SourceVault</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.ISubResource Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IKeyVaultSecretReferenceInternal.SourceVault { get => (this._sourceVault = this._sourceVault ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.SubResource()); set { {_sourceVault = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.ISubResource _sourceVault;

        /// <summary>The relative URL of the Key Vault containing the secret.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.ISubResource SourceVault { get => (this._sourceVault = this._sourceVault ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.SubResource()); set => this._sourceVault = value; }

        /// <summary>Resource Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public string SourceVaultId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.ISubResourceInternal)SourceVault).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.ISubResourceInternal)SourceVault).Id = value ?? null; }
...

    {
        ...
        string SecretUrl { get; set; }
        /// <summary>The relative URL of the Key Vault containing the secret.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.ISubResource SourceVault { get; set; }
        /// <summary>Resource Id</summary>
        string SourceVaultId { get; set; }
