...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview
{
    ...
    public partial class DiagnosticsProfile :
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IDiagnosticsProfile,
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IDiagnosticsProfileInternal
    {

        /// <summary>Backing field for <see cref="BootDiagnostic" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnostics _bootDiagnostic;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnostics BootDiagnostic { get => (this._bootDiagnostic = this._bootDiagnostic ?? new Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.BootDiagnostics()); set => this._bootDiagnostic = value; }
        ...
        public bool? BootDiagnosticEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnosticsInternal)BootDiagnostic).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnosticsInternal)BootDiagnostic).Enabled = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.PropertyOrigin.Inlined)]
        public string BootDiagnosticStorageUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnosticsInternal)BootDiagnostic).StorageUri; set => ((Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnosticsInternal)BootDiagnostic).StorageUri = value ?? null; }

        /// <summary>Internal Acessors for BootDiagnostic</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnostics Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IDiagnosticsProfileInternal.BootDiagnostic { get => (this._bootDiagnostic = this._bootDiagnostic ?? new Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.BootDiagnostics()); set { {_bootDiagnostic = value;} } }
...

    {
        ...
        /// Azure also enables you to see a screenshot of the VM from the hypervisor.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IBootDiagnostics BootDiagnostic { get; set; }
        /// <summary>Whether boot diagnostics should be enabled on the Virtual Machine.</summary>
        bool? BootDiagnosticEnabled { get; set; }
        /// <summary>
        /// Uri of the storage account to use for placing the console output and
