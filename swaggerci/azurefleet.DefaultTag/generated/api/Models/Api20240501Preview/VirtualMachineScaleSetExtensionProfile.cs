...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview
{
    ...
    public partial class VirtualMachineScaleSetExtensionProfile :
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IVirtualMachineScaleSetExtensionProfile,
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IVirtualMachineScaleSetExtensionProfileInternal
    {

        /// <summary>Backing field for <see cref="Extension" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IVirtualMachineScaleSetExtension[] _extension;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IVirtualMachineScaleSetExtension[] Extension { get => this._extension; set => this._extension = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Models.Api20240501Preview.IVirtualMachineScaleSetExtension[] Extension { get; set; }
        /// <summary>
        /// Specifies the time alloted for all extensions to start. The time duration
        /// should be between 15 minutes and 120 minutes (inclusive) and should be
        /// specified in ISO 8601 format. The default value is 90 minutes (PT1H30M).
