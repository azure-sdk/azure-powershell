...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview
{
    ...
    public partial class VirtualMachineScaleSetHardwareProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSetHardwareProfileInternal
    {

        /// <summary>Internal Acessors for VMSizeProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizeProperties Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSetHardwareProfileInternal.VMSizeProperty { get => (this._vMSizeProperty = this._vMSizeProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.VMSizeProperties()); set { {_vMSizeProperty = value;} } }

        /// <summary>Backing field for <see cref="VMSizeProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizeProperties _vMSizeProperty;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizeProperties VMSizeProperty { get => (this._vMSizeProperty = this._vMSizeProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.VMSizeProperties()); set => this._vMSizeProperty = value; }
        ...
        public int? VMSizePropertyVcpUsAvailable { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizePropertiesInternal)VMSizeProperty).VCpUsAvailable; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizePropertiesInternal)VMSizeProperty).VCpUsAvailable = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Inlined)]
        public int? VMSizePropertyVcpUsPerCore { get => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizePropertiesInternal)VMSizeProperty).VCpUsPerCore; set => ((Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizePropertiesInternal)VMSizeProperty).VCpUsPerCore = value ?? default(int); }
...

    {
        ...
        /// Customization](https://aka.ms/vmcustomization) for more details.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVMSizeProperties VMSizeProperty { get; set; }
        /// <summary>
        /// Specifies the number of vCPUs available for the VM. When this property is not
        /// specified in the request body the default behavior is to set it to the value of
        /// vCPUs available for that VM size exposed in api response of [List all available
