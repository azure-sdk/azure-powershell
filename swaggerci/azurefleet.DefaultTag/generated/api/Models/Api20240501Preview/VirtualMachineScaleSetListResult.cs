...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview
{
    ...
    public partial class VirtualMachineScaleSetListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSetListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSetListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSet[] _value;

        /// <summary>The VirtualMachineScaleSet items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSet[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSet) })]
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IVirtualMachineScaleSet[] Value { get; set; }
