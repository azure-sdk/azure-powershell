...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview
{
    ...
    public partial class FleetListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IFleetListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IFleetListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IFleet[] _value;

        /// <summary>The Fleet items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Fleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.Fleet.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IFleet[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IFleet) })]
        Microsoft.Azure.PowerShell.Cmdlets.Fleet.Models.Api20240501Preview.IFleet[] Value { get; set; }
