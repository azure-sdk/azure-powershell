...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.OperatingSystemTypes Linux = @"Linux";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.OperatingSystemTypes Windows = @"Windows";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.OperatingSystemTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.OperatingSystemTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.OperatingSystemTypes e1, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.OperatingSystemTypes e2)
        {
            return !e2.Equals(e1);
        }
