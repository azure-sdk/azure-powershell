...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support
{
        ...
        System.IEquatable<RegularPriorityAllocationStrategy>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy LowestPrice = @"LowestPrice";

        /// <summary>
        /// VM sizes distribution will be determined to optimize for the 'priority' as specified for each vm size.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy Prioritized = @"Prioritized";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy e1, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.RegularPriorityAllocationStrategy e2)
        {
            return !e2.Equals(e1);
        }
