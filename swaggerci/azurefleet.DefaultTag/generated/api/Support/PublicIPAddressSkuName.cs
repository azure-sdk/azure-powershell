...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PublicIPAddressSkuName Basic = @"Basic";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PublicIPAddressSkuName Standard = @"Standard";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PublicIPAddressSkuName e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PublicIPAddressSkuName e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PublicIPAddressSkuName e1, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.PublicIPAddressSkuName e2)
        {
            return !e2.Equals(e1);
        }
