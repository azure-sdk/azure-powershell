...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Initial creation in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Creating = @"Creating";

        /// <summary>Deletion in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Resource is being migrated from one subscription or resource group to another.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Migrating = @"Migrating";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Update in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
