...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes Error = @"Error";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes Info = @"Info";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes Warning = @"Warning";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes e1, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StatusLevelTypes e2)
        {
            return !e2.Equals(e1);
        }
