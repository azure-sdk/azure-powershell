...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType SystemAssigned = @"SystemAssigned";

        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType SystemAssignedUserAssigned = @"SystemAssigned,UserAssigned";

        public static Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.FleetTest.Support.ManagedServiceIdentityType e2)
        {
            return !e2.Equals(e1);
        }
