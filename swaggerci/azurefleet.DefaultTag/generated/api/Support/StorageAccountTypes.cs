...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support
{
    ...
    /// uses Standard HDD. StandardSSD_LRS uses Standard SSD. Premium_LRS uses Premium SSD. UltraSSD_LRS uses Ultra disk. Premium_ZRS
    /// uses Premium SSD zone redundant storage. StandardSSD_ZRS uses Standard SSD zone redundant storage. For more information
    /// regarding disks supported for Windows Virtual Machines, refer to https://docs.microsoft.com/azure/virtual-machines/windows/disks-types
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes PremiumLrs = @"Premium_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes PremiumV2Lrs = @"PremiumV2_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes PremiumZrs = @"Premium_ZRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes StandardLrs = @"Standard_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes StandardSsdLrs = @"StandardSSD_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes StandardSsdZrs = @"StandardSSD_ZRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes UltraSsdLrs = @"UltraSSD_LRS";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes e1, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.StorageAccountTypes e2)
        {
            return !e2.Equals(e1);
        }
