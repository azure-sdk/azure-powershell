...
namespace Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support
{
        ...
        System.IEquatable<StorageAccountTypes>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes PremiumLrs = @"Premium_LRS";

        /// <summary>PremiumV2_LRS option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes PremiumV2Lrs = @"PremiumV2_LRS";

        /// <summary>Premium_ZRS option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes PremiumZrs = @"Premium_ZRS";

        /// <summary>Standard_LRS option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes StandardLrs = @"Standard_LRS";

        /// <summary>StandardSSD_LRS option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes StandardSsdLrs = @"StandardSSD_LRS";

        /// <summary>StandardSSD_ZRS option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes StandardSsdZrs = @"StandardSSD_ZRS";

        /// <summary>UltraSSD_LRS option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes UltraSsdLrs = @"UltraSSD_LRS";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes e1, Microsoft.Azure.PowerShell.Cmdlets.FleetForTesting.Support.StorageAccountTypes e2)
        {
            return !e2.Equals(e1);
        }
