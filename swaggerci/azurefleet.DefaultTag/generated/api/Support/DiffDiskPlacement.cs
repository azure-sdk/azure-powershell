...
namespace Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support
{
        ...
        System.IEquatable<DiffDiskPlacement>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement CacheDisk = @"CacheDisk";

        /// <summary>NvmeDisk option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement NvmeDisk = @"NvmeDisk";

        /// <summary>Resource Disk option.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement ResourceDisk = @"ResourceDisk";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement e1, Microsoft.Azure.PowerShell.Cmdlets.Fleet.Support.DiffDiskPlacement e2)
        {
            return !e2.Equals(e1);
        }
