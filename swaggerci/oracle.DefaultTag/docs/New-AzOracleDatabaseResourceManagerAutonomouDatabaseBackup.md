...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/new-azoracledatabaseresourcemanagerautonomoudatabasebackup
schema: 2.0.0
---
...
```
New-AzOracleDatabaseResourceManagerAutonomouDatabaseBackup -Adbbackupid <String>
