...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/update-azoracledatabaseresourcemanagercloudexadatainfrastructure
schema: 2.0.0
---

# Update-AzOracleDatabaseResourceManagerCloudExadataInfrastructure
...
```
Update-AzOracleDatabaseResourceManagerCloudExadataInfrastructure -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ComputeCount <Int32>] [-CustomerContact <ICustomerContact[]>]
 ...
 [-MaintenanceWindowPatchingMode <PatchingMode>] [-MaintenanceWindowPreference <Preference>]
 [-MaintenanceWindowWeeksOfMonth <Int32[]>] [-StorageCount <Int32>] [-Tag <Hashtable>] [-Zone <String[]>]
...
```
Update-AzOracleDatabaseResourceManagerCloudExadataInfrastructure
 -InputObject <IOracleDatabaseResourceManagerIdentity> [-ComputeCount <Int32>]
 ...
 [-MaintenanceWindowPreference <Preference>] [-MaintenanceWindowWeeksOfMonth <Int32[]>]
 [-StorageCount <Int32>] [-Tag <Hashtable>] [-Zone <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.ICustomerContact[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDayOfWeek[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IMonth[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.PatchingMode
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.Preference
Parameter Sets: (All)
Aliases:
