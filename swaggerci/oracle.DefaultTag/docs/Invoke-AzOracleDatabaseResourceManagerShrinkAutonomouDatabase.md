...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/invoke-azoracledatabaseresourcemanagershrinkautonomoudatabase
schema: 2.0.0
---

# Invoke-AzOracleDatabaseResourceManagerShrinkAutonomouDatabase
...
### Shrink (Default)
```
Invoke-AzOracleDatabaseResourceManagerShrinkAutonomouDatabase -Autonomousdatabasename <String>
...
Parameter Sets: ShrinkViaIdentity
Aliases:
