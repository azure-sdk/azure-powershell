...
New-AzOracleDatabaseResourceManagerCloudVMCluster -Name <String> -ResourceGroupName <String>
 ...
 [-DbServer <String[]>] [-DisplayName <String>] [-Domain <String>]
 [-FileSystemConfigurationDetail <IFileSystemConfigurationDetails[]>] [-GiVersion <String>]
 [-Hostname <String>] [-IsLocalBackupEnabled] [-IsSparseDiskgroupEnabled] [-LicenseModel <LicenseModel>]
 [-MemorySizeInGb <Int32>] [-NsgCidr <INsgCidr[]>] [-OcpuCount <Single>] [-ScanListenerPortTcp <Int32>]
