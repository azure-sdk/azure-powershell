...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/new-azoracledatabaseresourcemanagerexadbvmcluster
schema: 2.0.0
---
...
```
New-AzOracleDatabaseResourceManagerExadbVMCluster -Name <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-BackupSubnetCidr <String>] [-ClusterName <String>]
 ...
 [-Hostname <String>] [-LicenseModel <LicenseModel>] [-NodeCount <Int32>] [-NsgCidr <INsgCidr[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.INsgCidr[]
Parameter Sets: (All)
Aliases:
