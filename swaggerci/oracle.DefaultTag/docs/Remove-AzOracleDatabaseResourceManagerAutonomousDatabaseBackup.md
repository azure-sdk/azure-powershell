...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/remove-azoracledatabaseresourcemanagerautonomousdatabasebackup
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerAutonomousDatabaseBackup
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerAutonomousDatabaseBackup -Adbbackupid <String>
