...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/remove-azoracledatabaseresourcemanagerfortestingautonomousdatabase
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerForTestingAutonomousDatabase
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerForTestingAutonomousDatabase -Name <String> -ResourceGroupName <String>
