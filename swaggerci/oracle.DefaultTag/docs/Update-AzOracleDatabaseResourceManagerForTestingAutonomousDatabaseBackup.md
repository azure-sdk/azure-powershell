...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/update-azoracledatabaseresourcemanagerfortestingautonomousdatabasebackup
schema: 2.0.0
---

# Update-AzOracleDatabaseResourceManagerForTestingAutonomousDatabaseBackup
...
```
Update-AzOracleDatabaseResourceManagerForTestingAutonomousDatabaseBackup -Adbbackupid <String>
...
```
Update-AzOracleDatabaseResourceManagerForTestingAutonomousDatabaseBackup
 -InputObject <IOracleDatabaseResourceManagerForTestingIdentity> [-RetentionPeriodInDay <Int32>]
