...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/remove-azoracledatabaseresourcemanagerfortestingcloudvmcluster
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerForTestingCloudVMCluster
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerForTestingCloudVMCluster -Name <String> -ResourceGroupName <String>
