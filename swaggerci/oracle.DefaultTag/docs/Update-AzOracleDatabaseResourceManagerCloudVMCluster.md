...
Update-AzOracleDatabaseResourceManagerCloudVMCluster -InputObject <IOracleDatabaseResourceManagerIdentity>
 ...
 [-FileSystemConfigurationDetail <IFileSystemConfigurationDetails[]>] [-LicenseModel <LicenseModel>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFileSystemConfigurationDetails[]
Parameter Sets: (All)
Aliases:
