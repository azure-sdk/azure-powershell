...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/new-azoracledatabaseresourcemanagerfortestingcloudvmcluster
schema: 2.0.0
---

# New-AzOracleDatabaseResourceManagerForTestingCloudVMCluster
...
```
New-AzOracleDatabaseResourceManagerForTestingCloudVMCluster -Name <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.INsgCidr[]
Parameter Sets: (All)
Aliases:
