...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/invoke-azoracledatabaseresourcemanagerfortestingswitchoverautonomoudatabase
schema: 2.0.0
---

# Invoke-AzOracleDatabaseResourceManagerForTestingSwitchoverAutonomouDatabase
...
```
Invoke-AzOracleDatabaseResourceManagerForTestingSwitchoverAutonomouDatabase -Autonomousdatabasename <String>
...
```
Invoke-AzOracleDatabaseResourceManagerForTestingSwitchoverAutonomouDatabase
 -InputObject <IOracleDatabaseResourceManagerForTestingIdentity> -Body <IPeerDbDetails>
...
```
Invoke-AzOracleDatabaseResourceManagerForTestingSwitchoverAutonomouDatabase
 -InputObject <IOracleDatabaseResourceManagerForTestingIdentity> [-PeerDbId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IPeerDbDetails
...
### Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IPeerDbDetails
