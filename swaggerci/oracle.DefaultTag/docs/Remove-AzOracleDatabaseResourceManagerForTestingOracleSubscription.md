...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/remove-azoracledatabaseresourcemanagerfortestingoraclesubscription
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerForTestingOracleSubscription
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerForTestingOracleSubscription [-SubscriptionId <String>]
