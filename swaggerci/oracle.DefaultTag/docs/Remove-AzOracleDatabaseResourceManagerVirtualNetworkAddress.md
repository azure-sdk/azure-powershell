...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/remove-azoracledatabaseresourcemanagervirtualnetworkaddress
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerVirtualNetworkAddress
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerVirtualNetworkAddress -Cloudvmclustername <String> -Name <String>
