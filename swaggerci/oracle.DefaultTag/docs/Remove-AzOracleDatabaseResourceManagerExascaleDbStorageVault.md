...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/remove-azoracledatabaseresourcemanagerexascaledbstoragevault
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerExascaleDbStorageVault
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerExascaleDbStorageVault -Name <String> -ResourceGroupName <String>
