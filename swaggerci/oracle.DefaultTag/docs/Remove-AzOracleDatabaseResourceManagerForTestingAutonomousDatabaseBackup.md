...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/remove-azoracledatabaseresourcemanagerfortestingautonomousdatabasebackup
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerForTestingAutonomousDatabaseBackup
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerForTestingAutonomousDatabaseBackup -Adbbackupid <String>
