...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/remove-azoracledatabaseresourcemanagerfortestingvirtualnetworkaddress
schema: 2.0.0
---

# Remove-AzOracleDatabaseResourceManagerForTestingVirtualNetworkAddress
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerForTestingVirtualNetworkAddress -Cloudvmclustername <String>
