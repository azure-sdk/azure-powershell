...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanagerfortesting/update-azoracledatabaseresourcemanagerfortestingcloudvmcluster
schema: 2.0.0
---

# Update-AzOracleDatabaseResourceManagerForTestingCloudVMCluster
...
```
Update-AzOracleDatabaseResourceManagerForTestingCloudVMCluster -Name <String> -ResourceGroupName <String>
...
```
Update-AzOracleDatabaseResourceManagerForTestingCloudVMCluster
 -InputObject <IOracleDatabaseResourceManagerForTestingIdentity> [-ComputeNode <String[]>]
