...
online version: https://learn.microsoft.com/powershell/module/az.oracledatabaseresourcemanager/remove-azoracledatabaseresourcemanagerautonomousdatabase
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzOracleDatabaseResourceManagerAutonomousDatabase -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzOracleDatabaseResourceManagerAutonomousDatabase -InputObject <IOracleDatabaseResourceManagerIdentity>
