...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901
{
    ...
    public partial class ConnectionStringType :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IConnectionStringType,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IConnectionStringTypeInternal
    {

        /// <summary>Backing field for <see cref="AllConnectionString" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringType _allConnectionString;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringType AllConnectionString { get => (this._allConnectionString = this._allConnectionString ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.AllConnectionStringType()); set => this._allConnectionString = value; }
        ...
        public string AllConnectionStringHigh { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringTypeInternal)AllConnectionString).High; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringTypeInternal)AllConnectionString).High = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PropertyOrigin.Inlined)]
        public string AllConnectionStringLow { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringTypeInternal)AllConnectionString).Low; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringTypeInternal)AllConnectionString).Low = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PropertyOrigin.Inlined)]
        public string AllConnectionStringMedium { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringTypeInternal)AllConnectionString).Medium; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringTypeInternal)AllConnectionString).Medium = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringType Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IConnectionStringTypeInternal.AllConnectionString { get => (this._allConnectionString = this._allConnectionString ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.AllConnectionStringType()); set { {_allConnectionString = value;} } }

        /// <summary>Backing field for <see cref="Profile" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IProfileType[] _profile;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IProfileType[] Profile { get => this._profile; set => this._profile = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IProfileType[] Profile { get; set; }
...

    {
        ...
        /// Returns all connection strings that can be used to connect to the Autonomous Database.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IAllConnectionStringType AllConnectionString { get; set; }
        /// <summary>
        /// The High database service provides the highest level of resources to each SQL statement resulting in the highest performance,
        /// but supports the fewest number of concurrent SQL statements.
        /// </summary>
