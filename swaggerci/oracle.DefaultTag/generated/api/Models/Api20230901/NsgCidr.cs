...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901
{
    ...
    public partial class NsgCidr :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.INsgCidrInternal
    {

        /// <summary>Backing field for <see cref="DestinationPortRange" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRange _destinationPortRange;
        ...
        public int? DestinationPortRangeMax { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRangeInternal)DestinationPortRange).Max; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRangeInternal)DestinationPortRange).Max = value ?? default(int); }

        /// <summary>
        /// The minimum port number, which must not be greater than the maximum port number.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PropertyOrigin.Inlined)]
        public int? DestinationPortRangeMin { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRangeInternal)DestinationPortRange).Min; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRangeInternal)DestinationPortRange).Min = value ?? default(int); }

        /// <summary>Internal Acessors for DestinationPortRange</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRange Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.INsgCidrInternal.DestinationPortRange { get => (this._destinationPortRange = this._destinationPortRange ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.PortRange()); set { {_destinationPortRange = value;} } }
    ...
    {
        /// <summary>Destination port range to specify particular destination ports for TCP rules.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20230901.IPortRange DestinationPortRange { get; set; }
        /// <summary>
        /// The maximum port number, which must not be less than the minimum port number. To specify a single port number, set both
        /// the min and max to the same value.
        /// </summary>
