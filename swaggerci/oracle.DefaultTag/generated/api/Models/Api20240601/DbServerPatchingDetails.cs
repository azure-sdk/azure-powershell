...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601
{
    ...
    public partial class DbServerPatchingDetails :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbServerPatchingDetails,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbServerPatchingDetailsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbServerPatchingDetailsInternal.EstimatedPatchDuration { get => this._estimatedPatchDuration; set { {_estimatedPatchDuration = value;} } }

        /// <summary>Internal Acessors for PatchingStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.DbServerPatchingStatus? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbServerPatchingDetailsInternal.PatchingStatus { get => this._patchingStatus; set { {_patchingStatus = value;} } }

        /// <summary>Internal Acessors for TimePatchingEnded</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbServerPatchingDetailsInternal.TimePatchingEnded { get => this._timePatchingEnded; set { {_timePatchingEnded = value;} } }

        /// <summary>Internal Acessors for TimePatchingStarted</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbServerPatchingDetailsInternal.TimePatchingStarted { get => this._timePatchingStarted; set { {_timePatchingStarted = value;} } }

        /// <summary>Backing field for <see cref="PatchingStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.DbServerPatchingStatus? _patchingStatus;

        /// <summary>Patching Status</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.DbServerPatchingStatus? PatchingStatus { get => this._patchingStatus; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.DbServerPatchingStatus? PatchingStatus { get;  }
        /// <summary>Time Patching Ended</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>Patching Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.DbServerPatchingStatus? PatchingStatus { get; set; }
        /// <summary>Time Patching Ended</summary>
