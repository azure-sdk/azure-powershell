...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601
{
    ...
    public partial class AutonomousDbVersionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.WorkloadType? DbWorkload { get => this._dbWorkload; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.WorkloadType? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal.DbWorkload { get => this._dbWorkload; set { {_dbWorkload = value;} } }

        /// <summary>Internal Acessors for IsDefaultForFree</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal.IsDefaultForFree { get => this._isDefaultForFree; set { {_isDefaultForFree = value;} } }

        /// <summary>Internal Acessors for IsDefaultForPaid</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal.IsDefaultForPaid { get => this._isDefaultForPaid; set { {_isDefaultForPaid = value;} } }

        /// <summary>Internal Acessors for IsFreeTierEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal.IsFreeTierEnabled { get => this._isFreeTierEnabled; set { {_isFreeTierEnabled = value;} } }

        /// <summary>Internal Acessors for IsPaidEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal.IsPaidEnabled { get => this._isPaidEnabled; set { {_isPaidEnabled = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IAutonomousDbVersionPropertiesInternal.Version { get => this._version; set { {_version = value;} } }
