...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601
{
    ...
    public partial class VirtualNetworkAddressProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IVirtualNetworkAddressProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IVirtualNetworkAddressPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.VirtualNetworkAddressLifecycleState? _lifecycleState;

        /// <summary>virtual network address lifecycle state.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Support.VirtualNetworkAddressLifecycleState? LifecycleState { get => this._lifecycleState; }

        /// <summary>Internal Acessors for Domain</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IVirtualNetworkAddressPropertiesInternal.Domain { get => this._domain; set { {_domain = value;} } }

        /// <summary>Internal Acessors for LifecycleDetail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IVirtualNetworkAddressPropertiesInternal.LifecycleDetail { get => this._lifecycleDetail; set { {_lifecycleDetail = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IVirtualNetworkAddressPropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IVirtualNetworkAddressPropertiesInternal.TimeAssigned { get => this._timeAssigned; set { {_timeAssigned = value;} } }
