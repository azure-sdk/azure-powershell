...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601
{
    ...
    public partial class ScheduledOperationsType :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IScheduledOperationsType,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IScheduledOperationsTypeInternal
    {

        /// <summary>Backing field for <see cref="DayOfWeek" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IDayOfWeek _dayOfWeek;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IDayOfWeek DayOfWeek { get => (this._dayOfWeek = this._dayOfWeek ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.DayOfWeek()); set => this._dayOfWeek = value; }
    ...
    {
        /// <summary>Day of week</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20240601.IDayOfWeek DayOfWeek { get; set; }
        /// <summary>Name of the day of the week.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.DayOfWeekName DayOfWeekName { get; set; }
        /// <summary>auto start time. value must be of ISO-8601 format HH:mm</summary>
        string ScheduledStartTime { get; set; }
