...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601
{
    ...
    public partial class DbSystemShapeProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapeProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableCoreCount { get => this._availableCoreCount; set { {_availableCoreCount = value;} } }

        /// <summary>Internal Acessors for AvailableCoreCountPerNode</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableCoreCountPerNode { get => this._availableCoreCountPerNode; set { {_availableCoreCountPerNode = value;} } }

        /// <summary>Internal Acessors for AvailableDataStorageInTb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableDataStorageInTb { get => this._availableDataStorageInTb; set { {_availableDataStorageInTb = value;} } }

        /// <summary>Internal Acessors for AvailableDataStoragePerServerInTb</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableDataStoragePerServerInTb { get => this._availableDataStoragePerServerInTb; set { {_availableDataStoragePerServerInTb = value;} } }

        /// <summary>Internal Acessors for AvailableDbNodePerNodeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableDbNodePerNodeInGb { get => this._availableDbNodePerNodeInGb; set { {_availableDbNodePerNodeInGb = value;} } }

        /// <summary>Internal Acessors for AvailableDbNodeStorageInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableDbNodeStorageInGb { get => this._availableDbNodeStorageInGb; set { {_availableDbNodeStorageInGb = value;} } }

        /// <summary>Internal Acessors for AvailableMemoryInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableMemoryInGb { get => this._availableMemoryInGb; set { {_availableMemoryInGb = value;} } }

        /// <summary>Internal Acessors for AvailableMemoryPerNodeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.AvailableMemoryPerNodeInGb { get => this._availableMemoryPerNodeInGb; set { {_availableMemoryPerNodeInGb = value;} } }

        /// <summary>Internal Acessors for CoreCountIncrement</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.CoreCountIncrement { get => this._coreCountIncrement; set { {_coreCountIncrement = value;} } }

        /// <summary>Internal Acessors for MaxStorageCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MaxStorageCount { get => this._maxStorageCount; set { {_maxStorageCount = value;} } }

        /// <summary>Internal Acessors for MaximumNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MaximumNodeCount { get => this._maximumNodeCount; set { {_maximumNodeCount = value;} } }

        /// <summary>Internal Acessors for MinCoreCountPerNode</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinCoreCountPerNode { get => this._minCoreCountPerNode; set { {_minCoreCountPerNode = value;} } }

        /// <summary>Internal Acessors for MinDataStorageInTb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinDataStorageInTb { get => this._minDataStorageInTb; set { {_minDataStorageInTb = value;} } }

        /// <summary>Internal Acessors for MinDbNodeStoragePerNodeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinDbNodeStoragePerNodeInGb { get => this._minDbNodeStoragePerNodeInGb; set { {_minDbNodeStoragePerNodeInGb = value;} } }

        /// <summary>Internal Acessors for MinMemoryPerNodeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinMemoryPerNodeInGb { get => this._minMemoryPerNodeInGb; set { {_minMemoryPerNodeInGb = value;} } }

        /// <summary>Internal Acessors for MinStorageCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinStorageCount { get => this._minStorageCount; set { {_minStorageCount = value;} } }

        /// <summary>Internal Acessors for MinimumCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinimumCoreCount { get => this._minimumCoreCount; set { {_minimumCoreCount = value;} } }

        /// <summary>Internal Acessors for MinimumNodeCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.MinimumNodeCount { get => this._minimumNodeCount; set { {_minimumNodeCount = value;} } }

        /// <summary>Internal Acessors for RuntimeMinimumCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.RuntimeMinimumCoreCount { get => this._runtimeMinimumCoreCount; set { {_runtimeMinimumCoreCount = value;} } }

        /// <summary>Internal Acessors for ShapeFamily</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IDbSystemShapePropertiesInternal.ShapeFamily { get => this._shapeFamily; set { {_shapeFamily = value;} } }
