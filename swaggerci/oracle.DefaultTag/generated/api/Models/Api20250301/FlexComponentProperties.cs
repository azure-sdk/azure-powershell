...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301
{
    ...
    public partial class FlexComponentProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.HardwareType? _hardwareType;

        /// <summary>
        /// The hardware type of the DB (Compute) or Storage (Cell) Server for this Flex Component.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.HardwareType? HardwareType { get => this._hardwareType; }

        /// <summary>Internal Acessors for AvailableCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.AvailableCoreCount { get => this._availableCoreCount; set { {_availableCoreCount = value;} } }

        /// <summary>Internal Acessors for AvailableDbStorageInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.AvailableDbStorageInGb { get => this._availableDbStorageInGb; set { {_availableDbStorageInGb = value;} } }

        /// <summary>Internal Acessors for AvailableLocalStorageInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.AvailableLocalStorageInGb { get => this._availableLocalStorageInGb; set { {_availableLocalStorageInGb = value;} } }

        /// <summary>Internal Acessors for AvailableMemoryInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.AvailableMemoryInGb { get => this._availableMemoryInGb; set { {_availableMemoryInGb = value;} } }

        /// <summary>Internal Acessors for ComputeModel</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.ComputeModel { get => this._computeModel; set { {_computeModel = value;} } }

        /// <summary>Internal Acessors for DescriptionSummary</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.DescriptionSummary { get => this._descriptionSummary; set { {_descriptionSummary = value;} } }

        /// <summary>Internal Acessors for HardwareType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.HardwareType? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.HardwareType { get => this._hardwareType; set { {_hardwareType = value;} } }

        /// <summary>Internal Acessors for MinimumCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.MinimumCoreCount { get => this._minimumCoreCount; set { {_minimumCoreCount = value;} } }

        /// <summary>Internal Acessors for RuntimeMinimumCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.RuntimeMinimumCoreCount { get => this._runtimeMinimumCoreCount; set { {_runtimeMinimumCoreCount = value;} } }

        /// <summary>Internal Acessors for Shape</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IFlexComponentPropertiesInternal.Shape { get => this._shape; set { {_shape = value;} } }
