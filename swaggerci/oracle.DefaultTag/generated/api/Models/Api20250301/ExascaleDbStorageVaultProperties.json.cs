...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301
{
    ...
    public partial class ExascaleDbStorageVaultProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject into a new instance of <see cref="ExascaleDbStorageVaultProperties" />.
        /// </summary>
        ...
        internal ExascaleDbStorageVaultProperties(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject json)
        {
            ...
            {_highCapacityDatabaseStorageInput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject>("highCapacityDatabaseStorageInput"), out var __jsonHighCapacityDatabaseStorageInput) ? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.ExascaleDbStorageInputDetails.FromJson(__jsonHighCapacityDatabaseStorageInput) : HighCapacityDatabaseStorageInput;}
            {_highCapacityDatabaseStorage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject>("highCapacityDatabaseStorage"), out var __jsonHighCapacityDatabaseStorage) ? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.ExascaleDbStorageDetails.FromJson(__jsonHighCapacityDatabaseStorage) : HighCapacityDatabaseStorage;}
            {_additionalFlashCacheInPercent = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNumber>("additionalFlashCacheInPercent"), out var __jsonAdditionalFlashCacheInPercent) ? (int?)__jsonAdditionalFlashCacheInPercent : AdditionalFlashCacheInPercent;}
            ...
            {_vMClusterCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNumber>("vmClusterCount"), out var __jsonVMClusterCount) ? (int?)__jsonVMClusterCount : VMClusterCount;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IExascaleDbStorageVaultProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IExascaleDbStorageVaultProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IExascaleDbStorageVaultProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject json ? new ExascaleDbStorageVaultProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ExascaleDbStorageVaultProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ExascaleDbStorageVaultProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._highCapacityDatabaseStorageInput ? (Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode) this._highCapacityDatabaseStorageInput.ToJson(null,serializationMode) : null, "highCapacityDatabaseStorageInput" ,container.Add );
            ...
            {
                AddIf( null != this._highCapacityDatabaseStorage ? (Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode) this._highCapacityDatabaseStorage.ToJson(null,serializationMode) : null, "highCapacityDatabaseStorage" ,container.Add );
            }
            AddIf( null != this._additionalFlashCacheInPercent ? (Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNumber((int)this._additionalFlashCacheInPercent) : null, "additionalFlashCacheInPercent" ,container.Add );
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._vMClusterCount ? (Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNumber((int)this._vMClusterCount) : null, "vmClusterCount" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.SerializationMode.IncludeReadOnly))
            {
