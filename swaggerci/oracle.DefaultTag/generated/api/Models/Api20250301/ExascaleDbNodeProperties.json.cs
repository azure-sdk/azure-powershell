...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301
{
    ...
    public partial class ExascaleDbNodeProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject into a new instance of <see cref="ExascaleDbNodeProperties" />.
        /// </summary>
        ...
        internal ExascaleDbNodeProperties(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject json)
        {
            ...
            {_totalCpuCoreCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNumber>("totalCpuCoreCount"), out var __jsonTotalCpuCoreCount) ? (int?)__jsonTotalCpuCoreCount : TotalCpuCoreCount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IExascaleDbNodeProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IExascaleDbNodeProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IExascaleDbNodeProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject json ? new ExascaleDbNodeProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ExascaleDbNodeProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ExascaleDbNodeProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._totalCpuCoreCount ? (Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Json.JsonNumber((int)this._totalCpuCoreCount) : null, "totalCpuCoreCount" ,container.Add );
