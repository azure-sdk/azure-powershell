...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301
{
    ...
    public partial class NsgCidr :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.INsgCidrInternal
    {

        /// <summary>Backing field for <see cref="DestinationPortRange" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IPortRange _destinationPortRange;
    ...
    {
        /// <summary>Destination port range to specify particular destination ports for TCP rules.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20250301.IPortRange DestinationPortRange { get; set; }
        /// <summary>
        /// The maximum port number, which must not be less than the minimum port number. To specify a single port number, set both
        /// the min and max to the same value.
        /// </summary>
