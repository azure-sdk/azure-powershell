...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview
{
    ...
    public partial class GenerateAutonomousDatabaseWalletDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IGenerateAutonomousDatabaseWalletDetailsInternal
    {

        /// <summary>Backing field for <see cref="GenerateType" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.GenerateType? _generateType;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.GenerateType? GenerateType { get => this._generateType; set => this._generateType = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.GenerateType? GenerateType { get; set; }
        /// <summary>
        /// True when requesting regional connection strings in PDB connect info, applicable to cross-region DG only.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Info(
