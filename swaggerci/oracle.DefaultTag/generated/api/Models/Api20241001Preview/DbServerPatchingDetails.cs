...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview
{
    ...
    public partial class DbServerPatchingDetails :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDbServerPatchingDetails,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDbServerPatchingDetailsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDbServerPatchingDetailsInternal.EstimatedPatchDuration { get => this._estimatedPatchDuration; set { {_estimatedPatchDuration = value;} } }

        /// <summary>Internal Acessors for PatchingStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.DbServerPatchingStatus? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDbServerPatchingDetailsInternal.PatchingStatus { get => this._patchingStatus; set { {_patchingStatus = value;} } }

        /// <summary>Internal Acessors for TimePatchingEnded</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDbServerPatchingDetailsInternal.TimePatchingEnded { get => this._timePatchingEnded; set { {_timePatchingEnded = value;} } }

        /// <summary>Internal Acessors for TimePatchingStarted</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Models.Api20241001Preview.IDbServerPatchingDetailsInternal.TimePatchingStarted { get => this._timePatchingStarted; set { {_timePatchingStarted = value;} } }

        /// <summary>Backing field for <see cref="PatchingStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.DbServerPatchingStatus? _patchingStatus;

        /// <summary>Patching Status</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.DbServerPatchingStatus? PatchingStatus { get => this._patchingStatus; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.DbServerPatchingStatus? PatchingStatus { get;  }
        /// <summary>Time Patching Ended</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>Patching Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManager.Support.DbServerPatchingStatus? PatchingStatus { get; set; }
        /// <summary>Time Patching Ended</summary>
