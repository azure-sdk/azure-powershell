...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Oracle.Database/autonomousDatabases"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOracleDatabaseResourceManagerForTestingAutonomouDatabase_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Description(@"List AutonomousDatabase resources by subscription ID")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Oracle.Database/autonomousDatabases", ApiVersion = "2024-06-01")]
    public partial class GetAzOracleDatabaseResourceManagerForTestingAutonomouDatabase_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzOracleDatabaseResourceManagerForTestingAutonomouDatabase_List" /> cmdlet
        /// class.
        /// </summary>
        public GetAzOracleDatabaseResourceManagerForTestingAutonomouDatabase_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AutonomousDatabasesListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IAutonomousDatabaseListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AutonomousDatabasesListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
