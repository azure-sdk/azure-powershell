...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzOracleDatabaseResourceManagerForTestingAutonomouDatabaseWallet_Generate", SupportsShouldProcess = true)]
    ...
    public partial class NewAzOracleDatabaseResourceManagerForTestingAutonomouDatabaseWallet_Generate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IGenerateAutonomousDatabaseWalletDetails _body;

        /// <summary>Autonomous Database Generate Wallet resource model.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Autonomous Database Generate Wallet resource model.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Autonomous Database Generate Wallet resource model.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IGenerateAutonomousDatabaseWalletDetails) })]
        public Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api20240601.IGenerateAutonomousDatabaseWalletDetails Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzOracleDatabaseResourceManagerForTestingAutonomouDatabaseWallet_Generate"
        /// /> cmdlet class.
        /// </summary>
        public NewAzOracleDatabaseResourceManagerForTestingAutonomouDatabaseWallet_Generate()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AutonomousDatabasesGenerateWallet(SubscriptionId, ResourceGroupName, Autonomousdatabasename, Body, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Autonomousdatabasename=Autonomousdatabasename,body=Body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabaseResourceManagerForTesting.Models.Api50.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Autonomousdatabasename=Autonomousdatabasename, body=Body })
                    {
