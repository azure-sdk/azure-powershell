...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Models.Api20151101Preview
{
    ...
    public partial class ErrorResponse
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonObject into a new instance of <see cref="ErrorResponse" />.
        /// </summary>
        ...
        internal ErrorResponse(Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonObject json)
        {
            ...
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Models.Api20151101Preview.Error.FromJson(__jsonError) : Error;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Models.Api20151101Preview.IErrorResponse.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Models.Api20151101Preview.IErrorResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Models.Api20151101Preview.IErrorResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonObject json ? new ErrorResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ErrorResponse" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ErrorResponse" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._error ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceMap.Runtime.Json.JsonNode) this._error.ToJson(null,serializationMode) : null, "error" ,container.Add );
