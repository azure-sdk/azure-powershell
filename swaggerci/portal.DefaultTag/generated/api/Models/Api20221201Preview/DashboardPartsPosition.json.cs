...
namespace Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.Api20221201Preview
{
    ...
    public partial class DashboardPartsPosition
    {
        ...
        internal DashboardPartsPosition(Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject json)
        {
            ...
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.Api20221201Preview.DashboardPartsPositionMetadata.FromJson(__jsonMetadata) : Metadata;}
            AfterFromJson(json);
        }
