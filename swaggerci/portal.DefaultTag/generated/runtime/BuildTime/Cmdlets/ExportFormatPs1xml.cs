...
namespace Microsoft.Azure.PowerShell.Cmdlets.PortalForTesting.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PortalForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PortalForTesting.Support";
