...
.Link
https://learn.microsoft.com/powershell/module/az.portal/get-azportallisttenantconfigurationviolationsoperation
#>
function Get-AzPortalListTenantConfigurationViolationsOperation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Portal.private\Get-AzPortalListTenantConfigurationViolationsOperation_List';
        }
