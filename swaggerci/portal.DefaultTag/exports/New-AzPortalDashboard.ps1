...
LENS <IDashboardLens[]>: The dashboard lenses.
  ...
  Part <IDashboardParts[]>: The dashboard parts.
    ...
    [Metadata <IDashboardPartMetadata>]: The dashboard part's metadata.
      [(Any) <Object>]: This indicates any property can be added to this object.
      Type <String>: The type of dashboard part.
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Portal.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Portal.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Portal.Models.Api20221201Preview.IDashboardTags]))]
    [System.Collections.Hashtable]
    # Resource tags
    ${Tag},
