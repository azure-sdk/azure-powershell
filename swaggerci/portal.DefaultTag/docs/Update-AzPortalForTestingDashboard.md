...
online version: https://learn.microsoft.com/powershell/module/az.portalfortesting/update-azportalfortestingdashboard
schema: 2.0.0
---

# Update-AzPortalForTestingDashboard
...
```
Update-AzPortalForTestingDashboard -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzPortalForTestingDashboard -InputObject <IPortalForTestingIdentity> [-Lens <IDashboardLens[]>]
 [-Metadata <IAny>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
