...
```
New-AzStreamAnalyticsTransformation -JobName <String> -ResourceGroupName <String> -TransformationName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-IfNoneMatch <String>] [-Name <String>] [-Query <String>]
 [-StreamingUnit <Int32>] [-ValidStreamingUnit <Int32[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.StreamAnalytics.Models.Api20200301.ITransformation
