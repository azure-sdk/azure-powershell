...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IPeeringServiceProvider
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IPeeringServiceProvider])]
