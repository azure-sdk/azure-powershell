...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IDirectConnection[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IExchangeConnection[]
Parameter Sets: (All)
Aliases:
