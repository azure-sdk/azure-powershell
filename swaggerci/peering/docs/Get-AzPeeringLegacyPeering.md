...
online version: https://docs.microsoft.com/en-us/powershell/module/az.peering/get-azpeeringlegacypeering
schema: 2.0.0
---
...
```
Get-AzPeeringLegacyPeering -Kind <LegacyPeeringsKind> -PeeringLocation <String> [-SubscriptionId <String[]>]
