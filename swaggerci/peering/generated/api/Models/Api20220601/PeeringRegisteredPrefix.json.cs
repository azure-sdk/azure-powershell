...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601
{
    ...
    public partial class PeeringRegisteredPrefix
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IPeeringRegisteredPrefix.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IPeeringRegisteredPrefix.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IPeeringRegisteredPrefix FromJson(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject json ? new PeeringRegisteredPrefix(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject into a new instance of <see cref="PeeringRegisteredPrefix" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PeeringRegisteredPrefix(Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.Resource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.PeeringRegisteredPrefixProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PeeringRegisteredPrefix" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PeeringRegisteredPrefix" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Json.JsonNode" />.
        /// </returns>
