...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601
{
    ...
    public partial class OperationDisplayInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IOperationDisplayInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IOperationDisplayInfoInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IOperationDisplayInfoInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IOperationDisplayInfoInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IOperationDisplayInfoInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20220601.IOperationDisplayInfoInternal.Resource { get => this._resource; set { {_resource = value;} } }
