...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201
{
    ...
    public partial class PeeringServiceLocation :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.IValidates
    {
        ...
        public string AzureRegion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationPropertiesInternal)Property).AzureRegion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationPropertiesInternal)Property).AzureRegion = value ?? null; }

        /// <summary>Country of the customer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public string Country { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationPropertiesInternal)Property).Country; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationPropertiesInternal)Property).Country = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationProperties Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.PeeringServiceLocationProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.PeeringServiceLocationProperties()); set => this._property = value; }

        /// <summary>State of the customer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Inlined)]
        public string State { get => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationPropertiesInternal)Property).State; set => ((Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationPropertiesInternal)Property).State = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IResourceInternal
    {
        ...
        string Country { get; set; }
        /// <summary>The properties that define a peering service location.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api202201.IPeeringServiceLocationProperties Property { get; set; }
        /// <summary>State of the customer</summary>
        string State { get; set; }
