...
$dll = Join-Path $PSScriptRoot 'bin/Az.Adp.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.Adp.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Adp.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Adp cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Adp.format.ps1xml'
