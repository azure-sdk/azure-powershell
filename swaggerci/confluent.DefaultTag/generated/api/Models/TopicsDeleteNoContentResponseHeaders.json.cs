...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models
{
    ...
    public partial class TopicsDeleteNoContentResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.ITopicsDeleteNoContentResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.ITopicsDeleteNoContentResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.ITopicsDeleteNoContentResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json ? new TopicsDeleteNoContentResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="TopicsDeleteNoContentResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TopicsDeleteNoContentResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject into a new instance of <see cref="TopicsDeleteNoContentResponseHeaders" />.
        /// </summary>
        ...
        internal TopicsDeleteNoContentResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
