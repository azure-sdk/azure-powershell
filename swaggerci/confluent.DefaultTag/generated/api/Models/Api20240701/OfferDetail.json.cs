...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701
{
    ...
    public partial class OfferDetail
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IOfferDetail.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IOfferDetail.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IOfferDetail FromJson(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode node)
        {
        ...
        internal OfferDetail(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json)
        {
            ...
            {_termId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("termId"), out var __jsonTermId) ? (string)__jsonTermId : (string)TermId;}
            {_privateOfferId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("privateOfferId"), out var __jsonPrivateOfferId) ? (string)__jsonPrivateOfferId : (string)PrivateOfferId;}
            {_privateOfferIds = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonArray>("privateOfferIds"), out var __jsonPrivateOfferIds) ? If( __jsonPrivateOfferIds as Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : PrivateOfferIds;}
