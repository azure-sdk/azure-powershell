...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701
{
    ...
    public partial class EnvironmentProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IEnvironmentProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IEnvironmentPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IScMetadataEntity Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IEnvironmentPropertiesInternal.Metadata { get => (this._metadata = this._metadata ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.ScMetadataEntity()); set { {_metadata = value;} } }

        /// <summary>Internal Acessors for StreamGovernanceConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IStreamGovernanceConfig Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IEnvironmentPropertiesInternal.StreamGovernanceConfig { get => (this._streamGovernanceConfig = this._streamGovernanceConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.StreamGovernanceConfig()); set { {_streamGovernanceConfig = value;} } }

        /// <summary>Backing field for <see cref="StreamGovernanceConfig" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IStreamGovernanceConfig _streamGovernanceConfig;

        /// <summary>Stream governance configuration</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IStreamGovernanceConfig StreamGovernanceConfig { get => (this._streamGovernanceConfig = this._streamGovernanceConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.StreamGovernanceConfig()); set => this._streamGovernanceConfig = value; }

        /// <summary>Stream governance configuration</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Confluent.Support.Package? StreamGovernanceConfigPackage { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IStreamGovernanceConfigInternal)StreamGovernanceConfig).Package; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IStreamGovernanceConfigInternal)StreamGovernanceConfig).Package = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Support.Package)""); }
