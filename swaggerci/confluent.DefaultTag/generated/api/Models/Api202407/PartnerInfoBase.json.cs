...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407
{
    ...
    public partial class PartnerInfoBase
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IPartnerInfoBase.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IPartnerInfoBase interface is polymorphic, and
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IPartnerInfoBase.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IPartnerInfoBase FromJson(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json))
            {
                return null;
            }
            // Polymorphic type -- select the appropriate constructor using the discriminator

            switch ( json.StringProperty("partnerConnectorType") )
            {
                case "KafkaAzureBlobStorageSink":
                {
                    return new KafkaAzureBlobStorageSinkConnectorInfo(json);
                }
                case "KafkaAzureBlobStorageSource":
                {
                    return new KafkaAzureBlobStorageSourceConnectorInfo(json);
                }
            }
            return new PartnerInfoBase(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject into a new instance of <see cref="PartnerInfoBase" />.
        /// </summary>
        ...
        internal PartnerInfoBase(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json)
        {
            ...
            {_partnerConnectorType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString>("partnerConnectorType"), out var __jsonPartnerConnectorType) ? (string)__jsonPartnerConnectorType : (string)PartnerConnectorType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PartnerInfoBase" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PartnerInfoBase" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._partnerConnectorType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonString(this._partnerConnectorType.ToString()) : null, "partnerConnectorType" ,container.Add );
