...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407
{
    ...
    public partial class AccessInviteUserAccountModel :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessInviteUserAccountModelInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessInvitedUserDetails _invitedUserDetail;

        /// <summary>Details of the user who is being invited</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessInvitedUserDetails InvitedUserDetail { get => (this._invitedUserDetail = this._invitedUserDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.AccessInvitedUserDetails()); set => this._invitedUserDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessInvitedUserDetails Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessInviteUserAccountModelInternal.InvitedUserDetail { get => (this._invitedUserDetail = this._invitedUserDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.AccessInvitedUserDetails()); set { {_invitedUserDetail = value;} } }
...

    {
        ...
        string Email { get; set; }
        /// <summary>Details of the user who is being invited</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessInvitedUserDetails InvitedUserDetail { get; set; }
        /// <summary>Auth type of the user</summary>
        string InvitedUserDetailAuthType { get; set; }
        /// <summary>UPN/Email of the user who is being invited</summary>
        string InvitedUserDetailInvitedEmail { get; set; }
