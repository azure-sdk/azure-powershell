...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407
{
    ...
    public partial class SchemaRegistryClusterSpecEntity :
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterSpecEntity,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterSpecEntityInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntity _environment;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntity _region;

        /// <summary>Region details of the schema registry cluster</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntity Region { get => (this._region = this._region ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.SchemaRegistryClusterEnvironmentRegionEntity()); set => this._region = value; }

        /// <summary>ID of the referred resource</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inlined)]
        public string RegionId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntityInternal)Region).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntityInternal)Region).Id = value ?? null; }

        /// <summary>API URL for accessing or modifying the referred object</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inlined)]
        public string RegionRelated { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntityInternal)Region).Related; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntityInternal)Region).Related = value ?? null; }
...

    {
        ...
        string Cloud { get; set; }
        /// <summary>Environment details of the schema registry cluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntity Environment { get; set; }
        /// <summary>ID of the referred resource</summary>
        string EnvironmentId { get; set; }
        /// <summary>API URL for accessing or modifying the referred object</summary>
        string EnvironmentRelated { get; set; }
        ...
        string Package { get; set; }
        /// <summary>Region details of the schema registry cluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.ISchemaRegistryClusterEnvironmentRegionEntity Region { get; set; }
        /// <summary>ID of the referred resource</summary>
        string RegionId { get; set; }
        /// <summary>API URL for accessing or modifying the referred object</summary>
        string RegionRelated { get; set; }
