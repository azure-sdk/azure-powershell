...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models
{
    ...
    public partial class ClusterDeleteNoContentResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject into a new instance of <see cref="ClusterDeleteNoContentResponseHeaders" />.
        /// </summary>
        ...
        internal ClusterDeleteNoContentResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IClusterDeleteNoContentResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IClusterDeleteNoContentResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.IClusterDeleteNoContentResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonObject json ? new ClusterDeleteNoContentResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ClusterDeleteNoContentResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ClusterDeleteNoContentResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Json.JsonNode" />.
        /// </returns>
