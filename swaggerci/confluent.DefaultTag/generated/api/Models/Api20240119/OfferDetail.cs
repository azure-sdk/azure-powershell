...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240119
{
    ...
    public partial class OfferDetail :
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240119.IOfferDetail,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240119.IOfferDetailInternal
    {
        ...
        private string[] _privateOfferIds;

        /// <summary>Array of Private Offer Ids</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Owned)]
        public string[] PrivateOfferIds { get => this._privateOfferIds; set => this._privateOfferIds = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string[] PrivateOfferIds { get; set; }
        /// <summary>Publisher Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Info(
        Required = true,
        ReadOnly = false,
