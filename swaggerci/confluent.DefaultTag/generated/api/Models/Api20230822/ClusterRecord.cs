...
namespace Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822
{
    ...
    public partial class ClusterRecord :
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterRecord,
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterRecordInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IMetadataEntity Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterRecordInternal.Metadata { get => (this._metadata = this._metadata ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.MetadataEntity()); set { {_metadata = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntity Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterRecordInternal.Status { get => (this._status = this._status ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.ClusterStatusEntity()); set { {_status = value;} } }

        /// <summary>Backing field for <see cref="Spec" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterSpecEntity _spec;

        /// <summary>Specification of the cluster</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterSpecEntity Spec { get => (this._spec = this._spec ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.ClusterSpecEntity()); set => this._spec = value; }

        /// <summary>Backing field for <see cref="Status" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntity _status;

        /// <summary>Specification of the cluster</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntity Status { get => (this._status = this._status ?? new Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.ClusterStatusEntity()); set => this._status = value; }

        /// <summary>The number of Confluent Kafka Units</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inlined)]
        public int? StatusCku { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntityInternal)Status).Cku; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntityInternal)Status).Cku = value ?? default(int); }

        /// <summary>The lifecycle phase of the cluster</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Origin(Microsoft.Azure.PowerShell.Cmdlets.Confluent.PropertyOrigin.Inlined)]
        public string StatusPhase { get => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntityInternal)Status).Phase; set => ((Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntityInternal)Status).Phase = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"spec",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterSpecEntity) })]
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterSpecEntity Spec { get; set; }
        /// <summary>The number of Confluent Kafka Units</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterSpecEntity Spec { get; set; }
        /// <summary>Specification of the cluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IClusterStatusEntity Status { get; set; }
        /// <summary>The number of Confluent Kafka Units</summary>
        int? StatusCku { get; set; }
        /// <summary>The lifecycle phase of the cluster</summary>
        string StatusPhase { get; set; }
