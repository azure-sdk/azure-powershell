...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IOperationResult
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20230822.IOperationResult])]
