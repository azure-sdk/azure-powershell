...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IScClusterRecord
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IScClusterRecord])]
