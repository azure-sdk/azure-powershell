...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IAccessListEnvironmentsSuccessResponse])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Confluent.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api202407.IListAccessRequestModelSearchFilters]))]
