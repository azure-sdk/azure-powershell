...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IAccessListEnvironmentsSuccessResponse
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20240701.IAccessListEnvironmentsSuccessResponse])]
