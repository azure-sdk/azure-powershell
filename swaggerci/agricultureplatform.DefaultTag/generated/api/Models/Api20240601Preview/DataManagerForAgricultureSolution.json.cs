...
namespace Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview
{
    ...
    public partial class DataManagerForAgricultureSolution
    {
        ...
        internal DataManagerForAgricultureSolution(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonObject json)
        {
            ...
            {_marketPlaceOfferDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonObject>("marketPlaceOfferDetails"), out var __jsonMarketPlaceOfferDetails) ? Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.MarketPlaceOfferDetails.FromJson(__jsonMarketPlaceOfferDetails) : MarketPlaceOfferDetail;}
            ...
            {_solutionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("solutionId"), out var __jsonSolutionId) ? (string)__jsonSolutionId : (string)SolutionId;}
            {_partnerTenantId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("partnerTenantId"), out var __jsonPartnerTenantId) ? (string)__jsonPartnerTenantId : (string)PartnerTenantId;}
            {_dataAccessScope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonArray>("dataAccessScopes"), out var __jsonDataAccessScopes) ? If( __jsonDataAccessScopes as Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : DataAccessScope;}
            {_saasApplicationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("saasApplicationId"), out var __jsonSaasApplicationId) ? (string)__jsonSaasApplicationId : (string)SaasApplicationId;}
            {_accessAzureDataManagerForAgricultureApplicationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("accessAzureDataManagerForAgricultureApplicationId"), out var __jsonAccessAzureDataManagerForAgricultureApplicationId) ? (string)__jsonAccessAzureDataManagerForAgricultureApplicationId : (string)AccessAzureDataManagerForAgricultureApplicationId;}
            {_accessAzureDataManagerForAgricultureApplicationName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("accessAzureDataManagerForAgricultureApplicationName"), out var __jsonAccessAzureDataManagerForAgricultureApplicationName) ? (string)__jsonAccessAzureDataManagerForAgricultureApplicationName : (string)AccessAzureDataManagerForAgricultureApplicationName;}
            {_isValidateInput = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonBoolean>("isValidateInput"), out var __jsonIsValidateInput) ? (bool)__jsonIsValidateInput : IsValidateInput;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IDataManagerForAgricultureSolution.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IDataManagerForAgricultureSolution.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IDataManagerForAgricultureSolution FromJson(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonNode node)
        {
