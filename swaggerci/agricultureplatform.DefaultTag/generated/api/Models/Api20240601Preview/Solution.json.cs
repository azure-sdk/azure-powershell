...
namespace Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview
{
    ...
    public partial class Solution
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.ISolution.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.ISolution.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.ISolution FromJson(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonNode node)
        {
        ...
        internal Solution(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonObject json)
        {
            ...
            {_applicationName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("applicationName"), out var __jsonApplicationName) ? (string)__jsonApplicationName : (string)ApplicationName;}
            {_partnerId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("partnerId"), out var __jsonPartnerId) ? (string)__jsonPartnerId : (string)PartnerId;}
            {_marketPlacePublisherId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("marketPlacePublisherId"), out var __jsonMarketPlacePublisherId) ? (string)__jsonMarketPlacePublisherId : (string)MarketPlacePublisherId;}
            {_saasSubscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("saasSubscriptionId"), out var __jsonSaasSubscriptionId) ? (string)__jsonSaasSubscriptionId : (string)SaasSubscriptionId;}
            {_saasSubscriptionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("saasSubscriptionName"), out var __jsonSaasSubscriptionName) ? (string)__jsonSaasSubscriptionName : (string)SaasSubscriptionName;}
            {_planId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Json.JsonString>("planId"), out var __jsonPlanId) ? (string)__jsonPlanId : (string)PlanId;}
            AfterFromJson(json);
        }
