...
namespace Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview
{
    ...
    public partial class DataManagerForAgricultureSolution :
        Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IDataManagerForAgricultureSolution,
        Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IDataManagerForAgricultureSolutionInternal
    {
        ...
        private string[] _dataAccessScope;

        /// <summary>Data access scopes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.PropertyOrigin.Owned)]
        public string[] DataAccessScope { get => this._dataAccessScope; set => this._dataAccessScope = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetails _marketPlaceOfferDetail;

        /// <summary>Marketplace offer details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetails MarketPlaceOfferDetail { get => (this._marketPlaceOfferDetail = this._marketPlaceOfferDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.MarketPlaceOfferDetails()); set => this._marketPlaceOfferDetail = value; }
        ...
        public string MarketPlaceOfferDetailPublisherId { get => ((Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetailsInternal)MarketPlaceOfferDetail).PublisherId; set => ((Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetailsInternal)MarketPlaceOfferDetail).PublisherId = value ; }

        /// <summary>Saas offer Id.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.PropertyOrigin.Inlined)]
        public string MarketPlaceOfferDetailSaasOfferId { get => ((Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetailsInternal)MarketPlaceOfferDetail).SaasOfferId; set => ((Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetailsInternal)MarketPlaceOfferDetail).SaasOfferId = value ; }

        /// <summary>Internal Acessors for MarketPlaceOfferDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetails Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IDataManagerForAgricultureSolutionInternal.MarketPlaceOfferDetail { get => (this._marketPlaceOfferDetail = this._marketPlaceOfferDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.MarketPlaceOfferDetails()); set { {_marketPlaceOfferDetail = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string[] DataAccessScope { get; set; }
        /// <summary>Whether solution inference will validate input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Runtime.Info(
        Required = true,
        ReadOnly = false,
...

    {
        ...
        bool IsValidateInput { get; set; }
        /// <summary>Marketplace offer details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AgriculturePlatform.Models.Api20240601Preview.IMarketPlaceOfferDetails MarketPlaceOfferDetail { get; set; }
        /// <summary>Publisher Id.</summary>
        string MarketPlaceOfferDetailPublisherId { get; set; }
        /// <summary>Saas offer Id.</summary>
        string MarketPlaceOfferDetailSaasOfferId { get; set; }
