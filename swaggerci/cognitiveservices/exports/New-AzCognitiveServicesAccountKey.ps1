...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20221001.IRegenerateKeyParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20221001.IApiKeys])]
