...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.cognitiveservices/new-azcognitiveservicescommitmentplanassociation
#>
function New-AzCognitiveServicesCommitmentPlanAssociation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20221201.ICommitmentPlanAccountAssociation])]
