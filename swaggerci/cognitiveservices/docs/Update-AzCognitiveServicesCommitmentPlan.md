...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cognitiveservices/update-azcognitiveservicescommitmentplan
schema: 2.0.0
---

# Update-AzCognitiveServicesCommitmentPlan
...
```
Update-AzCognitiveServicesCommitmentPlan -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzCognitiveServicesCommitmentPlan -InputObject <ICognitiveServicesIdentity> [-SkuCapacity <Int32>]
