...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cognitiveservices/clear-azcognitiveservicesdeletedaccount
schema: 2.0.0
---

# Clear-AzCognitiveServicesDeletedAccount
...
### Purge (Default)
```
Clear-AzCognitiveServicesDeletedAccount -AccountName <String> -Location <String> -ResourceGroupName <String>
...
### PurgeViaIdentity
```
Clear-AzCognitiveServicesDeletedAccount -InputObject <ICognitiveServicesIdentity> [-DefaultProfile <PSObject>]
