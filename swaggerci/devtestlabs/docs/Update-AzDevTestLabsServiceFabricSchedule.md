...
Update-AzDevTestLabsServiceFabricSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 -ServiceFabricName <String> -UserName <String> [-SubscriptionId <String>] [-IdentityClientSecretUrl <String>]
...
```
Update-AzDevTestLabsServiceFabricSchedule -InputObject <IDevTestLabsIdentity>
