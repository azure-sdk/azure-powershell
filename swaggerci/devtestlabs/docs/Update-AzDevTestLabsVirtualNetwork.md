...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsvirtualnetwork
schema: 2.0.0
---
...
```
Update-AzDevTestLabsVirtualNetwork -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
