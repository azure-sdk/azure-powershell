...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsvirtualmachineschedule
schema: 2.0.0
---

# Update-AzDevTestLabsVirtualMachineSchedule
...
```
Update-AzDevTestLabsVirtualMachineSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 -VirtualMachineName <String> [-SubscriptionId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDevTestLabsVirtualMachineSchedule -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
