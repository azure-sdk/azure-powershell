...
Update-AzDevTestLabsVirtualMachineSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 -VirtualMachineName <String> [-SubscriptionId <String>] [-IdentityClientSecretUrl <String>]
...
```
Update-AzDevTestLabsVirtualMachineSchedule -InputObject <IDevTestLabsIdentity>
