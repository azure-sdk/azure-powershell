...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabssecret
schema: 2.0.0
---

# Update-AzDevTestLabsSecret
...
```
Update-AzDevTestLabsSecret -LabName <String> -Name <String> -ResourceGroupName <String> -UserName <String>
...
```
Update-AzDevTestLabsSecret -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
