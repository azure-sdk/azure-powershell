...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabssecret
schema: 2.0.0
---
...
```
Update-AzDevTestLabsSecret -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
