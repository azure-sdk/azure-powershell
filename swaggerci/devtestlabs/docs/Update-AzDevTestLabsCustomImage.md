...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabscustomimage
schema: 2.0.0
---
...
```
Update-AzDevTestLabsCustomImage -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
