...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabscustomimage
schema: 2.0.0
---

# Update-AzDevTestLabsCustomImage
...
```
Update-AzDevTestLabsCustomImage -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsCustomImage -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
