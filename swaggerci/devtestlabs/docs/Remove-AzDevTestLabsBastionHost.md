...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsbastionhost
schema: 2.0.0
---

# Remove-AzDevTestLabsBastionHost
...
### Delete (Default)
```
Remove-AzDevTestLabsBastionHost -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsBastionHost -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
