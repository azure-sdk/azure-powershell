...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsuser
schema: 2.0.0
---

# Remove-AzDevTestLabsUser
...
### Delete (Default)
```
Remove-AzDevTestLabsUser -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsUser -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
