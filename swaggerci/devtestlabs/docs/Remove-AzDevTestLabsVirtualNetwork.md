...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsvirtualnetwork
schema: 2.0.0
---

# Remove-AzDevTestLabsVirtualNetwork
...
### Delete (Default)
```
Remove-AzDevTestLabsVirtualNetwork -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsVirtualNetwork -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
