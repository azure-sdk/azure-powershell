...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabssharedgallery
schema: 2.0.0
---

# Update-AzDevTestLabsSharedGallery
...
```
Update-AzDevTestLabsSharedGallery -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsSharedGallery -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
