...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsdetachvirtualmachinedatadisk
schema: 2.0.0
---

# Invoke-AzDevTestLabsDetachVirtualMachineDataDisk
...
```
Invoke-AzDevTestLabsDetachVirtualMachineDataDisk -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ExistingLabDiskId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```
Invoke-AzDevTestLabsDetachVirtualMachineDataDisk -LabName <String> -Name <String> -ResourceGroupName <String>
 -DetachDataDiskProperty <IDetachDataDiskProperties> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DetachViaIdentity
```
Invoke-AzDevTestLabsDetachVirtualMachineDataDisk -InputObject <IDevTestLabsIdentity>
 -DetachDataDiskProperty <IDetachDataDiskProperties> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-AzDevTestLabsDetachVirtualMachineDataDisk -InputObject <IDevTestLabsIdentity>
 [-ExistingLabDiskId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDetachDataDiskProperties
...
### Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDetachDataDiskProperties
