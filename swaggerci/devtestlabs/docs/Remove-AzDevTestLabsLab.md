...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabslab
schema: 2.0.0
---

# Remove-AzDevTestLabsLab
...
### Delete (Default)
```
Remove-AzDevTestLabsLab -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsLab -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
