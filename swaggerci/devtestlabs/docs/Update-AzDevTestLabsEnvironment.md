...
Update-AzDevTestLabsEnvironment -LabName <String> -Name <String> -ResourceGroupName <String>
 -UserName <String> [-SubscriptionId <String>] [-IdentityClientSecretUrl <String>]
...
```
Update-AzDevTestLabsEnvironment -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
 [-IdentityPrincipalId <String>] [-IdentityTenantId <String>] [-IdentityType <ManagedIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
