...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/start-azdevtestlabsvirtualmachine
schema: 2.0.0
---

# Start-AzDevTestLabsVirtualMachine
...
### Start (Default)
```
Start-AzDevTestLabsVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzDevTestLabsVirtualMachine -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
