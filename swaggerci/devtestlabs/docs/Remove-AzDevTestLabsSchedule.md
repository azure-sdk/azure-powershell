...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsschedule
schema: 2.0.0
---

# Remove-AzDevTestLabsSchedule
...
### Delete (Default)
```
Remove-AzDevTestLabsSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsSchedule -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-PassThru]
