...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsuser
schema: 2.0.0
---

# Update-AzDevTestLabsUser
...
```
Update-AzDevTestLabsUser -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsUser -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
