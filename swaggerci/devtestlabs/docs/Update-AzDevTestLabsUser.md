...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsuser
schema: 2.0.0
---
...
```
Update-AzDevTestLabsUser -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
