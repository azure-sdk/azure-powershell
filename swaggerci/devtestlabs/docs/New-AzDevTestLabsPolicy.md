...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/new-azdevtestlabspolicy
schema: 2.0.0
---
...
New-AzDevTestLabsPolicy -LabName <String> -Name <String> -ResourceGroupName <String> -SetName <String>
 -Location <String> [-SubscriptionId <String>] [-Description <String>] [-EvaluatorType <PolicyEvaluatorType>]
 [-FactData <String>] [-FactName <PolicyFactName>] [-Status <PolicyStatus>] [-Tag <Hashtable>]
 [-Threshold <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
