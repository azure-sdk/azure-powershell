...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsbastionhost
schema: 2.0.0
---
...
Update-AzDevTestLabsBastionHost -LabName <String> -Name <String> -ResourceGroupName <String>
 -VirtualNetworkName <String> [-SubscriptionId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDevTestLabsBastionHost -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
