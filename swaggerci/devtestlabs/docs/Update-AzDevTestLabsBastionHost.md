...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsbastionhost
schema: 2.0.0
---

# Update-AzDevTestLabsBastionHost
...
```
Update-AzDevTestLabsBastionHost -LabName <String> -Name <String> -ResourceGroupName <String>
 -VirtualNetworkName <String> [-SubscriptionId <String>] [-IdentityClientSecretUrl <String>]
...
```
Update-AzDevTestLabsBastionHost -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
 [-IdentityPrincipalId <String>] [-IdentityTenantId <String>] [-IdentityType <ManagedIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
