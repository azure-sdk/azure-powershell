...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabslabsecret
schema: 2.0.0
---
...
```
Update-AzDevTestLabsLabSecret -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
