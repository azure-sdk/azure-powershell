...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabslabsecret
schema: 2.0.0
---

# Update-AzDevTestLabsLabSecret
...
```
Update-AzDevTestLabsLabSecret -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsLabSecret -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
