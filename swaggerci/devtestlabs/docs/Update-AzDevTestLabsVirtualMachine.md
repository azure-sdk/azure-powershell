...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsvirtualmachine
schema: 2.0.0
---

# Update-AzDevTestLabsVirtualMachine
...
```
Update-AzDevTestLabsVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsVirtualMachine -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
