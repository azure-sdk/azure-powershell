...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabssharedimage
schema: 2.0.0
---
...
Update-AzDevTestLabsSharedImage -LabName <String> -Name <String> -ResourceGroupName <String>
 -SharedGalleryName <String> [-SubscriptionId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDevTestLabsSharedImage -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
