...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabssharedimage
schema: 2.0.0
---

# Update-AzDevTestLabsSharedImage
...
```
Update-AzDevTestLabsSharedImage -LabName <String> -Name <String> -ResourceGroupName <String>
 -SharedGalleryName <String> [-SubscriptionId <String>] [-IdentityClientSecretUrl <String>]
...
```
Update-AzDevTestLabsSharedImage -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
 [-IdentityPrincipalId <String>] [-IdentityTenantId <String>] [-IdentityType <ManagedIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
