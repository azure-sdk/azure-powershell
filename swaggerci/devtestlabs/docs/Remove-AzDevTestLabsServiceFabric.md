...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsservicefabric
schema: 2.0.0
---

# Remove-AzDevTestLabsServiceFabric
...
### Delete (Default)
```
Remove-AzDevTestLabsServiceFabric -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsServiceFabric -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
