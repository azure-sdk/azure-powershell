...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsgalleryimage
schema: 2.0.0
---
...
### Get
```
Get-AzDevTestLabsGalleryImage -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevTestLabsGalleryImage -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
