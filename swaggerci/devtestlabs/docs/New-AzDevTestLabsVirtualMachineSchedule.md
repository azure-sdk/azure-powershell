...
New-AzDevTestLabsVirtualMachineSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 -VirtualMachineName <String> -Location <String> [-SubscriptionId <String>] [-DailyRecurrenceTime <String>]
 [-HourlyRecurrenceMinute <Int32>] [-NotificationSettingEmailRecipient <String>]
