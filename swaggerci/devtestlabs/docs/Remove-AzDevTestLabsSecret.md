...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabssecret
schema: 2.0.0
---

# Remove-AzDevTestLabsSecret
...
### Delete (Default)
```
Remove-AzDevTestLabsSecret -LabName <String> -Name <String> -ResourceGroupName <String> -UserName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsSecret -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-PassThru]
