...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsclaimvirtualmachine
schema: 2.0.0
---

# Invoke-AzDevTestLabsClaimVirtualMachine
...
### Claim (Default)
```
Invoke-AzDevTestLabsClaimVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### ClaimViaIdentity
```
Invoke-AzDevTestLabsClaimVirtualMachine -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
