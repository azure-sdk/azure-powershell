...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsvirtualmachineschedule
schema: 2.0.0
---

# Remove-AzDevTestLabsVirtualMachineSchedule
...
### Delete (Default)
```
Remove-AzDevTestLabsVirtualMachineSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsVirtualMachineSchedule -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
