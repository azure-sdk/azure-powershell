...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsnotificationchannel
schema: 2.0.0
---

# Remove-AzDevTestLabsNotificationChannel
...
### Delete (Default)
```
Remove-AzDevTestLabsNotificationChannel -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsNotificationChannel -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
