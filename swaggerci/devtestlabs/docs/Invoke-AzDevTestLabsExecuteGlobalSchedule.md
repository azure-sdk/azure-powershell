...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsexecuteglobalschedule
schema: 2.0.0
---

# Invoke-AzDevTestLabsExecuteGlobalSchedule
...
### Execute (Default)
```
Invoke-AzDevTestLabsExecuteGlobalSchedule -Name <String> -ResourceGroupName <String>
...
### ExecuteViaIdentity
```
Invoke-AzDevTestLabsExecuteGlobalSchedule -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>]
