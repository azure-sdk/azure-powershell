...
New-AzDevTestLabsVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-GalleryImageReferenceSku <String>] [-GalleryImageReferenceVersion <String>]
 [-GalleryImageVersionId <String>] [-IsAuthenticationWithSshKey] [-LabSubnetName <String>]
 [-LabVirtualNetworkId <String>] [-Location <String>] [-NetworkInterfaceDnsName <String>]
