...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/clear-azdevtestlabsvirtualmachineartifactresult
schema: 2.0.0
---

# Clear-AzDevTestLabsVirtualMachineArtifactResult
...
### Clear (Default)
```
Clear-AzDevTestLabsVirtualMachineArtifactResult -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ClearViaIdentity
```
Clear-AzDevTestLabsVirtualMachineArtifactResult -InputObject <IDevTestLabsIdentity>
