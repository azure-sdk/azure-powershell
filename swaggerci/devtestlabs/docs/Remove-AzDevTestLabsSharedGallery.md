...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabssharedgallery
schema: 2.0.0
---

# Remove-AzDevTestLabsSharedGallery
...
### Delete (Default)
```
Remove-AzDevTestLabsSharedGallery -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsSharedGallery -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-PassThru]
