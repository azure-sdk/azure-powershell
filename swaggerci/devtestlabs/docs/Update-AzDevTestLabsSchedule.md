...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsschedule
schema: 2.0.0
---

# Update-AzDevTestLabsSchedule
...
```
Update-AzDevTestLabsSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsSchedule -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
