...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsformula
schema: 2.0.0
---
...
```
Update-AzDevTestLabsFormula -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
