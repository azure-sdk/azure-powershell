...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsservicerunner
schema: 2.0.0
---
...
### List (Default)
```
Get-AzDevTestLabsServiceRunner -LabName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
