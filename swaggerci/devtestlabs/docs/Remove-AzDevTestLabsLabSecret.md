...
online version: https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabslabsecret
schema: 2.0.0
---

# Remove-AzDevTestLabsLabSecret
...
### Delete (Default)
```
Remove-AzDevTestLabsLabSecret -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsLabSecret -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
