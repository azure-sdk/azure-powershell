...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901
{
    ...
    public partial class LabProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode node)
        {
        ...
        internal LabProperties(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject json)
        {
            ...
            {_announcement = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject>("announcement"), out var __jsonAnnouncement) ? Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.LabAnnouncementProperties.FromJson(__jsonAnnouncement) : Announcement;}
            {_support = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject>("support"), out var __jsonSupport) ? Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.LabSupportProperties.FromJson(__jsonSupport) : Support;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.Encryption.FromJson(__jsonEncryption) : Encryption;}
            ...
            {_extendedProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject>("extendedProperties"), out var __jsonExtendedProperties) ? Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.LabPropertiesExtendedProperties.FromJson(__jsonExtendedProperties) : ExtendedProperty;}
            {_browserConnect = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonString>("browserConnect"), out var __jsonBrowserConnect) ? (string)__jsonBrowserConnect : (string)BrowserConnect;}
            {_disableAutoUpgradeCseMinorVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonBoolean>("disableAutoUpgradeCseMinorVersion"), out var __jsonDisableAutoUpgradeCseMinorVersion) ? (bool?)__jsonDisableAutoUpgradeCseMinorVersion : DisableAutoUpgradeCseMinorVersion;}
            {_managementIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject>("managementIdentities"), out var __jsonManagementIdentities) ? Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.LabPropertiesManagementIdentities.FromJson(__jsonManagementIdentities) : ManagementIdentity;}
            {_isolateLabResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonString>("isolateLabResources"), out var __jsonIsolateLabResources) ? (string)__jsonIsolateLabResources : (string)IsolateLabResource;}
            {_defaultSecretName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonString>("defaultSecretName"), out var __jsonDefaultSecretName) ? (string)__jsonDefaultSecretName : (string)DefaultSecretName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._encryption ? (Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode) this._encryption.ToJson(null,serializationMode) : null, "encryption" ,container.Add );
            ...
            AddIf( null != (((object)this._browserConnect)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonString(this._browserConnect.ToString()) : null, "browserConnect" ,container.Add );
            AddIf( null != this._disableAutoUpgradeCseMinorVersion ? (Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonBoolean((bool)this._disableAutoUpgradeCseMinorVersion) : null, "disableAutoUpgradeCseMinorVersion" ,container.Add );
            AddIf( null != this._managementIdentity ? (Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode) this._managementIdentity.ToJson(null,serializationMode) : null, "managementIdentities" ,container.Add );
            AddIf( null != (((object)this._isolateLabResource)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonString(this._isolateLabResource.ToString()) : null, "isolateLabResources" ,container.Add );
            AddIf( null != (((object)this._defaultSecretName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Json.JsonString(this._defaultSecretName.ToString()) : null, "defaultSecretName" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.SerializationMode.IncludeReadOnly))
            {
