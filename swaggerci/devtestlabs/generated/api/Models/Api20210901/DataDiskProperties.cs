...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901
{
    ...
    public partial class DataDiskProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDataDiskProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDataDiskPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AttachNewDataDiskOption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IAttachNewDataDiskOptions _attachNewDataDiskOption;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IAttachNewDataDiskOptions AttachNewDataDiskOption { get => (this._attachNewDataDiskOption = this._attachNewDataDiskOption ?? new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.AttachNewDataDiskOptions()); set => this._attachNewDataDiskOption = value; }
        ...
        public string AttachNewDataDiskOptionDiskName { get => ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IAttachNewDataDiskOptionsInternal)AttachNewDataDiskOption).DiskName; set => ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IAttachNewDataDiskOptionsInternal)AttachNewDataDiskOption).DiskName = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IAttachNewDataDiskOptions Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDataDiskPropertiesInternal.AttachNewDataDiskOption { get => (this._attachNewDataDiskOption = this._attachNewDataDiskOption ?? new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.AttachNewDataDiskOptions()); set { {_attachNewDataDiskOption = value;} } }
    ...
    {
        /// <summary>Specifies options to attach a new disk to the virtual machine.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IAttachNewDataDiskOptions AttachNewDataDiskOption { get; set; }
        /// <summary>The name of the disk to be attached.</summary>
        string AttachNewDataDiskOptionDiskName { get; set; }
        /// <summary>Size of the disk to be attached in Gibibytes.</summary>
        int? AttachNewDataDiskOptionDiskSizeGiB { get; set; }
