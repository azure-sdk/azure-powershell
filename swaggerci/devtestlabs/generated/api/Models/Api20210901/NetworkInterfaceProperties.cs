...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901
{
    ...
    public partial class NetworkInterfaceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.INetworkInterfaceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.INetworkInterfacePropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedPublicIPAddressConfiguration Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.INetworkInterfacePropertiesInternal.SharedPublicIPAddressConfiguration { get => (this._sharedPublicIPAddressConfiguration = this._sharedPublicIPAddressConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.SharedPublicIPAddressConfiguration()); set { {_sharedPublicIPAddressConfiguration = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedPublicIPAddressConfiguration _sharedPublicIPAddressConfiguration;

        /// <summary>
        /// The configuration for sharing a public IP address across multiple virtual machines.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Origin(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedPublicIPAddressConfiguration SharedPublicIPAddressConfiguration { get => (this._sharedPublicIPAddressConfiguration = this._sharedPublicIPAddressConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.SharedPublicIPAddressConfiguration()); set => this._sharedPublicIPAddressConfiguration = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IInboundNatRule[] SharedPublicIPAddressConfigurationInboundNatRule { get => ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedPublicIPAddressConfigurationInternal)SharedPublicIPAddressConfiguration).InboundNatRule; set => ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedPublicIPAddressConfigurationInternal)SharedPublicIPAddressConfiguration).InboundNatRule = value ?? null /* arrayOf */; }
...

    {
        ...
        /// The configuration for sharing a public IP address across multiple virtual machines.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedPublicIPAddressConfiguration SharedPublicIPAddressConfiguration { get; set; }
        /// <summary>The incoming NAT rules</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IInboundNatRule[] SharedPublicIPAddressConfigurationInboundNatRule { get; set; }
        /// <summary>
        /// The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.
