...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901
{
    ...
    public partial class ArtifactProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.CreatedDate { get => this._createdDate; set { {_createdDate = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for FilePath</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.FilePath { get => this._filePath; set { {_filePath = value;} } }

        /// <summary>Internal Acessors for Icon</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.Icon { get => this._icon; set { {_icon = value;} } }

        /// <summary>Internal Acessors for Parameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.IAny Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Any()); set { {_parameter = value;} } }

        /// <summary>Internal Acessors for Publisher</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.Publisher { get => this._publisher; set { {_publisher = value;} } }

        /// <summary>Internal Acessors for TargetOSType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.TargetOSType { get => this._targetOSType; set { {_targetOSType = value;} } }

        /// <summary>Internal Acessors for Title</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactPropertiesInternal.Title { get => this._title; set { {_title = value;} } }
