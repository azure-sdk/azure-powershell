...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.IDevTestLabsIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="SharedGalleryName" /> property.</summary>
        private string _sharedGalleryName;

        /// <summary>The name of the shared gallery.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Origin(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.PropertyOrigin.Owned)]
        public string SharedGalleryName { get => this._sharedGalleryName; set => this._sharedGalleryName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string SharedGalleryName { get; set; }
        /// <summary>The subscription ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
