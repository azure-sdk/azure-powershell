...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] EvaluatePolicies=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/policysets/{name}/evaluatePolicies"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDevTestLabsPolicySetPolicy_EvaluateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IPolicySetResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Evaluates lab policy.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class TestAzDevTestLabsPolicySetPolicy_EvaluateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesRequest _evaluatePoliciesRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.EvaluatePoliciesRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Policies to evaluate.")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesProperties[] Policy { get => _evaluatePoliciesRequestBody.Policy ?? null /* arrayOf */; set => _evaluatePoliciesRequestBody.Policy = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesResponse">Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicySetsEvaluatePolicies' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicySetsEvaluatePoliciesViaIdentity(InputObject.Id, _evaluatePoliciesRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicySetsEvaluatePolicies(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LabName ?? null, InputObject.Name ?? null, _evaluatePoliciesRequestBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_evaluatePoliciesRequestBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzDevTestLabsPolicySetPolicy_EvaluateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public TestAzDevTestLabsPolicySetPolicy_EvaluateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_evaluatePoliciesRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_evaluatePoliciesRequestBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                WriteObject((await response).Result, true);
            }
        }
    }
}