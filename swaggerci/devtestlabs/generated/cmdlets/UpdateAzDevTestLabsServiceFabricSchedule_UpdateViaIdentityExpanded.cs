...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/servicefabrics/{serviceFabricName}/schedules/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDevTestLabsServiceFabricSchedule_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Allows modifying tags of schedules. All other properties will be ignored.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class UpdateAzDevTestLabsServiceFabricSchedule_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUpdateResource _scheduleBody = new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.UpdateResource();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The client secret URL of the identity.")]
        ...
        public string IdentityClientSecretUrl { get => _scheduleBody.IdentityClientSecretUrl ?? null; set => _scheduleBody.IdentityClientSecretUrl = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityPrincipalId { get => _scheduleBody.IdentityPrincipalId ?? null; set => _scheduleBody.IdentityPrincipalId = value; }

        /// <summary>The tenant identifier of resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The tenant identifier of resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityTenantId { get => _scheduleBody.IdentityTenantId ?? null; set => _scheduleBody.IdentityTenantId = value; }

        /// <summary>Type of identity (SystemAssigned, UserAssigned, None)</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Type of identity (SystemAssigned, UserAssigned, None)")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.ManagedIdentityType))]
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.ManagedIdentityType IdentityType { get => _scheduleBody.IdentityType ?? ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.ManagedIdentityType)""); set => _scheduleBody.IdentityType = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If Type is 'UserAssigned': List of user assigned identities.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IIdentityPropertiesUserAssignedIdentities IdentityUserAssignedIdentity { get => _scheduleBody.IdentityUserAssignedIdentity ?? null /* object */; set => _scheduleBody.IdentityUserAssignedIdentity = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUpdateResourceTags Tag { get => _scheduleBody.Tag ?? null /* object */; set => _scheduleBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule">Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceFabricSchedulesUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServiceFabricSchedulesUpdateViaIdentity(InputObject.Id, _scheduleBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.ServiceFabricName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ServiceFabricName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.ServiceFabricSchedulesUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LabName ?? null, InputObject.UserName ?? null, InputObject.ServiceFabricName ?? null, InputObject.Name ?? null, _scheduleBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_scheduleBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzDevTestLabsServiceFabricSchedule_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzDevTestLabsServiceFabricSchedule_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_scheduleBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_scheduleBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule
