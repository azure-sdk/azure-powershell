...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDevTestLabsUser_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Create or replace an existing user profile. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class NewAzDevTestLabsUser_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser _userBody = new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.User();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Set to the app Id of the client JWT making the request.")]
        ...
        public string IdentityAppId { get => _userBody.IdentityAppId ?? null; set => _userBody.IdentityAppId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Set to the object Id of the client JWT making the request. Not all users have object Id. For CSP (reseller) scenarios for example, object Id is not available.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityObjectId { get => _userBody.IdentityObjectId ?? null; set => _userBody.IdentityObjectId = value; }

        /// <summary>
        /// Set to the principal Id of the client JWT making the request. Service principal will not have the principal Id.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Set to the principal Id of the client JWT making the request. Service principal will not have the principal Id.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityPrincipalId { get => _userBody.IdentityPrincipalId ?? null; set => _userBody.IdentityPrincipalId = value; }

        /// <summary>Set to the principal name / UPN of the client JWT making the request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Set to the principal name / UPN of the client JWT making the request.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityPrincipalName { get => _userBody.IdentityPrincipalName ?? null; set => _userBody.IdentityPrincipalName = value; }

        /// <summary>Set to the tenant ID of the client JWT making the request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Set to the tenant ID of the client JWT making the request.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityTenantId { get => _userBody.IdentityTenantId ?? null; set => _userBody.IdentityTenantId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => _userBody.Location ?? null; set => _userBody.Location = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ID of the user's Key vault.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SecretStoreKeyVaultId { get => _userBody.SecretStoreKeyVaultId ?? null; set => _userBody.SecretStoreKeyVaultId = value; }

        /// <summary>The URI of the user's Key vault.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The URI of the user's Key vault.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SecretStoreKeyVaultUri { get => _userBody.SecretStoreKeyVaultUri ?? null; set => _userBody.SecretStoreKeyVaultUri = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IResourceTags Tag { get => _userBody.Tag ?? null /* object */; set => _userBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser">Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzDevTestLabsUser_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.NewAzDevTestLabsUser_CreateExpanded Clone()
        {
            var clone = new NewAzDevTestLabsUser_CreateExpanded();
            ...
            clone._userBody = this._userBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDevTestLabsUser_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDevTestLabsUser_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UsersCreateOrUpdate(SubscriptionId, ResourceGroupName, LabName, Name, _userBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,Name=Name,body=_userBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=_userBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=_userBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser
