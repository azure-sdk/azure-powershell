...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/servicerunners/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDevTestLabsServiceRunner_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Create or replace an existing Service runner. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class NewAzDevTestLabsServiceRunner_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IServiceRunner _serviceRunnerBody = new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ServiceRunner();
        ...
        public string IdentityClientSecretUrl { get => _serviceRunnerBody.IdentityClientSecretUrl ?? null; set => _serviceRunnerBody.IdentityClientSecretUrl = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityPrincipalId { get => _serviceRunnerBody.IdentityPrincipalId ?? null; set => _serviceRunnerBody.IdentityPrincipalId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityTenantId { get => _serviceRunnerBody.IdentityTenantId ?? null; set => _serviceRunnerBody.IdentityTenantId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.ManagedIdentityType IdentityType { get => _serviceRunnerBody.IdentityType ?? ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.ManagedIdentityType)""); set => _serviceRunnerBody.IdentityType = value; }

        /// <summary>
        /// The purpose of bringing the identity to the lab. Ex: To use during Environment creation or to deploy on the VMs.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The purpose of bringing the identity to the lab. Ex: To use during Environment creation or to deploy on the VMs.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityUsageType { get => _serviceRunnerBody.IdentityUsageType ?? null; set => _serviceRunnerBody.IdentityUsageType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IIdentityPropertiesUserAssignedIdentities IdentityUserAssignedIdentity { get => _serviceRunnerBody.IdentityUserAssignedIdentity ?? null /* object */; set => _serviceRunnerBody.IdentityUserAssignedIdentity = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => _serviceRunnerBody.Location ?? null; set => _serviceRunnerBody.Location = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IResourceTags Tag { get => _serviceRunnerBody.Tag ?? null /* object */; set => _serviceRunnerBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IServiceRunner">Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IServiceRunner</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IServiceRunner> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzDevTestLabsServiceRunner_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.NewAzDevTestLabsServiceRunner_CreateExpanded Clone()
        {
            var clone = new NewAzDevTestLabsServiceRunner_CreateExpanded();
            ...
            clone._serviceRunnerBody = this._serviceRunnerBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDevTestLabsServiceRunner_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDevTestLabsServiceRunner_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceRunnersCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServiceRunnersCreateOrUpdate(SubscriptionId, ResourceGroupName, LabName, Name, _serviceRunnerBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,Name=Name,body=_serviceRunnerBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=_serviceRunnerBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=_serviceRunnerBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IServiceRunner> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IServiceRunner
