...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabslabsecret
#>
function Remove-AzDevTestLabsLabSecret {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DevTestLabs.private\Remove-AzDevTestLabsLabSecret_Delete';
            DeleteViaIdentity = 'Az.DevTestLabs.private\Remove-AzDevTestLabsLabSecret_DeleteViaIdentity';
        }
