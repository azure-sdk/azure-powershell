...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabsbastionhost
#>
function Update-AzDevTestLabsBastionHost {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IBastionHost])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsBastionHost_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsBastionHost_UpdateViaIdentityExpanded';
        }
