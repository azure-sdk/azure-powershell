...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/new-azdevtestlabsuser
#>
function New-AzDevTestLabsUser {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IUser])]
