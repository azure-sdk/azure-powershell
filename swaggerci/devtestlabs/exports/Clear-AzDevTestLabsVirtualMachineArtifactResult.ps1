...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/clear-azdevtestlabsvirtualmachineartifactresult
#>
function Clear-AzDevTestLabsVirtualMachineArtifactResult {
...
begin {
    try {
        ...
        $mapping = @{
            Clear = 'Az.DevTestLabs.private\Clear-AzDevTestLabsVirtualMachineArtifactResult_Clear';
            ClearViaIdentity = 'Az.DevTestLabs.private\Clear-AzDevTestLabsVirtualMachineArtifactResult_ClearViaIdentity';
        }
        if (('Clear') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
