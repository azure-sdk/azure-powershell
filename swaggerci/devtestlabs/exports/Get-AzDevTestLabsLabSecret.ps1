...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabslabsecret
#>
function Get-AzDevTestLabsLabSecret {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabSecret])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevTestLabs.private\Get-AzDevTestLabsLabSecret_Get';
            GetViaIdentity = 'Az.DevTestLabs.private\Get-AzDevTestLabsLabSecret_GetViaIdentity';
            List = 'Az.DevTestLabs.private\Get-AzDevTestLabsLabSecret_List';
        }
