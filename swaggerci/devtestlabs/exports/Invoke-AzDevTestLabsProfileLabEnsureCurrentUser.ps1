...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/invoke-azdevtestlabsprofilelabensurecurrentuser
#>
function Invoke-AzDevTestLabsProfileLabEnsureCurrentUser {
...
begin {
    try {
        ...
        $mapping = @{
            Profile = 'Az.DevTestLabs.private\Invoke-AzDevTestLabsProfileLabEnsureCurrentUser_Profile';
            ProfileViaIdentity = 'Az.DevTestLabs.private\Invoke-AzDevTestLabsProfileLabEnsureCurrentUser_ProfileViaIdentity';
        }
        if (('Profile') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
