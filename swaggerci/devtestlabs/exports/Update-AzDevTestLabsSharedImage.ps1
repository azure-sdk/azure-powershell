...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabssharedimage
#>
function Update-AzDevTestLabsSharedImage {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsSharedImage_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsSharedImage_UpdateViaIdentityExpanded';
        }
