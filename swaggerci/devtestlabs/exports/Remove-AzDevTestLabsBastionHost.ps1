...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabsbastionhost
#>
function Remove-AzDevTestLabsBastionHost {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DevTestLabs.private\Remove-AzDevTestLabsBastionHost_Delete';
            DeleteViaIdentity = 'Az.DevTestLabs.private\Remove-AzDevTestLabsBastionHost_DeleteViaIdentity';
        }
