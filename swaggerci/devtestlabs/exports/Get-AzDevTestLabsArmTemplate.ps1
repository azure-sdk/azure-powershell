...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsarmtemplate
#>
function Get-AzDevTestLabsArmTemplate {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArmTemplate])]
