...
System.Boolean
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/new-azdevtestlabslabsecret
#>
function New-AzDevTestLabsLabSecret {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.DevTestLabs.private\New-AzDevTestLabsLabSecret_CreateExpanded';
        }
