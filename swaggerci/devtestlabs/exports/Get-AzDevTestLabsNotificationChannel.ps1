...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsnotificationchannel
#>
function Get-AzDevTestLabsNotificationChannel {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.INotificationChannel])]
