...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/new-azdevtestlabsnotificationchannel
#>
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvent[]]
