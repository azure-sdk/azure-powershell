...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/remove-azdevtestlabssharedgallery
#>
function Remove-AzDevTestLabsSharedGallery {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DevTestLabs.private\Remove-AzDevTestLabsSharedGallery_Delete';
            DeleteViaIdentity = 'Az.DevTestLabs.private\Remove-AzDevTestLabsSharedGallery_DeleteViaIdentity';
        }
