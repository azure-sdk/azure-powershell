...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabscost
#>
function Get-AzDevTestLabsCost {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabCost])]
