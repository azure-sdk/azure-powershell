...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabssharedgallery
#>
function Get-AzDevTestLabsSharedGallery {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevTestLabs.private\Get-AzDevTestLabsSharedGallery_Get';
            GetViaIdentity = 'Az.DevTestLabs.private\Get-AzDevTestLabsSharedGallery_GetViaIdentity';
            List = 'Az.DevTestLabs.private\Get-AzDevTestLabsSharedGallery_List';
        }
