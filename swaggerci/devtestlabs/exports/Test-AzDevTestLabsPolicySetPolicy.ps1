...
POLICY <IEvaluatePoliciesProperties[]>: Policies to evaluate.
  ...
  [ValueOffset <String>]: The value offset.
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/test-azdevtestlabspolicysetpolicy
#>
function Test-AzDevTestLabsPolicySetPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IPolicySetResult])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IEvaluatePoliciesProperties[]]
