...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabsbastionhost
#>
function Get-AzDevTestLabsBastionHost {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevTestLabs.private\Get-AzDevTestLabsBastionHost_Get';
            GetViaIdentity = 'Az.DevTestLabs.private\Get-AzDevTestLabsBastionHost_GetViaIdentity';
            List = 'Az.DevTestLabs.private\Get-AzDevTestLabsBastionHost_List';
        }
