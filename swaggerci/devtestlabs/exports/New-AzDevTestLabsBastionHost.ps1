...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/new-azdevtestlabsbastionhost
#>
function New-AzDevTestLabsBastionHost {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.DevTestLabs.private\New-AzDevTestLabsBastionHost_CreateExpanded';
        }
