...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsartifactsource
#>
function Get-AzDevTestLabsArtifactSource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactSource])]
