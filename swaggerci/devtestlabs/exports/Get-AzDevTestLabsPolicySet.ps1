...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/get-azdevtestlabspolicyset
#>
function Get-AzDevTestLabsPolicySet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IPolicySet])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DevTestLabs.private\Get-AzDevTestLabsPolicySet_List';
        }
