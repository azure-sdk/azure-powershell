...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/new-azdevtestlabssharedgallery
#>
function New-AzDevTestLabsSharedGallery {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.DevTestLabs.private\New-AzDevTestLabsSharedGallery_CreateExpanded';
        }
