...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.devtestlabs/update-azdevtestlabssharedgallery
#>
function Update-AzDevTestLabsSharedGallery {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedGallery])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsSharedGallery_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsSharedGallery_UpdateViaIdentityExpanded';
        }
