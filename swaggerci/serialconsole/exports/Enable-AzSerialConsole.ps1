...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SerialConsole.Models.Api20180501.ISerialConsoleState], [Microsoft.Azure.PowerShell.Cmdlets.SerialConsole.Models.Api20180501.IGetSerialConsoleSubscriptionNotFound])]
