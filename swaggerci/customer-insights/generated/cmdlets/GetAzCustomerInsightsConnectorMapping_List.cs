...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByConnector=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/connectors/{connectorName}/mappings"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCustomerInsightsConnectorMapping_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Description(@"Gets all the connector mappings in the specified connector.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Generated]
    public partial class GetAzCustomerInsightsConnectorMapping_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IConnectorMappingListResult">Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IConnectorMappingListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IConnectorMappingListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCustomerInsightsConnectorMapping_List" /> cmdlet class.
        /// </summary>
        public GetAzCustomerInsightsConnectorMapping_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConnectorMappingsListByConnector(ResourceGroupName, HubName, ConnectorName, SubscriptionId, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,HubName=HubName,ConnectorName=ConnectorName,SubscriptionId=SubscriptionId})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IConnectorMappingListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ConnectorMappingsListByConnector_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
