...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCustomerInsightsModelPredictionStatus_ModelViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCustomerInsightsModelPredictionStatus_ModelViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IPredictionModelStatus _parameter;

        /// <summary>The prediction model status.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The prediction model status.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The prediction model status.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IPredictionModelStatus) })]
        public Microsoft.Azure.PowerShell.Cmdlets.CustomerInsights.Models.Api20170426.IPredictionModelStatus Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCustomerInsightsModelPredictionStatus_ModelViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzCustomerInsightsModelPredictionStatus_ModelViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PredictionsModelStatusViaIdentity(InputObject.Id, Parameter, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PredictionsModelStatus(InputObject.ResourceGroupName ?? null, InputObject.HubName ?? null, InputObject.PredictionName ?? null, InputObject.SubscriptionId ?? null, Parameter, onOk, this, Pipeline);
                    }
