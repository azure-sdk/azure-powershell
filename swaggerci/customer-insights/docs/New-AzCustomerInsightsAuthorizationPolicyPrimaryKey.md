...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/new-azcustomerinsightsauthorizationpolicyprimarykey
schema: 2.0.0
---

# New-AzCustomerInsightsAuthorizationPolicyPrimaryKey
...
### Regenerate (Default)
```
New-AzCustomerInsightsAuthorizationPolicyPrimaryKey -AuthorizationPolicyName <String> -HubName <String>
...
```
New-AzCustomerInsightsAuthorizationPolicyPrimaryKey -InputObject <ICustomerInsightsIdentity>
