...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/remove-azcustomerinsightsview
schema: 2.0.0
---

# Remove-AzCustomerInsightsView
...
### Delete (Default)
```
Remove-AzCustomerInsightsView -HubName <String> -Name <String> -ResourceGroupName <String> -UserId <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzCustomerInsightsView -InputObject <ICustomerInsightsIdentity> -UserId <String>
