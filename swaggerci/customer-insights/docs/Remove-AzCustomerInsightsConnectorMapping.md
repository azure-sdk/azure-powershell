...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/remove-azcustomerinsightsconnectormapping
schema: 2.0.0
---

# Remove-AzCustomerInsightsConnectorMapping
...
### Delete (Default)
```
Remove-AzCustomerInsightsConnectorMapping -ConnectorName <String> -HubName <String> -MappingName <String>
...
### DeleteViaIdentity
```
Remove-AzCustomerInsightsConnectorMapping -InputObject <ICustomerInsightsIdentity>
