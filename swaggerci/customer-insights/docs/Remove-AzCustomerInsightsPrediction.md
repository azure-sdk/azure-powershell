...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/remove-azcustomerinsightsprediction
schema: 2.0.0
---

# Remove-AzCustomerInsightsPrediction
...
### Delete (Default)
```
Remove-AzCustomerInsightsPrediction -HubName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCustomerInsightsPrediction -InputObject <ICustomerInsightsIdentity> [-DefaultProfile <PSObject>]
