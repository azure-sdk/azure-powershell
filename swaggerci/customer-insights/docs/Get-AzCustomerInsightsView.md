...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customerinsights/get-azcustomerinsightsview
schema: 2.0.0
---

# Get-AzCustomerInsightsView
...
### List (Default)
```
Get-AzCustomerInsightsView -HubName <String> -ResourceGroupName <String> -UserId <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzCustomerInsightsView -HubName <String> -Name <String> -ResourceGroupName <String> -UserId <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCustomerInsightsView -InputObject <ICustomerInsightsIdentity> -UserId <String>
