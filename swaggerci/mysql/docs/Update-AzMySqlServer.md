...
Update-AzMySqlServer -InputObject <IMySqlIdentity> [-AdministratorLoginPassword <SecureString>]
 [-BackupGeoRedundantBackup <EnableStatusEnum>] [-BackupRetentionDay <Int32>]
 ...
 [-MaintenanceWindowStartMinute <Int32>] [-ReplicationRole <ReplicationRole>] [-SkuName <String>]
 [-SkuTier <SkuTier>] [-StorageAutoGrow <EnableStatusEnum>] [-StorageAutoIoScaling <EnableStatusEnum>]
 [-StorageIop <Int32>] [-StorageSizeGb <Int32>] [-Tag <Hashtable>] [-Version <ServerVersion>]
