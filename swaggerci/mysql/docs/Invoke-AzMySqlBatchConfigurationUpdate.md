...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220901.IConfigurationListForBatchUpdate
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220901.IConfigurationForBatchUpdate[]
Parameter Sets: BatchExpanded, BatchViaIdentityExpanded
Aliases:
