...
.Link
https://learn.microsoft.com/powershell/module/az.mysql/get-azmysqlprivatelinkresource
#>
function Get-AzMySqlPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api40.IPrivateLinkResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MySql.private\Get-AzMySqlPrivateLinkResource_Get';
            GetViaIdentity = 'Az.MySql.private\Get-AzMySqlPrivateLinkResource_GetViaIdentity';
            List = 'Az.MySql.private\Get-AzMySqlPrivateLinkResource_List';
        }
