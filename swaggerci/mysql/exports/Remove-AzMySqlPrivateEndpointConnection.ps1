...
.Link
https://learn.microsoft.com/powershell/module/az.mysql/remove-azmysqlprivateendpointconnection
#>
function Remove-AzMySqlPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.MySql.private\Remove-AzMySqlPrivateEndpointConnection_Delete';
            DeleteViaIdentity = 'Az.MySql.private\Remove-AzMySqlPrivateEndpointConnection_DeleteViaIdentity';
        }
