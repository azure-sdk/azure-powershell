...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IDatabase
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IDatabase])]
