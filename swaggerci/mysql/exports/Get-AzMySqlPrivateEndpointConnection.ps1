...
.Link
https://learn.microsoft.com/powershell/module/az.mysql/get-azmysqlprivateendpointconnection
#>
function Get-AzMySqlPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MySql.private\Get-AzMySqlPrivateEndpointConnection_Get';
            GetViaIdentity = 'Az.MySql.private\Get-AzMySqlPrivateEndpointConnection_GetViaIdentity';
            List = 'Az.MySql.private\Get-AzMySqlPrivateEndpointConnection_List';
        }
