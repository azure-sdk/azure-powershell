...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzPurviewAccountRootCollectionAdmin_AddViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzPurviewAccountRootCollectionAdmin_AddViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CollectionAdminUpdate" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICollectionAdminUpdate _collectionAdminUpdate;

        /// <summary>Collection administrator update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Collection administrator update.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICollectionAdminUpdate) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.ICollectionAdminUpdate CollectionAdminUpdate { get => this._collectionAdminUpdate; set => this._collectionAdminUpdate = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzPurviewAccountRootCollectionAdmin_AddViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzPurviewAccountRootCollectionAdmin_AddViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AccountsAddRootCollectionAdminViaIdentity(InputObject.Id, CollectionAdminUpdate, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AccountsAddRootCollectionAdmin(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, CollectionAdminUpdate, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CollectionAdminUpdate})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IErrorResponseModel> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CollectionAdminUpdate })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CollectionAdminUpdate })
                    {
