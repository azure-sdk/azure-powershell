...
namespace Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701
{
    ...
    public partial class UserAssignedIdentity
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IUserAssignedIdentity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IUserAssignedIdentity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20210701.IUserAssignedIdentity FromJson(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject json ? new UserAssignedIdentity(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserAssignedIdentity" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserAssignedIdentity" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._clientId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonString(this._clientId.ToString()) : null, "clientId" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.SerializationMode.IncludeReadOnly))
            {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject into a new instance of <see cref="UserAssignedIdentity" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserAssignedIdentity(Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_clientId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Json.JsonString>("clientId"), out var __jsonClientId) ? (string)__jsonClientId : (string)ClientId;}
