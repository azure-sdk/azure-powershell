...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api202301.IClientDiscoveryValueForSingleApi
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api202301.IClientDiscoveryValueForSingleApi])]
