...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220501.ICheckNameAvailabilityParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220501.ICheckNameAvailabilityResult])]
