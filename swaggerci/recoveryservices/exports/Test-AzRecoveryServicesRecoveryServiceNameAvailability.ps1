...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220901Preview.ICheckNameAvailabilityParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220901Preview.ICheckNameAvailabilityResult])]
