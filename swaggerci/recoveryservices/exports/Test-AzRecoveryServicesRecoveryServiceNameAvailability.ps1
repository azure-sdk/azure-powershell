...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220910.ICheckNameAvailabilityParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220910.ICheckNameAvailabilityResult])]
