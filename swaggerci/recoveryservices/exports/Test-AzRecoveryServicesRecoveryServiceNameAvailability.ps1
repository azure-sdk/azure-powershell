...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220401.ICheckNameAvailabilityParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220401.ICheckNameAvailabilityResult])]
