...
.Link
https://learn.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesoperationresult
#>
function Get-AzRecoveryServicesOperationResult {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IVault])]
