...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220901Preview.IPrivateLinkResource
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220901Preview.IPrivateLinkResource])]
