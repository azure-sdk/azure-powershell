...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220910.IPrivateLinkResource
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20220910.IPrivateLinkResource])]
