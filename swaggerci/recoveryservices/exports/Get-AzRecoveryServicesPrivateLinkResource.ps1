...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20221001.IPrivateLinkResource
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprivatelinkresource
#>
function Get-AzRecoveryServicesPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20221001.IPrivateLinkResource])]
