...
online version: https://learn.microsoft.com/powershell/module/az.blueprint/get-azblueprintassignmentoperation
schema: 2.0.0
---

# Get-AzBlueprintAssignmentOperation
...
### List (Default)
```
Get-AzBlueprintAssignmentOperation -AssignmentName <String> -ResourceScope <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzBlueprintAssignmentOperation -AssignmentName <String> -Name <String> -ResourceScope <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBlueprintAssignmentOperation -InputObject <IBlueprintIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
Type: System.String
Parameter Sets: Get
Aliases: AssignmentOperationName
