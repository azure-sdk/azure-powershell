...
$dll = Join-Path $PSScriptRoot 'bin/Az.Blueprint.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.Blueprint.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Blueprint.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Blueprint cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Blueprint.format.ps1xml'
