...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdbforpostgresql/remove-azcosmosdbforpostgresqlprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzCosmosDbForPostgreSqlPrivateEndpointConnection -ClusterName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzCosmosDbForPostgreSqlPrivateEndpointConnection -InputObject <ICosmosDbForPostgreSqlIdentity>
