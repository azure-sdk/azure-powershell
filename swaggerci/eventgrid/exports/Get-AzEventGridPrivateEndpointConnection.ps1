...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IPrivateEndpointConnection])]
...
param(
    ...
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PrivateEndpointConnectionsParentType])]
    [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PrivateEndpointConnectionsParentType]
