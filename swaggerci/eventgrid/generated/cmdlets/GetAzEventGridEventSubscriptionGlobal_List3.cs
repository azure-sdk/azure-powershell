...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListGlobalByResourceGroupForTopicType=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/topicTypes/{topicTypeName}/eventSubscriptions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEventGridEventSubscriptionGlobal_List3")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"List all global event subscriptions under a resource group for a specific topic type.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class GetAzEventGridEventSubscriptionGlobal_List3 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEventGridEventSubscriptionGlobal_List3" /> cmdlet class.
        /// </summary>
        public GetAzEventGridEventSubscriptionGlobal_List3()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.EventSubscriptionsListGlobalByResourceGroupForTopicType(SubscriptionId, ResourceGroupName, TopicTypeName, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.EventSubscriptionsListGlobalByResourceGroupForTopicType_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
