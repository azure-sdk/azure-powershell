...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzEventGridPartnerDestination_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzEventGridPartnerDestination_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Activation state of the partner destination.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerDestinationActivationState))]
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerDestinationActivationState ActivationState { get => PartnerDestinationBody.ActivationState ?? ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerDestinationActivationState)""); set => PartnerDestinationBody.ActivationState = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Endpoint Base URL of the partner destination")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string EndpointBaseUrl { get => PartnerDestinationBody.EndpointBaseUrl ?? null; set => PartnerDestinationBody.EndpointBaseUrl = value; }

        /// <summary>Endpoint context associated with this partner destination.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Endpoint context associated with this partner destination.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string EndpointServiceContext { get => PartnerDestinationBody.EndpointServiceContext ?? null; set => PartnerDestinationBody.EndpointServiceContext = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Expiration time of the partner destination. If this timer expires and the partner destination was never activated,the partner destination and corresponding channel are deleted.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Expiration time of the partner destination. If this timer expires and the partner destination was never activated,the partner destination and corresponding channel are deleted.",
        SerializedName = @"expirationTimeIfNotActivatedUtc",
        PossibleTypes = new [] { typeof(global::System.DateTime) })]
        public global::System.DateTime ExpirationTimeIfNotActivatedUtc { get => PartnerDestinationBody.ExpirationTimeIfNotActivatedUtc ?? default(global::System.DateTime); set => PartnerDestinationBody.ExpirationTimeIfNotActivatedUtc = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => PartnerDestinationBody.Location ?? null; set => PartnerDestinationBody.Location = value; }

        /// <summary>Context or helpful message that can be used during the approval process.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Context or helpful message that can be used during the approval process.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MessageForActivation { get => PartnerDestinationBody.MessageForActivation ?? null; set => PartnerDestinationBody.MessageForActivation = value; }
        ...
        /// <summary>Backing field for <see cref="PartnerDestinationBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerDestination _partnerDestinationBody= new Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.PartnerDestination();

        /// <summary>Event Grid Partner Destination.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerDestination PartnerDestinationBody { get => this._partnerDestinationBody; set => this._partnerDestinationBody = value; }

        /// <summary>The immutable Id of the corresponding partner registration.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The immutable Id of the corresponding partner registration.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PartnerRegistrationImmutableId { get => PartnerDestinationBody.PartnerRegistrationImmutableId ?? null; set => PartnerDestinationBody.PartnerRegistrationImmutableId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Provisioning state of the partner destination.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerDestinationProvisioningState))]
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerDestinationProvisioningState ProvisioningState { get => PartnerDestinationBody.ProvisioningState ?? ((Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Support.PartnerDestinationProvisioningState)""); set => PartnerDestinationBody.ProvisioningState = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.ITrackedResourceTags Tag { get => PartnerDestinationBody.Tag ?? null /* object */; set => PartnerDestinationBody.Tag = value; }
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerDestination> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzEventGridPartnerDestination_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzEventGridPartnerDestination_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PartnerDestinationsCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, PartnerDestinationBody, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=PartnerDestinationBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=PartnerDestinationBody })
                {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerDestination> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
