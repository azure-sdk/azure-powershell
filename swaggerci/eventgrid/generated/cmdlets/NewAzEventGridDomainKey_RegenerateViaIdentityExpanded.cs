        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DomainsRegenerateKeyViaIdentity(InputObject.Id, RegenerateKeyRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DomainsRegenerateKey(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.DomainName ?? null, RegenerateKeyRequestBody, onOk, onDefault, this, Pipeline);
                    }
