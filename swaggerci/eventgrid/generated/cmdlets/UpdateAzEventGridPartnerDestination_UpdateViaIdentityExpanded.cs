...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="PartnerDestinationUpdateParametersBody" /> property.
        /// </summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerDestinationUpdateParameters PartnerDestinationUpdateParametersBody { get => this._partnerDestinationUpdateParametersBody; set => this._partnerDestinationUpdateParametersBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20211015Preview.IPartnerDestinationUpdateParametersTags Tag { get => PartnerDestinationUpdateParametersBody.Tag ?? null /* object */; set => PartnerDestinationUpdateParametersBody.Tag = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PartnerDestinationsUpdateViaIdentity(InputObject.Id, PartnerDestinationUpdateParametersBody, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PartnerDestinationsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.PartnerDestinationName ?? null, PartnerDestinationUpdateParametersBody, onOk, onCreated, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PartnerDestinationUpdateParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PartnerDestinationUpdateParametersBody })
                {
