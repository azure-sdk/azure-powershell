...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListGlobalBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/eventSubscriptions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEventGridEventSubscriptionGlobal_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"List all aggregated global event subscriptions under a specific Azure subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class GetAzEventGridEventSubscriptionGlobal_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEventGridEventSubscriptionGlobal_List" /> cmdlet class.
        /// </summary>
        public GetAzEventGridEventSubscriptionGlobal_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.EventSubscriptionsListGlobalBySubscription(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.EventSubscriptionsListGlobalBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
