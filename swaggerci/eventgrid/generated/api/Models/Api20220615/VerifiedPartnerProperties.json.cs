...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615
{
    ...
    public partial class VerifiedPartnerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IVerifiedPartnerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IVerifiedPartnerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IVerifiedPartnerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode node)
        {
        ...
        internal VerifiedPartnerProperties(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject json)
        {
            ...
            {_partnerTopicDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("partnerTopicDetails"), out var __jsonPartnerTopicDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.PartnerDetails.FromJson(__jsonPartnerTopicDetails) : PartnerTopicDetail;}
            ...
            {_organizationName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonString>("organizationName"), out var __jsonOrganizationName) ? (string)__jsonOrganizationName : (string)OrganizationName;}
            {_partnerDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonString>("partnerDisplayName"), out var __jsonPartnerDisplayName) ? (string)__jsonPartnerDisplayName : (string)PartnerDisplayName;}
