...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615
{
    ...
    public partial class EventSubscriptionUpdateParameters
    {
        ...
        internal EventSubscriptionUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject json)
        {
            ...
            {_destination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("destination"), out var __jsonDestination) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.EventSubscriptionDestination.FromJson(__jsonDestination) : Destination;}
            {_deliveryWithResourceIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("deliveryWithResourceIdentity"), out var __jsonDeliveryWithResourceIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.DeliveryWithResourceIdentity.FromJson(__jsonDeliveryWithResourceIdentity) : DeliveryWithResourceIdentity;}
            {_filter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("filter"), out var __jsonFilter) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.EventSubscriptionFilter.FromJson(__jsonFilter) : Filter;}
            {_retryPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("retryPolicy"), out var __jsonRetryPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.RetryPolicy.FromJson(__jsonRetryPolicy) : RetryPolicy;}
            {_deadLetterDestination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("deadLetterDestination"), out var __jsonDeadLetterDestination) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.DeadLetterDestination.FromJson(__jsonDeadLetterDestination) : DeadLetterDestination;}
            {_deadLetterWithResourceIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("deadLetterWithResourceIdentity"), out var __jsonDeadLetterWithResourceIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.DeadLetterWithResourceIdentity.FromJson(__jsonDeadLetterWithResourceIdentity) : DeadLetterWithResourceIdentity;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IEventSubscriptionUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IEventSubscriptionUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IEventSubscriptionUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode node)
        {
