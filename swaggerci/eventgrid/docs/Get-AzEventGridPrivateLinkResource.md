...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/get-azeventgridprivatelinkresource
schema: 2.0.0
---
...
### List (Default)
```
Get-AzEventGridPrivateLinkResource -ParentName <String> -ParentType <String> -ResourceGroupName <String>
...
### Get
```
Get-AzEventGridPrivateLinkResource -Name <String> -ParentName <String> -ParentType <String>
...
### GetViaIdentity
```
Get-AzEventGridPrivateLinkResource -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IPrivateLinkResource
