...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/update-azeventgridtopic
schema: 2.0.0
---
...
Update-AzEventGridTopic -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DataResidencyBoundary <DataResidencyBoundary>] [-DisableLocalAuth] [-IdentityPrincipalId <String>]
...
```
Update-AzEventGridTopic -InputObject <IEventGridIdentity> [-DataResidencyBoundary <DataResidencyBoundary>]
 [-DisableLocalAuth] [-IdentityPrincipalId <String>] [-IdentityTenantId <String>]
