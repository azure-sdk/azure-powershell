...
New-AzEventGridChannel -Name <String> -PartnerNamespaceName <String> -ResourceGroupName <String>
 ...
 [-MessageForActivation <String>] [-PartnerTopicInfoAzureSubscriptionId <String>]
 [-PartnerTopicInfoName <String>] [-PartnerTopicInfoResourceGroupName <String>]
 [-PartnerTopicInfoSource <String>] [-ProvisioningState <ChannelProvisioningState>]
 [-ReadinessState <ReadinessState>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IChannel
