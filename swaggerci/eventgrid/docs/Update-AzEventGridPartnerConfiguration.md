...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/update-azeventgridpartnerconfiguration
schema: 2.0.0
---
...
```
Update-AzEventGridPartnerConfiguration -InputObject <IEventGridIdentity>
 [-DefaultMaximumExpirationTimeInDay <Int32>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
