...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/new-azeventgridsystemtopic
schema: 2.0.0
---
...
New-AzEventGridSystemTopic -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-IdentityType <IdentityType>] [-IdentityUserAssignedIdentity <Hashtable>] [-Source <String>]
 [-Tag <Hashtable>] [-TopicType <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
