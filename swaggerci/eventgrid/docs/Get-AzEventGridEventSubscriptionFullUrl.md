...
online version: https://docs.microsoft.com/en-us/powershell/module/az.eventgrid/get-azeventgrideventsubscriptionfullurl
schema: 2.0.0
---

# Get-AzEventGridEventSubscriptionFullUrl
...
### Get (Default)
```
Get-AzEventGridEventSubscriptionFullUrl -EventSubscriptionName <String> -Scope <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzEventGridEventSubscriptionFullUrl -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>]
