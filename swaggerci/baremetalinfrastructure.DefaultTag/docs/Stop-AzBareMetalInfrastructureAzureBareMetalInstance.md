...
online version: https://learn.microsoft.com/powershell/module/az.baremetalinfrastructure/stop-azbaremetalinfrastructureazurebaremetalinstance
schema: 2.0.0
---

# Stop-AzBareMetalInfrastructureAzureBareMetalInstance
...
### Shutdown (Default)
```
Stop-AzBareMetalInfrastructureAzureBareMetalInstance -Name <String> -ResourceGroupName <String>
...
### ShutdownViaIdentity
```
Stop-AzBareMetalInfrastructureAzureBareMetalInstance -InputObject <IBareMetalInfrastructureIdentity>
