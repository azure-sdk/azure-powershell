...
online version: https://learn.microsoft.com/powershell/module/az.baremetalinfrastructure/start-azbaremetalinfrastructureazurebaremetalinstance
schema: 2.0.0
---

# Start-AzBareMetalInfrastructureAzureBareMetalInstance
...
### Start (Default)
```
Start-AzBareMetalInfrastructureAzureBareMetalInstance -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzBareMetalInfrastructureAzureBareMetalInstance -InputObject <IBareMetalInfrastructureIdentity>
