...
New-AzBareMetalInfrastructureAzureBareMetalInstance -Name <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-NetworkProfileNetworkInterface <INetworkInterface[]>]
 [-OSProfileComputerName <String>] [-OSProfileSshPublicKey <String>] [-PartnerNodeId <String>]
 [-StorageProfileOSDisk <IDisk[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
