...
external help file:
Module Name: Az.SaaS
online version: https://learn.microsoft.com/powershell/module/az.saas/update-azsaassaassubscriptionlevel
schema: 2.0.0
---

# Update-AzSaaSSaasSubscriptionLevel
...
```
Update-AzSaaSSaasSubscriptionLevel -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-AutoRenew] [-Location <String>] [-Name <String>] [-OfferId <String>]
...
```
Update-AzSaaSSaasSubscriptionLevel -InputObject <ISaaSIdentity> [-AutoRenew] [-Location <String>]
 [-Name <String>] [-OfferId <String>] [-PaymentChannelMetadata <Hashtable>]
