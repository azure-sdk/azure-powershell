...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class OrderItemDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IOrderItemDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IOrderItemDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IOrderItemDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal OrderItemDetails(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_siteDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("siteDetails"), out var __jsonSiteDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.SiteDetails.FromJson(__jsonSiteDetails) : SiteDetail;}
            {_currentStage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("currentStage"), out var __jsonCurrentStage) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.StageDetails.FromJson(__jsonCurrentStage) : CurrentStage;}
            {_preference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("preferences"), out var __jsonPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.Preferences.FromJson(__jsonPreferences) : Preference;}
            {_forwardShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("forwardShippingDetails"), out var __jsonForwardShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ForwardShippingDetails.FromJson(__jsonForwardShippingDetails) : ForwardShippingDetail;}
            {_reverseShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("reverseShippingDetails"), out var __jsonReverseShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ReverseShippingDetails.FromJson(__jsonReverseShippingDetails) : ReverseShippingDetail;}
            {_error = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("error"), out var __jsonError) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api50.ErrorDetail.FromJson(__jsonError) : Error;}
            ...
            {_orderItemStageHistory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("orderItemStageHistory"), out var __jsonOrderItemStageHistory) ? If( __jsonOrderItemStageHistory as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IStageDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IStageDetails) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.StageDetails.FromJson(__u) )) ))() : null : OrderItemStageHistory;}
            ...
            {_managementRpDetailsList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("managementRpDetailsList"), out var __jsonManagementRpDetailsList) ? If( __jsonManagementRpDetailsList as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IResourceProviderDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IResourceProviderDetails) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ResourceProviderDetails.FromJson(__k) )) ))() : null : ManagementRpDetailsList;}
            {_productDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("productDetails"), out var __jsonProductDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ProductDetails.FromJson(__jsonProductDetails) : ProductDetail;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._siteDetail ? (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode) this._siteDetail.ToJson(null,serializationMode) : null, "siteDetails" ,container.Add );
