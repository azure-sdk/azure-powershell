...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class Dimensions :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensions,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal
    {
        ...
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.Depth { get => this._depth; set { {_depth = value;} } }

        /// <summary>Internal Acessors for Height</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.Height { get => this._height; set { {_height = value;} } }

        /// <summary>Internal Acessors for Length</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.Length { get => this._length; set { {_length = value;} } }

        /// <summary>Internal Acessors for LengthHeightUnit</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.LengthHeightUnit? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.LengthHeightUnit { get => this._lengthHeightUnit; set { {_lengthHeightUnit = value;} } }

        /// <summary>Internal Acessors for Weight</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.Weight { get => this._weight; set { {_weight = value;} } }

        /// <summary>Internal Acessors for WeightUnit</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.WeightMeasurementUnit? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.WeightUnit { get => this._weightUnit; set { {_weightUnit = value;} } }

        /// <summary>Internal Acessors for Width</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDimensionsInternal.Width { get => this._width; set { {_width = value;} } }
