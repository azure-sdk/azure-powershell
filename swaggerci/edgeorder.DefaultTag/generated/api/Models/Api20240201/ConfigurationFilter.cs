...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class ConfigurationFilter :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IConfigurationFilter,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IConfigurationFilterInternal
    {

        /// <summary>Backing field for <see cref="ChildConfigurationFilter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilter _childConfigurationFilter;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilter ChildConfigurationFilter { get => (this._childConfigurationFilter = this._childConfigurationFilter ?? new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ChildConfigurationFilter()); set => this._childConfigurationFilter = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ChildConfigurationType[] ChildConfigurationFilterChildConfigurationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilterInternal)ChildConfigurationFilter).ChildConfigurationType; set => ((Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilterInternal)ChildConfigurationFilter).ChildConfigurationType = value ?? null /* arrayOf */; }

        /// <summary>
        /// The list of child configuration hierarchy customer wants to filter for the given configuration.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IHierarchyInformation[] ChildConfigurationFilterHierarchyInformation { get => ((Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilterInternal)ChildConfigurationFilter).HierarchyInformation; set => ((Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilterInternal)ChildConfigurationFilter).HierarchyInformation = value ?? null /* arrayOf */; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IFilterableProperty[] FilterableProperty { get => this._filterableProperty; set => this._filterableProperty = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilter Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IConfigurationFilterInternal.ChildConfigurationFilter { get => (this._childConfigurationFilter = this._childConfigurationFilter ?? new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ChildConfigurationFilter()); set { {_childConfigurationFilter = value;} } }

        /// <summary>Internal Acessors for HierarchyInformation</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IHierarchyInformation Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IConfigurationFilterInternal.HierarchyInformation { get => (this._hierarchyInformation = this._hierarchyInformation ?? new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.HierarchyInformation()); set { {_hierarchyInformation = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IHierarchyInformation) })]
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IHierarchyInformation[] ChildConfigurationFilterHierarchyInformation { get; set; }
        /// <summary>Filters specific to product.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        /// of specific child configurations, or all child configurations of specific types of child configurations.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IChildConfigurationFilter ChildConfigurationFilter { get; set; }
        /// <summary>
        /// Filter to fetch all child configurations belonging to the given list of configuration types.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ChildConfigurationType[] ChildConfigurationFilterChildConfigurationType { get; set; }
