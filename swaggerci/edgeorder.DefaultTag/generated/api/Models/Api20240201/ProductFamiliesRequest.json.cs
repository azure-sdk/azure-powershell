...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class ProductFamiliesRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IProductFamiliesRequest.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IProductFamiliesRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IProductFamiliesRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
        ...
        internal ProductFamiliesRequest(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_customerSubscriptionDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("customerSubscriptionDetails"), out var __jsonCustomerSubscriptionDetails) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.CustomerSubscriptionDetails.FromJson(__jsonCustomerSubscriptionDetails) : CustomerSubscriptionDetail;}
            {_filterableProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("filterableProperties"), out var __jsonFilterableProperties) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ProductFamiliesRequestFilterableProperties.FromJson(__jsonFilterableProperties) : FilterableProperty;}
            AfterFromJson(json);
        }
