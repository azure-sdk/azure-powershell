...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class DisplayInfo :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDisplayInfo,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDisplayInfoInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDisplayInfoInternal.ConfigurationDisplayName { get => this._configurationDisplayName; set { {_configurationDisplayName = value;} } }

        /// <summary>Internal Acessors for ProductFamilyDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDisplayInfoInternal.ProductFamilyDisplayName { get => this._productFamilyDisplayName; set { {_productFamilyDisplayName = value;} } }
