...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class BasicInformation
    {
        ...
        internal BasicInformation(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject json)
        {
            ...
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("description"), out var __jsonDescription) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.Description.FromJson(__jsonDescription) : Description;}
            {_costInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("costInformation"), out var __jsonCostInformation) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.CostInformation.FromJson(__jsonCostInformation) : CostInformation;}
            {_availabilityInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonObject>("availabilityInformation"), out var __jsonAvailabilityInformation) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.AvailabilityInformation.FromJson(__jsonAvailabilityInformation) : AvailabilityInformation;}
            ...
            {_imageInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray>("imageInformation"), out var __jsonImageInformation) ? If( __jsonImageInformation as Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IImageInformation[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IImageInformation) (Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ImageInformation.FromJson(__u) )) ))() : null : ImageInformation;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IBasicInformation.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IBasicInformation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IBasicInformation FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Json.JsonNode node)
        {
