...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201
{
    ...
    public partial class Description :
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescription,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ILink[] _link;

        /// <summary>Links for the product system.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Origin(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ILink[] Link { get => this._link; }
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal.Attribute { get => this._attribute; set { {_attribute = value;} } }

        /// <summary>Internal Acessors for Keyword</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal.Keyword { get => this._keyword; set { {_keyword = value;} } }

        /// <summary>Internal Acessors for Link</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ILink[] Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal.Link { get => this._link; set { {_link = value;} } }

        /// <summary>Internal Acessors for LongDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal.LongDescription { get => this._longDescription; set { {_longDescription = value;} } }

        /// <summary>Internal Acessors for ShortDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal.ShortDescription { get => this._shortDescription; set { {_shortDescription = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.DescriptionType? Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IDescriptionInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ILink[] Link { get;  }
        /// <summary>Long description of the product system.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>Links for the product system.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.ILink[] Link { get; set; }
        /// <summary>Long description of the product system.</summary>
