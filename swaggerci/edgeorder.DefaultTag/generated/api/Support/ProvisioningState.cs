...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Creating state.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState Creating = @"Creating";

        /// <summary>Failed state.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Succeeded state.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
