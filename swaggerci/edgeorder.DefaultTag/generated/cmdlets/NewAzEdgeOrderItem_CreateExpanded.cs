...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// <summary>
    /// Create an order item. Existing order item cannot be updated with this api and should instead be updated with the Update
    /// order item\nAPI.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/orderItems/{orderItemName}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Description(@"Create an order item. Existing order item cannot be updated with this api and should instead be updated with the Update order item\nAPI.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IOrderItemResource _orderItemResourceBody = new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.OrderItemResource();

        /// <summary>Represents shipping and return address for order item.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Represents shipping and return address for order item.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IAddressDetails AddressDetail { get => _orderItemResourceBody.AddressDetail ?? null /* object */; set => _orderItemResourceBody.AddressDetail = value; }
        ...
        public string IdentityType { get => _orderItemResourceBody.IdentityType ?? null; set => _orderItemResourceBody.IdentityType = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api50.IResourceIdentityUserAssignedIdentities IdentityUserAssignedIdentity { get => _orderItemResourceBody.IdentityUserAssignedIdentity ?? null /* object */; set => _orderItemResourceBody.IdentityUserAssignedIdentity = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => _orderItemResourceBody.Location ?? null; set => _orderItemResourceBody.Location = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string OrderId { get => _orderItemResourceBody.OrderId ?? null; set => _orderItemResourceBody.OrderId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IOrderItemDetails OrderItemDetail { get => _orderItemResourceBody.OrderItemDetail ?? null /* object */; set => _orderItemResourceBody.OrderItemDetail = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api50.ITrackedResourceTags Tag { get => _orderItemResourceBody.Tag ?? null /* object */; set => _orderItemResourceBody.Tag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets.NewAzEdgeOrderItem_CreateExpanded Clone()
        {
            ...
            clone._orderItemResourceBody = this._orderItemResourceBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OrderItemsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OrderItemsCreate(SubscriptionId, ResourceGroupName, Name, _orderItemResourceBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=_orderItemResourceBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api50.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=_orderItemResourceBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=_orderItemResourceBody })
                    {
