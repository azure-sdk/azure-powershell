...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzEdgeOrderReturnOrderItem_ReturnViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/orderItems/{orderItemName}/return", ApiVersion = "2022-05-01-preview")]
    public partial class InvokeAzEdgeOrderReturnOrderItem_ReturnViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ReturnOrderItemDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IReturnOrderItemDetails _returnOrderItemDetail;

        /// <summary>Return order item request body.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Return order item request body.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Return order item request body.",
        SerializedName = @"returnOrderItemDetails",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IReturnOrderItemDetails) })]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IReturnOrderItemDetails ReturnOrderItemDetail { get => this._returnOrderItemDetail; set => this._returnOrderItemDetail = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzEdgeOrderReturnOrderItem_ReturnViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets.InvokeAzEdgeOrderReturnOrderItem_ReturnViaIdentity Clone()
        {
            var clone = new InvokeAzEdgeOrderReturnOrderItem_ReturnViaIdentity();
            ...
            clone.ReturnOrderItemDetail = this.ReturnOrderItemDetail;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzEdgeOrderReturnOrderItem_ReturnViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzEdgeOrderReturnOrderItem_ReturnViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.OrderItemsReturnViaIdentity(InputObject.Id, ReturnOrderItemDetail, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.OrderItemsReturn(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.OrderItemName ?? null, ReturnOrderItemDetail, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ReturnOrderItemDetail})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ReturnOrderItemDetail })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ReturnOrderItemDetail })
                    {
