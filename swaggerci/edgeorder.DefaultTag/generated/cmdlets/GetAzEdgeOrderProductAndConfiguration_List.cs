...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListConfigurations=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.EdgeOrder/listConfigurations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEdgeOrderProductAndConfiguration_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfiguration))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Description(@"List configurations for the given product family, product line and product for the given subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.EdgeOrder/listConfigurations", ApiVersion = "2022-05-01-preview")]
    public partial class GetAzEdgeOrderProductAndConfiguration_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConfigurationsRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurationsRequest _configurationsRequest;

        /// <summary>Configuration request object.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Configuration request object.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Configuration request object.",
        SerializedName = @"configurationsRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurationsRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurationsRequest ConfigurationsRequest { get => this._configurationsRequest; set => this._configurationsRequest = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "$skipToken is supported on list of configurations, which provides the next page in the list of configurations.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurations">Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurations</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurations> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEdgeOrderProductAndConfiguration_List" /> cmdlet class.
        /// </summary>
        public GetAzEdgeOrderProductAndConfiguration_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ProductsAndConfigurationsListConfigurations' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ProductsAndConfigurationsListConfigurations(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, ConfigurationsRequest, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, SkipToken=this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, body=ConfigurationsRequest })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IConfigurations> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ProductsAndConfigurationsListConfigurations_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
