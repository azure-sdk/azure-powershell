...
```
New-AzEdgeOrderItem -Name <String> -ResourceGroupName <String> -Location <String> -OrderId <String>
 -OrderItemDetail <IOrderItemDetails> [-SubscriptionId <String>] [-AddressDetail <IAddressDetails>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IAddressDetails
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IOrderItemDetails
Parameter Sets: (All)
Aliases:
