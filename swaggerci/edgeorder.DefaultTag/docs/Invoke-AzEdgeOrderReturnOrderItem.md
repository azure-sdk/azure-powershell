...
Invoke-AzEdgeOrderReturnOrderItem -OrderItemName <String> -ResourceGroupName <String> -ReturnReason <String>
 ...
 [-ReturnAddressClassification <AddressClassification>] [-ServiceTag <String>] [-ShippingAddressCity <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.AddressClassification
Parameter Sets: ReturnExpanded, ReturnViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.IReturnOrderItemDetails
