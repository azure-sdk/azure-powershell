...
Update-AzEdgeOrderItem -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-ForwardAddressClassification <AddressClassification>] [-IdentityType <String>]
 [-IdentityUserAssignedIdentity <Hashtable>]
 [-ManagementResourcePreferencePreferredManagementResourceId <String>] [-NotificationEmailList <String[]>]
 [-ParentProvisioningDetailAutoProvisioningStatus <AutoProvisioningStatus>]
 [-ParentProvisioningDetailManagementResourceArmId <String>]
 [-ParentProvisioningDetailProvisioningArmId <String>]
 [-ParentProvisioningDetailProvisioningEndPoint <String>] [-ParentProvisioningDetailQuantity <Int32>]
 [-ParentProvisioningDetailReadyToConnectArmId <String>] [-ParentProvisioningDetailSerialNumber <String>]
 [-ParentProvisioningDetailVendorName <String>]
 ...
 [-ShippingAddressZipExtendedCode <String>] [-SiteDetailSiteId <String>] [-Tag <Hashtable>]
 [-TermCommitmentPreferencePreferredTermCommitmentDuration <TimeSpan>]
 [-TermCommitmentPreferencePreferredTermCommitmentType <TermCommitmentType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.AutoProvisioningStatus
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20240201.INotificationPreference[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Support.TermCommitmentType
Parameter Sets: (All)
Aliases:
