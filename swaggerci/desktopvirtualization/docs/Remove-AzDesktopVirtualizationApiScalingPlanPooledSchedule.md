...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapiscalingplanpooledschedule
schema: 2.0.0
---

# Remove-AzDesktopVirtualizationApiScalingPlanPooledSchedule
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiScalingPlanPooledSchedule -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiScalingPlanPooledSchedule -InputObject <IDesktopVirtualizationApiIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
