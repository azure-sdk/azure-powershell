...
New-AzDesktopVirtualizationApiHostPool -Name <String> -ResourceGroupName <String> -HostPoolType <HostPoolType>
 ...
 [-SubscriptionId <String>] [-AgentUpdateMaintenanceWindowTimeZone <String>]
 [-AgentUpdateType <SessionHostComponentUpdateType>] [-AgentUpdateUseSessionHostLocalTime]
 ...
 [-PlanVersion <String>] [-RegistrationInfoExpirationTime <DateTime>]
...
### Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210903Preview.IHostPool
