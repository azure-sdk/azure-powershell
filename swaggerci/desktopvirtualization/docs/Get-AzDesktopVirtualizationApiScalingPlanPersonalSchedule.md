...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapiscalingplanpersonalschedule
schema: 2.0.0
---

# Get-AzDesktopVirtualizationApiScalingPlanPersonalSchedule
...
### List (Default)
```
Get-AzDesktopVirtualizationApiScalingPlanPersonalSchedule -ResourceGroupName <String>
 -ScalingPlanName <String> [-SubscriptionId <String[]>] [-InitialSkip <Int32>] [-IsDescending]
...
### GetViaIdentity
```
Get-AzDesktopVirtualizationApiScalingPlanPersonalSchedule -InputObject <IDesktopVirtualizationApiIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
