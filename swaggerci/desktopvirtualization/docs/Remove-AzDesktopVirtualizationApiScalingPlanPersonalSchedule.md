...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapiscalingplanpersonalschedule
schema: 2.0.0
---

# Remove-AzDesktopVirtualizationApiScalingPlanPersonalSchedule
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiScalingPlanPersonalSchedule -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiScalingPlanPersonalSchedule -InputObject <IDesktopVirtualizationApiIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
