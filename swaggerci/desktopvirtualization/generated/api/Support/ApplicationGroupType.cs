...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType Desktop = @"Desktop";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType RemoteApp = @"RemoteApp";
        ...
        {
            return new ApplicationGroupType(global::System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type ApplicationGroupType</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType e1, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType e2)
        {
            return !e2.Equals(e1);
        }
