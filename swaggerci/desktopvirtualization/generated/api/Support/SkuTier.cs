...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier Basic = @"Basic";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier Free = @"Free";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier Premium = @"Premium";

        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier Standard = @"Standard";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier e1, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.SkuTier e2)
        {
            return !e2.Equals(e1);
        }
