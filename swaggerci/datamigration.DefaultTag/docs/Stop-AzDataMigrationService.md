...
online version: https://learn.microsoft.com/powershell/module/az.datamigration/stop-azdatamigrationservice
schema: 2.0.0
---
...
### Stop (Default)
```
Stop-AzDataMigrationService -GroupName <String> -Name <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzDataMigrationService -InputObject <IDataMigrationIdentity> [-DefaultProfile <PSObject>] [-AsJob]
