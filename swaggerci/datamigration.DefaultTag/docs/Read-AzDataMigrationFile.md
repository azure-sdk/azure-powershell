...
online version: https://learn.microsoft.com/powershell/module/az.datamigration/read-azdatamigrationfile
schema: 2.0.0
---

# Read-AzDataMigrationFile
...
### Read (Default)
```
Read-AzDataMigrationFile -GroupName <String> -Name <String> -ProjectName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReadViaIdentity
```
Read-AzDataMigrationFile -InputObject <IDataMigrationIdentity> [-DefaultProfile <PSObject>] [-Confirm]
