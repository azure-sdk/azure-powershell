...
### Start (Default)
```
Start-AzDataMigrationService -GroupName <String> -Name <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzDataMigrationService -InputObject <IDataMigrationIdentity> [-DefaultProfile <PSObject>] [-AsJob]
