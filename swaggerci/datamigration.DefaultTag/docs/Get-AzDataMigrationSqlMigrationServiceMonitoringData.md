...
online version: https://learn.microsoft.com/powershell/module/az.datamigration/get-azdatamigrationsqlmigrationservicemonitoringdata
schema: 2.0.0
---
...
```
Get-AzDataMigrationSqlMigrationServiceMonitoringData -ResourceGroupName <String>
