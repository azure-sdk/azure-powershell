...
online version: https://learn.microsoft.com/powershell/module/az.datamigration/stop-azdatamigrationdatabasemigrationssqlvm
schema: 2.0.0
---

# Stop-AzDataMigrationDatabaseMigrationsSqlVM
...
```
Stop-AzDataMigrationDatabaseMigrationsSqlVM -ResourceGroupName <String> -SqlVirtualMachineName <String>
...
### CancelViaIdentity
```
Stop-AzDataMigrationDatabaseMigrationsSqlVM -InputObject <IDataMigrationIdentity>
