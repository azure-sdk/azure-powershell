...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <summary>
    /// The tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The PATCH
    /// method updates an existing task, but since tasks have no mutable custom properties, there is little reason to do so. Database
    /// Migration Service (classic) - SQL scenarios are on a deprecation path and will be retired on 15 March 2026 for all customers.
    /// Please migrate to Azure SQL database services by using the latest Azure Database Migration Service version which is available
    /// as an extension in Azure Data Studio, or by using Azure PowerShell and Azure CLI.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDataMigrationTask_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The PATCH method updates an existing task, but since tasks have no mutable custom properties, there is little reason to do so. Database Migration Service (classic) - SQL scenarios are on a deprecation path and will be retired on 15 March 2026 for all customers. Please migrate to Azure SQL database services by using the latest Azure Database Migration Service version which is available as an extension in Azure Data Studio, or by using Azure PowerShell and Azure CLI.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    public partial class UpdateAzDataMigrationTask_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.TasksUpdate(SubscriptionId, GroupName, ServiceName, ProjectName, Name, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzDataMigrationTask_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzDataMigrationTask_UpdateExpanded()
        {
