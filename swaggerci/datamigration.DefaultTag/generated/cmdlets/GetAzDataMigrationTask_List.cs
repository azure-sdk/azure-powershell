...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// returns a list of tasks owned by a service resource. Some tasks may have a status of Unknown, which indicates that an
    /// error occurred while querying the status of that task.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/projects/{projectName}/tasks"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataMigrationTask_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The services resource is the top-level resource that represents the Azure Database Migration Service (classic). This method returns a list of tasks owned by a service resource. Some tasks may have a status of Unknown, which indicates that an error occurred while querying the status of that task.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    public partial class GetAzDataMigrationTask_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.ITaskList">Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.ITaskList</see>
        /// from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDataMigrationTask_List" /> cmdlet class.
        /// </summary>
        public GetAzDataMigrationTask_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TasksList(SubscriptionId, GroupName, ServiceName, ProjectName, this.InvocationInformation.BoundParameters.ContainsKey("TaskType") ? TaskType : null, onOk, onDefault, this, Pipeline);
