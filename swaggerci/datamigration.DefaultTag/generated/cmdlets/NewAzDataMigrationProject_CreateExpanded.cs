...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// or updates an existing one. Database Migration Service (classic) - SQL scenarios are on a deprecation path and will be
    ...
    /// Migration Service version which is available as an extension in Azure Data Studio, or by using Azure PowerShell and Azure
    /// CLI.
    /// </summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The project resource is a nested resource representing a stored migration project. The PUT method creates a new project or updates an existing one. Database Migration Service (classic) - SQL scenarios are on a deprecation path and will be retired on 15 March 2026 for all customers. Please migrate to Azure SQL database services by using the latest Azure Database Migration Service version which is available as an extension in Azure Data Studio, or by using Azure PowerShell and Azure CLI.")]
