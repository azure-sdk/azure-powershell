...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview
{
    ...
    public partial class MigrateSqlServerSqlDbSyncDatabaseInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSqlServerSqlDbSyncDatabaseInput.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSqlServerSqlDbSyncDatabaseInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSqlServerSqlDbSyncDatabaseInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
        ...
        internal MigrateSqlServerSqlDbSyncDatabaseInput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_tableMap = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("tableMap"), out var __jsonTableMap) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.MigrateSqlServerSqlDbSyncDatabaseInputTableMap.FromJson(__jsonTableMap) : TableMap;}
            {_migrationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("migrationSetting"), out var __jsonMigrationSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.MigrateSqlServerSqlDbSyncDatabaseInputMigrationSetting.FromJson(__jsonMigrationSetting) : MigrationSetting;}
            {_sourceSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("sourceSetting"), out var __jsonSourceSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.MigrateSqlServerSqlDbSyncDatabaseInputSourceSetting.FromJson(__jsonSourceSetting) : SourceSetting;}
            {_targetSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("targetSetting"), out var __jsonTargetSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.MigrateSqlServerSqlDbSyncDatabaseInputTargetSetting.FromJson(__jsonTargetSetting) : TargetSetting;}
            AfterFromJson(json);
        }
