...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview
{
    ...
    public partial class ServerProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal
    {

        /// <summary>Internal Acessors for ServerDatabaseCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal.ServerDatabaseCount { get => this._serverDatabaseCount; set { {_serverDatabaseCount = value;} } }

        /// <summary>Internal Acessors for ServerEdition</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal.ServerEdition { get => this._serverEdition; set { {_serverEdition = value;} } }

        /// <summary>Internal Acessors for ServerName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal.ServerName { get => this._serverName; set { {_serverName = value;} } }

        /// <summary>Internal Acessors for ServerOperatingSystemVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal.ServerOperatingSystemVersion { get => this._serverOperatingSystemVersion; set { {_serverOperatingSystemVersion = value;} } }

        /// <summary>Internal Acessors for ServerPlatform</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal.ServerPlatform { get => this._serverPlatform; set { {_serverPlatform = value;} } }

        /// <summary>Internal Acessors for ServerVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IServerPropertiesInternal.ServerVersion { get => this._serverVersion; set { {_serverVersion = value;} } }
