...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview
{
    ...
    public partial class MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json ? new MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel"
        /// />.
        /// </summary>
        ...
        internal MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            __migrateSqlServerSqlMiSyncTaskOutput = new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.MigrateSqlServerSqlMiSyncTaskOutput(json);
            {_fullBackupSetInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("fullBackupSetInfo"), out var __jsonFullBackupSetInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.BackupSetInfo.FromJson(__jsonFullBackupSetInfo) : FullBackupSetInfo;}
            {_lastRestoredBackupSetInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("lastRestoredBackupSetInfo"), out var __jsonLastRestoredBackupSetInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.BackupSetInfo.FromJson(__jsonLastRestoredBackupSetInfo) : LastRestoredBackupSetInfo;}
            ...
            {_activeBackupSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonArray>("activeBackupSets"), out var __jsonActiveBackupSets) ? If( __jsonActiveBackupSets as Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IBackupSetInfo[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IBackupSetInfo) (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.BackupSetInfo.FromJson(__u) )) ))() : null : ActiveBackupSet;}
            {_containerName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString>("containerName"), out var __jsonContainerName) ? (string)__jsonContainerName : (string)ContainerName;}
            ...
            {_exceptionsAndWarning = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonArray>("exceptionsAndWarnings"), out var __jsonExceptionsAndWarnings) ? If( __jsonExceptionsAndWarnings as Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IReportableException[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IReportableException) (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ReportableException.FromJson(__p) )) ))() : null : ExceptionsAndWarning;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode serializationMode)
        {
            ...
            __migrateSqlServerSqlMiSyncTaskOutput?.ToJson(container, serializationMode);
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._containerName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString(this._containerName.ToString()) : null, "containerName" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
                if (null != this._exceptionsAndWarning)
                {
                    ...
                    foreach( var __s in this._exceptionsAndWarning )
                    {
                        AddIf(__s?.ToJson(null, serializationMode) ,__r.Add);
                    }
                    container.Add("exceptionsAndWarnings",__r);
                }
            }
