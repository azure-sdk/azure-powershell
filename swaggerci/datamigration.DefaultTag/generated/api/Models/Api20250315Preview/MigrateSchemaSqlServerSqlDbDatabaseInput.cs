...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview
{
    ...
    public partial class MigrateSchemaSqlServerSqlDbDatabaseInput :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSchemaSqlServerSqlDbDatabaseInput,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSchemaSqlServerSqlDbDatabaseInputInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSetting Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.IMigrateSchemaSqlServerSqlDbDatabaseInputInternal.SchemaSetting { get => (this._schemaSetting = this._schemaSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.SchemaMigrationSetting()); set { {_schemaSetting = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSetting _schemaSetting;

        /// <summary>Database schema migration settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSetting SchemaSetting { get => (this._schemaSetting = this._schemaSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.SchemaMigrationSetting()); set => this._schemaSetting = value; }
        ...
        public string SchemaSettingFileId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSettingInternal)SchemaSetting).FileId; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSettingInternal)SchemaSetting).FileId = value ?? null; }

        /// <summary>Name of the file resource containing the uploaded schema file</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Inlined)]
        public string SchemaSettingFileName { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSettingInternal)SchemaSetting).FileName; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSettingInternal)SchemaSetting).FileName = value ?? null; }

        /// <summary>Option on how to migrate the schema</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.SchemaMigrationOption? SchemaSettingSchemaOption { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSettingInternal)SchemaSetting).SchemaOption; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSettingInternal)SchemaSetting).SchemaOption = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.SchemaMigrationOption)""); }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Database schema migration settings</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20250315Preview.ISchemaMigrationSetting SchemaSetting { get; set; }
        /// <summary>Resource Identifier of a file resource containing the uploaded schema file</summary>
        string SchemaSettingFileId { get; set; }
        /// <summary>Name of the file resource containing the uploaded schema file</summary>
        string SchemaSettingFileName { get; set; }
