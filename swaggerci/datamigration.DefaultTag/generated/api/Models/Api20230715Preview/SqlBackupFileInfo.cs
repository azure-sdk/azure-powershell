...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview
{
    ...
    public partial class SqlBackupFileInfo :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfo,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.CopyDuration { get => this._copyDuration; set { {_copyDuration = value;} } }

        /// <summary>Internal Acessors for CopyThroughput</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.CopyThroughput { get => this._copyThroughput; set { {_copyThroughput = value;} } }

        /// <summary>Internal Acessors for DataRead</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.DataRead { get => this._dataRead; set { {_dataRead = value;} } }

        /// <summary>Internal Acessors for DataWritten</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.DataWritten { get => this._dataWritten; set { {_dataWritten = value;} } }

        /// <summary>Internal Acessors for FamilySequenceNumber</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.FamilySequenceNumber { get => this._familySequenceNumber; set { {_familySequenceNumber = value;} } }

        /// <summary>Internal Acessors for FileName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.FileName { get => this._fileName; set { {_fileName = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for TotalSize</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlBackupFileInfoInternal.TotalSize { get => this._totalSize; set { {_totalSize = value;} } }
