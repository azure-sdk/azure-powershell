...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview
{
    ...
    public partial class ConnectToTargetSqlDbTaskInput :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IConnectToTargetSqlDbTaskInput,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IConnectToTargetSqlDbTaskInputInternal
    {

        /// <summary>Internal Acessors for TargetConnectionInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlConnectionInfo Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IConnectToTargetSqlDbTaskInputInternal.TargetConnectionInfo { get => (this._targetConnectionInfo = this._targetConnectionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.SqlConnectionInfo()); set { {_targetConnectionInfo = value;} } }

        /// <summary>Backing field for <see cref="QueryObjectCount" /> property.</summary>
        private bool? _queryObjectCount;

        /// <summary>
        /// Boolean flag indicating whether to query object counts for each database on the target server
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        public bool? QueryObjectCount { get => this._queryObjectCount; set => this._queryObjectCount = value; }

        /// <summary>Backing field for <see cref="TargetConnectionInfo" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlConnectionInfo _targetConnectionInfo;

        /// <summary>Connection information for target SQL DB</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlConnectionInfo TargetConnectionInfo { get => (this._targetConnectionInfo = this._targetConnectionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.SqlConnectionInfo()); set => this._targetConnectionInfo = value; }
        ...
        /// <summary>Creates an new <see cref="ConnectToTargetSqlDbTaskInput" /> instance.</summary>
    ...
    /// Input for the task that validates connection to SQL DB and target server requirements
    internal partial interface IConnectToTargetSqlDbTaskInputInternal

    {
        ...
        bool? QueryObjectCount { get; set; }
        /// <summary>Connection information for target SQL DB</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.ISqlConnectionInfo TargetConnectionInfo { get; set; }
        /// <summary>Additional connection settings</summary>
        string TargetConnectionInfoAdditionalSetting { get; set; }
        /// <summary>Authentication type to use for connection</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.AuthenticationType? TargetConnectionInfoAuthentication { get; set; }
