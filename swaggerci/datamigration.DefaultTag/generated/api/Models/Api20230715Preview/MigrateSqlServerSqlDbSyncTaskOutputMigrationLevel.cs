...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview
{
    ...
    public partial class MigrateSqlServerSqlDbSyncTaskOutputMigrationLevel :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevel,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IValidates
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.DatabaseCount { get => this._databaseCount; set { {_databaseCount = value;} } }

        /// <summary>Internal Acessors for EndedOn</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.EndedOn { get => this._endedOn; set { {_endedOn = value;} } }

        /// <summary>Internal Acessors for SourceServer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.SourceServer { get => this._sourceServer; set { {_sourceServer = value;} } }

        /// <summary>Internal Acessors for SourceServerVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.SourceServerVersion { get => this._sourceServerVersion; set { {_sourceServerVersion = value;} } }

        /// <summary>Internal Acessors for StartedOn</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.StartedOn { get => this._startedOn; set { {_startedOn = value;} } }

        /// <summary>Internal Acessors for TargetServer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.TargetServer { get => this._targetServer; set { {_targetServer = value;} } }

        /// <summary>Internal Acessors for TargetServerVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IMigrateSqlServerSqlDbSyncTaskOutputMigrationLevelInternal.TargetServerVersion { get => this._targetServerVersion; set { {_targetServerVersion = value;} } }
