...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview
{
    ...
    public partial class DatabaseBackupInfo :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfo,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.BackupFile { get => this._backupFile; set { {_backupFile = value;} } }

        /// <summary>Internal Acessors for BackupFinishDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.BackupFinishDate { get => this._backupFinishDate; set { {_backupFinishDate = value;} } }

        /// <summary>Internal Acessors for BackupType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Support.BackupType? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.BackupType { get => this._backupType; set { {_backupType = value;} } }

        /// <summary>Internal Acessors for DatabaseName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.DatabaseName { get => this._databaseName; set { {_databaseName = value;} } }

        /// <summary>Internal Acessors for FamilyCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.FamilyCount { get => this._familyCount; set { {_familyCount = value;} } }

        /// <summary>Internal Acessors for IsCompressed</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.IsCompressed { get => this._isCompressed; set { {_isCompressed = value;} } }

        /// <summary>Internal Acessors for IsDamaged</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.IsDamaged { get => this._isDamaged; set { {_isDamaged = value;} } }

        /// <summary>Internal Acessors for Position</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20230715Preview.IDatabaseBackupInfoInternal.Position { get => this._position; set { {_position = value;} } }
