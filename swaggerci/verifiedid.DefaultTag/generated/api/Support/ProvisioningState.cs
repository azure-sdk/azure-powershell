...
namespace Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>Resource creation was canceled.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Deletion in progress</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Initial provisioning in progress</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Provisioning = @"Provisioning";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Update in progress</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmtTest.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
