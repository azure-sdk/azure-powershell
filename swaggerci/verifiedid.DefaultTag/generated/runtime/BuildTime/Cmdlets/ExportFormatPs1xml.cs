...
namespace Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmt.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmt.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.VerifiedIdMgmt.Support";
