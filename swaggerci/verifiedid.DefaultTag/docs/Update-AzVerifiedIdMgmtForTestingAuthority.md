...
online version: https://learn.microsoft.com/powershell/module/az.verifiedidmgmtfortesting/update-azverifiedidmgmtfortestingauthority
schema: 2.0.0
---

# Update-AzVerifiedIdMgmtForTestingAuthority
...
```
Update-AzVerifiedIdMgmtForTestingAuthority -Name <String> -ResourceGroupName <String>
...
```
Update-AzVerifiedIdMgmtForTestingAuthority -InputObject <IVerifiedIdMgmtForTestingIdentity> [-Tag <Hashtable>]
