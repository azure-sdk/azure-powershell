...
online version: https://learn.microsoft.com/powershell/module/az.verifiedidmgmt/update-azverifiedidmgmtauthority
schema: 2.0.0
---

# Update-AzVerifiedIdMgmtAuthority
...
```
Update-AzVerifiedIdMgmtAuthority -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzVerifiedIdMgmtAuthority -InputObject <IVerifiedIdMgmtIdentity> [-Tag <Hashtable>]
