...
online version: https://learn.microsoft.com/powershell/module/az.verifiedidmgmttest/update-azverifiedidmgmttestauthority
schema: 2.0.0
---

# Update-AzVerifiedIdMgmtTestAuthority
...
```
Update-AzVerifiedIdMgmtTestAuthority -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzVerifiedIdMgmtTestAuthority -InputObject <IVerifiedIdMgmtTestIdentity> [-Tag <Hashtable>]
