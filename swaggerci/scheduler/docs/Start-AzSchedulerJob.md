...
online version: https://docs.microsoft.com/en-us/powershell/module/az.scheduler/start-azschedulerjob
schema: 2.0.0
---

# Start-AzSchedulerJob
...
### Run (Default)
```
Start-AzSchedulerJob -CollectionName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RunViaIdentity
```
Start-AzSchedulerJob -InputObject <ISchedulerIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
