...
online version: https://docs.microsoft.com/en-us/powershell/module/az.scheduler/enable-azschedulerjobcollection
schema: 2.0.0
---
...
### Enable (Default)
```
Enable-AzSchedulerJobCollection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-AzSchedulerJobCollection -InputObject <ISchedulerIdentity> [-DefaultProfile <PSObject>] [-AsJob]
