...
New-AzAppPlatformApiPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-ApiTryOutEnabledState <ApiPortalApiTryOutEnabledState>] [-GatewayId <String[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ApiPortalApiTryOutEnabledState
Parameter Sets: (All)
Aliases:
