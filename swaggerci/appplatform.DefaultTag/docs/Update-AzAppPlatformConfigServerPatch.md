...
Update-AzAppPlatformConfigServerPatch -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-Code <String>] [-EnabledState <ConfigServerEnabledState>]
...
Update-AzAppPlatformConfigServerPatch -InputObject <IAppPlatformIdentity> [-Code <String>]
 [-EnabledState <ConfigServerEnabledState>] [-GitPropertyHostKey <String>]
...
### -EnabledState
Enabled state of the config server.
This is only used in Consumption tier.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ConfigServerEnabledState
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IGitPatternRepository[]
Parameter Sets: (All)
Aliases:
