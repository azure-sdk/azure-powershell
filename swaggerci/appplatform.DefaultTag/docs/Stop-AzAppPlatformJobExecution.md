...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/stop-azappplatformjobexecution
schema: 2.0.0
---

# Stop-AzAppPlatformJobExecution
...
### Cancel (Default)
```
Stop-AzAppPlatformJobExecution -JobName <String> -Name <String> -ResourceGroupName <String>
...
### CancelViaIdentity
```
Stop-AzAppPlatformJobExecution -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
