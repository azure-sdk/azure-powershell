...
New-AzAppPlatformJob -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-AddonConfig <Hashtable>] [-EnvironmentVariableProperty <Hashtable>]
 [-EnvironmentVariableSecret <Hashtable>] [-ResourceRequestCpu <String>] [-ResourceRequestMemory <String>]
 [-SourceType <String>] [-SourceVersion <String>] [-TemplateParallelism <Int32>]
 [-TemplateReplicaCompletionCount <Int32>] [-TemplateReplicaRetryLimit <Int32>]
 [-TemplateReplicaTimeout <Int32>] [-TriggerConfigTriggerType <String>] [-DefaultProfile <PSObject>] [-AsJob]
