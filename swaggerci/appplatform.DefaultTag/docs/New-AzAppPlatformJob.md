...
New-AzAppPlatformJob -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-ManagedComponentReference <IManagedComponentReference[]>] [-SourceType <String>]
 [-SourceVersion <String>] [-TemplateArg <String[]>] [-TemplateEnvironmentVariable <IEnvVar[]>]
 [-TriggerConfigTriggerType <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
