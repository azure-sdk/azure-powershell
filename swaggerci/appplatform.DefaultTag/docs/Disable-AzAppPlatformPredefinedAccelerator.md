...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/disable-azappplatformpredefinedaccelerator
schema: 2.0.0
---

# Disable-AzAppPlatformPredefinedAccelerator
...
### Disable (Default)
```
Disable-AzAppPlatformPredefinedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### DisableViaIdentity
```
Disable-AzAppPlatformPredefinedAccelerator -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
