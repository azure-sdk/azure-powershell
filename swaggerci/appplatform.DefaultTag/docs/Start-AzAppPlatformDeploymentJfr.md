...
online version: https://learn.microsoft.com/powershell/module/az.appplatform/start-azappplatformdeploymentjfr
schema: 2.0.0
---

# Start-AzAppPlatformDeploymentJfr
...
```
Start-AzAppPlatformDeploymentJfr -AppName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzAppPlatformDeploymentJfr -InputObject <IAppPlatformIdentity>
...
```
Start-AzAppPlatformDeploymentJfr -InputObject <IAppPlatformIdentity> [-AppInstance <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IDiagnosticParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IDiagnosticParameters
