...
Start-AzAppPlatformJob -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-ResourceRequestCpu <String>] [-ResourceRequestMemory <String>]
 [-TemplateArg <String[]>] [-TemplateEnvironmentVariable <IEnvVar[]>] [-DefaultProfile <PSObject>] [-AsJob]
...
```
Start-AzAppPlatformJob -InputObject <IAppPlatformIdentity> [-ResourceRequestCpu <String>]
 [-ResourceRequestMemory <String>] [-TemplateArg <String[]>] [-TemplateEnvironmentVariable <IEnvVar[]>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IJobExecutionProperties
