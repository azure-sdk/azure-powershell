...
Update-AzAppPlatformService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-VnetAddonLogStreamPublicEndpoint] [-VnetAddonPrivateDnsZoneId <String>] [-ZoneRedundant]
...
### Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IServiceResource
