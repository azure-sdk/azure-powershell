...
Update-AzAppPlatformService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-VnetAddonLogStreamPublicEndpoint] [-VnetAddonPrivateLinkState <PrivateLinkState>] [-ZoneRedundant]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAppPlatformService -InputObject <IAppPlatformIdentity> [-IdentityPrincipalId <String>]
 [-IdentityTenantId <String>] [-IdentityType <ManagedIdentityType>] [-InfraResourceGroup <String>]
