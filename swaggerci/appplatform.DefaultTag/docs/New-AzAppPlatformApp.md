...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomPersistentDiskResource[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ILoadedCertificate[]
Parameter Sets: (All)
Aliases:
