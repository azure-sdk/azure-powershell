...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformapm
#>
function New-AzAppPlatformApm {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IApmResource])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IApmProperties]))]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IApmPropertiesSecrets]))]
    [System.Collections.Hashtable]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AppPlatform.private\New-AzAppPlatformApm_CreateExpanded';
        }
