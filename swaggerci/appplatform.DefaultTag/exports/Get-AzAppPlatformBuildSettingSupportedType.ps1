...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformbuildsettingsupportedtype
#>
function Get-AzAppPlatformBuildSettingSupportedType {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ISupportedBuildSettingType])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformBuildSettingSupportedType_List';
        }
