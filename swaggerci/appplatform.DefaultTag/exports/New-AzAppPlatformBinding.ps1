...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IBindingResource])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IBindingResourcePropertiesBindingParameters]))]
