...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IBindingResource
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformbinding
#>
function New-AzAppPlatformBinding {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IBindingResource])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IBindingResourcePropertiesBindingParameters]))]
