...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResource])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesBindingParameters]))]
