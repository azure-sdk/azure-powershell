...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging])]
