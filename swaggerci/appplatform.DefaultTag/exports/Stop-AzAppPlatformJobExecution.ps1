...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/stop-azappplatformjobexecution
#>
function Stop-AzAppPlatformJobExecution {
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.AppPlatform.private\Stop-AzAppPlatformJobExecution_Cancel';
            CancelViaIdentity = 'Az.AppPlatform.private\Stop-AzAppPlatformJobExecution_CancelViaIdentity';
        }
