...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformservicesupportedserverversion
#>
function Get-AzAppPlatformServiceSupportedServerVersion {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ISupportedServerVersion])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformServiceSupportedServerVersion_List';
        }
