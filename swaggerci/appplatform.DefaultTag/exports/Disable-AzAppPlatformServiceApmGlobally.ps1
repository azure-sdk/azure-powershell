...
APM <IApmReference>: A reference to the APM
...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/disable-azappplatformserviceapmglobally
#>
function Disable-AzAppPlatformServiceApmGlobally {
...
param(
    ...
    [Parameter(ParameterSetName='DisableExpanded', Mandatory)]
    [Parameter(ParameterSetName='DisableViaIdentityExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'Az.AppPlatform.private\Disable-AzAppPlatformServiceApmGlobally_Disable';
            DisableExpanded = 'Az.AppPlatform.private\Disable-AzAppPlatformServiceApmGlobally_DisableExpanded';
            DisableViaIdentity = 'Az.AppPlatform.private\Disable-AzAppPlatformServiceApmGlobally_DisableViaIdentity';
            DisableViaIdentityExpanded = 'Az.AppPlatform.private\Disable-AzAppPlatformServiceApmGlobally_DisableViaIdentityExpanded';
        }
