...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformapm
#>
function Remove-AzAppPlatformApm {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AppPlatform.private\Remove-AzAppPlatformApm_Delete';
            DeleteViaIdentity = 'Az.AppPlatform.private\Remove-AzAppPlatformApm_DeleteViaIdentity';
        }
