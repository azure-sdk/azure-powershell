...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.ISupportedStackResource], [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.ISupportedStacksCollection])]
