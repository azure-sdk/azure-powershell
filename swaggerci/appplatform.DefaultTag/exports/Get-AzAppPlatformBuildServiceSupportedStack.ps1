...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ISupportedStackResource], [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ISupportedStacksCollection])]
