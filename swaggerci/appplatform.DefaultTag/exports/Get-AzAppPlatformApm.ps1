...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformapm
#>
function Get-AzAppPlatformApm {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppPlatform.private\Get-AzAppPlatformApm_Get';
            GetViaIdentity = 'Az.AppPlatform.private\Get-AzAppPlatformApm_GetViaIdentity';
            List = 'Az.AppPlatform.private\Get-AzAppPlatformApm_List';
        }
