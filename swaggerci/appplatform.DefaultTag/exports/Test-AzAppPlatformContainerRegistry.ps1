...
CONTAINERREGISTRYPROPERTY <IContainerRegistryProperties>: Container registry resource payload.
  CredentialsType <String>: The credential type of the container registry credentials.
...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/test-azappplatformcontainerregistry
#>
function Test-AzAppPlatformContainerRegistry {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IContainerRegistryValidateResult])]
...
begin {
    try {
        ...
        $mapping = @{
            Validate = 'Az.AppPlatform.private\Test-AzAppPlatformContainerRegistry_Validate';
            ValidateExpanded = 'Az.AppPlatform.private\Test-AzAppPlatformContainerRegistry_ValidateExpanded';
            ValidateViaIdentity = 'Az.AppPlatform.private\Test-AzAppPlatformContainerRegistry_ValidateViaIdentity';
            ValidateViaIdentityExpanded = 'Az.AppPlatform.private\Test-AzAppPlatformContainerRegistry_ValidateViaIdentityExpanded';
        }
