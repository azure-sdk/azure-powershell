...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformbuildsetting
#>
function Get-AzAppPlatformBuildSetting {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IBuildSettingResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppPlatform.private\Get-AzAppPlatformBuildSetting_Get';
            GetViaIdentity = 'Az.AppPlatform.private\Get-AzAppPlatformBuildSetting_GetViaIdentity';
            List = 'Az.AppPlatform.private\Get-AzAppPlatformBuildSetting_List';
        }
