...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/enable-azappplatformserviceapmglobally
#>
function Enable-AzAppPlatformServiceApmGlobally {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'Az.AppPlatform.private\Enable-AzAppPlatformServiceApmGlobally_Enable';
            EnableExpanded = 'Az.AppPlatform.private\Enable-AzAppPlatformServiceApmGlobally_EnableExpanded';
            EnableViaIdentity = 'Az.AppPlatform.private\Enable-AzAppPlatformServiceApmGlobally_EnableViaIdentity';
            EnableViaIdentityExpanded = 'Az.AppPlatform.private\Enable-AzAppPlatformServiceApmGlobally_EnableViaIdentityExpanded';
        }
