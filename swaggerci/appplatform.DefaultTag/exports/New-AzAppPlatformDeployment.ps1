...
DEPLOYMENTSETTING <IDeploymentSettings>: Deployment settings of the Deployment
  ...
  [Apm <IApmReference[]>]: Collection of ApmReferences
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IDeploymentResource])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IDeploymentSettings]
