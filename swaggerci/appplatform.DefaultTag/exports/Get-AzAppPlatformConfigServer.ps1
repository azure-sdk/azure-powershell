...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IConfigServerResource])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.AppPlatform.private\Get-AzAppPlatformConfigServer_List';
        }
