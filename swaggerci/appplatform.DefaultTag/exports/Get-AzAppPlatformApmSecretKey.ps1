...
System.String
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformapmsecretkey
#>
function Get-AzAppPlatformApmSecretKey {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformApmSecretKey_List';
        }
