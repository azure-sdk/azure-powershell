...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/new-azappplatformbuildsetting
#>
function New-AzAppPlatformBuildSetting {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AppPlatform.private\New-AzAppPlatformBuildSetting_CreateExpanded';
        }
