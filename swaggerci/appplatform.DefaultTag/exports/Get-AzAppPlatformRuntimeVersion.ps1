...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ISupportedRuntimeVersion
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ISupportedRuntimeVersion])]
