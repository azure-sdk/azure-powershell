...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformbuildsetting
#>
function Remove-AzAppPlatformBuildSetting {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AppPlatform.private\Remove-AzAppPlatformBuildSetting_Delete';
            DeleteViaIdentity = 'Az.AppPlatform.private\Remove-AzAppPlatformBuildSetting_DeleteViaIdentity';
        }
