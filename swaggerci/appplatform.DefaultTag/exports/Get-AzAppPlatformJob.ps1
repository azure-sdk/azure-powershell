...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformjob
#>
function Get-AzAppPlatformJob {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppPlatform.private\Get-AzAppPlatformJob_Get';
            GetViaIdentity = 'Az.AppPlatform.private\Get-AzAppPlatformJob_GetViaIdentity';
            List = 'Az.AppPlatform.private\Get-AzAppPlatformJob_List';
        }
