...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformservicesupportedapmtype
#>
function Get-AzAppPlatformServiceSupportedApmType {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ISupportedApmType])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformServiceSupportedApmType_List';
        }
