...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomizedAcceleratorProperties
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.IAppPlatformIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomizedAcceleratorValidateResult
.Notes
...
PROPERTY <ICustomizedAcceleratorProperties>: Customized accelerator properties payload
  ...
  [AcceleratorType <CustomizedAcceleratorType?>]: Type of the customized accelerator.
  [Description <String>]: 
  [DisplayName <String>]: 
  ...
  [GitRepositorySubPath <String>]: Folder path inside the git repository to consider as the root of the accelerator or fragment.
  [IconUrl <String>]: 
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomizedAcceleratorValidateResult])]
...
param(
    ...
    [Parameter(ParameterSetName='ValidateExpanded')]
    [Parameter(ParameterSetName='ValidateViaIdentityExpanded')]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.CustomizedAcceleratorType])]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.CustomizedAcceleratorType]
