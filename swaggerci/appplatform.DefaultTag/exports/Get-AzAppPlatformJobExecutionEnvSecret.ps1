...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformjobexecutionenvsecret
#>
function Get-AzAppPlatformJobExecutionEnvSecret {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformJobExecutionEnvSecret_List';
        }
