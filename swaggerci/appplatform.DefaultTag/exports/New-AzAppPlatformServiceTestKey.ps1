...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRegenerateTestKeyRequestPayload
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ITestKeys])]
