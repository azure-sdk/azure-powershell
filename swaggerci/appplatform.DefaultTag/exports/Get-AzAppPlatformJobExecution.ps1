...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IJobExecution
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformjobexecution
#>
function Get-AzAppPlatformJobExecution {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IJobExecution])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppPlatform.private\Get-AzAppPlatformJobExecution_Get';
            GetViaIdentity = 'Az.AppPlatform.private\Get-AzAppPlatformJobExecution_GetViaIdentity';
            List = 'Az.AppPlatform.private\Get-AzAppPlatformJobExecution_List';
        }
