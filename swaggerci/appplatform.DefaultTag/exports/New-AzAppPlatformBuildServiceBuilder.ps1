...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IBuilderResource])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IBuildpacksGroupProperties[]]
