...
System.String
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformservicegloballyenabledapm
#>
function Get-AzAppPlatformServiceGloballyEnabledApm {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformServiceGloballyEnabledApm_List';
        }
