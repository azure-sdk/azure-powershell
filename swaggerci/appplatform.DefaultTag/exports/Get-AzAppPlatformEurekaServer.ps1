...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IEurekaServerResourceCollection
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformeurekaserver
#>
function Get-AzAppPlatformEurekaServer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IEurekaServerResource], [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IEurekaServerResourceCollection])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppPlatform.private\Get-AzAppPlatformEurekaServer_Get';
            GetViaIdentity = 'Az.AppPlatform.private\Get-AzAppPlatformEurekaServer_GetViaIdentity';
            List = 'Az.AppPlatform.private\Get-AzAppPlatformEurekaServer_List';
        }
