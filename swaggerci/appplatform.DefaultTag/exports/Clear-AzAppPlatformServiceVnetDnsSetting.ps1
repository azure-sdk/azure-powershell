...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/clear-azappplatformservicevnetdnssetting
#>
function Clear-AzAppPlatformServiceVnetDnsSetting {
...
begin {
    try {
        ...
        $mapping = @{
            Flush = 'Az.AppPlatform.private\Clear-AzAppPlatformServiceVnetDnsSetting_Flush';
            FlushViaIdentity = 'Az.AppPlatform.private\Clear-AzAppPlatformServiceVnetDnsSetting_FlushViaIdentity';
        }
