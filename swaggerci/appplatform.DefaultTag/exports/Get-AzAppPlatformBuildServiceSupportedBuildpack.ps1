...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.ISupportedBuildpackResource], [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.ISupportedBuildpacksCollection])]
