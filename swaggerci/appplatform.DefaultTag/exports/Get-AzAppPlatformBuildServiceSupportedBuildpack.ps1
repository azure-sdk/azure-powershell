...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ISupportedBuildpackResource], [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ISupportedBuildpacksCollection])]
