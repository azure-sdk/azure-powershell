...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformconfigserver
#>
function Remove-AzAppPlatformConfigServer {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AppPlatform.private\Remove-AzAppPlatformConfigServer_Delete';
            DeleteViaIdentity = 'Az.AppPlatform.private\Remove-AzAppPlatformConfigServer_DeleteViaIdentity';
        }
