...
PROPERTY <IJobExecutionProperties>: Job's execution template, containing configuration for an execution
  ...
  [TemplateArg <String[]>]: Arguments for the Job executioin.
  [TemplateParallelism <Int32?>]: Number of parallel replicas of a job that can run at a given time.
  [TemplateReplicaCompletionCount <Int32?>]: Minimum number of successful replica completions before overall job completion.
  [TemplateReplicaRetryLimit <Int32?>]: Maximum number of retries before failing the job.
  [TemplateReplicaTimeout <Int32?>]: Maximum number of seconds a replica is allowed to run.
.Link
