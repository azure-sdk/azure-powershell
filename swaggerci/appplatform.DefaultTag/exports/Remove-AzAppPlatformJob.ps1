...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformjob
#>
function Remove-AzAppPlatformJob {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AppPlatform.private\Remove-AzAppPlatformJob_Delete';
            DeleteViaIdentity = 'Az.AppPlatform.private\Remove-AzAppPlatformJob_DeleteViaIdentity';
        }
