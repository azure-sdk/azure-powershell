...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/get-azappplatformjobenvsecret
#>
function Get-AzAppPlatformJobEnvSecret {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IEnvSecrets])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AppPlatform.private\Get-AzAppPlatformJobEnvSecret_List';
        }
