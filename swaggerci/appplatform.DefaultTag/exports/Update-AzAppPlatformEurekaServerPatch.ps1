...
INPUTOBJECT <IAppPlatformIdentity>: Identity Parameter
  ...
  [BuildSettingName <String>]: The name of the build setting
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource])]
