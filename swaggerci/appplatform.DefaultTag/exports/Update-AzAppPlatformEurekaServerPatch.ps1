...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/update-azappplatformeurekaserverpatch
#>
function Update-AzAppPlatformEurekaServerPatch {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IEurekaServerResource])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.EurekaServerEnabledState])]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.EurekaServerEnabledState]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AppPlatform.private\Update-AzAppPlatformEurekaServerPatch_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AppPlatform.private\Update-AzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded';
        }
