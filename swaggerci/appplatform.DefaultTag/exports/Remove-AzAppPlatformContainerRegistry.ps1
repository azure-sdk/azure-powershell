...
.Link
https://learn.microsoft.com/powershell/module/az.appplatform/remove-azappplatformcontainerregistry
#>
function Remove-AzAppPlatformContainerRegistry {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AppPlatform.private\Remove-AzAppPlatformContainerRegistry_Delete';
            DeleteViaIdentity = 'Az.AppPlatform.private\Remove-AzAppPlatformContainerRegistry_DeleteViaIdentity';
        }
