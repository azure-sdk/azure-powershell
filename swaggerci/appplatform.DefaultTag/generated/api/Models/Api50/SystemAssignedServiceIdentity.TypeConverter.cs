...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api50
{
    ...
    public partial class SystemAssignedServiceIdentityTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="SystemAssignedServiceIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api50.ISystemAssignedServiceIdentity ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api50.ISystemAssignedServiceIdentity).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
