...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview
{
    ...
    public partial class JarUploadedUserSourceInfo :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IJarUploadedUserSourceInfo,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IJarUploadedUserSourceInfoInternal,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUploadedUserSourceInfo"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUploadedUserSourceInfo __uploadedUserSourceInfo = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.UploadedUserSourceInfo();
        ...
        public string RelativePath { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUploadedUserSourceInfoInternal)__uploadedUserSourceInfo).RelativePath; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUploadedUserSourceInfoInternal)__uploadedUserSourceInfo).RelativePath = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Type = value ; }

        /// <summary>Version of the source</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inherited)]
        public string Version { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Version; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Version = value ?? null; }
    ...
    public partial interface IJarUploadedUserSourceInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUploadedUserSourceInfo
    {
        /// <summary>JVM parameter</summary>
    ...
    internal partial interface IJarUploadedUserSourceInfoInternal :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IUploadedUserSourceInfoInternal
    {
        /// <summary>JVM parameter</summary>
        string JvmOption { get; set; }
        /// <summary>Runtime version of the Jar file</summary>
