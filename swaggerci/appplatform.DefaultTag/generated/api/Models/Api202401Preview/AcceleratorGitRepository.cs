...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview
{
    ...
    public partial class AcceleratorGitRepository :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorGitRepositoryInternal
    {

        /// <summary>Backing field for <see cref="AuthSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorAuthSetting _authSetting;

        /// <summary>Properties of the auth setting payload.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorAuthSetting AuthSetting { get => (this._authSetting = this._authSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.AcceleratorAuthSetting()); set => this._authSetting = value; }
        ...
        public string AuthSettingAuthType { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorAuthSettingInternal)AuthSetting).AuthType; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorAuthSettingInternal)AuthSetting).AuthType = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorAuthSetting Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorGitRepositoryInternal.AuthSetting { get => (this._authSetting = this._authSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.AcceleratorAuthSetting()); set { {_authSetting = value;} } }
    ...
    {
        /// <summary>Properties of the auth setting payload.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IAcceleratorAuthSetting AuthSetting { get; set; }
        /// <summary>The type of the auth setting.</summary>
        string AuthSettingAuthType { get; set; }
        /// <summary>Git repository branch to be used.</summary>
        string Branch { get; set; }
