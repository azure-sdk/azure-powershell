...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview
{
    ...
    public partial class GatewayCorsProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IGatewayCorsProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IGatewayCorsPropertiesInternal
    {
        ...
        /// <summary>Backing field for <see cref="AllowedOriginPattern" /> property.</summary>
        private string[] _allowedOriginPattern;

        /// <summary>Allowed origin patterns to make cross-site requests.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        public string[] AllowedOriginPattern { get => this._allowedOriginPattern; set => this._allowedOriginPattern = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string[] AllowedOriginPattern { get; set; }
        /// <summary>HTTP response headers to expose for cross-site requests.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = false,
        ReadOnly = false,
