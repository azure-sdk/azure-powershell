...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201
{
    ...
    public partial class CustomContainer :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomContainer,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomContainerInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IImageRegistryCredential _imageRegistryCredential;

        /// <summary>Credential of the image registry</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IImageRegistryCredential ImageRegistryCredential { get => (this._imageRegistryCredential = this._imageRegistryCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ImageRegistryCredential()); set => this._imageRegistryCredential = value; }
        ...
        public string ImageRegistryCredentialPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IImageRegistryCredentialInternal)ImageRegistryCredential).Password; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IImageRegistryCredentialInternal)ImageRegistryCredential).Password = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IImageRegistryCredential Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ICustomContainerInternal.ImageRegistryCredential { get => (this._imageRegistryCredential = this._imageRegistryCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.ImageRegistryCredential()); set { {_imageRegistryCredential = value;} } }
...

    {
        ...
        string ContainerImage { get; set; }
        /// <summary>Credential of the image registry</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IImageRegistryCredential ImageRegistryCredential { get; set; }
        /// <summary>The password of the image registry credential</summary>
        string ImageRegistryCredentialPassword { get; set; }
        /// <summary>The username of the image registry credential</summary>
        string ImageRegistryCredentialUsername { get; set; }
