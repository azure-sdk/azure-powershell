...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201
{
    ...
    public partial class NetworkProfile :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfile,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IIngressConfig _ingressConfig;

        /// <summary>Ingress configuration payload for Azure Spring Apps resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IIngressConfig IngressConfig { get => (this._ingressConfig = this._ingressConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IngressConfig()); set => this._ingressConfig = value; }
        ...
        public int? IngressConfigReadTimeoutInSecond { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IIngressConfigInternal)IngressConfig).ReadTimeoutInSecond; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IIngressConfigInternal)IngressConfig).ReadTimeoutInSecond = value ?? default(int); }

        /// <summary>Internal Acessors for IngressConfig</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IIngressConfig Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileInternal.IngressConfig { get => (this._ingressConfig = this._ingressConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IngressConfig()); set { {_ingressConfig = value;} } }

        /// <summary>Internal Acessors for OutboundIP</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPs Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileInternal.OutboundIP { get => (this._outboundIP = this._outboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.NetworkProfileOutboundIPs()); set { {_outboundIP = value;} } }

        /// <summary>Internal Acessors for OutboundIPPublicIP</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileInternal.OutboundIPPublicIP { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPsInternal)OutboundIP).PublicIP; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPsInternal)OutboundIP).PublicIP = value; }

        /// <summary>Internal Acessors for RequiredTraffic</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IRequiredTraffic[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileInternal.RequiredTraffic { get => this._requiredTraffic; set { {_requiredTraffic = value;} } }

        /// <summary>Backing field for <see cref="OutboundIP" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPs _outboundIP;

        /// <summary>Desired outbound IP resources for Azure Spring Apps resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPs OutboundIP { get => (this._outboundIP = this._outboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.NetworkProfileOutboundIPs()); }

        /// <summary>A list of public IP addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public string[] OutboundIPPublicIP { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPsInternal)OutboundIP).PublicIP; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IRequiredTraffic[] _requiredTraffic;

        /// <summary>Required inbound or outbound traffics for Azure Spring Apps resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IRequiredTraffic[] RequiredTraffic { get => this._requiredTraffic; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IRequiredTraffic[] RequiredTraffic { get;  }
        /// <summary>Azure Spring Apps service reserved CIDR</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string AppSubnetId { get; set; }
        /// <summary>Ingress configuration payload for Azure Spring Apps resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IIngressConfig IngressConfig { get; set; }
        /// <summary>Ingress read time out in seconds.</summary>
        int? IngressConfigReadTimeoutInSecond { get; set; }
        /// <summary>Desired outbound IP resources for Azure Spring Apps resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.INetworkProfileOutboundIPs OutboundIP { get; set; }
        /// <summary>A list of public IP addresses.</summary>
        string[] OutboundIPPublicIP { get; set; }
        /// <summary>The egress traffic type of Azure Spring Apps VNet instances.</summary>
        string OutboundType { get; set; }
        /// <summary>Required inbound or outbound traffics for Azure Spring Apps resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20231201.IRequiredTraffic[] RequiredTraffic { get; set; }
        /// <summary>Azure Spring Apps service reserved CIDR</summary>
        string ServiceCidr { get; set; }
        /// <summary>
        /// Name of the resource group containing network resources of Azure Spring Apps Service Runtime
