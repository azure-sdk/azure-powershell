...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.ActivateDate { get => this._activateDate; set { {_activateDate = value;} } }

        /// <summary>Internal Acessors for DnsName</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.DnsName { get => this._dnsName; set { {_dnsName = value;} } }

        /// <summary>Internal Acessors for ExpirationDate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.ExpirationDate { get => this._expirationDate; set { {_expirationDate = value;} } }

        /// <summary>Internal Acessors for IssuedDate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.IssuedDate { get => this._issuedDate; set { {_issuedDate = value;} } }

        /// <summary>Internal Acessors for Issuer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.Issuer { get => this._issuer; set { {_issuer = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.CertificateResourceProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SubjectName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.SubjectName { get => this._subjectName; set { {_subjectName = value;} } }

        /// <summary>Internal Acessors for Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICertificatePropertiesInternal.Thumbprint { get => this._thumbprint; set { {_thumbprint = value;} } }
