...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview
{
    ...
    public partial class CustomizedAcceleratorProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepository _gitRepository;

        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepository GitRepository { get => (this._gitRepository = this._gitRepository ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.AcceleratorGitRepository()); set => this._gitRepository = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public string GitRepositoryUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepositoryInternal)GitRepository).Url; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepositoryInternal)GitRepository).Url = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepository Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorPropertiesInternal.GitRepository { get => (this._gitRepository = this._gitRepository ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.AcceleratorGitRepository()); set { {_gitRepository = value;} } }

        /// <summary>Internal Acessors for GitRepositoryAuthSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorAuthSetting Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorPropertiesInternal.GitRepositoryAuthSetting { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepositoryInternal)GitRepository).AuthSetting; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IAcceleratorGitRepositoryInternal)GitRepository).AuthSetting = value; }

        /// <summary>Internal Acessors for Import</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorPropertiesInternal.Import { get => this._import; set { {_import = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.CustomizedAcceleratorProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
