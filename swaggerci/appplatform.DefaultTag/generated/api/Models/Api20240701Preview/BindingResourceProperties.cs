...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview
{
    ...
    public partial class BindingResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesInternal
    {

        /// <summary>Backing field for <see cref="BindingParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesBindingParameters _bindingParameter;

        /// <summary>Binding parameters of the Binding resource</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesBindingParameters BindingParameter { get => (this._bindingParameter = this._bindingParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.BindingResourcePropertiesBindingParameters()); set => this._bindingParameter = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for GeneratedProperty</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesInternal.GeneratedProperty { get => this._generatedProperty; set { {_generatedProperty = value;} } }

        /// <summary>Internal Acessors for ResourceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesInternal.ResourceName { get => this._resourceName; set { {_resourceName = value;} } }

        /// <summary>Internal Acessors for ResourceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesInternal.ResourceType { get => this._resourceType; set { {_resourceType = value;} } }

        /// <summary>Internal Acessors for UpdatedAt</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IBindingResourcePropertiesInternal.UpdatedAt { get => this._updatedAt; set { {_updatedAt = value;} } }
