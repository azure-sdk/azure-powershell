...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview
{
    ...
    public partial class MonitoringSettingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IMonitoringSettingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IMonitoringSettingPropertiesInternal
    {
        ...
        public string AppInsightAgentVersionJava { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IApplicationInsightsAgentVersionsInternal)AppInsightsAgentVersion).Java; }

        /// <summary>Backing field for <see cref="AppInsightsAgentVersion" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IApplicationInsightsAgentVersions _appInsightsAgentVersion;

        /// <summary>Indicates the versions of application insight agent</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IApplicationInsightsAgentVersions AppInsightsAgentVersion { get => (this._appInsightsAgentVersion = this._appInsightsAgentVersion ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ApplicationInsightsAgentVersions()); set => this._appInsightsAgentVersion = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IMonitoringSettingPropertiesInternal.AppInsightAgentVersionJava { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IApplicationInsightsAgentVersionsInternal)AppInsightsAgentVersion).Java; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IApplicationInsightsAgentVersionsInternal)AppInsightsAgentVersion).Java = value; }

        /// <summary>Internal Acessors for AppInsightsAgentVersion</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IApplicationInsightsAgentVersions Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IMonitoringSettingPropertiesInternal.AppInsightsAgentVersion { get => (this._appInsightsAgentVersion = this._appInsightsAgentVersion ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ApplicationInsightsAgentVersions()); set { {_appInsightsAgentVersion = value;} } }

        /// <summary>Internal Acessors for Error</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IError Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IMonitoringSettingPropertiesInternal.Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.Error()); set { {_error = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.MonitoringSettingState? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.IMonitoringSettingPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
