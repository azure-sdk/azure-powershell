...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Friday = @"Friday";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Monday = @"Monday";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Saturday = @"Saturday";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Sunday = @"Sunday";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Thursday = @"Thursday";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Tuesday = @"Tuesday";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay Wednesday = @"Wednesday";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay e1, Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.WeekDay e2)
        {
            return !e2.Equals(e1);
        }
