...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// <summary>Update the eureka server settings.</summary>
    /// <remarks>
    /// [OpenAPI] UpdatePatch=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/eurekaServers/default"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Description(@"Update the eureka server settings.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/eurekaServers/default", ApiVersion = "2024-05-01-preview")]
    public partial class UpdateAzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource _eurekaServerResourceBody = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.EurekaServerResource();
        ...
        public string Code { get => _eurekaServerResourceBody.Code ?? null; set => _eurekaServerResourceBody.Code = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Enabled state of the eureka server. This is only used in Consumption tier.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.EurekaServerEnabledState))]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.EurekaServerEnabledState EnabledState { get => _eurekaServerResourceBody.EnabledState ?? ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.EurekaServerEnabledState)""); set => _eurekaServerResourceBody.EnabledState = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Message { get => _eurekaServerResourceBody.Message ?? null; set => _eurekaServerResourceBody.Message = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource">Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets.UpdateAzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded();
            ...
            clone._eurekaServerResourceBody = this._eurekaServerResourceBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'EurekaServersUpdatePatch' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.EurekaServersUpdatePatchViaIdentity(InputObject.Id, _eurekaServerResourceBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.EurekaServersUpdatePatch(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, _eurekaServerResourceBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_eurekaServerResourceBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzAppPlatformEurekaServerPatch_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_eurekaServerResourceBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_eurekaServerResourceBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IEurekaServerResource
