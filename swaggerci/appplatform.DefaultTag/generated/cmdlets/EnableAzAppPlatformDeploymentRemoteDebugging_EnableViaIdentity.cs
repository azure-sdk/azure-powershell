...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] EnableRemoteDebugging=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}/enableRemoteDebugging"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Description(@"Enable remote debugging.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}/enableRemoteDebugging", ApiVersion = "2024-05-01-preview")]
    public partial class EnableAzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="RemoteDebuggingPayload" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebuggingPayload _remoteDebuggingPayload;

        /// <summary>Remote debugging payload.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Remote debugging payload.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Remote debugging payload.",
        SerializedName = @"remoteDebuggingPayload",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebuggingPayload) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebuggingPayload RemoteDebuggingPayload { get => this._remoteDebuggingPayload; set => this._remoteDebuggingPayload = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging">Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of EnableAzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets.EnableAzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity Clone()
        {
            var clone = new EnableAzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity();
            ...
            clone.RemoteDebuggingPayload = this.RemoteDebuggingPayload;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public EnableAzAppPlatformDeploymentRemoteDebugging_EnableViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeploymentsEnableRemoteDebugging' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DeploymentsEnableRemoteDebuggingViaIdentity(InputObject.Id, RemoteDebuggingPayload, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DeploymentsEnableRemoteDebugging(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.AppName ?? null, InputObject.DeploymentName ?? null, RemoteDebuggingPayload, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RemoteDebuggingPayload})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RemoteDebuggingPayload })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RemoteDebuggingPayload })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240501Preview.IRemoteDebugging
