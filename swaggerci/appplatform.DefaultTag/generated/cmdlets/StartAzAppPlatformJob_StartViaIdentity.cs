...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IJobExecutionTemplate) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202401Preview.IJobExecutionTemplate Template { get => this._template; set => this._template = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.JobsStart(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.JobName ?? null, Template, onOk, onDefault, this, Pipeline);
                    }
