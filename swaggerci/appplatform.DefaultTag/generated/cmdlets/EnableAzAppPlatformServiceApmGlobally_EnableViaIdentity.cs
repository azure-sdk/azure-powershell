...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzAppPlatformServiceApmGlobally_EnableViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class EnableAzAppPlatformServiceApmGlobally_EnableViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of EnableAzAppPlatformServiceApmGlobally_EnableViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets.EnableAzAppPlatformServiceApmGlobally_EnableViaIdentity Clone()
        {
            var clone = new EnableAzAppPlatformServiceApmGlobally_EnableViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzAppPlatformServiceApmGlobally_EnableViaIdentity" /> cmdlet class.
        /// </summary>
        public EnableAzAppPlatformServiceApmGlobally_EnableViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesEnableApmGloballyViaIdentity(InputObject.Id, Apm, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesEnableApmGlobally(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, Apm, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Apm})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Apm })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Apm })
                    {
