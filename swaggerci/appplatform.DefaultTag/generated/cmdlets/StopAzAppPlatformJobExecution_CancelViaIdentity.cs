...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/jobs/{jobName}/executions/{jobExecutionName}/cancel", ApiVersion = "2024-05-01-preview")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.JobExecutionCancelViaIdentity(InputObject.Id, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobExecutionCancel(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.JobName ?? null, InputObject.JobExecutionName ?? null, onDefault, this, Pipeline);
                    }
