...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20240701Preview.ICustomizedAcceleratorProperties Property { get => this._property; set => this._property = value; }
        ...
        /// <returns>
        /// a duplicate instance of TestAzAppPlatformCustomizedAccelerator_ValidateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets.TestAzAppPlatformCustomizedAccelerator_ValidateViaIdentity Clone()
        {
            var clone = new TestAzAppPlatformCustomizedAccelerator_ValidateViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CustomizedAcceleratorsValidateViaIdentity(InputObject.Id, Property, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CustomizedAcceleratorsValidate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.ApplicationAcceleratorName ?? null, InputObject.CustomizedAcceleratorName ?? null, Property, onOk, onDefault, this, Pipeline);
                    }
