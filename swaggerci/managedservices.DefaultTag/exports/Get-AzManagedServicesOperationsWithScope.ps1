...
.Link
https://learn.microsoft.com/powershell/module/az.managedservices/get-azmanagedservicesoperationswithscope
#>
function Get-AzManagedServicesOperationsWithScope {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IOperation])]
