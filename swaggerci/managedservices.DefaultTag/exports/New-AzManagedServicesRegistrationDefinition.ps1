...
ELIGIBLEAUTHORIZATION <IEligibleAuthorization[]>: The collection of eligible authorization objects describing the just-in-time access Azure Active Directory principals in the managedBy tenant will receive on the delegated resource in the managed tenant.
  ...
  [PrincipalIdDisplayName <String>]: The display name of the Azure Active Directory principal.
.Link
https://learn.microsoft.com/powershell/module/az.managedservices/new-azmanagedservicesregistrationdefinition
#>
function New-AzManagedServicesRegistrationDefinition {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IRegistrationDefinition])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IAuthorization[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleAuthorization[]]
