...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001
{
    ...
    public partial class EligibleAuthorization :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleAuthorizationInternal
    {

        /// <summary>Backing field for <see cref="JustInTimeAccessPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicy _justInTimeAccessPolicy;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicy JustInTimeAccessPolicy { get => (this._justInTimeAccessPolicy = this._justInTimeAccessPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.JustInTimeAccessPolicy()); set => this._justInTimeAccessPolicy = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleApprover[] JustInTimeAccessPolicyManagedByTenantApprover { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicyInternal)JustInTimeAccessPolicy).ManagedByTenantApprover; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicyInternal)JustInTimeAccessPolicy).ManagedByTenantApprover = value ?? null /* arrayOf */; }

        /// <summary>
        /// The maximum access duration in ISO 8601 format for just-in-time access requests.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.PropertyOrigin.Inlined)]
        public global::System.TimeSpan? JustInTimeAccessPolicyMaximumActivationDuration { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicyInternal)JustInTimeAccessPolicy).MaximumActivationDuration; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicyInternal)JustInTimeAccessPolicy).MaximumActivationDuration = value ?? default(global::System.TimeSpan); }

        /// <summary>
        /// The multi-factor authorization provider to be used for just-in-time access requests.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Support.MultiFactorAuthProvider? JustInTimeAccessPolicyMultiFactorAuthProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicyInternal)JustInTimeAccessPolicy).MultiFactorAuthProvider; set => ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicyInternal)JustInTimeAccessPolicy).MultiFactorAuthProvider = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Support.MultiFactorAuthProvider)""); }

        /// <summary>Internal Acessors for JustInTimeAccessPolicy</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicy Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleAuthorizationInternal.JustInTimeAccessPolicy { get => (this._justInTimeAccessPolicy = this._justInTimeAccessPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.JustInTimeAccessPolicy()); set { {_justInTimeAccessPolicy = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleApprover) })]
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleApprover[] JustInTimeAccessPolicyManagedByTenantApprover { get; set; }
        /// <summary>
        /// The maximum access duration in ISO 8601 format for just-in-time access requests.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Runtime.Info(
    ...
    {
        /// <summary>The just-in-time access policy setting.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IJustInTimeAccessPolicy JustInTimeAccessPolicy { get; set; }
        /// <summary>The list of managedByTenant approvers for the eligible authorization.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServices.Models.Api20221001.IEligibleApprover[] JustInTimeAccessPolicyManagedByTenantApprover { get; set; }
        /// <summary>
        /// The maximum access duration in ISO 8601 format for just-in-time access requests.
