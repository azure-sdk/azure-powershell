...
namespace Microsoft.Azure.PowerShell.Cmdlets.PremonitionInsights.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PremonitionInsights.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PremonitionInsights.Support";
