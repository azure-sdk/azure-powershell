...
New-AzQuantumWorkspace -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-ApiKeyEnabled] [-IdentityType <ResourceIdentityType>] [-Provider <IProvider[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Quantum.Models.Api20231113Preview.IProvider[]
Parameter Sets: (All)
Aliases:
