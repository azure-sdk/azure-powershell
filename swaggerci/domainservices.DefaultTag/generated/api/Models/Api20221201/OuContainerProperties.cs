...
namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201
{
    ...
    public partial class OuContainerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal
    {

        /// <summary>Backing field for <see cref="Account" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IContainerAccount[] _account;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IContainerAccount[] Account { get => this._account; set => this._account = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.ContainerId { get => this._containerId; set { {_containerId = value;} } }

        /// <summary>Internal Acessors for DeploymentId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.DeploymentId { get => this._deploymentId; set { {_deploymentId = value;} } }

        /// <summary>Internal Acessors for DistinguishedName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.DistinguishedName { get => this._distinguishedName; set { {_distinguishedName = value;} } }

        /// <summary>Internal Acessors for DomainName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.DomainName { get => this._domainName; set { {_domainName = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for ServiceStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.ServiceStatus { get => this._serviceStatus; set { {_serviceStatus = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IOuContainerPropertiesInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IContainerAccount) })]
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IContainerAccount[] Account { get; set; }
        /// <summary>The OuContainer name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Info(
        Required = false,
        ReadOnly = true,
