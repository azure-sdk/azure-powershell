...
.Link
https://learn.microsoft.com/powershell/module/az.chaos/get-azchaosprivateaccessprivatelinkresource
#>
function Get-AzChaosPrivateAccessPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api50.IPrivateLinkResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Chaos.private\Get-AzChaosPrivateAccessPrivateLinkResource_Get';
            GetViaIdentity = 'Az.Chaos.private\Get-AzChaosPrivateAccessPrivateLinkResource_GetViaIdentity';
        }
        if (('Get') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.PipelineMock' -eq $_.Target.GetType().FullName) }
            if ($testPlayback) {
