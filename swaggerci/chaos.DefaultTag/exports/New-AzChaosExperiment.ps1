...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IExperiment])]
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentStep[]]
    # List of steps.
