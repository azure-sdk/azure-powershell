...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.IExperiment])]
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.IStep[]]
    # List of steps.
