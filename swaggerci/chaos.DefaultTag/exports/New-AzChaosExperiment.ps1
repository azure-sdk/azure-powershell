...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230415Preview.IExperiment])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230415Preview.IUserAssignedIdentities]))]
