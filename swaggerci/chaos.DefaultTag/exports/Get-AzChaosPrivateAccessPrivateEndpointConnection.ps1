...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IPrivateEndpointConnection
.Link
https://learn.microsoft.com/powershell/module/az.chaos/get-azchaosprivateaccessprivateendpointconnection
#>
function Get-AzChaosPrivateAccessPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IPrivateEndpointConnection])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Chaos.private\Get-AzChaosPrivateAccessPrivateEndpointConnection_List';
        }
