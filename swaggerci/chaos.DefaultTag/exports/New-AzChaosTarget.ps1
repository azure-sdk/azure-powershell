...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230415Preview.ITarget])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(Required, PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230415Preview.ITargetProperties]))]
