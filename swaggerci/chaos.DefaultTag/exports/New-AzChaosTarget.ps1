...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.ITarget])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(Required, PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.ITargetProperties]))]
