...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.ITarget])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(Required, PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.ITargetProperties]))]
