...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20240322Preview.ICapabilityType
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20240322Preview.ICapabilityType])]
