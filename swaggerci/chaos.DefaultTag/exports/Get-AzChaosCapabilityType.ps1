...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.ICapabilityType
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.ICapabilityType])]
