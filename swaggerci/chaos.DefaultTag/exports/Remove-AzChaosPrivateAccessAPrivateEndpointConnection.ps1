...
.Link
https://learn.microsoft.com/powershell/module/az.chaos/remove-azchaosprivateaccessaprivateendpointconnection
#>
function Remove-AzChaosPrivateAccessAPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Chaos.private\Remove-AzChaosPrivateAccessAPrivateEndpointConnection_Delete';
            DeleteViaIdentity = 'Az.Chaos.private\Remove-AzChaosPrivateAccessAPrivateEndpointConnection_DeleteViaIdentity';
        }
