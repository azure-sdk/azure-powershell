...
.Link
https://learn.microsoft.com/powershell/module/az.chaos/new-azchaosprivateaccess
#>
function New-AzChaosPrivateAccess {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IPrivateAccess])]
[CmdletBinding(DefaultParameterSetName='CreateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
    [Alias('PrivateAccessName')]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PublicNetworkAccessOption])]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PublicNetworkAccessOption]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Chaos.private\New-AzChaosPrivateAccess_CreateExpanded';
        }
