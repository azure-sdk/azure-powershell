...
.Link
https://learn.microsoft.com/powershell/module/az.chaos/remove-azchaosprivateaccess
#>
function Remove-AzChaosPrivateAccess {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Chaos.private\Remove-AzChaosPrivateAccess_Delete';
            DeleteViaIdentity = 'Az.Chaos.private\Remove-AzChaosPrivateAccess_DeleteViaIdentity';
        }
