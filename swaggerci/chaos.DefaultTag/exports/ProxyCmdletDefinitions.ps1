...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230415Preview.IExperimentStatus])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Path')]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20230415Preview.ITargetType])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
