...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20240322Preview.ITargetType])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
PRIVATEACCESSPATCH <IPrivateAccessPatch>: Describes a private access update.
  [Tag <ITags>]: The tags of the private access resource.
...
begin {
    try {
        ...
        $mapping = @{
            Patch = 'Az.Chaos.private\Update-AzChaosPrivateAccess_Patch';
            PatchExpanded = 'Az.Chaos.private\Update-AzChaosPrivateAccess_PatchExpanded';
            PatchViaIdentity = 'Az.Chaos.private\Update-AzChaosPrivateAccess_PatchViaIdentity';
            PatchViaIdentityExpanded = 'Az.Chaos.private\Update-AzChaosPrivateAccess_PatchViaIdentityExpanded';
        }
