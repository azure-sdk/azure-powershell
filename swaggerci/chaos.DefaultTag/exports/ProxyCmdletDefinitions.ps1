...
INPUTOBJECT <IChaosIdentity>: Identity Parameter
  ...
  [TargetTypeName <String>]: String that represents a Target Type resource name.
.Link
https://learn.microsoft.com/powershell/module/az.chaos/get-azchaosprivateaccessaprivateendpointconnection
#>
function Get-AzChaosPrivateAccessAPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Chaos.private\Get-AzChaosPrivateAccessAPrivateEndpointConnection_Get';
            GetViaIdentity = 'Az.Chaos.private\Get-AzChaosPrivateAccessAPrivateEndpointConnection_GetViaIdentity';
        }
        if (('Get') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IChaosIdentity>: Identity Parameter
  ...
  [TargetTypeName <String>]: String that represents a Target Type resource name.
.Link
https://learn.microsoft.com/powershell/module/az.chaos/get-azchaosprivateaccess
#>
function Get-AzChaosPrivateAccess {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Chaos.private\Get-AzChaosPrivateAccess_Get';
            GetViaIdentity = 'Az.Chaos.private\Get-AzChaosPrivateAccess_GetViaIdentity';
            List = 'Az.Chaos.private\Get-AzChaosPrivateAccess_List';
            List1 = 'Az.Chaos.private\Get-AzChaosPrivateAccess_List1';
        }
        if (('Get', 'List', 'List1') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.ITargetType])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
INPUTOBJECT <IChaosIdentity>: Identity Parameter
  ...
  [TargetTypeName <String>]: String that represents a Target Type resource name.
.Link
https://learn.microsoft.com/powershell/module/az.chaos/update-azchaosprivateaccess
#>
function Update-AzChaosPrivateAccess {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IPrivateAccess])]
[CmdletBinding(DefaultParameterSetName='UpdateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IPrivateAccessPatchTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Chaos.private\Update-AzChaosPrivateAccess_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.Chaos.private\Update-AzChaosPrivateAccess_UpdateViaIdentityExpanded';
        }
        if (('UpdateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
