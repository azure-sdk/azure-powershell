...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support
{
        ...
        System.IEquatable<PrivateEndpointServiceConnectionStatus>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus Approved = @"Approved";

        /// <summary>Pending status.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus Pending = @"Pending";

        /// <summary>Rejected status.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.PrivateEndpointServiceConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
