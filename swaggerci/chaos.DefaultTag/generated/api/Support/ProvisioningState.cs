...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Initial creation in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState Creating = @"Creating";

        /// <summary>Deletion in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Update in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Chaos.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
