...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview
{
    ...
    public partial class Selector
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.ISelector.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.ISelector interface is polymorphic, and the
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.ISelector.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.ISelector FromJson(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("type") )
            {
                case "List":
                {
                    return new ListSelector(json);
                }
                case "Query":
                {
                    return new QuerySelector(json);
                }
            }
            return new Selector(json, new global::System.Collections.Generic.HashSet<string>(){ @"type",@"id",@"filter" });
        }
        ...
        internal Selector(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            {_filter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject>("filter"), out var __jsonFilter) ? Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.Filter.FromJson(__jsonFilter) : Filter;}
