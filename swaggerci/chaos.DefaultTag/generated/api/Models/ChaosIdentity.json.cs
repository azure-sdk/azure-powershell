...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models
{
    ...
    public partial class ChaosIdentity
    {
        ...
        internal ChaosIdentity(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json)
        {
            ...
            {_executionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonString>("executionId"), out var __jsonExecutionId) ? (string)__jsonExecutionId : (string)ExecutionId;}
            ...
            {_asyncOperationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonString>("asyncOperationId"), out var __jsonAsyncOperationId) ? (string)__jsonAsyncOperationId : (string)AsyncOperationId;}
            {_privateAccessName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonString>("privateAccessName"), out var __jsonPrivateAccessName) ? (string)__jsonPrivateAccessName : (string)PrivateAccessName;}
            {_privateEndpointConnectionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonString>("privateEndpointConnectionName"), out var __jsonPrivateEndpointConnectionName) ? (string)__jsonPrivateEndpointConnectionName : (string)PrivateEndpointConnectionName;}
