...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401
{
    ...
    public partial class DelayAction :
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IDelayAction,
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IDelayActionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentAction"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentAction __chaosExperimentAction = new Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.ChaosExperimentAction();
        ...
        public string Name { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentActionInternal)__chaosExperimentAction).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentActionInternal)__chaosExperimentAction).Name = value ; }

        /// <summary>Enum that discriminates between action models.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentActionInternal)__chaosExperimentAction).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentActionInternal)__chaosExperimentAction).Type = value ; }
    ...
    public partial interface IDelayAction :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentAction
    {
        /// <summary>ISO8601 formatted string that represents a duration.</summary>
    ...
    internal partial interface IDelayActionInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api202401.IChaosExperimentActionInternal
    {
        /// <summary>ISO8601 formatted string that represents a duration.</summary>
        global::System.TimeSpan Duration { get; set; }
