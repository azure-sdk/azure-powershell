...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview
{
    ...
    public partial class ChaosTargetSimpleFilter
    {
        ...
        internal ChaosTargetSimpleFilter(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json)
        {
            ...
            __chaosTargetFilter = new Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.ChaosTargetFilter(json);
            {_parameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject>("parameters"), out var __jsonParameters) ? Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.ChaosTargetSimpleFilterParameters.FromJson(__jsonParameters) : Parameter;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IChaosTargetSimpleFilter.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IChaosTargetSimpleFilter.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241101Preview.IChaosTargetSimpleFilter FromJson(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode node)
        {
