...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models
{
    ...
    public partial class PrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IPrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IPrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IPrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json ? new PrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject into a new instance of <see cref="PrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="PrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders" /> into
        /// a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PrivateAccessesDeleteAPrivateEndpointConnectionAcceptedResponseHeaders" /> as a <see
