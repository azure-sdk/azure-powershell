...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101
{
    ...
    public partial class ActionStatus
    {
        ...
        internal ActionStatus(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json)
        {
            ...
            {_actionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonString>("actionName"), out var __jsonActionName) ? (string)__jsonActionName : (string)ActionName;}
            {_actionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonString>("actionId"), out var __jsonActionId) ? (string)__jsonActionId : (string)ActionId;}
            ...
            {_target = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonArray>("targets"), out var __jsonTargets) ? If( __jsonTargets as Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IExperimentExecutionActionTargetDetailsProperties[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IExperimentExecutionActionTargetDetailsProperties) (Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.ExperimentExecutionActionTargetDetailsProperties.FromJson(__u) )) ))() : null : Target;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IActionStatus.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IActionStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IActionStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode node)
        {
