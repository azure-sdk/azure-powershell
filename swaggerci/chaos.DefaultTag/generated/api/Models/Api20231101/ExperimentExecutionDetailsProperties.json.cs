...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101
{
    ...
    public partial class ExperimentExecutionDetailsProperties
    {
        ...
        internal ExperimentExecutionDetailsProperties(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject json)
        {
            ...
            __experimentExecutionProperties = new Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.ExperimentExecutionProperties(json);
            {_runInformation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonObject>("runInformation"), out var __jsonRunInformation) ? Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.ExperimentExecutionDetailsPropertiesRunInformation.FromJson(__jsonRunInformation) : RunInformation;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IExperimentExecutionDetailsProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IExperimentExecutionDetailsProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20231101.IExperimentExecutionDetailsProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Json.JsonNode node)
        {
