...
New-AzChaosExperiment -Name <String> -ResourceGroupName <String> -Location <String> -Selector <ISelector[]>
 -Step <IStep[]> [-SubscriptionId <String>] [-CustomerDataStorageAccountResourceId <String>]
 [-CustomerDataStorageBlobContainerName <String>] [-IdentityType <ResourceIdentityType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20240322Preview.ISelector[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20240322Preview.IStep[]
Parameter Sets: (All)
Aliases:
