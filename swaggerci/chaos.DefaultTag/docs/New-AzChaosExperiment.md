...
New-AzChaosExperiment -Name <String> -ResourceGroupName <String> -Location <String> -Selector <ISelector[]>
 -Step <IStep[]> [-SubscriptionId <String>] [-IdentityType <ResourceIdentityType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.ISelector[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.IStep[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20241201Preview.IExperiment
