...
### Patch
```
Update-AzChaosPrivateAccess -Name <String> -ResourceGroupName <String>
 -PrivateAccessPatch <IPrivateAccessPatch> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PatchViaIdentity
```
Update-AzChaosPrivateAccess -InputObject <IChaosIdentity> -PrivateAccessPatch <IPrivateAccessPatch>
...
To construct, see NOTES section for PRIVATEACCESSPATCH properties and create a hash table.
