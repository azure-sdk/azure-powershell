...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/invoke-azapicenterheadapi
schema: 2.0.0
---

# Invoke-AzApiCenterHeadApi
...
### Head (Default)
```
Invoke-AzApiCenterHeadApi -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterHeadApi -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
