...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/remove-azapicentertestapiversion
schema: 2.0.0
---

# Remove-AzApiCenterTestApiVersion
...
### Delete (Default)
```
Remove-AzApiCenterTestApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterTestApiVersion -InputObject <IApiCenterTestIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
