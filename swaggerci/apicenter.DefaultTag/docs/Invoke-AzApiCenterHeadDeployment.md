...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/invoke-azapicenterheaddeployment
schema: 2.0.0
---

# Invoke-AzApiCenterHeadDeployment
...
### Head (Default)
```
Invoke-AzApiCenterHeadDeployment -ApiName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterHeadDeployment -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
