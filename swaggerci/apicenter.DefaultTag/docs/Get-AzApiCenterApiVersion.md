...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/get-azapicenterapiversion
schema: 2.0.0
---

# Get-AzApiCenterApiVersion
...
### List (Default)
```
Get-AzApiCenterApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### GetViaIdentity
```
Get-AzApiCenterApiVersion -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
