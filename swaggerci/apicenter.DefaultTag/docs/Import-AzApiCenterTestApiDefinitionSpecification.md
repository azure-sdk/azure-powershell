...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/import-azapicentertestapidefinitionspecification
schema: 2.0.0
---

# Import-AzApiCenterTestApiDefinitionSpecification
...
```
Import-AzApiCenterTestApiDefinitionSpecification -ApiName <String> -DefinitionName <String>
...
### ImportViaIdentity
```
Import-AzApiCenterTestApiDefinitionSpecification -InputObject <IApiCenterTestIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models.Api20240315Preview.IApiSpecImportRequest
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Support.ApiSpecImportSourceFormat
