...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/remove-azapicenterapiversion
schema: 2.0.0
---

# Remove-AzApiCenterApiVersion
...
### Delete (Default)
```
Remove-AzApiCenterApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterApiVersion -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
