...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/remove-azapicenterfortestingapidefinition
schema: 2.0.0
---

# Remove-AzApiCenterForTestingApiDefinition
...
### Delete (Default)
```
Remove-AzApiCenterForTestingApiDefinition -ApiName <String> -DefinitionName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterForTestingApiDefinition -InputObject <IApiCenterForTestingIdentity>
