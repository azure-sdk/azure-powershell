...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/invoke-azapicenterfortestingheadapiversion
schema: 2.0.0
---

# Invoke-AzApiCenterForTestingHeadApiVersion
...
### Head (Default)
```
Invoke-AzApiCenterForTestingHeadApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterForTestingHeadApiVersion -InputObject <IApiCenterForTestingIdentity>
