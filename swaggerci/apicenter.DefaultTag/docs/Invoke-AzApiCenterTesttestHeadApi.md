...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/invoke-azapicentertesttestheadapi
schema: 2.0.0
---

# Invoke-AzApiCenterTesttestHeadApi
...
### Head (Default)
```
Invoke-AzApiCenterTesttestHeadApi -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTesttestHeadApi -InputObject <IApiCenterTesttestIdentity> [-DefaultProfile <PSObject>]
