...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/invoke-azapicentertestheadenvironment
schema: 2.0.0
---

# Invoke-AzApiCenterTestHeadEnvironment
...
### Head (Default)
```
Invoke-AzApiCenterTestHeadEnvironment -EnvironmentName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTestHeadEnvironment -InputObject <IApiCenterTestIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```
