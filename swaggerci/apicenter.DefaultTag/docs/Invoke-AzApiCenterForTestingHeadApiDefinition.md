...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/invoke-azapicenterfortestingheadapidefinition
schema: 2.0.0
---

# Invoke-AzApiCenterForTestingHeadApiDefinition
...
### Head (Default)
```
Invoke-AzApiCenterForTestingHeadApiDefinition -ApiName <String> -DefinitionName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterForTestingHeadApiDefinition -InputObject <IApiCenterForTestingIdentity>
