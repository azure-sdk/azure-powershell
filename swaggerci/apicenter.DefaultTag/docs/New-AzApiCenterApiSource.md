...
New-AzApiCenterApiSource -Name <String> -ResourceGroupName <String> -ServiceName <String>
 -WorkspaceName <String> [-SubscriptionId <String>] [-ApimSourceMsiResourceId <String>]
 [-ApimSourceResourceId <String>] [-ApimSourceTargetEnvironmentId <String>]
 [-ApimSourceTargetLifecycleStage <LifecycleStage>] [-ShouldImportSpec <ShouldImportSpec>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenter.Support.ShouldImportSpec
Parameter Sets: (All)
Aliases:
