...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/invoke-azapicentertestheadapi
schema: 2.0.0
---

# Invoke-AzApiCenterTestHeadApi
...
### Head (Default)
```
Invoke-AzApiCenterTestHeadApi -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTestHeadApi -InputObject <IApiCenterTestIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
