...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/get-azapicentertesttestapiversion
schema: 2.0.0
---

# Get-AzApiCenterTesttestApiVersion
...
### List (Default)
```
Get-AzApiCenterTesttestApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### GetViaIdentity
```
Get-AzApiCenterTesttestApiVersion -InputObject <IApiCenterTesttestIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
