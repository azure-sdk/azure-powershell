...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/invoke-azapicentertesttestheadenvironment
schema: 2.0.0
---

# Invoke-AzApiCenterTesttestHeadEnvironment
...
### Head (Default)
```
Invoke-AzApiCenterTesttestHeadEnvironment -EnvironmentName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTesttestHeadEnvironment -InputObject <IApiCenterTesttestIdentity>
