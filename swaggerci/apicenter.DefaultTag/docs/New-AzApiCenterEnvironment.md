...
New-AzApiCenterEnvironment -Name <String> -ResourceGroupName <String> -ServiceName <String>
 ...
 [-Description <String>] [-Kind <EnvironmentKind>] [-OnboardingDeveloperPortalUri <String[]>]
 [-OnboardingInstruction <String>] [-ServerManagementPortalUri <String[]>]
 [-ServerType <EnvironmentServerType>] [-Title <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
