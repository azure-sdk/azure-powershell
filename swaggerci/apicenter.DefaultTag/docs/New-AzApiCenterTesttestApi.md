...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/new-azapicentertesttestapi
schema: 2.0.0
---

# New-AzApiCenterTesttestApi
...
```
New-AzApiCenterTesttestApi -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Models.Api20240315Preview.IContact[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Models.Api20240315Preview.IExternalDocumentation[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.ApiKind
Parameter Sets: (All)
Aliases:
