...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/invoke-azapicenterheadapiversion
schema: 2.0.0
---

# Invoke-AzApiCenterHeadApiVersion
...
### Head (Default)
```
Invoke-AzApiCenterHeadApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterHeadApiVersion -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
