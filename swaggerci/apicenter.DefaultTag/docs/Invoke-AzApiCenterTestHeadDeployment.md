...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/invoke-azapicentertestheaddeployment
schema: 2.0.0
---

# Invoke-AzApiCenterTestHeadDeployment
...
### Head (Default)
```
Invoke-AzApiCenterTestHeadDeployment -ApiName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTestHeadDeployment -InputObject <IApiCenterTestIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```
