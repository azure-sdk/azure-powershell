...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/invoke-azapicenterfortestingheadenvironment
schema: 2.0.0
---

# Invoke-AzApiCenterForTestingHeadEnvironment
...
### Head (Default)
```
Invoke-AzApiCenterForTestingHeadEnvironment -EnvironmentName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterForTestingHeadEnvironment -InputObject <IApiCenterForTestingIdentity>
