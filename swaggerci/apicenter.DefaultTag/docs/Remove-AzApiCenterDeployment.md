...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/remove-azapicenterdeployment
schema: 2.0.0
---

# Remove-AzApiCenterDeployment
...
### Delete (Default)
```
Remove-AzApiCenterDeployment -ApiName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterDeployment -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
