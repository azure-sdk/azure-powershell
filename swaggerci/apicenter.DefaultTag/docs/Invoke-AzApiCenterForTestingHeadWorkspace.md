...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/invoke-azapicenterfortestingheadworkspace
schema: 2.0.0
---

# Invoke-AzApiCenterForTestingHeadWorkspace
...
### Head (Default)
```
Invoke-AzApiCenterForTestingHeadWorkspace -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterForTestingHeadWorkspace -InputObject <IApiCenterForTestingIdentity>
