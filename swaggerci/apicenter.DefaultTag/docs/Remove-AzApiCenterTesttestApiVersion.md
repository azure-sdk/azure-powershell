...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/remove-azapicentertesttestapiversion
schema: 2.0.0
---

# Remove-AzApiCenterTesttestApiVersion
...
### Delete (Default)
```
Remove-AzApiCenterTesttestApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterTesttestApiVersion -InputObject <IApiCenterTesttestIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
