...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/invoke-azapicentertesttestheadapidefinition
schema: 2.0.0
---

# Invoke-AzApiCenterTesttestHeadApiDefinition
...
### Head (Default)
```
Invoke-AzApiCenterTesttestHeadApiDefinition -ApiName <String> -DefinitionName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTesttestHeadApiDefinition -InputObject <IApiCenterTesttestIdentity>
