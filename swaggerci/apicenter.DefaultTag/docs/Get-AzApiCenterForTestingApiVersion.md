...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/get-azapicenterfortestingapiversion
schema: 2.0.0
---

# Get-AzApiCenterForTestingApiVersion
...
### List (Default)
```
Get-AzApiCenterForTestingApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### GetViaIdentity
```
Get-AzApiCenterForTestingApiVersion -InputObject <IApiCenterForTestingIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
