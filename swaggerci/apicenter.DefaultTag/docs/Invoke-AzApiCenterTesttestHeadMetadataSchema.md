...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/invoke-azapicentertesttestheadmetadataschema
schema: 2.0.0
---

# Invoke-AzApiCenterTesttestHeadMetadataSchema
...
### Head (Default)
```
Invoke-AzApiCenterTesttestHeadMetadataSchema -MetadataSchemaName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTesttestHeadMetadataSchema -InputObject <IApiCenterTesttestIdentity>
