...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/invoke-azapicenterfortestingheadmetadataschema
schema: 2.0.0
---

# Invoke-AzApiCenterForTestingHeadMetadataSchema
...
### Head (Default)
```
Invoke-AzApiCenterForTestingHeadMetadataSchema -MetadataSchemaName <String> -ResourceGroupName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterForTestingHeadMetadataSchema -InputObject <IApiCenterForTestingIdentity>
