...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/remove-azapicenterapisource
schema: 2.0.0
---

# Remove-AzApiCenterApiSource
...
### Delete (Default)
```
Remove-AzApiCenterApiSource -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterApiSource -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
