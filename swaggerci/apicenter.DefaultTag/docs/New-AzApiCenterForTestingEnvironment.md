...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/new-azapicenterfortestingenvironment
schema: 2.0.0
---

# New-AzApiCenterForTestingEnvironment
...
```
New-AzApiCenterForTestingEnvironment -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Support.EnvironmentKind
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Support.EnvironmentServerType
Parameter Sets: (All)
Aliases:
