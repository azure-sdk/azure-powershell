...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/get-azapicentertestapiversion
schema: 2.0.0
---

# Get-AzApiCenterTestApiVersion
...
### List (Default)
```
Get-AzApiCenterTestApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### GetViaIdentity
```
Get-AzApiCenterTestApiVersion -InputObject <IApiCenterTestIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
