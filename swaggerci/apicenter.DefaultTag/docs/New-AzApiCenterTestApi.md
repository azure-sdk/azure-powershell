...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/new-azapicentertestapi
schema: 2.0.0
---
...
```
New-AzApiCenterTestApi -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models.Api20240315Preview.IContact[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models.Api20240315Preview.IExternalDocumentation[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Support.ApiKind
Parameter Sets: (All)
Aliases:
