...
online version: https://learn.microsoft.com/powershell/module/az.apicentertest/remove-azapicentertestdeployment
schema: 2.0.0
---

# Remove-AzApiCenterTestDeployment
...
### Delete (Default)
```
Remove-AzApiCenterTestDeployment -ApiName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterTestDeployment -InputObject <IApiCenterTestIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
