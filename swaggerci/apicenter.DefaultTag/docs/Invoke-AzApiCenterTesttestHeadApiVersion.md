...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/invoke-azapicentertesttestheadapiversion
schema: 2.0.0
---

# Invoke-AzApiCenterTesttestHeadApiVersion
...
### Head (Default)
```
Invoke-AzApiCenterTesttestHeadApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### HeadViaIdentity
```
Invoke-AzApiCenterTesttestHeadApiVersion -InputObject <IApiCenterTesttestIdentity>
