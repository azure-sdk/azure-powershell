...
online version: https://learn.microsoft.com/powershell/module/az.apicentertesttest/remove-azapicentertesttestdeployment
schema: 2.0.0
---

# Remove-AzApiCenterTesttestDeployment
...
### Delete (Default)
```
Remove-AzApiCenterTesttestDeployment -ApiName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterTesttestDeployment -InputObject <IApiCenterTesttestIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
