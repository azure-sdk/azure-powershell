...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/remove-azapicenterfortestingdeployment
schema: 2.0.0
---

# Remove-AzApiCenterForTestingDeployment
...
### Delete (Default)
```
Remove-AzApiCenterForTestingDeployment -ApiName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterForTestingDeployment -InputObject <IApiCenterForTestingIdentity>
