...
online version: https://learn.microsoft.com/powershell/module/az.apicenter/remove-azapicenteranalyzerconfig
schema: 2.0.0
---

# Remove-AzApiCenterAnalyzerConfig
...
### Delete (Default)
```
Remove-AzApiCenterAnalyzerConfig -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterAnalyzerConfig -InputObject <IApiCenterIdentity> [-DefaultProfile <PSObject>] [-PassThru]
