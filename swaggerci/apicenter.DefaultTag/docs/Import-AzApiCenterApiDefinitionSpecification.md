...
### ImportViaIdentity
```
Import-AzApiCenterApiDefinitionSpecification -InputObject <IApiCenterIdentity> -Body <IApiSpecImportRequest>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApiCenter.Models.Api20241201Preview.IApiSpecImportRequest
