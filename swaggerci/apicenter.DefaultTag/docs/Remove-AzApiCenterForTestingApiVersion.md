...
online version: https://learn.microsoft.com/powershell/module/az.apicenterfortesting/remove-azapicenterfortestingapiversion
schema: 2.0.0
---

# Remove-AzApiCenterForTestingApiVersion
...
### Delete (Default)
```
Remove-AzApiCenterForTestingApiVersion -ApiName <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzApiCenterForTestingApiVersion -InputObject <IApiCenterForTestingIdentity>
