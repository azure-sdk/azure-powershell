...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models.Api50
{
    ...
    public partial class TrackedResourceTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="TrackedResource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models.Api50.ITrackedResource ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models.Api50.ITrackedResource).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
