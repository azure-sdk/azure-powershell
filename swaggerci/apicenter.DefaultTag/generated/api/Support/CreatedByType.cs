...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType Application = @"Application";

        public static Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType Key = @"Key";

        public static Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType ManagedIdentity = @"ManagedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType User = @"User";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType e1, Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTesttest.Support.CreatedByType e2)
        {
            return !e2.Equals(e1);
        }
