 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Runtime.Json
{
    using System;
    ...
    {
        internal override object ToValue() => Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
