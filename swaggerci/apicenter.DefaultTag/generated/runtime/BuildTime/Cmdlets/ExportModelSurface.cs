...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ApiCenterForTesting.Support";
