...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ApiCenterTest.Support";
