...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.managedserviceidentity/get-azmanagedserviceidentityfederatedidentitycredentials
#>
function Get-AzManagedServiceIdentityFederatedIdentityCredentials {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ManagedServiceIdentity.private\Get-AzManagedServiceIdentityFederatedIdentityCredentials_Get';
            GetViaIdentity = 'Az.ManagedServiceIdentity.private\Get-AzManagedServiceIdentityFederatedIdentityCredentials_GetViaIdentity';
            List = 'Az.ManagedServiceIdentity.private\Get-AzManagedServiceIdentityFederatedIdentityCredentials_List';
        }
