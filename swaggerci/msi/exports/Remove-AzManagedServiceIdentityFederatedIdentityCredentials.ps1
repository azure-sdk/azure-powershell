...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.managedserviceidentity/remove-azmanagedserviceidentityfederatedidentitycredentials
#>
function Remove-AzManagedServiceIdentityFederatedIdentityCredentials {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ManagedServiceIdentity.private\Remove-AzManagedServiceIdentityFederatedIdentityCredentials_Delete';
            DeleteViaIdentity = 'Az.ManagedServiceIdentity.private\Remove-AzManagedServiceIdentityFederatedIdentityCredentials_DeleteViaIdentity';
        }
