...
.Link
https://learn.microsoft.com/powershell/module/az.managedserviceidentity/update-azmanagedserviceidentityuserassignedidentity
#>
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20230131.IIdentityUpdateTags]))]
