...
online version: https://learn.microsoft.com/powershell/module/az.datalakestoreaccount/new-azdatalakestoreaccountfirewallrule
schema: 2.0.0
---

# New-AzDataLakeStoreAccountFirewallRule
...
```
New-AzDataLakeStoreAccountFirewallRule -AccountName <String> -Name <String> -ResourceGroupName <String>
