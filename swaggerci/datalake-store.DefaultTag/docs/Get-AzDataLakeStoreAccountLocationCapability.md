...
online version: https://learn.microsoft.com/powershell/module/az.datalakestoreaccount/get-azdatalakestoreaccountlocationcapability
schema: 2.0.0
---

# Get-AzDataLakeStoreAccountLocationCapability
...
### Get (Default)
```
Get-AzDataLakeStoreAccountLocationCapability -Location <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataLakeStoreAccountLocationCapability -InputObject <IDataLakeStoreAccountIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
