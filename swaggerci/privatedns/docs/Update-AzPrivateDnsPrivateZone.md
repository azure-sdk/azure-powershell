...
online version: https://docs.microsoft.com/en-us/powershell/module/az.privatedns/update-azprivatednsprivatezone
schema: 2.0.0
---

# Update-AzPrivateDnsPrivateZone
...
```
Update-AzPrivateDnsPrivateZone -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-IfMatch <String>] [-Etag <String>] [-Location <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzPrivateDnsPrivateZone -InputObject <IPrivateDnsIdentity> [-IfMatch <String>] [-Etag <String>]
