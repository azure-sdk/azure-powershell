        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RecordSetsUpdate(ResourceGroupName, PrivateZoneName, RecordType, RelativeRecordSetName, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, SubscriptionId, _parametersBody, onOk, onDefault, this, Pipeline);
