...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview
{
    ...
    public partial class HostnameConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IHostnameConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IHostnameConfigurationInternal
    {

        /// <summary>Backing field for <see cref="Certificate" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformation _certificate;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformation Certificate { get => (this._certificate = this._certificate ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.CertificateInformation()); set => this._certificate = value; }
        ...
        public global::System.DateTime? CertificateExpiry { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformationInternal)Certificate).Expiry; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformationInternal)Certificate).Expiry = value ?? default(global::System.DateTime); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string CertificateSubject { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformationInternal)Certificate).Subject; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformationInternal)Certificate).Subject = value ?? null; }

        /// <summary>Thumbprint of the certificate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string CertificateThumbprint { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformationInternal)Certificate).Thumbprint; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformationInternal)Certificate).Thumbprint = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformation Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IHostnameConfigurationInternal.Certificate { get => (this._certificate = this._certificate ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.CertificateInformation()); set { {_certificate = value;} } }
    ...
    {
        /// <summary>Certificate information.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ICertificateInformation Certificate { get; set; }
        /// <summary>
        /// Expiration date of the certificate. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by
        /// the ISO 8601 standard.
        /// </summary>
