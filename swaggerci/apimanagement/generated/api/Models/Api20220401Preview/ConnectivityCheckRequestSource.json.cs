...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview
{
    ...
    public partial class ConnectivityCheckRequestSource
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject into a new instance of <see cref="ConnectivityCheckRequestSource" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ConnectivityCheckRequestSource(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json)
        {
            ...
            {_instance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNumber>("instance"), out var __jsonInstance) ? (long?)__jsonInstance : Instance;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IConnectivityCheckRequestSource.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IConnectivityCheckRequestSource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IConnectivityCheckRequestSource FromJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json ? new ConnectivityCheckRequestSource(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectivityCheckRequestSource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectivityCheckRequestSource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._instance ? (Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNumber((long)this._instance) : null, "instance" ,container.Add );
