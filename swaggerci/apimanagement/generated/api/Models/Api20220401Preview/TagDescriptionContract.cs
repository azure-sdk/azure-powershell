...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview
{
    ...
    public partial class TagDescriptionContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string DisplayName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractPropertiesInternal)Property).DisplayName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractPropertiesInternal)Property).DisplayName = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.TagDescriptionContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractProperties _property;

        /// <summary>TagDescription entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.TagDescriptionContractProperties()); set => this._property = value; }

        /// <summary>Identifier of the tag in the form of /tags/{tagId}</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string TagId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractPropertiesInternal)Property).TagId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractPropertiesInternal)Property).TagId = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ExternalDocsUrl { get; set; }
        /// <summary>TagDescription entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.ITagDescriptionContractProperties Property { get; set; }
        /// <summary>Identifier of the tag in the form of /tags/{tagId}</summary>
        string TagId { get; set; }
