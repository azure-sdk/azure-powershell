...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview
{
    ...
    public partial class IssueContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IssueContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractProperties _property;

        /// <summary>Properties of the Issue.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IssueContractProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Title { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractPropertiesInternal)Property).Title; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractPropertiesInternal)Property).Title = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string UserId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractPropertiesInternal)Property).UserId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractPropertiesInternal)Property).UserId = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Properties of the Issue.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IIssueContractProperties Property { get; set; }
        /// <summary>Status of the issue.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.State? State { get; set; }
        /// <summary>The issue title.</summary>
        string Title { get; set; }
