...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview
{
    ...
    public partial class GlobalSchemaContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractPropertiesInternal)Property).Description = value ?? null; }

        /// <summary>Global Schema document object for json-based schema formats(e.g. json schema).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IAny Document { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractPropertiesInternal)Property).Document; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractPropertiesInternal)Property).Document = value ?? null /* model class */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.GlobalSchemaContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractProperties _property;

        /// <summary>Properties of the Global Schema.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.GlobalSchemaContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Properties of the Global Schema.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220401Preview.IGlobalSchemaContractProperties Property { get; set; }
        /// <summary>Schema Type. Immutable.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.SchemaType? SchemaType { get; set; }
        /// <summary>Json-encoded string for non json-based schema.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IAny Value { get; set; }
