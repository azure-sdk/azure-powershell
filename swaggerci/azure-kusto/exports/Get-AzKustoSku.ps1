...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.kusto/get-azkustosku
#>
function Get-AzKustoSku {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.ISkuDescription])]
