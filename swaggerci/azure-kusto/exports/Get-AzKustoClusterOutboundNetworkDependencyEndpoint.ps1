...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202207.IOutboundNetworkDependenciesEndpoint
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202207.IOutboundNetworkDependenciesEndpoint])]
