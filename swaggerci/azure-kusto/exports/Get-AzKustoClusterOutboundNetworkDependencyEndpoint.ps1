...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.IOutboundNetworkDependenciesEndpoint
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.IOutboundNetworkDependenciesEndpoint])]
