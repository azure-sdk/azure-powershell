...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.IPrivateEndpointConnection
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.IPrivateEndpointConnection])]
