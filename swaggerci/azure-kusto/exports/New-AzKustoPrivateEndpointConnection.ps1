...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202207.IPrivateEndpointConnection
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202207.IPrivateEndpointConnection])]
