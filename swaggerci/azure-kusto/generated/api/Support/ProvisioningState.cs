...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
