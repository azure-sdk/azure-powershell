...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827
{
    ...
    public partial class ReadOnlyFollowingDatabaseProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabaseProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal.AttachedDatabaseConfigurationName { get => this._attachedDatabaseConfigurationName; set { {_attachedDatabaseConfigurationName = value;} } }

        /// <summary>Internal Acessors for LeaderClusterResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal.LeaderClusterResourceId { get => this._leaderClusterResourceId; set { {_leaderClusterResourceId = value;} } }

        /// <summary>Internal Acessors for PrincipalsModificationKind</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.PrincipalsModificationKind? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal.PrincipalsModificationKind { get => this._principalsModificationKind; set { {_principalsModificationKind = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SoftDeletePeriod</summary>
        global::System.TimeSpan? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal.SoftDeletePeriod { get => this._softDeletePeriod; set { {_softDeletePeriod = value;} } }

        /// <summary>Internal Acessors for Statistics</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IDatabaseStatistics Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IReadOnlyFollowingDatabasePropertiesInternal.Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.DatabaseStatistics()); set { {_statistics = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IDatabaseStatistics _statistics;

        /// <summary>The statistics of the database.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IDatabaseStatistics Statistics { get => (this._statistics = this._statistics ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.DatabaseStatistics()); }
        ...
        public float? StatisticsSize { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IDatabaseStatisticsInternal)Statistics).Size; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IDatabaseStatisticsInternal)Statistics).Size = value ?? default(float); }
