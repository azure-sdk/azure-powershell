...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827
{
    ...
    public partial class Script :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IValidates
    {
        ...
        public bool? ContinueOnError { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ContinueOnError; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ContinueOnError = value ?? default(bool); }

        /// <summary>A unique string. If changed the script will be applied again.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public string ForceUpdateTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ForceUpdateTag; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ForceUpdateTag = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptProperties Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.ScriptProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ProvisioningState = value; }

        /// <summary>Internal Acessors for SystemData</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20.ISystemData Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptInternal.SystemData { get => (this._systemData = this._systemData ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20.SystemData()); set { {_systemData = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptProperties _property;

        /// <summary>The database script.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.ScriptProperties()); set => this._property = value; }

        /// <summary>The provisioned state of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.ProvisioningState? ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ProvisioningState; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public string Url { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ScriptUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ScriptUrl = value ?? null; }

        /// <summary>The SaS token.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public string UrlSasToken { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ScriptUrlSasToken; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptPropertiesInternal)Property).ScriptUrlSasToken = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api10.IResourceInternal
    {
        ...
        string ForceUpdateTag { get; set; }
        /// <summary>The database script.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IScriptProperties Property { get; set; }
        /// <summary>The provisioned state of the resource.</summary>
