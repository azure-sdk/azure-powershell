...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827
{
    ...
    public partial class OutboundNetworkDependenciesEndpointListResultTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OutboundNetworkDependenciesEndpointListResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IOutboundNetworkDependenciesEndpointListResult ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20210827.IOutboundNetworkDependenciesEndpointListResult).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
