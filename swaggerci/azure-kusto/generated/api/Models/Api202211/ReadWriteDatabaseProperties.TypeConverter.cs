...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211
{
    ...
    public partial class ReadWriteDatabasePropertiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ReadWriteDatabaseProperties" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.IReadWriteDatabaseProperties ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202211.IReadWriteDatabaseProperties).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
