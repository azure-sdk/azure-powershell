...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202207.IAcceptedAudiences[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202207.ITrustedExternalTenant[]
Parameter Sets: (All)
Aliases:
