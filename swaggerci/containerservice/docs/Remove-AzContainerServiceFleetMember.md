...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerservice/remove-azcontainerservicefleetmember
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleetMember -InputObject <IContainerServiceIdentity> [-IfMatch <String>]
