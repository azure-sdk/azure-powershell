...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerservice/remove-azcontainerservicefleet
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzContainerServiceFleet -InputObject <IContainerServiceIdentity> [-IfMatch <String>]
