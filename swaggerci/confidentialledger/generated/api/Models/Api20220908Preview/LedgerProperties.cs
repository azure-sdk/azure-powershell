...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview
{
    ...
    public partial class LedgerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AadBasedSecurityPrincipal" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.IAadBasedSecurityPrincipal[] _aadBasedSecurityPrincipal;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.IAadBasedSecurityPrincipal[] AadBasedSecurityPrincipal { get => this._aadBasedSecurityPrincipal; set => this._aadBasedSecurityPrincipal = value; }

        /// <summary>Backing field for <see cref="CertBasedSecurityPrincipal" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ICertBasedSecurityPrincipal[] _certBasedSecurityPrincipal;

        /// <summary>Array of all cert based Security Principals.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Origin(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ICertBasedSecurityPrincipal[] CertBasedSecurityPrincipal { get => this._certBasedSecurityPrincipal; set => this._certBasedSecurityPrincipal = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerPropertiesInternal.IdentityServiceUri { get => this._identityServiceUri; set { {_identityServiceUri = value;} } }

        /// <summary>Internal Acessors for LedgerInternalNamespace</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerPropertiesInternal.LedgerInternalNamespace { get => this._ledgerInternalNamespace; set { {_ledgerInternalNamespace = value;} } }

        /// <summary>Internal Acessors for LedgerName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerPropertiesInternal.LedgerName { get => this._ledgerName; set { {_ledgerName = value;} } }

        /// <summary>Internal Acessors for LedgerUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerPropertiesInternal.LedgerUri { get => this._ledgerUri; set { {_ledgerUri = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ILedgerPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
