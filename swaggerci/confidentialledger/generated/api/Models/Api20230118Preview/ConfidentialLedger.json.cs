...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview
{
    ...
    public partial class ConfidentialLedger
    {
        ...
        internal ConfidentialLedger(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.Resource(json);
            __resourceLocation = new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.ResourceLocation(json);
            __tags1 = new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.Tags1(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.LedgerProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.IConfidentialLedger.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.IConfidentialLedger.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.IConfidentialLedger FromJson(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Json.JsonNode node)
        {
