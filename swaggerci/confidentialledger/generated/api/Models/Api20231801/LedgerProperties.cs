...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801
{
    ...
    public partial class LedgerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ILedgerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ILedgerPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AadBasedSecurityPrincipal" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.IAadBasedSecurityPrincipal[] _aadBasedSecurityPrincipal;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.IAadBasedSecurityPrincipal[] AadBasedSecurityPrincipal { get => this._aadBasedSecurityPrincipal; set => this._aadBasedSecurityPrincipal = value; }

        /// <summary>Backing field for <see cref="CertBasedSecurityPrincipal" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ICertBasedSecurityPrincipal[] _certBasedSecurityPrincipal;

        /// <summary>Array of all cert based Security Principals.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Origin(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ICertBasedSecurityPrincipal[] CertBasedSecurityPrincipal { get => this._certBasedSecurityPrincipal; set => this._certBasedSecurityPrincipal = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ILedgerPropertiesInternal.IdentityServiceUri { get => this._identityServiceUri; set { {_identityServiceUri = value;} } }

        /// <summary>Internal Acessors for LedgerName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ILedgerPropertiesInternal.LedgerName { get => this._ledgerName; set { {_ledgerName = value;} } }

        /// <summary>Internal Acessors for LedgerUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ILedgerPropertiesInternal.LedgerUri { get => this._ledgerUri; set { {_ledgerUri = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20231801.ILedgerPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
