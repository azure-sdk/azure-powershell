...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220512.IAadBasedSecurityPrincipal[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220512.ICertBasedSecurityPrincipal[]
Parameter Sets: (All)
Aliases:
