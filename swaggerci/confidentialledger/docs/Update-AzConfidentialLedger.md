...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230120.IAadBasedSecurityPrincipal[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230120.ICertBasedSecurityPrincipal[]
Parameter Sets: (All)
Aliases:
