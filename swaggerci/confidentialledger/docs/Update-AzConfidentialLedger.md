...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.IAadBasedSecurityPrincipal[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20220908Preview.ICertBasedSecurityPrincipal[]
Parameter Sets: (All)
Aliases:
