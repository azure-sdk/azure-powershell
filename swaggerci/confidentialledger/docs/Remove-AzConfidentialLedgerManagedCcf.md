...
online version: https://docs.microsoft.com/en-us/powershell/module/az.confidentialledger/remove-azconfidentialledgermanagedccf
schema: 2.0.0
---

# Remove-AzConfidentialLedgerManagedCcf
...
### Delete (Default)
```
Remove-AzConfidentialLedgerManagedCcf -AppName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzConfidentialLedgerManagedCcf -InputObject <IConfidentialLedgerIdentity> [-DefaultProfile <PSObject>]
