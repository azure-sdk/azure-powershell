...
online version: https://docs.microsoft.com/en-us/powershell/module/az.confidentialledger/new-azconfidentialledgermanagedccf
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20230118Preview.IMemberIdentityCertificate[]
Parameter Sets: (All)
Aliases:
