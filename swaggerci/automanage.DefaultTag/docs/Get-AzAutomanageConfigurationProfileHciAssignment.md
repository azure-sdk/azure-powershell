...
online version: https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanageconfigurationprofilehciassignment
schema: 2.0.0
---

# Get-AzAutomanageConfigurationProfileHciAssignment
...
### Get (Default)
```
Get-AzAutomanageConfigurationProfileHciAssignment -ClusterName <String>
...
### GetViaIdentity
```
Get-AzAutomanageConfigurationProfileHciAssignment -InputObject <IAutomanageIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
