            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.HciReportsListByConfigurationProfileAssignments(SubscriptionId, ResourceGroupName, ClusterName, ConfigurationProfileAssignmentName, onOk, onDefault, this, Pipeline);
