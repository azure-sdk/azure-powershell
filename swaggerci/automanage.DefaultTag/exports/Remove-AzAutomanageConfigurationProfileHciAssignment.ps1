...
.Link
https://learn.microsoft.com/powershell/module/az.automanage/remove-azautomanageconfigurationprofilehciassignment
#>
function Remove-AzAutomanageConfigurationProfileHciAssignment {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Automanage.private\Remove-AzAutomanageConfigurationProfileHciAssignment_Delete';
            DeleteViaIdentity = 'Az.Automanage.private\Remove-AzAutomanageConfigurationProfileHciAssignment_DeleteViaIdentity';
        }
