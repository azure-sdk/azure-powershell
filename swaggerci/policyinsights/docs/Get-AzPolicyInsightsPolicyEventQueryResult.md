...
online version: https://docs.microsoft.com/en-us/powershell/module/az.policyinsights/get-azpolicyinsightspolicyeventqueryresult
schema: 2.0.0
---

# Get-AzPolicyInsightsPolicyEventQueryResult
...
### List1 (Default)
```
Get-AzPolicyInsightsPolicyEventQueryResult [-SubscriptionId <String[]>] [-Apply <String>] [-Filter <String>]
...
### List
```
Get-AzPolicyInsightsPolicyEventQueryResult -ManagementGroupName <String> [-Apply <String>] [-Filter <String>]
 [-From <DateTime>] [-OrderBy <String>] [-Select <String>] [-SkipToken <String>] [-To <DateTime>]
 [-Top <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### List2
```
Get-AzPolicyInsightsPolicyEventQueryResult -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### List3
```
Get-AzPolicyInsightsPolicyEventQueryResult -ResourceId <String> [-Apply <String>] [-Expand <String>]
...
### List4
```
Get-AzPolicyInsightsPolicyEventQueryResult -PolicySetDefinitionName <String> [-SubscriptionId <String[]>]
 [-Apply <String>] [-Filter <String>] [-From <DateTime>] [-OrderBy <String>] [-Select <String>]
 [-SkipToken <String>] [-To <DateTime>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### List5
```
Get-AzPolicyInsightsPolicyEventQueryResult -PolicyDefinitionName <String> [-SubscriptionId <String[]>]
 [-Apply <String>] [-Filter <String>] [-From <DateTime>] [-OrderBy <String>] [-Select <String>]
 [-SkipToken <String>] [-To <DateTime>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### List6
```
Get-AzPolicyInsightsPolicyEventQueryResult -PolicyAssignmentName <String> [-SubscriptionId <String[]>]
 [-Apply <String>] [-Filter <String>] [-From <DateTime>] [-OrderBy <String>] [-Select <String>]
 [-SkipToken <String>] [-To <DateTime>] [-Top <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### List7
```
Get-AzPolicyInsightsPolicyEventQueryResult -PolicyAssignmentName <String> -ResourceGroupName <String>
