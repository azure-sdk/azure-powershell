...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzPolicyInsightsAttestation_Create2", SupportsShouldProcess = true)]
    ...
    public partial class NewAzPolicyInsightsAttestation_Create2 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api202101.IAttestation _parameter;

        /// <summary>An attestation resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An attestation resource.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api202101.IAttestation Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>a duplicate instance of NewAzPolicyInsightsAttestation_Create2</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets.NewAzPolicyInsightsAttestation_Create2 Clone()
        {
            var clone = new NewAzPolicyInsightsAttestation_Create2();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzPolicyInsightsAttestation_Create2" /> cmdlet class.
        /// </summary>
        public NewAzPolicyInsightsAttestation_Create2()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AttestationsCreateOrUpdateAtResource(ResourceId, Name, Parameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceId=ResourceId,Name=Name,body=Parameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api202101.IErrorResponseAutoGenerated2> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceId=ResourceId, Name=Name, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceId=ResourceId, Name=Name, body=Parameter })
                    {
