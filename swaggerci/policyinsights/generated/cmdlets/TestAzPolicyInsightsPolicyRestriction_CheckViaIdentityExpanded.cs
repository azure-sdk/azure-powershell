...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CheckAtSubscriptionScope=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/checkPolicyRestrictions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzPolicyInsightsPolicyRestriction_CheckViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Checks what restrictions Azure Policy will place on a resource within a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    public partial class TestAzPolicyInsightsPolicyRestriction_CheckViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.CheckRestrictionsRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of fields and values that should be evaluated for potential restrictions.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.IPendingField[] PendingField { get => _parametersBody.PendingField ?? null /* arrayOf */; set => _parametersBody.PendingField = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The api-version of the resource content.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ResourceDetailApiVersion { get => _parametersBody.ResourceDetailApiVersion ?? null; set => _parametersBody.ResourceDetailApiVersion = value; }

        /// <summary>
        /// The resource content. This should include whatever properties are already known and can be a partial set of all resource
        /// properties.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The resource content. This should include whatever properties are already known and can be a partial set of all resource properties.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.IAny ResourceDetailResourceContent { get => _parametersBody.ResourceDetailResourceContent ?? null /* object */; set => _parametersBody.ResourceDetailResourceContent = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The scope where the resource is being created. For example, if the resource is a child resource this would be the parent resource's resource ID.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceDetailScope { get => _parametersBody.ResourceDetailScope ?? null; set => _parametersBody.ResourceDetailScope = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20191001.IErrorResponseAutoGenerated">Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20191001.IErrorResponseAutoGenerated</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20191001.IErrorResponseAutoGenerated> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsResult">Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyRestrictionsCheckAtSubscriptionScope' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicyRestrictionsCheckAtSubscriptionScopeViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicyRestrictionsCheckAtSubscriptionScope(InputObject.SubscriptionId ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzPolicyInsightsPolicyRestriction_CheckViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public TestAzPolicyInsightsPolicyRestriction_CheckViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20191001.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20191001.IErrorResponseAutoGenerated>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsResult
