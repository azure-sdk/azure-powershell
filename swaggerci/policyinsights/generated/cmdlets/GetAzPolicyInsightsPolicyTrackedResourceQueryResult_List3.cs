...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListQueryResultsForResource=>POST:"/{resourceId}/providers/Microsoft.PolicyInsights/policyTrackedResources/{policyTrackedResourcesResource}/queryResults"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyInsightsPolicyTrackedResourceQueryResult_List3", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Queries policy tracked resources under the resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    public partial class GetAzPolicyInsightsPolicyTrackedResourceQueryResult_List3 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPolicyInsightsPolicyTrackedResourceQueryResult_List3" /> cmdlet class.
        /// </summary>
        public GetAzPolicyInsightsPolicyTrackedResourceQueryResult_List3()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyTrackedResourcesListQueryResultsForResource' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicyTrackedResourcesListQueryResultsForResource(ResourceId, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicyTrackedResourcesListQueryResultsForResource_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
