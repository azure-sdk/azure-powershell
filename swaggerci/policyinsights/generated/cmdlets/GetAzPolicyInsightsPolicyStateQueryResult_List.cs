...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListQueryResultsForManagementGroup=>POST:"/providers/{managementGroupsNamespace}/managementGroups/{managementGroupName}/providers/Microsoft.PolicyInsights/policyStates/{policyStatesResource}/queryResults"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPolicyInsightsPolicyStateQueryResult_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Queries policy states for the resources under the management group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    public partial class GetAzPolicyInsightsPolicyStateQueryResult_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPolicyInsightsPolicyStateQueryResult_List" /> cmdlet class.
        /// </summary>
        public GetAzPolicyInsightsPolicyStateQueryResult_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyStatesListQueryResultsForManagementGroup' operation"))
                {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20180701Preview.IQueryFailure> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicyStatesResource=PolicyStatesResource, ManagementGroupName=ManagementGroupName, Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), OrderBy=this.InvocationInformation.BoundParameters.ContainsKey("OrderBy") ? OrderBy : null, Select=this.InvocationInformation.BoundParameters.ContainsKey("Select") ? Select : null, From=this.InvocationInformation.BoundParameters.ContainsKey("From") ? From : default(global::System.DateTime?), To=this.InvocationInformation.BoundParameters.ContainsKey("To") ? To : default(global::System.DateTime?), Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, Apply=this.InvocationInformation.BoundParameters.ContainsKey("Apply") ? Apply : null, SkipToken=this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicyStatesResource=PolicyStatesResource, ManagementGroupName=ManagementGroupName, Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), OrderBy=this.InvocationInformation.BoundParameters.ContainsKey("OrderBy") ? OrderBy : null, Select=this.InvocationInformation.BoundParameters.ContainsKey("Select") ? Select : null, From=this.InvocationInformation.BoundParameters.ContainsKey("From") ? From : default(global::System.DateTime?), To=this.InvocationInformation.BoundParameters.ContainsKey("To") ? To : default(global::System.DateTime?), Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, Apply=this.InvocationInformation.BoundParameters.ContainsKey("Apply") ? Apply : null, SkipToken=this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null })
                    {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PolicyStatesListQueryResultsForManagementGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
