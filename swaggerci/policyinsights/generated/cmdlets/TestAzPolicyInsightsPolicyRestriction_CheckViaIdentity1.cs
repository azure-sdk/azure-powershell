...
namespace Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CheckAtResourceGroupScope=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/checkPolicyRestrictions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzPolicyInsightsPolicyRestriction_CheckViaIdentity1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Description(@"Checks what restrictions Azure Policy will place on a resource within a resource group. Use this when the resource group the resource will be created in is already known.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Generated]
    public partial class TestAzPolicyInsightsPolicyRestriction_CheckViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsRequest _parameter;

        /// <summary>
        /// The check policy restrictions parameters describing the resource that is being evaluated.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The check policy restrictions parameters describing the resource that is being evaluated.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.PolicyInsights.Models.Api20200701.ICheckRestrictionsRequest Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyRestrictionsCheckAtResourceGroupScope' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PolicyRestrictionsCheckAtResourceGroupScopeViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PolicyRestrictionsCheckAtResourceGroupScope(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzPolicyInsightsPolicyRestriction_CheckViaIdentity1" /> cmdlet class.
        /// </summary>
        public TestAzPolicyInsightsPolicyRestriction_CheckViaIdentity1()
        {
