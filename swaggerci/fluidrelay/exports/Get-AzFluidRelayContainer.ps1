...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220511.IFluidRelayContainer
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.fluidrelay/get-azfluidrelaycontainer
#>
function Get-AzFluidRelayContainer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220511.IFluidRelayContainer])]
