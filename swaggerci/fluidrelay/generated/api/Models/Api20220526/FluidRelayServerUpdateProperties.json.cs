...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526
{
    ...
    public partial class FluidRelayServerUpdateProperties
    {
        ...
        internal FluidRelayServerUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.IFluidRelayServerUpdateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.IFluidRelayServerUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.IFluidRelayServerUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode node)
        {
