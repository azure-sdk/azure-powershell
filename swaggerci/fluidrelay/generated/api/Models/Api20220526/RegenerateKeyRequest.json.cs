...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526
{
    ...
    public partial class RegenerateKeyRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.IRegenerateKeyRequest.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.IRegenerateKeyRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220526.IRegenerateKeyRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json ? new RegenerateKeyRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject into a new instance of <see cref="RegenerateKeyRequest" />.
        /// </summary>
        ...
        internal RegenerateKeyRequest(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json)
        {
            ...
            {_keyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString>("keyName"), out var __jsonKeyName) ? (string)__jsonKeyName : (string)KeyName;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="RegenerateKeyRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RegenerateKeyRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._keyName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonString(this._keyName.ToString()) : null, "keyName" ,container.Add );
