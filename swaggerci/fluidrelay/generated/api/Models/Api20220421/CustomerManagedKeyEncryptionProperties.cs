...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421
{
    ...
    public partial class CustomerManagedKeyEncryptionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesInternal
    {

        /// <summary>Backing field for <see cref="KeyEncryptionKeyIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity _keyEncryptionKeyIdentity;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity KeyEncryptionKeyIdentity { get => (this._keyEncryptionKeyIdentity = this._keyEncryptionKeyIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity()); set => this._keyEncryptionKeyIdentity = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.PropertyOrigin.Inlined)]
        public string KeyEncryptionKeyIdentityUserAssignedIdentityResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).UserAssignedIdentityResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).UserAssignedIdentityResourceId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesInternal.KeyEncryptionKeyIdentity { get => (this._keyEncryptionKeyIdentity = this._keyEncryptionKeyIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity()); set { {_keyEncryptionKeyIdentity = value;} } }
...

    {
        ...
        /// All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity KeyEncryptionKeyIdentity { get; set; }
        /// <summary>Values can be SystemAssigned or UserAssigned</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Support.CmkIdentityType? KeyEncryptionKeyIdentityType { get; set; }
        /// <summary>
        /// user assigned identity to use for accessing key encryption key Url. Ex: /subscriptions/fa5fc227-a624-475e-b696-cdd604c735bc/resourceGroups/<resource
