...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421
{
    ...
    public partial class FluidRelayServerProperties
    {
        ...
        internal FluidRelayServerProperties(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject json)
        {
            ...
            {_fluidRelayEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject>("fluidRelayEndpoints"), out var __jsonFluidRelayEndpoints) ? Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.FluidRelayEndpoints.FromJson(__jsonFluidRelayEndpoints) : FluidRelayEndpoint;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Runtime.Json.JsonNode node)
        {
