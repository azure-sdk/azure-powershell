...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421
{
    ...
    public partial class FluidRelayServerUpdateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerUpdateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerUpdatePropertiesInternal
    {
        ...
        public string CustomerManagedKeyEncryptionKeyUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).CustomerManagedKeyEncryptionKeyUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).CustomerManagedKeyEncryptionKeyUrl = value ?? null; }

        /// <summary>Backing field for <see cref="Encryption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionProperties _encryption;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionProperties Encryption { get => (this._encryption = this._encryption ?? new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.EncryptionProperties()); set => this._encryption = value; }

        /// <summary>Values can be SystemAssigned or UserAssigned</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Support.CmkIdentityType? KeyEncryptionKeyIdentityType { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).KeyEncryptionKeyIdentityType; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).KeyEncryptionKeyIdentityType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Support.CmkIdentityType)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.PropertyOrigin.Inlined)]
        public string KeyEncryptionKeyIdentityUserAssignedIdentityResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).KeyEncryptionKeyIdentityUserAssignedIdentityResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).KeyEncryptionKeyIdentityUserAssignedIdentityResourceId = value ?? null; }

        /// <summary>Internal Acessors for CustomerManagedKeyEncryptionKeyIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerUpdatePropertiesInternal.CustomerManagedKeyEncryptionKeyIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).CustomerManagedKeyEncryptionKeyIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).CustomerManagedKeyEncryptionKeyIdentity = value; }

        /// <summary>Internal Acessors for Encryption</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionProperties Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerUpdatePropertiesInternal.Encryption { get => (this._encryption = this._encryption ?? new Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.EncryptionProperties()); set { {_encryption = value;} } }

        /// <summary>Internal Acessors for EncryptionCustomerManagedKeyEncryption</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionProperties Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IFluidRelayServerUpdatePropertiesInternal.EncryptionCustomerManagedKeyEncryption { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).CustomerManagedKeyEncryption; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionPropertiesInternal)Encryption).CustomerManagedKeyEncryption = value; }
...

    {
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity CustomerManagedKeyEncryptionKeyIdentity { get; set; }
        /// <summary>
        /// key encryption key Url, with or without a version. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78
        /// or https://contosovault.vault.azure.net/keys/contosokek. Key auto rotation is enabled by providing a key uri without version.
        /// Otherwise, customer is responsible for rotating the key. The keyEncryptionKeyIdentity(either SystemAssigned or UserAssigned)
        ...
        string CustomerManagedKeyEncryptionKeyUrl { get; set; }
        /// <summary>All encryption configuration for a resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.IEncryptionProperties Encryption { get; set; }
        /// <summary>All Customer-managed key encryption properties for the resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Models.Api20220421.ICustomerManagedKeyEncryptionProperties EncryptionCustomerManagedKeyEncryption { get; set; }
        /// <summary>Values can be SystemAssigned or UserAssigned</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Support.CmkIdentityType? KeyEncryptionKeyIdentityType { get; set; }
        /// <summary>
        /// user assigned identity to use for accessing key encryption key Url. Ex: /subscriptions/fa5fc227-a624-475e-b696-cdd604c735bc/resourceGroups/<resource
