...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluidRelay.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/getKeys"
    /// </remarks>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FluidRelayServersGetKeys(SubscriptionId, ResourceGroup, FluidRelayServerName, onOk, onDefault, this, Pipeline);
