...
namespace Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State Disabled = @"Disabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State Enabled = @"Enabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State NotConfigured = @"NotConfigured";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.PowerPlatform.Support.State e2)
        {
            return !e2.Equals(e1);
        }
