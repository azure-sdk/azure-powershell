...
online version: https://docs.microsoft.com/en-us/powershell/module/az.powerplatform/update-azpowerplatformenterprisepolicy
schema: 2.0.0
---
...
Update-AzPowerPlatformEnterprisePolicy -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-EncryptionState <State>] [-IdentityType <ResourceIdentityType>] [-KeyName <String>] [-KeyVaultId <String>]
 [-KeyVersion <String>] [-Kind <EnterprisePolicyKind>] [-Location <String>] [-LockboxState <State>]
 [-Tag <Hashtable>] [-VirtualNetworkNextLink <String>] [-VirtualNetworkValue <IVirtualNetworkProperties[]>]
...
Update-AzPowerPlatformEnterprisePolicy -InputObject <IPowerPlatformIdentity> [-EncryptionState <State>]
 ...
 [-Kind <EnterprisePolicyKind>] [-Location <String>] [-LockboxState <State>] [-Tag <Hashtable>]
 [-VirtualNetworkNextLink <String>] [-VirtualNetworkValue <IVirtualNetworkProperties[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
