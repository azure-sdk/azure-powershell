...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridprivatelinkresource
#>
function Get-AzEventGridPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IPrivateLinkResource])]
