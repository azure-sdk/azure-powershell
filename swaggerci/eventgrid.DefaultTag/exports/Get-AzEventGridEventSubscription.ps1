...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgrideventsubscription
#>
function Get-AzEventGridEventSubscription {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IEventSubscription])]
