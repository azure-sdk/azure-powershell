...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/update-azeventgridpartnerregistration
#>
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IPartnerRegistrationUpdateParametersTags]))]
