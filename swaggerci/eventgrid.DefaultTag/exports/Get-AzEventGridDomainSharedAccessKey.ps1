...
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgriddomainsharedaccesskey
#>
function Get-AzEventGridDomainSharedAccessKey {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IDomainSharedAccessKeys])]
