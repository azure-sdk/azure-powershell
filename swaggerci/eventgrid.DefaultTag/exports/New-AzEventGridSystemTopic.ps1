...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.ISystemTopic
.Link
https://learn.microsoft.com/powershell/module/az.eventgrid/new-azeventgridsystemtopic
#>
function New-AzEventGridSystemTopic {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.ISystemTopic])]
