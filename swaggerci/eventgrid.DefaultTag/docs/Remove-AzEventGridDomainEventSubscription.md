...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/remove-azeventgriddomaineventsubscription
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzEventGridDomainEventSubscription -DomainName <String> -EventSubscriptionName <String>
...
### DeleteViaIdentity
```
Remove-AzEventGridDomainEventSubscription -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>]
