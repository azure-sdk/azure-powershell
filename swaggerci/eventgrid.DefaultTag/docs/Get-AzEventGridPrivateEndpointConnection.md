...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridprivateendpointconnection
schema: 2.0.0
---
...
### List (Default)
```
Get-AzEventGridPrivateEndpointConnection -ParentName <String>
...
### Get
```
Get-AzEventGridPrivateEndpointConnection -Name <String> -ParentName <String>
 -ParentType <PrivateEndpointConnectionsParentType> -ResourceGroupName <String> [-SubscriptionId <String[]>]
