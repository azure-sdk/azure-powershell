...
### Delete (Default)
```
Remove-AzEventGridChannel -Name <String> -PartnerNamespaceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzEventGridChannel -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
