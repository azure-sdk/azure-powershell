...
online version: https://learn.microsoft.com/powershell/module/az.eventgrid/get-azeventgridprivatelinkresource
schema: 2.0.0
---
...
### List (Default)
```
Get-AzEventGridPrivateLinkResource -ParentName <String> -ParentType <PrivateEndpointConnectionsParentType>
...
### Get
```
Get-AzEventGridPrivateLinkResource -Name <String> -ParentName <String>
