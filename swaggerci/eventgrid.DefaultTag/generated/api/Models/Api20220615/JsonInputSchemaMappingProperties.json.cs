...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615
{
    ...
    public partial class JsonInputSchemaMappingProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IJsonInputSchemaMappingProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IJsonInputSchemaMappingProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.IJsonInputSchemaMappingProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonNode node)
        {
        ...
        internal JsonInputSchemaMappingProperties(Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject json)
        {
            ...
            {_id = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("id"), out var __jsonId) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.JsonField.FromJson(__jsonId) : Id;}
            {_topic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("topic"), out var __jsonTopic) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.JsonField.FromJson(__jsonTopic) : Topic;}
            {_eventTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("eventTime"), out var __jsonEventTime) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.JsonField.FromJson(__jsonEventTime) : EventTime;}
            {_eventType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("eventType"), out var __jsonEventType) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.JsonFieldWithDefault.FromJson(__jsonEventType) : EventType;}
            {_subject = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("subject"), out var __jsonSubject) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.JsonFieldWithDefault.FromJson(__jsonSubject) : Subject;}
            {_dataVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.Json.JsonObject>("dataVersion"), out var __jsonDataVersion) ? Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.Api20220615.JsonFieldWithDefault.FromJson(__jsonDataVersion) : DataVersion;}
            AfterFromJson(json);
        }
