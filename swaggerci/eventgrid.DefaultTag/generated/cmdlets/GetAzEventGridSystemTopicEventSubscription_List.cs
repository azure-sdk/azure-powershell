...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySystemTopic=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{systemTopicName}/eventSubscriptions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEventGridSystemTopicEventSubscription_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Description(@"List event subscriptions that belong to a specific system topic.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Generated]
    public partial class GetAzEventGridSystemTopicEventSubscription_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEventGridSystemTopicEventSubscription_List" /> cmdlet class.
        /// </summary>
        public GetAzEventGridSystemTopicEventSubscription_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SystemTopicEventSubscriptionsListBySystemTopic(SubscriptionId, ResourceGroupName, SystemTopicName, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SystemTopicEventSubscriptionsListBySystemTopic_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
