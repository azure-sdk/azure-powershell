...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230
{
    ...
    public partial class DelegatedSubnetUsage :
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IDelegatedSubnetUsage,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IDelegatedSubnetUsageInternal
    {

        /// <summary>Internal Acessors for SubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IDelegatedSubnetUsageInternal.SubnetName { get => this._subnetName; set { {_subnetName = value;} } }

        /// <summary>Internal Acessors for Usage</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IDelegatedSubnetUsageInternal.Usage { get => this._usage; set { {_usage = value;} } }
