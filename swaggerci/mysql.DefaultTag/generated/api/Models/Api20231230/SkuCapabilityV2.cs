...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230
{
    ...
    public partial class SkuCapabilityV2 :
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedHaMode</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal.SupportedHaMode { get => this._supportedHaMode; set { {_supportedHaMode = value;} } }

        /// <summary>Internal Acessors for SupportedIop</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal.SupportedIop { get => this._supportedIop; set { {_supportedIop = value;} } }

        /// <summary>Internal Acessors for SupportedMemoryPerVCoreMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal.SupportedMemoryPerVCoreMb { get => this._supportedMemoryPerVCoreMb; set { {_supportedMemoryPerVCoreMb = value;} } }

        /// <summary>Internal Acessors for SupportedZone</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal.SupportedZone { get => this._supportedZone; set { {_supportedZone = value;} } }

        /// <summary>Internal Acessors for VCore</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.ISkuCapabilityV2Internal.VCore { get => this._vCore; set { {_vCore = value;} } }
