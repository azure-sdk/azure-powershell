...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230
{
    ...
    public partial class StorageEditionCapability :
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapability,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.MaxBackupIntervalHour { get => this._maxBackupIntervalHour; set { {_maxBackupIntervalHour = value;} } }

        /// <summary>Internal Acessors for MaxBackupRetentionDay</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.MaxBackupRetentionDay { get => this._maxBackupRetentionDay; set { {_maxBackupRetentionDay = value;} } }

        /// <summary>Internal Acessors for MaxStorageSize</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.MaxStorageSize { get => this._maxStorageSize; set { {_maxStorageSize = value;} } }

        /// <summary>Internal Acessors for MinBackupIntervalHour</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.MinBackupIntervalHour { get => this._minBackupIntervalHour; set { {_minBackupIntervalHour = value;} } }

        /// <summary>Internal Acessors for MinBackupRetentionDay</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.MinBackupRetentionDay { get => this._minBackupRetentionDay; set { {_minBackupRetentionDay = value;} } }

        /// <summary>Internal Acessors for MinStorageSize</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.MinStorageSize { get => this._minStorageSize; set { {_minStorageSize = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IStorageEditionCapabilityInternal.Name { get => this._name; set { {_name = value;} } }
