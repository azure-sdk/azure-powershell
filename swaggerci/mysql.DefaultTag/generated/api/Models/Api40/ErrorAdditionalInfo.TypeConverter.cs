...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api40
{
    ...
    public partial class ErrorAdditionalInfoTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ErrorAdditionalInfo" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api40.IErrorAdditionalInfo ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api40.IErrorAdditionalInfo).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
