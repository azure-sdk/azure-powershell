...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview
{
    ...
    public partial class SkuCapability :
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapability,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedHaMode</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal.SupportedHaMode { get => this._supportedHaMode; set { {_supportedHaMode = value;} } }

        /// <summary>Internal Acessors for SupportedIop</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal.SupportedIop { get => this._supportedIop; set { {_supportedIop = value;} } }

        /// <summary>Internal Acessors for SupportedMemoryPerVCoreMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal.SupportedMemoryPerVCoreMb { get => this._supportedMemoryPerVCoreMb; set { {_supportedMemoryPerVCoreMb = value;} } }

        /// <summary>Internal Acessors for SupportedZone</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal.SupportedZone { get => this._supportedZone; set { {_supportedZone = value;} } }

        /// <summary>Internal Acessors for VCore</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ISkuCapabilityInternal.VCore { get => this._vCore; set { {_vCore = value;} } }
