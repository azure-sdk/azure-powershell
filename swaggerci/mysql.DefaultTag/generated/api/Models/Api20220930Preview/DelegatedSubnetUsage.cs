...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview
{
    ...
    public partial class DelegatedSubnetUsage :
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IDelegatedSubnetUsage,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IDelegatedSubnetUsageInternal
    {

        /// <summary>Internal Acessors for SubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IDelegatedSubnetUsageInternal.SubnetName { get => this._subnetName; set { {_subnetName = value;} } }

        /// <summary>Internal Acessors for Usage</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IDelegatedSubnetUsageInternal.Usage { get => this._usage; set { {_usage = value;} } }
