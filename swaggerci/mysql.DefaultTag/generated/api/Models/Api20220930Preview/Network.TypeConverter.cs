...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview
{
    ...
    public partial class NetworkTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Network" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.INetwork ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.INetwork).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
