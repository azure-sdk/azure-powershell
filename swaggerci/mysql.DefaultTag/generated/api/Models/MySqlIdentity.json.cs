...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models
{
    ...
    public partial class MySqlIdentity
    {
        ...
        internal MySqlIdentity(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject json)
        {
            ...
            {_administratorName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("administratorName"), out var __jsonAdministratorName) ? (string)__jsonAdministratorName : (string)AdministratorName;}
            ...
            {_capabilitySetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("capabilitySetName"), out var __jsonCapabilitySetName) ? (string)__jsonCapabilitySetName : (string)CapabilitySetName;}
            {_operationId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("operationId"), out var __jsonOperationId) ? (string)__jsonOperationId : (string)OperationId;}
            {_maintenanceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("maintenanceName"), out var __jsonMaintenanceName) ? (string)__jsonMaintenanceName : (string)MaintenanceName;}
