...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview
{
    ...
    public partial class ServerPropertiesForUpdate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.IServerPropertiesForUpdate.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.IServerPropertiesForUpdate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.IServerPropertiesForUpdate FromJson(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode node)
        {
        ...
        internal ServerPropertiesForUpdate(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject json)
        {
            ...
            {_storage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("storage"), out var __jsonStorage) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.Storage.FromJson(__jsonStorage) : Storage;}
            {_backup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("backup"), out var __jsonBackup) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.Backup.FromJson(__jsonBackup) : Backup;}
            {_highAvailability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("highAvailability"), out var __jsonHighAvailability) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.HighAvailability.FromJson(__jsonHighAvailability) : HighAvailability;}
            {_maintenancePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("maintenancePolicy"), out var __jsonMaintenancePolicy) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.MaintenancePolicy.FromJson(__jsonMaintenancePolicy) : MaintenancePolicy;}
            {_maintenanceWindow = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("maintenanceWindow"), out var __jsonMaintenanceWindow) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.MaintenanceWindow.FromJson(__jsonMaintenanceWindow) : MaintenanceWindow;}
            {_dataEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("dataEncryption"), out var __jsonDataEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.DataEncryption.FromJson(__jsonDataEncryption) : DataEncryption;}
            {_network = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject>("network"), out var __jsonNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20240601Preview.Network.FromJson(__jsonNetwork) : Network;}
