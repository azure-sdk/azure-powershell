...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview
{
    ...
    public partial class CapabilityProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.ICapabilityPropertiesInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.ICapabilityPropertiesInternal.SupportedGeoBackupRegion { get => this._supportedGeoBackupRegion; set { {_supportedGeoBackupRegion = value;} } }

        /// <summary>Internal Acessors for SupportedHaMode</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.ICapabilityPropertiesInternal.SupportedHaMode { get => this._supportedHaMode; set { {_supportedHaMode = value;} } }

        /// <summary>Internal Acessors for Zone</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.ICapabilityPropertiesInternal.Zone { get => this._zone; set { {_zone = value;} } }

        /// <summary>Backing field for <see cref="SupportedFlexibleServerEdition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.IServerEditionCapability[] _supportedFlexibleServerEdition;

        /// <summary>A list of supported flexible server editions.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Origin(Microsoft.Azure.PowerShell.Cmdlets.MySql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.IServerEditionCapability[] SupportedFlexibleServerEdition { get => this._supportedFlexibleServerEdition; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.IServerEditionCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.IServerEditionCapability[] SupportedFlexibleServerEdition { get;  }
        /// <summary>supported geo backup regions</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>A list of supported flexible server editions.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231201Preview.IServerEditionCapability[] SupportedFlexibleServerEdition { get; set; }
        /// <summary>supported geo backup regions</summary>
