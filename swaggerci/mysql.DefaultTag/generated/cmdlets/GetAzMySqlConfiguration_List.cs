...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByServer=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/configurations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMySqlConfiguration_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20230601Preview.IConfiguration))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/configurations", ApiVersion = "2023-06-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The keyword of the server configuration.")]
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MySql.ParameterCategory.Query)]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The page of the server configuration.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MySql.ParameterCategory.Query)]
        public int Page { get => this._page; set => this._page = value; }

        /// <summary>Backing field for <see cref="PageSize" /> property.</summary>
        private int _pageSize;

        /// <summary>The pageSize of the server configuration.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The pageSize of the server configuration.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The tags of the server configuration.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Info(
        Required = false,
        ReadOnly = false,
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ConfigurationsListByServer(SubscriptionId, ResourceGroupName, ServerName, this.InvocationInformation.BoundParameters.ContainsKey("Tag") ? Tag : null, this.InvocationInformation.BoundParameters.ContainsKey("Keyword") ? Keyword : null, this.InvocationInformation.BoundParameters.ContainsKey("Page") ? Page : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("PageSize") ? PageSize : default(int?), onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ServerName=ServerName,Tag=this.InvocationInformation.BoundParameters.ContainsKey("Tag") ? Tag : null,Keyword=this.InvocationInformation.BoundParameters.ContainsKey("Keyword") ? Keyword : null,Page=this.InvocationInformation.BoundParameters.ContainsKey("Page") ? Page : default(int?),PageSize=this.InvocationInformation.BoundParameters.ContainsKey("PageSize") ? PageSize : default(int?)})
                    {
