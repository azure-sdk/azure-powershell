...
New-AzMySqlServer -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-NetworkPrivateDnsZoneResourceId <String>] [-RestorePointInTime <DateTime>] [-SkuName <String>]
 [-SkuTier <SkuTier>] [-SourceServerResourceId <String>] [-StorageAutoGrow <EnableStatusEnum>]
 [-StorageAutoIoScaling <EnableStatusEnum>] [-StorageIop <Int32>] [-StorageSizeGb <Int32>] [-Tag <Hashtable>]
