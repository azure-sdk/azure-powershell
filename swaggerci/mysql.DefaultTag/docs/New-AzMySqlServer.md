...
New-AzMySqlServer -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-ImportSourcePropertyDataDirPath <String>] [-ImportSourcePropertySasToken <String>]
 [-ImportSourcePropertyStorageType <ImportSourceStorageType>] [-ImportSourcePropertyStorageUrl <String>]
 ...
 [-ReplicationRole <ReplicationRole>] [-RestorePointInTime <DateTime>] [-SkuName <String>]
 [-SkuTier <ServerSkuTier>] [-SourceServerResourceId <String>] [-StorageAutoGrow <EnableStatusEnum>]
