...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IConfigurationListForBatchUpdate
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20231230.IConfigurationForBatchUpdate[]
Parameter Sets: BatchExpanded, BatchViaIdentityExpanded
Aliases:
