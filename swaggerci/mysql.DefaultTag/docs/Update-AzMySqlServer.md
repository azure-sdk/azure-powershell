...
Update-AzMySqlServer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-StorageIop <Int32>] [-StorageLogOnDisk <EnableStatusEnum>] [-StorageSizeGb <Int32>] [-Tag <Hashtable>]
...
Update-AzMySqlServer -InputObject <IMySqlIdentity> [-AdministratorLoginPassword <SecureString>]
 ...
 [-StorageLogOnDisk <EnableStatusEnum>] [-StorageSizeGb <Int32>] [-Tag <Hashtable>] [-Version <ServerVersion>]
