...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.ICapabilityProperties])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.MySql.Category('Path')]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MySql.private\Get-AzMySqlLocationBasedCapability_Get';
            GetViaIdentity = 'Az.MySql.private\Get-AzMySqlLocationBasedCapability_GetViaIdentity';
        }
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.INameAvailability])]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.Api20220930Preview.IVirtualNetworkSubnetUsageResult])]
[CmdletBinding(DefaultParameterSetName='ExecuteExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Execute', Mandatory)]
    [Parameter(ParameterSetName='ExecuteExpanded', Mandatory)]
