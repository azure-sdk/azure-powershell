...
namespace Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.EndPointProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
