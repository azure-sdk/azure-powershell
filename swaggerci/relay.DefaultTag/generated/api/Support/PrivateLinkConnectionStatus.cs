...
namespace Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.RelayApi.Support.PrivateLinkConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
