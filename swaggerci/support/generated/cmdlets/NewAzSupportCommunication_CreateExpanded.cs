...
namespace Microsoft.Azure.PowerShell.Cmdlets.Support.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Support.Runtime.IEventListener
    {
        ...
        public string Body { get => CreateCommunicationParametersBody.Body ?? null; set => CreateCommunicationParametersBody.Body = value; }
        ...
        /// <summary>Backing field for <see cref="CreateCommunicationParametersBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ICommunicationDetails CreateCommunicationParametersBody { get => this._createCommunicationParametersBody; set => this._createCommunicationParametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Sender { get => CreateCommunicationParametersBody.Sender ?? null; set => CreateCommunicationParametersBody.Sender = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Subject { get => CreateCommunicationParametersBody.Subject ?? null; set => CreateCommunicationParametersBody.Subject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.ICommunicationDetails"
        /// /> from the remote call</param>
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Support.Cmdlets.NewAzSupportCommunication_CreateExpanded Clone()
        {
            ...
            clone.CreateCommunicationParametersBody = this.CreateCommunicationParametersBody;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CommunicationsCreate(SupportTicketName, Name, SubscriptionId, CreateCommunicationParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SupportTicketName=SupportTicketName,Name=Name,SubscriptionId=SubscriptionId,body=CreateCommunicationParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Support.Models.Api20200401.IExceptionResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SupportTicketName=SupportTicketName, Name=Name, SubscriptionId=SubscriptionId, body=CreateCommunicationParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SupportTicketName=SupportTicketName, Name=Name, SubscriptionId=SubscriptionId, body=CreateCommunicationParametersBody })
                    {
