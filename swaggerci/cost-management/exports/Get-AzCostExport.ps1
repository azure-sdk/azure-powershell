...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IExport])]
...
param(
    ...
    # Currently only 'runHistory' is supported and will return information for the last 10 runs of the export.
    ${Expand},
