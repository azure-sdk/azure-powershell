...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.cost/remove-azcostallocationrule
#>
function Remove-AzCostAllocationRule {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Cost.private\Remove-AzCostAllocationRule_Delete';
            DeleteViaIdentity = 'Az.Cost.private\Remove-AzCostAllocationRule_DeleteViaIdentity';
        }
