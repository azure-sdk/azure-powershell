...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IView])]
...
param(
    ...
    [Parameter(ParameterSetName='CreateViaIdentityExpanded1')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cost.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IReportConfigDefinition]
