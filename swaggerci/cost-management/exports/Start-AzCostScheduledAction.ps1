...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.cost/start-azcostscheduledaction
#>
function Start-AzCostScheduledAction {
...
param(
    ...
    [Parameter(ParameterSetName='Run1', Mandatory)]
    ...
    [Parameter(ParameterSetName='RunViaIdentity1', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Cost.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.ICostIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            Run = 'Az.Cost.private\Start-AzCostScheduledAction_Run';
            Run1 = 'Az.Cost.private\Start-AzCostScheduledAction_Run1';
            RunViaIdentity = 'Az.Cost.private\Start-AzCostScheduledAction_RunViaIdentity';
            RunViaIdentity1 = 'Az.Cost.private\Start-AzCostScheduledAction_RunViaIdentity1';
        }
