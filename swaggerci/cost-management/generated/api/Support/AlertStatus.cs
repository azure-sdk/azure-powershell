...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus Dismissed = @"Dismissed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus Overridden = @"Overridden";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus Resolved = @"Resolved";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertStatus e2)
        {
            return !e2.Equals(e1);
        }
