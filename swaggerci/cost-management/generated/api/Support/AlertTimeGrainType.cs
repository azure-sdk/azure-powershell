...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType Annually = @"Annually";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType BillingAnnual = @"BillingAnnual";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType BillingMonth = @"BillingMonth";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType BillingQuarter = @"BillingQuarter";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType Monthly = @"Monthly";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType Quarterly = @"Quarterly";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType e1, Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType e2)
        {
            return !e2.Equals(e1);
        }
