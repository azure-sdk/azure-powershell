...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501
{
    ...
    public partial class GenerateCostDetailsReportRequestDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinitionInternal
    {
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriod TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.CostDetailsTimePeriod()); set => this._timePeriod = value; }
        ...
        public string TimePeriodEnd { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriodInternal)TimePeriod).End; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriodInternal)TimePeriod).End = value ?? null; }

        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Inlined)]
        public string TimePeriodStart { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriodInternal)TimePeriod).Start; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriodInternal)TimePeriod).Start = value ?? null; }
...

    {
        ...
        /// 13 months. If no timePeriod or billingPeriod or invoiceId is provided the API defaults to the open month time period
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriod TimePeriod { get; set; }
        /// <summary>The end date to pull data to. example format 2020-03-15</summary>
        string TimePeriodEnd { get; set; }
        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        string TimePeriodStart { get; set; }
