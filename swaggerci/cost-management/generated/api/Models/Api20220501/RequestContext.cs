...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501
{
    ...
    public partial class RequestContext :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IRequestContext,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IRequestContextInternal
    {

        /// <summary>Internal Acessors for RequestBody</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinition Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IRequestContextInternal.RequestBody { get => (this._requestBody = this._requestBody ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.GenerateCostDetailsReportRequestDefinition()); set { {_requestBody = value;} } }

        /// <summary>Internal Acessors for RequestBodyTimePeriod</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriod Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IRequestContextInternal.RequestBodyTimePeriod { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinitionInternal)RequestBody).TimePeriod; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinitionInternal)RequestBody).TimePeriod = value; }

        /// <summary>Backing field for <see cref="RequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinition _requestBody;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinition RequestBody { get => (this._requestBody = this._requestBody ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.GenerateCostDetailsReportRequestDefinition()); set => this._requestBody = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType? RequestBodyMetric { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinitionInternal)RequestBody).Metric; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinitionInternal)RequestBody).Metric = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType)""); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType? RequestBodyMetric { get; set; }
        /// <summary>The request scope of the request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// The context of the Cost Details request.
    internal partial interface IRequestContextInternal

    {
        /// <summary>The request payload body provided in Cost Details call</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.IGenerateCostDetailsReportRequestDefinition RequestBody { get; set; }
        /// <summary>
        /// This parameter can be used only by Enterprise Agreement customers. Use the YearMonth(e.g. 202008) format. This parameter
        /// cannot be used alongside either the invoiceId or timePeriod parameters. If a timePeriod, invoiceId or billingPeriod parameter
        /// is not provided in the request body the API will return the current month's cost.
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220501.ICostDetailsTimePeriod RequestBodyTimePeriod { get; set; }
        /// <summary>The request scope of the request.</summary>
        string RequestScope { get; set; }
        /// <summary>The end date to pull data to. example format 2020-03-15</summary>
        string TimePeriodEnd { get; set; }
