...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview
{
    ...
    public partial class ViewProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IViewProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IViewPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IKpiProperties[] _kpi;

        /// <summary>List of KPIs to show in Cost Analysis UI.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IKpiProperties[] Kpi { get => this._kpi; set => this._kpi = value; }
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IViewPropertiesInternal.CreatedOn { get => this._createdOn; set { {_createdOn = value;} } }

        /// <summary>Internal Acessors for Currency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IViewPropertiesInternal.Currency { get => this._currency; set { {_currency = value;} } }

        /// <summary>Internal Acessors for DateRange</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IViewPropertiesInternal.DateRange { get => this._dateRange; set { {_dateRange = value;} } }

        /// <summary>Internal Acessors for ModifiedOn</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IViewPropertiesInternal.ModifiedOn { get => this._modifiedOn; set { {_modifiedOn = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IPivotProperties[] _pivot;

        /// <summary>Configuration of 3 sub-views in the Cost Analysis UI.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IPivotProperties[] Pivot { get => this._pivot; set => this._pivot = value; }

        /// <summary>Backing field for <see cref="Query" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IReportConfigDefinition _query;

        /// <summary>Query body configuration. Required.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IReportConfigDefinition Query { get => (this._query = this._query ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.ReportConfigDefinition()); set => this._query = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IKpiProperties[] Kpi { get; set; }
        /// <summary>Metric to use when displaying costs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IPivotProperties[] Pivot { get; set; }
        /// <summary>Query body configuration. Required.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IReportConfigDefinition Query { get; set; }
        /// <summary>
        /// Cost Management scope to save the view on. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}'
        /// for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}'
        /// for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}'
