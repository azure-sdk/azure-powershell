...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview
{
    ...
    public partial class DimensionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.Category { get => this._category; set { {_category = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for FilterEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.FilterEnabled { get => this._filterEnabled; set { {_filterEnabled = value;} } }

        /// <summary>Internal Acessors for GroupingEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.GroupingEnabled { get => this._groupingEnabled; set { {_groupingEnabled = value;} } }

        /// <summary>Internal Acessors for NextLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.NextLink { get => this._nextLink; set { {_nextLink = value;} } }

        /// <summary>Internal Acessors for Total</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.Total { get => this._total; set { {_total = value;} } }

        /// <summary>Internal Acessors for UsageEnd</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.UsageEnd { get => this._usageEnd; set { {_usageEnd = value;} } }

        /// <summary>Internal Acessors for UsageStart</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IDimensionPropertiesInternal.UsageStart { get => this._usageStart; set { {_usageStart = value;} } }
