...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class ExportDeliveryInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryInfoInternal
    {

        /// <summary>Backing field for <see cref="Destination" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestination _destination;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestination Destination { get => (this._destination = this._destination ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ExportDeliveryDestination()); set => this._destination = value; }
        ...
        public string DestinationContainer { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestinationInternal)Destination).Container; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestinationInternal)Destination).Container = value ; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Inlined)]
        public string DestinationSasToken { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestinationInternal)Destination).SasToken; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestinationInternal)Destination).SasToken = value ?? null; }
    ...
    {
        /// <summary>Has destination for the export being delivered.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDeliveryDestination Destination { get; set; }
        /// <summary>
        /// The name of the container where exports will be uploaded. If the container does not exist it will be created.
        /// </summary>
        string DestinationContainer { get; set; }
