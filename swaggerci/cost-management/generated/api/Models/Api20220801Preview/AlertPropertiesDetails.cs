...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class AlertPropertiesDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IAlertPropertiesDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IAlertPropertiesDetailsInternal
    {
        ...
        /// <summary>Backing field for <see cref="EnrollmentEndDate" /> property.</summary>
        private string _enrollmentEndDate;

        /// <summary>datetime of enrollmentEndDate</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public string EnrollmentEndDate { get => this._enrollmentEndDate; set => this._enrollmentEndDate = value; }

        /// <summary>Backing field for <see cref="EnrollmentNumber" /> property.</summary>
        private string _enrollmentNumber;

        /// <summary>enrollment number</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public string EnrollmentNumber { get => this._enrollmentNumber; set => this._enrollmentNumber = value; }

        /// <summary>Backing field for <see cref="EnrollmentStartDate" /> property.</summary>
        private string _enrollmentStartDate;

        /// <summary>datetime of enrollmentStartDate</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public string EnrollmentStartDate { get => this._enrollmentStartDate; set => this._enrollmentStartDate = value; }

        /// <summary>Backing field for <see cref="InvoicingThreshold" /> property.</summary>
        private decimal? _invoicingThreshold;

        /// <summary>invoicing threshold</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public decimal? InvoicingThreshold { get => this._invoicingThreshold; set => this._invoicingThreshold = value; }

        /// <summary>Backing field for <see cref="MeterFilter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] _meterFilter;

        /// <summary>array of meters to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] MeterFilter { get => this._meterFilter; set => this._meterFilter = value; }

        /// <summary>Backing field for <see cref="Operator" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertOperator? _operator;

        /// <summary>operator used to compare currentSpend with amount</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertOperator? Operator { get => this._operator; set => this._operator = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] _resourceFilter;

        /// <summary>array of resources to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] ResourceFilter { get => this._resourceFilter; set => this._resourceFilter = value; }

        /// <summary>Backing field for <see cref="ResourceGroupFilter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] _resourceGroupFilter;

        /// <summary>array of resourceGroups to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] ResourceGroupFilter { get => this._resourceGroupFilter; set => this._resourceGroupFilter = value; }

        /// <summary>Backing field for <see cref="TagFilter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny _tagFilter;

        /// <summary>tags to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny TagFilter { get => (this._tagFilter = this._tagFilter ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Any()); set => this._tagFilter = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType? _timeGrainType;

        /// <summary>Type of timegrain cadence</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType? TimeGrainType { get => this._timeGrainType; set => this._timeGrainType = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string EnrollmentEndDate { get; set; }
        /// <summary>enrollment number</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string EnrollmentNumber { get; set; }
        /// <summary>datetime of enrollmentStartDate</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string EnrollmentStartDate { get; set; }
        /// <summary>invoicing threshold</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(decimal) })]
        decimal? InvoicingThreshold { get; set; }
        /// <summary>array of meters to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] MeterFilter { get; set; }
        /// <summary>operator used to compare currentSpend with amount</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertOperator? Operator { get; set; }
        /// <summary>overriding alert</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] ResourceFilter { get; set; }
        /// <summary>array of resourceGroups to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny[] ResourceGroupFilter { get; set; }
        /// <summary>tags to filter by</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.IAny TagFilter { get; set; }
        /// <summary>notification threshold percentage as a decimal which activated this alert</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.AlertTimeGrainType? TimeGrainType { get; set; }
        /// <summary>notificationId that triggered this alert</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// Alert details
    internal partial interface IAlertPropertiesDetailsInternal
