...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class ExportDataset :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDataset,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDatasetInternal
    {

        /// <summary>Backing field for <see cref="Configuration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDatasetConfiguration _configuration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDatasetConfiguration Configuration { get => (this._configuration = this._configuration ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ExportDatasetConfiguration()); set => this._configuration = value; }
    ...
    {
        /// <summary>The export dataset configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IExportDatasetConfiguration Configuration { get; set; }
        /// <summary>
        /// Array of column names to be included in the export. If not provided then the export will include all available columns.
        /// The available columns can vary by customer channel (see examples).
        /// </summary>
