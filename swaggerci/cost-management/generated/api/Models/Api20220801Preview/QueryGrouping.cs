...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class QueryGrouping :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IQueryGrouping,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IQueryGroupingInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.QueryColumnType _type;

        /// <summary>Has type of the column to group.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.QueryColumnType Type { get => this._type; set => this._type = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.QueryColumnType) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.QueryColumnType Type { get; set; }

    }
    /// The group by expression to be used in the query.
    internal partial interface IQueryGroupingInternal
