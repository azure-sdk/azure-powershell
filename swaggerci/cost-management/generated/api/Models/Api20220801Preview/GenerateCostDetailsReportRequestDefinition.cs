...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class GenerateCostDetailsReportRequestDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinitionInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriod Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinitionInternal.TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.CostDetailsTimePeriod()); set { {_timePeriod = value;} } }

        /// <summary>Backing field for <see cref="TimePeriod" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriod _timePeriod;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriod TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.CostDetailsTimePeriod()); set => this._timePeriod = value; }
        ...
        public string TimePeriodEnd { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriodInternal)TimePeriod).End; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriodInternal)TimePeriod).End = value ?? null; }

        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Inlined)]
        public string TimePeriodStart { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriodInternal)TimePeriod).Start; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriodInternal)TimePeriod).Start = value ?? null; }
...

    {
        ...
        /// 13 months. If no timePeriod or billingPeriod or invoiceId is provided the API defaults to the open month time period
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriod TimePeriod { get; set; }
        /// <summary>The end date to pull data to. example format 2020-03-15</summary>
        string TimePeriodEnd { get; set; }
        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        string TimePeriodStart { get; set; }
