...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class GenerateDetailedCostReportDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportDefinitionInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriod Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportDefinitionInternal.TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.GenerateDetailedCostReportTimePeriod()); set { {_timePeriod = value;} } }

        /// <summary>Backing field for <see cref="TimePeriod" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriod _timePeriod;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriod TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.GenerateDetailedCostReportTimePeriod()); set => this._timePeriod = value; }
        ...
        public string TimePeriodEnd { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriodInternal)TimePeriod).End; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriodInternal)TimePeriod).End = value ?? null; }

        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Inlined)]
        public string TimePeriodStart { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriodInternal)TimePeriod).Start; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriodInternal)TimePeriod).Start = value ?? null; }
...

    {
        ...
        /// billingPeriod parameters. If none provided current month cost is provided.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateDetailedCostReportTimePeriod TimePeriod { get; set; }
        /// <summary>The end date to pull data to. example format 2020-03-15</summary>
        string TimePeriodEnd { get; set; }
        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        string TimePeriodStart { get; set; }
