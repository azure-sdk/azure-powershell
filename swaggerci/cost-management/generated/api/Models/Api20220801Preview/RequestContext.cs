...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview
{
    ...
    public partial class RequestContext :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IRequestContext,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IRequestContextInternal
    {

        /// <summary>Internal Acessors for RequestBody</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinition Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IRequestContextInternal.RequestBody { get => (this._requestBody = this._requestBody ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.GenerateCostDetailsReportRequestDefinition()); set { {_requestBody = value;} } }

        /// <summary>Internal Acessors for RequestBodyTimePeriod</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostDetailsTimePeriod Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IRequestContextInternal.RequestBodyTimePeriod { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinitionInternal)RequestBody).TimePeriod; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinitionInternal)RequestBody).TimePeriod = value; }

        /// <summary>Backing field for <see cref="RequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinition _requestBody;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinition RequestBody { get => (this._requestBody = this._requestBody ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.GenerateCostDetailsReportRequestDefinition()); set => this._requestBody = value; }
    ...
    {
        /// <summary>The request payload body provided in Cost Details call</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IGenerateCostDetailsReportRequestDefinition RequestBody { get; set; }
        /// <summary>
        /// This parameter can be used only by Enterprise Agreement customers. Use the YearMonth(e.g. 202008) format. This parameter
        /// cannot be used alongside either the invoiceId or timePeriod parameters. If a timePeriod, invoiceId or billingPeriod parameter
        /// is not provided in the request body the API will return the current month's cost.
