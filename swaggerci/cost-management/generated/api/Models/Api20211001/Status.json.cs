...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001
{
    ...
    public partial class Status
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IStatus.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20211001.IStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject json ? new Status(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject into a new instance of <see cref="Status" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Status(Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject json)
        {
            ...
            {_status1 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonString>("status"), out var __jsonStatus) ? (string)__jsonStatus : (string)Status1;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Status" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Status" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._status1)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonString(this._status1.ToString()) : null, "status" ,container.Add );
