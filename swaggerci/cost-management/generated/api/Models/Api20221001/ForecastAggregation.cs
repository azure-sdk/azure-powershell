...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001
{
    ...
    public partial class ForecastAggregation :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IForecastAggregation,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IForecastAggregationInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IForecastAggregationInternal.Function { get => this._function; set { {_function = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.FunctionName _name;

        /// <summary>The name of the column to aggregate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.FunctionName Name { get => this._name; set => this._name = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.FunctionName) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.FunctionName Name { get; set; }

    }
    /// The aggregation expression to be used in the forecast.
    internal partial interface IForecastAggregationInternal
