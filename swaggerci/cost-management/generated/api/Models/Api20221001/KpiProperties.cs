...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001
{
    ...
    public partial class KpiProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IKpiProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IKpiPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.KpiType? _type;

        /// <summary>KPI type (Forecast, Budget).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.KpiType? Type { get => this._type; set => this._type = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.KpiType) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.KpiType? Type { get; set; }

    }
    /// Each KPI must contain a 'type' and 'enabled' key.
    internal partial interface IKpiPropertiesInternal
