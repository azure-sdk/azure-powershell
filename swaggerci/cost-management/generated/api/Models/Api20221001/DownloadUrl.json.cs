...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001
{
    ...
    public partial class DownloadUrl
    {
        ...
        internal DownloadUrl(Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject json)
        {
            ...
            {_expiryTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonString>("expiryTime"), out var __jsonExpiryTime) ? global::System.DateTime.TryParse((string)__jsonExpiryTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonExpiryTimeValue) ? __jsonExpiryTimeValue : ExpiryTime : ExpiryTime;}
            {_url = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonString>("url"), out var __jsonUrl) ? (string)__jsonUrl : (string)Url;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._expiryTime ? (Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonString(this._expiryTime?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "expiryTime" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._url)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Json.JsonString(this._url.ToString()) : null, "url" ,container.Add );
            }
