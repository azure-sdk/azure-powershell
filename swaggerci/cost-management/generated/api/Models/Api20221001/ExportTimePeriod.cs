...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001
{
    ...
    public partial class ExportTimePeriod :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IExportTimePeriod,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IExportTimePeriodInternal
    {
    ...
    /// The date range for data in the export. This should only be specified with timeFrame set to 'Custom'. The maximum date
    /// range is 3 months.
    internal partial interface IExportTimePeriodInternal
