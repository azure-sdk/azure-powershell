...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001
{
    ...
    public partial class GenerateCostDetailsReportRequestDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IGenerateCostDetailsReportRequestDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IGenerateCostDetailsReportRequestDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType? _metric;

        /// <summary>The type of the detailed report. By default ActualCost is provided</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType? Metric { get => this._metric; set => this._metric = value; }

        /// <summary>Internal Acessors for TimePeriod</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriod Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IGenerateCostDetailsReportRequestDefinitionInternal.TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.CostDetailsTimePeriod()); set { {_timePeriod = value;} } }

        /// <summary>Backing field for <see cref="TimePeriod" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriod _timePeriod;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriod TimePeriod { get => (this._timePeriod = this._timePeriod ?? new Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.CostDetailsTimePeriod()); set => this._timePeriod = value; }
        ...
        public string TimePeriodEnd { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriodInternal)TimePeriod).End; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriodInternal)TimePeriod).End = value ?? null; }

        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Origin(Microsoft.Azure.PowerShell.Cmdlets.Cost.PropertyOrigin.Inlined)]
        public string TimePeriodStart { get => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriodInternal)TimePeriod).Start; set => ((Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriodInternal)TimePeriod).Start = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType) })]
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.CostDetailsMetricType? Metric { get; set; }
        /// <summary>The end date to pull data to. example format 2020-03-15</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    /// The definition of a cost detailed report.
    internal partial interface IGenerateCostDetailsReportRequestDefinitionInternal

    {
        ...
        /// 13 months. If no timePeriod or billingPeriod or invoiceId is provided the API defaults to the open month time period
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.ICostDetailsTimePeriod TimePeriod { get; set; }
        /// <summary>The end date to pull data to. example format 2020-03-15</summary>
        string TimePeriodEnd { get; set; }
        /// <summary>The start date to pull data from. example format 2020-03-15</summary>
        string TimePeriodStart { get; set; }
