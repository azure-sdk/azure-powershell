...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SavingsPlanScope=>POST:"/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Triggers generation of a benefit utilization summaries report for the provided savings plan.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class InvokeAzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Savings Plan Id")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Savings Plan Order Id")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets.InvokeAzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1 Clone()
        {
            var clone = new InvokeAzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1();
            ...
            clone.SavingsPlanOrderId = this.SavingsPlanOrderId;
            clone.SavingsPlanId = this.SavingsPlanId;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzCostPlanGenerateBenefitUtilizationSummaryReportAsync_Plan1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GenerateBenefitUtilizationSummariesReportAsyncSavingsPlanScope' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GenerateBenefitUtilizationSummariesReportAsyncSavingsPlanScope(SavingsPlanOrderId, SavingsPlanId, this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SavingsPlanOrderId=SavingsPlanOrderId,SavingsPlanId=SavingsPlanId,Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SavingsPlanOrderId=SavingsPlanOrderId, SavingsPlanId=SavingsPlanId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SavingsPlanOrderId=SavingsPlanOrderId, SavingsPlanId=SavingsPlanId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
