...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets.InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order Clone()
        {
            var clone = new InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_Order()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GenerateBenefitUtilizationSummariesReportAsyncReservationOrderScope(ReservationOrderId, this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ReservationOrderId=ReservationOrderId,Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ReservationOrderId=ReservationOrderId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ReservationOrderId=ReservationOrderId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
