...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListByBillingAccountId=>GET:"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.CostManagement/benefitUtilizationSummaries"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCostBenefitUtilizationSummary_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Lists benefit utilization summaries for the provided billingAccount. This API provides benefit utilization summaries only for enrollment accounts.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class GetAzCostBenefitUtilizationSummary_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCostBenefitUtilizationSummary_List" /> cmdlet class.
        /// </summary>
        public GetAzCostBenefitUtilizationSummary_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BenefitUtilizationSummariesListByBillingAccountId(BillingAccountId, this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BillingAccountId=BillingAccountId,GrainParameter=this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, GrainParameter=this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, GrainParameter=this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.BenefitUtilizationSummariesListByBillingAccountId_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
