...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySavingsPlanOrder=>GET:"/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/providers/Microsoft.CostManagement/benefitUtilizationSummaries"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCostBenefitUtilizationSummary_List2")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Lists the savings plan utilization summaries for daily or monthly grain.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class GetAzCostBenefitUtilizationSummary_List2 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Supports filtering by properties/usageDate.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCostBenefitUtilizationSummary_List2" /> cmdlet class.
        /// </summary>
        public GetAzCostBenefitUtilizationSummary_List2()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BenefitUtilizationSummariesListBySavingsPlanOrder(this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, SavingsPlanOrderId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.BenefitUtilizationSummariesListBySavingsPlanOrder_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
