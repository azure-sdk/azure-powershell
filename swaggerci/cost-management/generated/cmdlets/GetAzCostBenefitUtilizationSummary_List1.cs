...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByBillingProfileId=>GET:"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.CostManagement/benefitUtilizationSummaries"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCostBenefitUtilizationSummary_List1")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IBenefitUtilizationSummary))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Lists benefit utilization summaries for billingProfile.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class GetAzCostBenefitUtilizationSummary_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Supports filtering by properties/benefitType, properties/benefitId, properties/benefitOrderId and properties/usageDate. properties/benefitType is defaulted to savingsPlan.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Supports filtering by properties/benefitType, properties/benefitId, properties/benefitOrderId and properties/usageDate. properties/benefitType is defaulted to savingsPlan.",
        ...
        /// <summary>Backing field for <see cref="GrainParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.GrainParameter _grainParameter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.GrainParameter) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cost.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.GrainParameter))]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Support.GrainParameter GrainParameter { get => this._grainParameter; set => this._grainParameter = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IBenefitUtilizationSummariesListResult">Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IBenefitUtilizationSummariesListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IBenefitUtilizationSummariesListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCostBenefitUtilizationSummary_List1" /> cmdlet class.
        /// </summary>
        public GetAzCostBenefitUtilizationSummary_List1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BenefitUtilizationSummariesListByBillingProfileId(BillingAccountId, BillingProfileId, this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BillingAccountId=BillingAccountId,BillingProfileId=BillingProfileId,GrainParameter=this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, BillingProfileId=BillingProfileId, GrainParameter=this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, BillingProfileId=BillingProfileId, GrainParameter=this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221001.IBenefitUtilizationSummariesListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.BenefitUtilizationSummariesListByBillingProfileId_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
