...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCostBenefitUtilizationSummaryAsyncOperationStatusReservationScope_Get")]
    ...
    public partial class GetAzCostBenefitUtilizationSummaryAsyncOperationStatusReservationScope_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Reservation Id")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCostBenefitUtilizationSummaryAsyncOperationStatusReservationScope_Get"
        /// /> cmdlet class.
        /// </summary>
        public GetAzCostBenefitUtilizationSummaryAsyncOperationStatusReservationScope_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BenefitUtilizationSummariesAsyncGetOperationStatusReservationScope(ReservationOrderId, ReservationId, OperationId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ReservationOrderId=ReservationOrderId,ReservationId=ReservationId,OperationId=OperationId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ReservationOrderId=ReservationOrderId, ReservationId=ReservationId, OperationId=OperationId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ReservationOrderId=ReservationOrderId, ReservationId=ReservationId, OperationId=OperationId })
                    {
