...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzCostScheduledAction_Create1", SupportsShouldProcess = true)]
    ...
    public partial class NewAzCostScheduledAction_Create1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ScheduledAction" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IScheduledAction _scheduledAction;

        /// <summary>Scheduled action definition.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Scheduled action definition.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Scheduled action definition.",
        SerializedName = @"scheduledAction",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IScheduledAction) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IScheduledAction ScheduledAction { get => this._scheduledAction; set => this._scheduledAction = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzCostScheduledAction_Create1" /> cmdlet class.
        /// </summary>
        public NewAzCostScheduledAction_Create1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ScheduledActionsCreateOrUpdateByScope(Scope, Name, ScheduledAction, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Scope=Scope,Name=Name,body=ScheduledAction})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, Name=Name, body=ScheduledAction })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, Name=Name, body=ScheduledAction })
                    {
