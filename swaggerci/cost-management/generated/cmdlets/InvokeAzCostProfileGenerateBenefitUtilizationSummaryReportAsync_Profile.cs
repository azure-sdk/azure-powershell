...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] BillingProfileScope=>POST:"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Triggers generation of a benefit utilization summaries report for the provided billing account and billing profile.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class InvokeAzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="BenefitKind" /> property.</summary>
        private string _benefitKind;

        /// <summary>Type of benefit the customer wants data for.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Type of benefit the customer wants data for.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Type of benefit the customer wants data for.",
        SerializedName = @"benefitKind",
        ...
        public string BenefitKind { get => this._benefitKind; set => this._benefitKind = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets.InvokeAzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile Clone()
        {
            var clone = new InvokeAzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile();
            ...
            clone.BenefitKind = this.BenefitKind;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile" />
        /// cmdlet class.
        /// </summary>
        public InvokeAzCostProfileGenerateBenefitUtilizationSummaryReportAsync_Profile()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GenerateBenefitUtilizationSummariesReportAsyncBillingProfileScope' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GenerateBenefitUtilizationSummariesReportAsyncBillingProfileScope(BillingAccountId, BillingProfileId, this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, BenefitKind, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BillingAccountId=BillingAccountId,BillingProfileId=BillingProfileId,Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null,BenefitKind=BenefitKind,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, BillingProfileId=BillingProfileId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, BenefitKind=BenefitKind, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { BillingAccountId=BillingAccountId, BillingProfileId=BillingProfileId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, BenefitKind=BenefitKind, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
