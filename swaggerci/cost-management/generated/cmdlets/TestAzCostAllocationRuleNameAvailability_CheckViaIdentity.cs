...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CheckNameAvailability=>POST:"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.CostManagement/costAllocationRules/checkNameAvailability"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzCostAllocationRuleNameAvailability_CheckViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Checks availability and correctness of a name for a cost allocation rule")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class TestAzCostAllocationRuleNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Backing field for <see cref="CostAllocationRuleCheckNameAvailabilityRequest" /> property.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityRequest _costAllocationRuleCheckNameAvailabilityRequest;

        /// <summary>The cost allocation rule check name availability request</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The cost allocation rule check name availability request", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The cost allocation rule check name availability request",
        SerializedName = @"costAllocationRuleCheckNameAvailabilityRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityRequest CostAllocationRuleCheckNameAvailabilityRequest { get => this._costAllocationRuleCheckNameAvailabilityRequest; set => this._costAllocationRuleCheckNameAvailabilityRequest = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityResponse">Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CostAllocationRulesCheckNameAvailability' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CostAllocationRulesCheckNameAvailabilityViaIdentity(InputObject.Id, CostAllocationRuleCheckNameAvailabilityRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CostAllocationRulesCheckNameAvailability(InputObject.BillingAccountId ?? null, CostAllocationRuleCheckNameAvailabilityRequest, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CostAllocationRuleCheckNameAvailabilityRequest})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzCostAllocationRuleNameAvailability_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzCostAllocationRuleNameAvailability_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CostAllocationRuleCheckNameAvailabilityRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CostAllocationRuleCheckNameAvailabilityRequest })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.ICostAllocationRuleCheckNameAvailabilityResponse
