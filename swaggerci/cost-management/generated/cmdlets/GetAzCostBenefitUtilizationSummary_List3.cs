...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySavingsPlanId=>GET:"/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}/providers/Microsoft.CostManagement/benefitUtilizationSummaries"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCostBenefitUtilizationSummary_List3")]
    ...
    public partial class GetAzCostBenefitUtilizationSummary_List3 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCostBenefitUtilizationSummary_List3" /> cmdlet class.
        /// </summary>
        public GetAzCostBenefitUtilizationSummary_List3()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BenefitUtilizationSummariesListBySavingsPlanId(this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("GrainParameter") ? GrainParameter : null, SavingsPlanOrderId, SavingsPlanId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.BenefitUtilizationSummariesListBySavingsPlanId_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
