...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostUsageQuery_UsageViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCostUsageQuery_UsageViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IQueryDefinition _parameter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IQueryDefinition) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221015Preview.IQueryDefinition Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostUsageQuery_UsageViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzCostUsageQuery_UsageViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.QueryUsageViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null, Parameter, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.QueryUsage(InputObject.Scope ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null, Parameter, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Skiptoken=this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null,body=Parameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Skiptoken=this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Skiptoken=this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null, body=Parameter })
                    {
