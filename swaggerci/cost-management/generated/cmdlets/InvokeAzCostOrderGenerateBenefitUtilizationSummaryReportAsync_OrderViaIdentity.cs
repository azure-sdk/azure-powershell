...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ReservationOrderScope=>POST:"/providers/Microsoft.Capacity/reservationorders/{reservationOrderId}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Description(@"Triggers generation of a benefit utilization summaries report for the provided reservation order.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Generated]
    public partial class InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <summary>Supports filtering by usageDate.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Supports filtering by usageDate.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Supports filtering by usageDate.",
        ...
        /// <summary>Daily or monthly grain.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Daily or monthly grain.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Cost.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Cost.ParameterCategory.Query)]
        public string Grain { get => this._grain; set => this._grain = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets.InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity Clone()
        {
            var clone = new InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzCostOrderGenerateBenefitUtilizationSummaryReportAsync_OrderViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GenerateBenefitUtilizationSummariesReportAsyncReservationOrderScope' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.GenerateBenefitUtilizationSummariesReportAsyncReservationOrderScopeViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.GenerateBenefitUtilizationSummariesReportAsyncReservationOrderScope(InputObject.ReservationOrderId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
