...
namespace Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Cost.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Cost.Cmdlets.InvokeAzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation Clone()
        {
            var clone = new InvokeAzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope_Reservation()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GenerateBenefitUtilizationSummariesReportAsyncReservationScope(ReservationOrderId, ReservationId, this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ReservationOrderId=ReservationOrderId,ReservationId=ReservationId,Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20221005Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ReservationOrderId=ReservationOrderId, ReservationId=ReservationId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ReservationOrderId=ReservationOrderId, ReservationId=ReservationId, Grain=this.InvocationInformation.BoundParameters.ContainsKey("Grain") ? Grain : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
