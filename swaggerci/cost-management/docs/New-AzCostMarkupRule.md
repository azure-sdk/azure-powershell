...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/new-azcostmarkuprule
schema: 2.0.0
---

# New-AzCostMarkupRule
...
```
New-AzCostMarkupRule -BillingAccountId <String> -BillingProfileId <String> -Name <String>
 [-CustomerDetailBillingAccountId <String>] [-CustomerDetailBillingProfileId <String>] [-Description <String>]
 [-EndDate <DateTime>] [-ETag <String>] [-Percentage <Double>] [-StartDate <DateTime>]
