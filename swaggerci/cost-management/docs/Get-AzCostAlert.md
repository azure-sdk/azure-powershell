...
### List (Default)
```
Get-AzCostAlert -Scope <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzCostAlert -Id <String> -Scope <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostAlert -InputObject <ICostIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IAlert

### Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IAlertsResult
