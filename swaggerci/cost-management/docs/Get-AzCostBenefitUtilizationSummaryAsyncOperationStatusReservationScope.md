...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/get-azcostbenefitutilizationsummaryasyncoperationstatusreservationscope
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusReservationScope -OperationId <String>
 -ReservationId <String> -ReservationOrderId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusReservationScope -InputObject <ICostIdentity>
