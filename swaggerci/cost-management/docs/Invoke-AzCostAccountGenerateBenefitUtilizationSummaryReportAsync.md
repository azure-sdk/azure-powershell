...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/invoke-azcostaccountgeneratebenefitutilizationsummaryreportasync
schema: 2.0.0
---

# Invoke-AzCostAccountGenerateBenefitUtilizationSummaryReportAsync
...
### Account (Default)
```
Invoke-AzCostAccountGenerateBenefitUtilizationSummaryReportAsync -BillingAccountId <String>
 -BenefitKind <String> [-Filter <String>] [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AccountViaIdentity
```
Invoke-AzCostAccountGenerateBenefitUtilizationSummaryReportAsync -InputObject <ICostIdentity>
 -BenefitKind <String> [-Filter <String>] [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
