...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/remove-azcostallocationrule
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzCostAllocationRule -BillingAccountId <String> -RuleName <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzCostAllocationRule -InputObject <ICostIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
