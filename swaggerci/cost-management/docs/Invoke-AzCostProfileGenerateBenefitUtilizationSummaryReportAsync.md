...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/invoke-azcostprofilegeneratebenefitutilizationsummaryreportasync
schema: 2.0.0
---

# Invoke-AzCostProfileGenerateBenefitUtilizationSummaryReportAsync
...
### Profile (Default)
```
Invoke-AzCostProfileGenerateBenefitUtilizationSummaryReportAsync -BillingAccountId <String>
 -BillingProfileId <String> -BenefitKind <String> [-Filter <String>] [-Grain <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ProfileViaIdentity
```
Invoke-AzCostProfileGenerateBenefitUtilizationSummaryReportAsync -InputObject <ICostIdentity>
