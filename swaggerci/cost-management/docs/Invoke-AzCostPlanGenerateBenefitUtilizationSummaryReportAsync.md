...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/invoke-azcostplangeneratebenefitutilizationsummaryreportasync
schema: 2.0.0
---

# Invoke-AzCostPlanGenerateBenefitUtilizationSummaryReportAsync
...
### Plan (Default)
```
Invoke-AzCostPlanGenerateBenefitUtilizationSummaryReportAsync -SavingsPlanOrderId <String> [-Filter <String>]
 [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Plan1
```
Invoke-AzCostPlanGenerateBenefitUtilizationSummaryReportAsync -SavingsPlanId <String>
 -SavingsPlanOrderId <String> [-Filter <String>] [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PlanViaIdentity
```
Invoke-AzCostPlanGenerateBenefitUtilizationSummaryReportAsync -InputObject <ICostIdentity> [-Filter <String>]
 [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: PlanViaIdentity, PlanViaIdentity1
Aliases:
