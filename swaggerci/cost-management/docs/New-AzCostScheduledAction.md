...
New-AzCostScheduledAction -Name <String> [-Scope <String>] [-DisplayName <String>]
 [-FileDestinationFileFormat <FileFormat[]>] [-Kind <ScheduledActionKind>] [-NotificationMessage <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Cost.Models.Api20220801Preview.IScheduledAction
