...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/invoke-azcostexecutescheduledaction
schema: 2.0.0
---

# Invoke-AzCostExecuteScheduledAction
...
### Execute (Default)
```
Invoke-AzCostExecuteScheduledAction -Name <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Execute1
```
Invoke-AzCostExecuteScheduledAction -Name <String> -Scope <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExecuteViaIdentity
```
Invoke-AzCostExecuteScheduledAction -InputObject <ICostIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: ExecuteViaIdentity, ExecuteViaIdentity1
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Execute, Execute1
Aliases:
