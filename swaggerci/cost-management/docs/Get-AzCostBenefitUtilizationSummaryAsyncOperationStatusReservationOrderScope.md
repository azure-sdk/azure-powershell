...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/get-azcostbenefitutilizationsummaryasyncoperationstatusreservationorderscope
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusReservationOrderScope -OperationId <String>
 -ReservationOrderId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusReservationOrderScope -InputObject <ICostIdentity>
