...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/get-azcostmarkuprule
schema: 2.0.0
---

# Get-AzCostMarkupRule
...
### List (Default)
```
Get-AzCostMarkupRule -BillingAccountId <String> -BillingProfileId <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzCostMarkupRule -BillingAccountId <String> -BillingProfileId <String> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostMarkupRule -InputObject <ICostIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
