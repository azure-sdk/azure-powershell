...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/get-azcostbenefitutilizationsummaryasyncoperationstatussavingplanorderscope
schema: 2.0.0
---

# Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusSavingPlanOrderScope
...
### Get (Default)
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusSavingPlanOrderScope -OperationId <String>
 -SavingsPlanOrderId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusSavingPlanOrderScope -InputObject <ICostIdentity>
