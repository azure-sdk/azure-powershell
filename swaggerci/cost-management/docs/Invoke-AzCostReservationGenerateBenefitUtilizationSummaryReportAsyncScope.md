...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/invoke-azcostreservationgeneratebenefitutilizationsummaryreportasyncscope
schema: 2.0.0
---

# Invoke-AzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope
...
### Reservation (Default)
```
Invoke-AzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope -ReservationId <String>
 -ReservationOrderId <String> [-Filter <String>] [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReservationViaIdentity
```
Invoke-AzCostReservationGenerateBenefitUtilizationSummaryReportAsyncScope -InputObject <ICostIdentity>
 [-Filter <String>] [-Grain <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: ReservationViaIdentity
Aliases:
