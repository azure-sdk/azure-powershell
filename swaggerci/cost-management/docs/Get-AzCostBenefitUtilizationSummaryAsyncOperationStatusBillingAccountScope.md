...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/get-azcostbenefitutilizationsummaryasyncoperationstatusbillingaccountscope
schema: 2.0.0
---

# Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusBillingAccountScope
...
### Get (Default)
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusBillingAccountScope -BillingAccountId <String>
 -OperationId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusBillingAccountScope -InputObject <ICostIdentity>
