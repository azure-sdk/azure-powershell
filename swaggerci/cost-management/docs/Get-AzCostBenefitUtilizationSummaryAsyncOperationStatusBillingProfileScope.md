...
external help file:
Module Name: Az.Cost
online version: https://docs.microsoft.com/en-us/powershell/module/az.cost/get-azcostbenefitutilizationsummaryasyncoperationstatusbillingprofilescope
schema: 2.0.0
---

# Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusBillingProfileScope
...
### Get (Default)
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusBillingProfileScope -BillingAccountId <String>
 -BillingProfileId <String> -OperationId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCostBenefitUtilizationSummaryAsyncOperationStatusBillingProfileScope -InputObject <ICostIdentity>
