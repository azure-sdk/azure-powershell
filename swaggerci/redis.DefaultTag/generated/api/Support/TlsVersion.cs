...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion One2 = @"1.2";

        /// <summary>the value for an instance of the <see cref="TlsVersion" /> Enum.</summary>
        private string _value { get; set; }

        /// <summary>Conversion from arbitrary object to TlsVersion</summary>
        /// <param name="value">the value to convert to an instance of <see cref="TlsVersion" />.</param>
        internal static object CreateFrom(object value)
        {
            return new TlsVersion(global::System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type TlsVersion</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion e1, Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion e2)
        {
            return !e2.Equals(e1);
        }
