...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001
{
    ...
    public partial class RedisCommonPropertiesRedisConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IRedisCommonPropertiesRedisConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IRedisCommonPropertiesRedisConfigurationInternal
    {

        /// <summary>Backing field for <see cref="AadEnabled" /> property.</summary>
        private string _aadEnabled;
        ...
        public string AadEnabled { get => this._aadEnabled; set => this._aadEnabled = value; }

        /// <summary>Backing field for <see cref="AofBackupEnabled" /> property.</summary>
        private string _aofBackupEnabled;

        /// <summary>Specifies whether the aof backup is enabled</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Owned)]
        public string AofBackupEnabled { get => this._aofBackupEnabled; set => this._aofBackupEnabled = value; }
        ...
        /// <summary>Backing field for <see cref="Authnotrequired" /> property.</summary>
        private string _authnotrequired;

        /// <summary>
        /// Specifies whether the authentication is disabled. Setting this property is highly discouraged from security point of view.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Owned)]
        public string Authnotrequired { get => this._authnotrequired; set => this._authnotrequired = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IRedisCommonPropertiesRedisConfigurationInternal.Maxclient { get => this._maxclient; set { {_maxclient = value;} } }

        /// <summary>Internal Acessors for PreferredDataArchiveAuthMethod</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IRedisCommonPropertiesRedisConfigurationInternal.PreferredDataArchiveAuthMethod { get => this._preferredDataArchiveAuthMethod; set { {_preferredDataArchiveAuthMethod = value;} } }

        /// <summary>Internal Acessors for ZonalConfiguration</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IRedisCommonPropertiesRedisConfigurationInternal.ZonalConfiguration { get => this._zonalConfiguration; set { {_zonalConfiguration = value;} } }

        /// <summary>Backing field for <see cref="NotifyKeyspaceEvent" /> property.</summary>
        private string _notifyKeyspaceEvent;

        /// <summary>The keyspace events which should be monitored.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Owned)]
        public string NotifyKeyspaceEvent { get => this._notifyKeyspaceEvent; set => this._notifyKeyspaceEvent = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Owned)]
        public string PreferredDataPersistenceAuthMethod { get => this._preferredDataPersistenceAuthMethod; set => this._preferredDataPersistenceAuthMethod = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IAssociativeArray<global::System.Object>
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string AofBackupEnabled { get; set; }
        /// <summary>First storage account connection string</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string Authnotrequired { get; set; }
        /// <summary>The max clients config</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string NotifyKeyspaceEvent { get; set; }
        /// <summary>
        /// Preferred auth method to communicate to storage account used for data archive, specify SAS or ManagedIdentity, default
        /// value is SAS
        /// </summary>
