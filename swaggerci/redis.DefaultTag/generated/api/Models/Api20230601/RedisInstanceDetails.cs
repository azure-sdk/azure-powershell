...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601
{
    ...
    public partial class RedisInstanceDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal.IsMaster { get => this._isMaster; set { {_isMaster = value;} } }

        /// <summary>Internal Acessors for IsPrimary</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal.IsPrimary { get => this._isPrimary; set { {_isPrimary = value;} } }

        /// <summary>Internal Acessors for NonSslPort</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal.NonSslPort { get => this._nonSslPort; set { {_nonSslPort = value;} } }

        /// <summary>Internal Acessors for ShardId</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal.ShardId { get => this._shardId; set { {_shardId = value;} } }

        /// <summary>Internal Acessors for SslPort</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal.SslPort { get => this._sslPort; set { {_sslPort = value;} } }

        /// <summary>Internal Acessors for Zone</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisInstanceDetailsInternal.Zone { get => this._zone; set { {_zone = value;} } }
