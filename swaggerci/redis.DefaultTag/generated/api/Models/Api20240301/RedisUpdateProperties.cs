...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301
{
    ...
    public partial class RedisUpdateProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisUpdatePropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonProperties"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonProperties __redisCommonProperties = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.RedisCommonProperties();
        ...
        public bool? DisableAccessKeyAuthentication { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).DisableAccessKeyAuthentication; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).DisableAccessKeyAuthentication = value ?? default(bool); }

        /// <summary>Specifies whether the non-ssl Redis server port (6379) is enabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public bool? EnableNonSslPort { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).EnableNonSslPort; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).EnableNonSslPort = value ?? default(bool); }

        /// <summary>Internal Acessors for Sku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISku Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisUpdatePropertiesInternal.Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.Sku()); set { {_sku = value;} } }

        /// <summary>
        /// Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion? MinimumTlsVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).MinimumTlsVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).MinimumTlsVersion = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.TlsVersion)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public string RedisVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).RedisVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).RedisVersion = value ?? null; }

        /// <summary>The number of replicas to be created per primary.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public int? ReplicasPerMaster { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).ReplicasPerMaster; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).ReplicasPerMaster = value ?? default(int); }

        /// <summary>The number of replicas to be created per primary.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public int? ReplicasPerPrimary { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).ReplicasPerPrimary; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).ReplicasPerPrimary = value ?? default(int); }

        /// <summary>The number of shards to be created on a Premium Cluster Cache.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public int? ShardCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).ShardCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).ShardCount = value ?? default(int); }

        /// <summary>Backing field for <see cref="Sku" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISku _sku;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISku Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.Sku()); set => this._sku = value; }
        ...
        public int? SkuCapacity { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISkuInternal)Sku).Capacity; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISkuInternal)Sku).Capacity = value ?? default(int); }

        /// <summary>The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuFamily? SkuFamily { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISkuInternal)Sku).Family; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISkuInternal)Sku).Family = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuFamily)""); }

        /// <summary>The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuName? SkuName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISkuInternal)Sku).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.ISkuInternal)Sku).Name = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.SkuName)""); }

        /// <summary>A dictionary of tenant settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Origin(Microsoft.Azure.PowerShell.Cmdlets.Redis.PropertyOrigin.Inherited)]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesTenantSettings TenantSetting { get => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).TenantSetting; set => ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal)__redisCommonProperties).TenantSetting = value ?? null /* model class */; }
    ...
    public partial interface IRedisUpdateProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonProperties
    {
        /// <summary>
        /// The size of the Redis cache to deploy. Valid values: for C (Basic/Standard) family (0, 1, 2, 3, 4, 5, 6), for P (Premium)
        /// family (1, 2, 3, 4).
    ...
    internal partial interface IRedisUpdatePropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IRedisCommonPropertiesInternal
    {
        /// <summary>The SKU of the Redis cache to deploy.</summary>
