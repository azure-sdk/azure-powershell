...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ExportData=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{name}/export"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Export, @"AzRedisData_ExportViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Export data from the redis cache to blobs in a container.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{name}/export", ApiVersion = "2024-04-01-preview")]
    public partial class ExportAzRedisData_ExportViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240401Preview.IExportRdbParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240401Preview.ExportRdbParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Container name to export to.")]
        ...
        /// value is SAS
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Preferred auth method to communicate to storage account used for data archive, specify SAS or ManagedIdentity, default value is SAS")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PreferredDataArchiveAuthMethod { get => _parametersBody.PreferredDataArchiveAuthMethod ?? null; set => _parametersBody.PreferredDataArchiveAuthMethod = value; }

        /// <summary>Prefix to use for exported files.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Prefix to use for exported files.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Prefix { get => _parametersBody.Prefix ?? null; set => _parametersBody.Prefix = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Subscription id of the storage container for data to be exported using ManagedIdentity.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StorageSubscriptionId { get => _parametersBody.StorageSubscriptionId ?? null; set => _parametersBody.StorageSubscriptionId = value; }
        ...
        /// <returns>a duplicate instance of ExportAzRedisData_ExportViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.ExportAzRedisData_ExportViaIdentityExpanded Clone()
        {
            var clone = new ExportAzRedisData_ExportViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ExportAzRedisData_ExportViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ExportAzRedisData_ExportViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RedisExportData' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RedisExportDataViaIdentity(InputObject.Id, _parametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RedisExportData(InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.SubscriptionId ?? null, _parametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
