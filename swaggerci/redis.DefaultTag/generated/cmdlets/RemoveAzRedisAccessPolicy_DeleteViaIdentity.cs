...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRedisAccessPolicy_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzRedisAccessPolicy_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzRedisAccessPolicy_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.RemoveAzRedisAccessPolicy_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzRedisAccessPolicy_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AccessPolicyDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AccessPolicyDelete(InputObject.ResourceGroupName ?? null, InputObject.CacheName ?? null, InputObject.AccessPolicyName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzRedisAccessPolicy_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzRedisAccessPolicy_DeleteViaIdentity()
        {
