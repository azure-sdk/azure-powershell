...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/accessPolicyAssignments/{accessPolicyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRedisAccessPolicyAssignment_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Deletes the access policy assignment from a redis cache")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    public partial class RemoveAzRedisAccessPolicyAssignment_Delete : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        /// <summary>The name of the access policy being unassigned.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the access policy being unassigned.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The name of the access policy being unassigned.",
        ...
        /// <returns>a duplicate instance of RemoveAzRedisAccessPolicyAssignment_Delete</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.RemoveAzRedisAccessPolicyAssignment_Delete Clone()
        {
            var clone = new RemoveAzRedisAccessPolicyAssignment_Delete();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccessPolicyAssignmentDelete(ResourceGroupName, CacheName, AccessPolicyName, SubscriptionId, onOk, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,CacheName=CacheName,AccessPolicyName=AccessPolicyName,SubscriptionId=SubscriptionId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzRedisAccessPolicyAssignment_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzRedisAccessPolicyAssignment_Delete()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, CacheName=CacheName, AccessPolicyName=AccessPolicyName, SubscriptionId=SubscriptionId })
                    {
