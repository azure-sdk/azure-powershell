...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisResource))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{name}", ApiVersion = "2024-11-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisUpdateParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.RedisUpdateParameters();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Authentication to Redis through access keys is disabled when set as true. Default value is false.")]
        ...
        public global::System.Management.Automation.SwitchParameter DisableAccessKeyAuthentication { get => _parametersBody.DisableAccessKeyAuthentication ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.DisableAccessKeyAuthentication = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.2')")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.2')",
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisCommonPropertiesRedisConfiguration RedisConfiguration { get => _parametersBody.RedisConfiguration ?? null /* object */; set => _parametersBody.RedisConfiguration = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisUpdateParametersTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisUpdateParametersTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisCommonPropertiesTenantSettings TenantSetting { get => _parametersBody.TenantSetting ?? null /* object */; set => _parametersBody.TenantSetting = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.UpdateChannel))]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.UpdateChannel UpdateChannel { get => _parametersBody.UpdateChannel ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.UpdateChannel)""); set => _parametersBody.UpdateChannel = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.ZonalAllocationPolicy))]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.ZonalAllocationPolicy ZonalAllocationPolicy { get => _parametersBody.ZonalAllocationPolicy ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.ZonalAllocationPolicy)""); set => _parametersBody.ZonalAllocationPolicy = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api30.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api30.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api30.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisResource">Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateAzRedis_UpdateViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.UpdateAzRedis_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzRedis_UpdateViaIdentityExpanded();
        ...
        {
            var telemetryInfo = Microsoft.Azure.PowerShell.Cmdlets.Redis.Module.Instance.GetTelemetryInfo?.Invoke(__correlationId);
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.Redis.Module.Instance.SanitizeOutput?.Invoke(sendToPipeline, __correlationId);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api30.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IRedisResource
