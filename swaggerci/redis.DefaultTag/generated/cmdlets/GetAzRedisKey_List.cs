...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{name}/listKeys"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRedisKey_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Retrieve a Redis cache's access keys. This operation requires write permission to the cache resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{name}/listKeys", ApiVersion = "2024-04-01-preview")]
    public partial class GetAzRedisKey_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisKey_List" /> cmdlet class.
        /// </summary>
        public GetAzRedisKey_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RedisListKeys' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.RedisListKeys(ResourceGroupName, Name, SubscriptionId, onOk, onDefault, this, Pipeline);
