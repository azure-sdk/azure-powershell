...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CheckNameAvailability=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Cache/CheckNameAvailability"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzRedisNameAvailability_CheckViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Checks that the redis cache name is valid and is not already in use.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Cache/CheckNameAvailability", ApiVersion = "2024-04-01-preview")]
    public partial class TestAzRedisNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240401Preview.ICheckNameAvailabilityParameters _parameter;

        /// <summary>Parameters body to pass for resource name availability check.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters body to pass for resource name availability check.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240401Preview.ICheckNameAvailabilityParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240401Preview.ICheckNameAvailabilityParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RedisCheckNameAvailabilityViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RedisCheckNameAvailability(InputObject.SubscriptionId ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzRedisNameAvailability_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzRedisNameAvailability_CheckViaIdentity()
        {
