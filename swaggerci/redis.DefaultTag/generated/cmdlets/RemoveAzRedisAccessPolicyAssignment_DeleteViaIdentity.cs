...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/accessPolicyAssignments/{accessPolicyAssignmentName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRedisAccessPolicyAssignment_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzRedisAccessPolicyAssignment_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzRedisAccessPolicyAssignment_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.RemoveAzRedisAccessPolicyAssignment_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzRedisAccessPolicyAssignment_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AccessPolicyAssignmentDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AccessPolicyAssignmentDelete(InputObject.ResourceGroupName ?? null, InputObject.CacheName ?? null, InputObject.AccessPolicyAssignmentName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzRedisAccessPolicyAssignment_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzRedisAccessPolicyAssignment_DeleteViaIdentity()
        {
