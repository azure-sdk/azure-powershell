...
online version: https://learn.microsoft.com/powershell/module/az.redis/remove-azredispatchschedule
schema: 2.0.0
---

# Remove-AzRedisPatchSchedule
...
### Delete (Default)
```
Remove-AzRedisPatchSchedule -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRedisPatchSchedule -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
