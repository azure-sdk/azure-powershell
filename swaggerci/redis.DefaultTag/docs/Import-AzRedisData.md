...
online version: https://learn.microsoft.com/powershell/module/az.redis/import-azredisdata
schema: 2.0.0
---
...
Import-AzRedisData -Name <String> -ResourceGroupName <String> -File <String[]> [-SubscriptionId <String>]
 [-Format <String>] [-PreferredDataArchiveAuthMethod <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20220601Privatepreview.IImportRdbParameters
