...
Import-AzRedisData -Name <String> -ResourceGroupName <String> -File <String[]> [-SubscriptionId <String>]
 [-Format <String>] [-PreferredDataArchiveAuthMethod <String>] [-StorageSubscriptionId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240401Preview.IImportRdbParameters
