...
Update-AzRedis -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-EnableNonSslPort]
 ...
 [-UpdateChannel <UpdateChannel>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-AzRedis -InputObject <IRedisIdentity> [-EnableNonSslPort] [-IdentityType <ManagedServiceIdentityType>]
 ...
 [-TenantSetting <Hashtable>] [-UpdateChannel <UpdateChannel>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230801.IRedisCommonPropertiesRedisConfiguration
Parameter Sets: (All)
Aliases:
