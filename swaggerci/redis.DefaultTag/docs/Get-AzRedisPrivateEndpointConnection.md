...
online version: https://learn.microsoft.com/powershell/module/az.redis/get-azredisprivateendpointconnection
schema: 2.0.0
---
...
### List (Default)
```
Get-AzRedisPrivateEndpointConnection -CacheName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRedisPrivateEndpointConnection -CacheName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRedisPrivateEndpointConnection -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
