...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IImportRdbParameters
.Inputs
...
INPUTOBJECT <IRedisIdentity>: Identity Parameter
  [AccessPolicyAssignmentName <String>]: The name of the access policy assignment.
...
PARAMETER <IImportRdbParameters>: Parameters for Redis import operation.
  ...
  [StorageSubscriptionId <String>]: Subscription id of the storage container containing files to import using Managed Identity.
.Link
