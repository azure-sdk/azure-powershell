...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IOperationStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IOperationStatus])]
