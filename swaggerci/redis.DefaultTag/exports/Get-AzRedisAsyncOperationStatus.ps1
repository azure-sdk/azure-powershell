...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240801.IOperationStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240801.IOperationStatus])]
