...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230801.IOperationStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230801.IOperationStatus])]
