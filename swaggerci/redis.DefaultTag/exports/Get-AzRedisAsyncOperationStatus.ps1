...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IOperationStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20240301.IOperationStatus])]
