...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IOperationStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241001.IOperationStatus])]
