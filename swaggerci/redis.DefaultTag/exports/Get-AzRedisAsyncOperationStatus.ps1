...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IOperationStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IOperationStatus])]
