...
.Link
https://learn.microsoft.com/powershell/module/az.redis/clear-azrediscache
#>
function Clear-AzRedisCache {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api30.IOperationStatusResult])]
...
begin {
    try {
        ...
        $mapping = @{
            Flush = 'Az.Redis.private\Clear-AzRedisCache_Flush';
            FlushViaIdentity = 'Az.Redis.private\Clear-AzRedisCache_FlushViaIdentity';
        }
