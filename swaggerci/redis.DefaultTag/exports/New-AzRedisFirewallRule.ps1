...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisFirewallRule
.Link
https://learn.microsoft.com/powershell/module/az.redis/new-azredisfirewallrule
#>
function New-AzRedisFirewallRule {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230601.IRedisFirewallRule])]
