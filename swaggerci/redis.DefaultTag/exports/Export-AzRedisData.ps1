...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20241101.IExportRdbParameters
.Inputs
...
PARAMETER <IExportRdbParameters>: Parameters for Redis export operation.
  ...
  [StorageSubscriptionId <String>]: Subscription id of the storage container for data to be exported using ManagedIdentity.
.Link
