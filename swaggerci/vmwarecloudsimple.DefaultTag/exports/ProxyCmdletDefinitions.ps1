...
INPUTOBJECT <IVMwareCloudSimpleIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: virtual network id (vsphereId)
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/get-azvmwarecloudsimplededicatedcloudservice
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/get-azvmwarecloudsimpleskusavailability
#>
...
INPUTOBJECT <IVMwareCloudSimpleIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: virtual network id (vsphereId)
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/get-azvmwarecloudsimplevirtualmachine
#>
...
INPUTOBJECT <IVMwareCloudSimpleIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: virtual network id (vsphereId)
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/get-azvmwarecloudsimplevirtualnetwork
#>
...
INPUTOBJECT <IVMwareCloudSimpleIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: virtual network id (vsphereId)
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/remove-azvmwarecloudsimplededicatedcloudservice
#>
...
INPUTOBJECT <IVMwareCloudSimpleIdentity>: Identity Parameter
  ...
  [VirtualNetworkName <String>]: virtual network id (vsphereId)
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/remove-azvmwarecloudsimplevirtualmachine
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.vmwarecloudsimple/stop-azvmwarecloudsimplevirtualmachine
#>
