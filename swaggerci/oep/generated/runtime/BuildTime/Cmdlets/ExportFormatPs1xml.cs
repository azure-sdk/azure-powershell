...
namespace Microsoft.Azure.PowerShell.Cmdlets.OpenEnergyPlatformServiceApIs.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.OpenEnergyPlatformServiceApIs.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.OpenEnergyPlatformServiceApIs.Support";
