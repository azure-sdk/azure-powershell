# How-To
This document describes how to develop for `Az.OpenEnergyPlatformServiceApIs`.

## Building `Az.OpenEnergyPlatformServiceApIs`
...
## Testing `Az.OpenEnergyPlatformServiceApIs`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.OpenEnergyPlatformServiceApIs` into the session.
