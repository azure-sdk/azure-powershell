...
online version: https://docs.microsoft.com/en-us/powershell/module/az.openenergyplatformserviceapis/update-azopenenergyplatformserviceapisenergyservice
schema: 2.0.0
---

# Update-AzOpenEnergyPlatformServiceApIsEnergyService
...
```
Update-AzOpenEnergyPlatformServiceApIsEnergyService -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzOpenEnergyPlatformServiceApIsEnergyService -InputObject <IOpenEnergyPlatformServiceApIsIdentity>
