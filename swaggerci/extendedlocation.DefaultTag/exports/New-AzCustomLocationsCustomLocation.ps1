...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Models.Api30.ITrackedResourceTags]))]
