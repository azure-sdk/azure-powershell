...
namespace Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin System = @"system";

        public static Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin User = @"user";

        public static Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin UserSystem = @"user,system";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin e1, Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Support.Origin e2)
        {
            return !e2.Equals(e1);
        }
