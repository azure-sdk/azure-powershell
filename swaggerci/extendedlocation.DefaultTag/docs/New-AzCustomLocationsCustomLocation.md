...
online version: https://learn.microsoft.com/powershell/module/az.customlocations/new-azcustomlocationscustomlocation
schema: 2.0.0
---

# New-AzCustomLocationsCustomLocation
...
```
New-AzCustomLocationsCustomLocation -ResourceGroupName <String> -ResourceName <String> -Location <String>
...
### -HostResourceId
Connected Cluster, AKS Cluster or Edge Cluster.
The Custom Locations RP will perform a checkAccess API for listAdminCredentials permissions for Connected Cluster and AKS Cluster.
