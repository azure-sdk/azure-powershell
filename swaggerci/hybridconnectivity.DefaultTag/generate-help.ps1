...
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.HybridConnectivityApi.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Module]::Instance
