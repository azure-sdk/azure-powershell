...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support
{
        ...
        System.IEquatable<Status>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support.Status Connected = @"Connected";

        /// <summary>Disconnected status</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support.Status Disconnected = @"Disconnected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
