...
namespace Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesIconFileUris _iconFileUri;

        /// <summary>Icon File Uris</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Origin(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesIconFileUris IconFileUri { get => (this._iconFileUri = this._iconFileUri ?? new Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.OfferPropertiesIconFileUris()); set => this._iconFileUri = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for IsStopSell</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.IsStopSell { get => this._isStopSell; set { {_isStopSell = value;} } }

        /// <summary>Internal Acessors for ModifiedAt</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.ModifiedAt { get => this._modifiedAt; set { {_modifiedAt = value;} } }

        /// <summary>Internal Acessors for OfferDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.OfferDisplayName { get => this._offerDisplayName; set { {_offerDisplayName = value;} } }

        /// <summary>Internal Acessors for PrivateStoreId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.PrivateStoreId { get => this._privateStoreId; set { {_privateStoreId = value;} } }

        /// <summary>Internal Acessors for PublisherDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.PublisherDisplayName { get => this._publisherDisplayName; set { {_publisherDisplayName = value;} } }

        /// <summary>Internal Acessors for UniqueOfferId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IOfferPropertiesInternal.UniqueOfferId { get => this._uniqueOfferId; set { {_uniqueOfferId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IPlan[] _plan;

        /// <summary>Offer plans</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Origin(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IPlan[] Plan { get => this._plan; set => this._plan = value; }
