...
online version: https://learn.microsoft.com/powershell/module/az.marketplacerpservice/new-azmarketplacerpserviceprivatestorecollection
schema: 2.0.0
---

# New-AzMarketplaceRpServicePrivateStoreCollection
...
```
New-AzMarketplaceRpServicePrivateStoreCollection -CollectionId <String> -PrivateStoreId <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202301.ICollection
