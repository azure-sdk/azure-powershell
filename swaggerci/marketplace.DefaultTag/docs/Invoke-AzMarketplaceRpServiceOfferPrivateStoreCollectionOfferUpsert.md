...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IMultiContextAndPlansPayload
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api202501.IContextAndPlansDetails[]
Parameter Sets: OfferExpanded, OfferViaIdentityExpanded
Aliases:
