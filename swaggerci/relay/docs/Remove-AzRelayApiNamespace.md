...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/remove-azrelayapinamespace
schema: 2.0.0
---

# Remove-AzRelayApiNamespace
...
### Delete (Default)
```
Remove-AzRelayApiNamespace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRelayApiNamespace -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
