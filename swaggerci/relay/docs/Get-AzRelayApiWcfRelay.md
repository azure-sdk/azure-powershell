...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/get-azrelayapiwcfrelay
schema: 2.0.0
---

# Get-AzRelayApiWcfRelay
...
### List (Default)
```
Get-AzRelayApiWcfRelay -NamespaceName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRelayApiWcfRelay -NamespaceName <String> -RelayName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRelayApiWcfRelay -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
