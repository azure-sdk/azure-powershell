...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/get-azrelayapihybridconnection
schema: 2.0.0
---

# Get-AzRelayApiHybridConnection
...
### List (Default)
```
Get-AzRelayApiHybridConnection -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRelayApiHybridConnection -Name <String> -NamespaceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRelayApiHybridConnection -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
