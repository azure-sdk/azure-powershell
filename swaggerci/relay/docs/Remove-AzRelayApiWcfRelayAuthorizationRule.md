...
online version: https://docs.microsoft.com/en-us/powershell/module/az.relayapi/remove-azrelayapiwcfrelayauthorizationrule
schema: 2.0.0
---

# Remove-AzRelayApiWcfRelayAuthorizationRule
...
### Delete (Default)
```
Remove-AzRelayApiWcfRelayAuthorizationRule -AuthorizationRuleName <String> -NamespaceName <String>
...
### DeleteViaIdentity
```
Remove-AzRelayApiWcfRelayAuthorizationRule -InputObject <IRelayApiIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
