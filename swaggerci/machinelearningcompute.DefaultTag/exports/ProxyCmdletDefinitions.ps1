...
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningcompute/get-azmachinelearningcomputemachinelearningcomputeavailableoperation
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningcompute/new-azmachinelearningcomputeoperationalizationcluster
#>
...
INPUTOBJECT <IMachineLearningComputeIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Azure subscription ID.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningcompute/remove-azmachinelearningcomputeoperationalizationcluster
#>
...
INPUTOBJECT <IMachineLearningComputeIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Azure subscription ID.
.Link
https://learn.microsoft.com/powershell/module/az.machinelearningcompute/test-azmachinelearningcomputeoperationalizationclustersystemserviceupdateavailable
#>
