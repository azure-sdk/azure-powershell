...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview
{
    ...
    public partial class EncryptionV2 :
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2,
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2Internal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2KeyVaultProperties _keyVaultProperty;

        /// <summary>Key Vault input properties for encryption.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Origin(Microsoft.Azure.PowerShell.Cmdlets.Databricks.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2KeyVaultProperties KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.EncryptionV2KeyVaultProperties()); set => this._keyVaultProperty = value; }
        ...
        public string KeyVaultPropertyKeyName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2KeyVaultPropertiesInternal)KeyVaultProperty).KeyName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2KeyVaultPropertiesInternal)KeyVaultProperty).KeyName = value ?? null; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2Internal.KeySource { get => this._keySource; set { {_keySource = value;} } }

        /// <summary>Internal Acessors for KeyVaultProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2KeyVaultProperties Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2Internal.KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.EncryptionV2KeyVaultProperties()); set { {_keyVaultProperty = value;} } }
...

    {
        ...
        /// <summary>Key Vault input properties for encryption.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IEncryptionV2KeyVaultProperties KeyVaultProperty { get; set; }
        /// <summary>The name of KeyVault key.</summary>
        string KeyVaultPropertyKeyName { get; set; }
        /// <summary>The Uri of KeyVault.</summary>
        string KeyVaultPropertyKeyVaultUri { get; set; }
