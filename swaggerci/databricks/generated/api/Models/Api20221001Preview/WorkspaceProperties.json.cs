...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview
{
    ...
    public partial class WorkspaceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode node)
        {
        ...
        internal WorkspaceProperties(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject json)
        {
            ...
            {_createdBy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("createdBy"), out var __jsonCreatedBy) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.CreatedBy.FromJson(__jsonCreatedBy) : CreatedBy;}
            {_updatedBy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("updatedBy"), out var __jsonUpdatedBy) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.CreatedBy.FromJson(__jsonUpdatedBy) : UpdatedBy;}
            {_storageAccountIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("storageAccountIdentity"), out var __jsonStorageAccountIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.ManagedIdentityConfiguration.FromJson(__jsonStorageAccountIdentity) : StorageAccountIdentity;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.WorkspacePropertiesEncryption.FromJson(__jsonEncryption) : Encryption;}
            ...
            {_authorization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonArray>("authorizations"), out var __jsonAuthorizations) ? If( __jsonAuthorizations as Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceProviderAuthorization[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceProviderAuthorization) (Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.WorkspaceProviderAuthorization.FromJson(__u) )) ))() : null : Authorization;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IPrivateEndpointConnection[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IPrivateEndpointConnection) (Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.PrivateEndpointConnection.FromJson(__p) )) ))() : null : PrivateEndpointConnection;}
            ...
            {_parameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("parameters"), out var __jsonParameters) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.WorkspaceCustomParameters.FromJson(__jsonParameters) : Parameter;}
            AfterFromJson(json);
        }
    }
}