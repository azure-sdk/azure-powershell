...
online version: https://docs.microsoft.com/en-us/powershell/module/az.databricks/remove-azdatabricksaccessconnector
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDatabricksAccessConnector -ConnectorName <String> -ResourceGroupName <String>
