...
online version: https://docs.microsoft.com/en-us/powershell/module/az.databricks/update-azdatabricksaccessconnector
schema: 2.0.0
---
...
```
Update-AzDatabricksAccessConnector -ConnectorName <String> -ResourceGroupName <String>
...
```
Update-AzDatabricksAccessConnector -ConnectorName <String> -ResourceGroupName <String>
 -Parameter <IAccessConnectorUpdate> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
...
### UpdateViaIdentity1
```
Update-AzDatabricksAccessConnector -InputObject <IDatabricksIdentity> -Parameter <IAccessConnectorUpdate>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220401Preview.IAccessConnectorUpdate
