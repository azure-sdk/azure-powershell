...
New-AzDatabricksWorkspace -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-Authorization <IWorkspaceProviderAuthorization[]>] [-DiskEncryptionSetId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220901Preview.IWorkspaceProviderAuthorization[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20220901Preview.IWorkspaceCustomParameters
Parameter Sets: (All)
Aliases:
