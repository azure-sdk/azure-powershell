...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceProviderAuthorization[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20221001Preview.IWorkspaceCustomParameters
Parameter Sets: (All)
Aliases:
