...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30
{
    ...
    public partial class UserAssignedIdentitiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <see cref="sourceValue"/> parameter to the <see cref="UserAssignedIdentities"
        /// type/>.
        /// </summary>
        ...
        /// an instance of <see cref="UserAssignedIdentities" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.IUserAssignedIdentities ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api30.IUserAssignedIdentities).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
