...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview
{
    ...
    public partial class ConnectionDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IConnectionDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IConnectionDetailsInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IConnectionDetailsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LinkIdentifier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IConnectionDetailsInternal.LinkIdentifier { get => this._linkIdentifier; set { {_linkIdentifier = value;} } }

        /// <summary>Internal Acessors for MemberName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IConnectionDetailsInternal.MemberName { get => this._memberName; set { {_memberName = value;} } }

        /// <summary>Internal Acessors for PrivateIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IConnectionDetailsInternal.PrivateIPAddress { get => this._privateIPAddress; set { {_privateIPAddress = value;} } }
