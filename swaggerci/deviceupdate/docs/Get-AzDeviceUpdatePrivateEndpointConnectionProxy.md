...
online version: https://docs.microsoft.com/en-us/powershell/module/az.deviceupdate/get-azdeviceupdateprivateendpointconnectionproxy
schema: 2.0.0
---
...
### List (Default)
```
Get-AzDeviceUpdatePrivateEndpointConnectionProxy -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDeviceUpdatePrivateEndpointConnectionProxy -AccountName <String> -Id <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDeviceUpdatePrivateEndpointConnectionProxy -InputObject <IDeviceUpdateIdentity>
