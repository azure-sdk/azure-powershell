...
online version: https://docs.microsoft.com/en-us/powershell/module/az.deviceupdate/remove-azdeviceupdateprivateendpointconnectionproxy
schema: 2.0.0
---

# Remove-AzDeviceUpdatePrivateEndpointConnectionProxy
...
### Delete (Default)
```
Remove-AzDeviceUpdatePrivateEndpointConnectionProxy -AccountName <String> -Id <String>
...
### DeleteViaIdentity
```
Remove-AzDeviceUpdatePrivateEndpointConnectionProxy -InputObject <IDeviceUpdateIdentity>
