...
New-AzDeviceUpdateAccount -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-PublicNetworkAccess <PublicNetworkAccess>] [-Sku <Sku>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20220401Preview.IPrivateEndpointConnection[]
Parameter Sets: (All)
Aliases:
