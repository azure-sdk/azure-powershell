...
namespace Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState Cancelled = @"Cancelled";

        public static Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState ConfirmedBilling = @"ConfirmedBilling";

        public static Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState Created = @"Created";

        public static Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState PendingBilling = @"PendingBilling";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
