...
online version: https://docs.microsoft.com/en-us/powershell/module/az.benefitsrp/get-azbenefitsrpsavingsplanorderalias
schema: 2.0.0
---

# Get-AzBenefitsRpSavingsPlanOrderAlias
...
### Get (Default)
```
Get-AzBenefitsRpSavingsPlanOrderAlias -Name <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzBenefitsRpSavingsPlanOrderAlias -InputObject <IBenefitsRpIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
