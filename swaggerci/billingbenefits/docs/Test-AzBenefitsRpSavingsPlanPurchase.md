...
online version: https://docs.microsoft.com/en-us/powershell/module/az.benefitsrp/test-azbenefitsrpsavingsplanpurchase
schema: 2.0.0
---

# Test-AzBenefitsRpSavingsPlanPurchase
...
```
Test-AzBenefitsRpSavingsPlanPurchase [-Benefit <ISavingsPlanOrderAliasModel[]>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Validate
```
Test-AzBenefitsRpSavingsPlanPurchase -Body <ISavingsPlanPurchaseValidateRequest> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Models.Api20221101.ISavingsPlanOrderAliasModel[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Models.Api20221101.ISavingsPlanPurchaseValidateRequest
