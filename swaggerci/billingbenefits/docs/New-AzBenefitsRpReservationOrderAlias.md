...
online version: https://docs.microsoft.com/en-us/powershell/module/az.benefitsrp/new-azbenefitsrpreservationorderalias
schema: 2.0.0
---

# New-AzBenefitsRpReservationOrderAlias
...
```
New-AzBenefitsRpReservationOrderAlias -Name <String> [-AppliedScopePropertyAppliedScopeDisplayName <String>]
 ...
 [-ReservedResourceType <ReservedResourceType>] [-SkuName <String>] [-Term <SavingsPlanTerm>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.InstanceFlexibility
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.ReservedResourceType
Parameter Sets: (All)
Aliases:
