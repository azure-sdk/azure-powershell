...
online version: https://docs.microsoft.com/en-us/powershell/module/az.benefitsrp/new-azbenefitsrpsavingsplanorderalias
schema: 2.0.0
---

# New-AzBenefitsRpSavingsPlanOrderAlias
...
```
New-AzBenefitsRpSavingsPlanOrderAlias -Name <String> [-AppliedScopePropertyAppliedScopeDisplayName <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.BillingPlan
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.CommitmentGrain
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.BenefitsRp.Support.SavingsPlanTerm
Parameter Sets: (All)
Aliases:
