...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpreservationorderalias
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingplan
#>
...
INPUTOBJECT <IBillingBenefitsRpIdentity>: Identity Parameter
  ...
  [SavingsPlanOrderId <String>]: Order ID of the savings plan
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingsplanorderalias
#>
...
INPUTOBJECT <IBillingBenefitsRpIdentity>: Identity Parameter
  ...
  [SavingsPlanOrderId <String>]: Order ID of the savings plan
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingsplanorder
#>
...
INPUTOBJECT <IBillingBenefitsRpIdentity>: Identity Parameter
  ...
  [SavingsPlanOrderId <String>]: Order ID of the savings plan
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingsplan
#>
...
INPUTOBJECT <IBillingBenefitsRpIdentity>: Identity Parameter
  ...
  [SavingsPlanOrderId <String>]: Order ID of the savings plan
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/invoke-azbillingbenefitsrpelevatesavingplanorder
#>
...
Microsoft.Azure.PowerShell.Cmdlets.BillingBenefitsRp.Models.Api20221101.IReservationOrderAliasResponse
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/new-azbillingbenefitsrpreservationorderalias
#>
...
Microsoft.Azure.PowerShell.Cmdlets.BillingBenefitsRp.Models.Api20221101.ISavingsPlanOrderAliasModel
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/new-azbillingbenefitsrpsavingsplanorderalias
#>
...
BODY <ISavingsPlanPurchaseValidateRequest>: .
  [Benefit <ISavingsPlanOrderAliasModel[]>]: 
    ...
    [Term <Term?>]: Represent benefit term in ISO 8601 format.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/test-azbillingbenefitsrppurchase
#>
...
INPUTOBJECT <IBillingBenefitsRpIdentity>: Identity Parameter
  ...
  [SavingsPlanOrderId <String>]: Order ID of the savings plan
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/test-azbillingbenefitsrpsavingplanupdate
#>
...
INPUTOBJECT <IBillingBenefitsRpIdentity>: Identity Parameter
  ...
  [SavingsPlanOrderId <String>]: Order ID of the savings plan
.Link
https://docs.microsoft.com/en-us/powershell/module/az.billingbenefitsrp/update-azbillingbenefitsrpsavingsplan
#>
