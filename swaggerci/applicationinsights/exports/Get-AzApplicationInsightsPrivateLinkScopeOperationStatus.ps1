...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivatelinkscopeoperationstatus
#>
function Get-AzApplicationInsightsPrivateLinkScopeOperationStatus {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.IOperationStatus])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScopeOperationStatus_Get';
            GetViaIdentity = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScopeOperationStatus_GetViaIdentity';
        }
