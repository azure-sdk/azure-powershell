...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/new-azapplicationinsightsprivateendpointconnection
#>
function New-AzApplicationInsightsPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20.IPrivateEndpointConnection])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus])]
    [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ApplicationInsights.private\New-AzApplicationInsightsPrivateEndpointConnection_CreateExpanded';
        }
