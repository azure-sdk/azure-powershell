...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivatelinkscopedresource
#>
function Get-AzApplicationInsightsPrivateLinkScopedResource {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScopedResource_Get';
            GetViaIdentity = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScopedResource_GetViaIdentity';
            List = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScopedResource_List';
        }
