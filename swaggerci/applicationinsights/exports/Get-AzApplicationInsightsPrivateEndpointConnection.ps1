...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivateendpointconnection
#>
function Get-AzApplicationInsightsPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateEndpointConnection_Get';
            GetViaIdentity = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateEndpointConnection_GetViaIdentity';
            List = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateEndpointConnection_List';
        }
