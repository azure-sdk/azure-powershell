...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsprivateendpointconnection
#>
function Remove-AzApplicationInsightsPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ApplicationInsights.private\Remove-AzApplicationInsightsPrivateEndpointConnection_Delete';
            DeleteViaIdentity = 'Az.ApplicationInsights.private\Remove-AzApplicationInsightsPrivateEndpointConnection_DeleteViaIdentity';
        }
