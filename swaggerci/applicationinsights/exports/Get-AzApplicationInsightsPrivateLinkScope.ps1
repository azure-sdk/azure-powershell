...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivatelinkscope
#>
function Get-AzApplicationInsightsPrivateLinkScope {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScope_Get';
            GetViaIdentity = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScope_GetViaIdentity';
            List = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScope_List';
            List1 = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkScope_List1';
        }
