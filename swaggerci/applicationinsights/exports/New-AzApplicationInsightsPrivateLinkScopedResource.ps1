...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.IScopedResource
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/new-azapplicationinsightsprivatelinkscopedresource
#>
function New-AzApplicationInsightsPrivateLinkScopedResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.IScopedResource])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ApplicationInsights.private\New-AzApplicationInsightsPrivateLinkScopedResource_CreateExpanded';
        }
