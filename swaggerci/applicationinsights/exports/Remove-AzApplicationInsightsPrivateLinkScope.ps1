...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsprivatelinkscope
#>
function Remove-AzApplicationInsightsPrivateLinkScope {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ApplicationInsights.private\Remove-AzApplicationInsightsPrivateLinkScope_Delete';
            DeleteViaIdentity = 'Az.ApplicationInsights.private\Remove-AzApplicationInsightsPrivateLinkScope_DeleteViaIdentity';
        }
