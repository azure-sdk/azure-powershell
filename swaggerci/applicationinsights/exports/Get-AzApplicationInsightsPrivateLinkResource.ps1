...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivatelinkresource
#>
function Get-AzApplicationInsightsPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20.IPrivateLinkResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkResource_Get';
            GetViaIdentity = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkResource_GetViaIdentity';
            List = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsPrivateLinkResource_List';
        }
