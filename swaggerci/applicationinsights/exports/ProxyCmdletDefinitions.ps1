...
INPUTOBJECT <IApplicationInsightsIdentity>: Identity Parameter
  ...
  [WorkItemConfigId <String>]: The unique work item configuration Id. This can be either friendly name of connector as defined in connector configuration
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsprivatelinkscopedresource
#>
function Remove-AzApplicationInsightsPrivateLinkScopedResource {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Delete', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Delete', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ApplicationInsights.private\Remove-AzApplicationInsightsPrivateLinkScopedResource_Delete';
            DeleteViaIdentity = 'Az.ApplicationInsights.private\Remove-AzApplicationInsightsPrivateLinkScopedResource_DeleteViaIdentity';
        }
        if (('Delete') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
INPUTOBJECT <IApplicationInsightsIdentity>: Identity Parameter
  ...
  [WorkItemConfigId <String>]: The unique work item configuration Id. This can be either friendly name of connector as defined in connector configuration
.Link
https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/update-azapplicationinsightsprivatelinkscopetag
#>
function Update-AzApplicationInsightsPrivateLinkScopeTag {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.IAzureMonitorPrivateLinkScope])]
[CmdletBinding(DefaultParameterSetName='UpdateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='UpdateExpanded', Mandatory)]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.ITagsResourcePrivateLinkScopeTags]))]
    [System.Collections.Hashtable]
    # Resource tags
    ${Tag},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ApplicationInsights.private\Update-AzApplicationInsightsPrivateLinkScopeTag_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ApplicationInsights.private\Update-AzApplicationInsightsPrivateLinkScopeTag_UpdateViaIdentityExpanded';
        }
        if (('UpdateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
