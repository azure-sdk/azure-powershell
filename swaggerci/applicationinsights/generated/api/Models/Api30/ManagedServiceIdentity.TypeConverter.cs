...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api30
{
    ...
    public partial class ManagedServiceIdentityTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <see cref="sourceValue"/> parameter to the <see cref="ManagedServiceIdentity"
        /// type/>.
        /// </summary>
        ...
        /// an instance of <see cref="ManagedServiceIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api30.IManagedServiceIdentity ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api30.IManagedServiceIdentity).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
