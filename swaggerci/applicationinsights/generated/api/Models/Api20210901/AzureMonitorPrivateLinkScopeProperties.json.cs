...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901
{
    ...
    public partial class AzureMonitorPrivateLinkScopeProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonObject into a new instance of <see cref="AzureMonitorPrivateLinkScopeProperties" />.
        /// </summary>
        ...
        internal AzureMonitorPrivateLinkScopeProperties(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_accessModeSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonObject>("accessModeSettings"), out var __jsonAccessModeSettings) ? Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.AccessModeSettings.FromJson(__jsonAccessModeSettings) : AccessModeSetting;}
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.IAzureMonitorPrivateLinkScopeProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20210901.IAzureMonitorPrivateLinkScopeProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonObject json ? new AzureMonitorPrivateLinkScopeProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureMonitorPrivateLinkScopeProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureMonitorPrivateLinkScopeProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._accessModeSetting ? (Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Runtime.Json.JsonNode) this._accessModeSetting.ToJson(null,serializationMode) : null, "accessModeSettings" ,container.Add );
