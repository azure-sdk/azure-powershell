...
namespace Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Support.PrivateEndpointServiceConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
