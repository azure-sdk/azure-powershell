...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/new-azapplicationinsightsworkbooktemplate
schema: 2.0.0
---
...
```
New-AzApplicationInsightsWorkbookTemplate -ResourceGroupName <String> -ResourceName <String>
 -Location <String> [-SubscriptionId <String>] [-Author <String>] [-Gallery <IWorkbookTemplateGallery[]>]
