...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/update-azapplicationinsightsprivatelinkscopetag
schema: 2.0.0
---

# Update-AzApplicationInsightsPrivateLinkScopeTag
...
```
Update-AzApplicationInsightsPrivateLinkScopeTag -ResourceGroupName <String> -ScopeName <String>
...
```
Update-AzApplicationInsightsPrivateLinkScopeTag -InputObject <IApplicationInsightsIdentity> [-Tag <Hashtable>]
