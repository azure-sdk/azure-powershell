...
Module Guid: 94a551c3-0aab-4fc5-9f90-f956159ad1c9
...
### [Get-AzApplicationInsightsPrivateEndpointConnection](Get-AzApplicationInsightsPrivateEndpointConnection.md)
Gets a private endpoint connection.

### [Get-AzApplicationInsightsPrivateLinkResource](Get-AzApplicationInsightsPrivateLinkResource.md)
Gets the private link resources that need to be created for a Azure Monitor PrivateLinkScope.

### [Get-AzApplicationInsightsPrivateLinkScope](Get-AzApplicationInsightsPrivateLinkScope.md)
Returns a Azure Monitor PrivateLinkScope.

### [Get-AzApplicationInsightsPrivateLinkScopedResource](Get-AzApplicationInsightsPrivateLinkScopedResource.md)
Gets a scoped resource in a private link scope.

### [Get-AzApplicationInsightsPrivateLinkScopeOperationStatus](Get-AzApplicationInsightsPrivateLinkScopeOperationStatus.md)
...
### [New-AzApplicationInsightsPrivateEndpointConnection](New-AzApplicationInsightsPrivateEndpointConnection.md)
Approve or reject a private endpoint connection with a given name.

### [New-AzApplicationInsightsPrivateLinkScope](New-AzApplicationInsightsPrivateLinkScope.md)
Creates (or updates) a Azure Monitor PrivateLinkScope.
Note: You cannot specify a different value for InstrumentationKey nor AppId in the Put operation.

### [New-AzApplicationInsightsPrivateLinkScopedResource](New-AzApplicationInsightsPrivateLinkScopedResource.md)
Approve or reject a private endpoint connection with a given name.
...
### [Remove-AzApplicationInsightsPrivateEndpointConnection](Remove-AzApplicationInsightsPrivateEndpointConnection.md)
Deletes a private endpoint connection with a given name.

### [Remove-AzApplicationInsightsPrivateLinkScope](Remove-AzApplicationInsightsPrivateLinkScope.md)
Deletes a Azure Monitor PrivateLinkScope.

### [Remove-AzApplicationInsightsPrivateLinkScopedResource](Remove-AzApplicationInsightsPrivateLinkScopedResource.md)
Deletes a private endpoint connection with a given name.
...
### [Update-AzApplicationInsightsPrivateLinkScopeTag](Update-AzApplicationInsightsPrivateLinkScopeTag.md)
