...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsworkbooktemplate
schema: 2.0.0
---
...
### Get
```
Get-AzApplicationInsightsWorkbookTemplate -ResourceGroupName <String> -ResourceName <String>
