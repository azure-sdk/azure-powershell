...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivateendpointconnection
schema: 2.0.0
---

# Get-AzApplicationInsightsPrivateEndpointConnection
...
### List (Default)
```
Get-AzApplicationInsightsPrivateEndpointConnection -ResourceGroupName <String> -ScopeName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzApplicationInsightsPrivateEndpointConnection -Name <String> -ResourceGroupName <String>
 -ScopeName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzApplicationInsightsPrivateEndpointConnection -InputObject <IApplicationInsightsIdentity>
