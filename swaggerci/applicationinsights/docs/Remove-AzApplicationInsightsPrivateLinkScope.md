...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsprivatelinkscope
schema: 2.0.0
---

# Remove-AzApplicationInsightsPrivateLinkScope
...
### Delete (Default)
```
Remove-AzApplicationInsightsPrivateLinkScope -ResourceGroupName <String> -ScopeName <String>
...
### DeleteViaIdentity
```
Remove-AzApplicationInsightsPrivateLinkScope -InputObject <IApplicationInsightsIdentity>
