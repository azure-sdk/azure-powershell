...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsworkbookrevision
schema: 2.0.0
---
...
### List (Default)
```
Get-AzApplicationInsightsWorkbookRevision -ResourceGroupName <String> -ResourceName <String>
...
```
Get-AzApplicationInsightsWorkbookRevision -ResourceGroupName <String> -ResourceName <String>
 -RevisionId <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
