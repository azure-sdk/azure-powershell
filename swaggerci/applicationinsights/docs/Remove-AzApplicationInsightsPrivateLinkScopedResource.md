...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/remove-azapplicationinsightsprivatelinkscopedresource
schema: 2.0.0
---

# Remove-AzApplicationInsightsPrivateLinkScopedResource
...
### Delete (Default)
```
Remove-AzApplicationInsightsPrivateLinkScopedResource -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzApplicationInsightsPrivateLinkScopedResource -InputObject <IApplicationInsightsIdentity>
