...
online version: https://docs.microsoft.com/en-us/powershell/module/az.applicationinsights/get-azapplicationinsightsprivatelinkscopeoperationstatus
schema: 2.0.0
---

# Get-AzApplicationInsightsPrivateLinkScopeOperationStatus
...
### Get (Default)
```
Get-AzApplicationInsightsPrivateLinkScopeOperationStatus -AsyncOperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzApplicationInsightsPrivateLinkScopeOperationStatus -InputObject <IApplicationInsightsIdentity>
