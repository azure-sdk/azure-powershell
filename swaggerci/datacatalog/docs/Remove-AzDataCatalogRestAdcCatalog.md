...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datacatalogrest/remove-azdatacatalogrestadccatalog
schema: 2.0.0
---

# Remove-AzDataCatalogRestAdcCatalog
...
### Delete (Default)
```
Remove-AzDataCatalogRestAdcCatalog -CatalogName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDataCatalogRestAdcCatalog -InputObject <IDataCatalogRestIdentity> [-DefaultProfile <PSObject>]
