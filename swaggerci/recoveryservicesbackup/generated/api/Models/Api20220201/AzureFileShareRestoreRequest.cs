...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201
{
    ...
    public partial class AzureFileShareRestoreRequest :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IAzureFileShareRestoreRequest,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IAzureFileShareRestoreRequestInternal,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfo Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IAzureFileShareRestoreRequestInternal.TargetDetail { get => (this._targetDetail = this._targetDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.TargetAfsRestoreInfo()); set { {_targetDetail = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IRestoreFileSpecs[] _restoreFileSpec;

        /// <summary>
        /// List of Source Files/Folders(which need to recover) and TargetFolderPath details
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IRestoreFileSpecs[] RestoreFileSpec { get => this._restoreFileSpec; set => this._restoreFileSpec = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfo _targetDetail;

        /// <summary>Target File Share Details</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfo TargetDetail { get => (this._targetDetail = this._targetDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.TargetAfsRestoreInfo()); set => this._targetDetail = value; }
        ...
        public string TargetDetailName { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfoInternal)TargetDetail).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfoInternal)TargetDetail).Name = value ?? null; }

        /// <summary>Target file share resource ARM ID</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string TargetDetailTargetResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfoInternal)TargetDetail).TargetResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfoInternal)TargetDetail).TargetResourceId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IRestoreRequest
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IRestoreFileSpecs) })]
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IRestoreFileSpecs[] RestoreFileSpec { get; set; }
        /// <summary>Restore Type (FullShareRestore or ItemLevelRestore)</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.IRestoreRequestInternal
    {
        ...
        string SourceResourceId { get; set; }
        /// <summary>Target File Share Details</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220201.ITargetAfsRestoreInfo TargetDetail { get; set; }
        /// <summary>File share name</summary>
        string TargetDetailName { get; set; }
        /// <summary>Target file share resource ARM ID</summary>
        string TargetDetailTargetResourceId { get; set; }
