...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview
{
    ...
    public partial class ExtendedProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IExtendedPropertiesInternal
    {

        /// <summary>Backing field for <see cref="DiskExclusionProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IDiskExclusionProperties _diskExclusionProperty;

        /// <summary>Extended Properties for Disk Exclusion.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IDiskExclusionProperties DiskExclusionProperty { get => (this._diskExclusionProperty = this._diskExclusionProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.DiskExclusionProperties()); set => this._diskExclusionProperty = value; }
        ...
        public int[] DiskExclusionPropertyDiskLunList { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IDiskExclusionPropertiesInternal)DiskExclusionProperty).DiskLunList; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IDiskExclusionPropertiesInternal)DiskExclusionProperty).DiskLunList = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IDiskExclusionProperties Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IExtendedPropertiesInternal.DiskExclusionProperty { get => (this._diskExclusionProperty = this._diskExclusionProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.DiskExclusionProperties()); set { {_diskExclusionProperty = value;} } }
    ...
    {
        /// <summary>Extended Properties for Disk Exclusion.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20220901Preview.IDiskExclusionProperties DiskExclusionProperty { get; set; }
        /// <summary>List of Disks' Logical Unit Numbers (LUN) to be used for VM Protection.</summary>
        int[] DiskExclusionPropertyDiskLunList { get; set; }
        /// <summary>Flag to indicate whether DiskLunList is to be included/ excluded from backup.</summary>
        bool? DiskExclusionPropertyIsInclusionList { get; set; }
