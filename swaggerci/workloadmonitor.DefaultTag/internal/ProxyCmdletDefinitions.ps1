...
.Link
https://learn.microsoft.com/powershell/module/az.workloadmonitorapi/get-azworkloadmonitorapioperation
#>
function Get-AzWorkloadMonitorApiOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models.Api20200113Preview.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.WorkloadMonitorApi.private\Get-AzWorkloadMonitorApiOperation_List';
        }
