...
.Link
https://learn.microsoft.com/powershell/module/az.workloadmonitorapi/get-azworkloadmonitorapihealthmonitorstatechange
#>
...
begin {
    try {
        ...
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
        ...
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
            [Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
INPUTOBJECT <IWorkloadMonitorApiIdentity>: Identity Parameter
  ...
  [TimestampUnix <String>]: The timestamp of the state change (unix format).
.Link
https://learn.microsoft.com/powershell/module/az.workloadmonitorapi/get-azworkloadmonitorapihealthmonitor
#>
