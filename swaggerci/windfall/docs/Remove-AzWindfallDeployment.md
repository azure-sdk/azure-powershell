...
online version: https://docs.microsoft.com/en-us/powershell/module/az.windfall/remove-azwindfalldeployment
schema: 2.0.0
---

# Remove-AzWindfallDeployment
...
### Delete (Default)
```
Remove-AzWindfallDeployment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzWindfallDeployment -InputObject <IWindfallIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
