...
online version: https://docs.microsoft.com/en-us/powershell/module/az.windfall/update-azwindfalldeployment
schema: 2.0.0
---

# Update-AzWindfallDeployment
...
```
Update-AzWindfallDeployment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWindfallDeployment -InputObject <IWindfallIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
