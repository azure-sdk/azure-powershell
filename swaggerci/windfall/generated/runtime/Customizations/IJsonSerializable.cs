...
using Microsoft.Azure.PowerShell.Cmdlets.Windfall.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.Windfall.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.Windfall.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.Windfall.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.Windfall.Runtime.JsonSerializable.ToJson(dict, null);
            }
