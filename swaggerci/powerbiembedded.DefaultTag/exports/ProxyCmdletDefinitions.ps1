...
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/get-azpowerbiembeddedavailableoperation
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/get-azpowerbiembeddedworkspacecollectionaccesskey
#>
...
INPUTOBJECT <IPowerBiEmbeddedIdentity>: Identity Parameter
  ...
  [WorkspaceCollectionName <String>]: Power BI Embedded Workspace Collection name
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/get-azpowerbiembeddedworkspacecollection
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/get-azpowerbiembeddedworkspace
#>
...
INPUTOBJECT <IPowerBiEmbeddedIdentity>: Identity Parameter
  ...
  [WorkspaceCollectionName <String>]: Power BI Embedded Workspace Collection name
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/move-azpowerbiembeddedworkspacecollection
#>
...
INPUTOBJECT <IPowerBiEmbeddedIdentity>: Identity Parameter
  ...
  [WorkspaceCollectionName <String>]: Power BI Embedded Workspace Collection name
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/remove-azpowerbiembeddedworkspacecollection
#>
...
INPUTOBJECT <IPowerBiEmbeddedIdentity>: Identity Parameter
  ...
  [WorkspaceCollectionName <String>]: Power BI Embedded Workspace Collection name
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/test-azpowerbiembeddedworkspacecollectionnameavailability
#>
...
INPUTOBJECT <IPowerBiEmbeddedIdentity>: Identity Parameter
  ...
  [WorkspaceCollectionName <String>]: Power BI Embedded Workspace Collection name
.Link
https://learn.microsoft.com/powershell/module/az.powerbiembedded/update-azpowerbiembeddedworkspacecollection
#>
