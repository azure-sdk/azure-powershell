...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.PowerBiEmbedded.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.PowerBiEmbedded.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: PowerBiEmbedded cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.PowerBiEmbedded.format.ps1xml'
