...
online version: https://docs.microsoft.com/en-us/powershell/module/az.testbase/get-aztestbasebillinghubservicefreehourbalance
schema: 2.0.0
---

# Get-AzTestBaseBillingHubServiceFreeHourBalance
...
### Get (Default)
```
Get-AzTestBaseBillingHubServiceFreeHourBalance -ResourceGroupName <String> -TestBaseAccountName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzTestBaseBillingHubServiceFreeHourBalance -InputObject <ITestBaseIdentity> [-DefaultProfile <PSObject>]
