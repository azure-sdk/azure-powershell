...
online version: https://docs.microsoft.com/en-us/powershell/module/az.testbase/get-aztestbasebillinghubserviceusage
schema: 2.0.0
---

# Get-AzTestBaseBillingHubServiceUsage
...
### GetExpanded (Default)
```
Get-AzTestBaseBillingHubServiceUsage -ResourceGroupName <String> -TestBaseAccountName <String>
 -EndTimeStamp <DateTime> -StartTimeStamp <DateTime> [-SubscriptionId <String[]>] [-PageIndex <Int32>]
 [-PageSize <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Get
```
Get-AzTestBaseBillingHubServiceUsage -ResourceGroupName <String> -TestBaseAccountName <String>
 -GetUsageRequest <IBillingHubGetUsageRequest> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzTestBaseBillingHubServiceUsage -InputObject <ITestBaseIdentity>
 -GetUsageRequest <IBillingHubGetUsageRequest> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### GetViaIdentityExpanded
```
Get-AzTestBaseBillingHubServiceUsage -InputObject <ITestBaseIdentity> -EndTimeStamp <DateTime>
 -StartTimeStamp <DateTime> [-PageIndex <Int32>] [-PageSize <Int32>] [-DefaultProfile <PSObject>] [-Confirm]
...
### -GetUsageRequest
.
To construct, see NOTES section for GETUSAGEREQUEST properties and create a hash table.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.IBillingHubGetUsageRequest
...
GETUSAGEREQUEST <IBillingHubGetUsageRequest>: .
