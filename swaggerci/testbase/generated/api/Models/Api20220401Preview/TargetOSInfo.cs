...
namespace Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview
{
    ...
    public partial class TargetOSInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ITargetOSInfoInternal
    {

        /// <summary>Backing field for <see cref="BaselineOSs" /> property.</summary>
        private string[] _baselineOSs;

        /// <summary>Specifies the baseline OSs to be tested.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Origin(Microsoft.Azure.PowerShell.Cmdlets.TestBase.PropertyOrigin.Owned)]
        public string[] BaselineOSs { get => this._baselineOSs; set => this._baselineOSs = value; }
