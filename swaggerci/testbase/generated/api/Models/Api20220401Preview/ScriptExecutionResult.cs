...
namespace Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview
{
    ...
    public partial class ScriptExecutionResult :
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.IScriptExecutionResult,
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.IScriptExecutionResultInternal
    {
        ...
        /// <summary>Backing field for <see cref="StderrLogFileName" /> property.</summary>
        private string _stderrLogFileName;

        /// <summary>The stderr log file name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Origin(Microsoft.Azure.PowerShell.Cmdlets.TestBase.PropertyOrigin.Owned)]
        public string StderrLogFileName { get => this._stderrLogFileName; set => this._stderrLogFileName = value; }

        /// <summary>Backing field for <see cref="StdoutLogFileName" /> property.</summary>
        private string _stdoutLogFileName;

        /// <summary>The stdout log file name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Origin(Microsoft.Azure.PowerShell.Cmdlets.TestBase.PropertyOrigin.Owned)]
        public string StdoutLogFileName { get => this._stdoutLogFileName; set => this._stdoutLogFileName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string StderrLogFileName { get; set; }
        /// <summary>The stdout log file name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string StdoutLogFileName { get; set; }
        /// <summary>Whether the script execution is timed out.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Info(
        Required = false,
        ReadOnly = false,
