...
namespace Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview
{
    ...
    public partial class Test :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ITestInternal
    {

        /// <summary>Backing field for <see cref="Command" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ICommand[] _command;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ICommand[] Command { get => this._command; set => this._command = value; }
        ...
        /// <summary>Internal Acessors for ValidationResultId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ITestInternal.ValidationResultId { get => this._validationResultId; set { {_validationResultId = value;} } }

        /// <summary>Internal Acessors for ValidationRunStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Support.ValidationRunStatus? Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ITestInternal.ValidationRunStatus { get => this._validationRunStatus; set { {_validationRunStatus = value;} } }
        ...
        /// <summary>Backing field for <see cref="ValidationResultId" /> property.</summary>
        private string _validationResultId;

        /// <summary>Resource identifier of the validation test result.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Origin(Microsoft.Azure.PowerShell.Cmdlets.TestBase.PropertyOrigin.Owned)]
        public string ValidationResultId { get => this._validationResultId; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ICommand) })]
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20220401Preview.ICommand[] Command { get; set; }
        /// <summary>Indicates if this test is active.It doesn't schedule test for not active Test.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.TestBase.Support.TestType Type { get; set; }
        /// <summary>Resource identifier of the validation test result.</summary>
        string ValidationResultId { get; set; }
        /// <summary>The status of the validation run of the package.</summary>
