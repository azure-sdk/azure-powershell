...
namespace Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview
{
    ...
    public partial class OSUpdatesTestSummary
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.IOSUpdatesTestSummary.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.IOSUpdatesTestSummary.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.IOSUpdatesTestSummary FromJson(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject json ? new OSUpdatesTestSummary(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject into a new instance of <see cref="OSUpdatesTestSummary" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OSUpdatesTestSummary(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject json)
        {
            ...
            {_oSUpdateTestSummary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonArray>("osUpdateTestSummaries"), out var __jsonOSUpdateTestSummaries) ? If( __jsonOSUpdateTestSummaries as Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.IOSUpdateTestSummary[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.IOSUpdateTestSummary) (Microsoft.Azure.PowerShell.Cmdlets.TestBase.Models.Api20201216Preview.OSUpdateTestSummary.FromJson(__u) )) ))() : null : OSUpdateTestSummary;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OSUpdatesTestSummary" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OSUpdatesTestSummary" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._oSUpdateTestSummary)
            {
                var __w = new Microsoft.Azure.PowerShell.Cmdlets.TestBase.Runtime.Json.XNodeArray();
                foreach( var __x in this._oSUpdateTestSummary )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("osUpdateTestSummaries",__w);
            }
