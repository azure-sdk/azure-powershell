...
namespace Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models.Api20200113Preview
{
    ...
    public partial class ErrorDetails
    {
        ...
        /// <summary>
        /// <c>AfterToJson</c> will be called after the json erialization has finished, allowing customization of the <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonObject"
        /// /> before it is returned. Implement this method in a partial class to enable this behavior
        /// </summary>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonObject into a new instance of <see cref="ErrorDetails" />.
        /// </summary>
        ...
        internal ErrorDetails(Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonObject json)
        {
            ...
            {_code = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonString>("code"), out var __jsonCode) ? (string)__jsonCode : (string)Code;}
            {_message = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonString>("message"), out var __jsonMessage) ? (string)__jsonMessage : (string)Message;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Models.Api20200113Preview.IErrorDetails.
        /// </summary>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ErrorDetails" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ErrorDetails" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WorkloadMonitorApi.Runtime.Json.JsonNode" />.
        /// </returns>
