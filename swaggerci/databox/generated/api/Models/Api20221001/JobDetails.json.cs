...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001
{
    ...
    public partial class JobDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IJobDetails.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IJobDetails interface is polymorphic, and the
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IJobDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IJobDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal JobDetails(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_contactDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("contactDetails"), out var __jsonContactDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.ContactDetails.FromJson(__jsonContactDetails) : ContactDetail;}
            {_shippingAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("shippingAddress"), out var __jsonShippingAddress) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.ShippingAddress.FromJson(__jsonShippingAddress) : ShippingAddress;}
            {_deliveryPackage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("deliveryPackage"), out var __jsonDeliveryPackage) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.PackageShippingDetails.FromJson(__jsonDeliveryPackage) : DeliveryPackage;}
            {_returnPackage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("returnPackage"), out var __jsonReturnPackage) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.PackageShippingDetails.FromJson(__jsonReturnPackage) : ReturnPackage;}
            {_preference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("preferences"), out var __jsonPreferences) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.Preferences.FromJson(__jsonPreferences) : Preference;}
            {_reverseShippingDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("reverseShippingDetails"), out var __jsonReverseShippingDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.ReverseShippingDetails.FromJson(__jsonReverseShippingDetails) : ReverseShippingDetail;}
            {_deviceErasureDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("deviceErasureDetails"), out var __jsonDeviceErasureDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DeviceErasureDetails.FromJson(__jsonDeviceErasureDetails) : DeviceErasureDetail;}
            {_keyEncryptionKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("keyEncryptionKey"), out var __jsonKeyEncryptionKey) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.KeyEncryptionKey.FromJson(__jsonKeyEncryptionKey) : KeyEncryptionKey;}
            {_lastMitigationActionOnJob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("lastMitigationActionOnJob"), out var __jsonLastMitigationActionOnJob) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.LastMitigationActionOnJob.FromJson(__jsonLastMitigationActionOnJob) : LastMitigationActionOnJob;}
            {_datacenterAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("datacenterAddress"), out var __jsonDatacenterAddress) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DatacenterAddressResponse.FromJson(__jsonDatacenterAddress) : DatacenterAddress;}
            {_jobStage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("jobStages"), out var __jsonJobStages) ? If( __jsonJobStages as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IJobStages[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IJobStages) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.JobStages.FromJson(__u) )) ))() : null : JobStage;}
            {_dataImportDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("dataImportDetails"), out var __jsonDataImportDetails) ? If( __jsonDataImportDetails as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataImportDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataImportDetails) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataImportDetails.FromJson(__p) )) ))() : null : DataImportDetail;}
            {_dataExportDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("dataExportDetails"), out var __jsonDataExportDetails) ? If( __jsonDataExportDetails as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataExportDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataExportDetails) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataExportDetails.FromJson(__k) )) ))() : null : DataExportDetail;}
            ...
            {_copyLogDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("copyLogDetails"), out var __jsonCopyLogDetails) ? If( __jsonCopyLogDetails as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.ICopyLogDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.ICopyLogDetails) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.CopyLogDetails.FromJson(__f) )) ))() : null : CopyLogDetail;}
