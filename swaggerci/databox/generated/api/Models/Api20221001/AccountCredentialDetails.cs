...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001
{
    ...
    public partial class AccountCredentialDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IAccountCredentialDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IAccountCredentialDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IAccountCredentialDetailsInternal.AccountConnectionString { get => this._accountConnectionString; set { {_accountConnectionString = value;} } }

        /// <summary>Internal Acessors for AccountName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IAccountCredentialDetailsInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for DataAccountType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IAccountCredentialDetailsInternal.DataAccountType { get => this._dataAccountType; set { {_dataAccountType = value;} } }

        /// <summary>Internal Acessors for ShareCredentialDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IShareCredentialDetails[] Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IAccountCredentialDetailsInternal.ShareCredentialDetail { get => this._shareCredentialDetail; set { {_shareCredentialDetail = value;} } }

        /// <summary>Backing field for <see cref="ShareCredentialDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IShareCredentialDetails[] _shareCredentialDetail;

        /// <summary>Per share level unencrypted access credentials.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IShareCredentialDetails[] ShareCredentialDetail { get => this._shareCredentialDetail; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IShareCredentialDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IShareCredentialDetails[] ShareCredentialDetail { get;  }
...

    {
        ...
        /// <summary>Per share level unencrypted access credentials.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IShareCredentialDetails[] ShareCredentialDetail { get; set; }
