...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001
{
    ...
    public partial class ExportDiskDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IExportDiskDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IExportDiskDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IExportDiskDetailsInternal.BackupManifestCloudPath { get => this._backupManifestCloudPath; set { {_backupManifestCloudPath = value;} } }

        /// <summary>Internal Acessors for ManifestFile</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IExportDiskDetailsInternal.ManifestFile { get => this._manifestFile; set { {_manifestFile = value;} } }

        /// <summary>Internal Acessors for ManifestHash</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IExportDiskDetailsInternal.ManifestHash { get => this._manifestHash; set { {_manifestHash = value;} } }
