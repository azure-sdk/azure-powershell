...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001
{
    ...
    public partial class DataBoxDiskJobDetails
    {
        ...
        internal DataBoxDiskJobDetails(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_preferredDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("preferredDisks"), out var __jsonPreferredDisks) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataBoxDiskJobDetailsPreferredDisks.FromJson(__jsonPreferredDisks) : PreferredDisk;}
            {_copyProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("copyProgress"), out var __jsonCopyProgress) ? If( __jsonCopyProgress as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskCopyProgress[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskCopyProgress) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataBoxDiskCopyProgress.FromJson(__u) )) ))() : null : CopyProgress;}
            {_granularCopyProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("granularCopyProgress"), out var __jsonGranularCopyProgress) ? If( __jsonGranularCopyProgress as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskGranularCopyProgress[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskGranularCopyProgress) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataBoxDiskGranularCopyProgress.FromJson(__p) )) ))() : null : GranularCopyProgress;}
            {_granularCopyLogDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("granularCopyLogDetails"), out var __jsonGranularCopyLogDetails) ? If( __jsonGranularCopyLogDetails as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskGranularCopyLogDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskGranularCopyLogDetails) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataBoxDiskGranularCopyLogDetails.FromJson(__k) )) ))() : null : GranularCopyLogDetail;}
            {_disksAndSizeDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("disksAndSizeDetails"), out var __jsonDisksAndSizeDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.DataBoxDiskJobDetailsDisksAndSizeDetails.FromJson(__jsonDisksAndSizeDetails) : DisksAndSizeDetail;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskJobDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskJobDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IDataBoxDiskJobDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
