...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class TransferConfigurationTransferAllDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferAllDetailsInternal
    {

        /// <summary>Backing field for <see cref="Include" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetails _include;

        /// <summary>Details to transfer all data.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetails Include { get => (this._include = this._include ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransferAllDetails()); set => this._include = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public bool? IncludeTransferAllBlob { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetailsInternal)Include).TransferAllBlob; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetailsInternal)Include).TransferAllBlob = value ?? default(bool); }

        /// <summary>To indicate if all Azure Files have to be transferred</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public bool? IncludeTransferAllFile { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetailsInternal)Include).TransferAllFile; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetailsInternal)Include).TransferAllFile = value ?? default(bool); }

        /// <summary>Internal Acessors for Include</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetails Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferAllDetailsInternal.Include { get => (this._include = this._include ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransferAllDetails()); set { {_include = value;} } }
    ...
    {
        /// <summary>Details to transfer all data.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetails Include { get; set; }
        /// <summary>Type of the account of data</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType? IncludeDataAccountType { get; set; }
        /// <summary>To indicate if all Azure blobs have to be transferred</summary>
        bool? IncludeTransferAllBlob { get; set; }
