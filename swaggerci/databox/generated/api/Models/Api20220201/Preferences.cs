...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class Preferences :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IPreferences,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IPreferencesInternal
    {

        /// <summary>Backing field for <see cref="EncryptionPreference" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IEncryptionPreferences _encryptionPreference;

        /// <summary>Preferences related to the Encryption.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IEncryptionPreferences EncryptionPreference { get => (this._encryptionPreference = this._encryptionPreference ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.EncryptionPreferences()); set => this._encryptionPreference = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IEncryptionPreferences Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IPreferencesInternal.EncryptionPreference { get => (this._encryptionPreference = this._encryptionPreference ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.EncryptionPreferences()); set { {_encryptionPreference = value;} } }

        /// <summary>Internal Acessors for TransportPreference</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransportPreferences Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IPreferencesInternal.TransportPreference { get => (this._transportPreference = this._transportPreference ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransportPreferences()); set { {_transportPreference = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransportPreferences _transportPreference;

        /// <summary>Preferences related to the shipment logistics of the sku.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransportPreferences TransportPreference { get => (this._transportPreference = this._transportPreference ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransportPreferences()); set => this._transportPreference = value; }
    ...
    {
        /// <summary>Preferences related to the Encryption.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IEncryptionPreferences EncryptionPreference { get; set; }
        /// <summary>Defines secondary layer of software-based encryption enablement.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DoubleEncryption? EncryptionPreferenceDoubleEncryption { get; set; }
        /// <summary>Preferred data center region.</summary>
        string[] PreferredDataCenterRegion { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.StorageAccountAccessTier[] StorageAccountAccessTierPreference { get; set; }
        /// <summary>Preferences related to the shipment logistics of the sku.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransportPreferences TransportPreference { get; set; }
        /// <summary>Indicates Shipment Logistics type that the customer preferred.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.TransportShipmentTypes? TransportPreferencePreferredShipmentType { get; set; }
