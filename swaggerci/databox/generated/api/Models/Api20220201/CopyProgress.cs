...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.AccountId { get => this._accountId; set { {_accountId = value;} } }

        /// <summary>Internal Acessors for BytesProcessed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.BytesProcessed { get => this._bytesProcessed; set { {_bytesProcessed = value;} } }

        /// <summary>Internal Acessors for DataAccountType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.DataAccountType { get => this._dataAccountType; set { {_dataAccountType = value;} } }

        /// <summary>Internal Acessors for DirectoriesErroredOut</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.DirectoriesErroredOut { get => this._directoriesErroredOut; set { {_directoriesErroredOut = value;} } }

        /// <summary>Internal Acessors for FilesErroredOut</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.FilesErroredOut { get => this._filesErroredOut; set { {_filesErroredOut = value;} } }

        /// <summary>Internal Acessors for FilesProcessed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.FilesProcessed { get => this._filesProcessed; set { {_filesProcessed = value;} } }

        /// <summary>Internal Acessors for InvalidDirectoriesProcessed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.InvalidDirectoriesProcessed { get => this._invalidDirectoriesProcessed; set { {_invalidDirectoriesProcessed = value;} } }

        /// <summary>Internal Acessors for InvalidFileBytesUploaded</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.InvalidFileBytesUploaded { get => this._invalidFileBytesUploaded; set { {_invalidFileBytesUploaded = value;} } }

        /// <summary>Internal Acessors for InvalidFilesProcessed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.InvalidFilesProcessed { get => this._invalidFilesProcessed; set { {_invalidFilesProcessed = value;} } }

        /// <summary>Internal Acessors for IsEnumerationInProgress</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.IsEnumerationInProgress { get => this._isEnumerationInProgress; set { {_isEnumerationInProgress = value;} } }

        /// <summary>Internal Acessors for RenamedContainerCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.RenamedContainerCount { get => this._renamedContainerCount; set { {_renamedContainerCount = value;} } }

        /// <summary>Internal Acessors for StorageAccountName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.StorageAccountName { get => this._storageAccountName; set { {_storageAccountName = value;} } }

        /// <summary>Internal Acessors for TotalBytesToProcess</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.TotalBytesToProcess { get => this._totalBytesToProcess; set { {_totalBytesToProcess = value;} } }

        /// <summary>Internal Acessors for TotalFilesToProcess</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.TotalFilesToProcess { get => this._totalFilesToProcess; set { {_totalFilesToProcess = value;} } }

        /// <summary>Internal Acessors for TransferType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.TransferType? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyProgressInternal.TransferType { get => this._transferType; set { {_transferType = value;} } }
