...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class TransferConfigurationTransferFilterDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferFilterDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferFilterDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferFilterDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal TransferConfigurationTransferFilterDetails(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_include = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("include"), out var __jsonInclude) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransferFilterDetails.FromJson(__jsonInclude) : Include;}
            AfterFromJson(json);
        }
    }
}