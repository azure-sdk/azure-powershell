...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class DataBoxHeavyAccountCopyLogDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDataBoxHeavyAccountCopyLogDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDataBoxHeavyAccountCopyLogDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyLogDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyLogDetails __copyLogDetails = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.CopyLogDetails();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDataBoxHeavyAccountCopyLogDetailsInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for CopyLogLink</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDataBoxHeavyAccountCopyLogDetailsInternal.CopyLogLink { get => this._copyLogLink; set { {_copyLogLink = value;} } }

        /// <summary>Internal Acessors for CopyVerboseLogLink</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDataBoxHeavyAccountCopyLogDetailsInternal.CopyVerboseLogLink { get => this._copyVerboseLogLink; set { {_copyVerboseLogLink = value;} } }
    ...
    public partial interface IDataBoxHeavyAccountCopyLogDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyLogDetails
    {
        /// <summary>Account name.</summary>
    ...
    internal partial interface IDataBoxHeavyAccountCopyLogDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ICopyLogDetailsInternal
    {
        /// <summary>Account name.</summary>
