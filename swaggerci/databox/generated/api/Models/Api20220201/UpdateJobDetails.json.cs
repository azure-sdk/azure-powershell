...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class UpdateJobDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IUpdateJobDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IUpdateJobDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IUpdateJobDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal UpdateJobDetails(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_contactDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("contactDetails"), out var __jsonContactDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ContactDetails.FromJson(__jsonContactDetails) : ContactDetail;}
            {_shippingAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("shippingAddress"), out var __jsonShippingAddress) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ShippingAddress.FromJson(__jsonShippingAddress) : ShippingAddress;}
            {_keyEncryptionKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("keyEncryptionKey"), out var __jsonKeyEncryptionKey) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.KeyEncryptionKey.FromJson(__jsonKeyEncryptionKey) : KeyEncryptionKey;}
