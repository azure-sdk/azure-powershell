...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class KeyEncryptionKey :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IKeyEncryptionKey,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IKeyEncryptionKeyInternal
    {

        /// <summary>Backing field for <see cref="IdentityProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityProperties _identityProperty;

        /// <summary>Managed identity properties used for key encryption.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityProperties IdentityProperty { get => (this._identityProperty = this._identityProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IdentityProperties()); set => this._identityProperty = value; }
        ...
        public string IdentityPropertyType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityPropertiesInternal)IdentityProperty).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityPropertiesInternal)IdentityProperty).Type = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IKeyEncryptionKeyInternal.IdentityProperty { get => (this._identityProperty = this._identityProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IdentityProperties()); set { {_identityProperty = value;} } }

        /// <summary>Internal Acessors for IdentityPropertyUserAssigned</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IUserAssignedProperties Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IKeyEncryptionKeyInternal.IdentityPropertyUserAssigned { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityPropertiesInternal)IdentityProperty).UserAssigned; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityPropertiesInternal)IdentityProperty).UserAssigned = value; }
    ...
    {
        /// <summary>Managed identity properties used for key encryption.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IIdentityProperties IdentityProperty { get; set; }
        /// <summary>Managed service identity type.</summary>
        string IdentityPropertyType { get; set; }
