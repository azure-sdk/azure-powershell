...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class DataExportDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDataExportDetailsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfiguration _transferConfiguration;

        /// <summary>Configuration for the data transfer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfiguration TransferConfiguration { get => (this._transferConfiguration = this._transferConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransferConfiguration()); set => this._transferConfiguration = value; }

        /// <summary>Type of the configuration for transfer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.TransferConfigurationType TransferConfigurationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationInternal)TransferConfiguration).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationInternal)TransferConfiguration).Type = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IFilterFileDetails[] IncludeFilterFileDetail { get; set; }
        /// <summary>To indicate if all Azure blobs have to be transferred</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IAzureFileFilterDetails IncludeAzureFileFilterDetail { get; set; }
        /// <summary>Filter details to transfer blobs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IBlobFilterDetails IncludeBlobFilterDetail { get; set; }
        /// <summary>Details of the filter files to be used for data transfer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IFilterFileDetails[] IncludeFilterFileDetail { get; set; }
        /// <summary>To indicate if all Azure blobs have to be transferred</summary>
        bool? IncludeTransferAllBlob { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferAllDetails TransferAllDetailInclude { get; set; }
        /// <summary>Type of the account of data</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType? TransferAllDetailsIncludeDataAccountType { get; set; }
        /// <summary>Configuration for the data transfer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfiguration TransferConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferAllDetails TransferConfigurationTransferAllDetail { get; set; }
        /// <summary>
        /// Map of filter type and the details to filter. This field is required only if the TransferConfigurationType is given as
        /// TransferUsingFilter.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferConfigurationTransferFilterDetails TransferConfigurationTransferFilterDetail { get; set; }
        /// <summary>Type of the configuration for transfer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.TransferConfigurationType TransferConfigurationType { get; set; }
        /// <summary>Details of the filtering the transfer of data.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransferFilterDetails TransferFilterDetailInclude { get; set; }
        /// <summary>Type of the account of data.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType? TransferFilterDetailsIncludeDataAccountType { get; set; }
