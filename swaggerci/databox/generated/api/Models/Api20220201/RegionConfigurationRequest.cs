...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201
{
    ...
    public partial class RegionConfigurationRequest :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequestInternal
    {

        /// <summary>Backing field for <see cref="DatacenterAddressRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDatacenterAddressRequest _datacenterAddressRequest;

        /// <summary>Request body to get the datacenter address for given sku.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDatacenterAddressRequest DatacenterAddressRequest { get => (this._datacenterAddressRequest = this._datacenterAddressRequest ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.DatacenterAddressRequest()); set => this._datacenterAddressRequest = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string DatacenterAddressRequestStorageLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDatacenterAddressRequestInternal)DatacenterAddressRequest).StorageLocation; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDatacenterAddressRequestInternal)DatacenterAddressRequest).StorageLocation = value ?? null; }

        /// <summary>Internal Acessors for DatacenterAddressRequest</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDatacenterAddressRequest Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequestInternal.DatacenterAddressRequest { get => (this._datacenterAddressRequest = this._datacenterAddressRequest ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.DatacenterAddressRequest()); set { {_datacenterAddressRequest = value;} } }

        /// <summary>Internal Acessors for ScheduleAvailabilityRequest</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IScheduleAvailabilityRequest Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequestInternal.ScheduleAvailabilityRequest { get => (this._scheduleAvailabilityRequest = this._scheduleAvailabilityRequest ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ScheduleAvailabilityRequest()); set { {_scheduleAvailabilityRequest = value;} } }

        /// <summary>Internal Acessors for TransportAvailabilityRequest</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransportAvailabilityRequest Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequestInternal.TransportAvailabilityRequest { get => (this._transportAvailabilityRequest = this._transportAvailabilityRequest ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.TransportAvailabilityRequest()); set { {_transportAvailabilityRequest = value;} } }

        /// <summary>Backing field for <see cref="ScheduleAvailabilityRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IScheduleAvailabilityRequest _scheduleAvailabilityRequest;

        /// <summary>Request body to get the availability for scheduling orders.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IScheduleAvailabilityRequest ScheduleAvailabilityRequest { get => (this._scheduleAvailabilityRequest = this._scheduleAvailabilityRequest ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ScheduleAvailabilityRequest()); set => this._scheduleAvailabilityRequest = value; }

        /// <summary>Country in which storage location should be supported.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string ScheduleAvailabilityRequestCountry { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IScheduleAvailabilityRequestInternal)ScheduleAvailabilityRequest).Country; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IScheduleAvailabilityRequestInternal)ScheduleAvailabilityRequest).Country = value ?? null; }
    ...
    {
        /// <summary>Request body to get the datacenter address for given sku.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IDatacenterAddressRequest DatacenterAddressRequest { get; set; }
        /// <summary>Sku Name for which the data center address requested.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.SkuName? DatacenterAddressRequestSkuName { get; set; }
        /// <summary>
        /// Storage location. For locations check: https://management.azure.com/subscriptions/SUBSCRIPTIONID/locations?api-version=2018-01-01
        ...
        string DatacenterAddressRequestStorageLocation { get; set; }
        /// <summary>Request body to get the availability for scheduling orders.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IScheduleAvailabilityRequest ScheduleAvailabilityRequest { get; set; }
        /// <summary>Country in which storage location should be supported.</summary>
        string ScheduleAvailabilityRequestCountry { get; set; }
        /// <summary>Sku Name for which the order is to be scheduled.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.SkuName? ScheduleAvailabilityRequestSkuName { get; set; }
        ...
        string ScheduleAvailabilityRequestStorageLocation { get; set; }
        /// <summary>Request body to get the transport availability for given sku.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ITransportAvailabilityRequest TransportAvailabilityRequest { get; set; }
        /// <summary>Type of the device.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.SkuName? TransportAvailabilityRequestSkuName { get; set; }
