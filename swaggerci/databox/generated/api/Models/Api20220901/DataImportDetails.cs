...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901
{
    ...
    public partial class DataImportDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetailsInternal
    {

        /// <summary>Backing field for <see cref="AccountDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataAccountDetails _accountDetail;

        /// <summary>Account details of the data to be transferred</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataAccountDetails AccountDetail { get => (this._accountDetail = this._accountDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.DataAccountDetails()); set => this._accountDetail = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string AccountDetailSharePassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataAccountDetailsInternal)AccountDetail).SharePassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataAccountDetailsInternal)AccountDetail).SharePassword = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataAccountDetails Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetailsInternal.AccountDetail { get => (this._accountDetail = this._accountDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.DataAccountDetails()); set { {_accountDetail = value;} } }
    ...
    {
        /// <summary>Account details of the data to be transferred</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataAccountDetails AccountDetail { get; set; }
        /// <summary>Account Type of the data to be transferred.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.DataAccountType AccountDetailDataAccountType { get; set; }
        /// <summary>
        /// Password for all the shares to be created on the device. Should not be passed for TransferType:ExportFromAzure jobs. If
