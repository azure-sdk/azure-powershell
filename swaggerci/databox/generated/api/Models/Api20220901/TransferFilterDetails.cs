...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901
{
    ...
    public partial class TransferFilterDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.ITransferFilterDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.ITransferFilterDetailsInternal
    {

        /// <summary>Backing field for <see cref="AzureFileFilterDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetails _azureFileFilterDetail;

        /// <summary>Filter details to transfer Azure files.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetails AzureFileFilterDetail { get => (this._azureFileFilterDetail = this._azureFileFilterDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.AzureFileFilterDetails()); set => this._azureFileFilterDetail = value; }
        ...
        public string[] AzureFileFilterDetailFilePathList { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetailsInternal)AzureFileFilterDetail).FilePathList; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetailsInternal)AzureFileFilterDetail).FilePathList = value ?? null /* arrayOf */; }

        /// <summary>Prefix list of the Azure files to be transferred.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string[] AzureFileFilterDetailFilePrefixList { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetailsInternal)AzureFileFilterDetail).FilePrefixList; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetailsInternal)AzureFileFilterDetail).FilePrefixList = value ?? null /* arrayOf */; }

        /// <summary>List of file shares to be transferred.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string[] AzureFileFilterDetailFileShareList { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetailsInternal)AzureFileFilterDetail).FileShareList; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetailsInternal)AzureFileFilterDetail).FileShareList = value ?? null /* arrayOf */; }

        /// <summary>Backing field for <see cref="BlobFilterDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetails _blobFilterDetail;

        /// <summary>Filter details to transfer blobs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetails BlobFilterDetail { get => (this._blobFilterDetail = this._blobFilterDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.BlobFilterDetails()); set => this._blobFilterDetail = value; }

        /// <summary>List of full path of the blobs to be transferred.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string[] BlobFilterDetailBlobPathList { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetailsInternal)BlobFilterDetail).BlobPathList; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetailsInternal)BlobFilterDetail).BlobPathList = value ?? null /* arrayOf */; }

        /// <summary>Prefix list of the Azure blobs to be transferred.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string[] BlobFilterDetailBlobPrefixList { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetailsInternal)BlobFilterDetail).BlobPrefixList; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetailsInternal)BlobFilterDetail).BlobPrefixList = value ?? null /* arrayOf */; }

        /// <summary>List of blob containers to be transferred.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string[] BlobFilterDetailContainerList { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetailsInternal)BlobFilterDetail).ContainerList; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetailsInternal)BlobFilterDetail).ContainerList = value ?? null /* arrayOf */; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IFilterFileDetails[] _filterFileDetail;

        /// <summary>Details of the filter files to be used for data transfer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IFilterFileDetails[] FilterFileDetail { get => this._filterFileDetail; set => this._filterFileDetail = value; }

        /// <summary>Internal Acessors for AzureFileFilterDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetails Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.ITransferFilterDetailsInternal.AzureFileFilterDetail { get => (this._azureFileFilterDetail = this._azureFileFilterDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.AzureFileFilterDetails()); set { {_azureFileFilterDetail = value;} } }

        /// <summary>Internal Acessors for BlobFilterDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetails Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.ITransferFilterDetailsInternal.BlobFilterDetail { get => (this._blobFilterDetail = this._blobFilterDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.BlobFilterDetails()); set { {_blobFilterDetail = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IFilterFileDetails[] FilterFileDetail { get; set; }
    ...
    {
        /// <summary>Filter details to transfer Azure files.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IAzureFileFilterDetails AzureFileFilterDetail { get; set; }
        /// <summary>List of full path of the files to be transferred.</summary>
        string[] AzureFileFilterDetailFilePathList { get; set; }
        /// <summary>Prefix list of the Azure files to be transferred.</summary>
        string[] AzureFileFilterDetailFilePrefixList { get; set; }
        ...
        string[] AzureFileFilterDetailFileShareList { get; set; }
        /// <summary>Filter details to transfer blobs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IBlobFilterDetails BlobFilterDetail { get; set; }
        /// <summary>List of full path of the blobs to be transferred.</summary>
        string[] BlobFilterDetailBlobPathList { get; set; }
        /// <summary>Prefix list of the Azure blobs to be transferred.</summary>
        string[] BlobFilterDetailBlobPrefixList { get; set; }
