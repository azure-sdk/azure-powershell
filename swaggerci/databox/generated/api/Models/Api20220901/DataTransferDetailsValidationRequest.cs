...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901
{
    ...
    public partial class DataTransferDetailsValidationRequest :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataTransferDetailsValidationRequest,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataTransferDetailsValidationRequestInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IValidationInputRequest"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IValidationInputRequest __validationInputRequest = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.ValidationInputRequest();

        /// <summary>Backing field for <see cref="DataExportDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataExportDetails[] _dataExportDetail;

        /// <summary>List of DataTransfer details to be used to export data from azure.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataExportDetails[] DataExportDetail { get => this._dataExportDetail; set => this._dataExportDetail = value; }

        /// <summary>Backing field for <see cref="DataImportDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetails[] _dataImportDetail;

        /// <summary>List of DataTransfer details to be used to import data to azure.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetails[] DataImportDetail { get => this._dataImportDetail; set => this._dataImportDetail = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.ValidationInputDiscriminator ValidationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IValidationInputRequestInternal)__validationInputRequest).ValidationType; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IValidationInputRequestInternal)__validationInputRequest).ValidationType = value ; }
    ...
    public partial interface IDataTransferDetailsValidationRequest :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IValidationInputRequest
    {
        /// <summary>List of DataTransfer details to be used to export data from azure.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataExportDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataExportDetails[] DataExportDetail { get; set; }
        /// <summary>List of DataTransfer details to be used to import data to azure.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataImportDetails[] DataImportDetail { get; set; }
        /// <summary>Device type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = true,
        ReadOnly = false,
    ...
    internal partial interface IDataTransferDetailsValidationRequestInternal :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IValidationInputRequestInternal
    {
        /// <summary>List of DataTransfer details to be used to export data from azure.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IDataExportDetails[] DataExportDetail { get; set; }
        /// <summary>List of DataTransfer details to be used to import data to azure.</summary>
