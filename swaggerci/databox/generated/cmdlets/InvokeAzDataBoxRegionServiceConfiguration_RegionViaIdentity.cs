...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxRegionServiceConfiguration_RegionViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDataBoxRegionServiceConfiguration_RegionViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequest _regionConfigurationRequest;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationRequest RegionConfigurationRequest { get => this._regionConfigurationRequest; set => this._regionConfigurationRequest = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationResponse">Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IRegionConfigurationResponse</see>
        /// from the remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxRegionServiceConfiguration_RegionViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxRegionServiceConfiguration_RegionViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServiceRegionConfigurationViaIdentity(InputObject.Id, RegionConfigurationRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServiceRegionConfiguration(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, RegionConfigurationRequest, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RegionConfigurationRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RegionConfigurationRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RegionConfigurationRequest })
                    {
