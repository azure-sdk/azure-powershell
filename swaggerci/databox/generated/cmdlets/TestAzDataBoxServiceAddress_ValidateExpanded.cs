...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IValidateAddress _validateAddressBody= new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ValidateAddress();

        /// <summary>
        /// The requirements to validate customer address where the device needs to be shipped.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IValidateAddress ValidateAddressBody { get => this._validateAddressBody; set => this._validateAddressBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServiceValidateAddress(SubscriptionId, Location, ValidateAddressBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,body=ValidateAddressBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzDataBoxServiceAddress_ValidateExpanded" /> cmdlet class.
        /// </summary>
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=ValidateAddressBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=ValidateAddressBody })
                    {
