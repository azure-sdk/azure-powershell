...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataBoxServiceAvailableSku_List", SupportsShouldProcess = true)]
    ...
    public partial class GetAzDataBoxServiceAvailableSku_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="AvailableSkuRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IAvailableSkuRequest _availableSkuRequest;

        /// <summary>The filters for showing the available skus.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The filters for showing the available skus.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The filters for showing the available skus.",
        SerializedName = @"availableSkuRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IAvailableSkuRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IAvailableSkuRequest AvailableSkuRequest { get => this._availableSkuRequest; set => this._availableSkuRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDataBoxServiceAvailableSku_List" /> cmdlet class.
        /// </summary>
        public GetAzDataBoxServiceAvailableSku_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ServiceListAvailableSkusByResourceGroup(SubscriptionId, ResourceGroupName, Location, AvailableSkuRequest, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Location=Location,body=AvailableSkuRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Location=Location, body=AvailableSkuRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Location=Location, body=AvailableSkuRequest })
                    {
