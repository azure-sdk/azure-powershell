...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxBookJobShipmentPickUp_BookViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDataBoxBookJobShipmentPickUp_BookViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpRequest _shipmentPickUpRequestBody= new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.ShipmentPickUpRequest();

        /// <summary>Shipment pick up request details.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpRequest ShipmentPickUpRequestBody { get => this._shipmentPickUpRequestBody; set => this._shipmentPickUpRequestBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxBookJobShipmentPickUp_BookViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxBookJobShipmentPickUp_BookViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.JobsBookShipmentPickUpViaIdentity(InputObject.Id, ShipmentPickUpRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobsBookShipmentPickUp(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, ShipmentPickUpRequestBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ShipmentPickUpRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ShipmentPickUpRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ShipmentPickUpRequestBody })
                    {
