...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IValidationInputRequest[] IndividualRequestDetail { get => ValidationRequestBody.IndividualRequestDetail ?? null /* arrayOf */; set => ValidationRequestBody.IndividualRequestDetail = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IValidationRequest ValidationRequestBody { get => this._validationRequestBody; set => this._validationRequestBody = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IValidationResponse"
        /// /> from the remote call</param>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServiceValidateInputsViaIdentity(InputObject.Id, ValidationRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServiceValidateInputs(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, ValidationRequestBody, onOk, onDefault, this, Pipeline);
                    }
