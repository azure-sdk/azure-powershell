...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxBookJobShipmentPickUp_BookViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpResponse))]
    ...
    public partial class InvokeAzDataBoxBookJobShipmentPickUp_BookViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ShipmentPickUpRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpRequest _shipmentPickUpRequest;

        /// <summary>Shipment pick up request details.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Shipment pick up request details.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Shipment pick up request details.",
        SerializedName = @"shipmentPickUpRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpRequest ShipmentPickUpRequest { get => this._shipmentPickUpRequest; set => this._shipmentPickUpRequest = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpResponse">Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxBookJobShipmentPickUp_BookViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxBookJobShipmentPickUp_BookViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.JobsBookShipmentPickUpViaIdentity(InputObject.Id, ShipmentPickUpRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobsBookShipmentPickUp(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, ShipmentPickUpRequest, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ShipmentPickUpRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ShipmentPickUpRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ShipmentPickUpRequest })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IShipmentPickUpResponse
