...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        public string Country { get => _availableSkuRequestBody.Country ?? null; set => _availableSkuRequestBody.Country = value; }
        ...
        SerializedName = @"location",
        PossibleTypes = new [] { typeof(string) })]
        public string Location1 { get => _availableSkuRequestBody.Location ?? null; set => _availableSkuRequestBody.Location = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.SkuName[] SkuName { get => _availableSkuRequestBody.SkuName ?? null /* arrayOf */; set => _availableSkuRequestBody.SkuName = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.TransferType TransferType { get => _availableSkuRequestBody.TransferType; set => _availableSkuRequestBody.TransferType = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError">Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError</see>
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IAvailableSkusResult">Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IAvailableSkusResult</see>
        /// from the remote call</param>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ServiceListAvailableSkusByResourceGroup(SubscriptionId, ResourceGroupName, Location, _availableSkuRequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Location=Location,body=_availableSkuRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Location=Location, body=_availableSkuRequestBody })
                    {
