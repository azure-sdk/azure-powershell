...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IUnencryptedCredentials
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221001.IUnencryptedCredentials])]
