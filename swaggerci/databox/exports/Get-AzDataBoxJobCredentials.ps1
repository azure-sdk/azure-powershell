...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IUnencryptedCredentials
.Link
https://learn.microsoft.com/powershell/module/az.databox/get-azdataboxjobcredentials
#>
function Get-AzDataBoxJobCredentials {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20220901.IUnencryptedCredentials])]
