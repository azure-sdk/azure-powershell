...
.Link
https://learn.microsoft.com/powershell/module/az.databox/invoke-azdataboxbookjobshipmentpickup
#>
function Invoke-AzDataBoxBookJobShipmentPickUp {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20221201.IShipmentPickUpResponse])]
