...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api30.IOperation
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api30.IOperation])]
