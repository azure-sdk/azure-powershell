...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405
{
    ...
    public partial class GuestConfigurationNavigation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationNavigation.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationNavigation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationNavigation FromJson(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        internal GuestConfigurationNavigation(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_configurationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject>("configurationSetting"), out var __jsonConfigurationSetting) ? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.ConfigurationSetting.FromJson(__jsonConfigurationSetting) : ConfigurationSetting;}
            ...
            {_contentManagedIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString>("contentManagedIdentity"), out var __jsonContentManagedIdentity) ? (string)__jsonContentManagedIdentity : (string)ContentManagedIdentity;}
            ...
            {_configurationParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray>("configurationParameter"), out var __jsonConfigurationParameter) ? If( __jsonConfigurationParameter as Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IConfigurationParameter[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IConfigurationParameter) (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.ConfigurationParameter.FromJson(__u) )) ))() : null : ConfigurationParameter;}
            {_configurationProtectedParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray>("configurationProtectedParameter"), out var __jsonConfigurationProtectedParameter) ? If( __jsonConfigurationProtectedParameter as Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IConfigurationParameter[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IConfigurationParameter) (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.ConfigurationParameter.FromJson(__p) )) ))() : null : ConfigurationProtectedParameter;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._contentManagedIdentity)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.Json.JsonString(this._contentManagedIdentity.ToString()) : null, "contentManagedIdentity" ,container.Add );
