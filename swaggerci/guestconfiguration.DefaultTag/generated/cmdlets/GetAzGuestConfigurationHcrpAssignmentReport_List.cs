...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/machines/{machineName}/guestConfigurationAssignments/{guestConfigurationAssignmentName}/reports"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/machines/{machineName}/guestConfigurationAssignments/{guestConfigurationAssignmentName}/reports", ApiVersion = "2024-04-05")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GuestConfigurationHcrpAssignmentReportsList(SubscriptionId, ResourceGroupName, MachineName, GuestConfigurationAssignmentName, onOk, onDefault, this, Pipeline);
