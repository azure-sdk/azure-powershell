            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GuestConfigurationHcrpAssignmentReportsGet(SubscriptionId, ResourceGroupName, MachineName, GuestConfigurationAssignmentName, ReportId, onOk, onDefault, this, Pipeline);
