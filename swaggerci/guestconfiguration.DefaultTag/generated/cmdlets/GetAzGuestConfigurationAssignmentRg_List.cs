...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments", ApiVersion = "2024-04-05")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GuestConfigurationAssignmentsRglist(ResourceGroupName, SubscriptionId, onOk, onDefault, this, Pipeline);
