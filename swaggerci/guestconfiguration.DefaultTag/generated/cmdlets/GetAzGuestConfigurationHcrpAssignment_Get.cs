            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GuestConfigurationHcrpAssignmentsGet(SubscriptionId, ResourceGroupName, MachineName, GuestConfigurationAssignmentName, onOk, onDefault, this, Pipeline);
