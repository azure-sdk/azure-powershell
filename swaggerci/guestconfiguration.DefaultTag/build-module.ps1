...
$dll = Join-Path $PSScriptRoot 'bin/Az.GuestConfiguration.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.GuestConfiguration.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.GuestConfiguration.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: GuestConfiguration cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.GuestConfiguration.format.ps1xml'
