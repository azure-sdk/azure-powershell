...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationassignmentreportsvmss
#>
...
Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationAssignment
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationassignmentsubscription
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/new-azguestconfigurationassignmentvmss
#>
function New-AzGuestConfigurationAssignmentVmss {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationAssignment])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.GuestConfiguration.private\New-AzGuestConfigurationAssignmentVmss_CreateExpanded';
        }
...
LATESTASSIGNMENTREPORTRESOURCE <IAssignmentReportResource[]>: The list of resources for which guest configuration assignment compliance is checked.
  [Reason <IAssignmentReportResourceComplianceReason[]>]: Compliance reason and reason code for a resource.
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/new-azguestconfigurationconnectedvmwarevsphereassignment
#>
function New-AzGuestConfigurationConnectedVMwarevSphereAssignment {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationAssignment])]
[CmdletBinding(DefaultParameterSetName='CreateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.GuestConfiguration.private\New-AzGuestConfigurationConnectedVMwarevSphereAssignment_CreateExpanded';
        }
        if (('CreateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
INPUTOBJECT <IGuestConfigurationIdentity>: Identity Parameter
  ...
  [VmssName <String>]: The name of the virtual machine scale set.
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/remove-azguestconfigurationassignmentsvmss
#>
