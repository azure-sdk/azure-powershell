...
INPUTOBJECT <IGuestConfigurationIdentity>: Identity Parameter
  [GuestConfigurationAssignmentName <String>]: The name of the GuestConfigurationAssignment
  [Id <String>]: The GUID for the guest configuration assignment report.
  [Id1 <String>]: Resource identity path
  [MachineName <String>]: machines
  [Name <String>]: The name of the GuestConfigurationAssignment
  [ReportId <String>]: The GUID for the guest configuration assignment report.
  [ResourceGroupName <String>]: The name of the resource group. The name is case insensitive.
  [SubscriptionId <String>]: The ID of the target subscription.
  [VMName <String>]: virtualMachines
  [VmssName <String>]: virtualMachineScaleSets
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationconnectedvmwarevsphereassignmentsreport
#>
function Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20240405.IGuestConfigurationAssignmentReport])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport_Get';
            GetViaIdentity = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport_GetViaIdentity';
            List = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport_List';
        }
