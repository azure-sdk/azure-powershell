...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationhcrpassignmentreport
schema: 2.0.0
---

# Get-AzGuestConfigurationHcrpAssignmentReport
...
### List (Default)
```
Get-AzGuestConfigurationHcrpAssignmentReport -GuestConfigurationAssignmentName <String> -MachineName <String>
...
### GetViaIdentity
```
Get-AzGuestConfigurationHcrpAssignmentReport -InputObject <IGuestConfigurationIdentity>
