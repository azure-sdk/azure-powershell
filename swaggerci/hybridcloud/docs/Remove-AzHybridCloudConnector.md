...
online version: https://learn.microsoft.com/powershell/module/az.hybridcloud/remove-azhybridcloudconnector
schema: 2.0.0
---

# Remove-AzHybridCloudConnector
...
### Delete (Default)
```
Remove-AzHybridCloudConnector -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridCloudConnector -InputObject <IHybridCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
