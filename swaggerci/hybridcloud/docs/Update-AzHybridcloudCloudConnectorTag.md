...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcloud/update-azhybridcloudcloudconnectortag
schema: 2.0.0
---
...
```
Update-AzHybridcloudCloudConnectorTag -CloudConnectorName <String> -ResourceGroupName <String>
...
```
Update-AzHybridcloudCloudConnectorTag -InputObject <IHybridcloudIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Hybridcloud.Support.ManagedServiceIdentityType
Parameter Sets: (All)
Aliases:
