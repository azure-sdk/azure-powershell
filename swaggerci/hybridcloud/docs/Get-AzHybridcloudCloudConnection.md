...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcloud/get-azhybridcloudcloudconnection
schema: 2.0.0
---

# Get-AzHybridcloudCloudConnection
...
### Get (Default)
```
Get-AzHybridcloudCloudConnection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHybridcloudCloudConnection -InputObject <IHybridcloudIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
