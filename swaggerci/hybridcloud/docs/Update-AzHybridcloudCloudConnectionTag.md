...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcloud/update-azhybridcloudcloudconnectiontag
schema: 2.0.0
---
...
```
Update-AzHybridcloudCloudConnectionTag -CloudConnectionName <String> -ResourceGroupName <String>
...
```
Update-AzHybridcloudCloudConnectionTag -InputObject <IHybridcloudIdentity> [-Tag <Hashtable>]
