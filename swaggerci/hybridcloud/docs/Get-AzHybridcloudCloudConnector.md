...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcloud/get-azhybridcloudcloudconnector
schema: 2.0.0
---

# Get-AzHybridcloudCloudConnector
...
### Get (Default)
```
Get-AzHybridcloudCloudConnector -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHybridcloudCloudConnector -InputObject <IHybridcloudIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
