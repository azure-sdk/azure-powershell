...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcloud/remove-azhybridcloudcloudconnector
schema: 2.0.0
---

# Remove-AzHybridcloudCloudConnector
...
### Delete (Default)
```
Remove-AzHybridcloudCloudConnector -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridcloudCloudConnector -InputObject <IHybridcloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
