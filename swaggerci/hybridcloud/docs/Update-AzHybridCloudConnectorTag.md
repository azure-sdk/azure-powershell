...
online version: https://learn.microsoft.com/powershell/module/az.hybridcloud/update-azhybridcloudconnectortag
schema: 2.0.0
---

# Update-AzHybridCloudConnectorTag
...
```
Update-AzHybridCloudConnectorTag -CloudConnectorName <String> -ResourceGroupName <String>
...
```
Update-AzHybridCloudConnectorTag -InputObject <IHybridCloudIdentity> [-Tag <Hashtable>]
