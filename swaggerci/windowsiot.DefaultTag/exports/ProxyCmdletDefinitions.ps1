...
.Link
https://learn.microsoft.com/powershell/module/az.deviceservices/get-azdeviceservicesservice
#>
...
begin {
    try {
        ...
        if (('Get', 'List', 'List1') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
        ...
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
            [Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IDeviceService
.Link
https://learn.microsoft.com/powershell/module/az.deviceservices/new-azdeviceservicesservice
#>
...
INPUTOBJECT <IDeviceServicesIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription identifier.
.Link
https://learn.microsoft.com/powershell/module/az.deviceservices/remove-azdeviceservicesservice
#>
...
INPUTOBJECT <IDeviceServicesIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription identifier.
.Link
https://learn.microsoft.com/powershell/module/az.deviceservices/test-azdeviceservicesservicedeviceservicenameavailability
#>
...
INPUTOBJECT <IDeviceServicesIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription identifier.
.Link
https://learn.microsoft.com/powershell/module/az.deviceservices/update-azdeviceservicesservice
#>
