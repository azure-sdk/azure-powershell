...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.WindowsIoT/checkDeviceServiceNameAvailability", ApiVersion = "2019-06-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Runtime.IEventListener
    {
        ...
        public string Name { get => _deviceServiceCheckNameAvailabilityParametersBody.Name ?? null; set => _deviceServiceCheckNameAvailabilityParametersBody.Name = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IDeviceServiceNameAvailabilityInfo">Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IDeviceServiceNameAvailabilityInfo</see>
        /// from the remote call</param>
        ...
        {
            var telemetryInfo = Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Module.Instance.GetTelemetryInfo?.Invoke(__correlationId);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesCheckDeviceServiceNameAvailabilityViaIdentity(InputObject.Id, _deviceServiceCheckNameAvailabilityParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesCheckDeviceServiceNameAvailability(InputObject.SubscriptionId ?? null, _deviceServiceCheckNameAvailabilityParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_deviceServiceCheckNameAvailabilityParametersBody})
                    {
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Module.Instance.SanitizeOutput?.Invoke(sendToPipeline, __correlationId);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IErrorDetails> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_deviceServiceCheckNameAvailabilityParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_deviceServiceCheckNameAvailabilityParametersBody })
                    {
