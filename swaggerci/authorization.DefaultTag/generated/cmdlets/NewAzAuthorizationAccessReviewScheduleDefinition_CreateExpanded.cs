...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}", ApiVersion = "2021-12-01-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        {
            var telemetryInfo = Microsoft.Azure.PowerShell.Cmdlets.Authorization.Module.Instance.GetTelemetryInfo?.Invoke(__correlationId);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccessReviewScheduleDefinitionsCreateOrUpdateById(SubscriptionId, ScheduleDefinitionId, _propertiesBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ScheduleDefinitionId=ScheduleDefinitionId,body=_propertiesBody})
                    {
        ...
        {
            Microsoft.Azure.PowerShell.Cmdlets.Authorization.Module.Instance.SanitizeOutput?.Invoke(sendToPipeline, __correlationId);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IErrorDefinition> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ScheduleDefinitionId=ScheduleDefinitionId, body=_propertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ScheduleDefinitionId=ScheduleDefinitionId, body=_propertiesBody })
                    {
