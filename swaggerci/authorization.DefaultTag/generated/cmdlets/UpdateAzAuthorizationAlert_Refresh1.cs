...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RefreshAll=>POST:"/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/refresh"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAuthorizationAlert_Refresh1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Description(@"Refresh all alerts for a resource scope.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.HttpPath(Path = "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/refresh", ApiVersion = "2022-08-01-preview")]
    public partial class UpdateAzAuthorizationAlert_Refresh1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The scope of the alert.")]
        ...
        /// <returns>a duplicate instance of UpdateAzAuthorizationAlert_Refresh1</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets.UpdateAzAuthorizationAlert_Refresh1 Clone()
        {
            var clone = new UpdateAzAuthorizationAlert_Refresh1();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Events.DelayBeforePolling:
                    {
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            ...
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AlertsRefreshAll' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AlertsRefreshAll(Scope, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzAuthorizationAlert_Refresh1" /> cmdlet class.
        /// </summary>
        public UpdateAzAuthorizationAlert_Refresh1()
        {
