...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/{scope}/providers/Microsoft.Authorization/roleManagementAlertConfigurations/{alertId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAuthorizationAlertConfiguration_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Description(@"Update an alert configuration.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.HttpPath(Path = "/{scope}/providers/Microsoft.Authorization/roleManagementAlertConfigurations/{alertId}", ApiVersion = "2022-08-01-preview")]
    public partial class UpdateAzAuthorizationAlertConfiguration_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20220801Preview.IAlertConfiguration _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20220801Preview.AlertConfiguration();

        /// <summary>The alert configuration type.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The alert configuration type.")]
        ...
        public string AlertConfigurationType { get => _parametersBody.AlertConfigurationType ?? null; set => _parametersBody.AlertConfigurationType = value; }

        /// <summary>Backing field for <see cref="AlertId" /> property.</summary>
        private string _alertId;

        /// <summary>The name of the alert configuration to update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the alert configuration to update.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "True if the alert is enabled, false will disable the scanning for the specific alert.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>The scope of the alert configuration.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The scope of the alert configuration.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AlertConfigurationsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AlertConfigurationsUpdate(Scope, AlertId, _parametersBody, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Scope=Scope,AlertId=AlertId,body=_parametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzAuthorizationAlertConfiguration_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzAuthorizationAlertConfiguration_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20220801Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, AlertId=AlertId, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, AlertId=AlertId, body=_parametersBody })
                    {
