...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzAuthorizationRemediateAlertIncident_Remediate", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzAuthorizationRemediateAlertIncident_Remediate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        /// <summary>The name of the alert incident to remediate.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the alert incident to remediate.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzAuthorizationRemediateAlertIncident_Remediate" /> cmdlet class.
        /// </summary>
        public InvokeAzAuthorizationRemediateAlertIncident_Remediate()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AlertIncidentsRemediate(Scope, AlertId, AlertIncidentId, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Scope=Scope,AlertId=AlertId,AlertIncidentId=AlertIncidentId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20220801Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, AlertId=AlertId, AlertIncidentId=AlertIncidentId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, AlertId=AlertId, AlertIncidentId=AlertIncidentId })
                    {
