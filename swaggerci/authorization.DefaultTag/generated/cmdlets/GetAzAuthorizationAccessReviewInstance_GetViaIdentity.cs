...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}", ApiVersion = "2021-12-01-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.AccessReviewInstancesGetById(InputObject.SubscriptionId ?? null, InputObject.ScheduleDefinitionId ?? null, InputObject.Id ?? null, onOk, onDefault, this, Pipeline);
                    }
