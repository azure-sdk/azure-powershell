...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/{scope}/providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzAuthorizationRoleAssignment_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Description(@"Delete a role assignment by scope and name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.HttpPath(Path = "/{scope}/providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}", ApiVersion = "2024-02-01-preview")]
    public partial class RemoveAzAuthorizationRoleAssignment_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Tenant ID for cross-tenant request")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RoleAssignmentsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RoleAssignmentsDeleteViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.RoleAssignmentName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.RoleAssignmentName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.RoleAssignmentsDelete(InputObject.Scope ?? null, InputObject.RoleAssignmentName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  TenantId=this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzAuthorizationRoleAssignment_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzAuthorizationRoleAssignment_DeleteViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api60.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { TenantId=this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { TenantId=this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null })
                    {
