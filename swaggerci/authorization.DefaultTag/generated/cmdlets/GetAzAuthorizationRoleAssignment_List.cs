...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListForSubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/roleAssignments"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAuthorizationRoleAssignment_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Description(@"List all role assignments that apply to a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/roleAssignments", ApiVersion = "2024-02-01-preview")]
    public partial class GetAzAuthorizationRoleAssignment_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAuthorizationRoleAssignment_List" /> cmdlet class.
        /// </summary>
        public GetAzAuthorizationRoleAssignment_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.RoleAssignmentsListForSubscription(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.RoleAssignmentsListForSubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
