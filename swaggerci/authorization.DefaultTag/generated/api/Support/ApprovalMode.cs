...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode NoApproval = @"NoApproval";

        public static Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode Parallel = @"Parallel";

        public static Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode Serial = @"Serial";

        public static Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode SingleStage = @"SingleStage";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode e1, Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode e2)
        {
            return !e2.Equals(e1);
        }
