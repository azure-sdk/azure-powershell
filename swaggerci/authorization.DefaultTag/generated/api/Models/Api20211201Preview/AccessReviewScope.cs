...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview
{
    ...
    public partial class AccessReviewScope :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IAccessReviewScopeInternal
    {
        ...
        /// <summary>Backing field for <see cref="ExcludeResourceId" /> property.</summary>
        private string _excludeResourceId;

        /// <summary>This is used to indicate the resource id(s) to exclude</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public string ExcludeResourceId { get => this._excludeResourceId; set => this._excludeResourceId = value; }

        /// <summary>Backing field for <see cref="ExcludeRoleDefinitionId" /> property.</summary>
        private string _excludeRoleDefinitionId;

        /// <summary>This is used to indicate the role definition id(s) to exclude</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public string ExcludeRoleDefinitionId { get => this._excludeRoleDefinitionId; set => this._excludeRoleDefinitionId = value; }
        ...
        /// <summary>Backing field for <see cref="IncludeAccessBelowResource" /> property.</summary>
        private bool? _includeAccessBelowResource;

        /// <summary>Flag to indicate whether to expand nested memberships or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public bool? IncludeAccessBelowResource { get => this._includeAccessBelowResource; set => this._includeAccessBelowResource = value; }

        /// <summary>Backing field for <see cref="IncludeInheritedAccess" /> property.</summary>
        private bool? _includeInheritedAccess;

        /// <summary>Flag to indicate whether to expand nested memberships or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public bool? IncludeInheritedAccess { get => this._includeInheritedAccess; set => this._includeInheritedAccess = value; }

        /// <summary>Internal Acessors for AssignmentState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.AccessReviewScopeAssignmentState? Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IAccessReviewScopeInternal.AssignmentState { get => this._assignmentState; set { {_assignmentState = value;} } }

        /// <summary>Internal Acessors for PrincipalType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.AccessReviewScopePrincipalType? Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IAccessReviewScopeInternal.PrincipalType { get => this._principalType; set { {_principalType = value;} } }

        /// <summary>Internal Acessors for ResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IAccessReviewScopeInternal.ResourceId { get => this._resourceId; set { {_resourceId = value;} } }

        /// <summary>Internal Acessors for RoleDefinitionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IAccessReviewScopeInternal.RoleDefinitionId { get => this._roleDefinitionId; set { {_roleDefinitionId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        string ExcludeResourceId { get; set; }
        /// <summary>This is used to indicate the role definition id(s) to exclude</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string ExcludeRoleDefinitionId { get; set; }
        /// <summary>Flag to indicate whether to expand nested memberships or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? IncludeAccessBelowResource { get; set; }
        /// <summary>Flag to indicate whether to expand nested memberships or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? IncludeInheritedAccess { get; set; }
        /// <summary>The identity type user/servicePrincipal to review</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = true,
