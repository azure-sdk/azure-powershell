...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview
{
    ...
    public partial class ApprovalStage :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IApprovalStage,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IApprovalStageInternal
    {

        /// <summary>Backing field for <see cref="EscalationApprover" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet[] _escalationApprover;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet[] EscalationApprover { get => this._escalationApprover; set => this._escalationApprover = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet[] _primaryApprover;

        /// <summary>The primary approver of the request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet[] PrimaryApprover { get => this._primaryApprover; set => this._primaryApprover = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet[] EscalationApprover { get; set; }
        /// <summary>
        /// The time in minutes when the approval request would be escalated if the primary approver does not approve
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet) })]
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IUserSet[] PrimaryApprover { get; set; }
        /// <summary>The time in days when approval request would be timed out</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
