...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview
{
    ...
    public partial class RoleEligibilityScheduleListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilityScheduleListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilityScheduleListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilitySchedule[] _value;

        /// <summary>role eligibility schedule list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilitySchedule[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilitySchedule) })]
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilitySchedule[] Value { get; set; }
