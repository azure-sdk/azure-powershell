...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview
{
    ...
    public partial class RoleAssignmentScheduleRequestProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleAssignmentScheduleRequestProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleAssignmentScheduleRequestProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleAssignmentScheduleRequestProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject json ? new RoleAssignmentScheduleRequestProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject into a new instance of <see cref="RoleAssignmentScheduleRequestProperties" />.
        /// </summary>
        ...
        internal RoleAssignmentScheduleRequestProperties(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject json)
        {
            ...
            {_scheduleInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject>("scheduleInfo"), out var __jsonScheduleInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.RoleAssignmentScheduleRequestPropertiesScheduleInfo.FromJson(__jsonScheduleInfo) : ScheduleInfo;}
            {_ticketInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject>("ticketInfo"), out var __jsonTicketInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.RoleAssignmentScheduleRequestPropertiesTicketInfo.FromJson(__jsonTicketInfo) : TicketInfo;}
            {_expandedProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject>("expandedProperties"), out var __jsonExpandedProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.ExpandedProperties.FromJson(__jsonExpandedProperties) : ExpandedProperty;}
            ...
            {_targetRoleAssignmentScheduleId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString>("targetRoleAssignmentScheduleId"), out var __jsonTargetRoleAssignmentScheduleId) ? (string)__jsonTargetRoleAssignmentScheduleId : (string)TargetRoleAssignmentScheduleId;}
            {_targetRoleAssignmentScheduleInstanceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString>("targetRoleAssignmentScheduleInstanceId"), out var __jsonTargetRoleAssignmentScheduleInstanceId) ? (string)__jsonTargetRoleAssignmentScheduleInstanceId : (string)TargetRoleAssignmentScheduleInstanceId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="RoleAssignmentScheduleRequestProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RoleAssignmentScheduleRequestProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._targetRoleAssignmentScheduleId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._targetRoleAssignmentScheduleId.ToString()) : null, "targetRoleAssignmentScheduleId" ,container.Add );
            AddIf( null != (((object)this._targetRoleAssignmentScheduleInstanceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._targetRoleAssignmentScheduleInstanceId.ToString()) : null, "targetRoleAssignmentScheduleInstanceId" ,container.Add );
