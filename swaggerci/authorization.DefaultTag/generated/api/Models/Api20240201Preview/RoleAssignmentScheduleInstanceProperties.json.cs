...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview
{
    ...
    public partial class RoleAssignmentScheduleInstanceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleInstanceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleInstanceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleInstanceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject json ? new RoleAssignmentScheduleInstanceProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject into a new instance of <see cref="RoleAssignmentScheduleInstanceProperties" />.
        /// </summary>
        ...
        internal RoleAssignmentScheduleInstanceProperties(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject json)
        {
            ...
            {_expandedProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject>("expandedProperties"), out var __jsonExpandedProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.ExpandedProperties.FromJson(__jsonExpandedProperties) : ExpandedProperty;}
            ...
            {_roleAssignmentScheduleId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString>("roleAssignmentScheduleId"), out var __jsonRoleAssignmentScheduleId) ? (string)__jsonRoleAssignmentScheduleId : (string)RoleAssignmentScheduleId;}
            {_originRoleAssignmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString>("originRoleAssignmentId"), out var __jsonOriginRoleAssignmentId) ? (string)__jsonOriginRoleAssignmentId : (string)OriginRoleAssignmentId;}
            ...
            {_linkedRoleEligibilityScheduleId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString>("linkedRoleEligibilityScheduleId"), out var __jsonLinkedRoleEligibilityScheduleId) ? (string)__jsonLinkedRoleEligibilityScheduleId : (string)LinkedRoleEligibilityScheduleId;}
            ...
            {_assignmentType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString>("assignmentType"), out var __jsonAssignmentType) ? (string)__jsonAssignmentType : (string)AssignmentType;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="RoleAssignmentScheduleInstanceProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="RoleAssignmentScheduleInstanceProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._roleAssignmentScheduleId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._roleAssignmentScheduleId.ToString()) : null, "roleAssignmentScheduleId" ,container.Add );
            AddIf( null != (((object)this._originRoleAssignmentId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._originRoleAssignmentId.ToString()) : null, "originRoleAssignmentId" ,container.Add );
            ...
            AddIf( null != (((object)this._linkedRoleEligibilityScheduleId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._linkedRoleEligibilityScheduleId.ToString()) : null, "linkedRoleEligibilityScheduleId" ,container.Add );
            AddIf( null != (((object)this._linkedRoleEligibilityScheduleInstanceId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._linkedRoleEligibilityScheduleInstanceId.ToString()) : null, "linkedRoleEligibilityScheduleInstanceId" ,container.Add );
            AddIf( null != (((object)this._assignmentType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Json.JsonString(this._assignmentType.ToString()) : null, "assignmentType" ,container.Add );
