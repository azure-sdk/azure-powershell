...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview
{
    ...
    public partial class EligibleChildResourcesListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IEligibleChildResourcesListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IEligibleChildResourcesListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IEligibleChildResource[] _value;

        /// <summary>Eligible child resource list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IEligibleChildResource[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IEligibleChildResource) })]
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IEligibleChildResource[] Value { get; set; }
