...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview
{
    ...
    public partial class RoleManagementPolicyListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicy[] _value;

        /// <summary>Role management policy list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicy[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicy) })]
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicy[] Value { get; set; }
