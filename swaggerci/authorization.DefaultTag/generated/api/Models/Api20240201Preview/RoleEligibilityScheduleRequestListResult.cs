...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview
{
    ...
    public partial class RoleEligibilityScheduleRequestListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleEligibilityScheduleRequestListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleEligibilityScheduleRequestListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleEligibilityScheduleRequest[] _value;

        /// <summary>Role eligibility schedule request list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleEligibilityScheduleRequest[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleEligibilityScheduleRequest[] Value { get; set; }
