...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview
{
    ...
    public partial class RoleAssignmentScheduleRequestPropertiesScheduleInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfoInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfoExpiration _expiration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfoExpiration Expiration { get => (this._expiration = this._expiration ?? new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.RoleAssignmentScheduleRequestPropertiesScheduleInfoExpiration()); set => this._expiration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfoExpiration Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfoInternal.Expiration { get => (this._expiration = this._expiration ?? new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.RoleAssignmentScheduleRequestPropertiesScheduleInfoExpiration()); set { {_expiration = value;} } }
    ...
    {
        /// <summary>Expiration of the role assignment schedule</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleAssignmentScheduleRequestPropertiesScheduleInfoExpiration Expiration { get; set; }
        /// <summary>Duration of the role assignment schedule in TimeSpan.</summary>
        string ExpirationDuration { get; set; }
        /// <summary>End DateTime of the role assignment schedule.</summary>
        global::System.DateTime? ExpirationEndDateTime { get; set; }
