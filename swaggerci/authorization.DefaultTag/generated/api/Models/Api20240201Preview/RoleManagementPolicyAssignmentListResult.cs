...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview
{
    ...
    public partial class RoleManagementPolicyAssignmentListResult :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyAssignmentListResult,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyAssignmentListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyAssignment[] _value;

        /// <summary>Role management policy assignment list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyAssignment[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyAssignment) })]
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240201Preview.IRoleManagementPolicyAssignment[] Value { get; set; }
