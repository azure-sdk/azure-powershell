...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20220401Preview.IRoleAssignmentScheduleRequest
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20220401Preview.IRoleAssignmentScheduleRequest])]
