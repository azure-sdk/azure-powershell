...
online version: https://learn.microsoft.com/powershell/module/az.authorization/test-azauthorizationroleeligibilityschedulerequest
schema: 2.0.0
---

# Test-AzAuthorizationRoleEligibilityScheduleRequest
...
```
Test-AzAuthorizationRoleEligibilityScheduleRequest -Name <String> -Scope <String> [-Condition <String>]
...
### Validate
```
Test-AzAuthorizationRoleEligibilityScheduleRequest -Name <String> -Scope <String>
 -Parameter <IRoleEligibilityScheduleRequest> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ValidateViaIdentity
```
Test-AzAuthorizationRoleEligibilityScheduleRequest -InputObject <IAuthorizationIdentity>
 -Parameter <IRoleEligibilityScheduleRequest> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Test-AzAuthorizationRoleEligibilityScheduleRequest -InputObject <IAuthorizationIdentity> [-Condition <String>]
 [-ConditionVersion <String>] [-ExpirationDuration <String>] [-ExpirationEndDateTime <DateTime>]
 [-ExpirationType <Type>] [-Justification <String>] [-PrincipalId <String>] [-RequestType <RequestType>]
 [-RoleDefinitionId <String>] [-ScheduleInfoStartDateTime <DateTime>]
 [-TargetRoleEligibilityScheduleId <String>] [-TargetRoleEligibilityScheduleInstanceId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20240901Preview.IRoleEligibilityScheduleRequest
