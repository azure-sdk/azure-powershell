...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Patching = @"Patching";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
