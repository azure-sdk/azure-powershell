...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support
{
        ...
        System.IEquatable<Type>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type DefaultGroupQuota = @"DefaultGroupQuota";

        /// <summary>Default user quota</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type DefaultUserQuota = @"DefaultUserQuota";

        /// <summary>Individual group quota</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type IndividualGroupQuota = @"IndividualGroupQuota";

        /// <summary>Individual user quota</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type IndividualUserQuota = @"IndividualUserQuota";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.NetApp.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
