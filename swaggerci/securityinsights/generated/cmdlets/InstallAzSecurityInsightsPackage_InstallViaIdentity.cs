...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Install, @"AzSecurityInsightsPackage_InstallViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InstallAzSecurityInsightsPackage_InstallViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InstallAzSecurityInsightsPackage_InstallViaIdentity" /> cmdlet class.
        /// </summary>
        public InstallAzSecurityInsightsPackage_InstallViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PackageInstallViaIdentity(InputObject.Id, PackageInstallationProperty, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PackageInstall(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.OperationalInsightsResourceProvider ?? null, InputObject.WorkspaceName ?? null, InputObject.PackageId ?? null, PackageInstallationProperty, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PackageInstallationProperty})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api20.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PackageInstallationProperty })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PackageInstallationProperty })
                    {
