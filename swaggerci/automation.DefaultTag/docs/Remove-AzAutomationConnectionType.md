...
### Delete (Default)
```
Remove-AzAutomationConnectionType -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationConnectionType -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
