...
### Delete (Default)
```
Remove-AzAutomationModule -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationModule -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
