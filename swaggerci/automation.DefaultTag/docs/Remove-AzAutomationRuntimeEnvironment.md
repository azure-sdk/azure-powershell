...
### Delete (Default)
```
Remove-AzAutomationRuntimeEnvironment -AutomationAccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzAutomationRuntimeEnvironment -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
