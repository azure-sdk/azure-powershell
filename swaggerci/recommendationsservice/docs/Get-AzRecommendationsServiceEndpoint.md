...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recommendationsservice/get-azrecommendationsserviceendpoint
schema: 2.0.0
---

# Get-AzRecommendationsServiceEndpoint
...
### List (Default)
```
Get-AzRecommendationsServiceEndpoint -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRecommendationsServiceEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecommendationsServiceEndpoint -InputObject <IRecommendationsServiceIdentity>
