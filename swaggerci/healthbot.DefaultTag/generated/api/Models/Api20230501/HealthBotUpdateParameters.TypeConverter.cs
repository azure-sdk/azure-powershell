...
namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20230501
{
    ...
    public partial class HealthBotUpdateParametersTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="HealthBotUpdateParameters" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20230501.IHealthBotUpdateParameters ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20230501.IHealthBotUpdateParameters).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
