...
Update-AzRedHatOpenShiftCluster -InputObject <IRedHatOpenShiftIdentity> [-ApiserverProfileIP <String>]
 ...
 [-NetworkProfileServiceCidr <String>] [-ProvisioningState <ProvisioningState>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20230904.IIngressProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20230904.IWorkerProfile[]
Parameter Sets: (All)
Aliases:
