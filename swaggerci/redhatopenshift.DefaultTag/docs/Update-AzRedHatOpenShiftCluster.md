...
Update-AzRedHatOpenShiftCluster -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 ...
 [-ClusterProfileVersion <String>] [-IdentityType <ResourceIdentityType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Support.ResourceIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IPlatformWorkloadIdentity[]
Parameter Sets: (All)
Aliases:
