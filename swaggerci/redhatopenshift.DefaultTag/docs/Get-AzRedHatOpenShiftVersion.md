...
online version: https://learn.microsoft.com/powershell/module/az.redhatopenshift/get-azredhatopenshiftversion
schema: 2.0.0
---
...
### Get
```
Get-AzRedHatOpenShiftVersion -Location <String> -OpenShiftVersion <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRedHatOpenShiftVersion -InputObject <IRedHatOpenShiftIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IOpenShiftVersion
