...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview
{
    ...
    public partial class LoadBalancerProfile :
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.ILoadBalancerProfile,
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.ILoadBalancerProfileInternal
    {

        /// <summary>Backing field for <see cref="EffectiveOutboundIP" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IEffectiveOutboundIP[] _effectiveOutboundIP;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IEffectiveOutboundIP[] EffectiveOutboundIP { get => this._effectiveOutboundIP; }

        /// <summary>Backing field for <see cref="ManagedOutboundIP" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IManagedOutboundIPs _managedOutboundIP;

        /// <summary>The desired managed outbound IPs for the cluster public load balancer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Origin(Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IManagedOutboundIPs ManagedOutboundIP { get => (this._managedOutboundIP = this._managedOutboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.ManagedOutboundIPs()); set => this._managedOutboundIP = value; }
        ...
        public int? ManagedOutboundIPCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IManagedOutboundIPsInternal)ManagedOutboundIP).Count; set => ((Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IManagedOutboundIPsInternal)ManagedOutboundIP).Count = value ?? default(int); }

        /// <summary>Internal Acessors for EffectiveOutboundIP</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IEffectiveOutboundIP[] Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.ILoadBalancerProfileInternal.EffectiveOutboundIP { get => this._effectiveOutboundIP; set { {_effectiveOutboundIP = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IEffectiveOutboundIP[] EffectiveOutboundIP { get;  }
        /// <summary>
        /// Count represents the desired number of IPv4 outbound IPs created and managed by Azure for the cluster public load balancer.
        /// Allowed values are in the range of 1 - 20. The default value is 1.
        /// </summary>
    ...
    {
        /// <summary>The list of effective outbound IP addresses of the public load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IEffectiveOutboundIP[] EffectiveOutboundIP { get; set; }
        /// <summary>The desired managed outbound IPs for the cluster public load balancer.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IManagedOutboundIPs ManagedOutboundIP { get; set; }
        /// <summary>
        /// Count represents the desired number of IPv4 outbound IPs created and managed by Azure for the cluster public load balancer.
        /// Allowed values are in the range of 1 - 20. The default value is 1.
        /// </summary>
