...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/update-azredhatopenshiftsyncset
#>
function Update-AzRedHatOpenShiftSyncSet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20231122.ISyncSet])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.RedHatOpenShift.private\Update-AzRedHatOpenShiftSyncSet_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.RedHatOpenShift.private\Update-AzRedHatOpenShiftSyncSet_UpdateViaIdentityExpanded';
        }
