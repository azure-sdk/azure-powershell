...
PLATFORMWORKLOADIDENTITYPROFILEPLATFORMWORKLOADIDENTITY <IPlatformWorkloadIdentity[]>: .
  [OperatorName <String>]: The name of the operator for which the PlatformWorkloadIdentity is used for
...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/update-azredhatopenshiftcluster
#>
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Support.ResourceIdentityType])]
    [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Support.ResourceIdentityType]
    # The type of the Identity resource.
    ${IdentityType},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.IIdentityUserAssignedIdentities]))]
    ...
    # .
    # To construct, see NOTES section for PLATFORMWORKLOADIDENTITYPROFILEPLATFORMWORKLOADIDENTITY properties and create a hash table.
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.ITags]))]
    [System.Collections.Hashtable]
    # The resource tags.
    ${Tag},
