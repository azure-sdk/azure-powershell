...
INPUTOBJECT <IRedHatOpenShiftIdentity>: Identity Parameter
  ...
  [OpenShiftMinorVersion <String>]: The desired version value of the PlatformWorkloadIdentityRoleSet resource.
  [OpenShiftVersion <String>]: The desired version value of the OpenShiftVersion resource.
