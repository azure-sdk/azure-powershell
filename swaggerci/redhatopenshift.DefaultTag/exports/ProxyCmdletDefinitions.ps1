...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftPlatformWorkloadIdentityRoleSet_Get';
            GetViaIdentity = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftPlatformWorkloadIdentityRoleSet_GetViaIdentity';
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftVersion_Get';
            GetViaIdentity = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftVersion_GetViaIdentity';
