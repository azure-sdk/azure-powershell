...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/new-azredhatopenshiftsecret
#>
function New-AzRedHatOpenShiftSecret {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.RedHatOpenShift.private\New-AzRedHatOpenShiftSecret_CreateExpanded';
        }
