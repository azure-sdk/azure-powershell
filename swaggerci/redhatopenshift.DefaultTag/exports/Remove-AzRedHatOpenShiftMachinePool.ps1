...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/remove-azredhatopenshiftmachinepool
#>
function Remove-AzRedHatOpenShiftMachinePool {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.RedHatOpenShift.private\Remove-AzRedHatOpenShiftMachinePool_Delete';
            DeleteViaIdentity = 'Az.RedHatOpenShift.private\Remove-AzRedHatOpenShiftMachinePool_DeleteViaIdentity';
        }
