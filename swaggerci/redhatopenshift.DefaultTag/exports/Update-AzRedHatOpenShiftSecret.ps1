...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/update-azredhatopenshiftsecret
#>
function Update-AzRedHatOpenShiftSecret {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20240812Preview.ISecret])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.RedHatOpenShift.private\Update-AzRedHatOpenShiftSecret_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.RedHatOpenShift.private\Update-AzRedHatOpenShiftSecret_UpdateViaIdentityExpanded';
        }
