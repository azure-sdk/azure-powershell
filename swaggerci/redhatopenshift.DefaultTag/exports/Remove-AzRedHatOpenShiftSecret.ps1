...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/remove-azredhatopenshiftsecret
#>
function Remove-AzRedHatOpenShiftSecret {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.RedHatOpenShift.private\Remove-AzRedHatOpenShiftSecret_Delete';
            DeleteViaIdentity = 'Az.RedHatOpenShift.private\Remove-AzRedHatOpenShiftSecret_DeleteViaIdentity';
        }
