...
online version: https://learn.microsoft.com/powershell/module/az.qumulostorage/remove-azqumulostoragefilesystem
schema: 2.0.0
---

# Remove-AzQumuloStorageFileSystem
...
### Delete (Default)
```
Remove-AzQumuloStorageFileSystem -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzQumuloStorageFileSystem -InputObject <IQumuloStorageIdentity> [-DefaultProfile <PSObject>] [-AsJob]
