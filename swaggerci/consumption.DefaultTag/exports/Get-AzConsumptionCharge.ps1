...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IChargeSummary
.Link
https://learn.microsoft.com/powershell/module/az.consumption/get-azconsumptioncharge
#>
function Get-AzConsumptionCharge {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IChargeSummary])]
