...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IManagementGroupAggregatedCostResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IManagementGroupAggregatedCostResult])]
