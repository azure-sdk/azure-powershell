...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.IManagementGroupAggregatedCostResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.IManagementGroupAggregatedCostResult])]
