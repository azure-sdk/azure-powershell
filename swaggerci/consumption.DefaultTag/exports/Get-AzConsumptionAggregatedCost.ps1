...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IManagementGroupAggregatedCostResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IManagementGroupAggregatedCostResult])]
