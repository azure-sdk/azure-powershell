...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ITagsResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ITagsResult])]
