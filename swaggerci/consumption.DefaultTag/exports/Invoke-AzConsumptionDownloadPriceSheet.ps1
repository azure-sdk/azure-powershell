...
.Link
https://learn.microsoft.com/powershell/module/az.consumption/invoke-azconsumptiondownloadpricesheet
#>
function Invoke-AzConsumptionDownloadPriceSheet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IOperationStatus])]
...
begin {
    try {
        ...
        $mapping = @{
            Download = 'Az.Consumption.private\Invoke-AzConsumptionDownloadPriceSheet_Download';
            DownloadViaIdentity = 'Az.Consumption.private\Invoke-AzConsumptionDownloadPriceSheet_DownloadViaIdentity';
        }
