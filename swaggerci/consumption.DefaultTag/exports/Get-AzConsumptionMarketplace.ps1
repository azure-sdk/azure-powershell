...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.IMarketplace
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.IMarketplace])]
