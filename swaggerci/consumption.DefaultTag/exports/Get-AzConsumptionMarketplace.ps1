...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.IMarketplace
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.IMarketplace])]
