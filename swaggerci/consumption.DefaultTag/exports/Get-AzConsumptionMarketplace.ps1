...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IMarketplace
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IMarketplace])]
