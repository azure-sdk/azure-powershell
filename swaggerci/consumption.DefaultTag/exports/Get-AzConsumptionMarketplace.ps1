...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMarketplace
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMarketplace])]
