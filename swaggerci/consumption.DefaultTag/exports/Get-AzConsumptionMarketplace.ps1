...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMarketplace
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMarketplace])]
