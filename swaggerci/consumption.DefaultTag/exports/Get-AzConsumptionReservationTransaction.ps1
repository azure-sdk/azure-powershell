...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.IReservationTransaction], [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.IModernReservationTransaction])]
