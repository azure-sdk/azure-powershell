...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.IReservationTransaction], [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.IModernReservationTransaction])]
