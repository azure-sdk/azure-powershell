...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IReservationRecommendationDetailsModel])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Category('Path')]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IBudgetPropertiesNotifications]))]
