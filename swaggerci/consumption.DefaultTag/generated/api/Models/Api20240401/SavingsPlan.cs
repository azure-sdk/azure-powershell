...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401
{
    ...
    public partial class SavingsPlan :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.ISavingsPlan,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.ISavingsPlanInternal
    {
        ...
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.ISavingsPlanInternal.EffectivePrice { get => this._effectivePrice; set { {_effectivePrice = value;} } }

        /// <summary>Internal Acessors for MarketPrice</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.ISavingsPlanInternal.MarketPrice { get => this._marketPrice; set { {_marketPrice = value;} } }

        /// <summary>Internal Acessors for Term</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.ISavingsPlanInternal.Term { get => this._term; set { {_term = value;} } }
