...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401
{
    ...
    public partial class MeterDetailsResponse :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponse,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponseInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponseInternal.MeterCategory { get => this._meterCategory; set { {_meterCategory = value;} } }

        /// <summary>Internal Acessors for MeterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponseInternal.MeterName { get => this._meterName; set { {_meterName = value;} } }

        /// <summary>Internal Acessors for MeterSubCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponseInternal.MeterSubCategory { get => this._meterSubCategory; set { {_meterSubCategory = value;} } }

        /// <summary>Internal Acessors for ServiceFamily</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponseInternal.ServiceFamily { get => this._serviceFamily; set { {_serviceFamily = value;} } }

        /// <summary>Internal Acessors for UnitOfMeasure</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401.IMeterDetailsResponseInternal.UnitOfMeasure { get => this._unitOfMeasure; set { {_unitOfMeasure = value;} } }
