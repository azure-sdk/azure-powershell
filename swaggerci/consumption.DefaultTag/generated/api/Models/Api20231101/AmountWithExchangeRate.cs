...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101
{
    ...
    public partial class AmountWithExchangeRate :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountWithExchangeRate,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountWithExchangeRateInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmount"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmount __amount = new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.Amount();
        ...
        public string Currency { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal)__amount).Currency; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal.Currency { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal)__amount).Currency; set => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal)__amount).Currency = value; }

        /// <summary>Internal Acessors for Value</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal.Value { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal)__amount).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal)__amount).Value = value; }

        /// <summary>Internal Acessors for ExchangeRate</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountWithExchangeRateInternal.ExchangeRate { get => this._exchangeRate; set { {_exchangeRate = value;} } }

        /// <summary>Internal Acessors for ExchangeRateMonth</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountWithExchangeRateInternal.ExchangeRateMonth { get => this._exchangeRateMonth; set { {_exchangeRateMonth = value;} } }

        /// <summary>Amount.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Origin(Microsoft.Azure.PowerShell.Cmdlets.Consumption.PropertyOrigin.Inherited)]
        public decimal? Value { get => ((Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal)__amount).Value; }
    ...
    public partial interface IAmountWithExchangeRate :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmount
    {
        /// <summary>The exchange rate.</summary>
    ...
    internal partial interface IAmountWithExchangeRateInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20231101.IAmountInternal
    {
        /// <summary>The exchange rate.</summary>
