...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401
{
    ...
    public partial class LotProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.ILotProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.ILotProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.ILotProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode node)
        {
        ...
        internal LotProperties(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject json)
        {
            ...
            {_originalAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("originalAmount"), out var __jsonOriginalAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.Amount.FromJson(__jsonOriginalAmount) : OriginalAmount;}
            {_closedBalance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("closedBalance"), out var __jsonClosedBalance) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.Amount.FromJson(__jsonClosedBalance) : ClosedBalance;}
            {_originalAmountInBillingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("originalAmountInBillingCurrency"), out var __jsonOriginalAmountInBillingCurrency) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.AmountWithExchangeRate.FromJson(__jsonOriginalAmountInBillingCurrency) : OriginalAmountInBillingCurrency;}
            {_closedBalanceInBillingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("closedBalanceInBillingCurrency"), out var __jsonClosedBalanceInBillingCurrency) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.AmountWithExchangeRate.FromJson(__jsonClosedBalanceInBillingCurrency) : ClosedBalanceInBillingCurrency;}
            {_reseller = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("reseller"), out var __jsonReseller) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.Reseller.FromJson(__jsonReseller) : Reseller;}
            {_usedAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("usedAmount"), out var __jsonUsedAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20250401.Amount.FromJson(__jsonUsedAmount) : UsedAmount;}
            ...
            {_organizationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonString>("OrganizationType"), out var __jsonOrganizationType) ? (string)__jsonOrganizationType : (string)OrganizationType;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._usedAmount ? (Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode) this._usedAmount.ToJson(null,serializationMode) : null, "usedAmount" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._organizationType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonString(this._organizationType.ToString()) : null, "OrganizationType" ,container.Add );
            }
