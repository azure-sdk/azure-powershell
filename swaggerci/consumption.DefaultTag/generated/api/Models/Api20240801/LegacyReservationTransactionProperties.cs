...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801
{
    ...
    public partial class LegacyReservationTransactionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for AccountOwnerEmail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.AccountOwnerEmail { get => this._accountOwnerEmail; set { {_accountOwnerEmail = value;} } }

        /// <summary>Internal Acessors for Amount</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Amount { get => this._amount; set { {_amount = value;} } }

        /// <summary>Internal Acessors for ArmSkuName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.ArmSkuName { get => this._armSkuName; set { {_armSkuName = value;} } }

        /// <summary>Internal Acessors for BillingFrequency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.BillingFrequency { get => this._billingFrequency; set { {_billingFrequency = value;} } }

        /// <summary>Internal Acessors for BillingMonth</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.BillingMonth { get => this._billingMonth; set { {_billingMonth = value;} } }

        /// <summary>Internal Acessors for CostCenter</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.CostCenter { get => this._costCenter; set { {_costCenter = value;} } }

        /// <summary>Internal Acessors for Currency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Currency { get => this._currency; set { {_currency = value;} } }

        /// <summary>Internal Acessors for CurrentEnrollment</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.CurrentEnrollment { get => this._currentEnrollment; set { {_currentEnrollment = value;} } }

        /// <summary>Internal Acessors for DepartmentName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.DepartmentName { get => this._departmentName; set { {_departmentName = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for EventDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.EventDate { get => this._eventDate; set { {_eventDate = value;} } }

        /// <summary>Internal Acessors for EventType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.EventType { get => this._eventType; set { {_eventType = value;} } }

        /// <summary>Internal Acessors for MonetaryCommitment</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.MonetaryCommitment { get => this._monetaryCommitment; set { {_monetaryCommitment = value;} } }

        /// <summary>Internal Acessors for Overage</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Overage { get => this._overage; set { {_overage = value;} } }

        /// <summary>Internal Acessors for PurchasingEnrollment</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.PurchasingEnrollment { get => this._purchasingEnrollment; set { {_purchasingEnrollment = value;} } }

        /// <summary>Internal Acessors for PurchasingSubscriptionGuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.PurchasingSubscriptionGuid { get => this._purchasingSubscriptionGuid; set { {_purchasingSubscriptionGuid = value;} } }

        /// <summary>Internal Acessors for PurchasingSubscriptionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.PurchasingSubscriptionName { get => this._purchasingSubscriptionName; set { {_purchasingSubscriptionName = value;} } }

        /// <summary>Internal Acessors for Quantity</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Quantity { get => this._quantity; set { {_quantity = value;} } }

        /// <summary>Internal Acessors for Region</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Region { get => this._region; set { {_region = value;} } }

        /// <summary>Internal Acessors for ReservationOrderId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.ReservationOrderId { get => this._reservationOrderId; set { {_reservationOrderId = value;} } }

        /// <summary>Internal Acessors for ReservationOrderName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.ReservationOrderName { get => this._reservationOrderName; set { {_reservationOrderName = value;} } }

        /// <summary>Internal Acessors for Term</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240801.ILegacyReservationTransactionPropertiesInternal.Term { get => this._term; set { {_term = value;} } }
