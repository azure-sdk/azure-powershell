...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview
{
    ...
    public partial class SavingsPlan :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ISavingsPlan,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ISavingsPlanInternal
    {
        ...
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ISavingsPlanInternal.EffectivePrice { get => this._effectivePrice; set { {_effectivePrice = value;} } }

        /// <summary>Internal Acessors for MarketPrice</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ISavingsPlanInternal.MarketPrice { get => this._marketPrice; set { {_marketPrice = value;} } }

        /// <summary>Internal Acessors for Term</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ISavingsPlanInternal.Term { get => this._term; set { {_term = value;} } }
