...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview
{
    ...
    public partial class MeterDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.MeterCategory { get => this._meterCategory; set { {_meterCategory = value;} } }

        /// <summary>Internal Acessors for MeterLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.MeterLocation { get => this._meterLocation; set { {_meterLocation = value;} } }

        /// <summary>Internal Acessors for MeterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.MeterName { get => this._meterName; set { {_meterName = value;} } }

        /// <summary>Internal Acessors for MeterSubCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.MeterSubCategory { get => this._meterSubCategory; set { {_meterSubCategory = value;} } }

        /// <summary>Internal Acessors for PretaxStandardRate</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.PretaxStandardRate { get => this._pretaxStandardRate; set { {_pretaxStandardRate = value;} } }

        /// <summary>Internal Acessors for ServiceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.ServiceName { get => this._serviceName; set { {_serviceName = value;} } }

        /// <summary>Internal Acessors for ServiceTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.ServiceTier { get => this._serviceTier; set { {_serviceTier = value;} } }

        /// <summary>Internal Acessors for TotalIncludedQuantity</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.TotalIncludedQuantity { get => this._totalIncludedQuantity; set { {_totalIncludedQuantity = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.IMeterDetailsInternal.Unit { get => this._unit; set { {_unit = value;} } }
