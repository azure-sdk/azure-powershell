...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview
{
    ...
    public partial class LotProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ILotProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ILotProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ILotProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode node)
        {
        ...
        internal LotProperties(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject json)
        {
            ...
            {_originalAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("originalAmount"), out var __jsonOriginalAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.Amount.FromJson(__jsonOriginalAmount) : OriginalAmount;}
            {_usedAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("usedAmount"), out var __jsonUsedAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.Amount.FromJson(__jsonUsedAmount) : UsedAmount;}
            {_closedBalance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("closedBalance"), out var __jsonClosedBalance) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.Amount.FromJson(__jsonClosedBalance) : ClosedBalance;}
            {_originalAmountInBillingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("originalAmountInBillingCurrency"), out var __jsonOriginalAmountInBillingCurrency) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.AmountWithExchangeRate.FromJson(__jsonOriginalAmountInBillingCurrency) : OriginalAmountInBillingCurrency;}
            {_closedBalanceInBillingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("closedBalanceInBillingCurrency"), out var __jsonClosedBalanceInBillingCurrency) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.AmountWithExchangeRate.FromJson(__jsonClosedBalanceInBillingCurrency) : ClosedBalanceInBillingCurrency;}
            ...
            {_lotType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonString>("lotType"), out var __jsonLotType) ? (string)__jsonLotType : (string)LotType;}
            ...
            {_extendedProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("extendedProperties"), out var __jsonExtendedProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Any.FromJson(__jsonExtendedProperties) : ExtendedProperty;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._lotType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonString(this._lotType.ToString()) : null, "lotType" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._extendedProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode) this._extendedProperty.ToJson(null,serializationMode) : null, "extendedProperties" ,container.Add );
            }
