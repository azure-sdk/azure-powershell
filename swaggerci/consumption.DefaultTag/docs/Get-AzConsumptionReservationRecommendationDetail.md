...
Get-AzConsumptionReservationRecommendationDetail -ResourceScope <String> -LookBackPeriod <LookBackPeriod>
 -Product <String> -Region <String> -Scope <Scope> -Term <String> [-Filter <String>]
...
Get-AzConsumptionReservationRecommendationDetail -InputObject <IConsumptionIdentity>
 -LookBackPeriod <LookBackPeriod> -Product <String> -Region <String> -Scope <Scope> -Term <String>
...
Specify in ISO 8601 Duration.
Allowed values: ['P1M', 'P1Y', 'P3Y']
