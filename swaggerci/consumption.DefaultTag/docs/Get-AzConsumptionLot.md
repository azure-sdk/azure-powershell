...
### List1 (Default)
```
Get-AzConsumptionLot -BillingAccountId <String> [-ExtendedProperty] [-Filter <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20240401Preview.ILotSummary
