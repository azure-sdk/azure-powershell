...
namespace Microsoft.Azure.PowerShell.Cmdlets.Vi.Models
{
    ...
    public partial class ViIdentity :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.IViIdentityInternal
    {

        /// <summary>Backing field for <see cref="AccountName" /> property.</summary>
        private string _accountName;

        /// <summary>The name of the Azure Video Analyzer for Media account.</summary>
        ...
        /// <summary>Creates an new <see cref="ViIdentity" /> instance.</summary>
        public ViIdentity()
        {

        }
    }
    public partial interface IViIdentity :
    ...
    internal partial interface IViIdentityInternal
