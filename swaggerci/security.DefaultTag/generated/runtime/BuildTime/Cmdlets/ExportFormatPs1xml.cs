...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Support";
