...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview
{
    ...
    public partial class GitLabProjectProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal.FullyQualifiedFriendlyName { get => this._fullyQualifiedFriendlyName; set { {_fullyQualifiedFriendlyName = value;} } }

        /// <summary>Internal Acessors for FullyQualifiedName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal.FullyQualifiedName { get => this._fullyQualifiedName; set { {_fullyQualifiedName = value;} } }

        /// <summary>Internal Acessors for FullyQualifiedParentGroupName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal.FullyQualifiedParentGroupName { get => this._fullyQualifiedParentGroupName; set { {_fullyQualifiedParentGroupName = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatusMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal.ProvisioningStatusMessage { get => this._provisioningStatusMessage; set { {_provisioningStatusMessage = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatusUpdateTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal.ProvisioningStatusUpdateTimeUtc { get => this._provisioningStatusUpdateTimeUtc; set { {_provisioningStatusUpdateTimeUtc = value;} } }

        /// <summary>Internal Acessors for Url</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitLabProjectPropertiesInternal.Url { get => this._url; set { {_url = value;} } }
