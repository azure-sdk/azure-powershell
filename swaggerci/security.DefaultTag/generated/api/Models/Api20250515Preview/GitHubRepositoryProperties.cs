...
namespace Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview
{
    ...
    public partial class GitHubRepositoryProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal.ProvisioningStatusMessage { get => this._provisioningStatusMessage; set { {_provisioningStatusMessage = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatusUpdateTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal.ProvisioningStatusUpdateTimeUtc { get => this._provisioningStatusUpdateTimeUtc; set { {_provisioningStatusUpdateTimeUtc = value;} } }

        /// <summary>Internal Acessors for RepoFullName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal.RepoFullName { get => this._repoFullName; set { {_repoFullName = value;} } }

        /// <summary>Internal Acessors for RepoId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal.RepoId { get => this._repoId; set { {_repoId = value;} } }

        /// <summary>Internal Acessors for RepoName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal.RepoName { get => this._repoName; set { {_repoName = value;} } }

        /// <summary>Internal Acessors for RepoUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20250515Preview.IGitHubRepositoryPropertiesInternal.RepoUrl { get => this._repoUrl; set { {_repoUrl = value;} } }
