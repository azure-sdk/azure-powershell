...
INPUTOBJECT <ISecurityCenterIdentity>: Identity Parameter
  ...
  [ScanId <String>]: The identifier of the scan. Can be either 'latest' or a GUID.
  [SettingName <SettingName?>]: Defender for Storage setting name.
.Link
https://learn.microsoft.com/powershell/module/az.securitycenter/get-azsecuritycenterdefenderforstoragemalwarescan
#>
function Get-AzSecurityCenterDefenderForStorageMalwareScan {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20241001Preview.IMalwareScanProperties])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SecurityCenter.private\Get-AzSecurityCenterDefenderForStorageMalwareScan_Get';
            GetViaIdentity = 'Az.SecurityCenter.private\Get-AzSecurityCenterDefenderForStorageMalwareScan_GetViaIdentity';
        }
...
INPUTOBJECT <ISecurityCenterIdentity>: Identity Parameter
  ...
  [SettingName <SettingName?>]: Defender for Storage setting name.
.Link
https://learn.microsoft.com/powershell/module/az.securitycenter/get-azsecuritycenterdefenderforstorage
#>
function Get-AzSecurityCenterDefenderForStorage {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SecurityCenter.private\Get-AzSecurityCenterDefenderForStorage_Get';
            GetViaIdentity = 'Az.SecurityCenter.private\Get-AzSecurityCenterDefenderForStorage_GetViaIdentity';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
...
INPUTOBJECT <ISecurityCenterIdentity>: Identity Parameter
  ...
  [SettingName <SettingName?>]: Defender for Storage setting name.
.Link
https://learn.microsoft.com/powershell/module/az.securitycenter/start-azsecuritycenterdefenderforstoragemalwarescan
#>
function Start-AzSecurityCenterDefenderForStorageMalwareScan {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20241001Preview.IMalwareScanProperties])]
...
begin {
    try {
        ...
        $mapping = @{
            Start = 'Az.SecurityCenter.private\Start-AzSecurityCenterDefenderForStorageMalwareScan_Start';
            StartViaIdentity = 'Az.SecurityCenter.private\Start-AzSecurityCenterDefenderForStorageMalwareScan_StartViaIdentity';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
...
INPUTOBJECT <ISecurityCenterIdentity>: Identity Parameter
  ...
  [SettingName <SettingName?>]: Defender for Storage setting name.
.Link
https://learn.microsoft.com/powershell/module/az.securitycenter/stop-azsecuritycenterdefenderforstoragemalwarescan
#>
function Stop-AzSecurityCenterDefenderForStorageMalwareScan {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Models.Api20241001Preview.IMalwareScanProperties])]
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.SecurityCenter.private\Stop-AzSecurityCenterDefenderForStorageMalwareScan_Cancel';
            CancelViaIdentity = 'Az.SecurityCenter.private\Stop-AzSecurityCenterDefenderForStorageMalwareScan_CancelViaIdentity';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.SecurityCenter.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
