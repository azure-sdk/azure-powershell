...
online version: https://learn.microsoft.com/powershell/module/az.securitycenter/new-azsecuritycenterazuredevoprepos
schema: 2.0.0
---

# New-AzSecurityCenterAzureDevOpRepos
...
```
New-AzSecurityCenterAzureDevOpRepos -OrgName <String> -ProjectName <String> -RepoName <String>
