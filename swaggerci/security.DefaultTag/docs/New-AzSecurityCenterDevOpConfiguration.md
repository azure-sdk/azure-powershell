...
online version: https://learn.microsoft.com/powershell/module/az.securitycenter/new-azsecuritycenterdevopconfiguration
schema: 2.0.0
---

# New-AzSecurityCenterDevOpConfiguration
...
```
New-AzSecurityCenterDevOpConfiguration -ResourceGroupName <String> -SecurityConnectorName <String>
