...
online version: https://learn.microsoft.com/powershell/module/az.securitycenter/get-azsecuritycenterazuredevopsorg
schema: 2.0.0
---

# Get-AzSecurityCenterAzureDevOpsOrg
...
### List (Default)
```
Get-AzSecurityCenterAzureDevOpsOrg -ResourceGroupName <String> -SecurityConnectorName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSecurityCenterAzureDevOpsOrg -OrgName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzSecurityCenterAzureDevOpsOrg -InputObject <ISecurityCenterIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
