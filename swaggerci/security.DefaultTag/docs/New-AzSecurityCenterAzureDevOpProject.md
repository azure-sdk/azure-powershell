...
online version: https://learn.microsoft.com/powershell/module/az.securitycenter/new-azsecuritycenterazuredevopproject
schema: 2.0.0
---

# New-AzSecurityCenterAzureDevOpProject
...
```
New-AzSecurityCenterAzureDevOpProject -OrgName <String> -ProjectName <String> -ResourceGroupName <String>
