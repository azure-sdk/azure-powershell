...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkconfigurationgroupschema
schema: 2.0.0
---

# Update-AzHybridNetworkConfigurationGroupSchema
...
```
Update-AzHybridNetworkConfigurationGroupSchema -Name <String> -PublisherName <String>
...
```
Update-AzHybridNetworkConfigurationGroupSchema -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
