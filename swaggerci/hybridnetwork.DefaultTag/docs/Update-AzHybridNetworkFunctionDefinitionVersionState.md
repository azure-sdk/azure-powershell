...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkfunctiondefinitionversionstate
schema: 2.0.0
---

# Update-AzHybridNetworkFunctionDefinitionVersionState
...
```
Update-AzHybridNetworkFunctionDefinitionVersionState -NetworkFunctionDefinitionGroupName <String>
 -NetworkFunctionDefinitionVersionName <String> -PublisherName <String> -ResourceGroupName <String>
...
```
Update-AzHybridNetworkFunctionDefinitionVersionState -InputObject <IHybridNetworkIdentity>
