...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkconfigurationgroupvaluetag
schema: 2.0.0
---

# Update-AzHybridNetworkConfigurationGroupValueTag
...
```
Update-AzHybridNetworkConfigurationGroupValueTag -ConfigurationGroupValueName <String>
...
```
Update-AzHybridNetworkConfigurationGroupValueTag -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
