...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/remove-azhybridnetworkservicedesignversion
schema: 2.0.0
---

# Remove-AzHybridNetworkServiceDesignVersion
...
### Delete (Default)
```
Remove-AzHybridNetworkServiceDesignVersion -Name <String> -NetworkServiceDesignGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridNetworkServiceDesignVersion -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
