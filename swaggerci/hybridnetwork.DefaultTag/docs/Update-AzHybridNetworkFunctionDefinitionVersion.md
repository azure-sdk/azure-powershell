...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkfunctiondefinitionversion
schema: 2.0.0
---

# Update-AzHybridNetworkFunctionDefinitionVersion
...
```
Update-AzHybridNetworkFunctionDefinitionVersion -Name <String> -NetworkFunctionDefinitionGroupName <String>
 -PublisherName <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHybridNetworkFunctionDefinitionVersion -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
