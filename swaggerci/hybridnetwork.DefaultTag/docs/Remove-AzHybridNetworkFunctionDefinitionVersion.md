...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/remove-azhybridnetworkfunctiondefinitionversion
schema: 2.0.0
---

# Remove-AzHybridNetworkFunctionDefinitionVersion
...
### Delete (Default)
```
Remove-AzHybridNetworkFunctionDefinitionVersion -Name <String> -NetworkFunctionDefinitionGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridNetworkFunctionDefinitionVersion -InputObject <IHybridNetworkIdentity>
