...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworksitenetworkservicetag
schema: 2.0.0
---
...
```
Update-AzHybridNetworkSiteNetworkServiceTag -ResourceGroupName <String> -SiteNetworkServiceName <String>
...
```
Update-AzHybridNetworkSiteNetworkServiceTag -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
