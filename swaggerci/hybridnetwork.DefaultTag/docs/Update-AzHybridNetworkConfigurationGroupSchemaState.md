...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkconfigurationgroupschemastate
schema: 2.0.0
---

# Update-AzHybridNetworkConfigurationGroupSchemaState
...
```
Update-AzHybridNetworkConfigurationGroupSchemaState -ConfigurationGroupSchemaName <String>
 -PublisherName <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-VersionState <VersionState>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHybridNetworkConfigurationGroupSchemaState -InputObject <IHybridNetworkIdentity>
