...
online version: https://learn.microsoft.com/powershell/module/az.hybridnetwork/update-azhybridnetworkservicedesignversion
schema: 2.0.0
---

# Update-AzHybridNetworkServiceDesignVersion
...
```
Update-AzHybridNetworkServiceDesignVersion -Name <String> -NetworkServiceDesignGroupName <String>
...
```
Update-AzHybridNetworkServiceDesignVersion -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
