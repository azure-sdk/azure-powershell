...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901
{
    ...
    public partial class AzureStorageAccountCredential :
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountCredential,
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountCredentialInternal,
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IArtifactAccessCredential"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IArtifactAccessCredential __artifactAccessCredential = new Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.ArtifactAccessCredential();

        /// <summary>Backing field for <see cref="ContainerCredentials" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountContainerCredential[] _containerCredentials;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountContainerCredential[] ContainerCredentials { get => this._containerCredentials; set => this._containerCredentials = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.CredentialType CredentialType { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IArtifactAccessCredentialInternal)__artifactAccessCredential).CredentialType; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IArtifactAccessCredentialInternal)__artifactAccessCredential).CredentialType = value ; }
    ...
    public partial interface IAzureStorageAccountCredential :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IArtifactAccessCredential
    {
        /// <summary>The containers that could be accessed using the current credential.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountContainerCredential) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountContainerCredential[] ContainerCredentials { get; set; }
        /// <summary>The UTC time when credential will expire.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IAzureStorageAccountCredentialInternal :
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IArtifactAccessCredentialInternal
    {
        /// <summary>The containers that could be accessed using the current credential.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.IAzureStorageAccountContainerCredential[] ContainerCredentials { get; set; }
        /// <summary>The UTC time when credential will expire.</summary>
