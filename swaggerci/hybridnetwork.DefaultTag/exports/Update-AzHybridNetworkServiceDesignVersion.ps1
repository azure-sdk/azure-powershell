...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.INetworkServiceDesignVersion])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Models.Api20230901.ITagsObjectTags]))]
