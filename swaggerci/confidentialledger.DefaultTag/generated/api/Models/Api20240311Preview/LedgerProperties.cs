...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview
{
    ...
    public partial class LedgerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AadBasedSecurityPrincipal" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.IAadBasedSecurityPrincipal[] _aadBasedSecurityPrincipal;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.IAadBasedSecurityPrincipal[] AadBasedSecurityPrincipal { get => this._aadBasedSecurityPrincipal; set => this._aadBasedSecurityPrincipal = value; }

        /// <summary>Backing field for <see cref="CertBasedSecurityPrincipal" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ICertBasedSecurityPrincipal[] _certBasedSecurityPrincipal;

        /// <summary>Array of all cert based Security Principals.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Origin(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ICertBasedSecurityPrincipal[] CertBasedSecurityPrincipal { get => this._certBasedSecurityPrincipal; set => this._certBasedSecurityPrincipal = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Origin(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.EnclavePlatform? EnclavePlatform { get => this._enclavePlatform; }
        ...
        /// <summary>Internal Acessors for EnclavePlatform</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.EnclavePlatform? Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal.EnclavePlatform { get => this._enclavePlatform; set { {_enclavePlatform = value;} } }

        /// <summary>Internal Acessors for IdentityServiceUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal.IdentityServiceUri { get => this._identityServiceUri; set { {_identityServiceUri = value;} } }

        /// <summary>Internal Acessors for LedgerInternalNamespace</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal.LedgerInternalNamespace { get => this._ledgerInternalNamespace; set { {_ledgerInternalNamespace = value;} } }

        /// <summary>Internal Acessors for LedgerName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal.LedgerName { get => this._ledgerName; set { {_ledgerName = value;} } }

        /// <summary>Internal Acessors for LedgerUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal.LedgerUri { get => this._ledgerUri; set { {_ledgerUri = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ILedgerPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.IAadBasedSecurityPrincipal[] AadBasedSecurityPrincipal { get; set; }
        /// <summary>Array of all cert based Security Principals.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240311Preview.ICertBasedSecurityPrincipal[] CertBasedSecurityPrincipal { get; set; }
        /// <summary>Enclave Platform on which Ledger Application is deployed, defaults to IntelSgx</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Info(
        Required = false,
        ReadOnly = true,
        Description = @"Enclave Platform on which Ledger Application is deployed, defaults to IntelSgx",
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.EnclavePlatform? EnclavePlatform { get;  }
        /// <summary>Endpoint for accessing network identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Runtime.Info(
        Required = false,
        ReadOnly = true,
