...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview
{
    ...
    public partial class ResourceProviderOperationDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDefinitionInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.ResourceProviderOperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDisplayInternal)Display).Description = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDefinitionInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.ResourceProviderOperationDisplay()); set { {_display = value;} } }
    ...
    {
        /// <summary>Details about the operations</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Models.Api20240919Preview.IResourceProviderOperationDisplay Display { get; set; }
        /// <summary>Description of the resource provider operation.</summary>
        string DisplayDescription { get; set; }
        /// <summary>Name of the resource provider operation.</summary>
        string DisplayOperation { get; set; }
