...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ApplicationType CodeTransparency = @"CodeTransparency";

        public static Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ApplicationType ConfidentialLedger = @"ConfidentialLedger";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ApplicationType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ApplicationType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ApplicationType e1, Microsoft.Azure.PowerShell.Cmdlets.ConfidentialLedger.Support.ApplicationType e2)
        {
            return !e2.Equals(e1);
        }
