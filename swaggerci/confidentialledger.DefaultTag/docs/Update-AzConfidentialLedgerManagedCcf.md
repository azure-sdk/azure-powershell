...
Update-AzConfidentialLedgerManagedCcf -InputObject <IConfidentialLedgerIdentity> -Location <String>
 ...
 [-EnclavePlatform <EnclavePlatform>] [-MemberIdentityCertificate <IMemberIdentityCertificate[]>]
 [-NodeCount <Int32>] [-RunningState <RunningState>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
