...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20230131.IPrivateEndpointConnection
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20230131.IPrivateEndpointConnection])]
