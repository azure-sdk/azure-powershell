...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IGroupIdInformation])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsResourceTags]))]
    [System.Collections.Hashtable]
    # The resource tags.
    ${Tag},
