...
Remove-AzDigitalTwinsTimeSeriesDatabaseConnection -Name <String> -ResourceGroupName <String>
 -ResourceName <String> [-SubscriptionId <String>] [-CleanupConnectionArtifact <CleanupConnectionArtifacts>]
...
Remove-AzDigitalTwinsTimeSeriesDatabaseConnection -InputObject <IDigitalTwinsIdentity>
 [-CleanupConnectionArtifact <CleanupConnectionArtifacts>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.CleanupConnectionArtifacts
Parameter Sets: (All)
Aliases:
