...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview
{
    ...
    public partial class ConnectionPropertiesPrivateLinkServiceConnectionState :
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionPropertiesPrivateLinkServiceConnectionState,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionPropertiesPrivateLinkServiceConnectionStateInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionState"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionState __connectionState = new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.ConnectionState();
        ...
        public string ActionsRequired { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal)__connectionState).ActionsRequired; set => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal)__connectionState).ActionsRequired = value ?? null; }

        /// <summary>The description for the current state of a private endpoint connection.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Inherited)]
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal)__connectionState).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal)__connectionState).Description = value ; }

        /// <summary>The status of a private endpoint connection.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Inherited)]
        public Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.PrivateLinkServiceConnectionStatus Status { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal)__connectionState).Status; set => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal)__connectionState).Status = value ; }
    ...
    public partial interface IConnectionPropertiesPrivateLinkServiceConnectionState :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionState
    {

    }
    /// The connection state.
    internal partial interface IConnectionPropertiesPrivateLinkServiceConnectionStateInternal :
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20210630Preview.IConnectionStateInternal
    {
