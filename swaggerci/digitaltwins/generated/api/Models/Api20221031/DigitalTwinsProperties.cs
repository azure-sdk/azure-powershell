...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031
{
    ...
    public partial class DigitalTwinsProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsPropertiesInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsPropertiesInternal.CreatedTime { get => this._createdTime; set { {_createdTime = value;} } }

        /// <summary>Internal Acessors for HostName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsPropertiesInternal.HostName { get => this._hostName; set { {_hostName = value;} } }

        /// <summary>Internal Acessors for LastUpdatedTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsPropertiesInternal.LastUpdatedTime { get => this._lastUpdatedTime; set { {_lastUpdatedTime = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IDigitalTwinsPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="PrivateEndpointConnection" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IPrivateEndpointConnection[] _privateEndpointConnection;

        /// <summary>The private endpoint connections.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20221031.IPrivateEndpointConnection[] PrivateEndpointConnection { get => this._privateEndpointConnection; set => this._privateEndpointConnection = value; }
