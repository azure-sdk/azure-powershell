...
online version: https://docs.microsoft.com/en-us/powershell/module/az.stack/remove-azstackcustomersubscription
schema: 2.0.0
---

# Remove-AzStackCustomerSubscription
...
### Delete (Default)
```
Remove-AzStackCustomerSubscription -Name <String> -RegistrationName <String> -ResourceGroup <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStackCustomerSubscription -InputObject <IStackIdentity> [-DefaultProfile <PSObject>] [-PassThru]
