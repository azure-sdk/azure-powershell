...
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.EnterpriseKnowledgeGraphService.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.EnterpriseKnowledgeGraphService.Module]::Instance
