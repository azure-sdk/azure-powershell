...
online version: https://learn.microsoft.com/powershell/module/az.networkanalyticsfortesting/new-aznetworkanalyticsfortestingdatatype
schema: 2.0.0
---

# New-AzNetworkAnalyticsForTestingDataType
...
```
New-AzNetworkAnalyticsForTestingDataType -DataProductName <String> -Name <String> -ResourceGroupName <String>
