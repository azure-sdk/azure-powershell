...
online version: https://learn.microsoft.com/powershell/module/az.networkanalytics/new-aznetworkanalyticsdatatype
schema: 2.0.0
---

# New-AzNetworkAnalyticsDataType
...
```
New-AzNetworkAnalyticsDataType -DataProductName <String> -Name <String> -ResourceGroupName <String>
