...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support";
