...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115
{
    ...
    public partial class ConsumptionEndpointsProperties :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsProperties,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal.FileAccessResourceId { get => this._fileAccessResourceId; set { {_fileAccessResourceId = value;} } }

        /// <summary>Internal Acessors for FileAccessUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal.FileAccessUrl { get => this._fileAccessUrl; set { {_fileAccessUrl = value;} } }

        /// <summary>Internal Acessors for IngestionResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal.IngestionResourceId { get => this._ingestionResourceId; set { {_ingestionResourceId = value;} } }

        /// <summary>Internal Acessors for IngestionUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal.IngestionUrl { get => this._ingestionUrl; set { {_ingestionUrl = value;} } }

        /// <summary>Internal Acessors for QueryResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal.QueryResourceId { get => this._queryResourceId; set { {_queryResourceId = value;} } }

        /// <summary>Internal Acessors for QueryUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Models.Api20231115.IConsumptionEndpointsPropertiesInternal.QueryUrl { get => this._queryUrl; set { {_queryUrl = value;} } }
