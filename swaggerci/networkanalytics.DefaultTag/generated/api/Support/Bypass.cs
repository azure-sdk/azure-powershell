...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support
{
    ...
    {
        /// <summary>Represents bypassing azure services traffic.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass AzureServices = @"AzureServices";

        /// <summary>Represents bypassing logging traffic.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass Logging = @"Logging";

        /// <summary>Represents bypassing metrics traffic.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass Metrics = @"Metrics";

        /// <summary>Represents no bypassing of traffic.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass None = @"None";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass e1, Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalyticsForTesting.Support.Bypass e2)
        {
            return !e2.Equals(e1);
        }
