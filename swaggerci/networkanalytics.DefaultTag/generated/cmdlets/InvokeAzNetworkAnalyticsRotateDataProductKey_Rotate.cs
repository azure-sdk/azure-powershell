...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RotateKey=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}/rotateKey"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzNetworkAnalyticsRotateDataProductKey_Rotate", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Description(@"Initiate key rotation on Data Product.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/dataProducts/{dataProductName}/rotateKey", ApiVersion = "2023-11-15")]
    public partial class InvokeAzNetworkAnalyticsRotateDataProductKey_Rotate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IKeyVaultInfo _body;

        /// <summary>Details for KeyVault.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Details for KeyVault.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Details for KeyVault.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IKeyVaultInfo) })]
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20231115.IKeyVaultInfo Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzNetworkAnalyticsRotateDataProductKey_Rotate" /> cmdlet class.
        /// </summary>
        public InvokeAzNetworkAnalyticsRotateDataProductKey_Rotate()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DataProductsRotateKey' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DataProductsRotateKey(SubscriptionId, ResourceGroupName, DataProductName, Body, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,DataProductName=DataProductName,body=Body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, DataProductName=DataProductName, body=Body })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, DataProductName=DataProductName, body=Body })
                    {
