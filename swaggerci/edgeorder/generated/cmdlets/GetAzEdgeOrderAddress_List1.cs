...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListAddressesAtResourceGroupLevel=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/addresses"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Description(@"Lists all the addresses available under the given resource group.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "$skipToken is supported on Get list of addresses, which provides the next page in the list of address.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ListAddressesAtResourceGroupLevel(SubscriptionId, ResourceGroupName, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ListAddressesAtResourceGroupLevel_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
