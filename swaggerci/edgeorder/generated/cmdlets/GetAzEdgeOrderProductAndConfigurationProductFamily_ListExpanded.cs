...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListProductFamilies=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.EdgeOrder/listProductFamilies"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEdgeOrderProductAndConfigurationProductFamily_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamily))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Description(@"List product families for the given subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Generated]
    public partial class GetAzEdgeOrderProductAndConfigurationProductFamily_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamiliesRequest _productFamiliesRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.ProductFamiliesRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Location placement Id of a subscription.")]
        ...
        public string CustomerSubscriptionDetailLocationPlacementId { get => _productFamiliesRequestBody.CustomerSubscriptionDetailLocationPlacementId ?? null; set => _productFamiliesRequestBody.CustomerSubscriptionDetailLocationPlacementId = value; }

        /// <summary>Quota ID of a subscription.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Quota ID of a subscription.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string CustomerSubscriptionDetailQuotaId { get => _productFamiliesRequestBody.CustomerSubscriptionDetailQuotaId ?? null; set => _productFamiliesRequestBody.CustomerSubscriptionDetailQuotaId = value; }

        /// <summary>List of registered feature flags for subscription.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of registered feature flags for subscription.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "$expand is supported on configurations parameter for product, which provides details on the configurations for the product.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Dictionary of filterable properties on product family.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamiliesRequestFilterableProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamiliesRequestFilterableProperties FilterableProperty { get => _productFamiliesRequestBody.FilterableProperty ?? null /* object */; set => _productFamiliesRequestBody.FilterableProperty = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "$skipToken is supported on list of product families, which provides the next page in the list of product families.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamilies">Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamilies</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamilies> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEdgeOrderProductAndConfigurationProductFamily_ListExpanded" /> cmdlet
        /// class.
        /// </summary>
        public GetAzEdgeOrderProductAndConfigurationProductFamily_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ProductsAndConfigurationsListProductFamilies' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ProductsAndConfigurationsListProductFamilies(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, _productFamiliesRequestBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EdgeOrder.Models.Api20220501Preview.IProductFamilies> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ProductsAndConfigurationsListProductFamilies_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
