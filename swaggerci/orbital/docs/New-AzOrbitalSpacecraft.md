...
online version: https://docs.microsoft.com/en-us/powershell/module/az.orbital/new-azorbitalspacecraft
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.ISpacecraftLink[]
Parameter Sets: (All)
Aliases:
