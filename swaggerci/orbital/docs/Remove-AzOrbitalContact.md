...
online version: https://docs.microsoft.com/en-us/powershell/module/az.orbital/remove-azorbitalcontact
schema: 2.0.0
---

# Remove-AzOrbitalContact
...
### Delete (Default)
```
Remove-AzOrbitalContact -Name <String> -ResourceGroupName <String> -SpacecraftName <String>
...
### DeleteViaIdentity
```
Remove-AzOrbitalContact -InputObject <IOrbitalIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
