...
online version: https://docs.microsoft.com/en-us/powershell/module/az.orbital/get-azorbitalcontactprofile
schema: 2.0.0
---
...
### List (Default)
```
Get-AzOrbitalContactProfile [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### List1
```
Get-AzOrbitalContactProfile -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
