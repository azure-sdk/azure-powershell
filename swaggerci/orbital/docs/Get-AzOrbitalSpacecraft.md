...
online version: https://docs.microsoft.com/en-us/powershell/module/az.orbital/get-azorbitalspacecraft
schema: 2.0.0
---
...
### List (Default)
```
Get-AzOrbitalSpacecraft [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### List1
```
Get-AzOrbitalSpacecraft -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
