...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview
{
    ...
    public partial class SpacecraftsProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.ISpacecraftsProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.ISpacecraftsProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.ISpacecraftsProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode node)
        {
        ...
        internal SpacecraftsProperties(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonObject json)
        {
            ...
            {_authorizationStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("authorizationStatus"), out var __jsonAuthorizationStatus) ? (string)__jsonAuthorizationStatus : (string)AuthorizationStatus;}
            {_authorizationStatusExtended = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("authorizationStatusExtended"), out var __jsonAuthorizationStatusExtended) ? (string)__jsonAuthorizationStatusExtended : (string)AuthorizationStatusExtended;}
            ...
            {_link = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonArray>("links"), out var __jsonLinks) ? If( __jsonLinks as Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.ISpacecraftLink[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.ISpacecraftLink) (Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api202104Preview.SpacecraftLink.FromJson(__u) )) ))() : null : Link;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._authorizationStatus)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString(this._authorizationStatus.ToString()) : null, "authorizationStatus" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._authorizationStatusExtended)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString(this._authorizationStatusExtended.ToString()) : null, "authorizationStatusExtended" ,container.Add );
            }
