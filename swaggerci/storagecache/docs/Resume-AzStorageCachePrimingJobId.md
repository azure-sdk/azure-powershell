...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagecache/resume-azstoragecacheprimingjobid
schema: 2.0.0
---

# Resume-AzStorageCachePrimingJobId
...
### Resume (Default)
```
Resume-AzStorageCachePrimingJobId -CacheName <String> -PrimingJobId <String> -ResourceGroupName <String>
...
### ResumeViaIdentity
```
Resume-AzStorageCachePrimingJobId -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
