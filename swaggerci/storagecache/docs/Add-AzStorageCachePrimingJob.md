...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagecache/add-azstoragecacheprimingjob
schema: 2.0.0
---

# Add-AzStorageCachePrimingJob
...
### AddExpanded (Default)
```
Add-AzStorageCachePrimingJob -CacheName <String> -ResourceGroupName <String> -PrimingJobName <String>
...
### Add
```
Add-AzStorageCachePrimingJob -CacheName <String> -ResourceGroupName <String> -Primingjob <IPrimingJob>
...
### AddViaIdentity
```
Add-AzStorageCachePrimingJob -InputObject <IStorageCacheIdentity> -Primingjob <IPrimingJob>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-AzStorageCachePrimingJob -InputObject <IStorageCacheIdentity> -PrimingJobName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IPrimingJob
