...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagecache/debug-azstoragecachecachinfo
schema: 2.0.0
---
...
### Debug (Default)
```
Debug-AzStorageCacheCachInfo -CacheName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DebugViaIdentity
```
Debug-AzStorageCacheCachInfo -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
