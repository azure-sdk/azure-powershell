...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagecache/remove-azstoragecacheprimingjobid
schema: 2.0.0
---

# Remove-AzStorageCachePrimingJobId
...
### Remove (Default)
```
Remove-AzStorageCachePrimingJobId -CacheName <String> -PrimingJobId <String> -ResourceGroupName <String>
...
### RemoveViaIdentity
```
Remove-AzStorageCachePrimingJobId -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
