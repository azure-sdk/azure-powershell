...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagecache/suspend-azstoragecacheprimingjobid
schema: 2.0.0
---

# Suspend-AzStorageCachePrimingJobId
...
### Pause (Default)
```
Suspend-AzStorageCachePrimingJobId -CacheName <String> -PrimingJobId <String> -ResourceGroupName <String>
...
### PauseViaIdentity
```
Suspend-AzStorageCachePrimingJobId -InputObject <IStorageCacheIdentity> [-DefaultProfile <PSObject>] [-AsJob]
