...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501
{
    ...
    public partial class CacheProperties
    {
        ...
        internal CacheProperties(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject json)
        {
            ...
            {_health = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("health"), out var __jsonHealth) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheHealth.FromJson(__jsonHealth) : Health;}
            {_upgradeStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("upgradeStatus"), out var __jsonUpgradeStatus) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheUpgradeStatus.FromJson(__jsonUpgradeStatus) : UpgradeStatus;}
            {_upgradeSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("upgradeSettings"), out var __jsonUpgradeSettings) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheUpgradeSettings.FromJson(__jsonUpgradeSettings) : UpgradeSetting;}
            {_networkSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("networkSettings"), out var __jsonNetworkSettings) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheNetworkSettings.FromJson(__jsonNetworkSettings) : NetworkSetting;}
            {_encryptionSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("encryptionSettings"), out var __jsonEncryptionSettings) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheEncryptionSettings.FromJson(__jsonEncryptionSettings) : EncryptionSetting;}
            {_securitySetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("securitySettings"), out var __jsonSecuritySettings) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheSecuritySettings.FromJson(__jsonSecuritySettings) : SecuritySetting;}
            ...
            {_primingJob = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonArray>("primingJobs"), out var __jsonPrimingJobs) ? If( __jsonPrimingJobs as Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IPrimingJob[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IPrimingJob) (Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.PrimingJob.FromJson(__k) )) ))() : null : PrimingJob;}
            {_spaceAllocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonArray>("spaceAllocation"), out var __jsonSpaceAllocation) ? If( __jsonSpaceAllocation as Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IStorageTargetSpaceAllocation[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IStorageTargetSpaceAllocation) (Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.StorageTargetSpaceAllocation.FromJson(__f) )) ))() : null : SpaceAllocation;}
            {_directoryServicesSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("directoryServicesSettings"), out var __jsonDirectoryServicesSettings) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheDirectorySettings.FromJson(__jsonDirectoryServicesSettings) : DirectoryServicesSetting;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonNode node)
        {
