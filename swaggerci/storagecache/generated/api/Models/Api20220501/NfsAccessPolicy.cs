...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501
{
    ...
    public partial class NfsAccessPolicy :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INfsAccessPolicyInternal
    {

        /// <summary>Backing field for <see cref="AccessRule" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INfsAccessRule[] _accessRule;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INfsAccessRule[] AccessRule { get => this._accessRule; set => this._accessRule = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INfsAccessRule) })]
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INfsAccessRule[] AccessRule { get; set; }
        /// <summary>Name identifying this policy. Access Policy names are not case sensitive.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Info(
        Required = true,
        ReadOnly = false,
