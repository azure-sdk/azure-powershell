...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501
{
    ...
    public partial class CacheActiveDirectorySettings :
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettings,
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsCredentials _credentials;

        /// <summary>Active Directory admin credentials used to join the HPC Cache to a domain.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsCredentials Credentials { get => (this._credentials = this._credentials ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheActiveDirectorySettingsCredentials()); set => this._credentials = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsCredentials Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsInternal.Credentials { get => (this._credentials = this._credentials ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.CacheActiveDirectorySettingsCredentials()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for DomainJoined</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Support.DomainJoinedType? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsInternal.DomainJoined { get => this._domainJoined; set { {_domainJoined = value;} } }
...

    {
        ...
        string CacheNetBiosName { get; set; }
        /// <summary>Active Directory admin credentials used to join the HPC Cache to a domain.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ICacheActiveDirectorySettingsCredentials Credentials { get; set; }
        /// <summary>
        /// Plain text password of the Active Directory domain administrator. This value is stored encrypted and not returned on response.
        /// </summary>
        string CredentialsPassword { get; set; }
