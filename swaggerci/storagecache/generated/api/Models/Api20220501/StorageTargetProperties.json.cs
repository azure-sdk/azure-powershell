...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501
{
    ...
    public partial class StorageTargetProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IStorageTargetProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IStorageTargetProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IStorageTargetProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonNode node)
        {
        ...
        internal StorageTargetProperties(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject json)
        {
            ...
            {_nfs3 = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("nfs3"), out var __jsonNfs3) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.Nfs3Target.FromJson(__jsonNfs3) : Nfs3;}
            {_clf = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("clfs"), out var __jsonClfs) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ClfsTarget.FromJson(__jsonClfs) : Clf;}
            {_unknown = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("unknown"), out var __jsonUnknown) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.UnknownTarget.FromJson(__jsonUnknown) : Unknown;}
            {_blobNf = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonObject>("blobNfs"), out var __jsonBlobNfs) ? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.BlobNfsTarget.FromJson(__jsonBlobNfs) : BlobNf;}
            {_junction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonArray>("junctions"), out var __jsonJunctions) ? If( __jsonJunctions as Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INamespaceJunction[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.INamespaceJunction) (Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.NamespaceJunction.FromJson(__u) )) ))() : null : Junction;}
