...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501
{
    ...
    public partial class ResourceUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageInternal.CurrentValue { get => this._currentValue; set { {_currentValue = value;} } }

        /// <summary>Internal Acessors for Limit</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageInternal.Limit { get => this._limit; set { {_limit = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageName Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ResourceUsageName()); set { {_name = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageInternal.Unit { get => this._unit; set { {_unit = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageName _name;

        /// <summary>Naming information for this resource type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.ResourceUsageName()); }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>Canonical name for this resource type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        int? Limit { get; set; }
        /// <summary>Naming information for this resource type.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api20220501.IResourceUsageName Name { get; set; }
        /// <summary>Localized name for this resource type.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>Canonical name for this resource type.</summary>
        string NameValue { get; set; }
