...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201
{
    ...
    public partial class UsageModel :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.UsageModelDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelDisplayInternal)Display).Description = value ?? null; }

        /// <summary>Internal Acessors for Display</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelDisplay Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.UsageModelDisplay()); set { {_display = value;} } }
    ...
    {
        /// <summary>Localized information describing this usage model.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.IUsageModelDisplay Display { get; set; }
        /// <summary>String to display for this usage model.</summary>
        string DisplayDescription { get; set; }
        /// <summary>Non-localized keyword name for this usage model.</summary>
        string ModelName { get; set; }
