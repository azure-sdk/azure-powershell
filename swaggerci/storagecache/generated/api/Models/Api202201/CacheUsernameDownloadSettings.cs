...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201
{
    ...
    public partial class CacheUsernameDownloadSettings :
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettings,
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsCredentials _credentials;

        /// <summary>When present, these are the credentials for the secure LDAP connection.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageCache.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsCredentials Credentials { get => (this._credentials = this._credentials ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.CacheUsernameDownloadSettingsCredentials()); set => this._credentials = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsCredentials Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsInternal.Credentials { get => (this._credentials = this._credentials ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.CacheUsernameDownloadSettingsCredentials()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for UsernameDownloaded</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Support.UsernameDownloadedType? Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsInternal.UsernameDownloaded { get => this._usernameDownloaded; set { {_usernameDownloaded = value;} } }
...

    {
        ...
        string CaCertificateUri { get; set; }
        /// <summary>When present, these are the credentials for the secure LDAP connection.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheUsernameDownloadSettingsCredentials Credentials { get; set; }
        /// <summary>
        /// The Bind Distinguished Name identity to be used in the secure LDAP connection. This value is stored encrypted and not
        /// returned on response.
        /// </summary>
