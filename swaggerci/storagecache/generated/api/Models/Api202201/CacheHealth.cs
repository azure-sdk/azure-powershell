...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201
{
    ...
    public partial class CacheHealth :
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheHealth,
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheHealthInternal
    {

        /// <summary>Backing field for <see cref="Condition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICondition[] _condition;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICondition[] Condition { get => this._condition; }

        /// <summary>Internal Acessors for Condition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICondition[] Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICacheHealthInternal.Condition { get => this._condition; set { {_condition = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICondition[] Condition { get;  }
        /// <summary>List of Cache health states.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>Outstanding conditions that need to be investigated and resolved.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Models.Api202201.ICondition[] Condition { get; set; }
        /// <summary>List of Cache health states.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageCache.Support.HealthStateType? State { get; set; }
        /// <summary>Describes explanation of state.</summary>
        string StatusDescription { get; set; }
