...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801
{
    ...
    public partial class MarketplaceSku
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IMarketplaceSku.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IMarketplaceSku.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IMarketplaceSku FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNode node)
        {
        ...
        internal MarketplaceSku(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject json)
        {
            ...
            {_operatingSystem = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject>("operatingSystem"), out var __jsonOperatingSystem) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.SkuOperatingSystem.FromJson(__jsonOperatingSystem) : OperatingSystem;}
            {_catalogPlanId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("catalogPlanId"), out var __jsonCatalogPlanId) ? (string)__jsonCatalogPlanId : (string)CatalogPlanId;}
            {_id = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("marketplaceSkuId"), out var __jsonMarketplaceSkuId) ? (string)__jsonMarketplaceSkuId : (string)Id;}
            ...
            {_generation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("generation"), out var __jsonGeneration) ? (string)__jsonGeneration : (string)Generation;}
            {_displayRank = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNumber>("displayRank"), out var __jsonDisplayRank) ? (int?)__jsonDisplayRank : DisplayRank;}
            {_version = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonArray>("marketplaceSkuVersions"), out var __jsonMarketplaceSkuVersions) ? If( __jsonMarketplaceSkuVersions as Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IMarketplaceSkuVersion[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IMarketplaceSkuVersion) (Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.MarketplaceSkuVersion.FromJson(__u) )) ))() : null : Version;}
            AfterFromJson(json);
        }
