...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801
{
    ...
    public partial class OfferContent
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IOfferContent.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IOfferContent.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IOfferContent FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNode node)
        {
        ...
        internal OfferContent(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject json)
        {
            ...
            {_offerPublisher = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject>("offerPublisher"), out var __jsonOfferPublisher) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.OfferPublisher.FromJson(__jsonOfferPublisher) : OfferPublisher;}
            {_iconFileUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject>("iconFileUris"), out var __jsonIconFileUris) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IconFileUris.FromJson(__jsonIconFileUris) : IconFileUri;}
            {_termsAndCondition = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject>("termsAndConditions"), out var __jsonTermsAndConditions) ? Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.TermsAndConditions.FromJson(__jsonTermsAndConditions) : TermsAndCondition;}
            {_displayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("displayName"), out var __jsonDisplayName) ? (string)__jsonDisplayName : (string)DisplayName;}
            {_summary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("summary"), out var __jsonSummary) ? (string)__jsonSummary : (string)Summary;}
            {_longSummary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("longSummary"), out var __jsonLongSummary) ? (string)__jsonLongSummary : (string)LongSummary;}
            {_description = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("description"), out var __jsonDescription) ? (string)__jsonDescription : (string)Description;}
            {_offerId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("offerId"), out var __jsonOfferId) ? (string)__jsonOfferId : (string)OfferId;}
            {_offerType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("offerType"), out var __jsonOfferType) ? (string)__jsonOfferType : (string)OfferType;}
            {_supportUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("supportUri"), out var __jsonSupportUri) ? (string)__jsonSupportUri : (string)SupportUri;}
            {_popularity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNumber>("popularity"), out var __jsonPopularity) ? (int?)__jsonPopularity : Popularity;}
            {_availability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("availability"), out var __jsonAvailability) ? (string)__jsonAvailability : (string)Availability;}
            {_releaseType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("releaseType"), out var __jsonReleaseType) ? (string)__jsonReleaseType : (string)ReleaseType;}
            {_categoryId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonArray>("categoryIds"), out var __jsonCategoryIds) ? If( __jsonCategoryIds as Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : CategoryId;}
            {_operatingSystem = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonArray>("operatingSystems"), out var __jsonOperatingSystems) ? If( __jsonOperatingSystems as Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : OperatingSystem;}
            AfterFromJson(json);
        }
