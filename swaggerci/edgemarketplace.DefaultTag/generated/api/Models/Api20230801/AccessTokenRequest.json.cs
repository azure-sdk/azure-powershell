...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801
{
    ...
    public partial class AccessTokenRequest
    {
        ...
        internal AccessTokenRequest(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonObject json)
        {
            ...
            {_edgeMarketPlaceRegion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("edgeMarketPlaceRegion"), out var __jsonEdgeMarketPlaceRegion) ? (string)__jsonEdgeMarketPlaceRegion : (string)EdgeMarketPlaceRegion;}
            {_egeMarketPlaceResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("egeMarketPlaceResourceId"), out var __jsonEgeMarketPlaceResourceId) ? (string)__jsonEgeMarketPlaceResourceId : (string)EgeMarketPlaceResourceId;}
            {_hypervGeneration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("hypervGeneration"), out var __jsonHypervGeneration) ? (string)__jsonHypervGeneration : (string)HypervGeneration;}
            {_marketPlaceSku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("marketPlaceSku"), out var __jsonMarketPlaceSku) ? (string)__jsonMarketPlaceSku : (string)MarketPlaceSku;}
            {_marketPlaceSkuVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("marketPlaceSkuVersion"), out var __jsonMarketPlaceSkuVersion) ? (string)__jsonMarketPlaceSkuVersion : (string)MarketPlaceSkuVersion;}
            {_deviceSku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("deviceSku"), out var __jsonDeviceSku) ? (string)__jsonDeviceSku : (string)DeviceSku;}
            {_deviceVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonString>("deviceVersion"), out var __jsonDeviceVersion) ? (string)__jsonDeviceVersion : (string)DeviceVersion;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IAccessTokenRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IAccessTokenRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Models.Api20230801.IAccessTokenRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.EdgeMarketplace.Runtime.Json.JsonNode node)
        {
