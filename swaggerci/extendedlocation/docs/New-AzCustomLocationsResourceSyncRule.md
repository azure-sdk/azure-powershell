...
online version: https://docs.microsoft.com/en-us/powershell/module/az.customlocations/new-azcustomlocationsresourcesyncrule
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CustomLocations.Models.Api20230401Preview.IMatchExpressionsProperties[]
Parameter Sets: (All)
Aliases:
