...
Update-AzCustomLocationsCustomLocation -ResourceGroupName <String> -ResourceName <String>
 ...
 [-SingleProjectNumber <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-AzCustomLocationsCustomLocation -InputObject <ICustomLocationsIdentity> [-AuthenticationType <String>]
 [-AuthenticationValue <String>] [-AwCloudProfileAccountId <String>]
 [-AwCloudProfileExcludedAccount <String[]>] [-ClusterExtensionId <String[]>] [-DisplayName <String>]
 [-HostResourceId <String>] [-HostType <HostType>] [-IdentityType <ResourceIdentityType>]
 [-Namespace <String>] [-OrganizationProjectExcludedFolderId <String[]>]
 [-OrganizationProjectExcludedProjectNumber <String[]>] [-OrganizationProjectOrganizationId <String>]
 [-ProvisioningState <String>] [-SingleProjectId <String>] [-SingleProjectNumber <String>] [-Tag <Hashtable>]
