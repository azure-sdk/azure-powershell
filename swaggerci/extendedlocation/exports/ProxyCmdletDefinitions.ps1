...
INPUTOBJECT <ICustomLocationsIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.customlocations/get-azcustomlocationsresourcesyncrule
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.customlocations/new-azcustomlocationsresourcesyncrule
#>
...
INPUTOBJECT <ICustomLocationsIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.customlocations/remove-azcustomlocationsresourcesyncrule
#>
