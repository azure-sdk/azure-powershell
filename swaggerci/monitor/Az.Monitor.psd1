@{
  GUID = '9e24ff43-4eab-417c-84bd-71fd19af850c'
  ...
  FunctionsToExport = 'Get-AzMonitorActivityLogAlert', 'New-AzMonitorActivityLogAlert', 'Remove-AzMonitorActivityLogAlert', 'Update-AzMonitorActivityLogAlert', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
