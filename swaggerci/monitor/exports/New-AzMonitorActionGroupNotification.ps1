...
WEBHOOKRECEIVER <IWebhookReceiver[]>: The list of webhook receivers that are part of this action group.
  ...
  [UseCommonAlertSchema <Boolean?>]: Indicates whether to use common alert schema.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmonitoractiongroupnotification
#>
function New-AzMonitorActionGroupNotification {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Monitor.private\New-AzMonitorActionGroupNotification_CreateExpanded';
        }
