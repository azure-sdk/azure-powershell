...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.monitor/get-azmonitoractiongrouptestnotification
#>
function Get-AzMonitorActionGroupTestNotification {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.ITestNotificationDetailsResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Monitor.private\Get-AzMonitorActionGroupTestNotification_Get';
            Get1 = 'Az.Monitor.private\Get-AzMonitorActionGroupTestNotification_Get1';
            GetViaIdentity = 'Az.Monitor.private\Get-AzMonitorActionGroupTestNotification_GetViaIdentity';
            GetViaIdentity1 = 'Az.Monitor.private\Get-AzMonitorActionGroupTestNotification_GetViaIdentity1';
        }
