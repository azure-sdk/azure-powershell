...
INPUTOBJECT <IMonitorIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.monitor/remove-azmonitoractiongroup
#>
function Remove-AzMonitorActionGroup {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Monitor.private\Remove-AzMonitorActionGroup_Delete';
            DeleteViaIdentity = 'Az.Monitor.private\Remove-AzMonitorActionGroup_DeleteViaIdentity';
        }
...
INPUTOBJECT <IMonitorIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.monitor/update-azmonitoractiongroup
#>
function Update-AzMonitorActionGroup {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IActionGroupResource])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IActionGroupPatchBodyTags]))]
    [System.Collections.Hashtable]
    # Resource tags
    ${Tag},
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Monitor.private\Update-AzMonitorActionGroup_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.Monitor.private\Update-AzMonitorActionGroup_UpdateViaIdentityExpanded';
        }
