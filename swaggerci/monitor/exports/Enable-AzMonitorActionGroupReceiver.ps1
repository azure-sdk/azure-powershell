...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.monitor/enable-azmonitoractiongroupreceiver
#>
function Enable-AzMonitorActionGroupReceiver {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'Az.Monitor.private\Enable-AzMonitorActionGroupReceiver_Enable';
            EnableExpanded = 'Az.Monitor.private\Enable-AzMonitorActionGroupReceiver_EnableExpanded';
            EnableViaIdentity = 'Az.Monitor.private\Enable-AzMonitorActionGroupReceiver_EnableViaIdentity';
            EnableViaIdentityExpanded = 'Az.Monitor.private\Enable-AzMonitorActionGroupReceiver_EnableViaIdentityExpanded';
        }
