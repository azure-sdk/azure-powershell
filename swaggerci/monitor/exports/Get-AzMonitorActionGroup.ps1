...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.monitor/get-azmonitoractiongroup
#>
function Get-AzMonitorActionGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Monitor.private\Get-AzMonitorActionGroup_Get';
            GetViaIdentity = 'Az.Monitor.private\Get-AzMonitorActionGroup_GetViaIdentity';
            List = 'Az.Monitor.private\Get-AzMonitorActionGroup_List';
            List1 = 'Az.Monitor.private\Get-AzMonitorActionGroup_List1';
        }
