...
online version: https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmonitoractivitylogalert
schema: 2.0.0
---
...
New-AzMonitorActivityLogAlert -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-ActionCustomProperty <Hashtable>] [-ActionGroup <String[]>] [-ActionProperty <Hashtable>]
 [-ConditionAllOf <IAlertRuleAnyOfOrLeafCondition[]>] [-Description <String>] [-Enabled] [-Location <String>]
 [-Scope <String[]>] [-Tag <Hashtable>] [-TenantScope <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api202301Preview.IAlertRuleAnyOfOrLeafCondition[]
Parameter Sets: (All)
Aliases:
