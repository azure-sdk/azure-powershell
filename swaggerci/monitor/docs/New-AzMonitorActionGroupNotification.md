...
online version: https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmonitoractiongroupnotification
schema: 2.0.0
---

# New-AzMonitorActionGroupNotification
...
```
New-AzMonitorActionGroupNotification -ResourceGroupName <String> -AlertType <String>
