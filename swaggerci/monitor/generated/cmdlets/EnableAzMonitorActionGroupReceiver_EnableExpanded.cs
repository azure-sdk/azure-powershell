...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] EnableReceiver=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/subscribe"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzMonitorActionGroupReceiver_EnableExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.Description(@"Enable a receiver in an action group. This changes the receiver's status from Disabled to Enabled. This operation is only supported for Email or SMS receivers.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.Generated]
    public partial class EnableAzMonitorActionGroupReceiver_EnableExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="EnableRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IEnableRequest _enableRequestBody= new Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.EnableRequest();

        /// <summary>Describes a receiver that should be resubscribed.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IEnableRequest EnableRequestBody { get => this._enableRequestBody; set => this._enableRequestBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the receiver to resubscribe.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ReceiverName { get => EnableRequestBody.ReceiverName ?? null; set => EnableRequestBody.ReceiverName = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzMonitorActionGroupReceiver_EnableExpanded" /> cmdlet class.
        /// </summary>
        public EnableAzMonitorActionGroupReceiver_EnableExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ActionGroupsEnableReceiver' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ActionGroupsEnableReceiver(ResourceGroupName, ActionGroupName, SubscriptionId, EnableRequestBody, onOk, onConflict, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ActionGroupName=ActionGroupName,SubscriptionId=SubscriptionId,body=EnableRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ActionGroupName=ActionGroupName, SubscriptionId=SubscriptionId, body=EnableRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ActionGroupName=ActionGroupName, SubscriptionId=SubscriptionId, body=EnableRequestBody })
                    {
