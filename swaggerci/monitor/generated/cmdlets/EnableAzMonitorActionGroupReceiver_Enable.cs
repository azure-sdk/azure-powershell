...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzMonitorActionGroupReceiver_Enable", SupportsShouldProcess = true)]
    ...
    public partial class EnableAzMonitorActionGroupReceiver_Enable : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="EnableRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IEnableRequest _enableRequest;

        /// <summary>Describes a receiver that should be resubscribed.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Describes a receiver that should be resubscribed.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Describes a receiver that should be resubscribed.",
        SerializedName = @"enableRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IEnableRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IEnableRequest EnableRequest { get => this._enableRequest; set => this._enableRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzMonitorActionGroupReceiver_Enable" /> cmdlet class.
        /// </summary>
        public EnableAzMonitorActionGroupReceiver_Enable()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ActionGroupsEnableReceiver(ResourceGroupName, ActionGroupName, SubscriptionId, EnableRequest, onOk, onConflict, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ActionGroupName=ActionGroupName,SubscriptionId=SubscriptionId,body=EnableRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ActionGroupName=ActionGroupName, SubscriptionId=SubscriptionId, body=EnableRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ActionGroupName=ActionGroupName, SubscriptionId=SubscriptionId, body=EnableRequest })
                    {
