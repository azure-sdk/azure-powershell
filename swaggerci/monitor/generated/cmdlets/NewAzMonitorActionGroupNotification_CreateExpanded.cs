...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateNotificationsAtResourceGroupLevel=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/createNotifications"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMonitorActionGroupNotification_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzMonitorActionGroupNotification_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewAzMonitorActionGroupNotification_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets.NewAzMonitorActionGroupNotification_CreateExpanded Clone()
        {
            var clone = new NewAzMonitorActionGroupNotification_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMonitorActionGroupNotification_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzMonitorActionGroupNotification_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ActionGroupsCreateNotificationsAtResourceGroupLevel' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ActionGroupsCreateNotificationsAtResourceGroupLevel(SubscriptionId, ResourceGroupName, NotificationRequestBody, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=NotificationRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=NotificationRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=NotificationRequestBody })
                    {
