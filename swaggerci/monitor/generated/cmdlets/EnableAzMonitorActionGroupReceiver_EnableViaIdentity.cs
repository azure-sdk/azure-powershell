...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzMonitorActionGroupReceiver_EnableViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class EnableAzMonitorActionGroupReceiver_EnableViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzMonitorActionGroupReceiver_EnableViaIdentity" /> cmdlet class.
        /// </summary>
        public EnableAzMonitorActionGroupReceiver_EnableViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ActionGroupsEnableReceiverViaIdentity(InputObject.Id, EnableRequest, onOk, onConflict, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ActionGroupsEnableReceiver(InputObject.ResourceGroupName ?? null, InputObject.ActionGroupName ?? null, InputObject.SubscriptionId ?? null, EnableRequest, onOk, onConflict, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=EnableRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=EnableRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=EnableRequest })
                    {
