...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMonitorActionGroup_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.Description(@"Updates an existing action group's tags. To update other fields use the CreateOrUpdate method.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.Generated]
    public partial class UpdateAzMonitorActionGroup_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ActionGroupPatchBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IActionGroupPatchBody _actionGroupPatchBody= new Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.ActionGroupPatchBody();

        /// <summary>An action group object for the body of patch operations.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IActionGroupPatchBody ActionGroupPatchBody { get => this._actionGroupPatchBody; set => this._actionGroupPatchBody = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates whether this action group is enabled. If an action group is not enabled, then none of its actions will be activated.")]
        ...
        public global::System.Management.Automation.SwitchParameter Enabled { get => ActionGroupPatchBody.Enabled ?? default(global::System.Management.Automation.SwitchParameter); set => ActionGroupPatchBody.Enabled = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IActionGroupPatchBodyTags Tag { get => ActionGroupPatchBody.Tag ?? null /* object */; set => ActionGroupPatchBody.Tag = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ActionGroupsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ActionGroupsUpdate(SubscriptionId, ResourceGroupName, Name, ActionGroupPatchBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,body=ActionGroupPatchBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzMonitorActionGroup_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMonitorActionGroup_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=ActionGroupPatchBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Name=Name, body=ActionGroupPatchBody })
                    {
