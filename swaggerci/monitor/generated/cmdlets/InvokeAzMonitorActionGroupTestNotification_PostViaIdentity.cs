...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMonitorActionGroupTestNotification_PostViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzMonitorActionGroupTestNotification_PostViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="NotificationRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.INotificationRequestBody _notificationRequest;

        /// <summary>The request body which contain contact detail metadata</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The request body which contain contact detail metadata", ValueFromPipeline = true)]
        ...
        SerializedName = @"notificationRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.INotificationRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.INotificationRequestBody NotificationRequest { get => this._notificationRequest; set => this._notificationRequest = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzMonitorActionGroupTestNotification_PostViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Monitor.Cmdlets.InvokeAzMonitorActionGroupTestNotification_PostViaIdentity Clone()
        {
            var clone = new InvokeAzMonitorActionGroupTestNotification_PostViaIdentity();
            ...
            clone.NotificationRequest = this.NotificationRequest;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzMonitorActionGroupTestNotification_PostViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzMonitorActionGroupTestNotification_PostViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ActionGroupsPostTestNotificationsViaIdentity(InputObject.Id, NotificationRequest, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ActionGroupsPostTestNotifications(InputObject.SubscriptionId ?? null, NotificationRequest, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=NotificationRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20220601.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=NotificationRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=NotificationRequest })
                    {
