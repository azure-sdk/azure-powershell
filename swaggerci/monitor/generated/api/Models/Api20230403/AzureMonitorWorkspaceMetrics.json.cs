...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403
{
    ...
    public partial class AzureMonitorWorkspaceMetrics
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject into a new instance of <see cref="AzureMonitorWorkspaceMetrics" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureMonitorWorkspaceMetrics(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject json)
        {
            ...
            __metrics = new Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.Metrics(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceMetrics.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceMetrics.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceMetrics FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject json ? new AzureMonitorWorkspaceMetrics(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureMonitorWorkspaceMetrics" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureMonitorWorkspaceMetrics" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode" />.
        /// </returns>
