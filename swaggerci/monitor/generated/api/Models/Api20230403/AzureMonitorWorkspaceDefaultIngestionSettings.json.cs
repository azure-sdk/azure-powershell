...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403
{
    ...
    public partial class AzureMonitorWorkspaceDefaultIngestionSettings
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject into a new instance of <see cref="AzureMonitorWorkspaceDefaultIngestionSettings"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureMonitorWorkspaceDefaultIngestionSettings(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject json)
        {
            ...
            __ingestionSettings = new Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IngestionSettings(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceDefaultIngestionSettings.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceDefaultIngestionSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceDefaultIngestionSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject json ? new AzureMonitorWorkspaceDefaultIngestionSettings(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureMonitorWorkspaceDefaultIngestionSettings" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureMonitorWorkspaceDefaultIngestionSettings" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
