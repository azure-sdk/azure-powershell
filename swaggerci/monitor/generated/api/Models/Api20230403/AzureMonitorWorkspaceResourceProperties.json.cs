...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403
{
    ...
    public partial class AzureMonitorWorkspaceResourceProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject into a new instance of <see cref="AzureMonitorWorkspaceResourceProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AzureMonitorWorkspaceResourceProperties(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject json)
        {
            ...
            __azureMonitorWorkspace = new Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.AzureMonitorWorkspace(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceResourceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceResourceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Monitor.Models.Api20230403.IAzureMonitorWorkspaceResourceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonObject json ? new AzureMonitorWorkspaceResourceProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AzureMonitorWorkspaceResourceProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureMonitorWorkspaceResourceProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Monitor.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
