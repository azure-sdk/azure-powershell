...
online version: https://learn.microsoft.com/powershell/module/az.databasefleet/unregister-azdatabasefleetfleetspace
schema: 2.0.0
---

# Unregister-AzDatabaseFleetFleetspace
...
### Unregister (Default)
```
Unregister-AzDatabaseFleetFleetspace -FleetName <String> -Name <String> -ResourceGroupName <String>
...
```
Unregister-AzDatabaseFleetFleetspace -InputObject <IDatabaseFleetIdentity> [-DefaultProfile <PSObject>]
