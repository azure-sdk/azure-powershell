...
online version: https://learn.microsoft.com/powershell/module/az.databasefleet/update-azdatabasefleet
schema: 2.0.0
---

# Update-AzDatabaseFleet
...
```
Update-AzDatabaseFleet -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzDatabaseFleet -InputObject <IDatabaseFleetIdentity> [-Description <String>] [-Tag <Hashtable>]
