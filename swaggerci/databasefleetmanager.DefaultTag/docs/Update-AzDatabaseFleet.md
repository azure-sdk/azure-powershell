...
```
Update-AzDatabaseFleet -Name <String> -ResourceGroupName <String> -Location <String>
...
```
Update-AzDatabaseFleet -InputObject <IDatabaseFleetIdentity> -Location <String> [-Description <String>]
