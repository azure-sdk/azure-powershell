...
online version: https://learn.microsoft.com/powershell/module/az.databasefleet/new-azdatabasefleet
schema: 2.0.0
---
...
```
New-AzDatabaseFleet -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
