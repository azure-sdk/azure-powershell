...
online version: https://learn.microsoft.com/powershell/module/az.databasefleet/update-azdatabasefleettier
schema: 2.0.0
---

# Update-AzDatabaseFleetTier
...
```
Update-AzDatabaseFleetTier -FleetName <String> -ResourceGroupName <String> -TierName <String>
 ...
 [-HighAvailabilityReplicaCount <Int32>] [-Pooled] [-PoolNumOfDatabasesMax <Int32>] [-Serverless]
 [-ServiceTier <String>] [-ZoneRedundancy <ZoneRedundancy>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDatabaseFleetTier -InputObject <IDatabaseFleetIdentity> [-Capacity <Int32>]
 [-DatabaseCapacityMax <Double>] [-DatabaseCapacityMin <Double>] [-DatabaseSizeGbMax <Int32>]
 [-Family <String>] [-HighAvailabilityReplicaCount <Int32>] [-Pooled] [-PoolNumOfDatabasesMax <Int32>]
 [-Serverless] [-ServiceTier <String>] [-ZoneRedundancy <ZoneRedundancy>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ZoneRedundancy
Parameter Sets: (All)
Aliases:
