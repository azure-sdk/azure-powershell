...
namespace Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support
{
        ...
        System.IEquatable<ResourceType>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ResourceType Database = @"Database";

        /// <summary>Elastic pool resource type.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ResourceType Pool = @"Pool";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ResourceType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ResourceType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ResourceType e1, Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Support.ResourceType e2)
        {
            return !e2.Equals(e1);
        }
