...
namespace Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview
{
    ...
    public partial class FirewallRuleListResult :
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview.IFirewallRuleListResult,
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview.IFirewallRuleListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview.IFirewallRule[] _value;

        /// <summary>The FirewallRule items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview.IFirewallRule[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview.IFirewallRule) })]
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Models.Api20250201Preview.IFirewallRule[] Value { get; set; }
