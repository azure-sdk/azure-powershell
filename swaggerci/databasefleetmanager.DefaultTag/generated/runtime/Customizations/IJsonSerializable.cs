...
using Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.DatabaseFleet.Runtime.JsonSerializable.ToJson(dict, null);
            }
