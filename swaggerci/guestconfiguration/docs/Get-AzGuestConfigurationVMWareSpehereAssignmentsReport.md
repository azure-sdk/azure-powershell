...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationvmwarespehereassignmentsreport
schema: 2.0.0
---

# Get-AzGuestConfigurationVMWareSpehereAssignmentsReport
...
### List (Default)
```
Get-AzGuestConfigurationVMWareSpehereAssignmentsReport -GuestConfigurationAssignmentName <String>
...
### GetViaIdentity
```
Get-AzGuestConfigurationVMWareSpehereAssignmentsReport -InputObject <IGuestConfigurationIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
