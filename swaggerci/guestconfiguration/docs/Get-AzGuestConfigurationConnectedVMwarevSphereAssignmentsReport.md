...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationconnectedvmwarevsphereassignmentsreport
schema: 2.0.0
---
...
### List (Default)
```
Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport -GuestConfigurationAssignmentName <String>
...
```
Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport -GuestConfigurationAssignmentName <String>
 -ReportId <String> -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzGuestConfigurationConnectedVMwarevSphereAssignmentsReport -InputObject <IGuestConfigurationIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
