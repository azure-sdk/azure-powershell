...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/remove-azguestconfigurationvmwarespehereassignment
schema: 2.0.0
---

# Remove-AzGuestConfigurationVMWareSpehereAssignment
...
### Delete (Default)
```
Remove-AzGuestConfigurationVMWareSpehereAssignment -GuestConfigurationAssignmentName <String>
...
### DeleteViaIdentity
```
Remove-AzGuestConfigurationVMWareSpehereAssignment -InputObject <IGuestConfigurationIdentity>
