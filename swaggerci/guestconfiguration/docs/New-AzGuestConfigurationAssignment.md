...
New-AzGuestConfigurationAssignment -GuestConfigurationAssignmentName <String> -ResourceGroupName <String>
 -VMName <String> [-SubscriptionId <String>] [-ConfigurationSettingActionAfterReboot <ActionAfterReboot>]
 [-ConfigurationSettingAllowModuleOverwrite] [-ConfigurationSettingConfigurationMode <ConfigurationMode>]
