...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationvmwarespehereassignment
schema: 2.0.0
---

# Get-AzGuestConfigurationVMWareSpehereAssignment
...
### List (Default)
```
Get-AzGuestConfigurationVMWareSpehereAssignment -ResourceGroupName <String> -VMName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzGuestConfigurationVMWareSpehereAssignment -GuestConfigurationAssignmentName <String>
...
### GetViaIdentity
```
Get-AzGuestConfigurationVMWareSpehereAssignment -InputObject <IGuestConfigurationIdentity>
