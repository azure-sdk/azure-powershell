...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/new-azguestconfigurationvmwarespehereassignment
schema: 2.0.0
---
...
```
New-AzGuestConfigurationVMWareSpehereAssignment -GuestConfigurationAssignmentName <String>
