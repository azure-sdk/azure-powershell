...
online version: https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationconnectedvmwarevsphereassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-AzGuestConfigurationConnectedVMwarevSphereAssignment -ResourceGroupName <String> -VMName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzGuestConfigurationConnectedVMwarevSphereAssignment -GuestConfigurationAssignmentName <String>
...
### GetViaIdentity
```
Get-AzGuestConfigurationConnectedVMwarevSphereAssignment -InputObject <IGuestConfigurationIdentity>
