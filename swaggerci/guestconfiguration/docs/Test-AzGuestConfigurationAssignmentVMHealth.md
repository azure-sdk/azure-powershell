...
online version: https://docs.microsoft.com/en-us/powershell/module/az.guestconfiguration/test-azguestconfigurationassignmentvmhealth
schema: 2.0.0
---

# Test-AzGuestConfigurationAssignmentVMHealth
...
### Check (Default)
```
Test-AzGuestConfigurationAssignmentVMHealth -ResourceGroupName <String> -VMName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzGuestConfigurationAssignmentVMHealth -InputObject <IGuestConfigurationIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220125.IGuestConfigurationVMHealthCheckProperties
