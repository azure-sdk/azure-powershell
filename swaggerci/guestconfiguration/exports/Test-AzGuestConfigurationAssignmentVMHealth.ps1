...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.guestconfiguration/test-azguestconfigurationassignmentvmhealth
#>
function Test-AzGuestConfigurationAssignmentVMHealth {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220125.IGuestConfigurationVMHealthCheckProperties])]
...
begin {
    try {
        ...
        $mapping = @{
            Check = 'Az.GuestConfiguration.private\Test-AzGuestConfigurationAssignmentVMHealth_Check';
            CheckViaIdentity = 'Az.GuestConfiguration.private\Test-AzGuestConfigurationAssignmentVMHealth_CheckViaIdentity';
        }
