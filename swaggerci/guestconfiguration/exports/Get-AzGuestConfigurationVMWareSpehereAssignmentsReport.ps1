...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationvmwarespehereassignmentsreport
#>
function Get-AzGuestConfigurationVMWareSpehereAssignmentsReport {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationVMWareSpehereAssignmentsReport_Get';
            GetViaIdentity = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationVMWareSpehereAssignmentsReport_GetViaIdentity';
            List = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationVMWareSpehereAssignmentsReport_List';
        }
