...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationvmwarespehereassignment
#>
function Get-AzGuestConfigurationVMWareSpehereAssignment {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationVMWareSpehereAssignment_Get';
            GetViaIdentity = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationVMWareSpehereAssignment_GetViaIdentity';
            List = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationVMWareSpehereAssignment_List';
        }
