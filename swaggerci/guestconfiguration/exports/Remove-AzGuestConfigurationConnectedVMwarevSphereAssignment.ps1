...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/remove-azguestconfigurationconnectedvmwarevsphereassignment
#>
function Remove-AzGuestConfigurationConnectedVMwarevSphereAssignment {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.GuestConfiguration.private\Remove-AzGuestConfigurationConnectedVMwarevSphereAssignment_Delete';
            DeleteViaIdentity = 'Az.GuestConfiguration.private\Remove-AzGuestConfigurationConnectedVMwarevSphereAssignment_DeleteViaIdentity';
        }
