...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/remove-azguestconfigurationvmwarespehereassignment
#>
function Remove-AzGuestConfigurationVMWareSpehereAssignment {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.GuestConfiguration.private\Remove-AzGuestConfigurationVMWareSpehereAssignment_Delete';
            DeleteViaIdentity = 'Az.GuestConfiguration.private\Remove-AzGuestConfigurationVMWareSpehereAssignment_DeleteViaIdentity';
        }
