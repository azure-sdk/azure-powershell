...
.Link
https://learn.microsoft.com/powershell/module/az.guestconfiguration/get-azguestconfigurationconnectedvmwarevsphereassignment
#>
function Get-AzGuestConfigurationConnectedVMwarevSphereAssignment {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationConnectedVMwarevSphereAssignment_Get';
            GetViaIdentity = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationConnectedVMwarevSphereAssignment_GetViaIdentity';
            List = 'Az.GuestConfiguration.private\Get-AzGuestConfigurationConnectedVMwarevSphereAssignment_List';
        }
