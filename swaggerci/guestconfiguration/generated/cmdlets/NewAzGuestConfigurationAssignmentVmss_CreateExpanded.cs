...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzGuestConfigurationAssignmentVmss_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Description(@"Creates an association between a VMSS and guest configuration")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Generated]
    public partial class NewAzGuestConfigurationAssignmentVmss_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Runtime.IEventListener
    {
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string Name1 { get => _parametersBody.Name ?? null; set => _parametersBody.Name = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzGuestConfigurationAssignmentVmss_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzGuestConfigurationAssignmentVmss_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GuestConfigurationAssignmentsVmssCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GuestConfigurationAssignmentsVmssCreateOrUpdate(Name, SubscriptionId, ResourceGroupName, VmssName, _parametersBody, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Name=Name,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,VmssName=VmssName,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20180630Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Name=Name, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, VmssName=VmssName, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Name=Name, SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, VmssName=VmssName, body=_parametersBody })
                    {
