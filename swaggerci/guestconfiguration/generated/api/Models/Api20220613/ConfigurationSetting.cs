...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613
{
    ...
    public partial class ConfigurationSetting :
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSetting,
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ActionAfterReboot? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal.ActionAfterReboot { get => this._actionAfterReboot; set { {_actionAfterReboot = value;} } }

        /// <summary>Internal Acessors for AllowModuleOverwrite</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal.AllowModuleOverwrite { get => this._allowModuleOverwrite; set { {_allowModuleOverwrite = value;} } }

        /// <summary>Internal Acessors for ConfigurationMode</summary>
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ConfigurationMode? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal.ConfigurationMode { get => this._configurationMode; set { {_configurationMode = value;} } }

        /// <summary>Internal Acessors for ConfigurationModeFrequencyMin</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal.ConfigurationModeFrequencyMin { get => this._configurationModeFrequencyMin; set { {_configurationModeFrequencyMin = value;} } }

        /// <summary>Internal Acessors for RebootIfNeeded</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal.RebootIfNeeded { get => this._rebootIfNeeded; set { {_rebootIfNeeded = value;} } }

        /// <summary>Internal Acessors for RefreshFrequencyMin</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IConfigurationSettingInternal.RefreshFrequencyMin { get => this._refreshFrequencyMin; set { {_refreshFrequencyMin = value;} } }
