...
namespace Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613
{
    ...
    public partial class VmssvmInfo :
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfo,
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfoInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Support.ComplianceStatus? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfoInternal.ComplianceStatus { get => this._complianceStatus; set { {_complianceStatus = value;} } }

        /// <summary>Internal Acessors for LastComplianceChecked</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfoInternal.LastComplianceChecked { get => this._lastComplianceChecked; set { {_lastComplianceChecked = value;} } }

        /// <summary>Internal Acessors for LatestReportId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfoInternal.LatestReportId { get => this._latestReportId; set { {_latestReportId = value;} } }

        /// <summary>Internal Acessors for VMId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfoInternal.VMId { get => this._vMId; set { {_vMId = value;} } }

        /// <summary>Internal Acessors for VMResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.GuestConfiguration.Models.Api20220613.IVmssvmInfoInternal.VMResourceId { get => this._vMResourceId; set { {_vMResourceId = value;} } }
