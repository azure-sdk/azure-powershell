...
namespace Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState Provisioning = @"Provisioning";

        public static Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Windowsesu.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
