...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/dataCenters/{dataCenterName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzCosmosDbCassandraDataCenterUpdate_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Description(@"Create or update a managed Cassandra data center. When updating, overwrite all properties. To update only some properties, use PATCH.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Generated]
    public partial class NewAzCosmosDbCassandraDataCenterUpdate_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Data center name in a managed Cassandra cluster.")]
        [Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of NewAzCosmosDbCassandraDataCenterUpdate_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets.NewAzCosmosDbCassandraDataCenterUpdate_CreateExpanded Clone()
        {
            var clone = new NewAzCosmosDbCassandraDataCenterUpdate_CreateExpanded();
            ...
            clone.DataCenterName = this.DataCenterName;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzCosmosDbCassandraDataCenterUpdate_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzCosmosDbCassandraDataCenterUpdate_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CassandraDataCentersCreateUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CassandraDataCentersCreateUpdate(SubscriptionId, ResourceGroupName, ClusterName, DataCenterName, _body, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,DataCenterName=DataCenterName,body=_body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Models.Api20220815.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, DataCenterName=DataCenterName, body=_body })
                    {
