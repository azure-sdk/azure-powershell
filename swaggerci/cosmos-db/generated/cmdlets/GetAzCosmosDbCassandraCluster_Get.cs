...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzCosmosDbCassandraCluster_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Description(@"Get the properties of a managed Cassandra cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Generated]
    public partial class GetAzCosmosDbCassandraCluster_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzCosmosDbCassandraCluster_Get" /> cmdlet class.
        /// </summary>
        public GetAzCosmosDbCassandraCluster_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.CassandraClustersGet(SubscriptionId, ResourceGroupName, ClusterName, onOk, onDefault, this, Pipeline);
