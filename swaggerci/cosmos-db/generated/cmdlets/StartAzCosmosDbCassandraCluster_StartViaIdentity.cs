...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Start=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/start"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzCosmosDbCassandraCluster_StartViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Description(@"Start the Managed Cassandra Cluster and Associated Data Centers. Start will start the host virtual machine of this cluster with reserved data disk. This won't do anything on an already running cluster. Use Deallocate to deallocate the cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Generated]
    public partial class StartAzCosmosDbCassandraCluster_StartViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of StartAzCosmosDbCassandraCluster_StartViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets.StartAzCosmosDbCassandraCluster_StartViaIdentity Clone()
        {
            var clone = new StartAzCosmosDbCassandraCluster_StartViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CassandraClustersStart' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CassandraClustersStartViaIdentity(InputObject.Id, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CassandraClustersStart(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzCosmosDbCassandraCluster_StartViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzCosmosDbCassandraCluster_StartViaIdentity()
        {
