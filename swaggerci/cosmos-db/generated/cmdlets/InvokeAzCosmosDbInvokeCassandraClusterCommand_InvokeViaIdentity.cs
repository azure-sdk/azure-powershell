...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Models.Api20221115.ICommandPostBody _body;

        /// <summary>Specification of which command to run where</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Specification of which command to run where", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Specification of which command to run where",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Models.Api20221115.ICommandPostBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Models.Api20221115.ICommandPostBody Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets.InvokeAzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity Clone()
        {
            var clone = new InvokeAzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzCosmosDbInvokeCassandraClusterCommand_InvokeViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CassandraClustersInvokeCommandViaIdentity(InputObject.Id, Body, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CassandraClustersInvokeCommand(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, Body, onDefault, this, Pipeline);
                    }
