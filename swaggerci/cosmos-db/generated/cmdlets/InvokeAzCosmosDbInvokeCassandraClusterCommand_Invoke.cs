...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzCosmosDbInvokeCassandraClusterCommand_Invoke", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzCosmosDbInvokeCassandraClusterCommand_Invoke : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of InvokeAzCosmosDbInvokeCassandraClusterCommand_Invoke</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Cmdlets.InvokeAzCosmosDbInvokeCassandraClusterCommand_Invoke Clone()
        {
            var clone = new InvokeAzCosmosDbInvokeCassandraClusterCommand_Invoke();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzCosmosDbInvokeCassandraClusterCommand_Invoke" /> cmdlet class.
        /// </summary>
        public InvokeAzCosmosDbInvokeCassandraClusterCommand_Invoke()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CassandraClustersInvokeCommand(SubscriptionId, ResourceGroupName, ClusterName, Body, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,body=Body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.CosmosDb.Models.Api20220815.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=Body })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, body=Body })
                    {
