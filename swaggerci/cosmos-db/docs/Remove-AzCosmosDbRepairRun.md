...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/remove-azcosmosdbrepairrun
schema: 2.0.0
---

# Remove-AzCosmosDbRepairRun
...
### Delete (Default)
```
Remove-AzCosmosDbRepairRun -ClusterName <String> -Id <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzCosmosDbRepairRun -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-PassThru]
