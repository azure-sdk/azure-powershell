...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/remove-azcosmosdbcassandradatacenter
schema: 2.0.0
---

# Remove-AzCosmosDbCassandraDataCenter
...
### Delete (Default)
```
Remove-AzCosmosDbCassandraDataCenter -ClusterName <String> -DataCenterName <String>
...
### DeleteViaIdentity
```
Remove-AzCosmosDbCassandraDataCenter -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-AsJob]
