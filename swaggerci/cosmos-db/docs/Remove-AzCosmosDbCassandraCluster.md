...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/remove-azcosmosdbcassandracluster
schema: 2.0.0
---

# Remove-AzCosmosDbCassandraCluster
...
### Delete (Default)
```
Remove-AzCosmosDbCassandraCluster -ClusterName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzCosmosDbCassandraCluster -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-AsJob]
