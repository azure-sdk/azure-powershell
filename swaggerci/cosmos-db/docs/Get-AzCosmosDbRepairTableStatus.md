...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/get-azcosmosdbrepairtablestatus
schema: 2.0.0
---

# Get-AzCosmosDbRepairTableStatus
...
### Get (Default)
```
Get-AzCosmosDbRepairTableStatus -ClusterName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCosmosDbRepairTableStatus -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-Confirm]
