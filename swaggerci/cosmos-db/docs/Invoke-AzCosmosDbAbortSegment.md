...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/invoke-azcosmosdbabortsegment
schema: 2.0.0
---

# Invoke-AzCosmosDbAbortSegment
...
### Abort (Default)
```
Invoke-AzCosmosDbAbortSegment -ClusterName <String> -RepairRunId <String> -ResourceGroupName <String>
 -SegmentId <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AbortViaIdentity
```
Invoke-AzCosmosDbAbortSegment -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-PassThru]
