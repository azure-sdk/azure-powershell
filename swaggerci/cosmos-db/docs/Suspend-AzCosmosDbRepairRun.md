...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/suspend-azcosmosdbrepairrun
schema: 2.0.0
---

# Suspend-AzCosmosDbRepairRun
...
### Pause (Default)
```
Suspend-AzCosmosDbRepairRun -ClusterName <String> -Id <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PauseViaIdentity
```
Suspend-AzCosmosDbRepairRun -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-PassThru]
