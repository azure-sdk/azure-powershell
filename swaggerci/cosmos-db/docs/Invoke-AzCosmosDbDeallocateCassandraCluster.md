...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/invoke-azcosmosdbdeallocatecassandracluster
schema: 2.0.0
---

# Invoke-AzCosmosDbDeallocateCassandraCluster
...
### Deallocate (Default)
```
Invoke-AzCosmosDbDeallocateCassandraCluster -ClusterName <String> -ResourceGroupName <String>
...
```
Invoke-AzCosmosDbDeallocateCassandraCluster -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>]
