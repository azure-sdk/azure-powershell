...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/resume-azcosmosdbrepairrun
schema: 2.0.0
---

# Resume-AzCosmosDbRepairRun
...
### Resume (Default)
```
Resume-AzCosmosDbRepairRun -ClusterName <String> -Id <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResumeViaIdentity
```
Resume-AzCosmosDbRepairRun -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-PassThru]
