...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdb/get-azcosmosdbrepairclusterstatus
schema: 2.0.0
---

# Get-AzCosmosDbRepairClusterStatus
...
### Get (Default)
```
Get-AzCosmosDbRepairClusterStatus -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzCosmosDbRepairClusterStatus -InputObject <ICosmosDbIdentity> [-DefaultProfile <PSObject>] [-Confirm]
