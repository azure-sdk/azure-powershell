...
online version: https://learn.microsoft.com/powershell/module/az.maintenance/new-azmaintenanceconfigurationassignmentparent
schema: 2.0.0
---
...
New-AzMaintenanceConfigurationAssignmentParent -ConfigurationAssignmentName <String> -ProviderName <String>
 ...
 -ResourceType <String> [-SubscriptionId <String>] [-FilterLocation <String[]>] [-FilterOSType <String[]>]
