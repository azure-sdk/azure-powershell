...
online version: https://learn.microsoft.com/powershell/module/az.maintenance/new-azmaintenanceconfigurationassignment
schema: 2.0.0
---

# New-AzMaintenanceConfigurationAssignment
...
```
New-AzMaintenanceConfigurationAssignment -Name <String> -ProviderName <String> -ResourceGroupName <String>
 -ResourceName <String> -ResourceType <String> [-SubscriptionId <String>] [-FilterLocation <String[]>]
