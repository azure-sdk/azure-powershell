...
online version: https://learn.microsoft.com/powershell/module/az.maintenance/new-azmaintenanceconfigurationassignmentforresourcegroup
schema: 2.0.0
---
...
```
New-AzMaintenanceConfigurationAssignmentForResourceGroup -ConfigurationAssignmentName <String>
