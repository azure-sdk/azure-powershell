...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Models.Api50.ITrackedResourceTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
