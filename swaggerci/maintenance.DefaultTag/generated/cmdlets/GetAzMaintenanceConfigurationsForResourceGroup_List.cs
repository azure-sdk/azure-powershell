...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maintenance.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maintenance/maintenanceConfigurations", ApiVersion = "2023-10-01-preview")]
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.MaintenanceConfigurationsForResourceGroupList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
