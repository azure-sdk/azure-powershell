...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Maintenance/applyUpdates"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMaintenanceApplyUpdate_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maintenance.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Maintenance/applyUpdates", ApiVersion = "2023-10-01-preview")]
    public partial class GetAzMaintenanceApplyUpdate_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMaintenanceApplyUpdate_List" /> cmdlet class.
        /// </summary>
        public GetAzMaintenanceApplyUpdate_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ApplyUpdatesList(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ApplyUpdatesList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
