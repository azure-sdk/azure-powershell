...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maintenance.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Maintenance/publicMaintenanceConfigurations", ApiVersion = "2023-10-01-preview")]
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PublicMaintenanceConfigurationsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
