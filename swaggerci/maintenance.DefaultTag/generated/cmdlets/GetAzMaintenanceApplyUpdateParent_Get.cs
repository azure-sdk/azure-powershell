            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ApplyUpdatesGetParent(SubscriptionId, ResourceGroupName, ProviderName, ResourceParentType, ResourceParentName, ResourceType, ResourceName, ApplyUpdateName, onOk, onDefault, this, Pipeline);
