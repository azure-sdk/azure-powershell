...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Support
{
    ...
    {
        /// <summary>
        /// Cancel the schedule and stop creating PMR for resources part of it. Applicable to Maintenance Configuration resource type
        /// only.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Support.UpdateStatus Cancel = @"Cancel";

        /// <summary>
        /// Send the Cancelled response to the user if request came to cancel the schedule. Applicable to Maintenance Configuration
        /// resource type only.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Support.UpdateStatus Cancelled = @"Cancelled";
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Support.UpdateStatus NoUpdatesPending = @"NoUpdatesPending";
