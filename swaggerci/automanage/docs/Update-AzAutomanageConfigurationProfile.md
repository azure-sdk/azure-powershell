...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automanage/update-azautomanageconfigurationprofile
schema: 2.0.0
---
...
Update-AzAutomanageConfigurationProfile -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Configuration <IAny>] [-Override <IAny[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
