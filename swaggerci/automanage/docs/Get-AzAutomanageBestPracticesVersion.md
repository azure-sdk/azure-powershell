...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automanage/get-azautomanagebestpracticesversion
schema: 2.0.0
---

# Get-AzAutomanageBestPracticesVersion
...
### GetViaIdentity
```
Get-AzAutomanageBestPracticesVersion -InputObject <IAutomanageIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
