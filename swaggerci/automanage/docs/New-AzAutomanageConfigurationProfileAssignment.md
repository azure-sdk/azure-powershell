...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automanage/new-azautomanageconfigurationprofileassignment
schema: 2.0.0
---
...
New-AzAutomanageConfigurationProfileAssignment -Name <String> -ResourceGroupName <String> -VMName <String>
 [-SubscriptionId <String>] [-ConfigurationProfile <String>] [-Mode <AssignmentMode>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Automanage.Support.AssignmentMode
Parameter Sets: (All)
Aliases:
