...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automanage/new-azautomanageconfigurationprofilehciassignment
schema: 2.0.0
---
...
New-AzAutomanageConfigurationProfileHciAssignment -ClusterName <String>
 ...
 [-ConfigurationProfile <String>] [-Mode <AssignmentMode>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
