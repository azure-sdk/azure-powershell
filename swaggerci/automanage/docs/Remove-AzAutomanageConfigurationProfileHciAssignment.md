...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automanage/remove-azautomanageconfigurationprofilehciassignment
schema: 2.0.0
---

# Remove-AzAutomanageConfigurationProfileHciAssignment
...
### Delete (Default)
```
Remove-AzAutomanageConfigurationProfileHciAssignment -ClusterName <String>
...
### DeleteViaIdentity
```
Remove-AzAutomanageConfigurationProfileHciAssignment -InputObject <IAutomanageIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
