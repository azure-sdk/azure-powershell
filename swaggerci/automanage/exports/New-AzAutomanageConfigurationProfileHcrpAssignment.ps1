...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.automanage/new-azautomanageconfigurationprofilehcrpassignment
#>
function New-AzAutomanageConfigurationProfileHcrpAssignment {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Automanage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20220504.IConfigurationProfileAssignmentProfileOverrides]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Automanage.private\New-AzAutomanageConfigurationProfileHcrpAssignment_CreateExpanded';
        }
