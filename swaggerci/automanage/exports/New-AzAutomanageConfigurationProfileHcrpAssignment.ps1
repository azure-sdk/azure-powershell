...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Automanage.Support.AssignmentMode])]
    [Microsoft.Azure.PowerShell.Cmdlets.Automanage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Automanage.Support.AssignmentMode]
