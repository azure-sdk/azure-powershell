...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.automanage/get-azautomanageconfigurationprofilehcrpassignment
#>
function Get-AzAutomanageConfigurationProfileHcrpAssignment {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Automanage.private\Get-AzAutomanageConfigurationProfileHcrpAssignment_Get';
            GetViaIdentity = 'Az.Automanage.private\Get-AzAutomanageConfigurationProfileHcrpAssignment_GetViaIdentity';
        }
