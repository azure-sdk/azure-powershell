...
namespace Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview
{
    ...
    public partial class UpdateResource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview.IUpdateResource.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview.IUpdateResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview.IUpdateResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonObject json ? new UpdateResource(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpdateResource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateResource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonObject into a new instance of <see cref="UpdateResource" />.
        /// </summary>
        ...
        internal UpdateResource(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Automanage.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview.UpdateResourceTags.FromJson(__jsonTags) : Tag;}
            AfterFromJson(json);
        }
    }
}