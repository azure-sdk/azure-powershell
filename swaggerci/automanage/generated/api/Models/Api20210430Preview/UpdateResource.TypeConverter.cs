...
namespace Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview
{
    ...
    public partial class UpdateResourceTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="UpdateResource"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="UpdateResource" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="UpdateResource" />.</param>
        /// <returns>
        /// an instance of <see cref="UpdateResource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview.IUpdateResource ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Automanage.Models.Api20210430Preview.IUpdateResource).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
