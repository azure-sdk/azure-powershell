...
New-AzPeering -Name <String> -ResourceGroupName <String> -Kind <Kind> -Location <String>
 [-SubscriptionId <String>] [-ConnectivityProbe <IConnectivityProbe[]>]
 [-DirectConnection <IDirectConnection[]>] [-DirectPeerAsnId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IConnectivityProbe[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IDirectConnection[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IExchangeConnection[]
Parameter Sets: (All)
Aliases:
