...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501
{
    ...
    public partial class CdnPeeringPrefixProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixPropertiesInternal.AzureRegion { get => this._azureRegion; set { {_azureRegion = value;} } }

        /// <summary>Internal Acessors for AzureService</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixPropertiesInternal.AzureService { get => this._azureService; set { {_azureService = value;} } }

        /// <summary>Internal Acessors for BgpCommunity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixPropertiesInternal.BgpCommunity { get => this._bgpCommunity; set { {_bgpCommunity = value;} } }

        /// <summary>Internal Acessors for IsPrimaryRegion</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixPropertiesInternal.IsPrimaryRegion { get => this._isPrimaryRegion; set { {_isPrimaryRegion = value;} } }

        /// <summary>Internal Acessors for Prefix</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.ICdnPeeringPrefixPropertiesInternal.Prefix { get => this._prefix; set { {_prefix = value;} } }
