...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501
{
    ...
    public partial class MetricSpecification :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecification,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricDimension[] _dimension;

        /// <summary>Dimensions of the metric.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Origin(Microsoft.Azure.PowerShell.Cmdlets.Peering.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricDimension[] Dimension { get => this._dimension; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.AggregationType { get => this._aggregationType; set { {_aggregationType = value;} } }

        /// <summary>Internal Acessors for Dimension</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricDimension[] Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.Dimension { get => this._dimension; set { {_dimension = value;} } }

        /// <summary>Internal Acessors for DisplayDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.DisplayDescription { get => this._displayDescription; set { {_displayDescription = value;} } }

        /// <summary>Internal Acessors for DisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedTimeGrainType</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.SupportedTimeGrainType { get => this._supportedTimeGrainType; set { {_supportedTimeGrainType = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricSpecificationInternal.Unit { get => this._unit; set { {_unit = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricDimension) })]
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricDimension[] Dimension { get;  }
        /// <summary>Localized friendly description of the metric.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>Dimensions of the metric.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IMetricDimension[] Dimension { get; set; }
        /// <summary>Localized friendly description of the metric.</summary>
