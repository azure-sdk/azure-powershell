...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501
{
    ...
    public partial class PeeringReceivedRoute :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRoute,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.AsPath { get => this._asPath; set { {_asPath = value;} } }

        /// <summary>Internal Acessors for NextHop</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.NextHop { get => this._nextHop; set { {_nextHop = value;} } }

        /// <summary>Internal Acessors for OriginAsValidationState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.OriginAsValidationState { get => this._originAsValidationState; set { {_originAsValidationState = value;} } }

        /// <summary>Internal Acessors for Prefix</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.Prefix { get => this._prefix; set { {_prefix = value;} } }

        /// <summary>Internal Acessors for ReceivedTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.ReceivedTimestamp { get => this._receivedTimestamp; set { {_receivedTimestamp = value;} } }

        /// <summary>Internal Acessors for RpkiValidationState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.RpkiValidationState { get => this._rpkiValidationState; set { {_rpkiValidationState = value;} } }

        /// <summary>Internal Acessors for TrustAnchor</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringReceivedRouteInternal.TrustAnchor { get => this._trustAnchor; set { {_trustAnchor = value;} } }
