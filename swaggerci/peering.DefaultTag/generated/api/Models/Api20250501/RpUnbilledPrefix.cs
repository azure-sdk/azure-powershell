...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501
{
    ...
    public partial class RpUnbilledPrefix :
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IRpUnbilledPrefix,
        Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IRpUnbilledPrefixInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IRpUnbilledPrefixInternal.AzureRegion { get => this._azureRegion; set { {_azureRegion = value;} } }

        /// <summary>Internal Acessors for PeerAsn</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IRpUnbilledPrefixInternal.PeerAsn { get => this._peerAsn; set { {_peerAsn = value;} } }

        /// <summary>Internal Acessors for Prefix</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IRpUnbilledPrefixInternal.Prefix { get => this._prefix; set { {_prefix = value;} } }
