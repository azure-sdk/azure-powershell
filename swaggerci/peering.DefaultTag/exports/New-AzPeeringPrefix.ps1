...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringServicePrefix
.Link
https://learn.microsoft.com/powershell/module/az.peering/new-azpeeringprefix
#>
function New-AzPeeringPrefix {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringServicePrefix])]
