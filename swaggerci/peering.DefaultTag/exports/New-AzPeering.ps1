...
CONNECTIVITYPROBE <IConnectivityProbe[]>: The connectivity probes associated with the peering.
  [CreatedTimeUtc <DateTime?>]: Time when {Microsoft.Peering.PeeringContract.Public.Data.ConnectivityProbe} was created in UTC.
...
DIRECTCONNECTION <IDirectConnection[]>: The set of connections that constitute a direct peering.
  ...
  [LastFailureTimeUtc <DateTime?>]: Gets or sets the time corresponding to when the connection was last set to ProvisioningFailed.
  [MigrationWorkWindowBgpSessionSameDevice <IDirectConnectionMigrationWorkWindowBgpSessionSameDevice>]: The old V4 BGP session associated with the connection during migration on the same device. Will be used for Work-Window validation
    [(Any) <String>]: This indicates any property can be added to this object.
  [MigrationWorkWindowTracker <String>]: Gets or sets the migration work window tracker. Format = "DateTime String Format|WorkWindowInitiator Email ID"
  [PeeringDbFacilityId <Int32?>]: The PeeringDB.com ID of the facility at which the connection has to be set up.
  [PreviousConnectionProvisioningState <PreviousConnectionProvisioningState?>]: The previous connection provisioning state, used to resume provisioning after connection has been blocked.
...
EXCHANGECONNECTION <IExchangeConnection[]>: The set of connections that constitute an exchange peering.
  ...
  [ConnectionIdentifier <String>]: The unique identifier (GUID) for the connection.
  [LastFailureTimeUtc <DateTime?>]: Gets or sets the time corresponding to when the connection was last set to ProvisioningFailed.
  [MigrationWorkWindowBgpSessionSameDevice <IExchangeConnectionMigrationWorkWindowBgpSessionSameDevice>]: The old V4 BGP session associated with the connection during migration on the same device. Will be used for Work-Window validation
    [(Any) <String>]: This indicates any property can be added to this object.
  [MigrationWorkWindowTracker <String>]: Gets or sets the migration work window tracker. Format = "DateTime String Format|WorkWindowInitiator Email ID"
  [PeeringDbFacilityId <Int32?>]: The PeeringDB.com ID of the facility at which the connection has to be set up.
  [PreviousConnectionProvisioningState <PreviousConnectionProvisioningState?>]: The previous connection provisioning state, used to resume provisioning after connection has been blocked.
...
param(
    ...
    # To construct, see NOTES section for CONNECTIVITYPROBE properties and create a hash table.
    ${ConnectivityProbe},
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Peering.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IExchangeConnection[]]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Peering.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Peering.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeeringTags]))]
