...
.Link
https://learn.microsoft.com/powershell/module/az.peering/get-azpeeringlegacypeering
#>
function Get-AzPeeringLegacyPeering {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.Api20250501.IPeering])]
