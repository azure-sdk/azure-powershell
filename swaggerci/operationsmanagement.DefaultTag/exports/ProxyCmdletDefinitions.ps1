...
System.Boolean
.Link
https://learn.microsoft.com/powershell/module/az.operations/new-azoperationssolution
#>
...
INPUTOBJECT <IOperationsIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://learn.microsoft.com/powershell/module/az.operations/remove-azoperationsmanagementconfiguration
#>
