...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IMonitoringTagRules
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IMonitoringTagRules])]
