...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20231101Preview.IMonitoringTagRules
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20231101Preview.IMonitoringTagRules])]
