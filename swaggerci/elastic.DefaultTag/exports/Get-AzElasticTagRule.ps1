...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IMonitoringTagRules
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IMonitoringTagRules])]
