...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240501Preview.IElasticMonitorResource
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240501Preview.IElasticMonitorResource])]
