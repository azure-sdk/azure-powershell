...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.IResubscribeProperties
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.IElasticMonitorResource])]
