...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IResubscribeProperties
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.IElasticIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IElasticMonitorResource
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.elastic/invoke-azelasticresubscribeorganization
#>
function Invoke-AzElasticResubscribeOrganization {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IElasticMonitorResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Resubscribe = 'Az.Elastic.private\Invoke-AzElasticResubscribeOrganization_Resubscribe';
            ResubscribeExpanded = 'Az.Elastic.private\Invoke-AzElasticResubscribeOrganization_ResubscribeExpanded';
            ResubscribeViaIdentity = 'Az.Elastic.private\Invoke-AzElasticResubscribeOrganization_ResubscribeViaIdentity';
            ResubscribeViaIdentityExpanded = 'Az.Elastic.private\Invoke-AzElasticResubscribeOrganization_ResubscribeViaIdentityExpanded';
        }
        if (('Resubscribe', 'ResubscribeExpanded', 'ResubscribeViaIdentityExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
