...
### GetViaIdentity
```
Get-AzElasticOpenAi -InputObject <IElasticIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IOpenAiIntegrationRpmodel
