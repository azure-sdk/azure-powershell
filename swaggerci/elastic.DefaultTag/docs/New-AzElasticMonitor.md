...
New-AzElasticMonitor -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-PlanDetailTermId <String>] [-ProvisioningState <ProvisioningState>] [-SaaSAzureSubscriptionStatus <String>]
 [-SkuName <String>] [-SourceCampaignId <String>] [-SourceCampaignName <String>] [-SubscriptionState <String>]
