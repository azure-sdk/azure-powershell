...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20250115Preview.IMonitoredSubscription[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Operation
Parameter Sets: (All)
Aliases:
