...
### GetViaIdentity
```
Get-AzElasticOpenAiStatus -InputObject <IElasticIdentity> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IOpenAiIntegrationStatusResponseProperties
