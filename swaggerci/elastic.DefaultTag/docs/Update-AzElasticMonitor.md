...
Update-AzElasticMonitor -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-ResubscribePropertyOrganizationId <String>] [-ResubscribePropertyPlanId <String>]
 [-ResubscribePropertyResourceGroup <String>] [-ResubscribePropertySubscriptionId <String>]
 [-ResubscribePropertyTerm <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzElasticMonitor -InputObject <IElasticIdentity> [-ResubscribePropertyOrganizationId <String>]
 [-ResubscribePropertyPlanId <String>] [-ResubscribePropertyResourceGroup <String>]
 [-ResubscribePropertySubscriptionId <String>] [-ResubscribePropertyTerm <String>] [-Tag <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IElasticMonitorUpgrade
...
### -ResubscribePropertyOrganizationId
...
### -ResubscribePropertyResourceGroup
...
### -ResubscribePropertySubscriptionId
...
### Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IElasticMonitorUpgrade
