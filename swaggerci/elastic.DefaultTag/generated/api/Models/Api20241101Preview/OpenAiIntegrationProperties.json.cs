...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview
{
    ...
    public partial class OpenAiIntegrationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IOpenAiIntegrationProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IOpenAiIntegrationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241101Preview.IOpenAiIntegrationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
        ...
        internal OpenAiIntegrationProperties(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_openAiResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonString>("openAIResourceId"), out var __jsonOpenAiResourceId) ? (string)__jsonOpenAiResourceId : (string)OpenAiResourceId;}
            {_openAiResourceEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonString>("openAIResourceEndpoint"), out var __jsonOpenAiResourceEndpoint) ? (string)__jsonOpenAiResourceEndpoint : (string)OpenAiResourceEndpoint;}
            {_openAiConnectorId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonString>("openAIConnectorId"), out var __jsonOpenAiConnectorId) ? (string)__jsonOpenAiConnectorId : (string)OpenAiConnectorId;}
            {_key = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonString>("key"), out var __jsonKey) ? (string)__jsonKey : (string)Key;}
            {_lastRefreshAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonString>("lastRefreshAt"), out var __jsonLastRefreshAt) ? global::System.DateTime.TryParse((string)__jsonLastRefreshAt, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastRefreshAtValue) ? __jsonLastRefreshAtValue : LastRefreshAt : LastRefreshAt;}
            AfterFromJson(json);
        }
