...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview
{
    ...
    public partial class ElasticTrafficFilterResponse :
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview.IElasticTrafficFilterResponse,
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview.IElasticTrafficFilterResponseInternal
    {

        /// <summary>Backing field for <see cref="Ruleset" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview.IElasticTrafficFilter[] _ruleset;

        /// <summary>List of elastic traffic filters in the account</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview.IElasticTrafficFilter[] Ruleset { get => this._ruleset; set => this._ruleset = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview.IElasticTrafficFilter) })]
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202401Preview.IElasticTrafficFilter[] Ruleset { get; set; }
