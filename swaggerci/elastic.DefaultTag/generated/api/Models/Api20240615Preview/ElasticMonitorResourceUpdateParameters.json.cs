...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview
{
    ...
    public partial class ElasticMonitorResourceUpdateParameters
    {
        ...
        internal ElasticMonitorResourceUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_resubscribeProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("resubscribeProperties"), out var __jsonResubscribeProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ResubscribeProperties.FromJson(__jsonResubscribeProperties) : ResubscribeProperty;}
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ElasticMonitorResourceUpdateParametersTags.FromJson(__jsonTags) : Tag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IElasticMonitorResourceUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IElasticMonitorResourceUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IElasticMonitorResourceUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._resubscribeProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode) this._resubscribeProperty.ToJson(null,serializationMode) : null, "resubscribeProperties" ,container.Add );
