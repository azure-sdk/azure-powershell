...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview
{
    ...
    public partial class OperationResultTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OperationResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IOperationResult ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IOperationResult).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
