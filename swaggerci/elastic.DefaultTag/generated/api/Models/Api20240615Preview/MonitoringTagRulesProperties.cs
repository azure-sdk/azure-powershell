...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview
{
    ...
    public partial class MonitoringTagRulesProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IMonitoringTagRulesPropertiesInternal
    {

        /// <summary>Backing field for <see cref="LogRule" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRules _logRule;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRules LogRule { get => (this._logRule = this._logRule ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.LogRules()); set => this._logRule = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IFilteringTag[] LogRuleFilteringTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).FilteringTag; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).FilteringTag = value ?? null /* arrayOf */; }

        /// <summary>Flag specifying if AAD logs should be sent for the Monitor resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public bool? LogRuleSendAadLog { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).SendAadLog; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).SendAadLog = value ?? default(bool); }

        /// <summary>
        /// Flag specifying if activity logs from Azure resources should be sent for the Monitor resource.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public bool? LogRuleSendActivityLog { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).SendActivityLog; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).SendActivityLog = value ?? default(bool); }

        /// <summary>Flag specifying if subscription logs should be sent for the Monitor resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Inlined)]
        public bool? LogRuleSendSubscriptionLog { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).SendSubscriptionLog; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRulesInternal)LogRule).SendSubscriptionLog = value ?? default(bool); }

        /// <summary>Internal Acessors for LogRule</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.ILogRules Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IMonitoringTagRulesPropertiesInternal.LogRule { get => (this._logRule = this._logRule ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.LogRules()); set { {_logRule = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20240615Preview.IMonitoringTagRulesPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
