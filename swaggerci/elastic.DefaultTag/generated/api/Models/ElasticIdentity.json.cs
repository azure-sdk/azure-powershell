...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models
{
    ...
    public partial class ElasticIdentity
    {
        ...
        internal ElasticIdentity(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_configurationName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonString>("configurationName"), out var __jsonConfigurationName) ? (string)__jsonConfigurationName : (string)ConfigurationName;}
