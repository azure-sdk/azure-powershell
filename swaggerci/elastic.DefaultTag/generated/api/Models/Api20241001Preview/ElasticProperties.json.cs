...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview
{
    ...
    public partial class ElasticProperties
    {
        ...
        internal ElasticProperties(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_elasticCloudUser = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("elasticCloudUser"), out var __jsonElasticCloudUser) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.ElasticCloudUser.FromJson(__jsonElasticCloudUser) : ElasticCloudUser;}
            {_elasticCloudDeployment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("elasticCloudDeployment"), out var __jsonElasticCloudDeployment) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.ElasticCloudDeployment.FromJson(__jsonElasticCloudDeployment) : ElasticCloudDeployment;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.IElasticProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.IElasticProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20241001Preview.IElasticProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
