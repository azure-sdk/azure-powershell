...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status InProgress = @"InProgress";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
