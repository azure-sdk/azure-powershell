...
New-AzOrbitalSpacecraft -Name <String> -ResourceGroupName <String> -Link <ISpacecraftLink[]>
 ...
 [-NoradId <String>] [-ProvisioningState <SpacecraftsPropertiesProvisioningState>] [-Tag <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Orbital.Support.SpacecraftsPropertiesProvisioningState
Parameter Sets: (All)
Aliases:
