...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/contactProfiles", ApiVersion = "2022-11-01")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContactProfilesList(SubscriptionId, ResourceGroupName, this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null, onOk, onDefault, this, Pipeline);
