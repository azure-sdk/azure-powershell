...
.Link
https://learn.microsoft.com/powershell/module/az.logz/get-azlogzmonitormonitoredresource
#>
...
VMRESOURCEID <IVMResources[]>: Request of a list vm host update operation.
  ...
  [Id <String>]: Request of a list vm host update operation.
.Link
https://learn.microsoft.com/powershell/module/az.logz/get-azlogzmonitorvmhostupdate
#>
...
INPUTOBJECT <ILogzIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.logz/get-azlogzsinglesignon
#>
...
VMRESOURCEID <IVMResources[]>: Request of a list vm host update operation.
  ...
  [Id <String>]: Request of a list vm host update operation.
.Link
https://learn.microsoft.com/powershell/module/az.logz/get-azlogzsubaccountvmhostupdate
#>
...
INPUTOBJECT <ILogzIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.logz/get-azlogztagrule
#>
...
Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.ILogzSingleSignOnResource
.Link
https://learn.microsoft.com/powershell/module/az.logz/new-azlogzsinglesignon
#>
...
LOGRULEFILTERINGTAG <IFilteringTag[]>: List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
  ...
  [Value <String>]: The value of the tag.
.Link
https://learn.microsoft.com/powershell/module/az.logz/new-azlogztagrule
#>
...
INPUTOBJECT <ILogzIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.logz/remove-azlogztagrule
#>
