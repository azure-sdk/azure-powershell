...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListVMHosts=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/listVMHosts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzLogzMonitorVMHost_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Description(@"List the compute resources currently being monitored by the Logz main account resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Generated]
    public partial class GetAzLogzMonitorVMHost_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLogzMonitorVMHost_List" /> cmdlet class.
        /// </summary>
        public GetAzLogzMonitorVMHost_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MonitorListVMHosts' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorListVMHosts(SubscriptionId, ResourceGroupName, MonitorName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.MonitorListVMHosts_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
