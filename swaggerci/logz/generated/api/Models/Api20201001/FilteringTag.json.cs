...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001
{
    ...
    public partial class FilteringTag
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject into a new instance of <see cref="FilteringTag" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal FilteringTag(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json)
        {
            ...
            {_value = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonString>("value"), out var __jsonValue) ? (string)__jsonValue : (string)Value;}
            {_action = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonString>("action"), out var __jsonAction) ? (string)__jsonAction : (string)Action;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IFilteringTag.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IFilteringTag.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IFilteringTag FromJson(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json ? new FilteringTag(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FilteringTag" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="FilteringTag" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._value)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonString(this._value.ToString()) : null, "value" ,container.Add );
            AddIf( null != (((object)this._action)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonString(this._action.ToString()) : null, "action" ,container.Add );
