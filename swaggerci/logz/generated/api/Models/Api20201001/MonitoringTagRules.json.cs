...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001
{
    ...
    public partial class MonitoringTagRules
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IMonitoringTagRules.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IMonitoringTagRules.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IMonitoringTagRules FromJson(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json ? new MonitoringTagRules(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject into a new instance of <see cref="MonitoringTagRules" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MonitoringTagRules(Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.MonitoringTagRulesProperties.FromJson(__jsonProperties) : Property;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MonitoringTagRules" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MonitoringTagRules" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Json.JsonNode" />.
        /// </returns>
