...
external help file:
Module Name: Az.Logz
online version: https://learn.microsoft.com/powershell/module/az.logz/new-azlogztagrule
schema: 2.0.0
---
...
```
New-AzLogzTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
