...
external help file:
Module Name: Az.Logz
online version: https://learn.microsoft.com/powershell/module/az.logz/get-azlogzsubaccountvmhostupdate
schema: 2.0.0
---
...
```
Get-AzLogzSubAccountVMHostUpdate -MonitorName <String> -ResourceGroupName <String> -SubAccountName <String>
...
```
Get-AzLogzSubAccountVMHostUpdate -MonitorName <String> -ResourceGroupName <String> -SubAccountName <String>
 -Body <IVMHostUpdateRequest> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
