...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview
{
    ...
    public partial class WebPubSubNetworkAcLs
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IWebPubSubNetworkAcLs.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IWebPubSubNetworkAcLs.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IWebPubSubNetworkAcLs FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
        ...
        internal WebPubSubNetworkAcLs(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json)
        {
            ...
            {_publicNetwork = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("publicNetwork"), out var __jsonPublicNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.NetworkAcl.FromJson(__jsonPublicNetwork) : PublicNetwork;}
            ...
            {_privateEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray>("privateEndpoints"), out var __jsonPrivateEndpoints) ? If( __jsonPrivateEndpoints as Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IPrivateEndpointAcl[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IPrivateEndpointAcl) (Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.PrivateEndpointAcl.FromJson(__u) )) ))() : null : PrivateEndpoint;}
            AfterFromJson(json);
        }
    }
}