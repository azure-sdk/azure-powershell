...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview
{
    ...
    public partial class EventListenerEndpoint
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject into a new instance of <see cref="EventListenerEndpoint" />.
        /// </summary>
        ...
        internal EventListenerEndpoint(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IEventListenerEndpoint.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IEventListenerEndpoint interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IEventListenerEndpoint.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IEventListenerEndpoint FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json))
            {
                return null;
            }
            ...
            switch ( json.StringProperty("type") )
            {
                case "EventHub":
                {
                    return new EventHubEndpoint(json);
                }
            }
            return new EventListenerEndpoint(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="EventListenerEndpoint" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="EventListenerEndpoint" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" />.
        /// </returns>
