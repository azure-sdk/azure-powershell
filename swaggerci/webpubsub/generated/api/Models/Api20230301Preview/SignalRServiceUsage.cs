...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview
{
    ...
    public partial class SignalRServiceUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageName Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.SignalRServiceUsageName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageName _name;

        /// <summary>Localizable String object containing the name and a localized value.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.SignalRServiceUsageName()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The identifier of the usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>Localizable String object containing the name and a localized value.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.ISignalRServiceUsageName Name { get; set; }
        /// <summary>Localized name of the usage.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The identifier of the usage.</summary>
        string NameValue { get; set; }
