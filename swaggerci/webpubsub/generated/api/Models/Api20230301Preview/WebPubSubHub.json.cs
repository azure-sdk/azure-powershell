...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview
{
    ...
    public partial class WebPubSubHub
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IWebPubSubHub.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IWebPubSubHub.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IWebPubSubHub FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
        ...
        internal WebPubSubHub(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.Resource(json);
            {_systemData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("systemData"), out var __jsonSystemData) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api40.SystemData.FromJson(__jsonSystemData) : SystemData;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.WebPubSubHubProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }
    }
}