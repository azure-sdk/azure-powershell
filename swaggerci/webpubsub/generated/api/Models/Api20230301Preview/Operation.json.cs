...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview
{
    ...
    public partial class Operation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IOperation.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IOperation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IOperation FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
        ...
        internal Operation(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.OperationDisplay.FromJson(__jsonDisplay) : Display;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.OperationProperties.FromJson(__jsonProperties) : Property;}
