...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201
{
    ...
    public partial class LiveTraceConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ILiveTraceConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ILiveTraceConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ILiveTraceConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
        ...
        internal LiveTraceConfiguration(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json)
        {
            ...
            {_category = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray>("categories"), out var __jsonCategories) ? If( __jsonCategories as Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ILiveTraceCategory[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ILiveTraceCategory) (Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.LiveTraceCategory.FromJson(__u) )) ))() : null : Category;}
            AfterFromJson(json);
        }
