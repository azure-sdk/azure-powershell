...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201
{
    ...
    public partial class EventHandler :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IEventHandlerInternal
    {

        /// <summary>Backing field for <see cref="Auth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettings _auth;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettings Auth { get => (this._auth = this._auth ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.UpstreamAuthSettings()); set => this._auth = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Support.UpstreamAuthType? AuthType { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettingsInternal)Auth).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettingsInternal)Auth).Type = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Support.UpstreamAuthType)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Inlined)]
        public string ManagedIdentityResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettingsInternal)Auth).ManagedIdentityResource; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettingsInternal)Auth).ManagedIdentityResource = value ?? null; }

        /// <summary>Internal Acessors for Auth</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettings Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IEventHandlerInternal.Auth { get => (this._auth = this._auth ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.UpstreamAuthSettings()); set { {_auth = value;} } }

        /// <summary>Internal Acessors for AuthManagedIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IManagedIdentitySettings Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IEventHandlerInternal.AuthManagedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettingsInternal)Auth).ManagedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettingsInternal)Auth).ManagedIdentity = value; }
    ...
    {
        /// <summary>Upstream auth settings. If not set, no auth is used for upstream messages.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUpstreamAuthSettings Auth { get; set; }
        /// <summary>Managed identity settings for upstream.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IManagedIdentitySettings AuthManagedIdentity { get; set; }
        /// <summary>Upstream auth type enum.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Support.UpstreamAuthType? AuthType { get; set; }
        /// <summary>
        /// The Resource indicating the App ID URI of the target resource.
