...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201
{
    ...
    public partial class SignalRServiceUsage :
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsage,
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageName Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.SignalRServiceUsageName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageName _name;

        /// <summary>Localizable String object containing the name and a localized value.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.SignalRServiceUsageName()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The identifier of the usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Origin(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>Localizable String object containing the name and a localized value.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.ISignalRServiceUsageName Name { get; set; }
        /// <summary>Localized name of the usage.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The identifier of the usage.</summary>
        string NameValue { get; set; }
