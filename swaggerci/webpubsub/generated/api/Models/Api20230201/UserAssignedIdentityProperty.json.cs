...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201
{
    ...
    public partial class UserAssignedIdentityProperty
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUserAssignedIdentityProperty.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUserAssignedIdentityProperty.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IUserAssignedIdentityProperty FromJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject json ? new UserAssignedIdentityProperty(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserAssignedIdentityProperty" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserAssignedIdentityProperty" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._clientId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.Json.JsonString(this._clientId.ToString()) : null, "clientId" ,container.Add );
            }
