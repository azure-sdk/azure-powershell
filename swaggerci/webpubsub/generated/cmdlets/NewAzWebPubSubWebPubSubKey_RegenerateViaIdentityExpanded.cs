        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WebPubSubRegenerateKeyViaIdentity(InputObject.Id, ParametersBody, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebPubSubRegenerateKey(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, ParametersBody, onDefault, this, Pipeline);
                    }
