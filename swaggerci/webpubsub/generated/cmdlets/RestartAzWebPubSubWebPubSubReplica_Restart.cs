...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Restart=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/replicas/{replicaName}/restart"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzWebPubSubWebPubSubReplica_Restart", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Description(@"Operation to restart a replica.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Generated]
    public partial class RestartAzWebPubSubWebPubSubReplica_Restart : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RestartAzWebPubSubWebPubSubReplica_Restart</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets.RestartAzWebPubSubWebPubSubReplica_Restart Clone()
        {
            var clone = new RestartAzWebPubSubWebPubSubReplica_Restart();
            ...
            clone.ReplicaName = this.ReplicaName;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WebPubSubReplicasRestart' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WebPubSubReplicasRestart(SubscriptionId, ResourceGroupName, ResourceName, ReplicaName, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ResourceName=ResourceName,ReplicaName=ReplicaName})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzWebPubSubWebPubSubReplica_Restart" /> cmdlet class.
        /// </summary>
        public RestartAzWebPubSubWebPubSubReplica_Restart()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, ReplicaName=ReplicaName })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, ReplicaName=ReplicaName })
                    {
