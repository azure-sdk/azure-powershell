...
namespace Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/replicas/{replicaName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Description(@"Operation to update an exiting replica.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Generated]
    public partial class UpdateAzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IReplica _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.Replica();
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Cmdlets.UpdateAzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WebPubSubReplicasUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.WebPubSubReplicasUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebPubSubReplicasUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, InputObject.ReplicaName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzWebPubSubWebPubSubReplica_UpdateViaIdentityExpanded()
        {
