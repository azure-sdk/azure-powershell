...
online version: https://learn.microsoft.com/powershell/module/az.webpubsub/new-azwebpubsubwebpubsub
schema: 2.0.0
---
...
```
New-AzWebPubSubWebPubSub -ResourceGroupName <String> -ResourceName <String> -Location <String>
