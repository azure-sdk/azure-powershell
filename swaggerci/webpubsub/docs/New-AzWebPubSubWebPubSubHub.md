...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IEventHandler[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230201.IEventListener[]
Parameter Sets: (All)
Aliases:
