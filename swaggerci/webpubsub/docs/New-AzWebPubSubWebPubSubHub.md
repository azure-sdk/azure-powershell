...
online version: https://learn.microsoft.com/powershell/module/az.webpubsub/new-azwebpubsubwebpubsubhub
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IEventHandler[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.WebPubSub.Models.Api20230301Preview.IEventListener[]
Parameter Sets: (All)
Aliases:
