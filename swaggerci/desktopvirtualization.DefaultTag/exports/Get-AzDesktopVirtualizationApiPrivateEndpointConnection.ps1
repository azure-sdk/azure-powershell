...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910Preview.IPrivateEndpointConnections
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapiprivateendpointconnection
#>
function Get-AzDesktopVirtualizationApiPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910Preview.IPrivateEndpointConnections])]
...
param(
    ...
    [System.Int32]
    # The number of items to skip before starting to return items.
    ${InitialSkip},
