...
INPUTOBJECT <IDesktopVirtualizationApiIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: The name of the workspace
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapiactivesessionhostconfiguration
#>
function Get-AzDesktopVirtualizationApiActiveSessionHostConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IActiveSessionHostConfiguration])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiActiveSessionHostConfiguration_Get';
            GetViaIdentity = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiActiveSessionHostConfiguration_GetViaIdentity';
            List = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiActiveSessionHostConfiguration_List';
        }
...
INPUTOBJECT <IDesktopVirtualizationApiIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: The name of the workspace
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapisessionhostconfigurationsoperationstatus
#>
function Get-AzDesktopVirtualizationApiSessionHostConfigurationsOperationStatus {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.ISessionHostConfigurationOperationStatus])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostConfigurationsOperationStatus_Get';
            GetViaIdentity = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostConfigurationsOperationStatus_GetViaIdentity';
            List = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostConfigurationsOperationStatus_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
INPUTOBJECT <IDesktopVirtualizationApiIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: The name of the workspace
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapisessionhostmanagement
#>
function Get-AzDesktopVirtualizationApiSessionHostManagement {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagement_Get';
            GetViaIdentity = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagement_GetViaIdentity';
            List = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagement_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IStartMenuItem])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Category('Path')]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IUserSession])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IApplicationGroupPatchTags]))]
    [System.Collections.Hashtable]
    # tags to be updated
    ${Tag},
