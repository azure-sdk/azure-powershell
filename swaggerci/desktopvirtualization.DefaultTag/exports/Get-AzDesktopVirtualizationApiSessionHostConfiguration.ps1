...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapisessionhostconfiguration
#>
function Get-AzDesktopVirtualizationApiSessionHostConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240306Preview.ISessionHostConfiguration])]
