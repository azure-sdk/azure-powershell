...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/update-azdesktopvirtualizationapisessionhostmanagement
#>
function Update-AzDesktopVirtualizationApiSessionHostManagement {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250301Preview.ISessionHostManagement])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.FailedSessionHostCleanupPolicyShc])]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.FailedSessionHostCleanupPolicyShc]
    # The policy that should be applied when the Session Host provisioning operation fails.
    ${FailedSessionHostCleanupPolicy},

    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.CanaryPolicy])]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.CanaryPolicy]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DesktopVirtualizationApi.private\Update-AzDesktopVirtualizationApiSessionHostManagement_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DesktopVirtualizationApi.private\Update-AzDesktopVirtualizationApiSessionHostManagement_UpdateViaIdentityExpanded';
        }
