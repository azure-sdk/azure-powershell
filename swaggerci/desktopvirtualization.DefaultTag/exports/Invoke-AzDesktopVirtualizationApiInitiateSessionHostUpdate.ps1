...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/invoke-azdesktopvirtualizationapiinitiatesessionhostupdate
#>
function Invoke-AzDesktopVirtualizationApiInitiateSessionHostUpdate {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview.IUpdateSessionHostsRequestBody])]
...
begin {
    try {
        ...
        $mapping = @{
            Post = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiInitiateSessionHostUpdate_Post';
            PostExpanded = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiInitiateSessionHostUpdate_PostExpanded';
            PostViaIdentity = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiInitiateSessionHostUpdate_PostViaIdentity';
            PostViaIdentityExpanded = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiInitiateSessionHostUpdate_PostViaIdentityExpanded';
        }
