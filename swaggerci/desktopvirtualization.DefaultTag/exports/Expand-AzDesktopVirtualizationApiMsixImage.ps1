...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/expand-azdesktopvirtualizationapimsiximage
#>
function Expand-AzDesktopVirtualizationApiMsixImage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230130Preview.IExpandMsixImage])]
