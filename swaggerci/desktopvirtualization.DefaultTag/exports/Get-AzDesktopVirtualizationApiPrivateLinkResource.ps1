...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapiprivatelinkresource
#>
function Get-AzDesktopVirtualizationApiPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240306Preview.IPrivateLinkResource])]
