...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapisessionhostmanagementsupdatestatus
#>
function Get-AzDesktopVirtualizationApiSessionHostManagementsUpdateStatus {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20241101Preview.ISessionHostManagementUpdateStatus])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagementsUpdateStatus_Get';
            GetViaIdentity = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagementsUpdateStatus_GetViaIdentity';
        }
