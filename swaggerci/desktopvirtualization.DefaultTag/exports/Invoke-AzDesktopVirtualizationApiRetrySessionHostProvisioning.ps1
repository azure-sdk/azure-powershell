...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/invoke-azdesktopvirtualizationapiretrysessionhostprovisioning
#>
function Invoke-AzDesktopVirtualizationApiRetrySessionHostProvisioning {
...
begin {
    try {
        ...
        $mapping = @{
            Retry = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiRetrySessionHostProvisioning_Retry';
            RetryViaIdentity = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiRetrySessionHostProvisioning_RetryViaIdentity';
        }
