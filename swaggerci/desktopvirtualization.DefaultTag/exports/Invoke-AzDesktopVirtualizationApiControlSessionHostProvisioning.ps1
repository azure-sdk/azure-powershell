...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/invoke-azdesktopvirtualizationapicontrolsessionhostprovisioning
#>
function Invoke-AzDesktopVirtualizationApiControlSessionHostProvisioning {
...
begin {
    try {
        ...
        $mapping = @{
            Post = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostProvisioning_Post';
            PostExpanded = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostProvisioning_PostExpanded';
            PostViaIdentity = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostProvisioning_PostViaIdentity';
            PostViaIdentityExpanded = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostProvisioning_PostViaIdentityExpanded';
        }
