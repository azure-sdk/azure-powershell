...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/invoke-azdesktopvirtualizationapicontrolsessionhostupdate
#>
function Invoke-AzDesktopVirtualizationApiControlSessionHostUpdate {
...
begin {
    try {
        ...
        $mapping = @{
            Post = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostUpdate_Post';
            PostExpanded = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostUpdate_PostExpanded';
            PostViaIdentity = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostUpdate_PostViaIdentity';
            PostViaIdentityExpanded = 'Az.DesktopVirtualizationApi.private\Invoke-AzDesktopVirtualizationApiControlSessionHostUpdate_PostViaIdentityExpanded';
        }
