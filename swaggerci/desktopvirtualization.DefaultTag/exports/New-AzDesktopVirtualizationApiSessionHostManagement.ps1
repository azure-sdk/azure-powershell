...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/new-azdesktopvirtualizationapisessionhostmanagement
#>
function New-AzDesktopVirtualizationApiSessionHostManagement {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.DesktopVirtualizationApi.private\New-AzDesktopVirtualizationApiSessionHostManagement_CreateExpanded';
        }
