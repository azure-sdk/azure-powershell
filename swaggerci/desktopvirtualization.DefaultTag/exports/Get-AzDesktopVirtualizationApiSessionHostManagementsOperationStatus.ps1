...
.Link
https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapisessionhostmanagementsoperationstatus
#>
function Get-AzDesktopVirtualizationApiSessionHostManagementsOperationStatus {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240306Preview.ISessionHostManagementOperationStatus])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagementsOperationStatus_Get';
            GetViaIdentity = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagementsOperationStatus_GetViaIdentity';
            List = 'Az.DesktopVirtualizationApi.private\Get-AzDesktopVirtualizationApiSessionHostManagementsOperationStatus_List';
        }
