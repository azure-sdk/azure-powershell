...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/new-azdesktopvirtualizationapiscalingplanpooledschedule
schema: 2.0.0
---

# New-AzDesktopVirtualizationApiScalingPlanPooledSchedule
...
```
New-AzDesktopVirtualizationApiScalingPlanPooledSchedule -ResourceGroupName <String> -ScalingPlanName <String>
 -ScalingPlanScheduleName <String> -DaysOfWeek <DayOfWeek[]> -OffPeakStartTimeHour <Int32>
 ...
 [-CreateDeleteRampUpMinimumHostPoolSize <Int32>]
 [-OffPeakLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>]
 [-PeakLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>] [-RampDownForceLogoffUser]
 [-RampDownLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>] [-RampDownMinimumHostsPct <Int32>]
 [-RampDownNotificationMessage <String>] [-RampDownStopHostsWhen <StopHostsWhen>]
 [-RampDownWaitTimeMinute <Int32>] [-RampUpLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>]
 [-RampUpMinimumHostsPct <Int32>] [-ScalingMethod <ScalingMethod>] [-DefaultProfile <PSObject>] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ScalingMethod
Parameter Sets: (All)
Aliases:
