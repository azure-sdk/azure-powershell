...
New-AzDesktopVirtualizationApiScalingPlanPooledSchedule -ResourceGroupName <String> -ScalingPlanName <String>
 ...
 [-ManagedBy <String>] [-OffPeakLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>]
 ...
 [-PeakStartTimeMinute <Int32>] [-PlanName <String>] [-PlanProduct <String>] [-PlanPromotionCode <String>]
 [-PlanPublisher <String>] [-PlanVersion <String>] [-RampDownCapacityThresholdPct <Int32>]
