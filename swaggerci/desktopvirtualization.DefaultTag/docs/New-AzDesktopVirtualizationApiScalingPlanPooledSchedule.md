...
New-AzDesktopVirtualizationApiScalingPlanPooledSchedule -ResourceGroupName <String> -ScalingPlanName <String>
 ...
 [-PeakLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>] [-PropertiesName <String>]
 [-RampDownForceLogoffUser] [-RampDownLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>]
 [-RampDownMinimumHostsPct <Int32>] [-RampDownNotificationMessage <String>]
 [-RampDownStopHostsWhen <StopHostsWhen>] [-RampDownWaitTimeMinute <Int32>]
 [-RampUpLoadBalancingAlgorithm <SessionHostLoadBalancingAlgorithm>] [-RampUpMinimumHostsPct <Int32>]
 [-ScalingMethod <ScalingMethodType>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ScalingMethodType
Parameter Sets: (All)
Aliases:
