...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IScalingHostPoolReference[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IScalingSchedule[]
Parameter Sets: (All)
Aliases:
