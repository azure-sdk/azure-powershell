...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IScalingHostPoolReference[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IScalingSchedule[]
Parameter Sets: (All)
Aliases:
