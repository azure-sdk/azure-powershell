...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/update-azdesktopvirtualizationapiscalingplan
schema: 2.0.0
---
...
Update-AzDesktopVirtualizationApiScalingPlan -Name <String> -ResourceGroupName <String>
 ...
 [-HostPoolReference <IScalingHostPoolReference[]>] [-Schedule <IScalingPlanPooledScheduleProperties[]>]
 [-Tag <Hashtable>] [-TimeZone <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview.IScalingHostPoolReference[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview.IScalingPlanPooledScheduleProperties[]
Parameter Sets: (All)
Aliases:
