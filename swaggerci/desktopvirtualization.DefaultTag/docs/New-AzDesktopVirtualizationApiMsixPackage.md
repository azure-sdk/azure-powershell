...
```
New-AzDesktopVirtualizationApiMsixPackage -FullName <String> [-SubscriptionId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910.IMsixPackageApplications[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910.IMsixPackageDependencies[]
Parameter Sets: (All)
Aliases:
