...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230130Preview.IMsixPackageApplications[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230130Preview.IMsixPackageDependencies[]
Parameter Sets: (All)
Aliases:
