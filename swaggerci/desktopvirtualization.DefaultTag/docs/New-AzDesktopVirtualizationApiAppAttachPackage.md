...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/new-azdesktopvirtualizationapiappattachpackage
schema: 2.0.0
---

# New-AzDesktopVirtualizationApiAppAttachPackage
...
```
New-AzDesktopVirtualizationApiAppAttachPackage -Name <String> -ResourceGroupName <String> -Location <String>
