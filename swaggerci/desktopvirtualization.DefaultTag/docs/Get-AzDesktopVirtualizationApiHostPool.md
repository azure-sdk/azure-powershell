...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapihostpool
schema: 2.0.0
---
...
### List (Default)
```
Get-AzDesktopVirtualizationApiHostPool [-SubscriptionId <String[]>] [-InitialSkip <Int32>] [-IsDescending]
