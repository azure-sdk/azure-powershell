...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/invoke-azdesktopvirtualizationapiupdatesessionhost
schema: 2.0.0
---

# Invoke-AzDesktopVirtualizationApiUpdateSessionHost
...
```
Invoke-AzDesktopVirtualizationApiUpdateSessionHost -HostPoolName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ScheduledDateTime <DateTime>] [-TimeZone <String>] [-UpdateDeleteOriginalVM]
...
### PostViaIdentity
```
Invoke-AzDesktopVirtualizationApiUpdateSessionHost -InputObject <IDesktopVirtualizationApiIdentity>
...
```
Invoke-AzDesktopVirtualizationApiUpdateSessionHost -InputObject <IDesktopVirtualizationApiIdentity>
 [-ScheduledDateTime <DateTime>] [-TimeZone <String>] [-UpdateDeleteOriginalVM]
 [-UpdateLogOffDelayMinute <Int32>] [-UpdateLogOffMessage <String>] [-UpdateMaxVmsRemovedDuringUpdate <Int32>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230406Preview.IUpdateSessionHostsRequestBody
...
`UPDATESESSIONHOSTSREQUESTBODY <IUpdateSessionHostsRequestBody>`: Object containing the definition for properties to be used for a sessionHostUpdate operation.
  ...
  - `[TimeZone <String>]`: The timeZone as defined in https://docs.microsoft.com/en-us/dotnet/api/system.timezoneinfo.findsystemtimezonebyid?view=net-5.0.
