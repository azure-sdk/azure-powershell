...
Invoke-AzDesktopVirtualizationApiInitiateSessionHostUpdate -InputObject <IDesktopVirtualizationApiIdentity>
 -UpdateSessionHostsRequestBody <IUpdateSessionHostsRequestBody> [-DefaultProfile <PSObject>] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview.IUpdateSessionHostsRequestBody
