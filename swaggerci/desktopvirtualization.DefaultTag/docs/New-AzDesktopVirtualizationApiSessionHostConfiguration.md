...
New-AzDesktopVirtualizationApiSessionHostConfiguration -HostPoolName <String> -ResourceGroupName <String>
 -DomainInfoJoinType <DomainJoinType> -ImageInfoImageType <Type> -NetworkInfoSubnetId <String>
 ...
 [-CustomInfoResourceId <String>] [-DiffDiskSettingOption <DiffDiskOption>]
 [-DiffDiskSettingPlacement <DiffDiskPlacement>] [-DomainCredentialsPasswordKeyVaultSecretUri <String>]
 [-DomainCredentialsUsernameKeyVaultSecretUri <String>] [-FriendlyName <String>]
 [-ManagedDiskType <VirtualMachineDiskType>] [-MarketplaceInfoExactVersion <String>]
 [-MarketplaceInfoOffer <String>] [-MarketplaceInfoPublisher <String>] [-MarketplaceInfoSku <String>]
 [-NetworkInfoSecurityGroupId <String>] [-SecurityInfoSecureBootEnabled]
 [-SecurityInfoType <VirtualMachineSecurityType>] [-SecurityInfoVTpmEnabled] [-VMLocation <String>]
 [-VMResourceGroup <String>] [-VMTag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.DiffDiskOption
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.DiffDiskPlacement
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250301Preview.ISessionHostConfiguration
