...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapiappattachpackage
schema: 2.0.0
---

# Remove-AzDesktopVirtualizationApiAppAttachPackage
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiAppAttachPackage -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiAppAttachPackage -InputObject <IDesktopVirtualizationApiIdentity> [-Force]
