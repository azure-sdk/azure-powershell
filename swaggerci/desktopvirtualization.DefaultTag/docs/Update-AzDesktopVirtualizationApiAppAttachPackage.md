...
online version: https://learn.microsoft.com/powershell/module/az.desktopvirtualizationapi/update-azdesktopvirtualizationapiappattachpackage
schema: 2.0.0
---

# Update-AzDesktopVirtualizationApiAppAttachPackage
...
```
Update-AzDesktopVirtualizationApiAppAttachPackage -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-FailHealthCheckOnStagingFailure <FailHealthCheckOnStagingFailureEnum>]
...
```
Update-AzDesktopVirtualizationApiAppAttachPackage -InputObject <IDesktopVirtualizationApiIdentity>
 [-FailHealthCheckOnStagingFailure <FailHealthCheckOnStagingFailureEnum>] [-HostPoolReference <String[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.FailHealthCheckOnStagingFailureEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.PackageTimestamped
Parameter Sets: (All)
Aliases:
