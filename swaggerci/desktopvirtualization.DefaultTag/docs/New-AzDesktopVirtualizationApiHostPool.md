...
New-AzDesktopVirtualizationApiHostPool -Name <String> -ResourceGroupName <String> -HostPoolType <HostPoolType>
 ...
 [-DirectUdp <DirectUdp>] [-FriendlyName <String>] [-IdentityType <ManagedServiceIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-Kind <String>] [-ManagedBy <String>]
 [-ManagedPrivateUdp <ManagedPrivateUdp>] [-ManagementType <ManagementType>] [-MaxSessionLimit <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IMaintenanceWindowProperties[]
Parameter Sets: (All)
Aliases:
