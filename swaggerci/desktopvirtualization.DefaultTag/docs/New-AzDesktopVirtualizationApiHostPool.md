...
New-AzDesktopVirtualizationApiHostPool -Name <String> -ResourceGroupName <String> -HostPoolType <HostPoolType>
 ...
 [-DirectUdp <DirectUdp>] [-FriendlyName <String>] [-IdentityType <ResourceIdentityType>] [-Kind <String>]
 [-Location <String>] [-ManagedBy <String>] [-ManagedPrivateUdp <ManagedPrivateUdp>]
 [-ManagementType <ManagementType>] [-MaxSessionLimit <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240116Preview.IMaintenanceWindowProperties[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ManagementType
Parameter Sets: (All)
Aliases:
