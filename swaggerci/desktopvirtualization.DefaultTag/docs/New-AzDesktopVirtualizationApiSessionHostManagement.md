...
New-AzDesktopVirtualizationApiSessionHostManagement -HostPoolName <String> -ResourceGroupName <String>
 -TimeZone <String> -UpdateLogOffDelayMinute <Int32> -UpdateLogOffMessage <String>
 -UpdateMaxVmsRemovedDuringUpdate <Int32> [-SubscriptionId <String>] [-UpdateDeleteOriginalVM]
