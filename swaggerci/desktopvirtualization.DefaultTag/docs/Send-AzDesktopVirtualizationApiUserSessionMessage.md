...
```
Send-AzDesktopVirtualizationApiUserSessionMessage -HostPoolName <String> -ResourceGroupName <String>
 -SessionHostName <String> -UserSessionId <String> -Body <ISendMessage> [-SubscriptionId <String>]
...
Send-AzDesktopVirtualizationApiUserSessionMessage -InputObject <IDesktopVirtualizationApiIdentity>
 -Body <ISendMessage> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910Preview.ISendMessage
...
### Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910Preview.ISendMessage
