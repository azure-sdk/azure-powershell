...
New-AzDesktopVirtualizationApiScalingPlan -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-HostPoolType <ScalingHostPoolType>] [-IdentityType <ManagedServiceIdentityType>]
 ...
 [-Schedule <IScalingPlanPooledScheduleProperties[]>] [-SkuCapacity <Int32>] [-SkuFamily <String>]
