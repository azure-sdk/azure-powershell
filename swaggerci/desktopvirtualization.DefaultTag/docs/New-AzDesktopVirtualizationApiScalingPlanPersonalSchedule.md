...
New-AzDesktopVirtualizationApiScalingPlanPersonalSchedule -ResourceGroupName <String>
 -ScalingPlanName <String> -ScalingPlanScheduleName <String> -DaysOfWeek <DayOfWeek[]>
 ...
 -RampUpStartTimeHour <Int32> -RampUpStartTimeMinute <Int32> [-SubscriptionId <String>]
 ...
 [-PeakMinutesToWaitOnLogoff <Int32>] [-PeakStartVMOnConnect <SetStartVMOnConnect>]
