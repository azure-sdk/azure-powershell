...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Description(@"List App Attach packages in subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DesktopVirtualization/appAttachPackages", ApiVersion = "2024-11-01-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AppAttachPackageListBySubscription(SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AppAttachPackageListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
