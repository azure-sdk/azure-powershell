...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/userSessions/{userSessionId}/sendMessage", ApiVersion = "2024-09-10-preview")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910Preview.ISendMessage _body = new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240910Preview.SendMessage();
        ...
        public string MessageBody { get => _body.MessageBody ?? null; set => _body.MessageBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MessageTitle { get => _body.MessageTitle ?? null; set => _body.MessageTitle = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.UserSessionsSendMessageViaIdentity(InputObject.Id, _body, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.UserSessionsSendMessage(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HostPoolName ?? null, InputObject.SessionHostName ?? null, InputObject.UserSessionId ?? null, _body, onNoContent, onDefault, this, Pipeline);
                    }
