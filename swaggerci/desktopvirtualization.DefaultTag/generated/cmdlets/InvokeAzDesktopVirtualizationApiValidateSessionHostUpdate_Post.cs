...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Cmdlets
{
    ...
    /// <summary>
    /// Validates a session host update operation for validation errors. When Session Host Configuration and Session Host Management
    /// values are not provided the ones saved in the Host Pool will be used.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Post=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/validateSessionHostUpdate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDesktopVirtualizationApiValidateSessionHostUpdate_Post", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Description(@"Validates a session host update operation for validation errors. When Session Host Configuration and Session Host Management values are not provided the ones saved in the Host Pool will be used.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/validateSessionHostUpdate", ApiVersion = "2023-11-01-preview")]
    public partial class InvokeAzDesktopVirtualizationApiValidateSessionHostUpdate_Post : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ValidateSessionHostUpdateRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20231101Preview.IValidateSessionHostUpdateRequestBody _validateSessionHostUpdateRequestBody;

        /// <summary>
        /// Object containing the definition for properties to be used in the sessionHostUpdate validation.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Object containing the definition for properties to be used in the sessionHostUpdate validation.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Object containing the definition for properties to be used in the sessionHostUpdate validation.",
        SerializedName = @"validateSessionHostUpdateRequestBody",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20231101Preview.IValidateSessionHostUpdateRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20231101Preview.IValidateSessionHostUpdateRequestBody ValidateSessionHostUpdateRequestBody { get => this._validateSessionHostUpdateRequestBody; set => this._validateSessionHostUpdateRequestBody = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzDesktopVirtualizationApiValidateSessionHostUpdate_Post
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Cmdlets.InvokeAzDesktopVirtualizationApiValidateSessionHostUpdate_Post Clone()
        {
            var clone = new InvokeAzDesktopVirtualizationApiValidateSessionHostUpdate_Post();
            ...
            clone.ValidateSessionHostUpdateRequestBody = this.ValidateSessionHostUpdateRequestBody;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDesktopVirtualizationApiValidateSessionHostUpdate_Post" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzDesktopVirtualizationApiValidateSessionHostUpdate_Post()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ValidateSessionHostUpdatePost' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ValidateSessionHostUpdatePost(SubscriptionId, ResourceGroupName, HostPoolName, ValidateSessionHostUpdateRequestBody, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,HostPoolName=HostPoolName,body=ValidateSessionHostUpdateRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, HostPoolName=HostPoolName, body=ValidateSessionHostUpdateRequestBody })
                    {
