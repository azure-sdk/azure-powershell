...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Cmdlets
{
    ...
    /// <summary>
    /// Initiates a hostpool update or schedule an update for the future. When validateOnly is true this will only run validations
    /// and return warnings and errors.
    /// </summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Description(@"Initiates a hostpool update or schedule an update for the future. When validateOnly is true this will only run validations and return warnings and errors.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230406Preview.IValidateSessionHostUpdateRequestBody _validateSessionHostUpdateRequestBody;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230406Preview.IValidateSessionHostUpdateRequestBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20230406Preview.IValidateSessionHostUpdateRequestBody ValidateSessionHostUpdateRequestBody { get => this._validateSessionHostUpdateRequestBody; set => this._validateSessionHostUpdateRequestBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ValidateSessionHostUpdatePost(SubscriptionId, ResourceGroupName, HostPoolName, ValidateSessionHostUpdateRequestBody, onOk, onNoContent, onDefault, this, Pipeline);
