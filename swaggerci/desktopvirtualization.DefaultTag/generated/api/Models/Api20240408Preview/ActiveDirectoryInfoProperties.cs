...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview
{
    ...
    public partial class ActiveDirectoryInfoProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IActiveDirectoryInfoProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IActiveDirectoryInfoPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IKeyVaultCredentialsProperties _domainCredentials;

        /// <summary>Credentials needed to create the virtual machine.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IKeyVaultCredentialsProperties DomainCredentials { get => (this._domainCredentials = this._domainCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.KeyVaultCredentialsProperties()); set => this._domainCredentials = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IKeyVaultCredentialsProperties Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IActiveDirectoryInfoPropertiesInternal.DomainCredentials { get => (this._domainCredentials = this._domainCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.KeyVaultCredentialsProperties()); set { {_domainCredentials = value;} } }
    ...
    {
        /// <summary>Credentials needed to create the virtual machine.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20240408Preview.IKeyVaultCredentialsProperties DomainCredentials { get; set; }
        /// <summary>The uri to access the secret that the password is stored in.</summary>
        string DomainCredentialsPasswordKeyVaultSecretUri { get; set; }
        /// <summary>The uri to access the secret that the username is stored in.</summary>
        string DomainCredentialsUsernameKeyVaultSecretUri { get; set; }
