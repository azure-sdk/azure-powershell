...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api60
{
    ...
    public partial class ErrorResponseTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ErrorResponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api60.IErrorResponse ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api60.IErrorResponse).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
