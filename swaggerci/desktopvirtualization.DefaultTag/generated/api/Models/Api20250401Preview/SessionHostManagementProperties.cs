...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview
{
    ...
    public partial class SessionHostManagementProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.ISessionHostManagementPropertiesInternal
    {

        /// <summary>Internal Acessors for Update</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationProperties Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.ISessionHostManagementPropertiesInternal.Update { get => (this._update = this._update ?? new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.HostPoolUpdateConfigurationProperties()); set { {_update = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationProperties _update;

        /// <summary>Parameters for a hostpool update.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationProperties Update { get => (this._update = this._update ?? new Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.HostPoolUpdateConfigurationProperties()); set => this._update = value; }
        ...
        public bool? UpdateDeleteOriginalVM { get => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).DeleteOriginalVM; set => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).DeleteOriginalVM = value ?? default(bool); }

        /// <summary>Grace period before logging off users in minutes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Inlined)]
        public int UpdateLogOffDelayMinute { get => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).LogOffDelayMinute; set => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).LogOffDelayMinute = value ; }

        /// <summary>Log off message sent to user for logoff. Default value is an empty string.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Inlined)]
        public string UpdateLogOffMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).LogOffMessage; set => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).LogOffMessage = value ?? null; }

        /// <summary>The maximum number of virtual machines to be removed during hostpool update.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Inlined)]
        public int UpdateMaxVmsRemoved { get => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).MaxVmsRemoved; set => ((Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20250401Preview.IHostPoolUpdateConfigurationPropertiesInternal)Update).MaxVmsRemoved = value ; }
