...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview
{
    ...
    public partial class ResourceProviderOperationListResultTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ResourceProviderOperationListResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview.IResourceProviderOperationListResult ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api202408Preview.IResourceProviderOperationListResult).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
