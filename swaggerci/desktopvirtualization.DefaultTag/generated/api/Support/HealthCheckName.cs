...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support
{
        ...
        System.IEquatable<HealthCheckName>
    {
        ...
        /// to enable the staging/registration (and eventual de-registration/destaging) of MSIX apps that have been set up by the
        /// tenant admin. This checks whether the component had any failures during package staging. Failures in staging will prevent
        /// some MSIX apps from working properly for the end user. If this check fails, it is non fatal and the machine still can
        /// service connections, main issue may be certain apps will not work for end-users. (Currently Enabled)
        /// </summary>
