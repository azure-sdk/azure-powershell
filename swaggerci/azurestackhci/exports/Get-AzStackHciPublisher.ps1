...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.stackhci/get-azstackhcipublisher
#>
function Get-AzStackHciPublisher {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview.IPublisher])]
