...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.stackhci/get-azstackhciupdate
#>
function Get-AzStackHciUpdate {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview.IUpdate])]
