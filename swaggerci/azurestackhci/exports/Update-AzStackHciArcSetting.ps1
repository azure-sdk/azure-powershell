...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IArcSettingsPatchTags]))]
