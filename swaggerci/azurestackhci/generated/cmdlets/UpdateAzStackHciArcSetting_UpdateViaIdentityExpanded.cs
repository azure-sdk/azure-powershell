...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/arcSettings/{arcSettingName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStackHciArcSetting_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Description(@"Update ArcSettings for HCI cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Generated]
    public partial class UpdateAzStackHciArcSetting_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IArcSettingsPatch _arcSettingBody= new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.ArcSettingsPatch();

        /// <summary>ArcSetting details to update.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IArcSettingsPatch ArcSettingBody { get => this._arcSettingBody; set => this._arcSettingBody = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IArcSettingsPatchTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IArcSettingsPatchTags Tag { get => ArcSettingBody.Tag ?? null /* object */; set => ArcSettingBody.Tag = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ArcSettingsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ArcSettingsUpdateViaIdentity(InputObject.Id, ArcSettingBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ArcSettingsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.ArcSettingName ?? null, ArcSettingBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ArcSettingBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzStackHciArcSetting_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzStackHciArcSetting_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ArcSettingBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ArcSettingBody })
                    {
