...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201
{
    ...
    public partial class ClusterNode :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNode,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal
    {
        ...
        float? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.CoreCount { get => this._coreCount; set { {_coreCount = value;} } }

        /// <summary>Internal Acessors for EhcResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.EhcResourceId { get => this._ehcResourceId; set { {_ehcResourceId = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LastLicensingTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.LastLicensingTimestamp { get => this._lastLicensingTimestamp; set { {_lastLicensingTimestamp = value;} } }

        /// <summary>Internal Acessors for Manufacturer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.Manufacturer { get => this._manufacturer; set { {_manufacturer = value;} } }

        /// <summary>Internal Acessors for MemoryInGiB</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.MemoryInGiB { get => this._memoryInGiB; set { {_memoryInGiB = value;} } }

        /// <summary>Internal Acessors for Model</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.Model { get => this._model; set { {_model = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for NodeType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ClusterNodeType? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.NodeType { get => this._nodeType; set { {_nodeType = value;} } }

        /// <summary>Internal Acessors for OSDisplayVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.OSDisplayVersion { get => this._oSDisplayVersion; set { {_oSDisplayVersion = value;} } }

        /// <summary>Internal Acessors for OSName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.OSName { get => this._oSName; set { {_oSName = value;} } }

        /// <summary>Internal Acessors for OSVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.OSVersion { get => this._oSVersion; set { {_oSVersion = value;} } }

        /// <summary>Internal Acessors for SerialNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.SerialNumber { get => this._serialNumber; set { {_serialNumber = value;} } }

        /// <summary>Internal Acessors for WindowsServerSubscription</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.WindowsServerSubscription? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230201.IClusterNodeInternal.WindowsServerSubscription { get => this._windowsServerSubscription; set { {_windowsServerSubscription = value;} } }
