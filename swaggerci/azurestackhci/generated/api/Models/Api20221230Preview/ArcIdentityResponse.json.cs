...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview
{
    ...
    public partial class ArcIdentityResponse
    {
        ...
        internal ArcIdentityResponse(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview.ArcIdentityResponseProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview.IArcIdentityResponse.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview.IArcIdentityResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221230Preview.IArcIdentityResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
