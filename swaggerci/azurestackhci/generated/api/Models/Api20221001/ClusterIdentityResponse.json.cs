...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221001
{
    ...
    public partial class ClusterIdentityResponse
    {
        ...
        internal ClusterIdentityResponse(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221001.ClusterIdentityResponseProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221001.IClusterIdentityResponse.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221001.IClusterIdentityResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221001.IClusterIdentityResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
