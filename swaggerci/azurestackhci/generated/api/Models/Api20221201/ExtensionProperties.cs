...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201
{
    ...
    public partial class ExtensionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionParameters _extensionParameter;

        /// <summary>Parameters specific to this extension type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionParameters ExtensionParameter { get => (this._extensionParameter = this._extensionParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.ExtensionParameters()); set => this._extensionParameter = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Inlined)]
        public string ExtensionParameterType { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionParametersInternal)ExtensionParameter).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionParametersInternal)ExtensionParameter).Type = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ExtensionAggregateState? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionPropertiesInternal.AggregateState { get => this._aggregateState; set { {_aggregateState = value;} } }

        /// <summary>Internal Acessors for ExtensionParameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionParameters Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionPropertiesInternal.ExtensionParameter { get => (this._extensionParameter = this._extensionParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.ExtensionParameters()); set { {_extensionParameter = value;} } }

        /// <summary>Internal Acessors for PerNodeExtensionDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IPerNodeExtensionState[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionPropertiesInternal.PerNodeExtensionDetail { get => this._perNodeExtensionDetail; set { {_perNodeExtensionDetail = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="PerNodeExtensionDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IPerNodeExtensionState[] _perNodeExtensionDetail;

        /// <summary>State of Arc Extension in each of the nodes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IPerNodeExtensionState[] PerNodeExtensionDetail { get => this._perNodeExtensionDetail; }
...

    {
        ...
        /// <summary>Parameters specific to this extension type.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20221201.IExtensionParameters ExtensionParameter { get; set; }
        /// <summary>
        /// Indicates whether the extension should use a newer minor version if one is available at deployment time. Once deployed,
        /// however, the extension will not upgrade minor versions unless redeployed, even with this property set to true.
        /// </summary>
