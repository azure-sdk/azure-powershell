...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501
{
    ...
    public partial class ClusterReportedProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal.ClusterId { get => this._clusterId; set { {_clusterId = value;} } }

        /// <summary>Internal Acessors for ClusterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal.ClusterName { get => this._clusterName; set { {_clusterName = value;} } }

        /// <summary>Internal Acessors for ClusterVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal.ClusterVersion { get => this._clusterVersion; set { {_clusterVersion = value;} } }

        /// <summary>Internal Acessors for ImdsAttestation</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ImdsAttestation? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal.ImdsAttestation { get => this._imdsAttestation; set { {_imdsAttestation = value;} } }

        /// <summary>Internal Acessors for LastUpdated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal.LastUpdated { get => this._lastUpdated; set { {_lastUpdated = value;} } }

        /// <summary>Internal Acessors for Node</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterNode[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterReportedPropertiesInternal.Node { get => this._node; set { {_node = value;} } }

        /// <summary>Backing field for <see cref="Node" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterNode[] _node;

        /// <summary>List of nodes reported by the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterNode[] Node { get => this._node; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterNode[] Node { get;  }
...

    {
        ...
        /// <summary>List of nodes reported by the cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20220501.IClusterNode[] Node { get; set; }
