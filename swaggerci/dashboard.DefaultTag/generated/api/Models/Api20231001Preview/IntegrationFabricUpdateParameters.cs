...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview
{
    ...
    public partial class IntegrationFabricUpdateParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersInternal
    {

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricPropertiesUpdateParameters Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IntegrationFabricPropertiesUpdateParameters()); set { {_property = value;} } }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricPropertiesUpdateParameters _property;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersTags _tag;

        /// <summary>The new tags of the Integration Fabric resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Origin(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IntegrationFabricUpdateParametersTags()); set => this._tag = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersTags Tag { get; set; }
    ...
    {
        /// <summary>The new properties of this Integration Fabric resource</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricPropertiesUpdateParameters Property { get; set; }
        /// <summary>The new integration scenarios covered by this integration fabric.</summary>
        string[] Scenario { get; set; }
        /// <summary>The new tags of the Integration Fabric resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IIntegrationFabricUpdateParametersTags Tag { get; set; }
