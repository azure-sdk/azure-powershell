...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001
{
    ...
    public partial class Smtp
    {
        ...
        internal Smtp(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject json)
        {
            ...
            {_password = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonString>("password"), out var __jsonPassword) ? new System.Net.NetworkCredential("",(string)__jsonPassword).SecurePassword : Password;}
