...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001
{
    ...
    public partial class Security
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.ISecurity.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.ISecurity.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.ISecurity FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject json ? new Security(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject into a new instance of <see cref="Security" />.
        /// </summary>
        ...
        internal Security(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject json)
        {
            ...
            {_csrfAlwaysCheck = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonBoolean>("csrfAlwaysCheck"), out var __jsonCsrfAlwaysCheck) ? (bool?)__jsonCsrfAlwaysCheck : CsrfAlwaysCheck;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Security" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Security" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._csrfAlwaysCheck ? (Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonBoolean((bool)this._csrfAlwaysCheck) : null, "csrfAlwaysCheck" ,container.Add );
