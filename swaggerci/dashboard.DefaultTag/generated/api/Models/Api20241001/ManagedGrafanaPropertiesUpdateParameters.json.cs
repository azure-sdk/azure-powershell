...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001
{
    ...
    public partial class ManagedGrafanaPropertiesUpdateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.IManagedGrafanaPropertiesUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.IManagedGrafanaPropertiesUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.IManagedGrafanaPropertiesUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode node)
        {
        ...
        internal ManagedGrafanaPropertiesUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject json)
        {
            ...
            {_grafanaIntegration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject>("grafanaIntegrations"), out var __jsonGrafanaIntegrations) ? Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.GrafanaIntegrations.FromJson(__jsonGrafanaIntegrations) : GrafanaIntegration;}
            {_enterpriseConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject>("enterpriseConfigurations"), out var __jsonEnterpriseConfigurations) ? Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.EnterpriseConfigurations.FromJson(__jsonEnterpriseConfigurations) : EnterpriseConfiguration;}
            {_grafanaConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject>("grafanaConfigurations"), out var __jsonGrafanaConfigurations) ? Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.GrafanaConfigurations.FromJson(__jsonGrafanaConfigurations) : GrafanaConfiguration;}
            ...
            {_grafanaPlugin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject>("grafanaPlugins"), out var __jsonGrafanaPlugins) ? Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241001.ManagedGrafanaPropertiesUpdateParametersGrafanaPlugins.FromJson(__jsonGrafanaPlugins) : GrafanaPlugin;}
            {_grafanaMajorVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonString>("grafanaMajorVersion"), out var __jsonGrafanaMajorVersion) ? (string)__jsonGrafanaMajorVersion : (string)GrafanaMajorVersion;}
            AfterFromJson(json);
        }
