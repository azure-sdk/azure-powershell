...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview
{
    ...
    public partial class MarketplaceTrialQuota
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IMarketplaceTrialQuota.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IMarketplaceTrialQuota.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IMarketplaceTrialQuota FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode node)
        {
        ...
        internal MarketplaceTrialQuota(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject json)
        {
            ...
            {_availablePromotion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonString>("availablePromotion"), out var __jsonAvailablePromotion) ? (string)__jsonAvailablePromotion : (string)AvailablePromotion;}
            {_grafanaResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonString>("grafanaResourceId"), out var __jsonGrafanaResourceId) ? (string)__jsonGrafanaResourceId : (string)GrafanaResourceId;}
            {_trialStartAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonString>("trialStartAt"), out var __jsonTrialStartAt) ? global::System.DateTime.TryParse((string)__jsonTrialStartAt, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTrialStartAtValue) ? __jsonTrialStartAtValue : TrialStartAt : TrialStartAt;}
            {_trialEndAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonString>("trialEndAt"), out var __jsonTrialEndAt) ? global::System.DateTime.TryParse((string)__jsonTrialEndAt, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTrialEndAtValue) ? __jsonTrialEndAtValue : TrialEndAt : TrialEndAt;}
            AfterFromJson(json);
        }
