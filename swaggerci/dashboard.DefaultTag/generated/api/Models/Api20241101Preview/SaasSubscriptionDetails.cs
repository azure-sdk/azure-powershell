...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview
{
    ...
    public partial class SaasSubscriptionDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISaasSubscriptionDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISaasSubscriptionDetailsInternal
    {

        /// <summary>Internal Acessors for Term</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTerm Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISaasSubscriptionDetailsInternal.Term { get => (this._term = this._term ?? new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.SubscriptionTerm()); set { {_term = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTerm _term;

        /// <summary>The billing term of the SaaS Subscription.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Origin(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTerm Term { get => (this._term = this._term ?? new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.SubscriptionTerm()); set => this._term = value; }
        ...
        public global::System.DateTime? TermEndDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTermInternal)Term).EndDate; set => ((Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTermInternal)Term).EndDate = value ?? default(global::System.DateTime); }

        /// <summary>The date and time in UTC of when the billing term starts.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Origin(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.PropertyOrigin.Inlined)]
        public global::System.DateTime? TermStartDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTermInternal)Term).StartDate; set => ((Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTermInternal)Term).StartDate = value ?? default(global::System.DateTime); }

        /// <summary>The unit of the billing term.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Origin(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.PropertyOrigin.Inlined)]
        public string TermUnit { get => ((Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTermInternal)Term).TermUnit; set => ((Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTermInternal)Term).TermUnit = value ?? null; }
...

    {
        ...
        string PublisherId { get; set; }
        /// <summary>The billing term of the SaaS Subscription.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ISubscriptionTerm Term { get; set; }
        /// <summary>The date and time in UTC of when the billing term ends.</summary>
        global::System.DateTime? TermEndDate { get; set; }
        /// <summary>The date and time in UTC of when the billing term starts.</summary>
        global::System.DateTime? TermStartDate { get; set; }
