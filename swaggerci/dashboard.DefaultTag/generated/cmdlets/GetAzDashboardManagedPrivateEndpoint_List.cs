...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}/managedPrivateEndpoints"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDashboardManagedPrivateEndpoint_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Description(@"List all managed private endpoints of a grafana resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}/managedPrivateEndpoints", ApiVersion = "2023-10-01-preview")]
    public partial class GetAzDashboardManagedPrivateEndpoint_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IManagedPrivateEndpointModelListResponse">Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IManagedPrivateEndpointModelListResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IManagedPrivateEndpointModelListResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDashboardManagedPrivateEndpoint_List" /> cmdlet class.
        /// </summary>
        public GetAzDashboardManagedPrivateEndpoint_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ManagedPrivateEndpointsList(SubscriptionId, ResourceGroupName, WorkspaceName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20231001Preview.IManagedPrivateEndpointModelListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ManagedPrivateEndpointsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
