...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets
{
    ...
    /// <summary>
    /// Create or update a dashboard for grafana resource. This API is idempotent, so user can either create a new dashboard or
    /// update an existing dashboard.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/dashboards/{dashboardName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDashboardManagedDashboard_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Description(@"Create or update a dashboard for grafana resource. This API is idempotent, so user can either create a new dashboard or update an existing dashboard.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/dashboards/{dashboardName}", ApiVersion = "2024-11-01-preview")]
    public partial class NewAzDashboardManagedDashboard_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard _requestBodyParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.ManagedDashboard();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Azure Managed Dashboard.")]
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api30.ITrackedResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api30.ITrackedResourceTags Tag { get => _requestBodyParametersBody.Tag ?? null /* object */; set => _requestBodyParametersBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard">Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzDashboardManagedDashboard_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets.NewAzDashboardManagedDashboard_CreateExpanded Clone()
        {
            var clone = new NewAzDashboardManagedDashboard_CreateExpanded();
            ...
            clone.DashboardName = this.DashboardName;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDashboardManagedDashboard_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDashboardManagedDashboard_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedDashboardsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ManagedDashboardsCreate(SubscriptionId, ResourceGroupName, DashboardName, _requestBodyParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,DashboardName=DashboardName,body=_requestBodyParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, DashboardName=DashboardName, body=_requestBodyParametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard
