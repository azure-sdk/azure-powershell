...
.Link
https://learn.microsoft.com/powershell/module/az.dashboard/update-azdashboardmanageddashboard
#>
function Update-AzDashboardManagedDashboard {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboard])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedDashboardUpdateParametersTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Dashboard.private\Update-AzDashboardManagedDashboard_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.Dashboard.private\Update-AzDashboardManagedDashboard_UpdateViaIdentityExpanded';
        }
