...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IPrivateEndpointConnection
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedPrivateEndpointModel])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IPrivateEndpointConnection])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Alias('PrivateEndpointConnectionName')]
...
INPUTOBJECT <IDashboardIdentity>: Identity Parameter
  ...
  [WorkspaceName <String>]: The workspace name of Azure Managed Grafana.
.Link
https://learn.microsoft.com/powershell/module/az.dashboard/get-azdashboard
#>
function Get-AzDashboard {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Dashboard.private\Get-AzDashboard_Get';
            GetViaIdentity = 'Az.Dashboard.private\Get-AzDashboard_GetViaIdentity';
            List = 'Az.Dashboard.private\Get-AzDashboard_List';
            List1 = 'Az.Dashboard.private\Get-AzDashboard_List1';
        }
        if (('Get', 'List', 'List1') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
[OutputType([System.Boolean], [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedPrivateEndpointModel])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IManagedPrivateEndpointUpdateParametersTags]))]
    [System.Collections.Hashtable]
