...
.Link
https://learn.microsoft.com/powershell/module/az.dashboard/remove-azdashboardmanageddashboard
#>
function Remove-AzDashboardManagedDashboard {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Dashboard.private\Remove-AzDashboardManagedDashboard_Delete';
            DeleteViaIdentity = 'Az.Dashboard.private\Remove-AzDashboardManagedDashboard_DeleteViaIdentity';
        }
