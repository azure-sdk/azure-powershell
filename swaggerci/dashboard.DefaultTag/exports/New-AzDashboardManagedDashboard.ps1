...
.Link
https://learn.microsoft.com/powershell/module/az.dashboard/new-azdashboardmanageddashboard
#>
function New-AzDashboardManagedDashboard {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Dashboard.private\New-AzDashboardManagedDashboard_CreateExpanded';
        }
