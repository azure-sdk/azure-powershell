...
online version: https://learn.microsoft.com/powershell/module/az.dashboard/new-azdashboardmanagedprivateendpoint
schema: 2.0.0
---

# New-AzDashboardManagedPrivateEndpoint
...
```
New-AzDashboardManagedPrivateEndpoint -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
