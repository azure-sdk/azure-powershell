...
Update-AzDashboardGrafana -ResourceGroupName <String> -WorkspaceName <String> [-SubscriptionId <String>]
 ...
 [-UnifiedAlertingScreenshotCaptureEnabled] [-UserEditorsCanAdmin] [-UserViewersCanEdit]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20241101Preview.IAzureMonitorWorkspaceIntegration[]
Parameter Sets: (All)
Aliases:
