...
online version: https://learn.microsoft.com/powershell/module/az.dashboard/update-azdashboardintegrationfabric
schema: 2.0.0
---

# Update-AzDashboardIntegrationFabric
...
```
Update-AzDashboardIntegrationFabric -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
```
Update-AzDashboardIntegrationFabric -InputObject <IDashboardIdentity> [-Scenario <String[]>]
