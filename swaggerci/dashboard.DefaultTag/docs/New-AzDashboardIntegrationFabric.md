...
online version: https://learn.microsoft.com/powershell/module/az.dashboard/new-azdashboardintegrationfabric
schema: 2.0.0
---

# New-AzDashboardIntegrationFabric
...
```
New-AzDashboardIntegrationFabric -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
