...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzPrivateDnsRecordSet_Delete", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}", ApiVersion = "2020-06-01")]
    public partial class RemoveAzPrivateDnsRecordSet_Delete : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// The type of DNS record in this record set. Record sets of type SOA cannot be deleted (they are deleted when the Private
        /// DNS zone is deleted).
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The type of DNS record in this record set. Record sets of type SOA cannot be deleted (they are deleted when the Private DNS zone is deleted).")]
        [Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RecordSetsDelete(ResourceGroupName, PrivateZoneName, RecordType, RelativeRecordSetName, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, SubscriptionId, onOk, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPrivateDnsRecordSet_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzPrivateDnsRecordSet_Delete()
        {
