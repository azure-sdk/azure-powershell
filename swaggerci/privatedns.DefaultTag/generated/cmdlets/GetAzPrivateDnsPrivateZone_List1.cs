...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPrivateDnsPrivateZone_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Description(@"Lists the Private DNS zones within a resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones", ApiVersion = "2020-06-01")]
    public partial class GetAzPrivateDnsPrivateZone_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The maximum number of record sets to return. If not specified, returns up to 100 record sets.")]
        [Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.ParameterCategory.Query)]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IPrivateZoneListResult">Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IPrivateZoneListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IPrivateZoneListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPrivateDnsPrivateZone_List1" /> cmdlet class.
        /// </summary>
        public GetAzPrivateDnsPrivateZone_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PrivateZonesListByResourceGroup(ResourceGroupName, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Top=this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), SubscriptionId=SubscriptionId })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Models.Api20200601.IPrivateZoneListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.PrivateZonesListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
