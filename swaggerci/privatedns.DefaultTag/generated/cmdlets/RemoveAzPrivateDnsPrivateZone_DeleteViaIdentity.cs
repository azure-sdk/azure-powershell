...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzPrivateDnsPrivateZone_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Description(@"Deletes a Private DNS zone. WARNING: All DNS records in the zone will also be deleted. This operation cannot be undone. Private DNS zone cannot be deleted unless all virtual network links to it are removed.")]
    ...
    public partial class RemoveAzPrivateDnsPrivateZone_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// The ETag of the Private DNS zone. Omit this value to always delete the current zone. Specify the last-seen ETag value
        /// to prevent accidentally deleting any concurrent changes.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ETag of the Private DNS zone. Omit this value to always delete the current zone. Specify the last-seen ETag value to prevent accidentally deleting any concurrent changes.")]
        ...
        /// <returns>a duplicate instance of RemoveAzPrivateDnsPrivateZone_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PrivateDns.Cmdlets.RemoveAzPrivateDnsPrivateZone_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzPrivateDnsPrivateZone_DeleteViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PrivateZonesDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PrivateZonesDeleteViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PrivateZonesDelete(InputObject.ResourceGroupName ?? null, InputObject.PrivateZoneName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPrivateDnsPrivateZone_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzPrivateDnsPrivateZone_DeleteViaIdentity()
        {
