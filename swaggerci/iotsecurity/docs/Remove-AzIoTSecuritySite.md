...
online version: https://docs.microsoft.com/en-us/powershell/module/az.iotsecurity/remove-aziotsecuritysite
schema: 2.0.0
---

# Remove-AzIoTSecuritySite
...
### Delete (Default)
```
Remove-AzIoTSecuritySite -Scope <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzIoTSecuritySite -InputObject <IIoTSecurityIdentity> [-DefaultProfile <PSObject>] [-PassThru]
