...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DebugSend=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName}/debugsend"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Debug, @"AzNotificationHubsNotificationHubSend_DebugExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IDebugSendResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Description(@"test send a push notification")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Generated]
    public partial class DebugAzNotificationHubsNotificationHubSend_DebugExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.IAny _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Any();

        /// <summary>Any object</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.IAny ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IDebugSendResponse"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IDebugSendResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="DebugAzNotificationHubsNotificationHubSend_DebugExpanded" /> cmdlet class.
        /// </summary>
        public DebugAzNotificationHubsNotificationHubSend_DebugExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NotificationHubsDebugSend' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NotificationHubsDebugSend(ResourceGroupName, NamespaceName, NotificationHubName, SubscriptionId, ParametersBody, onCreated, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NamespaceName=NamespaceName,NotificationHubName=NotificationHubName,SubscriptionId=SubscriptionId,body=ParametersBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IDebugSendResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.IDebugSendResponse
