...
namespace Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzNotificationHubsNotificationHub_List")]
    ...
    public partial class GetAzNotificationHubsNotificationHub_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubListResult"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzNotificationHubsNotificationHub_List" /> cmdlet class.
        /// </summary>
        public GetAzNotificationHubsNotificationHub_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NotificationHubsList(ResourceGroupName, NamespaceName, SubscriptionId, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Models.Api20170401.INotificationHubListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        ...
                        {
                            requestMessage = requestMessage.Clone(new global::System.Uri( _nextLink ),Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Method.Get );
                            await ((Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.NotificationHubs.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                            await this.Client.NotificationHubsList_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
