        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NamespacesRegenerateKeysViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NamespacesRegenerateKeys(InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.AuthorizationRuleName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
