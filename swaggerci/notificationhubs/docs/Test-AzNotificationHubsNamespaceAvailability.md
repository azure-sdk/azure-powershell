...
online version: https://docs.microsoft.com/en-us/powershell/module/az.notificationhubs/test-aznotificationhubsnamespaceavailability
schema: 2.0.0
---

# Test-AzNotificationHubsNamespaceAvailability
...
```
Test-AzNotificationHubsNamespaceAvailability -Name <String> [-SubscriptionId <String>] [-IsAvailiable]
...
### Check
```
Test-AzNotificationHubsNamespaceAvailability -Parameter <ICheckAvailabilityParameters>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzNotificationHubsNamespaceAvailability -InputObject <INotificationHubsIdentity>
...
```
Test-AzNotificationHubsNamespaceAvailability -InputObject <INotificationHubsIdentity> -Name <String>
