...
### Delete (Default)
```
Remove-AzNotificationHubsNamespace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNotificationHubsNamespace -InputObject <INotificationHubsIdentity> [-DefaultProfile <PSObject>]
