...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datalakeanalyticsaccount/remove-azdatalakeanalyticsaccountstorageaccount
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDataLakeAnalyticsAccountStorageAccount -AccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzDataLakeAnalyticsAccountStorageAccount -InputObject <IDataLakeAnalyticsAccountIdentity>
