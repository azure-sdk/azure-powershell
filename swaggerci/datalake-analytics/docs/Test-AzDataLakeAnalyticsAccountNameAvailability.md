...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datalakeanalyticsaccount/test-azdatalakeanalyticsaccountnameavailability
schema: 2.0.0
---

# Test-AzDataLakeAnalyticsAccountNameAvailability
...
```
Test-AzDataLakeAnalyticsAccountNameAvailability -Location <String> -Name <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Check
```
Test-AzDataLakeAnalyticsAccountNameAvailability -Location <String>
 -Parameter <ICheckNameAvailabilityParameters> [-SubscriptionId <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzDataLakeAnalyticsAccountNameAvailability -InputObject <IDataLakeAnalyticsAccountIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataLakeAnalyticsAccount.Models.Api20191101Preview.ICheckNameAvailabilityParameters
