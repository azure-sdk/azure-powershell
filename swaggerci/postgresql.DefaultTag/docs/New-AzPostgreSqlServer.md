...
New-AzPostgreSqlServer -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-ClusterGroupName <String>] [-ClusterParameterDescription <String>] [-ClusterParameterValue <String>]
 [-ClusterSize <Int32>] [-CreateMode <CreateMode>] [-CustomerResourceId <String>]
 ...
 [-FullyQualifiedClusterGroupReadOnlyDomainName <String>]
 [-FullyQualifiedClusterGroupReadWriteDomainName <String>] [-HighAvailabilityMode <HighAvailabilityMode>]
 ...
 [-PointInTimeUtc <DateTime>] [-PropertiesClusterPropertiesType <String>]
 ...
 [-SkuTier <SkuTier>] [-SourceClusterLocation <String>] [-SourceServerResourceId <String>]
