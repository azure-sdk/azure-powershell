...
New-AzPostgreSqlServer -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-CreateMode <CreateMode>] [-DataEncryptionGeoBackupDelegatedIdentityClientId <String>]
 ...
 [-PointInTimeUtc <DateTime>] [-ReplicaPromoteMode <ReadReplicaPromoteMode>]
 ...
 [-SourceServerResourceId <String>] [-StorageAutoGrow <StorageAutoGrow>] [-StorageIop <Int32>]
 [-StorageSizeGb <Int32>] [-StorageThroughput <Int32>] [-StorageTier <AzureManagedDiskPerformanceTiers>]
 [-StorageType <StorageType>] [-Tag <Hashtable>] [-Version <ServerVersion>] [-DefaultProfile <PSObject>]
