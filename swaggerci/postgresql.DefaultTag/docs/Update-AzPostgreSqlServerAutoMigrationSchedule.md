...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlserver/update-azpostgresqlserverautomigrationschedule
schema: 2.0.0
---

# Update-AzPostgreSqlServerAutoMigrationSchedule
...
```
Update-AzPostgreSqlServerAutoMigrationSchedule -LocationName <String> [-SubscriptionId <String>]
...
```
Update-AzPostgreSqlServerAutoMigrationSchedule -InputObject <IPostgreSqlServerIdentity>
 [-AutoMigrationEndTimeInUtc <DateTime>] [-AutoMigrationScheduleCreateTimeInUtc <DateTime>]
 [-AutoMigrationStartTimeInUtc <DateTime>] [-MigrationName <String>] [-ScheduleId <String>]
 [-ScheduleState <ScheduleState>] [-SourceDbServerResourceId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
