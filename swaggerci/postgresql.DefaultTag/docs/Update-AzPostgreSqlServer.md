...
Update-AzPostgreSqlServer -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-DataEncryptionGeoBackupDelegatedIdentityClientId <String>]
 ...
 [-DataEncryptionPrimaryDelegatedIdentityClientId <String>]
 ...
 [-IdentityDelegatedResource <Hashtable>] [-IdentityPrincipalId <String>] [-IdentityType <IdentityType>]
 ...
 [-NetworkPrivateDnsZoneArmResourceId <String>] [-NetworkPublicNetworkAccess <ServerPublicNetworkAccessState>]
 ...
 [-SkuTier <SkuTier>] [-StorageAutoGrow <StorageAutoGrow>] [-StorageIop <Int32>] [-StorageSizeGb <Int32>]
...
Update-AzPostgreSqlServer -InputObject <IPostgreSqlIdentity> [-AdministratorLogin <String>]
 ...
 [-CreateMode <CreateModeForUpdate>] [-DataEncryptionGeoBackupDelegatedIdentityClientId <String>]
 [-DataEncryptionGeoBackupEncryptionKeyStatus <KeyStatusEnum>] [-DataEncryptionGeoBackupKeyUri <String>]
 [-DataEncryptionGeoBackupUserAssignedIdentityId <String>]
 [-DataEncryptionPrimaryDelegatedIdentityClientId <String>]
 [-DataEncryptionPrimaryEncryptionKeyStatus <KeyStatusEnum>] [-DataEncryptionPrimaryKeyUri <String>]
