...
```
Get-AzPostgreSqlTuningConfigurationSession -ResourceGroupName <String> -ServerName <String>
 -TuningOption <TuningOptionEnum> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
