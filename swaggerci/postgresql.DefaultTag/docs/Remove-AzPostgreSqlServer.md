...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlserver/remove-azpostgresqlserver
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzPostgreSqlServer -InputObject <IPostgreSqlServerIdentity> [-DefaultProfile <PSObject>] [-AsJob]
