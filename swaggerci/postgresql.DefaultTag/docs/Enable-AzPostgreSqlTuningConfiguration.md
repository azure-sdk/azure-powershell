...
### Enable (Default)
```
Enable-AzPostgreSqlTuningConfiguration -ResourceGroupName <String> -ServerName <String>
...
### EnableViaIdentity
```
Enable-AzPostgreSqlTuningConfiguration -InputObject <IPostgreSqlIdentity> [-DefaultProfile <PSObject>]
