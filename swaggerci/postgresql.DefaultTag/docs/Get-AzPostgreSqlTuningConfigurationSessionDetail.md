...
```
Get-AzPostgreSqlTuningConfigurationSessionDetail -ResourceGroupName <String> -ServerName <String>
 -TuningOption <TuningOptionEnum> -SessionId <String> [-SubscriptionId <String[]>]
