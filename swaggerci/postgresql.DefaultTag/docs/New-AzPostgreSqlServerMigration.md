...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlserver/new-azpostgresqlservermigration
schema: 2.0.0
---

# New-AzPostgreSqlServerMigration
...
```
New-AzPostgreSqlServerMigration -Name <String> -ResourceGroupName <String> -TargetDbServerName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.MigrationOption
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.SourceType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.SslMode
Parameter Sets: (All)
Aliases:
