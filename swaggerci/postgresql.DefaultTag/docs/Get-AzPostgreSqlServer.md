...
online version: https://learn.microsoft.com/powershell/module/az.postgresqlserver/get-azpostgresqlserver
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzPostgreSqlServer -InputObject <IPostgreSqlServerIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
