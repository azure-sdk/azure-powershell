...
### Disable (Default)
```
Disable-AzPostgreSqlTuningConfiguration -ResourceGroupName <String> -ServerName <String>
 -TuningOption <TuningOptionEnum> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-AzPostgreSqlTuningConfiguration -InputObject <IPostgreSqlIdentity> [-DefaultProfile <PSObject>]
