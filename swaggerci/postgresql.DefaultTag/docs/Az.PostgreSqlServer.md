...
Module Guid: fa22f9e7-32a2-4788-84ab-7d482ace0b36
...
### [Get-AzPostgreSqlServerGetAutoMigrationFreeSlot](Get-AzPostgreSqlServerGetAutoMigrationFreeSlot.md)
This method gets the available slots for auto migration for a given single server resource id

### [Get-AzPostgreSqlServerLatestAutoMigrationSchedule](Get-AzPostgreSqlServerLatestAutoMigrationSchedule.md)
...
### [Get-AzPostgreSqlServerLtrBackupOperation](Get-AzPostgreSqlServerLtrBackupOperation.md)
...
### [Invoke-AzPostgreSqlServerExecuteGetPrivateDnsZoneSuffix](Invoke-AzPostgreSqlServerExecuteGetPrivateDnsZoneSuffix.md)
...
### [Remove-AzPostgreSqlServerBackup](Remove-AzPostgreSqlServerBackup.md)
...
### [Update-AzPostgreSqlServerAutoMigrationSchedule](Update-AzPostgreSqlServerAutoMigrationSchedule.md)
This method updates the auto migration schedule for a given single server resource id

### [Update-AzPostgreSqlServerConfiguration](Update-AzPostgreSqlServerConfiguration.md)
