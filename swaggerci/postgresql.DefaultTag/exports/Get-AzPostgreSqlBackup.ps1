...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IServerBackup
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IServerBackup])]
