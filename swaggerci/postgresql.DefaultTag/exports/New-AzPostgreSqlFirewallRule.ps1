...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFirewallRule
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFirewallRule])]
