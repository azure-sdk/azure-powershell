...
.Link
https://learn.microsoft.com/powershell/module/az.postgresql/get-azpostgresqllatestautomigrationschedule
#>
function Get-AzPostgreSqlLatestAutoMigrationSchedule {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAutoMigrationScheduleResource])]
...
param(
    ...
    [Parameter(ParameterSetName='GetExpanded')]
    [Parameter(ParameterSetName='GetViaIdentityExpanded')]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ScheduleState])]
    [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ScheduleState]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.PostgreSql.private\Get-AzPostgreSqlLatestAutoMigrationSchedule_Get';
            GetExpanded = 'Az.PostgreSql.private\Get-AzPostgreSqlLatestAutoMigrationSchedule_GetExpanded';
            GetViaIdentity = 'Az.PostgreSql.private\Get-AzPostgreSqlLatestAutoMigrationSchedule_GetViaIdentity';
            GetViaIdentityExpanded = 'Az.PostgreSql.private\Get-AzPostgreSqlLatestAutoMigrationSchedule_GetViaIdentityExpanded';
        }
