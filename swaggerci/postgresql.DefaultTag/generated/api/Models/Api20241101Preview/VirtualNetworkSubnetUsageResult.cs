...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview
{
    ...
    public partial class VirtualNetworkSubnetUsageResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IVirtualNetworkSubnetUsageResultInternal
    {

        /// <summary>Backing field for <see cref="DelegatedSubnetsUsage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IDelegatedSubnetUsage[] _delegatedSubnetsUsage;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IDelegatedSubnetUsage[] DelegatedSubnetsUsage { get => this._delegatedSubnetsUsage; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IDelegatedSubnetUsage[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IVirtualNetworkSubnetUsageResultInternal.DelegatedSubnetsUsage { get => this._delegatedSubnetsUsage; set { {_delegatedSubnetsUsage = value;} } }

        /// <summary>Internal Acessors for Location</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IVirtualNetworkSubnetUsageResultInternal.Location { get => this._location; set { {_location = value;} } }

        /// <summary>Internal Acessors for SubscriptionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IVirtualNetworkSubnetUsageResultInternal.SubscriptionId { get => this._subscriptionId; set { {_subscriptionId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IDelegatedSubnetUsage) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IDelegatedSubnetUsage[] DelegatedSubnetsUsage { get;  }
        /// <summary>location of the delegated subnet usage</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.IDelegatedSubnetUsage[] DelegatedSubnetsUsage { get; set; }
        /// <summary>location of the delegated subnet usage</summary>
