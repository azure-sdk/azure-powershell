...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview
{
    ...
    public partial class LtrBackupOperationResponseProperties :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.ILtrBackupOperationResponseProperties,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.ILtrBackupOperationResponsePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.ILtrBackupOperationResponsePropertiesInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20241101Preview.ILtrBackupOperationResponsePropertiesInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ExecutionStatus _status;

        /// <summary>Service-set extensible enum indicating the status of operation</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ExecutionStatus Status { get => this._status; set => this._status = value; }
