...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview
{
    ...
    public partial class StorageMbCapability :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapability,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.DefaultIopsTier { get => this._defaultIopsTier; set { {_defaultIopsTier = value;} } }

        /// <summary>Internal Acessors for MaximumStorageSizeMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.MaximumStorageSizeMb { get => this._maximumStorageSizeMb; set { {_maximumStorageSizeMb = value;} } }

        /// <summary>Internal Acessors for StorageSizeMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.StorageSizeMb { get => this._storageSizeMb; set { {_storageSizeMb = value;} } }

        /// <summary>Internal Acessors for SupportedIop</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.SupportedIop { get => this._supportedIop; set { {_supportedIop = value;} } }

        /// <summary>Internal Acessors for SupportedIopsTier</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageTierCapability[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.SupportedIopsTier { get => this._supportedIopsTier; set { {_supportedIopsTier = value;} } }

        /// <summary>Internal Acessors for SupportedMaximumIop</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.SupportedMaximumIop { get => this._supportedMaximumIop; set { {_supportedMaximumIop = value;} } }

        /// <summary>Internal Acessors for SupportedMaximumThroughput</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.SupportedMaximumThroughput { get => this._supportedMaximumThroughput; set { {_supportedMaximumThroughput = value;} } }

        /// <summary>Internal Acessors for SupportedThroughput</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageMbCapabilityInternal.SupportedThroughput { get => this._supportedThroughput; set { {_supportedThroughput = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageTierCapability[] _supportedIopsTier;

        /// <summary>List of available options to upgrade the storage performance</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageTierCapability[] SupportedIopsTier { get => this._supportedIopsTier; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBase
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageTierCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageTierCapability[] SupportedIopsTier { get;  }
        /// <summary>Maximum IOPS supported by this #Vcores or PremiumV2_LRS Storage Size</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBaseInternal
    {
        ...
        /// <summary>List of available options to upgrade the storage performance</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IStorageTierCapability[] SupportedIopsTier { get; set; }
        /// <summary>Maximum IOPS supported by this #Vcores or PremiumV2_LRS Storage Size</summary>
