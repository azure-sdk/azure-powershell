...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview
{
    ...
    public partial class FlexibleServerEditionCapability :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IFlexibleServerEditionCapability,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IFlexibleServerEditionCapabilityInternal.DefaultSkuName { get => this._defaultSkuName; set { {_defaultSkuName = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IFlexibleServerEditionCapabilityInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedServerSku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IServerSkuCapability[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IFlexibleServerEditionCapabilityInternal.SupportedServerSku { get => this._supportedServerSku; set { {_supportedServerSku = value;} } }

        /// <summary>Internal Acessors for SupportedStorageEdition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IStorageEditionCapability[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IFlexibleServerEditionCapabilityInternal.SupportedStorageEdition { get => this._supportedStorageEdition; set { {_supportedStorageEdition = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IServerSkuCapability[] _supportedServerSku;

        /// <summary>List of supported server SKUs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IServerSkuCapability[] SupportedServerSku { get => this._supportedServerSku; }

        /// <summary>Backing field for <see cref="SupportedStorageEdition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IStorageEditionCapability[] _supportedStorageEdition;

        /// <summary>The list of editions supported by this server edition.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IStorageEditionCapability[] SupportedStorageEdition { get => this._supportedStorageEdition; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBase
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IServerSkuCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IServerSkuCapability[] SupportedServerSku { get;  }
        /// <summary>The list of editions supported by this server edition.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IStorageEditionCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IStorageEditionCapability[] SupportedStorageEdition { get;  }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBaseInternal
    {
        ...
        string Name { get; set; }
        /// <summary>List of supported server SKUs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IServerSkuCapability[] SupportedServerSku { get; set; }
        /// <summary>The list of editions supported by this server edition.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20230601Preview.IStorageEditionCapability[] SupportedStorageEdition { get; set; }
