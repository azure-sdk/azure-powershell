...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview
{
    ...
    public partial class ServerTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Server" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IServer ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IServer).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
