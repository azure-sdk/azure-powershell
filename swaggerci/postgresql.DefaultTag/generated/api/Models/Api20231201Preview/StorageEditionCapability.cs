...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview
{
    ...
    public partial class StorageEditionCapability :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageEditionCapability,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageEditionCapabilityInternal,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IValidates
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageEditionCapabilityInternal.DefaultStorageSizeMb { get => this._defaultStorageSizeMb; set { {_defaultStorageSizeMb = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageEditionCapabilityInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedStorageMb</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageMbCapability[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageEditionCapabilityInternal.SupportedStorageMb { get => this._supportedStorageMb; set { {_supportedStorageMb = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageMbCapability[] _supportedStorageMb;

        /// <summary>Flexible server supported storage range in MB</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageMbCapability[] SupportedStorageMb { get => this._supportedStorageMb; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBase
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageMbCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageMbCapability[] SupportedStorageMb { get;  }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBaseInternal
    {
        ...
        string Name { get; set; }
        /// <summary>Flexible server supported storage range in MB</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IStorageMbCapability[] SupportedStorageMb { get; set; }
