...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview
{
    ...
    public partial class MigrationSecretParameters :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IMigrationSecretParameters,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IMigrationSecretParametersInternal
    {

        /// <summary>Backing field for <see cref="AdminCredentials" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IAdminCredentials _adminCredentials;

        /// <summary>Admin credentials for source and target servers</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IAdminCredentials AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.AdminCredentials()); set => this._adminCredentials = value; }
    ...
    {
        /// <summary>Admin credentials for source and target servers</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IAdminCredentials AdminCredentials { get; set; }
        /// <summary>Password for source server.</summary>
        string AdminCredentialsSourceServerPassword { get; set; }
        /// <summary>Password for target server.</summary>
        string AdminCredentialsTargetServerPassword { get; set; }
