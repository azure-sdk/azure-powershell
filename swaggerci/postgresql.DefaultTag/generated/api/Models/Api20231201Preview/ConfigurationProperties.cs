...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview
{
    ...
    public partial class ConfigurationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.AllowedValue { get => this._allowedValue; set { {_allowedValue = value;} } }

        /// <summary>Internal Acessors for DataType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ConfigurationDataType? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.DataType { get => this._dataType; set { {_dataType = value;} } }

        /// <summary>Internal Acessors for DefaultValue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.DefaultValue { get => this._defaultValue; set { {_defaultValue = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for DocumentationLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.DocumentationLink { get => this._documentationLink; set { {_documentationLink = value;} } }

        /// <summary>Internal Acessors for IsConfigPendingRestart</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.IsConfigPendingRestart { get => this._isConfigPendingRestart; set { {_isConfigPendingRestart = value;} } }

        /// <summary>Internal Acessors for IsDynamicConfig</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.IsDynamicConfig { get => this._isDynamicConfig; set { {_isDynamicConfig = value;} } }

        /// <summary>Internal Acessors for IsReadOnly</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.IsReadOnly { get => this._isReadOnly; set { {_isReadOnly = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IConfigurationPropertiesInternal.Unit { get => this._unit; set { {_unit = value;} } }
