...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview
{
    ...
    public partial class ServerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IServerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IServerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IServerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonNode node)
        {
        ...
        internal ServerProperties(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject json)
        {
            ...
            {_storage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("storage"), out var __jsonStorage) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.Storage.FromJson(__jsonStorage) : Storage;}
            {_authConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("authConfig"), out var __jsonAuthConfig) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.AuthConfig.FromJson(__jsonAuthConfig) : AuthConfig;}
            {_dataEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("dataEncryption"), out var __jsonDataEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.DataEncryption.FromJson(__jsonDataEncryption) : DataEncryption;}
            {_backup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("backup"), out var __jsonBackup) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.Backup.FromJson(__jsonBackup) : Backup;}
            {_network = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("network"), out var __jsonNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.Network.FromJson(__jsonNetwork) : Network;}
            {_highAvailability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("highAvailability"), out var __jsonHighAvailability) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.HighAvailability.FromJson(__jsonHighAvailability) : HighAvailability;}
            {_maintenanceWindow = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("maintenanceWindow"), out var __jsonMaintenanceWindow) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.MaintenanceWindow.FromJson(__jsonMaintenanceWindow) : MaintenanceWindow;}
            {_replica = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Json.JsonObject>("replica"), out var __jsonReplica) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.Replica.FromJson(__jsonReplica) : Replica;}
