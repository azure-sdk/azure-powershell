...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview
{
    ...
    public partial class Replica :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IReplica,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IReplicaInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IReplicaInternal.Capacity { get => this._capacity; set { {_capacity = value;} } }

        /// <summary>Internal Acessors for TionState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationState? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20231201Preview.IReplicaInternal.TionState { get => this._tionState; set { {_tionState = value;} } }

        /// <summary>Backing field for <see cref="PromoteMode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReadReplicaPromoteMode? _promoteMode;

        /// <summary>Sets the promote mode for a replica server. This is a write only property.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReadReplicaPromoteMode? PromoteMode { get => this._promoteMode; set => this._promoteMode = value; }

        /// <summary>Backing field for <see cref="PromoteOption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationPromoteOption? _promoteOption;

        /// <summary>Sets the promote options for a replica server. This is a write only property.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationPromoteOption? PromoteOption { get => this._promoteOption; set => this._promoteOption = value; }

        /// <summary>Backing field for <see cref="Role" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole? _role;

        /// <summary>Used to indicate role of the server in replication set.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole? Role { get => this._role; set => this._role = value; }

        /// <summary>Backing field for <see cref="TionState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationState? _tionState;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationState? TionState { get => this._tionState; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReadReplicaPromoteMode? PromoteMode { get; set; }
        /// <summary>Sets the promote options for a replica server. This is a write only property.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationPromoteOption? PromoteOption { get; set; }
        /// <summary>Used to indicate role of the server in replication set.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole? Role { get; set; }
        /// <summary>
        /// Gets the replication state of a replica server. This property is returned only for replicas api call. Supported values
        /// are Active, Catchup, Provisioning, Updating, Broken, Reconfiguring
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationState? TionState { get;  }
...

    {
        ...
        /// are Active, Catchup, Provisioning, Updating, Broken, Reconfiguring
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationState? TionState { get; set; }
