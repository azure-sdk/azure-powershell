...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview
{
    ...
    public partial class MigrationSecretParameters :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IMigrationSecretParameters,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IMigrationSecretParametersInternal
    {

        /// <summary>Backing field for <see cref="AdminCredentials" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentials _adminCredentials;

        /// <summary>Admin credentials for source and target servers</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentials AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.AdminCredentials()); set => this._adminCredentials = value; }
        ...
        public string AdminCredentialsSourceServerPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentialsInternal)AdminCredentials).SourceServerPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentialsInternal)AdminCredentials).SourceServerPassword = value ; }

        /// <summary>Password for target server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Inlined)]
        public string AdminCredentialsTargetServerPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentialsInternal)AdminCredentials).TargetServerPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentialsInternal)AdminCredentials).TargetServerPassword = value ; }

        /// <summary>Internal Acessors for AdminCredentials</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentials Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IMigrationSecretParametersInternal.AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.AdminCredentials()); set { {_adminCredentials = value;} } }
    ...
    {
        /// <summary>Admin credentials for source and target servers</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAdminCredentials AdminCredentials { get; set; }
        /// <summary>Password for source server.</summary>
        string AdminCredentialsSourceServerPassword { get; set; }
        /// <summary>Password for target server.</summary>
        string AdminCredentialsTargetServerPassword { get; set; }
