...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview
{
    ...
    public partial class FastProvisioningEditionCapability :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFastProvisioningEditionCapabilityInternal,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IValidates
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFastProvisioningEditionCapabilityInternal.ServerCount { get => this._serverCount; set { {_serverCount = value;} } }

        /// <summary>Internal Acessors for SupportedServerVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFastProvisioningEditionCapabilityInternal.SupportedServerVersion { get => this._supportedServerVersion; set { {_supportedServerVersion = value;} } }

        /// <summary>Internal Acessors for SupportedSku</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFastProvisioningEditionCapabilityInternal.SupportedSku { get => this._supportedSku; set { {_supportedSku = value;} } }

        /// <summary>Internal Acessors for SupportedStorageGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFastProvisioningEditionCapabilityInternal.SupportedStorageGb { get => this._supportedStorageGb; set { {_supportedStorageGb = value;} } }

        /// <summary>Internal Acessors for SupportedTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFastProvisioningEditionCapabilityInternal.SupportedTier { get => this._supportedTier; set { {_supportedTier = value;} } }
