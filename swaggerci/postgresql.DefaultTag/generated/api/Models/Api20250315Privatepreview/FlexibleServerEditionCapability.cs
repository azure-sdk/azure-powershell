...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview
{
    ...
    public partial class FlexibleServerEditionCapability :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IFlexibleServerEditionCapability,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IFlexibleServerEditionCapabilityInternal.DefaultSkuName { get => this._defaultSkuName; set { {_defaultSkuName = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IFlexibleServerEditionCapabilityInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedServerSku</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IServerSkuCapability[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IFlexibleServerEditionCapabilityInternal.SupportedServerSku { get => this._supportedServerSku; set { {_supportedServerSku = value;} } }

        /// <summary>Internal Acessors for SupportedStorageEdition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IStorageEditionCapability[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IFlexibleServerEditionCapabilityInternal.SupportedStorageEdition { get => this._supportedStorageEdition; set { {_supportedStorageEdition = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IServerSkuCapability[] _supportedServerSku;

        /// <summary>List of supported server SKUs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IServerSkuCapability[] SupportedServerSku { get => this._supportedServerSku; }

        /// <summary>Backing field for <see cref="SupportedStorageEdition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IStorageEditionCapability[] _supportedStorageEdition;

        /// <summary>The list of editions supported by this server edition.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IStorageEditionCapability[] SupportedStorageEdition { get => this._supportedStorageEdition; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBase
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IServerSkuCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IServerSkuCapability[] SupportedServerSku { get;  }
        /// <summary>The list of editions supported by this server edition.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IStorageEditionCapability) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IStorageEditionCapability[] SupportedStorageEdition { get;  }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api10.ICapabilityBaseInternal
    {
        ...
        string Name { get; set; }
        /// <summary>List of supported server SKUs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IServerSkuCapability[] SupportedServerSku { get; set; }
        /// <summary>The list of editions supported by this server edition.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IStorageEditionCapability[] SupportedStorageEdition { get; set; }
