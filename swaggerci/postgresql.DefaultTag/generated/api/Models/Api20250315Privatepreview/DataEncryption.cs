...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview
{
    ...
    public partial class DataEncryption :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IDataEncryption,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IDataEncryptionInternal
    {

        /// <summary>Backing field for <see cref="GeoBackupDelegatedIdentityClientId" /> property.</summary>
        private string _geoBackupDelegatedIdentityClientId;

        /// <summary>
        /// Client Id for the User assigned identity to be used for data encryption for geo-backup of server.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public string GeoBackupDelegatedIdentityClientId { get => this._geoBackupDelegatedIdentityClientId; set => this._geoBackupDelegatedIdentityClientId = value; }

        /// <summary>Backing field for <see cref="GeoBackupEncryptionKeyStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum? _geoBackupEncryptionKeyStatus;

        /// <summary>Geo-backup encryption key status for Data encryption enabled server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum? GeoBackupEncryptionKeyStatus { get => this._geoBackupEncryptionKeyStatus; set => this._geoBackupEncryptionKeyStatus = value; }
        ...
        /// <summary>Backing field for <see cref="PrimaryDelegatedIdentityClientId" /> property.</summary>
        private string _primaryDelegatedIdentityClientId;

        /// <summary>
        /// Client Id for the User assigned identity to be used for data encryption of the primary server.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public string PrimaryDelegatedIdentityClientId { get => this._primaryDelegatedIdentityClientId; set => this._primaryDelegatedIdentityClientId = value; }

        /// <summary>Backing field for <see cref="PrimaryEncryptionKeyStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum? _primaryEncryptionKeyStatus;

        /// <summary>Primary encryption key status for Data encryption enabled server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum? PrimaryEncryptionKeyStatus { get => this._primaryEncryptionKeyStatus; set => this._primaryEncryptionKeyStatus = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IJsonSerializable
    {
        ...
        string GeoBackupDelegatedIdentityClientId { get; set; }
        /// <summary>Geo-backup encryption key status for Data encryption enabled server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum? GeoBackupEncryptionKeyStatus { get; set; }
        /// <summary>URI for the key in keyvault for data encryption for geo-backup of server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        string PrimaryDelegatedIdentityClientId { get; set; }
        /// <summary>Primary encryption key status for Data encryption enabled server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.KeyStatusEnum? PrimaryEncryptionKeyStatus { get; set; }
        /// <summary>URI for the key in keyvault for data encryption of the primary server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
