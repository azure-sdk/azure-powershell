...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api50
{
    ...
    public partial class ProxyResourceTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ProxyResource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api50.IProxyResource ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api50.IProxyResource).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
