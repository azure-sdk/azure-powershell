...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class AuthConfig :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IAuthConfig,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IAuthConfigInternal
    {

        /// <summary>Backing field for <see cref="ActiveDirectoryAuth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ActiveDirectoryAuthEnum? _activeDirectoryAuth;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ActiveDirectoryAuthEnum? ActiveDirectoryAuth { get => this._activeDirectoryAuth; set => this._activeDirectoryAuth = value; }

        /// <summary>Backing field for <see cref="PasswordAuth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.PasswordAuthEnum? _passwordAuth;

        /// <summary>If Enabled, Password authentication is enabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.PasswordAuthEnum? PasswordAuth { get => this._passwordAuth; set => this._passwordAuth = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ActiveDirectoryAuthEnum? ActiveDirectoryAuth { get; set; }
        /// <summary>If Enabled, Password authentication is enabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.PasswordAuthEnum? PasswordAuth { get; set; }
        /// <summary>Tenant id of the server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
