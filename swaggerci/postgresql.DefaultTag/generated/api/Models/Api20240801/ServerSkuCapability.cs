...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801
{
    ...
    public partial class ServerSkuCapability :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapability,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedHaMode</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.HaMode[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal.SupportedHaMode { get => this._supportedHaMode; set { {_supportedHaMode = value;} } }

        /// <summary>Internal Acessors for SupportedIop</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal.SupportedIop { get => this._supportedIop; set { {_supportedIop = value;} } }

        /// <summary>Internal Acessors for SupportedMemoryPerVcoreMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal.SupportedMemoryPerVcoreMb { get => this._supportedMemoryPerVcoreMb; set { {_supportedMemoryPerVcoreMb = value;} } }

        /// <summary>Internal Acessors for SupportedZone</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal.SupportedZone { get => this._supportedZone; set { {_supportedZone = value;} } }

        /// <summary>Internal Acessors for VCore</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IServerSkuCapabilityInternal.VCore { get => this._vCore; set { {_vCore = value;} } }
