...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801
{
    ...
    public partial class MigrationSecretParameters :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IMigrationSecretParameters,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IMigrationSecretParametersInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentials _adminCredentials;

        /// <summary>Admin credentials for source and target servers</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentials AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.AdminCredentials()); set => this._adminCredentials = value; }
        ...
        public string AdminCredentialsSourceServerPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentialsInternal)AdminCredentials).SourceServerPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentialsInternal)AdminCredentials).SourceServerPassword = value ; }

        /// <summary>Password for target server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.PropertyOrigin.Inlined)]
        public string AdminCredentialsTargetServerPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentialsInternal)AdminCredentials).TargetServerPassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentialsInternal)AdminCredentials).TargetServerPassword = value ; }

        /// <summary>Internal Acessors for AdminCredentials</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentials Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IMigrationSecretParametersInternal.AdminCredentials { get => (this._adminCredentials = this._adminCredentials ?? new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.AdminCredentials()); set { {_adminCredentials = value;} } }
    ...
    {
        /// <summary>Admin credentials for source and target servers</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IAdminCredentials AdminCredentials { get; set; }
        /// <summary>Password for source server.</summary>
        string AdminCredentialsSourceServerPassword { get; set; }
        /// <summary>Password for target server.</summary>
        string AdminCredentialsTargetServerPassword { get; set; }
