...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class ConfigurationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.AllowedValue { get => this._allowedValue; set { {_allowedValue = value;} } }

        /// <summary>Internal Acessors for DataType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ConfigurationDataType? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.DataType { get => this._dataType; set { {_dataType = value;} } }

        /// <summary>Internal Acessors for DefaultValue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.DefaultValue { get => this._defaultValue; set { {_defaultValue = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for DocumentationLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.DocumentationLink { get => this._documentationLink; set { {_documentationLink = value;} } }

        /// <summary>Internal Acessors for IsConfigPendingRestart</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.IsConfigPendingRestart { get => this._isConfigPendingRestart; set { {_isConfigPendingRestart = value;} } }

        /// <summary>Internal Acessors for IsDynamicConfig</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.IsDynamicConfig { get => this._isDynamicConfig; set { {_isDynamicConfig = value;} } }

        /// <summary>Internal Acessors for IsReadOnly</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.IsReadOnly { get => this._isReadOnly; set { {_isReadOnly = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IConfigurationPropertiesInternal.Unit { get => this._unit; set { {_unit = value;} } }
