...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class Storage :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IStorage,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IStorageInternal
    {

        /// <summary>Backing field for <see cref="AutoGrow" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.StorageAutoGrow? _autoGrow;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.StorageAutoGrow? AutoGrow { get => this._autoGrow; set => this._autoGrow = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.AzureManagedDiskPerformanceTiers? _tier;

        /// <summary>Name of storage tier for IOPS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.AzureManagedDiskPerformanceTiers? Tier { get => this._tier; set => this._tier = value; }

        /// <summary>Backing field for <see cref="Type" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.StorageType? _type;

        /// <summary>
        /// Storage type for the server. Allowed values are Premium_LRS and PremiumV2_LRS, and default is Premium_LRS if not specified
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.StorageType? Type { get => this._type; set => this._type = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.StorageAutoGrow? AutoGrow { get; set; }
        /// <summary>
        /// Storage tier IOPS quantity. This property is required to be set for storage Type PremiumV2_LRS
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.AzureManagedDiskPerformanceTiers? Tier { get; set; }
        /// <summary>
        /// Storage type for the server. Allowed values are Premium_LRS and PremiumV2_LRS, and default is Premium_LRS if not specified
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.StorageType? Type { get; set; }
