...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class LtrBackupRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILtrBackupRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILtrBackupRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILtrBackupRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonObject json ? new LtrBackupRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonObject into a new instance of <see cref="LtrBackupRequest" />.
        /// </summary>
        ...
        internal LtrBackupRequest(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonObject json)
        {
            ...
            __backupRequestBase = new Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.BackupRequestBase(json);
            {_targetDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonObject>("targetDetails"), out var __jsonTargetDetails) ? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.BackupStoreDetails.FromJson(__jsonTargetDetails) : TargetDetail;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LtrBackupRequest" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LtrBackupRequest" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._targetDetail ? (Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Json.JsonNode) this._targetDetail.ToJson(null,serializationMode) : null, "targetDetails" ,container.Add );
