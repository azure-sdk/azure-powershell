...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class Backup :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IBackup,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IBackupInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.GeoRedundantBackupEnum? _geoRedundantBackup;

        /// <summary>A value indicating whether Geo-Redundant backup is enabled on the server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.GeoRedundantBackupEnum? GeoRedundantBackup { get => this._geoRedundantBackup; set => this._geoRedundantBackup = value; }

        /// <summary>Internal Acessors for EarliestRestoreDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IBackupInternal.EarliestRestoreDate { get => this._earliestRestoreDate; set { {_earliestRestoreDate = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.GeoRedundantBackupEnum? GeoRedundantBackup { get; set; }
        /// <summary>Backup retention days for the server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
