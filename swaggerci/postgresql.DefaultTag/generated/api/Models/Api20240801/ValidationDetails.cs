...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class ValidationDetails :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IValidationDetails,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IValidationDetailsInternal
    {

        /// <summary>Backing field for <see cref="DbLevelValidationDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IDbLevelValidationStatus[] _dbLevelValidationDetail;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IDbLevelValidationStatus[] DbLevelValidationDetail { get => this._dbLevelValidationDetail; set => this._dbLevelValidationDetail = value; }

        /// <summary>Backing field for <see cref="ServerLevelValidationDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IValidationSummaryItem[] _serverLevelValidationDetail;

        /// <summary>Details of server level validations</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IValidationSummaryItem[] ServerLevelValidationDetail { get => this._serverLevelValidationDetail; set => this._serverLevelValidationDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IDbLevelValidationStatus[] DbLevelValidationDetail { get; set; }
        /// <summary>Details of server level validations</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IValidationSummaryItem[] ServerLevelValidationDetail { get; set; }
        /// <summary>Validation status for migration</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.Info(
        Required = false,
        ReadOnly = false,
