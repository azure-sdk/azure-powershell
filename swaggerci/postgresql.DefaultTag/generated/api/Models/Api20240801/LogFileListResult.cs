...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class LogFileListResult :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILogFileListResult,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILogFileListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILogFile[] _value;

        /// <summary>The list of logFiles in a server</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Origin(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILogFile[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILogFile) })]
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.ILogFile[] Value { get; set; }
