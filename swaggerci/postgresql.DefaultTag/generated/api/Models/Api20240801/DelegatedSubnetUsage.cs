...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801
{
    ...
    public partial class DelegatedSubnetUsage :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IDelegatedSubnetUsage,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IDelegatedSubnetUsageInternal
    {

        /// <summary>Internal Acessors for SubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IDelegatedSubnetUsageInternal.SubnetName { get => this._subnetName; set { {_subnetName = value;} } }

        /// <summary>Internal Acessors for Usage</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240801.IDelegatedSubnetUsageInternal.Usage { get => this._usage; set { {_usage = value;} } }
