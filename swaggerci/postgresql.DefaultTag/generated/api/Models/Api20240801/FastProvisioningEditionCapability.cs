...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801
{
    ...
    public partial class FastProvisioningEditionCapability :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapability,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapabilityInternal,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.IValidates
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapabilityInternal.ServerCount { get => this._serverCount; set { {_serverCount = value;} } }

        /// <summary>Internal Acessors for SupportedServerVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapabilityInternal.SupportedServerVersion { get => this._supportedServerVersion; set { {_supportedServerVersion = value;} } }

        /// <summary>Internal Acessors for SupportedSku</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapabilityInternal.SupportedSku { get => this._supportedSku; set { {_supportedSku = value;} } }

        /// <summary>Internal Acessors for SupportedStorageGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapabilityInternal.SupportedStorageGb { get => this._supportedStorageGb; set { {_supportedStorageGb = value;} } }

        /// <summary>Internal Acessors for SupportedTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api20240801.IFastProvisioningEditionCapabilityInternal.SupportedTier { get => this._supportedTier; set { {_supportedTier = value;} } }
