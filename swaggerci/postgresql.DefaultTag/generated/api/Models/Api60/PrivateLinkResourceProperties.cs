...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api60
{
    ...
    public partial class PrivateLinkResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api60.IPrivateLinkResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api60.IPrivateLinkResourcePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api60.IPrivateLinkResourcePropertiesInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for RequiredMember</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models.Api60.IPrivateLinkResourcePropertiesInternal.RequiredMember { get => this._requiredMember; set { {_requiredMember = value;} } }
