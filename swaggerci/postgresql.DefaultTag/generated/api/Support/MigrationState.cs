...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState CleaningUp = @"CleaningUp";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState ValidationFailed = @"ValidationFailed";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState WaitingForUserAction = @"WaitingForUserAction";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState e1, Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.MigrationState e2)
        {
            return !e2.Equals(e1);
        }
