...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.Origin CustomerOnDemand = @"Customer On-Demand";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.Origin Full = @"Full";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.Origin e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.Origin e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.Origin e1, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.Origin e2)
        {
            return !e2.Equals(e1);
        }
