...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Eleven = @"11";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Fifteen = @"15";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Fourteen = @"14";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Seventeen = @"17";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Sixteen = @"16";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Thirteen = @"13";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion Twelve = @"12";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion e1, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ServerVersion e2)
        {
            return !e2.Equals(e1);
        }
