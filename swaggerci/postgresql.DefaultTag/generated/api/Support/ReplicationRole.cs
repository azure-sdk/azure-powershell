...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole AsyncReplica = @"AsyncReplica";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole GeoAsyncReplica = @"GeoAsyncReplica";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole Primary = @"Primary";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole e1, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.ReplicationRole e2)
        {
            return !e2.Equals(e1);
        }
