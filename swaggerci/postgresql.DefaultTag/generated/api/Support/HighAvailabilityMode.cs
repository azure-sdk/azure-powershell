...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode Disabled = @"Disabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode SameZone = @"SameZone";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode ZoneRedundant = @"ZoneRedundant";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode e1, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support.HighAvailabilityMode e2)
        {
            return !e2.Equals(e1);
        }
