...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/locations/{locationName}/getAutoMigrationFreeSlots"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPostgreSqlGetAutoMigrationFreeSlot_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFreeSlotsListResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Description(@"This method gets the available slots for auto migration for a given single server resource id")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/locations/{locationName}/getAutoMigrationFreeSlots", ApiVersion = "2024-03-01-preview")]
    public partial class GetAzPostgreSqlGetAutoMigrationFreeSlot_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="MigrationScheduleTimeRange" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAutoMigrationScheduleTimeRange _migrationScheduleTimeRange;

        /// <summary>The time range between which the slots are required for.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The time range between which the slots are required for.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The time range between which the slots are required for.",
        SerializedName = @"migrationScheduleTimeRange",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAutoMigrationScheduleTimeRange) })]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IAutoMigrationScheduleTimeRange MigrationScheduleTimeRange { get => this._migrationScheduleTimeRange; set => this._migrationScheduleTimeRange = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFreeSlotsListResult">Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFreeSlotsListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFreeSlotsListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPostgreSqlGetAutoMigrationFreeSlot_List" /> cmdlet class.
        /// </summary>
        public GetAzPostgreSqlGetAutoMigrationFreeSlot_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GetAutoMigrationFreeSlotsList' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GetAutoMigrationFreeSlotsList(SubscriptionId, LocationName, MigrationScheduleTimeRange, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,LocationName=LocationName,body=MigrationScheduleTimeRange})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api50.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, LocationName=LocationName, body=MigrationScheduleTimeRange })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, LocationName=LocationName, body=MigrationScheduleTimeRange })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20240301Preview.IFreeSlotsListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.GetAutoMigrationFreeSlotsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
