...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
    ...
    /// <summary>Starts up the config tuning session.</summary>
    /// <remarks>
    /// [OpenAPI] StartSession=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/tuningOptions/{tuningOption}/startSession"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Description(@"Starts up the config tuning session.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/tuningOptions/{tuningOption}/startSession", ApiVersion = "2025-03-15-privatepreview")]
    public partial class StartAzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IConfigTuningRequestParameter _configTuningRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.ConfigTuningRequestParameter();

        /// <summary>Indicates whether PG should be restarted during a tuning session.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates whether PG should be restarted during a tuning session.")]
        ...
        public global::System.Management.Automation.SwitchParameter AllowServerRestart { get => _configTuningRequestBody.AllowServerRestart ?? default(global::System.Management.Automation.SwitchParameter); set => _configTuningRequestBody.AllowServerRestart = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The mode with which the feature will be enabled.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter ConfigTuningUsageMode { get => _configTuningRequestBody.ConfigTuningUsageMode ?? default(global::System.Management.Automation.SwitchParameter); set => _configTuningRequestBody.ConfigTuningUsageMode = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of server.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ServerName { get => _configTuningRequestBody.ServerName ?? null; set => _configTuningRequestBody.ServerName = value; }

        /// <summary>The target metric the tuning session is trying to improve.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The target metric the tuning session is trying to improve.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetImprovementMetric { get => _configTuningRequestBody.TargetImprovementMetric ?? null; set => _configTuningRequestBody.TargetImprovementMetric = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets.StartAzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded Clone()
        {
            var clone = new StartAzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded();
            ...
            clone._configTuningRequestBody = this._configTuningRequestBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TuningConfigurationStartSession' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.TuningConfigurationStartSessionViaIdentity(InputObject.Id, _configTuningRequestBody, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.TuningConfigurationStartSession(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, InputObject.TuningOption ?? ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.TuningOptionEnum)""), _configTuningRequestBody, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_configTuningRequestBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public StartAzPostgreSqlTuningConfigurationSession_StartViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api60.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_configTuningRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_configTuningRequestBody })
                    {
