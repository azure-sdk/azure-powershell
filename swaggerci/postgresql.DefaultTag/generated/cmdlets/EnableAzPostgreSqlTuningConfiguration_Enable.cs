...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
    ...
    /// <summary>Enables the config tuning.</summary>
    /// <remarks>
    /// [OpenAPI] Enable=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/tuningOptions/{tuningOption}/enable"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"AzPostgreSqlTuningConfiguration_Enable", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Description(@"Enables the config tuning.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/tuningOptions/{tuningOption}/enable", ApiVersion = "2025-03-15-privatepreview")]
    public partial class EnableAzPostgreSqlTuningConfiguration_Enable : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.TuningOptionEnum _tuningOption;

        /// <summary>The name of the tuning option.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the tuning option.")]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The name of the tuning option.",
        SerializedName = @"tuningOption",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.TuningOptionEnum) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Category(global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.ParameterCategory.Path)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.TuningOptionEnum))]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.TuningOptionEnum TuningOption { get => this._tuningOption; set => this._tuningOption = value; }
        ...
        /// <returns>a duplicate instance of EnableAzPostgreSqlTuningConfiguration_Enable</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets.EnableAzPostgreSqlTuningConfiguration_Enable Clone()
        {
            var clone = new EnableAzPostgreSqlTuningConfiguration_Enable();
            ...
            clone.TuningOption = this.TuningOption;
            return clone;
        }

        /// <summary>
        /// Intializes a new instance of the <see cref="EnableAzPostgreSqlTuningConfiguration_Enable" /> cmdlet class.
        /// </summary>
        public EnableAzPostgreSqlTuningConfiguration_Enable()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TuningConfigurationEnable' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.TuningConfigurationEnable(SubscriptionId, ResourceGroupName, ServerName, TuningOption, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ServerName=ServerName,TuningOption=TuningOption})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api60.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ServerName=ServerName, TuningOption=TuningOption })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ServerName=ServerName, TuningOption=TuningOption })
                    {
