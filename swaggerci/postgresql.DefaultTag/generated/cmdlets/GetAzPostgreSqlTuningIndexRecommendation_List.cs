...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
    ...
    /// <summary>Retrieve the list of available tuning recommendations.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzPostgreSqlTuningIndexRecommendation_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IObjectRecommendationResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Description(@"Retrieve the list of available tuning recommendations.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/tuningOptions/{tuningOption}/recommendations", ApiVersion = "2025-01-01-preview")]
    public partial class GetAzPostgreSqlTuningIndexRecommendation_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IObjectRecommendationListResult">Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IObjectRecommendationListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IObjectRecommendationListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPostgreSqlTuningIndexRecommendation_List" /> cmdlet class.
        /// </summary>
        public GetAzPostgreSqlTuningIndexRecommendation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TuningIndexListRecommendations(SubscriptionId, ResourceGroupName, ServerName, TuningOption, this.InvocationInformation.BoundParameters.ContainsKey("RecommendationType") ? RecommendationType : null, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api202501Preview.IObjectRecommendationListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.TuningIndexListRecommendations_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
