...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzPostgreSqlTuningConfigurationSession_StartViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzPostgreSqlTuningConfigurationSession_StartViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConfigTuningRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IConfigTuningRequestParameter _configTuningRequest;

        /// <summary>Config tuning request parameters.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Config tuning request parameters.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Config tuning request parameters.",
        SerializedName = @"configTuningRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IConfigTuningRequestParameter) })]
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20250315Privatepreview.IConfigTuningRequestParameter ConfigTuningRequest { get => this._configTuningRequest; set => this._configTuningRequest = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzPostgreSqlTuningConfigurationSession_StartViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Cmdlets.StartAzPostgreSqlTuningConfigurationSession_StartViaIdentity Clone()
        {
            var clone = new StartAzPostgreSqlTuningConfigurationSession_StartViaIdentity();
            ...
            clone.ConfigTuningRequest = this.ConfigTuningRequest;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.TuningConfigurationStartSessionViaIdentity(InputObject.Id, ConfigTuningRequest, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.TuningConfigurationStartSession(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, InputObject.TuningOption ?? ((Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.TuningOptionEnum)""), ConfigTuningRequest, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ConfigTuningRequest})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzPostgreSqlTuningConfigurationSession_StartViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzPostgreSqlTuningConfigurationSession_StartViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api60.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConfigTuningRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ConfigTuningRequest })
                    {
