...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlServer.Support";
