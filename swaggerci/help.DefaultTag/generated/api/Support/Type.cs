...
namespace Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type AutomatedCheck = @"AutomatedCheck";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type Decision = @"Decision";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type Input = @"Input";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type Insight = @"Insight";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type Solution = @"Solution";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
