...
namespace Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType Avg = @"Avg";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType Count = @"Count";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType Max = @"Max";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType Min = @"Min";

        public static Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType Sum = @"Sum";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType e1, Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Support.AggregationType e2)
        {
            return !e2.Equals(e1);
        }
