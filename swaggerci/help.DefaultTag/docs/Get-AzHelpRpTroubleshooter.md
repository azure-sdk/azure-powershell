...
online version: https://learn.microsoft.com/powershell/module/az.helprp/get-azhelprptroubleshooter
schema: 2.0.0
---

# Get-AzHelpRpTroubleshooter
...
### Get (Default)
```
Get-AzHelpRpTroubleshooter -Name <String> -Scope <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzHelpRpTroubleshooter -InputObject <IHelpRpIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
