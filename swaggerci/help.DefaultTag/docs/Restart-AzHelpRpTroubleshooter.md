...
online version: https://learn.microsoft.com/powershell/module/az.helprp/restart-azhelprptroubleshooter
schema: 2.0.0
---

# Restart-AzHelpRpTroubleshooter
...
### Restart (Default)
```
Restart-AzHelpRpTroubleshooter -Name <String> -Scope <String> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzHelpRpTroubleshooter -InputObject <IHelpRpIdentity> [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
