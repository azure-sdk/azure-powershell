...
.Link
https://learn.microsoft.com/powershell/module/az.helprp/invoke-azhelprpchecknameavailability
#>
function Invoke-AzHelpRpCheckNameAvailability {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HelpRp.Models.Api20230901Preview.ICheckNameAvailabilityResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Post = 'Az.HelpRp.private\Invoke-AzHelpRpCheckNameAvailability_Post';
            PostExpanded = 'Az.HelpRp.private\Invoke-AzHelpRpCheckNameAvailability_PostExpanded';
            PostViaIdentity = 'Az.HelpRp.private\Invoke-AzHelpRpCheckNameAvailability_PostViaIdentity';
            PostViaIdentityExpanded = 'Az.HelpRp.private\Invoke-AzHelpRpCheckNameAvailability_PostViaIdentityExpanded';
        }
