...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus Rejected = @"Rejected";

        public static Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus Timeout = @"Timeout";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningWorkspaces.Support.PrivateEndpointServiceConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
