...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maps/accounts/{accountName}/creators/{creatorName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMapsCreator_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreator))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Description(@"Updates the Maps Creator resource. Only a subset of the parameters may be updated after creation, such as Tags.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.Generated]
    public partial class UpdateAzMapsCreator_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CreatorUpdateParametersBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreatorUpdateParameters _creatorUpdateParametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.CreatorUpdateParameters();

        /// <summary>Parameters used to update an existing Creator resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreatorUpdateParameters CreatorUpdateParametersBody { get => this._creatorUpdateParametersBody; set => this._creatorUpdateParametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The storage units to be allocated. Integer values from 1 to 100, inclusive.")]
        ...
        public int StorageUnit { get => CreatorUpdateParametersBody.StorageUnit ?? default(int); set => CreatorUpdateParametersBody.StorageUnit = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreatorUpdateParametersTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreatorUpdateParametersTags Tag { get => CreatorUpdateParametersBody.Tag ?? null /* object */; set => CreatorUpdateParametersBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreator"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreator> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreatorsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CreatorsUpdateViaIdentity(InputObject.Id, CreatorUpdateParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.CreatorName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.CreatorName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.CreatorsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.CreatorName ?? null, CreatorUpdateParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CreatorUpdateParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzMapsCreator_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMapsCreator_UpdateViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CreatorUpdateParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CreatorUpdateParametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreator> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20211201Preview.ICreator
