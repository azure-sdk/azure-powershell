...
online version: https://learn.microsoft.com/powershell/module/az.billingbenefitsrp/get-azbillingbenefitsrpsavingsplan
schema: 2.0.0
---
...
### List (Default)
```
Get-AzBillingBenefitsRpSavingsPlan -OrderId <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
