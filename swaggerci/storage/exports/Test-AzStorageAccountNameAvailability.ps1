...
.Link
https://learn.microsoft.com/powershell/module/az.storage/test-azstorageaccountnameavailability
#>
function Test-AzStorageAccountNameAvailability {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICheckNameAvailabilityResult])]
