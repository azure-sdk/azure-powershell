...
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstoragefileservice
#>
function Get-AzStorageFileService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServiceProperties])]
