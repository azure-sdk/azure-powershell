...
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstoragetableservice
#>
function Get-AzStorageTableService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ITableServiceProperties])]
