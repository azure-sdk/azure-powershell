...
.Link
https://learn.microsoft.com/powershell/module/az.storage/new-azstorageblobcontainer
#>
function New-AzStorageBlobContainer {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IBlobContainer])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IContainerProperties]
