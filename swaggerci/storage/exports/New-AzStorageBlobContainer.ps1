...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IBlobContainer])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IContainerProperties]
