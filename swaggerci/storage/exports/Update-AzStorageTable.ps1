...
.Link
https://learn.microsoft.com/powershell/module/az.storage/update-azstoragetable
#>
function Update-AzStorageTable {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ITable])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ITableSignedIdentifier[]]
