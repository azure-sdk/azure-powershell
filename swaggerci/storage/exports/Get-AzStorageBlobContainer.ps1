...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IBlobContainer], [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IListContainerItem])]
