...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IBlobContainer], [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IListContainerItem])]
