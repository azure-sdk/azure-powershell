...
.Link
https://learn.microsoft.com/powershell/module/az.storage/new-azstoragemanagementpolicy
#>
function New-AzStorageManagementPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicy])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyRule[]]
