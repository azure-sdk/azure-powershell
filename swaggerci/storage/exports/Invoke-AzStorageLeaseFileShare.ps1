...
.Link
https://learn.microsoft.com/powershell/module/az.storage/invoke-azstorageleasefileshare
#>
function Invoke-AzStorageLeaseFileShare {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ILeaseShareResponse])]
