...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.LeaseShareAction Action { get => ParametersBody.Action; set => ParametersBody.Action = value; }
        ...
        public int BreakPeriod { get => ParametersBody.BreakPeriod ?? default(int); set => ParametersBody.BreakPeriod = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int LeaseDuration { get => ParametersBody.LeaseDuration ?? default(int); set => ParametersBody.LeaseDuration = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LeaseId { get => ParametersBody.LeaseId ?? null; set => ParametersBody.LeaseId = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILeaseShareRequest _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.LeaseShareRequest();

        /// <summary>Lease Share request schema.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILeaseShareRequest ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ProposedLeaseId { get => ParametersBody.ProposedLeaseId ?? null; set => ParametersBody.ProposedLeaseId = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FileSharesLease(ResourceGroupName, AccountName, ShareName, SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("XmsSnapshot") ? XmsSnapshot : null, ParametersBody, onOk, onDefault, this, Pipeline);
