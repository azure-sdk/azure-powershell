        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BlobContainersLeaseViaIdentity(InputObject.Id, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BlobContainersLease(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ContainerName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, this, Pipeline);
                    }
