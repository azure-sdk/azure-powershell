...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DestinationAccount { get => PropertiesBody.DestinationAccount ?? null; set => PropertiesBody.DestinationAccount = value; }
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IObjectReplicationPolicy PropertiesBody { get => this._propertiesBody; set => this._propertiesBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IObjectReplicationPolicyRule[] Rule { get => PropertiesBody.Rule ?? null /* arrayOf */; set => PropertiesBody.Rule = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceAccount { get => PropertiesBody.SourceAccount ?? null; set => PropertiesBody.SourceAccount = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ObjectReplicationPoliciesCreateOrUpdate(ResourceGroupName, AccountName, SubscriptionId, Id, PropertiesBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,AccountName=AccountName,SubscriptionId=SubscriptionId,Id=Id,body=PropertiesBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, SubscriptionId=SubscriptionId, Id=Id, body=PropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, SubscriptionId=SubscriptionId, Id=Id, body=PropertiesBody })
                    {
