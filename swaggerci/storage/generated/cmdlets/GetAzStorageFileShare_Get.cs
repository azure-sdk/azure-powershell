...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/fileServices/default/shares/{shareName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStorageFileShare_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Description(@"Gets properties of a specified share.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Generated]
    public partial class GetAzStorageFileShare_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// with delimiter ','.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional, used to expand the properties within share's properties. Valid values are: stats. Should be passed as a string with delimiter ','.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>Optional, used to retrieve properties of a snapshot.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional, used to retrieve properties of a snapshot.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStorageFileShare_Get" /> cmdlet class.
        /// </summary>
        public GetAzStorageFileShare_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FileSharesGet(ResourceGroupName, AccountName, ShareName, SubscriptionId, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, this.InvocationInformation.BoundParameters.ContainsKey("XmsSnapshot") ? XmsSnapshot : null, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, ShareName=ShareName, SubscriptionId=SubscriptionId, Expand=this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, XmsSnapshot=this.InvocationInformation.BoundParameters.ContainsKey("XmsSnapshot") ? XmsSnapshot : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, ShareName=ShareName, SubscriptionId=SubscriptionId, Expand=this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, XmsSnapshot=this.InvocationInformation.BoundParameters.ContainsKey("XmsSnapshot") ? XmsSnapshot : null })
                    {
