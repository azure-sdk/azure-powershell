        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BlobContainersExtendImmutabilityPolicyViaIdentity(InputObject.Id, IfMatch, ParametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BlobContainersExtendImmutabilityPolicy(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ContainerName ?? null, InputObject.SubscriptionId ?? null, IfMatch, ParametersBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  IfMatch=IfMatch,body=ParametersBody})
                    {
