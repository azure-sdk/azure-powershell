...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ClearLegalHold=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}/clearLegalHold"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Clear, @"AzStorageBlobContainerLegalHold_ClearViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Description(@"Clears legal hold tags. Clearing the same or non-existent tag results in an idempotent operation. ClearLegalHold clears out only the specified tags in the request.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Generated]
    public partial class ClearAzStorageBlobContainerLegalHold_ClearViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining legal hold protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted.")]
        ...
        public global::System.Management.Automation.SwitchParameter AllowProtectedAppendWritesAll { get => LegalHoldBody.AllowProtectedAppendWritesAll ?? default(global::System.Management.Automation.SwitchParameter); set => LegalHoldBody.AllowProtectedAppendWritesAll = value; }
        ...
        /// <summary>Backing field for <see cref="LegalHoldBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold _legalHoldBody= new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.LegalHold();

        /// <summary>The LegalHold property of a blob container.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold LegalHoldBody { get => this._legalHoldBody; set => this._legalHoldBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Each tag should be 3 to 23 alphanumeric characters and is normalized to lower case at SRP.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Storage.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public string[] Tag { get => LegalHoldBody.Tag ?? null /* arrayOf */; set => LegalHoldBody.Tag = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ClearAzStorageBlobContainerLegalHold_ClearViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ClearAzStorageBlobContainerLegalHold_ClearViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BlobContainersClearLegalHold' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BlobContainersClearLegalHoldViaIdentity(InputObject.Id, LegalHoldBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BlobContainersClearLegalHold(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ContainerName ?? null, InputObject.SubscriptionId ?? null, LegalHoldBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=LegalHoldBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ILegalHold
