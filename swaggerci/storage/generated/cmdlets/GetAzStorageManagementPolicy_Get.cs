...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    public partial class GetAzStorageManagementPolicy_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStorageManagementPolicy_Get" /> cmdlet class.
        /// </summary>
        public GetAzStorageManagementPolicy_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ManagementPoliciesGet(ResourceGroupName, AccountName, SubscriptionId, onOk, this, Pipeline);
