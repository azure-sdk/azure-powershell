...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Restore, @"AzStorageFileShare_RestoreViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RestoreAzStorageFileShare_RestoreViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.FileSharesRestoreViaIdentity(InputObject.Id, DeletedShare, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FileSharesRestore(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ShareName ?? null, InputObject.SubscriptionId ?? null, DeletedShare, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=DeletedShare})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestoreAzStorageFileShare_RestoreViaIdentity" /> cmdlet class.
        /// </summary>
        public RestoreAzStorageFileShare_RestoreViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DeletedShare })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DeletedShare })
                    {
