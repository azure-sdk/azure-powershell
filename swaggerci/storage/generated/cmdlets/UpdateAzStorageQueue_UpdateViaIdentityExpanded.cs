...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="QueueBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IStorageQueue QueueBody { get => this._queueBody; set => this._queueBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IQueuePropertiesMetadata QueuePropertyMetadata { get => QueueBody.QueuePropertyMetadata ?? null /* object */; set => QueueBody.QueuePropertyMetadata = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.QueueUpdateViaIdentity(InputObject.Id, QueueBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.QueueUpdate(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.SubscriptionId ?? null, InputObject.QueueName ?? null, QueueBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=QueueBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=QueueBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=QueueBody })
                    {
