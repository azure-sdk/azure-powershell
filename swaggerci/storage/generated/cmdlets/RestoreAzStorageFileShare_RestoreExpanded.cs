...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Restore, @"AzStorageFileShare_RestoreExpanded", SupportsShouldProcess = true)]
    ...
    public partial class RestoreAzStorageFileShare_RestoreExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="DeletedShareBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IDeletedShare DeletedShareBody { get => this._deletedShareBody; set => this._deletedShareBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DeletedShareName { get => DeletedShareBody.Name ?? null; set => DeletedShareBody.Name = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DeletedShareVersion { get => DeletedShareBody.Version ?? null; set => DeletedShareBody.Version = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FileSharesRestore(ResourceGroupName, AccountName, ShareName, SubscriptionId, DeletedShareBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,AccountName=AccountName,ShareName=ShareName,SubscriptionId=SubscriptionId,body=DeletedShareBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestoreAzStorageFileShare_RestoreExpanded" /> cmdlet class.
        /// </summary>
        public RestoreAzStorageFileShare_RestoreExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, ShareName=ShareName, SubscriptionId=SubscriptionId, body=DeletedShareBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, ShareName=ShareName, SubscriptionId=SubscriptionId, body=DeletedShareBody })
                    {
