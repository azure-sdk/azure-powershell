        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BlobContainersExtendImmutabilityPolicy(ResourceGroupName, AccountName, ContainerName, SubscriptionId, IfMatch, ParametersBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,AccountName=AccountName,ContainerName=ContainerName,SubscriptionId=SubscriptionId,IfMatch=IfMatch,body=ParametersBody})
                    {
