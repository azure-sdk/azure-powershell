...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        public string KeyName { get => RegenerateKeyBody.KeyName ?? null; set => RegenerateKeyBody.KeyName = value; }
        ...
        /// <summary>Backing field for <see cref="RegenerateKeyBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IStorageAccountRegenerateKeyParameters _regenerateKeyBody= new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.StorageAccountRegenerateKeyParameters();

        /// <summary>The parameters used to regenerate the storage account key.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210901.IStorageAccountRegenerateKeyParameters RegenerateKeyBody { get => this._regenerateKeyBody; set => this._regenerateKeyBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageAccountsRegenerateKeyViaIdentity(InputObject.Id, RegenerateKeyBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StorageAccountsRegenerateKey(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.SubscriptionId ?? null, RegenerateKeyBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RegenerateKeyBody})
                    {
