...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501
{
    ...
    public partial class ManagementPolicySnapShot :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IManagementPolicySnapShot,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IManagementPolicySnapShotInternal
    {

        /// <summary>Backing field for <see cref="Delete" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation _delete;

        /// <summary>The function to delete the blob snapshot</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation Delete { get => (this._delete = this._delete ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.DateAfterCreation()); set => this._delete = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation _tierToArchive;

        /// <summary>
        /// The function to tier blob snapshot to archive storage. Support blob snapshot currently at Hot or Cool tier
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation TierToArchive { get => (this._tierToArchive = this._tierToArchive ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.DateAfterCreation()); set => this._tierToArchive = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation _tierToCool;

        /// <summary>
        /// The function to tier blob snapshot to cool storage. Support blob snapshot currently at Hot tier
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation TierToCool { get => (this._tierToCool = this._tierToCool ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.DateAfterCreation()); set => this._tierToCool = value; }
    ...
    {
        /// <summary>The function to delete the blob snapshot</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation Delete { get; set; }
        /// <summary>Value indicating the age in days after creation</summary>
        float? DeleteDaysAfterCreationGreaterThan { get; set; }
        /// <summary>
        /// Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive
        ...
        /// The function to tier blob snapshot to archive storage. Support blob snapshot currently at Hot or Cool tier
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation TierToArchive { get; set; }
        /// <summary>Value indicating the age in days after creation</summary>
        float? TierToArchiveDaysAfterCreationGreaterThan { get; set; }
        /// <summary>
        /// Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive
        ...
        /// The function to tier blob snapshot to cool storage. Support blob snapshot currently at Hot tier
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IDateAfterCreation TierToCool { get; set; }
        /// <summary>Value indicating the age in days after creation</summary>
        float? TierToCoolDaysAfterCreationGreaterThan { get; set; }
        /// <summary>
        /// Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive
