...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501
{
    ...
    public partial class ImmutableStorageAccount :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IImmutableStorageAccount,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IImmutableStorageAccountInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IAccountImmutabilityPolicyProperties _immutabilityPolicy;
...

    {
        ...
        /// container-level immutability policy, which has a higher precedence than the account-level immutability policy.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220501.IAccountImmutabilityPolicyProperties ImmutabilityPolicy { get; set; }
        /// <summary>
        /// This property can only be changed for disabled and unlocked time-based retention policies. When enabled, new blocks can
        /// be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and
        /// any existing blocks cannot be modified or deleted.
