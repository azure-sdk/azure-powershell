...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901
{
    ...
    public partial class AccountSasParameters :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IAccountSasParametersInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Permissions _permission;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Permissions Permission { get => this._permission; set => this._permission = value; }

        /// <summary>Backing field for <see cref="Protocol" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.HttpProtocol? _protocol;

        /// <summary>The protocol permitted for a request made with the account SAS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.HttpProtocol? Protocol { get => this._protocol; set => this._protocol = value; }

        /// <summary>Backing field for <see cref="ResourceType" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.SignedResourceTypes _resourceType;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.SignedResourceTypes ResourceType { get => this._resourceType; set => this._resourceType = value; }

        /// <summary>Backing field for <see cref="Service" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Services _service;

        /// <summary>
        /// The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Services Service { get => this._service; set => this._service = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Permissions Permission { get; set; }
        /// <summary>The protocol permitted for a request made with the account SAS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.HttpProtocol? Protocol { get; set; }
        /// <summary>
        /// The signed resource types that are accessible with the account SAS. Service (s): Access to service-level APIs; Container
        /// (c): Access to container-level APIs; Object (o): Access to object-level APIs for blobs, queue messages, table entities,
        /// and files.
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.SignedResourceTypes ResourceType { get; set; }
        /// <summary>
        /// The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Services Service { get; set; }
        /// <summary>The time at which the shared access signature becomes invalid.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = true,
        ReadOnly = false,
