...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/remove-azstorageblobcontainer
schema: 2.0.0
---

# Remove-AzStorageBlobContainer
...
### Delete (Default)
```
Remove-AzStorageBlobContainer -AccountName <String> -ContainerName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorageBlobContainer -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [-PassThru]
