...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storage/remove-azstorageblobinventorypolicy
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzStorageBlobInventoryPolicy -AccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorageBlobInventoryPolicy -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [-PassThru]
