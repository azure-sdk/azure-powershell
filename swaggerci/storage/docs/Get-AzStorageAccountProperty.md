...
Get-AzStorageAccountProperty -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-Expand <StorageAccountExpand>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStorageAccountProperty -InputObject <IStorageIdentity> [-Expand <StorageAccountExpand>]
