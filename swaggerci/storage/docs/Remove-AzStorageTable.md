...
### Delete (Default)
```
Remove-AzStorageTable -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStorageTable -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
