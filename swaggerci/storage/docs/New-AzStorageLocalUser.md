...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IPermissionScope[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ISshPublicKey[]
Parameter Sets: (All)
Aliases:
