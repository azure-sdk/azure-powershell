...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api30.IOperation])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ConnectedKubernetes.private\Get-AzConnectedKubernetesOperation_List';
        }
