...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api202401
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api202401.IHybridConnectionConfigInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api202401.IHybridConnectionConfigInternal.ExpirationTime { get => this._expirationTime; set { {_expirationTime = value;} } }

        /// <summary>Internal Acessors for HybridConnectionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api202401.IHybridConnectionConfigInternal.HybridConnectionName { get => this._hybridConnectionName; set { {_hybridConnectionName = value;} } }

        /// <summary>Internal Acessors for Relay</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api202401.IHybridConnectionConfigInternal.Relay { get => this._relay; set { {_relay = value;} } }

        /// <summary>Internal Acessors for Token</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api202401.IHybridConnectionConfigInternal.Token { get => this._token; set { {_token = value;} } }
