...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview
{
    ...
    public partial class HybridConnectionConfig :
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IHybridConnectionConfig,
        Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IHybridConnectionConfigInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IHybridConnectionConfigInternal.ExpirationTime { get => this._expirationTime; set { {_expirationTime = value;} } }

        /// <summary>Internal Acessors for HybridConnectionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IHybridConnectionConfigInternal.HybridConnectionName { get => this._hybridConnectionName; set { {_hybridConnectionName = value;} } }

        /// <summary>Internal Acessors for Relay</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IHybridConnectionConfigInternal.Relay { get => this._relay; set { {_relay = value;} } }

        /// <summary>Internal Acessors for Token</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IHybridConnectionConfigInternal.Token { get => this._token; set { {_token = value;} } }
