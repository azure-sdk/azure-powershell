...
namespace Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview
{
    ...
    public partial class ConnectedClusterProperties
    {
        ...
        internal ConnectedClusterProperties(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject json)
        {
            ...
            {_aadProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("aadProfile"), out var __jsonAadProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.AadProfile.FromJson(__jsonAadProfile) : AadProfile;}
            {_arcAgentProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("arcAgentProfile"), out var __jsonArcAgentProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.ArcAgentProfile.FromJson(__jsonArcAgentProfile) : ArcAgentProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.SecurityProfile.FromJson(__jsonSecurityProfile) : SecurityProfile;}
            {_oidcIssuerProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("oidcIssuerProfile"), out var __jsonOidcIssuerProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.OidcIssuerProfile.FromJson(__jsonOidcIssuerProfile) : OidcIssuerProfile;}
            {_gateway = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("gateway"), out var __jsonGateway) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.Gateway.FromJson(__jsonGateway) : Gateway;}
            ...
            {_arcAgentryConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonArray>("arcAgentryConfigurations"), out var __jsonArcAgentryConfigurations) ? If( __jsonArcAgentryConfigurations as Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.IArcAgentryConfigurations[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.IArcAgentryConfigurations) (Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.ArcAgentryConfigurations.FromJson(__u) )) ))() : null : ArcAgentryConfiguration;}
            {_miscellaneousProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonObject>("miscellaneousProperties"), out var __jsonMiscellaneousProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.ConnectedClusterPropertiesMiscellaneousProperties.FromJson(__jsonMiscellaneousProperties) : MiscellaneousProperty;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.IConnectedClusterProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.IConnectedClusterProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20241201Preview.IConnectedClusterProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Runtime.Json.JsonNode node)
        {
