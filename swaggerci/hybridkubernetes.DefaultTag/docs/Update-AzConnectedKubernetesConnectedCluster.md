...
online version: https://learn.microsoft.com/powershell/module/az.connectedkubernetes/update-azconnectedkubernetesconnectedcluster
schema: 2.0.0
---
...
```
Update-AzConnectedKubernetesConnectedCluster -InputObject <IConnectedKubernetesIdentity>
