...
New-AzConnectedKubernetesConnectedCluster -ClusterName <String> -ResourceGroupName <String>
 ...
 [-Kind <ConnectedClusterKind>] [-PrivateLinkScopeResourceId <String>] [-PrivateLinkState <PrivateLinkState>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240201Preview.IAgentError[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240201Preview.ISystemComponent[]
Parameter Sets: (All)
Aliases:
