...
online version: https://learn.microsoft.com/powershell/module/az.connectedkubernetes/new-azconnectedkubernetesconnectedcluster
schema: 2.0.0
---

# New-AzConnectedKubernetesConnectedCluster
...
```
New-AzConnectedKubernetesConnectedCluster -ClusterName <String> -ResourceGroupName <String>
 ...
 [-ArcAgentProfileSystemComponent <ISystemComponent[]>] [-AzureHybridBenefit <AzureHybridBenefit>]
 [-Distribution <String>] [-DistributionVersion <String>] [-Infrastructure <String>]
 [-Kind <ConnectedClusterKind>] [-OidcIssuerProfileEnabled] [-OidcIssuerProfileSelfHostedIssuerUrl <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.IAgentError[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ConnectedKubernetes.Models.Api20240601Preview.ISystemComponent[]
Parameter Sets: (All)
Aliases:
