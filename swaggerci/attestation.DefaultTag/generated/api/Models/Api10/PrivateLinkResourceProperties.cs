...
namespace Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api10
{
    ...
    public partial class PrivateLinkResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api10.IPrivateLinkResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api10.IPrivateLinkResourcePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api10.IPrivateLinkResourcePropertiesInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for RequiredMember</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api10.IPrivateLinkResourcePropertiesInternal.RequiredMember { get => this._requiredMember; set { {_requiredMember = value;} } }
