...
namespace Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601
{
    ...
    public partial class OperationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601.IOperationProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601.IOperationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601.IOperationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonObject json ? new OperationProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonObject into a new instance of <see cref="OperationProperties" />.
        /// </summary>
        ...
        internal OperationProperties(Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonObject json)
        {
            ...
            {_serviceSpecification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonObject>("serviceSpecification"), out var __jsonServiceSpecification) ? Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601.ServiceSpecification.FromJson(__jsonServiceSpecification) : ServiceSpecification;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OperationProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OperationProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._serviceSpecification ? (Microsoft.Azure.PowerShell.Cmdlets.Attestation.Runtime.Json.JsonNode) this._serviceSpecification.ToJson(null,serializationMode) : null, "serviceSpecification" ,container.Add );
