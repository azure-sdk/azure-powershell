...
$dll = Join-Path $PSScriptRoot 'bin/Az.Attestation.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.Attestation.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Attestation.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Attestation cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Attestation.format.ps1xml'
