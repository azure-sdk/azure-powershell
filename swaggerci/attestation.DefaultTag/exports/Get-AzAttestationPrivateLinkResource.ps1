...
.Link
https://learn.microsoft.com/powershell/module/az.attestation/get-azattestationprivatelinkresource
#>
function Get-AzAttestationPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api10.IPrivateLinkResource])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Attestation.private\Get-AzAttestationPrivateLinkResource_List';
        }
