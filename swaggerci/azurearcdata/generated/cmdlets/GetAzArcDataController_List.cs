...
namespace Microsoft.Azure.PowerShell.Cmdlets.Arc.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListInSubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureArcData/dataControllers"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzArcDataController_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Description(@"List dataController resources in the subscription")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Arc.Generated]
    public partial class GetAzArcDataController_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzArcDataController_List" /> cmdlet class.
        /// </summary>
        public GetAzArcDataController_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DataControllersListInSubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.DataControllersListInSubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
