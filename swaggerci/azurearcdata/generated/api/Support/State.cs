...
namespace Microsoft.Azure.PowerShell.Cmdlets.Arc.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State Waiting = @"Waiting";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.State e2)
        {
            return !e2.Equals(e1);
        }
