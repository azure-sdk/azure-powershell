...
namespace Microsoft.Azure.PowerShell.Cmdlets.Arc.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType AwsVirtualMachine = @"AWS Virtual Machine";

        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType GcpVirtualMachine = @"GCP Virtual Machine";

        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType Other = @"Other";

        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType PhysicalServer = @"Physical Server";

        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType VirtualMachine = @"Virtual Machine";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType e1, Microsoft.Azure.PowerShell.Cmdlets.Arc.Support.HostType e2)
        {
            return !e2.Equals(e1);
        }
