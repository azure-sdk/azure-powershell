...
namespace Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview
{
    ...
    public partial class DataControllerProperties
    {
        ...
        internal DataControllerProperties(Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject json)
        {
            ...
            {_onPremiseProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject>("onPremiseProperty"), out var __jsonOnPremiseProperty) ? Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.OnPremiseProperty.FromJson(__jsonOnPremiseProperty) : OnPremiseProperty;}
            {_uploadWatermark = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject>("uploadWatermark"), out var __jsonUploadWatermark) ? Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.UploadWatermark.FromJson(__jsonUploadWatermark) : UploadWatermark;}
            ...
            {_metricsDashboardCredential = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject>("metricsDashboardCredential"), out var __jsonMetricsDashboardCredential) ? Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.BasicLoginInformation.FromJson(__jsonMetricsDashboardCredential) : MetricsDashboardCredential;}
            {_logsDashboardCredential = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject>("logsDashboardCredential"), out var __jsonLogsDashboardCredential) ? Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.BasicLoginInformation.FromJson(__jsonLogsDashboardCredential) : LogsDashboardCredential;}
            {_logAnalyticsWorkspaceConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject>("logAnalyticsWorkspaceConfig"), out var __jsonLogAnalyticsWorkspaceConfig) ? Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.LogAnalyticsWorkspaceConfig.FromJson(__jsonLogAnalyticsWorkspaceConfig) : LogAnalyticsWorkspaceConfig;}
            {_uploadServicePrincipal = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonObject>("uploadServicePrincipal"), out var __jsonUploadServicePrincipal) ? Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.UploadServicePrincipal.FromJson(__jsonUploadServicePrincipal) : UploadServicePrincipal;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.IDataControllerProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.IDataControllerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.IDataControllerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Arc.Runtime.Json.JsonNode node)
        {
