...
external help file:
Module Name: Az.Arc
online version: https://docs.microsoft.com/en-us/powershell/module/az.arc/remove-azarcsqlserverdatabase
schema: 2.0.0
---

# Remove-AzArcSqlServerDatabase
...
### Delete (Default)
```
Remove-AzArcSqlServerDatabase -DatabaseName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcSqlServerDatabase -InputObject <IArcIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
