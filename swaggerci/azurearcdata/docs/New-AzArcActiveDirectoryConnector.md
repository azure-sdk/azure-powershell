...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.IActiveDirectoryDomainController[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.IActiveDirectoryConnectorStatus
Parameter Sets: (All)
Aliases:
