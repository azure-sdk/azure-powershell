...
external help file:
Module Name: Az.Arc
online version: https://docs.microsoft.com/en-us/powershell/module/az.arc/update-azarcpostgresinstance
schema: 2.0.0
---

# Update-AzArcPostgresInstance
...
```
Update-AzArcPostgresInstance -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Admin <String>] [-BasicLoginInformationPassword <String>] [-BasicLoginInformationUsername <String>]
 [-DataControllerId <String>] [-K8SRaw <IAny>] [-LastUploadedDate <DateTime>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzArcPostgresInstance -InputObject <IArcIdentity> [-Admin <String>]
 [-BasicLoginInformationPassword <String>] [-BasicLoginInformationUsername <String>]
 [-DataControllerId <String>] [-K8SRaw <IAny>] [-LastUploadedDate <DateTime>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Arc.Models.Api20220615Preview.IPostgresInstance
