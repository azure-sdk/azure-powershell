...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support";
