...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Support";
