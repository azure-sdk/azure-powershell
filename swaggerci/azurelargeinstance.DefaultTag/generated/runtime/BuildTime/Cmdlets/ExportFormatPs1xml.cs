...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceTest.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceTest.Support";
