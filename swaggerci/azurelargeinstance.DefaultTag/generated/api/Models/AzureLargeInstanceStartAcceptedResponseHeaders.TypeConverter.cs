...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models
{
    ...
    public partial class AzureLargeInstanceStartAcceptedResponseHeadersTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="AzureLargeInstanceStartAcceptedResponseHeaders" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.IAzureLargeInstanceStartAcceptedResponseHeaders ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.IAzureLargeInstanceStartAcceptedResponseHeaders).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
