...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview
{
    ...
    public partial class StorageProperties :
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStorageProperties,
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStoragePropertiesInternal
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceHardwareTypeNamesEnum? HardwareType { get => this._hardwareType; set => this._hardwareType = value; }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStoragePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for StorageBillingProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStorageBillingProperties Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStoragePropertiesInternal.StorageBillingProperty { get => (this._storageBillingProperty = this._storageBillingProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.StorageBillingProperties()); set { {_storageBillingProperty = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.ProvisioningState? _provisioningState;

        /// <summary>State of provisioning of the AzureLargeStorageInstance</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.ProvisioningState? ProvisioningState { get => this._provisioningState; }

        /// <summary>Backing field for <see cref="StorageBillingProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStorageBillingProperties _storageBillingProperty;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.ProvisioningState? ProvisioningState { get;  }
        /// <summary>the billing mode for the storage instance</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string OfferingType { get; set; }
        /// <summary>State of provisioning of the AzureLargeStorageInstance</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.ProvisioningState? ProvisioningState { get; set; }
        /// <summary>the billing related information for the resource</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Models.Api20230720Preview.IStorageBillingProperties StorageBillingProperty { get; set; }
        /// <summary>the billing mode for the storage instance</summary>
        string StorageBillingPropertyBillingMode { get; set; }
        /// <summary>the SKU type that is provisioned</summary>
        string StorageBillingPropertySku { get; set; }
