...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstance
{
    ...
    public partial class AzureLargeInstance
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onDefault(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.Api40.ErrorResponse.FromJson(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                    }
                }
        ...
        /// <summary>
        /// Gets a list of Azure Large Instances in the specified subscription and resource group. The operations returns various
        ...
        /// <summary>
        /// Gets a list of Azure Large Instances in the specified subscription. The operations returns various properties of each
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.Api40.OperationStatusResult.FromJson(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                        default:
                        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        internal async global::System.Threading.Tasks.Task AzureLargeInstanceUpdate_Validate(string subscriptionId, string resourceGroupName, string azureLargeInstanceName, Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.Api20230720Preview.ITags1 body, Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.IEventListener eventListener)
        {
            using( NoSynchronizationContext )
            {
                await eventListener.AssertNotNull(nameof(subscriptionId),subscriptionId);
        ...
        /// <summary>
        /// Gets a list of AzureLargeStorageInstances in the specified subscription and resource group. The operations returns various
        ...
        /// <summary>
        /// Gets a list of AzureLargeStorageInstances in the specified subscription. The operations returns various properties of
        /// each Azure LargeStorage instance.
        /// </summary>
        /// <param name="subscriptionId">The ID of the target subscription. The value must be an UUID.</param>
        /// <param name="onOk">a delegate that is called when the remote service returns 200 (OK).</param>
        /// <param name="onDefault">a delegate that is called when the remote service returns default (any response code not handled
        ...
        /// <summary>
        /// Patches the Tags field of a Azure Large Storage Instance for the specified subscription, resource group, and instance
        /// name.
        /// </summary>
        /// <param name="subscriptionId">The ID of the target subscription. The value must be an UUID.</param>
        /// <param name="resourceGroupName">The name of the resource group. The name is case insensitive.</param>
        ...
        /// <summary>Gets a list of AzureLargeInstance management operations.</summary>
        /// <param name="onOk">a delegate that is called when the remote service returns 200 (OK).</param>
        /// <param name="onDefault">a delegate that is called when the remote service returns default (any response code not handled
        /// elsewhere).</param>
        /// <param name="eventListener">an <see cref="Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.IEventListener" /> instance that will receive events.</param>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        public async global::System.Threading.Tasks.Task OperationsList(global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.Api40.IOperationListResult>, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.Api40.IErrorResponse>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.ISendAsync sender)
        {
            var apiVersion = @"2023-07-20-preview";
            // Constant Parameters
            using( NoSynchronizationContext )
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Models.Api40.OperationListResult.FromJson(Microsoft.Azure.PowerShell.Cmdlets.LargeInstance.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                        default:
                        {
