...
namespace Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support
{
        ...
        System.IEquatable<AzureLargeInstanceProvisioningStatesEnum>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Accepted = @"Accepted";

        /// <summary>Cancelled Azure Large Instance resource operation has been cancelled</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Canceled = @"Canceled";

        /// <summary>Creating means Azure Large Instance resource is being created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Creating = @"Creating";

        /// <summary>Deleting means Azure Large Instance resource is in the process of being deleted</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Deleting = @"Deleting";

        /// <summary>Failed means Azure Large Instance resource is in failed state</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Failed = @"Failed";

        /// <summary>
        /// Migrating means Azure Large Instance resource is being migrated from one subscription or resource group to another
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Migrating = @"Migrating";

        /// <summary>
        /// Succeeded means Azure Large Instance resource creation succeeded during last create/update
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Succeeded = @"Succeeded";

        /// <summary>Updating means an existing Azure Large Instance resource is being updated</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum e1, Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceForTesting.Support.AzureLargeInstanceProvisioningStatesEnum e2)
        {
            return !e2.Equals(e1);
        }
