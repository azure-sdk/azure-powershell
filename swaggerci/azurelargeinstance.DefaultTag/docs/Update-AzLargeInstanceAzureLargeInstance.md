...
online version: https://learn.microsoft.com/powershell/module/az.largeinstance/update-azlargeinstanceazurelargeinstance
schema: 2.0.0
---

# Update-AzLargeInstanceAzureLargeInstance
...
```
Update-AzLargeInstanceAzureLargeInstance -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzLargeInstanceAzureLargeInstance -InputObject <ILargeInstanceIdentity> [-Tag <Hashtable>]
