...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancetest/restart-azlargeinstancetestazurelargeinstance
schema: 2.0.0
---

# Restart-AzLargeInstanceTestAzureLargeInstance
...
```
Restart-AzLargeInstanceTestAzureLargeInstance -Name <String> -ResourceGroupName <String>
...
### RestartViaIdentity
```
Restart-AzLargeInstanceTestAzureLargeInstance -InputObject <ILargeInstanceTestIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceTest.Models.Api20230720Preview.IForceState
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.LargeInstanceTest.Support.AzureLargeInstanceForcePowerState
