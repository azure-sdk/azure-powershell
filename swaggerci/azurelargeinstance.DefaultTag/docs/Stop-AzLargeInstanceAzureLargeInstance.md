...
online version: https://learn.microsoft.com/powershell/module/az.largeinstance/stop-azlargeinstanceazurelargeinstance
schema: 2.0.0
---

# Stop-AzLargeInstanceAzureLargeInstance
...
### Shutdown (Default)
```
Stop-AzLargeInstanceAzureLargeInstance -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ShutdownViaIdentity
```
Stop-AzLargeInstanceAzureLargeInstance -InputObject <ILargeInstanceIdentity> [-DefaultProfile <PSObject>]
