...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancefortesting/start-azlargeinstancefortestingazurelargeinstance
schema: 2.0.0
---

# Start-AzLargeInstanceForTestingAzureLargeInstance
...
### Start (Default)
```
Start-AzLargeInstanceForTestingAzureLargeInstance -Name <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzLargeInstanceForTestingAzureLargeInstance -InputObject <ILargeInstanceForTestingIdentity>
