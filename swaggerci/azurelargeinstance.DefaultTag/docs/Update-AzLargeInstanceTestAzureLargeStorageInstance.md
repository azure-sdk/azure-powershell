...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancetest/update-azlargeinstancetestazurelargestorageinstance
schema: 2.0.0
---
...
```
Update-AzLargeInstanceTestAzureLargeStorageInstance -Name <String> -ResourceGroupName <String>
...
```
Update-AzLargeInstanceTestAzureLargeStorageInstance -InputObject <ILargeInstanceTestIdentity>
