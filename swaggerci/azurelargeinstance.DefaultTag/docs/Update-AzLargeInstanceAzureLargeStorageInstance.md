...
online version: https://learn.microsoft.com/powershell/module/az.largeinstance/update-azlargeinstanceazurelargestorageinstance
schema: 2.0.0
---

# Update-AzLargeInstanceAzureLargeStorageInstance
...
```
Update-AzLargeInstanceAzureLargeStorageInstance -Name <String> -ResourceGroupName <String>
...
```
Update-AzLargeInstanceAzureLargeStorageInstance -InputObject <ILargeInstanceIdentity> [-Tag <Hashtable>]
