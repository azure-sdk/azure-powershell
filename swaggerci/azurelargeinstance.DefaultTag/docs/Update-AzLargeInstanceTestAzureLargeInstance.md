...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancetest/update-azlargeinstancetestazurelargeinstance
schema: 2.0.0
---

# Update-AzLargeInstanceTestAzureLargeInstance
...
```
Update-AzLargeInstanceTestAzureLargeInstance -Name <String> -ResourceGroupName <String>
...
```
Update-AzLargeInstanceTestAzureLargeInstance -InputObject <ILargeInstanceTestIdentity> [-Tag <Hashtable>]
