...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancefortesting/update-azlargeinstancefortestingazurelargestorageinstance
schema: 2.0.0
---
...
```
Update-AzLargeInstanceForTestingAzureLargeStorageInstance -Name <String> -ResourceGroupName <String>
...
```
Update-AzLargeInstanceForTestingAzureLargeStorageInstance -InputObject <ILargeInstanceForTestingIdentity>
