...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancefortesting/update-azlargeinstancefortestingazurelargeinstance
schema: 2.0.0
---
...
```
Update-AzLargeInstanceForTestingAzureLargeInstance -Name <String> -ResourceGroupName <String>
...
```
Update-AzLargeInstanceForTestingAzureLargeInstance -InputObject <ILargeInstanceForTestingIdentity>
