...
online version: https://learn.microsoft.com/powershell/module/az.largeinstancefortesting/stop-azlargeinstancefortestingazurelargeinstance
schema: 2.0.0
---

# Stop-AzLargeInstanceForTestingAzureLargeInstance
...
### Shutdown (Default)
```
Stop-AzLargeInstanceForTestingAzureLargeInstance -Name <String> -ResourceGroupName <String>
...
### ShutdownViaIdentity
```
Stop-AzLargeInstanceForTestingAzureLargeInstance -InputObject <ILargeInstanceForTestingIdentity>
