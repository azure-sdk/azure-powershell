...
online version: https://docs.microsoft.com/en-us/powershell/module/az.subscription/get-azsubscriptionoperationresult
schema: 2.0.0
---

# Get-AzSubscriptionOperationResult
...
### Get (Default)
```
Get-AzSubscriptionOperationResult -OperationId <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSubscriptionOperationResult -InputObject <ISubscriptionIdentity> [-DefaultProfile <PSObject>] [-AsJob]
