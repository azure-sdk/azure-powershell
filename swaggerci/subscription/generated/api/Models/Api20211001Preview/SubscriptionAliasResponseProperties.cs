...
namespace Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview
{
    ...
    public partial class SubscriptionAliasResponseProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.ISubscriptionAliasResponsePropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Support.AcceptOwnership? Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.ISubscriptionAliasResponsePropertiesInternal.AcceptOwnershipState { get => this._acceptOwnershipState; set { {_acceptOwnershipState = value;} } }

        /// <summary>Internal Acessors for AcceptOwnershipUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.ISubscriptionAliasResponsePropertiesInternal.AcceptOwnershipUrl { get => this._acceptOwnershipUrl; set { {_acceptOwnershipUrl = value;} } }

        /// <summary>Internal Acessors for SubscriptionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.ISubscriptionAliasResponsePropertiesInternal.SubscriptionId { get => this._subscriptionId; set { {_subscriptionId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.ISubscriptionAliasResponsePropertiesTags _tag;

        /// <summary>Tags for the subscription</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Origin(Microsoft.Azure.PowerShell.Cmdlets.Subscription.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.ISubscriptionAliasResponsePropertiesTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.SubscriptionAliasResponsePropertiesTags()); set => this._tag = value; }
