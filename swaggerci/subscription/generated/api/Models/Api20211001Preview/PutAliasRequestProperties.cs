...
namespace Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview
{
    ...
    public partial class PutAliasRequestProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AdditionalProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalProperties _additionalProperty;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalProperties AdditionalProperty { get => (this._additionalProperty = this._additionalProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.PutAliasRequestAdditionalProperties()); set => this._additionalProperty = value; }
        ...
        public string AdditionalPropertyManagementGroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesInternal)AdditionalProperty).ManagementGroupId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesInternal)AdditionalProperty).ManagementGroupId = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Origin(Microsoft.Azure.PowerShell.Cmdlets.Subscription.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesTags AdditionalPropertyTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesInternal)AdditionalProperty).Tag; set => ((Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesInternal)AdditionalProperty).Tag = value ?? null /* model class */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalProperties Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestPropertiesInternal.AdditionalProperty { get => (this._additionalProperty = this._additionalProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.PutAliasRequestAdditionalProperties()); set { {_additionalProperty = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalPropertiesTags AdditionalPropertyTag { get; set; }
        /// <summary>
        /// Billing scope of the subscription.
        /// For CustomerLed and FieldLed - /billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}
        /// For PartnerLed - /billingAccounts/{billingAccountName}/customers/{customerName}
    ...
    {
        /// <summary>Put alias request additional properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IPutAliasRequestAdditionalProperties AdditionalProperty { get; set; }
        /// <summary>Management group Id for the subscription.</summary>
        string AdditionalPropertyManagementGroupId { get; set; }
        /// <summary>Owner Id of the subscription</summary>
        string AdditionalPropertySubscriptionOwnerId { get; set; }
