@{
  GUID = '0d240511-efca-484d-b7aa-7fe7954aa4db'
  ...
  FunctionsToExport = 'Add-AzSubscriptionPolicyUpdatePolicy', 'Enable-AzSubscription', 'Get-AzSubscription', 'Get-AzSubscriptionAlias', 'Get-AzSubscriptionBillingAccountPolicy', 'Get-AzSubscriptionLocation', 'Get-AzSubscriptionOperationResult', 'Get-AzSubscriptionPolicy', 'Get-AzSubscriptionTenant', 'Invoke-AzSubscriptionAcceptSubscriptionOwnership', 'Invoke-AzSubscriptionAcceptSubscriptionOwnershipStatus', 'Invoke-AzSubscriptionCancel2023Subscription', 'Invoke-AzSubscriptionEnable2023Subscription', 'New-AzSubscriptionAlias', 'Remove-AzSubscriptionAlias', 'Rename-AzSubscription', 'Stop-AzSubscription', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
