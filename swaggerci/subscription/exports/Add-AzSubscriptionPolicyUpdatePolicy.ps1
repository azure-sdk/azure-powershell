...
.Link
https://learn.microsoft.com/powershell/module/az.subscription/add-azsubscriptionpolicyupdatepolicy
#>
function Add-AzSubscriptionPolicyUpdatePolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IGetTenantPolicyResponse])]
