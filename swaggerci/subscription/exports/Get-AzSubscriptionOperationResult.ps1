...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.subscription/get-azsubscriptionoperationresult
#>
function Get-AzSubscriptionOperationResult {
...
param(
    ...
    [System.String]
    # operationId is the id returned by async operations.
    ${OperationId},
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Subscription.private\Get-AzSubscriptionOperationResult_Get';
            GetViaIdentity = 'Az.Subscription.private\Get-AzSubscriptionOperationResult_GetViaIdentity';
        }
