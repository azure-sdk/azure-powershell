...
INPUTOBJECT <ISubscriptionIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.subscription/invoke-azsubscriptioncancel2023subscription
#>
function Invoke-AzSubscriptionCancel2023Subscription {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Cancel2023', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Cancel2023')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.DefaultInfo(Script='(Get-AzContext).Subscription.Id')]
    [System.String]
    # Subscription Id.
    ...
    [Parameter(ParameterSetName='Cancel2023ViaIdentity', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.ISubscriptionIdentity]
    # Identity Parameter
    # To construct, see NOTES section for INPUTOBJECT properties and create a hash table.
...
begin {
    try {
        ...
        $mapping = @{
            Cancel2023 = 'Az.Subscription.private\Invoke-AzSubscriptionCancel2023Subscription_Cancel2023';
            Cancel2023ViaIdentity = 'Az.Subscription.private\Invoke-AzSubscriptionCancel2023Subscription_Cancel2023ViaIdentity';
        }
        if (('Cancel2023') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
INPUTOBJECT <ISubscriptionIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.subscription/invoke-azsubscriptionenable2023subscription
#>
function Invoke-AzSubscriptionEnable2023Subscription {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Enable2023', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Enable2023')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.DefaultInfo(Script='(Get-AzContext).Subscription.Id')]
    [System.String]
    # Subscription Id.
    ...
    [Parameter(ParameterSetName='Enable2023ViaIdentity', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.ISubscriptionIdentity]
    # Identity Parameter
    # To construct, see NOTES section for INPUTOBJECT properties and create a hash table.
...
begin {
    try {
        ...
        $mapping = @{
            Enable2023 = 'Az.Subscription.private\Invoke-AzSubscriptionEnable2023Subscription_Enable2023';
            Enable2023ViaIdentity = 'Az.Subscription.private\Invoke-AzSubscriptionEnable2023Subscription_Enable2023ViaIdentity';
        }
        if (('Enable2023') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
