...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IAcceptOwnershipRequest
.Inputs
...
.Link
https://learn.microsoft.com/powershell/module/az.subscription/invoke-azsubscriptionacceptsubscriptionownership
#>
...
param(
    ...
    [Parameter(ParameterSetName='AcceptViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20211001Preview.IAcceptOwnershipRequestPropertiesTags]))]
