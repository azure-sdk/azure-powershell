...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetDryrun=>GET:"/{resourceUri}/{providers}/Microsoft.ServiceLinker/{dryruns}/{resourceUri}/{dryrunName}"
    /// </remarks>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.LinkersGetDryrun(InputObject.Provider ?? null, InputObject.Dryrun ?? null, InputObject.ResourceUri ?? null, InputObject.DryrunName ?? null, onOk, onDefault, this, Pipeline);
                    }
