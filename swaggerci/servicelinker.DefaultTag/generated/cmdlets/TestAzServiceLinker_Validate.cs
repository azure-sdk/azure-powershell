...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Validate=>POST:"/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}/validateLinker"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzServiceLinker_Validate", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Description(@"Validate a Linker.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.HttpPath(Path = "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}/validateLinker", ApiVersion = "2024-07-01-preview")]
    public partial class TestAzServiceLinker_Validate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="Linker" /> property.</summary>
        ...
        public string Linker { get => this._linker; set => this._linker = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "{resourceUri}")]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult">Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of TestAzServiceLinker_Validate</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Cmdlets.TestAzServiceLinker_Validate Clone()
        {
            var clone = new TestAzServiceLinker_Validate();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LinkerValidate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkerValidate(Provider, Linker, ResourceUri, Name, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Provider=Provider,Linker=Linker,ResourceUri=ResourceUri,Name=Name})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzServiceLinker_Validate" /> cmdlet class.
        /// </summary>
        public TestAzServiceLinker_Validate()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Provider=Provider, Linker=Linker, ResourceUri=ResourceUri, Name=Name })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Provider=Provider, Linker=Linker, ResourceUri=ResourceUri, Name=Name })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult
