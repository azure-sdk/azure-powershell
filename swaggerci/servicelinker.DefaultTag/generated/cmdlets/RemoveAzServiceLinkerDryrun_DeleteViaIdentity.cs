...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteDryrun=>DELETE:"/{resourceUri}/{providers}/Microsoft.ServiceLinker/{dryruns}/{resourceUri}/{dryrunName}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.HttpPath(Path = "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{dryruns}/{resourceUri}/{dryrunName}", ApiVersion = "2024-07-01-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (null == InputObject.Dryrun)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.Dryrun"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.LinkersDeleteDryrun(InputObject.Provider ?? null, InputObject.Dryrun ?? null, InputObject.ResourceUri ?? null, InputObject.DryrunName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
