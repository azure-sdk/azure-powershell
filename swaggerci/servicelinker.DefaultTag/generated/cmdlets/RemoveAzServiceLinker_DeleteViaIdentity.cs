...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}"
    /// </remarks>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.LinkerDelete(InputObject.Provider ?? null, InputObject.Linker ?? null, InputObject.ResourceUri ?? null, InputObject.LinkerName ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
