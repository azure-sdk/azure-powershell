...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview
{
    ...
    public partial class ConfigurationInfo
    {
        ...
        internal ConfigurationInfo(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            {_configurationStore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("configurationStore"), out var __jsonConfigurationStore) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.ConfigurationStore.FromJson(__jsonConfigurationStore) : ConfigurationStore;}
            ...
            {_customizedKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("customizedKeys"), out var __jsonCustomizedKeys) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.ConfigurationInfoCustomizedKeys.FromJson(__jsonCustomizedKeys) : CustomizedKey;}
            {_additionalConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("additionalConfigurations"), out var __jsonAdditionalConfigurations) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.ConfigurationInfoAdditionalConfigurations.FromJson(__jsonAdditionalConfigurations) : AdditionalConfiguration;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IConfigurationInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IConfigurationInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IConfigurationInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode node)
        {
