...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview
{
    ...
    public partial class LinkerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.ILinkerProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.ILinkerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.ILinkerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode node)
        {
        ...
        internal LinkerProperties(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            {_targetService = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("targetService"), out var __jsonTargetService) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.TargetServiceBase.FromJson(__jsonTargetService) : TargetService;}
            {_authInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("authInfo"), out var __jsonAuthInfo) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.AuthInfoBase.FromJson(__jsonAuthInfo) : AuthInfo;}
            {_vNetSolution = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("vNetSolution"), out var __jsonVNetSolution) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.VNetSolution.FromJson(__jsonVNetSolution) : VNetSolution;}
            {_secretStore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("secretStore"), out var __jsonSecretStore) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.SecretStore.FromJson(__jsonSecretStore) : SecretStore;}
            {_publicNetworkSolution = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("publicNetworkSolution"), out var __jsonPublicNetworkSolution) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.PublicNetworkSolution.FromJson(__jsonPublicNetworkSolution) : PublicNetworkSolution;}
            {_configurationInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("configurationInfo"), out var __jsonConfigurationInfo) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.ConfigurationInfo.FromJson(__jsonConfigurationInfo) : ConfigurationInfo;}
