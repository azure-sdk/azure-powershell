...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview
{
    ...
    public partial class AzureKeyVaultProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureKeyVaultProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureKeyVaultPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBase"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBase __azureResourcePropertiesBase = new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.AzureResourcePropertiesBase();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBaseInternal.Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBaseInternal)__azureResourcePropertiesBase).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBaseInternal)__azureResourcePropertiesBase).Type = value; }
        ...
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBaseInternal)__azureResourcePropertiesBase).Type; }
    ...
    public partial interface IAzureKeyVaultProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBase
    {
        /// <summary>True if connect via Kubernetes CSI Driver.</summary>
    ...
    internal partial interface IAzureKeyVaultPropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201Preview.IAzureResourcePropertiesBaseInternal
    {
        /// <summary>True if connect via Kubernetes CSI Driver.</summary>
        bool? ConnectAsKubernetesCsiDriver { get; set; }
