...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourcePropertiesBase Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourceInternal.ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.AzureResourcePropertiesBase()); set { {_resourceProperty = value;} } }

        /// <summary>Internal Acessors for ResourcePropertyType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourceInternal.ResourcePropertyType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourcePropertiesBaseInternal)ResourceProperty).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourcePropertiesBaseInternal)ResourceProperty).Type = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourcePropertiesBase ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.AzureResourcePropertiesBase()); set => this._resourceProperty = value; }
        ...
        public string ResourcePropertyType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20221101Preview.IAzureResourcePropertiesBaseInternal)ResourceProperty).Type; }
