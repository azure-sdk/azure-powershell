...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201
{
    ...
    public partial class LinkerProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.ILinkerProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.ILinkerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.ILinkerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode node)
        {
        ...
        internal LinkerProperties(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            {_targetService = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("targetService"), out var __jsonTargetService) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.TargetServiceBase.FromJson(__jsonTargetService) : TargetService;}
            {_authInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("authInfo"), out var __jsonAuthInfo) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.AuthInfoBase.FromJson(__jsonAuthInfo) : AuthInfo;}
            {_vNetSolution = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("vNetSolution"), out var __jsonVNetSolution) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.VNetSolution.FromJson(__jsonVNetSolution) : VNetSolution;}
            {_secretStore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("secretStore"), out var __jsonSecretStore) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240201.SecretStore.FromJson(__jsonSecretStore) : SecretStore;}
