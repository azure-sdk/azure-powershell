...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501
{
    ...
    public partial class AzureKeyVaultProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureKeyVaultProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureKeyVaultPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBase"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBase __azureResourcePropertiesBase = new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.AzureResourcePropertiesBase();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBaseInternal.Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBaseInternal)__azureResourcePropertiesBase).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBaseInternal)__azureResourcePropertiesBase).Type = value; }
        ...
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBaseInternal)__azureResourcePropertiesBase).Type; }
    ...
    public partial interface IAzureKeyVaultProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBase
    {
        /// <summary>True if connect via Kubernetes CSI Driver.</summary>
    ...
    internal partial interface IAzureKeyVaultPropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230501.IAzureResourcePropertiesBaseInternal
    {
        /// <summary>True if connect via Kubernetes CSI Driver.</summary>
        bool? ConnectAsKubernetesCsiDriver { get; set; }
