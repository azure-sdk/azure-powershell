...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview
{
    ...
    public partial class AuthInfoBase
    {
        ...
        internal AuthInfoBase(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            {_authMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString>("authMode"), out var __jsonAuthMode) ? (string)__jsonAuthMode : (string)AuthMode;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IAuthInfoBase.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IAuthInfoBase interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IAuthInfoBase.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IAuthInfoBase FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("authType") )
            {
                ...
                {
                    return new EasyAuthMicrosoftEntraIdAuthInfo(json);
                }
            }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._authMode)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString(this._authMode.ToString()) : null, "authMode" ,container.Add );
