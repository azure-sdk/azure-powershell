...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview
{
    ...
    public partial class ConfigurationInfo
    {
        ...
        internal ConfigurationInfo(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            {_daprProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("daprProperties"), out var __jsonDaprProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.DaprProperties.FromJson(__jsonDaprProperties) : DaprProperty;}
            {_configurationStore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("configurationStore"), out var __jsonConfigurationStore) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.ConfigurationStore.FromJson(__jsonConfigurationStore) : ConfigurationStore;}
            ...
            {_customizedKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("customizedKeys"), out var __jsonCustomizedKeys) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.ConfigurationInfoCustomizedKeys.FromJson(__jsonCustomizedKeys) : CustomizedKey;}
            {_additionalConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("additionalConfigurations"), out var __jsonAdditionalConfigurations) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.ConfigurationInfoAdditionalConfigurations.FromJson(__jsonAdditionalConfigurations) : AdditionalConfiguration;}
            {_additionalConnectionStringProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject>("additionalConnectionStringProperties"), out var __jsonAdditionalConnectionStringProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.ConfigurationInfoAdditionalConnectionStringProperties.FromJson(__jsonAdditionalConnectionStringProperties) : AdditionalConnectionStringProperty;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IConfigurationInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IConfigurationInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IConfigurationInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._daprProperty ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) this._daprProperty.ToJson(null,serializationMode) : null, "daprProperties" ,container.Add );
            AddIf( null != this._configurationStore ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) this._configurationStore.ToJson(null,serializationMode) : null, "configurationStore" ,container.Add );
            ...
            AddIf( null != this._additionalConnectionStringProperty ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) this._additionalConnectionStringProperty.ToJson(null,serializationMode) : null, "additionalConnectionStringProperties" ,container.Add );
