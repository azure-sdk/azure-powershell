...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview
{
    ...
    public partial class SourceConfigurationTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <paramref name="sourceValue"/> parameter to the <see cref="SourceConfiguration"/>
        /// type.
        /// </summary>
        ...
        /// <summary>
        /// Converts the <paramref name="sourceValue" /> parameter into an instance of <see cref="SourceConfiguration" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="SourceConfiguration" />.</param>
        /// <returns>
        /// an instance of <see cref="SourceConfiguration" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.ISourceConfiguration ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.ISourceConfiguration).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
