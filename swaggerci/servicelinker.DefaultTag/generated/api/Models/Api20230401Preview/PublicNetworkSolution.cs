...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview
{
    ...
    public partial class PublicNetworkSolution :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IPublicNetworkSolution,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IPublicNetworkSolutionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRules _firewallRule;

        /// <summary>
        /// Describe firewall rules of target service to make sure source application could connect to the target.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRules FirewallRule { get => (this._firewallRule = this._firewallRule ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.FirewallRules()); set => this._firewallRule = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AllowType? FirewallRuleAzureService { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRulesInternal)FirewallRule).AzureService; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRulesInternal)FirewallRule).AzureService = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AllowType)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AllowType? FirewallRuleCallerClientIP { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRulesInternal)FirewallRule).CallerClientIP; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRulesInternal)FirewallRule).CallerClientIP = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AllowType)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.PropertyOrigin.Inlined)]
        public string[] FirewallRuleIPRange { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRulesInternal)FirewallRule).IPRange; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRulesInternal)FirewallRule).IPRange = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for FirewallRule</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRules Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IPublicNetworkSolutionInternal.FirewallRule { get => (this._firewallRule = this._firewallRule ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.FirewallRules()); set { {_firewallRule = value;} } }
...

    {
        ...
        /// Describe firewall rules of target service to make sure source application could connect to the target.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20230401Preview.IFirewallRules FirewallRule { get; set; }
        /// <summary>Allow Azure services to access the target service if true.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Support.AllowType? FirewallRuleAzureService { get; set; }
        /// <summary>
        /// Allow caller client IP to access the target service if true. the property is used when connecting local application to
