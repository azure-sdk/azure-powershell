...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models
{
    ...
    public partial class ServiceLinkerIdentity
    {
        ...
        internal ServiceLinkerIdentity(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject json)
        {
            ...
            {_provider = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString>("providers"), out var __jsonProviders) ? (string)__jsonProviders : (string)Provider;}
            ...
            {_linker = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString>("linkers"), out var __jsonLinkers) ? (string)__jsonLinkers : (string)Linker;}
            ...
            {_dryrun = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString>("dryruns"), out var __jsonDryruns) ? (string)__jsonDryruns : (string)Dryrun;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._provider)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString(this._provider.ToString()) : null, "providers" ,container.Add );
            ...
            AddIf( null != (((object)this._linker)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString(this._linker.ToString()) : null, "linkers" ,container.Add );
            ...
            AddIf( null != (((object)this._dryrun)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Runtime.Json.JsonString(this._dryrun.ToString()) : null, "dryruns" ,container.Add );
