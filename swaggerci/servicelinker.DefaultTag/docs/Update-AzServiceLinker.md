...
```
Update-AzServiceLinker -Linker <String> -Name <String> -Provider <String> -ResourceUri <String>
 ...
 [-VNetSolutionType <VNetSolutionType>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
