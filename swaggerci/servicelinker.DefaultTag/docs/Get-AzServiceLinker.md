...
### List (Default)
```
Get-AzServiceLinker -Provider <String> -ResourceUri <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzServiceLinker -Linker <String> -Name <String> -Provider <String> -ResourceUri <String>
