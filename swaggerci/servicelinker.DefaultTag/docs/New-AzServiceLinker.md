...
```
New-AzServiceLinker -Linker <String> -Name <String> -Provider <String> -ResourceUri <String>
 [-AuthInfoAuthMode <AuthMode>] [-AuthInfoAuthType <AuthType>] [-ClientType <ClientType>]
