@{
  GUID = '63ef9c9e-eb30-445c-b448-5292a060b0d7'
  ...
  FunctionsToExport = 'Get-AzServiceLinker', 'Get-AzServiceLinkerConfiguration', 'New-AzServiceLinker', 'Test-AzServiceLinker', 'Update-AzServiceLinker', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
