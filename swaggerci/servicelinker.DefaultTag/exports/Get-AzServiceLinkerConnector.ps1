...
.Link
https://learn.microsoft.com/powershell/module/az.servicelinker/get-azservicelinkerconnector
#>
function Get-AzServiceLinkerConnector {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.ILinkerResource])]
