...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20231101Preview.IValidateOperationResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20231101Preview.IValidateOperationResult])]
