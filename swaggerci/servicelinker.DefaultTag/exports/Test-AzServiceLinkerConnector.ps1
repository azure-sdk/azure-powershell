...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult
.Notes
...
INPUTOBJECT <IServiceLinkerIdentity>: Identity Parameter
  [ConnectorName <String>]: The name of the LinkerResource
  [Dryrun <String>]: The name of the DryrunResource
  [DryrunName <String>]: The name of dryrun.
  [Id <String>]: Resource identity path
  [Linker <String>]: The name of the LinkerResource
  [LinkerName <String>]: The name Linker resource.
  [Location <String>]: The name of Azure region.
  [Provider <String>]: {resourceUri}
  [ResourceGroupName <String>]: The name of the resource group. The name is case insensitive.
  [ResourceUri <String>]: The fully qualified Azure Resource manager identifier of the resource to be connected.
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.servicelinker/test-azservicelinkerconnector
#>
function Test-AzServiceLinkerConnector {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ServiceLinker.Models.Api20240701Preview.IValidateOperationResult])]
