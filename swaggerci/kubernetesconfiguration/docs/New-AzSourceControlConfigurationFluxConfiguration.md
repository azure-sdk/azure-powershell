...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/new-azsourcecontrolconfigurationfluxconfiguration
schema: 2.0.0
---

# New-AzSourceControlConfigurationFluxConfiguration
...
```
New-AzSourceControlConfigurationFluxConfiguration -ClusterName <String> -ClusterResourceName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ScopeType
Parameter Sets: (All)
Aliases:
