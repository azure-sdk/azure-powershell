...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/get-azsourcecontrolconfigurationfluxconfigoperationstatus
schema: 2.0.0
---

# Get-AzSourceControlConfigurationFluxConfigOperationStatus
...
### Get (Default)
```
Get-AzSourceControlConfigurationFluxConfigOperationStatus -ClusterName <String> -ClusterResourceName <String>
 -ClusterRp <String> -FluxConfigurationName <String> -OperationId <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSourceControlConfigurationFluxConfigOperationStatus -InputObject <ISourceControlConfigurationIdentity>
