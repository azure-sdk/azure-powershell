...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/get-azsourcecontrolconfigurationfluxconfiguration
#>
function Get-AzSourceControlConfigurationFluxConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SourceControlConfiguration.private\Get-AzSourceControlConfigurationFluxConfiguration_Get';
            GetViaIdentity = 'Az.SourceControlConfiguration.private\Get-AzSourceControlConfigurationFluxConfiguration_GetViaIdentity';
            List = 'Az.SourceControlConfiguration.private\Get-AzSourceControlConfigurationFluxConfiguration_List';
        }
