...
### Delete (Default)
```
Remove-AzDataShareDataSet -AccountName <String> -Name <String> -ResourceGroupName <String> -ShareName <String>
...
### DeleteViaIdentity
```
Remove-AzDataShareDataSet -InputObject <IDataShareIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
