...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support";
