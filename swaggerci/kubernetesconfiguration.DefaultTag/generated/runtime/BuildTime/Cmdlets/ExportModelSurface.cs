...
namespace Microsoft.Azure.PowerShell.Cmdlets.PrivateLinkScopes.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PrivateLinkScopes.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.PrivateLinkScopes.Support";
