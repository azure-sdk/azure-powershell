...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401
{
    ...
    public partial class LayerSelectorDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.ILayerSelectorDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.ILayerSelectorDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.OperationType? _operation;

        /// <summary>
        /// The operation to be performed on the selected layer. The default value is 'extract', but it can be set to 'copy'.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.OperationType? Operation { get => this._operation; set => this._operation = value; }

        /// <summary>Creates an new <see cref="LayerSelectorDefinition" /> instance.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.OperationType? Operation { get; set; }

    }
    /// Parameters to specify which layer to pull from the OCI artifact. By default, the first layer in the artifact is pulled.
    internal partial interface ILayerSelectorDefinitionInternal
