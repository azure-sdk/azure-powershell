...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401
{
    ...
    public partial class GitRepositoryPatchDefinition :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IGitRepositoryPatchDefinitionInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IRepositoryRefDefinition Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IGitRepositoryPatchDefinitionInternal.RepositoryRef { get => (this._repositoryRef = this._repositoryRef ?? new Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.RepositoryRefDefinition()); set { {_repositoryRef = value;} } }

        /// <summary>Backing field for <see cref="Provider" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.ProviderType? _provider;

        /// <summary>Name of the provider used for authentication.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.ProviderType? Provider { get => this._provider; set => this._provider = value; }

        /// <summary>Backing field for <see cref="RepositoryRef" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IRepositoryRefDefinition _repositoryRef;

        /// <summary>The source reference for the GitRepository object.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IRepositoryRefDefinition RepositoryRef { get => (this._repositoryRef = this._repositoryRef ?? new Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.RepositoryRefDefinition()); set => this._repositoryRef = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.PropertyOrigin.Inlined)]
        public string RepositoryRefTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IRepositoryRefDefinitionInternal)RepositoryRef).Tag; set => ((Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IRepositoryRefDefinitionInternal)RepositoryRef).Tag = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.ProviderType? Provider { get; set; }
        /// <summary>The git repository branch name to checkout.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.ProviderType? Provider { get; set; }
        /// <summary>The source reference for the GitRepository object.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IRepositoryRefDefinition RepositoryRef { get; set; }
        /// <summary>The git repository branch name to checkout.</summary>
        string RepositoryRefBranch { get; set; }
        /// <summary>
        /// The commit SHA to checkout. This value must be combined with the branch name to be valid. This takes precedence over semver.
