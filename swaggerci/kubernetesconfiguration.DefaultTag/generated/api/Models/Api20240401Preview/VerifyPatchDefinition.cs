...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview
{
    ...
    public partial class VerifyPatchDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IVerifyPatchDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IVerifyPatchDefinitionInternal
    {

        /// <summary>Backing field for <see cref="MatchOidcIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IMatchOidcIdentityPatchDefinition[] _matchOidcIdentity;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IMatchOidcIdentityPatchDefinition[] MatchOidcIdentity { get => this._matchOidcIdentity; set => this._matchOidcIdentity = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IVerifyPatchDefinitionVerificationConfig _verificationConfig;

        /// <summary>An object containing trusted public keys of trusted authors.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IVerifyPatchDefinitionVerificationConfig VerificationConfig { get => (this._verificationConfig = this._verificationConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.VerifyPatchDefinitionVerificationConfig()); set => this._verificationConfig = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IMatchOidcIdentityPatchDefinition[] MatchOidcIdentity { get; set; }
        /// <summary>Verification provider name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401Preview.IVerifyPatchDefinitionVerificationConfig VerificationConfig { get; set; }
