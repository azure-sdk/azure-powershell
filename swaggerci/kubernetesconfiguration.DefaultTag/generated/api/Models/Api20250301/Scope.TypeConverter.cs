...
namespace Microsoft.Azure.PowerShell.Cmdlets.Extensions.Models.Api20250301
{
    ...
    public partial class ScopeTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Scope" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Extensions.Models.Api20250301.IScope ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Extensions.Models.Api20250301.IScope).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
