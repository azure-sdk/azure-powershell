...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401
{
    ...
    public partial class AzureBlobDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IAzureBlobDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IAzureBlobDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IManagedIdentityDefinition _managedIdentity;

        /// <summary>Parameters to authenticate using a Managed Identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IManagedIdentityDefinition ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ManagedIdentityDefinition()); set => this._managedIdentity = value; }
        ...
        public string ManagedIdentityClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IManagedIdentityDefinitionInternal)ManagedIdentity).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IManagedIdentityDefinitionInternal)ManagedIdentity).ClientId = value ?? null; }

        /// <summary>Internal Acessors for ManagedIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IManagedIdentityDefinition Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IAzureBlobDefinitionInternal.ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ManagedIdentityDefinition()); set { {_managedIdentity = value;} } }

        /// <summary>Internal Acessors for ServicePrincipal</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IServicePrincipalDefinition Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IAzureBlobDefinitionInternal.ServicePrincipal { get => (this._servicePrincipal = this._servicePrincipal ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ServicePrincipalDefinition()); set { {_servicePrincipal = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IServicePrincipalDefinition _servicePrincipal;

        /// <summary>Parameters to authenticate using Service Principal.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IServicePrincipalDefinition ServicePrincipal { get => (this._servicePrincipal = this._servicePrincipal ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ServicePrincipalDefinition()); set => this._servicePrincipal = value; }

        /// <summary>Base64-encoded certificate used to authenticate a Service Principal</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Inlined)]
        public string ServicePrincipalClientCertificate { get => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IServicePrincipalDefinitionInternal)ServicePrincipal).ClientCertificate; set => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IServicePrincipalDefinitionInternal)ServicePrincipal).ClientCertificate = value ?? null; }
...

    {
        ...
        string LocalAuthRef { get; set; }
        /// <summary>Parameters to authenticate using a Managed Identity.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IManagedIdentityDefinition ManagedIdentity { get; set; }
        /// <summary>The client Id for authenticating a Managed Identity.</summary>
        string ManagedIdentityClientId { get; set; }
        /// <summary>The Shared Access token to access the storage container</summary>
        string SasToken { get; set; }
        /// <summary>Parameters to authenticate using Service Principal.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IServicePrincipalDefinition ServicePrincipal { get; set; }
        /// <summary>Base64-encoded certificate used to authenticate a Service Principal</summary>
        string ServicePrincipalClientCertificate { get; set; }
        /// <summary>The password for the certificate used to authenticate a Service Principal</summary>
        string ServicePrincipalClientCertificatePassword { get; set; }
