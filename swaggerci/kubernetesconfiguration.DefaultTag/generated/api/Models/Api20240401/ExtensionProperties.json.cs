...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401
{
    ...
    public partial class ExtensionProperties
    {
        ...
        internal ExtensionProperties(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_scope = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonObject>("scope"), out var __jsonScope) ? Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.Scope.FromJson(__jsonScope) : Scope;}
            ...
            {_configurationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonObject>("configurationSettings"), out var __jsonConfigurationSettings) ? Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ExtensionPropertiesConfigurationSettings.FromJson(__jsonConfigurationSettings) : ConfigurationSetting;}
            {_configurationProtectedSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonObject>("configurationProtectedSettings"), out var __jsonConfigurationProtectedSettings) ? Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ExtensionPropertiesConfigurationProtectedSettings.FromJson(__jsonConfigurationProtectedSettings) : ConfigurationProtectedSetting;}
            {_currentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonString>("currentVersion"), out var __jsonCurrentVersion) ? (string)__jsonCurrentVersion : (string)CurrentVersion;}
            ...
            {_statuses = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonArray>("statuses"), out var __jsonStatuses) ? If( __jsonStatuses as Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IExtensionStatus[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IExtensionStatus) (Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ExtensionStatus.FromJson(__u) )) ))() : null : Statuses;}
            {_customLocationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonObject>("customLocationSettings"), out var __jsonCustomLocationSettings) ? Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.ExtensionPropertiesCustomLocationSettings.FromJson(__jsonCustomLocationSettings) : CustomLocationSetting;}
            ...
            {_isSystemExtension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonBoolean>("isSystemExtension"), out var __jsonIsSystemExtension) ? (bool?)__jsonIsSystemExtension : IsSystemExtension;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IExtensionProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IExtensionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IExtensionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._currentVersion)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonString(this._currentVersion.ToString()) : null, "currentVersion" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._isSystemExtension ? (Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Json.JsonBoolean((bool)this._isSystemExtension) : null, "isSystemExtension" ,container.Add );
            }
