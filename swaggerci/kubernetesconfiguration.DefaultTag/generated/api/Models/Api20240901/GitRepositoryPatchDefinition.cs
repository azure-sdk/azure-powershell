...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901
{
    ...
    public partial class GitRepositoryPatchDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IGitRepositoryPatchDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IGitRepositoryPatchDefinitionInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IRepositoryRefDefinition Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IGitRepositoryPatchDefinitionInternal.RepositoryRef { get => (this._repositoryRef = this._repositoryRef ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.RepositoryRefDefinition()); set { {_repositoryRef = value;} } }

        /// <summary>Backing field for <see cref="RepositoryRef" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IRepositoryRefDefinition _repositoryRef;

        /// <summary>The source reference for the GitRepository object.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IRepositoryRefDefinition RepositoryRef { get => (this._repositoryRef = this._repositoryRef ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.RepositoryRefDefinition()); set => this._repositoryRef = value; }
        ...
        public string RepositoryRefBranch { get => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IRepositoryRefDefinitionInternal)RepositoryRef).Branch; set => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IRepositoryRefDefinitionInternal)RepositoryRef).Branch = value ?? null; }
...

    {
        ...
        string LocalAuthRef { get; set; }
        /// <summary>The source reference for the GitRepository object.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IRepositoryRefDefinition RepositoryRef { get; set; }
        /// <summary>The git repository branch name to checkout.</summary>
        string RepositoryRefBranch { get; set; }
        /// <summary>
        /// The commit SHA to checkout. This value must be combined with the branch name to be valid. This takes precedence over semver.
