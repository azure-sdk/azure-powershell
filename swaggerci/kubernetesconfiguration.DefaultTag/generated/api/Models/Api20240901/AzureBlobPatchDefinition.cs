...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901
{
    ...
    public partial class AzureBlobPatchDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IAzureBlobPatchDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IAzureBlobPatchDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IManagedIdentityPatchDefinition _managedIdentity;

        /// <summary>Parameters to authenticate using a Managed Identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IManagedIdentityPatchDefinition ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.ManagedIdentityPatchDefinition()); set => this._managedIdentity = value; }
        ...
        public string ManagedIdentityClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IManagedIdentityPatchDefinitionInternal)ManagedIdentity).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IManagedIdentityPatchDefinitionInternal)ManagedIdentity).ClientId = value ?? null; }

        /// <summary>Internal Acessors for ManagedIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IManagedIdentityPatchDefinition Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IAzureBlobPatchDefinitionInternal.ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.ManagedIdentityPatchDefinition()); set { {_managedIdentity = value;} } }

        /// <summary>Internal Acessors for ServicePrincipal</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinition Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IAzureBlobPatchDefinitionInternal.ServicePrincipal { get => (this._servicePrincipal = this._servicePrincipal ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.ServicePrincipalPatchDefinition()); set { {_servicePrincipal = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinition _servicePrincipal;

        /// <summary>Parameters to authenticate using Service Principal.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinition ServicePrincipal { get => (this._servicePrincipal = this._servicePrincipal ?? new Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.ServicePrincipalPatchDefinition()); set => this._servicePrincipal = value; }

        /// <summary>Base64-encoded certificate used to authenticate a Service Principal</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Inlined)]
        public string ServicePrincipalClientCertificate { get => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinitionInternal)ServicePrincipal).ClientCertificate; set => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinitionInternal)ServicePrincipal).ClientCertificate = value ?? null; }

        /// <summary>The password for the certificate used to authenticate a Service Principal</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Inlined)]
        public string ServicePrincipalClientCertificatePassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinitionInternal)ServicePrincipal).ClientCertificatePassword; set => ((Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinitionInternal)ServicePrincipal).ClientCertificatePassword = value ?? null; }
...

    {
        ...
        string LocalAuthRef { get; set; }
        /// <summary>Parameters to authenticate using a Managed Identity.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IManagedIdentityPatchDefinition ManagedIdentity { get; set; }
        /// <summary>The client Id for authenticating a Managed Identity.</summary>
        string ManagedIdentityClientId { get; set; }
        /// <summary>The Shared Access token to access the storage container</summary>
        string SasToken { get; set; }
        /// <summary>Parameters to authenticate using Service Principal.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240901.IServicePrincipalPatchDefinition ServicePrincipal { get; set; }
        /// <summary>Base64-encoded certificate used to authenticate a Service Principal</summary>
        string ServicePrincipalClientCertificate { get; set; }
        /// <summary>The password for the certificate used to authenticate a Service Principal</summary>
        string ServicePrincipalClientCertificatePassword { get; set; }
