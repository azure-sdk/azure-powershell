...
namespace Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState Compliant = @"Compliant";

        public static Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState NonCompliant = @"Non-Compliant";

        public static Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState Suspended = @"Suspended";

        public static Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState e1, Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.FluxComplianceState e2)
        {
            return !e2.Equals(e1);
        }
