...
$modulePsd1 = Get-Item -Path (Join-Path $PSScriptRoot './Az.PrivateLinkScopes.psd1')
$modulePath = $modulePsd1.FullName
$moduleName = $modulePsd1.BaseName

# Load DLL to use build-time cmdlets
Import-Module -Name $modulePath
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.PrivateLinkScopes.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.PrivateLinkScopes.Module]::Instance
