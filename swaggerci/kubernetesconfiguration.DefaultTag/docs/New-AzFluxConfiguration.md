...
online version: https://learn.microsoft.com/powershell/module/az.fluxconfiguration/new-azfluxconfiguration
schema: 2.0.0
---
...
```
New-AzFluxConfiguration -ClusterName <String> -ClusterResourceName <String> -ClusterRp <String> -Name <String>
 ...
 [-GitRepositoryProvider <ProviderType>] [-GitRepositoryRefSemver <String>] [-GitRepositoryRefTag <String>]
 ...
 [-LayerSelectorMediaType <String>] [-LayerSelectorOperation <OperationType>]
 [-ManagedIdentityClientId <String>] [-Namespace <String>] [-OciRepositoryInsecure]
 ...
 [-ReconciliationWaitDuration <String>] [-RepositoryRefBranch <String>] [-RepositoryRefCommit <String>]
 [-RepositoryRefDigest <String>] [-Scope <ScopeType>] [-ServicePrincipalClientCertificate <String>]
 ...
 [-TlConfigCaCertificate <String>] [-TlConfigClientCertificate <String>] [-TlConfigPrivateKey <String>]
 [-VerifyMatchOidcIdentity <IMatchOidcIdentityDefinition[]>] [-VerifyProvider <String>]
 [-VerifyVerificationConfig <Hashtable>] [-WaitForReconciliation] [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.ProviderType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.OperationType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.ScopeType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Support.SourceKindType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IMatchOidcIdentityDefinition[]
Parameter Sets: (All)
Aliases:
