...
online version: https://learn.microsoft.com/powershell/module/az.privatelinkscopes/update-azprivatelinkscopesprivatelinkscopetag
schema: 2.0.0
---

# Update-AzPrivateLinkScopesPrivateLinkScopeTag
...
```
Update-AzPrivateLinkScopesPrivateLinkScopeTag -ResourceGroupName <String> -ScopeName <String>
...
```
Update-AzPrivateLinkScopesPrivateLinkScopeTag -InputObject <IPrivateLinkScopesIdentity> [-Tag <Hashtable>]
