...
New-AzExtensionsExtension -ClusterName <String> -ClusterResourceName <String> -ClusterRp <String>
 ...
 [-IdentityUserAssignedIdentity <Hashtable>] [-ManagedBy <String>] [-NamespaceTargetNamespace <String>]
 [-PlanName <String>] [-PlanProduct <String>] [-PlanPromotionCode <String>] [-PlanPublisher <String>]
 [-PlanVersion <String>] [-ReleaseTrain <String>] [-Statuses <IExtensionStatus[]>] [-Version <String>]
