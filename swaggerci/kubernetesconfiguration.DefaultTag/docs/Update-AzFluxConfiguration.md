...
online version: https://learn.microsoft.com/powershell/module/az.fluxconfiguration/update-azfluxconfiguration
schema: 2.0.0
---
...
```
Update-AzFluxConfiguration -ClusterName <String> -ClusterResourceName <String> -ClusterRp <String>
 ...
 [-ManagedIdentityClientId <String>] [-OciRepositoryInsecure] [-OciRepositoryLocalAuthRef <String>]
 [-OciRepositoryRefSemver <String>] [-OciRepositoryRefTag <String>]
...
```
Update-AzFluxConfiguration -InputObject <IFluxConfigurationIdentity> [-AzureBlobAccountKey <String>]
 [-AzureBlobContainerName <String>] [-AzureBlobLocalAuthRef <String>] [-AzureBlobSasToken <String>]
 [-AzureBlobSyncIntervalInSecond <Int64>] [-AzureBlobTimeoutInSecond <Int64>] [-AzureBlobUrl <String>]
 [-BucketAccessKey <String>] [-BucketInsecure] [-BucketLocalAuthRef <String>] [-BucketName <String>]
 [-BucketSyncIntervalInSecond <Int64>] [-BucketTimeoutInSecond <Int64>] [-BucketUrl <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.FluxConfiguration.Models.Api20250401.IMatchOidcIdentityPatchDefinition[]
Parameter Sets: (All)
Aliases:
