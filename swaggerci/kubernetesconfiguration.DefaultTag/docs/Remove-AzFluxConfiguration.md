...
online version: https://learn.microsoft.com/powershell/module/az.fluxconfiguration/remove-azfluxconfiguration
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzFluxConfiguration -ClusterName <String> -ClusterResourceName <String> -ClusterRp <String>
...
### DeleteViaIdentity
```
Remove-AzFluxConfiguration -InputObject <IFluxConfigurationIdentity> [-ForceDelete]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
