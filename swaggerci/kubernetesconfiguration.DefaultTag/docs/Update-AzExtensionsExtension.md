...
online version: https://learn.microsoft.com/powershell/module/az.extensions/update-azextensionsextension
schema: 2.0.0
---

# Update-AzExtensionsExtension
...
```
Update-AzExtensionsExtension -ClusterName <String> -ClusterResourceName <String> -ClusterRp <String>
 -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-AutoUpgradeMinorVersion]
 [-AutoUpgradeMode <AutoUpgradeMode>] [-ConfigurationProtectedSetting <Hashtable>]
 [-ConfigurationSetting <Hashtable>] [-IdentityType <ResourceIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-ReleaseTrain <String>] [-Version <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzExtensionsExtension -InputObject <IExtensionsIdentity> [-AutoUpgradeMinorVersion]
 [-AutoUpgradeMode <AutoUpgradeMode>] [-ConfigurationProtectedSetting <Hashtable>]
 [-ConfigurationSetting <Hashtable>] [-IdentityType <ResourceIdentityType>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-ReleaseTrain <String>] [-Version <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
...
Only user assigned identities are supported for 'Bring your own Identity' model.
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Extensions.Models.IExtensionsIdentity
