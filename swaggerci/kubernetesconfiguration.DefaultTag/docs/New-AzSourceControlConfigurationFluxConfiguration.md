...
New-AzSourceControlConfigurationFluxConfiguration -ClusterName <String> -ClusterResourceName <String>
 ...
 [-LayerSelectorOperation <String>] [-ManagedIdentityClientId <String>] [-Namespace <String>]
 [-OciRepositoryCertSecretRef <String>] [-OciRepositoryLocalAuthRef <String>]
 ...
 [-OciRepositoryTimeoutInSecond <Int64>] [-OciRepositoryUrl <String>] [-ReconciliationWaitDuration <String>]
 ...
 [-VerifySecretRef <String>] [-WaitForReconciliation] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20240401.IMatchOidcIdentityDefinition[]
Parameter Sets: (All)
Aliases:
