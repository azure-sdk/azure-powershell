...
New-AzSourceControlConfigurationFluxConfiguration -ClusterName <String> -ClusterResourceName <String>
 ...
 [-ManagedIdentityClientId <String>] [-Namespace <String>] [-ReconciliationWaitDuration <String>]
 [-RepositoryRefBranch <String>] [-RepositoryRefCommit <String>] [-RepositoryRefSemver <String>]
 [-RepositoryRefTag <String>] [-Scope <ScopeType>] [-ServicePrincipalClientCertificate <String>]
 ...
 [-ServicePrincipalTenantId <String>] [-SourceKind <SourceKindType>] [-Suspend] [-WaitForReconciliation]
