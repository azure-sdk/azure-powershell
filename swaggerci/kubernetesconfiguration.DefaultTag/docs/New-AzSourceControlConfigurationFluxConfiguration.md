...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ProviderType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20241101.IMatchOidcIdentityDefinition[]
Parameter Sets: (All)
Aliases:
