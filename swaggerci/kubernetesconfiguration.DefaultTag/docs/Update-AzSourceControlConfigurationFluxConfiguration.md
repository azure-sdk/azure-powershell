...
```
Update-AzSourceControlConfigurationFluxConfiguration -ClusterName <String>
 -ClusterResourceName <KubernetesClusterResourceName> -ClusterRp <KubernetesClusterResourceProviderName>
 -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-AzureBlobAccountKey <String>]
