...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType Application = @"application";

        public static Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType Key = @"key";

        public static Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType ManagedIdentity = @"managedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType User = @"user";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.AzureDataManagementClient.Support.IdentityType e2)
        {
            return !e2.Equals(e1);
        }
