...
online version: https://docs.microsoft.com/en-us/powershell/module/az.intelligentdataexperiences/new-azintelligentdataexperiencesdiagnosticsetting
schema: 2.0.0
---

# New-AzIntelligentdataexperiencesDiagnosticSetting
...
```
New-AzIntelligentdataexperiencesDiagnosticSetting -Name <String> [-EventHubAuthorizationRuleId <String>]
 [-EventHubName <String>] [-Log <ILogSettings[]>] [-ServiceBusRuleId <String>] [-StorageAccountId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Intelligentdataexperiences.Models.Api20230301Preview.ILogSettings[]
Parameter Sets: (All)
Aliases:
