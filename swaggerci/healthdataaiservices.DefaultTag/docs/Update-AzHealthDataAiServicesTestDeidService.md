...
online version: https://learn.microsoft.com/powershell/module/az.healthdataaiservicestest/update-azhealthdataaiservicestestdeidservice
schema: 2.0.0
---

# Update-AzHealthDataAiServicesTestDeidService
...
```
Update-AzHealthDataAiServicesTestDeidService -Name <String> -ResourceGroupName <String>
...
```
Update-AzHealthDataAiServicesTestDeidService -InputObject <IHealthDataAiServicesTestIdentity>
