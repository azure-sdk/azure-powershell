...
online version: https://learn.microsoft.com/powershell/module/az.healthdataaiservicesfortesting/update-azhealthdataaiservicesfortestingdeidservice
schema: 2.0.0
---

# Update-AzHealthDataAiServicesForTestingDeidService
...
```
Update-AzHealthDataAiServicesForTestingDeidService -Name <String> -ResourceGroupName <String>
...
```
Update-AzHealthDataAiServicesForTestingDeidService -InputObject <IHealthDataAiServicesForTestingIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesForTesting.Support.ManagedServiceIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesForTesting.Support.PublicNetworkAccess
Parameter Sets: (All)
Aliases:
