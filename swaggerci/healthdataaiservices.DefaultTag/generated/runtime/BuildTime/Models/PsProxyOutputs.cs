...
using static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Runtime.PowerShell.PsProxyTypeExtensions;
...
{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
{Indent}{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
{Indent}{Indent}}}" : $@"{Indent}{Indent}$cmdInfo = Get-Command -Name $mapping[$parameterSet]{Environment.NewLine}{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)";
        }
...
{Indent}{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.module]::Instance.Telemetry.Invoke('Create', $MyInvocation, $parameterSet, $PSCmdlet)
{Indent}{Indent}}} else {{
        ...
        private string GetDefaultValuesStatements()
        {
            ...
            foreach (var defaultInfo in defaultInfos)
            {
                ...
                if ("SubscriptionId".Equals(parameterName))
                {
                    ...
                    sb.AppendLine($"{Indent}{Indent}{Indent}$PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object {{ if ($_) {{ $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) }} }}");
...
{Indent}{Indent}if ($preTelemetryId -eq '') {{
{Indent}{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.module]::Instance.Telemetry.Invoke('Send', $MyInvocation, $parameterSet, $PSCmdlet)
