...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>Resource creation was canceled.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>The resource is being deleted.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Failed = @"Failed";

        /// <summary>The resource is being provisioned.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Provisioning = @"Provisioning";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>The resource is being updated.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServicesTest.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
