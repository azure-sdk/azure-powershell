...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920
{
    ...
    public partial class DeidService
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject into a new instance of <see cref="DeidService" />.
        /// </summary>
        ...
        internal DeidService(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject json)
        {
            ...
            __trackedResource = new Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50.TrackedResource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.DeidServiceProperties.FromJson(__jsonProperties) : Property;}
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50.ManagedServiceIdentity.FromJson(__jsonIdentity) : Identity;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.IDeidService.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.IDeidService.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.IDeidService FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject json ? new DeidService(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DeidService" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DeidService" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode" />.
        /// </returns>
