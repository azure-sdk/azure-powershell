...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920
{
    ...
    public partial class DeidUpdate
    {
        ...
        internal DeidUpdate(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject json)
        {
            ...
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.ManagedServiceIdentityUpdate.FromJson(__jsonIdentity) : Identity;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.DeidPropertiesUpdate.FromJson(__jsonProperties) : Property;}
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.DeidUpdateTags.FromJson(__jsonTags) : Tag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.IDeidUpdate.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.IDeidUpdate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api20240920.IDeidUpdate FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode node)
        {
