...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models
{
    ...
    public partial class HealthDataAiServicesIdentity
    {
        ...
        internal HealthDataAiServicesIdentity(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject json)
        {
            ...
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)SubscriptionId;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)ResourceGroupName;}
            {_deidServiceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonString>("deidServiceName"), out var __jsonDeidServiceName) ? (string)__jsonDeidServiceName : (string)DeidServiceName;}
            {_privateEndpointConnectionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonString>("privateEndpointConnectionName"), out var __jsonPrivateEndpointConnectionName) ? (string)__jsonPrivateEndpointConnectionName : (string)PrivateEndpointConnectionName;}
