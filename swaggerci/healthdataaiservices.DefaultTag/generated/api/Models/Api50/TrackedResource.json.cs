...
namespace Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50
{
    ...
    public partial class TrackedResource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50.ITrackedResource.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50.ITrackedResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50.ITrackedResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonNode node)
        {
        ...
        internal TrackedResource(Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject json)
        {
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Models.Api50.TrackedResourceTags.FromJson(__jsonTags) : Tag;}
            {_location = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.HealthDataAiServices.Runtime.Json.JsonString>("location"), out var __jsonLocation) ? (string)__jsonLocation : (string)Location;}
            AfterFromJson(json);
        }
    }
}