...
online version: https://learn.microsoft.com/powershell/module/az.edgesitestest/new-azedgesitestestsite
schema: 2.0.0
---

# New-AzEdgeSitesTestSite
...
```
New-AzEdgeSitesTestSite -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
