...
online version: https://learn.microsoft.com/powershell/module/az.edgesitestest/new-azedgesitestestsitebysubscription
schema: 2.0.0
---

# New-AzEdgeSitesTestSiteBySubscription
...
```
New-AzEdgeSitesTestSiteBySubscription -SiteName <String> [-SubscriptionId <String>]
