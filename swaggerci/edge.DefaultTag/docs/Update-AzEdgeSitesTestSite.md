...
online version: https://learn.microsoft.com/powershell/module/az.edgesitestest/update-azedgesitestestsite
schema: 2.0.0
---

# Update-AzEdgeSitesTestSite
...
```
Update-AzEdgeSitesTestSite -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzEdgeSitesTestSite -InputObject <IEdgeSitesTestIdentity> [-AddressResourceId <String>]
