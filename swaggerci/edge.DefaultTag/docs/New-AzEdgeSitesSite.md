...
online version: https://learn.microsoft.com/powershell/module/az.edgesites/new-azedgesitessite
schema: 2.0.0
---
...
```
New-AzEdgeSitesSite -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
