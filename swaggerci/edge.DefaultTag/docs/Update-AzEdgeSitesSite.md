...
online version: https://learn.microsoft.com/powershell/module/az.edgesites/update-azedgesitessite
schema: 2.0.0
---

# Update-AzEdgeSitesSite
...
```
Update-AzEdgeSitesSite -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzEdgeSitesSite -InputObject <IEdgeSitesIdentity> [-AddressResourceId <String>] [-Description <String>]
