...
namespace Microsoft.Azure.PowerShell.Cmdlets.EdgeSitesTest.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeSitesTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.EdgeSitesTest.Support";
