...
PARAMETER <IClusterCreateRequestValidationParameters>: The cluster create request specification.
  ...
  [PublicIPTag <String>]: Gets or sets value of the IpTag associated with the public IP. Example HDInsight, SQL, Storage etc
  [PublicIPTagIptagType <String>]: Gets or sets the ipTag type: Example FirstPartyUsage.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20250115Preview.IClusterCreateValidationResult])]
...
param(
    ...
    [Parameter(ParameterSetName='ValidateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20250115Preview.IClusterDefinitionComponentVersion]))]
    ...
    [Parameter(ParameterSetName='ValidateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20250115Preview.IKafkaRestPropertiesConfigurationOverride]))]
    [System.Collections.Hashtable]
    ...
    [Parameter(ParameterSetName='ValidateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20250115Preview.IClusterCreateParametersExtendedTags]))]
    [System.Collections.Hashtable]
    # The resource tags.
    ${Tag},
