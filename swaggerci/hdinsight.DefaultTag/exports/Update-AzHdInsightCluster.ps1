...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ICluster])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IClusterPatchParametersTags]))]
