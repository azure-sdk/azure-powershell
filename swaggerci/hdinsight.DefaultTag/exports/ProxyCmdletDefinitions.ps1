...
SELECTEDCONFIGURATIONTABLELIST <IAzureMonitorTableConfiguration[]>: The table list.
  [Name <String>]: The name.
.Link
https://learn.microsoft.com/powershell/module/az.hdinsight/enable-azhdinsightextensionazuremonitoragent
#>
function Enable-AzHdInsightExtensionAzureMonitorAgent {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'Az.HdInsight.private\Enable-AzHdInsightExtensionAzureMonitorAgent_Enable';
            EnableExpanded = 'Az.HdInsight.private\Enable-AzHdInsightExtensionAzureMonitorAgent_EnableExpanded';
            EnableViaIdentity = 'Az.HdInsight.private\Enable-AzHdInsightExtensionAzureMonitorAgent_EnableViaIdentity';
            EnableViaIdentityExpanded = 'Az.HdInsight.private\Enable-AzHdInsightExtensionAzureMonitorAgent_EnableViaIdentityExpanded';
        }
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20240801Preview.IClusterConfiguration], [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20240801Preview.IClusterConfigurations])]
...
INPUTOBJECT <IHdInsightIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://learn.microsoft.com/powershell/module/az.hdinsight/get-azhdinsightextensionazuremonitoragentstatus
#>
function Get-AzHdInsightExtensionAzureMonitorAgentStatus {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.HdInsight.private\Get-AzHdInsightExtensionAzureMonitorAgentStatus_Get';
            GetViaIdentity = 'Az.HdInsight.private\Get-AzHdInsightExtensionAzureMonitorAgentStatus_GetViaIdentity';
        }
        if (('Get') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
