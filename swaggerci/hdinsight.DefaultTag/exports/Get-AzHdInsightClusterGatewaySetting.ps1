...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IGatewaySettings
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IGatewaySettings])]
