...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20240801Preview.IGatewaySettings
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20240801Preview.IGatewaySettings])]
