...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IAsyncOperationResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IAsyncOperationResult])]
