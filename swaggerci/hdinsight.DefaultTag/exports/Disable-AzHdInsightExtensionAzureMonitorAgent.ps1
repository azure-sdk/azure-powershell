...
.Link
https://learn.microsoft.com/powershell/module/az.hdinsight/disable-azhdinsightextensionazuremonitoragent
#>
function Disable-AzHdInsightExtensionAzureMonitorAgent {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'Az.HdInsight.private\Disable-AzHdInsightExtensionAzureMonitorAgent_Disable';
            DisableViaIdentity = 'Az.HdInsight.private\Disable-AzHdInsightExtensionAzureMonitorAgent_DisableViaIdentity';
        }
