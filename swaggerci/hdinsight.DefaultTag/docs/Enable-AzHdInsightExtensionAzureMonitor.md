...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20210601.IAzureMonitorRequest
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20210601.IAzureMonitorTableConfiguration[]
Parameter Sets: EnableExpanded, EnableViaIdentityExpanded
Aliases:
