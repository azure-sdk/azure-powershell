...
online version: https://learn.microsoft.com/powershell/module/az.hdinsight/new-azhdinsightextension
schema: 2.0.0
---

# New-AzHdInsightExtension
...
```
New-AzHdInsightExtension -ClusterName <String> -Name <String> -ResourceGroupName <String>
