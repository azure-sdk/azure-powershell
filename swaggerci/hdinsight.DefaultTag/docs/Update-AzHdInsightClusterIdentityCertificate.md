...
online version: https://learn.microsoft.com/powershell/module/az.hdinsight/update-azhdinsightclusteridentitycertificate
schema: 2.0.0
---

# Update-AzHdInsightClusterIdentityCertificate
...
```
Update-AzHdInsightClusterIdentityCertificate -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ApplicationId <String>] [-Certificate <String>] [-CertificatePassword <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHdInsightClusterIdentityCertificate -InputObject <IHdInsightIdentity> [-ApplicationId <String>]
 [-Certificate <String>] [-CertificatePassword <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
