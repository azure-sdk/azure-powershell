...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RestartHosts=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/restartHosts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzHdInsightVirtualMachineHost_RestartViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Description(@"Restarts the specified HDInsight cluster hosts.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.HdInsight.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/restartHosts", ApiVersion = "2024-08-01-preview")]
    public partial class RestartAzHdInsightVirtualMachineHost_RestartViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.IEventListener
    {
        ...
        /// <summary>The list of hosts which need to be restarted.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The list of hosts which need to be restarted.", ValueFromPipeline = true)]
        ...
        public string[] Hosts { get => this._hosts; set => this._hosts = value; }
        ...
        /// <returns>a duplicate instance of RestartAzHdInsightVirtualMachineHost_RestartViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Cmdlets.RestartAzHdInsightVirtualMachineHost_RestartViaIdentity Clone()
        {
            var clone = new RestartAzHdInsightVirtualMachineHost_RestartViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualMachinesRestartHosts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesRestartHostsViaIdentity(InputObject.Id, Hosts, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesRestartHosts(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, Hosts, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Hosts})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartAzHdInsightVirtualMachineHost_RestartViaIdentity" /> cmdlet class.
        /// </summary>
        public RestartAzHdInsightVirtualMachineHost_RestartViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20240801Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Hosts })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Hosts })
                    {
