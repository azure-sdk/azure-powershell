...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview
{
    ...
    public partial class Usage :
        Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IUsage,
        Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedName Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.IUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.LocalizedName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedName _name;

        /// <summary>The details about the localizable name of the used resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Origin(Microsoft.Azure.PowerShell.Cmdlets.HdInsight.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.LocalizedName()); }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The name of the used resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Origin(Microsoft.Azure.PowerShell.Cmdlets.HdInsight.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>The details about the localizable name of the used resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20230815Preview.ILocalizedName Name { get; set; }
        /// <summary>The localized name of the used resource.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The name of the used resource.</summary>
        string NameValue { get; set; }
