...
New-AzResourceMoverServiceApiMoveResource -MoveCollectionName <String> -Name <String>
 ...
 [-ResourceSettingTargetResourceName <String>] [-ResourceSettingTargetSubscriptionId <String>]
 [-SourceId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IMoveResourceDependencyOverride[]
Parameter Sets: (All)
Aliases:
