...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801
{
    ...
    public partial class SubnetResourceSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.ISubnetResourceSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.ISubnetResourceSettingsInternal
    {
        ...
        /// <summary>Gets or sets address prefixes for the subnet.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.PropertyOrigin.Owned)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IAzureResourceReference Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.ISubnetResourceSettingsInternal.NetworkSecurityGroup { get => (this._networkSecurityGroup = this._networkSecurityGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.AzureResourceReference()); set { {_networkSecurityGroup = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IAzureResourceReference _networkSecurityGroup;

        /// <summary>Defines reference to an Azure resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IAzureResourceReference NetworkSecurityGroup { get => (this._networkSecurityGroup = this._networkSecurityGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.AzureResourceReference()); set => this._networkSecurityGroup = value; }
        ...
        public string NetworkSecurityGroupSourceArmResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IAzureResourceReferenceInternal)NetworkSecurityGroup).SourceArmResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IAzureResourceReferenceInternal)NetworkSecurityGroup).SourceArmResourceId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IJsonSerializable
    {
        ...
        Required = false,
        ReadOnly = false,
        Description = @"Gets or sets address prefixes for the subnet.",
...

    {
        ...
        string Name { get; set; }
        /// <summary>Defines reference to an Azure resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20240801.IAzureResourceReference NetworkSecurityGroup { get; set; }
        /// <summary>Gets the ARM resource ID of the tracked resource being referenced.</summary>
        string NetworkSecurityGroupSourceArmResourceId { get; set; }
