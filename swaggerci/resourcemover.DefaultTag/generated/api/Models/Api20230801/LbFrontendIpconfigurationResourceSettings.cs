...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801
{
    ...
    public partial class LbFrontendIpconfigurationResourceSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.ILbFrontendIpconfigurationResourceSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.ILbFrontendIpconfigurationResourceSettingsInternal
    {

        /// <summary>Internal Acessors for Subnet</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IProxyResourceReference Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.ILbFrontendIpconfigurationResourceSettingsInternal.Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.ProxyResourceReference()); set { {_subnet = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IProxyResourceReference _subnet;

        /// <summary>Defines reference to a proxy resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IProxyResourceReference Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.ProxyResourceReference()); set => this._subnet = value; }
        ...
        public string SubnetName { get => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IProxyResourceReferenceInternal)Subnet).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IProxyResourceReferenceInternal)Subnet).Name = value ?? null; }

        /// <summary>Gets the ARM resource ID of the tracked resource being referenced.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.PropertyOrigin.Inlined)]
        public string SubnetSourceArmResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IAzureResourceReferenceInternal)Subnet).SourceArmResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IAzureResourceReferenceInternal)Subnet).SourceArmResourceId = value ?? null; }
...

    {
        ...
        string PrivateIPAllocationMethod { get; set; }
        /// <summary>Defines reference to a proxy resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api20230801.IProxyResourceReference Subnet { get; set; }
        /// <summary>Gets the name of the proxy resource on the target side.</summary>
        string SubnetName { get; set; }
        /// <summary>Gets the ARM resource ID of the tracked resource being referenced.</summary>
        string SubnetSourceArmResourceId { get; set; }
