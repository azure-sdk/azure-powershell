...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/accessPolicyAssignments/{accessPolicyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzRedisAccessPolicyAssignmentUpdate_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Adds the access policy assignment to the specified users")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    public partial class NewAzRedisAccessPolicyAssignmentUpdate_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.RedisCacheAccessPolicyAssignmentRequestResponse();

        /// <summary>Backing field for <see cref="AccessPolicyName" /> property.</summary>
        private string _accessPolicyName;

        /// <summary>The name of the access policy to assign.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the access policy to assign.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The name of the access policy to assign.",
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignment[] Assignment { get => _parametersBody.Assignment ?? null /* arrayOf */; set => _parametersBody.Assignment = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse">Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzRedisAccessPolicyAssignmentUpdate_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets.NewAzRedisAccessPolicyAssignmentUpdate_CreateExpanded Clone()
        {
            var clone = new NewAzRedisAccessPolicyAssignmentUpdate_CreateExpanded();
            ...
            clone.AccessPolicyName = this.AccessPolicyName;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisAccessPolicyAssignmentUpdate_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzRedisAccessPolicyAssignmentUpdate_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccessPolicyAssignmentCreateUpdate(ResourceGroupName, CacheName, AccessPolicyName, SubscriptionId, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,CacheName=CacheName,AccessPolicyName=AccessPolicyName,SubscriptionId=SubscriptionId,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, CacheName=CacheName, AccessPolicyName=AccessPolicyName, SubscriptionId=SubscriptionId, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, CacheName=CacheName, AccessPolicyName=AccessPolicyName, SubscriptionId=SubscriptionId, body=_parametersBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20230501.IRedisCacheAccessPolicyAssignmentRequestResponse
