...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string EndIP { get => ParametersBody.EndIP ?? null; set => ParametersBody.EndIP = value; }
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisFirewallRule ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string StartIP { get => ParametersBody.StartIP ?? null; set => ParametersBody.StartIP = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesCreateOrUpdate(ResourceGroupName, CacheName, RuleName, SubscriptionId, ParametersBody, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,CacheName=CacheName,RuleName=RuleName,SubscriptionId=SubscriptionId,body=ParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, CacheName=CacheName, RuleName=RuleName, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, CacheName=CacheName, RuleName=RuleName, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
