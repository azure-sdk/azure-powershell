...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisRebootParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        public int[] Port { get => ParametersBody.Port ?? null /* arrayOf */; set => ParametersBody.Port = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RebootType RebootType { get => ParametersBody.RebootType ?? ((Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.RebootType)""); set => ParametersBody.RebootType = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int ShardId { get => ParametersBody.ShardId ?? default(int); set => ParametersBody.ShardId = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisForceRebootResponse"
        /// /> from the remote call</param>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RedisForceRebootViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RedisForceReboot(InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
