...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/accessPolicyAssignments/{accessPolicyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRedisAccessPolicyAssignment_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Gets the list of assignments for an access policy of a redis cache")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    public partial class GetAzRedisAccessPolicyAssignment_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        /// <summary>The name of the assigned access policy.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the assigned access policy.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The name of the assigned access policy.",
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisAccessPolicyAssignment_Get" /> cmdlet class.
        /// </summary>
        public GetAzRedisAccessPolicyAssignment_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AccessPolicyAssignmentGet(ResourceGroupName, CacheName, AccessPolicyName, SubscriptionId, onOk, onDefault, this, Pipeline);
