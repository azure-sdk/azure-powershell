...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/accessPolicies/{accessPolicyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRedisAccessPolicy_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Description(@"Gets the detailed information about an access policy of a redis cache")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Generated]
    public partial class GetAzRedisAccessPolicy_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        /// <summary>The name of the access policy that is being deleted from the Redis cache.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the access policy that is being deleted from the Redis cache.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The name of the access policy that is being deleted from the Redis cache.",
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisAccessPolicy_Get" /> cmdlet class.
        /// </summary>
        public GetAzRedisAccessPolicy_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AccessPolicyGet(ResourceGroupName, CacheName, Name, SubscriptionId, onOk, onDefault, this, Pipeline);
