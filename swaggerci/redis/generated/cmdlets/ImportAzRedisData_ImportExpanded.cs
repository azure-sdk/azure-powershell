...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        public string[] File { get => ParametersBody.File ?? null /* arrayOf */; set => ParametersBody.File = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IImportRdbParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisImportData(ResourceGroupName, Name, SubscriptionId, ParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
