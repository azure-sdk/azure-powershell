...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        public string LinkedRedisCacheId { get => ParametersBody.LinkedRedisCacheId ?? null; set => ParametersBody.LinkedRedisCacheId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LinkedRedisCacheLocation { get => ParametersBody.LinkedRedisCacheLocation ?? null; set => ParametersBody.LinkedRedisCacheLocation = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IRedisLinkedServerCreateParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Redis.Support.ReplicationRole ServerRole { get => ParametersBody.ServerRole; set => ParametersBody.ServerRole = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkedServerCreate(ResourceGroupName, Name, LinkedServerName, SubscriptionId, ParametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,Name=Name,LinkedServerName=LinkedServerName,SubscriptionId=SubscriptionId,body=ParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, LinkedServerName=LinkedServerName, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, Name=Name, LinkedServerName=LinkedServerName, SubscriptionId=SubscriptionId, body=ParametersBody })
                    {
