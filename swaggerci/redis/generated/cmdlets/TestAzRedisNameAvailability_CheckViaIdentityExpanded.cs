...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzRedisNameAvailability_CheckViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class TestAzRedisNameAvailability_CheckViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ICheckNameAvailabilityParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.CheckNameAvailabilityParameters();

        /// <summary>Parameters body to pass for resource name availability check.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ICheckNameAvailabilityParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Resource type. The only legal value of this property for checking redis cache name availability is 'Microsoft.Cache/redis'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Redis.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Redis.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RedisCheckNameAvailabilityViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RedisCheckNameAvailability(InputObject.SubscriptionId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzRedisNameAvailability_CheckViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public TestAzRedisNameAvailability_CheckViaIdentityExpanded()
        {
