...
namespace Microsoft.Azure.PowerShell.Cmdlets.Redis.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Redis.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IExportRdbParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.ExportRdbParameters();

        /// <summary>Parameters for Redis export operation.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Redis.Models.Api20210601.IExportRdbParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Prefix { get => ParametersBody.Prefix ?? null; set => ParametersBody.Prefix = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RedisExportDataViaIdentity(InputObject.Id, ParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RedisExportData(InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
