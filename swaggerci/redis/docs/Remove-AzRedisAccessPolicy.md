...
online version: https://learn.microsoft.com/powershell/module/az.redis/remove-azredisaccesspolicy
schema: 2.0.0
---

# Remove-AzRedisAccessPolicy
...
### Delete (Default)
```
Remove-AzRedisAccessPolicy -CacheName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzRedisAccessPolicy -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
