...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redis/remove-azredis
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzRedis -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRedis -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
