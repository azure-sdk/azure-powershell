...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redis/remove-azredisprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzRedisPrivateEndpointConnection -CacheName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRedisPrivateEndpointConnection -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-PassThru]
