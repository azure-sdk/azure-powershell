...
online version: https://learn.microsoft.com/powershell/module/az.redis/remove-azredisaccesspolicyassignment
schema: 2.0.0
---

# Remove-AzRedisAccessPolicyAssignment
...
### Delete (Default)
```
Remove-AzRedisAccessPolicyAssignment -AccessPolicyName <String> -CacheName <String>
...
### DeleteViaIdentity
```
Remove-AzRedisAccessPolicyAssignment -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-AsJob]
