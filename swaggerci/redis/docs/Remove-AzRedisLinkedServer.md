...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redis/remove-azredislinkedserver
schema: 2.0.0
---

# Remove-AzRedisLinkedServer
...
### Delete (Default)
```
Remove-AzRedisLinkedServer -LinkedServerName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzRedisLinkedServer -InputObject <IRedisIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
