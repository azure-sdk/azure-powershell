...
namespace Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.CheckNameAvailabilityReason AlreadyExists = @"AlreadyExists";

        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.CheckNameAvailabilityReason Invalid = @"Invalid";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.CheckNameAvailabilityReason e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.CheckNameAvailabilityReason e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.CheckNameAvailabilityReason e1, Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.CheckNameAvailabilityReason e2)
        {
            return !e2.Equals(e1);
        }
