...
namespace Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Provisioning state in progress.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState InProgress = @"InProgress";

        /// <summary>Provisioning state succeeded.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.VideoAnalyzer.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
