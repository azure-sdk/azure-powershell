...
online version: https://docs.microsoft.com/en-us/powershell/module/az.marketplacerpservice/invoke-azmarketplacerpservicecollectionprivatestoretosubscriptionmapping
schema: 2.0.0
---

# Invoke-AzMarketplaceRpServiceCollectionPrivateStoreToSubscriptionMapping
...
```
Invoke-AzMarketplaceRpServiceCollectionPrivateStoreToSubscriptionMapping -PrivateStoreId <String>
...
```
Invoke-AzMarketplaceRpServiceCollectionPrivateStoreToSubscriptionMapping
 -InputObject <IMarketplaceRpServiceIdentity> -Payload <ICollectionsToSubscriptionsMappingPayload>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.ICollectionsToSubscriptionsMappingPayload
...
### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.ICollectionsToSubscriptionsMappingPayload

### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.IMarketplaceRpServiceIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.ICollectionsToSubscriptionsMappingResponseProperties
