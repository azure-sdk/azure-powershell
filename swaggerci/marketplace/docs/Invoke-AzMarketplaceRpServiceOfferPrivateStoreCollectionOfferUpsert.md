...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20220901.IMultiContextAndPlansPayload
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20220901.IContextAndPlansDetails[]
Parameter Sets: OfferExpanded, OfferViaIdentityExpanded
Aliases:
