...
Invoke-AzMarketplaceRpServiceQueryPrivateStoreApprovedPlan -PrivateStoreId <String> [-OfferId <String>]
 [-PlanId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-AzMarketplaceRpServiceQueryPrivateStoreApprovedPlan -InputObject <IMarketplaceRpServiceIdentity>
 [-OfferId <String>] [-PlanId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.IQueryApprovedPlansPayload
...
### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.IQueryApprovedPlansDetails
