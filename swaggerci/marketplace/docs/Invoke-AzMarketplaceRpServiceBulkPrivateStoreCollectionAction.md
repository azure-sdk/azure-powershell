...
online version: https://docs.microsoft.com/en-us/powershell/module/az.marketplacerpservice/invoke-azmarketplacerpservicebulkprivatestorecollectionaction
schema: 2.0.0
---

# Invoke-AzMarketplaceRpServiceBulkPrivateStoreCollectionAction
...
```
Invoke-AzMarketplaceRpServiceBulkPrivateStoreCollectionAction -PrivateStoreId <String> [-Action <String>]
 [-CollectionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Bulk
```
Invoke-AzMarketplaceRpServiceBulkPrivateStoreCollectionAction -PrivateStoreId <String>
 -Payload <IBulkCollectionsPayload> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BulkViaIdentity
```
Invoke-AzMarketplaceRpServiceBulkPrivateStoreCollectionAction -InputObject <IMarketplaceRpServiceIdentity>
 -Payload <IBulkCollectionsPayload> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-AzMarketplaceRpServiceBulkPrivateStoreCollectionAction -InputObject <IMarketplaceRpServiceIdentity>
 [-Action <String>] [-CollectionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.IBulkCollectionsPayload
...
### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.IBulkCollectionsPayload

### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.IMarketplaceRpServiceIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Models.Api20211201.IBulkCollectionsResponse
