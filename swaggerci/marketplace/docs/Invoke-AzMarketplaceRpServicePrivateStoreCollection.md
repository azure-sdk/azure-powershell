...
online version: https://docs.microsoft.com/en-us/powershell/module/az.marketplacerpservice/invoke-azmarketplacerpserviceprivatestorecollection
schema: 2.0.0
---

# Invoke-AzMarketplaceRpServicePrivateStoreCollection
...
### Post (Default)
```
Invoke-AzMarketplaceRpServicePrivateStoreCollection -CollectionId <String> -PrivateStoreId <String>
 -Payload <Operation> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-AzMarketplaceRpServicePrivateStoreCollection -InputObject <IMarketplaceRpServiceIdentity>
 -Payload <Operation> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
