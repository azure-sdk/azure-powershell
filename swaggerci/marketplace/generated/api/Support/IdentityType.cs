...
namespace Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType Application = @"Application";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType Key = @"Key";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType ManagedIdentity = @"ManagedIdentity";

        public static Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType User = @"User";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.MarketplaceRpService.Support.IdentityType e2)
        {
            return !e2.Equals(e1);
        }
