...
Update-AzRecoveryServicesVault -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-SoftDeleteSettingSoftDeleteState <SoftDeleteState>] [-SourceScanConfigurationState <State>]
 [-SourceScanIdentityOperationIdentityType <IdentityType>] [-SourceScanIdentityUserAssignedIdentity <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.IdentityType
Parameter Sets: (All)
Aliases:
