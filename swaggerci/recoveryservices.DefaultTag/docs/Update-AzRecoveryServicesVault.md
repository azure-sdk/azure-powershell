...
Update-AzRecoveryServicesVault -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-RedundancySettingStandardTierStorageRedundancy <StandardTierStorageRedundancy>] [-SkuCapacity <String>]
 [-SkuFamily <String>] [-SkuName <SkuName>] [-SkuSize <String>] [-SkuTier <String>]
