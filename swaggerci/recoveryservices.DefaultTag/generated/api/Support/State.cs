...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State Disabled = @"Disabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State Enabled = @"Enabled";

        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State Invalid = @"Invalid";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.State e2)
        {
            return !e2.Equals(e1);
        }
