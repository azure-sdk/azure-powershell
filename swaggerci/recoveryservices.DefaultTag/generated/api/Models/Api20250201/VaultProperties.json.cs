...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201
{
    ...
    public partial class VaultProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.IVaultProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.IVaultProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.IVaultProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonNode node)
        {
        ...
        internal VaultProperties(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject json)
        {
            ...
            {_upgradeDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("upgradeDetails"), out var __jsonUpgradeDetails) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.UpgradeDetails.FromJson(__jsonUpgradeDetails) : UpgradeDetail;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.VaultPropertiesEncryption.FromJson(__jsonEncryption) : Encryption;}
            {_moveDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("moveDetails"), out var __jsonMoveDetails) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.VaultPropertiesMoveDetails.FromJson(__jsonMoveDetails) : MoveDetail;}
            {_monitoringSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("monitoringSettings"), out var __jsonMonitoringSettings) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.MonitoringSettings.FromJson(__jsonMonitoringSettings) : MonitoringSetting;}
            {_restoreSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("restoreSettings"), out var __jsonRestoreSettings) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.RestoreSettings.FromJson(__jsonRestoreSettings) : RestoreSetting;}
            {_redundancySetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("redundancySettings"), out var __jsonRedundancySettings) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.VaultPropertiesRedundancySettings.FromJson(__jsonRedundancySettings) : RedundancySetting;}
            {_securitySetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("securitySettings"), out var __jsonSecuritySettings) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.SecuritySettings.FromJson(__jsonSecuritySettings) : SecuritySetting;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.IPrivateEndpointConnectionVaultProperties[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.IPrivateEndpointConnectionVaultProperties) (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20250201.PrivateEndpointConnectionVaultProperties.FromJson(__u) )) ))() : null : PrivateEndpointConnection;}
