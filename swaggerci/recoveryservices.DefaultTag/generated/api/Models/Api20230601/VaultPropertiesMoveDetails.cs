...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601
{
    ...
    public partial class VaultPropertiesMoveDetails :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetails,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetailsInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetailsInternal.CompletionTimeUtc { get => this._completionTimeUtc; set { {_completionTimeUtc = value;} } }

        /// <summary>Internal Acessors for OperationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetailsInternal.OperationId { get => this._operationId; set { {_operationId = value;} } }

        /// <summary>Internal Acessors for SourceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetailsInternal.SourceResourceId { get => this._sourceResourceId; set { {_sourceResourceId = value;} } }

        /// <summary>Internal Acessors for StartTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetailsInternal.StartTimeUtc { get => this._startTimeUtc; set { {_startTimeUtc = value;} } }

        /// <summary>Internal Acessors for TargetResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230601.IVaultPropertiesMoveDetailsInternal.TargetResourceId { get => this._targetResourceId; set { {_targetResourceId = value;} } }
