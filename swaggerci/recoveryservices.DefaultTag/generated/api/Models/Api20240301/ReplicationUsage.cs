...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301
{
    ...
    public partial class ReplicationUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IReplicationUsageInternal
    {
        ...
        public int? JobSummaryFailedJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummaryInternal)JobsSummary).FailedJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummaryInternal)JobsSummary).FailedJob = value ?? default(int); }

        /// <summary>Count of in-progress jobs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? JobSummaryInProgressJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummaryInternal)JobsSummary).InProgressJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummaryInternal)JobsSummary).InProgressJob = value ?? default(int); }

        /// <summary>Count of suspended jobs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? JobSummarySuspendedJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummaryInternal)JobsSummary).SuspendedJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummaryInternal)JobsSummary).SuspendedJob = value ?? default(int); }

        /// <summary>Backing field for <see cref="JobsSummary" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummary _jobsSummary;

        /// <summary>Summary of the replication jobs data for this vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummary JobsSummary { get => (this._jobsSummary = this._jobsSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.JobsSummary()); set => this._jobsSummary = value; }

        /// <summary>Internal Acessors for JobsSummary</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummary Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IReplicationUsageInternal.JobsSummary { get => (this._jobsSummary = this._jobsSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.JobsSummary()); set { {_jobsSummary = value;} } }

        /// <summary>Internal Acessors for MonitoringSummary</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IMonitoringSummary Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IReplicationUsageInternal.MonitoringSummary { get => (this._monitoringSummary = this._monitoringSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.MonitoringSummary()); set { {_monitoringSummary = value;} } }

        /// <summary>Backing field for <see cref="MonitoringSummary" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IMonitoringSummary _monitoringSummary;

        /// <summary>Summary of the replication monitoring data for this vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IMonitoringSummary MonitoringSummary { get => (this._monitoringSummary = this._monitoringSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.MonitoringSummary()); set => this._monitoringSummary = value; }

        /// <summary>Count of all deprecated recovery service providers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummaryDeprecatedProviderCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IMonitoringSummaryInternal)MonitoringSummary).DeprecatedProviderCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IMonitoringSummaryInternal)MonitoringSummary).DeprecatedProviderCount = value ?? default(int); }
...

    {
        ...
        int? JobSummarySuspendedJob { get; set; }
        /// <summary>Summary of the replication jobs data for this vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IJobsSummary JobsSummary { get; set; }
        /// <summary>Summary of the replication monitoring data for this vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IMonitoringSummary MonitoringSummary { get; set; }
        /// <summary>Count of all deprecated recovery service providers.</summary>
        int? MonitoringSummaryDeprecatedProviderCount { get; set; }
        /// <summary>Count of all critical warnings.</summary>
        int? MonitoringSummaryEventsCount { get; set; }
