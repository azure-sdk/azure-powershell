...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201
{
    ...
    public partial class UpgradeDetails :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetails,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.EndTimeUtc { get => this._endTimeUtc; set { {_endTimeUtc = value;} } }

        /// <summary>Internal Acessors for LastUpdatedTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.LastUpdatedTimeUtc { get => this._lastUpdatedTimeUtc; set { {_lastUpdatedTimeUtc = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for OperationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.OperationId { get => this._operationId; set { {_operationId = value;} } }

        /// <summary>Internal Acessors for PreviousResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.PreviousResourceId { get => this._previousResourceId; set { {_previousResourceId = value;} } }

        /// <summary>Internal Acessors for StartTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.StartTimeUtc { get => this._startTimeUtc; set { {_startTimeUtc = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.VaultUpgradeState? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for TriggerType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Support.TriggerType? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.TriggerType { get => this._triggerType; set { {_triggerType = value;} } }

        /// <summary>Internal Acessors for UpgradedResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240201.IUpgradeDetailsInternal.UpgradedResourceId { get => this._upgradedResourceId; set { {_upgradedResourceId = value;} } }
