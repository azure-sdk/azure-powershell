...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240930Preview.IOperationResource
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesdeletedvaultoperationstatus
#>
function Get-AzRecoveryServicesDeletedVaultOperationStatus {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240930Preview.IOperationResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.RecoveryServices.private\Get-AzRecoveryServicesDeletedVaultOperationStatus_Get';
            GetViaIdentity = 'Az.RecoveryServices.private\Get-AzRecoveryServicesDeletedVaultOperationStatus_GetViaIdentity';
        }
