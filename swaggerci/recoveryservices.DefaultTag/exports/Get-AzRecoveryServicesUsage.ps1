...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240930Preview.IVaultUsage
.Link
https://learn.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesusage
#>
function Get-AzRecoveryServicesUsage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240930Preview.IVaultUsage])]
