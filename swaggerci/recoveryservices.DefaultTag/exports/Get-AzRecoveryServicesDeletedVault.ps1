...
.Link
https://learn.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesdeletedvault
#>
function Get-AzRecoveryServicesDeletedVault {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240930Preview.IDeletedVault])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.RecoveryServices.private\Get-AzRecoveryServicesDeletedVault_Get';
            GetViaIdentity = 'Az.RecoveryServices.private\Get-AzRecoveryServicesDeletedVault_GetViaIdentity';
            List = 'Az.RecoveryServices.private\Get-AzRecoveryServicesDeletedVault_List';
        }
