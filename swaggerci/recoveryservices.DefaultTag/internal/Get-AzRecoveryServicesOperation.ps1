...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20241001.IClientDiscoveryValueForSingleApi
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20241001.IClientDiscoveryValueForSingleApi])]
