...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IClientDiscoveryValueForSingleApi
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20240301.IClientDiscoveryValueForSingleApi])]
