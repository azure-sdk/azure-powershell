...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview
{
    ...
    public partial class AvailablePatchCountByClassification :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.Critical { get => this._critical; set { {_critical = value;} } }

        /// <summary>Internal Acessors for Definition</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.Definition { get => this._definition; set { {_definition = value;} } }

        /// <summary>Internal Acessors for FeaturePack</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.FeaturePack { get => this._featurePack; set { {_featurePack = value;} } }

        /// <summary>Internal Acessors for Other</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.Other { get => this._other; set { {_other = value;} } }

        /// <summary>Internal Acessors for Security</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.Security { get => this._security; set { {_security = value;} } }

        /// <summary>Internal Acessors for ServicePack</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.ServicePack { get => this._servicePack; set { {_servicePack = value;} } }

        /// <summary>Internal Acessors for Tool</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.Tool { get => this._tool; set { {_tool = value;} } }

        /// <summary>Internal Acessors for Update</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.Update { get => this._update; set { {_update = value;} } }

        /// <summary>Internal Acessors for UpdateRollup</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IAvailablePatchCountByClassificationInternal.UpdateRollup { get => this._updateRollup; set { {_updateRollup = value;} } }
