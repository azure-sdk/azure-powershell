...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapihost
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiHost
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiHost -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiHost -InputObject <IArcVMwareServiceApiIdentity> [-Force]
