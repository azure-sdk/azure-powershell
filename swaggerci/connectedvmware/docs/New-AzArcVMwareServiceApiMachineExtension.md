...
online version: https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/new-azarcvmwareserviceapimachineextension
schema: 2.0.0
---
...
```
New-AzArcVMwareServiceApiMachineExtension -ExtensionName <String> -ResourceGroupName <String>
