...
online version: https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/get-azarcvmwareserviceapimachineextension
schema: 2.0.0
---
...
### List (Default)
```
Get-AzArcVMwareServiceApiMachineExtension -ResourceGroupName <String> -VirtualMachineName <String>
 [-SubscriptionId <String[]>] [-Expand <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzArcVMwareServiceApiMachineExtension -ExtensionName <String> -ResourceGroupName <String>
