...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/new-azarcvmwareserviceapidatastore
schema: 2.0.0
---

# New-AzArcVMwareServiceApiDatastore
...
```
New-AzArcVMwareServiceApiDatastore -Name <String> -ResourceGroupName <String> -Location <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IDatastore
