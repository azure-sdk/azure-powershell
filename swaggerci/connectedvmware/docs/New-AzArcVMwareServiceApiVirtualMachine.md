...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/new-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---

# New-AzArcVMwareServiceApiVirtualMachine
...
```
New-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-ExtendedLocationName <String>] [-ExtendedLocationType <String>]
 [-FirmwareType <FirmwareType>] [-GuestAgentProfileClientPublicKey <String>]
 ...
 [-PlacementProfileHostId <String>] [-PlacementProfileResourcePoolId <String>] [-PublicKey <String>]
 [-ResourcePoolId <String>] [-SmbiosUuid <String>] [-StorageProfileDisk <IVirtualDisk[]>] [-Tag <Hashtable>]
 [-TemplateId <String>] [-UefiSettingSecureBootEnabled] [-VCenterId <String>]
...
### -GuestAgentProfileClientPublicKey
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.IdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.INetworkInterface[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IVirtualDisk[]
Parameter Sets: (All)
Aliases:
