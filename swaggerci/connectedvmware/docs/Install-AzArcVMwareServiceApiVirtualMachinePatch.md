...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/install-azarcvmwareserviceapivirtualmachinepatch
schema: 2.0.0
---

# Install-AzArcVMwareServiceApiVirtualMachinePatch
...
```
Install-AzArcVMwareServiceApiVirtualMachinePatch -Name <String> -ResourceGroupName <String>
...
### InstallViaIdentity
```
Install-AzArcVMwareServiceApiVirtualMachinePatch -InputObject <IArcVMwareServiceApiIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IVirtualMachineInstallPatchesParameters
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.VMGuestPatchClassificationLinux[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.VMGuestPatchRebootSetting
Parameter Sets: InstallExpanded, InstallViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Support.VMGuestPatchClassificationWindows[]
Parameter Sets: InstallExpanded, InstallViaIdentityExpanded
Aliases:
