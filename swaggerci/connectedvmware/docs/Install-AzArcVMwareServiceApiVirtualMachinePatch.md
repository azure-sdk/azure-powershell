...
```
Install-AzArcVMwareServiceApiVirtualMachinePatch -ResourceGroupName <String> -VirtualMachineName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IVirtualMachineInstallPatchesParameters
