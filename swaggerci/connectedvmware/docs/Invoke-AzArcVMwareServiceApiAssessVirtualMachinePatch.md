...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/invoke-azarcvmwareserviceapiassessvirtualmachinepatch
schema: 2.0.0
---

# Invoke-AzArcVMwareServiceApiAssessVirtualMachinePatch
...
### Assess (Default)
```
Invoke-AzArcVMwareServiceApiAssessVirtualMachinePatch -ResourceGroupName <String> -VirtualMachineName <String>
...
### AssessViaIdentity
```
Invoke-AzArcVMwareServiceApiAssessVirtualMachinePatch -InputObject <IArcVMwareServiceApiIdentity>
