...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapimachineextension
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiMachineExtension
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiMachineExtension -ExtensionName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiMachineExtension -InputObject <IArcVMwareServiceApiIdentity>
