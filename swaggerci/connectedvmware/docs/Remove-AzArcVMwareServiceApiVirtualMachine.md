...
online version: https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---
...
Remove-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Force] [-Retain] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity> [-Force] [-Retain]
