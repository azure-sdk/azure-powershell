...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapiresourcepool
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiResourcePool
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiResourcePool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiResourcePool -InputObject <IArcVMwareServiceApiIdentity> [-Force]
