...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapimachineextension
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiMachineExtension
...
```
Update-AzArcVMwareServiceApiMachineExtension -ExtensionName <String> -ResourceGroupName <String>
...
```
Update-AzArcVMwareServiceApiMachineExtension -InputObject <IArcVMwareServiceApiIdentity>
