...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapivirtualmachine
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiVirtualMachine
...
```
Update-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-GuestAgentProfileClientPublicKey <String>]
...
```
Update-AzArcVMwareServiceApiVirtualMachine -InputObject <IArcVMwareServiceApiIdentity>
 [-GuestAgentProfileClientPublicKey <String>] [-HardwareProfileMemorySizeMb <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.INetworkInterfaceUpdate[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IVirtualDiskUpdate[]
Parameter Sets: (All)
Aliases:
