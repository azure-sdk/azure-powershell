...
Update-AzArcVMwareServiceApiVirtualMachine -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-HardwareProfileMemorySizeMb <Int32>] [-HardwareProfileNumCoresPerSocket <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.INetworkInterfaceUpdate[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IVirtualDiskUpdate[]
Parameter Sets: (All)
Aliases:
