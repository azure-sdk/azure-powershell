...
online version: https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/get-azarcvmwareserviceapiinventoryitem
schema: 2.0.0
---

# Get-AzArcVMwareServiceApiInventoryItem
...
### List (Default)
```
Get-AzArcVMwareServiceApiInventoryItem -ResourceGroupName <String> -VcenterName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzArcVMwareServiceApiInventoryItem -Name <String> -ResourceGroupName <String> -VcenterName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzArcVMwareServiceApiInventoryItem -InputObject <IArcVMwareServiceApiIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220110Preview.IInventoryItem
