...
.Link
https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/new-azarcvmwareserviceapimachineextension
#>
function New-AzArcVMwareServiceApiMachineExtension {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IMachineExtension])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IMachineExtensionTags]))]
