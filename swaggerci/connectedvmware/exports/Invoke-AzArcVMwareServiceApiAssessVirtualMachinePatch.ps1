...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IVirtualMachineAssessPatchesResult
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.arcvmwareserviceapi/invoke-azarcvmwareserviceapiassessvirtualmachinepatch
#>
function Invoke-AzArcVMwareServiceApiAssessVirtualMachinePatch {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20220715Preview.IVirtualMachineAssessPatchesResult])]
...
begin {
    try {
        ...
        $mapping = @{
            Assess = 'Az.ArcVMwareServiceApi.private\Invoke-AzArcVMwareServiceApiAssessVirtualMachinePatch_Assess';
            AssessViaIdentity = 'Az.ArcVMwareServiceApi.private\Invoke-AzArcVMwareServiceApiAssessVirtualMachinePatch_AssessViaIdentity';
        }
