...
INSTALLPATCHESINPUT <IVirtualMachineInstallPatchesParameters>: Input for InstallPatches as directly received by the API
  ...
  [LinuxParameterPackageNameMasksToExclude <String[]>]: packages to exclude in the patch operation. Format: packageName=packageVersion
  [LinuxParameterPackageNameMasksToInclude <String[]>]: packages to include in the patch operation. Format: packageName=packageVersion
