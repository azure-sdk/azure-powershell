...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901
{
    ...
    public partial class ConsumerInvitationProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject into a new instance of <see cref="ConsumerInvitationProperties" />.
        /// </summary>
        ...
        internal ConsumerInvitationProperties(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject json)
        {
            ...
            {_dataSetCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNumber>("dataSetCount"), out var __jsonDataSetCount) ? (int?)__jsonDataSetCount : DataSetCount;}
            ...
            {_termsOfUse = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonString>("termsOfUse"), out var __jsonTermsOfUse) ? (string)__jsonTermsOfUse : (string)TermsOfUse;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901.IConsumerInvitationProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901.IConsumerInvitationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20200901.IConsumerInvitationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject json ? new ConsumerInvitationProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConsumerInvitationProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConsumerInvitationProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._dataSetCount ? (Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNumber((int)this._dataSetCount) : null, "dataSetCount" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._termsOfUse)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.Json.JsonString(this._termsOfUse.ToString()) : null, "termsOfUse" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataShare.Runtime.SerializationMode.IncludeReadOnly))
            {
