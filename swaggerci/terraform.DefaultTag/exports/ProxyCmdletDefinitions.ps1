...
INPUTOBJECT <ITerraformIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.terraform/get-azterraformoperationstatuses
#>
function Get-AzTerraformOperationStatuses {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Terraform.Models.Api20230701Preview.IOperationStatus])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Terraform.private\Get-AzTerraformOperationStatuses_Get';
            GetViaIdentity = 'Az.Terraform.private\Get-AzTerraformOperationStatuses_GetViaIdentity';
        }
