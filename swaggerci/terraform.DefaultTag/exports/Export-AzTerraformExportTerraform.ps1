...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Terraform.Models.Api20230701Preview.IExportResult
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.terraform/export-azterraformexportterraform
#>
function Export-AzTerraformExportTerraform {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Terraform.Models.Api20230701Preview.IExportResult])]
...
begin {
    try {
        ...
        $mapping = @{
            Export = 'Az.Terraform.private\Export-AzTerraformExportTerraform_Export';
            ExportExpanded = 'Az.Terraform.private\Export-AzTerraformExportTerraform_ExportExpanded';
            ExportViaIdentity = 'Az.Terraform.private\Export-AzTerraformExportTerraform_ExportViaIdentity';
            ExportViaIdentityExpanded = 'Az.Terraform.private\Export-AzTerraformExportTerraform_ExportViaIdentityExpanded';
        }
