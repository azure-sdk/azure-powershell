...
online version: https://learn.microsoft.com/powershell/module/az.terraform/export-azterraformexportterraform
schema: 2.0.0
---

# Export-AzTerraformExportTerraform
...
```
Export-AzTerraformExportTerraform -Type <Type> [-SubscriptionId <String>] [-FullProperty] [-MaskSensitive]
...
### Export
```
Export-AzTerraformExportTerraform -Body <IBaseExportModel> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExportViaIdentity
```
Export-AzTerraformExportTerraform -InputObject <ITerraformIdentity> -Body <IBaseExportModel>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExportViaIdentityExpanded
```
Export-AzTerraformExportTerraform -InputObject <ITerraformIdentity> -Type <Type> [-FullProperty]
 [-MaskSensitive] [-TargetProvider <TargetProvider>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
