...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/remove-azredhatopenshiftsyncidentityprovider
schema: 2.0.0
---

# Remove-AzRedHatOpenShiftSyncIdentityProvider
...
### Delete (Default)
```
Remove-AzRedHatOpenShiftSyncIdentityProvider -ChildResourceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzRedHatOpenShiftSyncIdentityProvider -InputObject <IRedHatOpenShiftIdentity>
