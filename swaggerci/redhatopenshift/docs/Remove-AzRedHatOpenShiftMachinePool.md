...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/remove-azredhatopenshiftmachinepool
schema: 2.0.0
---

# Remove-AzRedHatOpenShiftMachinePool
...
### Delete (Default)
```
Remove-AzRedHatOpenShiftMachinePool -ChildResourceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzRedHatOpenShiftMachinePool -InputObject <IRedHatOpenShiftIdentity> [-DefaultProfile <PSObject>]
