...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift4/new-azredhatopenshift4openshiftcluster
schema: 2.0.0
---

# New-AzRedHatOpenShift4OpenShiftCluster
...
```
New-AzRedHatOpenShift4OpenShiftCluster -ResourceGroupName <String> -ResourceName <String> -Location <String>
