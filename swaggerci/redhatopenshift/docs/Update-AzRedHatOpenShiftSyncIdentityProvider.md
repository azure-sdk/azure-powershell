...
online version: https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/update-azredhatopenshiftsyncidentityprovider
schema: 2.0.0
---

# Update-AzRedHatOpenShiftSyncIdentityProvider
...
```
Update-AzRedHatOpenShiftSyncIdentityProvider -ChildResourceName <String> -ResourceGroupName <String>
...
```
Update-AzRedHatOpenShiftSyncIdentityProvider -InputObject <IRedHatOpenShiftIdentity> [-Resource <String>]
