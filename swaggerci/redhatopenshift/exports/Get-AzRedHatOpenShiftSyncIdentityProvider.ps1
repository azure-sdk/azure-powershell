...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/get-azredhatopenshiftsyncidentityprovider
#>
function Get-AzRedHatOpenShiftSyncIdentityProvider {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20220904.ISyncIdentityProvider])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftSyncIdentityProvider_Get';
            GetViaIdentity = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftSyncIdentityProvider_GetViaIdentity';
            List = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftSyncIdentityProvider_List';
        }
