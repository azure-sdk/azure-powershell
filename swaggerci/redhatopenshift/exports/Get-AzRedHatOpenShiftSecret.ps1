...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/get-azredhatopenshiftsecret
#>
function Get-AzRedHatOpenShiftSecret {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20220904.ISecret])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftSecret_Get';
            GetViaIdentity = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftSecret_GetViaIdentity';
            List = 'Az.RedHatOpenShift.private\Get-AzRedHatOpenShiftSecret_List';
        }
