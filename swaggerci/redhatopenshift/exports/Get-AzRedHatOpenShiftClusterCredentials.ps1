...
.Link
https://learn.microsoft.com/powershell/module/az.redhatopenshift/get-azredhatopenshiftclustercredentials
#>
function Get-AzRedHatOpenShiftClusterCredentials {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20220904.IOpenShiftClusterCredentials])]
