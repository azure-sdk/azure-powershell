...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/new-azredhatopenshiftsyncset
#>
function New-AzRedHatOpenShiftSyncSet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.RedHatOpenShift.Models.Api20220904.ISyncSet])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.RedHatOpenShift.private\New-AzRedHatOpenShiftSyncSet_CreateExpanded';
        }
