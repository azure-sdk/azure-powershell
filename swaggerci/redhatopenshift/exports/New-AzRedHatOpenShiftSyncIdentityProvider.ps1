...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/new-azredhatopenshiftsyncidentityprovider
#>
function New-AzRedHatOpenShiftSyncIdentityProvider {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.RedHatOpenShift.private\New-AzRedHatOpenShiftSyncIdentityProvider_CreateExpanded';
        }
