...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.redhatopenshift/update-azredhatopenshiftsyncidentityprovider
#>
function Update-AzRedHatOpenShiftSyncIdentityProvider {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.RedHatOpenShift.private\Update-AzRedHatOpenShiftSyncIdentityProvider_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.RedHatOpenShift.private\Update-AzRedHatOpenShiftSyncIdentityProvider_UpdateViaIdentityExpanded';
        }
