...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapidaprresiliencytimeoutpolicy
schema: 2.0.0
---

# Remove-AzContainerAppsApiDaprResiliencyTimeoutPolicy
...
### Delete (Default)
```
Remove-AzContainerAppsApiDaprResiliencyTimeoutPolicy -EnvironmentName <String> -PolicyName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiDaprResiliencyTimeoutPolicy -InputObject <IContainerAppsApiIdentity>
