...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/new-azcontainerappsapidaprresiliencycircuitbreakerpolicy
schema: 2.0.0
---

# New-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy
...
```
New-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy -EnvironmentName <String> -PolicyName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-CircuitBreakerCacheSize <Int32>]
 [-CircuitBreakerScope <String>] [-Interval <String>] [-MaxRequest <Int32>] [-Timeout <String>]
 [-Trip <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
