...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/stop-azcontainerappsapijobexecution
schema: 2.0.0
---

# Stop-AzContainerAppsApiJobExecution
...
### Stop (Default)
```
Stop-AzContainerAppsApiJobExecution -JobName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzContainerAppsApiJobExecution -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>]
