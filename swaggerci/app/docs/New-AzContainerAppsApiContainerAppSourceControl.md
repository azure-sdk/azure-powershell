...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/new-azcontainerappsapicontainerappsourcecontrol
schema: 2.0.0
---
...
```
New-AzContainerAppsApiContainerAppSourceControl -ContainerAppName <String> -ResourceGroupName <String>
