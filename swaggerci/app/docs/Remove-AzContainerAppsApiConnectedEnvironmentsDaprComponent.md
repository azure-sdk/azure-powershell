...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapiconnectedenvironmentsdaprcomponent
schema: 2.0.0
---

# Remove-AzContainerAppsApiConnectedEnvironmentsDaprComponent
...
### Delete (Default)
```
Remove-AzContainerAppsApiConnectedEnvironmentsDaprComponent -ComponentName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiConnectedEnvironmentsDaprComponent -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
