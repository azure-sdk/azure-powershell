...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapicontainerappssourcecontrol
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerAppsApiContainerAppsSourceControl -ContainerAppName <String> -Name <String>
