...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/restart-azcontainerappsapicontainerapprevision
schema: 2.0.0
---

# Restart-AzContainerAppsApiContainerAppRevision
...
### Restart (Default)
```
Restart-AzContainerAppsApiContainerAppRevision -ContainerAppName <String> -ResourceGroupName <String>
...
### RestartViaIdentity
```
Restart-AzContainerAppsApiContainerAppRevision -InputObject <IContainerAppsApiIdentity>
