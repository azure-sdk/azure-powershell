...
Update-AzContainerAppsApiContainerApp -InputObject <IContainerAppsApiIdentity> -Location <String>
 ...
 [-IdentityUserAssignedIdentity <Hashtable>] [-ManagedEnvironmentId <String>] [-ScaleMaxReplica <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220601Preview.IConfiguration
Parameter Sets: (All)
Aliases:
