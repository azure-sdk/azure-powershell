...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapiconnectedenvironmentsdaprresiliencycircuitbreakerpolicy
schema: 2.0.0
---

# Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyCircuitBreakerPolicy
...
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyCircuitBreakerPolicy
 -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
