...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentdiagnosticdaprcomponent
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentDiagnosticDaprComponent
...
### List (Default)
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticDaprComponent -EnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticDaprComponent -ComponentName <String>
...
### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticDaprComponent -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
