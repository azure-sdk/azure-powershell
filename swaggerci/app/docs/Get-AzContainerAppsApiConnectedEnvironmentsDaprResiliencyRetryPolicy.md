...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapiconnectedenvironmentsdaprresiliencyretrypolicy
schema: 2.0.0
---

# Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyRetryPolicy
...
### List (Default)
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyRetryPolicy -ConnectedEnvironmentName <String>
...
### GetViaIdentity
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyRetryPolicy -InputObject <IContainerAppsApiIdentity>
