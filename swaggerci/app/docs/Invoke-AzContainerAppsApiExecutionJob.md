...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/invoke-azcontainerappsapiexecutionjob
schema: 2.0.0
---
...
```
Invoke-AzContainerAppsApiExecutionJob -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>]
