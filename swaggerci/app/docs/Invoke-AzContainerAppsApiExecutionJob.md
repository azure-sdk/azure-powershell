...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/invoke-azcontainerappsapiexecutionjob
schema: 2.0.0
---

# Invoke-AzContainerAppsApiExecutionJob
...
### Executions (Default)
```
Invoke-AzContainerAppsApiExecutionJob -JobName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [<CommonParameters>]
```

### ExecutionsViaIdentity
```
Invoke-AzContainerAppsApiExecutionJob -InputObject <IContainerAppsApiIdentity> [-Filter <String>]
...
Parameter Sets: ExecutionsViaIdentity
Aliases:
