...
online version: https://learn.microsoft.com/powershell/module/az.containerappsapi/invoke-azcontainerappsapideactivatecontainerapprevision
schema: 2.0.0
---
...
### Deactivate (Default)
```
Invoke-AzContainerAppsApiDeactivateContainerAppRevision -ContainerAppName <String> -ResourceGroupName <String>
