...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapidaprresiliencyretrypolicy
schema: 2.0.0
---

# Get-AzContainerAppsApiDaprResiliencyRetryPolicy
...
### List (Default)
```
Get-AzContainerAppsApiDaprResiliencyRetryPolicy -EnvironmentName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiDaprResiliencyRetryPolicy -EnvironmentName <String> -PolicyName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiDaprResiliencyRetryPolicy -InputObject <IContainerAppsApiIdentity>
