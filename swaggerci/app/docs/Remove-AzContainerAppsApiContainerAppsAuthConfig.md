...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapicontainerappsauthconfig
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerAppsApiContainerAppsAuthConfig -ContainerAppName <String> -Name <String>
