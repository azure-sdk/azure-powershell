...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/update-azcontainerappsapiconnectedenvironmentscertificate
schema: 2.0.0
---

# Update-AzContainerAppsApiConnectedEnvironmentsCertificate
...
```
Update-AzContainerAppsApiConnectedEnvironmentsCertificate -CertificateName <String>
 -ConnectedEnvironmentName <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzContainerAppsApiConnectedEnvironmentsCertificate -InputObject <IContainerAppsApiIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220601Preview.ICertificate
