...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/invoke-azcontainerappsapiterminatejob
schema: 2.0.0
---

# Invoke-AzContainerAppsApiTerminateJob
...
### Terminate (Default)
```
Invoke-AzContainerAppsApiTerminateJob -JobName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TerminateViaIdentity
```
Invoke-AzContainerAppsApiTerminateJob -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>]
