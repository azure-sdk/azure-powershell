...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapiconnectedenvironmentscertificate
schema: 2.0.0
---

# Get-AzContainerAppsApiConnectedEnvironmentsCertificate
...
### List (Default)
```
Get-AzContainerAppsApiConnectedEnvironmentsCertificate -ConnectedEnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiConnectedEnvironmentsCertificate -CertificateName <String>
...
### GetViaIdentity
```
Get-AzContainerAppsApiConnectedEnvironmentsCertificate -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
