...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentdiagnosticroot
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentDiagnosticRoot
...
### Get (Default)
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticRoot -EnvironmentName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticRoot -InputObject <IContainerAppsApiIdentity>
