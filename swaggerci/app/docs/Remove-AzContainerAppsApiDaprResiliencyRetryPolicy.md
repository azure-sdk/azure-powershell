...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapidaprresiliencyretrypolicy
schema: 2.0.0
---

# Remove-AzContainerAppsApiDaprResiliencyRetryPolicy
...
### Delete (Default)
```
Remove-AzContainerAppsApiDaprResiliencyRetryPolicy -EnvironmentName <String> -PolicyName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiDaprResiliencyRetryPolicy -InputObject <IContainerAppsApiIdentity>
