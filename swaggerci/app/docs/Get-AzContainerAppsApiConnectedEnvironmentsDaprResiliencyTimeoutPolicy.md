...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapiconnectedenvironmentsdaprresiliencytimeoutpolicy
schema: 2.0.0
---

# Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyTimeoutPolicy
...
### List (Default)
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyTimeoutPolicy -ConnectedEnvironmentName <String>
...
```
Get-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyTimeoutPolicy -ConnectedEnvironmentName <String>
 -PolicyName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
