...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapimanagedenvironmentdiagnosticcertificate
schema: 2.0.0
---

# Get-AzContainerAppsApiManagedEnvironmentDiagnosticCertificate
...
### List (Default)
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticCertificate -EnvironmentName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticCertificate -CertificateName <String>
 -EnvironmentName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiManagedEnvironmentDiagnosticCertificate -InputObject <IContainerAppsApiIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
