...
New-AzContainerAppsApiDaprComponent -ComponentName <String> -EnvironmentName <String>
 ...
 [-SecretStoreComponent <String>] [-Version <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221101Preview.IDaprMetadata[]
Parameter Sets: (All)
Aliases:
