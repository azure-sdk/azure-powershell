...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapiconnectedenvironmentsdaprresiliencytimeoutpolicy
schema: 2.0.0
---

# Remove-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyTimeoutPolicy
...
### Delete (Default)
```
Remove-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyTimeoutPolicy -ConnectedEnvironmentName <String>
...
```
Remove-AzContainerAppsApiConnectedEnvironmentsDaprResiliencyTimeoutPolicy
 -InputObject <IContainerAppsApiIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
