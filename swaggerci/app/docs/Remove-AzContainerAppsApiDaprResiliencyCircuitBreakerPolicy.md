...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/remove-azcontainerappsapidaprresiliencycircuitbreakerpolicy
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy -EnvironmentName <String> -PolicyName <String>
...
### DeleteViaIdentity
```
Remove-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy -InputObject <IContainerAppsApiIdentity>
