...
online version: https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/get-azcontainerappsapidaprresiliencycircuitbreakerpolicy
schema: 2.0.0
---

# Get-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy
...
### List (Default)
```
Get-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy -EnvironmentName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy -EnvironmentName <String> -PolicyName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzContainerAppsApiDaprResiliencyCircuitBreakerPolicy -InputObject <IContainerAppsApiIdentity>
