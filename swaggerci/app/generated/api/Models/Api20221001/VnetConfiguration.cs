...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001
{
    ...
    public partial class VnetConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IVnetConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IVnetConfigurationInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettings Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IVnetConfigurationInternal.OutboundSetting { get => (this._outboundSetting = this._outboundSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.ManagedEnvironmentOutboundSettings()); set { {_outboundSetting = value;} } }

        /// <summary>Backing field for <see cref="OutboundSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettings _outboundSetting;

        /// <summary>Configuration used to control the Environment Egress outbound traffic</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettings OutboundSetting { get => (this._outboundSetting = this._outboundSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.ManagedEnvironmentOutboundSettings()); set => this._outboundSetting = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.ManagedEnvironmentOutBoundType? OutboundSettingOutBoundType { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettingsInternal)OutboundSetting).OutBoundType; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettingsInternal)OutboundSetting).OutBoundType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.ManagedEnvironmentOutBoundType)""); }

        /// <summary>Virtual Appliance IP used as the Egress controller for the Environment</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string OutboundSettingVirtualNetworkApplianceIP { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettingsInternal)OutboundSetting).VirtualNetworkApplianceIP; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettingsInternal)OutboundSetting).VirtualNetworkApplianceIP = value ?? null; }
...

    {
        ...
        bool? Internal { get; set; }
        /// <summary>Configuration used to control the Environment Egress outbound traffic</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221001.IManagedEnvironmentOutboundSettings OutboundSetting { get; set; }
        /// <summary>Outbound type for the cluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.ManagedEnvironmentOutBoundType? OutboundSettingOutBoundType { get; set; }
        /// <summary>Virtual Appliance IP used as the Egress controller for the Environment</summary>
        string OutboundSettingVirtualNetworkApplianceIP { get; set; }
