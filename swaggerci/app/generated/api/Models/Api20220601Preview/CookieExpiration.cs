...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220601Preview
{
    ...
    public partial class CookieExpiration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220601Preview.ICookieExpiration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220601Preview.ICookieExpirationInternal
    {

        /// <summary>Backing field for <see cref="Convention" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.CookieExpirationConvention? _convention;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.CookieExpirationConvention? Convention { get => this._convention; set => this._convention = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Support.CookieExpirationConvention? Convention { get; set; }
        /// <summary>The time after the request is made when the session cookie should expire.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
