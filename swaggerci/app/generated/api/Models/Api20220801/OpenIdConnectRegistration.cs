...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801
{
    ...
    public partial class OpenIdConnectRegistration :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectRegistration,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectRegistrationInternal
    {

        /// <summary>Backing field for <see cref="ClientCredential" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectClientCredential _clientCredential;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectClientCredential ClientCredential { get => (this._clientCredential = this._clientCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.OpenIdConnectClientCredential()); set => this._clientCredential = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectClientCredential Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectRegistrationInternal.ClientCredential { get => (this._clientCredential = this._clientCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.OpenIdConnectClientCredential()); set { {_clientCredential = value;} } }

        /// <summary>Internal Acessors for OpenIdConnectConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectConfig Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectRegistrationInternal.OpenIdConnectConfiguration { get => (this._openIdConnectConfiguration = this._openIdConnectConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.OpenIdConnectConfig()); set { {_openIdConnectConfiguration = value;} } }

        /// <summary>Backing field for <see cref="OpenIdConnectConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectConfig _openIdConnectConfiguration;

        /// <summary>
        /// The configuration settings of the endpoints used for the custom Open ID Connect provider.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectConfig OpenIdConnectConfiguration { get => (this._openIdConnectConfiguration = this._openIdConnectConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.OpenIdConnectConfig()); set => this._openIdConnectConfiguration = value; }

        /// <summary>The endpoint to be used to make an authorization request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Inlined)]
        public string OpenIdConnectConfigurationAuthorizationEndpoint { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectConfigInternal)OpenIdConnectConfiguration).AuthorizationEndpoint; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectConfigInternal)OpenIdConnectConfiguration).AuthorizationEndpoint = value ?? null; }
    ...
    {
        /// <summary>The authentication credentials of the custom Open ID Connect provider.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectClientCredential ClientCredential { get; set; }
        /// <summary>
        /// The app setting that contains the client secret for the custom Open ID Connect provider.
        /// </summary>
        string ClientCredentialClientSecretSettingName { get; set; }
        ...
        /// The configuration settings of the endpoints used for the custom Open ID Connect provider.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220801.IOpenIdConnectConfig OpenIdConnectConfiguration { get; set; }
        /// <summary>The endpoint to be used to make an authorization request.</summary>
        string OpenIdConnectConfigurationAuthorizationEndpoint { get; set; }
        /// <summary>The endpoint that provides the keys necessary to validate the token.</summary>
        string OpenIdConnectConfigurationCertificationUri { get; set; }
