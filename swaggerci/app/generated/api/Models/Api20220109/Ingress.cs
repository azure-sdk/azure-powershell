...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109
{
    ...
    public partial class Ingress :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.IIngress,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.IIngressInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ICustomDomain[] _customDomain;

        /// <summary>custom domain bindings for Container Apps' hostnames.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ICustomDomain[] CustomDomain { get => this._customDomain; set => this._customDomain = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.IIngressInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITrafficWeight[] _traffic;

        /// <summary>Traffic weights for app's revisions</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITrafficWeight[] Traffic { get => this._traffic; set => this._traffic = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ICustomDomain[] CustomDomain { get; set; }
        /// <summary>Bool indicating if app exposes an external http endpoint</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITrafficWeight[] Traffic { get; set; }
        /// <summary>Ingress transport protocol</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
