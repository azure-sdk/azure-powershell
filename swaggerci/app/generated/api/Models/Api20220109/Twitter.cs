...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109
{
    ...
    public partial class Twitter :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitter,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterRegistration Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterInternal.Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.TwitterRegistration()); set { {_registration = value;} } }

        /// <summary>Backing field for <see cref="Registration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterRegistration _registration;

        /// <summary>The configuration settings of the app registration for the Twitter provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterRegistration Registration { get => (this._registration = this._registration ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.TwitterRegistration()); set => this._registration = value; }
        ...
        public string RegistrationConsumerKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterRegistrationInternal)Registration).ConsumerKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterRegistrationInternal)Registration).ConsumerKey = value ?? null; }
...

    {
        ...
        bool? Enabled { get; set; }
        /// <summary>The configuration settings of the app registration for the Twitter provider.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20220109.ITwitterRegistration Registration { get; set; }
        /// <summary>
        /// The OAuth 1.0a consumer key of the Twitter application used for sign-in.
        /// This setting is required for enabling Twitter Sign-In.
        /// Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in
