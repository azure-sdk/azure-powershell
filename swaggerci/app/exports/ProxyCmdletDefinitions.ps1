...
INPUTOBJECT <IContainerAppsApiIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/invoke-azcontainerappsapiexecutionjob
#>
function Invoke-AzContainerAppsApiExecutionJob {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.Api20221101Preview.IJobExecution])]
[CmdletBinding(DefaultParameterSetName='Executions', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Executions', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Path')]
    [System.String]
    # Name of the Container Apps Job.
    ${JobName},
    ...
    [Parameter(ParameterSetName='Executions')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.DefaultInfo(Script='(Get-AzContext).Subscription.Id')]
    [System.String]
    # The ID of the target subscription.
    ...
    [Parameter(ParameterSetName='ExecutionsViaIdentity', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Models.IContainerAppsApiIdentity]
    # Identity Parameter
    # To construct, see NOTES section for INPUTOBJECT properties and create a hash table.
...
begin {
    try {
        ...
        $mapping = @{
            Executions = 'Az.ContainerAppsApi.private\Invoke-AzContainerAppsApiExecutionJob_Executions';
            ExecutionsViaIdentity = 'Az.ContainerAppsApi.private\Invoke-AzContainerAppsApiExecutionJob_ExecutionsViaIdentity';
        }
        if (('Executions') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerAppsApi.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
begin {
    try {
        ...
        $mapping = @{
            ...
            RunExpanded = 'Az.ContainerAppsApi.private\Start-AzContainerAppsApiJob_RunExpanded';
            RunViaIdentity = 'Az.ContainerAppsApi.private\Start-AzContainerAppsApiJob_RunViaIdentity';
            RunViaIdentityExpanded = 'Az.ContainerAppsApi.private\Start-AzContainerAppsApiJob_RunViaIdentityExpanded';
        }
...
INPUTOBJECT <IContainerAppsApiIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/stop-azcontainerappsapijobexecution
#>
...
VALUE <IJobExecutionBase[]>: Collection of resources.
  ...
  [Name <String>]: Job execution name.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerappsapi/stop-azcontainerappsapijobmultipleexecution
#>
