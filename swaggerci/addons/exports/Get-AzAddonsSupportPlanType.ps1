...
.Link
https://learn.microsoft.com/powershell/module/az.addons/get-azaddonssupportplantype
#>
function Get-AzAddonsSupportPlanType {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanResponseEnvelope])]
