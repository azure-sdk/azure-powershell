...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.addons/get-azaddonscanonicalsupportplantype
#>
function Get-AzAddonsCanonicalSupportPlanType {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20240106.ICanonicalSupportPlanStatusItem])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Addons.private\Get-AzAddonsCanonicalSupportPlanType_Get';
            GetViaIdentity = 'Az.Addons.private\Get-AzAddonsCanonicalSupportPlanType_GetViaIdentity';
        }
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20240106.ICanonicalSupportPlanResponseEnvelope])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
