...
namespace Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanResponseEnvelopeInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanResponseEnvelopeInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanResponseEnvelopeInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanProperties Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanResponseEnvelopeInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.CanonicalSupportPlanProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanResponseEnvelopeInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanProperties _property;

        /// <summary>Describes Canonical support plan type and status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Addons.Origin(Microsoft.Azure.PowerShell.Cmdlets.Addons.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.CanonicalSupportPlanProperties()); set => this._property = value; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Describes Canonical support plan type and status.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20210912.ICanonicalSupportPlanProperties Property { get; set; }
        /// <summary>The provisioning state of the resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Addons.Support.ProvisioningState? ProvisioningState { get; set; }
        /// <summary>Microsoft.Addons/supportProvider</summary>
        string Type { get; set; }
