...
namespace Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20010116
{
    ...
    public partial class ErrorDefinitionTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="ErrorDefinition" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20010116.IErrorDefinition ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Addons.Models.Api20010116.IErrorDefinition).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
