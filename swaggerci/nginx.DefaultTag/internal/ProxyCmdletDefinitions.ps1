...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.IOperationResult
.Link
https://learn.microsoft.com/powershell/module/az.nginx/get-aznginxoperation
#>
function Get-AzNginxOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.IOperationResult])]
