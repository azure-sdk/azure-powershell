...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.IOperationResult
.Link
https://learn.microsoft.com/powershell/module/az.nginx/get-aznginxoperation
#>
function Get-AzNginxOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.IOperationResult])]
