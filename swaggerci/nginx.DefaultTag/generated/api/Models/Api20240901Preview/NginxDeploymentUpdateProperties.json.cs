...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview
{
    ...
    public partial class NginxDeploymentUpdateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.INginxDeploymentUpdateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.INginxDeploymentUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.INginxDeploymentUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode node)
        {
        ...
        internal NginxDeploymentUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json)
        {
            ...
            {_logging = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("logging"), out var __jsonLogging) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.NginxLogging.FromJson(__jsonLogging) : Logging;}
            {_scalingProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("scalingProperties"), out var __jsonScalingProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.NginxDeploymentScalingProperties.FromJson(__jsonScalingProperties) : ScalingProperty;}
            {_userProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("userProfile"), out var __jsonUserProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.NginxDeploymentUserProfile.FromJson(__jsonUserProfile) : UserProfile;}
            {_autoUpgradeProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("autoUpgradeProfile"), out var __jsonAutoUpgradeProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.AutoUpgradeProfile.FromJson(__jsonAutoUpgradeProfile) : AutoUpgradeProfile;}
            {_nginxAppProtect = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("nginxAppProtect"), out var __jsonNginxAppProtect) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.NginxDeploymentUpdatePropertiesNginxAppProtect.FromJson(__jsonNginxAppProtect) : NginxAppProtect;}
