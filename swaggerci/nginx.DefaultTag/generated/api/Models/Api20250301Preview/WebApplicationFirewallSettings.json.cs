...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview
{
    ...
    public partial class WebApplicationFirewallSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.IWebApplicationFirewallSettings.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.IWebApplicationFirewallSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.IWebApplicationFirewallSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json ? new WebApplicationFirewallSettings(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WebApplicationFirewallSettings" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="WebApplicationFirewallSettings" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._activationState)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonString(this._activationState.ToString()) : null, "activationState" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject into a new instance of <see cref="WebApplicationFirewallSettings" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WebApplicationFirewallSettings(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_activationState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonString>("activationState"), out var __jsonActivationState) ? (string)__jsonActivationState : (string)ActivationState;}
            AfterFromJson(json);
        }
    }
}