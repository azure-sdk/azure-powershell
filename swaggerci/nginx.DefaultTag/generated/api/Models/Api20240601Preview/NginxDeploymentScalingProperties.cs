...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview
{
    ...
    public partial class NginxDeploymentScalingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AutoScaleSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesAutoScaleSettings _autoScaleSetting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesAutoScaleSettings AutoScaleSetting { get => (this._autoScaleSetting = this._autoScaleSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxDeploymentScalingPropertiesAutoScaleSettings()); set => this._autoScaleSetting = value; }

        [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Origin(Microsoft.Azure.PowerShell.Cmdlets.Nginx.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.IScaleProfile[] AutoScaleSettingProfile { get => ((Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesAutoScaleSettingsInternal)AutoScaleSetting).Profile; set => ((Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesAutoScaleSettingsInternal)AutoScaleSetting).Profile = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesAutoScaleSettings Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesInternal.AutoScaleSetting { get => (this._autoScaleSetting = this._autoScaleSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxDeploymentScalingPropertiesAutoScaleSettings()); set { {_autoScaleSetting = value;} } }
...

    {
        ...
        /// The settings for enabling automatic scaling of the deployment. If this field is specified, 'scale.capacity' must be empty.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentScalingPropertiesAutoScaleSettings AutoScaleSetting { get; set; }
