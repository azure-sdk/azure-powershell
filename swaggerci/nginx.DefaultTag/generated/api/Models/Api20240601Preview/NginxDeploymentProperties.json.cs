...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview
{
    ...
    public partial class NginxDeploymentProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxDeploymentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode node)
        {
        ...
        internal NginxDeploymentProperties(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json)
        {
            ...
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxNetworkProfile.FromJson(__jsonNetworkProfile) : NetworkProfile;}
            {_logging = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("logging"), out var __jsonLogging) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxLogging.FromJson(__jsonLogging) : Logging;}
            {_scalingProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("scalingProperties"), out var __jsonScalingProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxDeploymentScalingProperties.FromJson(__jsonScalingProperties) : ScalingProperty;}
            {_autoUpgradeProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("autoUpgradeProfile"), out var __jsonAutoUpgradeProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.AutoUpgradeProfile.FromJson(__jsonAutoUpgradeProfile) : AutoUpgradeProfile;}
            {_userProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("userProfile"), out var __jsonUserProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxDeploymentUserProfile.FromJson(__jsonUserProfile) : UserProfile;}
            {_nginxAppProtect = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("nginxAppProtect"), out var __jsonNginxAppProtect) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxDeploymentPropertiesNginxAppProtect.FromJson(__jsonNginxAppProtect) : NginxAppProtect;}
