...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview
{
    ...
    public partial class NginxConfigurationListResponse :
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxConfigurationListResponse,
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxConfigurationListResponseInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxConfiguration[] _value;

        /// <summary>Results of a list operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Origin(Microsoft.Azure.PowerShell.Cmdlets.Nginx.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxConfiguration[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxConfiguration) })]
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxConfiguration[] Value { get; set; }
