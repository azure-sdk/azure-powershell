...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview
{
    ...
    public partial class NginxFrontendIPConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxFrontendIPConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxFrontendIPConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPrivateIPAddress[] _privateIPAddress;

        [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Origin(Microsoft.Azure.PowerShell.Cmdlets.Nginx.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPrivateIPAddress[] PrivateIPAddress { get => this._privateIPAddress; set => this._privateIPAddress = value; }

        /// <summary>Backing field for <see cref="PublicIPAddress" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPublicIPAddress[] _publicIPAddress;

        [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Origin(Microsoft.Azure.PowerShell.Cmdlets.Nginx.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPublicIPAddress[] PublicIPAddress { get => this._publicIPAddress; set => this._publicIPAddress = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPrivateIPAddress[] PrivateIPAddress { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPublicIPAddress[] PublicIPAddress { get; set; }
