...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview
{
    ...
    public partial class NginxCertificateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificatePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificateErrorResponseBody _certificateError;

        [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Origin(Microsoft.Azure.PowerShell.Cmdlets.Nginx.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificateErrorResponseBody CertificateError { get => (this._certificateError = this._certificateError ?? new Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxCertificateErrorResponseBody()); set => this._certificateError = value; }

        [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Origin(Microsoft.Azure.PowerShell.Cmdlets.Nginx.PropertyOrigin.Inlined)]
        public string CertificateErrorCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificateErrorResponseBodyInternal)CertificateError).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificateErrorResponseBodyInternal)CertificateError).Code = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificateErrorResponseBody Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificatePropertiesInternal.CertificateError { get => (this._certificateError = this._certificateError ?? new Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.NginxCertificateErrorResponseBody()); set { {_certificateError = value;} } }

        /// <summary>Internal Acessors for KeyVaultSecretCreated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificatePropertiesInternal.KeyVaultSecretCreated { get => this._keyVaultSecretCreated; set { {_keyVaultSecretCreated = value;} } }

        /// <summary>Internal Acessors for KeyVaultSecretVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificatePropertiesInternal.KeyVaultSecretVersion { get => this._keyVaultSecretVersion; set { {_keyVaultSecretVersion = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Nginx.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificatePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Sha1Thumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxCertificatePropertiesInternal.Sha1Thumbprint { get => this._sha1Thumbprint; set { {_sha1Thumbprint = value;} } }
