...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20241101Preview
{
    ...
    public partial class NginxLogging
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20241101Preview.INginxLogging.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20241101Preview.INginxLogging.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20241101Preview.INginxLogging FromJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json ? new NginxLogging(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject into a new instance of <see cref="NginxLogging" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal NginxLogging(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json)
        {
            ...
            {_storageAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("storageAccount"), out var __jsonStorageAccount) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20241101Preview.NginxStorageAccount.FromJson(__jsonStorageAccount) : StorageAccount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="NginxLogging" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="NginxLogging" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._storageAccount ? (Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode) this._storageAccount.ToJson(null,serializationMode) : null, "storageAccount" ,container.Add );
