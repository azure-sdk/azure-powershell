...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models
{
    ...
    public partial class CertificatesDeleteAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject into a new instance of <see cref="CertificatesDeleteAcceptedResponseHeaders" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CertificatesDeleteAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.ICertificatesDeleteAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.ICertificatesDeleteAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.ICertificatesDeleteAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json ? new CertificatesDeleteAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CertificatesDeleteAcceptedResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CertificatesDeleteAcceptedResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
