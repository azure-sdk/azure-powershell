...
namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901
{
    ...
    public partial class NginxDeploymentProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxDeploymentProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxDeploymentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxDeploymentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonNode node)
        {
        ...
        internal NginxDeploymentProperties(Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject json)
        {
            ...
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.NginxNetworkProfile.FromJson(__jsonNetworkProfile) : NetworkProfile;}
            {_logging = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("logging"), out var __jsonLogging) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.NginxLogging.FromJson(__jsonLogging) : Logging;}
            {_scalingProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("scalingProperties"), out var __jsonScalingProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.NginxDeploymentScalingProperties.FromJson(__jsonScalingProperties) : ScalingProperty;}
            {_userProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Json.JsonObject>("userProfile"), out var __jsonUserProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.NginxDeploymentUserProfile.FromJson(__jsonUserProfile) : UserProfile;}
