...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentApiKeyResponse])]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxConfigurationResponse])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
.Link
https://learn.microsoft.com/powershell/module/az.nginx/get-aznginxdefaultwafpolicy
#>
function Get-AzNginxDefaultWafPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentDefaultWafPolicyListResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Nginx.private\Get-AzNginxDefaultWafPolicy_List';
        }
...
INPUTOBJECT <INginxIdentity>: Identity Parameter
  ...
  [WafPolicyName <String>]: The name of Waf Policy
.Link
https://learn.microsoft.com/powershell/module/az.nginx/get-aznginxwafpolicy
#>
function Get-AzNginxWafPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentWafPolicy], [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentWafPolicyMetadata])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Nginx.private\Get-AzNginxWafPolicy_Get';
            GetViaIdentity = 'Az.Nginx.private\Get-AzNginxWafPolicy_GetViaIdentity';
            List = 'Az.Nginx.private\Get-AzNginxWafPolicy_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.IAnalysisResult])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxConfigurationFile[]]
    # .
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentTags]))]
    [System.Collections.Hashtable]
...
Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentWafPolicy
.Link
https://learn.microsoft.com/powershell/module/az.nginx/new-aznginxwafpolicy
#>
function New-AzNginxWafPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20250301Preview.INginxDeploymentWafPolicy])]
[CmdletBinding(DefaultParameterSetName='CreateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Category('Path')]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Nginx.private\New-AzNginxWafPolicy_CreateExpanded';
        }
        if (('CreateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
