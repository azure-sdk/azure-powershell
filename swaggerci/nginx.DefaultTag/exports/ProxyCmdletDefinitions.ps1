...
PROTECTEDFILE <INginxConfigurationProtectedFileResponse[]>: .
  [ContentHash <String>]: The hash of the content of the file. This value is used to determine if the file has changed.
  [VirtualPath <String>]: The virtual path of the protected file.
.Link
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Support.SkuTier])]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Support.SkuTier]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api50.ITrackedResourceTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
