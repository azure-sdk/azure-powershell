...
.Link
https://learn.microsoft.com/powershell/module/az.nginx/remove-aznginxwafpolicy
#>
function Remove-AzNginxWafPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Nginx.private\Remove-AzNginxWafPolicy_Delete';
            DeleteViaIdentity = 'Az.Nginx.private\Remove-AzNginxWafPolicy_DeleteViaIdentity';
        }
