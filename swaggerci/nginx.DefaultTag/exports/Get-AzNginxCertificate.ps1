...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxCertificate
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxCertificate])]
