...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.INginxCertificate
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240901Preview.INginxCertificate])]
