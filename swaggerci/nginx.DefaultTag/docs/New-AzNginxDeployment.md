...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230401.INginxPrivateIPAddress[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230401.INginxPublicIPAddress[]
Parameter Sets: (All)
Aliases:
