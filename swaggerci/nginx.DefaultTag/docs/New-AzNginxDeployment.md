...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPrivateIPAddress[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20240601Preview.INginxPublicIPAddress[]
Parameter Sets: (All)
Aliases:
