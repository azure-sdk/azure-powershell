...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxPrivateIPAddress[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230901.INginxPublicIPAddress[]
Parameter Sets: (All)
Aliases:
