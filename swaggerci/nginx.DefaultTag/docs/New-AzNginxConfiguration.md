...
New-AzNginxConfiguration -DeploymentName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-PackageProtectedFile <String[]>] [-ProtectedFile <INginxConfigurationProtectedFileResponse[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20241101Preview.INginxConfigurationProtectedFileResponse[]
Parameter Sets: (All)
Aliases:
