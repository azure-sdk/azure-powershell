...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationfabricinfra
#>
function Remove-AzSiteRecoveryReplicationFabricInfra {
...
begin {
    try {
        ...
        $mapping = @{
            Remove = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationFabricInfra_Remove';
            RemoveViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationFabricInfra_RemoveViaIdentity';
        }
