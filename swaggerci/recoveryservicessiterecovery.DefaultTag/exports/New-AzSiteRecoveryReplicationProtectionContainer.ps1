...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/new-azsiterecoveryreplicationprotectioncontainer
#>
function New-AzSiteRecoveryReplicationProtectionContainer {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IReplicationProviderSpecificContainerCreationInput[]]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationProtectionContainer_CreateExpanded';
        }
