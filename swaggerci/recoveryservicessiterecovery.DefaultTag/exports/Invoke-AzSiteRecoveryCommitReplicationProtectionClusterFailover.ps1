...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoverycommitreplicationprotectionclusterfailover
#>
function Invoke-AzSiteRecoveryCommitReplicationProtectionClusterFailover {
...
begin {
    try {
        ...
        $mapping = @{
            Commit = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryCommitReplicationProtectionClusterFailover_Commit';
            CommitViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryCommitReplicationProtectionClusterFailover_CommitViaIdentity';
        }
