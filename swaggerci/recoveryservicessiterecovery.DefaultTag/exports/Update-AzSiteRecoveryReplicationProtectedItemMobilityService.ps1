...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationprotecteditemmobilityservice
#>
function Update-AzSiteRecoveryReplicationProtectedItemMobilityService {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationProtectedItemMobilityService_UpdateViaIdentityExpanded';
        }
