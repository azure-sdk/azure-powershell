...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoveryunplannedreplicationprotectionclusterfailover
#>
function Invoke-AzSiteRecoveryUnplannedReplicationProtectionClusterFailover {
...
begin {
    try {
        ...
        $mapping = @{
            Unplanned = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectionClusterFailover_Unplanned';
            UnplannedExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectionClusterFailover_UnplannedExpanded';
            UnplannedViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectionClusterFailover_UnplannedViaIdentity';
            UnplannedViaIdentityExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryUnplannedReplicationProtectionClusterFailover_UnplannedViaIdentityExpanded';
        }
