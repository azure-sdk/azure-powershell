...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/new-azsiterecoveryreplicationstorageclassificationmapping
#>
function New-AzSiteRecoveryReplicationStorageClassificationMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IStorageClassificationMapping])]
