...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryclusterrecoverypoint
#>
function Get-AzSiteRecoveryClusterRecoveryPoint {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240201.IClusterRecoveryPoint])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryClusterRecoveryPoint_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryClusterRecoveryPoint_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryClusterRecoveryPoint_List';
        }
