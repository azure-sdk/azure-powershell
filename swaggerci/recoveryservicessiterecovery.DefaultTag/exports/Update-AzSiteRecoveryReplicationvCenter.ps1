...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationvcenter
#>
function Update-AzSiteRecoveryReplicationvCenter {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationvCenter_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationvCenter_UpdateViaIdentityExpanded';
        }
