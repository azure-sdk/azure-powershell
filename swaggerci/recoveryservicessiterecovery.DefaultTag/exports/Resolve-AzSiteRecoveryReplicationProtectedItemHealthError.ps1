...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IReplicationProtectedItem])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IResolveHealthError[]]
    # Health errors.
