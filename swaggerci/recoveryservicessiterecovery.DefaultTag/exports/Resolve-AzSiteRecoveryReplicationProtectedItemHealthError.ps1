...
RESOLVEHEALTHINPUT <IResolveHealthInput>: Resolve health input.
  [HealthError <IResolveHealthError[]>]: Health errors.
    [HealthErrorId <String>]: Health error id.
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/resolve-azsiterecoveryreplicationprotecteditemhealtherror
#>
function Resolve-AzSiteRecoveryReplicationProtectedItemHealthError {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IReplicationProtectedItem])]
[CmdletBinding(DefaultParameterSetName='ResolveExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Resolve', Mandatory)]
    [Parameter(ParameterSetName='ResolveExpanded', Mandatory)]
    ...
    [Parameter(ParameterSetName='ResolveExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    ...
    [Parameter(ParameterSetName='ResolveViaIdentityExpanded', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity]
    # Identity Parameter
    ...
    [Parameter(ParameterSetName='Resolve', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='ResolveViaIdentity', Mandatory, ValueFromPipeline)]
    ...
    [Parameter(ParameterSetName='ResolveExpanded')]
    [Parameter(ParameterSetName='ResolveViaIdentityExpanded')]
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IResolveHealthError[]]
    # Health errors.
...
begin {
    try {
        ...
        $mapping = @{
            Resolve = 'Az.SiteRecovery.private\Resolve-AzSiteRecoveryReplicationProtectedItemHealthError_Resolve';
            ResolveExpanded = 'Az.SiteRecovery.private\Resolve-AzSiteRecoveryReplicationProtectedItemHealthError_ResolveExpanded';
            ResolveViaIdentity = 'Az.SiteRecovery.private\Resolve-AzSiteRecoveryReplicationProtectedItemHealthError_ResolveViaIdentity';
            ResolveViaIdentityExpanded = 'Az.SiteRecovery.private\Resolve-AzSiteRecoveryReplicationProtectedItemHealthError_ResolveViaIdentityExpanded';
        }
        if (('Resolve', 'ResolveExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
