...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IReplicationProtectedItem])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IResolveHealthError[]]
    # Health errors.
