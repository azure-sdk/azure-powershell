...
CLEANUPINPUT <IClusterTestFailoverCleanupInput>: Input definition for test failover cleanup for cluster.
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationprotectionclusterfailovercleanup
#>
function Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup {
...
begin {
    try {
        ...
        $mapping = @{
            Test = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup_Test';
            TestExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup_TestExpanded';
            TestViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup_TestViaIdentity';
            TestViaIdentityExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup_TestViaIdentityExpanded';
        }
