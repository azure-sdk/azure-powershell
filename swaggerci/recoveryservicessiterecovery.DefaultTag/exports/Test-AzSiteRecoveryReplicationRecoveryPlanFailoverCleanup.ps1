...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationrecoveryplanfailovercleanup
#>
function Test-AzSiteRecoveryReplicationRecoveryPlanFailoverCleanup {
...
begin {
    try {
        ...
        $mapping = @{
            Test = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationRecoveryPlanFailoverCleanup_Test';
            TestExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationRecoveryPlanFailoverCleanup_TestExpanded';
