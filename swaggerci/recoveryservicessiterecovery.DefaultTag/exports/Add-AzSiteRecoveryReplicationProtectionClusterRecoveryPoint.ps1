...
APPLYCLUSTERRECOVERYPOINTINPUT <IApplyClusterRecoveryPointInput>: Input definition for apply cluster recovery point.
  ...
  [IndividualNodeRecoveryPoint <String[]>]: The list of individual node recovery points.
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/add-azsiterecoveryreplicationprotectionclusterrecoverypoint
#>
function Add-AzSiteRecoveryReplicationProtectionClusterRecoveryPoint {
...
begin {
    try {
        ...
        $mapping = @{
            Apply = 'Az.SiteRecovery.private\Add-AzSiteRecoveryReplicationProtectionClusterRecoveryPoint_Apply';
            ApplyExpanded = 'Az.SiteRecovery.private\Add-AzSiteRecoveryReplicationProtectionClusterRecoveryPoint_ApplyExpanded';
            ApplyViaIdentity = 'Az.SiteRecovery.private\Add-AzSiteRecoveryReplicationProtectionClusterRecoveryPoint_ApplyViaIdentity';
            ApplyViaIdentityExpanded = 'Az.SiteRecovery.private\Add-AzSiteRecoveryReplicationProtectionClusterRecoveryPoint_ApplyViaIdentityExpanded';
        }
