...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationrecoveryservicesprovider
#>
function Clear-AzSiteRecoveryReplicationRecoveryServicesProvider {
...
begin {
    try {
        ...
        $mapping = @{
            Purge = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationRecoveryServicesProvider_Purge';
            PurgeViaIdentity = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationRecoveryServicesProvider_PurgeViaIdentity';
        }
