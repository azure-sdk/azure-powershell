...
This api is for deprecated scenarios and no longer works.
.Description
The operation to reprotect(reverse replicate) a recovery plan.
This api is for deprecated scenarios and no longer works.
.Example
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoveryreprotectreplicationrecoveryplan
#>
function Invoke-AzSiteRecoveryReprotectReplicationRecoveryPlan {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryPlan])]
[CmdletBinding(DefaultParameterSetName='Reprotect', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Reprotect', Mandatory)]
    ...
    [Parameter(ParameterSetName='Reprotect')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    ...
    [Parameter(ParameterSetName='ReprotectViaIdentity', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            ...
            ReprotectViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryReprotectReplicationRecoveryPlan_ReprotectViaIdentity';
        }
        if (('Reprotect') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
