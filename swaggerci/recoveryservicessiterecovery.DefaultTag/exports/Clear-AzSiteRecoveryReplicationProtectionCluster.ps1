...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationprotectioncluster
#>
function Clear-AzSiteRecoveryReplicationProtectionCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Purge = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationProtectionCluster_Purge';
            PurgeViaIdentity = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationProtectionCluster_PurgeViaIdentity';
        }
