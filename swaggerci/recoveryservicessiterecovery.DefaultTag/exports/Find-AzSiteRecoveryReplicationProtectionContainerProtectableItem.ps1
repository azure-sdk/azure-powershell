...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/find-azsiterecoveryreplicationprotectioncontainerprotectableitem
#>
function Find-AzSiteRecoveryReplicationProtectionContainerProtectableItem {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainer])]
...
begin {
    try {
        ...
        $mapping = @{
            Discover = 'Az.SiteRecovery.private\Find-AzSiteRecoveryReplicationProtectionContainerProtectableItem_Discover';
            DiscoverExpanded = 'Az.SiteRecovery.private\Find-AzSiteRecoveryReplicationProtectionContainerProtectableItem_DiscoverExpanded';
