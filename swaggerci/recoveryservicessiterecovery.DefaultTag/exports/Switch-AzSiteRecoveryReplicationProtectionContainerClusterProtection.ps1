...
SWITCHINPUT <ISwitchClusterProtectionInput>: Switch cluster protection input.
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/switch-azsiterecoveryreplicationprotectioncontainerclusterprotection
#>
function Switch-AzSiteRecoveryReplicationProtectionContainerClusterProtection {
...
begin {
    try {
        ...
        $mapping = @{
            Switch = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerClusterProtection_Switch';
            SwitchExpanded = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerClusterProtection_SwitchExpanded';
            SwitchViaIdentity = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerClusterProtection_SwitchViaIdentity';
            SwitchViaIdentityExpanded = 'Az.SiteRecovery.private\Switch-AzSiteRecoveryReplicationProtectionContainerClusterProtection_SwitchViaIdentityExpanded';
        }
