...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IResumeReplicationInput
.Inputs
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/resume-azsiterecoveryreplicationmigrationitemreplication
#>
function Resume-AzSiteRecoveryReplicationMigrationItemReplication {
...
param(
    ...
    [Parameter(ParameterSetName='ResumeExpanded', Mandatory)]
    [Parameter(ParameterSetName='ResumeViaIdentityExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [System.String]
    # The class type.
...
begin {
    try {
        ...
        $mapping = @{
            Resume = 'Az.SiteRecovery.private\Resume-AzSiteRecoveryReplicationMigrationItemReplication_Resume';
            ResumeExpanded = 'Az.SiteRecovery.private\Resume-AzSiteRecoveryReplicationMigrationItemReplication_ResumeExpanded';
