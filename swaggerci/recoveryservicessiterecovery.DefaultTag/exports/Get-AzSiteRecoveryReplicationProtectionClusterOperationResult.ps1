...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotectionclusteroperationresult
#>
function Get-AzSiteRecoveryReplicationProtectionClusterOperationResult {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionClusterOperationResult_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionClusterOperationResult_GetViaIdentity';
        }
