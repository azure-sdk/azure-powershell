...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoverymigrationrecoverypoint
#>
function Get-AzSiteRecoveryMigrationRecoveryPoint {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IMigrationRecoveryPoint])]
