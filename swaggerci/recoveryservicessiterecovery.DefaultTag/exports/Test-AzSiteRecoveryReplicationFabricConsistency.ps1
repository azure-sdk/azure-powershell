...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationfabricconsistency
#>
function Test-AzSiteRecoveryReplicationFabricConsistency {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IFabric])]
...
begin {
    try {
        ...
        $mapping = @{
            Check = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationFabricConsistency_Check';
            CheckViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationFabricConsistency_CheckViaIdentity';
        }
