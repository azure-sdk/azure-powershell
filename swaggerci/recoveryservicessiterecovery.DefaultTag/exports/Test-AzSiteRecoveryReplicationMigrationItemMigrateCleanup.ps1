...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.ITestMigrateCleanupInput
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IMigrationItem])]
