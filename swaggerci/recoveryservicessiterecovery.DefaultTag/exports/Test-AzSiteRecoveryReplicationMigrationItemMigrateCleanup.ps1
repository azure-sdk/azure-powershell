...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationmigrationitemmigratecleanup
#>
function Test-AzSiteRecoveryReplicationMigrationItemMigrateCleanup {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IMigrationItem])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            TestViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationMigrationItemMigrateCleanup_TestViaIdentity';
            TestViaIdentityExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationMigrationItemMigrateCleanup_TestViaIdentityExpanded';
        }
