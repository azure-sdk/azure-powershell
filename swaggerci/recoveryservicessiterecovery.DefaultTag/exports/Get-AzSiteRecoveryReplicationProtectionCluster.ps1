...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotectioncluster
#>
function Get-AzSiteRecoveryReplicationProtectionCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionCluster_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionCluster_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionCluster_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionCluster_List1';
        }
