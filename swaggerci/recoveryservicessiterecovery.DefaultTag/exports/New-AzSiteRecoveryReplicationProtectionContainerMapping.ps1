...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/new-azsiterecoveryreplicationprotectioncontainermapping
#>
function New-AzSiteRecoveryReplicationProtectionContainerMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationProtectionContainerMapping_CreateExpanded';
        }
