...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoverycommitreplicationprotecteditemfailover
#>
function Invoke-AzSiteRecoveryCommitReplicationProtectedItemFailover {
...
begin {
    try {
        ...
        $mapping = @{
            Commit = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryCommitReplicationProtectedItemFailover_Commit';
            CommitViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryCommitReplicationProtectedItemFailover_CommitViaIdentity';
        }
