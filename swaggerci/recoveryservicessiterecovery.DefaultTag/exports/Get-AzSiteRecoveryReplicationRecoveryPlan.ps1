...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationrecoveryplan
#>
function Get-AzSiteRecoveryReplicationRecoveryPlan {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationRecoveryPlan_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationRecoveryPlan_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationRecoveryPlan_List';
        }
