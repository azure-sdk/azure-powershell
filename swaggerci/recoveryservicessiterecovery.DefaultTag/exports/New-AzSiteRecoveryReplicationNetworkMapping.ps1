...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/new-azsiterecoveryreplicationnetworkmapping
#>
function New-AzSiteRecoveryReplicationNetworkMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.INetworkMapping])]
