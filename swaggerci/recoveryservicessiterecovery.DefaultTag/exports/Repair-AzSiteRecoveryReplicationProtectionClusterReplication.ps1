...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/repair-azsiterecoveryreplicationprotectionclusterreplication
#>
function Repair-AzSiteRecoveryReplicationProtectionClusterReplication {
...
begin {
    try {
        ...
        $mapping = @{
            Repair = 'Az.SiteRecovery.private\Repair-AzSiteRecoveryReplicationProtectionClusterReplication_Repair';
            RepairViaIdentity = 'Az.SiteRecovery.private\Repair-AzSiteRecoveryReplicationProtectionClusterReplication_RepairViaIdentity';
        }
