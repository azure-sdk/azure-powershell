...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.ISupportedOperatingSystems
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoverysupportedoperatingsystem
#>
function Get-AzSiteRecoverySupportedOperatingSystem {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.ISupportedOperatingSystems])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.SiteRecovery.private\Get-AzSiteRecoverySupportedOperatingSystem_Get';
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoverySupportedOperatingSystem_GetViaIdentity';
        }
