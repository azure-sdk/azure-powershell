...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IClusterTestFailoverInput
.Inputs
...
FAILOVERINPUT <IClusterTestFailoverInput>: Input definition for test cluster failover.
  [FailoverDirection <FailoverDirection?>]: Failover direction.
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationprotectionclusterfailover
#>
function Test-AzSiteRecoveryReplicationProtectionClusterFailover {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IReplicationProtectionCluster])]
...
param(
    ...
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.FailoverDirection])]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.FailoverDirection]
    # Failover direction.
    ${FailoverDirection},
...
begin {
    try {
        ...
        $mapping = @{
            Test = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailover_Test';
            TestExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailover_TestExpanded';
            TestViaIdentity = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailover_TestViaIdentity';
            TestViaIdentityExpanded = 'Az.SiteRecovery.private\Test-AzSiteRecoveryReplicationProtectionClusterFailover_TestViaIdentityExpanded';
        }
