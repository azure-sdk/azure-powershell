...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401
{
    ...
    public partial class ProtectionContainerMappingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingProviderSpecificDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.ProtectionContainerMappingProviderSpecificDetails()); set { {_providerSpecificDetail = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingProviderSpecificDetails _providerSpecificDetail;

        /// <summary>Provider specific provider details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingProviderSpecificDetails ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.ProtectionContainerMappingProviderSpecificDetails()); set => this._providerSpecificDetail = value; }
...

    {
        ...
        string PolicyId { get; set; }
        /// <summary>Provider specific provider details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240401.IProtectionContainerMappingProviderSpecificDetails ProviderSpecificDetail { get; set; }
        /// <summary>Gets the class type. Overridden in derived classes.</summary>
        string ProviderSpecificDetailInstanceType { get; set; }
        /// <summary>Friendly name of source fabric.</summary>
        string SourceFabricFriendlyName { get; set; }
