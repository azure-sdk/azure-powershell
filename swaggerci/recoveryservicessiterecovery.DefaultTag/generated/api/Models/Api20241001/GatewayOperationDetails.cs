...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001
{
    ...
    public partial class GatewayOperationDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.DataStore { get => this._dataStore; set { {_dataStore = value;} } }

        /// <summary>Internal Acessors for HostName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.HostName { get => this._hostName; set { {_hostName = value;} } }

        /// <summary>Internal Acessors for ProgressPercentage</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.ProgressPercentage { get => this._progressPercentage; set { {_progressPercentage = value;} } }

        /// <summary>Internal Acessors for State</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.State { get => this._state; set { {_state = value;} } }

        /// <summary>Internal Acessors for TimeElapsed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.TimeElapsed { get => this._timeElapsed; set { {_timeElapsed = value;} } }

        /// <summary>Internal Acessors for TimeRemaining</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.TimeRemaining { get => this._timeRemaining; set { {_timeRemaining = value;} } }

        /// <summary>Internal Acessors for UploadSpeed</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.UploadSpeed { get => this._uploadSpeed; set { {_uploadSpeed = value;} } }

        /// <summary>Internal Acessors for VmwareReadThroughput</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IGatewayOperationDetailsInternal.VmwareReadThroughput { get => this._vmwareReadThroughput; set { {_vmwareReadThroughput = value;} } }
