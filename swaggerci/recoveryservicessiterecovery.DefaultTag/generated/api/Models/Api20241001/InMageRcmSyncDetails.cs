...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001
{
    ...
    public partial class InMageRcmSyncDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.Last15MinutesTransferredByte { get => this._last15MinutesTransferredByte; set { {_last15MinutesTransferredByte = value;} } }

        /// <summary>Internal Acessors for LastDataTransferTimeUtc</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.LastDataTransferTimeUtc { get => this._lastDataTransferTimeUtc; set { {_lastDataTransferTimeUtc = value;} } }

        /// <summary>Internal Acessors for LastRefreshTime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.LastRefreshTime { get => this._lastRefreshTime; set { {_lastRefreshTime = value;} } }

        /// <summary>Internal Acessors for ProcessedByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.ProcessedByte { get => this._processedByte; set { {_processedByte = value;} } }

        /// <summary>Internal Acessors for ProgressHealth</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.ProgressHealth { get => this._progressHealth; set { {_progressHealth = value;} } }

        /// <summary>Internal Acessors for ProgressPercentage</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.ProgressPercentage { get => this._progressPercentage; set { {_progressPercentage = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for TransferredByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IInMageRcmSyncDetailsInternal.TransferredByte { get => this._transferredByte; set { {_transferredByte = value;} } }
