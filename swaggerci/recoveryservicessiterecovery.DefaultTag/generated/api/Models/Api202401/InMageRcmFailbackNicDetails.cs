...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401
{
    ...
    public partial class InMageRcmFailbackNicDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401.IInMageRcmFailbackNicDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401.IInMageRcmFailbackNicDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401.IInMageRcmFailbackNicDetailsInternal.AdapterType { get => this._adapterType; set { {_adapterType = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401.IInMageRcmFailbackNicDetailsInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401.IInMageRcmFailbackNicDetailsInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for SourceIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202401.IInMageRcmFailbackNicDetailsInternal.SourceIPAddress { get => this._sourceIPAddress; set { {_sourceIPAddress = value;} } }
