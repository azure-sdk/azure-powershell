...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601
{
    ...
    public partial class ApplianceResourceDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IApplianceResourceDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IApplianceResourceDetailsInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IApplianceResourceDetailsInternal.Capacity { get => this._capacity; set { {_capacity = value;} } }

        /// <summary>Internal Acessors for ProcessUtilization</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IApplianceResourceDetailsInternal.ProcessUtilization { get => this._processUtilization; set { {_processUtilization = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IApplianceResourceDetailsInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for TotalUtilization</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IApplianceResourceDetailsInternal.TotalUtilization { get => this._totalUtilization; set { {_totalUtilization = value;} } }
