...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601
{
    ...
    public partial class AgentDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetailsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDiskDetails[] _disk;

        /// <summary>The disks.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDiskDetails[] Disk { get => this._disk; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetailsInternal.AgentId { get => this._agentId; set { {_agentId = value;} } }

        /// <summary>Internal Acessors for BiosId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetailsInternal.BiosId { get => this._biosId; set { {_biosId = value;} } }

        /// <summary>Internal Acessors for Disk</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDiskDetails[] Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetailsInternal.Disk { get => this._disk; set { {_disk = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetailsInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for MachineId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDetailsInternal.MachineId { get => this._machineId; set { {_machineId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDiskDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDiskDetails[] Disk { get;  }
        /// <summary>The machine FQDN.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The disks.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IAgentDiskDetails[] Disk { get; set; }
        /// <summary>The machine FQDN.</summary>
        string Fqdn { get; set; }
        /// <summary>The Id of the machine to which the agent is registered.</summary>
