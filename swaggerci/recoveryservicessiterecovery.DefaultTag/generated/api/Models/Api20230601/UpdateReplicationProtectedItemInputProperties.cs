...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601
{
    ...
    public partial class UpdateReplicationProtectedItemInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemInputPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemProviderInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemInputPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.UpdateReplicationProtectedItemProviderInput()); set { {_providerSpecificDetail = value;} } }

        /// <summary>Backing field for <see cref="ProviderSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemProviderInput _providerSpecificDetail;

        /// <summary>The provider specific input to update replication protected item.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemProviderInput ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.UpdateReplicationProtectedItemProviderInput()); set => this._providerSpecificDetail = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IVMNicInputDetails[] _vMNic;

        /// <summary>The list of VM nic details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IVMNicInputDetails[] VMNic { get => this._vMNic; set => this._vMNic = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IVMNicInputDetails[] VMNic { get; set; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.LicenseType? LicenseType { get; set; }
        /// <summary>The provider specific input to update replication protected item.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IUpdateReplicationProtectedItemProviderInput ProviderSpecificDetail { get; set; }
        /// <summary>The class type.</summary>
        string ProviderSpecificDetailInstanceType { get; set; }
        /// <summary>The target availability set Id.</summary>
        string RecoveryAvailabilitySetId { get; set; }
