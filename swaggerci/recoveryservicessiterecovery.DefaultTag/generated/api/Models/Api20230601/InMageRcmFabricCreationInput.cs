...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601
{
    ...
    public partial class InMageRcmFabricCreationInput :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IInMageRcmFabricCreationInput,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IInMageRcmFabricCreationInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IIdentityProviderInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IInMageRcmFabricCreationInputInternal.SourceAgentIdentity { get => (this._sourceAgentIdentity = this._sourceAgentIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IdentityProviderInput()); set { {_sourceAgentIdentity = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IIdentityProviderInput _sourceAgentIdentity;

        /// <summary>The identity provider input for source agent authentication.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IIdentityProviderInput SourceAgentIdentity { get => (this._sourceAgentIdentity = this._sourceAgentIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IdentityProviderInput()); set => this._sourceAgentIdentity = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IFabricSpecificCreationInputInternal
    {
        ...
        string PhysicalSiteId { get; set; }
        /// <summary>The identity provider input for source agent authentication.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IIdentityProviderInput SourceAgentIdentity { get; set; }
        /// <summary>The base authority for Azure Active Directory authentication.</summary>
        string SourceAgentIdentityAadAuthority { get; set; }
        /// <summary>
        /// The application/client Id for the service principal with which the on-premise management/data plane components would communicate
