...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301
{
    ...
    public partial class ExistingRecoveryAvailabilitySet :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IExistingRecoveryAvailabilitySet,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IExistingRecoveryAvailabilitySetInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryAvailabilitySetCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryAvailabilitySetCustomDetails __recoveryAvailabilitySetCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.RecoveryAvailabilitySetCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryAvailabilitySetCustomDetailsInternal)__recoveryAvailabilitySetCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryAvailabilitySetCustomDetailsInternal)__recoveryAvailabilitySetCustomDetails).ResourceType = value ; }
    ...
    public partial interface IExistingRecoveryAvailabilitySet :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryAvailabilitySetCustomDetails
    {
        /// <summary>The recovery availability set Id. Will throw error, if resource does not exist.</summary>
    ...
    internal partial interface IExistingRecoveryAvailabilitySetInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryAvailabilitySetCustomDetailsInternal
    {
        /// <summary>The recovery availability set Id. Will throw error, if resource does not exist.</summary>
        string RecoveryAvailabilitySetId { get; set; }
