...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301
{
    ...
    public partial class RecoveryPointProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryPointProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryPointPropertiesInternal
    {

        /// <summary>Internal Acessors for ProviderSpecificDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProviderSpecificRecoveryPointDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryPointPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.ProviderSpecificRecoveryPointDetails()); set { {_providerSpecificDetail = value;} } }

        /// <summary>Backing field for <see cref="ProviderSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProviderSpecificRecoveryPointDetails _providerSpecificDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProviderSpecificRecoveryPointDetails ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.ProviderSpecificRecoveryPointDetails()); set => this._providerSpecificDetail = value; }
        ...
        public string ProviderSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProviderSpecificRecoveryPointDetailsInternal)ProviderSpecificDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProviderSpecificRecoveryPointDetailsInternal)ProviderSpecificDetail).InstanceType = value ?? null; }
    ...
    {
        /// <summary>The provider specific details for the recovery point.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProviderSpecificRecoveryPointDetails ProviderSpecificDetail { get; set; }
        /// <summary>Gets the provider type.</summary>
        string ProviderSpecificDetailInstanceType { get; set; }
        /// <summary>The recovery point time.</summary>
        global::System.DateTime? RecoveryPointTime { get; set; }
