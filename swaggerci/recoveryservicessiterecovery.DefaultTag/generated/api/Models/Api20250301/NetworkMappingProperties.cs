...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301
{
    ...
    public partial class NetworkMappingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.INetworkMappingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.INetworkMappingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.INetworkMappingFabricSpecificSettings _fabricSpecificSetting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.NetworkMappingFabricSpecificSettings()); set => this._fabricSpecificSetting = value; }
    ...
    {
        /// <summary>The fabric specific settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get; set; }
        /// <summary>Gets the Instance type.</summary>
        string FabricSpecificSettingInstanceType { get; set; }
        /// <summary>The primary fabric friendly name.</summary>
        string PrimaryFabricFriendlyName { get; set; }
