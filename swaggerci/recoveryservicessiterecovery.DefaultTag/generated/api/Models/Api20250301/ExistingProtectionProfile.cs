...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301
{
    ...
    public partial class ExistingProtectionProfile :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IExistingProtectionProfile,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IExistingProtectionProfileInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProtectionProfileCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProtectionProfileCustomDetails __protectionProfileCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.ProtectionProfileCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProtectionProfileCustomDetailsInternal)__protectionProfileCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProtectionProfileCustomDetailsInternal)__protectionProfileCustomDetails).ResourceType = value ; }
    ...
    public partial interface IExistingProtectionProfile :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProtectionProfileCustomDetails
    {
        /// <summary>The protection profile Arm Id. Throw error, if resource does not exists.</summary>
    ...
    internal partial interface IExistingProtectionProfileInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IProtectionProfileCustomDetailsInternal
    {
        /// <summary>The protection profile Arm Id. Throw error, if resource does not exists.</summary>
        string ProtectionProfileId { get; set; }
