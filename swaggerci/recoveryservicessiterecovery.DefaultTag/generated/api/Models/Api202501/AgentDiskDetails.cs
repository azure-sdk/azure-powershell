...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501
{
    ...
    public partial class AgentDiskDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetailsInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetailsInternal.CapacityInByte { get => this._capacityInByte; set { {_capacityInByte = value;} } }

        /// <summary>Internal Acessors for DiskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetailsInternal.DiskId { get => this._diskId; set { {_diskId = value;} } }

        /// <summary>Internal Acessors for DiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetailsInternal.DiskName { get => this._diskName; set { {_diskName = value;} } }

        /// <summary>Internal Acessors for IsOSDisk</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetailsInternal.IsOSDisk { get => this._isOSDisk; set { {_isOSDisk = value;} } }

        /// <summary>Internal Acessors for LunId</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IAgentDiskDetailsInternal.LunId { get => this._lunId; set { {_lunId = value;} } }
