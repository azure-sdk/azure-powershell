...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class EventProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventSpecificDetails _eventSpecificDetail;

        /// <summary>The event specific settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventSpecificDetails EventSpecificDetail { get => (this._eventSpecificDetail = this._eventSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.EventSpecificDetails()); set => this._eventSpecificDetail = value; }
        ...
        public string EventSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventSpecificDetailsInternal)EventSpecificDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventSpecificDetailsInternal)EventSpecificDetail).InstanceType = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventSpecificDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventPropertiesInternal.EventSpecificDetail { get => (this._eventSpecificDetail = this._eventSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.EventSpecificDetails()); set { {_eventSpecificDetail = value;} } }

        /// <summary>Internal Acessors for ProviderSpecificDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventProviderSpecificDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.EventProviderSpecificDetails()); set { {_providerSpecificDetail = value;} } }

        /// <summary>Backing field for <see cref="ProviderSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventProviderSpecificDetails _providerSpecificDetail;

        /// <summary>The provider specific settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventProviderSpecificDetails ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.EventProviderSpecificDetails()); set => this._providerSpecificDetail = value; }

        /// <summary>Gets the class type. Overridden in derived classes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inlined)]
        public string ProviderSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventProviderSpecificDetailsInternal)ProviderSpecificDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventProviderSpecificDetailsInternal)ProviderSpecificDetail).InstanceType = value ?? null; }
...

    {
        ...
        string EventCode { get; set; }
        /// <summary>The event specific settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IEventSpecificDetails EventSpecificDetail { get; set; }
        /// <summary>Gets the class type. Overridden in derived classes.</summary>
        string EventSpecificDetailInstanceType { get; set; }
        /// <summary>The type of the event. for example: VM Health, Server Health, Job Failure etc.</summary>
        string EventType { get; set; }
