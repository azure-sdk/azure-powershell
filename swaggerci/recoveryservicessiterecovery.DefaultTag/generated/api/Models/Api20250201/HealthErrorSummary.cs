...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class HealthErrorSummary :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IHealthErrorSummary,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IHealthErrorSummaryInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.HealthErrorCategory? _category;

        /// <summary>The category of the health error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.HealthErrorCategory? Category { get => this._category; set => this._category = value; }

        /// <summary>Backing field for <see cref="Severity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.Severity? _severity;

        /// <summary>Severity of error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.Severity? Severity { get => this._severity; set => this._severity = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.HealthErrorCategory) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.HealthErrorCategory? Category { get; set; }
        /// <summary>Severity of error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.Severity) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.Severity? Severity { get; set; }
        /// <summary>The code of the health error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
