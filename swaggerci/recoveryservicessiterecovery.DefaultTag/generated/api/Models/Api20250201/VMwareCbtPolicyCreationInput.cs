...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class VMwareCbtPolicyCreationInput :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IVMwareCbtPolicyCreationInput,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IVMwareCbtPolicyCreationInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IPolicyProviderSpecificInput"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IPolicyProviderSpecificInput __policyProviderSpecificInput = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.PolicyProviderSpecificInput();
        ...
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IPolicyProviderSpecificInputInternal)__policyProviderSpecificInput).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IPolicyProviderSpecificInputInternal)__policyProviderSpecificInput).InstanceType = value ; }
    ...
    public partial interface IVMwareCbtPolicyCreationInput :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IPolicyProviderSpecificInput
    {
        /// <summary>The app consistent snapshot frequency (in minutes).</summary>
    ...
    internal partial interface IVMwareCbtPolicyCreationInputInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IPolicyProviderSpecificInputInternal
    {
        /// <summary>The app consistent snapshot frequency (in minutes).</summary>
        int? AppConsistentFrequencyInMinute { get; set; }
        /// <summary>The crash consistent snapshot frequency (in minutes).</summary>
