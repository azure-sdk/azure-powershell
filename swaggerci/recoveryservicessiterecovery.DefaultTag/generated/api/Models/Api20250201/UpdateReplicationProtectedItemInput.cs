...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class UpdateReplicationProtectedItemInput :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInput,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputProperties Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.UpdateReplicationProtectedItemInputProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProviderSpecificDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemProviderInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputInternal.ProviderSpecificDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputPropertiesInternal)Property).ProviderSpecificDetail; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputPropertiesInternal)Property).ProviderSpecificDetail = value; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.UpdateReplicationProtectedItemInputProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IVMNicInputDetails[] VMNic { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputPropertiesInternal)Property).VMNic; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputPropertiesInternal)Property).VMNic = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IVMNicInputDetails[] VMNic { get; set; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.LicenseType? LicenseType { get; set; }
        /// <summary>Update replication protected item properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemInputProperties Property { get; set; }
        /// <summary>The provider specific input to update replication protected item.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IUpdateReplicationProtectedItemProviderInput ProviderSpecificDetail { get; set; }
        /// <summary>The class type.</summary>
        string ProviderSpecificDetailInstanceType { get; set; }
        /// <summary>The target availability set Id.</summary>
        string RecoveryAvailabilitySetId { get; set; }
