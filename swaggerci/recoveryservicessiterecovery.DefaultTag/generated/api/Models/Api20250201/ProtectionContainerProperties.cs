...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class ProtectionContainerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerFabricSpecificDetails _fabricSpecificDetail;

        /// <summary>Fabric specific details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerFabricSpecificDetails FabricSpecificDetail { get => (this._fabricSpecificDetail = this._fabricSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.ProtectionContainerFabricSpecificDetails()); set => this._fabricSpecificDetail = value; }
        ...
        public string FabricSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerFabricSpecificDetailsInternal)FabricSpecificDetail).InstanceType; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerFabricSpecificDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerPropertiesInternal.FabricSpecificDetail { get => (this._fabricSpecificDetail = this._fabricSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.ProtectionContainerFabricSpecificDetails()); set { {_fabricSpecificDetail = value;} } }

        /// <summary>Internal Acessors for FabricSpecificDetailInstanceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerPropertiesInternal.FabricSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerFabricSpecificDetailsInternal)FabricSpecificDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IProtectionContainerFabricSpecificDetailsInternal)FabricSpecificDetail).InstanceType = value; }
