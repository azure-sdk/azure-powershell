...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class InMageRcmFailbackMobilityAgentDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.AgentVersionExpiryDate { get => this._agentVersionExpiryDate; set { {_agentVersionExpiryDate = value;} } }

        /// <summary>Internal Acessors for DriverVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.DriverVersion { get => this._driverVersion; set { {_driverVersion = value;} } }

        /// <summary>Internal Acessors for DriverVersionExpiryDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.DriverVersionExpiryDate { get => this._driverVersionExpiryDate; set { {_driverVersionExpiryDate = value;} } }

        /// <summary>Internal Acessors for IsUpgradeable</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.IsUpgradeable { get => this._isUpgradeable; set { {_isUpgradeable = value;} } }

        /// <summary>Internal Acessors for LastHeartbeatUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.LastHeartbeatUtc { get => this._lastHeartbeatUtc; set { {_lastHeartbeatUtc = value;} } }

        /// <summary>Internal Acessors for LatestUpgradableVersionWithoutReboot</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.LatestUpgradableVersionWithoutReboot { get => this._latestUpgradableVersionWithoutReboot; set { {_latestUpgradableVersionWithoutReboot = value;} } }

        /// <summary>Internal Acessors for LatestVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.LatestVersion { get => this._latestVersion; set { {_latestVersion = value;} } }

        /// <summary>Internal Acessors for ReasonsBlockingUpgrade</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.AgentUpgradeBlockedReason[] Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.ReasonsBlockingUpgrade { get => this._reasonsBlockingUpgrade; set { {_reasonsBlockingUpgrade = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IInMageRcmFailbackMobilityAgentDetailsInternal.Version { get => this._version; set { {_version = value;} } }
