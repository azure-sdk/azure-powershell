...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201
{
    ...
    public partial class ExistingRecoveryVirtualNetwork :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IExistingRecoveryVirtualNetwork,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IExistingRecoveryVirtualNetworkInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryVirtualNetworkCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryVirtualNetworkCustomDetails __recoveryVirtualNetworkCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.RecoveryVirtualNetworkCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryVirtualNetworkCustomDetailsInternal)__recoveryVirtualNetworkCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryVirtualNetworkCustomDetailsInternal)__recoveryVirtualNetworkCustomDetails).ResourceType = value ; }
    ...
    internal partial interface IExistingRecoveryVirtualNetworkInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryVirtualNetworkCustomDetailsInternal
    {
        /// <summary>The recovery subnet name.</summary>
        string RecoverySubnetName { get; set; }
        /// <summary>The recovery virtual network Id. Will throw error, if resource does not exist.</summary>
