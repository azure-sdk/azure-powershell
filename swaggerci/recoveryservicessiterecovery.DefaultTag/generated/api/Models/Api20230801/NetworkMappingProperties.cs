...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801
{
    ...
    public partial class NetworkMappingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingFabricSpecificSettings _fabricSpecificSetting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.NetworkMappingFabricSpecificSettings()); set => this._fabricSpecificSetting = value; }
        ...
        public string FabricSpecificSettingInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType = value ?? null; }

        /// <summary>Internal Acessors for FabricSpecificSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingFabricSpecificSettings Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingPropertiesInternal.FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.NetworkMappingFabricSpecificSettings()); set { {_fabricSpecificSetting = value;} } }
    ...
    {
        /// <summary>The fabric specific settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get; set; }
        /// <summary>Gets the Instance type.</summary>
        string FabricSpecificSettingInstanceType { get; set; }
        /// <summary>The primary fabric friendly name.</summary>
        string PrimaryFabricFriendlyName { get; set; }
