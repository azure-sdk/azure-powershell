...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801
{
    ...
    public partial class TestFailoverJobDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.ITestFailoverJobDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.ITestFailoverJobDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetails __jobDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.JobDetails();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetailsAffectedObjectDetails AffectedObjectDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetailsInternal)__jobDetails).AffectedObjectDetail; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetailsInternal)__jobDetails).AffectedObjectDetail = value ?? null /* model class */; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inherited)]
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetailsInternal)__jobDetails).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetailsInternal)__jobDetails).InstanceType = value ; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IFailoverReplicationProtectedItemDetails[] _protectedItemDetail;

        /// <summary>The test VM details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IFailoverReplicationProtectedItemDetails[] ProtectedItemDetail { get => this._protectedItemDetail; set => this._protectedItemDetail = value; }
    ...
    public partial interface ITestFailoverJobDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetails
    {
        /// <summary>The test failover comments.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IFailoverReplicationProtectedItemDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IFailoverReplicationProtectedItemDetails[] ProtectedItemDetail { get; set; }
        /// <summary>The test failover status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface ITestFailoverJobDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230801.IJobDetailsInternal
    {
        /// <summary>The test failover comments.</summary>
        string Comment { get; set; }
        /// <summary>The test network friendly name.</summary>
