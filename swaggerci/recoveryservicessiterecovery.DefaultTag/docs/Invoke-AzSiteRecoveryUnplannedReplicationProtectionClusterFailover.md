...
Invoke-AzSiteRecoveryUnplannedReplicationProtectionClusterFailover -InputObject <ISiteRecoveryIdentity>
 -FailoverInput <IClusterUnplannedFailoverInput> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230301.IClusterUnplannedFailoverInput
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230301.IClusterUnplannedFailoverInput
...
`FAILOVERINPUT <IClusterUnplannedFailoverInput>`: Input definition for unplanned cluster failover.
