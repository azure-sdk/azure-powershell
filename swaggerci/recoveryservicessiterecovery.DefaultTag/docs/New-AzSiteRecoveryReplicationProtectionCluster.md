...
New-AzSiteRecoveryReplicationProtectionCluster -FabricName <String> -Name <String>
 ...
 [-PrimaryProtectionContainerFriendlyName <String>] [-ProtectionClusterStatus <String>]
 [-ProtectionClusterType <String>] [-ProtectionState <String>] [-ProtectionStateDescription <String>]
 ...
 [-SharedDiskProviderSpecificDetailInstanceType <String>] [-StartTime <DateTime>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230301.IRegisteredClusterNodes[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230301.IHealthError[]
Parameter Sets: (All)
Aliases:
...
### -Name
A name for the replication protection cluster.
