...
### Purge (Default)
```
Clear-AzSiteRecoveryReplicationProtectionContainerMapping -FabricName <String> -MappingName <String>
...
### PurgeViaIdentity
```
Clear-AzSiteRecoveryReplicationProtectionContainerMapping -InputObject <ISiteRecoveryIdentity>
