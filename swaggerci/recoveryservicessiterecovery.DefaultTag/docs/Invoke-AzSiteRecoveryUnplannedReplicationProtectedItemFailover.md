...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoveryunplannedreplicationprotecteditemfailover
schema: 2.0.0
---
...
```
Invoke-AzSiteRecoveryUnplannedReplicationProtectedItemFailover -FabricName <String>
...
```
Invoke-AzSiteRecoveryUnplannedReplicationProtectedItemFailover -InputObject <ISiteRecoveryIdentity>
 -FailoverInput <IUnplannedFailoverInput> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240201.IUnplannedFailoverInput
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240201.IUnplannedFailoverInput

### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.ISiteRecoveryIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20240201.IReplicationProtectedItem
