...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/update-azsiterecoveryreplicationmigrationitem
schema: 2.0.0
---
...
```
Update-AzSiteRecoveryReplicationMigrationItem -FabricName <String> -MigrationItemName <String>
...
```
Update-AzSiteRecoveryReplicationMigrationItem -InputObject <ISiteRecoveryIdentity>
