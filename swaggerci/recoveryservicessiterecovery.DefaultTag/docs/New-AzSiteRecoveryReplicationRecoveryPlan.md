...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IRecoveryPlanGroup[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20230601.IRecoveryPlanProviderSpecificInput[]
Parameter Sets: (All)
Aliases:
