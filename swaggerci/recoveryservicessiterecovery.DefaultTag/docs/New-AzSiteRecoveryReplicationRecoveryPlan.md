...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryPlanGroup[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250301.IRecoveryPlanProviderSpecificInput[]
Parameter Sets: (All)
Aliases:
