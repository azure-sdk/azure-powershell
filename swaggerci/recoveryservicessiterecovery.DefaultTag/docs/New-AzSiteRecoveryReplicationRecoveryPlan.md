...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryPlanGroup[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20250201.IRecoveryPlanProviderSpecificInput[]
Parameter Sets: (All)
Aliases:
