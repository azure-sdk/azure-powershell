...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationprotectioncluster
schema: 2.0.0
---

# Clear-AzSiteRecoveryReplicationProtectionCluster
...
### Purge (Default)
```
Clear-AzSiteRecoveryReplicationProtectionCluster -FabricName <String> -Name <String>
...
### PurgeViaIdentity
```
Clear-AzSiteRecoveryReplicationProtectionCluster -InputObject <ISiteRecoveryIdentity>
