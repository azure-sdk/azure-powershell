...
online version: https://learn.microsoft.com/powershell/module/az.siterecovery/test-azsiterecoveryreplicationprotectionclusterfailovercleanup
schema: 2.0.0
---

# Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup
...
```
Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup -FabricName <String>
...
### TestViaIdentity
```
Test-AzSiteRecoveryReplicationProtectionClusterFailoverCleanup -InputObject <ISiteRecoveryIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202501.IClusterTestFailoverCleanupInput
