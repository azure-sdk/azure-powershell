...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryoperation
#>
function Get-AzSiteRecoveryOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20241001.IOperationsDiscovery])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryOperation_List';
        }
