...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.storagesync/invoke-azstoragesyncsharecloudendpoint
#>
function Invoke-AzStorageSyncShareCloudEndpoint {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ICloudEndpointAfsShareMetadataCertificatePublicKeys])]
