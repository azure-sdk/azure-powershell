...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason Registered = @"Registered";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason Suspended = @"Suspended";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason Unregistered = @"Unregistered";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason Warned = @"Warned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason e1, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.Reason e2)
        {
            return !e2.Equals(e1);
        }
