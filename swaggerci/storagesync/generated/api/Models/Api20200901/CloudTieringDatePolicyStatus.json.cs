...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20200901
{
    ...
    public partial class CloudTieringDatePolicyStatus
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject into a new instance of <see cref="CloudTieringDatePolicyStatus" />.
        /// </summary>
        ...
        internal CloudTieringDatePolicyStatus(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject json)
        {
            ...
            {_tieredFilesMostRecentAccessTimestamp = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonString>("tieredFilesMostRecentAccessTimestamp"), out var __jsonTieredFilesMostRecentAccessTimestamp) ? global::System.DateTime.TryParse((string)__jsonTieredFilesMostRecentAccessTimestamp, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonTieredFilesMostRecentAccessTimestampValue) ? __jsonTieredFilesMostRecentAccessTimestampValue : TieredFilesMostRecentAccessTimestamp : TieredFilesMostRecentAccessTimestamp;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20200901.ICloudTieringDatePolicyStatus.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20200901.ICloudTieringDatePolicyStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20200901.ICloudTieringDatePolicyStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject json ? new CloudTieringDatePolicyStatus(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CloudTieringDatePolicyStatus" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CloudTieringDatePolicyStatus" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._tieredFilesMostRecentAccessTimestamp ? (Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonString(this._tieredFilesMostRecentAccessTimestamp?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "tieredFilesMostRecentAccessTimestamp" ,container.Add );
            }
