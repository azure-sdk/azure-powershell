...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901
{
    ...
    public partial class ServerEndpointSyncStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncStatus.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncStatus.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncStatus FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonNode node)
        {
        ...
        internal ServerEndpointSyncStatus(Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject json)
        {
            ...
            {_uploadStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("uploadStatus"), out var __jsonUploadStatus) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ServerEndpointSyncSessionStatus.FromJson(__jsonUploadStatus) : UploadStatus;}
            {_downloadStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("downloadStatus"), out var __jsonDownloadStatus) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ServerEndpointSyncSessionStatus.FromJson(__jsonDownloadStatus) : DownloadStatus;}
            {_uploadActivity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("uploadActivity"), out var __jsonUploadActivity) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ServerEndpointSyncActivityStatus.FromJson(__jsonUploadActivity) : UploadActivity;}
            {_downloadActivity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("downloadActivity"), out var __jsonDownloadActivity) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ServerEndpointSyncActivityStatus.FromJson(__jsonDownloadActivity) : DownloadActivity;}
            {_backgroundDataDownloadActivity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Json.JsonObject>("backgroundDataDownloadActivity"), out var __jsonBackgroundDataDownloadActivity) ? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.ServerEndpointBackgroundDataDownloadActivity.FromJson(__jsonBackgroundDataDownloadActivity) : BackgroundDataDownloadActivity;}
