...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901
{
    ...
    public partial class ServerEndpointSyncSessionStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal
    {

        /// <summary>Backing field for <see cref="FilesNotSyncingError" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointFilesNotSyncingError[] _filesNotSyncingError;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointFilesNotSyncingError[] FilesNotSyncingError { get => this._filesNotSyncingError; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointFilesNotSyncingError[] Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.FilesNotSyncingError { get => this._filesNotSyncingError; set { {_filesNotSyncingError = value;} } }

        /// <summary>Internal Acessors for LastSyncMode</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Support.ServerEndpointSyncMode? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.LastSyncMode { get => this._lastSyncMode; set { {_lastSyncMode = value;} } }

        /// <summary>Internal Acessors for LastSyncPerItemErrorCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.LastSyncPerItemErrorCount { get => this._lastSyncPerItemErrorCount; set { {_lastSyncPerItemErrorCount = value;} } }

        /// <summary>Internal Acessors for LastSyncResult</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.LastSyncResult { get => this._lastSyncResult; set { {_lastSyncResult = value;} } }

        /// <summary>Internal Acessors for LastSyncSuccessTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.LastSyncSuccessTimestamp { get => this._lastSyncSuccessTimestamp; set { {_lastSyncSuccessTimestamp = value;} } }

        /// <summary>Internal Acessors for LastSyncTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.LastSyncTimestamp { get => this._lastSyncTimestamp; set { {_lastSyncTimestamp = value;} } }

        /// <summary>Internal Acessors for PersistentFilesNotSyncingCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.PersistentFilesNotSyncingCount { get => this._persistentFilesNotSyncingCount; set { {_persistentFilesNotSyncingCount = value;} } }

        /// <summary>Internal Acessors for TransientFilesNotSyncingCount</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointSyncSessionStatusInternal.TransientFilesNotSyncingCount { get => this._transientFilesNotSyncingCount; set { {_transientFilesNotSyncingCount = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointFilesNotSyncingError[] FilesNotSyncingError { get;  }
        /// <summary>Sync mode</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>Array of per-item errors coming from the last sync session.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220901.IServerEndpointFilesNotSyncingError[] FilesNotSyncingError { get; set; }
        /// <summary>Sync mode</summary>
