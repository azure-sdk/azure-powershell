...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagesync/remove-azstoragesyncregisteredserver
schema: 2.0.0
---

# Remove-AzStorageSyncRegisteredServer
...
### Delete (Default)
```
Remove-AzStorageSyncRegisteredServer -ResourceGroupName <String> -ServerId <String>
...
### DeleteViaIdentity
```
Remove-AzStorageSyncRegisteredServer -InputObject <IStorageSyncIdentity> [-DefaultProfile <PSObject>] [-AsJob]
