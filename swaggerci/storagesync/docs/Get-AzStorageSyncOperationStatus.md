...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagesync/get-azstoragesyncoperationstatus
schema: 2.0.0
---

# Get-AzStorageSyncOperationStatus
...
### Get (Default)
```
Get-AzStorageSyncOperationStatus -LocationName <String> -OperationId <String> -ResourceGroupName <String>
 -WorkflowId <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStorageSyncOperationStatus -InputObject <IStorageSyncIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.StorageSync.Models.Api20220601.IOperationStatus
