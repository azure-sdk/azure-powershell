...
online version: https://docs.microsoft.com/en-us/powershell/module/az.storagesync/update-azstoragesyncregisteredserver
schema: 2.0.0
---

# Update-AzStorageSyncRegisteredServer
...
```
Update-AzStorageSyncRegisteredServer -ResourceGroupName <String> -ServerId <String>
 -StorageSyncServiceName <String> [-SubscriptionId <String>] [-ApplicationId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzStorageSyncRegisteredServer -InputObject <IStorageSyncIdentity> [-ApplicationId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
