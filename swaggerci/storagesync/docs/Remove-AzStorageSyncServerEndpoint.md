...
### Delete (Default)
```
Remove-AzStorageSyncServerEndpoint -Name <String> -ResourceGroupName <String> -StorageSyncServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzStorageSyncServerEndpoint -InputObject <IStorageSyncIdentity> [-DefaultProfile <PSObject>] [-AsJob]
