...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201
{
    ...
    public partial class AssessmentSettings :
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IAssessmentSettings,
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IAssessmentSettingsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.ISchedule Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IAssessmentSettingsInternal.Schedule { get => (this._schedule = this._schedule ?? new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.Schedule()); set { {_schedule = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.ISchedule _schedule;

        /// <summary>Schedule for Assessment.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.ISchedule Schedule { get => (this._schedule = this._schedule ?? new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.Schedule()); set => this._schedule = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.AssessmentDayOfWeek? ScheduleDayOfWeek { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).DayOfWeek; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).DayOfWeek = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.AssessmentDayOfWeek)""); }

        /// <summary>Enable or disable assessment schedule on SQL virtual machine.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Inlined)]
        public bool? ScheduleEnable { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).Enable; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).Enable = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Inlined)]
        public int? ScheduleMonthlyOccurrence { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).MonthlyOccurrence; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).MonthlyOccurrence = value ?? default(int); }

        /// <summary>Time of the day in HH:mm format. Eg. 17:30</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Inlined)]
        public string ScheduleStartTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).StartTime; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).StartTime = value ?? null; }

        /// <summary>Number of weeks to schedule between 2 assessment runs. Takes value from 1-6</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Inlined)]
        public int? ScheduleWeeklyInterval { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).WeeklyInterval; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IScheduleInternal)Schedule).WeeklyInterval = value ?? default(int); }
...

    {
        ...
        bool? RunImmediately { get; set; }
        /// <summary>Schedule for Assessment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.ISchedule Schedule { get; set; }
        /// <summary>Day of the week to run assessment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.AssessmentDayOfWeek? ScheduleDayOfWeek { get; set; }
        /// <summary>Enable or disable assessment schedule on SQL virtual machine.</summary>
        bool? ScheduleEnable { get; set; }
