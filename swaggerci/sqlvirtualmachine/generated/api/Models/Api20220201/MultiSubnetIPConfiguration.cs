...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201
{
    ...
    public partial class MultiSubnetIPConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IMultiSubnetIPConfigurationInternal
    {

        /// <summary>Internal Acessors for PrivateIPAddress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddress Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IMultiSubnetIPConfigurationInternal.PrivateIPAddress { get => (this._privateIPAddress = this._privateIPAddress ?? new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.PrivateIPAddress()); set { {_privateIPAddress = value;} } }

        /// <summary>Backing field for <see cref="PrivateIPAddress" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddress _privateIPAddress;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddress PrivateIPAddress { get => (this._privateIPAddress = this._privateIPAddress ?? new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.PrivateIPAddress()); set => this._privateIPAddress = value; }
        ...
        public string PrivateIPAddressIpaddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddressInternal)PrivateIPAddress).IPAddress; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddressInternal)PrivateIPAddress).IPAddress = value ?? null; }

        /// <summary>Subnet used to include private IP.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Inlined)]
        public string PrivateIPAddressSubnetResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddressInternal)PrivateIPAddress).SubnetResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddressInternal)PrivateIPAddress).SubnetResourceId = value ?? null; }
    ...
    {
        /// <summary>Private IP address.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220201.IPrivateIPAddress PrivateIPAddress { get; set; }
        /// <summary>Private IP address bound to the availability group listener.</summary>
        string PrivateIPAddressIpaddress { get; set; }
        /// <summary>Subnet used to include private IP.</summary>
        string PrivateIPAddressSubnetResourceId { get; set; }
