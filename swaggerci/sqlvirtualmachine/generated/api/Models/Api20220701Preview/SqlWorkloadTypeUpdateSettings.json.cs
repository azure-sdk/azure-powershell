...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview
{
    ...
    public partial class SqlWorkloadTypeUpdateSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlWorkloadTypeUpdateSettings.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlWorkloadTypeUpdateSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlWorkloadTypeUpdateSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject json ? new SqlWorkloadTypeUpdateSettings(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject into a new instance of <see cref="SqlWorkloadTypeUpdateSettings" />.
        /// </summary>
        ...
        internal SqlWorkloadTypeUpdateSettings(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject json)
        {
            ...
            {_sqlWorkloadType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString>("sqlWorkloadType"), out var __jsonSqlWorkloadType) ? (string)__jsonSqlWorkloadType : (string)SqlWorkloadType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SqlWorkloadTypeUpdateSettings" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SqlWorkloadTypeUpdateSettings" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._sqlWorkloadType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Json.JsonString(this._sqlWorkloadType.ToString()) : null, "sqlWorkloadType" ,container.Add );
