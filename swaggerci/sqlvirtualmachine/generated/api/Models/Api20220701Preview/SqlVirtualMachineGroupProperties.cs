...
namespace Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview
{
    ...
    public partial class SqlVirtualMachineGroupProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.ClusterConfiguration? Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupPropertiesInternal.ClusterConfiguration { get => this._clusterConfiguration; set { {_clusterConfiguration = value;} } }

        /// <summary>Internal Acessors for ClusterManagerType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.ClusterManagerType? Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupPropertiesInternal.ClusterManagerType { get => this._clusterManagerType; set { {_clusterManagerType = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for ScaleType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.ScaleType? Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupPropertiesInternal.ScaleType { get => this._scaleType; set { {_scaleType = value;} } }

        /// <summary>Internal Acessors for WsfcDomainProfile</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.IWsfcDomainProfile Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.ISqlVirtualMachineGroupPropertiesInternal.WsfcDomainProfile { get => (this._wsfcDomainProfile = this._wsfcDomainProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.WsfcDomainProfile()); set { {_wsfcDomainProfile = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.IWsfcDomainProfile _wsfcDomainProfile;

        /// <summary>Cluster Active Directory domain profile.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Origin(Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.IWsfcDomainProfile WsfcDomainProfile { get => (this._wsfcDomainProfile = this._wsfcDomainProfile ?? new Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.WsfcDomainProfile()); set => this._wsfcDomainProfile = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string WsfcDomainProfileStorageAccountPrimaryKey { get; set; }
        /// <summary>Fully qualified ARM resource id of the witness storage account.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.SqlVMGroupImageSku? SqlImageSku { get; set; }
        /// <summary>Cluster Active Directory domain profile.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Models.Api20220701Preview.IWsfcDomainProfile WsfcDomainProfile { get; set; }
        /// <summary>
        /// Account name used for creating cluster (at minimum needs permissions to 'Create Computer Objects' in domain).
        /// </summary>
        string WsfcDomainProfileClusterBootstrapAccount { get; set; }
