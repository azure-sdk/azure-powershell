...
New-AzSqlVirtualMachineSqlVirtualMachine -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-AutoPatchingSettingMaintenanceWindowStartingHour <Int32>] [-IdentityType <IdentityTypeWithNone>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SqlVirtualMachine.Support.IdentityTypeWithNone
Parameter Sets: (All)
Aliases:
