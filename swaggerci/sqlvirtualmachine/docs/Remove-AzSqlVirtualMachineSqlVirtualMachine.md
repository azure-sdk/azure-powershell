...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sqlvirtualmachine/remove-azsqlvirtualmachinesqlvirtualmachine
schema: 2.0.0
---

# Remove-AzSqlVirtualMachineSqlVirtualMachine
...
### Delete (Default)
```
Remove-AzSqlVirtualMachineSqlVirtualMachine -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzSqlVirtualMachineSqlVirtualMachine -InputObject <ISqlVirtualMachineIdentity>
