...
online version: https://learn.microsoft.com/powershell/module/az.loadtest/new-azloadtest
schema: 2.0.0
---
...
```
New-AzLoadTest -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 [-Description <String>] [-EncryptionKeyUrl <String>] [-IdentityResourceId <String>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-ManagedServiceIdentityType <ManagedServiceIdentityType>]
 [-PropertiesEncryptionIdentityType <Type>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
Ex: /subscriptions/a0a0a0a0-bbbb-cccc-dddd-e1e1e1e1e1e1/resourceGroups/\<resource group\>/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId.
