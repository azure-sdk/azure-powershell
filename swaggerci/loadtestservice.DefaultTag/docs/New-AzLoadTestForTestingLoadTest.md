...
online version: https://learn.microsoft.com/powershell/module/az.loadtestfortesting/new-azloadtestfortestingloadtest
schema: 2.0.0
---

# New-AzLoadTestForTestingLoadTest
...
```
New-AzLoadTestForTestingLoadTest -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-Description <String>] [-EncryptionKeyUrl <String>]
 [-IdentityResourceId <String>] [-IdentityUserAssignedIdentity <Hashtable>]
 [-ManagedServiceIdentityType <ManagedServiceIdentityType>] [-PropertiesEncryptionIdentityType <Type>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.ManagedServiceIdentityType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type
Parameter Sets: (All)
Aliases:
