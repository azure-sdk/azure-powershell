...
online version: https://learn.microsoft.com/powershell/module/az.loadtestfortesting/update-azloadtestfortestingloadtest
schema: 2.0.0
---

# Update-AzLoadTestForTestingLoadTest
...
```
Update-AzLoadTestForTestingLoadTest -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzLoadTestForTestingLoadTest -InputObject <ILoadTestForTestingIdentity> [-Description <String>]
 [-EncryptionKeyUrl <String>] [-IdentityResourceId <String>] [-IdentityUserAssignedIdentity <Hashtable>]
