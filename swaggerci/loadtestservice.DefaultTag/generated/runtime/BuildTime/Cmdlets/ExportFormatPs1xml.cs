...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support";
