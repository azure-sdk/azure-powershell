...
namespace Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support
{
        ...
        System.IEquatable<Type>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type SystemAssigned = @"SystemAssigned";

        /// <summary>User assigned identity.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type e1, Microsoft.Azure.PowerShell.Cmdlets.LoadTestForTesting.Support.Type e2)
        {
            return !e2.Equals(e1);
        }
