...
.Link
https://learn.microsoft.com/powershell/module/az.loadtest/update-azloadtest
#>
function Update-AzLoadTest {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.ILoadTestResource])]
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api50.IUserAssignedIdentities]))]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api20221201.ILoadTestResourceUpdateTags]))]
    [System.Collections.Hashtable]
    # Resource tags.
    ${Tag},
...
begin {
    try {
        ...
        if (('UpdateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
        ...
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
            [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
