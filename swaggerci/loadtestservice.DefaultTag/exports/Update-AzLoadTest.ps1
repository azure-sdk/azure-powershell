...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.LoadTest.Models.Api50.IAzureResourceManagerCommonTypesManagedServiceIdentityUserAssignedIdentities]))]
