...
namespace Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Runtime.PowerShell
{
    ...
    internal class BeginOutput : BaseOutput
    {
        ...
        {
            return VariantGroup.IsInternal ? "" : $@"{Indent}{Indent}$cmdInfo = Get-Command -Name $mapping[$parameterSet]{Environment.NewLine}{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.AceProvisioningPartnerApi.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)";
        }
