# How-To
This document describes how to develop for `Az.VMwareSolutionApiForTesting`.

## Building `Az.VMwareSolutionApiForTesting`
...
## Testing `Az.VMwareSolutionApiForTesting`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.VMwareSolutionApiForTesting` into the session.
