...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsoperation
#>
function Get-AzDevTestLabsOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IOperationResult])]
