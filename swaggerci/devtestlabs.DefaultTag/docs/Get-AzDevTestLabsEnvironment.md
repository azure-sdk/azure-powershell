...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsenvironment
schema: 2.0.0
---

# Get-AzDevTestLabsEnvironment
...
### List (Default)
```
Get-AzDevTestLabsEnvironment -LabName <String> -ResourceGroupName <String> -UserName <String>
...
### Get
```
Get-AzDevTestLabsEnvironment -LabName <String> -Name <String> -ResourceGroupName <String> -UserName <String>
 [-SubscriptionId <String[]>] [-Expand <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevTestLabsEnvironment -InputObject <IDevTestLabsIdentity> [-Expand <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
