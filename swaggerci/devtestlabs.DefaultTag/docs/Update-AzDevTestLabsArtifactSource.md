...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsartifactsource
schema: 2.0.0
---
...
```
Update-AzDevTestLabsArtifactSource -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IArtifactSource
