...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/remove-azdevtestlabsvirtualmachine
schema: 2.0.0
---

# Remove-AzDevTestLabsVirtualMachine
...
### Delete (Default)
```
Remove-AzDevTestLabsVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDevTestLabsVirtualMachine -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
