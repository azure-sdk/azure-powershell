...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/new-azdevtestlabsvirtualmachineschedule
schema: 2.0.0
---

# New-AzDevTestLabsVirtualMachineSchedule
...
```
New-AzDevTestLabsVirtualMachineSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 -VirtualMachineName <String> [-SubscriptionId <String>] [-DailyRecurrenceTime <String>]
