...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/restart-azdevtestlabsvirtualmachine
schema: 2.0.0
---

# Restart-AzDevTestLabsVirtualMachine
...
### Restart (Default)
```
Restart-AzDevTestLabsVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### RestartViaIdentity
```
Restart-AzDevTestLabsVirtualMachine -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-AsJob]
