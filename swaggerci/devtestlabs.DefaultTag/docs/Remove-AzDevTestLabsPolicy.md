...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/remove-azdevtestlabspolicy
schema: 2.0.0
---

# Remove-AzDevTestLabsPolicy
...
### Delete (Default)
```
Remove-AzDevTestLabsPolicy -LabName <String> -Name <String> -ResourceGroupName <String> -SetName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsPolicy -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-PassThru]
