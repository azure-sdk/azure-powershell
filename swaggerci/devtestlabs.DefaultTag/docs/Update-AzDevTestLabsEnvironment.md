...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsenvironment
schema: 2.0.0
---

# Update-AzDevTestLabsEnvironment
...
```
Update-AzDevTestLabsEnvironment -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsEnvironment -InputObject <IDevTestLabsIdentity> [-Tag <Hashtable>]
