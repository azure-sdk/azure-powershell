...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabssharedgallery
schema: 2.0.0
---

# Get-AzDevTestLabsSharedGallery
...
### List (Default)
```
Get-AzDevTestLabsSharedGallery -LabName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### Get
```
Get-AzDevTestLabsSharedGallery -LabName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-Expand <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevTestLabsSharedGallery -InputObject <IDevTestLabsIdentity> [-Expand <String>]
