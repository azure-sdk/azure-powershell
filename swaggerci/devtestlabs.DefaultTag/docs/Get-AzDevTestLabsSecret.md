...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabssecret
schema: 2.0.0
---

# Get-AzDevTestLabsSecret
...
### List (Default)
```
Get-AzDevTestLabsSecret -LabName <String> -ResourceGroupName <String> -UserName <String>
...
### Get
```
Get-AzDevTestLabsSecret -LabName <String> -Name <String> -ResourceGroupName <String> -UserName <String>
 [-SubscriptionId <String[]>] [-Expand <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDevTestLabsSecret -InputObject <IDevTestLabsIdentity> [-Expand <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISecret
