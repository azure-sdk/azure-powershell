...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsvirtualnetwork
schema: 2.0.0
---

# Update-AzDevTestLabsVirtualNetwork
...
```
Update-AzDevTestLabsVirtualNetwork -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsVirtualNetwork -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
