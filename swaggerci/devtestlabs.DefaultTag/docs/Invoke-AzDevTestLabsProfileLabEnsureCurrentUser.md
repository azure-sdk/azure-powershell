...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/invoke-azdevtestlabsprofilelabensurecurrentuser
schema: 2.0.0
---

# Invoke-AzDevTestLabsProfileLabEnsureCurrentUser
...
### Profile (Default)
```
Invoke-AzDevTestLabsProfileLabEnsureCurrentUser -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ProfileViaIdentity
```
Invoke-AzDevTestLabsProfileLabEnsureCurrentUser -InputObject <IDevTestLabsIdentity>
...
Parameter Sets: ProfileViaIdentity
Aliases:
