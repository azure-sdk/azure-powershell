...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsvirtualmachine
schema: 2.0.0
---
...
```
Update-AzDevTestLabsVirtualMachine -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
