...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/remove-azdevtestlabssharedimage
schema: 2.0.0
---

# Remove-AzDevTestLabsSharedImage
...
### Delete (Default)
```
Remove-AzDevTestLabsSharedImage -LabName <String> -Name <String> -ResourceGroupName <String>
 -SharedGalleryName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDevTestLabsSharedImage -InputObject <IDevTestLabsIdentity> [-DefaultProfile <PSObject>] [-PassThru]
