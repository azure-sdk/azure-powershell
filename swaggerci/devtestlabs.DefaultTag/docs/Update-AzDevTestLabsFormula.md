...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsformula
schema: 2.0.0
---

# Update-AzDevTestLabsFormula
...
```
Update-AzDevTestLabsFormula -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsFormula -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
