...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsservicefabricschedule
schema: 2.0.0
---

# Get-AzDevTestLabsServiceFabricSchedule
...
### List (Default)
```
Get-AzDevTestLabsServiceFabricSchedule -LabName <String> -ResourceGroupName <String>
 -ServiceFabricName <String> -UserName <String> [-SubscriptionId <String[]>] [-Expand <String>]
 [-Filter <String>] [-Orderby <String>] [-Top <Int32>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDevTestLabsServiceFabricSchedule -LabName <String> -Name <String> -ResourceGroupName <String>
 -ServiceFabricName <String> -UserName <String> [-SubscriptionId <String[]>] [-Expand <String>]
...
### GetViaIdentity
```
Get-AzDevTestLabsServiceFabricSchedule -InputObject <IDevTestLabsIdentity> [-Expand <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
