...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsschedule
schema: 2.0.0
---
...
```
Update-AzDevTestLabsSchedule -InputObject <IDevTestLabsIdentity> [-IdentityClientSecretUrl <String>]
