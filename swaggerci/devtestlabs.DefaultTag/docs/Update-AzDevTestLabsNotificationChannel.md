...
online version: https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsnotificationchannel
schema: 2.0.0
---

# Update-AzDevTestLabsNotificationChannel
...
```
Update-AzDevTestLabsNotificationChannel -LabName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDevTestLabsNotificationChannel -InputObject <IDevTestLabsIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.INotificationChannel
