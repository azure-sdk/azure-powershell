...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ImportVirtualMachine=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{name}/importVirtualMachine"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Import, @"AzDevTestLabsLabVirtualMachine_ImportViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Import a virtual machine into a different lab. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class ImportAzDevTestLabsLabVirtualMachine_ImportViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ImportLabVirtualMachineRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IImportLabVirtualMachineRequest _importLabVirtualMachineRequest;

        /// <summary>
        /// This represents the payload required to import a virtual machine from a different lab into the current one
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "This represents the payload required to import a virtual machine from a different lab into the current one", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IImportLabVirtualMachineRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IImportLabVirtualMachineRequest ImportLabVirtualMachineRequest { get => this._importLabVirtualMachineRequest; set => this._importLabVirtualMachineRequest = value; }
        ...
        /// <returns>a duplicate instance of ImportAzDevTestLabsLabVirtualMachine_ImportViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.ImportAzDevTestLabsLabVirtualMachine_ImportViaIdentity Clone()
        {
            var clone = new ImportAzDevTestLabsLabVirtualMachine_ImportViaIdentity();
            ...
            clone.ImportLabVirtualMachineRequest = this.ImportLabVirtualMachineRequest;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzDevTestLabsLabVirtualMachine_ImportViaIdentity" /> cmdlet class.
        /// </summary>
        public ImportAzDevTestLabsLabVirtualMachine_ImportViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LabsImportVirtualMachine' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LabsImportVirtualMachineViaIdentity(InputObject.Id, ImportLabVirtualMachineRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LabsImportVirtualMachine(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, ImportLabVirtualMachineRequest, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ImportLabVirtualMachineRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ImportLabVirtualMachineRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ImportLabVirtualMachineRequest })
                    {
