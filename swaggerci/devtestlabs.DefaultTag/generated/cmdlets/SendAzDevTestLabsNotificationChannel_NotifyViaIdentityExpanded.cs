...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.NotificationChannelEventType EventName { get => _notifyParametersBody.EventName ?? ((Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Support.NotificationChannelEventType)""); set => _notifyParametersBody.EventName = value; }
        ...
        public string JsonPayload { get => _notifyParametersBody.JsonPayload ?? null; set => _notifyParametersBody.JsonPayload = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.NotificationChannelsNotifyViaIdentity(InputObject.Id, _notifyParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NotificationChannelsNotify(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LabName ?? null, InputObject.Name ?? null, _notifyParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_notifyParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20180915.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_notifyParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_notifyParametersBody })
                    {
