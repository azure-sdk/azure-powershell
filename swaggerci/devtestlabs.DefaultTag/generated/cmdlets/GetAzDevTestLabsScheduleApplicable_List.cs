...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListApplicable=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/schedules/{name}/listApplicable"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDevTestLabsScheduleApplicable_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Lists all applicable schedules")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/schedules/{name}/listApplicable", ApiVersion = "2018-09-15")]
    public partial class GetAzDevTestLabsScheduleApplicable_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDevTestLabsScheduleApplicable_List" /> cmdlet class.
        /// </summary>
        public GetAzDevTestLabsScheduleApplicable_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SchedulesListApplicable' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SchedulesListApplicable(SubscriptionId, ResourceGroupName, LabName, Name, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SchedulesListApplicable_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
