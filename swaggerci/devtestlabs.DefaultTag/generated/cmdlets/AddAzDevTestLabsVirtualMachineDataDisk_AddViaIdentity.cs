...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] AddDataDisk=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualmachines/{name}/addDataDisk"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzDevTestLabsVirtualMachineDataDisk_AddViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Attach a new or existing data disk to virtual machine. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class AddAzDevTestLabsVirtualMachineDataDisk_AddViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="DataDiskProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDataDiskProperties _dataDiskProperty;

        /// <summary>Request body for adding a new or existing data disk to a virtual machine.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request body for adding a new or existing data disk to a virtual machine.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDataDiskProperties DataDiskProperty { get => this._dataDiskProperty; set => this._dataDiskProperty = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzDevTestLabsVirtualMachineDataDisk_AddViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzDevTestLabsVirtualMachineDataDisk_AddViaIdentity()
        {
        ...
        /// <returns>a duplicate instance of AddAzDevTestLabsVirtualMachineDataDisk_AddViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.AddAzDevTestLabsVirtualMachineDataDisk_AddViaIdentity Clone()
        {
            var clone = new AddAzDevTestLabsVirtualMachineDataDisk_AddViaIdentity();
            ...
            clone.DataDiskProperty = this.DataDiskProperty;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualMachinesAddDataDisk' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesAddDataDiskViaIdentity(InputObject.Id, DataDiskProperty, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesAddDataDisk(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LabName ?? null, InputObject.Name ?? null, DataDiskProperty, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=DataDiskProperty})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DataDiskProperty })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DataDiskProperty })
                    {
