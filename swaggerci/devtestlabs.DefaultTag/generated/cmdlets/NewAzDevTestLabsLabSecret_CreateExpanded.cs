...
namespace Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/secrets/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDevTestLabsLabSecret_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Description(@"Create or replace an existing Lab Secret. This operation can take a while to complete.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Generated]
    public partial class NewAzDevTestLabsLabSecret_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabSecret _labSecretBody = new Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.LabSecret();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Is the secret enabled for use with ARM environments")]
        ...
        public global::System.Management.Automation.SwitchParameter EnabledForArmEnvironment { get => _labSecretBody.EnabledForArmEnvironment ?? default(global::System.Management.Automation.SwitchParameter); set => _labSecretBody.EnabledForArmEnvironment = value; }

        /// <summary>Is the secret enabled for use with artifacts</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Is the secret enabled for use with artifacts")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter EnabledForArtifact { get => _labSecretBody.EnabledForArtifact ?? default(global::System.Management.Automation.SwitchParameter); set => _labSecretBody.EnabledForArtifact = value; }

        /// <summary>Is the secret enabled for use with creation of VMs</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Is the secret enabled for use with creation of VMs")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter EnabledForVMCreation { get => _labSecretBody.EnabledForVMCreation ?? default(global::System.Management.Automation.SwitchParameter); set => _labSecretBody.EnabledForVMCreation = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Location { get => _labSecretBody.Location ?? null; set => _labSecretBody.Location = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IResourceTags Tag { get => _labSecretBody.Tag ?? null /* object */; set => _labSecretBody.Tag = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Value { get => _labSecretBody.Value ?? null; set => _labSecretBody.Value = value; }
        ...
        /// <returns>a duplicate instance of NewAzDevTestLabsLabSecret_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Cmdlets.NewAzDevTestLabsLabSecret_CreateExpanded Clone()
        {
            var clone = new NewAzDevTestLabsLabSecret_CreateExpanded();
            ...
            clone._labSecretBody = this._labSecretBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDevTestLabsLabSecret_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDevTestLabsLabSecret_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LabSecretsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LabSecretsCreateOrUpdate(SubscriptionId, ResourceGroupName, LabName, Name, _labSecretBody, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,LabName=LabName,Name=Name,body=_labSecretBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=_labSecretBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, LabName=LabName, Name=Name, body=_labSecretBody })
                    {
