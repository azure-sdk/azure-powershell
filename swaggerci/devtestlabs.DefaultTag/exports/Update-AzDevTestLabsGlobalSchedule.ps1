...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsglobalschedule
#>
function Update-AzDevTestLabsGlobalSchedule {
[OutputType([System.Boolean], [Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISchedule])]
