...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabsservicerunner
#>
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.DevTestLabs.private\Get-AzDevTestLabsServiceRunner_List';
        }
