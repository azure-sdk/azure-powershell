...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabslabvhd
#>
function Get-AzDevTestLabsLabVhd {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ILabVhd])]
