...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabslabsecret
#>
function Update-AzDevTestLabsLabSecret {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsLabSecret_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.DevTestLabs.private\Update-AzDevTestLabsLabSecret_UpdateViaIdentityExpanded';
        }
