...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/update-azdevtestlabsenvironment
#>
function Update-AzDevTestLabsEnvironment {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IDtlEnvironment])]
