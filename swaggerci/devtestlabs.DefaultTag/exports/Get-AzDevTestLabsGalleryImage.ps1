...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.IGalleryImage])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevTestLabs.private\Get-AzDevTestLabsGalleryImage_Get';
            GetViaIdentity = 'Az.DevTestLabs.private\Get-AzDevTestLabsGalleryImage_GetViaIdentity';
