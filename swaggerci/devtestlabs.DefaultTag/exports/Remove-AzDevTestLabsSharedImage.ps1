...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/remove-azdevtestlabssharedimage
#>
function Remove-AzDevTestLabsSharedImage {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DevTestLabs.private\Remove-AzDevTestLabsSharedImage_Delete';
            DeleteViaIdentity = 'Az.DevTestLabs.private\Remove-AzDevTestLabsSharedImage_DeleteViaIdentity';
        }
