...
.Link
https://learn.microsoft.com/powershell/module/az.devtestlabs/get-azdevtestlabssharedimage
#>
function Get-AzDevTestLabsSharedImage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DevTestLabs.Models.Api20210901.ISharedImage])]
...
param(
    ...
    # Example: 'properties($expand=versions)'
    ${Expand},
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DevTestLabs.private\Get-AzDevTestLabsSharedImage_Get';
            GetViaIdentity = 'Az.DevTestLabs.private\Get-AzDevTestLabsSharedImage_GetViaIdentity';
            List = 'Az.DevTestLabs.private\Get-AzDevTestLabsSharedImage_List';
        }
