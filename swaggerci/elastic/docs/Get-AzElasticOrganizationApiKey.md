...
### GetExpanded (Default)
```
Get-AzElasticOrganizationApiKey -ResourceGroupName <String> [-SubscriptionId <String[]>] [-EmailId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Get
```
Get-AzElasticOrganizationApiKey -ResourceGroupName <String> -Body <IUserEmailId> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IUserEmailId
...
### Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230201Preview.IUserEmailId
