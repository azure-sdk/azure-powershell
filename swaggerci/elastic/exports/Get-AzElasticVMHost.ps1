...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IVMResources
.Link
https://learn.microsoft.com/powershell/module/az.elastic/get-azelasticvmhost
#>
function Get-AzElasticVMHost {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IVMResources])]
