...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202205Preview.IVMResources
.Link
https://docs.microsoft.com/en-us/powershell/module/az.elastic/get-azelasticvmhost
#>
function Get-AzElasticVMHost {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202205Preview.IVMResources])]
