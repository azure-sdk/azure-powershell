...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202205Preview.IElasticTrafficFilter
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api202205Preview.IElasticTrafficFilter])]
