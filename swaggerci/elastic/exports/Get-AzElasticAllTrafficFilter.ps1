...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IElasticTrafficFilter
.Link
https://docs.microsoft.com/en-us/powershell/module/az.elastic/get-azelasticalltrafficfilter
#>
function Get-AzElasticAllTrafficFilter {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IElasticTrafficFilter])]
