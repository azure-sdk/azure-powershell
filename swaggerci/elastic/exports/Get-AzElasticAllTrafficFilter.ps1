...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220701Preview.IElasticTrafficFilter
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220701Preview.IElasticTrafficFilter])]
