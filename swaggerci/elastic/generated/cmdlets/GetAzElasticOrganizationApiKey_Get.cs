...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetApiKey=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/getOrganizationApiKey"
    /// </remarks>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.OrganizationsGetApiKey(SubscriptionId, ResourceGroupName, Body, onOk, onDefault, this, Pipeline);
