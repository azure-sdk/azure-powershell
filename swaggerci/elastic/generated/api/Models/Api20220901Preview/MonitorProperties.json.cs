...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview
{
    ...
    public partial class MonitorProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitorProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitorProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitorProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
        ...
        internal MonitorProperties(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_elasticProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("elasticProperties"), out var __jsonElasticProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.ElasticProperties.FromJson(__jsonElasticProperties) : ElasticProperty;}
            {_userInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("userInfo"), out var __jsonUserInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.UserInfo.FromJson(__jsonUserInfo) : UserInfo;}
