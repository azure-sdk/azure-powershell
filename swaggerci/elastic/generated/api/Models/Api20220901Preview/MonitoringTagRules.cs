...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview
{
    ...
    public partial class MonitoringTagRules :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IFilteringTag[] LogRuleFilteringTag { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesPropertiesInternal)Property).LogRuleFilteringTag; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesPropertiesInternal)Property).LogRuleFilteringTag = value ?? null /* arrayOf */; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LogRule</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.ILogRules Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal.LogRule { get => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesPropertiesInternal)Property).LogRule; set => ((Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesPropertiesInternal)Property).LogRule = value; }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesProperties Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.MonitoringTagRulesProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for SystemData</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20.ISystemData Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal.SystemData { get => (this._systemData = this._systemData ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20.SystemData()); set { {_systemData = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesProperties _property;

        /// <summary>Properties of the monitoring tag rules.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Origin(Microsoft.Azure.PowerShell.Cmdlets.Elastic.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.MonitoringTagRulesProperties()); set => this._property = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IFilteringTag) })]
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IFilteringTag[] LogRuleFilteringTag { get; set; }
        /// <summary>Flag specifying if AAD logs should be sent for the Monitor resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.ILogRules LogRule { get; set; }
        /// <summary>
        /// List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty,
        /// all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available
        /// resources. If Include actions are specified, the rules will only include resources with the associated tags.
        ...
        string Name { get; set; }
        /// <summary>Properties of the monitoring tag rules.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20220901Preview.IMonitoringTagRulesProperties Property { get; set; }
        /// <summary>Provisioning state of the monitoring tag rules.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Elastic.Support.ProvisioningState? ProvisioningState { get; set; }
        /// <summary>The system metadata relating to this resource</summary>
