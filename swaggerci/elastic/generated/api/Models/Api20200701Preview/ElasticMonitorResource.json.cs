...
namespace Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview
{
    ...
    public partial class ElasticMonitorResource
    {
        ...
        internal ElasticMonitorResource(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject json)
        {
            ...
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("sku"), out var __jsonSku) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.ResourceSku.FromJson(__jsonSku) : Sku;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.MonitorProperties.FromJson(__jsonProperties) : Property;}
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.IdentityProperties.FromJson(__jsonIdentity) : Identity;}
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.ElasticMonitorResourceTags.FromJson(__jsonTags) : Tag;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.IElasticMonitorResource.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.IElasticMonitorResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20200701Preview.IElasticMonitorResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.Elastic.Runtime.Json.JsonNode node)
        {
