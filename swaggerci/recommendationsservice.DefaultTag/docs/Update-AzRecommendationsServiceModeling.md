...
online version: https://learn.microsoft.com/powershell/module/az.recommendationsservice/update-azrecommendationsservicemodeling
schema: 2.0.0
---
...
```
Update-AzRecommendationsServiceModeling -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-InputDataConnectionString <String>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzRecommendationsServiceModeling -InputObject <IRecommendationsServiceIdentity>
 [-InputDataConnectionString <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
