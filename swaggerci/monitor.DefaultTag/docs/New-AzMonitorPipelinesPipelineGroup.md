...
online version: https://learn.microsoft.com/powershell/module/az.monitorpipelines/new-azmonitorpipelinespipelinegroup
schema: 2.0.0
---

# New-AzMonitorPipelinesPipelineGroup
...
```
New-AzMonitorPipelinesPipelineGroup -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-Exporter <IExporter[]>] [-ExtendedLocationName <String>]
 [-ExtendedLocationType <ExtendedLocationType>] [-NetworkingConfiguration <INetworkingConfiguration[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ExtendedLocationType
Parameter Sets: (All)
Aliases:
