...
online version: https://learn.microsoft.com/powershell/module/az.monitor/update-azmonitortenantactiongroup
schema: 2.0.0
---

# Update-AzMonitorTenantActionGroup
...
```
Update-AzMonitorTenantActionGroup -ManagementGroupId <String> -Name <String> -XmsClientTenantId <String>
 [-Enabled] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMonitorTenantActionGroup -InputObject <IMonitorIdentity> -XmsClientTenantId <String> [-Enabled]
