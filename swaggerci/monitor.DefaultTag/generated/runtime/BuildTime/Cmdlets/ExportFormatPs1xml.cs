...
namespace Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support";
