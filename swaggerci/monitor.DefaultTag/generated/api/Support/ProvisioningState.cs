...
namespace Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>The resource is being created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState Creating = @"Creating";

        /// <summary>The resource is being deleted.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
