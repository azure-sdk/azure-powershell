...
namespace Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview
{
    ...
    public partial class Service :
        Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IService,
        Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IServiceInternal
    {

        /// <summary>Internal Acessors for Persistence</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPersistenceConfigurations Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IServiceInternal.Persistence { get => (this._persistence = this._persistence ?? new Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.PersistenceConfigurations()); set { {_persistence = value;} } }

        /// <summary>Backing field for <see cref="Persistence" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPersistenceConfigurations _persistence;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPersistenceConfigurations Persistence { get => (this._persistence = this._persistence ?? new Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.PersistenceConfigurations()); set => this._persistence = value; }
        ...
        public string PersistencePersistentVolumeName { get => ((Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPersistenceConfigurationsInternal)Persistence).PersistentVolumeName; set => ((Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPersistenceConfigurationsInternal)Persistence).PersistentVolumeName = value ?? null; }
    ...
    {
        /// <summary>Persistence options to all pipelines in the instance.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPersistenceConfigurations Persistence { get; set; }
        /// <summary>The name of the mounted persistent volume.</summary>
        string PersistencePersistentVolumeName { get; set; }
        /// <summary>Pipelines belonging to a given pipeline group.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MonitorPipelines.Models.Api20241001Preview.IPipeline[] Pipeline { get; set; }
