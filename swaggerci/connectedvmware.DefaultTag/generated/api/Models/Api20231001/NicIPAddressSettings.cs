...
namespace Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20231001
{
    ...
    public partial class NicIPAddressSettings :
        Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20231001.INicIPAddressSettings,
        Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20231001.INicIPAddressSettingsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20231001.INicIPAddressSettingsInternal.AllocationMethod { get => this._allocationMethod; set { {_allocationMethod = value;} } }

        /// <summary>Internal Acessors for IPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20231001.INicIPAddressSettingsInternal.IPAddress { get => this._iPAddress; set { {_iPAddress = value;} } }

        /// <summary>Internal Acessors for SubnetMask</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Models.Api20231001.INicIPAddressSettingsInternal.SubnetMask { get => this._subnetMask; set { {_subnetMask = value;} } }
