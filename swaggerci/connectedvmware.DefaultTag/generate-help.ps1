...
Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.ArcVMwareServiceApi.private.dll')
$instance = [Microsoft.Azure.PowerShell.Cmdlets.ArcVMwareServiceApi.Module]::Instance
