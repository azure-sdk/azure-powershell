...
online version: https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/update-azarcvmwareserviceapivirtualmachinetemplate
schema: 2.0.0
---

# Update-AzArcVMwareServiceApiVirtualMachineTemplate
...
```
Update-AzArcVMwareServiceApiVirtualMachineTemplate -Name <String> -ResourceGroupName <String>
...
```
Update-AzArcVMwareServiceApiVirtualMachineTemplate -InputObject <IArcVMwareServiceApiIdentity>
