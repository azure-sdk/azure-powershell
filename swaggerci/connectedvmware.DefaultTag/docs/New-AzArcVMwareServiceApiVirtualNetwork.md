...
online version: https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/new-azarcvmwareserviceapivirtualnetwork
schema: 2.0.0
---

# New-AzArcVMwareServiceApiVirtualNetwork
...
```
New-AzArcVMwareServiceApiVirtualNetwork -Name <String> -ResourceGroupName <String> -Location <String>
