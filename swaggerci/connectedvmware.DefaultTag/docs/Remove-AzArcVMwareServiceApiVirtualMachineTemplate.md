...
online version: https://learn.microsoft.com/powershell/module/az.arcvmwareserviceapi/remove-azarcvmwareserviceapivirtualmachinetemplate
schema: 2.0.0
---

# Remove-AzArcVMwareServiceApiVirtualMachineTemplate
...
### Delete (Default)
```
Remove-AzArcVMwareServiceApiVirtualMachineTemplate -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzArcVMwareServiceApiVirtualMachineTemplate -InputObject <IArcVMwareServiceApiIdentity> [-Force]
