...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/new-azdynatraceobservabilitysinglesignon
schema: 2.0.0
---

# New-AzDynatraceObservabilitySingleSignOn
...
```
New-AzDynatraceObservabilitySingleSignOn -ConfigurationName <String> -MonitorName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-AadDomain <String[]>] [-EnterpriseAppId <String>]
