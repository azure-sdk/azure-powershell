...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/get-azdynatraceobservabilitytagrule
schema: 2.0.0
---

# Get-AzDynatraceObservabilityTagRule
...
### List (Default)
```
Get-AzDynatraceObservabilityTagRule -MonitorName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDynatraceObservabilityTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDynatraceObservabilityTagRule -InputObject <IDynatraceObservabilityIdentity>
