...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dynatraceobservability/get-azdynatraceobservabilitysinglesignon
schema: 2.0.0
---

# Get-AzDynatraceObservabilitySingleSignOn
...
### List (Default)
```
Get-AzDynatraceObservabilitySingleSignOn -MonitorName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDynatraceObservabilitySingleSignOn -ConfigurationName <String> -MonitorName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDynatraceObservabilitySingleSignOn -InputObject <IDynatraceObservabilityIdentity>
