...
Get-AzDynatraceObservabilityMonitorSsoDetail -MonitorName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-UserPrincipal <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Get-AzDynatraceObservabilityMonitorSsoDetail -MonitorName <String> -ResourceGroupName <String>
 -Request <ISsoDetailsRequest> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Get-AzDynatraceObservabilityMonitorSsoDetail -InputObject <IDynatraceObservabilityIdentity>
 -Request <ISsoDetailsRequest> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentityExpanded
```
Get-AzDynatraceObservabilityMonitorSsoDetail -InputObject <IDynatraceObservabilityIdentity>
 [-UserPrincipal <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
