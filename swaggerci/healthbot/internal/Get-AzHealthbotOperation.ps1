...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api202208.IOperationDetail
.Link
https://docs.microsoft.com/en-us/powershell/module/az.healthbot/get-azhealthbotoperation
#>
function Get-AzHealthbotOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api202208.IOperationDetail])]
