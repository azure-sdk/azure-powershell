...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api202208.IHealthBotUpdateParametersTags]))]
    [System.Collections.Hashtable]
