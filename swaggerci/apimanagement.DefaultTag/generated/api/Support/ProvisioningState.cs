...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Activating = @"Activating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Created = @"created";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Terminating = @"Terminating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Updating = @"Updating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ProvisioningState Upgrading = @"Upgrading";
