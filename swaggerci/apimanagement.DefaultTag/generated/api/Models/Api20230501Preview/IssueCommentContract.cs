...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class IssueCommentContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IssueCommentContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractProperties _property;

        /// <summary>Properties of the Issue Comment.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IssueCommentContractProperties()); set => this._property = value; }

        /// <summary>Comment text.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Text { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractPropertiesInternal)Property).Text; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractPropertiesInternal)Property).Text = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string UserId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractPropertiesInternal)Property).UserId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractPropertiesInternal)Property).UserId = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Properties of the Issue Comment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IIssueCommentContractProperties Property { get; set; }
        /// <summary>Comment text.</summary>
        string Text { get; set; }
        /// <summary>A resource identifier for the user who left the comment.</summary>
        string UserId { get; set; }
