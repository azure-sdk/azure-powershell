...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class ConnectivityCheckRequest :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequest,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestInternal
    {

        /// <summary>Backing field for <see cref="Destination" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestDestination _destination;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestDestination Destination { get => (this._destination = this._destination ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestDestination()); set => this._destination = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public long DestinationPort { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestDestinationInternal)Destination).Port; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestDestinationInternal)Destination).Port = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestDestination Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestInternal.Destination { get => (this._destination = this._destination ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestDestination()); set { {_destination = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSource Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestInternal.Source { get => (this._source = this._source ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestSource()); set { {_source = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfiguration _protocolConfiguration;

        /// <summary>Protocol-specific configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfiguration ProtocolConfiguration { get => (this._protocolConfiguration = this._protocolConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestProtocolConfiguration()); set => this._protocolConfiguration = value; }

        /// <summary>Backing field for <see cref="Source" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSource _source;

        /// <summary>Definitions about the connectivity check origin.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSource Source { get => (this._source = this._source ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestSource()); set => this._source = value; }

        /// <summary>The particular VMSS instance from which to fire the request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public long? SourceInstance { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSourceInternal)Source).Instance; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSourceInternal)Source).Instance = value ?? default(long); }

        /// <summary>
        /// The API Management service region from where to start the connectivity check operation.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string SourceRegion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSourceInternal)Source).Region; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSourceInternal)Source).Region = value ; }
    ...
    {
        /// <summary>The connectivity check operation destination.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestDestination Destination { get; set; }
        /// <summary>Destination address. Can either be an IP address or a FQDN.</summary>
        string DestinationAddress { get; set; }
        /// <summary>Destination port.</summary>
        long DestinationPort { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectivityCheckProtocol? Protocol { get; set; }
        /// <summary>Protocol-specific configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfiguration ProtocolConfiguration { get; set; }
        /// <summary>Configuration for HTTP or HTTPS requests.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationHttpConfiguration ProtocolConfigurationHttpConfiguration { get; set; }
        /// <summary>Definitions about the connectivity check origin.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestSource Source { get; set; }
        /// <summary>The particular VMSS instance from which to fire the request.</summary>
        long? SourceInstance { get; set; }
        /// <summary>
        /// The API Management service region from where to start the connectivity check operation.
