...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class BackendProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IBackendProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IBackendPropertiesInternal
    {

        /// <summary>Internal Acessors for ServiceFabricCluster</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IBackendServiceFabricClusterProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IBackendPropertiesInternal.ServiceFabricCluster { get => (this._serviceFabricCluster = this._serviceFabricCluster ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.BackendServiceFabricClusterProperties()); set { {_serviceFabricCluster = value;} } }

        /// <summary>Backing field for <see cref="ServiceFabricCluster" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IBackendServiceFabricClusterProperties _serviceFabricCluster;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IBackendServiceFabricClusterProperties ServiceFabricCluster { get => (this._serviceFabricCluster = this._serviceFabricCluster ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.BackendServiceFabricClusterProperties()); set => this._serviceFabricCluster = value; }
