...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class NamedValueContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string DisplayName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).DisplayName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).DisplayName = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal.KeyVault { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).KeyVault; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).KeyVault = value; }

        /// <summary>Internal Acessors for KeyVaultLastStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultLastAccessStatusContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal.KeyVaultLastStatus { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).KeyVaultLastStatus; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).KeyVaultLastStatus = value; }

        /// <summary>Internal Acessors for Property</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.NamedValueContractProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).ProvisioningState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractProperties _property;

        /// <summary>NamedValue entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.NamedValueContractProperties()); set => this._property = value; }

        /// <summary>The provisioning state</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).ProvisioningState; }

        /// <summary>
        /// Determines whether the value is a secret and should be encrypted or not. Default value is false.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? Secret { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParametersInternal)Property).Secret; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParametersInternal)Property).Secret = value ?? default(bool); }

        /// <summary>Optional tags that when provided can be used to filter the NamedValue list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string[] Tag { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParametersInternal)Property).Tag; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParametersInternal)Property).Tag = value ?? null /* arrayOf */; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Value { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractPropertiesInternal)Property).Value = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
            if (headers.TryGetValues("location", out var __locationHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
            if (headers.TryGetValues("Azure-AsyncOperation", out var __azureAsyncOperationHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractInternal)this).AzureAsyncOperation = System.Linq.Enumerable.FirstOrDefault(__azureAsyncOperationHeader2) is string __headerAzureAsyncOperationHeader2 ? __headerAzureAsyncOperationHeader2 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractProperties KeyVault { get; set; }
        /// <summary>
        /// Null for SystemAssignedIdentity or Client Id for UserAssignedIdentity , which will be used to access key vault secret.
        /// </summary>
        string KeyVaultIdentityClientId { get; set; }
        /// <summary>Last time sync and refresh status of secret from key vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultLastAccessStatusContractProperties KeyVaultLastStatus { get; set; }
        /// <summary>
        /// Key vault secret identifier for fetching secret. Providing a versioned secret will prevent auto-refresh. This requires
        /// API Management service to be configured with aka.ms/apimmsi
        /// </summary>
        ...
        string Location { get; set; }
        /// <summary>NamedValue entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueContractProperties Property { get; set; }
        /// <summary>The provisioning state</summary>
