...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class GlobalSchemaContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).Description = value ?? null; }

        /// <summary>Global Schema document object for json-based schema formats(e.g. json schema).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IAny Document { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).Document; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).Document = value ?? null /* model class */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.GlobalSchemaContractProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).ProvisioningState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractProperties _property;

        /// <summary>Properties of the Global Schema.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.GlobalSchemaContractProperties()); set => this._property = value; }

        /// <summary>The provisioning state</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractPropertiesInternal)Property).ProvisioningState; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
            if (headers.TryGetValues("location", out var __locationHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
            if (headers.TryGetValues("Azure-AsyncOperation", out var __azureAsyncOperationHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractInternal)this).AzureAsyncOperation = System.Linq.Enumerable.FirstOrDefault(__azureAsyncOperationHeader2) is string __headerAzureAsyncOperationHeader2 ? __headerAzureAsyncOperationHeader2 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string Location { get; set; }
        /// <summary>Properties of the Global Schema.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IGlobalSchemaContractProperties Property { get; set; }
        /// <summary>The provisioning state</summary>
