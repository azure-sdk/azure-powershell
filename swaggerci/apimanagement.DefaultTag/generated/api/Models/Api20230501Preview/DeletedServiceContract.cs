...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class DeletedServiceContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractInternal.Location { get => this._location; set { {_location = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractProperties _property;

        /// <summary>Deleted API Management Service details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.DeletedServiceContractProperties()); set => this._property = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public global::System.DateTime? ScheduledPurgeDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractPropertiesInternal)Property).ScheduledPurgeDate; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractPropertiesInternal)Property).ScheduledPurgeDate = value ?? default(global::System.DateTime); }

        /// <summary>Fully-qualified API Management Service Resource ID</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ServiceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractPropertiesInternal)Property).ServiceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractPropertiesInternal)Property).ServiceId = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        /// <summary>Deleted API Management Service details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IDeletedServiceContractProperties Property { get; set; }
        /// <summary>
        /// UTC Date and Time when the service will be automatically purged. The date conforms to the following format: yyyy-MM-ddTHH:mm:ssZ
        /// as specified by the ISO 8601 standard.
        /// </summary>
