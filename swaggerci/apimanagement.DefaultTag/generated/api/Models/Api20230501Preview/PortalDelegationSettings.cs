...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class PortalDelegationSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsProperties _property;

        /// <summary>Delegation settings contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.PortalDelegationSettingsProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Url { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal)Property).Url; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal)Property).Url = value ?? null; }

        /// <summary>Enable or disable delegation for user registration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? UserRegistrationEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal)Property).UserRegistrationEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal)Property).UserRegistrationEnabled = value ?? default(bool); }

        /// <summary>
        /// A base64-encoded validation key to validate, that a request is coming from Azure API Management.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ValidationKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal)Property).ValidationKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal)Property).ValidationKey = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        string ETag { get; set; }
        /// <summary>Delegation settings contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsProperties Property { get; set; }
