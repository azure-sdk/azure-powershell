...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationHttpConfiguration _httpConfiguration;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationHttpConfiguration HttpConfiguration { get => (this._httpConfiguration = this._httpConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestProtocolConfigurationHttpConfiguration()); set => this._httpConfiguration = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationHttpConfiguration Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationInternal.HttpConfiguration { get => (this._httpConfiguration = this._httpConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ConnectivityCheckRequestProtocolConfigurationHttpConfiguration()); set { {_httpConfiguration = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IHttpHeader) })]
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IHttpHeader[] HttpConfigurationHeader { get; set; }
        /// <summary>The HTTP method to be used.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>Configuration for HTTP or HTTPS requests.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IConnectivityCheckRequestProtocolConfigurationHttpConfiguration HttpConfiguration { get; set; }
        /// <summary>List of headers to be included in the request.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IHttpHeader[] HttpConfigurationHeader { get; set; }
        /// <summary>The HTTP method to be used.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.Method? HttpConfigurationMethod { get; set; }
