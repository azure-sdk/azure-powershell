...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class NamedValueCreateContractProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueCreateContractProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueCreateContractPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParameters"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParameters __namedValueEntityBaseParameters = new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.NamedValueEntityBaseParameters();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractCreateProperties _keyVault;

        /// <summary>KeyVault location details of the namedValue.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractCreateProperties KeyVault { get => (this._keyVault = this._keyVault ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.KeyVaultContractCreateProperties()); set => this._keyVault = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string KeyVaultSecretIdentifier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractCreatePropertiesInternal)KeyVault).SecretIdentifier; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractCreatePropertiesInternal)KeyVault).SecretIdentifier = value ?? null; }

        /// <summary>Internal Acessors for KeyVault</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractCreateProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueCreateContractPropertiesInternal.KeyVault { get => (this._keyVault = this._keyVault ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.KeyVaultContractCreateProperties()); set { {_keyVault = value;} } }
        ...
        /// <summary>Creates an new <see cref="NamedValueCreateContractProperties" /> instance.</summary>
    ...
    public partial interface INamedValueCreateContractProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParameters
    {
        /// <summary>
        /// Unique name of NamedValue. It may contain only letters, digits, period, dash, and underscore characters.
        /// </summary>
    ...
    /// NamedValue Contract properties.
    internal partial interface INamedValueCreateContractPropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.INamedValueEntityBaseParametersInternal
    {
        /// <summary>
        /// Unique name of NamedValue. It may contain only letters, digits, period, dash, and underscore characters.
        /// </summary>
        string DisplayName { get; set; }
        /// <summary>KeyVault location details of the namedValue.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IKeyVaultContractCreateProperties KeyVault { get; set; }
        /// <summary>
        /// Null for SystemAssignedIdentity or Client Id for UserAssignedIdentity , which will be used to access key vault secret.
        /// </summary>
        string KeyVaultIdentityClientId { get; set; }
