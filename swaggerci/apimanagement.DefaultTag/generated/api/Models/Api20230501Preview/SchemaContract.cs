...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class SchemaContract :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string ContentType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).ContentType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).ContentType = value ?? null; }

        /// <summary>Types definitions. Used for Swagger/OpenAPI v2/v3 schemas only, null otherwise.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IAny DocumentComponent { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).DocumentComponent; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).DocumentComponent = value ?? null /* model class */; }

        /// <summary>Types definitions. Used for Swagger/OpenAPI v1 schemas only, null otherwise.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IAny DocumentDefinition { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).DocumentDefinition; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).DocumentDefinition = value ?? null /* model class */; }

        /// <summary>
        /// Json escaped string defining the document representing the Schema. Used for schemas other than Swagger/OpenAPI.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string DocumentValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).DocumentValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).DocumentValue = value ?? null; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).ProvisioningState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractProperties _property;

        /// <summary>Properties of the API Schema.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.SchemaContractProperties()); set => this._property = value; }

        /// <summary>The provisioning state</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractPropertiesInternal)Property).ProvisioningState; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
            if (headers.TryGetValues("location", out var __locationHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
            if (headers.TryGetValues("Azure-AsyncOperation", out var __azureAsyncOperationHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractInternal)this).AzureAsyncOperation = System.Linq.Enumerable.FirstOrDefault(__azureAsyncOperationHeader2) is string __headerAzureAsyncOperationHeader2 ? __headerAzureAsyncOperationHeader2 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string Location { get; set; }
        /// <summary>Properties of the API Schema.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISchemaContractProperties Property { get; set; }
        /// <summary>The provisioning state</summary>
