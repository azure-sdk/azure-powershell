...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class SubscriptionUpdateParameters :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameters,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParametersInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParametersInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.SubscriptionUpdateParameterProperties()); set { {_property = value;} } }

        /// <summary>User identifier path: /users/{userId}</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string OwnerId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterPropertiesInternal)Property).OwnerId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterPropertiesInternal)Property).OwnerId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.SubscriptionUpdateParameterProperties()); set => this._property = value; }

        /// <summary>Scope like /products/{productId} or /apis or /apis/{apiId}</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Scope { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterPropertiesInternal)Property).Scope; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterPropertiesInternal)Property).Scope = value ?? null; }
...

    {
        ...
        string PrimaryKey { get; set; }
        /// <summary>Subscription Update contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionUpdateParameterProperties Property { get; set; }
        /// <summary>Scope like /products/{productId} or /apis or /apis/{apiId}</summary>
        string Scope { get; set; }
        /// <summary>Secondary subscription key.</summary>
        string SecondaryKey { get; set; }
