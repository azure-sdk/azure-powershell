...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class PortalDelegationSettingsProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal
    {

        /// <summary>Internal Acessors for Subscription</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionsDelegationSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal.Subscription { get => (this._subscription = this._subscription ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.SubscriptionsDelegationSettingsProperties()); set { {_subscription = value;} } }

        /// <summary>Internal Acessors for UserRegistration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IRegistrationDelegationSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalDelegationSettingsPropertiesInternal.UserRegistration { get => (this._userRegistration = this._userRegistration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.RegistrationDelegationSettingsProperties()); set { {_userRegistration = value;} } }

        /// <summary>Backing field for <see cref="Subscription" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionsDelegationSettingsProperties _subscription;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionsDelegationSettingsProperties Subscription { get => (this._subscription = this._subscription ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.SubscriptionsDelegationSettingsProperties()); set => this._subscription = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IRegistrationDelegationSettingsProperties _userRegistration;

        /// <summary>User registration delegation settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IRegistrationDelegationSettingsProperties UserRegistration { get => (this._userRegistration = this._userRegistration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.RegistrationDelegationSettingsProperties()); set => this._userRegistration = value; }
    ...
    {
        /// <summary>Subscriptions delegation settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ISubscriptionsDelegationSettingsProperties Subscription { get; set; }
        /// <summary>Enable or disable delegation for subscriptions.</summary>
        bool? SubscriptionEnabled { get; set; }
        /// <summary>A delegation Url.</summary>
        string Url { get; set; }
        /// <summary>User registration delegation settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IRegistrationDelegationSettingsProperties UserRegistration { get; set; }
        /// <summary>Enable or disable delegation for user registration.</summary>
        bool? UserRegistrationEnabled { get; set; }
        /// <summary>
        /// A base64-encoded validation key to validate, that a request is coming from Azure API Management.
