...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class PortalSignupSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public bool? Enabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).Enabled = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.PortalSignupSettingsProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for TermsOfService</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ITermsOfServiceProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsInternal.TermsOfService { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermsOfService; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermsOfService = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsProperties _property;

        /// <summary>Sign-up settings contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.PortalSignupSettingsProperties()); set => this._property = value; }

        /// <summary>Ask user for consent to the terms of service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? TermOfServiceConsentRequired { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceConsentRequired; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceConsentRequired = value ?? default(bool); }

        /// <summary>Display terms of service during a sign-up process.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? TermOfServiceEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceEnabled = value ?? default(bool); }

        /// <summary>A terms of service text.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string TermOfServiceText { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceText; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceText = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        bool? Enabled { get; set; }
        /// <summary>Sign-up settings contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IPortalSignupSettingsProperties Property { get; set; }
        /// <summary>Ask user for consent to the terms of service.</summary>
        bool? TermOfServiceConsentRequired { get; set; }
        /// <summary>Display terms of service during a sign-up process.</summary>
        bool? TermOfServiceEnabled { get; set; }
