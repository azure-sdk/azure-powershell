...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class CircuitBreakerRule :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerRule,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerRuleInternal
    {

        /// <summary>Backing field for <see cref="FailureCondition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureCondition _failureCondition;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureCondition FailureCondition { get => (this._failureCondition = this._failureCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.CircuitBreakerFailureCondition()); set => this._failureCondition = value; }
        ...
        /// <summary>The threshold for opening the circuit.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public long? FailureConditionPercentage { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureConditionInternal)FailureCondition).Percentage; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureConditionInternal)FailureCondition).Percentage = value ?? default(long); }

        /// <summary>The status code ranges which are considered as failure.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IFailureStatusCodeRange[] FailureConditionStatusCodeRange { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureConditionInternal)FailureCondition).StatusCodeRange; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureConditionInternal)FailureCondition).StatusCodeRange = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for FailureCondition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureCondition Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerRuleInternal.FailureCondition { get => (this._failureCondition = this._failureCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.CircuitBreakerFailureCondition()); set { {_failureCondition = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IFailureStatusCodeRange) })]
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IFailureStatusCodeRange[] FailureConditionStatusCodeRange { get; set; }
        /// <summary>The rule name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>The conditions for tripping the circuit breaker.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.ICircuitBreakerFailureCondition FailureCondition { get; set; }
        /// <summary>The threshold for opening the circuit.</summary>
        long? FailureConditionCount { get; set; }
        /// <summary>The error reasons which are considered as failure.</summary>
        string[] FailureConditionErrorReason { get; set; }
