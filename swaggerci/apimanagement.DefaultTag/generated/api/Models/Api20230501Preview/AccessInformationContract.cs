...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview
{
    ...
    public partial class AccessInformationContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public bool? Enabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractPropertiesInternal)Property).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractPropertiesInternal)Property).Enabled = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.AccessInformationContractProperties()); set { {_property = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string PrincipalId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractPropertiesInternal)Property).PrincipalId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractPropertiesInternal)Property).PrincipalId = value ?? null; }

        /// <summary>Access Information type ('access' or 'gitAccess')</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string PropertiesId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractPropertiesInternal)Property).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractPropertiesInternal)Property).Id = value ?? null; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractProperties _property;

        /// <summary>AccessInformation entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.AccessInformationContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string PropertiesId { get; set; }
        /// <summary>AccessInformation entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230501Preview.IAccessInformationContractProperties Property { get; set; }
