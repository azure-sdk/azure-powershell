...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901
{
    ...
    public partial class PolicyRestrictionContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.PolicyRestrictionContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractProperties _property;

        /// <summary>Properties of the Policy Restriction.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.PolicyRestrictionContractProperties()); set => this._property = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyRestrictionRequireBase? RequireBase { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractPropertiesInternal)Property).RequireBase; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractPropertiesInternal)Property).RequireBase = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyRestrictionRequireBase)""); }

        /// <summary>Path to the policy document.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Scope { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractPropertiesInternal)Property).Scope; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractPropertiesInternal)Property).Scope = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        string ETag { get; set; }
        /// <summary>Properties of the Policy Restriction.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPolicyRestrictionContractProperties Property { get; set; }
        /// <summary>Indicates if base policy should be enforced for the policy document.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyRestrictionRequireBase? RequireBase { get; set; }
        /// <summary>Path to the policy document.</summary>
        string Scope { get; set; }
