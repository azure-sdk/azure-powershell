...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901
{
    ...
    public partial class PortalSignupSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public bool? Enabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).Enabled = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.PortalSignupSettingsProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for TermsOfService</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.ITermsOfServiceProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsInternal.TermsOfService { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermsOfService; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermsOfService = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsProperties _property;

        /// <summary>Sign-up settings contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.PortalSignupSettingsProperties()); set => this._property = value; }

        /// <summary>Ask user for consent to the terms of service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? TermOfServiceConsentRequired { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceConsentRequired; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceConsentRequired = value ?? default(bool); }

        /// <summary>Display terms of service during a sign-up process.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public bool? TermOfServiceEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceEnabled = value ?? default(bool); }

        /// <summary>A terms of service text.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string TermOfServiceText { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceText; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsPropertiesInternal)Property).TermOfServiceText = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        bool? Enabled { get; set; }
        /// <summary>Sign-up settings contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IPortalSignupSettingsProperties Property { get; set; }
        /// <summary>Ask user for consent to the terms of service.</summary>
        bool? TermOfServiceConsentRequired { get; set; }
        /// <summary>Display terms of service during a sign-up process.</summary>
        bool? TermOfServiceEnabled { get; set; }
