...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901
{
    ...
    public partial class AuthorizationServerContract
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject into a new instance of <see cref="AuthorizationServerContract" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AuthorizationServerContract(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.AuthorizationServerContractProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IAuthorizationServerContract.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IAuthorizationServerContract.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IAuthorizationServerContract FromJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json ? new AuthorizationServerContract(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AuthorizationServerContract" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AuthorizationServerContract" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" />.
        /// </returns>
