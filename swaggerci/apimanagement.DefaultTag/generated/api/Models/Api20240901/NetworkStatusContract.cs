...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901
{
    ...
    public partial class NetworkStatusContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.INetworkStatusContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.INetworkStatusContractInternal
    {

        /// <summary>Backing field for <see cref="ConnectivityStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IConnectivityStatusContract[] _connectivityStatus;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IConnectivityStatusContract[] ConnectivityStatus { get => this._connectivityStatus; set => this._connectivityStatus = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IConnectivityStatusContract[] ConnectivityStatus { get; set; }
        /// <summary>Gets the list of DNS servers IPV4 addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = true,
        ReadOnly = false,
