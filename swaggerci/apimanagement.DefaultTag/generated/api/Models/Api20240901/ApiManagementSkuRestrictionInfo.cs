...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901
{
    ...
    public partial class ApiManagementSkuRestrictionInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IApiManagementSkuRestrictionInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IApiManagementSkuRestrictionInfoInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IApiManagementSkuRestrictionInfoInternal.Location { get => this._location; set { {_location = value;} } }

        /// <summary>Internal Acessors for Zone</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IApiManagementSkuRestrictionInfoInternal.Zone { get => this._zone; set { {_zone = value;} } }
