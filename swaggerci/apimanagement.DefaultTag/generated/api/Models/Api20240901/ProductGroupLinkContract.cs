...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901
{
    ...
    public partial class ProductGroupLinkContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string GroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractPropertiesInternal)Property).GroupId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractPropertiesInternal)Property).GroupId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.ProductGroupLinkContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractProperties _property;

        /// <summary>Product-group link entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.ProductGroupLinkContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string GroupId { get; set; }
        /// <summary>Product-group link entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240901.IProductGroupLinkContractProperties Property { get; set; }
