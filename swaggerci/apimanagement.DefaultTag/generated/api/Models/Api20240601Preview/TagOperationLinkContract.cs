...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview
{
    ...
    public partial class TagOperationLinkContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.TagOperationLinkContractProperties()); set { {_property = value;} } }
        ...
        public string OperationId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractPropertiesInternal)Property).OperationId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractPropertiesInternal)Property).OperationId = value ?? null; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractProperties _property;

        /// <summary>Tag-API link entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.TagOperationLinkContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }

        /// <summary>Creates an new <see cref="TagOperationLinkContract" /> instance.</summary>
        public TagOperationLinkContract()
        {
    ...
    public partial interface ITagOperationLinkContract :
    ...
    /// Tag-operation link details.
    internal partial interface ITagOperationLinkContractInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string OperationId { get; set; }
        /// <summary>Tag-API link entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ITagOperationLinkContractProperties Property { get; set; }
