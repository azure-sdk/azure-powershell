...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview
{
    ...
    public partial class NetworkStatusContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.INetworkStatusContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.INetworkStatusContractInternal
    {

        /// <summary>Backing field for <see cref="ConnectivityStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.IConnectivityStatusContract[] _connectivityStatus;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.IConnectivityStatusContract[] ConnectivityStatus { get => this._connectivityStatus; set => this._connectivityStatus = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.IConnectivityStatusContract) })]
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.IConnectivityStatusContract[] ConnectivityStatus { get; set; }
        /// <summary>Gets the list of DNS servers IPV4 addresses.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = true,
        ReadOnly = false,
