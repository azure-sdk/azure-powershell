...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview
{
    ...
    public partial class CircuitBreakerRule :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerRule,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerRuleInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerFailureCondition _failureCondition;

        /// <summary>The conditions for tripping the circuit breaker.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerFailureCondition FailureCondition { get => (this._failureCondition = this._failureCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.CircuitBreakerFailureCondition()); set => this._failureCondition = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.IFailureStatusCodeRange[] FailureConditionStatusCodeRange { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerFailureConditionInternal)FailureCondition).StatusCodeRange; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerFailureConditionInternal)FailureCondition).StatusCodeRange = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for FailureCondition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerFailureCondition Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerRuleInternal.FailureCondition { get => (this._failureCondition = this._failureCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.CircuitBreakerFailureCondition()); set { {_failureCondition = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.IFailureStatusCodeRange[] FailureConditionStatusCodeRange { get; set; }
        /// <summary>The rule name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        bool? AcceptRetryAfter { get; set; }
        /// <summary>The conditions for tripping the circuit breaker.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601Preview.ICircuitBreakerFailureCondition FailureCondition { get; set; }
        /// <summary>The threshold for opening the circuit.</summary>
        long? FailureConditionCount { get; set; }
        /// <summary>The error reasons which are considered as failure.</summary>
        string[] FailureConditionErrorReason { get; set; }
