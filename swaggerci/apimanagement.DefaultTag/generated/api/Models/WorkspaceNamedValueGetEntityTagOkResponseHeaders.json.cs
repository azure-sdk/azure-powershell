...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models
{
    ...
    public partial class WorkspaceNamedValueGetEntityTagOkResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceNamedValueGetEntityTagOkResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceNamedValueGetEntityTagOkResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceNamedValueGetEntityTagOkResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json ? new WorkspaceNamedValueGetEntityTagOkResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WorkspaceNamedValueGetEntityTagOkResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="WorkspaceNamedValueGetEntityTagOkResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject into a new instance of <see cref="WorkspaceNamedValueGetEntityTagOkResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WorkspaceNamedValueGetEntityTagOkResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
