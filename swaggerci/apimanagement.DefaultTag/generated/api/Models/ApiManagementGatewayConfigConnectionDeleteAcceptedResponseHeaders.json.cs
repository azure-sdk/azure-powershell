...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models
{
    ...
    public partial class ApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject into a new instance of <see cref="ApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json ? new ApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders" /> into a <see
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApiManagementGatewayConfigConnectionDeleteAcceptedResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
