...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview
{
    ...
    public partial class PortalSigninSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingsInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public bool? Enabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingPropertiesInternal)Property).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingPropertiesInternal)Property).Enabled = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingsInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.PortalSigninSettingProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingProperties _property;

        /// <summary>Sign-in settings contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.PortalSigninSettingProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingsInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        bool? Enabled { get; set; }
        /// <summary>Sign-in settings contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IPortalSigninSettingProperties Property { get; set; }
