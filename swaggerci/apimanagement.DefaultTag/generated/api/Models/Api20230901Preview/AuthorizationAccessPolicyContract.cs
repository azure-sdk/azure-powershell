...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview
{
    ...
    public partial class AuthorizationAccessPolicyContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string[] AppId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractPropertiesInternal)Property).AppId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractPropertiesInternal)Property).AppId = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.AuthorizationAccessPolicyContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractProperties _property;

        /// <summary>Properties of the Authorization Contract.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.AuthorizationAccessPolicyContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ObjectId { get; set; }
        /// <summary>Properties of the Authorization Contract.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.IAuthorizationAccessPolicyContractProperties Property { get; set; }
        /// <summary>The Tenant Id</summary>
        string TenantId { get; set; }
