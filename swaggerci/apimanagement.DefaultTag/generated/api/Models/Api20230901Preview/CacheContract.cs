...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview
{
    ...
    public partial class CacheContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string ConnectionString { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).ConnectionString; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).ConnectionString = value ?? null; }

        /// <summary>Cache description</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.CacheContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractProperties _property;

        /// <summary>Cache properties details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.CacheContractProperties()); set => this._property = value; }

        /// <summary>Original uri of entity in external system cache points to</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).ResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).ResourceId = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string UseFromLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).UseFromLocation; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractPropertiesInternal)Property).UseFromLocation = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Cache properties details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ICacheContractProperties Property { get; set; }
        /// <summary>Original uri of entity in external system cache points to</summary>
        string ResourceId { get; set; }
        /// <summary>
        /// Location identifier to use cache from (should be either 'default' or valid Azure region identifier)
