...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview
{
    ...
    public partial class TagProductLinkContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.TagProductLinkContractProperties()); set { {_property = value;} } }
        ...
        public string ProductId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractPropertiesInternal)Property).ProductId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractPropertiesInternal)Property).ProductId = value ?? null; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractProperties _property;

        /// <summary>Tag-API link entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.TagProductLinkContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }

        /// <summary>Creates an new <see cref="TagProductLinkContract" /> instance.</summary>
        public TagProductLinkContract()
        {
    ...
    public partial interface ITagProductLinkContract :
    ...
    /// Tag-product link details.
    internal partial interface ITagProductLinkContractInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ProductId { get; set; }
        /// <summary>Tag-API link entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITagProductLinkContractProperties Property { get; set; }
