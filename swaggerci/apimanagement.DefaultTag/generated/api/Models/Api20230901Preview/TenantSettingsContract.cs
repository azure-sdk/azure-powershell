...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview
{
    ...
    public partial class TenantSettingsContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.TenantSettingsContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractProperties _property;

        /// <summary>TenantSettings entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.TenantSettingsContractProperties()); set => this._property = value; }

        /// <summary>Tenant settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractPropertiesSettings Setting { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractPropertiesInternal)Property).Setting; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractPropertiesInternal)Property).Setting = value ?? null /* model class */; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        string ETag { get; set; }
        /// <summary>TenantSettings entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractProperties Property { get; set; }
        /// <summary>Tenant settings</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230901Preview.ITenantSettingsContractPropertiesSettings Setting { get; set; }
