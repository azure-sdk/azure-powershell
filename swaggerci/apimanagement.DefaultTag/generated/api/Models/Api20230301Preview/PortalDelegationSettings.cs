...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview
{
    ...
    public partial class PortalDelegationSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.PortalDelegationSettingsProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for Subscription</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.ISubscriptionsDelegationSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsInternal.Subscription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsPropertiesInternal)Property).Subscription; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsPropertiesInternal)Property).Subscription = value; }

        /// <summary>Internal Acessors for UserRegistration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IRegistrationDelegationSettingsProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsInternal.UserRegistration { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsPropertiesInternal)Property).UserRegistration; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsPropertiesInternal)Property).UserRegistration = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsProperties _property;

        /// <summary>Delegation settings contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.PortalDelegationSettingsProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Url { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsPropertiesInternal)Property).Url; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsPropertiesInternal)Property).Url = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        string ETag { get; set; }
        /// <summary>Delegation settings contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPortalDelegationSettingsProperties Property { get; set; }
