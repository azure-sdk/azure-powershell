...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview
{
    ...
    public partial class GatewayCertificateAuthorityContractProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IGatewayCertificateAuthorityContractProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IGatewayCertificateAuthorityContractProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IGatewayCertificateAuthorityContractProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json ? new GatewayCertificateAuthorityContractProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject into a new instance of <see cref="GatewayCertificateAuthorityContractProperties"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal GatewayCertificateAuthorityContractProperties(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json)
        {
            ...
            {_isTrusted = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonBoolean>("isTrusted"), out var __jsonIsTrusted) ? (bool?)__jsonIsTrusted : IsTrusted;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GatewayCertificateAuthorityContractProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GatewayCertificateAuthorityContractProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._isTrusted ? (Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonBoolean((bool)this._isTrusted) : null, "isTrusted" ,container.Add );
