...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview
{
    ...
    public partial class ConnectivityHop :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHop,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityIssue[] _issue;

        /// <summary>List of issues.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityIssue[] Issue { get => this._issue; }

        /// <summary>Internal Acessors for Address</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal.Address { get => this._address; set { {_address = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Issue</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityIssue[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal.Issue { get => this._issue; set { {_issue = value;} } }

        /// <summary>Internal Acessors for NextHopId</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal.NextHopId { get => this._nextHopId; set { {_nextHopId = value;} } }

        /// <summary>Internal Acessors for ResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal.ResourceId { get => this._resourceId; set { {_resourceId = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityHopInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityIssue) })]
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityIssue[] Issue { get;  }
        /// <summary>List of next hop identifiers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        string Id { get; set; }
        /// <summary>List of issues.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IConnectivityIssue[] Issue { get; set; }
        /// <summary>List of next hop identifiers.</summary>
