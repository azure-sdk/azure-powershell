...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview
{
    ...
    public partial class IssueAttachmentContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string Content { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractPropertiesInternal)Property).Content; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractPropertiesInternal)Property).Content = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ContentFormat { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractPropertiesInternal)Property).ContentFormat; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractPropertiesInternal)Property).ContentFormat = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IssueAttachmentContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractProperties _property;

        /// <summary>Properties of the Issue Attachment.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IssueAttachmentContractProperties()); set => this._property = value; }

        /// <summary>Filename by which the binary data will be saved.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Title { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractPropertiesInternal)Property).Title; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractPropertiesInternal)Property).Title = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Properties of the Issue Attachment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IIssueAttachmentContractProperties Property { get; set; }
        /// <summary>Filename by which the binary data will be saved.</summary>
        string Title { get; set; }
