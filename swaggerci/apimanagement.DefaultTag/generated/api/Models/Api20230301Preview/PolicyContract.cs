...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview
{
    ...
    public partial class PolicyContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyContentFormat? Format { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractPropertiesInternal)Property).Format; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractPropertiesInternal)Property).Format = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyContentFormat)""); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.PolicyContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractProperties _property;

        /// <summary>Properties of the Policy.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.PolicyContractProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Value { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractPropertiesInternal)Property).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractPropertiesInternal)Property).Value = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyContentFormat? Format { get; set; }
        /// <summary>Properties of the Policy.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20230301Preview.IPolicyContractProperties Property { get; set; }
        /// <summary>Contents of the Policy as defined by the format.</summary>
        string Value { get; set; }
