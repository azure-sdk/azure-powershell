...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class CertificateContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string LastStatusCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).LastStatusCode; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).LastStatusCode = value ?? null; }

        /// <summary>Details of the error else empty.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string LastStatusMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).LastStatusMessage; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).LastStatusMessage = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.CertificateContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractProperties _property;

        /// <summary>Certificate properties details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.CertificateContractProperties()); set => this._property = value; }

        /// <summary>Subject attribute of the certificate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Subject { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).Subject; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).Subject = value ?? null; }

        /// <summary>Thumbprint of the certificate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Thumbprint { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).Thumbprint; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractPropertiesInternal)Property).Thumbprint = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        global::System.DateTime? LastStatusTimeStampUtc { get; set; }
        /// <summary>Certificate properties details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICertificateContractProperties Property { get; set; }
        /// <summary>Subject attribute of the certificate.</summary>
        string Subject { get; set; }
        /// <summary>Thumbprint of the certificate.</summary>
        string Thumbprint { get; set; }
