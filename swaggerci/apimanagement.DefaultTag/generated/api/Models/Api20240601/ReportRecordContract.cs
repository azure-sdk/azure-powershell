...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class ReportRecordContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IReportRecordContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IReportRecordContractInternal
    {
        ...
        /// <summary>
        /// Number of calls failed due to gateway or backend errors. This includes calls returning HttpStatusCode.BadRequest(400)
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IReportRecordContractInternal.ProductId { get => this._productId; set { {_productId = value;} } }

        /// <summary>Internal Acessors for UserId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IReportRecordContractInternal.UserId { get => this._userId; set { {_userId = value;} } }
