...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class IssueAttachmentContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string Content { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractPropertiesInternal)Property).Content; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractPropertiesInternal)Property).Content = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ContentFormat { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractPropertiesInternal)Property).ContentFormat; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractPropertiesInternal)Property).ContentFormat = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractProperties _property;

        /// <summary>Properties of the Issue Attachment.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IssueAttachmentContractProperties()); set => this._property = value; }

        /// <summary>Filename by which the binary data will be saved.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Title { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractPropertiesInternal)Property).Title; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractPropertiesInternal)Property).Title = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Properties of the Issue Attachment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IIssueAttachmentContractProperties Property { get; set; }
        /// <summary>Filename by which the binary data will be saved.</summary>
        string Title { get; set; }
