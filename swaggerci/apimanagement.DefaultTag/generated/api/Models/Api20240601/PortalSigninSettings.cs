...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class PortalSigninSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingsInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public bool? Enabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingPropertiesInternal)Property).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingPropertiesInternal)Property).Enabled = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingsInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.PortalSigninSettingProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingProperties _property;

        /// <summary>Sign-in settings contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.PortalSigninSettingProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingsInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        bool? Enabled { get; set; }
        /// <summary>Sign-in settings contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IPortalSigninSettingProperties Property { get; set; }
