...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class NotificationContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IValidates
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.NotificationContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.NotificationContractProperties()); set => this._property = value; }

        /// <summary>List of Emails subscribed for the notification.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string[] RecipientEmail { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).RecipientEmail; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).RecipientEmail = value ?? null /* arrayOf */; }

        /// <summary>List of Users subscribed for the notification.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string[] RecipientUser { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).RecipientUser; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).RecipientUser = value ?? null /* arrayOf */; }

        /// <summary>Title of the Notification.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Title { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).Title; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractPropertiesInternal)Property).Title = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string Description { get; set; }
        /// <summary>Notification entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.INotificationContractProperties Property { get; set; }
