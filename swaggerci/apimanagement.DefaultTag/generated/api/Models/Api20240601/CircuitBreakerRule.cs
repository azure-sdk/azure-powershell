...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class CircuitBreakerRule :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICircuitBreakerRule,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICircuitBreakerRuleInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICircuitBreakerFailureCondition _failureCondition;

        /// <summary>The conditions for tripping the circuit breaker.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICircuitBreakerFailureCondition FailureCondition { get => (this._failureCondition = this._failureCondition ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.CircuitBreakerFailureCondition()); set => this._failureCondition = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IFailureStatusCodeRange) })]
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IFailureStatusCodeRange[] FailureConditionStatusCodeRange { get; set; }
        /// <summary>The rule name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        bool? AcceptRetryAfter { get; set; }
        /// <summary>The conditions for tripping the circuit breaker.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ICircuitBreakerFailureCondition FailureCondition { get; set; }
        /// <summary>The threshold for opening the circuit.</summary>
        long? FailureConditionCount { get; set; }
        /// <summary>The error reasons which are considered as failure.</summary>
        string[] FailureConditionErrorReason { get; set; }
