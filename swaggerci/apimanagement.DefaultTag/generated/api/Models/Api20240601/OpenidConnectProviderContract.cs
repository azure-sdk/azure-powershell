...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class OpenidConnectProviderContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string ClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractPropertiesInternal)Property).ClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractPropertiesInternal)Property).ClientId = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractPropertiesInternal)Property).Description = value ?? null; }

        /// <summary>User-friendly OpenID Connect Provider name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string DisplayName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractPropertiesInternal)Property).DisplayName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractPropertiesInternal)Property).DisplayName = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractProperties _property;

        /// <summary>OpenId Connect Provider contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.OpenidConnectProviderContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string MetadataEndpoint { get; set; }
        /// <summary>OpenId Connect Provider contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IOpenidConnectProviderContractProperties Property { get; set; }
        /// <summary>
        /// If true, the Open ID Connect provider will be used in the API documentation in the developer portal. False by default
        /// if no value is provided.
        /// </summary>
