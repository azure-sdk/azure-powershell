...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601
{
    ...
    public partial class ResolverContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContractInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContractInternal)Property).Description = value ?? null; }

        /// <summary>Resolver Name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string DisplayName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContractInternal)Property).DisplayName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContractInternal)Property).DisplayName = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Path { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContractInternal)Property).Path; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContractInternal)Property).Path = value ?? null; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContract _property;

        /// <summary>Properties of the Resolver Contract.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContract Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.ResolverEntityBaseContract()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string Path { get; set; }
        /// <summary>Properties of the Resolver Contract.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240601.IResolverEntityBaseContract Property { get; set; }
