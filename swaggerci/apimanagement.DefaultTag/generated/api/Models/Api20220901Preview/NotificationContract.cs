...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview
{
    ...
    public partial class NotificationContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IValidates
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.NotificationContractProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for Recipient</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IRecipientsContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractInternal.Recipient { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractPropertiesInternal)Property).Recipient; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractPropertiesInternal)Property).Recipient = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.NotificationContractProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Title { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractPropertiesInternal)Property).Title; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractPropertiesInternal)Property).Title = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string Description { get; set; }
        /// <summary>Notification entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.INotificationContractProperties Property { get; set; }
        /// <summary>Recipient Parameter values.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IRecipientsContractProperties Recipient { get; set; }
        /// <summary>List of Emails subscribed for the notification.</summary>
        string[] RecipientEmail { get; set; }
        /// <summary>List of Users subscribed for the notification.</summary>
        string[] RecipientUser { get; set; }
