...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview
{
    ...
    public partial class ProductApiLinkContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string ApiId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractPropertiesInternal)Property).ApiId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractPropertiesInternal)Property).ApiId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.ProductApiLinkContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractProperties _property;

        /// <summary>Product-API link entity contract properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.ProductApiLinkContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ETag { get; set; }
        /// <summary>Product-API link entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IProductApiLinkContractProperties Property { get; set; }
