...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview
{
    ...
    public partial class PolicyFragmentContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyFragmentContentFormat? Format { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractPropertiesInternal)Property).Format; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractPropertiesInternal)Property).Format = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyFragmentContentFormat)""); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.PolicyFragmentContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractProperties _property;

        /// <summary>Properties of the Policy Fragment.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.PolicyFragmentContractProperties()); set => this._property = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Value { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractPropertiesInternal)Property).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractPropertiesInternal)Property).Value = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.PolicyFragmentContentFormat? Format { get; set; }
        /// <summary>Properties of the Policy Fragment.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20220901Preview.IPolicyFragmentContractProperties Property { get; set; }
        /// <summary>Contents of the policy fragment.</summary>
        string Value { get; set; }
