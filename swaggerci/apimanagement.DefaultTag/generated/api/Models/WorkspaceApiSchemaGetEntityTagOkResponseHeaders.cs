...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models
{
    ...
    public partial class WorkspaceApiSchemaGetEntityTagOkResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceApiSchemaGetEntityTagOkResponseHeaders,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceApiSchemaGetEntityTagOkResponseHeadersInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }

        /// <summary>
        /// Creates an new <see cref="WorkspaceApiSchemaGetEntityTagOkResponseHeaders" /> instance.
        /// </summary>
        public WorkspaceApiSchemaGetEntityTagOkResponseHeaders()
        {
    ...
    internal partial interface IWorkspaceApiSchemaGetEntityTagOkResponseHeadersInternal
