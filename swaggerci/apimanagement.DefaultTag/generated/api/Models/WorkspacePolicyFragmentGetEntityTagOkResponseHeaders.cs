...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models
{
    ...
    public partial class WorkspacePolicyFragmentGetEntityTagOkResponseHeaders :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspacePolicyFragmentGetEntityTagOkResponseHeadersInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }

        /// <summary>
        /// Creates an new <see cref="WorkspacePolicyFragmentGetEntityTagOkResponseHeaders" /> instance.
        /// </summary>
        public WorkspacePolicyFragmentGetEntityTagOkResponseHeaders()
        {

        }
    }
    public partial interface IWorkspacePolicyFragmentGetEntityTagOkResponseHeaders
    ...
    internal partial interface IWorkspacePolicyFragmentGetEntityTagOkResponseHeadersInternal
