...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501
{
    ...
    public partial class ConnectivityCheckRequest :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequest,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestInternal
    {

        /// <summary>Backing field for <see cref="Destination" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestination _destination;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestination Destination { get => (this._destination = this._destination ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.ConnectivityCheckRequestDestination()); set => this._destination = value; }
        ...
        public string DestinationAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestinationInternal)Destination).Address; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestinationInternal)Destination).Address = value ; }

        /// <summary>Destination port.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public long DestinationPort { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestinationInternal)Destination).Port; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestinationInternal)Destination).Port = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestination Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestInternal.Destination { get => (this._destination = this._destination ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.ConnectivityCheckRequestDestination()); set { {_destination = value;} } }

        /// <summary>Internal Acessors for ProtocolConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestProtocolConfiguration Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestInternal.ProtocolConfiguration { get => (this._protocolConfiguration = this._protocolConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.ConnectivityCheckRequestProtocolConfiguration()); set { {_protocolConfiguration = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSource Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestInternal.Source { get => (this._source = this._source ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.ConnectivityCheckRequestSource()); set { {_source = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestProtocolConfiguration _protocolConfiguration;

        /// <summary>Protocol-specific configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestProtocolConfiguration ProtocolConfiguration { get => (this._protocolConfiguration = this._protocolConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.ConnectivityCheckRequestProtocolConfiguration()); set => this._protocolConfiguration = value; }

        /// <summary>Backing field for <see cref="Source" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSource _source;

        /// <summary>Definitions about the connectivity check origin.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSource Source { get => (this._source = this._source ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.ConnectivityCheckRequestSource()); set => this._source = value; }

        /// <summary>The particular VMSS instance from which to fire the request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public long? SourceInstance { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSourceInternal)Source).Instance; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSourceInternal)Source).Instance = value ?? default(long); }

        /// <summary>
        /// The API Management service region from where to start the connectivity check operation.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string SourceRegion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSourceInternal)Source).Region; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSourceInternal)Source).Region = value ; }
    ...
    {
        /// <summary>The connectivity check operation destination.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestDestination Destination { get; set; }
        /// <summary>Destination address. Can either be an IP address or a FQDN.</summary>
        string DestinationAddress { get; set; }
        /// <summary>Destination port.</summary>
        long DestinationPort { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Support.ConnectivityCheckProtocol? Protocol { get; set; }
        /// <summary>Protocol-specific configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestProtocolConfiguration ProtocolConfiguration { get; set; }
        /// <summary>Configuration for HTTP or HTTPS requests.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestProtocolConfigurationHttpConfiguration ProtocolConfigurationHttpConfiguration { get; set; }
        /// <summary>Definitions about the connectivity check origin.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IConnectivityCheckRequestSource Source { get; set; }
        /// <summary>The particular VMSS instance from which to fire the request.</summary>
        long? SourceInstance { get; set; }
        /// <summary>
        /// The API Management service region from where to start the connectivity check operation.
