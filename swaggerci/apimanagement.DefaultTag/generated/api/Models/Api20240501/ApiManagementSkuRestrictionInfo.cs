...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501
{
    ...
    public partial class ApiManagementSkuRestrictionInfo :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IApiManagementSkuRestrictionInfo,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IApiManagementSkuRestrictionInfoInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IApiManagementSkuRestrictionInfoInternal.Location { get => this._location; set { {_location = value;} } }

        /// <summary>Internal Acessors for Zone</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IApiManagementSkuRestrictionInfoInternal.Zone { get => this._zone; set { {_zone = value;} } }
