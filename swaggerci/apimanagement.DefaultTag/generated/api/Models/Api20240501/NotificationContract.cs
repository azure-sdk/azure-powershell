...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501
{
    ...
    public partial class NotificationContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IValidates
    {
        ...
        public string Description { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).Description = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.NotificationContractProperties()); set => this._property = value; }

        /// <summary>List of Emails subscribed for the notification.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string[] RecipientEmail { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).RecipientEmail; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).RecipientEmail = value ?? null /* arrayOf */; }

        /// <summary>List of Users subscribed for the notification.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string[] RecipientUser { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).RecipientUser; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).RecipientUser = value ?? null /* arrayOf */; }

        /// <summary>Title of the Notification.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string Title { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).Title; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractPropertiesInternal)Property).Title = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string Description { get; set; }
        /// <summary>Notification entity contract properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.INotificationContractProperties Property { get; set; }
