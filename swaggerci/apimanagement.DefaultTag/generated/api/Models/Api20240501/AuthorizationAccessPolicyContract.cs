...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501
{
    ...
    public partial class AuthorizationAccessPolicyContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        public string[] AppId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractPropertiesInternal)Property).AppId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractPropertiesInternal)Property).AppId = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.AuthorizationAccessPolicyContractProperties()); set { {_property = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string ObjectId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractPropertiesInternal)Property).ObjectId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractPropertiesInternal)Property).ObjectId = value ?? null; }

        /// <summary>Backing field for <see cref="Property" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractProperties _property;

        /// <summary>Properties of the Authorization Contract.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.AuthorizationAccessPolicyContractProperties()); set => this._property = value; }

        /// <summary>The Tenant Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Inlined)]
        public string TenantId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractPropertiesInternal)Property).TenantId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractPropertiesInternal)Property).TenantId = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        string ObjectId { get; set; }
        /// <summary>Properties of the Authorization Contract.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IAuthorizationAccessPolicyContractProperties Property { get; set; }
        /// <summary>The Tenant Id</summary>
        string TenantId { get; set; }
