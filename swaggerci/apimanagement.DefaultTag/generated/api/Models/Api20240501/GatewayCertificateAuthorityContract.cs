...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501
{
    ...
    public partial class GatewayCertificateAuthorityContract :
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContract,
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractProperties Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.GatewayCertificateAuthorityContractProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractProperties _property;

        /// <summary>Gateway certificate authority details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Api.Origin(Microsoft.Azure.PowerShell.Cmdlets.Api.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.GatewayCertificateAuthorityContractProperties()); set => this._property = value; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractInternal)this).ETag = System.Linq.Enumerable.FirstOrDefault(__eTagHeader0) is string __headerETagHeader0 ? __headerETagHeader0 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20.IResourceInternal
    {
        ...
        bool? IsTrusted { get; set; }
        /// <summary>Gateway certificate authority details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Api.Models.Api20240501.IGatewayCertificateAuthorityContractProperties Property { get; set; }
