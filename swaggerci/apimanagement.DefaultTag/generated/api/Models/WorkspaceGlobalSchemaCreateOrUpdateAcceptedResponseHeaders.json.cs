...
namespace Microsoft.Azure.PowerShell.Cmdlets.Api.Models
{
    ...
    public partial class WorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Api.Models.IWorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json ? new WorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="WorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject into a new instance of <see cref="WorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WorkspaceGlobalSchemaCreateOrUpdateAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Api.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
