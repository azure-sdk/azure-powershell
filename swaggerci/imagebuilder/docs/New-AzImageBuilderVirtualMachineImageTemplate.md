...
New-AzImageBuilderVirtualMachineImageTemplate -ImageTemplateName <String> -ResourceGroupName <String>
 ...
 [-Tag <Hashtable>] [-VMProfileOsdiskSizeGb <Int32>] [-VMProfileUserAssignedIdentity <String[]>]
 [-VMProfileVmsize <String>] [-VnetConfigProxyVMSize <String>] [-VnetConfigSubnetId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateCustomizer[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateDistributor[]
Parameter Sets: (All)
Aliases:
