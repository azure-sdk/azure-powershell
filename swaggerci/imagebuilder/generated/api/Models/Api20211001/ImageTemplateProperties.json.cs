...
namespace Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001
{
    ...
    public partial class ImageTemplateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonNode node)
        {
        ...
        internal ImageTemplateProperties(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonObject json)
        {
            ...
            {_source = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonObject>("source"), out var __jsonSource) ? Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.ImageTemplateSource.FromJson(__jsonSource) : Source;}
            {_provisioningError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonObject>("provisioningError"), out var __jsonProvisioningError) ? Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.ProvisioningError.FromJson(__jsonProvisioningError) : ProvisioningError;}
            {_lastRunStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonObject>("lastRunStatus"), out var __jsonLastRunStatus) ? Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.ImageTemplateLastRunStatus.FromJson(__jsonLastRunStatus) : LastRunStatus;}
            {_vMProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonObject>("vmProfile"), out var __jsonVMProfile) ? Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.ImageTemplateVMProfile.FromJson(__jsonVMProfile) : VMProfile;}
            {_customize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonArray>("customize"), out var __jsonCustomize) ? If( __jsonCustomize as Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateCustomizer[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateCustomizer) (Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.ImageTemplateCustomizer.FromJson(__u) )) ))() : null : Customize;}
            {_distribute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonArray>("distribute"), out var __jsonDistribute) ? If( __jsonDistribute as Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateDistributor[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.IImageTemplateDistributor) (Microsoft.Azure.PowerShell.Cmdlets.ImageBuilder.Models.Api20211001.ImageTemplateDistributor.FromJson(__p) )) ))() : null : Distribute;}
