...
online version: https://learn.microsoft.com/powershell/module/az.mongoclusterfortesting/new-azmongoclusterfortestingmongocluster
schema: 2.0.0
---

# New-AzMongoClusterForTestingMongoCluster
...
```
New-AzMongoClusterForTestingMongoCluster -Name <String> -ResourceGroupName <String> -Location <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.CreateMode
Parameter Sets: (All)
Aliases:
