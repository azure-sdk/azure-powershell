...
online version: https://learn.microsoft.com/powershell/module/az.mongoclusterfortesting/new-azmongoclusterfortestingfirewallrule
schema: 2.0.0
---
...
```
New-AzMongoClusterForTestingFirewallRule -MongoClusterName <String> -Name <String> -ResourceGroupName <String>
