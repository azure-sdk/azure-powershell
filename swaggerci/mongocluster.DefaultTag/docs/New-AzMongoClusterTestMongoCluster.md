...
online version: https://learn.microsoft.com/powershell/module/az.mongoclustertest/new-azmongoclustertestmongocluster
schema: 2.0.0
---

# New-AzMongoClusterTestMongoCluster
...
```
New-AzMongoClusterTestMongoCluster -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-AdministratorPassword <SecureString>] [-AdministratorUserName <String>]
 [-ComputeTier <String>] [-CreateMode <CreateMode>] [-HighAvailabilityTargetMode <HighAvailabilityMode>]
 ...
 [-ServerVersion <String>] [-ShardingShardCount <Int32>] [-StorageSizeGb <Int64>] [-Tag <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.CreateMode
Parameter Sets: (All)
Aliases:
