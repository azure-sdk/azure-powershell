...
Update-AzMongoCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-ShardingShardCount <Int32>] [-StorageSizeGb <Int64>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
...
Update-AzMongoCluster -InputObject <IMongoClusterIdentity> [-AdministratorPassword <SecureString>]
 [-AdministratorUserName <String>] [-ComputeTier <String>] [-DataApiMode <DataApiMode>]
...
### Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IMongoCluster
