...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support
{
    ...
    {
        /// <summary>
        /// High availability mode is disabled. This mode is can see availability impact during faults or maintenance and is not recommended
        /// for production.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode Disabled = @"Disabled";

        /// <summary>
        /// High availability mode is enabled, where each server in a shard is placed in the same availability zone.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode SameZone = @"SameZone";

        /// <summary>
        /// High availability mode is enabled, where each server in a shard is distributed across availability zones.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode ZoneRedundant = @"ZoneRedundant";

        /// <summary>
        /// High availability mode is enabled and preferences ZoneRedundant if availability zones capacity is available in the region,
        /// otherwise falls-back to provisioning with SameZone.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode ZoneRedundantPreferred = @"ZoneRedundantPreferred";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode e1, Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.HighAvailabilityMode e2)
        {
            return !e2.Equals(e1);
        }
