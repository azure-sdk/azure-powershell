...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support
{
        ...
        System.IEquatable<ReplicationRole>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole AsyncReplica = @"AsyncReplica";

        /// <summary>The cluster is a geo-asynchronous replica.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole GeoAsyncReplica = @"GeoAsyncReplica";

        /// <summary>The cluster is a primary replica.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole Primary = @"Primary";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole e1, Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support.ReplicationRole e2)
        {
            return !e2.Equals(e1);
        }
