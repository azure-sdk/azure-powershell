...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support
{
        ...
        System.IEquatable<PublicNetworkAccess>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PublicNetworkAccess Disabled = @"Disabled";

        /// <summary>If set, mongo cluster can be accessed through private and public methods.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PublicNetworkAccess Enabled = @"Enabled";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PublicNetworkAccess e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PublicNetworkAccess e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PublicNetworkAccess e1, Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PublicNetworkAccess e2)
        {
            return !e2.Equals(e1);
        }
