...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus e1, Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support.PrivateEndpointServiceConnectionStatus e2)
        {
            return !e2.Equals(e1);
        }
