...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701
{
    ...
    public partial class ConnectionString :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IConnectionString,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IConnectionStringInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IConnectionStringInternal.ConnectionString1 { get => this._connectionString1; set { {_connectionString1 = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IConnectionStringInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IConnectionStringInternal.Name { get => this._name; set { {_name = value;} } }
