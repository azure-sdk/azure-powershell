...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701
{
    ...
    public partial class MongoClusterListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IMongoClusterListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IMongoClusterListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IMongoCluster[] _value;

        /// <summary>The MongoCluster items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IMongoCluster[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IMongoCluster) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IMongoCluster[] Value { get; set; }
