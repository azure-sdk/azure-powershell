...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701
{
    ...
    public partial class ReplicationProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IReplicationPropertiesInternal
    {

        /// <summary>Internal Acessors for ReplicationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationState? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IReplicationPropertiesInternal.ReplicationState { get => this._replicationState; set { {_replicationState = value;} } }

        /// <summary>Internal Acessors for Role</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationRole? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IReplicationPropertiesInternal.Role { get => this._role; set { {_role = value;} } }

        /// <summary>Internal Acessors for SourceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240701.IReplicationPropertiesInternal.SourceResourceId { get => this._sourceResourceId; set { {_sourceResourceId = value;} } }

        /// <summary>Backing field for <see cref="ReplicationState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationState? _replicationState;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationState? ReplicationState { get => this._replicationState; }

        /// <summary>Backing field for <see cref="Role" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationRole? _role;

        /// <summary>The replication role of the cluster</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationRole? Role { get => this._role; }
