...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api50
{
    ...
    public partial class PrivateLinkResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api50.IPrivateLinkResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api50.IPrivateLinkResourcePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api50.IPrivateLinkResourcePropertiesInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for RequiredMember</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api50.IPrivateLinkResourcePropertiesInternal.RequiredMember { get => this._requiredMember; set { {_requiredMember = value;} } }
