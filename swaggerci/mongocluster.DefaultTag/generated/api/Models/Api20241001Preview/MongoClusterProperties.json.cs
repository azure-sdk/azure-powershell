...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview
{
    ...
    public partial class MongoClusterProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IMongoClusterProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IMongoClusterProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IMongoClusterProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonNode node)
        {
        ...
        internal MongoClusterProperties(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject json)
        {
            ...
            {_restoreParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("restoreParameters"), out var __jsonRestoreParameters) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.MongoClusterRestoreParameters.FromJson(__jsonRestoreParameters) : RestoreParameter;}
            {_replicaParameter = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("replicaParameters"), out var __jsonReplicaParameters) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.MongoClusterReplicaParameters.FromJson(__jsonReplicaParameters) : ReplicaParameter;}
            {_administrator = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("administrator"), out var __jsonAdministrator) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.AdministratorProperties.FromJson(__jsonAdministrator) : Administrator;}
            {_highAvailability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("highAvailability"), out var __jsonHighAvailability) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.HighAvailabilityProperties.FromJson(__jsonHighAvailability) : HighAvailability;}
            {_storage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("storage"), out var __jsonStorage) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.StorageProperties.FromJson(__jsonStorage) : Storage;}
            {_sharding = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("sharding"), out var __jsonSharding) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.ShardingProperties.FromJson(__jsonSharding) : Sharding;}
            {_compute = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("compute"), out var __jsonCompute) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.ComputeProperties.FromJson(__jsonCompute) : Compute;}
            {_backup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("backup"), out var __jsonBackup) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.BackupProperties.FromJson(__jsonBackup) : Backup;}
            {_dataApi = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("dataApi"), out var __jsonDataApi) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.DataApiProperties.FromJson(__jsonDataApi) : DataApi;}
            {_replica = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Json.JsonObject>("replica"), out var __jsonReplica) ? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.ReplicationProperties.FromJson(__jsonReplica) : Replica;}
