...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview
{
    ...
    public partial class ReplicaListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IReplicaListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IReplicaListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IReplica[] _value;

        /// <summary>The Replica items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IReplica[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IReplica) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IReplica[] Value { get; set; }
