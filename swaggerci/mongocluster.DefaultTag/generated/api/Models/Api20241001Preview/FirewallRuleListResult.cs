...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview
{
    ...
    public partial class FirewallRuleListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IFirewallRuleListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IFirewallRuleListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IFirewallRule[] _value;

        /// <summary>The FirewallRule items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IFirewallRule[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IFirewallRule) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20241001Preview.IFirewallRule[] Value { get; set; }
