...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview
{
    ...
    public partial class ListConnectionStringsResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IListConnectionStringsResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IListConnectionStringsResultInternal
    {

        /// <summary>Backing field for <see cref="ConnectionString" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IConnectionString[] _connectionString;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IConnectionString[] ConnectionString { get => this._connectionString; }

        /// <summary>Internal Acessors for ConnectionString</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IConnectionString[] Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IListConnectionStringsResultInternal.ConnectionString { get => this._connectionString; set { {_connectionString = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IConnectionString) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IConnectionString[] ConnectionString { get;  }
    ...
    {
        /// <summary>An array that contains the connection strings for a mongo cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IConnectionString[] ConnectionString { get; set; }
