...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview
{
    ...
    public partial class MongoClusterListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IMongoClusterListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IMongoClusterListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IMongoCluster[] _value;

        /// <summary>The MongoCluster items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IMongoCluster[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IMongoCluster) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IMongoCluster[] Value { get; set; }
