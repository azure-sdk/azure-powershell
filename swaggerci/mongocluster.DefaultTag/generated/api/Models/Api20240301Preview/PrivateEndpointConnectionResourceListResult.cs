...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview
{
    ...
    public partial class PrivateEndpointConnectionResourceListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IPrivateEndpointConnectionResourceListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IPrivateEndpointConnectionResourceListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IPrivateEndpointConnectionResource[] _value;

        /// <summary>The PrivateEndpointConnectionResource items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IPrivateEndpointConnectionResource[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IPrivateEndpointConnectionResource) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IPrivateEndpointConnectionResource[] Value { get; set; }
