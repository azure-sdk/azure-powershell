...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview
{
    ...
    public partial class FirewallRuleListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IFirewallRuleListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IFirewallRuleListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IFirewallRule[] _value;

        /// <summary>The FirewallRule items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IFirewallRule[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IFirewallRule) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models.Api20240301Preview.IFirewallRule[] Value { get; set; }
