...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20250401Preview
{
    ...
    public partial class ReplicationProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20250401Preview.IReplicationPropertiesInternal
    {

        /// <summary>Internal Acessors for ReplicationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationState? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20250401Preview.IReplicationPropertiesInternal.ReplicationState { get => this._replicationState; set { {_replicationState = value;} } }

        /// <summary>Internal Acessors for Role</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ReplicationRole? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20250401Preview.IReplicationPropertiesInternal.Role { get => this._role; set { {_role = value;} } }

        /// <summary>Internal Acessors for SourceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20250401Preview.IReplicationPropertiesInternal.SourceResourceId { get => this._sourceResourceId; set { {_sourceResourceId = value;} } }
