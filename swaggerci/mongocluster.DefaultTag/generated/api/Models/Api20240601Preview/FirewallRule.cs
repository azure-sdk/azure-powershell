...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview
{
    ...
    public partial class FirewallRule :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleInternal,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IValidates
    {
        ...
        public string EndIPAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).EndIPAddress; set => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).EndIPAddress = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleProperties Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.FirewallRuleProperties()); set { {_property = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).ProvisioningState = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.FirewallRuleProperties()); set => this._property = value; }

        /// <summary>The provisioning state of the firewall rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Support.ProvisioningState? ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).ProvisioningState; }

        /// <summary>The start IP address of the mongo cluster firewall rule. Must be IPv4 format.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Inlined)]
        public string StartIPAddress { get => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).StartIPAddress; set => ((Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRulePropertiesInternal)Property).StartIPAddress = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api50.IResourceInternal
    {
        ...
        string EndIPAddress { get; set; }
        /// <summary>The resource-specific properties for this resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IFirewallRuleProperties Property { get; set; }
        /// <summary>The provisioning state of the firewall rule.</summary>
