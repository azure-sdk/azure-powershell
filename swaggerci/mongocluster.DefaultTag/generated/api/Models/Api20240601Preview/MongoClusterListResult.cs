...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview
{
    ...
    public partial class MongoClusterListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IMongoClusterListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IMongoClusterListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IMongoCluster[] _value;

        /// <summary>The MongoCluster items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IMongoCluster[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IMongoCluster) })]
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IMongoCluster[] Value { get; set; }
