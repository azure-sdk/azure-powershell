...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MongoClusterTest.Support";
