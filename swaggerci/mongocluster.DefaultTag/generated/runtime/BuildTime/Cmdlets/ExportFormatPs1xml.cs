...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MongoClusterForTesting.Support";
