...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListConnections=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/mongoClusters/{mongoClusterName}/privateEndpointConnections"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMongoClusterPrivateEndpointConnection_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Description(@"List existing private connections")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/mongoClusters/{mongoClusterName}/privateEndpointConnections", ApiVersion = "2024-03-01-preview")]
    public partial class GetAzMongoClusterPrivateEndpointConnection_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IPrivateEndpointConnectionResourceListResult">Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IPrivateEndpointConnectionResourceListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IPrivateEndpointConnectionResourceListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMongoClusterPrivateEndpointConnection_List" /> cmdlet class.
        /// </summary>
        public GetAzMongoClusterPrivateEndpointConnection_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PrivateEndpointConnectionsListConnections(SubscriptionId, ResourceGroupName, MongoClusterName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240301Preview.IPrivateEndpointConnectionResourceListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.PrivateEndpointConnectionsListConnections_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
