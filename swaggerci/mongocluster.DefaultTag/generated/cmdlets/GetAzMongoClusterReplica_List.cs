...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByMongoCluster=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/mongoClusters/{mongoClusterName}/replicas"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMongoClusterReplica_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IReplica))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Description(@"List all the replicas for the mongo cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/mongoClusters/{mongoClusterName}/replicas", ApiVersion = "2024-06-01-preview")]
    public partial class GetAzMongoClusterReplica_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IReplicaListResult">Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IReplicaListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IReplicaListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMongoClusterReplica_List" /> cmdlet class.
        /// </summary>
        public GetAzMongoClusterReplica_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ReplicasListByMongoCluster(SubscriptionId, ResourceGroupName, MongoClusterName, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.Api20240601Preview.IReplicaListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ReplicasListByMongoCluster_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
