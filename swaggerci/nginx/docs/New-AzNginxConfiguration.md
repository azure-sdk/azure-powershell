...
online version: https://docs.microsoft.com/en-us/powershell/module/az.nginx/new-aznginxconfiguration
schema: 2.0.0
---
...
New-AzNginxConfiguration -DeploymentName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-ProtectedFile <INginxConfigurationFile[]>] [-ProvisioningState <ProvisioningState>] [-RootFile <String>]
