...
.Link
https://learn.microsoft.com/powershell/module/az.subscription/get-azsubscriptionlocation
#>
...
INPUTOBJECT <ISubscriptionIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://learn.microsoft.com/powershell/module/az.subscription/get-azsubscription
#>
