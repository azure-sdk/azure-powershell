...
namespace Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20160601
{
    ...
    public partial class Subscription
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20160601.ISubscription.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20160601.ISubscription.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20160601.ISubscription FromJson(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode node)
        {
        ...
        internal Subscription(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject json)
        {
            ...
            {_policy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject>("subscriptionPolicies"), out var __jsonSubscriptionPolicies) ? Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20160601.SubscriptionPolicies.FromJson(__jsonSubscriptionPolicies) : Policy;}
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models.Api20160601.SubscriptionTags.FromJson(__jsonTags) : Tag;}
            {_authorizationSource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString>("authorizationSource"), out var __jsonAuthorizationSource) ? (string)__jsonAuthorizationSource : (string)AuthorizationSource;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._policy ? (Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode) this._policy.ToJson(null,serializationMode) : null, "subscriptionPolicies" ,container.Add );
            ...
            AddIf( null != (((object)this._authorizationSource)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString(this._authorizationSource.ToString()) : null, "authorizationSource" ,container.Add );
