...
.Link
https://learn.microsoft.com/powershell/module/az.applicationinsights/get-azapplicationinsightsdeletedworkbook
#>
function Get-AzApplicationInsightsDeletedWorkbook {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.Api20240201Preview.IDeletedWorkbook])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.ApplicationInsights.private\Get-AzApplicationInsightsDeletedWorkbook_List';
        }
