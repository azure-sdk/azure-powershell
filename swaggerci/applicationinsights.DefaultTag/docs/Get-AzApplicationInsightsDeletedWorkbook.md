...
```
Get-AzApplicationInsightsDeletedWorkbook [-SubscriptionId <String[]>] [-CanFetchContent]
 [-Category <CategoryType>] [-Tag <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
