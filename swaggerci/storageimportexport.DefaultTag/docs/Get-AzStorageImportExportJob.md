...
online version: https://learn.microsoft.com/powershell/module/az.storageimportexport/get-azstorageimportexportjob
schema: 2.0.0
---
...
### List (Default)
```
Get-AzStorageImportExportJob [-SubscriptionId <String[]>] [-Filter <String>] [-Top <Int64>]
...
Get-AzStorageImportExportJob -ResourceGroupName <String> [-SubscriptionId <String[]>] [-Filter <String>]
 [-Top <Int64>] [-AcceptLanguage <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
