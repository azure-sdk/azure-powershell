...
.Link
https://learn.microsoft.com/powershell/module/az.storageimportexport/get-azstorageimportexportbitlockerkey
#>
...
begin {
    try {
        ...
        if (('List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
        ...
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
            [Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
.Link
https://learn.microsoft.com/powershell/module/az.storageimportexport/get-azstorageimportexportjob
#>
...
INPUTOBJECT <IStorageImportExportIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription ID for the Azure user.
.Link
https://learn.microsoft.com/powershell/module/az.storageimportexport/get-azstorageimportexportlocation
#>
...
.Link
https://learn.microsoft.com/powershell/module/az.storageimportexport/new-azstorageimportexportjob
#>
...
INPUTOBJECT <IStorageImportExportIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription ID for the Azure user.
.Link
https://learn.microsoft.com/powershell/module/az.storageimportexport/remove-azstorageimportexportjob
#>
...
INPUTOBJECT <IStorageImportExportIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The subscription ID for the Azure user.
.Link
https://learn.microsoft.com/powershell/module/az.storageimportexport/update-azstorageimportexportjob
#>
