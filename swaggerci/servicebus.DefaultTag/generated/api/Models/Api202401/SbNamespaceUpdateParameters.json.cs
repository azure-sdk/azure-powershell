...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401
{
    ...
    public partial class SbNamespaceUpdateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ISbNamespaceUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ISbNamespaceUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ISbNamespaceUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode node)
        {
        ...
        internal SbNamespaceUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject json)
        {
            ...
            __resourceNamespacePatch = new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ResourceNamespacePatch(json);
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject>("sku"), out var __jsonSku) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.SbSku.FromJson(__jsonSku) : Sku;}
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.SbNamespaceUpdateProperties.FromJson(__jsonProperties) : Property;}
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.Identity.FromJson(__jsonIdentity) : Identity;}
            AfterFromJson(json);
        }
