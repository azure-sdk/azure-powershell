...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IKeyVaultPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IUserAssignedIdentityProperties _identity;

        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IUserAssignedIdentityProperties Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.UserAssignedIdentityProperties()); set => this._identity = value; }
        ...
        public string IdentityUserAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IUserAssignedIdentityPropertiesInternal)Identity).UserAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IUserAssignedIdentityPropertiesInternal)Identity).UserAssignedIdentity = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IUserAssignedIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IKeyVaultPropertiesInternal.Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.UserAssignedIdentityProperties()); set { {_identity = value;} } }
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IUserAssignedIdentityProperties Identity { get; set; }
        /// <summary>ARM ID of user Identity selected for encryption</summary>
        string IdentityUserAssignedIdentity { get; set; }
        /// <summary>Name of the Key from KeyVault</summary>
        string KeyName { get; set; }
