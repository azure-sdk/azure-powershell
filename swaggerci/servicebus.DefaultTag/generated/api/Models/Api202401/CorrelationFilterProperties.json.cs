...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401
{
    ...
    public partial class CorrelationFilterProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject into a new instance of <see cref="CorrelationFilterProperties" />.
        /// </summary>
        ...
        internal CorrelationFilterProperties(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.JsonSerializable.FromJson( json, ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IAssociativeArray<string>)this).AdditionalProperties, null ,exclusions );
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ICorrelationFilterProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ICorrelationFilterProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ICorrelationFilterProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject json ? new CorrelationFilterProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CorrelationFilterProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CorrelationFilterProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.SerializationMode serializationMode)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.JsonSerializable.ToJson( ((Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IAssociativeArray<string>)this).AdditionalProperties, container);
