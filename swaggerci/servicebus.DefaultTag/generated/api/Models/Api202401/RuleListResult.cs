...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401
{
    ...
    public partial class RuleListResult :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IRuleListResult,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IRuleListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IRule[] _value;

        /// <summary>Result of the List Rules operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IRule[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IRule) })]
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IRule[] Value { get; set; }
