...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ISbQueue
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.ISbQueue])]
