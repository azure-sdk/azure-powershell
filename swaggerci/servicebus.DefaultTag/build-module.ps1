...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.ServiceBus.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ServiceBus.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ServiceBus cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ServiceBus.format.ps1xml'
