...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IKeyVaultProperties[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api202401.IPrivateEndpointConnection[]
Parameter Sets: (All)
Aliases:
