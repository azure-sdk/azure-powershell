...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DisplayName { get => PatchGroupRequestBody.DisplayName ?? null; set => PatchGroupRequestBody.DisplayName = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ParentGroupId { get => PatchGroupRequestBody.ParentGroupId ?? null; set => PatchGroupRequestBody.ParentGroupId = value; }

        /// <summary>Backing field for <see cref="PatchGroupRequestBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.IPatchManagementGroupRequest PatchGroupRequestBody { get => this._patchGroupRequestBody; set => this._patchGroupRequestBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ManagementGroupsUpdate(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, PatchGroupRequestBody, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId=GroupId, CacheControl=this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, body=PatchGroupRequestBody })
                    {
