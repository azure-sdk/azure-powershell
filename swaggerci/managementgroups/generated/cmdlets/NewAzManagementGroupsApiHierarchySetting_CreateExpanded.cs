...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CreateTenantSettingsRequestBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.ICreateOrUpdateSettingsRequest CreateTenantSettingsRequestBody { get => this._createTenantSettingsRequestBody; set => this._createTenantSettingsRequestBody = value; }
        ...
        public string DefaultManagementGroup { get => CreateTenantSettingsRequestBody.DefaultManagementGroup ?? null; set => CreateTenantSettingsRequestBody.DefaultManagementGroup = value; }
        ...
        public global::System.Management.Automation.SwitchParameter RequireAuthorizationForGroupCreation { get => CreateTenantSettingsRequestBody.RequireAuthorizationForGroupCreation ?? default(global::System.Management.Automation.SwitchParameter); set => CreateTenantSettingsRequestBody.RequireAuthorizationForGroupCreation = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.IErrorResponse"
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.IHierarchySettings"
        /// /> from the remote call</param>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.HierarchySettingsCreateOrUpdate(GroupId, CreateTenantSettingsRequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  GroupId=GroupId,body=CreateTenantSettingsRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId=GroupId, body=CreateTenantSettingsRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId=GroupId, body=CreateTenantSettingsRequestBody })
                    {
