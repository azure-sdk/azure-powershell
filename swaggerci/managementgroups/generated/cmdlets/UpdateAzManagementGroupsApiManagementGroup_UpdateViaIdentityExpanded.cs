        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ManagementGroupsUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, PatchGroupRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ManagementGroupsUpdate(InputObject.GroupId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, PatchGroupRequestBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20210401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { CacheControl=this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, body=PatchGroupRequestBody })
                    {
