...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole AsyncReplica = @"AsyncReplica";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole GeoAsyncReplica = @"GeoAsyncReplica";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole GeoSyncReplica = @"GeoSyncReplica";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole Primary = @"Primary";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole Secondary = @"Secondary";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole SyncReplica = @"SyncReplica";

        public static Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole WalReplica = @"WalReplica";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole e1, Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Support.ReplicationRole e2)
        {
            return !e2.Equals(e1);
        }
