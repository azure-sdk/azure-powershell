...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/get-azpostgresqladministrator
#>
...
INPUTOBJECT <IPostgreSqlIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/get-azpostgresqlbackup
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/invoke-azpostgresqlexecutechecknameavailabilitywithlocation
#>
