...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/stop-azlabservicesvirtualmachine
schema: 2.0.0
---

# Stop-AzLabServicesVirtualMachine
...
### Stop (Default)
```
Stop-AzLabServicesVirtualMachine -LabName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzLabServicesVirtualMachine -InputObject <ILabServicesIdentity> [-DefaultProfile <PSObject>] [-AsJob]
