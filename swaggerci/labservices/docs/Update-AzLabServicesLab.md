...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/update-azlabserviceslab
schema: 2.0.0
---
...
Update-AzLabServicesLab -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-Description <String>] [-LabPlanId <String>] [-RosterProfileActiveDirectoryGroupId <String>]
 ...
 [-SecurityProfileOpenAccess <EnableState>] [-Tag <String[]>] [-Title <String>]
 [-VirtualMachineProfile <IVirtualMachineProfile>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
