...
online version: https://docs.microsoft.com/en-us/powershell/module/az.labservices/new-azlabserviceslab
schema: 2.0.0
---
...
New-AzLabServicesLab -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-AutoShutdownProfileNoConnectDelay <TimeSpan>] [-AutoShutdownProfileShutdownOnDisconnect <EnableState>]
 ...
 [-Description <String>] [-LabPlanId <String>] [-NetworkProfileLoadBalancerId <String>]
 ...
 [-RosterProfileLtiRosterEndpoint <String>] [-SecurityProfileOpenAccess <EnableState>] [-Tag <Hashtable>]
 [-Title <String>] [-VirtualMachineProfile <IVirtualMachineProfile>] [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.IVirtualMachineProfile
Parameter Sets: (All)
Aliases:
