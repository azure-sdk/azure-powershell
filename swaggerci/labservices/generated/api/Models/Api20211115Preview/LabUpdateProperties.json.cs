...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview
{
    ...
    public partial class LabUpdateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.ILabUpdateProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.ILabUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.ILabUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode node)
        {
        ...
        internal LabUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject json)
        {
            ...
            {_autoShutdownProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("autoShutdownProfile"), out var __jsonAutoShutdownProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.AutoShutdownProfile.FromJson(__jsonAutoShutdownProfile) : AutoShutdownProfile;}
            {_connectionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("connectionProfile"), out var __jsonConnectionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.ConnectionProfile.FromJson(__jsonConnectionProfile) : ConnectionProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.SecurityProfile.FromJson(__jsonSecurityProfile) : SecurityProfile;}
            {_rosterProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("rosterProfile"), out var __jsonRosterProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.RosterProfile.FromJson(__jsonRosterProfile) : RosterProfile;}
            ...
            {_virtualMachineProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("virtualMachineProfile"), out var __jsonVirtualMachineProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20211115Preview.VirtualMachineProfile.FromJson(__jsonVirtualMachineProfile) : VirtualMachineProfile;}
            AfterFromJson(json);
        }
