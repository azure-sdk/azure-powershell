...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801
{
    ...
    public partial class UserProperties :
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserProperties,
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserUpdateProperties"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserUpdateProperties __userUpdateProperties = new Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.UserUpdateProperties();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for InvitationSent</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal.InvitationSent { get => this._invitationSent; set { {_invitationSent = value;} } }

        /// <summary>Internal Acessors for InvitationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Support.InvitationState? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal.InvitationState { get => this._invitationState; set { {_invitationState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for RegistrationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Support.RegistrationState? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal.RegistrationState { get => this._registrationState; set { {_registrationState = value;} } }

        /// <summary>Internal Acessors for TotalUsage</summary>
        global::System.TimeSpan? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserPropertiesInternal.TotalUsage { get => this._totalUsage; set { {_totalUsage = value;} } }
    ...
    internal partial interface IUserPropertiesInternal :
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.IUserUpdatePropertiesInternal
    {
        /// <summary>Display name of the user, for example user's full name.</summary>
