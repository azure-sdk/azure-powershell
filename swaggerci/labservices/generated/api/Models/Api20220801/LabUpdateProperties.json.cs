...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801
{
    ...
    public partial class LabUpdateProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.ILabUpdateProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.ILabUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.ILabUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonNode node)
        {
        ...
        internal LabUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject json)
        {
            ...
            {_autoShutdownProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("autoShutdownProfile"), out var __jsonAutoShutdownProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.AutoShutdownProfile.FromJson(__jsonAutoShutdownProfile) : AutoShutdownProfile;}
            {_connectionProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("connectionProfile"), out var __jsonConnectionProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.ConnectionProfile.FromJson(__jsonConnectionProfile) : ConnectionProfile;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.SecurityProfile.FromJson(__jsonSecurityProfile) : SecurityProfile;}
            {_rosterProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("rosterProfile"), out var __jsonRosterProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.RosterProfile.FromJson(__jsonRosterProfile) : RosterProfile;}
            ...
            {_virtualMachineProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.LabServices.Runtime.Json.JsonObject>("virtualMachineProfile"), out var __jsonVirtualMachineProfile) ? Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20220801.VirtualMachineProfile.FromJson(__jsonVirtualMachineProfile) : VirtualMachineProfile;}
            AfterFromJson(json);
        }
