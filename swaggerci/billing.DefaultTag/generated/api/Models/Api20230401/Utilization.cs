...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401
{
    ...
    public partial class Utilization :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IUtilization,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IUtilizationInternal
    {

        /// <summary>Backing field for <see cref="Aggregate" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IUtilizationAggregates[] _aggregate;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IUtilizationAggregates[] Aggregate { get => this._aggregate; set => this._aggregate = value; }

        /// <summary>Internal Acessors for Trend</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IUtilizationInternal.Trend { get => this._trend; set { {_trend = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IUtilizationAggregates[] Aggregate { get; set; }
        /// <summary>The trend for a savings plan's utilization</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Info(
        Required = false,
        ReadOnly = true,
