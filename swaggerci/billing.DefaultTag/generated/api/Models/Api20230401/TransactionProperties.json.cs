...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401
{
    ...
    public partial class TransactionProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.ITransactionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.ITransactionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.ITransactionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        internal TransactionProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_azureCreditApplied = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("azureCreditApplied"), out var __jsonAzureCreditApplied) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonAzureCreditApplied) : AzureCreditApplied;}
            {_effectivePrice = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("effectivePrice"), out var __jsonEffectivePrice) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonEffectivePrice) : EffectivePrice;}
            {_marketPrice = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("marketPrice"), out var __jsonMarketPrice) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonMarketPrice) : MarketPrice;}
            ...
            {_tax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("tax"), out var __jsonTax) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonTax) : Tax;}
            {_transactionAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("transactionAmount"), out var __jsonTransactionAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.Amount.FromJson(__jsonTransactionAmount) : TransactionAmount;}
