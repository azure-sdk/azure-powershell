...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class BillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject into a new instance of <see cref="BillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal BillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IBillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IBillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IBillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json ? new BillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders" /> into a
        ...
        /// <returns>
        /// a serialized instance of <see cref="BillingRoleAssignmentsResolveByInvoiceSectionAcceptedResponseHeaders" /> as a <see
