...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class ReservationProperty
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IReservationProperty.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IReservationProperty.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IReservationProperty FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        internal ReservationProperty(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_extendedStatusInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("extendedStatusInfo"), out var __jsonExtendedStatusInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ReservationExtendedStatusInfo.FromJson(__jsonExtendedStatusInfo) : ExtendedStatusInfo;}
            {_splitProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("splitProperties"), out var __jsonSplitProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ReservationSplitProperties.FromJson(__jsonSplitProperties) : SplitProperty;}
            {_mergeProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("mergeProperties"), out var __jsonMergeProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ReservationMergeProperties.FromJson(__jsonMergeProperties) : MergeProperty;}
            {_swapProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("swapProperties"), out var __jsonSwapProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ReservationSwapProperties.FromJson(__jsonSwapProperties) : SwapProperty;}
            {_appliedScopeProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("appliedScopeProperties"), out var __jsonAppliedScopeProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ReservationAppliedScopeProperties.FromJson(__jsonAppliedScopeProperties) : AppliedScopeProperty;}
            {_utilization = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("utilization"), out var __jsonUtilization) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ReservationPropertyUtilization.FromJson(__jsonUtilization) : Utilization;}
            ...
            {_instanceFlexibility = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("instanceFlexibility"), out var __jsonInstanceFlexibility) ? (string)__jsonInstanceFlexibility : (string)InstanceFlexibility;}
            ...
            {_archived = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonBoolean>("archived"), out var __jsonArchived) ? (bool?)__jsonArchived : Archived;}
            {_capability = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("capabilities"), out var __jsonCapabilities) ? (string)__jsonCapabilities : (string)Capability;}
            ...
            {_effectiveDateTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("effectiveDateTime"), out var __jsonEffectiveDateTime) ? global::System.DateTime.TryParse((string)__jsonEffectiveDateTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonEffectiveDateTimeValue) ? __jsonEffectiveDateTimeValue : EffectiveDateTime : EffectiveDateTime;}
            ...
            {_lastUpdatedDateTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("lastUpdatedDateTime"), out var __jsonLastUpdatedDateTime) ? global::System.DateTime.TryParse((string)__jsonLastUpdatedDateTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastUpdatedDateTimeValue) ? __jsonLastUpdatedDateTimeValue : LastUpdatedDateTime : LastUpdatedDateTime;}
            ...
            {_billingPlan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("billingPlan"), out var __jsonBillingPlan) ? (string)__jsonBillingPlan : (string)BillingPlan;}
            ...
            {_purchaseDateTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("purchaseDateTime"), out var __jsonPurchaseDateTime) ? global::System.DateTime.TryParse((string)__jsonPurchaseDateTime, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonPurchaseDateTimeValue) ? __jsonPurchaseDateTimeValue : PurchaseDateTime : PurchaseDateTime;}
            {_billingScopeId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("billingScopeId"), out var __jsonBillingScopeId) ? (string)__jsonBillingScopeId : (string)BillingScopeId;}
            ...
            {_renewDestination = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("renewDestination"), out var __jsonRenewDestination) ? (string)__jsonRenewDestination : (string)RenewDestination;}
            ...
            {_productCode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("productCode"), out var __jsonProductCode) ? (string)__jsonProductCode : (string)ProductCode;}
            {_renewProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("renewProperties"), out var __jsonRenewProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.RenewPropertiesResponse.FromJson(__jsonRenewProperties) : RenewProperty;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._splitProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._splitProperty.ToJson(null,serializationMode) : null, "splitProperties" ,container.Add );
            AddIf( null != this._mergeProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._mergeProperty.ToJson(null,serializationMode) : null, "mergeProperties" ,container.Add );
            AddIf( null != this._swapProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._swapProperty.ToJson(null,serializationMode) : null, "swapProperties" ,container.Add );
            AddIf( null != this._appliedScopeProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._appliedScopeProperty.ToJson(null,serializationMode) : null, "appliedScopeProperties" ,container.Add );
            ...
            AddIf( null != (((object)this._instanceFlexibility)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._instanceFlexibility.ToString()) : null, "instanceFlexibility" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != this._archived ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonBoolean((bool)this._archived) : null, "archived" ,container.Add );
            AddIf( null != (((object)this._capability)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._capability.ToString()) : null, "capabilities" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._effectiveDateTime ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._effectiveDateTime?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "effectiveDateTime" ,container.Add );
            }
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._lastUpdatedDateTime ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._lastUpdatedDateTime?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "lastUpdatedDateTime" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != this._purchaseDate ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._purchaseDate?.ToString(@"yyyy-MM-dd",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "purchaseDate" ,container.Add );
            AddIf( null != this._purchaseDateTime ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._purchaseDateTime?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "purchaseDateTime" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._billingScopeId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._billingScopeId.ToString()) : null, "billingScopeId" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != (((object)this._renewDestination)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._renewDestination.ToString()) : null, "renewDestination" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            AddIf( null != this._renewProperty ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._renewProperty.ToJson(null,serializationMode) : null, "renewProperties" ,container.Add );
