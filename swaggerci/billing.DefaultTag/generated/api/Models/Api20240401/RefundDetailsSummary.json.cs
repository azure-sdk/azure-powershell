...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class RefundDetailsSummary
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummary.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummary.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummary FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        internal RefundDetailsSummary(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_completedOn = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("completedOn"), out var __jsonCompletedOn) ? global::System.DateTime.TryParse((string)__jsonCompletedOn, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonCompletedOnValue) ? __jsonCompletedOnValue : CompletedOn : CompletedOn;}
            {_rebillInvoiceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("rebillInvoiceId"), out var __jsonRebillInvoiceId) ? (string)__jsonRebillInvoiceId : (string)RebillInvoiceId;}
            {_transactionCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNumber>("transactionCount"), out var __jsonTransactionCount) ? (int?)__jsonTransactionCount : TransactionCount;}
            {_refundStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("refundStatus"), out var __jsonRefundStatus) ? (string)__jsonRefundStatus : (string)RefundStatus;}
            ...
            {_refundReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("refundReason"), out var __jsonRefundReason) ? (string)__jsonRefundReason : (string)RefundReason;}
            AfterFromJson(json);
        }
