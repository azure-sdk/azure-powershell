...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class RenewalTermDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal.BillingFrequency { get => this._billingFrequency; set { {_billingFrequency = value;} } }

        /// <summary>Internal Acessors for ProductId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal.ProductId { get => this._productId; set { {_productId = value;} } }

        /// <summary>Internal Acessors for ProductTypeId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal.ProductTypeId { get => this._productTypeId; set { {_productTypeId = value;} } }

        /// <summary>Internal Acessors for SkuId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal.SkuId { get => this._skuId; set { {_skuId = value;} } }

        /// <summary>Internal Acessors for TermDuration</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal.TermDuration { get => this._termDuration; set { {_termDuration = value;} } }

        /// <summary>Internal Acessors for TermEndDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRenewalTermDetailsInternal.TermEndDate { get => this._termEndDate; set { {_termEndDate = value;} } }
