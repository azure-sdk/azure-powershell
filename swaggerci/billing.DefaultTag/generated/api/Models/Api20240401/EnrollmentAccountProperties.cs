...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class EnrollmentAccountProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.AccountOwner { get => this._accountOwner; set { {_accountOwner = value;} } }

        /// <summary>Internal Acessors for AuthType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.AuthType { get => this._authType; set { {_authType = value;} } }

        /// <summary>Internal Acessors for DepartmentDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.DepartmentDisplayName { get => this._departmentDisplayName; set { {_departmentDisplayName = value;} } }

        /// <summary>Internal Acessors for DepartmentId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.DepartmentId { get => this._departmentId; set { {_departmentId = value;} } }

        /// <summary>Internal Acessors for EndDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.EndDate { get => this._endDate; set { {_endDate = value;} } }

        /// <summary>Internal Acessors for StartDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.StartDate { get => this._startDate; set { {_startDate = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IEnrollmentAccountPropertiesInternal.Status { get => this._status; set { {_status = value;} } }
