...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IAmount Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.AmountRefunded { get => (this._amountRefunded = this._amountRefunded ?? new Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount()); set { {_amountRefunded = value;} } }
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.ApprovedOn { get => this._approvedOn; set { {_approvedOn = value;} } }

        /// <summary>Internal Acessors for CompletedOn</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.CompletedOn { get => this._completedOn; set { {_completedOn = value;} } }

        /// <summary>Internal Acessors for RebillInvoiceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.RebillInvoiceId { get => this._rebillInvoiceId; set { {_rebillInvoiceId = value;} } }

        /// <summary>Internal Acessors for RefundOperationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.RefundOperationId { get => this._refundOperationId; set { {_refundOperationId = value;} } }

        /// <summary>Internal Acessors for RefundReason</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundReasonCode? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.RefundReason { get => this._refundReason; set { {_refundReason = value;} } }

        /// <summary>Internal Acessors for RefundStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundStatus? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.RefundStatus { get => this._refundStatus; set { {_refundStatus = value;} } }

        /// <summary>Internal Acessors for RequestedOn</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.RequestedOn { get => this._requestedOn; set { {_requestedOn = value;} } }

        /// <summary>Internal Acessors for TransactionCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IRefundDetailsSummaryInternal.TransactionCount { get => this._transactionCount; set { {_transactionCount = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundReasonCode? _refundReason;

        /// <summary>The reason for refund.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Origin(Microsoft.Azure.PowerShell.Cmdlets.Billing.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundReasonCode? RefundReason { get => this._refundReason; }

        /// <summary>Backing field for <see cref="RefundStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundStatus? _refundStatus;

        /// <summary>The status of refund request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Origin(Microsoft.Azure.PowerShell.Cmdlets.Billing.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundStatus? RefundStatus { get => this._refundStatus; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundReasonCode? RefundReason { get;  }
        /// <summary>The status of refund request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundStatus? RefundStatus { get;  }
        /// <summary>Date when the refund was requested.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The reason for refund.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundReasonCode? RefundReason { get; set; }
        /// <summary>The status of refund request.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.RefundStatus? RefundStatus { get; set; }
        /// <summary>Date when the refund was requested.</summary>
