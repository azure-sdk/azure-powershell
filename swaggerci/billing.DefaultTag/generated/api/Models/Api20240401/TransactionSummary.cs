...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class TransactionSummary :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummary,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal
    {
        ...
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal.AzureCreditApplied { get => this._azureCreditApplied; set { {_azureCreditApplied = value;} } }

        /// <summary>Internal Acessors for BillingCurrency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal.BillingCurrency { get => this._billingCurrency; set { {_billingCurrency = value;} } }

        /// <summary>Internal Acessors for ConsumptionCommitmentDecremented</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal.ConsumptionCommitmentDecremented { get => this._consumptionCommitmentDecremented; set { {_consumptionCommitmentDecremented = value;} } }

        /// <summary>Internal Acessors for SubTotal</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal.SubTotal { get => this._subTotal; set { {_subTotal = value;} } }

        /// <summary>Internal Acessors for Tax</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal.Tax { get => this._tax; set { {_tax = value;} } }

        /// <summary>Internal Acessors for Total</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITransactionSummaryInternal.Total { get => this._total; set { {_total = value;} } }
