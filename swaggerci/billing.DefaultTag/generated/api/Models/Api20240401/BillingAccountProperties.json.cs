...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class BillingAccountProperties
    {
        ...
        internal BillingAccountProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_enrollmentDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("enrollmentDetails"), out var __jsonEnrollmentDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.EnrollmentDetails.FromJson(__jsonEnrollmentDetails) : EnrollmentDetail;}
            {_soldTo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("soldTo"), out var __jsonSoldTo) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.AddressDetails.FromJson(__jsonSoldTo) : SoldTo;}
            {_registrationNumber = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("registrationNumber"), out var __jsonRegistrationNumber) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.RegistrationNumber.FromJson(__jsonRegistrationNumber) : RegistrationNumber;}
            ...
            {_hasNoBillingProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonBoolean>("hasNoBillingProfiles"), out var __jsonHasNoBillingProfiles) ? (bool?)__jsonHasNoBillingProfiles : HasNoBillingProfile;}
            ...
            {_billingRelationshipType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("billingRelationshipTypes"), out var __jsonBillingRelationshipTypes) ? If( __jsonBillingRelationshipTypes as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.BillingRelationshipType[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.BillingRelationshipType) (__u is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString __t ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.BillingRelationshipType)(__t.ToString()) : ((Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.BillingRelationshipType)""))) ))() : null : BillingRelationshipType;}
            {_qualification = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("qualifications"), out var __jsonQualifications) ? If( __jsonQualifications as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : Qualification;}
            {_taxId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("taxIds"), out var __jsonTaxIds) ? If( __jsonTaxIds as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITaxIdentifier[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ITaxIdentifier) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.TaxIdentifier.FromJson(__k) )) ))() : null : TaxId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingAccountProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingAccountProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingAccountProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
