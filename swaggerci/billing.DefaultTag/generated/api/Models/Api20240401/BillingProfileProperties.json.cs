...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class BillingProfileProperties
    {
        ...
        internal BillingProfileProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_billTo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("billTo"), out var __jsonBillTo) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.AddressDetails.FromJson(__jsonBillTo) : BillTo;}
            {_indirectRelationshipInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("indirectRelationshipInfo"), out var __jsonIndirectRelationshipInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IndirectRelationshipInfo.FromJson(__jsonIndirectRelationshipInfo) : IndirectRelationshipInfo;}
            {_shipTo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("shipTo"), out var __jsonShipTo) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.AddressDetails.FromJson(__jsonShipTo) : ShipTo;}
            ...
            {_currentPaymentTerm = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("currentPaymentTerm"), out var __jsonCurrentPaymentTerm) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.PaymentTerm.FromJson(__jsonCurrentPaymentTerm) : CurrentPaymentTerm;}
            ...
            {_enabledAzurePlan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("enabledAzurePlans"), out var __jsonEnabledAzurePlans) ? If( __jsonEnabledAzurePlans as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IAzurePlan[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IAzurePlan) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.AzurePlan.FromJson(__u) )) ))() : null : EnabledAzurePlan;}
            ...
            {_spendingLimitDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("spendingLimitDetails"), out var __jsonSpendingLimitDetails) ? If( __jsonSpendingLimitDetails as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ISpendingLimitDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.ISpendingLimitDetails) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.SpendingLimitDetails.FromJson(__k) )) ))() : null : SpendingLimitDetail;}
            ...
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.BillingProfilePropertiesTags.FromJson(__jsonTags) : Tag;}
            {_targetCloud = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("targetClouds"), out var __jsonTargetClouds) ? If( __jsonTargetClouds as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(string) (__f is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString __e ? (string)(__e.ToString()) : null)) ))() : null : TargetCloud;}
            {_otherPaymentTerm = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("otherPaymentTerms"), out var __jsonOtherPaymentTerms) ? If( __jsonOtherPaymentTerms as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IPaymentTerm[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IPaymentTerm) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.PaymentTerm.FromJson(__a) )) ))() : null : OtherPaymentTerm;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingProfileProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingProfileProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingProfileProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
