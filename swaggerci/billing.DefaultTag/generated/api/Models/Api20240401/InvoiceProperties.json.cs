...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class InvoiceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IInvoiceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IInvoiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IInvoiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        internal InvoiceProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_amountDue = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("amountDue"), out var __jsonAmountDue) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonAmountDue) : AmountDue;}
            {_azurePrepaymentApplied = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("azurePrepaymentApplied"), out var __jsonAzurePrepaymentApplied) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonAzurePrepaymentApplied) : AzurePrepaymentApplied;}
            {_billedAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("billedAmount"), out var __jsonBilledAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonBilledAmount) : BilledAmount;}
            {_creditAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("creditAmount"), out var __jsonCreditAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonCreditAmount) : CreditAmount;}
            {_freeAzureCreditApplied = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("freeAzureCreditApplied"), out var __jsonFreeAzureCreditApplied) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonFreeAzureCreditApplied) : FreeAzureCreditApplied;}
            {_rebillDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("rebillDetails"), out var __jsonRebillDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.RebillDetails.FromJson(__jsonRebillDetails) : RebillDetail;}
            {_subTotal = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("subTotal"), out var __jsonSubTotal) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonSubTotal) : SubTotal;}
            {_taxAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("taxAmount"), out var __jsonTaxAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonTaxAmount) : TaxAmount;}
            {_totalAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("totalAmount"), out var __jsonTotalAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonTotalAmount) : TotalAmount;}
            {_refundDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("refundDetails"), out var __jsonRefundDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.RefundDetailsSummary.FromJson(__jsonRefundDetails) : RefundDetail;}
            ...
            {_document = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("documents"), out var __jsonDocuments) ? If( __jsonDocuments as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IInvoiceDocument[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IInvoiceDocument) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.InvoiceDocument.FromJson(__u) )) ))() : null : Document;}
            ...
            {_failedPayment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("failedPayments"), out var __jsonFailedPayments) ? If( __jsonFailedPayments as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IFailedPayment[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IFailedPayment) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.FailedPayment.FromJson(__p) )) ))() : null : FailedPayment;}
            ...
            {_payment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("payments"), out var __jsonPayments) ? If( __jsonPayments as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IPayment[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IPayment) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Payment.FromJson(__k) )) ))() : null : Payment;}
            ...
            {_specialTaxationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("specialTaxationType"), out var __jsonSpecialTaxationType) ? (string)__jsonSpecialTaxationType : (string)SpecialTaxationType;}
            AfterFromJson(json);
        }
