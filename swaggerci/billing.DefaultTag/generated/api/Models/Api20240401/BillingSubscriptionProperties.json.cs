...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401
{
    ...
    public partial class BillingSubscriptionProperties
    {
        ...
        internal BillingSubscriptionProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_beneficiary = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("beneficiary"), out var __jsonBeneficiary) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Beneficiary.FromJson(__jsonBeneficiary) : Beneficiary;}
            {_enrollmentAccountSubscriptionDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("enrollmentAccountSubscriptionDetails"), out var __jsonEnrollmentAccountSubscriptionDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.EnrollmentAccountSubscriptionDetails.FromJson(__jsonEnrollmentAccountSubscriptionDetails) : EnrollmentAccountSubscriptionDetail;}
            {_lastMonthCharge = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("lastMonthCharges"), out var __jsonLastMonthCharges) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonLastMonthCharges) : LastMonthCharge;}
            {_monthToDateCharge = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("monthToDateCharges"), out var __jsonMonthToDateCharges) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.Amount.FromJson(__jsonMonthToDateCharges) : MonthToDateCharge;}
            {_nextBillingCycleDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("nextBillingCycleDetails"), out var __jsonNextBillingCycleDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.NextBillingCycleDetails.FromJson(__jsonNextBillingCycleDetails) : NextBillingCycleDetail;}
            ...
            {_renewalTermDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("renewalTermDetails"), out var __jsonRenewalTermDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.RenewalTermDetails.FromJson(__jsonRenewalTermDetails) : RenewalTermDetail;}
            {_systemOverride = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("systemOverrides"), out var __jsonSystemOverrides) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.SystemOverrides.FromJson(__jsonSystemOverrides) : SystemOverride;}
            ...
            {_beneficiaryTenantId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("beneficiaryTenantId"), out var __jsonBeneficiaryTenantId) ? (string)__jsonBeneficiaryTenantId : (string)BeneficiaryTenantId;}
            ...
            {_billingPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("billingPolicies"), out var __jsonBillingPolicies) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.BillingSubscriptionPropertiesBillingPolicies.FromJson(__jsonBillingPolicies) : BillingPolicy;}
            ...
            {_resourceUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("resourceUri"), out var __jsonResourceUri) ? (string)__jsonResourceUri : (string)ResourceUri;}
            ...
            {_operationStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("operationStatus"), out var __jsonOperationStatus) ? (string)__jsonOperationStatus : (string)OperationStatus;}
            ...
            {_suspensionReasonDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray>("suspensionReasonDetails"), out var __jsonSuspensionReasonDetails) ? If( __jsonSuspensionReasonDetails as Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingSubscriptionStatusDetails[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingSubscriptionStatusDetails) (Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.BillingSubscriptionStatusDetails.FromJson(__p) )) ))() : null : SuspensionReasonDetail;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingSubscriptionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingSubscriptionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20240401.IBillingSubscriptionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
