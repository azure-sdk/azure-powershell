...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class InvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json ? new InvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject into a new instance of <see cref="InvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal InvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="InvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders" /> into
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvoicesDownloadDocumentsByBillingSubscriptionAcceptedResponseHeaders" /> as a <see
