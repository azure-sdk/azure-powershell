...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CommitmentGrain Hourly = @"Hourly";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CommitmentGrain e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CommitmentGrain e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CommitmentGrain e1, Microsoft.Azure.PowerShell.Cmdlets.Billing.Support.CommitmentGrain e2)
        {
            return !e2.Equals(e1);
        }
