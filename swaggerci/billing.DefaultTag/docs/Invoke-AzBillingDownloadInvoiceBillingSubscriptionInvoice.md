...
online version: https://learn.microsoft.com/powershell/module/az.billing/invoke-azbillingdownloadinvoicebillingsubscriptioninvoice
schema: 2.0.0
---

# Invoke-AzBillingDownloadInvoiceBillingSubscriptionInvoice
...
### Download (Default)
```
Invoke-AzBillingDownloadInvoiceBillingSubscriptionInvoice -InvoiceName <String> -DownloadToken <String>
...
### DownloadViaIdentity
```
Invoke-AzBillingDownloadInvoiceBillingSubscriptionInvoice -InputObject <IBillingIdentity>
 -DownloadToken <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
