...
### List1 (Default)
```
Get-AzBillingEnrollmentAccount -BillingAccountName <String> [-Count] [-Filter <String>] [-OrderBy <String>]
 [-Search <String>] [-Skip <Int64>] [-Top <Int64>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzBillingEnrollmentAccount -BillingAccountName <String> -DepartmentName <String> -Name <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get1
```
Get-AzBillingEnrollmentAccount -BillingAccountName <String> -Name <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### List
```
Get-AzBillingEnrollmentAccount -BillingAccountName <String> -DepartmentName <String> [-Count]
