...
.Link
https://learn.microsoft.com/powershell/module/az.billing/get-azbillingenrollmentaccount
#>
function Get-AzBillingEnrollmentAccount {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IEnrollmentAccountAutoGenerated])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            Get1 = 'Az.Billing.private\Get-AzBillingEnrollmentAccount_Get1';
            GetViaIdentity = 'Az.Billing.private\Get-AzBillingEnrollmentAccount_GetViaIdentity';
            GetViaIdentity1 = 'Az.Billing.private\Get-AzBillingEnrollmentAccount_GetViaIdentity1';
            List = 'Az.Billing.private\Get-AzBillingEnrollmentAccount_List';
            List1 = 'Az.Billing.private\Get-AzBillingEnrollmentAccount_List1';
        }
