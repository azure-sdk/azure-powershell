...
.Link
https://learn.microsoft.com/powershell/module/az.billing/get-azbillingdepartment
#>
function Get-AzBillingDepartment {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Api20230401.IDepartmentAutoGenerated])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Billing.private\Get-AzBillingDepartment_Get';
            GetViaIdentity = 'Az.Billing.private\Get-AzBillingDepartment_GetViaIdentity';
            List = 'Az.Billing.private\Get-AzBillingDepartment_List';
        }
