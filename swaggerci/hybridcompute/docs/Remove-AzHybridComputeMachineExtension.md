...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcompute/remove-azhybridcomputemachineextension
schema: 2.0.0
---

# Remove-AzHybridComputeMachineExtension
...
### Delete (Default)
```
Remove-AzHybridComputeMachineExtension -ExtensionName <String> -MachineName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridComputeMachineExtension -InputObject <IHybridComputeIdentity> [-DefaultProfile <PSObject>]
