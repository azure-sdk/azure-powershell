...
New-AzHybridComputeMachine -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-ClientPublicKey <String>] [-ExtensionServiceStartupType <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachine
