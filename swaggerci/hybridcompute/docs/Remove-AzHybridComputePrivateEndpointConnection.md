...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcompute/remove-azhybridcomputeprivateendpointconnection
schema: 2.0.0
---

# Remove-AzHybridComputePrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzHybridComputePrivateEndpointConnection -Name <String> -ResourceGroupName <String> -ScopeName <String>
...
### DeleteViaIdentity
```
Remove-AzHybridComputePrivateEndpointConnection -InputObject <IHybridComputeIdentity>
