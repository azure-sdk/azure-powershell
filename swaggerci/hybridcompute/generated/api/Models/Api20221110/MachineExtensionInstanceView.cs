...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110
{
    ...
    public partial class MachineExtensionInstanceView :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewInternal
    {

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatus Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewInternal.Status { get => (this._status = this._status ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.MachineExtensionInstanceViewStatus()); set { {_status = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatus _status;

        /// <summary>Instance view status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatus Status { get => (this._status = this._status ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.MachineExtensionInstanceViewStatus()); set => this._status = value; }
        ...
        public string StatusCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatusInternal)Status).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatusInternal)Status).Code = value ?? null; }

        /// <summary>The short localizable label for the status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.PropertyOrigin.Inlined)]
        public string StatusDisplayStatus { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatusInternal)Status).DisplayStatus; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatusInternal)Status).DisplayStatus = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.PropertyOrigin.Inlined)]
        public string StatusMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatusInternal)Status).Message; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatusInternal)Status).Message = value ?? null; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Instance view status.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221110.IMachineExtensionInstanceViewStatus Status { get; set; }
        /// <summary>The status code.</summary>
        string StatusCode { get; set; }
        /// <summary>The short localizable label for the status.</summary>
        string StatusDisplayStatus { get; set; }
