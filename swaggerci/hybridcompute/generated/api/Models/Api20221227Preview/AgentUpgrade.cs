...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview
{
    ...
    public partial class AgentUpgrade :
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IAgentUpgrade,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IAgentUpgradeInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.LastAttemptStatusEnum? _lastAttemptStatus;

        /// <summary>Specifies the status of Agent Upgrade.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.LastAttemptStatusEnum? LastAttemptStatus { get => this._lastAttemptStatus; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IAgentUpgradeInternal.LastAttemptMessage { get => this._lastAttemptMessage; set { {_lastAttemptMessage = value;} } }

        /// <summary>Internal Acessors for LastAttemptStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.LastAttemptStatusEnum? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IAgentUpgradeInternal.LastAttemptStatus { get => this._lastAttemptStatus; set { {_lastAttemptStatus = value;} } }

        /// <summary>Internal Acessors for LastAttemptTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IAgentUpgradeInternal.LastAttemptTimestamp { get => this._lastAttemptTimestamp; set { {_lastAttemptTimestamp = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.LastAttemptStatusEnum? LastAttemptStatus { get;  }
        /// <summary>Timestamp of last upgrade attempt</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>Specifies the status of Agent Upgrade.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.LastAttemptStatusEnum? LastAttemptStatus { get; set; }
        /// <summary>Timestamp of last upgrade attempt</summary>
