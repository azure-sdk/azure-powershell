...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview
{
    ...
    public partial class HybridComputePrivateLinkScopeProperties :
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IHybridComputePrivateLinkScopeProperties,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IHybridComputePrivateLinkScopePropertiesInternal
    {

        /// <summary>Internal Acessors for PrivateEndpointConnection</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IPrivateEndpointConnectionDataModel[] Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IHybridComputePrivateLinkScopePropertiesInternal.PrivateEndpointConnection { get => this._privateEndpointConnection; set { {_privateEndpointConnection = value;} } }

        /// <summary>Internal Acessors for PrivateLinkScopeId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IHybridComputePrivateLinkScopePropertiesInternal.PrivateLinkScopeId { get => this._privateLinkScopeId; set { {_privateLinkScopeId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IHybridComputePrivateLinkScopePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="PrivateEndpointConnection" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IPrivateEndpointConnectionDataModel[] _privateEndpointConnection;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IPrivateEndpointConnectionDataModel[] PrivateEndpointConnection { get => this._privateEndpointConnection; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IPrivateEndpointConnectionDataModel) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IPrivateEndpointConnectionDataModel[] PrivateEndpointConnection { get;  }
        /// <summary>The Guid id of the private link scope.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>The collection of associated Private Endpoint Connections.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227Preview.IPrivateEndpointConnectionDataModel[] PrivateEndpointConnection { get; set; }
        /// <summary>The Guid id of the private link scope.</summary>
