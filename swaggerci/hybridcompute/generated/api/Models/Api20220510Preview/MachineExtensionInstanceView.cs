...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview
{
    ...
    public partial class MachineExtensionInstanceView :
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceView,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewInternal
    {

        /// <summary>Internal Acessors for Status</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewStatus Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewInternal.Status { get => (this._status = this._status ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.MachineExtensionInstanceViewStatus()); set { {_status = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewStatus _status;

        /// <summary>Instance view status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Origin(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewStatus Status { get => (this._status = this._status ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.MachineExtensionInstanceViewStatus()); set => this._status = value; }
        ...
        public string StatusCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewStatusInternal)Status).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewStatusInternal)Status).Code = value ?? null; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Instance view status.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20220510Preview.IMachineExtensionInstanceViewStatus Status { get; set; }
        /// <summary>The status code.</summary>
        string StatusCode { get; set; }
        /// <summary>The short localizable label for the status.</summary>
        string StatusDisplayStatus { get; set; }
