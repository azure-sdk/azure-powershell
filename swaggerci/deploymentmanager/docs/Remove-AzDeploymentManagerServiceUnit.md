...
### Delete (Default)
```
Remove-AzDeploymentManagerServiceUnit -Name <String> -ResourceGroupName <String> -ServiceName <String>
 -ServiceTopologyName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDeploymentManagerServiceUnit -InputObject <IDeploymentManagerIdentity> [-DefaultProfile <PSObject>]
