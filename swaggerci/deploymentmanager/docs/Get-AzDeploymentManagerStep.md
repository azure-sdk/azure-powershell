...
### List (Default)
```
Get-AzDeploymentManagerStep -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDeploymentManagerStep -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDeploymentManagerStep -InputObject <IDeploymentManagerIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
