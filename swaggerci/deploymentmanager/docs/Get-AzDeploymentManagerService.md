...
### List (Default)
```
Get-AzDeploymentManagerService -ResourceGroupName <String> -TopologyName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDeploymentManagerService -Name <String> -ResourceGroupName <String> -TopologyName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDeploymentManagerService -InputObject <IDeploymentManagerIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
