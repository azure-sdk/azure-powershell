...
### List (Default)
```
Get-AzDeploymentManagerArtifactSource -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDeploymentManagerArtifactSource -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDeploymentManagerArtifactSource -InputObject <IDeploymentManagerIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
