...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>Resource is deleting</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Resource is provisioning</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState Provisioning = @"Provisioning";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>Resource is updating</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.FabricServiceForTesting.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
