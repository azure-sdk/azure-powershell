...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricService.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.FabricService.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.FabricService.Support";
