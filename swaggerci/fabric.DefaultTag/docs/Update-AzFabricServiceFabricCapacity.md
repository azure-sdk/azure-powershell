...
online version: https://learn.microsoft.com/powershell/module/az.fabricservice/update-azfabricservicefabriccapacity
schema: 2.0.0
---

# Update-AzFabricServiceFabricCapacity
...
```
Update-AzFabricServiceFabricCapacity -CapacityName <String> -ResourceGroupName <String>
...
```
Update-AzFabricServiceFabricCapacity -InputObject <IFabricServiceIdentity> [-AdministrationMember <String[]>]
