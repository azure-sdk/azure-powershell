...
online version: https://learn.microsoft.com/powershell/module/az.fabricservice/resume-azfabricservicefabriccapacity
schema: 2.0.0
---

# Resume-AzFabricServiceFabricCapacity
...
### Resume (Default)
```
Resume-AzFabricServiceFabricCapacity -CapacityName <String> -ResourceGroupName <String>
...
### ResumeViaIdentity
```
Resume-AzFabricServiceFabricCapacity -InputObject <IFabricServiceIdentity> [-DefaultProfile <PSObject>]
