...
online version: https://learn.microsoft.com/powershell/module/az.fabricservicefortesting/resume-azfabricservicefortestingfabriccapacity
schema: 2.0.0
---
...
### Resume (Default)
```
Resume-AzFabricServiceForTestingFabricCapacity -CapacityName <String> -ResourceGroupName <String>
...
### ResumeViaIdentity
```
Resume-AzFabricServiceForTestingFabricCapacity -InputObject <IFabricServiceForTestingIdentity>
