...
online version: https://learn.microsoft.com/powershell/module/az.fabricservice/new-azfabricservicefabriccapacity
schema: 2.0.0
---
...
```
New-AzFabricServiceFabricCapacity -CapacityName <String> -ResourceGroupName <String> -Location <String>
 -SkuName <String> [-SubscriptionId <String>] [-AdministrationMember <String[]>] [-Tag <Hashtable>]
