...
online version: https://learn.microsoft.com/powershell/module/az.fabricservice/suspend-azfabricservicefabriccapacity
schema: 2.0.0
---

# Suspend-AzFabricServiceFabricCapacity
...
### Suspend (Default)
```
Suspend-AzFabricServiceFabricCapacity -CapacityName <String> -ResourceGroupName <String>
...
### SuspendViaIdentity
```
Suspend-AzFabricServiceFabricCapacity -InputObject <IFabricServiceIdentity> [-DefaultProfile <PSObject>]
