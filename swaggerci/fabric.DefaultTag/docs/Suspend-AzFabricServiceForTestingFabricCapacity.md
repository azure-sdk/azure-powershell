...
online version: https://learn.microsoft.com/powershell/module/az.fabricservicefortesting/suspend-azfabricservicefortestingfabriccapacity
schema: 2.0.0
---

# Suspend-AzFabricServiceForTestingFabricCapacity
...
### Suspend (Default)
```
Suspend-AzFabricServiceForTestingFabricCapacity -CapacityName <String> -ResourceGroupName <String>
...
### SuspendViaIdentity
```
Suspend-AzFabricServiceForTestingFabricCapacity -InputObject <IFabricServiceForTestingIdentity>
