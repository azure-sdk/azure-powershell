...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IAdminKeyResult])]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.INetworkSecurityPerimeterConfiguration])]
...
.Link
https://learn.microsoft.com/powershell/module/az.search/get-azsearchoffering
#>
function Get-AzSearchOffering {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IOfferingsByRegion])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter()]
    [Alias('AzureRMContext', 'AzureCredential')]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Search.private\Get-AzSearchOffering_List';
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
...
Microsoft.Azure.PowerShell.Cmdlets.Search.Models.ISearchIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IPrivateEndpointConnection
.Notes
COMPLEX PARAMETER PROPERTIES
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/get-azsearchprivateendpointconnection
#>
function Get-AzSearchPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IPrivateEndpointConnection])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
...
.Link
https://learn.microsoft.com/powershell/module/az.search/get-azsearchquerykey
#>
function Get-AzSearchQueryKey {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IQueryKey])]
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/get-azsearchsharedprivatelinkresource
#>
function Get-AzSearchSharedPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.ISharedPrivateLinkResource])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IQuotaUsageResult])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.Search.Category('Path')]
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/invoke-azsearchreconcilenetworksecurityperimeterconfiguration
#>
function Invoke-AzSearchReconcileNetworkSecurityPerimeterConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Reconcile = 'Az.Search.private\Invoke-AzSearchReconcileNetworkSecurityPerimeterConfiguration_Reconcile';
            ReconcileViaIdentity = 'Az.Search.private\Invoke-AzSearchReconcileNetworkSecurityPerimeterConfiguration_ReconcileViaIdentity';
        }
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/invoke-azsearchusage
#>
function Invoke-AzSearchUsage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IQuotaUsageResult])]
[CmdletBinding(DefaultParameterSetName='Usage', PositionalBinding=$false)]
param(
...
begin {
    try {
        ...
        $mapping = @{
            Usage = 'Az.Search.private\Invoke-AzSearchUsage_Usage';
            UsageViaIdentity = 'Az.Search.private\Invoke-AzSearchUsage_UsageViaIdentity';
        }
        if (('Usage') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
                $PSBoundParameters['SubscriptionId'] = . (Join-Path $PSScriptRoot '..' 'utils' 'Get-SubscriptionIdTestSafe.ps1')
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/new-azsearchadminkey
#>
...
Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.ISharedPrivateLinkResource
.Link
https://learn.microsoft.com/powershell/module/az.search/new-azsearchsharedprivatelinkresource
#>
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/remove-azsearchprivateendpointconnection
#>
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/remove-azsearchquerykey
#>
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/remove-azsearchservice
#>
...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal.
.Link
https://learn.microsoft.com/powershell/module/az.search/remove-azsearchsharedprivatelinkresource
#>
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.ICheckNameAvailabilityOutput])]
...
NETWORKRULESETIPRULE <IIPRule[]>: A list of IP restriction rules that defines the inbound network(s) with allowing access to the search service endpoint. At the meantime, all other public IP networks are blocked by the firewall. These restriction rules are applied only when the 'publicNetworkAccess' of the search service is 'enabled'; otherwise, traffic over public interface is not allowed even with any public IP rules, and private endpoint connections would be the exclusive access method.
  [Value <String>]: Value corresponding to a single IPv4 address (eg., 123.1.2.3) or an IP range in CIDR format (eg., 123.1.2.3/24) to be allowed.
.Link
https://learn.microsoft.com/powershell/module/az.search/update-azsearchservice
#>
...
param(
    ...
    [Parameter(ParameterSetName='UpdateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.Search.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.ISearchServiceUpdateTags]))]
    [System.Collections.Hashtable]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            Upgrade = 'Az.Search.private\Update-AzSearchService_Upgrade';
            UpgradeViaIdentity = 'Az.Search.private\Update-AzSearchService_UpgradeViaIdentity';
        }
