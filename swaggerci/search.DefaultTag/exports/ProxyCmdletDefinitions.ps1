...
INPUTOBJECT <ISearchIdentity>: Identity Parameter
  ...
  [NspConfigName <String>]: The network security perimeter configuration name.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api000000.INetworkSecurityPerimeterConfiguration])]
