...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models
{
    ...
    public partial class NetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.INetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.INetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Models.INetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject json ? new NetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject into a new instance of <see cref="NetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal NetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="NetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders" /> into
        /// a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="NetworkSecurityPerimeterConfigurationsReconcileAcceptedResponseHeaders" /> as a <see
