...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview
{
    ...
    public partial class QuotaUsageResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultName Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.QuotaUsageResultName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultName _name;

        /// <summary>The name of the SKU supported by Azure AI Search.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Origin(Microsoft.Azure.PowerShell.Cmdlets.Search.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.QuotaUsageResultName()); }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The SKU name supported by Azure AI Search.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Origin(Microsoft.Azure.PowerShell.Cmdlets.Search.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        int? Limit { get; set; }
        /// <summary>The name of the SKU supported by Azure AI Search.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240301Preview.IQuotaUsageResultName Name { get; set; }
        /// <summary>The localized string value for the SKU name.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The SKU name supported by Azure AI Search.</summary>
        string NameValue { get; set; }
