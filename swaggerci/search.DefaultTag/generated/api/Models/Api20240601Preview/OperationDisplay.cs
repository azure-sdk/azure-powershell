...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview
{
    ...
    public partial class OperationDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IOperationDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IOperationDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
