...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview
{
    ...
    public partial class SearchServiceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.ISearchServiceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.ISearchServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.ISearchServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode node)
        {
        ...
        internal SearchServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject json)
        {
            ...
            {_networkRuleSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("networkRuleSet"), out var __jsonNetworkRuleSet) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.NetworkRuleSet.FromJson(__jsonNetworkRuleSet) : NetworkRuleSet;}
            {_encryptionWithCmk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("encryptionWithCmk"), out var __jsonEncryptionWithCmk) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.EncryptionWithCmk.FromJson(__jsonEncryptionWithCmk) : EncryptionWithCmk;}
            {_authOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("authOptions"), out var __jsonAuthOptions) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.DataPlaneAuthOptions.FromJson(__jsonAuthOptions) : AuthOption;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IPrivateEndpointConnection[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.IPrivateEndpointConnection) (Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.PrivateEndpointConnection.FromJson(__p) )) ))() : null : PrivateEndpointConnection;}
            {_sharedPrivateLinkResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray>("sharedPrivateLinkResources"), out var __jsonSharedPrivateLinkResources) ? If( __jsonSharedPrivateLinkResources as Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.ISharedPrivateLinkResource[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.ISharedPrivateLinkResource) (Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20240601Preview.SharedPrivateLinkResource.FromJson(__k) )) ))() : null : SharedPrivateLinkResource;}
