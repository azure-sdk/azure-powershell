...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501
{
    ...
    public partial class IdentityTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Identity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.IIdentity ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.IIdentity).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
