...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501
{
    ...
    public partial class SearchServiceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.ISearchServiceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.ISearchServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.ISearchServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode node)
        {
        ...
        internal SearchServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject json)
        {
            ...
            {_networkRuleSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("networkRuleSet"), out var __jsonNetworkRuleSet) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.NetworkRuleSet.FromJson(__jsonNetworkRuleSet) : NetworkRuleSet;}
            {_encryptionWithCmk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("encryptionWithCmk"), out var __jsonEncryptionWithCmk) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.EncryptionWithCmk.FromJson(__jsonEncryptionWithCmk) : EncryptionWithCmk;}
            {_authOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("authOptions"), out var __jsonAuthOptions) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.DataPlaneAuthOptions.FromJson(__jsonAuthOptions) : AuthOption;}
            ...
            {_dataExfiltrationProtection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray>("dataExfiltrationProtections"), out var __jsonDataExfiltrationProtections) ? If( __jsonDataExfiltrationProtections as Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SearchDataExfiltrationProtection[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SearchDataExfiltrationProtection) (__u is Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonString __t ? (Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SearchDataExfiltrationProtection)(__t.ToString()) : ((Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SearchDataExfiltrationProtection)""))) ))() : null : DataExfiltrationProtection;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.IPrivateEndpointConnection[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.IPrivateEndpointConnection) (Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.PrivateEndpointConnection.FromJson(__p) )) ))() : null : PrivateEndpointConnection;}
            {_sharedPrivateLinkResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray>("sharedPrivateLinkResources"), out var __jsonSharedPrivateLinkResources) ? If( __jsonSharedPrivateLinkResources as Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.ISharedPrivateLinkResource[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.ISharedPrivateLinkResource) (Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.SharedPrivateLinkResource.FromJson(__k) )) ))() : null : SharedPrivateLinkResource;}
            ...
            {_upgradeAvailable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonString>("upgradeAvailable"), out var __jsonUpgradeAvailable) ? (string)__jsonUpgradeAvailable : (string)UpgradeAvailable;}
            {_serviceUpgradedAt = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonString>("serviceUpgradedAt"), out var __jsonServiceUpgradedAt) ? global::System.DateTime.TryParse((string)__jsonServiceUpgradedAt, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonServiceUpgradedAtValue) ? __jsonServiceUpgradedAtValue : ServiceUpgradedAt : ServiceUpgradedAt;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._dataExfiltrationProtection)
            {
                var __w = new Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.XNodeArray();
                foreach( var __x in this._dataExfiltrationProtection )
                {
                ...
                container.Add("dataExfiltrationProtections",__w);
            }
            ...
            AddIf( null != (((object)this._upgradeAvailable)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonString(this._upgradeAvailable.ToString()) : null, "upgradeAvailable" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._serviceUpgradedAt ? (Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonString(this._serviceUpgradedAt?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "serviceUpgradedAt" ,container.Add );
            }
