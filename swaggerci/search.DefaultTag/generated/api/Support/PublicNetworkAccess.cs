...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Support
{
    ...
    {
        /// <summary>
        /// The search service is not accessible from traffic originating from the public internet. Access is only permitted over
        ...
        /// <summary>
        /// The network security perimeter configuration rules allow or disallow public network access to the resource. Requires an
        /// associated network security perimeter.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.PublicNetworkAccess SecuredByPerimeter = @"securedByPerimeter";
