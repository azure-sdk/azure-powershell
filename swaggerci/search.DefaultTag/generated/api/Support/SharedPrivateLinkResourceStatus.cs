...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus e1, Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SharedPrivateLinkResourceStatus e2)
        {
            return !e2.Equals(e1);
        }
