...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Support
{
        ...
        System.IEquatable<SkuName>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName Basic = @"basic";

        /// <summary>
        /// Free tier, with no SLA guarantees and a subset of the features offered on billable tiers.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName Free = @"free";

        /// <summary>
        /// Billable tier for a dedicated service having up to 12 partitions and 12 replicas.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName Standard = @"standard";

        /// <summary>Similar to 'standard', but with more capacity per search unit.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName Standard2 = @"standard2";

        /// <summary>
        /// The largest Standard offering with up to 12 partitions and 12 replicas (or up to 3 partitions with more indexes if you
        /// also set the hostingMode property to 'highDensity').
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName Standard3 = @"standard3";

        /// <summary>
        /// Billable tier for a dedicated service that supports 1TB per partition, up to 12 partitions.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName StorageOptimizedL1 = @"storage_optimized_l1";

        /// <summary>
        /// Billable tier for a dedicated service that supports 2TB per partition, up to 12 partitions.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName StorageOptimizedL2 = @"storage_optimized_l2";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName e1, Microsoft.Azure.PowerShell.Cmdlets.Search.Support.SkuName e2)
        {
            return !e2.Equals(e1);
        }
