...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/networkSecurityPerimeterConfigurations/{nspConfigName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSearchNetworkSecurityPerimeterConfiguration_Get")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.INetworkSecurityPerimeterConfiguration))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.Description(@"Gets a network security perimeter configuration.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/networkSecurityPerimeterConfigurations/{nspConfigName}", ApiVersion = "2025-05-01")]
    public partial class GetAzSearchNetworkSecurityPerimeterConfiguration_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="NspConfigName" /> property.</summary>
        private string _nspConfigName;

        /// <summary>The network security configuration name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The network security configuration name.")]
        ...
        public string NspConfigName { get => this._nspConfigName; set => this._nspConfigName = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Azure AI Search service associated with the specified resource group.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.INetworkSecurityPerimeterConfiguration">Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.INetworkSecurityPerimeterConfiguration</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.INetworkSecurityPerimeterConfiguration> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzSearchNetworkSecurityPerimeterConfiguration_Get" /> cmdlet class.
        /// </summary>
        public GetAzSearchNetworkSecurityPerimeterConfiguration_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkSecurityPerimeterConfigurationsGet(ResourceGroupName, SearchServiceName, NspConfigName, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SearchServiceName=SearchServiceName,NspConfigName=NspConfigName,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SearchServiceName=SearchServiceName, NspConfigName=NspConfigName, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SearchServiceName=SearchServiceName, NspConfigName=NspConfigName, SubscriptionId=SubscriptionId })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.INetworkSecurityPerimeterConfiguration> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250501.INetworkSecurityPerimeterConfiguration
