...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Upgrade=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/upgrade"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzSearchService_UpgradeViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.Description(@"Upgrades the Azure AI Search service to the latest version available.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Search.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/upgrade", ApiVersion = "2025-02-01-preview")]
    public partial class UpdateAzSearchService_UpgradeViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of UpdateAzSearchService_UpgradeViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets.UpdateAzSearchService_UpgradeViaIdentity Clone()
        {
            var clone = new UpdateAzSearchService_UpgradeViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServicesUpgrade' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesUpgradeViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesUpgrade(InputObject.ResourceGroupName ?? null, InputObject.SearchServiceName ?? null, InputObject.SubscriptionId ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzSearchService_UpgradeViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzSearchService_UpgradeViaIdentity()
        {
