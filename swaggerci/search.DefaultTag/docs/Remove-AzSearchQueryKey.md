...
### Delete (Default)
```
Remove-AzSearchQueryKey -Key <String> -ResourceGroupName <String> -SearchServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzSearchQueryKey -InputObject <ISearchIdentity> [-ClientRequestId <String>]
