...
Update-AzSearchService -ResourceGroupName <String> -SearchServiceName <String> [-SubscriptionId <String>]
 ...
 [-DisabledDataExfiltrationOption <SearchDisabledDataExfiltrationOption[]>] [-DisableLocalAuth]
...
Update-AzSearchService -InputObject <ISearchIdentity> [-ClientRequestId <String>]
 ...
 [-ComputeType <ComputeType>] [-DisabledDataExfiltrationOption <SearchDisabledDataExfiltrationOption[]>]
 ...
 [-SemanticSearch <SearchSemanticSearch>] [-SkuName <SkuName>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IIPRule[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
