...
```
Get-AzSearchQueryKey -ResourceGroupName <String> -SearchServiceName <String> [-SubscriptionId <String[]>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20250201Preview.IQueryKey
