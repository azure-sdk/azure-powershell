@{
  GUID = '6dcf192f-8e5a-4e73-be6d-410cb5e5ea2e'
  ...
  FunctionsToExport = 'Get-AzSearchAdminKey', 'Get-AzSearchPrivateEndpointConnection', 'Get-AzSearchPrivateLinkResourceSupported', 'Get-AzSearchQueryKey', 'Get-AzSearchService', 'Get-AzSearchSharedPrivateLinkResource', 'Get-AzSearchUsage', 'Invoke-AzSearchUsage', 'New-AzSearchAdminKey', 'New-AzSearchService', 'New-AzSearchSharedPrivateLinkResource', 'Remove-AzSearchPrivateEndpointConnection', 'Remove-AzSearchQueryKey', 'Remove-AzSearchService', 'Remove-AzSearchSharedPrivateLinkResource', 'Test-AzSearchServiceNameAvailability', 'Update-AzSearchService', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
