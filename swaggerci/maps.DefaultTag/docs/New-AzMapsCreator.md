...
New-AzMapsCreator -AccountName <String> -Name <String> -ResourceGroupName <String> -Location <String>
 -StorageUnit <Int32> [-SubscriptionId <String>] [-ConsumedStorageUnitSizeInByte <Int32>] [-Tag <Hashtable>]
 [-TotalStorageUnitSizeInByte <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.ICreator
