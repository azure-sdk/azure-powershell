...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IAccountSasParameters
Parameter Sets: List
Aliases:
...
Picking `primaryKey` or `secondaryKey` will use the Map account Shared Keys, and using `managedIdentity` will use the auto-renewed private key to sign the SAS.
...
### Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IAccountSasParameters
