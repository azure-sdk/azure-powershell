...
New-AzMapsAccount -Name <String> -ResourceGroupName <String> -Location <String> -SkuName <Name>
 [-SubscriptionId <String>] [-CorCorsRule <ICorsRule[]>] [-CustomerManagedKeyEncryptionKeyUrl <String>]
 [-DisableLocalAuth] [-EncryptionInfrastructureEncryption <InfrastructureEncryption>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.ICorsRule[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.ILinkedResource[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IMapsAccount
