...
Update-AzMapsCreator -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ConsumedStorageUnitSizeInByte <Int32>] [-StorageUnit <Int32>] [-Tag <Hashtable>]
 [-TotalStorageUnitSizeInByte <Int32>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMapsCreator -InputObject <IMapsIdentity> [-ConsumedStorageUnitSizeInByte <Int32>]
 [-StorageUnit <Int32>] [-Tag <Hashtable>] [-TotalStorageUnitSizeInByte <Int32>] [-DefaultProfile <PSObject>]
