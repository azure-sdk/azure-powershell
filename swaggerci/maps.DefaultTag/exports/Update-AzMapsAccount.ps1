...
LOCATION <ILocationsItem[]>: List of data processing locations for the Maps Account. If no locations are set, Azure REST APIs will only enable features available in the Maps Account's location.Please refer to [Azure Maps Data Processing Locations](https://https://learn.microsoft.com/en-us/azure/azure-maps/) for features enabled on select locations.
  LocationName <String>: The locations name.
.Link
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Maps.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountUpdateParametersTags]))]
    [System.Collections.Hashtable]
