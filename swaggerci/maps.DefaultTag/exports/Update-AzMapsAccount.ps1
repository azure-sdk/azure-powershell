...
LOCATION <ILocationsItem[]>: List of enabled data processing locations for the Maps Account. If no locations are set, Azure REST APIs will only enable features available in the Maps Account's location.
