...
.Link
https://learn.microsoft.com/powershell/module/az.maps/remove-azmapsprivateendpointconnection
#>
function Remove-AzMapsPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Maps.private\Remove-AzMapsPrivateEndpointConnection_Delete';
            DeleteViaIdentity = 'Az.Maps.private\Remove-AzMapsPrivateEndpointConnection_DeleteViaIdentity';
        }
