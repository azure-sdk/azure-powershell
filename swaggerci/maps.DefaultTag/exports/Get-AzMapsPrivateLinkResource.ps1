...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.IPrivateLinkResource
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.maps/get-azmapsprivatelinkresource
#>
function Get-AzMapsPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.IPrivateLinkResource])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Maps.private\Get-AzMapsPrivateLinkResource_Get';
            GetViaIdentity = 'Az.Maps.private\Get-AzMapsPrivateLinkResource_GetViaIdentity';
            List = 'Az.Maps.private\Get-AzMapsPrivateLinkResource_List';
        }
