...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IOperationDetail
.Link
https://learn.microsoft.com/powershell/module/az.maps/get-azmapsmapsubscriptionoperation
#>
function Get-AzMapsMapSubscriptionOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IOperationDetail])]
