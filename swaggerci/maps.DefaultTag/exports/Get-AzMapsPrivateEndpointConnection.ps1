...
.Link
https://learn.microsoft.com/powershell/module/az.maps/get-azmapsprivateendpointconnection
#>
function Get-AzMapsPrivateEndpointConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Maps.private\Get-AzMapsPrivateEndpointConnection_Get';
            GetViaIdentity = 'Az.Maps.private\Get-AzMapsPrivateEndpointConnection_GetViaIdentity';
            List = 'Az.Maps.private\Get-AzMapsPrivateEndpointConnection_List';
        }
