...
PROPERTIESLOCATIONS <ILocationsItem[]>: List of data processing locations for the Maps Account. If no locations are set, Azure REST APIs will only enable features available in the Maps Account's location.Please refer to [Azure Maps Data Processing Locations](https://https://learn.microsoft.com/en-us/azure/azure-maps/) for features enabled on select locations.
