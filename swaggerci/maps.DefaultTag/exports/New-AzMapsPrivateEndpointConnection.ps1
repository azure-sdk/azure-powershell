...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.IPrivateEndpointConnection
.Link
https://learn.microsoft.com/powershell/module/az.maps/new-azmapsprivateendpointconnection
#>
function New-AzMapsPrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.IPrivateEndpointConnection])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Maps.Support.PrivateEndpointServiceConnectionStatus])]
    [Microsoft.Azure.PowerShell.Cmdlets.Maps.Category('Body')]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.Maps.private\New-AzMapsPrivateEndpointConnection_CreateExpanded';
        }
