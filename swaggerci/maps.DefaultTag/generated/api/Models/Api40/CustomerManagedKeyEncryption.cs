...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40
{
    ...
    public partial class CustomerManagedKeyEncryption :
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryption,
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionInternal
    {

        /// <summary>Backing field for <see cref="KeyEncryptionKeyIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentity _keyEncryptionKeyIdentity;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentity KeyEncryptionKeyIdentity { get => (this._keyEncryptionKeyIdentity = this._keyEncryptionKeyIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.CustomerManagedKeyEncryptionKeyIdentity()); set => this._keyEncryptionKeyIdentity = value; }
        ...
        public string KeyEncryptionKeyIdentityDelegatedIdentityClientId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).DelegatedIdentityClientId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).DelegatedIdentityClientId = value ?? null; }

        /// <summary>Values can be systemAssignedIdentity or userAssignedIdentity</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Origin(Microsoft.Azure.PowerShell.Cmdlets.Maps.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Support.IdentityType? KeyEncryptionKeyIdentityType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).IdentityType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).IdentityType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Support.IdentityType)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Maps.Origin(Microsoft.Azure.PowerShell.Cmdlets.Maps.PropertyOrigin.Inlined)]
        public string KeyEncryptionKeyIdentityUserAssignedIdentityResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).UserAssignedIdentityResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentityInternal)KeyEncryptionKeyIdentity).UserAssignedIdentityResourceId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentity Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionInternal.KeyEncryptionKeyIdentity { get => (this._keyEncryptionKeyIdentity = this._keyEncryptionKeyIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.CustomerManagedKeyEncryptionKeyIdentity()); set { {_keyEncryptionKeyIdentity = value;} } }
...

    {
        ...
        /// All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ICustomerManagedKeyEncryptionKeyIdentity KeyEncryptionKeyIdentity { get; set; }
        /// <summary>
        /// delegated identity to use for accessing key encryption key Url. Ex: /subscriptions/fa5fc227-a624-475e-b696-cdd604c735bc/resourceGroups/<resource
        /// group>/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId. Mutually exclusive with identityType systemAssignedIdentity
        /// and userAssignedIdentity - internal use only.
