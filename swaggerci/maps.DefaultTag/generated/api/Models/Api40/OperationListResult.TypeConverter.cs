...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40
{
    ...
    public partial class OperationListResultTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OperationListResult" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.IOperationListResult ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.IOperationListResult).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
