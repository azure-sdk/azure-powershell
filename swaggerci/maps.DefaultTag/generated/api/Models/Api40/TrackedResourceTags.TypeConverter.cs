...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40
{
    ...
    public partial class TrackedResourceTagsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="TrackedResourceTags" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ITrackedResourceTags ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.ITrackedResourceTags).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
