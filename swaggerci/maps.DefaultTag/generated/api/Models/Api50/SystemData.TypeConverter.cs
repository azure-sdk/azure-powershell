...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50
{
    ...
    public partial class SystemDataTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="SystemData" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.ISystemData ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.ISystemData).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
