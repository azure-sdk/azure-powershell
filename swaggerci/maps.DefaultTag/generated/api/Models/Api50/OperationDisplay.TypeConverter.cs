...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50
{
    ...
    public partial class OperationDisplayTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OperationDisplay" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.IOperationDisplay ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.IOperationDisplay).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
