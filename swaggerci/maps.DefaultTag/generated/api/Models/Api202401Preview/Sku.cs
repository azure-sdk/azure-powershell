...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview
{
    ...
    public partial class Sku :
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.ISku,
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.ISkuInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.ISkuInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Tier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.ISkuInternal.Tier { get => this._tier; set { {_tier = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private string _name= @"G2";
