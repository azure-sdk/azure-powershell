...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview
{
    ...
    public partial class MetricSpecification
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IMetricSpecification.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IMetricSpecification.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IMetricSpecification FromJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode node)
        {
        ...
        internal MetricSpecification(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json)
        {
            ...
            {_dimension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonArray>("dimensions"), out var __jsonDimensions) ? If( __jsonDimensions as Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IDimension[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IDimension) (Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.Dimension.FromJson(__u) )) ))() : null : Dimension;}
            ...
            {_lockAggregationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("lockAggregationType"), out var __jsonLockAggregationType) ? (string)__jsonLockAggregationType : (string)LockAggregationType;}
            ...
            {_supportedAggregationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString>("supportedAggregationTypes"), out var __jsonSupportedAggregationTypes) ? (string)__jsonSupportedAggregationTypes : (string)SupportedAggregationType;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._lockAggregationType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString(this._lockAggregationType.ToString()) : null, "lockAggregationType" ,container.Add );
            ...
            AddIf( null != (((object)this._supportedAggregationType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonString(this._supportedAggregationType.ToString()) : null, "supportedAggregationTypes" ,container.Add );
