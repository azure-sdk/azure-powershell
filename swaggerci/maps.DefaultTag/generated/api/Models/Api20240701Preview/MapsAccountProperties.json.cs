...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview
{
    ...
    public partial class MapsAccountProperties
    {
        ...
        internal MapsAccountProperties(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.Encryption.FromJson(__jsonEncryption) : Encryption;}
