...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview
{
    ...
    public partial class MapsAccountProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IMapsAccountProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IMapsAccountProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.IMapsAccountProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode node)
        {
        ...
        internal MapsAccountProperties(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json)
        {
            ...
            {_cor = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject>("cors"), out var __jsonCors) ? Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.CorsRules.FromJson(__jsonCors) : Cor;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api50.Encryption.FromJson(__jsonEncryption) : Encryption;}
            ...
            {_linkedResource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonArray>("linkedResources"), out var __jsonLinkedResources) ? If( __jsonLinkedResources as Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.ILinkedResource[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.ILinkedResource) (Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.LinkedResource.FromJson(__u) )) ))() : null : LinkedResource;}
            {_location = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonArray>("locations"), out var __jsonLocations) ? If( __jsonLocations as Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.ILocationsItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.ILocationsItem) (Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20240701Preview.LocationsItem.FromJson(__p) )) ))() : null : Location;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._cor ? (Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode) this._cor.ToJson(null,serializationMode) : null, "cors" ,container.Add );
            AddIf( null != this._encryption ? (Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode) this._encryption.ToJson(null,serializationMode) : null, "encryption" ,container.Add );
            ...
            if (null != this._linkedResource)
            {
                var __w = new Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.XNodeArray();
                foreach( var __x in this._linkedResource )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("linkedResources",__w);
            }
