...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview
{
    ...
    public partial class CreatorProperties
    {
        ...
        internal CreatorProperties(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject json)
        {
            ...
            {_totalStorageUnitSizeInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNumber>("totalStorageUnitSizeInBytes"), out var __jsonTotalStorageUnitSizeInBytes) ? (int?)__jsonTotalStorageUnitSizeInBytes : TotalStorageUnitSizeInByte;}
            {_consumedStorageUnitSizeInByte = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNumber>("consumedStorageUnitSizeInBytes"), out var __jsonConsumedStorageUnitSizeInBytes) ? (int?)__jsonConsumedStorageUnitSizeInBytes : ConsumedStorageUnitSizeInByte;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.ICreatorProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.ICreatorProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.ICreatorProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._totalStorageUnitSizeInByte ? (Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNumber((int)this._totalStorageUnitSizeInByte) : null, "totalStorageUnitSizeInBytes" ,container.Add );
            AddIf( null != this._consumedStorageUnitSizeInByte ? (Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.Json.JsonNumber((int)this._consumedStorageUnitSizeInByte) : null, "consumedStorageUnitSizeInBytes" ,container.Add );
