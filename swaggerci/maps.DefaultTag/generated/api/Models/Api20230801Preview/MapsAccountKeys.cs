...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview
{
    ...
    public partial class MapsAccountKeys :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IMapsAccountKeysInternal
    {

        /// <summary>Internal Acessors for PrimaryKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IMapsAccountKeysInternal.PrimaryKey { get => this._primaryKey; set { {_primaryKey = value;} } }

        /// <summary>Internal Acessors for PrimaryKeyLastUpdated</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IMapsAccountKeysInternal.PrimaryKeyLastUpdated { get => this._primaryKeyLastUpdated; set { {_primaryKeyLastUpdated = value;} } }

        /// <summary>Internal Acessors for SecondaryKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IMapsAccountKeysInternal.SecondaryKey { get => this._secondaryKey; set { {_secondaryKey = value;} } }

        /// <summary>Internal Acessors for SecondaryKeyLastUpdated</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api20230801Preview.IMapsAccountKeysInternal.SecondaryKeyLastUpdated { get => this._secondaryKeyLastUpdated; set { {_secondaryKeyLastUpdated = value;} } }
