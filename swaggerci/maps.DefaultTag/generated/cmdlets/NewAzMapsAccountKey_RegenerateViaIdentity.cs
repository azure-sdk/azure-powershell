...
namespace Microsoft.Azure.PowerShell.Cmdlets.Maps.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMapsAccountKey_RegenerateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountKeys))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Maps.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maps/accounts/{accountName}/regenerateKey", ApiVersion = "2024-01-01-preview")]
    public partial class NewAzMapsAccountKey_RegenerateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Maps.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="KeySpecification" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsKeySpecification _keySpecification;

        /// <summary>Whether the operation refers to the primary or secondary key.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Whether the operation refers to the primary or secondary key.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsKeySpecification) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsKeySpecification KeySpecification { get => this._keySpecification; set => this._keySpecification = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountKeys">Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountKeys</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountKeys> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzMapsAccountKey_RegenerateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzMapsAccountKey_RegenerateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AccountsRegenerateKeysViaIdentity(InputObject.Id, KeySpecification, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AccountsRegenerateKeys(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, KeySpecification, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=KeySpecification})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=KeySpecification })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=KeySpecification })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountKeys> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Maps.Models.Api202401Preview.IMapsAccountKeys
