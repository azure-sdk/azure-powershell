...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxMitigate_MitigateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}/mitigate", ApiVersion = "2025-02-01")]
    public partial class InvokeAzDataBoxMitigate_MitigateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IMitigateJobRequest _mitigateJobRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.MitigateJobRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resolution code for the job")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.CustomerResolutionCode))]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.CustomerResolutionCode CustomerResolutionCode { get => _mitigateJobRequestBody.CustomerResolutionCode ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Support.CustomerResolutionCode)""); set => _mitigateJobRequestBody.CustomerResolutionCode = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Serial number and the customer resolution code corresponding to each serial number")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IMitigateJobRequestSerialNumberCustomerResolutionMap) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IMitigateJobRequestSerialNumberCustomerResolutionMap SerialNumberCustomerResolutionMap { get => _mitigateJobRequestBody.SerialNumberCustomerResolutionMap ?? null /* object */; set => _mitigateJobRequestBody.SerialNumberCustomerResolutionMap = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDataBoxMitigate_MitigateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxMitigate_MitigateViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MitigateViaIdentity(InputObject.Id, _mitigateJobRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.Mitigate(InputObject.JobName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, _mitigateJobRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_mitigateJobRequestBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_mitigateJobRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_mitigateJobRequestBody })
                    {
