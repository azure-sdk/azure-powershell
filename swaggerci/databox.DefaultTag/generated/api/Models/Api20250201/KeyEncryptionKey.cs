...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal
    {
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityProperties IdentityProperty { get => (this._identityProperty = this._identityProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IdentityProperties()); set => this._identityProperty = value; }
        ...
        public string IdentityPropertyType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityPropertiesInternal)IdentityProperty).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityPropertiesInternal)IdentityProperty).Type = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal.IdentityProperty { get => (this._identityProperty = this._identityProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IdentityProperties()); set { {_identityProperty = value;} } }

        /// <summary>Internal Acessors for IdentityPropertyUserAssigned</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IUserAssignedProperties Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal.IdentityPropertyUserAssigned { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityPropertiesInternal)IdentityProperty).UserAssigned; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityPropertiesInternal)IdentityProperty).UserAssigned = value; }

        /// <summary>Arm resource id for user assigned identity to be used to fetch MSI token.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public string UserAssignedResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityPropertiesInternal)IdentityProperty).UserAssignedResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IIdentityPropertiesInternal)IdentityProperty).UserAssignedResourceId = value ?? null; }
