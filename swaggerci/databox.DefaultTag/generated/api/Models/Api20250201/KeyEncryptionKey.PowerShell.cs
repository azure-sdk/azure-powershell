...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201
{
    ...
    public partial class KeyEncryptionKey
    {
        ...
        internal KeyEncryptionKey(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal)this).IdentityPropertyType = (string) content.GetValueForProperty("IdentityPropertyType",((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal)this).IdentityPropertyType, global::System.Convert.ToString);
            }
            if (content.Contains("IdentityPropertyUserAssigned"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal)this).IdentityPropertyUserAssigned = (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IUserAssignedProperties) content.GetValueForProperty("IdentityPropertyUserAssigned",((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal)this).IdentityPropertyUserAssigned, Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.UserAssignedPropertiesTypeConverter.ConvertFrom);
            }
            if (content.Contains("UserAssignedResourceId"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal)this).UserAssignedResourceId = (string) content.GetValueForProperty("UserAssignedResourceId",((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IKeyEncryptionKeyInternal)this).UserAssignedResourceId, global::System.Convert.ToString);
            }
