...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IAvailableSkuRequest
.Outputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.ISkuInformation])]
