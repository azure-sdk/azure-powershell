...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IShipmentPickUpResponse])]
...
param(
    ...
    [Parameter(ParameterSetName='MitigateViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IMitigateJobRequestSerialNumberCustomerResolutionMap]))]
...
DETAIL <IJobDetails>: Details of a job run. This field will only be sent for expand details filter.
  ...
  [ReverseShippingDetailsShippingAddressTaxIdentificationNumber <String>]: Tax Identification Number
...
VALIDATEADDRESS <IValidateAddress>: The requirements to validate customer address where the device needs to be shipped.
  ...
  [TransportPreferencePreferredShipmentType <TransportShipmentTypes?>]: Indicates Shipment Logistics type that the customer preferred.
.Link
https://learn.microsoft.com/powershell/module/az.databox/test-azdataboxserviceaddress
#>
function Test-AzDataBoxServiceAddress {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IAddressValidationProperties])]
