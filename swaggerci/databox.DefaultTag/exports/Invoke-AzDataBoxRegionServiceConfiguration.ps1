...
REGIONCONFIGURATIONREQUEST <IRegionConfigurationRequest>: Request body to get the configuration for the region.
  [DatacenterAddressRequestModel <ModelName?>]: The customer friendly name of the combination of version and capacity of the device. This field is necessary only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
  ...
  [DeviceCapabilityRequestModel <ModelName?>]: The customer friendly name of the combination of version and capacity of the device. This field is necessary only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
  [DeviceCapabilityRequestSkuName <SkuName?>]: Type of the device.
  [ScheduleAvailabilityRequestCountry <String>]: Country in which storage location should be supported.
  [ScheduleAvailabilityRequestModel <ModelName?>]: The customer friendly name of the combination of version and capacity of the device. This field is necessary only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
  ...
  [TransportAvailabilityRequestModel <ModelName?>]: The customer friendly name of the combination of version and capacity of the device. This field is necessary only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
  [TransportAvailabilityRequestSkuName <SkuName?>]: Type of the device.
.Link
https://learn.microsoft.com/powershell/module/az.databox/invoke-azdataboxregionserviceconfiguration
#>
function Invoke-AzDataBoxRegionServiceConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.Api20250201.IRegionConfigurationResponse])]
