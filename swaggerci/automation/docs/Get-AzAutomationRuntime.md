...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationruntime
schema: 2.0.0
---

# Get-AzAutomationRuntime
...
### List (Default)
```
Get-AzAutomationRuntime -AutomationAccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAutomationRuntime -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationRuntime -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
