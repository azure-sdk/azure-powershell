...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/update-azautomationhybridrunbookworkergroup
schema: 2.0.0
---
...
```
Update-AzAutomationHybridRunbookWorkerGroup -AutomationAccountName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-CredentialName <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20210622.IHybridRunbookWorkerGroup
