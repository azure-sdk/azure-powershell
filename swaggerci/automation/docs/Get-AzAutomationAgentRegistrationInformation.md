...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationagentregistrationinformation
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzAutomationAgentRegistrationInformation -AutomationAccountName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationAgentRegistrationInformation -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
