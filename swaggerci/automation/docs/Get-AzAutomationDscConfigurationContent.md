...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationdscconfigurationcontent
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzAutomationDscConfigurationContent -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
