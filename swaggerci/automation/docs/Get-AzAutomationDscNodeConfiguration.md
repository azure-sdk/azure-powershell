...
### List (Default)
```
Get-AzAutomationDscNodeConfiguration -AutomationAccountName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzAutomationDscNodeConfiguration -AutomationAccountName <String> -NodeConfigurationName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationDscNodeConfiguration -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20200113Preview.IDscNodeConfiguration
