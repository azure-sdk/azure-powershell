...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/remove-azautomationruntime
schema: 2.0.0
---

# Remove-AzAutomationRuntime
...
### Delete (Default)
```
Remove-AzAutomationRuntime -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationRuntime -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
