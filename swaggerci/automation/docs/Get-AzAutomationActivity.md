...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationactivity
schema: 2.0.0
---

# Get-AzAutomationActivity
...
### List (Default)
```
Get-AzAutomationActivity -AutomationAccountName <String> -ModuleName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAutomationActivity -AutomationAccountName <String> -ModuleName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get1
```
Get-AzAutomationActivity -AutomationAccountName <String> -DependencyName <String> -Name <String>
 -ResourceGroupName <String> -RuntimeName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationActivity -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### List1
```
Get-AzAutomationActivity -AutomationAccountName <String> -DependencyName <String> -ResourceGroupName <String>
 -RuntimeName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20200113Preview.IActivity

### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20220630Preview.IActivityAutoGenerated
