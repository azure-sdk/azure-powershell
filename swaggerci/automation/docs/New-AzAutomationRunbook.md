...
New-AzAutomationRunbook -AutomationAccountName <String> -ResourceGroupName <String> -RunbookName <String>
 ...
 [-PublishContentLinkVersion <String>] [-Runtime <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20220630Preview.IRunbook
