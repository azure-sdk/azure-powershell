...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationrunbookcontent
schema: 2.0.0
---

# Get-AzAutomationRunbookContent
...
### Get (Default)
```
Get-AzAutomationRunbookContent -AutomationAccountName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzAutomationRunbookContent -InputObject <IAutomationIdentity> -OutFile <String>
