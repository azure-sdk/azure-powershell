...
```
Update-AzAutomationRuntime -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultPackage <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAutomationRuntime -InputObject <IAutomationIdentity> [-DefaultPackage <Hashtable>]
