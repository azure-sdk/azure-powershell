...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/update-azautomationruntime
schema: 2.0.0
---

# Update-AzAutomationRuntime
...
```
Update-AzAutomationRuntime -AutomationAccountName <String> -ResourceGroupName <String> -RuntimeName <String>
 [-SubscriptionId <String>] [-BuiltInDependency <Hashtable>] [-Language <String>] [-LanguageVersion <String>]
 [-Name <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzAutomationRuntime -InputObject <IAutomationIdentity> [-BuiltInDependency <Hashtable>]
 [-Language <String>] [-LanguageVersion <String>] [-Name <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
### Microsoft.Azure.PowerShell.Cmdlets.Automation.Models.Api20220630Preview.IRuntime
