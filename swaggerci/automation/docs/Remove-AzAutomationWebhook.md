...
### Delete (Default)
```
Remove-AzAutomationWebhook -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationWebhook -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
