...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/get-azautomationdependency
schema: 2.0.0
---

# Get-AzAutomationDependency
...
### List (Default)
```
Get-AzAutomationDependency -AutomationAccountName <String> -ResourceGroupName <String> -RuntimeName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAutomationDependency -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 -RuntimeName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAutomationDependency -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
