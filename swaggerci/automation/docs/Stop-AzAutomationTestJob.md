...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/stop-azautomationtestjob
schema: 2.0.0
---

# Stop-AzAutomationTestJob
...
### Stop (Default)
```
Stop-AzAutomationTestJob -AutomationAccountName <String> -ResourceGroupName <String> -RunbookName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzAutomationTestJob -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
