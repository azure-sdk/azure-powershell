...
Update-AzAutomationRunbook -AutomationAccountName <String> -ResourceGroupName <String> -RunbookName <String>
 ...
 [-LogProgress] [-LogVerbose] [-Name <String>] [-RunbookType <RunbookTypeEnum>] [-Runtime <String>]
...
Update-AzAutomationRunbook -InputObject <IAutomationIdentity> [-Description <String>] [-Location <String>]
 [-LogActivityTrace <Int32>] [-LogProgress] [-LogVerbose] [-Name <String>] [-RunbookType <RunbookTypeEnum>]
 [-Runtime <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
