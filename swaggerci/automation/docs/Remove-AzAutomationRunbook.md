...
online version: https://learn.microsoft.com/powershell/module/az.automation/remove-azautomationrunbook
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzAutomationRunbook -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationRunbook -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
