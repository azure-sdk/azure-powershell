...
online version: https://docs.microsoft.com/en-us/powershell/module/az.automation/remove-azautomationdependency
schema: 2.0.0
---

# Remove-AzAutomationDependency
...
### Delete (Default)
```
Remove-AzAutomationDependency -AutomationAccountName <String> -Name <String> -ResourceGroupName <String>
 -RuntimeName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAutomationDependency -InputObject <IAutomationIdentity> [-DefaultProfile <PSObject>] [-PassThru]
