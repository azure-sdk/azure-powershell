...
online version: https://learn.microsoft.com/powershell/module/az.migratev2/get-azmigratev2assessmentreportdownloadurl
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzMigrateV2AssessmentReportDownloadUrl -AssessmentName <String> -GroupName <String> -ProjectName <String>
...
### GetViaIdentity
```
Get-AzMigrateV2AssessmentReportDownloadUrl -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>]
