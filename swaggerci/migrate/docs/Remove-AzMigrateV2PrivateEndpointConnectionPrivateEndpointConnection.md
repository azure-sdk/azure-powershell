...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2privateendpointconnectionprivateendpointconnection
schema: 2.0.0
---

# Remove-AzMigrateV2PrivateEndpointConnectionPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzMigrateV2PrivateEndpointConnectionPrivateEndpointConnection -PeConnectionName <String>
...
### DeleteViaIdentity
```
Remove-AzMigrateV2PrivateEndpointConnectionPrivateEndpointConnection -InputObject <IMigrateV2Identity>
