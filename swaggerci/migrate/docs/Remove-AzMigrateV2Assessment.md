...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2assessment
schema: 2.0.0
---

# Remove-AzMigrateV2Assessment
...
### Delete (Default)
```
Remove-AzMigrateV2Assessment -GroupName <String> -Name <String> -ProjectName <String>
...
### DeleteViaIdentity
```
Remove-AzMigrateV2Assessment -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>] [-PassThru]
