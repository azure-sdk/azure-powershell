...
online version: https://learn.microsoft.com/powershell/module/az.migratev2/get-azmigratev2privatelinkresource
schema: 2.0.0
---
...
### List (Default)
```
Get-AzMigrateV2PrivateLinkResource -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMigrateV2PrivateLinkResource -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMigrateV2PrivateLinkResource -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
