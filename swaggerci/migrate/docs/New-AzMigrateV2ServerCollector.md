...
online version: https://learn.microsoft.com/powershell/module/az.migratev2/new-azmigratev2servercollector
schema: 2.0.0
---

# New-AzMigrateV2ServerCollector
...
```
New-AzMigrateV2ServerCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
