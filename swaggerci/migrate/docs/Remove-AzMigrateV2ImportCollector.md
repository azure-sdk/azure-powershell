...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migratev2/remove-azmigratev2importcollector
schema: 2.0.0
---

# Remove-AzMigrateV2ImportCollector
...
### Delete (Default)
```
Remove-AzMigrateV2ImportCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateV2ImportCollector -InputObject <IMigrateV2Identity> [-DefaultProfile <PSObject>] [-PassThru]
