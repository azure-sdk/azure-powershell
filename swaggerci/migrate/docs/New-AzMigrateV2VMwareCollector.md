...
online version: https://learn.microsoft.com/powershell/module/az.migratev2/new-azmigratev2vmwarecollector
schema: 2.0.0
---

# New-AzMigrateV2VMwareCollector
...
```
New-AzMigrateV2VMwareCollector -Name <String> -ProjectName <String> -ResourceGroupName <String>
