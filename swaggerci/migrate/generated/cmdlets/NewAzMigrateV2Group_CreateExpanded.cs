...
namespace Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.IEventListener
    {
        ...
        public string ETag { get => GroupBody.ETag ?? null; set => GroupBody.ETag = value; }

        /// <summary>Backing field for <see cref="GroupBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.IGroup GroupBody { get => this._groupBody; set => this._groupBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string GroupType { get => GroupBody.GroupType ?? null; set => GroupBody.GroupType = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreate(SubscriptionId, ResourceGroupName, ProjectName, Name, GroupBody, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ProjectName=ProjectName,Name=Name,body=GroupBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ProjectName=ProjectName, Name=Name, body=GroupBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ProjectName=ProjectName, Name=Name, body=GroupBody })
                    {
