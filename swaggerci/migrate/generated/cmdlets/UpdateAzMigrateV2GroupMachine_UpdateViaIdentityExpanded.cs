...
namespace Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Runtime.IEventListener
    {
        ...
        public string ETag { get => GroupUpdatePropertiesBody.ETag ?? null; set => GroupUpdatePropertiesBody.ETag = value; }

        /// <summary>Backing field for <see cref="GroupUpdatePropertiesBody" /> property.</summary>
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.IUpdateGroupBody GroupUpdatePropertiesBody { get => this._groupUpdatePropertiesBody; set => this._groupUpdatePropertiesBody = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] Machine { get => GroupUpdatePropertiesBody.Machine ?? null /* arrayOf */; set => GroupUpdatePropertiesBody.Machine = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Support.GroupUpdateOperation OperationType { get => GroupUpdatePropertiesBody.OperationType ?? ((Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Support.GroupUpdateOperation)""); set => GroupUpdatePropertiesBody.OperationType = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.GroupsUpdateMachinesViaIdentity(InputObject.Id, GroupUpdatePropertiesBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.GroupsUpdateMachines(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ProjectName ?? null, InputObject.GroupName ?? null, GroupUpdatePropertiesBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=GroupUpdatePropertiesBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MigrateV2.Models.Api20191001.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=GroupUpdatePropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=GroupUpdatePropertiesBody })
                    {
