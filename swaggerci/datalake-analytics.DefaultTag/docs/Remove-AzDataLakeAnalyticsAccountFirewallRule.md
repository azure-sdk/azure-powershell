...
online version: https://learn.microsoft.com/powershell/module/az.datalakeanalyticsaccount/remove-azdatalakeanalyticsaccountfirewallrule
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDataLakeAnalyticsAccountFirewallRule -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataLakeAnalyticsAccountFirewallRule -InputObject <IDataLakeAnalyticsAccountIdentity>
