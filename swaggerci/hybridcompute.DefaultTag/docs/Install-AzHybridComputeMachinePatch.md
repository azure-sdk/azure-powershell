...
online version: https://learn.microsoft.com/powershell/module/az.hybridcompute/install-azhybridcomputemachinepatch
schema: 2.0.0
---

# Install-AzHybridComputeMachinePatch
...
```
Install-AzHybridComputeMachinePatch -Name <String> -ResourceGroupName <String> -MaximumDuration <String>
...
### Install
```
Install-AzHybridComputeMachinePatch -Name <String> -ResourceGroupName <String>
...
### InstallViaIdentity
```
Install-AzHybridComputeMachinePatch -InputObject <IHybridComputeIdentity>
...
```
Install-AzHybridComputeMachinePatch -InputObject <IHybridComputeIdentity> -MaximumDuration <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesParameters
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.VMGuestPatchClassificationLinux[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.VMGuestPatchRebootSetting
Parameter Sets: InstallExpanded, InstallViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.VMGuestPatchClassificationWindows[]
Parameter Sets: InstallExpanded, InstallViaIdentityExpanded
Aliases:
