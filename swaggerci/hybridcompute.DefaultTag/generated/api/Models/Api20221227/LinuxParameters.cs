...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227
{
    ...
    public partial class LinuxParameters :
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.ILinuxParameters,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.ILinuxParametersInternal
    {

        /// <summary>Backing field for <see cref="ClassificationsToInclude" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.VMGuestPatchClassificationLinux[] _classificationsToInclude;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.VMGuestPatchClassificationLinux[] ClassificationsToInclude { get => this._classificationsToInclude; set => this._classificationsToInclude = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.VMGuestPatchClassificationLinux[] ClassificationsToInclude { get; set; }
        /// <summary>packages to exclude in the patch operation. Format: packageName_packageVersion</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.Info(
        Required = false,
        ReadOnly = false,
