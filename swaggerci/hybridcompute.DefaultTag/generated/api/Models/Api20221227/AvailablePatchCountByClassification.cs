...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227
{
    ...
    public partial class AvailablePatchCountByClassification :
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassification,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.Critical { get => this._critical; set { {_critical = value;} } }

        /// <summary>Internal Acessors for Definition</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.Definition { get => this._definition; set { {_definition = value;} } }

        /// <summary>Internal Acessors for FeaturePack</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.FeaturePack { get => this._featurePack; set { {_featurePack = value;} } }

        /// <summary>Internal Acessors for Other</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.Other { get => this._other; set { {_other = value;} } }

        /// <summary>Internal Acessors for Security</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.Security { get => this._security; set { {_security = value;} } }

        /// <summary>Internal Acessors for ServicePack</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.ServicePack { get => this._servicePack; set { {_servicePack = value;} } }

        /// <summary>Internal Acessors for Tool</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.Tool { get => this._tool; set { {_tool = value;} } }

        /// <summary>Internal Acessors for Update</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.Update { get => this._update; set { {_update = value;} } }

        /// <summary>Internal Acessors for UpdateRollup</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAvailablePatchCountByClassificationInternal.UpdateRollup { get => this._updateRollup; set { {_updateRollup = value;} } }
