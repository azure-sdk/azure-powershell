...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227
{
    ...
    public partial class AgentUpgrade :
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAgentUpgrade,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAgentUpgradeInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAgentUpgradeInternal.LastAttemptMessage { get => this._lastAttemptMessage; set { {_lastAttemptMessage = value;} } }

        /// <summary>Internal Acessors for LastAttemptStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.LastAttemptStatusEnum? Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAgentUpgradeInternal.LastAttemptStatus { get => this._lastAttemptStatus; set { {_lastAttemptStatus = value;} } }

        /// <summary>Internal Acessors for LastAttemptTimestamp</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IAgentUpgradeInternal.LastAttemptTimestamp { get => this._lastAttemptTimestamp; set { {_lastAttemptTimestamp = value;} } }
