...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.PatchOperationStartedBy Platform = @"Platform";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.PatchOperationStartedBy User = @"User";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.PatchOperationStartedBy e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.PatchOperationStartedBy e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.PatchOperationStartedBy e1, Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Support.PatchOperationStartedBy e2)
        {
            return !e2.Equals(e1);
        }
