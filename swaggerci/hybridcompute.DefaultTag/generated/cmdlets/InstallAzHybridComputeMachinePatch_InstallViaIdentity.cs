...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] InstallPatches=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/machines/{name}/installPatches"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Install, @"AzHybridComputeMachinePatch_InstallViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Description(@"The operation to install patches on a hybrid machine identity in Azure.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Generated]
    public partial class InstallAzHybridComputeMachinePatch_InstallViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="InstallPatchesInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesParameters _installPatchesInput;

        /// <summary>Input for InstallPatches as directly received by the API</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input for InstallPatches as directly received by the API", ValueFromPipeline = true)]
        ...
        SerializedName = @"installPatchesInput",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesParameters InstallPatchesInput { get => this._installPatchesInput; set => this._installPatchesInput = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesResult">Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of InstallAzHybridComputeMachinePatch_InstallViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Cmdlets.InstallAzHybridComputeMachinePatch_InstallViaIdentity Clone()
        {
            var clone = new InstallAzHybridComputeMachinePatch_InstallViaIdentity();
            ...
            clone.InstallPatchesInput = this.InstallPatchesInput;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InstallAzHybridComputeMachinePatch_InstallViaIdentity" /> cmdlet class.
        /// </summary>
        public InstallAzHybridComputeMachinePatch_InstallViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MachinesInstallPatches' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MachinesInstallPatchesViaIdentity(InputObject.Id, InstallPatchesInput, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MachinesInstallPatches(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, InstallPatchesInput, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=InstallPatchesInput})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=InstallPatchesInput })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=InstallPatchesInput })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20221227.IMachineInstallPatchesResult
