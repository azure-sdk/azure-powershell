...
namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220601
{
    ...
    public partial class ConfigDiagnosticsValidatorResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220601.IConfigDiagnosticsValidatorResultInternal
    {

        /// <summary>Backing field for <see cref="Issue" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220601.IConfigDiagnosticsValidatorResultIssue[] _issue;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220601.IConfigDiagnosticsValidatorResultIssue[] Issue { get => this._issue; set => this._issue = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220601.IConfigDiagnosticsValidatorResultIssue) })]
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220601.IConfigDiagnosticsValidatorResultIssue[] Issue { get; set; }
        /// <summary>Replica set location and subnet name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
