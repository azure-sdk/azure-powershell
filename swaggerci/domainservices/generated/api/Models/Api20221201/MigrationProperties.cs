...
namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201
{
    ...
    public partial class MigrationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationPropertiesInternal
    {

        /// <summary>Internal Acessors for MigrationProgress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgress Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationPropertiesInternal.MigrationProgress { get => (this._migrationProgress = this._migrationProgress ?? new Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.MigrationProgress()); set { {_migrationProgress = value;} } }

        /// <summary>Internal Acessors for OldSubnetId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationPropertiesInternal.OldSubnetId { get => this._oldSubnetId; set { {_oldSubnetId = value;} } }

        /// <summary>Internal Acessors for OldVnetSiteId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationPropertiesInternal.OldVnetSiteId { get => this._oldVnetSiteId; set { {_oldVnetSiteId = value;} } }

        /// <summary>Backing field for <see cref="MigrationProgress" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgress _migrationProgress;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgress MigrationProgress { get => (this._migrationProgress = this._migrationProgress ?? new Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.MigrationProgress()); }
        ...
        public double? MigrationProgressCompletionPercentage { get => ((Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgressInternal)MigrationProgress).CompletionPercentage; set => ((Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgressInternal)MigrationProgress).CompletionPercentage = value ?? default(double); }

        /// <summary>Progress Message</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Inlined)]
        public string MigrationProgressMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgressInternal)MigrationProgress).ProgressMessage; set => ((Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgressInternal)MigrationProgress).ProgressMessage = value ?? null; }
    ...
    {
        /// <summary>Migration Progress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IMigrationProgress MigrationProgress { get; set; }
        /// <summary>Completion Percentage</summary>
        double? MigrationProgressCompletionPercentage { get; set; }
        /// <summary>Progress Message</summary>
        string MigrationProgressMessage { get; set; }
