...
online version: https://docs.microsoft.com/en-us/powershell/module/az.domainservices/remove-azdomainservicesdomainservice
schema: 2.0.0
---

# Remove-AzDomainServicesDomainService
...
### Delete (Default)
```
Remove-AzDomainServicesDomainService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDomainServicesDomainService -InputObject <IDomainServicesIdentity> [-DefaultProfile <PSObject>]
