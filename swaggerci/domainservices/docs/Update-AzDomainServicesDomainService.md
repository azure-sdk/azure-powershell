...
online version: https://learn.microsoft.com/powershell/module/az.domainservices/update-azdomainservicesdomainservice
schema: 2.0.0
---
...
Update-AzDomainServicesDomainService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-DomainName <String>] [-DomainSecuritySettingChannelBinding <ChannelBinding>]
 [-DomainSecuritySettingKerberosArmoring <KerberosArmoring>]
 [-DomainSecuritySettingKerberosRc4Encryption <KerberosRc4Encryption>]
 [-DomainSecuritySettingLdapSigning <LdapSigning>] [-DomainSecuritySettingNtlmV1 <NtlmV1>]
 ...
 [-SyncScope <SyncScope>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IConfigDiagnosticsValidatorResult[]
Parameter Sets: (All)
Aliases:
...
### -DomainSecuritySettingChannelBinding
A flag to determine whether or not ChannelBinding is enabled or disabled.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.ChannelBinding
Parameter Sets: (All)
Aliases:
...
### -DomainSecuritySettingLdapSigning
A flag to determine whether or not LdapSigning is enabled or disabled.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.LdapSigning
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IReplicaSet[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20221201.IForestTrust[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.SyncScope
Parameter Sets: (All)
Aliases:
