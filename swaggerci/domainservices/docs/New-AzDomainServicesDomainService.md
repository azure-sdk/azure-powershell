...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220901.IConfigDiagnosticsValidatorResult[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220901.IReplicaSet[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220901.IForestTrust[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20220901.IDomainService
