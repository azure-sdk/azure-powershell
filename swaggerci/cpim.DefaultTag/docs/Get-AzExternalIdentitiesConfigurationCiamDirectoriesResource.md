...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/get-azexternalidentitiesconfigurationciamdirectoriesresource
schema: 2.0.0
---

# Get-AzExternalIdentitiesConfigurationCiamDirectoriesResource
...
### Get (Default)
```
Get-AzExternalIdentitiesConfigurationCiamDirectoriesResource -ResourceGroupName <String>
