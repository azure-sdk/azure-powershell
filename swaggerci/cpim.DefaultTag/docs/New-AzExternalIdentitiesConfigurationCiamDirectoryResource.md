...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/new-azexternalidentitiesconfigurationciamdirectoryresource
schema: 2.0.0
---

# New-AzExternalIdentitiesConfigurationCiamDirectoryResource
...
```
New-AzExternalIdentitiesConfigurationCiamDirectoryResource -ResourceGroupName <String> -ResourceName <String>
 -Location <String> [-SubscriptionId <String>] [-CreateTenantPropertyCountryCode <String>]
 [-CreateTenantPropertyDisplayName <String>] [-Tag <Hashtable>] [-TenantId <String>]
