...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/get-azexternalidentitiesconfigurationb2cdirectoryresource
schema: 2.0.0
---
...
### List (Default)
```
Get-AzExternalIdentitiesConfigurationB2CDirectoryResource [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### List1
```
Get-AzExternalIdentitiesConfigurationB2CDirectoryResource -ResourceGroupName <String>
