...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/get-azexternalidentitiesconfigurationguestusagesresource
schema: 2.0.0
---

# Get-AzExternalIdentitiesConfigurationGuestUsagesResource
...
### Get (Default)
```
Get-AzExternalIdentitiesConfigurationGuestUsagesResource -ResourceGroupName <String> -ResourceName <String>
