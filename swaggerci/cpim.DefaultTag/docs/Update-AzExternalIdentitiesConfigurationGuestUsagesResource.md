...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/update-azexternalidentitiesconfigurationguestusagesresource
schema: 2.0.0
---
...
```
Update-AzExternalIdentitiesConfigurationGuestUsagesResource -ResourceGroupName <String> -ResourceName <String>
...
```
Update-AzExternalIdentitiesConfigurationGuestUsagesResource
 -InputObject <IExternalIdentitiesConfigurationIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
