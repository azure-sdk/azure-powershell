...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/remove-azexternalidentitiesconfigurationb2cdirectoriesresource
schema: 2.0.0
---

# Remove-AzExternalIdentitiesConfigurationB2CDirectoriesResource
...
### Delete (Default)
```
Remove-AzExternalIdentitiesConfigurationB2CDirectoriesResource -ResourceGroupName <String>
...
```
Remove-AzExternalIdentitiesConfigurationB2CDirectoriesResource
 -InputObject <IExternalIdentitiesConfigurationIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
