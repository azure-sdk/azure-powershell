...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/update-azexternalidentitiesconfigurationciamtenant
schema: 2.0.0
---

# Update-AzExternalIdentitiesConfigurationCiamTenant
...
```
Update-AzExternalIdentitiesConfigurationCiamTenant -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-SkuName <CiamResourceSkuName>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzExternalIdentitiesConfigurationCiamTenant -InputObject <IExternalIdentitiesConfigurationIdentity>
 [-SkuName <CiamResourceSkuName>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
