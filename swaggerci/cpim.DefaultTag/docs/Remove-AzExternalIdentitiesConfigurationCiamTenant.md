...
online version: https://learn.microsoft.com/powershell/module/az.externalidentitiesconfiguration/remove-azexternalidentitiesconfigurationciamtenant
schema: 2.0.0
---

# Remove-AzExternalIdentitiesConfigurationCiamTenant
...
### Delete (Default)
```
Remove-AzExternalIdentitiesConfigurationCiamTenant -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzExternalIdentitiesConfigurationCiamTenant -InputObject <IExternalIdentitiesConfigurationIdentity>
