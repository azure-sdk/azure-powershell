...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20220501Preview
{
    ...
    public partial class PrivateEndpointConnection
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20220501Preview.IPrivateEndpointConnection.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20220501Preview.IPrivateEndpointConnection.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20220501Preview.IPrivateEndpointConnection FromJson(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonNode node)
        {
        ...
        internal PrivateEndpointConnection(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.Api20220501Preview.PrivateEndpointConnectionProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }
