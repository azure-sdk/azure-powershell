...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dashboard/remove-azdashboardgrafana
schema: 2.0.0
---

# Remove-AzDashboardGrafana
...
### Delete (Default)
```
Remove-AzDashboardGrafana -ResourceGroupName <String> -WorkspaceName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDashboardGrafana -InputObject <IDashboardIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
