...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dashboard/remove-azdashboardprivateendpointconnection
schema: 2.0.0
---

# Remove-AzDashboardPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzDashboardPrivateEndpointConnection -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzDashboardPrivateEndpointConnection -InputObject <IDashboardIdentity> [-DefaultProfile <PSObject>]
