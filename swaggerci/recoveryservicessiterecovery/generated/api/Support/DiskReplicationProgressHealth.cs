...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth NoProgress = @"NoProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth Queued = @"Queued";

        public static Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth SlowProgress = @"SlowProgress";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth e1, Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.DiskReplicationProgressHealth e2)
        {
            return !e2.Equals(e1);
        }
