...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801
{
    ...
    public partial class ReplicationProtectionIntentProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentPropertiesInternal.CreationTimeUtc { get => this._creationTimeUtc; set { {_creationTimeUtc = value;} } }

        /// <summary>Internal Acessors for IsActive</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentPropertiesInternal.IsActive { get => this._isActive; set { {_isActive = value;} } }

        /// <summary>Internal Acessors for JobId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentPropertiesInternal.JobId { get => this._jobId; set { {_jobId = value;} } }

        /// <summary>Internal Acessors for JobState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentPropertiesInternal.JobState { get => this._jobState; set { {_jobState = value;} } }

        /// <summary>Internal Acessors for ProviderSpecificDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentProviderSpecificSettings Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ReplicationProtectionIntentProviderSpecificSettings()); set { {_providerSpecificDetail = value;} } }

        /// <summary>Backing field for <see cref="ProviderSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentProviderSpecificSettings _providerSpecificDetail;

        /// <summary>The Replication provider custom settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentProviderSpecificSettings ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ReplicationProtectionIntentProviderSpecificSettings()); set => this._providerSpecificDetail = value; }
...

    {
        ...
        /// <summary>The Replication provider custom settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IReplicationProtectionIntentProviderSpecificSettings ProviderSpecificDetail { get; set; }
        /// <summary>Gets the Instance type.</summary>
        string ProviderSpecificDetailInstanceType { get; set; }
