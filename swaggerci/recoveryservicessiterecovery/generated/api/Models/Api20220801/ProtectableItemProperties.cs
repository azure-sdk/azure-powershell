...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801
{
    ...
    public partial class ProtectableItemProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProtectableItemProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProtectableItemPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IConfigurationSettings _customDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IConfigurationSettings CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ConfigurationSettings()); set => this._customDetail = value; }
        ...
        public string CustomDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IConfigurationSettingsInternal)CustomDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IConfigurationSettingsInternal)CustomDetail).InstanceType = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IConfigurationSettings Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProtectableItemPropertiesInternal.CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ConfigurationSettings()); set { {_customDetail = value;} } }
    ...
    {
        /// <summary>The Replication provider custom settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IConfigurationSettings CustomDetail { get; set; }
        /// <summary>Gets the class type. Overridden in derived classes.</summary>
        string CustomDetailInstanceType { get; set; }
        /// <summary>The name.</summary>
        string FriendlyName { get; set; }
