...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801
{
    ...
    public partial class RecoveryPlanProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetails _currentScenario;

        /// <summary>The current scenario details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetails CurrentScenario { get => (this._currentScenario = this._currentScenario ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.CurrentScenarioDetails()); set => this._currentScenario = value; }
        ...
        public string CurrentScenarioJobId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetailsInternal)CurrentScenario).JobId; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetailsInternal)CurrentScenario).JobId = value ?? null; }

        /// <summary>Scenario name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inlined)]
        public string CurrentScenarioName { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetailsInternal)CurrentScenario).ScenarioName; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetailsInternal)CurrentScenario).ScenarioName = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanGroup[] _group;

        /// <summary>The recovery plan groups.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanGroup[] Group { get => this._group; set => this._group = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanPropertiesInternal.CurrentScenario { get => (this._currentScenario = this._currentScenario ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.CurrentScenarioDetails()); set { {_currentScenario = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanProviderSpecificDetails[] _providerSpecificDetail;

        /// <summary>The provider id and provider specific details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanProviderSpecificDetails[] ProviderSpecificDetail { get => this._providerSpecificDetail; set => this._providerSpecificDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanGroup[] Group { get; set; }
        /// <summary>The start time of the last planned failover.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanProviderSpecificDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanProviderSpecificDetails[] ProviderSpecificDetail { get; set; }
        /// <summary>The recovery fabric friendly name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string[] AllowedOperation { get; set; }
        /// <summary>The current scenario details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICurrentScenarioDetails CurrentScenario { get; set; }
        /// <summary>ARM Id of the job being executed.</summary>
        string CurrentScenarioJobId { get; set; }
        /// <summary>Scenario name.</summary>
        string CurrentScenarioName { get; set; }
