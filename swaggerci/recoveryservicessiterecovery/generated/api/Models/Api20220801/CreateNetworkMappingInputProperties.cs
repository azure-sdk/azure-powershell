...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801
{
    ...
    public partial class CreateNetworkMappingInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICreateNetworkMappingInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICreateNetworkMappingInputPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IFabricSpecificCreateNetworkMappingInput _fabricSpecificDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IFabricSpecificCreateNetworkMappingInput FabricSpecificDetail { get => (this._fabricSpecificDetail = this._fabricSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.FabricSpecificCreateNetworkMappingInput()); set => this._fabricSpecificDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IFabricSpecificCreateNetworkMappingInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.ICreateNetworkMappingInputPropertiesInternal.FabricSpecificDetail { get => (this._fabricSpecificDetail = this._fabricSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.FabricSpecificCreateNetworkMappingInput()); set { {_fabricSpecificDetail = value;} } }
    ...
    {
        /// <summary>Fabric specific input properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IFabricSpecificCreateNetworkMappingInput FabricSpecificDetail { get; set; }
        /// <summary>The instance type.</summary>
        string FabricSpecificDetailInstanceType { get; set; }
        /// <summary>Recovery fabric Name.</summary>
        string RecoveryFabricName { get; set; }
