...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801
{
    ...
    public partial class ProcessServer :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServer,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IVersionDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.AgentVersionDetail { get => (this._agentVersionDetail = this._agentVersionDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.VersionDetails()); set { {_agentVersionDetail = value;} } }

        /// <summary>Internal Acessors for Health</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ProtectionHealth? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.Health { get => this._health; set { {_health = value;} } }

        /// <summary>Internal Acessors for MarsCommunicationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.MarsCommunicationStatus { get => this._marsCommunicationStatus; set { {_marsCommunicationStatus = value;} } }

        /// <summary>Internal Acessors for MarsRegistrationStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.MarsRegistrationStatus { get => this._marsRegistrationStatus; set { {_marsRegistrationStatus = value;} } }

        /// <summary>Internal Acessors for PsStatsRefreshTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.PsStatsRefreshTime { get => this._psStatsRefreshTime; set { {_psStatsRefreshTime = value;} } }

        /// <summary>Internal Acessors for ThroughputInByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.ThroughputInByte { get => this._throughputInByte; set { {_throughputInByte = value;} } }

        /// <summary>Internal Acessors for ThroughputInMBps</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.ThroughputInMBps { get => this._throughputInMBps; set { {_throughputInMBps = value;} } }

        /// <summary>Internal Acessors for ThroughputStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.ThroughputStatus { get => this._throughputStatus; set { {_throughputStatus = value;} } }

        /// <summary>Internal Acessors for ThroughputUploadPendingDataInByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IProcessServerInternal.ThroughputUploadPendingDataInByte { get => this._throughputUploadPendingDataInByte; set { {_throughputUploadPendingDataInByte = value;} } }

        /// <summary>Backing field for <see cref="MobilityServiceUpdate" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IMobilityServiceUpdate[] _mobilityServiceUpdate;

        /// <summary>The list of the mobility service updates available on the Process Server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IMobilityServiceUpdate[] MobilityServiceUpdate { get => this._mobilityServiceUpdate; set => this._mobilityServiceUpdate = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IMobilityServiceUpdate) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IMobilityServiceUpdate[] MobilityServiceUpdate { get; set; }
        /// <summary>The OS type of the server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
