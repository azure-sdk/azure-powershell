...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class DiskEncryptionInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskEncryptionInfoInternal
    {

        /// <summary>Backing field for <see cref="DiskEncryptionKeyInfo" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskEncryptionKeyInfo _diskEncryptionKeyInfo;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskEncryptionKeyInfo DiskEncryptionKeyInfo { get => (this._diskEncryptionKeyInfo = this._diskEncryptionKeyInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.DiskEncryptionKeyInfo()); set => this._diskEncryptionKeyInfo = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IKeyEncryptionKeyInfo Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskEncryptionInfoInternal.KeyEncryptionKeyInfo { get => (this._keyEncryptionKeyInfo = this._keyEncryptionKeyInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.KeyEncryptionKeyInfo()); set { {_keyEncryptionKeyInfo = value;} } }
    ...
    {
        /// <summary>The recovery KeyVault reference for secret.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskEncryptionKeyInfo DiskEncryptionKeyInfo { get; set; }
        /// <summary>The KeyVault resource ARM id for secret.</summary>
        string DiskEncryptionKeyInfoKeyVaultResourceArmId { get; set; }
        /// <summary>The secret url / identifier.</summary>
        string DiskEncryptionKeyInfoSecretIdentifier { get; set; }
        /// <summary>The recovery KeyVault reference for key.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IKeyEncryptionKeyInfo KeyEncryptionKeyInfo { get; set; }
        /// <summary>The key URL / identifier.</summary>
        string KeyEncryptionKeyInfoKeyIdentifier { get; set; }
        /// <summary>The KeyVault resource ARM Id for key.</summary>
        string KeyEncryptionKeyInfoKeyVaultResourceArmId { get; set; }
