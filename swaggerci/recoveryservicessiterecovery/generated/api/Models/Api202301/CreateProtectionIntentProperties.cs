...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class CreateProtectionIntentProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentProviderSpecificDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.CreateProtectionIntentProviderSpecificDetails()); set { {_providerSpecificDetail = value;} } }

        /// <summary>Backing field for <see cref="ProviderSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentProviderSpecificDetails _providerSpecificDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentProviderSpecificDetails ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.CreateProtectionIntentProviderSpecificDetails()); set => this._providerSpecificDetail = value; }
...

    {
        ...
        /// The ReplicationProviderInput. For A2A provider, it will be A2ACreateProtectionIntentInput object.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ICreateProtectionIntentProviderSpecificDetails ProviderSpecificDetail { get; set; }
        /// <summary>The class type.</summary>
        string ProviderSpecificDetailInstanceType { get; set; }
