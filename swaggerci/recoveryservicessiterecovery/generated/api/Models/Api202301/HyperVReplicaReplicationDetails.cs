...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class HyperVReplicaReplicationDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IHyperVReplicaReplicationDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IHyperVReplicaReplicationDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInitialReplicationDetails _initialReplicationDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInitialReplicationDetails InitialReplicationDetail { get => (this._initialReplicationDetail = this._initialReplicationDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.InitialReplicationDetails()); set => this._initialReplicationDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInitialReplicationDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IHyperVReplicaReplicationDetailsInternal.InitialReplicationDetail { get => (this._initialReplicationDetail = this._initialReplicationDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.InitialReplicationDetails()); set { {_initialReplicationDetail = value;} } }

        /// <summary>Backing field for <see cref="VMDiskDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskDetails[] _vMDiskDetail;

        /// <summary>VM disk details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskDetails[] VMDiskDetail { get => this._vMDiskDetail; set => this._vMDiskDetail = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMNicDetails[] _vMNic;

        /// <summary>The PE Network details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMNicDetails[] VMNic { get => this._vMNic; set => this._vMNic = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IReplicationProviderSpecificSettings
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IDiskDetails[] VMDiskDetail { get; set; }
        /// <summary>The virtual machine Id.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMNicDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMNicDetails[] VMNic { get; set; }
        /// <summary>The protection state for the vm.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>Initial replication details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInitialReplicationDetails InitialReplicationDetail { get; set; }
        /// <summary>The initial replication progress percentage.</summary>
        string InitialReplicationDetailInitialReplicationProgressPercentage { get; set; }
        /// <summary>Initial replication type.</summary>
        string InitialReplicationDetailInitialReplicationType { get; set; }
