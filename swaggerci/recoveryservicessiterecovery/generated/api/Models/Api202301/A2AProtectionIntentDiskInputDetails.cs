...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class A2AProtectionIntentDiskInputDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IA2AProtectionIntentDiskInputDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IA2AProtectionIntentDiskInputDetailsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IA2AProtectionIntentDiskInputDetailsInternal.RecoveryAzureStorageAccountCustomInput { get => (this._recoveryAzureStorageAccountCustomInput = this._recoveryAzureStorageAccountCustomInput ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.StorageAccountCustomDetails()); set { {_recoveryAzureStorageAccountCustomInput = value;} } }
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails _recoveryAzureStorageAccountCustomInput;

        /// <summary>The recovery VHD storage account input.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails RecoveryAzureStorageAccountCustomInput { get => (this._recoveryAzureStorageAccountCustomInput = this._recoveryAzureStorageAccountCustomInput ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.StorageAccountCustomDetails()); set => this._recoveryAzureStorageAccountCustomInput = value; }

        /// <summary>The class type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inlined)]
        public string RecoveryAzureStorageAccountCustomInputResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetailsInternal)RecoveryAzureStorageAccountCustomInput).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetailsInternal)RecoveryAzureStorageAccountCustomInput).ResourceType = value ?? null; }
...

    {
        ...
        string PrimaryStagingStorageAccountCustomInputResourceType { get; set; }
        /// <summary>The recovery VHD storage account input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails RecoveryAzureStorageAccountCustomInput { get; set; }
        /// <summary>The class type.</summary>
        string RecoveryAzureStorageAccountCustomInputResourceType { get; set; }
