...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobDetailsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobDetailsAffectedObjectDetails _affectedObjectDetail;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobDetailsAffectedObjectDetails AffectedObjectDetail { get => (this._affectedObjectDetail = this._affectedObjectDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.JobDetailsAffectedObjectDetails()); set => this._affectedObjectDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobDetailsAffectedObjectDetails AffectedObjectDetail { get; set; }
        /// <summary>Gets the type of job details (see JobDetailsTypes enum for possible values).</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = true,
        ReadOnly = false,
