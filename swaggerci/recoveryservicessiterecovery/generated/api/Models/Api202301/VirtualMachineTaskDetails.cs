...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class VirtualMachineTaskDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVirtualMachineTaskDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVirtualMachineTaskDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetails __jobTaskDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.JobTaskDetails();
        ...
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ITaskTypeDetailsInternal)__jobTaskDetails).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ITaskTypeDetailsInternal)__jobTaskDetails).InstanceType = value ; }

        /// <summary>The job entity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inherited)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobEntity JobTask { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal)__jobTaskDetails).JobTask; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal)__jobTaskDetails).JobTask = value ?? null /* model class */; }

        /// <summary>The job display name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inherited)]
        public string JobTaskJobFriendlyName { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal)__jobTaskDetails).JobTaskJobFriendlyName; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal)__jobTaskDetails).JobTaskJobFriendlyName = value ?? null; }

        /// <summary>The job id.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inherited)]
        public string JobTaskJobId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal)__jobTaskDetails).JobTaskJobId; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal)__jobTaskDetails).JobTaskJobId = value ?? null; }
    ...
    public partial interface IVirtualMachineTaskDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetails
    {
        /// <summary>The skipped reason.</summary>
    ...
    internal partial interface IVirtualMachineTaskDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IJobTaskDetailsInternal
    {
        /// <summary>The skipped reason.</summary>
        string SkippedReason { get; set; }
        /// <summary>The skipped reason string.</summary>
