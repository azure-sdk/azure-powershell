...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class InMageEnableProtectionInput :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageEnableProtectionInput,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageEnableProtectionInputInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IEnableProtectionProviderSpecificInput
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskSignatureExclusionOptions[] DiskExclusionInputDiskSignatureOption { get; set; }
        /// <summary>The volume label based option for disk exclusion.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageVolumeExclusionOptions) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageVolumeExclusionOptions[] DiskExclusionInputVolumeOption { get; set; }
        /// <summary>The disks to include list.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IEnableProtectionProviderSpecificInputInternal
    {
        ...
        string DatastoreName { get; set; }
        /// <summary>The enable disk exclusion input.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskExclusionInput DiskExclusionInput { get; set; }
        /// <summary>The guest disk signature based option for disk exclusion.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskSignatureExclusionOptions[] DiskExclusionInputDiskSignatureOption { get; set; }
        /// <summary>The volume label based option for disk exclusion.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageVolumeExclusionOptions[] DiskExclusionInputVolumeOption { get; set; }
