...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class ExistingStorageAccount :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IExistingStorageAccount,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IExistingStorageAccountInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails __storageAccountCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.StorageAccountCustomDetails();
    ...
    public partial interface IExistingStorageAccount :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetails
    {
        /// <summary>The storage account Arm Id. Throw error, if resource does not exists.</summary>
    ...
    internal partial interface IExistingStorageAccountInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IStorageAccountCustomDetailsInternal
    {
        /// <summary>The storage account Arm Id. Throw error, if resource does not exists.</summary>
        string AzureStorageAccountId { get; set; }
