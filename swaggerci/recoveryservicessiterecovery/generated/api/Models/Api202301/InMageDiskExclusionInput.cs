...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class InMageDiskExclusionInput :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskExclusionInputInternal
    {

        /// <summary>Backing field for <see cref="DiskSignatureOption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskSignatureExclusionOptions[] _diskSignatureOption;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskSignatureExclusionOptions[] DiskSignatureOption { get => this._diskSignatureOption; set => this._diskSignatureOption = value; }

        /// <summary>Backing field for <see cref="VolumeOption" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageVolumeExclusionOptions[] _volumeOption;

        /// <summary>The volume label based option for disk exclusion.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageVolumeExclusionOptions[] VolumeOption { get => this._volumeOption; set => this._volumeOption = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageDiskSignatureExclusionOptions[] DiskSignatureOption { get; set; }
        /// <summary>The volume label based option for disk exclusion.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageVolumeExclusionOptions[] VolumeOption { get; set; }
