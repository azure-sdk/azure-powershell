...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorMessageParameters _errorMessageParameter;

        /// <summary>The error message parameters.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorMessageParameters ErrorMessageParameter { get => (this._errorMessageParameter = this._errorMessageParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.InMageFabricSwitchProviderBlockingErrorDetailsErrorMessageParameters()); }

        /// <summary>Backing field for <see cref="ErrorTag" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorTags _errorTag;

        /// <summary>The error tags.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorTags ErrorTag { get => (this._errorTag = this._errorTag ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.InMageFabricSwitchProviderBlockingErrorDetailsErrorTags()); }

        /// <summary>Internal Acessors for ErrorCode</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorTags Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsInternal.ErrorTag { get => (this._errorTag = this._errorTag ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.InMageFabricSwitchProviderBlockingErrorDetailsErrorTags()); set { {_errorTag = value;} } }

        /// <summary>Internal Acessors for PossibleCaus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsInternal.PossibleCaus { get => this._possibleCaus; set { {_possibleCaus = value;} } }

        /// <summary>Internal Acessors for RecommendedAction</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsInternal.RecommendedAction { get => this._recommendedAction; set { {_recommendedAction = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorMessageParameters ErrorMessageParameter { get;  }
        /// <summary>The error tags.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorTags ErrorTag { get;  }
        /// <summary>The possible causes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The error message parameters.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorMessageParameters ErrorMessageParameter { get; set; }
        /// <summary>The error tags.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IInMageFabricSwitchProviderBlockingErrorDetailsErrorTags ErrorTag { get; set; }
        /// <summary>The possible causes.</summary>
