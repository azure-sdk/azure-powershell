...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301
{
    ...
    public partial class VMwareCbtProtectionContainerMappingDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetails,
    ...
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IProtectionContainerMappingProviderSpecificDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IProtectionContainerMappingProviderSpecificDetails __protectionContainerMappingProviderSpecificDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.ProtectionContainerMappingProviderSpecificDetails();
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsInternal.KeyVaultId { get => this._keyVaultId; set { {_keyVaultId = value;} } }

        /// <summary>Internal Acessors for KeyVaultUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsInternal.KeyVaultUri { get => this._keyVaultUri; set { {_keyVaultUri = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsInternal.ServiceBusConnectionStringSecretName { get => this._serviceBusConnectionStringSecretName; set { {_serviceBusConnectionStringSecretName = value;} } }

        /// <summary>Internal Acessors for StorageAccountId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsInternal.StorageAccountId { get => this._storageAccountId; set { {_storageAccountId = value;} } }

        /// <summary>Internal Acessors for StorageAccountSasSecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsInternal.StorageAccountSasSecretName { get => this._storageAccountSasSecretName; set { {_storageAccountSasSecretName = value;} } }

        /// <summary>Internal Acessors for TargetLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsInternal.TargetLocation { get => this._targetLocation; set { {_targetLocation = value;} } }

        /// <summary>Backing field for <see cref="RoleSizeToNicCountMap" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap _roleSizeToNicCountMap;

        /// <summary>The role size to NIC count map.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap RoleSizeToNicCountMap { get => (this._roleSizeToNicCountMap = this._roleSizeToNicCountMap ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.VMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IProtectionContainerMappingProviderSpecificDetails
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap RoleSizeToNicCountMap { get;  }
        /// <summary>The secret name of the service bus connection string.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    internal partial interface IVMwareCbtProtectionContainerMappingDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IProtectionContainerMappingProviderSpecificDetailsInternal
    {
        /// <summary>The SKUs to be excluded.</summary>
        string[] ExcludedSku { get; set; }
        /// <summary>The target key vault ARM Id.</summary>
        ...
        /// <summary>The role size to NIC count map.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IVMwareCbtProtectionContainerMappingDetailsRoleSizeToNicCountMap RoleSizeToNicCountMap { get; set; }
        /// <summary>The secret name of the service bus connection string.</summary>
