...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401
{
    ...
    public partial class VMwareCbtProtectedDiskDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.CapacityInByte { get => this._capacityInByte; set { {_capacityInByte = value;} } }

        /// <summary>Internal Acessors for DiskEncryptionSetId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.DiskEncryptionSetId { get => this._diskEncryptionSetId; set { {_diskEncryptionSetId = value;} } }

        /// <summary>Internal Acessors for DiskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.DiskId { get => this._diskId; set { {_diskId = value;} } }

        /// <summary>Internal Acessors for DiskName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.DiskName { get => this._diskName; set { {_diskName = value;} } }

        /// <summary>Internal Acessors for DiskPath</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.DiskPath { get => this._diskPath; set { {_diskPath = value;} } }

        /// <summary>Internal Acessors for IsOSDisk</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.IsOSDisk { get => this._isOSDisk; set { {_isOSDisk = value;} } }

        /// <summary>Internal Acessors for LogStorageAccountId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.LogStorageAccountId { get => this._logStorageAccountId; set { {_logStorageAccountId = value;} } }

        /// <summary>Internal Acessors for LogStorageAccountSasSecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.LogStorageAccountSasSecretName { get => this._logStorageAccountSasSecretName; set { {_logStorageAccountSasSecretName = value;} } }

        /// <summary>Internal Acessors for SeedManagedDiskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.SeedManagedDiskId { get => this._seedManagedDiskId; set { {_seedManagedDiskId = value;} } }

        /// <summary>Internal Acessors for TargetManagedDiskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVMwareCbtProtectedDiskDetailsInternal.TargetManagedDiskId { get => this._targetManagedDiskId; set { {_targetManagedDiskId = value;} } }
