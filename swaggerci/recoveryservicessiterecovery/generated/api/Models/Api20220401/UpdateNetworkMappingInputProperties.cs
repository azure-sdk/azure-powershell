...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401
{
    ...
    public partial class UpdateNetworkMappingInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IUpdateNetworkMappingInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IUpdateNetworkMappingInputPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IFabricSpecificUpdateNetworkMappingInput _fabricSpecificDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IFabricSpecificUpdateNetworkMappingInput FabricSpecificDetail { get => (this._fabricSpecificDetail = this._fabricSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.FabricSpecificUpdateNetworkMappingInput()); set => this._fabricSpecificDetail = value; }
        ...
        public string FabricSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IFabricSpecificUpdateNetworkMappingInputInternal)FabricSpecificDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IFabricSpecificUpdateNetworkMappingInputInternal)FabricSpecificDetail).InstanceType = value ?? null; }

        /// <summary>Internal Acessors for FabricSpecificDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IFabricSpecificUpdateNetworkMappingInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IUpdateNetworkMappingInputPropertiesInternal.FabricSpecificDetail { get => (this._fabricSpecificDetail = this._fabricSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.FabricSpecificUpdateNetworkMappingInput()); set { {_fabricSpecificDetail = value;} } }
