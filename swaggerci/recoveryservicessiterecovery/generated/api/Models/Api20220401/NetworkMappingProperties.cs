...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401
{
    ...
    public partial class NetworkMappingProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingFabricSpecificSettings _fabricSpecificSetting;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.NetworkMappingFabricSpecificSettings()); set => this._fabricSpecificSetting = value; }
        ...
        public string FabricSpecificSettingInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingFabricSpecificSettingsInternal)FabricSpecificSetting).InstanceType = value ?? null; }

        /// <summary>Internal Acessors for FabricSpecificSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingFabricSpecificSettings Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.INetworkMappingPropertiesInternal.FabricSpecificSetting { get => (this._fabricSpecificSetting = this._fabricSpecificSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.NetworkMappingFabricSpecificSettings()); set { {_fabricSpecificSetting = value;} } }
