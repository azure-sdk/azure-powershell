...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401
{
    ...
    public partial class CreateProtectionContainerMappingInputProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.ICreateProtectionContainerMappingInputProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.ICreateProtectionContainerMappingInputPropertiesInternal
    {

        /// <summary>Internal Acessors for ProviderSpecificInput</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IReplicationProviderSpecificContainerMappingInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.ICreateProtectionContainerMappingInputPropertiesInternal.ProviderSpecificInput { get => (this._providerSpecificInput = this._providerSpecificInput ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.ReplicationProviderSpecificContainerMappingInput()); set { {_providerSpecificInput = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IReplicationProviderSpecificContainerMappingInput _providerSpecificInput;

        /// <summary>Provider specific input for pairing.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IReplicationProviderSpecificContainerMappingInput ProviderSpecificInput { get => (this._providerSpecificInput = this._providerSpecificInput ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.ReplicationProviderSpecificContainerMappingInput()); set => this._providerSpecificInput = value; }
...

    {
        ...
        string PolicyId { get; set; }
        /// <summary>Provider specific input for pairing.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IReplicationProviderSpecificContainerMappingInput ProviderSpecificInput { get; set; }
        /// <summary>The class type.</summary>
        string ProviderSpecificInputInstanceType { get; set; }
        /// <summary>The target unique protection container name.</summary>
        string TargetProtectionContainerId { get; set; }
