...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201
{
    ...
    public partial class InMageRcmEventDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for ComponentDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.ComponentDisplayName { get => this._componentDisplayName; set { {_componentDisplayName = value;} } }

        /// <summary>Internal Acessors for FabricName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.FabricName { get => this._fabricName; set { {_fabricName = value;} } }

        /// <summary>Internal Acessors for JobId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.JobId { get => this._jobId; set { {_jobId = value;} } }

        /// <summary>Internal Acessors for LatestAgentVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.LatestAgentVersion { get => this._latestAgentVersion; set { {_latestAgentVersion = value;} } }

        /// <summary>Internal Acessors for ProtectedItemName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.ProtectedItemName { get => this._protectedItemName; set { {_protectedItemName = value;} } }

        /// <summary>Internal Acessors for ServerType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.ServerType { get => this._serverType; set { {_serverType = value;} } }

        /// <summary>Internal Acessors for VMName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IInMageRcmEventDetailsInternal.VMName { get => this._vMName; set { {_vMName = value;} } }
