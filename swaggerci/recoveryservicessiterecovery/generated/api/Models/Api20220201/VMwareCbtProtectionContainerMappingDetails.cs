...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201
{
    ...
    public partial class VMwareCbtProtectionContainerMappingDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMappingProviderSpecificDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMappingProviderSpecificDetails __protectionContainerMappingProviderSpecificDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ProtectionContainerMappingProviderSpecificDetails();
        ...
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMappingProviderSpecificDetailsInternal)__protectionContainerMappingProviderSpecificDetails).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMappingProviderSpecificDetailsInternal)__protectionContainerMappingProviderSpecificDetails).InstanceType = value ; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal.KeyVaultId { get => this._keyVaultId; set { {_keyVaultId = value;} } }

        /// <summary>Internal Acessors for KeyVaultUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal.KeyVaultUri { get => this._keyVaultUri; set { {_keyVaultUri = value;} } }

        /// <summary>Internal Acessors for ServiceBusConnectionStringSecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal.ServiceBusConnectionStringSecretName { get => this._serviceBusConnectionStringSecretName; set { {_serviceBusConnectionStringSecretName = value;} } }

        /// <summary>Internal Acessors for StorageAccountId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal.StorageAccountId { get => this._storageAccountId; set { {_storageAccountId = value;} } }

        /// <summary>Internal Acessors for StorageAccountSasSecretName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal.StorageAccountSasSecretName { get => this._storageAccountSasSecretName; set { {_storageAccountSasSecretName = value;} } }

        /// <summary>Internal Acessors for TargetLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVMwareCbtProtectionContainerMappingDetailsInternal.TargetLocation { get => this._targetLocation; set { {_targetLocation = value;} } }
    ...
    public partial interface IVMwareCbtProtectionContainerMappingDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMappingProviderSpecificDetails
    {
        /// <summary>The target key vault ARM Id.</summary>
    ...
    internal partial interface IVMwareCbtProtectionContainerMappingDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMappingProviderSpecificDetailsInternal
    {
        /// <summary>The target key vault ARM Id.</summary>
