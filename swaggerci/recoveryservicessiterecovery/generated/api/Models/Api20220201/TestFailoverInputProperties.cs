...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201
{
    ...
    public partial class TestFailoverInputProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverInputPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverProviderSpecificInput Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverInputPropertiesInternal.ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.TestFailoverProviderSpecificInput()); set { {_providerSpecificDetail = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverProviderSpecificInput _providerSpecificDetail;

        /// <summary>Provider specific settings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverProviderSpecificInput ProviderSpecificDetail { get => (this._providerSpecificDetail = this._providerSpecificDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.TestFailoverProviderSpecificInput()); set => this._providerSpecificDetail = value; }
        ...
        public string ProviderSpecificDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverProviderSpecificInputInternal)ProviderSpecificDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverProviderSpecificInputInternal)ProviderSpecificDetail).InstanceType = value ?? null; }
