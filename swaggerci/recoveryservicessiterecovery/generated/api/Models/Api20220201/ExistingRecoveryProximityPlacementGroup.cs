...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201
{
    ...
    public partial class ExistingRecoveryProximityPlacementGroup :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IExistingRecoveryProximityPlacementGroup,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IExistingRecoveryProximityPlacementGroupInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryProximityPlacementGroupCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryProximityPlacementGroupCustomDetails __recoveryProximityPlacementGroupCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.RecoveryProximityPlacementGroupCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryProximityPlacementGroupCustomDetailsInternal)__recoveryProximityPlacementGroupCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryProximityPlacementGroupCustomDetailsInternal)__recoveryProximityPlacementGroupCustomDetails).ResourceType = value ; }
    ...
    public partial interface IExistingRecoveryProximityPlacementGroup :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryProximityPlacementGroupCustomDetails
    {
        /// <summary>
        /// The recovery proximity placement group Id. Will throw error, if resource does not exist.
        /// </summary>
    ...
    internal partial interface IExistingRecoveryProximityPlacementGroupInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryProximityPlacementGroupCustomDetailsInternal
    {
        /// <summary>
        /// The recovery proximity placement group Id. Will throw error, if resource does not exist.
        /// </summary>
