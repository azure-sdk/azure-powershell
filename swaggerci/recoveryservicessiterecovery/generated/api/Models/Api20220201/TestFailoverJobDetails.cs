...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201
{
    ...
    public partial class TestFailoverJobDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverJobDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ITestFailoverJobDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetails __jobDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.JobDetails();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetailsAffectedObjectDetails AffectedObjectDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetailsInternal)__jobDetails).AffectedObjectDetail; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetailsInternal)__jobDetails).AffectedObjectDetail = value ?? null /* model class */; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Inherited)]
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetailsInternal)__jobDetails).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetailsInternal)__jobDetails).InstanceType = value ; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IFailoverReplicationProtectedItemDetails[] _protectedItemDetail;

        /// <summary>The test VM details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IFailoverReplicationProtectedItemDetails[] ProtectedItemDetail { get => this._protectedItemDetail; set => this._protectedItemDetail = value; }
    ...
    public partial interface ITestFailoverJobDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetails
    {
        /// <summary>The test failover comments.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IFailoverReplicationProtectedItemDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IFailoverReplicationProtectedItemDetails[] ProtectedItemDetail { get; set; }
        /// <summary>The test failover status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface ITestFailoverJobDetailsInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobDetailsInternal
    {
        /// <summary>The test failover comments.</summary>
        string Comment { get; set; }
        /// <summary>The test network friendly name.</summary>
