...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910
{
    ...
    public partial class InMageAzureV2SwitchProviderDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IInMageAzureV2SwitchProviderDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IInMageAzureV2SwitchProviderDetailsInternal
    {

        /// <summary>Internal Acessors for TargetApplianceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IInMageAzureV2SwitchProviderDetailsInternal.TargetApplianceId { get => this._targetApplianceId; set { {_targetApplianceId = value;} } }

        /// <summary>Internal Acessors for TargetFabricId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IInMageAzureV2SwitchProviderDetailsInternal.TargetFabricId { get => this._targetFabricId; set { {_targetFabricId = value;} } }

        /// <summary>Internal Acessors for TargetResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IInMageAzureV2SwitchProviderDetailsInternal.TargetResourceId { get => this._targetResourceId; set { {_targetResourceId = value;} } }

        /// <summary>Internal Acessors for TargetVaultId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IInMageAzureV2SwitchProviderDetailsInternal.TargetVaultId { get => this._targetVaultId; set { {_targetVaultId = value;} } }
