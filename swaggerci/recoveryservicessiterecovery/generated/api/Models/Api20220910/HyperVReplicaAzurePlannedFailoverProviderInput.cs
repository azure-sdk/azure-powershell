...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910
{
    ...
    public partial class HyperVReplicaAzurePlannedFailoverProviderInput :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IHyperVReplicaAzurePlannedFailoverProviderInput,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IHyperVReplicaAzurePlannedFailoverProviderInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IPlannedFailoverProviderSpecificFailoverInput"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IPlannedFailoverProviderSpecificFailoverInput __plannedFailoverProviderSpecificFailoverInput = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.PlannedFailoverProviderSpecificFailoverInput();
        ...
        public string InstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IPlannedFailoverProviderSpecificFailoverInputInternal)__plannedFailoverProviderSpecificFailoverInput).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IPlannedFailoverProviderSpecificFailoverInputInternal)__plannedFailoverProviderSpecificFailoverInput).InstanceType = value ; }
    ...
    public partial interface IHyperVReplicaAzurePlannedFailoverProviderInput :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IPlannedFailoverProviderSpecificFailoverInput
    {
        /// <summary>Primary kek certificate pfx.</summary>
    ...
    internal partial interface IHyperVReplicaAzurePlannedFailoverProviderInputInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IPlannedFailoverProviderSpecificFailoverInputInternal
    {
        /// <summary>Primary kek certificate pfx.</summary>
        string PrimaryKekCertificatePfx { get; set; }
        /// <summary>
