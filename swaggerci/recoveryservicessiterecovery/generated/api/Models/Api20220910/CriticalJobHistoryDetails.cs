...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910
{
    ...
    public partial class CriticalJobHistoryDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.ICriticalJobHistoryDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.ICriticalJobHistoryDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.ICriticalJobHistoryDetailsInternal.JobId { get => this._jobId; set { {_jobId = value;} } }

        /// <summary>Internal Acessors for JobName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.ICriticalJobHistoryDetailsInternal.JobName { get => this._jobName; set { {_jobName = value;} } }

        /// <summary>Internal Acessors for JobStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.ICriticalJobHistoryDetailsInternal.JobStatus { get => this._jobStatus; set { {_jobStatus = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.ICriticalJobHistoryDetailsInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }
