...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910
{
    ...
    public partial class ExistingRecoveryVirtualNetwork :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IExistingRecoveryVirtualNetwork,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IExistingRecoveryVirtualNetworkInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryVirtualNetworkCustomDetails"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryVirtualNetworkCustomDetails __recoveryVirtualNetworkCustomDetails = new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.RecoveryVirtualNetworkCustomDetails();
        ...
        public string ResourceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryVirtualNetworkCustomDetailsInternal)__recoveryVirtualNetworkCustomDetails).ResourceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryVirtualNetworkCustomDetailsInternal)__recoveryVirtualNetworkCustomDetails).ResourceType = value ; }
    ...
    public partial interface IExistingRecoveryVirtualNetwork :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryVirtualNetworkCustomDetails
    {
        /// <summary>The recovery subnet name.</summary>
    ...
    internal partial interface IExistingRecoveryVirtualNetworkInternal :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryVirtualNetworkCustomDetailsInternal
    {
        /// <summary>The recovery subnet name.</summary>
        string RecoverySubnetName { get; set; }
        /// <summary>The recovery virtual network Id. Will throw error, if resource does not exist.</summary>
