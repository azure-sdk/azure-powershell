...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501
{
    ...
    public partial class VMwareV2FabricSpecificDetails :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetails,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.MigrationSolutionId { get => this._migrationSolutionId; set { {_migrationSolutionId = value;} } }

        /// <summary>Internal Acessors for PhysicalSiteId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.PhysicalSiteId { get => this._physicalSiteId; set { {_physicalSiteId = value;} } }

        /// <summary>Internal Acessors for ProcessServer</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IProcessServerDetails[] Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.ProcessServer { get => this._processServer; set { {_processServer = value;} } }

        /// <summary>Internal Acessors for ServiceContainerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.ServiceContainerId { get => this._serviceContainerId; set { {_serviceContainerId = value;} } }

        /// <summary>Internal Acessors for ServiceEndpoint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.ServiceEndpoint { get => this._serviceEndpoint; set { {_serviceEndpoint = value;} } }

        /// <summary>Internal Acessors for ServiceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.ServiceResourceId { get => this._serviceResourceId; set { {_serviceResourceId = value;} } }

        /// <summary>Internal Acessors for VmwareSiteId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IVMwareV2FabricSpecificDetailsInternal.VmwareSiteId { get => this._vmwareSiteId; set { {_vmwareSiteId = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IProcessServerDetails[] ProcessServer { get => this._processServer; }
