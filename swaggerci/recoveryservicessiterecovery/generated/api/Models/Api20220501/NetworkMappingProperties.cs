...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501
{
    ...
    public partial class NetworkMappingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.INetworkMappingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.INetworkMappingPropertiesInternal
    {

        /// <summary>Backing field for <see cref="FabricSpecificSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.INetworkMappingFabricSpecificSettings _fabricSpecificSetting;
    ...
    {
        /// <summary>The fabric specific settings.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.INetworkMappingFabricSpecificSettings FabricSpecificSetting { get; set; }
        /// <summary>Gets the Instance type.</summary>
        string FabricSpecificSettingInstanceType { get; set; }
        /// <summary>The primary fabric friendly name.</summary>
        string PrimaryFabricFriendlyName { get; set; }
