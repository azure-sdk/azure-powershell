...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501
{
    ...
    public partial class AsrTask :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTask,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTaskInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ITaskTypeDetails _customDetail;

        /// <summary>The custom task details based on the task type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ITaskTypeDetails CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.TaskTypeDetails()); set => this._customDetail = value; }
        ...
        public string CustomDetailInstanceType { get => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ITaskTypeDetailsInternal)CustomDetail).InstanceType; set => ((Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ITaskTypeDetailsInternal)CustomDetail).InstanceType = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IJobErrorDetails[] _error;

        /// <summary>The task error details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IJobErrorDetails[] Error { get => this._error; set => this._error = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IGroupTaskDetails _groupTaskCustomDetail;
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ITaskTypeDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTaskInternal.CustomDetail { get => (this._customDetail = this._customDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.TaskTypeDetails()); set { {_customDetail = value;} } }

        /// <summary>Internal Acessors for GroupTaskCustomDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IGroupTaskDetails Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTaskInternal.GroupTaskCustomDetail { get => (this._groupTaskCustomDetail = this._groupTaskCustomDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.GroupTaskDetails()); set { {_groupTaskCustomDetail = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IJobErrorDetails) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IJobErrorDetails[] Error { get; set; }
        /// <summary>The name.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTask) })]
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTask[] GroupTaskCustomDetailChildTask { get; set; }
        /// <summary>The type of task details.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string[] AllowedAction { get; set; }
        /// <summary>The custom task details based on the task type.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ITaskTypeDetails CustomDetail { get; set; }
        /// <summary>The type of task details.</summary>
        string CustomDetailInstanceType { get; set; }
        /// <summary>The end time.</summary>
        global::System.DateTime? EndTime { get; set; }
        ...
        /// it.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IGroupTaskDetails GroupTaskCustomDetail { get; set; }
        /// <summary>The child tasks.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IAsrTask[] GroupTaskCustomDetailChildTask { get; set; }
        /// <summary>The type of task details.</summary>
        string GroupTaskCustomDetailInstanceType { get; set; }
