...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501
{
    ...
    public partial class ResourceHealthSummary :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IResourceHealthSummary,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IResourceHealthSummaryInternal
    {

        /// <summary>Backing field for <see cref="CategorizedResourceCount" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IResourceHealthSummaryCategorizedResourceCounts _categorizedResourceCount;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IResourceHealthSummaryCategorizedResourceCounts CategorizedResourceCount { get => (this._categorizedResourceCount = this._categorizedResourceCount ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.ResourceHealthSummaryCategorizedResourceCounts()); set => this._categorizedResourceCount = value; }

        /// <summary>Backing field for <see cref="Issue" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IHealthErrorSummary[] _issue;

        /// <summary>The list of summary of health errors across the resources under the container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IHealthErrorSummary[] Issue { get => this._issue; set => this._issue = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IResourceHealthSummaryCategorizedResourceCounts CategorizedResourceCount { get; set; }
        /// <summary>The list of summary of health errors across the resources under the container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IHealthErrorSummary[] Issue { get; set; }
        /// <summary>The count of total resources under the container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.Info(
        Required = false,
        ReadOnly = false,
