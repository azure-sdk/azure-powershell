...
namespace Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501
{
    ...
    public partial class InMageRcmFabricCreationInput :
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IInMageRcmFabricCreationInput,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IInMageRcmFabricCreationInputInternal,
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IIdentityProviderInput _sourceAgentIdentity;

        /// <summary>The identity provider input for source agent authentication.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Origin(Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IIdentityProviderInput SourceAgentIdentity { get => (this._sourceAgentIdentity = this._sourceAgentIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IdentityProviderInput()); set => this._sourceAgentIdentity = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IFabricSpecificCreationInputInternal
    {
        ...
        string PhysicalSiteId { get; set; }
        /// <summary>The identity provider input for source agent authentication.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IIdentityProviderInput SourceAgentIdentity { get; set; }
        /// <summary>The base authority for Azure Active Directory authentication.</summary>
        string SourceAgentIdentityAadAuthority { get; set; }
        /// <summary>
        /// The application/client Id for the service principal with which the on-premise management/data plane components would communicate
