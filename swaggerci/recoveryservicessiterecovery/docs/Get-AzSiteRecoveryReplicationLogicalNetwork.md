...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationlogicalnetwork
schema: 2.0.0
---
...
### List (Default)
```
Get-AzSiteRecoveryReplicationLogicalNetwork -FabricName <String> -ResourceGroupName <String>
 -ResourceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSiteRecoveryReplicationLogicalNetwork -FabricName <String> -LogicalNetworkName <String>
...
### GetViaIdentity
```
Get-AzSiteRecoveryReplicationLogicalNetwork -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.ILogicalNetwork
