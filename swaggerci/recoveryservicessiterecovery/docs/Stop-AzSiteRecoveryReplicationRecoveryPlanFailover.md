...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/stop-azsiterecoveryreplicationrecoveryplanfailover
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzSiteRecoveryReplicationRecoveryPlanFailover -RecoveryPlanName <String> -ResourceGroupName <String>
...
### CancelViaIdentity
```
Stop-AzSiteRecoveryReplicationRecoveryPlanFailover -InputObject <ISiteRecoveryIdentity>
