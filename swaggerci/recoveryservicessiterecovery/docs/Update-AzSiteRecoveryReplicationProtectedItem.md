...
```
Update-AzSiteRecoveryReplicationProtectedItem -FabricName <String> -Name <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20221001.IVMNicInputDetails[]
Parameter Sets: (All)
Aliases:
