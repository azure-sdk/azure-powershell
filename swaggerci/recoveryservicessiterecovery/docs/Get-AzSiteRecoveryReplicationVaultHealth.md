...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationvaulthealth
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzSiteRecoveryReplicationVaultHealth -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSiteRecoveryReplicationVaultHealth -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVaultHealthDetails
