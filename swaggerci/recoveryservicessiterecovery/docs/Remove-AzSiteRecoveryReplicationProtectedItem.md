...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationprotecteditem
schema: 2.0.0
---
...
```
Remove-AzSiteRecoveryReplicationProtectedItem -FabricName <String> -Name <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20221001.IDisableProtectionInput
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20221001.IDisableProtectionInput
