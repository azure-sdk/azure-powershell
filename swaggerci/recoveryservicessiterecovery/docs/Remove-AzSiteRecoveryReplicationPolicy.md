...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationpolicy
schema: 2.0.0
---

# Remove-AzSiteRecoveryReplicationPolicy
...
### Delete (Default)
```
Remove-AzSiteRecoveryReplicationPolicy -PolicyName <String> -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzSiteRecoveryReplicationPolicy -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
