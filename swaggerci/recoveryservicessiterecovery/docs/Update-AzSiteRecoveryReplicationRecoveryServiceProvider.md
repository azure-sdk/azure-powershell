...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationrecoveryserviceprovider
schema: 2.0.0
---
...
### Refresh (Default)
```
Update-AzSiteRecoveryReplicationRecoveryServiceProvider -FabricName <String> -ProviderName <String>
...
### RefreshViaIdentity
```
Update-AzSiteRecoveryReplicationRecoveryServiceProvider -InputObject <ISiteRecoveryIdentity>
