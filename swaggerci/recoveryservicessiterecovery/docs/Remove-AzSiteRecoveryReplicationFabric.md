...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationfabric
schema: 2.0.0
---

# Remove-AzSiteRecoveryReplicationFabric
...
### Delete (Default)
```
Remove-AzSiteRecoveryReplicationFabric -FabricName <String> -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzSiteRecoveryReplicationFabric -InputObject <ISiteRecoveryIdentity> [-DefaultProfile <PSObject>]
