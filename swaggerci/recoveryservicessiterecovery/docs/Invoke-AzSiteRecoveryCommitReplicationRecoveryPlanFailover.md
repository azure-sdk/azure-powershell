...
online version: https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/invoke-azsiterecoverycommitreplicationrecoveryplanfailover
schema: 2.0.0
---

# Invoke-AzSiteRecoveryCommitReplicationRecoveryPlanFailover
...
### Commit (Default)
```
Invoke-AzSiteRecoveryCommitReplicationRecoveryPlanFailover -RecoveryPlanName <String>
...
### CommitViaIdentity
```
Invoke-AzSiteRecoveryCommitReplicationRecoveryPlanFailover -InputObject <ISiteRecoveryIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryPlan
