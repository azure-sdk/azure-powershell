...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IRecoveryPlanUnplannedFailoverInput
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IRecoveryPlanProviderSpecificFailoverInput[]
Parameter Sets: UnplannedExpanded, UnplannedViaIdentityExpanded
Aliases:
