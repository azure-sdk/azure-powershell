...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryPlanUnplannedFailoverInput
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IRecoveryPlanProviderSpecificFailoverInput[]
Parameter Sets: UnplannedExpanded, UnplannedViaIdentityExpanded
Aliases:
