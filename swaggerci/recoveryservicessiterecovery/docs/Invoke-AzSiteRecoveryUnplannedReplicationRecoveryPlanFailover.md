...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanUnplannedFailoverInput
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220801.IRecoveryPlanProviderSpecificFailoverInput[]
Parameter Sets: UnplannedExpanded, UnplannedViaIdentityExpanded
Aliases:
