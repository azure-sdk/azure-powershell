...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IRecoveryPlanUnplannedFailoverInput
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220501.IRecoveryPlanProviderSpecificFailoverInput[]
Parameter Sets: UnplannedExpanded, UnplannedViaIdentityExpanded
Aliases:
