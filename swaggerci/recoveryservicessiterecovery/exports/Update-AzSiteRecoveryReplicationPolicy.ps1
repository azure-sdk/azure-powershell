...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationpolicy
#>
function Update-AzSiteRecoveryReplicationPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IPolicy])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationPolicy_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationPolicy_UpdateViaIdentityExpanded';
        }
