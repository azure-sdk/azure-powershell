...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/get-azsiterecoveryreplicationstorageclassificationmapping
#>
function Get-AzSiteRecoveryReplicationStorageClassificationMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20221001.IStorageClassificationMapping])]
