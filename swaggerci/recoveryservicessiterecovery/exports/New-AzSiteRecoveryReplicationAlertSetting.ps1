...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationalertsetting
#>
function New-AzSiteRecoveryReplicationAlertSetting {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationAlertSetting_CreateExpanded';
        }
