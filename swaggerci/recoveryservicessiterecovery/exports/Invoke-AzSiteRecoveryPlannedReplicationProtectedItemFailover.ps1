...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/invoke-azsiterecoveryplannedreplicationprotecteditemfailover
#>
function Invoke-AzSiteRecoveryPlannedReplicationProtectedItemFailover {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IReplicationProtectedItem])]
