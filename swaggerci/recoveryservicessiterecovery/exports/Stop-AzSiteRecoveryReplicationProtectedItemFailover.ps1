...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/stop-azsiterecoveryreplicationprotecteditemfailover
#>
function Stop-AzSiteRecoveryReplicationProtectedItemFailover {
...
begin {
    try {
        ...
        $mapping = @{
            Cancel = 'Az.SiteRecovery.private\Stop-AzSiteRecoveryReplicationProtectedItemFailover_Cancel';
            CancelViaIdentity = 'Az.SiteRecovery.private\Stop-AzSiteRecoveryReplicationProtectedItemFailover_CancelViaIdentity';
        }
