...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationlogicalnetwork
#>
function Get-AzSiteRecoveryReplicationLogicalNetwork {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.ILogicalNetwork])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            GetViaIdentity = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationLogicalNetwork_GetViaIdentity';
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationLogicalNetwork_List';
        }
