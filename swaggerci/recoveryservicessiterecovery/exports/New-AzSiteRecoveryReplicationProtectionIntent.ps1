...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IReplicationProtectionIntent
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationprotectionintent
#>
function New-AzSiteRecoveryReplicationProtectionIntent {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IReplicationProtectionIntent])]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationProtectionIntent_CreateExpanded';
        }
