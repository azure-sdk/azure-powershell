...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationprotectioncontainermapping
#>
function Get-AzSiteRecoveryReplicationProtectionContainerMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IProtectionContainerMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionContainerMapping_List';
            List1 = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationProtectionContainerMapping_List1';
        }
