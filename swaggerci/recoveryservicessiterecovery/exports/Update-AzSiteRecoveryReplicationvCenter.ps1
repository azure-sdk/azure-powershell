...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationvcenter
#>
function Update-AzSiteRecoveryReplicationvCenter {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IVCenter])]
