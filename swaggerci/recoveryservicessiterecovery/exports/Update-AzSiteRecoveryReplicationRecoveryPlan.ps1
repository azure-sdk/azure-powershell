...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationrecoveryplan
#>
function Update-AzSiteRecoveryReplicationRecoveryPlan {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationRecoveryPlan_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationRecoveryPlan_UpdateViaIdentityExpanded';
        }
