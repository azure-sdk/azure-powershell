...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20221001.IUnplannedFailoverInput
.Inputs
...
.Link
https://learn.microsoft.com/powershell/module/az.siterecovery/invoke-azsiterecoveryunplannedreplicationprotecteditemfailover
#>
