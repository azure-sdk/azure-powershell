...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationnetworkmapping
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationNetworkMapping_Delete';
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationNetworkMapping_DeleteViaIdentity';
        }
