...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IAddDisksInput
.Inputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/add-azsiterecoveryreplicationprotecteditemdisk
#>
function Add-AzSiteRecoveryReplicationProtectedItemDisk {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            AddExpanded = 'Az.SiteRecovery.private\Add-AzSiteRecoveryReplicationProtectedItemDisk_AddExpanded';
            AddViaIdentity = 'Az.SiteRecovery.private\Add-AzSiteRecoveryReplicationProtectedItemDisk_AddViaIdentity';
