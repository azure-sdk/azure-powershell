...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationstorageclassificationmapping
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationStorageClassificationMapping_Delete';
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationStorageClassificationMapping_DeleteViaIdentity';
        }
