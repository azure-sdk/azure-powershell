...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationprotecteditem
#>
function New-AzSiteRecoveryReplicationProtectedItem {
...
param(
    ...
    [Parameter(Mandatory)]
    [Alias('ReplicationProtectedItemName')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Path')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationProtectedItem_CreateExpanded';
        }
