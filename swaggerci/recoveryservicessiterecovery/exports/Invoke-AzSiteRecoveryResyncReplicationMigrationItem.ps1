...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/invoke-azsiterecoveryresyncreplicationmigrationitem
#>
function Invoke-AzSiteRecoveryResyncReplicationMigrationItem {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IMigrationItem])]
