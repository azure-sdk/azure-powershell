...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IReplicationEligibilityResults
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api202301.IReplicationEligibilityResults])]
