...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationpolicy
#>
function Remove-AzSiteRecoveryReplicationPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationPolicy_Delete';
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationPolicy_DeleteViaIdentity';
        }
