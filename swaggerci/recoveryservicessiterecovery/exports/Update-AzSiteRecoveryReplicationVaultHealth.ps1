...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationvaulthealth
#>
function Update-AzSiteRecoveryReplicationVaultHealth {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IVaultHealthDetails])]
