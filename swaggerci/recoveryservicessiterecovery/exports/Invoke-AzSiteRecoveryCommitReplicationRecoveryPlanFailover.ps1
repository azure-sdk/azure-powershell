...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/invoke-azsiterecoverycommitreplicationrecoveryplanfailover
#>
...
begin {
    try {
        ...
        $mapping = @{
            Commit = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryCommitReplicationRecoveryPlanFailover_Commit';
            CommitViaIdentity = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryCommitReplicationRecoveryPlanFailover_CommitViaIdentity';
        }
