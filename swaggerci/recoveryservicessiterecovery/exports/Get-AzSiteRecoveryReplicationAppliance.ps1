...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IReplicationAppliance
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationappliance
#>
function Get-AzSiteRecoveryReplicationAppliance {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.IReplicationAppliance])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.SiteRecovery.private\Get-AzSiteRecoveryReplicationAppliance_List';
        }
