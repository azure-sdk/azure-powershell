...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/clear-azsiterecoveryreplicationfabric
#>
...
begin {
    try {
        ...
        $mapping = @{
            Purge = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationFabric_Purge';
            PurgeViaIdentity = 'Az.SiteRecovery.private\Clear-AzSiteRecoveryReplicationFabric_PurgeViaIdentity';
        }
