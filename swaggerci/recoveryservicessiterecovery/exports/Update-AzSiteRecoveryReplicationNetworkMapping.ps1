...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.INetworkMapping
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/update-azsiterecoveryreplicationnetworkmapping
#>
function Update-AzSiteRecoveryReplicationNetworkMapping {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.INetworkMapping])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationNetworkMapping_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.SiteRecovery.private\Update-AzSiteRecoveryReplicationNetworkMapping_UpdateViaIdentityExpanded';
        }
