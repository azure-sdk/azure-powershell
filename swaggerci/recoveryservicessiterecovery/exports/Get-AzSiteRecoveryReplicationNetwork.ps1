...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.INetwork
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/get-azsiterecoveryreplicationnetwork
#>
function Get-AzSiteRecoveryReplicationNetwork {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220301.INetwork])]
