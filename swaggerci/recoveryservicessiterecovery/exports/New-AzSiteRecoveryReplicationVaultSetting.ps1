...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/new-azsiterecoveryreplicationvaultsetting
#>
function New-AzSiteRecoveryReplicationVaultSetting {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.SiteRecovery.private\New-AzSiteRecoveryReplicationVaultSetting_CreateExpanded';
        }
