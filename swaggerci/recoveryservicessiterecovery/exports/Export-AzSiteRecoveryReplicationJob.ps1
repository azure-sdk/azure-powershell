...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJobQueryParameter
.Inputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/export-azsiterecoveryreplicationjob
#>
function Export-AzSiteRecoveryReplicationJob {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IJob])]
...
param(
    ...
    [Parameter(ParameterSetName='ExportExpanded')]
    [Parameter(ParameterSetName='ExportViaIdentityExpanded')]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ExportJobOutputSerializationType])]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Support.ExportJobOutputSerializationType]
...
begin {
    try {
        ...
        $mapping = @{
            Export = 'Az.SiteRecovery.private\Export-AzSiteRecoveryReplicationJob_Export';
            ExportExpanded = 'Az.SiteRecovery.private\Export-AzSiteRecoveryReplicationJob_ExportExpanded';
            ExportViaIdentity = 'Az.SiteRecovery.private\Export-AzSiteRecoveryReplicationJob_ExportViaIdentity';
            ExportViaIdentityExpanded = 'Az.SiteRecovery.private\Export-AzSiteRecoveryReplicationJob_ExportViaIdentityExpanded';
        }
