...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/stop-azsiterecoveryreplicationjob
#>
function Stop-AzSiteRecoveryReplicationJob {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            CancelViaIdentity = 'Az.SiteRecovery.private\Stop-AzSiteRecoveryReplicationJob_CancelViaIdentity';
        }
