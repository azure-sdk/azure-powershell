...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/suspend-azsiterecoveryreplicationmigrationitemreplication
#>
function Suspend-AzSiteRecoveryReplicationMigrationItemReplication {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220910.IMigrationItem])]
...
param(
    ...
    [Parameter(ParameterSetName='Pause', Mandatory, ValueFromPipeline)]
    [Parameter(ParameterSetName='PauseViaIdentity', Mandatory, ValueFromPipeline)]
    ...
    [Parameter(ParameterSetName='PauseExpanded', Mandatory)]
    [Parameter(ParameterSetName='PauseViaIdentityExpanded', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [System.String]
    # The class type.
    ${InstanceType},
...
begin {
    try {
        ...
        $mapping = @{
            ...
            PauseViaIdentity = 'Az.SiteRecovery.private\Suspend-AzSiteRecoveryReplicationMigrationItemReplication_PauseViaIdentity';
            PauseViaIdentityExpanded = 'Az.SiteRecovery.private\Suspend-AzSiteRecoveryReplicationMigrationItemReplication_PauseViaIdentityExpanded';
        }
        if (('Pause', 'PauseExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
