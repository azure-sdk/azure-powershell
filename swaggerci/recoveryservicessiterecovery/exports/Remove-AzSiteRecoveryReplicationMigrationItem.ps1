...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/remove-azsiterecoveryreplicationmigrationitem
#>
function Remove-AzSiteRecoveryReplicationMigrationItem {
...
begin {
    try {
        ...
        $mapping = @{
            ...
            DeleteViaIdentity = 'Az.SiteRecovery.private\Remove-AzSiteRecoveryReplicationMigrationItem_DeleteViaIdentity';
        }
