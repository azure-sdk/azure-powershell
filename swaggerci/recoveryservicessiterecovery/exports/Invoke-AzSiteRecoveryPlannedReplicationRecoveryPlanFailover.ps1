...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryPlanPlannedFailoverInput
.Inputs
...
PROVIDERSPECIFICDETAIL <IRecoveryPlanProviderSpecificFailoverInput[]>: The provider specific properties.
  InstanceType <String>: The class type.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.siterecovery/invoke-azsiterecoveryplannedreplicationrecoveryplanfailover
#>
function Invoke-AzSiteRecoveryPlannedReplicationRecoveryPlanFailover {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryPlan])]
...
param(
    ...
    [Parameter(ParameterSetName='PlannedExpanded')]
    [Parameter(ParameterSetName='PlannedViaIdentityExpanded')]
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220201.IRecoveryPlanProviderSpecificFailoverInput[]]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            PlannedViaIdentityExpanded = 'Az.SiteRecovery.private\Invoke-AzSiteRecoveryPlannedReplicationRecoveryPlanFailover_PlannedViaIdentityExpanded';
        }
