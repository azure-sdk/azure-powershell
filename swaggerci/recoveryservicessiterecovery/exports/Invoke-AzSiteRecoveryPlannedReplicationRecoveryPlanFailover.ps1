...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IRecoveryPlanPlannedFailoverInput
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SiteRecovery.Models.Api20220401.IRecoveryPlan])]
