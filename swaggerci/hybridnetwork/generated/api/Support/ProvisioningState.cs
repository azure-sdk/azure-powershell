...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState Unknown = @"Unknown";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.HybridNetwork.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
