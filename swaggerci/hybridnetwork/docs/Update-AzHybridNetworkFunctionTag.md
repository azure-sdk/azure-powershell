...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/update-azhybridnetworkfunctiontag
schema: 2.0.0
---
...
```
Update-AzHybridNetworkFunctionTag -NetworkFunctionName <String> -ResourceGroupName <String>
...
```
Update-AzHybridNetworkFunctionTag -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
