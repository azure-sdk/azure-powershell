...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/update-azhybridnetworkdevicetag
schema: 2.0.0
---

# Update-AzHybridNetworkDeviceTag
...
```
Update-AzHybridNetworkDeviceTag -DeviceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHybridNetworkDeviceTag -InputObject <IHybridNetworkIdentity> [-Tag <Hashtable>]
