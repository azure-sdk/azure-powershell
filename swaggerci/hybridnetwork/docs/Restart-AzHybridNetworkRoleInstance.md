...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/restart-azhybridnetworkroleinstance
schema: 2.0.0
---

# Restart-AzHybridNetworkRoleInstance
...
### Restart (Default)
```
Restart-AzHybridNetworkRoleInstance -LocationName <String> -Name <String> -ServiceKey <String>
...
### RestartViaIdentity
```
Restart-AzHybridNetworkRoleInstance -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>]
