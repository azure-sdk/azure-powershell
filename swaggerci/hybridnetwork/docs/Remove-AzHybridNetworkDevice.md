...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridnetwork/remove-azhybridnetworkdevice
schema: 2.0.0
---

# Remove-AzHybridNetworkDevice
...
### Delete (Default)
```
Remove-AzHybridNetworkDevice -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridNetworkDevice -InputObject <IHybridNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
