...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331
{
    ...
    public partial class UserAssignedIdentity :
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IUserAssignedIdentity,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IUserAssignedIdentityInternal
    {

        /// <summary>Backing field for <see cref="ClientId" /> property.</summary>
        private string _clientId;

        /// <summary>The client id of the User Assigned Identity Resource.</summary>
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IUserAssignedIdentityInternal.ClientId { get => this._clientId; set { {_clientId = value;} } }

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IUserAssignedIdentityInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Backing field for <see cref="PrincipalId" /> property.</summary>
        private string _principalId;

        /// <summary>The object id of the User Assigned Identity Resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Owned)]
