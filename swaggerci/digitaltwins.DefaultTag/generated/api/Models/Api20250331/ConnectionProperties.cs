...
namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331
{
    ...
    public partial class ConnectionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpoint Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionPropertiesInternal.PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.PrivateEndpoint()); set { {_privateEndpoint = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionState Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionPropertiesInternal.PrivateLinkServiceConnectionState { get => (this._privateLinkServiceConnectionState = this._privateLinkServiceConnectionState ?? new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.ConnectionState()); set { {_privateLinkServiceConnectionState = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.ConnectionPropertiesProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="PrivateEndpoint" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpoint _privateEndpoint;

        /// <summary>The private endpoint.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpoint PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.PrivateEndpoint()); set => this._privateEndpoint = value; }
        ...
        public string PrivateEndpointId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpointInternal)PrivateEndpoint).Id; }

        /// <summary>Backing field for <see cref="PrivateLinkServiceConnectionState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionState _privateLinkServiceConnectionState;

        /// <summary>The connection state.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Origin(Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionState PrivateLinkServiceConnectionState { get => (this._privateLinkServiceConnectionState = this._privateLinkServiceConnectionState ?? new Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.ConnectionState()); set => this._privateLinkServiceConnectionState = value; }
...

    {
        ...
        string[] GroupId { get; set; }
        /// <summary>The private endpoint.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpoint PrivateEndpoint { get; set; }
        /// <summary>The resource identifier.</summary>
        string PrivateEndpointId { get; set; }
        /// <summary>The connection state.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IConnectionState PrivateLinkServiceConnectionState { get; set; }
        /// <summary>Actions required for a private endpoint connection.</summary>
        string PrivateLinkServiceConnectionStateActionsRequired { get; set; }
        /// <summary>The description for the current state of a private endpoint connection.</summary>
        string PrivateLinkServiceConnectionStateDescription { get; set; }
