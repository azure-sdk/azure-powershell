...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpointConnection
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20250331.IPrivateEndpointConnection])]
