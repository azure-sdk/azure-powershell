...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20230131.ITimeSeriesDatabaseConnection])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.CleanupConnectionArtifacts])]
    [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Category('Query')]
    [Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Support.CleanupConnectionArtifacts]
    # Specifies whether or not to attempt to clean up artifacts that were created in order to establish a connection to the time series database.
    # This is a best-effort attempt that will fail if appropriate permissions are not in place.
