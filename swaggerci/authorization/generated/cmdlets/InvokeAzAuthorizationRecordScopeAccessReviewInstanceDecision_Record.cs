...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzAuthorizationRecordScopeAccessReviewInstanceDecision_Record", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzAuthorizationRecordScopeAccessReviewInstanceDecision_Record : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IRecordAllDecisionsProperties _property;

        /// <summary>Record All Decisions payload.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Record All Decisions payload.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Record All Decisions payload.",
        SerializedName = @"properties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IRecordAllDecisionsProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IRecordAllDecisionsProperties Property { get => this._property; set => this._property = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzAuthorizationRecordScopeAccessReviewInstanceDecision_Record" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzAuthorizationRecordScopeAccessReviewInstanceDecision_Record()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ScopeAccessReviewInstanceRecordAllDecisions(Scope, ScheduleDefinitionId, Id, Property, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Scope=Scope,ScheduleDefinitionId=ScheduleDefinitionId,Id=Id,body=Property})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20211201Preview.IErrorDefinition> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, ScheduleDefinitionId=ScheduleDefinitionId, Id=Id, body=Property })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, ScheduleDefinitionId=ScheduleDefinitionId, Id=Id, body=Property })
                    {
