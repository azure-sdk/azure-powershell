...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/{scope}/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAuthorizationRoleDefinition_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Description(@"Creates or updates a role definition.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Generated]
    public partial class NewAzAuthorizationRoleDefinition_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Role definition assignable scopes.")]
        ...
        public string[] AssignableScope { get => RoleDefinitionBody.AssignableScope ?? null /* arrayOf */; set => RoleDefinitionBody.AssignableScope = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The role definition description.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Description { get => RoleDefinitionBody.Description ?? null; set => RoleDefinitionBody.Description = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ID of the role definition.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Role definition permissions.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api201801Preview.IPermission[] Permission { get => RoleDefinitionBody.Permission ?? null /* arrayOf */; set => RoleDefinitionBody.Permission = value; }
        ...
        /// <summary>Backing field for <see cref="RoleDefinitionBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api201801Preview.IRoleDefinition _roleDefinitionBody= new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api201801Preview.RoleDefinition();

        /// <summary>Role definition.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api201801Preview.IRoleDefinition RoleDefinitionBody { get => this._roleDefinitionBody; set => this._roleDefinitionBody = value; }

        /// <summary>The role name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The role name.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RoleName { get => RoleDefinitionBody.RoleName ?? null; set => RoleDefinitionBody.RoleName = value; }

        /// <summary>The role type.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The role type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string RoleType { get => RoleDefinitionBody.RoleType ?? null; set => RoleDefinitionBody.RoleType = value; }
        ...
        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api201801Preview.IRoleDefinition> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAuthorizationRoleDefinition_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAuthorizationRoleDefinition_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RoleDefinitionsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RoleDefinitionsCreateOrUpdate(Scope, Id, RoleDefinitionBody, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Scope=Scope,Id=Id,body=RoleDefinitionBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api201801Preview.IRoleDefinition> response)
        {
            using( NoSynchronizationContext )
            {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, Id=Id, body=RoleDefinitionBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Scope=Scope, Id=Id, body=RoleDefinitionBody })
                    {
