...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.AccessReviewResult Decision { get => PropertiesBody.Decision ?? ((Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.AccessReviewResult)""); set => PropertiesBody.Decision = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Justification { get => PropertiesBody.Justification ?? null; set => PropertiesBody.Justification = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewDecisionProperties _propertiesBody= new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.AccessReviewDecisionProperties();

        /// <summary>Approval Step.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewDecisionProperties PropertiesBody { get => this._propertiesBody; set => this._propertiesBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AccessReviewInstanceMyDecisionsPatch(ScheduleDefinitionId, Id, DecisionId, PropertiesBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ScheduleDefinitionId=ScheduleDefinitionId,Id=Id,DecisionId=DecisionId,body=PropertiesBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IErrorDefinition> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ScheduleDefinitionId=ScheduleDefinitionId, Id=Id, DecisionId=DecisionId, body=PropertiesBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ScheduleDefinitionId=ScheduleDefinitionId, Id=Id, DecisionId=DecisionId, body=PropertiesBody })
                    {
