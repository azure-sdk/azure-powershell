...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListForScope=>GET:"/{scope}/providers/Microsoft.Authorization/roleAssignments"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAuthorizationRoleAssignment_List3")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Description(@"List all role assignments that apply to a scope.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Authorization.Generated]
    public partial class GetAzAuthorizationRoleAssignment_List3 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The skipToken to apply on the operation. Use $skipToken={skiptoken} to return paged role assignments following the skipToken passed. Only supported on provider level calls.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAuthorizationRoleAssignment_List3" /> cmdlet class.
        /// </summary>
        public GetAzAuthorizationRoleAssignment_List3()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RoleAssignmentsListForScope(Scope, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, this.InvocationInformation.BoundParameters.ContainsKey("TenantId") ? TenantId : null, this.InvocationInformation.BoundParameters.ContainsKey("SkipToken") ? SkipToken : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.RoleAssignmentsListForScope_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
