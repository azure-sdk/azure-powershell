...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview
{
    ...
    public partial class AccessReviewRecurrenceSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceSettingsInternal
    {

        /// <summary>Internal Acessors for Pattern</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrencePattern Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceSettingsInternal.Pattern { get => (this._pattern = this._pattern ?? new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.AccessReviewRecurrencePattern()); set { {_pattern = value;} } }

        /// <summary>Internal Acessors for Range</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceRange Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceSettingsInternal.Range { get => (this._range = this._range ?? new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.AccessReviewRecurrenceRange()); set { {_range = value;} } }

        /// <summary>Backing field for <see cref="Pattern" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrencePattern _pattern;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrencePattern Pattern { get => (this._pattern = this._pattern ?? new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.AccessReviewRecurrencePattern()); set => this._pattern = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceRange _range;

        /// <summary>Access Review schedule definition recurrence range.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceRange Range { get => (this._range = this._range ?? new Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.AccessReviewRecurrenceRange()); set => this._range = value; }

        /// <summary>The DateTime when the review is scheduled to end. Required if type is endDate</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Inlined)]
        public global::System.DateTime? RangeEndDate { get => ((Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceRangeInternal)Range).EndDate; set => ((Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceRangeInternal)Range).EndDate = value ?? default(global::System.DateTime); }
    ...
    {
        /// <summary>Access Review schedule definition recurrence pattern.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrencePattern Pattern { get; set; }
        /// <summary>
        /// The interval for recurrence. For a quarterly review, the interval is 3 for type : absoluteMonthly.
        /// </summary>
        int? PatternInterval { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.AccessReviewRecurrencePatternType? PatternType { get; set; }
        /// <summary>Access Review schedule definition recurrence range.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20180501Preview.IAccessReviewRecurrenceRange Range { get; set; }
        /// <summary>The DateTime when the review is scheduled to end. Required if type is endDate</summary>
        global::System.DateTime? RangeEndDate { get; set; }
        /// <summary>
        /// The number of times to repeat the access review. Required and must be positive if type is numbered.
