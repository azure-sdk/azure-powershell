...
namespace Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20201001Preview
{
    ...
    public partial class ApprovalSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20201001Preview.IApprovalSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20201001Preview.IApprovalSettingsInternal
    {

        /// <summary>Backing field for <see cref="ApprovalMode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode? _approvalMode;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode? ApprovalMode { get => this._approvalMode; set => this._approvalMode = value; }

        /// <summary>Backing field for <see cref="ApprovalStage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20201001Preview.IApprovalStage[] _approvalStage;

        /// <summary>The approval stages of the request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Origin(Microsoft.Azure.PowerShell.Cmdlets.Authorization.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20201001Preview.IApprovalStage[] ApprovalStage { get => this._approvalStage; set => this._approvalStage = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Support.ApprovalMode? ApprovalMode { get; set; }
        /// <summary>The approval stages of the request.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Authorization.Models.Api20201001Preview.IApprovalStage[] ApprovalStage { get; set; }
        /// <summary>Determine whether approval is required or not.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Authorization.Runtime.Info(
        Required = false,
        ReadOnly = false,
