...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/add-azauthorizationscopeaccessreviewinstancedecision
schema: 2.0.0
---

# Add-AzAuthorizationScopeAccessReviewInstanceDecision
...
### Apply (Default)
```
Add-AzAuthorizationScopeAccessReviewInstanceDecision -Id <String> -ScheduleDefinitionId <String>
 -Scope <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApplyViaIdentity
```
Add-AzAuthorizationScopeAccessReviewInstanceDecision -InputObject <IAuthorizationIdentity>
