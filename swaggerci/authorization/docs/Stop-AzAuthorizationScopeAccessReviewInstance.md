...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/stop-azauthorizationscopeaccessreviewinstance
schema: 2.0.0
---

# Stop-AzAuthorizationScopeAccessReviewInstance
...
### Stop (Default)
```
Stop-AzAuthorizationScopeAccessReviewInstance -Id <String> -ScheduleDefinitionId <String> -Scope <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzAuthorizationScopeAccessReviewInstance -InputObject <IAuthorizationIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
