...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/remove-azauthorizationrolemanagementpolicy
schema: 2.0.0
---

# Remove-AzAuthorizationRoleManagementPolicy
...
### Delete (Default)
```
Remove-AzAuthorizationRoleManagementPolicy -Name <String> -Scope <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzAuthorizationRoleManagementPolicy -InputObject <IAuthorizationIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
