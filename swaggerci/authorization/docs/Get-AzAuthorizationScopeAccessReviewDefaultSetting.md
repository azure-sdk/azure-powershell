...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/get-azauthorizationscopeaccessreviewdefaultsetting
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzAuthorizationScopeAccessReviewDefaultSetting -Scope <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAuthorizationScopeAccessReviewDefaultSetting -InputObject <IAuthorizationIdentity>
