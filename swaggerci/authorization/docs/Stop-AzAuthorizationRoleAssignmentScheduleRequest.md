...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/stop-azauthorizationroleassignmentschedulerequest
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzAuthorizationRoleAssignmentScheduleRequest -Name <String> -Scope <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzAuthorizationRoleAssignmentScheduleRequest -InputObject <IAuthorizationIdentity>
