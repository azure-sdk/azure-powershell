...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/stop-azauthorizationroleeligibilityschedulerequest
schema: 2.0.0
---

# Stop-AzAuthorizationRoleEligibilityScheduleRequest
...
### Cancel (Default)
```
Stop-AzAuthorizationRoleEligibilityScheduleRequest -Name <String> -Scope <String> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzAuthorizationRoleEligibilityScheduleRequest -InputObject <IAuthorizationIdentity>
