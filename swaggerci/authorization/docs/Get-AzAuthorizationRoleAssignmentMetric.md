...
online version: https://docs.microsoft.com/en-us/powershell/module/az.authorization/get-azauthorizationroleassignmentmetric
schema: 2.0.0
---

# Get-AzAuthorizationRoleAssignmentMetric
...
### Get (Default)
```
Get-AzAuthorizationRoleAssignmentMetric [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAuthorizationRoleAssignmentMetric -InputObject <IAuthorizationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
