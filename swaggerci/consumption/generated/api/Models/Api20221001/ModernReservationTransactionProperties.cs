...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001
{
    ...
    public partial class ModernReservationTransactionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal
    {
        ...
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Amount { get => this._amount; set { {_amount = value;} } }

        /// <summary>Internal Acessors for ArmSkuName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.ArmSkuName { get => this._armSkuName; set { {_armSkuName = value;} } }

        /// <summary>Internal Acessors for BillingFrequency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.BillingFrequency { get => this._billingFrequency; set { {_billingFrequency = value;} } }

        /// <summary>Internal Acessors for BillingProfileId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.BillingProfileId { get => this._billingProfileId; set { {_billingProfileId = value;} } }

        /// <summary>Internal Acessors for BillingProfileName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.BillingProfileName { get => this._billingProfileName; set { {_billingProfileName = value;} } }

        /// <summary>Internal Acessors for Currency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Currency { get => this._currency; set { {_currency = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for EventDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.EventDate { get => this._eventDate; set { {_eventDate = value;} } }

        /// <summary>Internal Acessors for EventType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.EventType { get => this._eventType; set { {_eventType = value;} } }

        /// <summary>Internal Acessors for Invoice</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Invoice { get => this._invoice; set { {_invoice = value;} } }

        /// <summary>Internal Acessors for InvoiceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.InvoiceId { get => this._invoiceId; set { {_invoiceId = value;} } }

        /// <summary>Internal Acessors for InvoiceSectionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.InvoiceSectionId { get => this._invoiceSectionId; set { {_invoiceSectionId = value;} } }

        /// <summary>Internal Acessors for InvoiceSectionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.InvoiceSectionName { get => this._invoiceSectionName; set { {_invoiceSectionName = value;} } }

        /// <summary>Internal Acessors for PurchasingSubscriptionGuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.PurchasingSubscriptionGuid { get => this._purchasingSubscriptionGuid; set { {_purchasingSubscriptionGuid = value;} } }

        /// <summary>Internal Acessors for PurchasingSubscriptionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.PurchasingSubscriptionName { get => this._purchasingSubscriptionName; set { {_purchasingSubscriptionName = value;} } }

        /// <summary>Internal Acessors for Quantity</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Quantity { get => this._quantity; set { {_quantity = value;} } }

        /// <summary>Internal Acessors for Region</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Region { get => this._region; set { {_region = value;} } }

        /// <summary>Internal Acessors for ReservationOrderId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.ReservationOrderId { get => this._reservationOrderId; set { {_reservationOrderId = value;} } }

        /// <summary>Internal Acessors for ReservationOrderName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.ReservationOrderName { get => this._reservationOrderName; set { {_reservationOrderName = value;} } }

        /// <summary>Internal Acessors for Term</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransactionPropertiesInternal.Term { get => this._term; set { {_term = value;} } }
