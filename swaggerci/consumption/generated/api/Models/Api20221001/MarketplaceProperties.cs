...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001
{
    ...
    public partial class MarketplaceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplaceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for AdditionalInfo</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.AdditionalInfo { get => this._additionalInfo; set { {_additionalInfo = value;} } }

        /// <summary>Internal Acessors for AdditionalProperty</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.AdditionalProperty { get => this._additionalProperty; set { {_additionalProperty = value;} } }

        /// <summary>Internal Acessors for BillingPeriodId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.BillingPeriodId { get => this._billingPeriodId; set { {_billingPeriodId = value;} } }

        /// <summary>Internal Acessors for ConsumedQuantity</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.ConsumedQuantity { get => this._consumedQuantity; set { {_consumedQuantity = value;} } }

        /// <summary>Internal Acessors for ConsumedService</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.ConsumedService { get => this._consumedService; set { {_consumedService = value;} } }

        /// <summary>Internal Acessors for CostCenter</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.CostCenter { get => this._costCenter; set { {_costCenter = value;} } }

        /// <summary>Internal Acessors for Currency</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.Currency { get => this._currency; set { {_currency = value;} } }

        /// <summary>Internal Acessors for DepartmentName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.DepartmentName { get => this._departmentName; set { {_departmentName = value;} } }

        /// <summary>Internal Acessors for InstanceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.InstanceId { get => this._instanceId; set { {_instanceId = value;} } }

        /// <summary>Internal Acessors for InstanceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.InstanceName { get => this._instanceName; set { {_instanceName = value;} } }

        /// <summary>Internal Acessors for IsEstimated</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.IsEstimated { get => this._isEstimated; set { {_isEstimated = value;} } }

        /// <summary>Internal Acessors for IsRecurringCharge</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.IsRecurringCharge { get => this._isRecurringCharge; set { {_isRecurringCharge = value;} } }

        /// <summary>Internal Acessors for MeterId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.MeterId { get => this._meterId; set { {_meterId = value;} } }

        /// <summary>Internal Acessors for OfferName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.OfferName { get => this._offerName; set { {_offerName = value;} } }

        /// <summary>Internal Acessors for OrderNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.OrderNumber { get => this._orderNumber; set { {_orderNumber = value;} } }

        /// <summary>Internal Acessors for PlanName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.PlanName { get => this._planName; set { {_planName = value;} } }

        /// <summary>Internal Acessors for PretaxCost</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.PretaxCost { get => this._pretaxCost; set { {_pretaxCost = value;} } }

        /// <summary>Internal Acessors for PublisherName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.PublisherName { get => this._publisherName; set { {_publisherName = value;} } }

        /// <summary>Internal Acessors for ResourceGroup</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.ResourceGroup { get => this._resourceGroup; set { {_resourceGroup = value;} } }

        /// <summary>Internal Acessors for ResourceRate</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.ResourceRate { get => this._resourceRate; set { {_resourceRate = value;} } }

        /// <summary>Internal Acessors for SubscriptionGuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.SubscriptionGuid { get => this._subscriptionGuid; set { {_subscriptionGuid = value;} } }

        /// <summary>Internal Acessors for SubscriptionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.SubscriptionName { get => this._subscriptionName; set { {_subscriptionName = value;} } }

        /// <summary>Internal Acessors for UnitOfMeasure</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.UnitOfMeasure { get => this._unitOfMeasure; set { {_unitOfMeasure = value;} } }

        /// <summary>Internal Acessors for UsageEnd</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.UsageEnd { get => this._usageEnd; set { {_usageEnd = value;} } }

        /// <summary>Internal Acessors for UsageStart</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IMarketplacePropertiesInternal.UsageStart { get => this._usageStart; set { {_usageStart = value;} } }
