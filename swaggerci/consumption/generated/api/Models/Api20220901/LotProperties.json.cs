...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901
{
    ...
    public partial class LotProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.ILotProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.ILotProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.ILotProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonNode node)
        {
        ...
        internal LotProperties(Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject json)
        {
            ...
            {_originalAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("originalAmount"), out var __jsonOriginalAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.Amount.FromJson(__jsonOriginalAmount) : OriginalAmount;}
            {_closedBalance = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("closedBalance"), out var __jsonClosedBalance) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.Amount.FromJson(__jsonClosedBalance) : ClosedBalance;}
            {_originalAmountInBillingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("originalAmountInBillingCurrency"), out var __jsonOriginalAmountInBillingCurrency) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.AmountWithExchangeRate.FromJson(__jsonOriginalAmountInBillingCurrency) : OriginalAmountInBillingCurrency;}
            {_closedBalanceInBillingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("closedBalanceInBillingCurrency"), out var __jsonClosedBalanceInBillingCurrency) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.AmountWithExchangeRate.FromJson(__jsonClosedBalanceInBillingCurrency) : ClosedBalanceInBillingCurrency;}
            {_reseller = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Json.JsonObject>("reseller"), out var __jsonReseller) ? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.Reseller.FromJson(__jsonReseller) : Reseller;}
