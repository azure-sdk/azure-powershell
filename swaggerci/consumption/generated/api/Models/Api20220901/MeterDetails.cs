...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901
{
    ...
    public partial class MeterDetails :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetails,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.MeterCategory { get => this._meterCategory; set { {_meterCategory = value;} } }

        /// <summary>Internal Acessors for MeterLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.MeterLocation { get => this._meterLocation; set { {_meterLocation = value;} } }

        /// <summary>Internal Acessors for MeterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.MeterName { get => this._meterName; set { {_meterName = value;} } }

        /// <summary>Internal Acessors for MeterSubCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.MeterSubCategory { get => this._meterSubCategory; set { {_meterSubCategory = value;} } }

        /// <summary>Internal Acessors for PretaxStandardRate</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.PretaxStandardRate { get => this._pretaxStandardRate; set { {_pretaxStandardRate = value;} } }

        /// <summary>Internal Acessors for ServiceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.ServiceName { get => this._serviceName; set { {_serviceName = value;} } }

        /// <summary>Internal Acessors for ServiceTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.ServiceTier { get => this._serviceTier; set { {_serviceTier = value;} } }

        /// <summary>Internal Acessors for TotalIncludedQuantity</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.TotalIncludedQuantity { get => this._totalIncludedQuantity; set { {_totalIncludedQuantity = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IMeterDetailsInternal.Unit { get => this._unit; set { {_unit = value;} } }
