...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001
{
    ...
    public partial class MeterDetailsAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.MeterCategory { get => this._meterCategory; set { {_meterCategory = value;} } }

        /// <summary>Internal Acessors for MeterLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.MeterLocation { get => this._meterLocation; set { {_meterLocation = value;} } }

        /// <summary>Internal Acessors for MeterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.MeterName { get => this._meterName; set { {_meterName = value;} } }

        /// <summary>Internal Acessors for MeterSubCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.MeterSubCategory { get => this._meterSubCategory; set { {_meterSubCategory = value;} } }

        /// <summary>Internal Acessors for PretaxStandardRate</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.PretaxStandardRate { get => this._pretaxStandardRate; set { {_pretaxStandardRate = value;} } }

        /// <summary>Internal Acessors for ServiceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.ServiceName { get => this._serviceName; set { {_serviceName = value;} } }

        /// <summary>Internal Acessors for ServiceTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.ServiceTier { get => this._serviceTier; set { {_serviceTier = value;} } }

        /// <summary>Internal Acessors for TotalIncludedQuantity</summary>
        decimal? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.TotalIncludedQuantity { get => this._totalIncludedQuantity; set { {_totalIncludedQuantity = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IMeterDetailsAutoGeneratedInternal.Unit { get => this._unit; set { {_unit = value;} } }
        ...
        /// <summary>Creates an new <see cref="MeterDetailsAutoGenerated" /> instance.</summary>
    ...
    /// The properties of the meter detail.
    internal partial interface IMeterDetailsAutoGeneratedInternal
