...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301
{
    ...
    public partial class MeterDetailsV2 :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.MeterCategory { get => this._meterCategory; set { {_meterCategory = value;} } }

        /// <summary>Internal Acessors for MeterLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.MeterLocation { get => this._meterLocation; set { {_meterLocation = value;} } }

        /// <summary>Internal Acessors for MeterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.MeterName { get => this._meterName; set { {_meterName = value;} } }

        /// <summary>Internal Acessors for MeterSubCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.MeterSubCategory { get => this._meterSubCategory; set { {_meterSubCategory = value;} } }

        /// <summary>Internal Acessors for PretaxStandardRate</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.PretaxStandardRate { get => this._pretaxStandardRate; set { {_pretaxStandardRate = value;} } }

        /// <summary>Internal Acessors for ServiceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.ServiceName { get => this._serviceName; set { {_serviceName = value;} } }

        /// <summary>Internal Acessors for ServiceTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.ServiceTier { get => this._serviceTier; set { {_serviceTier = value;} } }

        /// <summary>Internal Acessors for TotalIncludedQuantity</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.TotalIncludedQuantity { get => this._totalIncludedQuantity; set { {_totalIncludedQuantity = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20230301.IMeterDetailsV2Internal.Unit { get => this._unit; set { {_unit = value;} } }
