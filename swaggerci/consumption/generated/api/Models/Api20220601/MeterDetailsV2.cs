...
namespace Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601
{
    ...
    public partial class MeterDetailsV2 :
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2,
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.MeterCategory { get => this._meterCategory; set { {_meterCategory = value;} } }

        /// <summary>Internal Acessors for MeterLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.MeterLocation { get => this._meterLocation; set { {_meterLocation = value;} } }

        /// <summary>Internal Acessors for MeterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.MeterName { get => this._meterName; set { {_meterName = value;} } }

        /// <summary>Internal Acessors for MeterSubCategory</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.MeterSubCategory { get => this._meterSubCategory; set { {_meterSubCategory = value;} } }

        /// <summary>Internal Acessors for PretaxStandardRate</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.PretaxStandardRate { get => this._pretaxStandardRate; set { {_pretaxStandardRate = value;} } }

        /// <summary>Internal Acessors for ServiceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.ServiceName { get => this._serviceName; set { {_serviceName = value;} } }

        /// <summary>Internal Acessors for ServiceTier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.ServiceTier { get => this._serviceTier; set { {_serviceTier = value;} } }

        /// <summary>Internal Acessors for TotalIncludedQuantity</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.TotalIncludedQuantity { get => this._totalIncludedQuantity; set { {_totalIncludedQuantity = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IMeterDetailsV2Internal.Unit { get => this._unit; set { {_unit = value;} } }

        /// <summary>Backing field for <see cref="PretaxStandardRate" /> property.</summary>
        private float? _pretaxStandardRate;

        /// <summary>The pretax listing price.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Origin(Microsoft.Azure.PowerShell.Cmdlets.Consumption.PropertyOrigin.Owned)]
        public float? PretaxStandardRate { get => this._pretaxStandardRate; }
        ...
        private float? _totalIncludedQuantity;

        /// <summary>The total included quantity associated with the offer.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Origin(Microsoft.Azure.PowerShell.Cmdlets.Consumption.PropertyOrigin.Owned)]
        public float? TotalIncludedQuantity { get => this._totalIncludedQuantity; }
        ...
        /// <summary>Creates an new <see cref="MeterDetailsV2" /> instance.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(float) })]
        float? TotalIncludedQuantity { get;  }
        /// <summary>
        /// The unit in which the meter consumption is charged, for example, 'Hours', 'GB', etc.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Runtime.Info(
    ...
    /// The properties of the meter detail.
    internal partial interface IMeterDetailsV2Internal

    {
        ...
        /// <summary>The pretax listing price.</summary>
        float? PretaxStandardRate { get; set; }
        /// <summary>The name of the service.</summary>
        string ServiceName { get; set; }
        /// <summary>The service tier.</summary>
        string ServiceTier { get; set; }
        /// <summary>The total included quantity associated with the offer.</summary>
        float? TotalIncludedQuantity { get; set; }
        /// <summary>
        /// The unit in which the meter consumption is charged, for example, 'Hours', 'GB', etc.
        /// </summary>
        string Unit { get; set; }
