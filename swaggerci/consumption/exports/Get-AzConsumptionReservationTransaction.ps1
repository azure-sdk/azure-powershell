...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IReservationTransaction], [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IModernReservationTransaction])]
