...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IReservationTransaction], [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IModernReservationTransaction])]
