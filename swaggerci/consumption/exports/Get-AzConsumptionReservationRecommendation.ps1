...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IReservationRecommendation
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IReservationRecommendation])]
