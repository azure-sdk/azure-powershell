...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.consumption/get-azconsumptionoperationsresult
#>
function Get-AzConsumptionOperationsResult {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IOperationV2])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter()]
    [Alias('AzureRMContext', 'AzureCredential')]
