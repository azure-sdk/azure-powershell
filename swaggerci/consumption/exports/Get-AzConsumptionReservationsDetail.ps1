...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IReservationDetail
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220901.IReservationDetail])]
