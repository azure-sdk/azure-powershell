...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IReservationDetail
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20221001.IReservationDetail])]
