...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20220601.IPriceSheetResult], [Microsoft.Azure.PowerShell.Cmdlets.Consumption.Models.Api20211001.IPriceSheetResultAutoGenerated])]
...
begin {
    try {
        ...
        $mapping = @{
            ...
            Get2 = 'Az.Consumption.private\Get-AzConsumptionPriceSheet_Get2';
            Get3 = 'Az.Consumption.private\Get-AzConsumptionPriceSheet_Get3';
            ...
            GetViaIdentity2 = 'Az.Consumption.private\Get-AzConsumptionPriceSheet_GetViaIdentity2';
            GetViaIdentity3 = 'Az.Consumption.private\Get-AzConsumptionPriceSheet_GetViaIdentity3';
        }
        if (('Get', 'Get1', 'Get2', 'Get3') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
