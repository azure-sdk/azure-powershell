...
```
Invoke-AzReservationApiReturn [-ReservationToReturnQuantity <Int32>]
...
### Post
```
Invoke-AzReservationApiReturn -Body <IRefundRequest> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IRefundRequest
Parameter Sets: Post
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IRefundRequest

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IRefundResponse
