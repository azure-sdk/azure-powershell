...
online version: https://docs.microsoft.com/en-us/powershell/module/az.reservationapi/invoke-azreservationapiarchivereservation
schema: 2.0.0
---
...
### Archive (Default)
```
Invoke-AzReservationApiArchiveReservation -ReservationId <String> -ReservationOrderId <String>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ArchiveViaIdentity
```
Invoke-AzReservationApiArchiveReservation -InputObject <IReservationApiIdentity> [-DefaultProfile <PSObject>]
