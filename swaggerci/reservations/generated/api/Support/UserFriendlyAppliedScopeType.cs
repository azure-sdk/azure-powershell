...
namespace Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType ManagementGroup = @"ManagementGroup";

        public static Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType ResourceGroup = @"ResourceGroup";

        public static Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType Shared = @"Shared";

        public static Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType Single = @"Single";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType e1, Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Support.UserFriendlyAppliedScopeType e2)
        {
            return !e2.Equals(e1);
        }
