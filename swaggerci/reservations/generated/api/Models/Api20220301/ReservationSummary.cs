...
namespace Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301
{
    ...
    public partial class ReservationSummary :
        Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummary,
        Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal
    {
        ...
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.CancelledCount { get => this._cancelledCount; set { {_cancelledCount = value;} } }

        /// <summary>Internal Acessors for ExpiredCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.ExpiredCount { get => this._expiredCount; set { {_expiredCount = value;} } }

        /// <summary>Internal Acessors for ExpiringCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.ExpiringCount { get => this._expiringCount; set { {_expiringCount = value;} } }

        /// <summary>Internal Acessors for FailedCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.FailedCount { get => this._failedCount; set { {_failedCount = value;} } }

        /// <summary>Internal Acessors for NoBenefitCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.NoBenefitCount { get => this._noBenefitCount; set { {_noBenefitCount = value;} } }

        /// <summary>Internal Acessors for PendingCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.PendingCount { get => this._pendingCount; set { {_pendingCount = value;} } }

        /// <summary>Internal Acessors for ProcessingCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.ProcessingCount { get => this._processingCount; set { {_processingCount = value;} } }

        /// <summary>Internal Acessors for SucceededCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.SucceededCount { get => this._succeededCount; set { {_succeededCount = value;} } }

        /// <summary>Internal Acessors for WarningCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.IReservationSummaryInternal.WarningCount { get => this._warningCount; set { {_warningCount = value;} } }
