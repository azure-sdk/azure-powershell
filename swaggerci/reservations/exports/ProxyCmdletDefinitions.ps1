...
INPUTOBJECT <IReservationApiIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Id of the subscription
.Link
https://docs.microsoft.com/en-us/powershell/module/az.reservationapi/invoke-azreservationapiarchivereservation
#>
...
INPUTOBJECT <IReservationApiIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Id of the subscription
.Link
https://docs.microsoft.com/en-us/powershell/module/az.reservationapi/invoke-azreservationapireturn
#>
function Invoke-AzReservationApiReturn {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20221101.IRefundResponse])]
[CmdletBinding(DefaultParameterSetName='PostExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Post', Mandatory)]
    [Parameter(ParameterSetName='PostExpanded', Mandatory)]
