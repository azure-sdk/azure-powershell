...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.reservationapi/invoke-azreservationapicalculaterefund
#>
function Invoke-AzReservationApiCalculateRefund {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ReservationApi.Models.Api20220301.ICalculateRefundResponse])]
