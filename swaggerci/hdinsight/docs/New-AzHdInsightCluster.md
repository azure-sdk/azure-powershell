...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20221101Preview.IRole[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20221101Preview.IPrivateLinkConfiguration[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20221101Preview.IStorageAccount[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20221101Preview.ICluster
