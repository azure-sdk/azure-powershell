...
### Delete (Default)
```
Remove-AzHdInsightCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHdInsightCluster -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
