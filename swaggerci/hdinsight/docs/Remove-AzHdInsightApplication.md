...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/remove-azhdinsightapplication
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzHdInsightApplication -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHdInsightApplication -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>] [-AsJob]
