...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/update-azhdinsightconfiguration
schema: 2.0.0
---

# Update-AzHdInsightConfiguration
...
```
Update-AzHdInsightConfiguration -ClusterName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AdditionalProperties <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHdInsightConfiguration -InputObject <IHdInsightIdentity> [-AdditionalProperties <Hashtable>]
