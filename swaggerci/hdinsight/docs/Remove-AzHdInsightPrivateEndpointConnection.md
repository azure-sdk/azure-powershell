...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/remove-azhdinsightprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzHdInsightPrivateEndpointConnection -ClusterName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzHdInsightPrivateEndpointConnection -InputObject <IHdInsightIdentity> [-DefaultProfile <PSObject>]
