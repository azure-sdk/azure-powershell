...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hdinsight/restart-azhdinsightvirtualmachinehost
schema: 2.0.0
---

# Restart-AzHdInsightVirtualMachineHost
...
### Restart (Default)
```
Restart-AzHdInsightVirtualMachineHost -ClusterName <String> -ResourceGroupName <String> -Hosts <String[]>
...
### RestartViaIdentity
```
Restart-AzHdInsightVirtualMachineHost -InputObject <IHdInsightIdentity> -Hosts <String[]>
