...
namespace Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string CertificatePassword { get => ParametersBody.CertificatePassword ?? null; set => ParametersBody.CertificatePassword = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20210601.IUpdateClusterIdentityCertificateParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20210601.UpdateClusterIdentityCertificateParameters();

        /// <summary>The update cluster identity certificate request parameters.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HdInsight.Models.Api20210601.IUpdateClusterIdentityCertificateParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersUpdateIdentityCertificateViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersUpdateIdentityCertificate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
