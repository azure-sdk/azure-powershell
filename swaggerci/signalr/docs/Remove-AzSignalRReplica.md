...
### Delete (Default)
```
Remove-AzSignalRReplica -ReplicaName <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSignalRReplica -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
