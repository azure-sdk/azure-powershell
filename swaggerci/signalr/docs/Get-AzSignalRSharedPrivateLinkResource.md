...
online version: https://docs.microsoft.com/en-us/powershell/module/az.signalr/get-azsignalrsharedprivatelinkresource
schema: 2.0.0
---
...
### List (Default)
```
Get-AzSignalRSharedPrivateLinkResource -ResourceGroupName <String> -ResourceName <String>
...
### GetViaIdentity
```
Get-AzSignalRSharedPrivateLinkResource -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
