...
```
Update-AzSignalRReplica -ReplicaName <String> -ResourceGroupName <String> -ResourceName <String>
 -Location <String> [-SubscriptionId <String>] [-SkuCapacity <Int32>] [-SkuName <String>]
 [-SkuTier <SignalRSkuTier>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSignalRReplica -InputObject <ISignalRIdentity> -Location <String> [-SkuCapacity <Int32>]
 [-SkuName <String>] [-SkuTier <SignalRSkuTier>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
