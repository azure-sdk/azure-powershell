...
### Restart (Default)
```
Restart-AzSignalRReplica -ReplicaName <String> -ResourceGroupName <String> -ResourceName <String>
...
### RestartViaIdentity
```
Restart-AzSignalRReplica -InputObject <ISignalRIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
