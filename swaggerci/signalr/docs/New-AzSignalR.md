...
```
New-AzSignalR -ResourceGroupName <String> -ResourceName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-PublicNetworkAccess <String>] [-PublicNetworkAllow <SignalRRequestType[]>]
 [-PublicNetworkDeny <SignalRRequestType[]>] [-ResourceLogConfigurationCategory <IResourceLogCategory[]>]
 [-ServerlessConnectionTimeoutInSecond <Int32>] [-SkuCapacity <Int32>] [-SkuName <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRFeature[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ILiveTraceCategory[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IPrivateEndpointAcl[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceLogCategory[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IUpstreamTemplate[]
Parameter Sets: (All)
Aliases:
