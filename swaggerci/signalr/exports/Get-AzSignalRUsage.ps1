...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ISignalRUsage
.Link
https://learn.microsoft.com/powershell/module/az.signalr/get-azsignalrusage
#>
function Get-AzSignalRUsage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ISignalRUsage])]
