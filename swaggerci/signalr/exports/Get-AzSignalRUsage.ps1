...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISignalRUsage
.Link
https://docs.microsoft.com/en-us/powershell/module/az.signalr/get-azsignalrusage
#>
function Get-AzSignalRUsage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISignalRUsage])]
