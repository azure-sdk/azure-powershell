...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IEventListener
    {
        ...
        public string CustomCertificateId { get => ParametersBody.CustomCertificateId ?? null; set => ParametersBody.CustomCertificateId = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.ICustomDomain ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SignalRCustomDomainsCreateOrUpdate(SubscriptionId, ResourceGroupName, ResourceName, Name, ParametersBody, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ResourceName=ResourceName,Name=Name,body=ParametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, Name=Name, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ResourceName=ResourceName, Name=Name, body=ParametersBody })
                    {
