...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.KeyType KeyType { get => ParametersBody.KeyType ?? ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.KeyType)""); set => ParametersBody.KeyType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.IRegenerateKeyParameters _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.RegenerateKeyParameters();

        /// <summary>Parameters describes the request to regenerate access keys</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220201.IRegenerateKeyParameters ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SignalRRegenerateKeyViaIdentity(InputObject.Id, ParametersBody, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SignalRRegenerateKey(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ResourceName ?? null, ParametersBody, onDefault, this, Pipeline);
                    }
