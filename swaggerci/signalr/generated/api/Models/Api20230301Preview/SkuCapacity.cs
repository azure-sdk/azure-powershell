...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview
{
    ...
    public partial class SkuCapacity :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacity,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacityInternal
    {
        ...
        int[] Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacityInternal.AllowedValue { get => this._allowedValue; set { {_allowedValue = value;} } }

        /// <summary>Internal Acessors for Default</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacityInternal.Default { get => this._default; set { {_default = value;} } }

        /// <summary>Internal Acessors for Maximum</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacityInternal.Maximum { get => this._maximum; set { {_maximum = value;} } }

        /// <summary>Internal Acessors for Minimum</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacityInternal.Minimum { get => this._minimum; set { {_minimum = value;} } }

        /// <summary>Internal Acessors for ScaleType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ScaleType? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISkuCapacityInternal.ScaleType { get => this._scaleType; set { {_scaleType = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ScaleType? _scaleType;

        /// <summary>The scale type applicable to the sku.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ScaleType? ScaleType { get => this._scaleType; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ScaleType? ScaleType { get;  }
...

    {
        ...
        int? Minimum { get; set; }
        /// <summary>The scale type applicable to the sku.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ScaleType? ScaleType { get; set; }
