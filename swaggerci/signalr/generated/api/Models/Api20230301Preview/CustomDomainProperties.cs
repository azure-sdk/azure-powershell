...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview
{
    ...
    public partial class CustomDomainProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ICustomDomainProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ICustomDomainPropertiesInternal
    {

        /// <summary>Backing field for <see cref="CustomCertificate" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceReference _customCertificate;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceReference CustomCertificate { get => (this._customCertificate = this._customCertificate ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ResourceReference()); set => this._customCertificate = value; }

        /// <summary>Resource ID.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Inlined)]
        public string CustomCertificateId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceReferenceInternal)CustomCertificate).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceReferenceInternal)CustomCertificate).Id = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceReference Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ICustomDomainPropertiesInternal.CustomCertificate { get => (this._customCertificate = this._customCertificate ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ResourceReference()); set { {_customCertificate = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ICustomDomainPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
    ...
    {
        /// <summary>Reference to a resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.IResourceReference CustomCertificate { get; set; }
        /// <summary>Resource ID.</summary>
        string CustomCertificateId { get; set; }
        /// <summary>The custom domain name.</summary>
        string DomainName { get; set; }
