...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview
{
    ...
    public partial class SignalRUsage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageName Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.SignalRUsageName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageName _name;

        /// <summary>Localizable String object containing the name and a localized value.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.SignalRUsageName()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The identifier of the usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>Localizable String object containing the name and a localized value.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230301Preview.ISignalRUsageName Name { get; set; }
        /// <summary>Localized name of the usage.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The identifier of the usage.</summary>
        string NameValue { get; set; }
