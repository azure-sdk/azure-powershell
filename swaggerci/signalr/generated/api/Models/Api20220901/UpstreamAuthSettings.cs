...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901
{
    ...
    public partial class UpstreamAuthSettings :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IUpstreamAuthSettings,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IUpstreamAuthSettingsInternal
    {

        /// <summary>Backing field for <see cref="ManagedIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IManagedIdentitySettings _managedIdentity;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IManagedIdentitySettings ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.ManagedIdentitySettings()); set => this._managedIdentity = value; }
        ...
        public string ManagedIdentityResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IManagedIdentitySettingsInternal)ManagedIdentity).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IManagedIdentitySettingsInternal)ManagedIdentity).Resource = value ?? null; }

        /// <summary>Internal Acessors for ManagedIdentity</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IManagedIdentitySettings Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IUpstreamAuthSettingsInternal.ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.ManagedIdentitySettings()); set { {_managedIdentity = value;} } }
    ...
    {
        /// <summary>Managed identity settings for upstream.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220901.IManagedIdentitySettings ManagedIdentity { get; set; }
        /// <summary>
        /// The Resource indicating the App ID URI of the target resource.
        /// It also appears in the aud (audience) claim of the issued token.
        /// </summary>
