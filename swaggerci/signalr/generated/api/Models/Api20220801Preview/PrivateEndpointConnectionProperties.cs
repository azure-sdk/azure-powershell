...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview
{
    ...
    public partial class PrivateEndpointConnectionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointConnectionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointConnectionPropertiesInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointConnectionPropertiesInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for PrivateEndpoint</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpoint Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointConnectionPropertiesInternal.PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.PrivateEndpoint()); set { {_privateEndpoint = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointConnectionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="PrivateEndpoint" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpoint _privateEndpoint;

        /// <summary>Private endpoint</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpoint PrivateEndpoint { get => (this._privateEndpoint = this._privateEndpoint ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.PrivateEndpoint()); set => this._privateEndpoint = value; }
        ...
        public string PrivateEndpointId { get => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointInternal)PrivateEndpoint).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointInternal)PrivateEndpoint).Id = value ?? null; }

        /// <summary>Backing field for <see cref="PrivateLinkServiceConnectionState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateLinkServiceConnectionState _privateLinkServiceConnectionState;
