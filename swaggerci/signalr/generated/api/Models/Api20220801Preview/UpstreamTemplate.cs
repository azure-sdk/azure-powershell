...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview
{
    ...
    public partial class UpstreamTemplate :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamTemplate,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamTemplateInternal
    {

        /// <summary>Backing field for <see cref="Auth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamAuthSettings _auth;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamAuthSettings Auth { get => (this._auth = this._auth ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.UpstreamAuthSettings()); set => this._auth = value; }
    ...
    {
        /// <summary>Upstream auth settings. If not set, no auth is used for upstream messages.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamAuthSettings Auth { get; set; }
        /// <summary>Managed identity settings for upstream.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IManagedIdentitySettings AuthManagedIdentity { get; set; }
        /// <summary>Upstream auth type enum.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.UpstreamAuthType? AuthType { get; set; }
        /// <summary>
        /// Gets or sets the matching pattern for category names. If not set, it matches any category.
