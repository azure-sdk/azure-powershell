...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview
{
    ...
    public partial class SignalRNetworkAcls :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISignalRNetworkAcls,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISignalRNetworkAclsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointAcl[] _privateEndpoint;

        /// <summary>ACLs for requests from private endpoints</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointAcl[] PrivateEndpoint { get => this._privateEndpoint; set => this._privateEndpoint = value; }

        /// <summary>Backing field for <see cref="PublicNetwork" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.INetworkAcl _publicNetwork;

        /// <summary>Network ACL</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Origin(Microsoft.Azure.PowerShell.Cmdlets.SignalR.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.INetworkAcl PublicNetwork { get => (this._publicNetwork = this._publicNetwork ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.NetworkAcl()); set => this._publicNetwork = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointAcl[] PrivateEndpoint { get; set; }
        /// <summary>
        /// Allowed request types. The value can be one or more of: ClientConnection, ServerConnection, RESTAPI.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.Info(
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IPrivateEndpointAcl[] PrivateEndpoint { get; set; }
        /// <summary>Network ACL</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.INetworkAcl PublicNetwork { get; set; }
        /// <summary>
        /// Allowed request types. The value can be one or more of: ClientConnection, ServerConnection, RESTAPI.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.SignalRRequestType[] PublicNetworkAllow { get; set; }
