...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview
{
    ...
    public partial class SkuCapacity :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacity,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacityInternal
    {
        ...
        int[] Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacityInternal.AllowedValue { get => this._allowedValue; set { {_allowedValue = value;} } }

        /// <summary>Internal Acessors for Default</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacityInternal.Default { get => this._default; set { {_default = value;} } }

        /// <summary>Internal Acessors for Maximum</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacityInternal.Maximum { get => this._maximum; set { {_maximum = value;} } }

        /// <summary>Internal Acessors for Minimum</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacityInternal.Minimum { get => this._minimum; set { {_minimum = value;} } }

        /// <summary>Internal Acessors for ScaleType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ScaleType? Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ISkuCapacityInternal.ScaleType { get => this._scaleType; set { {_scaleType = value;} } }
