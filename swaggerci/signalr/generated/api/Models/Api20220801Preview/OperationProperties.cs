...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ILogSpecification[] ServiceSpecificationLogSpecification { get; set; }
        /// <summary>Specifications of the Metrics for Azure Monitoring.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IMetricSpecification[] ServiceSpecificationMetricSpecification { get; set; }
    ...
    {
        /// <summary>An object that describes a specification.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IServiceSpecification ServiceSpecification { get; set; }
        /// <summary>Specifications of the Logs for Azure Monitoring.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ILogSpecification[] ServiceSpecificationLogSpecification { get; set; }
        /// <summary>Specifications of the Metrics for Azure Monitoring.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IMetricSpecification[] ServiceSpecificationMetricSpecification { get; set; }
