...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview
{
    ...
    public partial class UpstreamAuthSettings :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamAuthSettings,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IUpstreamAuthSettingsInternal
    {

        /// <summary>Backing field for <see cref="ManagedIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IManagedIdentitySettings _managedIdentity;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IManagedIdentitySettings ManagedIdentity { get => (this._managedIdentity = this._managedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.ManagedIdentitySettings()); set => this._managedIdentity = value; }
    ...
    {
        /// <summary>Managed identity settings for upstream.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20220801Preview.IManagedIdentitySettings ManagedIdentity { get; set; }
        /// <summary>
        /// The Resource indicating the App ID URI of the target resource.
        /// It also appears in the aud (audience) claim of the issued token.
        /// </summary>
