...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201
{
    ...
    public partial class LiveTraceConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ILiveTraceConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ILiveTraceConfigurationInternal
    {

        /// <summary>Backing field for <see cref="Category" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ILiveTraceCategory[] _category;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ILiveTraceCategory[] Category { get => this._category; set => this._category = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SignalR.Models.Api20230201.ILiveTraceCategory[] Category { get; set; }
        /// <summary>
        /// Indicates whether or not enable live trace.
        /// When it's set to true, live trace client can connect to the service.
        /// Otherwise, live trace client can't connect to the service, so that you are unable to receive any log, no matter what you
