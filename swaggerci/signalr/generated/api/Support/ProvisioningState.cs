...
namespace Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Unknown = @"Unknown";

        public static Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.SignalR.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
