@{
  GUID = '500e7e88-deea-4134-a66d-0d6e5ea1a040'
  ...
  FunctionsToExport = 'Get-AzResourceHealthAvailabilityStatuses', 'Get-AzResourceHealthEvent', 'Get-AzResourceHealthImpactedResource', 'Get-AzResourceHealthSecurityAdvisoryImpactedResource', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
