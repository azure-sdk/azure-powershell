...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20220701
{
    ...
    public partial class ServiceImpactingEventIncidentProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20220701.IServiceImpactingEventIncidentProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20220701.IServiceImpactingEventIncidentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models.Api20220701.IServiceImpactingEventIncidentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode node)
        {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject into a new instance of <see cref="ServiceImpactingEventIncidentProperties" />.
        /// </summary>
        ...
        internal ServiceImpactingEventIncidentProperties(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject json)
        {
            ...
            {_service = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("service"), out var __jsonService) ? (string)__jsonService : (string)Service;}
            {_region = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("region"), out var __jsonRegion) ? (string)__jsonRegion : (string)Region;}
            {_incidentType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("incidentType"), out var __jsonIncidentType) ? (string)__jsonIncidentType : (string)IncidentType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ServiceImpactingEventIncidentProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ServiceImpactingEventIncidentProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
