...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Models
{
    ...
    public partial class ResourceHealthIdentity
    {
        ...
        internal ResourceHealthIdentity(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject json)
        {
            ...
            {_eventTrackingId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("eventTrackingId"), out var __jsonEventTrackingId) ? (string)__jsonEventTrackingId : (string)EventTrackingId;}
            {_impactedResourceName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("impactedResourceName"), out var __jsonImpactedResourceName) ? (string)__jsonImpactedResourceName : (string)ImpactedResourceName;}
            {_issueName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString>("issueName"), out var __jsonIssueName) ? (string)__jsonIssueName : (string)IssueName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._eventTrackingId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._eventTrackingId.ToString()) : null, "eventTrackingId" ,container.Add );
            AddIf( null != (((object)this._impactedResourceName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._impactedResourceName.ToString()) : null, "impactedResourceName" ,container.Add );
            AddIf( null != (((object)this._issueName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ResourceHealth.Runtime.Json.JsonString(this._issueName.ToString()) : null, "issueName" ,container.Add );
