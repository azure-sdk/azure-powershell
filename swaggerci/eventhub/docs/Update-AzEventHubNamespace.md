...
Update-AzEventHubNamespace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-SkuTier <SkuTier>] [-Tag <Hashtable>] [-ZoneRedundant] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
...
Update-AzEventHubNamespace -InputObject <IEventHubIdentity> [-AlternateName <String>] [-ClusterArmId <String>]
 ...
 [-MaximumThroughputUnit <Int32>] [-PrivateEndpointConnection <IPrivateEndpointConnection[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IKeyVaultProperties[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IPrivateEndpointConnection[]
Parameter Sets: (All)
Aliases:
