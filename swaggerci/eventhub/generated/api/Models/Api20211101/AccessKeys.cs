...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101
{
    ...
    public partial class AccessKeys :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.AliasPrimaryConnectionString { get => this._aliasPrimaryConnectionString; set { {_aliasPrimaryConnectionString = value;} } }

        /// <summary>Internal Acessors for AliasSecondaryConnectionString</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.AliasSecondaryConnectionString { get => this._aliasSecondaryConnectionString; set { {_aliasSecondaryConnectionString = value;} } }

        /// <summary>Internal Acessors for KeyName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.KeyName { get => this._keyName; set { {_keyName = value;} } }

        /// <summary>Internal Acessors for PrimaryConnectionString</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.PrimaryConnectionString { get => this._primaryConnectionString; set { {_primaryConnectionString = value;} } }

        /// <summary>Internal Acessors for PrimaryKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.PrimaryKey { get => this._primaryKey; set { {_primaryKey = value;} } }

        /// <summary>Internal Acessors for SecondaryConnectionString</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.SecondaryConnectionString { get => this._secondaryConnectionString; set { {_secondaryConnectionString = value;} } }

        /// <summary>Internal Acessors for SecondaryKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20211101.IAccessKeysInternal.SecondaryKey { get => this._secondaryKey; set { {_secondaryKey = value;} } }
