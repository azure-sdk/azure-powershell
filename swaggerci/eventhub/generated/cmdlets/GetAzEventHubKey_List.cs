...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/eventhubs/{eventHubName}/authorizationRules/{authorizationRuleName}/listKeys"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzEventHubKey_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.Description(@"Gets the ACS and SAS connection strings for the Event Hub.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.Generated]
    public partial class GetAzEventHubKey_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzEventHubKey_List" /> cmdlet class.
        /// </summary>
        public GetAzEventHubKey_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'EventHubsListKeys' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.EventHubsListKeys(ResourceGroupName, NamespaceName, EventHubName, AuthorizationRuleName, SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NamespaceName=NamespaceName, EventHubName=EventHubName, AuthorizationRuleName=AuthorizationRuleName, SubscriptionId=SubscriptionId })
                    {
