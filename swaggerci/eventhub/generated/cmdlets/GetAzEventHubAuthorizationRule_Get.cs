            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.EventHubsGetAuthorizationRule(ResourceGroupName, NamespaceName, EventHubName, AuthorizationRuleName, SubscriptionId, onOk, onDefault, this, Pipeline);
