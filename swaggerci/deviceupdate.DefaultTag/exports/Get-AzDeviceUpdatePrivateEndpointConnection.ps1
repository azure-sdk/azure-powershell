...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IPrivateEndpointConnection
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.deviceupdate/get-azdeviceupdateprivateendpointconnection
#>
function Get-AzDeviceUpdatePrivateEndpointConnection {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IPrivateEndpointConnection])]
