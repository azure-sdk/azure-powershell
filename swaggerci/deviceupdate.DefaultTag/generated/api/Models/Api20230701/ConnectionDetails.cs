...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701
{
    ...
    public partial class ConnectionDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IConnectionDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IConnectionDetailsInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IConnectionDetailsInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for LinkIdentifier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IConnectionDetailsInternal.LinkIdentifier { get => this._linkIdentifier; set { {_linkIdentifier = value;} } }

        /// <summary>Internal Acessors for MemberName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IConnectionDetailsInternal.MemberName { get => this._memberName; set { {_memberName = value;} } }

        /// <summary>Internal Acessors for PrivateIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IConnectionDetailsInternal.PrivateIPAddress { get => this._privateIPAddress; set { {_privateIPAddress = value;} } }
