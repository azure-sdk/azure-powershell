...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IAccount _accountBody = new Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.Account();
        ...
        public string EncryptionKeyVaultKeyUri { get => _accountBody.EncryptionKeyVaultKeyUri ?? null; set => _accountBody.EncryptionKeyVaultKeyUri = value; }

        /// <summary>
        /// The full resourceId of the user assigned identity to be used for key vault access. Identity has to be also assigned to
        /// the Account
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The full resourceId of the user assigned identity to be used for key vault access. Identity has to be also assigned to the Account")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string EncryptionUserAssignedIdentity { get => _accountBody.EncryptionUserAssignedIdentity ?? null; set => _accountBody.EncryptionUserAssignedIdentity = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceUpdate.Models.Api20230701.IPrivateEndpointConnection[] PrivateEndpointConnection { get => _accountBody.PrivateEndpointConnection ?? null /* arrayOf */; set => _accountBody.PrivateEndpointConnection = value; }
