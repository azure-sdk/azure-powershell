...
using Microsoft.Azure.PowerShell.Cmdlets.Snapshots.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.Snapshots.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.Snapshots.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.Snapshots.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.Snapshots.Runtime.JsonSerializable.ToJson(dict, null);
            }
