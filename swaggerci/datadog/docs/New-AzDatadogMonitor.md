...
New-AzDatadogMonitor -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-DatadogOrganizationPropertyLinkingAuthCode <String>] [-DatadogOrganizationPropertyLinkingClientId <String>]
 [-DatadogOrganizationPropertyName <String>] [-DatadogOrganizationPropertyRedirectUri <String>]
