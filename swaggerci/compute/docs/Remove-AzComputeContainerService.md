...
online version: https://docs.microsoft.com/en-us/powershell/module/az.compute/remove-azcomputecontainerservice
schema: 2.0.0
---

# Remove-AzComputeContainerService
...
### Delete (Default)
```
Remove-AzComputeContainerService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzComputeContainerService -InputObject <IComputeIdentity> [-DefaultProfile <PSObject>] [-AsJob]
