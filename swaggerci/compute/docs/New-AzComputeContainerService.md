...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220911.IContainerServiceAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220911.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
