...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
