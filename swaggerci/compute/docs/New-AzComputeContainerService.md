...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220508.IContainerServiceAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220508.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
