...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220919.IContainerServiceAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220919.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
