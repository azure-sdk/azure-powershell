...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceAgentPoolProfile[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceSshPublicKey[]
Parameter Sets: (All)
Aliases:
