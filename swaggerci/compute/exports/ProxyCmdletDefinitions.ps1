...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Compute.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220919.IContainerServiceAgentPoolProfile[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Compute.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220919.IContainerServiceSshPublicKey[]]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Compute.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220919.IResourceTags]))]
...
INPUTOBJECT <IComputeIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.compute/remove-azcomputecontainerservice
#>
function Remove-AzComputeContainerService {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.Compute.private\Remove-AzComputeContainerService_Delete';
            DeleteViaIdentity = 'Az.Compute.private\Remove-AzComputeContainerService_DeleteViaIdentity';
        }
