...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/containerServices/{containerServiceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzComputeContainerService_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.Description(@"Deletes the specified container service in the specified subscription and resource group. The operation does not delete other resources created as part of creating a container service, including storage accounts, VMs, and availability sets. All the other resources created with the container service are part of the same resource group and can be deleted individually.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.Generated]
    public partial class RemoveAzComputeContainerService_Delete : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzComputeContainerService_Delete</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets.RemoveAzComputeContainerService_Delete Clone()
        {
            var clone = new RemoveAzComputeContainerService_Delete();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ContainerServicesDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ContainerServicesDelete(ResourceGroupName, Name, SubscriptionId, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzComputeContainerService_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAzComputeContainerService_Delete()
        {
