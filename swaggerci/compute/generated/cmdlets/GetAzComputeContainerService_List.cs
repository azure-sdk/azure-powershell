...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/containerServices"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzComputeContainerService_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.Description(@"Gets a list of container services in the specified subscription. The operation returns properties of each container service including state, orchestrator, number of masters and agents, and FQDNs of masters and agents.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Compute.Generated]
    public partial class GetAzComputeContainerService_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzComputeContainerService_List" /> cmdlet class.
        /// </summary>
        public GetAzComputeContainerService_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ContainerServicesList(SubscriptionId, onOk, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ContainerServicesList_Call(requestMessage, onOk, this, Pipeline);
                        }
                    }
                }
            }
