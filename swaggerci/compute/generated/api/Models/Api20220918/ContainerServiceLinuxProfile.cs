...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918
{
    ...
    public partial class ContainerServiceLinuxProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceLinuxProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceLinuxProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshConfiguration Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceLinuxProfileInternal.Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.ContainerServiceSshConfiguration()); set { {_ssh = value;} } }

        /// <summary>Backing field for <see cref="Ssh" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshConfiguration _ssh;

        /// <summary>The ssh key configuration for Linux VMs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshConfiguration Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.ContainerServiceSshConfiguration()); set => this._ssh = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshPublicKey[] SshPublicKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshConfigurationInternal)Ssh).PublicKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshConfigurationInternal)Ssh).PublicKey = value ; }
...

    {
        ...
        string AdminUsername { get; set; }
        /// <summary>The ssh key configuration for Linux VMs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshConfiguration Ssh { get; set; }
        /// <summary>the list of SSH public keys used to authenticate with Linux-based VMs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220918.IContainerServiceSshPublicKey[] SshPublicKey { get; set; }
