...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api202211
{
    ...
    public partial class ContainerServiceDiagnosticsProfile
    {
        ...
        internal ContainerServiceDiagnosticsProfile(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_vMDiagnostic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("vmDiagnostics"), out var __jsonVMDiagnostics) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api202211.ContainerServiceVMDiagnostics.FromJson(__jsonVMDiagnostics) : VMDiagnostic;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api202211.IContainerServiceDiagnosticsProfile.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api202211.IContainerServiceDiagnosticsProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api202211.IContainerServiceDiagnosticsProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
