...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class ComputeIdentity
    {
        ...
        internal ComputeIdentity(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("ContainerServiceName"))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IComputeIdentityInternal)this).ContainerServiceName = (string) content.GetValueForProperty("ContainerServiceName",((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.IComputeIdentityInternal)this).ContainerServiceName, global::System.Convert.ToString);
            }
