...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview
{
    ...
    public partial class ContainerServiceProperties
    {
        ...
        internal ContainerServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_orchestratorProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("orchestratorProfile"), out var __jsonOrchestratorProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceOrchestratorProfile.FromJson(__jsonOrchestratorProfile) : OrchestratorProfile;}
            {_customProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("customProfile"), out var __jsonCustomProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceCustomProfile.FromJson(__jsonCustomProfile) : CustomProfile;}
            {_servicePrincipalProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("servicePrincipalProfile"), out var __jsonServicePrincipalProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServicePrincipalProfile.FromJson(__jsonServicePrincipalProfile) : ServicePrincipalProfile;}
            {_masterProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("masterProfile"), out var __jsonMasterProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceMasterProfile.FromJson(__jsonMasterProfile) : MasterProfile;}
            {_windowsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("windowsProfile"), out var __jsonWindowsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceWindowsProfile.FromJson(__jsonWindowsProfile) : WindowsProfile;}
            {_linuxProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("linuxProfile"), out var __jsonLinuxProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceLinuxProfile.FromJson(__jsonLinuxProfile) : LinuxProfile;}
            {_diagnosticsProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject>("diagnosticsProfile"), out var __jsonDiagnosticsProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceDiagnosticsProfile.FromJson(__jsonDiagnosticsProfile) : DiagnosticsProfile;}
            ...
            {_agentPoolProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonArray>("agentPoolProfiles"), out var __jsonAgentPoolProfiles) ? If( __jsonAgentPoolProfiles as Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceAgentPoolProfile[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceAgentPoolProfile) (Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.ContainerServiceAgentPoolProfile.FromJson(__u) )) ))() : null : AgentPoolProfile;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20221108Preview.IContainerServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode node)
        {
