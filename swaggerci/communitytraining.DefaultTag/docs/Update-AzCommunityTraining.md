...
online version: https://learn.microsoft.com/powershell/module/az.community/update-azcommunitytraining
schema: 2.0.0
---

# Update-AzCommunityTraining
...
```
Update-AzCommunityTraining -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-IdentityConfigurationTeamsEnabled] [-IdentityConfigurationTenantId <String>] [-SkuCapacity <Int32>]
...
```
Update-AzCommunityTraining -InputObject <ICommunityIdentity>
 [-IdentityConfigurationB2CAuthenticationPolicy <String>]
 [-IdentityConfigurationB2CPasswordResetPolicy <String>] [-IdentityConfigurationClientId <String>]
 [-IdentityConfigurationClientSecret <SecureString>] [-IdentityConfigurationCustomLoginParameter <String>]
 [-IdentityConfigurationDomainName <String>] [-IdentityConfigurationIdentityType <String>]
