...
online version: https://learn.microsoft.com/powershell/module/az.communitytest/new-azcommunitytestcommunitytraining
schema: 2.0.0
---

# New-AzCommunityTestCommunityTraining
...
```
New-AzCommunityTestCommunityTraining -Name <String> -ResourceGroupName <String> -Location <String>
