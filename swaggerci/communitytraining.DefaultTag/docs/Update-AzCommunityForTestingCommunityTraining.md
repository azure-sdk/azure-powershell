...
online version: https://learn.microsoft.com/powershell/module/az.communityfortesting/update-azcommunityfortestingcommunitytraining
schema: 2.0.0
---

# Update-AzCommunityForTestingCommunityTraining
...
```
Update-AzCommunityForTestingCommunityTraining -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IdentityConfigurationB2CAuthenticationPolicy <String>]
...
```
Update-AzCommunityForTestingCommunityTraining -InputObject <ICommunityForTestingIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CommunityForTesting.Support.SkuTier
Parameter Sets: (All)
Aliases:
