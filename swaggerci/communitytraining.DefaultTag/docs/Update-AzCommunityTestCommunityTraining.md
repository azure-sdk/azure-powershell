...
online version: https://learn.microsoft.com/powershell/module/az.communitytest/update-azcommunitytestcommunitytraining
schema: 2.0.0
---

# Update-AzCommunityTestCommunityTraining
...
```
Update-AzCommunityTestCommunityTraining -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzCommunityTestCommunityTraining -InputObject <ICommunityTestIdentity>
 [-IdentityConfigurationB2CAuthenticationPolicy <String>]
 [-IdentityConfigurationB2CPasswordResetPolicy <String>] [-IdentityConfigurationClientId <String>]
 [-IdentityConfigurationClientSecret <SecureString>] [-IdentityConfigurationCustomLoginParameter <String>]
 [-IdentityConfigurationDomainName <String>] [-IdentityConfigurationIdentityType <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CommunityTest.Support.SkuTier
Parameter Sets: (All)
Aliases:
