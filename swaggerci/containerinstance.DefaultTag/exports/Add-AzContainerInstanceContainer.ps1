...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IContainerAttachResponse
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IContainerAttachResponse])]
