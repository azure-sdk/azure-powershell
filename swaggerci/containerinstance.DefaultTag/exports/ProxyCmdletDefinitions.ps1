...
SECRET <ISecretReference[]>: The secret references that will be referenced within the container group.
  Identity <String>: The resource id of the managed identity that has access to the secret in the key vault
