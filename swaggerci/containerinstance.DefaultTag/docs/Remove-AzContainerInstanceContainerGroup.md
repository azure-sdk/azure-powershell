...
online version: https://learn.microsoft.com/powershell/module/az.containerinstance/remove-azcontainerinstancecontainergroup
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzContainerInstanceContainerGroup -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzContainerInstanceContainerGroup -InputObject <IContainerInstanceIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IContainerGroup
