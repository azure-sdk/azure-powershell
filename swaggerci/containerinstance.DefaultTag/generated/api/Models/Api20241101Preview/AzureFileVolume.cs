...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview
{
    ...
    public partial class AzureFileVolume :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IAzureFileVolume,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IAzureFileVolumeInternal
    {
        ...
        /// <summary>Backing field for <see cref="StorageAccountKeyReference" /> property.</summary>
        private string _storageAccountKeyReference;

        /// <summary>
        /// The reference to the storage account access key used to access the Azure File share.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        public string StorageAccountKeyReference { get => this._storageAccountKeyReference; set => this._storageAccountKeyReference = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string StorageAccountKeyReference { get; set; }
        /// <summary>The name of the storage account that contains the Azure File share.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Info(
        Required = true,
        ReadOnly = false,
