...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview
{
    ...
    public partial class SecurityContextDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinition _capability;

        /// <summary>The capabilities to add or drop from a container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinition Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.SecurityContextCapabilitiesDefinition()); set => this._capability = value; }
        ...
        public string[] CapabilityAdd { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinitionInternal)Capability).Add; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinitionInternal)Capability).Add = value ?? null /* arrayOf */; }

        /// <summary>The capabilities to drop from the container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Inlined)]
        public string[] CapabilityDrop { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinitionInternal)Capability).Drop; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinitionInternal)Capability).Drop = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for Capability</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinition Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextDefinitionInternal.Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.SecurityContextCapabilitiesDefinition()); set { {_capability = value;} } }
...

    {
        ...
        bool? AllowPrivilegeEscalation { get; set; }
        /// <summary>The capabilities to add or drop from a container.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.ISecurityContextCapabilitiesDefinition Capability { get; set; }
        /// <summary>The capabilities to add to the container.</summary>
        string[] CapabilityAdd { get; set; }
        /// <summary>The capabilities to drop from the container.</summary>
        string[] CapabilityDrop { get; set; }
