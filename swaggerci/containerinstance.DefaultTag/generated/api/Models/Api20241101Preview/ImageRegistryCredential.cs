...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview
{
    ...
    public partial class ImageRegistryCredential :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IImageRegistryCredentialInternal
    {
        ...
        /// <summary>Backing field for <see cref="PasswordReference" /> property.</summary>
        private string _passwordReference;

        /// <summary>The reference for the private registry password.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        public string PasswordReference { get => this._passwordReference; set => this._passwordReference = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string PasswordReference { get; set; }
        /// <summary>The Docker image registry server without a protocol such as "http" and "https".</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Info(
        Required = true,
        ReadOnly = false,
