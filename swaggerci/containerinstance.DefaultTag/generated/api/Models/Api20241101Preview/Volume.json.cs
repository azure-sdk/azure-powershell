...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview
{
    ...
    public partial class Volume
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IVolume.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IVolume.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.IVolume FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._secretReference ? (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode) this._secretReference.ToJson(null,serializationMode) : null, "secretReference" ,container.Add );
        ...
        internal Volume(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_azureFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("azureFile"), out var __jsonAzureFile) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.AzureFileVolume.FromJson(__jsonAzureFile) : AzureFile;}
            {_gitRepo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("gitRepo"), out var __jsonGitRepo) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.GitRepoVolume.FromJson(__jsonGitRepo) : GitRepo;}
            ...
            {_secret = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("secret"), out var __jsonSecret) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.SecretVolume.FromJson(__jsonSecret) : Secret;}
            {_secretReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("secretReference"), out var __jsonSecretReference) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241101Preview.SecretReferenceVolume.FromJson(__jsonSecretReference) : SecretReference;}
            AfterFromJson(json);
        }
    }
}