...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501
{
    ...
    public partial class SecurityContextDefinition :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextDefinition,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextDefinitionInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextCapabilitiesDefinition _capability;

        /// <summary>The capabilities to add or drop from a container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextCapabilitiesDefinition Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.SecurityContextCapabilitiesDefinition()); set => this._capability = value; }
        ...
        public string[] CapabilityAdd { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextCapabilitiesDefinitionInternal)Capability).Add; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextCapabilitiesDefinitionInternal)Capability).Add = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextCapabilitiesDefinition Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextDefinitionInternal.Capability { get => (this._capability = this._capability ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.SecurityContextCapabilitiesDefinition()); set { {_capability = value;} } }
...

    {
        ...
        bool? AllowPrivilegeEscalation { get; set; }
        /// <summary>The capabilities to add or drop from a container.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.ISecurityContextCapabilitiesDefinition Capability { get; set; }
        /// <summary>The capabilities to add to the container.</summary>
        string[] CapabilityAdd { get; set; }
        /// <summary>The capabilities to drop from the container.</summary>
        string[] CapabilityDrop { get; set; }
