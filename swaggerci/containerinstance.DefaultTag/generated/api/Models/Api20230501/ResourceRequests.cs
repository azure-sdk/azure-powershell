...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501
{
    ...
    public partial class ResourceRequests :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IResourceRequests,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IResourceRequestsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResource _gpu;

        /// <summary>The GPU request of this container instance.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResource Gpu { get => (this._gpu = this._gpu ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.GpuResource()); set => this._gpu = value; }
        ...
        public int? GpuCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResourceInternal)Gpu).Count; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResourceInternal)Gpu).Count = value ?? default(int); }

        /// <summary>The SKU of the GPU resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku? GpuSku { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResourceInternal)Gpu).Sku; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResourceInternal)Gpu).Sku = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku)""); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResource Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IResourceRequestsInternal.Gpu { get => (this._gpu = this._gpu ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.GpuResource()); set { {_gpu = value;} } }
...

    {
        ...
        double Cpu { get; set; }
        /// <summary>The GPU request of this container instance.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20230501.IGpuResource Gpu { get; set; }
        /// <summary>The count of the GPU resource.</summary>
        int? GpuCount { get; set; }
        /// <summary>The SKU of the GPU resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku? GpuSku { get; set; }
