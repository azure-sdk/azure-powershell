...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview
{
    ...
    public partial class Volume
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IVolume.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IVolume.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IVolume FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
        ...
        internal Volume(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_azureFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("azureFile"), out var __jsonAzureFile) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.AzureFileVolume.FromJson(__jsonAzureFile) : AzureFile;}
            {_gitRepo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("gitRepo"), out var __jsonGitRepo) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.GitRepoVolume.FromJson(__jsonGitRepo) : GitRepo;}
            ...
            {_secret = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("secret"), out var __jsonSecret) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.SecretVolume.FromJson(__jsonSecret) : Secret;}
            {_secretReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("secretReference"), out var __jsonSecretReference) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.SecretReferenceVolume.FromJson(__jsonSecretReference) : SecretReference;}
            AfterFromJson(json);
        }
    }
}