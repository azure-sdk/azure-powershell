...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview
{
    ...
    public partial class ResourceRequirements
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IResourceRequirements.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IResourceRequirements.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IResourceRequirements FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
        ...
        internal ResourceRequirements(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_request = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("requests"), out var __jsonRequests) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ResourceRequests.FromJson(__jsonRequests) : Request;}
            {_limit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("limits"), out var __jsonLimits) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ResourceLimits.FromJson(__jsonLimits) : Limit;}
            AfterFromJson(json);
        }
