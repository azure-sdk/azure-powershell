...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview
{
    ...
    public partial class ContainerProperties
    {
        ...
        internal ContainerProperties(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_instanceView = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("instanceView"), out var __jsonInstanceView) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ContainerPropertiesInstanceView.FromJson(__jsonInstanceView) : InstanceView;}
            {_resource = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("resources"), out var __jsonResources) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ResourceRequirements.FromJson(__jsonResources) : Resource;}
            {_livenessProbe = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("livenessProbe"), out var __jsonLivenessProbe) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ContainerProbe.FromJson(__jsonLivenessProbe) : LivenessProbe;}
            {_readinessProbe = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("readinessProbe"), out var __jsonReadinessProbe) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ContainerProbe.FromJson(__jsonReadinessProbe) : ReadinessProbe;}
            ...
            {_configMap = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("configMap"), out var __jsonConfigMap) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ConfigMap.FromJson(__jsonConfigMap) : ConfigMap;}
            ...
            {_port = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("ports"), out var __jsonPorts) ? If( __jsonPorts as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerPort[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerPort) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.ContainerPort.FromJson(__p) )) ))() : null : Port;}
            {_environmentVariable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("environmentVariables"), out var __jsonEnvironmentVariables) ? If( __jsonEnvironmentVariables as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IEnvironmentVariable[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IEnvironmentVariable) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.EnvironmentVariable.FromJson(__k) )) ))() : null : EnvironmentVariable;}
            {_volumeMount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("volumeMounts"), out var __jsonVolumeMounts) ? If( __jsonVolumeMounts as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IVolumeMount[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IVolumeMount) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.VolumeMount.FromJson(__f) )) ))() : null : VolumeMount;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
