...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview
{
    ...
    public partial class ResourceRequests :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IResourceRequests,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IResourceRequestsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IGpuResource _gpu;

        /// <summary>The GPU request of this container instance.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IGpuResource Gpu { get => (this._gpu = this._gpu ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.GpuResource()); set => this._gpu = value; }
        ...
        public int? GpuCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IGpuResourceInternal)Gpu).Count; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IGpuResourceInternal)Gpu).Count = value ?? default(int); }
...

    {
        ...
        double Cpu { get; set; }
        /// <summary>The GPU request of this container instance.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IGpuResource Gpu { get; set; }
        /// <summary>The count of the GPU resource.</summary>
        int? GpuCount { get; set; }
        /// <summary>The SKU of the GPU resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Support.GpuSku? GpuSku { get; set; }
