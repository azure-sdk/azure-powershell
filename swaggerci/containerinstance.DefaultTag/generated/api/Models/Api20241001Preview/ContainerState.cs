...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview
{
    ...
    public partial class ContainerState :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerState,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerStateInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerStateInternal.DetailStatus { get => this._detailStatus; set { {_detailStatus = value;} } }

        /// <summary>Internal Acessors for ExitCode</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerStateInternal.ExitCode { get => this._exitCode; set { {_exitCode = value;} } }

        /// <summary>Internal Acessors for FinishTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerStateInternal.FinishTime { get => this._finishTime; set { {_finishTime = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerStateInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for State</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20241001Preview.IContainerStateInternal.State { get => this._state; set { {_state = value;} } }
