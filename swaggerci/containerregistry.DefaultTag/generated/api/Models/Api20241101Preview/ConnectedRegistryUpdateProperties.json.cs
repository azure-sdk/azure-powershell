...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview
{
    ...
    public partial class ConnectedRegistryUpdateProperties
    {
        ...
        internal ConnectedRegistryUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_syncProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("syncProperties"), out var __jsonSyncProperties) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.SyncUpdateProperties.FromJson(__jsonSyncProperties) : SyncProperty;}
            {_logging = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("logging"), out var __jsonLogging) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.LoggingProperties.FromJson(__jsonLogging) : Logging;}
            {_garbageCollection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("garbageCollection"), out var __jsonGarbageCollection) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.GarbageCollectionProperties.FromJson(__jsonGarbageCollection) : GarbageCollection;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.IConnectedRegistryUpdateProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.IConnectedRegistryUpdateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.IConnectedRegistryUpdateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode node)
        {
