...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview
{
    ...
    public partial class TaskPropertiesUpdateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ITaskPropertiesUpdateParameters.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ITaskPropertiesUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ITaskPropertiesUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode node)
        {
        ...
        internal TaskPropertiesUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_platform = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("platform"), out var __jsonPlatform) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.PlatformUpdateParameters.FromJson(__jsonPlatform) : Platform;}
            ...
            {_step = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("step"), out var __jsonStep) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.TaskStepUpdateParameters.FromJson(__jsonStep) : Step;}
            {_trigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("trigger"), out var __jsonTrigger) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.TriggerUpdateParameters.FromJson(__jsonTrigger) : Trigger;}
            {_credentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("credentials"), out var __jsonCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.Credentials.FromJson(__jsonCredentials) : Credentials;}
