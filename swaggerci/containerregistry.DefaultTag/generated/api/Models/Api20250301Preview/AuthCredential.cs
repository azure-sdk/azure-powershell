...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview
{
    ...
    public partial class AuthCredential :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.IAuthCredentialInternal
    {

        /// <summary>Backing field for <see cref="CredentialHealth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ICredentialHealth _credentialHealth;

        /// <summary>This provides data pertaining to the health of the auth credential.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ICredentialHealth CredentialHealth { get => (this._credentialHealth = this._credentialHealth ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.CredentialHealth()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ICredentialHealth Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.IAuthCredentialInternal.CredentialHealth { get => (this._credentialHealth = this._credentialHealth ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.CredentialHealth()); set { {_credentialHealth = value;} } }
    ...
    {
        /// <summary>This provides data pertaining to the health of the auth credential.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250301Preview.ICredentialHealth CredentialHealth { get; set; }
        /// <summary>Error code representing the health check error.</summary>
        string CredentialHealthErrorCode { get; set; }
        /// <summary>Descriptive message representing the health check error.</summary>
        string CredentialHealthErrorMessage { get; set; }
