...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview
{
    ...
    public partial class AuthCredential :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.IAuthCredentialInternal
    {

        /// <summary>Backing field for <see cref="CredentialHealth" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealth _credentialHealth;

        /// <summary>This provides data pertaining to the health of the auth credential.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealth CredentialHealth { get => (this._credentialHealth = this._credentialHealth ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.CredentialHealth()); }

        /// <summary>Error code representing the health check error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Inlined)]
        public string CredentialHealthErrorCode { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealthInternal)CredentialHealth).ErrorCode; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealthInternal)CredentialHealth).ErrorCode = value ?? null; }

        /// <summary>Descriptive message representing the health check error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Inlined)]
        public string CredentialHealthErrorMessage { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealthInternal)CredentialHealth).ErrorMessage; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealthInternal)CredentialHealth).ErrorMessage = value ?? null; }

        /// <summary>The health status of credential.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.CredentialHealthStatus? CredentialHealthStatus { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealthInternal)CredentialHealth).Status; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealthInternal)CredentialHealth).Status = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.CredentialHealthStatus)""); }

        /// <summary>Internal Acessors for CredentialHealth</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealth Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.IAuthCredentialInternal.CredentialHealth { get => (this._credentialHealth = this._credentialHealth ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.CredentialHealth()); set { {_credentialHealth = value;} } }
    ...
    {
        /// <summary>This provides data pertaining to the health of the auth credential.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ICredentialHealth CredentialHealth { get; set; }
        /// <summary>Error code representing the health check error.</summary>
        string CredentialHealthErrorCode { get; set; }
        /// <summary>Descriptive message representing the health check error.</summary>
        string CredentialHealthErrorMessage { get; set; }
