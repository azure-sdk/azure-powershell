...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models
{
    ...
    public partial class ContainerRegistryIdentity
    {
        ...
        internal ContainerRegistryIdentity(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_packageType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("packageType"), out var __jsonPackageType) ? (string)__jsonPackageType : (string)PackageType;}
            {_archiveName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("archiveName"), out var __jsonArchiveName) ? (string)__jsonArchiveName : (string)ArchiveName;}
            {_archiveVersionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString>("archiveVersionName"), out var __jsonArchiveVersionName) ? (string)__jsonArchiveVersionName : (string)ArchiveVersionName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._packageType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString(this._packageType.ToString()) : null, "packageType" ,container.Add );
            AddIf( null != (((object)this._archiveName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString(this._archiveName.ToString()) : null, "archiveName" ,container.Add );
            AddIf( null != (((object)this._archiveVersionName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonString(this._archiveVersionName.ToString()) : null, "archiveVersionName" ,container.Add );
