...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.IContainerRegistryIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="ArchiveVersionName" /> property.</summary>
        private string _archiveVersionName;

        /// <summary>The name of the archive version resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Owned)]
        public string ArchiveVersionName { get => this._archiveVersionName; set => this._archiveVersionName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string ArchiveVersionName { get; set; }
        /// <summary>The name of the cache rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
