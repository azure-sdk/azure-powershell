...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview
{
    ...
    public partial class DockerBuildStepUpdateParameters :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IDockerBuildStepUpdateParameters,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IDockerBuildStepUpdateParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParameters"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParameters __taskStepUpdateParameters = new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.TaskStepUpdateParameters();

        /// <summary>Backing field for <see cref="Argument" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArgument[] _argument;

        /// <summary>The collection of override arguments to be used when executing this build step.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArgument[] Argument { get => this._argument; set => this._argument = value; }
        ...
        public string ContextAccessToken { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal)__taskStepUpdateParameters).ContextAccessToken; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal)__taskStepUpdateParameters).ContextAccessToken = value ?? null; }

        /// <summary>The URL(absolute or relative) of the source context for the task step.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Inherited)]
        public string ContextPath { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal)__taskStepUpdateParameters).ContextPath; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal)__taskStepUpdateParameters).ContextPath = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.PropertyOrigin.Inherited)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.StepType Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal)__taskStepUpdateParameters).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal)__taskStepUpdateParameters).Type = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParameters
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArgument) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArgument[] Argument { get; set; }
        /// <summary>The Docker file path relative to the source context.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    internal partial interface IDockerBuildStepUpdateParametersInternal :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.ITaskStepUpdateParametersInternal
    {
        /// <summary>The collection of override arguments to be used when executing this build step.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArgument[] Argument { get; set; }
        /// <summary>The Docker file path relative to the source context.</summary>
