...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview
{
    ...
    public partial class ConnectedRegistryProperties
    {
        ...
        internal ConnectedRegistryProperties(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_activation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("activation"), out var __jsonActivation) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.ActivationProperties.FromJson(__jsonActivation) : Activation;}
            {_parent = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("parent"), out var __jsonParent) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.ParentProperties.FromJson(__jsonParent) : Parent;}
            {_loginServer = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("loginServer"), out var __jsonLoginServer) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.LoginServerProperties.FromJson(__jsonLoginServer) : LoginServer;}
            {_logging = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("logging"), out var __jsonLogging) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.LoggingProperties.FromJson(__jsonLogging) : Logging;}
            {_garbageCollection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("garbageCollection"), out var __jsonGarbageCollection) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.GarbageCollectionProperties.FromJson(__jsonGarbageCollection) : GarbageCollection;}
            ...
            {_statusDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonArray>("statusDetails"), out var __jsonStatusDetails) ? If( __jsonStatusDetails as Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IStatusDetailProperties[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IStatusDetailProperties) (Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.StatusDetailProperties.FromJson(__p) )) ))() : null : StatusDetail;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IConnectedRegistryProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IConnectedRegistryProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IConnectedRegistryProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode node)
        {
