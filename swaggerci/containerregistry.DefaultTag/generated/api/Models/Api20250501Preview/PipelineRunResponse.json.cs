...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview
{
    ...
    public partial class PipelineRunResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IPipelineRunResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IPipelineRunResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.IPipelineRunResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonNode node)
        {
        ...
        internal PipelineRunResponse(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_progress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("progress"), out var __jsonProgress) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.ProgressProperties.FromJson(__jsonProgress) : Progress;}
            {_source = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("source"), out var __jsonSource) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.ImportPipelineSourceProperties.FromJson(__jsonSource) : Source;}
            {_target = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("target"), out var __jsonTarget) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.ExportPipelineTargetProperties.FromJson(__jsonTarget) : Target;}
            {_trigger = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Json.JsonObject>("trigger"), out var __jsonTrigger) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250501Preview.PipelineTriggerDescriptor.FromJson(__jsonTrigger) : Trigger;}
