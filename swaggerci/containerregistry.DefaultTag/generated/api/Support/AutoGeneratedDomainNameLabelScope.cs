...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope NoReuse = @"NoReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope ResourceGroupReuse = @"ResourceGroupReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope SubscriptionReuse = @"SubscriptionReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope TenantReuse = @"TenantReuse";

        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope Unsecure = @"Unsecure";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope e1, Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope e2)
        {
            return !e2.Equals(e1);
        }
