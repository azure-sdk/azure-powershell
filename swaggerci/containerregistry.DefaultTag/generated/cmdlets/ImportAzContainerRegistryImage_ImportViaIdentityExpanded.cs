...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Import, @"AzContainerRegistryImage_ImportViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/importImage", ApiVersion = "2024-01-01-preview")]
    public partial class ImportAzContainerRegistryImage_ImportViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.IImportImageParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.ImportImageParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The password used to authenticate with the source registry.")]
        ...
        public string CredentialsPassword { get => _parametersBody.CredentialsPassword ?? null; set => _parametersBody.CredentialsPassword = value; }

        /// <summary>The username to authenticate with the source registry.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The username to authenticate with the source registry.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string CredentialsUsername { get => _parametersBody.CredentialsUsername ?? null; set => _parametersBody.CredentialsUsername = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When Force, any existing target tags will be overwritten. When NoForce, any existing target tags will fail the operation before any copying begins.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.ImportMode))]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.ImportMode Mode { get => _parametersBody.Mode ?? ((Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.ImportMode)""); set => _parametersBody.Mode = value; }
        ...
        /// <summary>The resource identifier of the source Cache Rule.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource identifier of the source Cache Rule.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"The resource identifier of the source Cache Rule.",
        SerializedName = @"cacheRuleResourceId",
        PossibleTypes = new [] { typeof(string) })]
        public string SourceCacheRuleResourceId { get => _parametersBody.SourceCacheRuleResourceId ?? null; set => _parametersBody.SourceCacheRuleResourceId = value; }

        /// <summary>
        /// Repository name of the source image.Specify an image by repository ('hello-world'). This will use the 'latest' tag.Specify
        /// an image by tag ('hello-world:latest').Specify an image by sha256-based manifest digest ('hello-world@sha256:abc123').
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Repository name of the source image.Specify an image by repository ('hello-world'). This will use the 'latest' tag.Specify an image by tag ('hello-world:latest').Specify an image by sha256-based manifest digest ('hello-world@sha256:abc123').")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Repository name of the source image.Specify an image by repository ('hello-world'). This will use the 'latest' tag.Specify an image by tag ('hello-world:latest').Specify an image by sha256-based manifest digest ('hello-world@sha256:abc123').",
        SerializedName = @"sourceImage",
        PossibleTypes = new [] { typeof(string) })]
        public string SourceImage { get => _parametersBody.SourceImage ?? null; set => _parametersBody.SourceImage = value; }

        /// <summary>The address of the source registry (e.g. 'mcr.microsoft.com').</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The address of the source registry (e.g. 'mcr.microsoft.com').")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceRegistryUri { get => _parametersBody.SourceRegistryUri ?? null; set => _parametersBody.SourceRegistryUri = value; }

        /// <summary>The resource identifier of the source Azure Container Registry.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource identifier of the source Azure Container Registry.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of strings of the form repo[:tag]. When tag is omitted the source will be used (or 'latest' if source tag is also omitted).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] TargetTag { get => _parametersBody.TargetTag ?? null /* arrayOf */; set => _parametersBody.TargetTag = value; }

        /// <summary>
        /// List of strings of repository names to do a manifest only copy. No tag will be created.
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of strings of repository names to do a manifest only copy. No tag will be created.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] UntaggedTargetRepository { get => _parametersBody.UntaggedTargetRepository ?? null /* arrayOf */; set => _parametersBody.UntaggedTargetRepository = value; }
        ...
        /// <returns>
        /// a duplicate instance of ImportAzContainerRegistryImage_ImportViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Cmdlets.ImportAzContainerRegistryImage_ImportViaIdentityExpanded Clone()
        {
            var clone = new ImportAzContainerRegistryImage_ImportViaIdentityExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzContainerRegistryImage_ImportViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ImportAzContainerRegistryImage_ImportViaIdentityExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RegistriesImportImageViaIdentity(InputObject.Id, _parametersBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RegistriesImportImage(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.RegistryName ?? null, _parametersBody, onOk, this, Pipeline);
                    }
