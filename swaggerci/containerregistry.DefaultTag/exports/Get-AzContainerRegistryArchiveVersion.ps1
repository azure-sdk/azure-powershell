...
INPUTOBJECT <IContainerRegistryIdentity>: Identity Parameter
  ...
  [PackageType <String>]: The type of the repository resource.
...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/get-azcontainerregistryarchiveversion
#>
function Get-AzContainerRegistryArchiveVersion {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.IArchiveVersion])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerRegistry.private\Get-AzContainerRegistryArchiveVersion_Get';
            GetViaIdentity = 'Az.ContainerRegistry.private\Get-AzContainerRegistryArchiveVersion_GetViaIdentity';
            List = 'Az.ContainerRegistry.private\Get-AzContainerRegistryArchiveVersion_List';
        }
