...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArchiveVersion
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IArchiveVersion])]
