...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/get-azcontainerregistrycredentials
#>
function Get-AzContainerRegistryCredentials {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.IRegistryListCredentialsResult])]
