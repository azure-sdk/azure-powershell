...
CREDENTIALSCERTIFICATE <ITokenCertificate[]>: The list of certificates configured with the token.
...
CREDENTIALSPASSWORD <ITokenPassword[]>: The list of passwords generated for the token.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.IToken])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.ITokenCertificate[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.ITokenPassword[]]
