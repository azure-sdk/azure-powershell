...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/new-azcontainerregistryarchive
#>
function New-AzContainerRegistryArchive {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.IArchive])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.PackageSourceType])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.PackageSourceType]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.ContainerRegistry.private\New-AzContainerRegistryArchive_CreateExpanded';
        }
