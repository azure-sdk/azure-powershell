...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IRegistryNameStatus
.Notes
...
REGISTRYNAMECHECKREQUEST <IRegistryNameCheckRequest>: A request to check whether a container registry name is available.
  ...
  [AutoGeneratedDomainNameLabelScope <AutoGeneratedDomainNameLabelScope?>]: The auto generated domain name label of the container registry. This value defaults to "Unsecure".
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IRegistryNameStatus])]
...
param(
    ...
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope])]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.AutoGeneratedDomainNameLabelScope]
