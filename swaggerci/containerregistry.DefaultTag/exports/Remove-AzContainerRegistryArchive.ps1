...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/remove-azcontainerregistryarchive
#>
function Remove-AzContainerRegistryArchive {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerRegistry.private\Remove-AzContainerRegistryArchive_Delete';
            DeleteViaIdentity = 'Az.ContainerRegistry.private\Remove-AzContainerRegistryArchive_DeleteViaIdentity';
        }
