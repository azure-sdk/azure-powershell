...
Update-AzContainerRegistry -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-MetadataSearch <MetadataSearch>] [-NetworkRuleBypassOption <NetworkRuleBypassOptions>]
 ...
 [-RetentionPolicyDay <Int32>] [-RetentionPolicyStatus <PolicyStatus>]
 [-RoleAssignmentMode <RoleAssignmentMode>] [-SkuName <SkuName>] [-SoftDeletePolicyRetentionDay <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.MetadataSearch
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IIPRule[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.RoleAssignmentMode
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IRegistry
