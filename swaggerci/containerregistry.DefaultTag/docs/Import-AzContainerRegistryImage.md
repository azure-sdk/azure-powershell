...
Import-AzContainerRegistryImage -RegistryName <String> -ResourceGroupName <String> -SourceImage <String>
 ...
 [-Mode <ImportMode>] [-SourceCacheRuleResourceId <String>] [-SourceRegistryUri <String>]
...
Import-AzContainerRegistryImage -InputObject <IContainerRegistryIdentity> -SourceImage <String>
 ...
 [-SourceCacheRuleResourceId <String>] [-SourceRegistryUri <String>] [-SourceResourceId <String>]
 [-TargetTag <String[]>] [-UntaggedTargetRepository <String[]>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202401Preview.IImportImageParameters
