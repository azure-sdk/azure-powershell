...
New-AzContainerRegistry -Name <String> -ResourceGroupName <String> -Location <String> -SkuName <SkuName>
 ...
 [-RetentionPolicyStatus <PolicyStatus>] [-RoleAssignmentMode <RoleAssignmentMode>]
 [-SoftDeletePolicyRetentionDay <Int32>] [-SoftDeletePolicyStatus <PolicyStatus>] [-Tag <Hashtable>]
 [-TrustPolicyStatus <PolicyStatus>] [-TrustPolicyType <TrustPolicyType>] [-ZoneRedundancy <ZoneRedundancy>]
