...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.ITokenCertificate[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20241101Preview.ITokenPassword[]
Parameter Sets: (All)
Aliases:
