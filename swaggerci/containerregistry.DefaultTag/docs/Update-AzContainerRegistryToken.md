...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ITokenCertificate[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20231101Preview.ITokenPassword[]
Parameter Sets: (All)
Aliases:
