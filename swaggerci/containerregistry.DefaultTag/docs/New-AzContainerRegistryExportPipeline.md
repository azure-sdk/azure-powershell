...
New-AzContainerRegistryExportPipeline -Name <String> -RegistryName <String> -ResourceGroupName <String>
 ...
 [-Location <String>] [-Option <PipelineOptions[]>] [-TargetKeyVaultUri <String>]
 [-TargetStorageAccessMode <StorageAccessMode>] [-TargetType <PipelineTargetType>] [-TargetUri <String>]
...
### -TargetStorageAccessMode
The storage access mode used for the customer storage account.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.StorageAccessMode
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Support.PipelineTargetType
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20250601Preview.IExportPipeline
