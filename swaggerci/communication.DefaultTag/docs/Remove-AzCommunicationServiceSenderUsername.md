...
online version: https://learn.microsoft.com/powershell/module/az.communicationservice/remove-azcommunicationservicesenderusername
schema: 2.0.0
---

# Remove-AzCommunicationServiceSenderUsername
...
### Delete (Default)
```
Remove-AzCommunicationServiceSenderUsername -DomainName <String> -EmailServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzCommunicationServiceSenderUsername -InputObject <ICommunicationServiceIdentity>
