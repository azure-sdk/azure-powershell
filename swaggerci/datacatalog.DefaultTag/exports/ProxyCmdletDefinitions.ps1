...
.Link
https://learn.microsoft.com/powershell/module/az.datacatalogrest/get-azdatacatalogrestadccatalog
#>
...
begin {
    try {
        ...
        if (('Get') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $testPlayback = $false
            $PSBoundParameters['HttpPipelinePrepend'] | Foreach-Object { if ($_) { $testPlayback = $testPlayback -or ('Microsoft.Azure.PowerShell.Cmdlets.DataCatalogRest.Runtime.PipelineMock' -eq $_.Target.GetType().FullName -and 'Playback' -eq $_.Target.Mode) } }
            if ($testPlayback) {
        ...
        if ($null -ne $MyInvocation.MyCommand -and [Microsoft.WindowsAzure.Commands.Utilities.Common.AzurePSCmdlet]::PromptedPreviewMessageCmdlets -notcontains $MyInvocation.MyCommand.Name -and [Microsoft.Azure.PowerShell.Cmdlets.DataCatalogRest.Runtime.MessageAttributeHelper]::ContainsPreviewAttribute($cmdInfo, $MyInvocation)){
            [Microsoft.Azure.PowerShell.Cmdlets.DataCatalogRest.Runtime.MessageAttributeHelper]::ProcessPreviewMessageAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
.Link
https://learn.microsoft.com/powershell/module/az.datacatalogrest/get-azdatacatalogrestadcoperation
#>
...
INPUTOBJECT <IDataCatalogRestIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Gets subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://learn.microsoft.com/powershell/module/az.datacatalogrest/invoke-azdatacatalogrestlisttadccatalog
#>
...
USER <IPrincipals[]>: Azure data catalog user list.
  ...
  [Upn <String>]: UPN of the user.
.Link
https://learn.microsoft.com/powershell/module/az.datacatalogrest/new-azdatacatalogrestadccatalog
#>
...
INPUTOBJECT <IDataCatalogRestIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: Gets subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
.Link
https://learn.microsoft.com/powershell/module/az.datacatalogrest/remove-azdatacatalogrestadccatalog
#>
...
USER <IPrincipals[]>: Azure data catalog user list.
  ...
  [Upn <String>]: UPN of the user.
.Link
https://learn.microsoft.com/powershell/module/az.datacatalogrest/update-azdatacatalogrestadccatalog
#>
