...
online version: https://learn.microsoft.com/powershell/module/az.sovereign/remove-azsovereignlandingzoneconfigurationoperation
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSovereignLandingZoneConfigurationOperation -LandingZoneAccountName <String>
...
### DeleteViaIdentity
```
Remove-AzSovereignLandingZoneConfigurationOperation -InputObject <ISovereignIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
