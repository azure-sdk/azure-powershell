...
online version: https://learn.microsoft.com/powershell/module/az.sovereign/remove-azsovereignlandingzoneregistrationoperation
schema: 2.0.0
---

# Remove-AzSovereignLandingZoneRegistrationOperation
...
### Delete (Default)
```
Remove-AzSovereignLandingZoneRegistrationOperation -LandingZoneAccountName <String>
...
### DeleteViaIdentity
```
Remove-AzSovereignLandingZoneRegistrationOperation -InputObject <ISovereignIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
