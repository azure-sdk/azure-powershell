...
using Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.JsonSerializable.ToJson(dict, null);
            }
