...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support
{
    ...
    /// <summary>The custom provisioning state.</summary>
    public partial struct ProvisioningState :
        System.IEquatable<ProvisioningState>
    {
        /// <summary>Resource creation was canceled.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>The state of the resource when creating</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState Creating = @"Creating";

        /// <summary>The state of the resource when deleting</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState Failed = @"Failed";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>The state of the resource when updating</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
