...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSovereignLandingZoneRegistrationOperation_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Description(@"Lists the landing zone registrations within a resource group.")]
    ...
    public partial class GetAzSovereignLandingZoneRegistrationOperation_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzSovereignLandingZoneRegistrationOperation_List1" /> cmdlet class.
        /// </summary>
        public GetAzSovereignLandingZoneRegistrationOperation_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LandingZoneRegistrationOperationsListByResourceGroup(SubscriptionId, ResourceGroupName, LandingZoneAccountName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LandingZoneRegistrationOperationsListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
