...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Description(@"List the landing zone registrations within a landing zone account.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations", ApiVersion = "2025-02-27-preview")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LandingZoneRegistrationOperationsList(SubscriptionId, ResourceGroupName, LandingZoneAccountName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LandingZoneRegistrationOperationsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
