...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Sovereign/landingZoneAccounts"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSovereignLandingZoneAccountOperation_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Description(@"Lists the landing zone accounts within a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Sovereign/landingZoneAccounts", ApiVersion = "2025-02-27-preview")]
    public partial class GetAzSovereignLandingZoneAccountOperation_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzSovereignLandingZoneAccountOperation_List" /> cmdlet class.
        /// </summary>
        public GetAzSovereignLandingZoneAccountOperation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LandingZoneAccountOperationsListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LandingZoneAccountOperationsListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
