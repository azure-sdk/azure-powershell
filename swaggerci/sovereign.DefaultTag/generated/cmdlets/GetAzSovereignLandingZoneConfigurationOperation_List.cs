...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneConfigurations"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Description(@"List the landing zone configurations within a landing zone account.")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LandingZoneConfigurationOperationsList(SubscriptionId, ResourceGroupName, LandingZoneAccountName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LandingZoneConfigurationOperationsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
