...
namespace Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Cmdlets
{
    ...
    /// <summary>Generate the landing zone.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Description(@"Generate the landing zone.")]
    ...
    public partial class NewAzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Models.Api20250227Preview.IGenerateLandingZoneRequest _body;

        /// <summary>The request to generate code for a landing zone.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The request to generate code for a landing zone.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The request to generate code for a landing zone.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Models.Api20250227Preview.IGenerateLandingZoneRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Models.Api20250227Preview.IGenerateLandingZoneRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Sovereign.Cmdlets.NewAzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity Clone()
        {
            var clone = new NewAzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public NewAzSovereignLandingZoneConfigurationOperationLandingZone_GenerateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LandingZoneConfigurationOperationsGenerateLandingZoneViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.LandingZoneConfigurationName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.LandingZoneConfigurationName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.LandingZoneConfigurationOperationsGenerateLandingZone(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.LandingZoneAccountName ?? null, InputObject.LandingZoneConfigurationName ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
