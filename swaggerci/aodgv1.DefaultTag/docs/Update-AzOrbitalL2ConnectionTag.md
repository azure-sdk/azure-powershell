...
online version: https://learn.microsoft.com/powershell/module/az.orbital/update-azorbitall2connectiontag
schema: 2.0.0
---
...
```
Update-AzOrbitalL2ConnectionTag -L2ConnectionName <String> -ResourceGroupName <String>
...
```
Update-AzOrbitalL2ConnectionTag -InputObject <IOrbitalIdentity> [-Tag <Hashtable>]
