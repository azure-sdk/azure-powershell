...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
    ...
    /// <summary>Creates or updates an L2 Connection.</summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/l2Connections/{l2ConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzOrbitalL2Connection_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Description(@"Creates or updates an L2 Connection.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/l2Connections/{l2ConnectionName}", ApiVersion = "2024-03-01-preview")]
    public partial class NewAzOrbitalL2Connection_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.IL2Connection _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.L2Connection();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The edge site's resource ID.")]
        ...
        public string EdgeSiteId { get => _parametersBody.EdgeSiteId ?? null; set => _parametersBody.EdgeSiteId = value; }

        /// <summary>
        /// The unique name of the partner router that cross-connects with the Orbital Edge Router at the edge site.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The unique name of the partner router that cross-connects with the Orbital Edge Router at the edge site.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string EdgeSitePartnerRouterName { get => _parametersBody.EdgeSitePartnerRouterName ?? null; set => _parametersBody.EdgeSitePartnerRouterName = value; }

        /// <summary>The ground station's resource ID.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ground station's resource ID.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string GroundStationId { get => _parametersBody.GroundStationId ?? null; set => _parametersBody.GroundStationId = value; }

        /// <summary>
        /// The unique name of the partner router that cross-connects with the Orbital Edge Router at the ground station site.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The unique name of the partner router that cross-connects with the Orbital Edge Router at the ground station site.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string GroundStationPartnerRouterName { get => _parametersBody.GroundStationPartnerRouterName ?? null; set => _parametersBody.GroundStationPartnerRouterName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "L2 Connection name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("L2ConnectionName")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api40.ITrackedResourceTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }

        /// <summary>The VLAN ID for the L2 connection.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The VLAN ID for the L2 connection.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public int VlanId { get => _parametersBody.VlanId; set => _parametersBody.VlanId = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.IL2Connection">Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.IL2Connection</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.IL2Connection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzOrbitalL2Connection_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets.NewAzOrbitalL2Connection_CreateExpanded Clone()
        {
            var clone = new NewAzOrbitalL2Connection_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzOrbitalL2Connection_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzOrbitalL2Connection_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'L2ConnectionsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.L2ConnectionsCreateOrUpdate(ResourceGroupName, SubscriptionId, Name, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.IL2Connection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api20240301Preview.IL2Connection
