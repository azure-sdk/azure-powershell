...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/l2Connections"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzOrbitalL2Connection_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Description(@"Returns a list of L2 Connections attached to an orbital gateway.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/l2Connections", ApiVersion = "2024-03-01-preview")]
    public partial class GetAzOrbitalL2Connection_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzOrbitalL2Connection_List" /> cmdlet class.
        /// </summary>
        public GetAzOrbitalL2Connection_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.L2ConnectionsList(SubscriptionId, ResourceGroupName, this.InvocationInformation.BoundParameters.ContainsKey("Skiptoken") ? Skiptoken : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.L2ConnectionsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
