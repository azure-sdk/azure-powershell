...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets
{
    ...
    /// <summary>Updates the specified L2 Connection's tags.</summary>
    /// <remarks>
    /// [OpenAPI] UpdateTags=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/l2Connections/{l2ConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzOrbitalL2ConnectionTag_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Orbital.Description(@"Updates the specified L2 Connection's tags.")]
    ...
    public partial class UpdateAzOrbitalL2ConnectionTag_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of UpdateAzOrbitalL2ConnectionTag_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Cmdlets.UpdateAzOrbitalL2ConnectionTag_UpdateExpanded Clone()
        {
            var clone = new UpdateAzOrbitalL2ConnectionTag_UpdateExpanded();
            ...
            clone.L2ConnectionName = this.L2ConnectionName;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'L2ConnectionsUpdateTags' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.L2ConnectionsUpdateTags(ResourceGroupName, SubscriptionId, L2ConnectionName, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,SubscriptionId=SubscriptionId,L2ConnectionName=L2ConnectionName,body=_parametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzOrbitalL2ConnectionTag_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzOrbitalL2ConnectionTag_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, L2ConnectionName=L2ConnectionName, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, L2ConnectionName=L2ConnectionName, body=_parametersBody })
                    {
