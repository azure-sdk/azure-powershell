...
namespace Microsoft.Azure.PowerShell.Cmdlets.Orbital.Models
{
    ...
    public partial class OrbitalIdentity
    {
        ...
        internal OrbitalIdentity(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonObject json)
        {
            ...
            {_edgeSiteName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("edgeSiteName"), out var __jsonEdgeSiteName) ? (string)__jsonEdgeSiteName : (string)EdgeSiteName;}
            {_l2ConnectionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("l2ConnectionName"), out var __jsonL2ConnectionName) ? (string)__jsonL2ConnectionName : (string)L2ConnectionName;}
            {_globalCommunicationsSiteName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString>("globalCommunicationsSiteName"), out var __jsonGlobalCommunicationsSiteName) ? (string)__jsonGlobalCommunicationsSiteName : (string)GlobalCommunicationsSiteName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._edgeSiteName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString(this._edgeSiteName.ToString()) : null, "edgeSiteName" ,container.Add );
            AddIf( null != (((object)this._l2ConnectionName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString(this._l2ConnectionName.ToString()) : null, "l2ConnectionName" ,container.Add );
            AddIf( null != (((object)this._globalCommunicationsSiteName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Orbital.Runtime.Json.JsonString(this._globalCommunicationsSiteName.ToString()) : null, "globalCommunicationsSiteName" ,container.Add );
