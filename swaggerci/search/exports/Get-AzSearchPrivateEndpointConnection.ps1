...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IPrivateEndpointConnection
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IPrivateEndpointConnection])]
