...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IPrivateLinkResource
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.IPrivateLinkResource])]
