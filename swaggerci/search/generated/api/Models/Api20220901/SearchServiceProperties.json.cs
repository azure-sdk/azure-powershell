...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901
{
    ...
    public partial class SearchServiceProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.ISearchServiceProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.ISearchServiceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.ISearchServiceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonNode node)
        {
        ...
        internal SearchServiceProperties(Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject json)
        {
            ...
            {_networkRuleSet = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("networkRuleSet"), out var __jsonNetworkRuleSet) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.NetworkRuleSet.FromJson(__jsonNetworkRuleSet) : NetworkRuleSet;}
            {_authOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.Json.JsonObject>("authOptions"), out var __jsonAuthOptions) ? Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20220901.DataPlaneAuthOptions.FromJson(__jsonAuthOptions) : AuthOption;}
