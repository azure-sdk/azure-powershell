...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzSearchServiceNameAvailability_CheckViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class TestAzSearchServiceNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICheckNameAvailabilityInput _checkNameAvailabilityInput;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICheckNameAvailabilityInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICheckNameAvailabilityInput CheckNameAvailabilityInput { get => this._checkNameAvailabilityInput; set => this._checkNameAvailabilityInput = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICheckNameAvailabilityOutput"
        /// /> from the remote call</param>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesCheckNameAvailabilityViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, CheckNameAvailabilityInput, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesCheckNameAvailability(this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, InputObject.SubscriptionId ?? null, CheckNameAvailabilityInput, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzSearchServiceNameAvailability_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzSearchServiceNameAvailability_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ClientRequestId=this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, body=CheckNameAvailabilityInput })
                    {
