...
namespace Microsoft.Azure.PowerShell.Cmdlets.Search.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Search.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICheckNameAvailabilityInput CheckNameAvailabilityInputBody { get => this._checkNameAvailabilityInputBody; set => this._checkNameAvailabilityInputBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesCheckNameAvailabilityViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, CheckNameAvailabilityInputBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesCheckNameAvailability(this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, InputObject.SubscriptionId ?? null, CheckNameAvailabilityInputBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20200801.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ClientRequestId=this.InvocationInformation.BoundParameters.ContainsKey("ClientRequestId") ? ClientRequestId : null, body=CheckNameAvailabilityInputBody })
                    {
