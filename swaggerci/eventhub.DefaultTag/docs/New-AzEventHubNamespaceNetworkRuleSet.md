...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INwRuleSetIPRules[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INwRuleSetVirtualNetworkRules[]
Parameter Sets: (All)
Aliases:
