...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INwRuleSetIPRules[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INwRuleSetVirtualNetworkRules[]
Parameter Sets: (All)
Aliases:
