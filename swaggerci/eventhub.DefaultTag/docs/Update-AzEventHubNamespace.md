...
online version: https://learn.microsoft.com/powershell/module/az.eventhub/update-azeventhubnamespace
schema: 2.0.0
---

# Update-AzEventHubNamespace
...
```
Update-AzEventHubNamespace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-Tag <Hashtable>] [-ZoneRedundant] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzEventHubNamespace -InputObject <IEventHubIdentity> [-AlternateName <String>] [-ClusterArmId <String>]
 [-DisableLocalAuth] [-EncryptionKeySource <KeySource>] [-EncryptionKeyVaultProperty <IKeyVaultProperties[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IKeyVaultProperties[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IPrivateEndpointConnection[]
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IEhNamespace
