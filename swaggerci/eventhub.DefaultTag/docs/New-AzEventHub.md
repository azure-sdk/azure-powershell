...
New-AzEventHub -Name <String> -NamespaceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-DestinationName <String>] [-IdentityType <CaptureIdentityType>] [-IdentityUserAssignedIdentity <String>]
 [-MessageRetentionInDay <Int64>] [-MessageTimestampType <TimestampType>] [-PartitionCount <Int64>]
 [-RetentionDescriptionCleanupPolicy <CleanupPolicyRetentionDescription>]
 [-RetentionDescriptionMinCompactionLagInMin <Int64>] [-RetentionDescriptionRetentionTimeInHour <Int64>]
 [-RetentionDescriptionTombstoneRetentionTimeInHour <Int32>] [-Status <EntityStatus>]
 [-StorageAccountResourceId <String>] [-UserMetadata <String>] [-DefaultProfile <PSObject>] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.TimestampType
Parameter Sets: (All)
Aliases:
