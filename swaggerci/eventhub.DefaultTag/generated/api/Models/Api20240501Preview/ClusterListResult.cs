...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview
{
    ...
    public partial class ClusterListResult :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IClusterListResult,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IClusterListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ICluster[] _value;

        /// <summary>The Event Hubs Clusters present in the List Event Hubs operation results.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ICluster[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ICluster) })]
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ICluster[] Value { get; set; }
