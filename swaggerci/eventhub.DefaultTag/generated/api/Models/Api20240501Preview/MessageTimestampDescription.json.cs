...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview
{
    ...
    public partial class MessageTimestampDescription
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IMessageTimestampDescription.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IMessageTimestampDescription.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IMessageTimestampDescription FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode node)
        {
        ...
        internal MessageTimestampDescription(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonObject json)
        {
            ...
            {_timestampType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonString>("timestampType"), out var __jsonTimestampType) ? (string)__jsonTimestampType : (string)TimestampType;}
            AfterFromJson(json);
        }
