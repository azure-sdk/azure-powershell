...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview
{
    ...
    public partial class ConsumerGroupListResult :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IConsumerGroupListResult,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IConsumerGroupListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IConsumerGroup[] _value;

        /// <summary>Result of the List Consumer Group operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IConsumerGroup[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IConsumerGroup) })]
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IConsumerGroup[] Value { get; set; }
