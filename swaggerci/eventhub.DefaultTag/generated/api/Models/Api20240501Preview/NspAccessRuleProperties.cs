...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview
{
    ...
    public partial class NspAccessRuleProperties :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INspAccessRuleProperties,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INspAccessRulePropertiesInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INspAccessRulePropertiesInternal.FullyQualifiedDomainName { get => this._fullyQualifiedDomainName; set { {_fullyQualifiedDomainName = value;} } }

        /// <summary>Internal Acessors for NetworkSecurityPerimeter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INetworkSecurityPerimeter[] Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INspAccessRulePropertiesInternal.NetworkSecurityPerimeter { get => this._networkSecurityPerimeter; set { {_networkSecurityPerimeter = value;} } }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INetworkSecurityPerimeter[] NetworkSecurityPerimeter { get => this._networkSecurityPerimeter; }

        /// <summary>Backing field for <see cref="Subscription" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INspAccessRulePropertiesSubscriptionsItem[] _subscription;

        /// <summary>Subscriptions for inbound rules</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.INspAccessRulePropertiesSubscriptionsItem[] Subscription { get => this._subscription; set => this._subscription = value; }
