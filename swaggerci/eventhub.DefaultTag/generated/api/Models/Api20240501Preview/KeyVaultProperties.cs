...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview
{
    ...
    public partial class KeyVaultProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IKeyVaultPropertiesInternal
    {

        /// <summary>Backing field for <see cref="Identity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IUserAssignedIdentityProperties _identity;

        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IUserAssignedIdentityProperties Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.UserAssignedIdentityProperties()); set => this._identity = value; }
        ...
        public string IdentityUserAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IUserAssignedIdentityPropertiesInternal)Identity).UserAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IUserAssignedIdentityPropertiesInternal)Identity).UserAssignedIdentity = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IUserAssignedIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IKeyVaultPropertiesInternal.Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.UserAssignedIdentityProperties()); set { {_identity = value;} } }
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IUserAssignedIdentityProperties Identity { get; set; }
        /// <summary>ARM ID of user Identity selected for encryption</summary>
        string IdentityUserAssignedIdentity { get; set; }
        /// <summary>Name of the Key from KeyVault</summary>
        string KeyName { get; set; }
