...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview
{
    ...
    public partial class SchemaGroupListResult :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ISchemaGroupListResult,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ISchemaGroupListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ISchemaGroup[] _value;

        /// <summary>Result of the List SchemaGroups operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ISchemaGroup[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ISchemaGroup) })]
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.ISchemaGroup[] Value { get; set; }
