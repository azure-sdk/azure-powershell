...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview
{
    ...
    public partial class ClusterProperties :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterProperties,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterPropertiesInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for MetricId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterPropertiesInternal.MetricId { get => this._metricId; set { {_metricId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterPropertiesInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for UpdatedAt</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20221001Preview.IClusterPropertiesInternal.UpdatedAt { get => this._updatedAt; set { {_updatedAt = value;} } }
