...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401
{
    ...
    public partial class NspAccessRuleProperties :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRuleProperties,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesInternal.FullyQualifiedDomainName { get => this._fullyQualifiedDomainName; set { {_fullyQualifiedDomainName = value;} } }

        /// <summary>Internal Acessors for NetworkSecurityPerimeter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INetworkSecurityPerimeter[] Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesInternal.NetworkSecurityPerimeter { get => this._networkSecurityPerimeter; set { {_networkSecurityPerimeter = value;} } }

        /// <summary>Backing field for <see cref="NetworkSecurityPerimeter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INetworkSecurityPerimeter[] _networkSecurityPerimeter;

        /// <summary>NetworkSecurityPerimeters for inbound rules</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INetworkSecurityPerimeter[] NetworkSecurityPerimeter { get => this._networkSecurityPerimeter; }

        /// <summary>Backing field for <see cref="Subscription" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesSubscriptionsItem[] _subscription;

        /// <summary>Subscriptions for inbound rules</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Origin(Microsoft.Azure.PowerShell.Cmdlets.EventHub.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesSubscriptionsItem[] Subscription { get => this._subscription; set => this._subscription = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INetworkSecurityPerimeter) })]
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INetworkSecurityPerimeter[] NetworkSecurityPerimeter { get;  }
        /// <summary>Subscriptions for inbound rules</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesSubscriptionsItem) })]
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.INspAccessRulePropertiesSubscriptionsItem[] Subscription { get; set; }
