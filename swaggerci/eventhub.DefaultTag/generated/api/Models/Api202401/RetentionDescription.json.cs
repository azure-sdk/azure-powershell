...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401
{
    ...
    public partial class RetentionDescription
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IRetentionDescription.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IRetentionDescription.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IRetentionDescription FromJson(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNode node)
        {
        ...
        internal RetentionDescription(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonObject json)
        {
            ...
            {_cleanupPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonString>("cleanupPolicy"), out var __jsonCleanupPolicy) ? (string)__jsonCleanupPolicy : (string)CleanupPolicy;}
            {_retentionTimeInHour = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNumber>("retentionTimeInHours"), out var __jsonRetentionTimeInHours) ? (long?)__jsonRetentionTimeInHours : RetentionTimeInHour;}
            {_minCompactionLagInMin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNumber>("minCompactionLagInMins"), out var __jsonMinCompactionLagInMins) ? (long?)__jsonMinCompactionLagInMins : MinCompactionLagInMin;}
            {_tombstoneRetentionTimeInHour = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Json.JsonNumber>("tombstoneRetentionTimeInHours"), out var __jsonTombstoneRetentionTimeInHours) ? (int?)__jsonTombstoneRetentionTimeInHours : TombstoneRetentionTimeInHour;}
            AfterFromJson(json);
        }
