...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401
{
    ...
    public partial class OperationDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IOperationDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IOperationDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api202401.IOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
