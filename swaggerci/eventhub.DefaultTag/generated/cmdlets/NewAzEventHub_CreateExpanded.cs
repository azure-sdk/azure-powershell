...
namespace Microsoft.Azure.PowerShell.Cmdlets.EventHub.Cmdlets
{
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub))]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.Eventhub();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IdentityUserAssignedIdentity { get => _parametersBody.IdentityUserAssignedIdentity ?? null; set => _parametersBody.IdentityUserAssignedIdentity = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Denotes the type of timestamp the message will hold. Two types of timestamp types AppendTime, CreateTime. AppendTime refers the time in which message got appended inside broker log. CreateTime refers to the time in which the message was generated on source side and producers can set this timestamp while sending the message. Default value is AppendTime. If you are using AMQP protocol, CreateTime equals AppendTime for now and will full have runtime support later.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.TimestampType))]
        public Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.TimestampType MessageTimestampType { get => _parametersBody.MessageTimestampType ?? ((Microsoft.Azure.PowerShell.Cmdlets.EventHub.Support.TimestampType)""); set => _parametersBody.MessageTimestampType = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The minimum time a message will remain ineligible for compaction in the log. Only applicable for logs that are being compacted.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(long) })]
        public long RetentionDescriptionMinCompactionLagInMin { get => _parametersBody.RetentionDescriptionMinCompactionLagInMin ?? default(long); set => _parametersBody.RetentionDescriptionMinCompactionLagInMin = value; }

        /// <summary>
        /// Number of hours to retain the events for this Event Hub. If cleanupPolicy is Compact the returned value of this property
        /// is Long.MaxValue
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Number of hours to retain the events for this Event Hub. If cleanupPolicy is Compact the returned value of this property is Long.MaxValue ")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.Category(global::Microsoft.Azure.PowerShell.Cmdlets.EventHub.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.EventHub.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub">Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.EventHub.Models.Api20240501Preview.IEventhub
