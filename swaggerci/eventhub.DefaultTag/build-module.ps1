...
$dll = Join-Path $PSScriptRoot 'bin/Az.EventHub.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.EventHub.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.EventHub.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: EventHub cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.EventHub.format.ps1xml'
