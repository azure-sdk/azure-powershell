...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState Cancelled = @"Cancelled";

        /// <summary>The account is being created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState Creating = @"Creating";

        /// <summary>The account is being deleted.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>The last operation for the account is failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState Failed = @"Failed";

        /// <summary>The account is in an invalid state.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState Invalid = @"Invalid";

        /// <summary>The account has been created and is ready for use.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
