...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101
{
    ...
    public partial class DeploymentConfiguration
    {
        ...
        internal DeploymentConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_cloudServiceConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("cloudServiceConfiguration"), out var __jsonCloudServiceConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.CloudServiceConfiguration.FromJson(__jsonCloudServiceConfiguration) : CloudServiceConfiguration;}
            {_virtualMachineConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("virtualMachineConfiguration"), out var __jsonVirtualMachineConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.VirtualMachineConfiguration.FromJson(__jsonVirtualMachineConfiguration) : VirtualMachineConfiguration;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDeploymentConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDeploymentConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDeploymentConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
