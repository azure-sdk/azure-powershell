...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101
{
    ...
    public partial class CloudErrorBodyTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="CloudErrorBody" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ICloudErrorBody ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ICloudErrorBody).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
