...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101
{
    ...
    public partial class NetworkConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.INetworkConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.INetworkConfigurationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPoolEndpointConfiguration _endpointConfiguration;

        /// <summary>
        /// Pool endpoint configuration is only supported on pools with the virtualMachineConfiguration property.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPoolEndpointConfiguration EndpointConfiguration { get => (this._endpointConfiguration = this._endpointConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.PoolEndpointConfiguration()); set => this._endpointConfiguration = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IInboundNatPool[] EndpointConfigurationInboundNatPool { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPoolEndpointConfigurationInternal)EndpointConfiguration).InboundNatPool; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPoolEndpointConfigurationInternal)EndpointConfiguration).InboundNatPool = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for EndpointConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPoolEndpointConfiguration Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.INetworkConfigurationInternal.EndpointConfiguration { get => (this._endpointConfiguration = this._endpointConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.PoolEndpointConfiguration()); set { {_endpointConfiguration = value;} } }

        /// <summary>Internal Acessors for PublicIPAddressConfiguration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPublicIPAddressConfiguration Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.INetworkConfigurationInternal.PublicIPAddressConfiguration { get => (this._publicIPAddressConfiguration = this._publicIPAddressConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.PublicIPAddressConfiguration()); set { {_publicIPAddressConfiguration = value;} } }

        /// <summary>Backing field for <see cref="PublicIPAddressConfiguration" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPublicIPAddressConfiguration _publicIPAddressConfiguration;

        /// <summary>
        /// This property is only supported on Pools with the virtualMachineConfiguration property.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPublicIPAddressConfiguration PublicIPAddressConfiguration { get => (this._publicIPAddressConfiguration = this._publicIPAddressConfiguration ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.PublicIPAddressConfiguration()); set => this._publicIPAddressConfiguration = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public string[] PublicIPAddressConfigurationIpaddressId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPublicIPAddressConfigurationInternal)PublicIPAddressConfiguration).IPAddressId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPublicIPAddressConfigurationInternal)PublicIPAddressConfiguration).IPAddressId = value ?? null /* arrayOf */; }
...

    {
        ...
        /// Pool endpoint configuration is only supported on pools with the virtualMachineConfiguration property.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPoolEndpointConfiguration EndpointConfiguration { get; set; }
        /// <summary>
        /// The maximum number of inbound NAT pools per Batch pool is 5. If the maximum number of inbound NAT pools is exceeded the
        /// request fails with HTTP status code 400. This cannot be specified if the IPAddressProvisioningType is NoPublicIPAddresses.
        /// </summary>
        ...
        /// This property is only supported on Pools with the virtualMachineConfiguration property.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPublicIPAddressConfiguration PublicIPAddressConfiguration { get; set; }
        /// <summary>
        /// The number of IPs specified here limits the maximum size of the Pool - 100 dedicated nodes or 100 Spot/low-priority nodes
        /// can be allocated for each public IP. For example, a pool needing 250 dedicated VMs would need at least 3 public IPs specified.
        /// Each element of this collection is of the form: /subscriptions/{subscription}/resourceGroups/{group}/providers/Microsoft.Network/publicIPAddresses/{ip}.
