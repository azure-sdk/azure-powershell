...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101
{
    ...
    public partial class TaskContainerSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ITaskContainerSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ITaskContainerSettingsInternal
    {
        ...
        public string IdentityReferenceResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).IdentityReferenceResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).IdentityReferenceResourceId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistry Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ITaskContainerSettingsInternal.Registry { get => (this._registry = this._registry ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ContainerRegistry()); set { {_registry = value;} } }

        /// <summary>Internal Acessors for RegistryIdentityReference</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IComputeNodeIdentityReference Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ITaskContainerSettingsInternal.RegistryIdentityReference { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).IdentityReference; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).IdentityReference = value; }

        /// <summary>Backing field for <see cref="Registry" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistry _registry;

        /// <summary>This setting can be omitted if was already provided at pool creation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistry Registry { get => (this._registry = this._registry ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ContainerRegistry()); set => this._registry = value; }

        /// <summary>The password to log into the registry server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public string RegistryPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).Password; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).Password = value ?? null; }

        /// <summary>If omitted, the default is "docker.io".</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public string RegistryServer { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).RegistryServer; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).RegistryServer = value ?? null; }

        /// <summary>The user name to log into the registry server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public string RegistryUserName { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).UserName; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistryInternal)Registry).UserName = value ?? null; }
...

    {
        ...
        string ImageName { get; set; }
        /// <summary>This setting can be omitted if was already provided at pool creation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IContainerRegistry Registry { get; set; }
        /// <summary>
