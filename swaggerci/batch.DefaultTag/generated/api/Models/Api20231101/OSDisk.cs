...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101
{
    ...
    public partial class OSDisk :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IOSDisk,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IOSDiskInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDiffDiskSettings _ephemeralOSDiskSetting;

        /// <summary>
        /// Specifies the ephemeral Disk Settings for the operating system disk used by the virtual machine.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDiffDiskSettings EphemeralOSDiskSetting { get => (this._ephemeralOSDiskSetting = this._ephemeralOSDiskSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.DiffDiskSettings()); set => this._ephemeralOSDiskSetting = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.DiffDiskPlacement? EphemeralOSDiskSettingPlacement { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDiffDiskSettingsInternal)EphemeralOSDiskSetting).Placement; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDiffDiskSettingsInternal)EphemeralOSDiskSetting).Placement = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.DiffDiskPlacement)""); }

        /// <summary>Backing field for <see cref="ManagedDisk" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IManagedDisk _managedDisk;

        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IManagedDisk ManagedDisk { get => (this._managedDisk = this._managedDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ManagedDisk()); set => this._managedDisk = value; }

        /// <summary>The storage account type for use in creating data disks or OS disk.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.StorageAccountType? ManagedDiskStorageAccountType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IManagedDiskInternal)ManagedDisk).StorageAccountType; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IManagedDiskInternal)ManagedDisk).StorageAccountType = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.StorageAccountType)""); }

        /// <summary>Internal Acessors for EphemeralOSDiskSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDiffDiskSettings Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IOSDiskInternal.EphemeralOSDiskSetting { get => (this._ephemeralOSDiskSetting = this._ephemeralOSDiskSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.DiffDiskSettings()); set { {_ephemeralOSDiskSetting = value;} } }

        /// <summary>Internal Acessors for ManagedDisk</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IManagedDisk Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IOSDiskInternal.ManagedDisk { get => (this._managedDisk = this._managedDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.ManagedDisk()); set { {_managedDisk = value;} } }
...

    {
        ...
        /// Specifies the ephemeral Disk Settings for the operating system disk used by the virtual machine.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDiffDiskSettings EphemeralOSDiskSetting { get; set; }
        /// <summary>
        /// This property can be used by user in the request to choose which location the operating system should be in. e.g., cache
        /// disk space for Ephemeral OS disk provisioning. For more information on Ephemeral OS disk size requirements, please refer
        /// to Ephemeral OS disk size requirements for Windows VMs at https://docs.microsoft.com/en-us/azure/virtual-machines/windows/ephemeral-os-disks#size-requirements
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IManagedDisk ManagedDisk { get; set; }
        /// <summary>The storage account type for use in creating data disks or OS disk.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.StorageAccountType? ManagedDiskStorageAccountType { get; set; }
        /// <summary>Specifies whether writeAccelerator should be enabled or disabled on the disk.</summary>
        bool? WriteAcceleratorEnabled { get; set; }
