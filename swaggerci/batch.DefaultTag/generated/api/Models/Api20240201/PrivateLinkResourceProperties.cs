...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201
{
    ...
    public partial class PrivateLinkResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateLinkResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateLinkResourcePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateLinkResourcePropertiesInternal.GroupId { get => this._groupId; set { {_groupId = value;} } }

        /// <summary>Internal Acessors for RequiredMember</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateLinkResourcePropertiesInternal.RequiredMember { get => this._requiredMember; set { {_requiredMember = value;} } }

        /// <summary>Internal Acessors for RequiredZoneName</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateLinkResourcePropertiesInternal.RequiredZoneName { get => this._requiredZoneName; set { {_requiredZoneName = value;} } }
