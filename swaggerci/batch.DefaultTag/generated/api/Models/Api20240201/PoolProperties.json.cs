...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201
{
    ...
    public partial class PoolProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPoolProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPoolProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPoolProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
        ...
        internal PoolProperties(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_deploymentConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("deploymentConfiguration"), out var __jsonDeploymentConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.DeploymentConfiguration.FromJson(__jsonDeploymentConfiguration) : DeploymentConfiguration;}
            {_scaleSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("scaleSettings"), out var __jsonScaleSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ScaleSettings.FromJson(__jsonScaleSettings) : ScaleSetting;}
            {_autoScaleRun = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("autoScaleRun"), out var __jsonAutoScaleRun) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.AutoScaleRun.FromJson(__jsonAutoScaleRun) : AutoScaleRun;}
            {_networkConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("networkConfiguration"), out var __jsonNetworkConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.NetworkConfiguration.FromJson(__jsonNetworkConfiguration) : NetworkConfiguration;}
            {_taskSchedulingPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("taskSchedulingPolicy"), out var __jsonTaskSchedulingPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.TaskSchedulingPolicy.FromJson(__jsonTaskSchedulingPolicy) : TaskSchedulingPolicy;}
            {_startTask = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("startTask"), out var __jsonStartTask) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.StartTask.FromJson(__jsonStartTask) : StartTask;}
            {_resizeOperationStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("resizeOperationStatus"), out var __jsonResizeOperationStatus) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ResizeOperationStatus.FromJson(__jsonResizeOperationStatus) : ResizeOperationStatus;}
            {_upgradePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("upgradePolicy"), out var __jsonUpgradePolicy) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.UpgradePolicy.FromJson(__jsonUpgradePolicy) : UpgradePolicy;}
            ...
            {_userAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("userAccounts"), out var __jsonUserAccounts) ? If( __jsonUserAccounts as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IUserAccount[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IUserAccount) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.UserAccount.FromJson(__u) )) ))() : null : UserAccount;}
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("metadata"), out var __jsonMetadata) ? If( __jsonMetadata as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IMetadataItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IMetadataItem) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.MetadataItem.FromJson(__p) )) ))() : null : Metadata;}
            {_certificate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("certificates"), out var __jsonCertificates) ? If( __jsonCertificates as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ICertificateReference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ICertificateReference) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.CertificateReference.FromJson(__k) )) ))() : null : Certificate;}
            {_applicationPackage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("applicationPackages"), out var __jsonApplicationPackages) ? If( __jsonApplicationPackages as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IApplicationPackageReference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IApplicationPackageReference) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ApplicationPackageReference.FromJson(__f) )) ))() : null : ApplicationPackage;}
            ...
            {_mountConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("mountConfiguration"), out var __jsonMountConfiguration) ? If( __jsonMountConfiguration as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var ___w) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IMountConfiguration[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(___w, (___v)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IMountConfiguration) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.MountConfiguration.FromJson(___v) )) ))() : null : MountConfiguration;}
            ...
            {_resourceTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("resourceTags"), out var __jsonResourceTags) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.PoolPropertiesResourceTags.FromJson(__jsonResourceTags) : ResourceTag;}
            AfterFromJson(json);
        }
