...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201
{
    ...
    public partial class VirtualMachineConfiguration
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVirtualMachineConfiguration.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVirtualMachineConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVirtualMachineConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
        ...
        internal VirtualMachineConfiguration(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_imageReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("imageReference"), out var __jsonImageReference) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ImageReference.FromJson(__jsonImageReference) : ImageReference;}
            {_windowsConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("windowsConfiguration"), out var __jsonWindowsConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.WindowsConfiguration.FromJson(__jsonWindowsConfiguration) : WindowsConfiguration;}
            {_containerConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("containerConfiguration"), out var __jsonContainerConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ContainerConfiguration.FromJson(__jsonContainerConfiguration) : ContainerConfiguration;}
            {_diskEncryptionConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("diskEncryptionConfiguration"), out var __jsonDiskEncryptionConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.DiskEncryptionConfiguration.FromJson(__jsonDiskEncryptionConfiguration) : DiskEncryptionConfiguration;}
            {_nodePlacementConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("nodePlacementConfiguration"), out var __jsonNodePlacementConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.NodePlacementConfiguration.FromJson(__jsonNodePlacementConfiguration) : NodePlacementConfiguration;}
            {_oSDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("osDisk"), out var __jsonOSDisk) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.OSDisk.FromJson(__jsonOSDisk) : OSDisk;}
            {_securityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("securityProfile"), out var __jsonSecurityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.SecurityProfile.FromJson(__jsonSecurityProfile) : SecurityProfile;}
            {_serviceArtifactReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("serviceArtifactReference"), out var __jsonServiceArtifactReference) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ServiceArtifactReference.FromJson(__jsonServiceArtifactReference) : ServiceArtifactReference;}
            ...
            {_dataDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("dataDisks"), out var __jsonDataDisks) ? If( __jsonDataDisks as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IDataDisk[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IDataDisk) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.DataDisk.FromJson(__u) )) ))() : null : DataDisk;}
            ...
            {_extension = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("extensions"), out var __jsonExtensions) ? If( __jsonExtensions as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVMExtension[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVMExtension) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.VMExtension.FromJson(__p) )) ))() : null : Extension;}
            AfterFromJson(json);
        }
    }
}