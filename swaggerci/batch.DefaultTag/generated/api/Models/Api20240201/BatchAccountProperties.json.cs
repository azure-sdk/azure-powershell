...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201
{
    ...
    public partial class BatchAccountProperties
    {
        ...
        internal BatchAccountProperties(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_keyVaultReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("keyVaultReference"), out var __jsonKeyVaultReference) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.KeyVaultReference.FromJson(__jsonKeyVaultReference) : KeyVaultReference;}
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.NetworkProfile.FromJson(__jsonNetworkProfile) : NetworkProfile;}
            {_autoStorage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("autoStorage"), out var __jsonAutoStorage) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.AutoStorageProperties.FromJson(__jsonAutoStorage) : AutoStorage;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            ...
            {_nodeManagementEndpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonString>("nodeManagementEndpoint"), out var __jsonNodeManagementEndpoint) ? (string)__jsonNodeManagementEndpoint : (string)NodeManagementEndpoint;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateEndpointConnection[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IPrivateEndpointConnection) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.PrivateEndpointConnection.FromJson(__u) )) ))() : null : PrivateEndpointConnection;}
            ...
            {_dedicatedCoreQuotaPerVMFamily = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("dedicatedCoreQuotaPerVMFamily"), out var __jsonDedicatedCoreQuotaPerVMFamily) ? If( __jsonDedicatedCoreQuotaPerVMFamily as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVirtualMachineFamilyCoreQuota[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IVirtualMachineFamilyCoreQuota) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.VirtualMachineFamilyCoreQuota.FromJson(__p) )) ))() : null : DedicatedCoreQuotaPerVMFamily;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IBatchAccountProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IBatchAccountProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.IBatchAccountProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._networkProfile ? (Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode) this._networkProfile.ToJson(null,serializationMode) : null, "networkProfile" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.SerializationMode.IncludeReadOnly))
            {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._nodeManagementEndpoint)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonString(this._nodeManagementEndpoint.ToString()) : null, "nodeManagementEndpoint" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.SerializationMode.IncludeReadOnly))
            {
