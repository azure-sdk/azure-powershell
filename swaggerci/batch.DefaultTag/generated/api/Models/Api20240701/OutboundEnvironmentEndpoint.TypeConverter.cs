...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240701
{
    ...
    public partial class OutboundEnvironmentEndpointTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="OutboundEnvironmentEndpoint" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240701.IOutboundEnvironmentEndpoint ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240701.IOutboundEnvironmentEndpoint).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
