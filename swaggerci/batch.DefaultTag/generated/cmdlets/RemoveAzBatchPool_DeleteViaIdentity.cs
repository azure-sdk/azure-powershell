...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzBatchPool_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/pools/{poolName}", ApiVersion = "2024-02-01")]
    public partial class RemoveAzBatchPool_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzBatchPool_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets.RemoveAzBatchPool_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzBatchPool_DeleteViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PoolDeleteViaIdentity(InputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PoolDelete(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.PoolName ?? null, InputObject.SubscriptionId ?? null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzBatchPool_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzBatchPool_DeleteViaIdentity()
        {
