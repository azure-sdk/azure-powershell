...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListSupportedCloudServiceSkus=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Batch/locations/{locationName}/cloudServiceSkus"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzBatchLocationSupportedCloudServiceSku_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ISupportedSku))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"Gets the list of Batch supported Cloud Service VM sizes available at the given location.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Batch/locations/{locationName}/cloudServiceSkus", ApiVersion = "2024-02-01")]
    public partial class GetAzBatchLocationSupportedCloudServiceSku_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "OData filter expression. Valid properties for filtering are \"familyName\".")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The region for which to retrieve Batch service supported SKUs.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ISupportedSkusResult">Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ISupportedSkusResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ISupportedSkusResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzBatchLocationSupportedCloudServiceSku_List" /> cmdlet class.
        /// </summary>
        public GetAzBatchLocationSupportedCloudServiceSku_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.LocationListSupportedCloudServiceSkus(LocationName, this.InvocationInformation.BoundParameters.ContainsKey("Maxresult") ? Maxresult : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  LocationName=LocationName,Maxresult=this.InvocationInformation.BoundParameters.ContainsKey("Maxresult") ? Maxresult : default(int?),Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null,SubscriptionId=SubscriptionId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LocationName=LocationName, Maxresult=this.InvocationInformation.BoundParameters.ContainsKey("Maxresult") ? Maxresult : default(int?), Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, SubscriptionId=SubscriptionId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { LocationName=LocationName, Maxresult=this.InvocationInformation.BoundParameters.ContainsKey("Maxresult") ? Maxresult : default(int?), Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, SubscriptionId=SubscriptionId })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240201.ISupportedSkusResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.LocationListSupportedCloudServiceSkus_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
