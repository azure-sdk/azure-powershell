...
online version: https://learn.microsoft.com/powershell/module/az.batch/update-azbatchcertificate
schema: 2.0.0
---
...
Update-AzBatchCertificate -InputObject <IBatchIdentity> [-IfMatch <String>] [-Data <String>]
 [-Format <CertificateFormat>] [-Password <String>] [-Tag <Hashtable>] [-Thumbprint <String>]
