...
.Link
https://learn.microsoft.com/powershell/module/az.batch/new-azbatchapplicationpackage
#>
function New-AzBatchApplicationPackage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20240701.IApplicationPackage])]
