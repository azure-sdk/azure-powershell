...
.Link
https://learn.microsoft.com/powershell/module/az.batch/disable-azbatchpoolautoscale
#>
function Disable-AzBatchPoolAutoScale {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IPool])]
