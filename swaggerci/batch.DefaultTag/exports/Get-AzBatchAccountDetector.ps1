...
.Link
https://learn.microsoft.com/powershell/module/az.batch/get-azbatchaccountdetector
#>
function Get-AzBatchAccountDetector {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IDetectorResponse])]
