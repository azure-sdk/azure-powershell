...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IApplication
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.batch/get-azbatchapplication
#>
function Get-AzBatchApplication {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20231101.IApplication])]
