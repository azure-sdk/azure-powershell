...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkAnalytics/networkAnalyticsProducts/default"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Description(@"Create a NetworkAnalyticsProducts")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Generated]
    public partial class NewAzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20230430.INetworkAnalyticsProducts _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20230430.NetworkAnalyticsProducts();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The connectors supported by the product")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api20230430.INetworkAnalyticsProductConnectorInformation[] NetworkAnalyticProductInformationProductConnector { get => _resourceBody.NetworkAnalyticProductInformationProductConnector ?? null /* arrayOf */; set => _resourceBody.NetworkAnalyticProductInformationProductConnector = value; }

        /// <summary>Name of the network analytics product</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the network analytics product")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string NetworkAnalyticProductInformationProductName { get => _resourceBody.NetworkAnalyticProductInformationProductName ?? null; set => _resourceBody.NetworkAnalyticProductInformationProductName = value; }

        /// <summary>The available versions for the product</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The available versions for the product")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] NetworkAnalyticProductInformationProductVersion { get => _resourceBody.NetworkAnalyticProductInformationProductVersion ?? null /* arrayOf */; set => _resourceBody.NetworkAnalyticProductInformationProductVersion = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Cmdlets.NewAzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded Clone()
        {
            var clone = new NewAzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzNetworkAnalyticsNetworkAnalyticProduct_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NetworkAnalyticsProductCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.NetworkAnalyticsProductCreateOrUpdate(SubscriptionId, ResourceGroupName, _resourceBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=_resourceBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=_resourceBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, body=_resourceBody })
                    {
