...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass AzureServices = @"AzureServices";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass Logging = @"Logging";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass Metrics = @"Metrics";

        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass None = @"None";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass e1, Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Support.Bypass e2)
        {
            return !e2.Equals(e1);
        }
