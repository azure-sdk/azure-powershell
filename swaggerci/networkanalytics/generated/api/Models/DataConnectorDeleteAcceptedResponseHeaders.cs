...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models
{
    ...
    public partial class DataConnectorDeleteAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IDataConnectorDeleteAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IDataConnectorDeleteAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IHeaderSerializable
    {
        ...
        /// <summary>
        /// Creates an new <see cref="DataConnectorDeleteAcceptedResponseHeaders" /> instance.
        /// </summary>
        public DataConnectorDeleteAcceptedResponseHeaders()
        {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IDataConnectorDeleteAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader0) is string __headerRetryAfterHeader0 ? int.TryParse( __headerRetryAfterHeader0, out int __headerRetryAfterHeader0Value ) ? __headerRetryAfterHeader0Value : default(int?) : default(int?);
            }
        }
    }
    public partial interface IDataConnectorDeleteAcceptedResponseHeaders
    ...
    internal partial interface IDataConnectorDeleteAcceptedResponseHeadersInternal
