...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models
{
    ...
    public partial class StorageDeleteAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IStorageDeleteAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IStorageDeleteAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IStorageDeleteAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader0) is string __headerRetryAfterHeader0 ? int.TryParse( __headerRetryAfterHeader0, out int __headerRetryAfterHeader0Value ) ? __headerRetryAfterHeader0Value : default(int?) : default(int?);
            }
        }

        /// <summary>Creates an new <see cref="StorageDeleteAcceptedResponseHeaders" /> instance.</summary>
        public StorageDeleteAcceptedResponseHeaders()
        {

        }
    }
    public partial interface IStorageDeleteAcceptedResponseHeaders
    ...
    internal partial interface IStorageDeleteAcceptedResponseHeadersInternal
