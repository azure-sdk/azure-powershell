...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models
{
    ...
    public partial class NetworkAnalyticsProductDeleteAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.INetworkAnalyticsProductDeleteAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.INetworkAnalyticsProductDeleteAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.INetworkAnalyticsProductDeleteAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader0) is string __headerRetryAfterHeader0 ? int.TryParse( __headerRetryAfterHeader0, out int __headerRetryAfterHeader0Value ) ? __headerRetryAfterHeader0Value : default(int?) : default(int?);
            }
        }

        /// <summary>
        /// Creates an new <see cref="NetworkAnalyticsProductDeleteAcceptedResponseHeaders" /> instance.
        /// </summary>
        public NetworkAnalyticsProductDeleteAcceptedResponseHeaders()
        {

        }
    }
    public partial interface INetworkAnalyticsProductDeleteAcceptedResponseHeaders
    ...
    internal partial interface INetworkAnalyticsProductDeleteAcceptedResponseHeadersInternal
