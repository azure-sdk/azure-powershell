...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/update-aznetworkanalyticsstorage
schema: 2.0.0
---

# Update-AzNetworkAnalyticsStorage
...
```
Update-AzNetworkAnalyticsStorage -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzNetworkAnalyticsStorage -InputObject <INetworkAnalyticsIdentity>
 [-ManagedResourceGroupConfigurationLocation <String>] [-ManagedResourceGroupConfigurationName <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
