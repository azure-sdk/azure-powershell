...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/remove-aznetworkanalyticsproduct
schema: 2.0.0
---

# Remove-AzNetworkAnalyticsProduct
...
### Delete (Default)
```
Remove-AzNetworkAnalyticsProduct -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkAnalyticsProduct -InputObject <INetworkAnalyticsIdentity> [-DefaultProfile <PSObject>]
