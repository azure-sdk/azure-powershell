...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/remove-aznetworkanalyticsstorage
schema: 2.0.0
---

# Remove-AzNetworkAnalyticsStorage
...
### Delete (Default)
```
Remove-AzNetworkAnalyticsStorage -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkAnalyticsStorage -InputObject <INetworkAnalyticsIdentity> [-DefaultProfile <PSObject>]
