...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/remove-aznetworkanalyticsmetricsingestionendpoint
schema: 2.0.0
---

# Remove-AzNetworkAnalyticsMetricsIngestionEndpoint
...
### Delete (Default)
```
Remove-AzNetworkAnalyticsMetricsIngestionEndpoint -ResourceUri <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkAnalyticsMetricsIngestionEndpoint -InputObject <INetworkAnalyticsIdentity>
