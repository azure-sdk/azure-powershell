...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/get-aznetworkanalyticsproduct
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzNetworkAnalyticsProduct -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzNetworkAnalyticsProduct -InputObject <INetworkAnalyticsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
