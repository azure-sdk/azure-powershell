...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/remove-aznetworkanalyticsdataconnector
schema: 2.0.0
---

# Remove-AzNetworkAnalyticsDataConnector
...
### Delete (Default)
```
Remove-AzNetworkAnalyticsDataConnector -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzNetworkAnalyticsDataConnector -InputObject <INetworkAnalyticsIdentity> [-DefaultProfile <PSObject>]
