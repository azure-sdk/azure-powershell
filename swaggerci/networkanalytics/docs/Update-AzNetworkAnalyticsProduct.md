...
online version: https://docs.microsoft.com/en-us/powershell/module/az.networkanalytics/update-aznetworkanalyticsproduct
schema: 2.0.0
---

# Update-AzNetworkAnalyticsProduct
...
```
Update-AzNetworkAnalyticsProduct -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzNetworkAnalyticsProduct -InputObject <INetworkAnalyticsIdentity> [-DefaultProfile <PSObject>]
