...
### Get (Default)
```
Get-AzRecoveryServicesBackupCrrOperationResult -AzureRegion <String> -OperationId <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesBackupCrrOperationResult -InputObject <IRecoveryServicesBackupIdentity>
