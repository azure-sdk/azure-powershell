...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115
{
    ...
    public partial class AzureIaaSvmErrorInfo :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.IAzureIaaSvmErrorInfo,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.IAzureIaaSvmErrorInfoInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.IAzureIaaSvmErrorInfoInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorString</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.IAzureIaaSvmErrorInfoInternal.ErrorString { get => this._errorString; set { {_errorString = value;} } }

        /// <summary>Internal Acessors for ErrorTitle</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.IAzureIaaSvmErrorInfoInternal.ErrorTitle { get => this._errorTitle; set { {_errorTitle = value;} } }

        /// <summary>Internal Acessors for Recommendation</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.IAzureIaaSvmErrorInfoInternal.Recommendation { get => this._recommendation; set { {_recommendation = value;} } }
