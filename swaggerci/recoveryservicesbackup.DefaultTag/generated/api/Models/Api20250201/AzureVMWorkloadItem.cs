...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201
{
    ...
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItem"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItem __workloadItem = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.WorkloadItem();
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inherited)]
        public string FriendlyName { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal)__workloadItem).FriendlyName; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal)__workloadItem).FriendlyName = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal)__workloadItem).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal)__workloadItem).Type = value ; }

        /// <summary>Type of workload for the backup management</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inherited)]
        public string WorkloadType { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal)__workloadItem).WorkloadType; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal)__workloadItem).WorkloadType = value ?? null; }
    ...
    public partial interface IAzureVMWorkloadItem :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItem
    {
        /// <summary>Indicates if workload item is auto-protectable</summary>
    ...
    internal partial interface IAzureVMWorkloadItemInternal :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IWorkloadItemInternal
    {
        /// <summary>Indicates if workload item is auto-protectable</summary>
        bool? IsAutoProtectable { get; set; }
        /// <summary>Name for instance or AG</summary>
