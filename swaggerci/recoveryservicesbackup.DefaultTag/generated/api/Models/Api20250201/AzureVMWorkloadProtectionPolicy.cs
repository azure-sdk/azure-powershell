...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201
{
    ...
    public partial class AzureVMWorkloadProtectionPolicy :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IAzureVMWorkloadProtectionPolicy,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IAzureVMWorkloadProtectionPolicyInternal,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettings Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IAzureVMWorkloadProtectionPolicyInternal.Setting { get => (this._setting = this._setting ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.Settings()); set { {_setting = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettings _setting;

        /// <summary>Common settings for the backup management</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettings Setting { get => (this._setting = this._setting ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.Settings()); set => this._setting = value; }
        ...
        public bool? SettingIsCompression { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettingsInternal)Setting).IsCompression; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettingsInternal)Setting).IsCompression = value ?? default(bool); }

        /// <summary>SQL compression flag</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public bool? SettingIssqlcompression { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettingsInternal)Setting).Issqlcompression; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettingsInternal)Setting).Issqlcompression = value ?? default(bool); }

        /// <summary>
        /// TimeZone optional input as string. For example: TimeZone = "Pacific Standard Time".
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string SettingTimeZone { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettingsInternal)Setting).TimeZone; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettingsInternal)Setting).TimeZone = value ?? null; }

        /// <summary>Backing field for <see cref="SubProtectionPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISubProtectionPolicy[] _subProtectionPolicy;

        /// <summary>List of sub-protection policies which includes schedule and retention</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISubProtectionPolicy[] SubProtectionPolicy { get => this._subProtectionPolicy; set => this._subProtectionPolicy = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IProtectionPolicy
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISubProtectionPolicy) })]
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISubProtectionPolicy[] SubProtectionPolicy { get; set; }
        /// <summary>Type of workload for the backup management</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IProtectionPolicyInternal
    {
        ...
        bool? MakePolicyConsistent { get; set; }
        /// <summary>Common settings for the backup management</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.ISettings Setting { get; set; }
        /// <summary>
        /// Workload compression flag. This has been added so that 'isSqlCompression'
        /// will be deprecated once clients upgrade to consider this flag.
        /// </summary>
