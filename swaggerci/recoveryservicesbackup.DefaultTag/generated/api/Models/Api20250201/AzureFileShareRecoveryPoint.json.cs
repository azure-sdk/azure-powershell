...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201
{
    ...
    public partial class AzureFileShareRecoveryPoint
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject into a new instance of <see cref="AzureFileShareRecoveryPoint" />.
        /// </summary>
        ...
        internal AzureFileShareRecoveryPoint(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            __recoveryPoint = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.RecoveryPoint(json);
            {_recoveryPointProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("recoveryPointProperties"), out var __jsonRecoveryPointProperties) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.RecoveryPointProperties.FromJson(__jsonRecoveryPointProperties) : RecoveryPointProperty;}
            ...
            {_fileShareSnapshotUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("fileShareSnapshotUri"), out var __jsonFileShareSnapshotUri) ? (string)__jsonFileShareSnapshotUri : (string)FileShareSnapshotUri;}
            {_recoveryPointSizeInGb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNumber>("recoveryPointSizeInGB"), out var __jsonRecoveryPointSizeInGb) ? (int?)__jsonRecoveryPointSizeInGb : RecoveryPointSizeInGb;}
            {_recoveryPointTierDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray>("recoveryPointTierDetails"), out var __jsonRecoveryPointTierDetails) ? If( __jsonRecoveryPointTierDetails as Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IRecoveryPointTierInformation[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IRecoveryPointTierInformation) (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.RecoveryPointTierInformation.FromJson(__u) )) ))() : null : RecoveryPointTierDetail;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IAzureFileShareRecoveryPoint.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IAzureFileShareRecoveryPoint.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20250201.IAzureFileShareRecoveryPoint FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="AzureFileShareRecoveryPoint" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureFileShareRecoveryPoint" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode" />.
        /// </returns>
