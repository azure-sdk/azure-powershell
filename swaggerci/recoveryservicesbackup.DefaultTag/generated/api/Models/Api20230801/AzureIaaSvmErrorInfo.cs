...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801
{
    ...
    public partial class AzureIaaSvmErrorInfo :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureIaaSvmErrorInfo,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureIaaSvmErrorInfoInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureIaaSvmErrorInfoInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorString</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureIaaSvmErrorInfoInternal.ErrorString { get => this._errorString; set { {_errorString = value;} } }

        /// <summary>Internal Acessors for ErrorTitle</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureIaaSvmErrorInfoInternal.ErrorTitle { get => this._errorTitle; set { {_errorTitle = value;} } }

        /// <summary>Internal Acessors for Recommendation</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureIaaSvmErrorInfoInternal.Recommendation { get => this._recommendation; set { {_recommendation = value;} } }
