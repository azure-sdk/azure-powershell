...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801
{
    ...
    public partial class AzureFileShareProtectionPolicy
    {
        ...
        internal AzureFileShareProtectionPolicy(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            __protectionPolicy = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.ProtectionPolicy(json);
            {_schedulePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("schedulePolicy"), out var __jsonSchedulePolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.SchedulePolicy.FromJson(__jsonSchedulePolicy) : SchedulePolicy;}
            {_retentionPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("retentionPolicy"), out var __jsonRetentionPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.RetentionPolicy.FromJson(__jsonRetentionPolicy) : RetentionPolicy;}
            {_vaultRetentionPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("vaultRetentionPolicy"), out var __jsonVaultRetentionPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.VaultRetentionPolicy.FromJson(__jsonVaultRetentionPolicy) : VaultRetentionPolicy;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureFileShareProtectionPolicy.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureFileShareProtectionPolicy.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20230801.IAzureFileShareProtectionPolicy FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
