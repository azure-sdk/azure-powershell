...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401
{
    ...
    public partial class AzureIaaSvmProtectionPolicy
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject into a new instance of <see cref="AzureIaaSvmProtectionPolicy" />.
        /// </summary>
        ...
        internal AzureIaaSvmProtectionPolicy(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            __protectionPolicy = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.ProtectionPolicy(json);
            {_instantRpDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("instantRPDetails"), out var __jsonInstantRpDetails) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.InstantRpAdditionalDetails.FromJson(__jsonInstantRpDetails) : InstantRpDetail;}
            {_schedulePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("schedulePolicy"), out var __jsonSchedulePolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.SchedulePolicy.FromJson(__jsonSchedulePolicy) : SchedulePolicy;}
            {_retentionPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("retentionPolicy"), out var __jsonRetentionPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.RetentionPolicy.FromJson(__jsonRetentionPolicy) : RetentionPolicy;}
            {_tieringPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("tieringPolicy"), out var __jsonTieringPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.AzureIaaSvmProtectionPolicyTieringPolicy.FromJson(__jsonTieringPolicy) : TieringPolicy;}
            {_instantRpRetentionRangeInDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNumber>("instantRpRetentionRangeInDays"), out var __jsonInstantRpRetentionRangeInDays) ? (int?)__jsonInstantRpRetentionRangeInDays : InstantRpRetentionRangeInDay;}
            {_timeZone = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("timeZone"), out var __jsonTimeZone) ? (string)__jsonTimeZone : (string)TimeZone;}
            {_policyType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("policyType"), out var __jsonPolicyType) ? (string)__jsonPolicyType : (string)PolicyType;}
            {_snapshotConsistencyType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("snapshotConsistencyType"), out var __jsonSnapshotConsistencyType) ? (string)__jsonSnapshotConsistencyType : (string)SnapshotConsistencyType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.IAzureIaaSvmProtectionPolicy.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.IAzureIaaSvmProtectionPolicy.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202401.IAzureIaaSvmProtectionPolicy FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="AzureIaaSvmProtectionPolicy" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureIaaSvmProtectionPolicy" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode" />.
        /// </returns>
