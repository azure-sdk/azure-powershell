...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501
{
    ...
    public partial class SnapshotBackupAdditionalDetails :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.ISnapshotBackupAdditionalDetails,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.ISnapshotBackupAdditionalDetailsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedManagedIdentityDetails Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.ISnapshotBackupAdditionalDetailsInternal.UserAssignedManagedIdentityDetail { get => (this._userAssignedManagedIdentityDetail = this._userAssignedManagedIdentityDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.UserAssignedManagedIdentityDetails()); set { {_userAssignedManagedIdentityDetail = value;} } }

        /// <summary>
        /// Internal Acessors for UserAssignedManagedIdentityDetailUserAssignedIdentityProperty
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.ISnapshotBackupAdditionalDetailsInternal.UserAssignedManagedIdentityDetailUserAssignedIdentityProperty { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedManagedIdentityDetailsInternal)UserAssignedManagedIdentityDetail).UserAssignedIdentityProperty; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedManagedIdentityDetailsInternal)UserAssignedManagedIdentityDetail).UserAssignedIdentityProperty = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedManagedIdentityDetails _userAssignedManagedIdentityDetail;

        /// <summary>User assigned managed identity details</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedManagedIdentityDetails UserAssignedManagedIdentityDetail { get => (this._userAssignedManagedIdentityDetail = this._userAssignedManagedIdentityDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.UserAssignedManagedIdentityDetails()); set => this._userAssignedManagedIdentityDetail = value; }
...

    {
        ...
        string UserAssignedIdentityPropertyPrincipalId { get; set; }
        /// <summary>User assigned managed identity details</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedManagedIdentityDetails UserAssignedManagedIdentityDetail { get; set; }
        /// <summary>The ARM id of the assigned identity.</summary>
        string UserAssignedManagedIdentityDetailIdentityArmId { get; set; }
        /// <summary>The name of the assigned identity.</summary>
        string UserAssignedManagedIdentityDetailIdentityName { get; set; }
        /// <summary>User assigned managed identity properties</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api202501.IUserAssignedIdentityProperties UserAssignedManagedIdentityDetailUserAssignedIdentityProperty { get; set; }
