...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview
{
    ...
    public partial class AzureStorageJob
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject into a new instance of <see cref="AzureStorageJob" />.
        /// </summary>
        ...
        internal AzureStorageJob(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            __job = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.Job(json);
            {_extendedInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("extendedInfo"), out var __jsonExtendedInfo) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.AzureStorageJobExtendedInfo.FromJson(__jsonExtendedInfo) : ExtendedInfo;}
            ...
            {_errorDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray>("errorDetails"), out var __jsonErrorDetails) ? If( __jsonErrorDetails as Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.IAzureStorageErrorInfo[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.IAzureStorageErrorInfo) (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.AzureStorageErrorInfo.FromJson(__p) )) ))() : null : ErrorDetail;}
            {_storageAccountName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("storageAccountName"), out var __jsonStorageAccountName) ? (string)__jsonStorageAccountName : (string)StorageAccountName;}
            {_storageAccountVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("storageAccountVersion"), out var __jsonStorageAccountVersion) ? (string)__jsonStorageAccountVersion : (string)StorageAccountVersion;}
            {_isUserTriggered = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonBoolean>("isUserTriggered"), out var __jsonIsUserTriggered) ? (bool?)__jsonIsUserTriggered : IsUserTriggered;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.IAzureStorageJob.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.IAzureStorageJob.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241101Preview.IAzureStorageJob FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="AzureStorageJob" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AzureStorageJob" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode" />.
        /// </returns>
