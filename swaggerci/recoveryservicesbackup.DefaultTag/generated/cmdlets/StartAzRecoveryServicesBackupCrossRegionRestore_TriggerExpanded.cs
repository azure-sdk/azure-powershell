...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Trigger=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupCrossRegionRestore"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Restores the specified backed up data in a different region as compared to where the data is backed up.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupCrossRegionRestore", ApiVersion = "2024-11-15")]
    public partial class StartAzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.ICrossRegionRestoreRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.CrossRegionRestoreRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Azure region to hit Api")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Access details for cross region restore")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.ICrrAccessToken CrossRegionRestoreAccessDetail { get => _parametersBody.CrossRegionRestoreAccessDetail ?? null /* object */; set => _parametersBody.CrossRegionRestoreAccessDetail = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RestoreRequestObjectType { get => _parametersBody.RestoreRequestObjectType ?? null; set => _parametersBody.RestoreRequestObjectType = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.StartAzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded Clone()
        {
            var clone = new StartAzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded();
            ...
            clone.AzureRegion = this.AzureRegion;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CrossRegionRestoreTrigger' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CrossRegionRestoreTrigger(AzureRegion, SubscriptionId, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  AzureRegion=AzureRegion,SubscriptionId=SubscriptionId,body=_parametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded" /> cmdlet
        /// class.
        /// </summary>
        public StartAzRecoveryServicesBackupCrossRegionRestore_TriggerExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20241115.INewErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { AzureRegion=AzureRegion, SubscriptionId=SubscriptionId, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { AzureRegion=AzureRegion, SubscriptionId=SubscriptionId, body=_parametersBody })
                    {
