...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerregistry/update-azcontainerregistrycacherule
#>
function Update-AzContainerRegistryCacheRule {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.ICacheRule])]
