...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerregistry/new-azcontainerregistrycredentialset
#>
function New-AzContainerRegistryCredentialSet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.ICredentialSet])]
