...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerregistry/get-azcontainerregistrycredentialset
#>
function Get-AzContainerRegistryCredentialSet {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.ICredentialSet], [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.ICredentialSetListResult])]
