...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20221201.IToken])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20221201.ITokenCertificate[]]
    # .
