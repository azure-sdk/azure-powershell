...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/remove-azcontainerregistryarchiveversion
#>
function Remove-AzContainerRegistryArchiveVersion {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ContainerRegistry.private\Remove-AzContainerRegistryArchiveVersion_Delete';
            DeleteViaIdentity = 'Az.ContainerRegistry.private\Remove-AzContainerRegistryArchiveVersion_DeleteViaIdentity';
        }
