...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/get-azcontainerregistryarchive
#>
function Get-AzContainerRegistryArchive {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api202301Preview.IArchive])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerRegistry.private\Get-AzContainerRegistryArchive_Get';
            GetViaIdentity = 'Az.ContainerRegistry.private\Get-AzContainerRegistryArchive_GetViaIdentity';
            List = 'Az.ContainerRegistry.private\Get-AzContainerRegistryArchive_List';
        }
