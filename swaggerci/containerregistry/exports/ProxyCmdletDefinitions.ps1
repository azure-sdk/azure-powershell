...
INPUTOBJECT <IContainerRegistryIdentity>: Identity Parameter
  ...
  [WebhookName <String>]: The name of the webhook.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerregistry/get-azcontainerregistrycacheruleasync
#>
function Get-AzContainerRegistryCacheRuleAsync {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.ContainerRegistry.private\Get-AzContainerRegistryCacheRuleAsync_Get';
            GetViaIdentity = 'Az.ContainerRegistry.private\Get-AzContainerRegistryCacheRuleAsync_GetViaIdentity';
            List = 'Az.ContainerRegistry.private\Get-AzContainerRegistryCacheRuleAsync_List';
        }
        if (('Get', 'List') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
INPUTOBJECT <IContainerRegistryIdentity>: Identity Parameter
  ...
  [WebhookName <String>]: The name of the webhook.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerregistry/update-azcontainerregistrycredentialset
#>
