...
.Link
https://learn.microsoft.com/powershell/module/az.containerregistry/update-azcontainerregistryarchive
#>
function Update-AzContainerRegistryArchive {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.ContainerRegistry.private\Update-AzContainerRegistryArchive_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.ContainerRegistry.private\Update-AzContainerRegistryArchive_UpdateViaIdentityExpanded';
        }
