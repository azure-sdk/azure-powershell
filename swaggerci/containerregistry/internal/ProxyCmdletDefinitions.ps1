...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20221201.IOperationDefinition
.Link
https://docs.microsoft.com/en-us/powershell/module/az.containerregistry/get-azcontainerregistryoperation
#>
function Get-AzContainerRegistryOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20221201.IOperationDefinition])]
