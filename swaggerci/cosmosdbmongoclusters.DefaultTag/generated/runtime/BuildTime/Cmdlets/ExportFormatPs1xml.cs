...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support";
