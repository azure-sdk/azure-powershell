...
namespace Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support
{
        ...
        System.IEquatable<ProvisioningState>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState Canceled = @"Canceled";

        /// <summary>A drop operation is in-progress on the resource.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState Dropping = @"Dropping";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState Failed = @"Failed";

        /// <summary>An operation is in-progress on the resource.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState InProgress = @"InProgress";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState Succeeded = @"Succeeded";

        /// <summary>An update operation is in-progress on the resource.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.CosmosDbMongoCluster.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
