...
online version: https://learn.microsoft.com/powershell/module/az.cosmosdbmongocluster/update-azcosmosdbmongocluster
schema: 2.0.0
---
...
```
Update-AzCosmosDbMongoCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzCosmosDbMongoCluster -InputObject <ICosmosDbMongoClusterIdentity> [-AdministratorLogin <String>]
