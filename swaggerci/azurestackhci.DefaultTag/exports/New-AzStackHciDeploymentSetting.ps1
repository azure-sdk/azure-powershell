...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IDeploymentSetting])]
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IScaleUnits[]]
