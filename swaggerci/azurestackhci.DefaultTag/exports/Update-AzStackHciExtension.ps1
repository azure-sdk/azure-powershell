...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionUpgradeParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtension], [System.Boolean])]
