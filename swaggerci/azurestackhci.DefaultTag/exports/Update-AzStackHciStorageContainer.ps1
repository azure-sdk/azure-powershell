...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainersUpdateRequestTags]))]
