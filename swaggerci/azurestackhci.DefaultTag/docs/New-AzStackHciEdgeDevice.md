...
New-AzStackHciEdgeDevice -Name <String> -ResourceUri <String> [-DeviceConfigurationDeviceMetadata <String>]
 [-DeviceConfigurationNicDetail <INicDetail[]>] [-ProvisioningState <ProvisioningState>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.INicDetail[]
Parameter Sets: (All)
Aliases:
