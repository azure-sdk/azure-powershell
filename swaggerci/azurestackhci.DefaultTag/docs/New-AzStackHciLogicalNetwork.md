...
online version: https://learn.microsoft.com/powershell/module/az.stackhci/new-azstackhcilogicalnetwork
schema: 2.0.0
---

# New-AzStackHciLogicalNetwork
...
```
New-AzStackHciLogicalNetwork -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-DhcpOptionDnsServer <String[]>] [-ExtendedLocationName <String>]
 [-ExtendedLocationType <ExtendedLocationTypes>] [-Subnet <ISubnet[]>] [-Tag <Hashtable>]
 [-VMSwitchName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ISubnet[]
Parameter Sets: (All)
Aliases:
