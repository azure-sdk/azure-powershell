...
online version: https://learn.microsoft.com/powershell/module/az.stackhci/new-azstackhcigalleryimage
schema: 2.0.0
---
...
```
New-AzStackHciGalleryImage -Name <String> -ResourceGroupName <String> -Location <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.CloudInitDataSource
Parameter Sets: (All)
Aliases:
