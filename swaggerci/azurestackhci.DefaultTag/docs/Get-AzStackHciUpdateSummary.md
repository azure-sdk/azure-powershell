...
### GetViaIdentity
```
Get-AzStackHciUpdateSummary -InputObject <IStackHciIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IUpdateSummaries
