...
New-AzStackHciDeploymentSetting -ClusterName <String> -ResourceGroupName <String> -SName <String>
 ...
 [-DeploymentMode <DeploymentMode>] [-ProvisioningState <ProvisioningState>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IScaleUnits[]
Parameter Sets: (All)
Aliases:
