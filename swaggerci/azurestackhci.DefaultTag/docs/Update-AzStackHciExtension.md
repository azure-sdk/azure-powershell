...
Update-AzStackHciExtension -ArcSettingName <String> -ClusterName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-ExtensionParameterEnableAutomaticUpgrade]
 [-ExtensionParameterProtectedSetting <IAny>] [-ExtensionParameterSetting <IAny>]
...
```
Update-AzStackHciExtension -InputObject <IStackHciIdentity> [-ExtensionParameterEnableAutomaticUpgrade]
 [-ExtensionParameterProtectedSetting <IAny>] [-ExtensionParameterSetting <IAny>]
 [-ExtensionParameterTypeHandlerVersion <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IExtensionUpgradeParameters
