...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus Connected = @"Connected";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus Disconnected = @"Disconnected";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus NotConnectedRecently = @"NotConnectedRecently";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus NotSpecified = @"NotSpecified";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus NotYetRegistered = @"NotYetRegistered";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus PartiallyConnected = @"PartiallyConnected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus e1, Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ConnectivityStatus e2)
        {
            return !e2.Equals(e1);
        }
