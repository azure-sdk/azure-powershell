...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes e1, Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.StatusTypes e2)
        {
            return !e2.Equals(e1);
        }
