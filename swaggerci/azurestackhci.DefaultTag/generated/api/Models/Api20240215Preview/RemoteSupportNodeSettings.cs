...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.ArcResourceId { get => this._arcResourceId; set { {_arcResourceId = value;} } }

        /// <summary>Internal Acessors for ConnectionErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.ConnectionErrorMessage { get => this._connectionErrorMessage; set { {_connectionErrorMessage = value;} } }

        /// <summary>Internal Acessors for ConnectionStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.ConnectionStatus { get => this._connectionStatus; set { {_connectionStatus = value;} } }

        /// <summary>Internal Acessors for CreatedAt</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for State</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.State { get => this._state; set { {_state = value;} } }

        /// <summary>Internal Acessors for TranscriptLocation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.TranscriptLocation { get => this._transcriptLocation; set { {_transcriptLocation = value;} } }

        /// <summary>Internal Acessors for UpdatedAt</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IRemoteSupportNodeSettingsInternal.UpdatedAt { get => this._updatedAt; set { {_updatedAt = value;} } }
