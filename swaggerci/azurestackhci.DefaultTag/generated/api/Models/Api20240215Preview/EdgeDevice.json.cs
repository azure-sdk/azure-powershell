...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
    ...
    public partial class EdgeDevice
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject into a new instance of <see cref="EdgeDevice" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal EdgeDevice(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            __resourceAutoGenerated = new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.ResourceAutoGenerated(json);
            {_kind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString>("kind"), out var __jsonKind) ? (string)__jsonKind : (string)Kind;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IEdgeDevice.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IEdgeDevice interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IEdgeDevice.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IEdgeDevice FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
            if (!(node is Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json))
            {
                return null;
            }
            ...
            switch ( json.StringProperty("kind") )
            {
                case "HCI":
                {
                    return new HciEdgeDevice(json);
                }
            }
            return new EdgeDevice(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="EdgeDevice" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="EdgeDevice" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._kind)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString(this._kind.ToString()) : null, "kind" ,container.Add );
