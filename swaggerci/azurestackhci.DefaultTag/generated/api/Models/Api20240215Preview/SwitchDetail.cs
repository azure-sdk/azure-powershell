...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
    ...
    public partial class SwitchDetail :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchDetail,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchDetailInternal
    {

        /// <summary>Backing field for <see cref="Extension" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchExtension[] _extension;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchExtension[] Extension { get => this._extension; }

        /// <summary>Internal Acessors for Extension</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchExtension[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchDetailInternal.Extension { get => this._extension; set { {_extension = value;} } }

        /// <summary>Internal Acessors for SwitchName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchDetailInternal.SwitchName { get => this._switchName; set { {_switchName = value;} } }

        /// <summary>Internal Acessors for SwitchType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchDetailInternal.SwitchType { get => this._switchType; set { {_switchType = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchExtension) })]
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchExtension[] Extension { get;  }
        /// <summary>The name of the switch.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>This represents extensions installed on virtualSwitch.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISwitchExtension[] Extension { get; set; }
        /// <summary>The name of the switch.</summary>
