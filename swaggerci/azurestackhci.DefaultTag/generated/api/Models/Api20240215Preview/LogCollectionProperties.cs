...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
    ...
    public partial class LogCollectionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionSession[] _logCollectionSessionDetail;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionSession[] LogCollectionSessionDetail { get => this._logCollectionSessionDetail; }

        /// <summary>Internal Acessors for FromDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionPropertiesInternal.FromDate { get => this._fromDate; set { {_fromDate = value;} } }

        /// <summary>Internal Acessors for LastLogGenerated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionPropertiesInternal.LastLogGenerated { get => this._lastLogGenerated; set { {_lastLogGenerated = value;} } }

        /// <summary>Internal Acessors for LogCollectionSessionDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionSession[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionPropertiesInternal.LogCollectionSessionDetail { get => this._logCollectionSessionDetail; set { {_logCollectionSessionDetail = value;} } }

        /// <summary>Internal Acessors for ToDate</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionPropertiesInternal.ToDate { get => this._toDate; set { {_toDate = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionSession[] LogCollectionSessionDetail { get;  }
        /// <summary>To DateTimeStamp till when logs need to be connected</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ILogCollectionSession[] LogCollectionSessionDetail { get; set; }
        /// <summary>To DateTimeStamp till when logs need to be connected</summary>
