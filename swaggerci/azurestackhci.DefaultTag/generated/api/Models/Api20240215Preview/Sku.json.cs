...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
    ...
    public partial class Sku
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISku.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISku.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ISku FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json ? new Sku(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject into a new instance of <see cref="Sku" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Sku(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.SkuProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Sku" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Sku" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </returns>
