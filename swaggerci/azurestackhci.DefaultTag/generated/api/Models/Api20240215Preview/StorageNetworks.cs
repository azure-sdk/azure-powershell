...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
    ...
    public partial class StorageNetworks :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IStorageNetworks,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IStorageNetworksInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IStorageAdapterIPInfo[] _storageAdapterIPInfo;

        /// <summary>List of Storage adapter physical nodes config to deploy AzureStackHCI Cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IStorageAdapterIPInfo[] StorageAdapterIPInfo { get => this._storageAdapterIPInfo; set => this._storageAdapterIPInfo = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IStorageAdapterIPInfo) })]
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IStorageAdapterIPInfo[] StorageAdapterIPInfo { get; set; }
        /// <summary>
        /// ID specified for the VLAN storage network. This setting is applied to the network interfaces that route the storage and
        /// VM migration traffic.
        /// </summary>
