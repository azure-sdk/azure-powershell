...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview
{
    ...
    public partial class HciNicDetail :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetail,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.AdapterName { get => this._adapterName; set { {_adapterName = value;} } }

        /// <summary>Internal Acessors for ComponentId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.ComponentId { get => this._componentId; set { {_componentId = value;} } }

        /// <summary>Internal Acessors for DefaultGateway</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.DefaultGateway { get => this._defaultGateway; set { {_defaultGateway = value;} } }

        /// <summary>Internal Acessors for DefaultIsolationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.DefaultIsolationId { get => this._defaultIsolationId; set { {_defaultIsolationId = value;} } }

        /// <summary>Internal Acessors for DnsServer</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.DnsServer { get => this._dnsServer; set { {_dnsServer = value;} } }

        /// <summary>Internal Acessors for DriverVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.DriverVersion { get => this._driverVersion; set { {_driverVersion = value;} } }

        /// <summary>Internal Acessors for InterfaceDescription</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.InterfaceDescription { get => this._interfaceDescription; set { {_interfaceDescription = value;} } }

        /// <summary>Internal Acessors for Ip4Address</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.Ip4Address { get => this._ip4Address; set { {_ip4Address = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NicStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.NicStatus { get => this._nicStatus; set { {_nicStatus = value;} } }

        /// <summary>Internal Acessors for NicType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.NicType { get => this._nicType; set { {_nicType = value;} } }

        /// <summary>Internal Acessors for Slot</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.Slot { get => this._slot; set { {_slot = value;} } }

        /// <summary>Internal Acessors for SubnetMask</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.SubnetMask { get => this._subnetMask; set { {_subnetMask = value;} } }

        /// <summary>Internal Acessors for SwitchName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.SwitchName { get => this._switchName; set { {_switchName = value;} } }

        /// <summary>Internal Acessors for VlanId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IHciNicDetailInternal.VlanId { get => this._vlanId; set { {_vlanId = value;} } }
