...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401
{
    ...
    public partial class GalleryImageStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusInternal
    {

        /// <summary>Backing field for <see cref="DownloadStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusDownloadStatus _downloadStatus;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusDownloadStatus DownloadStatus { get => (this._downloadStatus = this._downloadStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.GalleryImageStatusDownloadStatus()); set => this._downloadStatus = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusDownloadStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusInternal.DownloadStatus { get => (this._downloadStatus = this._downloadStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.GalleryImageStatusDownloadStatus()); set { {_downloadStatus = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusProvisioningStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusInternal.ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.GalleryImageStatusProvisioningStatus()); set { {_provisioningStatus = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusProvisioningStatus _provisioningStatus;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusProvisioningStatus ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.GalleryImageStatusProvisioningStatus()); set => this._provisioningStatus = value; }

        /// <summary>The ID of the operation performed on the gallery image</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Inlined)]
        public string ProvisioningStatusOperationId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusProvisioningStatusInternal)ProvisioningStatus).OperationId; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusProvisioningStatusInternal)ProvisioningStatus).OperationId = value ?? null; }
    ...
    {
        /// <summary>The download status of the gallery image</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusDownloadStatus DownloadStatus { get; set; }
        /// <summary>The downloaded sized of the image in MB</summary>
        long? DownloadStatusDownloadSizeInMb { get; set; }
        /// <summary>GalleryImage provisioning error code</summary>
        string ErrorCode { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImageStatusProvisioningStatus ProvisioningStatus { get; set; }
        /// <summary>The ID of the operation performed on the gallery image</summary>
        string ProvisioningStatusOperationId { get; set; }
        /// <summary>
        /// The status of the operation performed on the gallery image [Succeeded, Failed, InProgress]
