...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401
{
    ...
    public partial class StorageContainerStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IStorageContainerStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IStorageContainerStatusInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IStorageContainerStatusProvisioningStatus _provisioningStatus;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IStorageContainerStatusProvisioningStatus ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.StorageContainerStatusProvisioningStatus()); set => this._provisioningStatus = value; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IStorageContainerStatusProvisioningStatus ProvisioningStatus { get; set; }
        /// <summary>The ID of the operation performed on the storage container</summary>
        string ProvisioningStatusOperationId { get; set; }
        /// <summary>
        /// The status of the operation performed on the storage container [Succeeded, Failed, InProgress]
