...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401
{
    ...
    public partial class IPConfigurationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesInternal.Gateway { get => this._gateway; set { {_gateway = value;} } }

        /// <summary>Internal Acessors for PrefixLength</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesInternal.PrefixLength { get => this._prefixLength; set { {_prefixLength = value;} } }

        /// <summary>Internal Acessors for Subnet</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesSubnet Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesInternal.Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IPConfigurationPropertiesSubnet()); set { {_subnet = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesSubnet _subnet;

        /// <summary>Subnet - Name of Subnet bound to the IP configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesSubnet Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IPConfigurationPropertiesSubnet()); set => this._subnet = value; }
        ...
        public string SubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesSubnetInternal)Subnet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IIPConfigurationPropertiesSubnetInternal)Subnet).Id = value ?? null; }
