...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401
{
    ...
    public partial class ClusterReportedProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.ClusterId { get => this._clusterId; set { {_clusterId = value;} } }

        /// <summary>Internal Acessors for ClusterName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.ClusterName { get => this._clusterName; set { {_clusterName = value;} } }

        /// <summary>Internal Acessors for ClusterType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ClusterNodeType? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.ClusterType { get => this._clusterType; set { {_clusterType = value;} } }

        /// <summary>Internal Acessors for ClusterVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.ClusterVersion { get => this._clusterVersion; set { {_clusterVersion = value;} } }

        /// <summary>Internal Acessors for ImdsAttestation</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.ImdsAttestation? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.ImdsAttestation { get => this._imdsAttestation; set { {_imdsAttestation = value;} } }

        /// <summary>Internal Acessors for LastUpdated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.LastUpdated { get => this._lastUpdated; set { {_lastUpdated = value;} } }

        /// <summary>Internal Acessors for Manufacturer</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.Manufacturer { get => this._manufacturer; set { {_manufacturer = value;} } }

        /// <summary>Internal Acessors for Node</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterNode[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.Node { get => this._node; set { {_node = value;} } }

        /// <summary>Internal Acessors for OemActivation</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.OemActivation? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.OemActivation { get => this._oemActivation; set { {_oemActivation = value;} } }

        /// <summary>Internal Acessors for SupportedCapability</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterReportedPropertiesInternal.SupportedCapability { get => this._supportedCapability; set { {_supportedCapability = value;} } }

        /// <summary>Backing field for <see cref="Node" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterNode[] _node;

        /// <summary>List of nodes reported by the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterNode[] Node { get => this._node; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterNode[] Node { get;  }
        /// <summary>OEM activation status of the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>List of nodes reported by the cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterNode[] Node { get; set; }
        /// <summary>OEM activation status of the cluster.</summary>
