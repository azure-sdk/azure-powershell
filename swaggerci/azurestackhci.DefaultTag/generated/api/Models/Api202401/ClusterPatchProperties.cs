...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401
{
    ...
    public partial class ClusterPatchProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterPatchProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterPatchPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterDesiredProperties _desiredProperty;

        /// <summary>Desired properties of the cluster.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterDesiredProperties DesiredProperty { get => (this._desiredProperty = this._desiredProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ClusterDesiredProperties()); set => this._desiredProperty = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterDesiredProperties Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterPatchPropertiesInternal.DesiredProperty { get => (this._desiredProperty = this._desiredProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ClusterDesiredProperties()); set { {_desiredProperty = value;} } }
...

    {
        ...
        string CloudManagementEndpoint { get; set; }
        /// <summary>Desired properties of the cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IClusterDesiredProperties DesiredProperty { get; set; }
        /// <summary>Desired level of diagnostic data emitted by the cluster.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.DiagnosticLevel? DesiredPropertyDiagnosticLevel { get; set; }
        /// <summary>Desired state of Windows Server Subscription.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.WindowsServerSubscription? DesiredPropertyWindowsServerSubscription { get; set; }
