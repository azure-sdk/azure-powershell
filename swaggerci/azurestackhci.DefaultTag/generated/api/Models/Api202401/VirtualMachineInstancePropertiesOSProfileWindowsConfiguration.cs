...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401
{
    ...
    public partial class VirtualMachineInstancePropertiesOSProfileWindowsConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IVirtualMachineInstancePropertiesOSProfileWindowsConfigurationInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshConfiguration Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IVirtualMachineInstancePropertiesOSProfileWindowsConfigurationInternal.Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.SshConfiguration()); set { {_ssh = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshConfiguration _ssh;

        /// <summary>Specifies the ssh key configuration for Windows OS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshConfiguration Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.SshConfiguration()); set => this._ssh = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshPublicKey[] SshPublicKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshConfigurationInternal)Ssh).PublicKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshConfigurationInternal)Ssh).PublicKey = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshPublicKey[] SshPublicKey { get; set; }
        /// <summary>TimeZone for the virtual machine instance</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        bool? ProvisionVMConfigAgent { get; set; }
        /// <summary>Specifies the ssh key configuration for Windows OS.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshConfiguration Ssh { get; set; }
        /// <summary>The list of SSH public keys used to authenticate with linux based VMs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.ISshPublicKey[] SshPublicKey { get; set; }
        /// <summary>TimeZone for the virtual machine instance</summary>
        string TimeZone { get; set; }
