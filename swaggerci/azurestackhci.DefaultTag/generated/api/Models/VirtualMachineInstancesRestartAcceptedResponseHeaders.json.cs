...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models
{
    ...
    public partial class VirtualMachineInstancesRestartAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.IVirtualMachineInstancesRestartAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.IVirtualMachineInstancesRestartAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.IVirtualMachineInstancesRestartAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json ? new VirtualMachineInstancesRestartAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="VirtualMachineInstancesRestartAcceptedResponseHeaders" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="VirtualMachineInstancesRestartAcceptedResponseHeaders" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject into a new instance of <see cref="VirtualMachineInstancesRestartAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal VirtualMachineInstancesRestartAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
