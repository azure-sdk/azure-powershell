...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230301
{
    ...
    public partial class ExtensionParametersProtectedSettings
    {
        ...
        internal ExtensionParametersProtectedSettings(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            {_workspaceKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString>("workspaceKey"), out var __jsonWorkspaceKey) ? (string)__jsonWorkspaceKey : (string)WorkspaceKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230301.IExtensionParametersProtectedSettings.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230301.IExtensionParametersProtectedSettings.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230301.IExtensionParametersProtectedSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._workspaceKey)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString(this._workspaceKey.ToString()) : null, "workspaceKey" ,container.Add );
