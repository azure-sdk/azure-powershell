...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview
{
    ...
    public partial class PrecheckResult :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResult,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTags Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultInternal.Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.PrecheckResultTags()); set { {_tag = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTags _tag;

        /// <summary>Key-value pairs that allow grouping/filtering individual tests.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.PrecheckResultTags()); set => this._tag = value; }
        ...
        public string TagKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTagsInternal)Tag).Key; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTagsInternal)Tag).Key = value ?? null; }

        /// <summary>Value of the key that allow grouping/filtering individual tests.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Inlined)]
        public string TagValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTagsInternal)Tag).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTagsInternal)Tag).Value = value ?? null; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Support.Status? Status { get; set; }
        /// <summary>Key-value pairs that allow grouping/filtering individual tests.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IPrecheckResultTags Tag { get; set; }
        /// <summary>Key that allow grouping/filtering individual tests.</summary>
        string TagKey { get; set; }
        /// <summary>Value of the key that allow grouping/filtering individual tests.</summary>
        string TagValue { get; set; }
