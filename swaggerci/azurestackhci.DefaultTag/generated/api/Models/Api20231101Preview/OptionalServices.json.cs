...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview
{
    ...
    public partial class OptionalServices
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IOptionalServices.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IOptionalServices.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IOptionalServices FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json ? new OptionalServices(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject into a new instance of <see cref="OptionalServices" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OptionalServices(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            {_customLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString>("customLocation"), out var __jsonCustomLocation) ? (string)__jsonCustomLocation : (string)CustomLocation;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OptionalServices" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OptionalServices" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._customLocation)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString(this._customLocation.ToString()) : null, "customLocation" ,container.Add );
