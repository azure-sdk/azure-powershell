...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview
{
    ...
    public partial class EdgeDevice
    {
        ...
        internal EdgeDevice(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.EdgeDeviceProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IEdgeDevice.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IEdgeDevice.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IEdgeDevice FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json ? new EdgeDevice(json) : null;
        }
