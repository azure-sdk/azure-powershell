...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview
{
    ...
    public partial class ExtensionPatchProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchPropertiesInternal
    {

        /// <summary>Backing field for <see cref="ExtensionParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchParameters _extensionParameter;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchParameters ExtensionParameter { get => (this._extensionParameter = this._extensionParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.ExtensionPatchParameters()); set => this._extensionParameter = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchParameters Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchPropertiesInternal.ExtensionParameter { get => (this._extensionParameter = this._extensionParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.ExtensionPatchParameters()); set { {_extensionParameter = value;} } }
    ...
    {
        /// <summary>Describes the properties of a Machine Extension that can be updated.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IExtensionPatchParameters ExtensionParameter { get; set; }
        /// <summary>
        /// Indicates whether the extension should be automatically upgraded by the platform if there is a newer version available.
        /// </summary>
        bool? ExtensionParameterEnableAutomaticUpgrade { get; set; }
