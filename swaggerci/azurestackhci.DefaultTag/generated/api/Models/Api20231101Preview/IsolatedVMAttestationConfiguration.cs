...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview
{
    ...
    public partial class IsolatedVMAttestationConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IIsolatedVMAttestationConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IIsolatedVMAttestationConfigurationInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IIsolatedVMAttestationConfigurationInternal.AttestationResourceId { get => this._attestationResourceId; set { {_attestationResourceId = value;} } }

        /// <summary>Internal Acessors for AttestationServiceEndpoint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IIsolatedVMAttestationConfigurationInternal.AttestationServiceEndpoint { get => this._attestationServiceEndpoint; set { {_attestationServiceEndpoint = value;} } }

        /// <summary>Internal Acessors for RelyingPartyServiceEndpoint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IIsolatedVMAttestationConfigurationInternal.RelyingPartyServiceEndpoint { get => this._relyingPartyServiceEndpoint; set { {_relyingPartyServiceEndpoint = value;} } }
