...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview
{
    ...
    public partial class UpdatePrerequisite
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IUpdatePrerequisite.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IUpdatePrerequisite.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20231101Preview.IUpdatePrerequisite FromJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json ? new UpdatePrerequisite(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpdatePrerequisite" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdatePrerequisite" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._updateType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString(this._updateType.ToString()) : null, "updateType" ,container.Add );
            ...
            AddIf( null != (((object)this._packageName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString(this._packageName.ToString()) : null, "packageName" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject into a new instance of <see cref="UpdatePrerequisite" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UpdatePrerequisite(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_updateType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString>("updateType"), out var __jsonUpdateType) ? (string)__jsonUpdateType : (string)UpdateType;}
            ...
            {_packageName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Json.JsonString>("packageName"), out var __jsonPackageName) ? (string)__jsonPackageName : (string)PackageName;}
            AfterFromJson(json);
        }
    }
}