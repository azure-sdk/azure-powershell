...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview
{
    ...
    public partial class VirtualMachineInstancePropertiesHardwareProfile :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfile,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileInternal
    {

        /// <summary>Backing field for <see cref="DynamicMemoryConfig" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig _dynamicMemoryConfig;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig DynamicMemoryConfig { get => (this._dynamicMemoryConfig = this._dynamicMemoryConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.VirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig()); set => this._dynamicMemoryConfig = value; }

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Inlined)]
        public long? DynamicMemoryConfigMaximumMemoryMb { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfigInternal)DynamicMemoryConfig).MaximumMemoryMb; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfigInternal)DynamicMemoryConfig).MaximumMemoryMb = value ?? default(long); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileInternal.DynamicMemoryConfig { get => (this._dynamicMemoryConfig = this._dynamicMemoryConfig ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.VirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig()); set { {_dynamicMemoryConfig = value;} } }
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IVirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfig DynamicMemoryConfig { get; set; }
