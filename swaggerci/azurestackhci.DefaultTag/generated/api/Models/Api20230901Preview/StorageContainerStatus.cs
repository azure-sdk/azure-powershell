...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview
{
    ...
    public partial class StorageContainerStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusProvisioningStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusInternal.ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.StorageContainerStatusProvisioningStatus()); set { {_provisioningStatus = value;} } }

        /// <summary>Backing field for <see cref="ProvisioningStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusProvisioningStatus _provisioningStatus;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusProvisioningStatus ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.StorageContainerStatusProvisioningStatus()); set => this._provisioningStatus = value; }
        ...
        public string ProvisioningStatusOperationId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusProvisioningStatusInternal)ProvisioningStatus).OperationId; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusProvisioningStatusInternal)ProvisioningStatus).OperationId = value ?? null; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IStorageContainerStatusProvisioningStatus ProvisioningStatus { get; set; }
        /// <summary>The ID of the operation performed on the storage container</summary>
        string ProvisioningStatusOperationId { get; set; }
        /// <summary>
        /// The status of the operation performed on the storage container [Succeeded, Failed, InProgress]
