...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview
{
    ...
    public partial class IPConfigurationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesInternal.Gateway { get => this._gateway; set { {_gateway = value;} } }

        /// <summary>Internal Acessors for PrefixLength</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesInternal.PrefixLength { get => this._prefixLength; set { {_prefixLength = value;} } }

        /// <summary>Internal Acessors for Subnet</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesSubnet Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesInternal.Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IPConfigurationPropertiesSubnet()); set { {_subnet = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesSubnet _subnet;

        /// <summary>Subnet - Name of Subnet bound to the IP configuration.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesSubnet Subnet { get => (this._subnet = this._subnet ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IPConfigurationPropertiesSubnet()); set => this._subnet = value; }
        ...
        public string SubnetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesSubnetInternal)Subnet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesSubnetInternal)Subnet).Id = value ?? null; }
...

    {
        ...
        string PrivateIPAddress { get; set; }
        /// <summary>Subnet - Name of Subnet bound to the IP configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IIPConfigurationPropertiesSubnet Subnet { get; set; }
        /// <summary>
        /// ID - The ARM resource id in the form of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/...
        /// </summary>
        string SubnetId { get; set; }
