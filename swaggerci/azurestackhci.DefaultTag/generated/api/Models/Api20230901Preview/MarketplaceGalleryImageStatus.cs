...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview
{
    ...
    public partial class MarketplaceGalleryImageStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusInternal
    {

        /// <summary>Backing field for <see cref="DownloadStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusDownloadStatus _downloadStatus;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusDownloadStatus DownloadStatus { get => (this._downloadStatus = this._downloadStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.MarketplaceGalleryImageStatusDownloadStatus()); set => this._downloadStatus = value; }
        ...
        public long? DownloadStatusDownloadSizeInMb { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusDownloadStatusInternal)DownloadStatus).DownloadSizeInMb; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusDownloadStatusInternal)DownloadStatus).DownloadSizeInMb = value ?? default(long); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusDownloadStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusInternal.DownloadStatus { get => (this._downloadStatus = this._downloadStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.MarketplaceGalleryImageStatusDownloadStatus()); set { {_downloadStatus = value;} } }

        /// <summary>Internal Acessors for ProvisioningStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusProvisioningStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusInternal.ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.MarketplaceGalleryImageStatusProvisioningStatus()); set { {_provisioningStatus = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusProvisioningStatus _provisioningStatus;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusProvisioningStatus ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.MarketplaceGalleryImageStatusProvisioningStatus()); set => this._provisioningStatus = value; }

        /// <summary>The ID of the operation performed on the gallery image</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Inlined)]
        public string ProvisioningStatusOperationId { get => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusProvisioningStatusInternal)ProvisioningStatus).OperationId; set => ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusProvisioningStatusInternal)ProvisioningStatus).OperationId = value ?? null; }
    ...
    {
        /// <summary>The download status of the gallery image</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusDownloadStatus DownloadStatus { get; set; }
        /// <summary>The downloaded sized of the image in MB</summary>
        long? DownloadStatusDownloadSizeInMb { get; set; }
        /// <summary>MarketplaceGalleryImage provisioning error code</summary>
        string ErrorCode { get; set; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImageStatusProvisioningStatus ProvisioningStatus { get; set; }
        /// <summary>The ID of the operation performed on the gallery image</summary>
        string ProvisioningStatusOperationId { get; set; }
        /// <summary>
        /// The status of the operation performed on the gallery image [Succeeded, Failed, InProgress]
