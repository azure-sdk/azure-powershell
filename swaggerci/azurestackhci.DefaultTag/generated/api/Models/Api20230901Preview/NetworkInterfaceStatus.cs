...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview
{
    ...
    public partial class NetworkInterfaceStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatusInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatusProvisioningStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatusInternal.ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.NetworkInterfaceStatusProvisioningStatus()); set { {_provisioningStatus = value;} } }

        /// <summary>Backing field for <see cref="ProvisioningStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatusProvisioningStatus _provisioningStatus;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatusProvisioningStatus ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.NetworkInterfaceStatusProvisioningStatus()); set => this._provisioningStatus = value; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.INetworkInterfaceStatusProvisioningStatus ProvisioningStatus { get; set; }
        /// <summary>The ID of the operation performed on the network interface</summary>
        string ProvisioningStatusOperationId { get; set; }
        /// <summary>
        /// The status of the operation performed on the network interface [Succeeded, Failed, InProgress]
