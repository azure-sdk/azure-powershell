...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview
{
    ...
    public partial class LogicalNetworkStatus :
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatus,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatusInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatusProvisioningStatus Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatusInternal.ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.LogicalNetworkStatusProvisioningStatus()); set { {_provisioningStatus = value;} } }

        /// <summary>Backing field for <see cref="ProvisioningStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatusProvisioningStatus _provisioningStatus;

        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Origin(Microsoft.Azure.PowerShell.Cmdlets.StackHci.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatusProvisioningStatus ProvisioningStatus { get => (this._provisioningStatus = this._provisioningStatus ?? new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.LogicalNetworkStatusProvisioningStatus()); set => this._provisioningStatus = value; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.ILogicalNetworkStatusProvisioningStatus ProvisioningStatus { get; set; }
        /// <summary>The ID of the operation performed on the logical network</summary>
        string ProvisioningStatusOperationId { get; set; }
        /// <summary>
        /// The status of the operation performed on the logical network [Succeeded, Failed, InProgress]
