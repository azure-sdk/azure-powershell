...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IHeaderSerializable
    {
        ...
        /// <summary>
        /// Creates an new <see cref="EdgeDevicesValidateAcceptedResponseHeaders" /> instance.
        /// </summary>
        public EdgeDevicesValidateAcceptedResponseHeaders()
        {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.IEdgeDevicesValidateAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
        }
    }
    ...
    internal partial interface IEdgeDevicesValidateAcceptedResponseHeadersInternal
