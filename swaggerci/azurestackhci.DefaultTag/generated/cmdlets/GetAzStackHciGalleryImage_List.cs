...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAll=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/galleryImages"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStackHciGalleryImage_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Description(@"Lists all of the gallery images in the specified subscription. Use the nextLink property in the response to get the next page of gallery images.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/galleryImages", ApiVersion = "2024-01-01")]
    public partial class GetAzStackHciGalleryImage_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImagesListResult">Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImagesListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImagesListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStackHciGalleryImage_List" /> cmdlet class.
        /// </summary>
        public GetAzStackHciGalleryImage_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.GalleryImagesListAll(SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api202401.IGalleryImagesListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.GalleryImagesListAll_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
