...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListAll=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/marketplaceGalleryImages"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Description(@"Lists all of the marketplace gallery images in the specified subscription. Use the nextLink property in the response to get the next page of marketplace gallery images.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/marketplaceGalleryImages", ApiVersion = "2023-09-01-preview")]
    public partial class GetAzStackHciMarketplaceGalleryImage_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImagesListResult">Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImagesListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImagesListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStackHciMarketplaceGalleryImage_List1" /> cmdlet class.
        /// </summary>
        public GetAzStackHciMarketplaceGalleryImage_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MarketplaceGalleryImagesListAll(SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20230901Preview.IMarketplaceGalleryImagesListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.MarketplaceGalleryImagesListAll_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
