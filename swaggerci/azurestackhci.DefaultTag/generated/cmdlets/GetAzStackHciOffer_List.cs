...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByPublisher=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/publishers/{publisherName}/offers"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStackHciOffer_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Description(@"List Offers available for a publisher within the HCI Cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/publishers/{publisherName}/offers", ApiVersion = "2024-02-15-preview")]
    public partial class GetAzStackHciOffer_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStackHciOffer_List" /> cmdlet class.
        /// </summary>
        public GetAzStackHciOffer_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.OffersListByPublisher(SubscriptionId, ResourceGroupName, ClusterName, PublisherName, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.OffersListByPublisher_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
