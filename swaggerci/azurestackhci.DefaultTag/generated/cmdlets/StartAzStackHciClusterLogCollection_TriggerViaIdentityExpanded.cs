...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzStackHciClusterLogCollection_TriggerViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class StartAzStackHciClusterLogCollection_TriggerViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of StartAzStackHciClusterLogCollection_TriggerViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets.StartAzStackHciClusterLogCollection_TriggerViaIdentityExpanded Clone()
        {
            var clone = new StartAzStackHciClusterLogCollection_TriggerViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersTriggerLogCollectionViaIdentity(InputObject.Id, _logCollectionRequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersTriggerLogCollection(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, _logCollectionRequestBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_logCollectionRequestBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzStackHciClusterLogCollection_TriggerViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public StartAzStackHciClusterLogCollection_TriggerViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_logCollectionRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_logCollectionRequestBody })
                    {
