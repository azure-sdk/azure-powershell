...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzStackHciEdgeDevice_ValidateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.HttpPath(Path = "/{resourceUri}/providers/Microsoft.AzureStackHCI/edgeDevices/{edgeDeviceName}/validate", ApiVersion = "2024-02-15-preview")]
    public partial class TestAzStackHciEdgeDevice_ValidateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IValidateRequest _validateRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.ValidateRequest();

        /// <summary>Additional info required for validation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Additional info required for validation.")]
        ...
        public string AdditionalInfo { get => _validateRequestBody.AdditionalInfo ?? null; set => _validateRequestBody.AdditionalInfo = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Node Ids against which, current node has to be validated.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] EdgeDeviceId { get => _validateRequestBody.EdgeDeviceId ?? null /* arrayOf */; set => _validateRequestBody.EdgeDeviceId = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.IErrorResponseAutoGenerated">Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.IErrorResponseAutoGenerated</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.IErrorResponseAutoGenerated> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IValidateResponse">Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IValidateResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IValidateResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of TestAzStackHciEdgeDevice_ValidateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets.TestAzStackHciEdgeDevice_ValidateExpanded Clone()
        {
            var clone = new TestAzStackHciEdgeDevice_ValidateExpanded();
            ...
            clone._validateRequestBody = this._validateRequestBody;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'EdgeDevicesValidate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.EdgeDevicesValidate(ResourceUri, Name, _validateRequestBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceUri=ResourceUri,Name=Name,body=_validateRequestBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzStackHciEdgeDevice_ValidateExpanded" /> cmdlet class.
        /// </summary>
        public TestAzStackHciEdgeDevice_ValidateExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api50.IErrorResponseAutoGenerated>(responseMessage, await response);
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceUri=ResourceUri, Name=Name, body=_validateRequestBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceUri=ResourceUri, Name=Name, body=_validateRequestBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IValidateResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IValidateResponse
