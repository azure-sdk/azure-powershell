...
namespace Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzStackHciExtension_UpgradeViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StackHci.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/arcSettings/{arcSettingName}/extensions/{extensionName}/upgrade", ApiVersion = "2024-02-15-preview")]
    public partial class UpdateAzStackHciExtension_UpgradeViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.StackHci.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IExtensionUpgradeParameters _extensionUpgradeParameter;

        /// <summary>Describes the parameters for Extension upgrade.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Describes the parameters for Extension upgrade.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IExtensionUpgradeParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Models.Api20240215Preview.IExtensionUpgradeParameters ExtensionUpgradeParameter { get => this._extensionUpgradeParameter; set => this._extensionUpgradeParameter = value; }
        ...
        /// <returns>a duplicate instance of UpdateAzStackHciExtension_UpgradeViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StackHci.Cmdlets.UpdateAzStackHciExtension_UpgradeViaIdentity Clone()
        {
            var clone = new UpdateAzStackHciExtension_UpgradeViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ExtensionsUpgradeViaIdentity(InputObject.Id, ExtensionUpgradeParameter, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ExtensionsUpgrade(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.ArcSettingName ?? null, InputObject.ExtensionName ?? null, ExtensionUpgradeParameter, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzStackHciExtension_UpgradeViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzStackHciExtension_UpgradeViaIdentity()
        {
