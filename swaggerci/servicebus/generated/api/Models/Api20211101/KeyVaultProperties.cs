...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101
{
    ...
    public partial class KeyVaultProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IKeyVaultProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IKeyVaultPropertiesInternal
    {

        /// <summary>Backing field for <see cref="Identity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IUserAssignedIdentityProperties _identity;

        [Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Origin(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IUserAssignedIdentityProperties Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.UserAssignedIdentityProperties()); set => this._identity = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IUserAssignedIdentityProperties Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IKeyVaultPropertiesInternal.Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.UserAssignedIdentityProperties()); set { {_identity = value;} } }
    ...
    {
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IUserAssignedIdentityProperties Identity { get; set; }
        /// <summary>ARM ID of user Identity selected for encryption</summary>
        string IdentityUserAssignedIdentity { get; set; }
        /// <summary>Name of the Key from KeyVault</summary>
        string KeyName { get; set; }
