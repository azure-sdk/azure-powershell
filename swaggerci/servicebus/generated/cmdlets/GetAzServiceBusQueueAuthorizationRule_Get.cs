...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzServiceBusQueueAuthorizationRule_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.QueuesGetAuthorizationRule(ResourceGroupName, NamespaceName, QueueName, AuthorizationRuleName, SubscriptionId, onOk, onDefault, this, Pipeline);
