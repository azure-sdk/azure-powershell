...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IEventListener
    {
        ...
        public global::System.Management.Automation.SwitchParameter IsSafeFailover { get => ParametersBody.IsSafeFailover ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.IsSafeFailover = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IFailoverProperties _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.FailoverProperties();

        /// <summary>
        /// Safe failover is to indicate the service should wait for pending replication to finish before switching to the secondary.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IFailoverProperties ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DisasterRecoveryConfigsFailOverViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DisasterRecoveryConfigsFailOver(InputObject.ResourceGroupName ?? null, InputObject.NamespaceName ?? null, InputObject.Alias ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
