...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IFailoverProperties _parameter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IFailoverProperties) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IFailoverProperties Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzServiceBusFailDisasterRecoveryConfigOver_Fail" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DisasterRecoveryConfigsFailOver(ResourceGroupName, NamespaceName, Alias, SubscriptionId, Parameter, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,NamespaceName=NamespaceName,Alias=Alias,SubscriptionId=SubscriptionId,body=Parameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api10.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NamespaceName=NamespaceName, Alias=Alias, SubscriptionId=SubscriptionId, body=Parameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, NamespaceName=NamespaceName, Alias=Alias, SubscriptionId=SubscriptionId, body=Parameter })
                    {
