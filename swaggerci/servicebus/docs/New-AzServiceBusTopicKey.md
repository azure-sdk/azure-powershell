...
```
New-AzServiceBusTopicKey -AuthorizationRuleName <String> -NamespaceName <String> -ResourceGroupName <String>
 -TopicName <String> -Parameter <IRegenerateAccessKeyParameters> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentity
```
New-AzServiceBusTopicKey -InputObject <IServiceBusIdentity> -Parameter <IRegenerateAccessKeyParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzServiceBusTopicKey -InputObject <IServiceBusIdentity> -KeyType <KeyType> [-Key <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IRegenerateAccessKeyParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IRegenerateAccessKeyParameters

### Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.IServiceBusIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IAccessKeys
