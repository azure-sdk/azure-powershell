...
online version: https://docs.microsoft.com/en-us/powershell/module/az.servicebus/new-azservicebusqueuekey
schema: 2.0.0
---
...
```
New-AzServiceBusQueueKey -AuthorizationRuleName <String> -NamespaceName <String> -QueueName <String>
...
```
New-AzServiceBusQueueKey -InputObject <IServiceBusIdentity> -Parameter <IRegenerateAccessKeyParameters>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzServiceBusQueueKey -InputObject <IServiceBusIdentity> -KeyType <KeyType> [-Key <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
