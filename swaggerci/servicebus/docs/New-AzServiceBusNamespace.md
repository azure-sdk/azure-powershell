...
New-AzServiceBusNamespace -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-SkuTier <SkuTier>] [-Tag <Hashtable>] [-ZoneRedundant] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IKeyVaultProperties[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.IPrivateEndpointConnection[]
Parameter Sets: (All)
Aliases:
