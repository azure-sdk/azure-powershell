...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.ICheckNameAvailability
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ServiceBus.Models.Api20211101.ICheckNameAvailabilityResult])]
