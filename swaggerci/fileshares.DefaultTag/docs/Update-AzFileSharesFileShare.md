...
online version: https://learn.microsoft.com/powershell/module/az.fileshares/update-azfilesharesfileshare
schema: 2.0.0
---

# Update-AzFileSharesFileShare
...
```
Update-AzFileSharesFileShare -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
 [-NfProtocolPropertyRootSquash <ShareRootSquash>] [-ProvisionedIoPerSec <Int32>]
...
```
Update-AzFileSharesFileShare -InputObject <IFileSharesIdentity>
 [-NfProtocolPropertyRootSquash <ShareRootSquash>] [-ProvisionedIoPerSec <Int32>]
 [-ProvisionedStorageGiB <Int32>] [-ProvisionedThroughputMiBPerSec <Int32>]
 [-PublicAccessPropertyAllowedSubnet <String[]>] [-PublicNetworkAccess <PublicNetworkAccess>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
