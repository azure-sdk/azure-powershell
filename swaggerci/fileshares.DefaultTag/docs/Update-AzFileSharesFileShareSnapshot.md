...
online version: https://learn.microsoft.com/powershell/module/az.fileshares/update-azfilesharesfilesharesnapshot
schema: 2.0.0
---

# Update-AzFileSharesFileShareSnapshot
...
```
Update-AzFileSharesFileShareSnapshot -Name <String> -ResourceGroupName <String> -ResourceName <String>
...
```
Update-AzFileSharesFileShareSnapshot -InputObject <IFileSharesIdentity> [-Metadata <Hashtable>]
