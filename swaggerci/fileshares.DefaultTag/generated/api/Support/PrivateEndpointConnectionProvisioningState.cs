...
namespace Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.FileShares.Support.PrivateEndpointConnectionProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
