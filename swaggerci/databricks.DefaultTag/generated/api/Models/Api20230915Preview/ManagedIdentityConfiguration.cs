...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview
{
    ...
    public partial class ManagedIdentityConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IManagedIdentityConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IManagedIdentityConfigurationInternal
    {

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IManagedIdentityConfigurationInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IManagedIdentityConfigurationInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IManagedIdentityConfigurationInternal.Type { get => this._type; set { {_type = value;} } }
