...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview
{
    ...
    public partial class WorkspaceCustomParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IWorkspaceCustomParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IWorkspaceCustomParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IWorkspaceCustomParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode node)
        {
        ...
        internal WorkspaceCustomParameters(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject json)
        {
            ...
            {_amlWorkspaceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("amlWorkspaceId"), out var __jsonAmlWorkspaceId) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonAmlWorkspaceId) : AmlWorkspaceId;}
            {_customVirtualNetworkId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("customVirtualNetworkId"), out var __jsonCustomVirtualNetworkId) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonCustomVirtualNetworkId) : CustomVirtualNetworkId;}
            {_customPublicSubnetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("customPublicSubnetName"), out var __jsonCustomPublicSubnetName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonCustomPublicSubnetName) : CustomPublicSubnetName;}
            {_customPrivateSubnetName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("customPrivateSubnetName"), out var __jsonCustomPrivateSubnetName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonCustomPrivateSubnetName) : CustomPrivateSubnetName;}
            {_enableNoPublicIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("enableNoPublicIp"), out var __jsonEnableNoPublicIP) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomBooleanParameter.FromJson(__jsonEnableNoPublicIP) : EnableNoPublicIP;}
            {_loadBalancerBackendPoolName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("loadBalancerBackendPoolName"), out var __jsonLoadBalancerBackendPoolName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonLoadBalancerBackendPoolName) : LoadBalancerBackendPoolName;}
            {_loadBalancerId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("loadBalancerId"), out var __jsonLoadBalancerId) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonLoadBalancerId) : LoadBalancerId;}
            {_natGatewayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("natGatewayName"), out var __jsonNatGatewayName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonNatGatewayName) : NatGatewayName;}
            {_publicIPName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("publicIpName"), out var __jsonPublicIPName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonPublicIPName) : PublicIPName;}
            {_prepareEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("prepareEncryption"), out var __jsonPrepareEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomBooleanParameter.FromJson(__jsonPrepareEncryption) : PrepareEncryption;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceEncryptionParameter.FromJson(__jsonEncryption) : Encryption;}
            {_requireInfrastructureEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("requireInfrastructureEncryption"), out var __jsonRequireInfrastructureEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomBooleanParameter.FromJson(__jsonRequireInfrastructureEncryption) : RequireInfrastructureEncryption;}
            {_storageAccountName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("storageAccountName"), out var __jsonStorageAccountName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonStorageAccountName) : StorageAccountName;}
            {_storageAccountSkuName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("storageAccountSkuName"), out var __jsonStorageAccountSkuName) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonStorageAccountSkuName) : StorageAccountSkuName;}
            {_vnetAddressPrefix = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("vnetAddressPrefix"), out var __jsonVnetAddressPrefix) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomStringParameter.FromJson(__jsonVnetAddressPrefix) : VnetAddressPrefix;}
            {_resourceTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("resourceTags"), out var __jsonResourceTags) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.WorkspaceCustomObjectParameter.FromJson(__jsonResourceTags) : ResourceTag;}
            AfterFromJson(json);
        }
    }
}