...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview
{
    ...
    public partial class ManagedIdentityConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IManagedIdentityConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IManagedIdentityConfigurationInternal
    {

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IManagedIdentityConfigurationInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IManagedIdentityConfigurationInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IManagedIdentityConfigurationInternal.Type { get => this._type; set { {_type = value;} } }
