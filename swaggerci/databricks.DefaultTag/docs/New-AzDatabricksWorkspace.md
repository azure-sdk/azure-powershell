...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240901Preview.IWorkspaceProviderAuthorization[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240901Preview.IWorkspaceCustomParameters
Parameter Sets: (All)
Aliases:
