...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IWorkspaceProviderAuthorization[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IWorkspaceCustomParameters
Parameter Sets: (All)
Aliases:
