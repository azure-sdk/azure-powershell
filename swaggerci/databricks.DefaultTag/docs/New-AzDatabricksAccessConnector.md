...
New-AzDatabricksAccessConnector -ConnectorName <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-IdentityType <SystemAssignedOrUserAssignedServiceIdentityType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Databricks.Support.SystemAssignedOrUserAssignedServiceIdentityType
Parameter Sets: (All)
Aliases:
