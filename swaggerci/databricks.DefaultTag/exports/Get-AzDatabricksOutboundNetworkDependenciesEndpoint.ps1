...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IOutboundEnvironmentEndpoint
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20230915Preview.IOutboundEnvironmentEndpoint])]
