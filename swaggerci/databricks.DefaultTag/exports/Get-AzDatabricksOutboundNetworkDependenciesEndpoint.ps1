...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IOutboundEnvironmentEndpoint
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IOutboundEnvironmentEndpoint])]
