...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IPrivateEndpointConnection
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240201Preview.IPrivateEndpointConnection])]
