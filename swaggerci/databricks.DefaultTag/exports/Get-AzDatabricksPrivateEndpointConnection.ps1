...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240901Preview.IPrivateEndpointConnection
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240901Preview.IPrivateEndpointConnection])]
