...
PARAMETER <IWorkspaceCustomParameters>: The workspace's custom parameters.
  ...
  [EnableNoPublicIP <Boolean?>]: Boolean indicating whether the public IP should be disabled. Default value is true
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240501.IWorkspaceCustomParameters]
