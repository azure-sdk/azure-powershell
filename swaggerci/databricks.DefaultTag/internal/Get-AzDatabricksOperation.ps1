...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240901Preview.IOperation
.Link
https://learn.microsoft.com/powershell/module/az.databricks/get-azdatabricksoperation
#>
function Get-AzDatabricksOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20240901Preview.IOperation])]
