...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130
{
    ...
    public partial class UserAssignedIdentityProperties :
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130.IUserAssignedIdentityProperties,
        Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130.IUserAssignedIdentityPropertiesInternal
    {
        ...
        /// <summary>Backing field for <see cref="IsolationScope" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Support.IsolationScope? _isolationScope;

        /// <summary>Enum to configure regional restrictions on identity assignment, as necessary.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Origin(Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Support.IsolationScope? IsolationScope { get => this._isolationScope; set => this._isolationScope = value; }

        /// <summary>Internal Acessors for ClientId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130.IUserAssignedIdentityPropertiesInternal.ClientId { get => this._clientId; set { {_clientId = value;} } }

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130.IUserAssignedIdentityPropertiesInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130.IUserAssignedIdentityPropertiesInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }
