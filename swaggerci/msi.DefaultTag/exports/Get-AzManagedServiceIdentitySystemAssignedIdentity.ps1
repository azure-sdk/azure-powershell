...
.Link
https://learn.microsoft.com/powershell/module/az.managedserviceidentity/get-azmanagedserviceidentitysystemassignedidentity
#>
function Get-AzManagedServiceIdentitySystemAssignedIdentity {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.ManagedServiceIdentity.Models.Api20241130.ISystemAssignedIdentity])]
