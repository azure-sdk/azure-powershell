...
namespace Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.Api202401
{
    ...
    public partial class TagsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Tags" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.Api202401.ITags ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.Api202401.ITags).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
