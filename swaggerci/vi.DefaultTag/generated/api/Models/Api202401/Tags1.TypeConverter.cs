...
namespace Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.Api202401
{
    ...
    public partial class Tags1TypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Tags1" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.Api202401.ITags1 ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Vi.Models.Api202401.ITags1).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
