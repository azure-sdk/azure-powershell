...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState Registered = @"Registered";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState Suspended = @"Suspended";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState Unregistered = @"Unregistered";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState Warned = @"Warned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState e1, Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.SubscriptionState e2)
        {
            return !e2.Equals(e1);
        }
