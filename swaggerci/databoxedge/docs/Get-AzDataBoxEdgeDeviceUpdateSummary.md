...
online version: https://learn.microsoft.com/powershell/module/az.databoxedge/get-azdataboxedgedeviceupdatesummary
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzDataBoxEdgeDeviceUpdateSummary -DeviceName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataBoxEdgeDeviceUpdateSummary -InputObject <IDataBoxEdgeIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
