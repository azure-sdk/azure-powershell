...
online version: https://learn.microsoft.com/powershell/module/az.databoxedge/remove-azdataboxedgerole
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDataBoxEdgeRole -DeviceName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDataBoxEdgeRole -InputObject <IDataBoxEdgeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
