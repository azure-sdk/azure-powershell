...
online version: https://docs.microsoft.com/en-us/powershell/module/az.databoxedge/remove-azdataboxedgemonitoringconfig
schema: 2.0.0
---

# Remove-AzDataBoxEdgeMonitoringConfig
...
### Delete (Default)
```
Remove-AzDataBoxEdgeMonitoringConfig -DeviceName <String> -ResourceGroupName <String> -RoleName <String>
...
### DeleteViaIdentity
```
Remove-AzDataBoxEdgeMonitoringConfig -InputObject <IDataBoxEdgeIdentity> [-DefaultProfile <PSObject>] [-AsJob]
