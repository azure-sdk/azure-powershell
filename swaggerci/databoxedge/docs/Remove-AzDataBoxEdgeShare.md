...
online version: https://learn.microsoft.com/powershell/module/az.databoxedge/remove-azdataboxedgeshare
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDataBoxEdgeShare -DeviceName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDataBoxEdgeShare -InputObject <IDataBoxEdgeIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
