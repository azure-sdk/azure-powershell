...
### List (Default)
```
Get-AzStorageBlobContainer -AccountName <String> -BlobServicesName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-Include <ListContainersInclude>] [-Maxpagesize <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStorageBlobContainer -AccountName <String> -BlobServicesName <String> -ContainerName <String>
