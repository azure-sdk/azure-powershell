...
```
Invoke-AzStorageLeaseBlobContainer -AccountName <String> -BlobServicesName <String> -ContainerName <String>
 -ResourceGroupName <String> -Action <LeaseContainerRequestAction> [-SubscriptionId <String>]
...
```
Invoke-AzStorageLeaseBlobContainer -AccountName <String> -BlobServicesName <String> -ContainerName <String>
 -ResourceGroupName <String> -Parameter <ILeaseContainerRequest> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ILeaseContainerRequest
...
### Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ILeaseContainerRequest
