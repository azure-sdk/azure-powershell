...
```
Invoke-AzStorageExtendBlobContainerImmutabilityPolicy -AccountName <String> -BlobServicesName <String>
 -ContainerName <String> -ImmutabilityPolicyName <String> -ResourceGroupName <String> -IfMatch <String>
 [-SubscriptionId <String>] [-AllowProtectedAppendWrite] [-AllowProtectedAppendWritesAll]
...
Invoke-AzStorageExtendBlobContainerImmutabilityPolicy -AccountName <String> -BlobServicesName <String>
 -ContainerName <String> -ImmutabilityPolicyName <String> -ResourceGroupName <String> -IfMatch <String>
 -Parameter <IImmutabilityPolicy> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
