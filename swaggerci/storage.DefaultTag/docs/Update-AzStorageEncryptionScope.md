...
Update-AzStorageEncryptionScope -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-KeyVaultPropertyKeyUri <String>] [-RequireInfrastructureEncryption]
 [-Source <EncryptionScopeSource>] [-State <EncryptionScopeState>] [-DefaultProfile <PSObject>] [-Confirm]
...
```
Update-AzStorageEncryptionScope -InputObject <IStorageIdentity> [-KeyVaultPropertyKeyUri <String>]
 [-RequireInfrastructureEncryption] [-Source <EncryptionScopeSource>] [-State <EncryptionScopeState>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IEncryptionScope
