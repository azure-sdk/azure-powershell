...
Update-AzStorageTaskAssignment -AccountName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-ParameterInterval <Int32>] [-ParameterIntervalUnit <TriggerParametersUpdateIntervalUnit>]
...
Update-AzStorageTaskAssignment -InputObject <IStorageIdentity> [-Description <String>] [-Enabled]
 [-ParameterEndBy <DateTime>] [-ParameterInterval <Int32>]
 [-ParameterIntervalUnit <TriggerParametersUpdateIntervalUnit>] [-ParameterStartFrom <DateTime>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.TriggerParametersUpdateIntervalUnit
Parameter Sets: (All)
Aliases:
