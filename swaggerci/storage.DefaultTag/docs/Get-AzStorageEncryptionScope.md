...
### List (Default)
```
Get-AzStorageEncryptionScope -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-Filter <String>] [-Include <ListEncryptionScopesInclude>] [-Maxpagesize <Int32>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzStorageEncryptionScope -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzStorageEncryptionScope -InputObject <IStorageIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
