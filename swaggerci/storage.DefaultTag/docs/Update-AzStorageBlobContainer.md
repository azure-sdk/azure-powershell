...
```
Update-AzStorageBlobContainer -AccountName <String> -BlobServicesName <String> -ContainerName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DefaultEncryptionScope <String>]
