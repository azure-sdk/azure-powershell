...
online version: https://learn.microsoft.com/powershell/module/az.storage/lock-azstorageblobcontainerimmutabilitypolicy
schema: 2.0.0
---
...
### Lock (Default)
```
Lock-AzStorageBlobContainerImmutabilityPolicy -AccountName <String> -BlobServicesName <String>
 -ContainerName <String> -ImmutabilityPolicyName <String> -ResourceGroupName <String> -IfMatch <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LockViaIdentity
```
Lock-AzStorageBlobContainerImmutabilityPolicy -InputObject <IStorageIdentity> -IfMatch <String>
