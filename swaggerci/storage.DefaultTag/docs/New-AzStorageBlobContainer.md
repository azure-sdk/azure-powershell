...
online version: https://learn.microsoft.com/powershell/module/az.storage/new-azstorageblobcontainer
schema: 2.0.0
---
...
```
New-AzStorageBlobContainer -AccountName <String> -BlobServicesName <String> -ContainerName <String>
