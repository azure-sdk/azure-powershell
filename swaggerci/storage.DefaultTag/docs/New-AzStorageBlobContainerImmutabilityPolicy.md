...
```
New-AzStorageBlobContainerImmutabilityPolicy -AccountName <String> -BlobServicesName <String>
 -ContainerName <String> -ImmutabilityPolicyName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-IfMatch <String>] [-AllowProtectedAppendWrite] [-AllowProtectedAppendWritesAll]
