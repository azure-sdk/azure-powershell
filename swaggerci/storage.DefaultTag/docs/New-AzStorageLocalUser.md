...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IPermissionScope[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ISshPublicKey[]
Parameter Sets: (All)
Aliases:
