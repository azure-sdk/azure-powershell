...
New-AzStorageTaskAssignment -AccountName <String> -Name <String> -ResourceGroupName <String>
 -Description <String> -Enabled -ReportPrefix <String> -TaskId <String> -TriggerType <TriggerType>
 [-SubscriptionId <String>] [-ParameterEndBy <DateTime>] [-ParameterInterval <Int32>]
 [-ParameterIntervalUnit <TriggerParametersIntervalUnit>] [-ParameterStartFrom <DateTime>]
 [-ParameterStartOn <DateTime>] [-TargetExcludePrefix <String[]>] [-TargetPrefix <String[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.TriggerParametersIntervalUnit
Parameter Sets: (All)
Aliases:
