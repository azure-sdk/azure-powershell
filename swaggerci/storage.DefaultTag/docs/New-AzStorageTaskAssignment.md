...
New-AzStorageTaskAssignment -AccountName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-ParameterIntervalUnit <IntervalUnit>] [-ParameterStartFrom <DateTime>] [-ParameterStartOn <DateTime>]
 [-TargetExcludePrefix <String[]>] [-TargetPrefix <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
