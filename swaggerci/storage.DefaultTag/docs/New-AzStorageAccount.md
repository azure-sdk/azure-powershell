...
New-AzStorageAccount -AccountName <String> -ResourceGroupName <String> -Kind <Kind> -Location <String>
 ...
 [-DnsEndpointType <DnsEndpointType>] [-EnableExtendedGroup] [-EnableHttpsTrafficOnly] [-EnableNfsV3]
 [-Encryption <IEncryption>] [-ExtendedLocationName <String>] [-ExtendedLocationType <ExtendedLocationTypes>]
 ...
 [-SasPolicySasExpirationPeriod <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IEncryption
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IIPRule[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IResourceAccessRule[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IVirtualNetworkRule[]
Parameter Sets: (All)
Aliases:
