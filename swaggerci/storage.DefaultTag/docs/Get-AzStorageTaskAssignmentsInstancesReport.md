...
online version: https://learn.microsoft.com/powershell/module/az.storage/get-azstoragetaskassignmentsinstancesreport
schema: 2.0.0
---

# Get-AzStorageTaskAssignmentsInstancesReport
...
```
Get-AzStorageTaskAssignmentsInstancesReport -AccountName <String> -ResourceGroupName <String>
