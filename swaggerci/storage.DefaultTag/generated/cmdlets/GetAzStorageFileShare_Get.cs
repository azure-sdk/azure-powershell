            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.FileSharesGet(SubscriptionId, ResourceGroupName, AccountName, ShareName, this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, this.InvocationInformation.BoundParameters.ContainsKey("XmsSnapshot") ? XmsSnapshot : null, onOk, onDefault, this, Pipeline);
