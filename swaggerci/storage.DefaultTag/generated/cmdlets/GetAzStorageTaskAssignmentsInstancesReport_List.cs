...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStorageTaskAssignmentsInstancesReport_List")]
    ...
    public partial class GetAzStorageTaskAssignmentsInstancesReport_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStorageTaskAssignmentsInstancesReport_List" /> cmdlet class.
        /// </summary>
        public GetAzStorageTaskAssignmentsInstancesReport_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StorageTaskAssignmentsInstancesReportList(SubscriptionId, ResourceGroupName, AccountName, this.InvocationInformation.BoundParameters.ContainsKey("Maxpagesize") ? Maxpagesize : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.StorageTaskAssignmentsInstancesReportList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
