...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] LockImmutabilityPolicy=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}/immutabilityPolicies/{ImmutabilityPolicyName}/lock"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}/immutabilityPolicies/{ImmutabilityPolicyName}/lock", ApiVersion = "2024-01-01")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BlobContainersLockImmutabilityPolicyViaIdentity(InputObject.Id, IfMatch, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BlobContainersLockImmutabilityPolicy(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ContainerName ?? null, InputObject.ImmutabilityPolicyName ?? null, IfMatch, onOk, onDefault, this, Pipeline);
                    }
