            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.BlobContainersExtendImmutabilityPolicy(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ContainerName ?? null, IfMatch, Parameter, onOk, onDefault, this, Pipeline);
                    }
