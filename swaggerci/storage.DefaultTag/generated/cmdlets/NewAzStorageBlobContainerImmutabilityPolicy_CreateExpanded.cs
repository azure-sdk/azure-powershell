...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdateImmutabilityPolicy=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/{blobServicesName}/containers/{containerName}/immutabilityPolicies/{ImmutabilityPolicyName}"
    /// </remarks>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BlobContainersCreateOrUpdateImmutabilityPolicy(SubscriptionId, ResourceGroupName, AccountName, BlobServicesName, ContainerName, ImmutabilityPolicyName, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _parametersBody, onOk, onDefault, this, Pipeline);
