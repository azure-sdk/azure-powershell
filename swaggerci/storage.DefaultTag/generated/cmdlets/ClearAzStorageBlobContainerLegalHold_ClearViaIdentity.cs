...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}/clearLegalHold", ApiVersion = "2024-01-01")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.BlobContainersClearLegalHold(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.ContainerName ?? null, LegalHold, onOk, onDefault, this, Pipeline);
                    }
