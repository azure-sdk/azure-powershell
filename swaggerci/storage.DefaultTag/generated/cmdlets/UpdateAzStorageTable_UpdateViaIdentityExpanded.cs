...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ITableSignedIdentifier[] SignedIdentifier { get => _parametersBody.SignedIdentifier ?? null /* arrayOf */; set => _parametersBody.SignedIdentifier = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.TableUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.TableName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
