...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IServiceSasParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ServiceSasParameters();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StorageAccountsListServiceSas(SubscriptionId, ResourceGroupName, AccountName, _parametersBody, onOk, onDefault, this, Pipeline);
