...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] HierarchicalNamespaceMigration=>POST:"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/hnsonmigration"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Description(@"Live Migration of storage account to enable Hns")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.HttpPath(Path = "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/hnsonmigration", ApiVersion = "2023-05-01")]
    public partial class InvokeAzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// or a hydration request 'HnsOnHydrationRequest'. The validation request will validate the migration whereas the hydration
        /// request will migrate the account.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Required. Hierarchical namespace migration type can either be a hierarchical namespace validation request 'HnsOnValidationRequest' or a hydration request 'HnsOnHydrationRequest'. The validation request will validate the migration whereas the hydration request will migrate the account.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets.InvokeAzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical Clone()
        {
            var clone = new InvokeAzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzStorageHierarchicalStorageAccountNamespaceMigration_Hierarchical()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageAccountsHierarchicalNamespaceMigration' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.StorageAccountsHierarchicalNamespaceMigration(ResourceGroupName, AccountName, SubscriptionId, RequestType, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,AccountName=AccountName,SubscriptionId=SubscriptionId,RequestType=RequestType})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, SubscriptionId=SubscriptionId, RequestType=RequestType })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, AccountName=AccountName, SubscriptionId=SubscriptionId, RequestType=RequestType })
                    {
