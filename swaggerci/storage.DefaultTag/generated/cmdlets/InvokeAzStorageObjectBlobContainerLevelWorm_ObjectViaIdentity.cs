...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ObjectLevelWorm=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/{blobServicesName}/containers/{containerName}/migrate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/{blobServicesName}/containers/{containerName}/migrate", ApiVersion = "2024-01-01")]
    public partial class InvokeAzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets.InvokeAzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity Clone()
        {
            var clone = new InvokeAzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzStorageObjectBlobContainerLevelWorm_ObjectViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BlobContainersObjectLevelWormViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BlobContainersObjectLevelWorm(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.BlobServicesName ?? null, InputObject.ContainerName ?? null, onOk, onDefault, this, Pipeline);
                    }
