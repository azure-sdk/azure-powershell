...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CheckStorageAccountNameAvailability=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Storage/checkNameAvailability"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzStorageAccountNameAvailability_CheckViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ICheckNameAvailabilityResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Description(@"Checks that the storage account name is valid and is not already in use.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Storage.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Storage/checkNameAvailability", ApiVersion = "2024-01-01")]
    public partial class TestAzStorageAccountNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountCheckNameAvailabilityParameters _accountName;

        /// <summary>The parameters used to check the availability of the storage account name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters used to check the availability of the storage account name.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The parameters used to check the availability of the storage account name.",
        SerializedName = @"accountName",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountCheckNameAvailabilityParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountCheckNameAvailabilityParameters AccountName { get => this._accountName; set => this._accountName = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ICheckNameAvailabilityResult">Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ICheckNameAvailabilityResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ICheckNameAvailabilityResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageAccountsCheckStorageAccountNameAvailability' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageAccountsCheckStorageAccountNameAvailabilityViaIdentity(InputObject.Id, AccountName, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StorageAccountsCheckStorageAccountNameAvailability(InputObject.SubscriptionId ?? null, AccountName, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=AccountName})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzStorageAccountNameAvailability_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzStorageAccountNameAvailability_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AccountName })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=AccountName })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ICheckNameAvailabilityResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ICheckNameAvailabilityResult
