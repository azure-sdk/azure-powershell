...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzStorageFileServiceUsage_GetViaIdentity" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.FileServicesGetServiceUsage(InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, InputObject.SubscriptionId ?? null, onOk, onDefault, this, Pipeline);
                    }
