...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState Accepted = @"Accepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState Failed = @"Failed";
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState ValidateSubscriptionQuotaBegin = @"ValidateSubscriptionQuotaBegin";

        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ProvisioningState ValidateSubscriptionQuotaEnd = @"ValidateSubscriptionQuotaEnd";
