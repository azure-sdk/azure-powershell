...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401
{
    ...
    public partial class SmbSetting
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ISmbSetting.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ISmbSetting.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ISmbSetting FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
        ...
        internal SmbSetting(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_multichannel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("multichannel"), out var __jsonMultichannel) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.Multichannel.FromJson(__jsonMultichannel) : Multichannel;}
            {_version = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("versions"), out var __jsonVersions) ? (string)__jsonVersions : (string)Version;}
            {_authenticationMethod = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("authenticationMethods"), out var __jsonAuthenticationMethods) ? (string)__jsonAuthenticationMethods : (string)AuthenticationMethod;}
            {_kerberosTicketEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("kerberosTicketEncryption"), out var __jsonKerberosTicketEncryption) ? (string)__jsonKerberosTicketEncryption : (string)KerberosTicketEncryption;}
            {_channelEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("channelEncryption"), out var __jsonChannelEncryption) ? (string)__jsonChannelEncryption : (string)ChannelEncryption;}
            AfterFromJson(json);
        }
