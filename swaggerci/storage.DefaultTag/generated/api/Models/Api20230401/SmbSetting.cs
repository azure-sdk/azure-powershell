...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401
{
    ...
    public partial class SmbSetting :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ISmbSettingInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IMultichannel Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ISmbSettingInternal.Multichannel { get => (this._multichannel = this._multichannel ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.Multichannel()); set { {_multichannel = value;} } }

        /// <summary>Backing field for <see cref="Multichannel" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IMultichannel _multichannel;

        /// <summary>Multichannel setting. Applies to Premium FileStorage only.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IMultichannel Multichannel { get => (this._multichannel = this._multichannel ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.Multichannel()); set => this._multichannel = value; }

        /// <summary>Indicates whether multichannel is enabled</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public bool? MultichannelEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IMultichannelInternal)Multichannel).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IMultichannelInternal)Multichannel).Enabled = value ?? default(bool); }
...

    {
        ...
        string KerberosTicketEncryption { get; set; }
        /// <summary>Multichannel setting. Applies to Premium FileStorage only.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IMultichannel Multichannel { get; set; }
        /// <summary>Indicates whether multichannel is enabled</summary>
        bool? MultichannelEnabled { get; set; }
        /// <summary>
        /// SMB protocol versions supported by server. Valid values are SMB2.1, SMB3.0, SMB3.1.1. Should be passed as a string with
