...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401
{
    ...
    public partial class LegalHoldProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ILegalHoldProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ILegalHoldPropertiesInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ILegalHoldPropertiesInternal.HasLegalHold { get => this._hasLegalHold; set { {_hasLegalHold = value;} } }

        /// <summary>Internal Acessors for ProtectedAppendWriteHistoryTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ILegalHoldPropertiesInternal.ProtectedAppendWriteHistoryTimestamp { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistoryInternal)ProtectedAppendWritesHistory).Timestamp; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistoryInternal)ProtectedAppendWritesHistory).Timestamp = value; }

        /// <summary>Internal Acessors for ProtectedAppendWritesHistory</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistory Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ILegalHoldPropertiesInternal.ProtectedAppendWritesHistory { get => (this._protectedAppendWritesHistory = this._protectedAppendWritesHistory ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ProtectedAppendWritesHistory()); set { {_protectedAppendWritesHistory = value;} } }
        ...
        public bool? ProtectedAppendWriteHistoryAllowProtectedAppendWritesAll { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistoryInternal)ProtectedAppendWritesHistory).AllowProtectedAppendWritesAll; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistoryInternal)ProtectedAppendWritesHistory).AllowProtectedAppendWritesAll = value ?? default(bool); }

        /// <summary>Returns the date and time the tag was added.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public global::System.DateTime? ProtectedAppendWriteHistoryTimestamp { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistoryInternal)ProtectedAppendWritesHistory).Timestamp; }

        /// <summary>Backing field for <see cref="ProtectedAppendWritesHistory" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistory _protectedAppendWritesHistory;

        /// <summary>Protected append blob writes history.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistory ProtectedAppendWritesHistory { get => (this._protectedAppendWritesHistory = this._protectedAppendWritesHistory ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ProtectedAppendWritesHistory()); set => this._protectedAppendWritesHistory = value; }

        /// <summary>Backing field for <see cref="Tag" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ITagProperty[] _tag;

        /// <summary>The list of LegalHold tags of a blob container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ITagProperty[] Tag { get => this._tag; set => this._tag = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ITagProperty[] Tag { get; set; }
...

    {
        ...
        /// <summary>Protected append blob writes history.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IProtectedAppendWritesHistory ProtectedAppendWritesHistory { get; set; }
        /// <summary>The list of LegalHold tags of a blob container.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.ITagProperty[] Tag { get; set; }
