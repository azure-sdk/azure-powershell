...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.FinishTime { get => this._finishTime; set { {_finishTime = value;} } }

        /// <summary>Internal Acessors for ObjectFailedCount</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.ObjectFailedCount { get => this._objectFailedCount; set { {_objectFailedCount = value;} } }

        /// <summary>Internal Acessors for ObjectsOperatedOnCount</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.ObjectsOperatedOnCount { get => this._objectsOperatedOnCount; set { {_objectsOperatedOnCount = value;} } }

        /// <summary>Internal Acessors for ObjectsSucceededCount</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.ObjectsSucceededCount { get => this._objectsSucceededCount; set { {_objectsSucceededCount = value;} } }

        /// <summary>Internal Acessors for ObjectsTargetedCount</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.ObjectsTargetedCount { get => this._objectsTargetedCount; set { {_objectsTargetedCount = value;} } }

        /// <summary>Internal Acessors for RunResult</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.RunResult? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.RunResult { get => this._runResult; set { {_runResult = value;} } }

        /// <summary>Internal Acessors for RunStatusEnum</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.RunStatusEnum? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.RunStatusEnum { get => this._runStatusEnum; set { {_runStatusEnum = value;} } }

        /// <summary>Internal Acessors for RunStatusError</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.RunStatusError { get => this._runStatusError; set { {_runStatusError = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for StorageAccountId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.StorageAccountId { get => this._storageAccountId; set { {_storageAccountId = value;} } }

        /// <summary>Internal Acessors for SummaryReportPath</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.SummaryReportPath { get => this._summaryReportPath; set { {_summaryReportPath = value;} } }

        /// <summary>Internal Acessors for TaskAssignmentId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.TaskAssignmentId { get => this._taskAssignmentId; set { {_taskAssignmentId = value;} } }

        /// <summary>Internal Acessors for TaskId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.TaskId { get => this._taskId; set { {_taskId = value;} } }

        /// <summary>Internal Acessors for TaskVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportPropertiesInternal.TaskVersion { get => this._taskVersion; set { {_taskVersion = value;} } }
