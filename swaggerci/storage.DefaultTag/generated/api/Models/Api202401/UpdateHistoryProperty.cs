...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401
{
    ...
    public partial class UpdateHistoryProperty :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal.ImmutabilityPeriodSinceCreationInDay { get => this._immutabilityPeriodSinceCreationInDay; set { {_immutabilityPeriodSinceCreationInDay = value;} } }

        /// <summary>Internal Acessors for ObjectIdentifier</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal.ObjectIdentifier { get => this._objectIdentifier; set { {_objectIdentifier = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }

        /// <summary>Internal Acessors for Timestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal.Timestamp { get => this._timestamp; set { {_timestamp = value;} } }

        /// <summary>Internal Acessors for Update</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ImmutabilityPolicyUpdateType? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal.Update { get => this._update; set { {_update = value;} } }

        /// <summary>Internal Acessors for Upn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IUpdateHistoryPropertyInternal.Upn { get => this._upn; set { {_upn = value;} } }
