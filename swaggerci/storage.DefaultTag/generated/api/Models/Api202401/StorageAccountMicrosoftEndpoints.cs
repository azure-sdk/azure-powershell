...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401
{
    ...
    public partial class StorageAccountMicrosoftEndpoints :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpoints,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal.Blob { get => this._blob; set { {_blob = value;} } }

        /// <summary>Internal Acessors for Df</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal.Df { get => this._df; set { {_df = value;} } }

        /// <summary>Internal Acessors for File</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal.File { get => this._file; set { {_file = value;} } }

        /// <summary>Internal Acessors for Queue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal.Queue { get => this._queue; set { {_queue = value;} } }

        /// <summary>Internal Acessors for Table</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal.Table { get => this._table; set { {_table = value;} } }

        /// <summary>Internal Acessors for Web</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMicrosoftEndpointsInternal.Web { get => this._web; set { {_web = value;} } }
