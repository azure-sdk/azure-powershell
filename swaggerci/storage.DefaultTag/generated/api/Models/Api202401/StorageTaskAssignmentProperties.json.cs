...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401
{
    ...
    public partial class StorageTaskAssignmentProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskAssignmentProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskAssignmentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskAssignmentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
        ...
        internal StorageTaskAssignmentProperties(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_executionContext = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("executionContext"), out var __jsonExecutionContext) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.StorageTaskAssignmentExecutionContext.FromJson(__jsonExecutionContext) : ExecutionContext;}
            {_report = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("report"), out var __jsonReport) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.StorageTaskAssignmentReport.FromJson(__jsonReport) : Report;}
            {_runStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("runStatus"), out var __jsonRunStatus) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.StorageTaskReportProperties.FromJson(__jsonRunStatus) : RunStatus;}
