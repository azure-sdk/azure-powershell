...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401
{
    ...
    public partial class ImmutableStorageAccount :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IImmutableStorageAccount,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IImmutableStorageAccountInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyProperties _immutabilityPolicy;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyProperties ImmutabilityPolicy { get => (this._immutabilityPolicy = this._immutabilityPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.AccountImmutabilityPolicyProperties()); set => this._immutabilityPolicy = value; }
        ...
        public bool? ImmutabilityPolicyAllowProtectedAppendWrite { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyPropertiesInternal)ImmutabilityPolicy).AllowProtectedAppendWrite; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyPropertiesInternal)ImmutabilityPolicy).AllowProtectedAppendWrite = value ?? default(bool); }

        /// <summary>
        /// The immutability period for the blobs in the container since the policy creation, in days.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public int? ImmutabilityPolicyImmutabilityPeriodSinceCreationInDay { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyPropertiesInternal)ImmutabilityPolicy).ImmutabilityPeriodSinceCreationInDay; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyPropertiesInternal)ImmutabilityPolicy).ImmutabilityPeriodSinceCreationInDay = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.AccountImmutabilityPolicyState? ImmutabilityPolicyState { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyPropertiesInternal)ImmutabilityPolicy).State; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyPropertiesInternal)ImmutabilityPolicy).State = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.AccountImmutabilityPolicyState)""); }

        /// <summary>Internal Acessors for ImmutabilityPolicy</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyProperties Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IImmutableStorageAccountInternal.ImmutabilityPolicy { get => (this._immutabilityPolicy = this._immutabilityPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.AccountImmutabilityPolicyProperties()); set { {_immutabilityPolicy = value;} } }
...

    {
        ...
        /// container-level immutability policy, which has a higher precedence than the account-level immutability policy.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IAccountImmutabilityPolicyProperties ImmutabilityPolicy { get; set; }
        /// <summary>
        /// This property can only be changed for disabled and unlocked time-based retention policies. When enabled, new blocks can
        /// be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and
        /// any existing blocks cannot be modified or deleted.
