...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models
{
    ...
    public partial class StorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IStorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IStorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IStorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json ? new StorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject into a new instance of <see cref="StorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal StorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="StorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders" /> into
        ...
        /// <returns>
        /// a serialized instance of <see cref="StorageAccountsAbortHierarchicalNamespaceMigrationAcceptedResponseHeaders" /> as a
