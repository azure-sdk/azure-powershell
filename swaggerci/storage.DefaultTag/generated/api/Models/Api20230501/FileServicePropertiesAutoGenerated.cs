...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501
{
    ...
    public partial class FileServicePropertiesAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IFileServicePropertiesAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IFileServicePropertiesAutoGeneratedInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ICorsRules Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IFileServicePropertiesAutoGeneratedInternal.Cor { get => (this._cor = this._cor ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.CorsRules()); set { {_cor = value;} } }

        /// <summary>Internal Acessors for ProtocolSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettings Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IFileServicePropertiesAutoGeneratedInternal.ProtocolSetting { get => (this._protocolSetting = this._protocolSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ProtocolSettings()); set { {_protocolSetting = value;} } }

        /// <summary>Internal Acessors for ProtocolSettingSmb</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISmbSetting Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IFileServicePropertiesAutoGeneratedInternal.ProtocolSettingSmb { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettingsInternal)ProtocolSetting).Smb; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettingsInternal)ProtocolSetting).Smb = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettings _protocolSetting;

        /// <summary>Protocol settings for file service</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettings ProtocolSetting { get => (this._protocolSetting = this._protocolSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ProtocolSettings()); set => this._protocolSetting = value; }

        /// <summary>Backing field for <see cref="ShareDeleteRetentionPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IDeleteRetentionPolicy _shareDeleteRetentionPolicy;

        /// <summary>The file service properties for share soft delete.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IDeleteRetentionPolicy ShareDeleteRetentionPolicy { get => (this._shareDeleteRetentionPolicy = this._shareDeleteRetentionPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.DeleteRetentionPolicy()); set => this._shareDeleteRetentionPolicy = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public string SmbVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettingsInternal)ProtocolSetting).SmbVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettingsInternal)ProtocolSetting).SmbVersion = value ?? null; }
...

    {
        ...
        bool? MultichannelEnabled { get; set; }
        /// <summary>Protocol settings for file service</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IProtocolSettings ProtocolSetting { get; set; }
        ...
        /// <summary>The file service properties for share soft delete.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IDeleteRetentionPolicy ShareDeleteRetentionPolicy { get; set; }
        /// <summary>
        /// This property when set to true allows deletion of the soft deleted blob versions and snapshots. This property cannot be
        /// used blob restore policy. This property only applies to blob service and does not apply to containers or file share.
        /// </summary>
