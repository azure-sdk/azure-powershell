...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501
{
    ...
    public partial class StorageTaskAssignmentProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json ? new StorageTaskAssignmentProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject into a new instance of <see cref="StorageTaskAssignmentProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal StorageTaskAssignmentProperties(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_executionContext = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("executionContext"), out var __jsonExecutionContext) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.StorageTaskAssignmentExecutionContext.FromJson(__jsonExecutionContext) : ExecutionContext;}
            {_report = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("report"), out var __jsonReport) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.StorageTaskAssignmentReport.FromJson(__jsonReport) : Report;}
            {_runStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject>("runStatus"), out var __jsonRunStatus) ? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.StorageTaskReportProperties.FromJson(__jsonRunStatus) : RunStatus;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="StorageTaskAssignmentProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="StorageTaskAssignmentProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" />.
        /// </returns>
