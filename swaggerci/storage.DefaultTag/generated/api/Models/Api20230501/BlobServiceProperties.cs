...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesAutoGenerated _blobServiceProperty;

        /// <summary>The properties of a storage account’s Blob service.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesAutoGenerated BlobServiceProperty { get => (this._blobServiceProperty = this._blobServiceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.BlobServicePropertiesAutoGenerated()); set => this._blobServiceProperty = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISku Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesInternal.Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.Sku()); set { {_sku = value;} } }

        /// <summary>Internal Acessors for SkuTier</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.SkuTier? Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesInternal.SkuTier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISkuInternal)Sku).Tier; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISkuInternal)Sku).Tier = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISku _sku;

        /// <summary>Sku name and tier.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISku Sku { get => (this._sku = this._sku ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.Sku()); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.SkuTier? SkuTier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISkuInternal)Sku).Tier; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api10.IResource
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesAutoGenerated) })]
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesAutoGenerated BlobServiceProperty { get; set; }
        /// <summary>
        /// The SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api10.IResourceInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobServicePropertiesAutoGenerated BlobServiceProperty { get; set; }
        /// <summary>Sku name and tier.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISku Sku { get; set; }
        /// <summary>
        /// The SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.SkuName? SkuName { get; set; }
