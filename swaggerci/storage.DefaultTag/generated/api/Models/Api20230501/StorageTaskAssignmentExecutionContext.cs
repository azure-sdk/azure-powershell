...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501
{
    ...
    public partial class StorageTaskAssignmentExecutionContext :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentExecutionContext,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentExecutionContextInternal
    {

        /// <summary>Internal Acessors for Target</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTarget Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentExecutionContextInternal.Target { get => (this._target = this._target ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ExecutionTarget()); set { {_target = value;} } }

        /// <summary>Internal Acessors for Trigger</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTrigger Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentExecutionContextInternal.Trigger { get => (this._trigger = this._trigger ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ExecutionTrigger()); set { {_trigger = value;} } }

        /// <summary>Internal Acessors for TriggerParameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ITriggerParameters Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskAssignmentExecutionContextInternal.TriggerParameter { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTriggerInternal)Trigger).Parameter; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTriggerInternal)Trigger).Parameter = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public int? ParameterInterval { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTriggerInternal)Trigger).ParameterInterval; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTriggerInternal)Trigger).ParameterInterval = value ?? default(int); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public string[] TargetPrefix { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTargetInternal)Target).Prefix; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTargetInternal)Target).Prefix = value ; }

        /// <summary>Backing field for <see cref="Trigger" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTrigger _trigger;

        /// <summary>Execution trigger of the storage task assignment</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTrigger Trigger { get => (this._trigger = this._trigger ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ExecutionTrigger()); set => this._trigger = value; }

        /// <summary>The trigger type of the storage task assignment execution</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.TriggerType TriggerType { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTriggerInternal)Trigger).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTriggerInternal)Trigger).Type = value ; }
...

    {
        ...
        string[] TargetPrefix { get; set; }
        /// <summary>Execution trigger of the storage task assignment</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IExecutionTrigger Trigger { get; set; }
