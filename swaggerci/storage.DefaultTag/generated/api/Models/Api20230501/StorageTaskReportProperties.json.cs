...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501
{
    ...
    public partial class StorageTaskReportProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskReportProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskReportProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageTaskReportProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonNode node)
        {
        ...
        internal StorageTaskReportProperties(Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonObject json)
        {
            ...
            {_taskAssignmentId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("taskAssignmentId"), out var __jsonTaskAssignmentId) ? (string)__jsonTaskAssignmentId : (string)TaskAssignmentId;}
            {_storageAccountId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("storageAccountId"), out var __jsonStorageAccountId) ? (string)__jsonStorageAccountId : (string)StorageAccountId;}
            ...
            {_finishTime = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("finishTime"), out var __jsonFinishTime) ? (string)__jsonFinishTime : (string)FinishTime;}
            {_objectsTargetedCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("objectsTargetedCount"), out var __jsonObjectsTargetedCount) ? (string)__jsonObjectsTargetedCount : (string)ObjectsTargetedCount;}
            {_objectsOperatedOnCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("objectsOperatedOnCount"), out var __jsonObjectsOperatedOnCount) ? (string)__jsonObjectsOperatedOnCount : (string)ObjectsOperatedOnCount;}
            {_objectFailedCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("objectFailedCount"), out var __jsonObjectFailedCount) ? (string)__jsonObjectFailedCount : (string)ObjectFailedCount;}
            {_objectsSucceededCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("objectsSucceededCount"), out var __jsonObjectsSucceededCount) ? (string)__jsonObjectsSucceededCount : (string)ObjectsSucceededCount;}
            {_runStatusError = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("runStatusError"), out var __jsonRunStatusError) ? (string)__jsonRunStatusError : (string)RunStatusError;}
            {_runStatusEnum = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("runStatusEnum"), out var __jsonRunStatusEnum) ? (string)__jsonRunStatusEnum : (string)RunStatusEnum;}
            {_summaryReportPath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("summaryReportPath"), out var __jsonSummaryReportPath) ? (string)__jsonSummaryReportPath : (string)SummaryReportPath;}
            {_taskId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("taskId"), out var __jsonTaskId) ? (string)__jsonTaskId : (string)TaskId;}
            {_taskVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("taskVersion"), out var __jsonTaskVersion) ? (string)__jsonTaskVersion : (string)TaskVersion;}
            {_runResult = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Json.JsonString>("runResult"), out var __jsonRunResult) ? (string)__jsonRunResult : (string)RunResult;}
            AfterFromJson(json);
        }
