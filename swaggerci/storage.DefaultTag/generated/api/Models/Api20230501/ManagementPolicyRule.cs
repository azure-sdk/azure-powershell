...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501
{
    ...
    public partial class ManagementPolicyRule :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyRuleInternal
    {

        /// <summary>Backing field for <see cref="Definition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinition _definition;

        /// <summary>An object that defines the Lifecycle rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinition Definition { get => (this._definition = this._definition ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ManagementPolicyDefinition()); set => this._definition = value; }

        /// <summary>An object that defines the action set.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyAction DefinitionAction { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinitionInternal)Definition).Action; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinitionInternal)Definition).Action = value ; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyFilter Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyRuleInternal.DefinitionFilter { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinitionInternal)Definition).Filter; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinitionInternal)Definition).Filter = value; }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyRuleInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyAction DefinitionAction { get; set; }
        /// <summary>Rule is enabled if set to true.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>An object that defines the Lifecycle rule.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyDefinition Definition { get; set; }
        /// <summary>An object that defines the action set.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyAction DefinitionAction { get; set; }
        /// <summary>An object that defines the filter set.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyFilter DefinitionFilter { get; set; }
        /// <summary>Rule is enabled if set to true.</summary>
        bool? Enabled { get; set; }
        /// <summary>An array of blob index tag based filters, there can be at most 10 tag filters</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ITagFilter[] FilterBlobIndexMatch { get; set; }
