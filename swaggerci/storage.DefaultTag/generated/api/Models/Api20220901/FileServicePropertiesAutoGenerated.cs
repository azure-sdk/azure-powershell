...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901
{
    ...
    public partial class FileServicePropertiesAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServicePropertiesAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServicePropertiesAutoGeneratedInternal
    {

        /// <summary>Backing field for <see cref="Cor" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRules _cor;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRules Cor { get => (this._cor = this._cor ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.CorsRules()); set => this._cor = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRules Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServicePropertiesAutoGeneratedInternal.Cor { get => (this._cor = this._cor ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.CorsRules()); set { {_cor = value;} } }

        /// <summary>Internal Acessors for ProtocolSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettings Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServicePropertiesAutoGeneratedInternal.ProtocolSetting { get => (this._protocolSetting = this._protocolSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ProtocolSettings()); set { {_protocolSetting = value;} } }

        /// <summary>Internal Acessors for ProtocolSettingSmb</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ISmbSetting Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServicePropertiesAutoGeneratedInternal.ProtocolSettingSmb { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettingsInternal)ProtocolSetting).Smb; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettingsInternal)ProtocolSetting).Smb = value; }

        /// <summary>Internal Acessors for ShareDeleteRetentionPolicy</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IDeleteRetentionPolicy Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IFileServicePropertiesAutoGeneratedInternal.ShareDeleteRetentionPolicy { get => (this._shareDeleteRetentionPolicy = this._shareDeleteRetentionPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.DeleteRetentionPolicy()); set { {_shareDeleteRetentionPolicy = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettings _protocolSetting;

        /// <summary>Protocol settings for file service</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettings ProtocolSetting { get => (this._protocolSetting = this._protocolSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ProtocolSettings()); set => this._protocolSetting = value; }

        /// <summary>Backing field for <see cref="ShareDeleteRetentionPolicy" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IDeleteRetentionPolicy _shareDeleteRetentionPolicy;

        /// <summary>The file service properties for share soft delete.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IDeleteRetentionPolicy ShareDeleteRetentionPolicy { get => (this._shareDeleteRetentionPolicy = this._shareDeleteRetentionPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.DeleteRetentionPolicy()); set => this._shareDeleteRetentionPolicy = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Inlined)]
        public string SmbVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettingsInternal)ProtocolSetting).SmbVersion; set => ((Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettingsInternal)ProtocolSetting).SmbVersion = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRule) })]
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRule[] CorCorsRule { get; set; }
        /// <summary>Indicates whether multichannel is enabled</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Required = false,
        ReadOnly = false,
        Description = @"Indicates the number of days that the deleted item should be retained. The minimum specified value can be 1 and the maximum value can be 365. 0 will be returned when policy is disabled.",
        SerializedName = @"days",
...

    {
        ...
        /// elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the File service.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRules Cor { get; set; }
        /// <summary>
        /// The List of CORS rules. You can include up to five CorsRule elements in the request.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ICorsRule[] CorCorsRule { get; set; }
        ...
        bool? MultichannelEnabled { get; set; }
        /// <summary>Protocol settings for file service</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IProtocolSettings ProtocolSetting { get; set; }
        /// <summary>Setting for SMB protocol</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ISmbSetting ProtocolSettingSmb { get; set; }
        /// <summary>The file service properties for share soft delete.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IDeleteRetentionPolicy ShareDeleteRetentionPolicy { get; set; }
        /// <summary>
        /// This property when set to true allows deletion of the soft deleted blob versions and snapshots. This property cannot be
        /// used blob restore policy. This property only applies to blob service and does not apply to containers or file share.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IMultichannel SmbMultichannel { get; set; }
        /// <summary>
        /// SMB protocol versions supported by server. Valid values are SMB2.1, SMB3.0, SMB3.1.1. Should be passed as a string with
        /// delimiter ';'.
        /// </summary>
