...
namespace Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901
{
    ...
    public partial class ManagementPolicyRule :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyRuleInternal
    {

        /// <summary>Backing field for <see cref="Definition" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyDefinition _definition;

        /// <summary>An object that defines the Lifecycle rule.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Origin(Microsoft.Azure.PowerShell.Cmdlets.Storage.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyDefinition Definition { get => (this._definition = this._definition ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ManagementPolicyDefinition()); set => this._definition = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyDefinition Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyRuleInternal.Definition { get => (this._definition = this._definition ?? new Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ManagementPolicyDefinition()); set { {_definition = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyRuleInternal.Type { get => this._type; set { {_type = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyAction DefinitionAction { get; set; }
        /// <summary>Rule is enabled if set to true.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(
        Required = false,
        ReadOnly = false,
    ...
    {
        /// <summary>An object that defines the Lifecycle rule.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyDefinition Definition { get; set; }
        /// <summary>An object that defines the action set.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyAction DefinitionAction { get; set; }
        /// <summary>An object that defines the filter set.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IManagementPolicyFilter DefinitionFilter { get; set; }
        /// <summary>Rule is enabled if set to true.</summary>
        bool? Enabled { get; set; }
        /// <summary>An array of blob index tag based filters, there can be at most 10 tag filters</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ITagFilter[] FilterBlobIndexMatch { get; set; }
