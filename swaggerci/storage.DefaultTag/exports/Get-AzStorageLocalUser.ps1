...
param(
    ...
    [Parameter(ParameterSetName='List')]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ListLocalUserIncludeParam])]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Query')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.ListLocalUserIncludeParam]
