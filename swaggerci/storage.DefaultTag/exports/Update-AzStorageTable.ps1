...
SIGNEDIDENTIFIER <ITableSignedIdentifier[]>: List of stored access policies specified on the table.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.ITable])]
