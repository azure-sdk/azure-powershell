...
ENCRYPTIONSCOPE <IEncryptionScope>: The Encryption Scope resource.
  ...
  [Source <EncryptionScopeSource?>]: The provider for the encryption scope. Possible values (case-insensitive):  Microsoft.Storage, Microsoft.KeyVault.
  [State <EncryptionScopeState?>]: The state of the encryption scope. Possible values (case-insensitive):  Enabled, Disabled.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IEncryptionScope])]
