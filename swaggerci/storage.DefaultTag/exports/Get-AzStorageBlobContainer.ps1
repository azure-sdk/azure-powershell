...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IBlobContainer], [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IListContainerItem])]
