...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IQueueServiceProperties
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstoragequeueserviceproperty
#>
function Get-AzStorageQueueServiceProperty {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IQueueServiceProperties])]
