...
FILESHAREPROPERTY <IFileShareProperties>: Properties of the file share.
  [AccessTier <ShareAccessTier?>]: Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium.
  [EnabledProtocol <EnabledProtocols?>]: The authentication protocol that is used for the file share. Can only be specified when creating a share.
  [FileSharePaidBurstingEnabled <Boolean?>]: Indicates whether paid bursting is enabled for the share. This property is only for file shares created under Files Provisioned v1 SSD account type.
  [FileSharePaidBurstingMaxBandwidthMibp <Int32?>]: The maximum paid bursting bandwidth for the share, in mebibytes per second. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 10340 which is the maximum allowed bandwidth for a share.
  [FileSharePaidBurstingMaxIop <Int32?>]: The maximum paid bursting IOPS for the share. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 102400 which is the maximum allowed IOPS for a share.
  [Metadata <IFileSharePropertiesMetadata>]: A name-value pair to associate with the share as metadata.
    [(Any) <String>]: This indicates any property can be added to this object.
  [ProvisionedBandwidthMibp <Int32?>]: The provisioned bandwidth of the share, in mebibytes per second. This property is only for file shares created under Files Provisioned v2 account type. Please refer to the GetFileServiceUsage API response for the minimum and maximum allowed value for provisioned bandwidth.
  [ProvisionedIop <Int32?>]: The provisioned IOPS of the share. This property is only for file shares created under Files Provisioned v2 account type. Please refer to the GetFileServiceUsage API response for the minimum and maximum allowed value for provisioned IOPS.
  [RootSquash <RootSquashType?>]: The property is for NFS share only. The default is NoRootSquash.
  [ShareQuota <Int32?>]: The provisioned size of the share, in gibibytes. Must be greater than 0, and less than or equal to 5TB (5120). For Large File Shares, the maximum size is 102400. For file shares created under Files Provisioned v2 account type, please refer to the GetFileServiceUsage API response for the minimum and maximum allowed provisioned storage size.
  [SignedIdentifier <ISignedIdentifier[]>]: List of stored access policies specified on the share.
...
.Link
https://learn.microsoft.com/powershell/module/az.storage/update-azstoragefileshare
#>
function Update-AzStorageFileShare {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IFileShare])]
