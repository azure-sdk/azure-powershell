...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202301.ILocalUserKeys
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstoragelocaluserkey
#>
function Get-AzStorageLocalUserKey {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202301.ILocalUserKeys])]
