...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ITableServiceProperties
.Notes
...
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstoragetableserviceproperty
#>
function Get-AzStorageTableServiceProperty {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ITableServiceProperties])]
