...
PERMISSIONSCOPE <IPermissionScope[]>: The permission scopes of the local user.
  ...
  Service <PermissionScopeServiceName>: The service used by the local user, e.g. blob, file.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ILocalUser])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IPermissionScope[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.ISshPublicKey[]]
