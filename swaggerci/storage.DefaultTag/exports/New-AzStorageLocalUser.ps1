...
PERMISSIONSCOPE <IPermissionScope[]>: The permission scopes of the local user.
  Permission <String>: The permissions for the local user. Possible values include: Read (r), Write (w), Delete (d), List (l), Create (c), Modify Ownership (o), and Modify Permissions (p).
...
.Link
https://learn.microsoft.com/powershell/module/az.storage/new-azstoragelocaluser
#>
function New-AzStorageLocalUser {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ILocalUser])]
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IPermissionScope[]]
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.ISshPublicKey[]]
