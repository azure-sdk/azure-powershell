...
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstorageaccountcustomerinitiatedmigration
#>
function Get-AzStorageAccountCustomerInitiatedMigration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountMigration])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Storage.private\Get-AzStorageAccountCustomerInitiatedMigration_Get';
            GetViaIdentity = 'Az.Storage.private\Get-AzStorageAccountCustomerInitiatedMigration_GetViaIdentity';
        }
