...
.Link
https://learn.microsoft.com/powershell/module/az.storage/restore-azstorageaccountblobrange
#>
function Restore-AzStorageAccountBlobRange {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IBlobRestoreStatus])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IBlobRestoreRange[]]
