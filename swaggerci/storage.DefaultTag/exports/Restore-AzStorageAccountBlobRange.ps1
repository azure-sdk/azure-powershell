...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IBlobRestoreStatus])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IBlobRestoreRange[]]
