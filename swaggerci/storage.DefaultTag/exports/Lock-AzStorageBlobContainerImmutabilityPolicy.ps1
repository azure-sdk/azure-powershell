...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IImmutabilityPolicy
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IImmutabilityPolicy])]
