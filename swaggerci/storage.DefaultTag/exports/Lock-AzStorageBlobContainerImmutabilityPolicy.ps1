...
.Link
https://learn.microsoft.com/powershell/module/az.storage/lock-azstorageblobcontainerimmutabilitypolicy
#>
function Lock-AzStorageBlobContainerImmutabilityPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IImmutabilityPolicy])]
