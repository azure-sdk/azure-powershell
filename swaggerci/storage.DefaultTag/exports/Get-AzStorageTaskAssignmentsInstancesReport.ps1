...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportInstance
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstoragetaskassignmentsinstancesreport
#>
function Get-AzStorageTaskAssignmentsInstancesReport {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageTaskReportInstance])]
