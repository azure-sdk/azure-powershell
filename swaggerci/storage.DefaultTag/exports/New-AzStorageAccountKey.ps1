...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202301.IStorageAccountRegenerateKeyParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202301.IStorageAccountKey])]
