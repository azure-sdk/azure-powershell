...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IStorageAccountRegenerateKeyParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IStorageAccountKey])]
