...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IStorageAccountRegenerateKeyParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IStorageAccountKey])]
