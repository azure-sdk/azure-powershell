...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageQueue], [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IListQueue])]
