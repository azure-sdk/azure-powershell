...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202301.IBlobServiceProperties
.Link
https://learn.microsoft.com/powershell/module/az.storage/get-azstorageblobservice
#>
function Get-AzStorageBlobService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202301.IBlobServiceProperties])]
