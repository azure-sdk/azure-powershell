...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageAccountKey])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Enum71])]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Query')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Support.Enum71]
