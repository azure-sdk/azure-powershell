...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IStorageQueue])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20220901.IQueuePropertiesMetadata]))]
