...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IStorageQueue])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IQueuePropertiesMetadata]))]
