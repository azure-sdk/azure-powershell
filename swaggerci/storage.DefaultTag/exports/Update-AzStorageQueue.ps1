...
.Link
https://learn.microsoft.com/powershell/module/az.storage/update-azstoragequeue
#>
function Update-AzStorageQueue {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IStorageQueue])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IQueuePropertiesMetadata]))]
