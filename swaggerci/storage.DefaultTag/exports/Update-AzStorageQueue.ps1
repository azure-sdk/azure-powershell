...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IStorageQueue])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IQueuePropertiesMetadata]))]
