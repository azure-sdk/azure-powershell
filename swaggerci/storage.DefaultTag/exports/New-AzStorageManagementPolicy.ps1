...
POLICYRULE <IManagementPolicyRule[]>: The Storage Account ManagementPolicies Rules. See more details in: https://learn.microsoft.com/azure/storage/blobs/lifecycle-management-overview.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api202401.IManagementPolicy])]
...
param(
    ...
    # See more details in: https://learn.microsoft.com/azure/storage/blobs/lifecycle-management-overview.
