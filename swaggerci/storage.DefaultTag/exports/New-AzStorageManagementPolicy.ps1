...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IManagementPolicy])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IManagementPolicyRule[]]
