...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicy])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230501.IManagementPolicyRule[]]
