...
NETWORKRULESETIPRULE <IIPRule[]>: Sets the IP ACL rules
  ...
  [Action <IPRuleAction?>]: The action of IP ACL rule.
...
NETWORKRULESETVIRTUALNETWORKRULE <IVirtualNetworkRule[]>: Sets the virtual network rules
  ...
  [Action <VirtualNetworkRuleAction?>]: The action of virtual network rule.
.Link
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Storage.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api30.IIdentityUserAssignedIdentities]))]
