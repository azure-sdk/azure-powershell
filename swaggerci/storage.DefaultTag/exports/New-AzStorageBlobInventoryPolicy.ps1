...
POLICYRULE <IBlobInventoryPolicyRule[]>: The storage account blob inventory policy rules. The rule is applied when it is enabled.
  ...
  [CreationTimeLastNDay <Int32?>]: When set the policy filters the objects that are created in the last N days. Where N is an integer value between 1 to 36500.
...
.Link
https://learn.microsoft.com/powershell/module/az.storage/new-azstorageblobinventorypolicy
#>
function New-AzStorageBlobInventoryPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20230401.IBlobInventoryPolicy])]
