...
namespace Microsoft.Azure.PowerShell.Cmdlets.OnlineExperimentationService.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.OnlineExperimentationService.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.OnlineExperimentationService.Support";
