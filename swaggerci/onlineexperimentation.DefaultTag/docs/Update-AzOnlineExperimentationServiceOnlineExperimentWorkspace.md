...
online version: https://learn.microsoft.com/powershell/module/az.onlineexperimentationservice/update-azonlineexperimentationserviceonlineexperimentworkspace
schema: 2.0.0
---

# Update-AzOnlineExperimentationServiceOnlineExperimentWorkspace
...
```
Update-AzOnlineExperimentationServiceOnlineExperimentWorkspace -ResourceGroupName <String>
 -WorkspaceName <String> [-SubscriptionId <String>] [-CustomerManagedKeyEncryptionKeyUrl <String>]
 [-IdentityType <ManagedServiceIdentityType>] [-IdentityUserAssignedIdentity <Hashtable>]
 [-KeyEncryptionKeyIdentityDelegatedIdentityClientId <String>]
...
```
Update-AzOnlineExperimentationServiceOnlineExperimentWorkspace
 -InputObject <IOnlineExperimentationServiceIdentity> [-CustomerManagedKeyEncryptionKeyUrl <String>]
 [-IdentityType <ManagedServiceIdentityType>] [-IdentityUserAssignedIdentity <Hashtable>]
 [-KeyEncryptionKeyIdentityDelegatedIdentityClientId <String>]
 [-KeyEncryptionKeyIdentityFederatedClientId <String>]
 [-KeyEncryptionKeyIdentityType <KeyEncryptionKeyIdentityType>]
