...
online version: https://learn.microsoft.com/powershell/module/az.onlineexperimentationservice/remove-azonlineexperimentationserviceonlineexperimentworkspace
schema: 2.0.0
---

# Remove-AzOnlineExperimentationServiceOnlineExperimentWorkspace
...
### Delete (Default)
```
Remove-AzOnlineExperimentationServiceOnlineExperimentWorkspace -ResourceGroupName <String>
...
```
Remove-AzOnlineExperimentationServiceOnlineExperimentWorkspace
 -InputObject <IOnlineExperimentationServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
