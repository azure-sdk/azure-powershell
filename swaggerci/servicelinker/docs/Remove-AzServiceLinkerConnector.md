...
online version: https://docs.microsoft.com/en-us/powershell/module/az.servicelinker/remove-azservicelinkerconnector
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzServiceLinkerConnector -Location <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzServiceLinkerConnector -InputObject <IServiceLinkerIdentity> [-DefaultProfile <PSObject>] [-AsJob]
