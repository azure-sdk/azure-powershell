...
online version: https://docs.microsoft.com/en-us/powershell/module/az.servicelinker/update-azservicelinkerconnectordryrun
schema: 2.0.0
---

# Update-AzServiceLinkerConnectorDryrun
...
```
Update-AzServiceLinkerConnectorDryrun -DryrunName <String> -Location <String> -ResourceGroupName <String>
...
```
Update-AzServiceLinkerConnectorDryrun -InputObject <IServiceLinkerIdentity> [-DefaultProfile <PSObject>]
