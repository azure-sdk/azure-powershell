...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus DownloadCompleted = @"DownloadCompleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus DownloadPending = @"DownloadPending";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus DownloadStarted = @"DownloadStarted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus InstallCompleted = @"InstallCompleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus InstallStarted = @"InstallStarted";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus e1, Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UpdateStatus e2)
        {
            return !e2.Equals(e1);
        }
