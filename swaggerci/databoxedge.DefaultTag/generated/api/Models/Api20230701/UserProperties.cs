...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701
{
    ...
    public partial class UserProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IUserProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IUserPropertiesInternal
    {

        /// <summary>Backing field for <see cref="EncryptedPassword" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecret _encryptedPassword;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecret EncryptedPassword { get => (this._encryptedPassword = this._encryptedPassword ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.AsymmetricEncryptedSecret()); set => this._encryptedPassword = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.EncryptionAlgorithm? EncryptedPasswordEncryptionAlgorithm { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecretInternal)EncryptedPassword).EncryptionAlgorithm; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecretInternal)EncryptedPassword).EncryptionAlgorithm = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.EncryptionAlgorithm)""); }

        /// <summary>
        /// Thumbprint certificate used to encrypt \"Value\". If the value is unencrypted, it will be null.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string EncryptedPasswordEncryptionCertThumbprint { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecretInternal)EncryptedPassword).EncryptionCertThumbprint; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecretInternal)EncryptedPassword).EncryptionCertThumbprint = value ?? null; }

        /// <summary>The value of the secret.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string EncryptedPasswordValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecretInternal)EncryptedPassword).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecretInternal)EncryptedPassword).Value = value ?? null; }

        /// <summary>Internal Acessors for EncryptedPassword</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecret Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IUserPropertiesInternal.EncryptedPassword { get => (this._encryptedPassword = this._encryptedPassword ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.AsymmetricEncryptedSecret()); set { {_encryptedPassword = value;} } }

        /// <summary>Internal Acessors for ShareAccessRights</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IShareAccessRight[] Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IUserPropertiesInternal.ShareAccessRights { get => this._shareAccessRights; set { {_shareAccessRights = value;} } }

        /// <summary>Backing field for <see cref="ShareAccessRights" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IShareAccessRight[] _shareAccessRights;

        /// <summary>
        /// List of shares that the user has rights on. This field should not be specified during user creation.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IShareAccessRight[] ShareAccessRights { get => this._shareAccessRights; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IShareAccessRight) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IShareAccessRight[] ShareAccessRights { get;  }
        /// <summary>Type of the user.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Info(
        Required = true,
        ReadOnly = false,
    ...
    {
        /// <summary>The password details.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IAsymmetricEncryptedSecret EncryptedPassword { get; set; }
        /// <summary>The algorithm used to encrypt "Value".</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.EncryptionAlgorithm? EncryptedPasswordEncryptionAlgorithm { get; set; }
        /// <summary>
        /// Thumbprint certificate used to encrypt \"Value\". If the value is unencrypted, it will be null.
        ...
        /// List of shares that the user has rights on. This field should not be specified during user creation.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IShareAccessRight[] ShareAccessRights { get; set; }
        /// <summary>Type of the user.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.UserType UserType { get; set; }
