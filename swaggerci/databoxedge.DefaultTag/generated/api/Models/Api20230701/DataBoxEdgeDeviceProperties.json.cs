...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701
{
    ...
    public partial class DataBoxEdgeDeviceProperties
    {
        ...
        internal DataBoxEdgeDeviceProperties(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceMoveDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonObject>("resourceMoveDetails"), out var __jsonResourceMoveDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.ResourceMoveDetails.FromJson(__jsonResourceMoveDetails) : ResourceMoveDetail;}
            {_edgeProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonObject>("edgeProfile"), out var __jsonEdgeProfile) ? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.EdgeProfile.FromJson(__jsonEdgeProfile) : EdgeProfile;}
            {_dataResidency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonObject>("dataResidency"), out var __jsonDataResidency) ? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.DataResidency.FromJson(__jsonDataResidency) : DataResidency;}
            ...
            {_kubernetesWorkloadProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonString>("kubernetesWorkloadProfile"), out var __jsonKubernetesWorkloadProfile) ? (string)__jsonKubernetesWorkloadProfile : (string)KubernetesWorkloadProfile;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IDataBoxEdgeDeviceProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IDataBoxEdgeDeviceProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IDataBoxEdgeDeviceProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._kubernetesWorkloadProfile)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Json.JsonString(this._kubernetesWorkloadProfile.ToString()) : null, "kubernetesWorkloadProfile" ,container.Add );
            }
