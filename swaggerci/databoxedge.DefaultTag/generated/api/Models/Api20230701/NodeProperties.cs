...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701
{
    ...
    public partial class NodeProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodeProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal
    {

        /// <summary>Internal Acessors for NodeChassisSerialNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeChassisSerialNumber { get => this._nodeChassisSerialNumber; set { {_nodeChassisSerialNumber = value;} } }

        /// <summary>Internal Acessors for NodeDisplayName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeDisplayName { get => this._nodeDisplayName; set { {_nodeDisplayName = value;} } }

        /// <summary>Internal Acessors for NodeFriendlySoftwareVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeFriendlySoftwareVersion { get => this._nodeFriendlySoftwareVersion; set { {_nodeFriendlySoftwareVersion = value;} } }

        /// <summary>Internal Acessors for NodeHcsVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeHcsVersion { get => this._nodeHcsVersion; set { {_nodeHcsVersion = value;} } }

        /// <summary>Internal Acessors for NodeInstanceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeInstanceId { get => this._nodeInstanceId; set { {_nodeInstanceId = value;} } }

        /// <summary>Internal Acessors for NodeSerialNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeSerialNumber { get => this._nodeSerialNumber; set { {_nodeSerialNumber = value;} } }

        /// <summary>Internal Acessors for NodeStatus</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.NodeStatus? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.INodePropertiesInternal.NodeStatus { get => this._nodeStatus; set { {_nodeStatus = value;} } }
