...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class MetricConfiguration :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMetricConfigurationInternal
    {

        /// <summary>Backing field for <see cref="CounterSet" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMetricCounterSet[] _counterSet;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMetricCounterSet[] CounterSet { get => this._counterSet; set => this._counterSet = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMetricCounterSet) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMetricCounterSet[] CounterSet { get; set; }
        /// <summary>The MDM account to which the counters should be pushed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Info(
        Required = false,
        ReadOnly = false,
