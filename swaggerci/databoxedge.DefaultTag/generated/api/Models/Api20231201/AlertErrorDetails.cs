...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class AlertErrorDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAlertErrorDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAlertErrorDetailsInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAlertErrorDetailsInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAlertErrorDetailsInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }

        /// <summary>Internal Acessors for Occurrence</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAlertErrorDetailsInternal.Occurrence { get => this._occurrence; set { {_occurrence = value;} } }
