...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class KubernetesRoleStorage :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IKubernetesRoleStorage,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IKubernetesRoleStorageInternal
    {

        /// <summary>Backing field for <see cref="Endpoint" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMountPointMap[] _endpoint;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMountPointMap[] Endpoint { get => this._endpoint; set => this._endpoint = value; }

        /// <summary>Internal Acessors for StorageClass</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IKubernetesRoleStorageClassInfo[] Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IKubernetesRoleStorageInternal.StorageClass { get => this._storageClass; set { {_storageClass = value;} } }

        /// <summary>Backing field for <see cref="StorageClass" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IKubernetesRoleStorageClassInfo[] _storageClass;

        /// <summary>Kubernetes storage class info.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IKubernetesRoleStorageClassInfo[] StorageClass { get => this._storageClass; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMountPointMap[] Endpoint { get; set; }
        /// <summary>Kubernetes storage class info.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Info(
        Required = false,
        ReadOnly = true,
