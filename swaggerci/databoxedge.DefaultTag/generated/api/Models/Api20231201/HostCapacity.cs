...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class HostCapacity :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IHostCapacity,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IHostCapacityInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.INumaNodeData[] _numaNodesData;

        /// <summary>The numa nodes information for Hpn VMs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.INumaNodeData[] NumaNodesData { get => this._numaNodesData; set => this._numaNodesData = value; }

        /// <summary>Backing field for <see cref="VMUsedMemory" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IHostCapacityVMUsedMemory _vMUsedMemory;

        /// <summary>The VM used memory per VmId.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IHostCapacityVMUsedMemory VMUsedMemory { get => (this._vMUsedMemory = this._vMUsedMemory ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.HostCapacityVMUsedMemory()); set => this._vMUsedMemory = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.INumaNodeData) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.INumaNodeData[] NumaNodesData { get; set; }
        /// <summary>The VM used memory per VmId.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IHostCapacityVMUsedMemory) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IHostCapacityVMUsedMemory VMUsedMemory { get; set; }
