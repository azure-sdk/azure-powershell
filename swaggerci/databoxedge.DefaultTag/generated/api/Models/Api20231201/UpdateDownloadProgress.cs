...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class UpdateDownloadProgress :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgress,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.DownloadPhase? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal.DownloadPhase { get => this._downloadPhase; set { {_downloadPhase = value;} } }

        /// <summary>Internal Acessors for NumberOfUpdatesDownloaded</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal.NumberOfUpdatesDownloaded { get => this._numberOfUpdatesDownloaded; set { {_numberOfUpdatesDownloaded = value;} } }

        /// <summary>Internal Acessors for NumberOfUpdatesToDownload</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal.NumberOfUpdatesToDownload { get => this._numberOfUpdatesToDownload; set { {_numberOfUpdatesToDownload = value;} } }

        /// <summary>Internal Acessors for PercentComplete</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal.PercentComplete { get => this._percentComplete; set { {_percentComplete = value;} } }

        /// <summary>Internal Acessors for TotalBytesDownloaded</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal.TotalBytesDownloaded { get => this._totalBytesDownloaded; set { {_totalBytesDownloaded = value;} } }

        /// <summary>Internal Acessors for TotalBytesToDownload</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IUpdateDownloadProgressInternal.TotalBytesToDownload { get => this._totalBytesToDownload; set { {_totalBytesToDownload = value;} } }
