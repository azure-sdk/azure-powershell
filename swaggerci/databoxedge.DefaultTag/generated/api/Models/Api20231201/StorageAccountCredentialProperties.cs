...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class StorageAccountCredentialProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IStorageAccountCredentialProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IStorageAccountCredentialPropertiesInternal
    {

        /// <summary>Backing field for <see cref="AccountKey" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecret _accountKey;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecret AccountKey { get => (this._accountKey = this._accountKey ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.AsymmetricEncryptedSecret()); set => this._accountKey = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.EncryptionAlgorithm? AccountKeyEncryptionAlgorithm { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)AccountKey).EncryptionAlgorithm; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)AccountKey).EncryptionAlgorithm = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.EncryptionAlgorithm)""); }

        /// <summary>
        /// Thumbprint certificate used to encrypt \"Value\". If the value is unencrypted, it will be null.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string AccountKeyEncryptionCertThumbprint { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)AccountKey).EncryptionCertThumbprint; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)AccountKey).EncryptionCertThumbprint = value ?? null; }

        /// <summary>The value of the secret.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string AccountKeyValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)AccountKey).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)AccountKey).Value = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecret Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IStorageAccountCredentialPropertiesInternal.AccountKey { get => (this._accountKey = this._accountKey ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.AsymmetricEncryptedSecret()); set { {_accountKey = value;} } }
