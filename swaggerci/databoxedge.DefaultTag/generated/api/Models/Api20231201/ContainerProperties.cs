...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class ContainerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IContainerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IContainerPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.ContainerStatus? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IContainerPropertiesInternal.ContainerStatus { get => this._containerStatus; set { {_containerStatus = value;} } }

        /// <summary>Internal Acessors for CreatedDateTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IContainerPropertiesInternal.CreatedDateTime { get => this._createdDateTime; set { {_createdDateTime = value;} } }

        /// <summary>Internal Acessors for RefreshDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetails Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IContainerPropertiesInternal.RefreshDetail { get => (this._refreshDetail = this._refreshDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.RefreshDetails()); set { {_refreshDetail = value;} } }

        /// <summary>Backing field for <see cref="RefreshDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetails _refreshDetail;

        /// <summary>Details of the refresh job on this container.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetails RefreshDetail { get => (this._refreshDetail = this._refreshDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.RefreshDetails()); }
        ...
        public string RefreshDetailErrorManifestFile { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetailsInternal)RefreshDetail).ErrorManifestFile; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetailsInternal)RefreshDetail).ErrorManifestFile = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string RefreshDetailLastJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetailsInternal)RefreshDetail).LastJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetailsInternal)RefreshDetail).LastJob = value ?? null; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.AzureContainerDataFormat DataFormat { get; set; }
        /// <summary>Details of the refresh job on this container.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IRefreshDetails RefreshDetail { get; set; }
        /// <summary>
        /// Indicates the relative path of the error xml for the last refresh job on this particular share or container, if any. This
        /// could be a failed job or a successful job.
        /// </summary>
