...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201
{
    ...
    public partial class SecuritySettingsProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.ISecuritySettingsProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.ISecuritySettingsPropertiesInternal
    {

        /// <summary>Backing field for <see cref="DeviceAdminPassword" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecret _deviceAdminPassword;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Support.EncryptionAlgorithm DeviceAdminPasswordEncryptionAlgorithm { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)DeviceAdminPassword).EncryptionAlgorithm; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)DeviceAdminPassword).EncryptionAlgorithm = value ; }

        /// <summary>
        /// Thumbprint certificate used to encrypt \"Value\". If the value is unencrypted, it will be null.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string DeviceAdminPasswordEncryptionCertThumbprint { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)DeviceAdminPassword).EncryptionCertThumbprint; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)DeviceAdminPassword).EncryptionCertThumbprint = value ?? null; }

        /// <summary>The value of the secret.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.PropertyOrigin.Inlined)]
        public string DeviceAdminPasswordValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)DeviceAdminPassword).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecretInternal)DeviceAdminPassword).Value = value ; }

        /// <summary>Internal Acessors for DeviceAdminPassword</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IAsymmetricEncryptedSecret Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.ISecuritySettingsPropertiesInternal.DeviceAdminPassword { get => (this._deviceAdminPassword = this._deviceAdminPassword ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.AsymmetricEncryptedSecret()); set { {_deviceAdminPassword = value;} } }
