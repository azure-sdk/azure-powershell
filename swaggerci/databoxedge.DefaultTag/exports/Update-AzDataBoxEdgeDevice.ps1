...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IDataBoxEdgeDevicePatchTags]))]
