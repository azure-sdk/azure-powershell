...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMonitoringMetricConfiguration])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20231201.IMetricConfiguration[]]
