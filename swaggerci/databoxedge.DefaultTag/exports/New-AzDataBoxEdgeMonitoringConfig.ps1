...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IMonitoringMetricConfiguration])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.Api20230701.IMetricConfiguration[]]
