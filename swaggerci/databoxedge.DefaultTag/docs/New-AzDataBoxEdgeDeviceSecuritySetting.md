...
online version: https://learn.microsoft.com/powershell/module/az.databoxedge/new-azdataboxedgedevicesecuritysetting
schema: 2.0.0
---
...
```
New-AzDataBoxEdgeDeviceSecuritySetting -DeviceName <String> -ResourceGroupName <String>
