...
New-AzAppConfigurationStore -ConfigStoreName <String> -ResourceGroupName <String> -Location <String>
 ...
 [-PublicNetworkAccess <PublicNetworkAccess>] [-SasAuth <SasAuth>] [-SoftDeleteRetentionInDay <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.SasAuth
Parameter Sets: (All)
Aliases:
