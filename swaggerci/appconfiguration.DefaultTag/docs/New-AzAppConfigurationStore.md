...
New-AzAppConfigurationStore -ConfigStoreName <String> -ResourceGroupName <String> -Location <String>
 ...
 [-PublicNetworkAccess <PublicNetworkAccess>] [-Replica <IReplicaInfo[]>] [-SoftDeleteRetentionInDay <Int32>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IReplicaInfo[]
Parameter Sets: (All)
Aliases:
