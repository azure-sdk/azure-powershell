...
New-AzAppConfigurationStoreSasToken -ConfigStoreName <String> -ResourceGroupName <String> -Expire <DateTime>
 -Kind <SasTokenKind> [-SubscriptionId <String>] [-CacheControlMaxAge <Single>]
 [-ResourceParameterResourceType <ResourceType>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-AzAppConfigurationStoreSasToken -InputObject <IAppConfigurationIdentity> -Expire <DateTime>
 -Kind <SasTokenKind> [-CacheControlMaxAge <Single>] [-ResourceParameterResourceType <ResourceType>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
