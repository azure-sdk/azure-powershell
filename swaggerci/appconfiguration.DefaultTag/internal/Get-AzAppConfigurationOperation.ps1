...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IOperationDefinition
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IOperationDefinition])]
