...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IOperationDefinition
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IOperationDefinition])]
