    ...
    public partial class AppConfigurationManagementClient
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onDefault(_response,_response.Content.ReadAsStringAsync().ContinueWith( body => Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api60.ErrorResponseAutoGenerated.FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode.Parse(body.Result)) ));
                            break;
                        }
                    }
                }
        ...
        internal async global::System.Threading.Tasks.Task ExperimentationCreate_Validate(string subscriptionId, string resourceGroupName, string configStoreName, string experimentationName, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.IExperimentation body, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener eventListener)
        {
            using( NoSynchronizationContext )
            {
                ...
                await eventListener.AssertRegEx(nameof(experimentationName),experimentationName,@"^default$");
                await eventListener.AssertNotNull(nameof(body), body);
                await eventListener.AssertObjectIsValid(nameof(body), body);
            }
        }
