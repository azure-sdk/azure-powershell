...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview
{
    ...
    public partial class ConfigurationStoreProperties
    {
        ...
        internal ConfigurationStoreProperties(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            {_dataPlaneProxy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("dataPlaneProxy"), out var __jsonDataPlaneProxy) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.DataPlaneProxyProperties.FromJson(__jsonDataPlaneProxy) : DataPlaneProxy;}
            {_telemetry = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("telemetry"), out var __jsonTelemetry) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.TelemetryProperties.FromJson(__jsonTelemetry) : Telemetry;}
            {_experimentation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("experimentation"), out var __jsonExperimentation) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.ExperimentationProperties.FromJson(__jsonExperimentation) : Experimentation;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IPrivateEndpointConnectionReference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IPrivateEndpointConnectionReference) (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.PrivateEndpointConnectionReference.FromJson(__u) )) ))() : null : PrivateEndpointConnection;}
            ...
            {_softDeleteRetentionInDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNumber>("softDeleteRetentionInDays"), out var __jsonSoftDeleteRetentionInDays) ? (int?)__jsonSoftDeleteRetentionInDays : SoftDeleteRetentionInDay;}
            {_enablePurgeProtection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonBoolean>("enablePurgeProtection"), out var __jsonEnablePurgeProtection) ? (bool?)__jsonEnablePurgeProtection : EnablePurgeProtection;}
            {_createMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonString>("createMode"), out var __jsonCreateMode) ? (string)__jsonCreateMode : (string)CreateMode;}
            {_replica = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray>("replicas"), out var __jsonReplicas) ? If( __jsonReplicas as Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IReplicaInfo[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IReplicaInfo) (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.ReplicaInfo.FromJson(__p) )) ))() : null : Replica;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IConfigurationStoreProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IConfigurationStoreProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20230901Preview.IConfigurationStoreProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._telemetry ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) this._telemetry.ToJson(null,serializationMode) : null, "telemetry" ,container.Add );
            AddIf( null != this._experimentation ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) this._experimentation.ToJson(null,serializationMode) : null, "experimentation" ,container.Add );
            ...
            AddIf( null != (((object)this._createMode)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonString(this._createMode.ToString()) : null, "createMode" ,container.Add );
            if (null != this._replica)
            {
                var __r = new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.XNodeArray();
                foreach( var __s in this._replica )
                {
                    AddIf(__s?.ToJson(null, serializationMode) ,__r.Add);
                }
                container.Add("replicas",__r);
            }
