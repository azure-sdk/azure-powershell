...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview
{
    ...
    public partial class ConfigurationStoreProperties
    {
        ...
        internal ConfigurationStoreProperties(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            {_dataPlaneProxy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("dataPlaneProxy"), out var __jsonDataPlaneProxy) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.DataPlaneProxyProperties.FromJson(__jsonDataPlaneProxy) : DataPlaneProxy;}
            {_telemetry = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("telemetry"), out var __jsonTelemetry) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.TelemetryProperties.FromJson(__jsonTelemetry) : Telemetry;}
            {_managedOnBehalfOfConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("managedOnBehalfOfConfiguration"), out var __jsonManagedOnBehalfOfConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api50.ManagedOnBehalfOfConfiguration.FromJson(__jsonManagedOnBehalfOfConfiguration) : ManagedOnBehalfOfConfiguration;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.IConfigurationStoreProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.IConfigurationStoreProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.IConfigurationStoreProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._managedOnBehalfOfConfiguration ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) this._managedOnBehalfOfConfiguration.ToJson(null,serializationMode) : null, "managedOnBehalfOfConfiguration" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode.IncludeReadOnly))
            {
