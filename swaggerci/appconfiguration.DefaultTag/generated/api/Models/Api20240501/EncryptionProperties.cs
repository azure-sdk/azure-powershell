...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501
{
    ...
    public partial class EncryptionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IEncryptionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IEncryptionPropertiesInternal
    {

        /// <summary>Backing field for <see cref="KeyVaultProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IKeyVaultProperties _keyVaultProperty;

        /// <summary>Key vault properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IKeyVaultProperties KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.KeyVaultProperties()); set => this._keyVaultProperty = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IKeyVaultProperties Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IEncryptionPropertiesInternal.KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.KeyVaultProperties()); set { {_keyVaultProperty = value;} } }
    ...
    {
        /// <summary>Key vault properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.IKeyVaultProperties KeyVaultProperty { get; set; }
        /// <summary>The client id of the identity which will be used to access key vault.</summary>
        string KeyVaultPropertyIdentityClientId { get; set; }
        /// <summary>The URI of the key vault key used to encrypt data.</summary>
        string KeyVaultPropertyKeyIdentifier { get; set; }
