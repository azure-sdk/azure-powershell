...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview
{
    ...
    public partial class ConfigurationStoreProperties
    {
        ...
        internal ConfigurationStoreProperties(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            {_dataPlaneProxy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("dataPlaneProxy"), out var __jsonDataPlaneProxy) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.DataPlaneProxyProperties.FromJson(__jsonDataPlaneProxy) : DataPlaneProxy;}
            {_telemetry = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("telemetry"), out var __jsonTelemetry) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.TelemetryProperties.FromJson(__jsonTelemetry) : Telemetry;}
            {_experimentation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("experimentation"), out var __jsonExperimentation) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.ExperimentationProperties.FromJson(__jsonExperimentation) : Experimentation;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IPrivateEndpointConnectionReference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IPrivateEndpointConnectionReference) (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.PrivateEndpointConnectionReference.FromJson(__u) )) ))() : null : PrivateEndpointConnection;}
            ...
            {_revisionRetentionPeriodInSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNumber>("revisionRetentionPeriodInSeconds"), out var __jsonRevisionRetentionPeriodInSeconds) ? (long?)__jsonRevisionRetentionPeriodInSeconds : RevisionRetentionPeriodInSecond;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IConfigurationStoreProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IConfigurationStoreProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240701Preview.IConfigurationStoreProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._revisionRetentionPeriodInSecond ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNumber((long)this._revisionRetentionPeriodInSecond) : null, "revisionRetentionPeriodInSeconds" ,container.Add );
