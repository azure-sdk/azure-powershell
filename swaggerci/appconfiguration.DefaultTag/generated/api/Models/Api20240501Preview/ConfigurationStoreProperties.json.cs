...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview
{
    ...
    public partial class ConfigurationStoreProperties
    {
        ...
        internal ConfigurationStoreProperties(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            {_dataPlaneProxy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("dataPlaneProxy"), out var __jsonDataPlaneProxy) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.DataPlaneProxyProperties.FromJson(__jsonDataPlaneProxy) : DataPlaneProxy;}
            {_telemetry = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("telemetry"), out var __jsonTelemetry) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.TelemetryProperties.FromJson(__jsonTelemetry) : Telemetry;}
            {_experimentation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("experimentation"), out var __jsonExperimentation) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.ExperimentationProperties.FromJson(__jsonExperimentation) : Experimentation;}
            ...
            {_privateEndpointConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray>("privateEndpointConnections"), out var __jsonPrivateEndpointConnections) ? If( __jsonPrivateEndpointConnections as Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.IPrivateEndpointConnectionReference[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.IPrivateEndpointConnectionReference) (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.PrivateEndpointConnectionReference.FromJson(__u) )) ))() : null : PrivateEndpointConnection;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.IConfigurationStoreProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.IConfigurationStoreProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.IConfigurationStoreProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
