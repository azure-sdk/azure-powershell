...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/networkSecurityPerimeterConfigurations/{nspConfigurationName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAppConfigurationNetworkSecurityPerimeterConfiguration_Get")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"Gets the specified network security perimeter configuration associated with the configuration store.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/networkSecurityPerimeterConfigurations/{nspConfigurationName}", ApiVersion = "2023-10-01-preview")]
    public partial class GetAzAppConfigurationNetworkSecurityPerimeterConfiguration_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// The name of the network security perimeter configuration. Takes the format {perimeterGuid}.{associationName}.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the network security perimeter configuration. Takes the format {perimeterGuid}.{associationName}.")]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The name of the network security perimeter configuration. Takes the format {perimeterGuid}.{associationName}.",
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration">Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAppConfigurationNetworkSecurityPerimeterConfiguration_Get" /> cmdlet
        /// class.
        /// </summary>
        public GetAzAppConfigurationNetworkSecurityPerimeterConfiguration_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NetworkSecurityPerimeterConfigurationsGet(SubscriptionId, ResourceGroupName, ConfigStoreName, NspConfigurationName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ConfigStoreName=ConfigStoreName,NspConfigurationName=NspConfigurationName})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ConfigStoreName=ConfigStoreName, NspConfigurationName=NspConfigurationName })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration
