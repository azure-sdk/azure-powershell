...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// <summary>
    /// Deletes a key-value. NOTE: This operation is intended for use in ARM Template deployments. For all other scenarios involving
    /// App Configuration key-values the data plane API should be used instead.
    /// </summary>
    /// <remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"Deletes a key-value. NOTE: This operation is intended for use in ARM Template deployments. For all other scenarios involving App Configuration key-values the data plane API should be used instead.")]
