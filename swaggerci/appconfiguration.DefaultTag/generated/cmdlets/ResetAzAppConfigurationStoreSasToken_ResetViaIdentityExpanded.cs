...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzAppConfigurationStoreSasToken_ResetViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class ResetAzAppConfigurationStoreSasToken_ResetViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IResetSasTokensParameters _resetSasTokensParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.ResetSasTokensParameters();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.Kind Kind { get => _resetSasTokensParametersBody.Kind; set => _resetSasTokensParametersBody.Kind = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConfigurationStoresResetSasTokensViaIdentity(InputObject.Id, _resetSasTokensParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConfigurationStoresResetSasTokens(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ConfigStoreName ?? null, _resetSasTokensParametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_resetSasTokensParametersBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzAppConfigurationStoreSasToken_ResetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public ResetAzAppConfigurationStoreSasToken_ResetViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_resetSasTokensParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_resetSasTokensParametersBody })
                    {
