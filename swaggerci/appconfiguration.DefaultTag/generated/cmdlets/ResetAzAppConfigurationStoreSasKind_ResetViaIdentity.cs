...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Reset, @"AzAppConfigurationStoreSasKind_ResetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class ResetAzAppConfigurationStoreSasKind_ResetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ResetSasKindParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601Preview.IResetSasKindParameters _resetSasKindParameter;

        /// <summary>Parameters used for resetting SAS kind.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters used for resetting SAS kind.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters used for resetting SAS kind.",
        SerializedName = @"resetSasKindParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601Preview.IResetSasKindParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601Preview.IResetSasKindParameters ResetSasKindParameter { get => this._resetSasKindParameter; set => this._resetSasKindParameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ConfigurationStoresResetSasKindViaIdentity(InputObject.Id, ResetSasKindParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ConfigurationStoresResetSasKind(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ConfigStoreName ?? null, ResetSasKindParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ResetSasKindParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResetAzAppConfigurationStoreSasKind_ResetViaIdentity" /> cmdlet class.
        /// </summary>
        public ResetAzAppConfigurationStoreSasKind_ResetViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ResetSasKindParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ResetSasKindParameter })
                    {
