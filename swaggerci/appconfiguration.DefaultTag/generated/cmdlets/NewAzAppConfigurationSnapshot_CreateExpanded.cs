...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/snapshots/{snapshotName}"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"Creates a snapshot. NOTE: This operation is intended for use in Azure Resource Manager (ARM) Template deployments. For all other scenarios involving App Configuration snapshots the data plane API should be used instead.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601.ISnapshot _body = new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601.Snapshot();
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.CompositionType))]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.CompositionType CompositionType { get => _body.CompositionType ?? ((Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.CompositionType)""); set => _body.CompositionType = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of filters used to filter the key-values included in the snapshot.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601.IKeyValueFilter[] Filter { get => _body.Filter ?? null /* arrayOf */; set => _body.Filter = value; }
        ...
        public long RetentionPeriod { get => _body.RetentionPeriod ?? default(long); set => _body.RetentionPeriod = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The tags of the snapshot. NOTE: These are data plane tags, not Azure Resource Manager (ARM) tags.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240601.ISnapshotPropertiesTags Tag { get => _body.Tag ?? null /* object */; set => _body.Tag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.NewAzAppConfigurationSnapshot_CreateExpanded Clone()
        {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAppConfigurationSnapshot_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SnapshotsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SnapshotsCreate(SubscriptionId, ResourceGroupName, ConfigStoreName, Name, _body, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ConfigStoreName=ConfigStoreName,Name=Name,body=_body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api50.IErrorResponseAutoGenerated> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ConfigStoreName=ConfigStoreName, Name=Name, body=_body })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ConfigStoreName=ConfigStoreName, Name=Name, body=_body })
                    {
