...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.ISnapshot])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppConfiguration.private\Get-AzAppConfigurationSnapshot_Get';
            GetViaIdentity = 'Az.AppConfiguration.private\Get-AzAppConfigurationSnapshot_GetViaIdentity';
        }
