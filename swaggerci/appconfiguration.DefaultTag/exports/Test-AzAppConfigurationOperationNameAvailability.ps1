...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.INameAvailabilityStatus
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501Preview.INameAvailabilityStatus])]
