...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.ICheckNameAvailabilityParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240501.INameAvailabilityStatus])]
