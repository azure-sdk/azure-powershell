...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.ICheckNameAvailabilityParameters
.Inputs
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.INameAvailabilityStatus])]
