...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IKeyValue])]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IPrivateEndpointConnection])]
...
INPUTOBJECT <IAppConfigurationIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Microsoft Azure subscription ID.
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/get-azappconfigurationprivatelinkresource
#>
function Get-AzAppConfigurationPrivateLinkResource {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IPrivateLinkResource])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
INPUTOBJECT <IAppConfigurationIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Microsoft Azure subscription ID.
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/get-azappconfigurationstoredeleted
#>
function Get-AzAppConfigurationStoreDeleted {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IDeletedConfigurationStore])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Path')]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IApiKey])]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IConfigurationStore])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Path')]
...
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IKeyValue
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/new-azappconfigurationkeyvalue
#>
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IKeyValuePropertiesTags]))]
...
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IPrivateEndpointConnection
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/new-azappconfigurationprivateendpointconnection
#>
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.ISnapshotPropertiesTags]))]
    [System.Collections.Hashtable]
...
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IRegenerateKeyParameters
.Inputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IAppConfigurationIdentity
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IApiKey
...
SASTOKENGENERATIONPARAMETER <ISasTokenGenerationParameters>: Parameters used for generating SAS token.
  Expire <DateTime>: The time that the SAS token expires in the Universal ISO 8601 DateTime format. Max allowed expiration is 1 year from the time of token creation.
  Kind <Kind>: The kind of the SAS token.
  ResourceType <ResourceType>: The data plane resource type that the SAS token is authorized to access.
  [CacheControlMaxAge <Single?>]: Time (in seconds) for which the data plane response may be cached by clients. App Configuration sets the Cache-Control response header `max-age` to the value that's specified on the SAS token. See [rfc9111](https://www.rfc-editor.org/rfc/rfc9111#name-max-age-2) for more details.
  [SignedParameterKey <String>]: A filter used to match keys. Syntax reference:         https://aka.ms/azconfig/docs/keyvaluefiltering. This is only applicable when the resourceType is Kv.
  [SignedParameterLabel <String>]: A filter used to match labels. Syntax reference:         https://aka.ms/azconfig/docs/keyvaluefiltering. This is only applicable when the resourceType is Kv.
  [SignedParameterName <String>]: The name of the snapshot. This is only applicable when the resourceType is Snapshot.
  [SignedParameterTag <String[]>]: Am array of tag filters used to match tags.
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/new-azappconfigurationstoresastoken
#>
function New-AzAppConfigurationStoreSasToken {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.ISasTokenGenerationResult])]
...
param(
    ...
    [Parameter(ParameterSetName='GenerateExpanded', Mandatory)]
    [Parameter(ParameterSetName='GenerateViaIdentityExpanded', Mandatory)]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.Kind])]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.Kind]
    # The kind of the SAS token.
    ${Kind},

    [Parameter(ParameterSetName='GenerateExpanded', Mandatory)]
    [Parameter(ParameterSetName='GenerateViaIdentityExpanded', Mandatory)]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.ResourceType])]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.ResourceType]
...
begin {
    try {
        ...
        $mapping = @{
            Generate = 'Az.AppConfiguration.private\New-AzAppConfigurationStoreSasToken_Generate';
            GenerateExpanded = 'Az.AppConfiguration.private\New-AzAppConfigurationStoreSasToken_GenerateExpanded';
            GenerateViaIdentity = 'Az.AppConfiguration.private\New-AzAppConfigurationStoreSasToken_GenerateViaIdentity';
            GenerateViaIdentityExpanded = 'Az.AppConfiguration.private\New-AzAppConfigurationStoreSasToken_GenerateViaIdentityExpanded';
        }
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IResourceIdentityUserAssignedIdentities]))]
    [System.Collections.Hashtable]
...
RESETSASTOKENSPARAMETER <IResetSasTokensParameters>: Parameters used for resetting SAS token.
  Kind <Kind>: The kind of the SAS token.
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/reset-azappconfigurationstoresastoken
#>
function Reset-AzAppConfigurationStoreSasToken {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Reset = 'Az.AppConfiguration.private\Reset-AzAppConfigurationStoreSasToken_Reset';
            ResetExpanded = 'Az.AppConfiguration.private\Reset-AzAppConfigurationStoreSasToken_ResetExpanded';
            ResetViaIdentity = 'Az.AppConfiguration.private\Reset-AzAppConfigurationStoreSasToken_ResetViaIdentity';
            ResetViaIdentityExpanded = 'Az.AppConfiguration.private\Reset-AzAppConfigurationStoreSasToken_ResetViaIdentityExpanded';
        }
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20240901Preview.IConfigurationStoreUpdateParametersTags]))]
    [System.Collections.Hashtable]
