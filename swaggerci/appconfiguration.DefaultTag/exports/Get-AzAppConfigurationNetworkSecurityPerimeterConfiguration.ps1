...
INPUTOBJECT <IAppConfigurationIdentity>: Identity Parameter
  ...
  [NspConfigurationName <String>]: The name of the network security perimeter configuration. Takes the format {perimeterGuid}.{associationName}.
...
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/get-azappconfigurationnetworksecurityperimeterconfiguration
#>
function Get-AzAppConfigurationNetworkSecurityPerimeterConfiguration {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20231001Preview.INetworkSecurityPerimeterConfiguration])]
...
param(
    ...
    # Takes the format {perimeterGuid}.{associationName}.
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppConfiguration.private\Get-AzAppConfigurationNetworkSecurityPerimeterConfiguration_Get';
            GetViaIdentity = 'Az.AppConfiguration.private\Get-AzAppConfigurationNetworkSecurityPerimeterConfiguration_GetViaIdentity';
            List = 'Az.AppConfiguration.private\Get-AzAppConfigurationNetworkSecurityPerimeterConfiguration_List';
        }
