...
INPUTOBJECT <IAppConfigurationIdentity>: Identity Parameter
  ...
  [ExperimentationName <String>]: The name of the experimentation.
...
.Link
https://learn.microsoft.com/powershell/module/az.appconfiguration/get-azappconfigurationexperimentation
#>
function Get-AzAppConfigurationExperimentation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20250201Preview.IExperimentation])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AppConfiguration.private\Get-AzAppConfigurationExperimentation_Get';
            GetViaIdentity = 'Az.AppConfiguration.private\Get-AzAppConfigurationExperimentation_GetViaIdentity';
            List = 'Az.AppConfiguration.private\Get-AzAppConfigurationExperimentation_List';
        }
