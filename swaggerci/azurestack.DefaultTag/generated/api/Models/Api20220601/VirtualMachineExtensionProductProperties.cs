...
namespace Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601
{
    ...
    public partial class VirtualMachineExtensionProductProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Stack.Support.ComputeRole? Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.ComputeRole { get => this._computeRole; set { {_computeRole = value;} } }

        /// <summary>Internal Acessors for IsSystemExtension</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.IsSystemExtension { get => this._isSystemExtension; set { {_isSystemExtension = value;} } }

        /// <summary>Internal Acessors for SourceBlob</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUri Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.SourceBlob { get => (this._sourceBlob = this._sourceBlob ?? new Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.Uri()); set { {_sourceBlob = value;} } }

        /// <summary>Internal Acessors for SourceBlobUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.SourceBlobUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUriInternal)SourceBlob).Uri1; set => ((Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUriInternal)SourceBlob).Uri1 = value; }

        /// <summary>Internal Acessors for SupportMultipleExtension</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.SupportMultipleExtension { get => this._supportMultipleExtension; set { {_supportMultipleExtension = value;} } }

        /// <summary>Internal Acessors for VMScaleSetEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.VMScaleSetEnabled { get => this._vMScaleSetEnabled; set { {_vMScaleSetEnabled = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.Version { get => this._version; set { {_version = value;} } }

        /// <summary>Internal Acessors for VmosType</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Stack.Support.OperatingSystem? Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IVirtualMachineExtensionProductPropertiesInternal.VmosType { get => this._vmosType; set { {_vmosType = value;} } }

        /// <summary>Backing field for <see cref="SourceBlob" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUri _sourceBlob;

        /// <summary>Specifies a download location where content can be downloaded from.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Stack.Origin(Microsoft.Azure.PowerShell.Cmdlets.Stack.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUri SourceBlob { get => (this._sourceBlob = this._sourceBlob ?? new Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.Uri()); }
        ...
        public string SourceBlobUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUriInternal)SourceBlob).Uri1; }
...

    {
        ...
        /// <summary>Specifies a download location where content can be downloaded from.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Stack.Models.Api20220601.IUri SourceBlob { get; set; }
        /// <summary>The URI.</summary>
