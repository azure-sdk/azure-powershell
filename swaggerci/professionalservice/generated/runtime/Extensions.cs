 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.Professionalservice.Runtime
{
    using System.Linq;
    using System;
    ...
    internal static partial class Extensions
    {
        ...
        internal static void AddIf<T>(T value, System.Action<T> addMethod)
        {
            ...
            if (null != value && (value as Microsoft.Azure.PowerShell.Cmdlets.Professionalservice.Runtime.Json.JsonObject)?.Keys.Count != 0)
            {
                addMethod(value);
            }
        }
