...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Support";
