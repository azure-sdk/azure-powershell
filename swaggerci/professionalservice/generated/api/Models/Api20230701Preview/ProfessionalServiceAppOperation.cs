...
namespace Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview
{
    ...
    public partial class ProfessionalServiceAppOperation :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.IProfessionalServiceAppOperationInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.IProfessionalServiceAppOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.IProfessionalServiceAppOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.ProfessionalServiceAppOperationDisplay()); set => this._display = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.IProfessionalServiceAppOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.IProfessionalServiceAppOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.ProfessionalServiceAppOperationDisplay()); set { {_display = value;} } }
        ...
        /// <summary>Creates an new <see cref="ProfessionalServiceAppOperation" /> instance.</summary>
        public ProfessionalServiceAppOperation()
        {
    ...
    /// professionalService app operations
    internal partial interface IProfessionalServiceAppOperationInternal

    {
        /// <summary>the operation display</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ProfessionalService.Models.Api20230701Preview.IProfessionalServiceAppOperationDisplay Display { get; set; }
        /// <summary>Description of the operation for display purposes</summary>
        string DisplayDescription { get; set; }
        /// <summary>Name of the operation for display purposes</summary>
        string DisplayOperation { get; set; }
