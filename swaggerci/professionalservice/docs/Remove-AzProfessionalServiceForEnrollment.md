...
online version: https://docs.microsoft.com/en-us/powershell/module/az.professionalservice/remove-azprofessionalserviceforenrollment
schema: 2.0.0
---

# Remove-AzProfessionalServiceForEnrollment
...
### Delete (Default)
```
Remove-AzProfessionalServiceForEnrollment -EnrollmentBillingAccount <String> -ResourceName <String>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzProfessionalServiceForEnrollment -InputObject <IProfessionalServiceIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
