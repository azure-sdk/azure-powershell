...
online version: https://learn.microsoft.com/powershell/module/az.professionalservice/remove-azprofessionalservicesubscriptionlevel
schema: 2.0.0
---

# Remove-AzProfessionalServiceSubscriptionLevel
...
### Delete (Default)
```
Remove-AzProfessionalServiceSubscriptionLevel -ResourceGroupName <String> -ResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzProfessionalServiceSubscriptionLevel -InputObject <IProfessionalServiceIdentity>
