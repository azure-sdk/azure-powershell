...
Module Guid: ba0efd98-3655-4319-b981-4418a3f36d9e
...
### [Get-AzCognitiveServicesAccountCapabilityHost](Get-AzCognitiveServicesAccountCapabilityHost.md)
Get account capabilityHost.

### [Get-AzCognitiveServicesAccountConnection](Get-AzCognitiveServicesAccountConnection.md)
...
### [Get-AzCognitiveServicesProject](Get-AzCognitiveServicesProject.md)
Returns a Cognitive Services project specified by the parameters.

### [Get-AzCognitiveServicesProjectCapabilityHost](Get-AzCognitiveServicesProjectCapabilityHost.md)
Get project capabilityHost.

### [Get-AzCognitiveServicesProjectConnection](Get-AzCognitiveServicesProjectConnection.md)
Lists Cognitive Services project connection by name.

### [Get-AzCognitiveServicesRaiBlocklist](Get-AzCognitiveServicesRaiBlocklist.md)
...
### [New-AzCognitiveServicesAccountCapabilityHost](New-AzCognitiveServicesAccountCapabilityHost.md)
Create or update account capabilityHost.

### [New-AzCognitiveServicesAccountConnection](New-AzCognitiveServicesAccountConnection.md)
...
### [New-AzCognitiveServicesProject](New-AzCognitiveServicesProject.md)
...
### [New-AzCognitiveServicesProjectCapabilityHost](New-AzCognitiveServicesProjectCapabilityHost.md)
Create or update project capabilityHost.

### [New-AzCognitiveServicesProjectConnection](New-AzCognitiveServicesProjectConnection.md)
...
### [Remove-AzCognitiveServicesAccountCapabilityHost](Remove-AzCognitiveServicesAccountCapabilityHost.md)
Delete account capabilityHost.

### [Remove-AzCognitiveServicesAccountConnection](Remove-AzCognitiveServicesAccountConnection.md)
...
### [Remove-AzCognitiveServicesProject](Remove-AzCognitiveServicesProject.md)
Deletes a Cognitive Services project from the resource group.

### [Remove-AzCognitiveServicesProjectCapabilityHost](Remove-AzCognitiveServicesProjectCapabilityHost.md)
Delete project capabilityHost.

### [Remove-AzCognitiveServicesProjectConnection](Remove-AzCognitiveServicesProjectConnection.md)
...
### [Update-AzCognitiveServicesAccountConnection](Update-AzCognitiveServicesAccountConnection.md)
...
### [Update-AzCognitiveServicesProject](Update-AzCognitiveServicesProject.md)
Updates a Cognitive Services Project

### [Update-AzCognitiveServicesProjectConnection](Update-AzCognitiveServicesProjectConnection.md)
