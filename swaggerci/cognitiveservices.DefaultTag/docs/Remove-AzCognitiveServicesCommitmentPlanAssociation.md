...
### Delete (Default)
```
Remove-AzCognitiveServicesCommitmentPlanAssociation -CommitmentPlanName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesCommitmentPlanAssociation -InputObject <ICognitiveServicesIdentity>
