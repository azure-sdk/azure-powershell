...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicesencryptionscope
schema: 2.0.0
---

# Remove-AzCognitiveServicesEncryptionScope
...
### Delete (Default)
```
Remove-AzCognitiveServicesEncryptionScope -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesEncryptionScope -InputObject <ICognitiveServicesIdentity>
