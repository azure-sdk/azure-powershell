...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicesraiblocklistitem
schema: 2.0.0
---

# Remove-AzCognitiveServicesRaiBlocklistItem
...
### Delete (Default)
```
Remove-AzCognitiveServicesRaiBlocklistItem -AccountName <String> -Name <String> -RaiBlocklistName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesRaiBlocklistItem -InputObject <ICognitiveServicesIdentity>
