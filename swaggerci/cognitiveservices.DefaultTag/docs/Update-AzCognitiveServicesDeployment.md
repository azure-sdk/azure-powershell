...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/update-azcognitiveservicesdeployment
schema: 2.0.0
---
...
```
Update-AzCognitiveServicesDeployment -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzCognitiveServicesDeployment -InputObject <ICognitiveServicesIdentity> [-SkuCapacity <Int32>]
