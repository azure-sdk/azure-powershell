...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/new-azcognitiveservicesaccountcapabilityhost
schema: 2.0.0
---

# New-AzCognitiveServicesAccountCapabilityHost
...
```
New-AzCognitiveServicesAccountCapabilityHost -AccountName <String> -CapabilityHostName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-AiServicesConnection <String[]>]
 [-CapabilityHostKind <CapabilityHostKind>] [-CustomerSubnet <String>] [-Description <String>]
 [-StorageConnection <String[]>] [-Tag <Hashtable>] [-ThreadStorageConnection <String[]>]
 [-VectorStoreConnection <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
