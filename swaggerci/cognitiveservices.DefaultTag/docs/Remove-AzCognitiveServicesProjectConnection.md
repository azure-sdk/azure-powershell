...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicesprojectconnection
schema: 2.0.0
---

# Remove-AzCognitiveServicesProjectConnection
...
### Delete (Default)
```
Remove-AzCognitiveServicesProjectConnection -AccountName <String> -ConnectionName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesProjectConnection -InputObject <ICognitiveServicesIdentity>
