...
### List2 (Default)
```
Get-AzCognitiveServicesCommitmentPlan [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Get1
```
Get-AzCognitiveServicesCommitmentPlan -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### List1
```
Get-AzCognitiveServicesCommitmentPlan -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
