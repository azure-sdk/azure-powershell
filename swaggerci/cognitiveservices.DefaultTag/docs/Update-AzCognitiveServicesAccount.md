...
Update-AzCognitiveServicesAccount -InputObject <ICognitiveServicesIdentity> [-AllowedFqdnList <String[]>]
 [-AllowProjectManagement] [-AmlWorkspaceIdentityClientId <String>] [-AmlWorkspaceResourceId <String>]
 [-ApiProperty <IApiProperties>] [-AssociatedProject <String[]>] [-CustomSubDomainName <String>]
 [-DefaultProject <String>] [-DisableLocalAuth] [-DynamicThrottlingEnabled] [-EncryptionKeySource <KeySource>]
 ...
 [-MigrationToken <String>] [-NetworkAclsBypass <ByPassSelection>]
 [-NetworkAclsDefaultAction <NetworkRuleAction>] [-NetworkAclsIPRule <IIPRule[]>]
 [-NetworkAclsVirtualNetworkRule <IVirtualNetworkRule[]>] [-NetworkInjectionScenario <ScenarioType>]
 [-NetworkInjectionSubnetArmId <String>] [-NetworkInjectionUseMicrosoftManagedNetwork]
