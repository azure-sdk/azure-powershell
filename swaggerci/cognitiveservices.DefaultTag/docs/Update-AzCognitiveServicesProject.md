...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/update-azcognitiveservicesproject
schema: 2.0.0
---

# Update-AzCognitiveServicesProject
...
```
Update-AzCognitiveServicesProject -AccountName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzCognitiveServicesProject -InputObject <ICognitiveServicesIdentity> [-Description <String>]
 [-DisplayName <String>] [-IdentityType <ResourceIdentityType>] [-IdentityUserAssignedIdentity <Hashtable>]
