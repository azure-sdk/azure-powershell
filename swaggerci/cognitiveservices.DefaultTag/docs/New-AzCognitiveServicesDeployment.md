...
New-AzCognitiveServicesDeployment -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-ModelFormat <String>] [-ModelName <String>] [-ModelVersion <String>]
 [-RaiPolicyName <String>] [-ScaleSettingCapacity <Int32>] [-ScaleSettingScaleType <DeploymentScaleType>]
