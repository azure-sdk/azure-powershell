...
New-AzCognitiveServicesDeployment -AccountName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-CurrentCapacity <Int32>] [-ModelFormat <String>] [-ModelName <String>] [-ModelSource <String>]
 [-ModelVersion <String>] [-RaiPolicyName <String>] [-ScaleSettingCapacity <Int32>]
 [-ScaleSettingScaleType <DeploymentScaleType>] [-SkuCapacity <Int32>] [-SkuFamily <String>]
 [-SkuName <String>] [-SkuSize <String>] [-SkuTier <SkuTier>] [-Tag <Hashtable>]
 [-VersionUpgradeOption <DeploymentModelVersionUpgradeOption>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
