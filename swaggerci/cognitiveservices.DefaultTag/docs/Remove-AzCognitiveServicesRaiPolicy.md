...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicesraipolicy
schema: 2.0.0
---

# Remove-AzCognitiveServicesRaiPolicy

## SYNOPSIS
Deletes the specified RaiPolicy associated with the Cognitive Services account.

## SYNTAX

### Delete (Default)
```
Remove-AzCognitiveServicesRaiPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesRaiPolicy -InputObject <ICognitiveServicesIdentity> [-DefaultProfile <PSObject>]
