...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicesprivateendpointconnection
schema: 2.0.0
---

# Remove-AzCognitiveServicesPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzCognitiveServicesPrivateEndpointConnection -AccountName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesPrivateEndpointConnection -InputObject <ICognitiveServicesIdentity>
