...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/get-azcognitiveservicesprojectcapabilityhost
schema: 2.0.0
---

# Get-AzCognitiveServicesProjectCapabilityHost
...
### Get (Default)
```
Get-AzCognitiveServicesProjectCapabilityHost -AccountName <String> -CapabilityHostName <String>
...
### GetViaIdentity
```
Get-AzCognitiveServicesProjectCapabilityHost -InputObject <ICognitiveServicesIdentity>
