...
Invoke-AzCognitiveServicesCalculateModelCapacity [-SubscriptionId <String>] [-ModelFormat <String>]
 [-ModelName <String>] [-ModelSource <String>] [-ModelVersion <String>] [-SkuName <String>]
...
```
Invoke-AzCognitiveServicesCalculateModelCapacity -InputObject <ICognitiveServicesIdentity>
 [-ModelFormat <String>] [-ModelName <String>] [-ModelSource <String>] [-ModelVersion <String>]
 [-SkuName <String>] [-Workload <IModelCapacityCalculatorWorkload[]>] [-DefaultProfile <PSObject>] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.ICalculateModelCapacityParameter
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IModelCapacityCalculatorWorkload[]
Parameter Sets: CalculateExpanded, CalculateViaIdentityExpanded
Aliases:
