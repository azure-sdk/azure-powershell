...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.ICalculateModelCapacityParameter
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IModelCapacityCalculatorWorkload[]
Parameter Sets: CalculateExpanded, CalculateViaIdentityExpanded
Aliases:
