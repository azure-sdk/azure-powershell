...
online version: https://learn.microsoft.com/powershell/module/az.cognitiveservices/remove-azcognitiveservicesprojectcapabilityhost
schema: 2.0.0
---

# Remove-AzCognitiveServicesProjectCapabilityHost
...
### Delete (Default)
```
Remove-AzCognitiveServicesProjectCapabilityHost -AccountName <String> -CapabilityHostName <String>
...
### DeleteViaIdentity
```
Remove-AzCognitiveServicesProjectCapabilityHost -InputObject <ICognitiveServicesIdentity>
