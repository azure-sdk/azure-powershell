...
namespace Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601
{
    ...
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfig"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfig __raiBlocklistConfig = new Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.RaiBlocklistConfig();
        ...
        public bool? Blocking { get => ((Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfigInternal)__raiBlocklistConfig).Blocking; set => ((Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfigInternal)__raiBlocklistConfig).Blocking = value ?? default(bool); }

        /// <summary>Name of ContentFilter.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.PropertyOrigin.Inherited)]
        public string BlocklistName { get => ((Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfigInternal)__raiBlocklistConfig).BlocklistName; set => ((Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfigInternal)__raiBlocklistConfig).BlocklistName = value ?? null; }
    ...
    public partial interface ICustomBlocklistConfig :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfig
    {
        /// <summary>Content source to apply the Content Filters.</summary>
    ...
    internal partial interface ICustomBlocklistConfigInternal :
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IRaiBlocklistConfigInternal
    {
        /// <summary>Content source to apply the Content Filters.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Support.RaiPolicyContentSource? Source { get; set; }
