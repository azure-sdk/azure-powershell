...
namespace Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601
{
    ...
    public partial class DeploymentListResult :
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeploymentListResult,
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeploymentListResultInternal
    {

        /// <summary>Internal Acessors for Value</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeployment[] Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeploymentListResultInternal.Value { get => this._value; set { {_value = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeployment[] _value;

        /// <summary>Gets the list of Cognitive Services accounts Deployment and their properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeployment[] Value { get => this._value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeployment) })]
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeployment[] Value { get;  }
...

    {
        ...
        string NextLink { get; set; }
        /// <summary>Gets the list of Cognitive Services accounts Deployment and their properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20250601.IDeployment[] Value { get; set; }
