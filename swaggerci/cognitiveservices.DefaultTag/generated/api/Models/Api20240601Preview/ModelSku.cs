...
namespace Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview
{
    ...
    public partial class ModelSku :
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IModelSku,
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IModelSkuInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IBillingMeterInfo[] _cost;

        /// <summary>The list of billing meter info.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IBillingMeterInfo[] Cost { get => this._cost; set => this._cost = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.ICapacityConfig Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IModelSkuInternal.Capacity { get => (this._capacity = this._capacity ?? new Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.CapacityConfig()); set { {_capacity = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.ICallRateLimit[] _rateLimit;

        /// <summary>The list of rateLimit.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.ICallRateLimit[] RateLimit { get => this._rateLimit; set => this._rateLimit = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"cost",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IBillingMeterInfo) })]
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.IBillingMeterInfo[] Cost { get; set; }
        /// <summary>The datetime of deprecation of the model SKU.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.ICallRateLimit) })]
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20240601Preview.ICallRateLimit[] RateLimit { get; set; }
        /// <summary>The usage name of the model SKU.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
