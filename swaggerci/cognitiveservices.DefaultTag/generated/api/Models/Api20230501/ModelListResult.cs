...
namespace Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501
{
    ...
    public partial class ModelListResult :
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501.IModelListResult,
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501.IModelListResultInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501.IModel[] _value;

        /// <summary>Gets the list of Cognitive Services accounts Model and their properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501.IModel[] Value { get => this._value; set => this._value = value; }

        /// <summary>Creates an new <see cref="ModelListResult" /> instance.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501.IModel) })]
        Microsoft.Azure.PowerShell.Cmdlets.CognitiveServices.Models.Api20230501.IModel[] Value { get; set; }

    }
    /// The list of cognitive services models.
    internal partial interface IModelListResultInternal
