...
online version: https://learn.microsoft.com/powershell/module/az.powerbidedicated/get-azpowerbidedicatedcapacitydetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzPowerBiDedicatedCapacityDetail -DedicatedCapacityName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzPowerBiDedicatedCapacityDetail -InputObject <IPowerBiDedicatedIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
