...
online version: https://learn.microsoft.com/powershell/module/az.powerbidedicated/remove-azpowerbidedicatedcapacity
schema: 2.0.0
---

# Remove-AzPowerBiDedicatedCapacity
...
### Delete (Default)
```
Remove-AzPowerBiDedicatedCapacity -DedicatedCapacityName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzPowerBiDedicatedCapacity -InputObject <IPowerBiDedicatedIdentity> [-DefaultProfile <PSObject>]
