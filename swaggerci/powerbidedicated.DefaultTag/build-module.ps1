...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/Az.PowerBiDedicated.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.PowerBiDedicated.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: PowerBiDedicated cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.PowerBiDedicated.format.ps1xml'
