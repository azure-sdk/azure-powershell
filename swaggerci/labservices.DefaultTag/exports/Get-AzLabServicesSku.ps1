...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.ILabServicesSku
.Link
https://learn.microsoft.com/powershell/module/az.labservices/get-azlabservicessku
#>
function Get-AzLabServicesSku {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.ILabServicesSku])]
