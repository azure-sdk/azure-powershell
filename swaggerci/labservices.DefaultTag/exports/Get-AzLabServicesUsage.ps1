...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IUsage
.Link
https://learn.microsoft.com/powershell/module/az.labservices/get-azlabservicesusage
#>
function Get-AzLabServicesUsage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IUsage])]
