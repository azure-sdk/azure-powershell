...
.Link
https://learn.microsoft.com/powershell/module/az.labservices/update-azlabservicesimage
#>
function Update-AzLabServicesImage {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IImage])]
