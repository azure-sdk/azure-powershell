...
INPUTOBJECT <ILabServicesIdentity>: Identity Parameter
  ...
  [VirtualMachineName <String>]: The ID of the virtual machine that uniquely identifies it within the containing lab. Used in resource URIs.
.Link
https://learn.microsoft.com/powershell/module/az.labservices/get-azlabservicesoperationresult
#>
function Get-AzLabServicesOperationResult {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IOperationResult])]
...
INPUTOBJECT <ILabServicesIdentity>: Identity Parameter
  ...
  [VirtualMachineName <String>]: The ID of the virtual machine that uniquely identifies it within the containing lab. Used in resource URIs.
.Link
https://learn.microsoft.com/powershell/module/az.labservices/get-azlabservicesvirtualmachine
#>
function Get-AzLabServicesVirtualMachine {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachine])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
...
INPUTOBJECT <ILabServicesIdentity>: Identity Parameter
  ...
  [VirtualMachineName <String>]: The ID of the virtual machine that uniquely identifies it within the containing lab. Used in resource URIs.
.Link
https://learn.microsoft.com/powershell/module/az.labservices/invoke-azlabservicesinviteuser
#>
...
INPUTOBJECT <ILabServicesIdentity>: Identity Parameter
  ...
  [VirtualMachineName <String>]: The ID of the virtual machine that uniquely identifies it within the containing lab. Used in resource URIs.
.Link
https://learn.microsoft.com/powershell/module/az.labservices/update-azlabservicesvirtualmachine
#>
