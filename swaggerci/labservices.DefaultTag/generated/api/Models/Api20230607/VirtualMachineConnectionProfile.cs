...
namespace Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607
{
    ...
    public partial class VirtualMachineConnectionProfile :
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfile,
        Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.AdminUsername { get => this._adminUsername; set { {_adminUsername = value;} } }

        /// <summary>Internal Acessors for NonAdminUsername</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.NonAdminUsername { get => this._nonAdminUsername; set { {_nonAdminUsername = value;} } }

        /// <summary>Internal Acessors for PrivateIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.PrivateIPAddress { get => this._privateIPAddress; set { {_privateIPAddress = value;} } }

        /// <summary>Internal Acessors for RdpAuthority</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.RdpAuthority { get => this._rdpAuthority; set { {_rdpAuthority = value;} } }

        /// <summary>Internal Acessors for RdpInBrowserUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.RdpInBrowserUrl { get => this._rdpInBrowserUrl; set { {_rdpInBrowserUrl = value;} } }

        /// <summary>Internal Acessors for SshAuthority</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.SshAuthority { get => this._sshAuthority; set { {_sshAuthority = value;} } }

        /// <summary>Internal Acessors for SshInBrowserUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LabServices.Models.Api20230607.IVirtualMachineConnectionProfileInternal.SshInBrowserUrl { get => this._sshInBrowserUrl; set { {_sshInBrowserUrl = value;} } }
