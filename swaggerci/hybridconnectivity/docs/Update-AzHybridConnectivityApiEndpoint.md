...
Update-AzHybridConnectivityApiEndpoint -Name <String> -ResourceUri <String> [-PropertiesType <Type>]
 [-ResourceId <String>] [-ServiceConfiguration <IServiceConfiguration[]>] [-DefaultProfile <PSObject>]
...
To construct, see NOTES section for SERVICECONFIGURATION properties and create a hash table.

```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridConnectivityApi.Models.Api20230315.IServiceConfiguration[]
Parameter Sets: (All)
Aliases:
...
`SERVICECONFIGURATION <IServiceConfiguration[]>`: The enabled service configurations.
  - `[Port <String>]`: The port on which service is enabled.
  - `[ServiceName <ServiceName?>]`: The type of service enabled.
