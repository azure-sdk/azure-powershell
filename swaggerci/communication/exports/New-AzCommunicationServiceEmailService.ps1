...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/new-azcommunicationserviceemailservice
#>
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api30.ITrackedResourceTags]))]
