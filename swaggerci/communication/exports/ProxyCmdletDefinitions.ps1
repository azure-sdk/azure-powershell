...
VALUE <IValidSenderUsername[]>: List of valid sender user names.
  ...
  Name <String>: Name of sender.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/add-azcommunicationservicedomainvalidsenderusername
#>
function Add-AzCommunicationServiceDomainValidSenderUsername {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='AddViaIdentity', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Add', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Add = 'Az.CommunicationService.private\Add-AzCommunicationServiceDomainValidSenderUsername_Add';
            AddExpanded = 'Az.CommunicationService.private\Add-AzCommunicationServiceDomainValidSenderUsername_AddExpanded';
            AddViaIdentity = 'Az.CommunicationService.private\Add-AzCommunicationServiceDomainValidSenderUsername_AddViaIdentity';
            AddViaIdentityExpanded = 'Az.CommunicationService.private\Add-AzCommunicationServiceDomainValidSenderUsername_AddViaIdentityExpanded';
        }
        if (('Add', 'AddExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20221001Preview.IValidSenderUsername
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/get-azcommunicationservicedomainvalidsenderusername
#>
function Get-AzCommunicationServiceDomainValidSenderUsername {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20221001Preview.IValidSenderUsername])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.CommunicationService.private\Get-AzCommunicationServiceDomainValidSenderUsername_List';
        }
...
INPUTOBJECT <ICommunicationServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/get-azcommunicationservicedomain
#>
function Get-AzCommunicationServiceDomain {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20221001Preview.IDomainResource])]
...
System.String
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/get-azcommunicationserviceemailserviceverifiedexchangeonlinedomain
#>
...
INPUTOBJECT <ICommunicationServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/get-azcommunicationserviceemailservice
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/invoke-azcommunicationserviceinitiatedomainverification
#>
...
Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20221001Preview.IDomainResource
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/new-azcommunicationservicedomain
#>
...
PARAMETER <ISuppressionListRemoveRequest>: Object that describes what address will be removed from the suppression list.
  ...
  [ValidSenderUsername <String>]: Optional parameter to operate on suppression list associated with a valid sender user name. When this parameter is not present, by default the domain level suppression list will be operated on.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/remove-azcommunicationservicedomainsuppressedemailaddress
#>
function Remove-AzCommunicationServiceDomainSuppressedEmailAddress {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Remove = 'Az.CommunicationService.private\Remove-AzCommunicationServiceDomainSuppressedEmailAddress_Remove';
            RemoveExpanded = 'Az.CommunicationService.private\Remove-AzCommunicationServiceDomainSuppressedEmailAddress_RemoveExpanded';
            RemoveViaIdentity = 'Az.CommunicationService.private\Remove-AzCommunicationServiceDomainSuppressedEmailAddress_RemoveViaIdentity';
            RemoveViaIdentityExpanded = 'Az.CommunicationService.private\Remove-AzCommunicationServiceDomainSuppressedEmailAddress_RemoveViaIdentityExpanded';
        }
...
INPUTOBJECT <ICommunicationServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/remove-azcommunicationservicedomain
#>
...
INPUTOBJECT <ICommunicationServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/remove-azcommunicationserviceemailservice
#>
...
PARAMETER <IVerificationParameter>: Input parameter for verification APIs
  VerificationType <VerificationType>: Type of verification.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/stop-azcommunicationservicedomainverification
#>
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api30.ICheckNameAvailabilityResponse])]
...
INPUTOBJECT <ICommunicationServiceIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/update-azcommunicationservicedomain
#>
