...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20211001Preview.IEmailServiceResource
.Notes
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/update-azcommunicationserviceemailservice
#>
function Update-AzCommunicationServiceEmailService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20211001Preview.IEmailServiceResource])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20211001Preview.ITaggedResourceTags]))]
