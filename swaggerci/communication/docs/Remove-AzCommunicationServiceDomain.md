...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/remove-azcommunicationservicedomain
schema: 2.0.0
---

# Remove-AzCommunicationServiceDomain
...
### Delete (Default)
```
Remove-AzCommunicationServiceDomain -EmailServiceName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzCommunicationServiceDomain -InputObject <ICommunicationServiceIdentity> [-DefaultProfile <PSObject>]
