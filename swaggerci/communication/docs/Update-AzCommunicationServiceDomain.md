...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/update-azcommunicationservicedomain
schema: 2.0.0
---
...
Update-AzCommunicationServiceDomain -EmailServiceName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-ValidSenderUsername <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
