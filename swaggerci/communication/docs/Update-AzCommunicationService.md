...
online version: https://learn.microsoft.com/powershell/module/az.communicationservice/update-azcommunicationservice
schema: 2.0.0
---
...
```
Update-AzCommunicationService -InputObject <ICommunicationServiceIdentity> [-LinkedDomain <String[]>]
