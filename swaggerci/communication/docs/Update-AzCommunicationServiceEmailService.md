...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/update-azcommunicationserviceemailservice
schema: 2.0.0
---
...
```
Update-AzCommunicationServiceEmailService -Name <String> -ResourceGroupName <String>
...
```
Update-AzCommunicationServiceEmailService -InputObject <ICommunicationServiceIdentity> [-Tag <Hashtable>]
