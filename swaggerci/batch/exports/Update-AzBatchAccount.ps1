...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Batch.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.IBatchAccountUpdateParametersTags]))]
    [System.Collections.Hashtable]
