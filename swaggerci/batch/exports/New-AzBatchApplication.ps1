...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IApplication
.Link
https://docs.microsoft.com/en-us/powershell/module/az.batch/new-azbatchapplication
#>
function New-AzBatchApplication {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IApplication])]
