...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.IPrivateEndpointConnection
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.IPrivateEndpointConnection])]
