...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001
{
    ...
    public partial class BatchAccountCreateProperties
    {
        ...
        internal BatchAccountCreateProperties(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_autoStorage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("autoStorage"), out var __jsonAutoStorage) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.AutoStorageBaseProperties.FromJson(__jsonAutoStorage) : AutoStorage;}
            {_keyVaultReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("keyVaultReference"), out var __jsonKeyVaultReference) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.KeyVaultReference.FromJson(__jsonKeyVaultReference) : KeyVaultReference;}
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.NetworkProfile.FromJson(__jsonNetworkProfile) : NetworkProfile;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.IBatchAccountCreateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.IBatchAccountCreateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.IBatchAccountCreateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
