...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601
{
    ...
    public partial class UserIdentity :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IUserIdentityInternal
    {

        /// <summary>Backing field for <see cref="AutoUser" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecification _autoUser;

        /// <summary>
        /// The userName and autoUser properties are mutually exclusive; you must specify one but not both.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecification AutoUser { get => (this._autoUser = this._autoUser ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.AutoUserSpecification()); set => this._autoUser = value; }

        /// <summary>The default value is nonAdmin.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ElevationLevel? AutoUserElevationLevel { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecificationInternal)AutoUser).ElevationLevel; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecificationInternal)AutoUser).ElevationLevel = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ElevationLevel)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AutoUserScope? AutoUserScope { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecificationInternal)AutoUser).Scope; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecificationInternal)AutoUser).Scope = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AutoUserScope)""); }

        /// <summary>Internal Acessors for AutoUser</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecification Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IUserIdentityInternal.AutoUser { get => (this._autoUser = this._autoUser ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.AutoUserSpecification()); set { {_autoUser = value;} } }
...

    {
        ...
        /// The userName and autoUser properties are mutually exclusive; you must specify one but not both.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IAutoUserSpecification AutoUser { get; set; }
        /// <summary>The default value is nonAdmin.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.ElevationLevel? AutoUserElevationLevel { get; set; }
        /// <summary>
        /// The default value is Pool. If the pool is running Windows a value of Task should be specified if stricter isolation between
