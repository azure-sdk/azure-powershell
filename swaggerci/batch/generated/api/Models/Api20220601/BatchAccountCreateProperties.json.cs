...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601
{
    ...
    public partial class BatchAccountCreateProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject into a new instance of <see cref="BatchAccountCreateProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal BatchAccountCreateProperties(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_autoStorage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("autoStorage"), out var __jsonAutoStorage) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.AutoStorageBaseProperties.FromJson(__jsonAutoStorage) : AutoStorage;}
            {_keyVaultReference = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("keyVaultReference"), out var __jsonKeyVaultReference) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.KeyVaultReference.FromJson(__jsonKeyVaultReference) : KeyVaultReference;}
            {_networkProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("networkProfile"), out var __jsonNetworkProfile) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.NetworkProfile.FromJson(__jsonNetworkProfile) : NetworkProfile;}
            {_encryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("encryption"), out var __jsonEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.EncryptionProperties.FromJson(__jsonEncryption) : Encryption;}
            ...
            {_allowedAuthenticationMode = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("allowedAuthenticationModes"), out var __jsonAllowedAuthenticationModes) ? If( __jsonAllowedAuthenticationModes as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AuthenticationMode[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AuthenticationMode) (__u is Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonString __t ? (Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AuthenticationMode)(__t.ToString()) : ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.AuthenticationMode)""))) ))() : null : AllowedAuthenticationMode;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IBatchAccountCreateProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IBatchAccountCreateProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IBatchAccountCreateProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json ? new BatchAccountCreateProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BatchAccountCreateProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BatchAccountCreateProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._allowedAuthenticationMode)
            {
                ...
                foreach( var __x in this._allowedAuthenticationMode )
                {
                ...
                container.Add("allowedAuthenticationModes",__w);
            }
