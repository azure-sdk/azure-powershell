...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601
{
    ...
    public partial class EncryptionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IEncryptionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IEncryptionPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IKeyVaultProperties _keyVaultProperty;

        /// <summary>Additional details when using Microsoft.KeyVault</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Origin(Microsoft.Azure.PowerShell.Cmdlets.Batch.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IKeyVaultProperties KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.KeyVaultProperties()); set => this._keyVaultProperty = value; }
        ...
        public string KeyVaultPropertyKeyIdentifier { get => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IKeyVaultPropertiesInternal)KeyVaultProperty).KeyIdentifier; set => ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IKeyVaultPropertiesInternal)KeyVaultProperty).KeyIdentifier = value ?? null; }

        /// <summary>Internal Acessors for KeyVaultProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IKeyVaultProperties Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IEncryptionPropertiesInternal.KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.KeyVaultProperties()); set { {_keyVaultProperty = value;} } }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.KeySource? KeySource { get; set; }
        /// <summary>Additional details when using Microsoft.KeyVault</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IKeyVaultProperties KeyVaultProperty { get; set; }
        /// <summary>
        /// Full path to the versioned secret. Example https://mykeyvault.vault.azure.net/keys/testkey/6e34a81fef704045975661e297a4c053.
        /// To be usable the following prerequisites must be met:
        /// The Batch Account has a System Assigned identity
