...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601
{
    ...
    public partial class StartTask
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IStartTask.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IStartTask.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IStartTask FromJson(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonNode node)
        {
        ...
        internal StartTask(Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject json)
        {
            ...
            {_userIdentity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("userIdentity"), out var __jsonUserIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.UserIdentity.FromJson(__jsonUserIdentity) : UserIdentity;}
            {_containerSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonObject>("containerSettings"), out var __jsonContainerSettings) ? Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.TaskContainerSettings.FromJson(__jsonContainerSettings) : ContainerSetting;}
            ...
            {_resourceFile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("resourceFiles"), out var __jsonResourceFiles) ? If( __jsonResourceFiles as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IResourceFile[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IResourceFile) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.ResourceFile.FromJson(__u) )) ))() : null : ResourceFile;}
            {_environmentSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray>("environmentSettings"), out var __jsonEnvironmentSettings) ? If( __jsonEnvironmentSettings as Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IEnvironmentSetting[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IEnvironmentSetting) (Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.EnvironmentSetting.FromJson(__p) )) ))() : null : EnvironmentSetting;}
