...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/certificates/{certificateName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzBatchCertificate_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificate))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Description(@"Warning: This operation is deprecated and will be removed after February, 2024. Please use the [Azure KeyVault Extension](https://learn.microsoft.com/azure/batch/batch-certificate-migration-guide) instead.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Batch.Generated]
    public partial class NewAzBatchCertificate_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificateCreateOrUpdateParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.CertificateCreateOrUpdateParameters();
        ...
        SerializedName = @"data",
        PossibleTypes = new [] { typeof(string) })]
        public string Data { get => _parametersBody.Data ?? null; set => _parametersBody.Data = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.CertificateFormat Format { get => _parametersBody.Format ?? ((Microsoft.Azure.PowerShell.Cmdlets.Batch.Support.CertificateFormat)""); set => _parametersBody.Format = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The entity state (ETag) version of the certificate to update. A value of \"*\" can be used to apply the operation only if the certificate already exists. If omitted, this operation will always be applied.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// be ignored.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Set to '*' to allow a new certificate to be created, but to prevent updating an existing certificate. Other values will be ignored.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The identifier for the certificate. This must be made up of algorithm and thumbprint separated by a dash, and must match the certificate data in the request. For example SHA1-a3d1c5.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Thumbprint { get => _parametersBody.Thumbprint ?? null; set => _parametersBody.Thumbprint = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ThumbprintAlgorithm { get => _parametersBody.ThumbprintAlgorithm ?? null; set => _parametersBody.ThumbprintAlgorithm = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICloudError">Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICloudError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICloudError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificate">Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificate</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificate> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzBatchCertificate_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzBatchCertificate_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CertificateCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CertificateCreate(ResourceGroupName, AccountName, Name, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, this.InvocationInformation.BoundParameters.ContainsKey("IfNoneMatch") ? IfNoneMatch : null, SubscriptionId, _parametersBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICloudError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificate> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20221001.ICertificate
