...
namespace Microsoft.Azure.PowerShell.Cmdlets.Batch.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Batch.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.IPrivateEndpointConnection _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Batch.Models.Api20220601.PrivateEndpointConnection();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PrivateEndpointConnectionUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _parametersBody, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
