...
online version: https://docs.microsoft.com/en-us/powershell/module/az.batch/remove-azbatchprivateendpointconnection
schema: 2.0.0
---

# Remove-AzBatchPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzBatchPrivateEndpointConnection -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzBatchPrivateEndpointConnection -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-AsJob]
