...
### Delete (Default)
```
Remove-AzBatchPool -AccountName <String> -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzBatchPool -InputObject <IBatchIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
