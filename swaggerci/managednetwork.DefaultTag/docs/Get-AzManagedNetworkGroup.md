...
online version: https://learn.microsoft.com/powershell/module/az.managednetwork/get-azmanagednetworkgroup
schema: 2.0.0
---
...
### List (Default)
```
Get-AzManagedNetworkGroup -ManagedNetworkName <String> -ResourceGroupName <String>
...
### Get
```
Get-AzManagedNetworkGroup -ManagedNetworkName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzManagedNetworkGroup -InputObject <IManagedNetworkIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
