...
online version: https://learn.microsoft.com/powershell/module/az.managednetwork/remove-azmanagednetworkgroup
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzManagedNetworkGroup -ManagedNetworkName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzManagedNetworkGroup -InputObject <IManagedNetworkIdentity> [-DefaultProfile <PSObject>] [-AsJob]
