...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cloudshell/remove-azcloudshellusersetting
schema: 2.0.0
---

# Remove-AzCloudShellUserSetting
...
### Delete1 (Default)
```
Remove-AzCloudShellUserSetting -SName <String> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Delete
```
Remove-AzCloudShellUserSetting -Location <String> -SName <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzCloudShellUserSetting -InputObject <ICloudShellIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
