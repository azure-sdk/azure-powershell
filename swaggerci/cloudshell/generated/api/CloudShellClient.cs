            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    switch ( _response.StatusCode )
                    {
                        ...
                        {
                            await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.CloudShell.Runtime.Events.BeforeResponseDispatch, _response); if( eventListener.Token.IsCancellationRequested ) { return; }
                            await onOk(_response,null /* deserializeFromResponse doesn't support '-header-' /home/cloudtest/.autorest/@autorest_powershell@3.0.487/node_modules/@autorest/powershell/dist/llcsharp/schema/object.js*/);
                            break;
                        }
                        default:
                        {
