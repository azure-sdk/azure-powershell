...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601
{
    ...
    public partial class PublicLandMobileNetwork
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPublicLandMobileNetwork.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPublicLandMobileNetwork.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPublicLandMobileNetwork FromJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json ? new PublicLandMobileNetwork(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject into a new instance of <see cref="PublicLandMobileNetwork" />.
        /// </summary>
        ...
        internal PublicLandMobileNetwork(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json)
        {
            ...
            __plmnId = new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.PlmnId(json);
            {_homeNetworkPublicKey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject>("homeNetworkPublicKeys"), out var __jsonHomeNetworkPublicKeys) ? Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.PublicLandMobileNetworkHomeNetworkPublicKeys.FromJson(__jsonHomeNetworkPublicKeys) : HomeNetworkPublicKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PublicLandMobileNetwork" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PublicLandMobileNetwork" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode serializationMode)
        {
            ...
            __plmnId?.ToJson(container, serializationMode);
            AddIf( null != this._homeNetworkPublicKey ? (Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode) this._homeNetworkPublicKey.ToJson(null,serializationMode) : null, "homeNetworkPublicKeys" ,container.Add );
