...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601
{
    ...
    public partial class SimUploadList :
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ISimUploadList,
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ISimUploadListInternal
    {

        /// <summary>Backing field for <see cref="Sim" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ISimNameAndProperties[] _sim;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ISimNameAndProperties[] Sim { get => this._sim; set => this._sim = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"sims",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ISimNameAndProperties) })]
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ISimNameAndProperties[] Sim { get; set; }
