...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601
{
    ...
    public partial class ServicePropertiesFormat :
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IServicePropertiesFormat,
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IServicePropertiesFormatInternal
    {
        ...
        public string MaximumBitRateDownlink { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).MaximumBitRateDownlink; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).MaximumBitRateDownlink = value ?? null; }

        /// <summary>Uplink bit rate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.PropertyOrigin.Inlined)]
        public string MaximumBitRateUplink { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).MaximumBitRateUplink; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).MaximumBitRateUplink = value ?? null; }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IServicePropertiesFormatInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for ServiceQoPolicyMaximumBitRate</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IAmbr Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IServicePropertiesFormatInternal.ServiceQoPolicyMaximumBitRate { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).MaximumBitRate; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).MaximumBitRate = value; }

        /// <summary>Internal Acessors for ServiceQosPolicy</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicy Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IServicePropertiesFormatInternal.ServiceQosPolicy { get => (this._serviceQosPolicy = this._serviceQosPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.QosPolicy()); set { {_serviceQosPolicy = value;} } }

        /// <summary>Backing field for <see cref="PccRule" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPccRuleConfiguration[] _pccRule;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPccRuleConfiguration[] PccRule { get => this._pccRule; set => this._pccRule = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.PropertyOrigin.Inlined)]
        public int? ServiceQoPolicyAllocationAndRetentionPriorityLevel { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).AllocationAndRetentionPriorityLevel; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).AllocationAndRetentionPriorityLevel = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.PropertyOrigin.Inlined)]
        public int? ServiceQoPolicyFiveQi { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).FiveQi; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicyInternal)ServiceQosPolicy).FiveQi = value ?? default(int); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicy ServiceQosPolicy { get => (this._serviceQosPolicy = this._serviceQosPolicy ?? new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.QosPolicy()); set => this._serviceQosPolicy = value; }
...

    {
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IAmbr ServiceQoPolicyMaximumBitRate { get; set; }
        /// <summary>
        /// QoS Flow preemption capability. The preemption capability of a QoS Flow controls whether it can preempt another QoS Flow
        /// with a lower priority level. See 3GPP TS23.501 section 5.7.2.2 for a full description of the ARP parameters.
        /// </summary>
        ...
        /// field in a PccRuleConfiguration. If this field is null then the UE's SIM policy will define the QoS settings.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IQosPolicy ServiceQosPolicy { get; set; }
