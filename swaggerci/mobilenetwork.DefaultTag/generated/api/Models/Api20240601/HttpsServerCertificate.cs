...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601
{
    ...
    public partial class HttpsServerCertificate :
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IHttpsServerCertificate,
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IHttpsServerCertificateInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioning Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IHttpsServerCertificateInternal.Provisioning { get => (this._provisioning = this._provisioning ?? new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.CertificateProvisioning()); set { {_provisioning = value;} } }

        /// <summary>Internal Acessors for ProvisioningReason</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IHttpsServerCertificateInternal.ProvisioningReason { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioningInternal)Provisioning).Reason; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioningInternal)Provisioning).Reason = value; }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.CertificateProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IHttpsServerCertificateInternal.ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioningInternal)Provisioning).State; set => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioningInternal)Provisioning).State = value; }

        /// <summary>Backing field for <see cref="Provisioning" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioning _provisioning;

        /// <summary>The provisioning state of the certificate.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioning Provisioning { get => (this._provisioning = this._provisioning ?? new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.CertificateProvisioning()); }
        ...
        public string ProvisioningReason { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioningInternal)Provisioning).Reason; }

        /// <summary>The certificate's provisioning state</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Origin(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Support.CertificateProvisioningState? ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioningInternal)Provisioning).State; }
...

    {
        ...
        string CertificateUrl { get; set; }
        /// <summary>The provisioning state of the certificate.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.ICertificateProvisioning Provisioning { get; set; }
        /// <summary>Reason for certificate provisioning failure.</summary>
