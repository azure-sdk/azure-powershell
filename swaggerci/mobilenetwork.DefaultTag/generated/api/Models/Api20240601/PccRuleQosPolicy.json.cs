...
namespace Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601
{
    ...
    public partial class PccRuleQosPolicy
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPccRuleQosPolicy.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPccRuleQosPolicy.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.IPccRuleQosPolicy FromJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json ? new PccRuleQosPolicy(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject into a new instance of <see cref="PccRuleQosPolicy" />.
        /// </summary>
        ...
        internal PccRuleQosPolicy(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject json)
        {
            ...
            __qosPolicy = new Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.QosPolicy(json);
            {_guaranteedBitRate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject>("guaranteedBitRate"), out var __jsonGuaranteedBitRate) ? Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Models.Api20240601.Ambr.FromJson(__jsonGuaranteedBitRate) : GuaranteedBitRate;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PccRuleQosPolicy" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PccRuleQosPolicy" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.SerializationMode serializationMode)
        {
            ...
            __qosPolicy?.ToJson(container, serializationMode);
            AddIf( null != this._guaranteedBitRate ? (Microsoft.Azure.PowerShell.Cmdlets.MobileNetwork.Runtime.Json.JsonNode) this._guaranteedBitRate.ToJson(null,serializationMode) : null, "guaranteedBitRate" ,container.Add );
