...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAppPlatformBuildServiceBuild_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Description(@"Create or update a KPack build.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Generated]
    public partial class NewAzAppPlatformBuildServiceBuild_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild _buildBody = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.Build();
        ...
        public string AgentPool { get => _buildBody.AgentPool ?? null; set => _buildBody.AgentPool = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Builder { get => _buildBody.Er ?? null; set => _buildBody.Er = value; }
        ...
        SerializedName = @"env",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuildPropertiesEnv) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuildPropertiesEnv Env { get => _buildBody.Env ?? null /* object */; set => _buildBody.Env = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional Cpu allocated to the build resource. 1 core can be represented by 1 or 1000m. The default value is 1, this should not exceed build service agent pool cpu size.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Optional Cpu allocated to the build resource. 1 core can be represented by 1 or 1000m. The default value is 1, this should not exceed build service agent pool cpu size.",
        SerializedName = @"cpu",
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceRequestCpu { get => _buildBody.ResourceRequestCpu ?? null; set => _buildBody.ResourceRequestCpu = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional Memory allocated to the build resource. 1 GB can be represented by 1Gi or 1024Mi. The default value is 2Gi, this should not exceed build service agent pool memory size.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Optional Memory allocated to the build resource. 1 GB can be represented by 1Gi or 1024Mi. The default value is 2Gi, this should not exceed build service agent pool memory size.",
        SerializedName = @"memory",
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceRequestMemory { get => _buildBody.ResourceRequestMemory ?? null; set => _buildBody.ResourceRequestMemory = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild">Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAppPlatformBuildServiceBuild_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAppPlatformBuildServiceBuild_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BuildServiceCreateOrUpdateBuild(SubscriptionId, ResourceGroupName, ServiceName, BuildServiceName, BuildName, _buildBody, onOk, onCreated, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ServiceName=ServiceName,BuildServiceName=BuildServiceName,BuildName=BuildName,body=_buildBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IBuild> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
