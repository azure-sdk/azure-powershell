...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106
{
    ...
    public partial class CustomDomainResourceTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="CustomDomainResource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.ICustomDomainResource ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.ICustomDomainResource).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
