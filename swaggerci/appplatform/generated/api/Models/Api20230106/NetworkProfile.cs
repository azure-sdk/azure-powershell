...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106
{
    ...
    public partial class NetworkProfile :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfile,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IRequiredTraffic[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfileInternal.RequiredTraffic { get => this._requiredTraffic; set { {_requiredTraffic = value;} } }

        /// <summary>Backing field for <see cref="OutboundIP" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfileOutboundIPs _outboundIP;

        /// <summary>Desired outbound IP resources for Azure Spring Apps resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfileOutboundIPs OutboundIP { get => (this._outboundIP = this._outboundIP ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.NetworkProfileOutboundIPs()); }
        ...
        public string[] OutboundIPPublicIP { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfileOutboundIPsInternal)OutboundIP).PublicIP; }

        /// <summary>Backing field for <see cref="RequiredTraffic" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IRequiredTraffic[] _requiredTraffic;

        /// <summary>Required inbound or outbound traffics for Azure Spring Apps resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IRequiredTraffic[] RequiredTraffic { get => this._requiredTraffic; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IRequiredTraffic[] RequiredTraffic { get;  }
        /// <summary>Azure Spring Apps service reserved CIDR</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        string AppSubnetId { get; set; }
        /// <summary>Desired outbound IP resources for Azure Spring Apps resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetworkProfileOutboundIPs OutboundIP { get; set; }
        /// <summary>A list of public IP addresses.</summary>
        string[] OutboundIPPublicIP { get; set; }
        /// <summary>Required inbound or outbound traffics for Azure Spring Apps resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IRequiredTraffic[] RequiredTraffic { get; set; }
        /// <summary>Azure Spring Apps service reserved CIDR</summary>
        string ServiceCidr { get; set; }
        /// <summary>
        /// Name of the resource group containing network resources of Azure Spring Apps Service Runtime
