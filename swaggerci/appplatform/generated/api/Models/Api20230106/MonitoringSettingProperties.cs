...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106
{
    ...
    public partial class MonitoringSettingProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IMonitoringSettingProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IMonitoringSettingPropertiesInternal
    {
        ...
        public string AppInsightAgentVersionJava { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersionsInternal)AppInsightsAgentVersion).Java; }

        /// <summary>Backing field for <see cref="AppInsightsAgentVersion" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersions _appInsightsAgentVersion;

        /// <summary>Indicates the versions of application insight agent</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersions AppInsightsAgentVersion { get => (this._appInsightsAgentVersion = this._appInsightsAgentVersion ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.ApplicationInsightsAgentVersions()); set => this._appInsightsAgentVersion = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public string Code { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IErrorInternal)Error).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IErrorInternal)Error).Code = value ?? null; }

        /// <summary>Backing field for <see cref="Error" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IError _error;

        /// <summary>Error when apply Monitoring Setting changes.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IError Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.Error()); set => this._error = value; }

        /// <summary>The message of error.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public string Message { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IErrorInternal)Error).Message; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IErrorInternal)Error).Message = value ?? null; }

        /// <summary>Internal Acessors for AppInsightAgentVersionJava</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IMonitoringSettingPropertiesInternal.AppInsightAgentVersionJava { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersionsInternal)AppInsightsAgentVersion).Java; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersionsInternal)AppInsightsAgentVersion).Java = value; }

        /// <summary>Internal Acessors for AppInsightsAgentVersion</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersions Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IMonitoringSettingPropertiesInternal.AppInsightsAgentVersion { get => (this._appInsightsAgentVersion = this._appInsightsAgentVersion ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.ApplicationInsightsAgentVersions()); set { {_appInsightsAgentVersion = value;} } }

        /// <summary>Internal Acessors for Error</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IError Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IMonitoringSettingPropertiesInternal.Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.Error()); set { {_error = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.MonitoringSettingState? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IMonitoringSettingPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
...

    {
        ...
        /// <summary>Indicates the versions of application insight agent</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IApplicationInsightsAgentVersions AppInsightsAgentVersion { get; set; }
        /// <summary>
        /// Target application insight instrumentation key, null or whitespace include empty will disable monitoringSettings
        /// </summary>
        string AppInsightsInstrumentationKey { get; set; }
        ...
        string Code { get; set; }
        /// <summary>Error when apply Monitoring Setting changes.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IError Error { get; set; }
        /// <summary>The message of error.</summary>
        string Message { get; set; }
        /// <summary>State of the Monitoring Setting.</summary>
