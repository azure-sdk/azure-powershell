...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106
{
    ...
    public partial class NetCoreZipUploadedUserSourceInfo :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetCoreZipUploadedUserSourceInfo,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.INetCoreZipUploadedUserSourceInfoInternal,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUploadedUserSourceInfo"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUploadedUserSourceInfo __uploadedUserSourceInfo = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.UploadedUserSourceInfo();
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUserSourceInfoInternal)__uploadedUserSourceInfo).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUserSourceInfoInternal)__uploadedUserSourceInfo).Type = value ; }

        /// <summary>Version of the source</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inherited)]
        public string Version { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUserSourceInfoInternal)__uploadedUserSourceInfo).Version; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUserSourceInfoInternal)__uploadedUserSourceInfo).Version = value ?? null; }
    ...
    public partial interface INetCoreZipUploadedUserSourceInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUploadedUserSourceInfo
    {
        /// <summary>The path to the .NET executable relative to zip root</summary>
    ...
    internal partial interface INetCoreZipUploadedUserSourceInfoInternal :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20230106.IUploadedUserSourceInfoInternal
    {
        /// <summary>The path to the .NET executable relative to zip root</summary>
        string NetCoreMainEntryPath { get; set; }
        /// <summary>Runtime version of the .Net file</summary>
