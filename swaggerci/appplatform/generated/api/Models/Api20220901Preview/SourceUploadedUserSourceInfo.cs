...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview
{
    ...
    public partial class SourceUploadedUserSourceInfo :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ISourceUploadedUserSourceInfo,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ISourceUploadedUserSourceInfoInternal,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUploadedUserSourceInfo"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUploadedUserSourceInfo __uploadedUserSourceInfo = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.UploadedUserSourceInfo();
        ...
        public string RelativePath { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUploadedUserSourceInfoInternal)__uploadedUserSourceInfo).RelativePath; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUploadedUserSourceInfoInternal)__uploadedUserSourceInfo).RelativePath = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Type = value ; }

        /// <summary>Version of the source</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inherited)]
        public string Version { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Version; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUserSourceInfoInternal)__uploadedUserSourceInfo).Version = value ?? null; }
    ...
    public partial interface ISourceUploadedUserSourceInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUploadedUserSourceInfo
    {
        /// <summary>
        /// Selector for the artifact to be used for the deployment for multi-module projects. This should be
        /// the relative path to the target module/project.
    ...
    internal partial interface ISourceUploadedUserSourceInfoInternal :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IUploadedUserSourceInfoInternal
    {
        /// <summary>
        /// Selector for the artifact to be used for the deployment for multi-module projects. This should be
        /// the relative path to the target module/project.
