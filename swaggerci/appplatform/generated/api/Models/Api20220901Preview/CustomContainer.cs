...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview
{
    ...
    public partial class CustomContainer :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ICustomContainer,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ICustomContainerInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IImageRegistryCredential _imageRegistryCredential;

        /// <summary>Credential of the image registry</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IImageRegistryCredential ImageRegistryCredential { get => (this._imageRegistryCredential = this._imageRegistryCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ImageRegistryCredential()); set => this._imageRegistryCredential = value; }
        ...
        public string ImageRegistryCredentialPassword { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IImageRegistryCredentialInternal)ImageRegistryCredential).Password; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IImageRegistryCredentialInternal)ImageRegistryCredential).Password = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IImageRegistryCredential Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ICustomContainerInternal.ImageRegistryCredential { get => (this._imageRegistryCredential = this._imageRegistryCredential ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.ImageRegistryCredential()); set { {_imageRegistryCredential = value;} } }
...

    {
        ...
        string ContainerImage { get; set; }
        /// <summary>Credential of the image registry</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IImageRegistryCredential ImageRegistryCredential { get; set; }
        /// <summary>The password of the image registry credential</summary>
        string ImageRegistryCredentialPassword { get; set; }
        /// <summary>The username of the image registry credential</summary>
        string ImageRegistryCredentialUsername { get; set; }
