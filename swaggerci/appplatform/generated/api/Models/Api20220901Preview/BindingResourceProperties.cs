...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview
{
    ...
    public partial class BindingResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesBindingParameters _bindingParameter;

        /// <summary>Binding parameters of the Binding resource</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesBindingParameters BindingParameter { get => (this._bindingParameter = this._bindingParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.BindingResourcePropertiesBindingParameters()); set => this._bindingParameter = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesInternal.CreatedAt { get => this._createdAt; set { {_createdAt = value;} } }

        /// <summary>Internal Acessors for GeneratedProperty</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesInternal.GeneratedProperty { get => this._generatedProperty; set { {_generatedProperty = value;} } }

        /// <summary>Internal Acessors for ResourceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesInternal.ResourceName { get => this._resourceName; set { {_resourceName = value;} } }

        /// <summary>Internal Acessors for ResourceType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesInternal.ResourceType { get => this._resourceType; set { {_resourceType = value;} } }

        /// <summary>Internal Acessors for UpdatedAt</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220901Preview.IBindingResourcePropertiesInternal.UpdatedAt { get => this._updatedAt; set { {_updatedAt = value;} } }
