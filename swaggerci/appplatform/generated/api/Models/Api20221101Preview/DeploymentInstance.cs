...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview
{
    ...
    public partial class DeploymentInstance :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstance,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal.DiscoveryStatus { get => this._discoveryStatus; set { {_discoveryStatus = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Reason</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal.Reason { get => this._reason; set { {_reason = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for Zone</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDeploymentInstanceInternal.Zone { get => this._zone; set { {_zone = value;} } }
