...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview
{
    ...
    public partial class ExecAction :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IExecAction,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IExecActionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IProbeAction"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IProbeAction __probeAction = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.ProbeAction();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProbeActionType Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IProbeActionInternal)__probeAction).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IProbeActionInternal)__probeAction).Type = value ; }
    ...
    public partial interface IExecAction :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IProbeAction
    {
        /// <summary>
        /// Command is the command line to execute inside the container, the working directory for the command is root ('/') in the
        /// container's filesystem. The command is not run inside a shell, so traditional shell instructions ('|', etc) won't work.
    ...
    internal partial interface IExecActionInternal :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IProbeActionInternal
    {
        /// <summary>
        /// Command is the command line to execute inside the container, the working directory for the command is root ('/') in the
        /// container's filesystem. The command is not run inside a shell, so traditional shell instructions ('|', etc) won't work.
