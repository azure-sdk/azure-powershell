...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview
{
    ...
    public partial class NetworkProfile
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.INetworkProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.INetworkProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.INetworkProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonNode node)
        {
        ...
        internal NetworkProfile(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonObject json)
        {
            ...
            {_outboundIP = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonObject>("outboundIPs"), out var __jsonOutboundIPs) ? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.NetworkProfileOutboundIPs.FromJson(__jsonOutboundIPs) : OutboundIP;}
            {_ingressConfig = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonObject>("ingressConfig"), out var __jsonIngressConfig) ? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IngressConfig.FromJson(__jsonIngressConfig) : IngressConfig;}
            ...
            {_requiredTraffic = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonArray>("requiredTraffics"), out var __jsonRequiredTraffics) ? If( __jsonRequiredTraffics as Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IRequiredTraffic[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IRequiredTraffic) (Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.RequiredTraffic.FromJson(__u) )) ))() : null : RequiredTraffic;}
            {_outboundType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonString>("outboundType"), out var __jsonOutboundType) ? (string)__jsonOutboundType : (string)OutboundType;}
            AfterFromJson(json);
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._ingressConfig ? (Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonNode) this._ingressConfig.ToJson(null,serializationMode) : null, "ingressConfig" ,container.Add );
            ...
            AddIf( null != (((object)this._outboundType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonString(this._outboundType.ToString()) : null, "outboundType" ,container.Add );
