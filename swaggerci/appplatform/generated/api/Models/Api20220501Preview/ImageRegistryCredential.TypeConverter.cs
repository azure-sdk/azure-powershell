...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview
{
    ...
    public partial class ImageRegistryCredentialTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// <summary>
        /// Determines if the converter can convert the <see cref="sourceValue"/> parameter to the <see cref="ImageRegistryCredential"
        /// type/>.
        /// </summary>
        ...
        /// an instance of <see cref="ImageRegistryCredential" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IImageRegistryCredential ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IImageRegistryCredential).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
