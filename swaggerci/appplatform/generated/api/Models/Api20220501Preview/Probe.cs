...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview
{
    ...
    public partial class Probe :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbe,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbeInternal
    {

        /// <summary>Backing field for <see cref="Action" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbeAction _action;

        /// <summary>The action of the probe.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbeAction Action { get => (this._action = this._action ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.ProbeAction()); set => this._action = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbeAction Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbeInternal.Action { get => (this._action = this._action ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.ProbeAction()); set { {_action = value;} } }
    ...
    {
        /// <summary>The action of the probe.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IProbeAction Action { get; set; }
        /// <summary>The type of the action to take to perform the health check.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProbeActionType? ActionType { get; set; }
        /// <summary>Indicate whether the probe is disabled.</summary>
        bool DisableProbe { get; set; }
