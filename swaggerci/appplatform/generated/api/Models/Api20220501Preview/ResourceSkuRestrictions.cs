...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview
{
    ...
    public partial class ResourceSkuRestrictions :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictions,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionsInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfo Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionsInternal.RestrictionInfo { get => (this._restrictionInfo = this._restrictionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.ResourceSkuRestrictionInfo()); set { {_restrictionInfo = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfo _restrictionInfo;

        /// <summary>Gets the information about the restriction where the SKU cannot be used.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfo RestrictionInfo { get => (this._restrictionInfo = this._restrictionInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.ResourceSkuRestrictionInfo()); set => this._restrictionInfo = value; }
        ...
        public string[] RestrictionInfoLocation { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Location; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Location = value ?? null /* arrayOf */; }

        /// <summary>Gets list of availability zones where the SKU is restricted.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public string[] RestrictionInfoZone { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Zone; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfoInternal)RestrictionInfo).Zone = value ?? null /* arrayOf */; }
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ResourceSkuRestrictionsReasonCode? ReasonCode { get; set; }
        /// <summary>Gets the information about the restriction where the SKU cannot be used.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IResourceSkuRestrictionInfo RestrictionInfo { get; set; }
        /// <summary>Gets locations where the SKU is restricted</summary>
        string[] RestrictionInfoLocation { get; set; }
        /// <summary>Gets list of availability zones where the SKU is restricted.</summary>
        string[] RestrictionInfoZone { get; set; }
