...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType Container = @"Container";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType Jar = @"Jar";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType NetCoreZip = @"NetCoreZip";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType Source = @"Source";
        ...
        {
            return new UserSourceType(global::System.Convert.ToString(value));
        }

        /// <summary>Compares values of enum type UserSourceType</summary>
        /// <param name="e">the value to compare against this instance.</param>
        /// <returns><c>true</c> if the two instances are equal to the same value</returns>
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType e1, Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.UserSourceType e2)
        {
            return !e2.Equals(e1);
        }
