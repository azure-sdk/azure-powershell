...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/new-azappplatformapplicationliveview
#>
function New-AzAppPlatformApplicationLiveView {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IApplicationLiveViewResource])]
