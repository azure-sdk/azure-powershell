...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/update-azappplatformgatewaycapacity
#>
function Update-AzAppPlatformGatewayCapacity {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.IGatewayResource])]
