...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.ISupportedBuildpackResource], [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202301Preview.ISupportedBuildpacksCollection])]
