...
PROPERTY <ICustomizedAcceleratorProperties>: Customized accelerator properties payload
  ...
  [IconUrl <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/test-azappplatformcustomizedaccelerator
#>
function Test-AzAppPlatformCustomizedAccelerator {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.ICustomizedAcceleratorValidateResult])]
