...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformpredefinedaccelerator
#>
function Get-AzAppPlatformPredefinedAccelerator {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IPredefinedAcceleratorResource])]
