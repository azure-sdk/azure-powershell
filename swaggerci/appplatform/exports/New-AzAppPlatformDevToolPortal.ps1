...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/new-azappplatformdevtoolportal
#>
function New-AzAppPlatformDevToolPortal {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IDevToolPortalResource])]
