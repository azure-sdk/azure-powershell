...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformgatewayenvsecret
#>
function Get-AzAppPlatformGatewayEnvSecret {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IGatewayEnvSecrets])]
