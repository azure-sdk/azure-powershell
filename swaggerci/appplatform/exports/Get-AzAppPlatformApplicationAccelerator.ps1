...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformapplicationaccelerator
#>
function Get-AzAppPlatformApplicationAccelerator {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IApplicationAcceleratorResource])]
