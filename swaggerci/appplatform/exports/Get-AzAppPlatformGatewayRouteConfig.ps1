...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IGatewayRouteConfigResource
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IGatewayRouteConfigResource])]
