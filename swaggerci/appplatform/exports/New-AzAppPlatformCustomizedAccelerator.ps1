...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.appplatform/new-azappplatformcustomizedaccelerator
#>
function New-AzAppPlatformCustomizedAccelerator {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.ICustomizedAcceleratorResource])]
