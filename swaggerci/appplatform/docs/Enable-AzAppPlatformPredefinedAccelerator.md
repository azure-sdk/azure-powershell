...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/enable-azappplatformpredefinedaccelerator
schema: 2.0.0
---

# Enable-AzAppPlatformPredefinedAccelerator
...
### Enable (Default)
```
Enable-AzAppPlatformPredefinedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### EnableViaIdentity
```
Enable-AzAppPlatformPredefinedAccelerator -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
