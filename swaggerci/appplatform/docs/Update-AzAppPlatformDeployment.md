...
Update-AzAppPlatformDeployment -AppName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-DeploymentSettingEnvironmentVariable <Hashtable>] [-ResourceRequestCpu <String>]
...
Update-AzAppPlatformDeployment -InputObject <IAppPlatformIdentity> [-Active]
 [-DeploymentSettingAddonConfig <Hashtable>] [-DeploymentSettingEnvironmentVariable <Hashtable>]
