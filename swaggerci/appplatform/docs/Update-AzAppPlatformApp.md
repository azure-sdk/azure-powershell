...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.ICustomPersistentDiskResource[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.ILoadedCertificate[]
Parameter Sets: (All)
Aliases:
