...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/remove-azappplatformstorage
schema: 2.0.0
---

# Remove-AzAppPlatformStorage
...
### Delete (Default)
```
Remove-AzAppPlatformStorage -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformStorage -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
