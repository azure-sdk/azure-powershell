...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/remove-azappplatformconfigurationservice
schema: 2.0.0
---

# Remove-AzAppPlatformConfigurationService
...
### Delete (Default)
```
Remove-AzAppPlatformConfigurationService -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformConfigurationService -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
