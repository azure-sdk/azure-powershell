...
New-AzAppPlatformGatewayRouteConfig -GatewayName <String> -ResourceGroupName <String>
 ...
 [-OpenApiUri <String>] [-Route <IGatewayApiRoute[]>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20220501Preview.IGatewayApiRoute[]
Parameter Sets: (All)
Aliases:
