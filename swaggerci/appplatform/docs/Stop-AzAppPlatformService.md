...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/stop-azappplatformservice
schema: 2.0.0
---

# Stop-AzAppPlatformService
...
### Stop (Default)
```
Stop-AzAppPlatformService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzAppPlatformService -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
