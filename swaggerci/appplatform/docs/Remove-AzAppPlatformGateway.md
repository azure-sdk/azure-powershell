...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/remove-azappplatformgateway
schema: 2.0.0
---

# Remove-AzAppPlatformGateway
...
### Delete (Default)
```
Remove-AzAppPlatformGateway -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformGateway -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>] [-AsJob]
