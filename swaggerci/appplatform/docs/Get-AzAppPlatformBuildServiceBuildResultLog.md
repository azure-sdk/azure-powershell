...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformbuildservicebuildresultlog
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzAppPlatformBuildServiceBuildResultLog -BuildName <String> -BuildResultName <String>
...
### GetViaIdentity
```
Get-AzAppPlatformBuildServiceBuildResultLog -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
