...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformdeploymentremotedebuggingconfig
schema: 2.0.0
---

# Get-AzAppPlatformDeploymentRemoteDebuggingConfig
...
### Get (Default)
```
Get-AzAppPlatformDeploymentRemoteDebuggingConfig -AppName <String> -DeploymentName <String>
...
### GetViaIdentity
```
Get-AzAppPlatformDeploymentRemoteDebuggingConfig -InputObject <IAppPlatformIdentity>
