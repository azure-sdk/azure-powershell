...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformpredefinedaccelerator
schema: 2.0.0
---

# Get-AzAppPlatformPredefinedAccelerator
...
### List (Default)
```
Get-AzAppPlatformPredefinedAccelerator -ApplicationAcceleratorName <String> -ResourceGroupName <String>
 -ServiceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAppPlatformPredefinedAccelerator -ApplicationAcceleratorName <String> -Name <String>
...
### GetViaIdentity
```
Get-AzAppPlatformPredefinedAccelerator -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.IPredefinedAcceleratorResource
