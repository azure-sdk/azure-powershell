...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/remove-azappplatformgatewayrouteconfig
schema: 2.0.0
---

# Remove-AzAppPlatformGatewayRouteConfig
...
### Delete (Default)
```
Remove-AzAppPlatformGatewayRouteConfig -GatewayName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzAppPlatformGatewayRouteConfig -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
