...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/test-azappplatformcustomizedaccelerator
schema: 2.0.0
---
...
Test-AzAppPlatformCustomizedAccelerator -ApplicationAcceleratorName <String> -Name <String>
 ...
 [-SubscriptionId <String>] [-AcceleratorTag <String[]>] [-Description <String>] [-DisplayName <String>]
 [-GitRepositoryBranch <String>] [-GitRepositoryCommit <String>] [-GitRepositoryGitTag <String>]
 [-GitRepositoryIntervalInSecond <Int32>] [-IconUrl <String>] [-DefaultProfile <PSObject>] [-PassThru]
...
Test-AzAppPlatformCustomizedAccelerator -InputObject <IAppPlatformIdentity>
 -Property <ICustomizedAcceleratorProperties> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Test-AzAppPlatformCustomizedAccelerator -InputObject <IAppPlatformIdentity> -AuthSettingAuthType <String>
 -GitRepositoryUrl <String> [-AcceleratorTag <String[]>] [-Description <String>] [-DisplayName <String>]
 [-GitRepositoryBranch <String>] [-GitRepositoryCommit <String>] [-GitRepositoryGitTag <String>]
 [-GitRepositoryIntervalInSecond <Int32>] [-IconUrl <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.ICustomizedAcceleratorProperties
...
### Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.ICustomizedAcceleratorProperties

### Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.IAppPlatformIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20221101Preview.ICustomizedAcceleratorValidateResult
