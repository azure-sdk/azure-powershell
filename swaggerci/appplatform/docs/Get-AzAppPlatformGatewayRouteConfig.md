...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/get-azappplatformgatewayrouteconfig
schema: 2.0.0
---

# Get-AzAppPlatformGatewayRouteConfig
...
### List (Default)
```
Get-AzAppPlatformGatewayRouteConfig -GatewayName <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAppPlatformGatewayRouteConfig -GatewayName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzAppPlatformGatewayRouteConfig -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
