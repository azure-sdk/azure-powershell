...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.advisor/get-azadvisor12recommendationssmetadata
#>
function Get-AzAdvisor12RecommendationssMetadata {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20220901.IMetadataEntity])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.Advisor.private\Get-AzAdvisor12RecommendationssMetadata_Get';
            GetViaIdentity = 'Az.Advisor.private\Get-AzAdvisor12RecommendationssMetadata_GetViaIdentity';
        }
