...
online version: https://docs.microsoft.com/en-us/powershell/module/az.advisor/get-azadvisor12recommendationssmetadata
schema: 2.0.0
---

# Get-AzAdvisor12RecommendationssMetadata
...
### Get (Default)
```
Get-AzAdvisor12RecommendationssMetadata -Name <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAdvisor12RecommendationssMetadata -InputObject <IAdvisorIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20220901.IMetadataEntity
