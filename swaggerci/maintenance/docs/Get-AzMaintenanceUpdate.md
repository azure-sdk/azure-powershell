...
```
Get-AzMaintenanceUpdate -ProviderName <String> -ResourceGroupName <String> -ResourceName <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.Maintenance.Models.Api20220701Preview.IUpdate
