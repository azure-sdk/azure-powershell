...
New-AzLogzMonitor -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 [-IdentityType <ManagedIdentityTypes>] [-LogzOrganizationPropertyCompanyName <String>]
 [-LogzOrganizationPropertyEnterpriseAppId <String>] [-LogzOrganizationPropertySingleSignOnUrl <String>]
