...
```
New-AzLogzSubAccountTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
 -SubAccountName <String> [-SubscriptionId <String>] [-LogRuleFilteringTag <IFilteringTag[]>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IFilteringTag[]
Parameter Sets: (All)
Aliases:
