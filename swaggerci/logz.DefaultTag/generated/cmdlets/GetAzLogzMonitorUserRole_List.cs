...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListUserRoles=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/listUserRoles"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzLogzMonitorUserRole_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Description(@"List the user's roles configured on Logz.io side for the account corresponding to the monitor resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/listUserRoles", ApiVersion = "2020-10-01")]
    public partial class GetAzLogzMonitorUserRole_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleRequest _body;

        /// <summary>Request for checking user's role for Logz.io account.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request for checking user's role for Logz.io account.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Request for checking user's role for Logz.io account.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleRequest Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleListResponse">Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleListResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleListResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLogzMonitorUserRole_List" /> cmdlet class.
        /// </summary>
        public GetAzLogzMonitorUserRole_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MonitorsListUserRoles' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.MonitorsListUserRoles(SubscriptionId, ResourceGroupName, MonitorName, Body, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,MonitorName=MonitorName,body=Body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MonitorName=MonitorName, body=Body })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MonitorName=MonitorName, body=Body })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Logz.Models.Api20201001.IUserRoleListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.MonitorsListUserRoles_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
