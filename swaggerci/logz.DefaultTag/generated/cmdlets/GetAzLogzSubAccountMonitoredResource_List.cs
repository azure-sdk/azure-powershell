...
namespace Microsoft.Azure.PowerShell.Cmdlets.Logz.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListMonitoredResources=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/accounts/{subAccountName}/listMonitoredResources"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzLogzSubAccountMonitoredResource_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Description(@"List the resources currently being monitored by the Logz sub account resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Logz.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logz/monitors/{monitorName}/accounts/{subAccountName}/listMonitoredResources", ApiVersion = "2020-10-01")]
    public partial class GetAzLogzSubAccountMonitoredResource_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Logz.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLogzSubAccountMonitoredResource_List" /> cmdlet class.
        /// </summary>
        public GetAzLogzSubAccountMonitoredResource_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SubAccountListMonitoredResources' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SubAccountListMonitoredResources(SubscriptionId, ResourceGroupName, MonitorName, SubAccountName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.SubAccountListMonitoredResources_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
