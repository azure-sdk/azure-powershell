...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IOperationResult
.Link
https://learn.microsoft.com/powershell/module/az.datadog/get-azdatadogoperation
#>
function Get-AzDatadogOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IOperationResult])]
