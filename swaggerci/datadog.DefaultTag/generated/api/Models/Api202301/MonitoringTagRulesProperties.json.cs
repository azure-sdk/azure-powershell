...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301
{
    ...
    public partial class MonitoringTagRulesProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IMonitoringTagRulesProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IMonitoringTagRulesProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IMonitoringTagRulesProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject json ? new MonitoringTagRulesProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject into a new instance of <see cref="MonitoringTagRulesProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MonitoringTagRulesProperties(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject json)
        {
            ...
            {_logRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject>("logRules"), out var __jsonLogRules) ? Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.LogRules.FromJson(__jsonLogRules) : LogRule;}
            {_metricRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject>("metricRules"), out var __jsonMetricRules) ? Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.MetricRules.FromJson(__jsonMetricRules) : MetricRule;}
            ...
            {_automuting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonBoolean>("automuting"), out var __jsonAutomuting) ? (bool?)__jsonAutomuting : Automuting;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MonitoringTagRulesProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MonitoringTagRulesProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" />.
        /// </returns>
