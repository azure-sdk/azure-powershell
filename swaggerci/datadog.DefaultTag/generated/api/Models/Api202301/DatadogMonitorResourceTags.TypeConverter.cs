...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301
{
    ...
    public partial class DatadogMonitorResourceTagsTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="DatadogMonitorResourceTags" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IDatadogMonitorResourceTags ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IDatadogMonitorResourceTags).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
