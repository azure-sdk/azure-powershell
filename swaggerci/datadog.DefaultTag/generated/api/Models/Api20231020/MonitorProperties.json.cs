...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020
{
    ...
    public partial class MonitorProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IMonitorProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IMonitorProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IMonitorProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode node)
        {
        ...
        internal MonitorProperties(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject json)
        {
            ...
            {_datadogOrganizationProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject>("datadogOrganizationProperties"), out var __jsonDatadogOrganizationProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.DatadogOrganizationProperties.FromJson(__jsonDatadogOrganizationProperties) : DatadogOrganizationProperty;}
            {_userInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject>("userInfo"), out var __jsonUserInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.UserInfo.FromJson(__jsonUserInfo) : UserInfo;}
