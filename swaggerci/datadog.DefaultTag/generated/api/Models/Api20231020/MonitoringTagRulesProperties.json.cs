...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020
{
    ...
    public partial class MonitoringTagRulesProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IMonitoringTagRulesProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IMonitoringTagRulesProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IMonitoringTagRulesProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonNode node)
        {
        ...
        internal MonitoringTagRulesProperties(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject json)
        {
            ...
            {_logRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject>("logRules"), out var __jsonLogRules) ? Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.LogRules.FromJson(__jsonLogRules) : LogRule;}
            {_metricRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonObject>("metricRules"), out var __jsonMetricRules) ? Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.MetricRules.FromJson(__jsonMetricRules) : MetricRule;}
            ...
            {_customMetric = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Datadog.Runtime.Json.JsonBoolean>("customMetrics"), out var __jsonCustomMetrics) ? (bool?)__jsonCustomMetrics : CustomMetric;}
            AfterFromJson(json);
        }
