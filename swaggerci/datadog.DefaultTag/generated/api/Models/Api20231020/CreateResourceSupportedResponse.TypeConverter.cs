...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020
{
    ...
    public partial class CreateResourceSupportedResponseTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="CreateResourceSupportedResponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.ICreateResourceSupportedResponse ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.ICreateResourceSupportedResponse).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
