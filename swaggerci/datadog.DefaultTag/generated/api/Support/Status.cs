...
namespace Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status Active = @"Active";

        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status InProgress = @"InProgress";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.Datadog.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
