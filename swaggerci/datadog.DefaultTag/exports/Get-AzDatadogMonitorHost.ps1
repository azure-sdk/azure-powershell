...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IDatadogHost
.Link
https://learn.microsoft.com/powershell/module/az.datadog/get-azdatadogmonitorhost
#>
function Get-AzDatadogMonitorHost {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IDatadogHost])]
