...
New-AzDatadogMonitor -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
 ...
 [-DatadogOrganizationPropertyCspm] [-DatadogOrganizationPropertyEnterpriseAppId <String>]
 [-DatadogOrganizationPropertyId <String>] [-DatadogOrganizationPropertyLinkingAuthCode <String>]
 [-DatadogOrganizationPropertyLinkingClientId <String>] [-DatadogOrganizationPropertyName <String>]
 [-DatadogOrganizationPropertyRedirectUri <String>] [-IdentityType <ManagedIdentityTypes>]
 [-MonitoringStatus <MonitoringStatus>] [-SkuName <String>] [-Tag <Hashtable>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api20231020.IDatadogMonitorResource
