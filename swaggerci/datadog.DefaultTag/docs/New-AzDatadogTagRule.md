...
New-AzDatadogTagRule -MonitorName <String> -ResourceGroupName <String> -RuleSetName <String>
 [-SubscriptionId <String>] [-Automuting] [-LogRuleFilteringTag <IFilteringTag[]>] [-LogRuleSendAadLog]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Datadog.Models.Api202301.IFilteringTag[]
Parameter Sets: (All)
Aliases:
