...
online version: https://learn.microsoft.com/powershell/module/az.managementgroupsapi/get-azmanagementgroupsapientitiesoperation
schema: 2.0.0
---

# Get-AzManagementGroupsApiEntitiesOperation
...
```
Get-AzManagementGroupsApiEntitiesOperation [-Filter <String>] [-GroupName <String>]
 [-Search <EntitySearchType>] [-Select <String>] [-Skip <Int32>] [-Skiptoken <String>] [-Top <Int32>]
 [-View <EntityViewParameterType>] [-CacheControl <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
