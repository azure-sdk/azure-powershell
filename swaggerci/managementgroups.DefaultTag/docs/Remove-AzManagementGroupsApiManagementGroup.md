...
### Delete (Default)
```
Remove-AzManagementGroupsApiManagementGroup -GroupId <String> [-CacheControl <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzManagementGroupsApiManagementGroup -InputObject <IManagementGroupsApiIdentity>
 [-CacheControl <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
