...
namespace Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20230401.IPatchManagementGroupRequest _propertiesBody = new Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api20230401.PatchManagementGroupRequest();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ParentGroupId { get => _propertiesBody.ParentGroupId ?? null; set => _propertiesBody.ParentGroupId = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ManagementGroupsUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, _propertiesBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ManagementGroupsUpdate(this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, InputObject.GroupId ?? null, _propertiesBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  CacheControl=this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null,body=_propertiesBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ManagementGroupsApi.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { CacheControl=this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, body=_propertiesBody })
                    {
