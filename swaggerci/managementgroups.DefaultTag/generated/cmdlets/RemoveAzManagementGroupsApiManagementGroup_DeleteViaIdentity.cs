            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.ManagementGroupsDelete(this.InvocationInformation.BoundParameters.ContainsKey("CacheControl") ? CacheControl : null, InputObject.GroupId ?? null, onNoContent, onDefault, this, Pipeline);
                    }
