...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.QuotaExtensionApi.Models.Api20230201.IQuotaRequestDetails])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.QuotaExtensionApi.Models.Api20230201.ICurrentUsagesBase])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.QuotaExtensionApi.Category('Path')]
