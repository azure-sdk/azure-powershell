...
online version: https://learn.microsoft.com/powershell/module/az.quotaextensionapi/remove-azquotaextensionapigroupquotasubscription
schema: 2.0.0
---

# Remove-AzQuotaExtensionApiGroupQuotaSubscription
...
### Delete (Default)
```
Remove-AzQuotaExtensionApiGroupQuotaSubscription -GroupQuotaName <String> -ManagementGroupId <String>
...
### DeleteViaIdentity
```
Remove-AzQuotaExtensionApiGroupQuotaSubscription -InputObject <IQuotaExtensionApiIdentity>
