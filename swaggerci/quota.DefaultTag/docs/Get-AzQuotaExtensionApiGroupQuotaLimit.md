...
online version: https://learn.microsoft.com/powershell/module/az.quotaextensionapi/get-azquotaextensionapigroupquotalimit
schema: 2.0.0
---

# Get-AzQuotaExtensionApiGroupQuotaLimit
...
```
Get-AzQuotaExtensionApiGroupQuotaLimit -GroupQuotaName <String> -Location <String> -ManagementGroupId <String>
