...
online version: https://learn.microsoft.com/powershell/module/az.quotaextensionapi/remove-azquotaextensionapigroupquota
schema: 2.0.0
---

# Remove-AzQuotaExtensionApiGroupQuota
...
### Delete (Default)
```
Remove-AzQuotaExtensionApiGroupQuota -ManagementGroupId <String> -Name <String> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzQuotaExtensionApiGroupQuota -InputObject <IQuotaExtensionApiIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
