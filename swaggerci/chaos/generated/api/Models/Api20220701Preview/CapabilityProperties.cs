...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview
{
    ...
    public partial class CapabilityProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityPropertiesInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for ParametersSchema</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityPropertiesInternal.ParametersSchema { get => this._parametersSchema; set { {_parametersSchema = value;} } }

        /// <summary>Internal Acessors for Publisher</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityPropertiesInternal.Publisher { get => this._publisher; set { {_publisher = value;} } }

        /// <summary>Internal Acessors for TargetType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityPropertiesInternal.TargetType { get => this._targetType; set { {_targetType = value;} } }

        /// <summary>Internal Acessors for Urn</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapabilityPropertiesInternal.Urn { get => this._urn; set { {_urn = value;} } }
