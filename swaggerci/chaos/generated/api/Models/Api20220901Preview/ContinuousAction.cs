...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview
{
    ...
    public partial class ContinuousAction :
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IContinuousAction,
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IContinuousActionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IAction"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IAction __action = new Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.Action();
        ...
        public string Name { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IActionInternal)__action).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IActionInternal)__action).Name = value ; }

        /// <summary>Backing field for <see cref="Parameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IKeyValuePair[] _parameter;

        /// <summary>List of key value pairs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IKeyValuePair[] Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Inherited)]
        public string Type { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IActionInternal)__action).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IActionInternal)__action).Type = value ; }
    ...
    public partial interface IContinuousAction :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IAction
    {
        /// <summary>ISO8601 formatted string that represents a duration.</summary>
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IKeyValuePair) })]
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IKeyValuePair[] Parameter { get; set; }
        /// <summary>String that represents a selector.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(
        Required = true,
        ReadOnly = false,
    ...
    internal partial interface IContinuousActionInternal :
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IActionInternal
    {
        /// <summary>ISO8601 formatted string that represents a duration.</summary>
        string Duration { get; set; }
        /// <summary>List of key value pairs.</summary>
