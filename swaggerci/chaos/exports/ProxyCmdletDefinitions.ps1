...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.IExperimentExecutionDetails])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Path')]
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.ITargetType])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Parameter(ParameterSetName='List', Mandatory)]
