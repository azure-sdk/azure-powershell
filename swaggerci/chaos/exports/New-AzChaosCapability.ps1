...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapability
.Link
https://docs.microsoft.com/en-us/powershell/module/az.chaos/new-azchaoscapability
#>
function New-AzChaosCapability {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.ICapability])]
