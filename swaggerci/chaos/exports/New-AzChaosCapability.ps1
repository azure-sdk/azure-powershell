...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.ICapability
.Link
https://learn.microsoft.com/powershell/module/az.chaos/new-azchaoscapability
#>
function New-AzChaosCapability {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.ICapability])]
