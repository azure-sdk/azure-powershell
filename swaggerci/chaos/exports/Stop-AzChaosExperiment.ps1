...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IExperimentCancelOperationResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IExperimentCancelOperationResult])]
