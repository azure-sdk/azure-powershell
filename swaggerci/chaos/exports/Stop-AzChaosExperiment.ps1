...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.IExperimentCancelOperationResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.IExperimentCancelOperationResult])]
