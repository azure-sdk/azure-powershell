...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.IExperimentCancelOperationResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.IExperimentCancelOperationResult])]
