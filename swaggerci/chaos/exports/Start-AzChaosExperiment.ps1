...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.IExperimentStartOperationResult
.Notes
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.IExperimentStartOperationResult])]
