...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.Info(Required, PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.ITargetProperties]))]
