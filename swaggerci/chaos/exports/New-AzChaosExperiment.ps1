...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.IExperiment])]
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20221001Preview.IStep[]]
    # List of steps.
