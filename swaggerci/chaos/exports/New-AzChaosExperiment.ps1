...
SELECTOR <ISelector[]>: List of selectors.
  FilterZone <String[]>: List of zones.
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IExperiment])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.ISelector[]]
    # List of selectors.
    ...
    [AllowEmptyCollection()]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220901Preview.IStep[]]
    # List of steps.
