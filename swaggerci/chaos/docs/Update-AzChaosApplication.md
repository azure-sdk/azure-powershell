...
online version: https://learn.microsoft.com/powershell/module/az.chaos/update-azchaosapplication
schema: 2.0.0
---

# Update-AzChaosApplication
...
```
Update-AzChaosApplication -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzChaosApplication -InputObject <IChaosIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
