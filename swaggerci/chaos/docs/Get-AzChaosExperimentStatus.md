...
online version: https://docs.microsoft.com/en-us/powershell/module/az.chaos/get-azchaosexperimentstatus
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzChaosExperimentStatus -ExperimentName <String> -ResourceGroupName <String> -StatusId <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzChaosExperimentStatus -InputObject <IChaosIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.Api20220701Preview.IExperimentStatus
