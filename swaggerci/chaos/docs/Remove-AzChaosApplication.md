...
online version: https://learn.microsoft.com/powershell/module/az.chaos/remove-azchaosapplication
schema: 2.0.0
---

# Remove-AzChaosApplication
...
### Delete (Default)
```
Remove-AzChaosApplication -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzChaosApplication -InputObject <IChaosIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
