...
online version: https://docs.microsoft.com/en-us/powershell/module/az.chaos/remove-azchaostarget
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzChaosTarget -InputObject <IChaosIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
