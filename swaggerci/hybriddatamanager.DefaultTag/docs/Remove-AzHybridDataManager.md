...
online version: https://learn.microsoft.com/powershell/module/az.hybrid/remove-azhybriddatamanager
schema: 2.0.0
---

# Remove-AzHybridDataManager
...
### Delete (Default)
```
Remove-AzHybridDataManager -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridDataManager -InputObject <IHybridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
