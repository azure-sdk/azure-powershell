...
online version: https://learn.microsoft.com/powershell/module/az.hybridcloud/update-azhybridcloudconnectiontag
schema: 2.0.0
---

# Update-AzHybridCloudConnectionTag
...
```
Update-AzHybridCloudConnectionTag -CloudConnectionName <String> -ResourceGroupName <String>
...
```
Update-AzHybridCloudConnectionTag -InputObject <IHybridCloudIdentity> [-Tag <Hashtable>]
