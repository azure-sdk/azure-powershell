...
online version: https://learn.microsoft.com/powershell/module/az.hybridcloud/find-azhybridcloudconnectorresource
schema: 2.0.0
---

# Find-AzHybridCloudConnectorResource
...
### Discover (Default)
```
Find-AzHybridCloudConnectorResource -CloudConnectorName <String> -ResourceGroupName <String>
...
### DiscoverViaIdentity
```
Find-AzHybridCloudConnectorResource -InputObject <IHybridCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
