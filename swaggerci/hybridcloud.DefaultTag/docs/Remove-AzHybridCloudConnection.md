...
online version: https://learn.microsoft.com/powershell/module/az.hybridcloud/remove-azhybridcloudconnection
schema: 2.0.0
---

# Remove-AzHybridCloudConnection
...
### Delete (Default)
```
Remove-AzHybridCloudConnection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzHybridCloudConnection -InputObject <IHybridCloudIdentity> [-DefaultProfile <PSObject>] [-AsJob]
