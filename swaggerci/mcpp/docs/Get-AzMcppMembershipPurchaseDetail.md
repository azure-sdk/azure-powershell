...
external help file:
Module Name: Az.Mcpp
online version: https://learn.microsoft.com/powershell/module/az.mcpp/get-azmcppmembershippurchasedetail
schema: 2.0.0
---

# Get-AzMcppMembershipPurchaseDetail
...
### Get (Default)
```
Get-AzMcppMembershipPurchaseDetail -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMcppMembershipPurchaseDetail -InputObject <IMcppIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
