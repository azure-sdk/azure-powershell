      ...
      [Default <IK8SSchedulingOptions>]: The kubernetes scheduling options. It describes restrictions used to help Kubernetes select appropriate nodes to host the database service
        ...
        [Resource <IK8SResourceRequirements>]: The kubernetes resource limits and requests used to restrict or reserve resource usage.
          ...
          [Request <IK8SResourceRequirementsRequests>]: Requests for a kubernetes resource type (e.g 'cpu', 'memory'). The 'cpu' request must be less than or equal to 'cpu' limit. Default 'cpu' is 2, minimum is 1. Default 'memory' is '4Gi', minimum is '2Gi. If sku.tier is GeneralPurpose, maximum 'cpu' is 24 and maximum 'memory' is '128Gi'.
            [(Any) <String>]: This indicates any property can be added to this object.
    [Security <IK8SSecurity>]: The kubernetes security information.
      [(Any) <Object>]: This indicates any property can be added to this object.
      [ActiveDirectoryAccountName <String>]: Account name for AAD
      [ActiveDirectoryEncryptionType <String[]>]: An array of encryption types
      [ActiveDirectoryKeytabSecret <String>]: Keytab secret used to authenticate with Active Directory.
      [AdminLoginSecret <String>]: Admin login secret key
      [ConnectorName <String>]: Name of the connector
      [ConnectorNamespace <String>]: Name space of the connector
      [ServiceCertificateSecret <String>]: Service certificate secret used
      [TransparentDataEncryptionMode <String>]: Transparent data encryption mode. Can be Service Managed, Customer managed or disabled
      [TransparentDataEncryptionProtectorSecret <String>]: Protector secret for customer managed Transparent data encryption mode
    [Setting <IK8SSettings>]: The kubernetes settings information.
      [(Any) <Object>]: This indicates any property can be added to this object.
      [NetworkForceencryption <Int32?>]: If 1, then SQL Server forces all connections to be encrypted. By default, this option is 0
      [NetworkTlscipher <String>]: Specifies which ciphers are allowed by SQL Server for TLS
      [NetworkTlsprotocol <String>]: A comma-separated list of which TLS protocols are allowed by SQL Server
.Link
