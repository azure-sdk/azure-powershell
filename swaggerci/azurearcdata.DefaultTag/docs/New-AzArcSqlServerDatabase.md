...
external help file:
Module Name: Az.Arc
online version: https://learn.microsoft.com/powershell/module/az.arc/new-azarcsqlserverdatabase
schema: 2.0.0
---

# New-AzArcSqlServerDatabase
...
```
New-AzArcSqlServerDatabase -DatabaseName <String> -ResourceGroupName <String> -SqlServerInstanceName <String>
 -Location <String> [-SubscriptionId <String>] [-BackupInformationLastFullBackup <DateTime>]
