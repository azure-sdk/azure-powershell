...
online version: https://learn.microsoft.com/powershell/module/az.customproviders/new-azcustomprovidersassociation
schema: 2.0.0
---

# New-AzCustomprovidersAssociation
...
```
New-AzCustomprovidersAssociation -Name <String> -Scope <String> [-TargetResourceId <String>]
