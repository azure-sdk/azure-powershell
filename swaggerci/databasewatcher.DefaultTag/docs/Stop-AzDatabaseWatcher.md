...
online version: https://learn.microsoft.com/powershell/module/az.databasewatcher/stop-azdatabasewatcher
schema: 2.0.0
---

# Stop-AzDatabaseWatcher
...
### Stop (Default)
```
Stop-AzDatabaseWatcher -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzDatabaseWatcher -InputObject <IDatabaseWatcherIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
