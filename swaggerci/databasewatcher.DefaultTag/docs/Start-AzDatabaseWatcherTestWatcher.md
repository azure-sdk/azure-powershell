...
online version: https://learn.microsoft.com/powershell/module/az.databasewatchertest/start-azdatabasewatchertestwatcher
schema: 2.0.0
---

# Start-AzDatabaseWatcherTestWatcher
...
### Start (Default)
```
Start-AzDatabaseWatcherTestWatcher -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzDatabaseWatcherTestWatcher -InputObject <IDatabaseWatcherTestIdentity> [-DefaultProfile <PSObject>]
