...
online version: https://learn.microsoft.com/powershell/module/az.databasewatchertest/update-azdatabasewatchertestwatcher
schema: 2.0.0
---
...
```
Update-AzDatabaseWatcherTestWatcher -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzDatabaseWatcherTestWatcher -InputObject <IDatabaseWatcherTestIdentity>
 [-DatastoreAdxClusterResourceId <String>] [-DatastoreKustoClusterDisplayName <String>]
 [-DatastoreKustoClusterUri <String>] [-DatastoreKustoDatabaseName <String>]
 [-DatastoreKustoDataIngestionUri <String>] [-DatastoreKustoManagementUrl <String>]
 [-DatastoreKustoOfferingType <KustoOfferingType>] [-DefaultAlertRuleIdentityResourceId <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcherTest.Support.KustoOfferingType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcherTest.Support.ManagedServiceIdentityType
Parameter Sets: (All)
Aliases:
