...
online version: https://learn.microsoft.com/powershell/module/az.databasewatchertest/stop-azdatabasewatchertestwatcher
schema: 2.0.0
---

# Stop-AzDatabaseWatcherTestWatcher
...
### Stop (Default)
```
Stop-AzDatabaseWatcherTestWatcher -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzDatabaseWatcherTestWatcher -InputObject <IDatabaseWatcherTestIdentity> [-DefaultProfile <PSObject>]
