...
online version: https://learn.microsoft.com/powershell/module/az.databasewatcher/new-azdatabasewatcher
schema: 2.0.0
---

# New-AzDatabaseWatcher
...
```
New-AzDatabaseWatcher -Name <String> -ResourceGroupName <String> -Location <String> [-SubscriptionId <String>]
