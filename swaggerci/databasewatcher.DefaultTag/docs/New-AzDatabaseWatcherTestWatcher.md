...
online version: https://learn.microsoft.com/powershell/module/az.databasewatchertest/new-azdatabasewatchertestwatcher
schema: 2.0.0
---

# New-AzDatabaseWatcherTestWatcher
...
```
New-AzDatabaseWatcherTestWatcher -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-DatastoreAdxClusterResourceId <String>]
