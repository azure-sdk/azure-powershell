...
namespace Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcherTest.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcherTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcherTest.Support";
