...
namespace Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Models.Api20230901Preview
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Models.Api20230901Preview.ITargetPropertiesInternal
    {
        ...
        /// <summary>Backing field for <see cref="TargetCollectionStatus" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.String? _targetCollectionStatus;

        /// <summary>The target collection status.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Origin(Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.String? TargetCollectionStatus { get => this._targetCollectionStatus; set => this._targetCollectionStatus = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"targetCollectionStatus",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.String) })]
        Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.String? TargetCollectionStatus { get; set; }
        /// <summary>Discriminator property for TargetProperties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        Required = false,
        ReadOnly = false,
        Description = @"The ARM ResourceId of the Key Vault instance storing database authentication secrets.",
