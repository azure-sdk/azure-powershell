...
namespace Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support
{
        ...
        System.IEquatable<SharedPrivateLinkResourceStatus>
    {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus Approved = @"Approved";

        /// <summary>
        /// The shared private link connection request was disconnected by the resource owner.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus Disconnected = @"Disconnected";

        /// <summary>
        /// The shared private link connection request was not yet authorized by the resource owner.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus Pending = @"Pending";

        /// <summary>The shared private link connection request was rejected by the resource owner.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus e1, Microsoft.Azure.PowerShell.Cmdlets.DatabaseWatcher.Support.SharedPrivateLinkResourceStatus e2)
        {
            return !e2.Equals(e1);
        }
