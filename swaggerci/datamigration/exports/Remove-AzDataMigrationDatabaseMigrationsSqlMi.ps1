...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.datamigration/remove-azdatamigrationdatabasemigrationssqlmi
#>
function Remove-AzDataMigrationDatabaseMigrationsSqlMi {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DataMigration.private\Remove-AzDataMigrationDatabaseMigrationsSqlMi_Delete';
            DeleteViaIdentity = 'Az.DataMigration.private\Remove-AzDataMigrationDatabaseMigrationsSqlMi_DeleteViaIdentity';
        }
