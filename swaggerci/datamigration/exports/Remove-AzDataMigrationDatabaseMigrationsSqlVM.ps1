...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.datamigration/remove-azdatamigrationdatabasemigrationssqlvm
#>
function Remove-AzDataMigrationDatabaseMigrationsSqlVM {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.DataMigration.private\Remove-AzDataMigrationDatabaseMigrationsSqlVM_Delete';
            DeleteViaIdentity = 'Az.DataMigration.private\Remove-AzDataMigrationDatabaseMigrationsSqlVM_DeleteViaIdentity';
        }
