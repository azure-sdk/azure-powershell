...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.datamigration/get-azdatamigrationdatabasemigrationsqlvm
#>
function Get-AzDataMigrationDatabaseMigrationSqlVM {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IDatabaseMigrationSqlVMListResult])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DataMigration.private\Get-AzDataMigrationDatabaseMigrationSqlVM_List';
        }
