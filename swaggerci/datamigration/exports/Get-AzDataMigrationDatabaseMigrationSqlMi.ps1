...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.datamigration/get-azdatamigrationdatabasemigrationsqlmi
#>
function Get-AzDataMigrationDatabaseMigrationSqlMi {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IDatabaseMigrationSqlMiListResult])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DataMigration.private\Get-AzDataMigrationDatabaseMigrationSqlMi_List';
        }
