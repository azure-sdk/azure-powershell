...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationSqlDb
.Link
...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationSqlDb])]
