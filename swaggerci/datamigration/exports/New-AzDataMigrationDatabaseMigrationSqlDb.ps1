...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IDatabaseMigrationSqlDb])]
...
param(
    ...
    ${KeyVaultFileSharePasswordSecretName},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category('Body')]
    [System.String]
    # Key Vault Secret Name corresponding to file share username.
    ${KeyVaultFileShareUsernameSecretName},
    ...
    ${KeyVaultSourcePasswordSecretName},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category('Body')]
    [System.String]
    # Key Vault Secret Name corresponding to source username.
    ${KeyVaultSourceUsernameSecretName},
