...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.datamigration/invoke-azdatamigrationmonitoringsqlmigrationservicedata
#>
function Invoke-AzDataMigrationMonitoringSqlMigrationServiceData {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IIntegrationRuntimeMonitoringData])]
[CmdletBinding(DefaultParameterSetName='Monitoring', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Monitoring', Mandatory)]
    ...
    [Parameter(ParameterSetName='MonitoringViaIdentity', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.IDataMigrationIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            Monitoring = 'Az.DataMigration.private\Invoke-AzDataMigrationMonitoringSqlMigrationServiceData_Monitoring';
            MonitoringViaIdentity = 'Az.DataMigration.private\Invoke-AzDataMigrationMonitoringSqlMigrationServiceData_MonitoringViaIdentity';
        }
        if (('Monitoring') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
