...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.datamigration/invoke-azdatamigrationretrydatabasemigrationsqldb
#>
function Invoke-AzDataMigrationRetryDatabaseMigrationSqlDb {
...
param(
    ...
    [Parameter(ParameterSetName='RetryExpanded')]
    [Parameter(ParameterSetName='RetryViaIdentityExpanded')]
    [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Category('Body')]
    [System.String]
...
begin {
    try {
        ...
        $mapping = @{
            Retry = 'Az.DataMigration.private\Invoke-AzDataMigrationRetryDatabaseMigrationSqlDb_Retry';
            RetryExpanded = 'Az.DataMigration.private\Invoke-AzDataMigrationRetryDatabaseMigrationSqlDb_RetryExpanded';
            RetryViaIdentity = 'Az.DataMigration.private\Invoke-AzDataMigrationRetryDatabaseMigrationSqlDb_RetryViaIdentity';
            RetryViaIdentityExpanded = 'Az.DataMigration.private\Invoke-AzDataMigrationRetryDatabaseMigrationSqlDb_RetryViaIdentityExpanded';
        }
