...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datamigration/remove-azdatamigrationdatabasemigrationssqlmi
schema: 2.0.0
---

# Remove-AzDataMigrationDatabaseMigrationsSqlMi
...
### Delete (Default)
```
Remove-AzDataMigrationDatabaseMigrationsSqlMi -ManagedInstanceName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDataMigrationDatabaseMigrationsSqlMi -InputObject <IDataMigrationIdentity> [-Force]
