...
### Cancel (Default)
```
Stop-AzDataMigrationTask -GroupName <String> -Name <String> -ProjectName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-AzDataMigrationTask -InputObject <IDataMigrationIdentity> [-DefaultProfile <PSObject>] [-Confirm]
...
### Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IProjectTask
