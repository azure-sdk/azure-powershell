...
online version: https://docs.microsoft.com/en-us/powershell/module/az.datamigration/remove-azdatamigrationdatabasemigrationssqlvm
schema: 2.0.0
---

# Remove-AzDataMigrationDatabaseMigrationsSqlVM
...
### Delete (Default)
```
Remove-AzDataMigrationDatabaseMigrationsSqlVM -ResourceGroupName <String> -SqlVirtualMachineName <String>
...
### DeleteViaIdentity
```
Remove-AzDataMigrationDatabaseMigrationsSqlVM -InputObject <IDataMigrationIdentity> [-Force]
