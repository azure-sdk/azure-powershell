...
New-AzDataMigrationDatabaseMigrationSqlDb -ResourceGroupName <String> -SqlDbInstanceName <String>
 -TargetDbName <String> [-SubscriptionId <String>] [-KeyVaultFileSharePasswordSecretName <String>]
 [-KeyVaultFileShareUsernameSecretName <String>] [-KeyVaultName <String>]
 [-KeyVaultSourcePasswordSecretName <String>] [-KeyVaultSourceUsernameSecretName <String>] [-Kind <String>]
 [-Location <String>] [-MigrationOperationId <String>] [-MigrationService <String>]
