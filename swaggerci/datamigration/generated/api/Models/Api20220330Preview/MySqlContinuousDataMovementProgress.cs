...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class MySqlContinuousDataMovementProgress :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgress,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutput _binlogPosition;

        /// <summary>Current binlog position of the last event committed at target</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutput BinlogPosition { get => (this._binlogPosition = this._binlogPosition ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.MySqlBinlogPositionOutput()); }
        ...
        public int? BinlogPositionFileSeqNum { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).FileSeqNum; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).FileSeqNum = value ?? default(int); }

        /// <summary>Specifies the MySQL binlog file name</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Inlined)]
        public string BinlogPositionName { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).Name; }

        /// <summary>Specifies the position in the binlog file</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Inlined)]
        public long? BinlogPositionPosition { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).Position; }

        /// <summary>Internal Acessors for BinlogPosition</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutput Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.BinlogPosition { get => (this._binlogPosition = this._binlogPosition ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.MySqlBinlogPositionOutput()); set { {_binlogPosition = value;} } }

        /// <summary>Internal Acessors for BinlogPositionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.BinlogPositionName { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).Name = value; }

        /// <summary>Internal Acessors for BinlogPositionPosition</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.BinlogPositionPosition { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).Position; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutputInternal)BinlogPosition).Position = value; }

        /// <summary>Internal Acessors for NumberOfDeleteRowsEventsProcessed</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfDeleteRowsEventsProcessed { get => this._numberOfDeleteRowsEventsProcessed; set { {_numberOfDeleteRowsEventsProcessed = value;} } }

        /// <summary>Internal Acessors for NumberOfQueryEventsProcessed</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfQueryEventsProcessed { get => this._numberOfQueryEventsProcessed; set { {_numberOfQueryEventsProcessed = value;} } }

        /// <summary>Internal Acessors for NumberOfRowsDeleted</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfRowsDeleted { get => this._numberOfRowsDeleted; set { {_numberOfRowsDeleted = value;} } }

        /// <summary>Internal Acessors for NumberOfRowsInserted</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfRowsInserted { get => this._numberOfRowsInserted; set { {_numberOfRowsInserted = value;} } }

        /// <summary>Internal Acessors for NumberOfRowsUpdated</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfRowsUpdated { get => this._numberOfRowsUpdated; set { {_numberOfRowsUpdated = value;} } }

        /// <summary>Internal Acessors for NumberOfUpdateRowsEventsProcessed</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfUpdateRowsEventsProcessed { get => this._numberOfUpdateRowsEventsProcessed; set { {_numberOfUpdateRowsEventsProcessed = value;} } }

        /// <summary>Internal Acessors for NumberOfWriteRowsEventsProcessed</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.NumberOfWriteRowsEventsProcessed { get => this._numberOfWriteRowsEventsProcessed; set { {_numberOfWriteRowsEventsProcessed = value;} } }

        /// <summary>Internal Acessors for SecondsBehindSource</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.SecondsBehindSource { get => this._secondsBehindSource; set { {_secondsBehindSource = value;} } }

        /// <summary>Internal Acessors for Timestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlContinuousDataMovementProgressInternal.Timestamp { get => this._timestamp; set { {_timestamp = value;} } }
    ...
    {
        /// <summary>Current binlog position of the last event committed at target</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMySqlBinlogPositionOutput BinlogPosition { get; set; }
        /// <summary>
        /// Specifies the the sequential number of the binlog fie, extracted from the file name
        /// </summary>
        int? BinlogPositionFileSeqNum { get; set; }
