...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class MigrateOracleAzureDbPostgreSqlSyncTaskOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateOracleAzureDbPostgreSqlSyncTaskOutput.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateOracleAzureDbPostgreSqlSyncTaskOutput
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateOracleAzureDbPostgreSqlSyncTaskOutput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateOracleAzureDbPostgreSqlSyncTaskOutput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("resultType") )
            {
                ...
                {
                    return new MigrateOracleAzureDbPostgreSqlSyncTaskOutputMigrationLevel(json);
                }
                case "DatabaseLevelOutput":
                {
                    return new MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseLevel(json);
                }
                case "TableLevelOutput":
                {
                    return new MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel(json);
                }
                case "ErrorOutput":
                {
                    return new MigrateOracleAzureDbPostgreSqlSyncTaskOutputError(json);
                }
                case "DatabaseLevelErrorOutput":
                {
                    return new MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseError(json);
                }
            }
            return new MigrateOracleAzureDbPostgreSqlSyncTaskOutput(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrateOracleAzureDbPostgreSqlSyncTaskOutput"
        /// />.
        /// </summary>
        ...
        internal MigrateOracleAzureDbPostgreSqlSyncTaskOutput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigrateOracleAzureDbPostgreSqlSyncTaskOutput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrateOracleAzureDbPostgreSqlSyncTaskOutput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
