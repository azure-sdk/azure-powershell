...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class ConnectToSourceSqlServerTaskOutput
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="ConnectToSourceSqlServerTaskOutput" />.
        /// </summary>
        ...
        internal ConnectToSourceSqlServerTaskOutput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IConnectToSourceSqlServerTaskOutput.
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IConnectToSourceSqlServerTaskOutput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IConnectToSourceSqlServerTaskOutput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("resultType") )
            {
                ...
                {
                    return new ConnectToSourceSqlServerTaskOutputTaskLevel(json);
                }
                case "DatabaseLevelOutput":
                {
                    return new ConnectToSourceSqlServerTaskOutputDatabaseLevel(json);
                }
                case "LoginLevelOutput":
                {
                    return new ConnectToSourceSqlServerTaskOutputLoginLevel(json);
                }
                case "AgentJobLevelOutput":
                {
                    return new ConnectToSourceSqlServerTaskOutputAgentJobLevel(json);
                }
            }
            return new ConnectToSourceSqlServerTaskOutput(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectToSourceSqlServerTaskOutput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectToSourceSqlServerTaskOutput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
