...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview
{
    ...
    public partial class MigrateSqlServerSqlDbSyncTaskOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSqlServerSqlDbSyncTaskOutput.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSqlServerSqlDbSyncTaskOutput
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSqlServerSqlDbSyncTaskOutput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20220330Preview.IMigrateSqlServerSqlDbSyncTaskOutput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("resultType") )
            {
                ...
                {
                    return new MigrateSqlServerSqlDbSyncTaskOutputMigrationLevel(json);
                }
                case "DatabaseLevelOutput":
                {
                    return new MigrateSqlServerSqlDbSyncTaskOutputDatabaseLevel(json);
                }
                case "TableLevelOutput":
                {
                    return new MigrateSqlServerSqlDbSyncTaskOutputTableLevel(json);
                }
                case "ErrorOutput":
                {
                    return new MigrateSqlServerSqlDbSyncTaskOutputError(json);
                }
                case "DatabaseLevelErrorOutput":
                {
                    return new MigrateSqlServerSqlDbSyncTaskOutputDatabaseError(json);
                }
            }
            return new MigrateSqlServerSqlDbSyncTaskOutput(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrateSqlServerSqlDbSyncTaskOutput" />.
        /// </summary>
        ...
        internal MigrateSqlServerSqlDbSyncTaskOutput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigrateSqlServerSqlDbSyncTaskOutput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrateSqlServerSqlDbSyncTaskOutput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
