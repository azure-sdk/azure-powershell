...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MigrateSchemaSqlServerSqlDbTaskOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSchemaSqlServerSqlDbTaskOutput.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSchemaSqlServerSqlDbTaskOutput
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSchemaSqlServerSqlDbTaskOutput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSchemaSqlServerSqlDbTaskOutput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("resultType") )
            {
                ...
                {
                    return new MigrateSchemaSqlServerSqlDbTaskOutputMigrationLevel(json);
                }
                case "DatabaseLevelOutput":
                {
                    return new MigrateSchemaSqlServerSqlDbTaskOutputDatabaseLevel(json);
                }
                case "SchemaErrorOutput":
                {
                    return new MigrateSchemaSqlServerSqlDbTaskOutputError(json);
                }
                case "ErrorOutput":
                {
                    return new MigrateSchemaSqlTaskOutputError(json);
                }
            }
            return new MigrateSchemaSqlServerSqlDbTaskOutput(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrateSchemaSqlServerSqlDbTaskOutput" />.
        /// </summary>
        ...
        internal MigrateSchemaSqlServerSqlDbTaskOutput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigrateSchemaSqlServerSqlDbTaskOutput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrateSchemaSqlServerSqlDbTaskOutput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
