...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MigrateMySqlAzureDbForMySqlSyncDatabaseInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateMySqlAzureDbForMySqlSyncDatabaseInput.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateMySqlAzureDbForMySqlSyncDatabaseInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateMySqlAzureDbForMySqlSyncDatabaseInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
        ...
        internal MigrateMySqlAzureDbForMySqlSyncDatabaseInput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_migrationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("migrationSetting"), out var __jsonMigrationSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigrateMySqlAzureDbForMySqlSyncDatabaseInputMigrationSetting.FromJson(__jsonMigrationSetting) : MigrationSetting;}
            {_sourceSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("sourceSetting"), out var __jsonSourceSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigrateMySqlAzureDbForMySqlSyncDatabaseInputSourceSetting.FromJson(__jsonSourceSetting) : SourceSetting;}
            {_targetSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("targetSetting"), out var __jsonTargetSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigrateMySqlAzureDbForMySqlSyncDatabaseInputTargetSetting.FromJson(__jsonTargetSetting) : TargetSetting;}
            {_tableMap = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("tableMap"), out var __jsonTableMap) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigrateMySqlAzureDbForMySqlSyncDatabaseInputTableMap.FromJson(__jsonTableMap) : TableMap;}
            AfterFromJson(json);
        }
