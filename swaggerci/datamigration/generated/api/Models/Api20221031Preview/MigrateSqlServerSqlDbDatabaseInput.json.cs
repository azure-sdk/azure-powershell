...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MigrateSqlServerSqlDbDatabaseInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSqlServerSqlDbDatabaseInput.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSqlServerSqlDbDatabaseInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrateSqlServerSqlDbDatabaseInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json ? new MigrateSqlServerSqlDbDatabaseInput(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrateSqlServerSqlDbDatabaseInput" />.
        /// </summary>
        ...
        internal MigrateSqlServerSqlDbDatabaseInput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_makeSourceDbReadOnly = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonBoolean>("makeSourceDbReadOnly"), out var __jsonMakeSourceDbReadOnly) ? (bool?)__jsonMakeSourceDbReadOnly : MakeSourceDbReadOnly;}
            {_tableMap = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("tableMap"), out var __jsonTableMap) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigrateSqlServerSqlDbDatabaseInputTableMap.FromJson(__jsonTableMap) : TableMap;}
            {_schemaSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("schemaSetting"), out var __jsonSchemaSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Any.FromJson(__jsonSchemaSetting) : SchemaSetting;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigrateSqlServerSqlDbDatabaseInput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrateSqlServerSqlDbDatabaseInput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._makeSourceDbReadOnly ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonBoolean((bool)this._makeSourceDbReadOnly) : null, "makeSourceDbReadOnly" ,container.Add );
            ...
            AddIf( null != this._schemaSetting ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) this._schemaSetting.ToJson(null,serializationMode) : null, "schemaSetting" ,container.Add );
