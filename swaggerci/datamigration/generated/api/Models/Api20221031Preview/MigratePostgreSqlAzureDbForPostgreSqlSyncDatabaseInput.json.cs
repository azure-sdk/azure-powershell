...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
        ...
        internal MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_migrationSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("migrationSetting"), out var __jsonMigrationSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputMigrationSetting.FromJson(__jsonMigrationSetting) : MigrationSetting;}
            {_sourceSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("sourceSetting"), out var __jsonSourceSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputSourceSetting.FromJson(__jsonSourceSetting) : SourceSetting;}
            {_targetSetting = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("targetSetting"), out var __jsonTargetSetting) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputTargetSetting.FromJson(__jsonTargetSetting) : TargetSetting;}
            {_selectedTable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonArray>("selectedTables"), out var __jsonSelectedTables) ? If( __jsonSelectedTables as Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput) (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput.FromJson(__u) )) ))() : null : SelectedTable;}
            AfterFromJson(json);
        }
