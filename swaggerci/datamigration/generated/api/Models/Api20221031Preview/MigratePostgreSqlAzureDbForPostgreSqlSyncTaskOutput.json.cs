...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("resultType") )
            {
                ...
                {
                    return new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel(json);
                }
                case "DatabaseLevelOutput":
                {
                    return new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseLevel(json);
                }
                case "TableLevelOutput":
                {
                    return new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel(json);
                }
                case "ErrorOutput":
                {
                    return new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputError(json);
                }
                case "DatabaseLevelErrorOutput":
                {
                    return new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseError(json);
                }
            }
            return new MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput"
        /// />.
        /// </summary>
        ...
        internal MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
