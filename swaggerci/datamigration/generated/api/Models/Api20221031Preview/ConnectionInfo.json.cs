...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class ConnectionInfo
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="ConnectionInfo" />.
        /// </summary>
        ...
        internal ConnectionInfo(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_password = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonString>("password"), out var __jsonPassword) ? (string)__jsonPassword : (string)Password;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IConnectionInfo.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IConnectionInfo interface is polymorphic,
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IConnectionInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IConnectionInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("type") )
            {
                ...
                {
                    return new MongoDbConnectionInfo(json);
                }
                case "SqlConnectionInfo":
                {
                    return new SqlConnectionInfo(json);
                }
                case "MySqlConnectionInfo":
                {
                    return new MySqlConnectionInfo(json);
                }
                case "OracleConnectionInfo":
                {
                    return new OracleConnectionInfo(json);
                }
                case "PostgreSqlConnectionInfo":
                {
                    return new PostgreSqlConnectionInfo(json);
                }
                case "MiSqlConnectionInfo":
                {
                    return new MiSqlConnectionInfo(json);
                }
            }
            return new ConnectionInfo(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ConnectionInfo" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConnectionInfo" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
