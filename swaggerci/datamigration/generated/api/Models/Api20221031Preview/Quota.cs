...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class Quota :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaName Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.QuotaName()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaName _name;

        /// <summary>The name of the quota</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.QuotaName()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The unlocalized name (or ID) of the quota</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        double? Limit { get; set; }
        /// <summary>The name of the quota</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IQuotaName Name { get; set; }
        /// <summary>The localized name of the quota</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The unlocalized name (or ID) of the quota</summary>
        string NameValue { get; set; }
