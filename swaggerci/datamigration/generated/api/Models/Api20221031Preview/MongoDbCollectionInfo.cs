...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MongoDbCollectionInfo :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbCollectionInfo,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbCollectionInfoInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfo Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbCollectionInfoInternal.ShardKey { get => (this._shardKey = this._shardKey ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MongoDbShardKeyInfo()); set { {_shardKey = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfo _shardKey;

        /// <summary>The shard key on the collection, or null if the collection is not sharded</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfo ShardKey { get => (this._shardKey = this._shardKey ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.MongoDbShardKeyInfo()); set => this._shardKey = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyField[] ShardKeyField { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfoInternal)ShardKey).Field; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfoInternal)ShardKey).Field = value ?? null /* arrayOf */; }

        /// <summary>Whether the shard key is unique</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Inlined)]
        public bool? ShardKeyIsUnique { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfoInternal)ShardKey).IsUnique; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfoInternal)ShardKey).IsUnique = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbObjectInfo
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyField[] ShardKeyField { get; set; }
        /// <summary>Whether the shard key is unique</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbObjectInfoInternal
    {
        ...
        bool IsView { get; set; }
        /// <summary>The shard key on the collection, or null if the collection is not sharded</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyInfo ShardKey { get; set; }
        /// <summary>The fields within the shard key</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMongoDbShardKeyField[] ShardKeyField { get; set; }
        /// <summary>Whether the shard key is unique</summary>
        bool? ShardKeyIsUnique { get; set; }
