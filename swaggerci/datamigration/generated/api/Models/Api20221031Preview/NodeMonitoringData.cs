...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class NodeMonitoringData :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringData,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal
    {

        /// <summary>Backing field for <see cref="AdditionalProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataAdditionalProperties _additionalProperty;

        /// <summary>Unmatched properties from the message are deserialized in this collection.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataAdditionalProperties AdditionalProperty { get => (this._additionalProperty = this._additionalProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.NodeMonitoringDataAdditionalProperties()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataAdditionalProperties Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.AdditionalProperty { get => (this._additionalProperty = this._additionalProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.NodeMonitoringDataAdditionalProperties()); set { {_additionalProperty = value;} } }

        /// <summary>Internal Acessors for AvailableMemoryInMb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.AvailableMemoryInMb { get => this._availableMemoryInMb; set { {_availableMemoryInMb = value;} } }

        /// <summary>Internal Acessors for ConcurrentJobsLimit</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.ConcurrentJobsLimit { get => this._concurrentJobsLimit; set { {_concurrentJobsLimit = value;} } }

        /// <summary>Internal Acessors for ConcurrentJobsRunning</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.ConcurrentJobsRunning { get => this._concurrentJobsRunning; set { {_concurrentJobsRunning = value;} } }

        /// <summary>Internal Acessors for CpuUtilization</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.CpuUtilization { get => this._cpuUtilization; set { {_cpuUtilization = value;} } }

        /// <summary>Internal Acessors for MaxConcurrentJob</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.MaxConcurrentJob { get => this._maxConcurrentJob; set { {_maxConcurrentJob = value;} } }

        /// <summary>Internal Acessors for NodeName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.NodeName { get => this._nodeName; set { {_nodeName = value;} } }

        /// <summary>Internal Acessors for ReceivedByte</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.ReceivedByte { get => this._receivedByte; set { {_receivedByte = value;} } }

        /// <summary>Internal Acessors for SentByte</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataInternal.SentByte { get => this._sentByte; set { {_sentByte = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataAdditionalProperties) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataAdditionalProperties AdditionalProperty { get;  }
        /// <summary>Available memory (MB) on the integration runtime node.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Info(
        Required = false,
        ReadOnly = true,
    ...
    {
        /// <summary>Unmatched properties from the message are deserialized in this collection.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.INodeMonitoringDataAdditionalProperties AdditionalProperty { get; set; }
        /// <summary>Available memory (MB) on the integration runtime node.</summary>
