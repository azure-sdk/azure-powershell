...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class BackupConfiguration
    {
        ...
        internal BackupConfiguration(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_sourceLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("sourceLocation"), out var __jsonSourceLocation) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.SourceLocation.FromJson(__jsonSourceLocation) : SourceLocation;}
            {_targetLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("targetLocation"), out var __jsonTargetLocation) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.TargetLocation.FromJson(__jsonTargetLocation) : TargetLocation;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IBackupConfiguration.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IBackupConfiguration.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IBackupConfiguration FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
