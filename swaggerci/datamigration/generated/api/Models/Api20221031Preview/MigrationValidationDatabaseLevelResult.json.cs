...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview
{
    ...
    public partial class MigrationValidationDatabaseLevelResult
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrationValidationDatabaseLevelResult.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrationValidationDatabaseLevelResult.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IMigrationValidationDatabaseLevelResult FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json ? new MigrationValidationDatabaseLevelResult(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrationValidationDatabaseLevelResult" />.
        /// </summary>
        ...
        internal MigrationValidationDatabaseLevelResult(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_dataIntegrityValidationResult = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("dataIntegrityValidationResult"), out var __jsonDataIntegrityValidationResult) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.DataIntegrityValidationResult.FromJson(__jsonDataIntegrityValidationResult) : DataIntegrityValidationResult;}
            {_schemaValidationResult = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("schemaValidationResult"), out var __jsonSchemaValidationResult) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.SchemaComparisonValidationResult.FromJson(__jsonSchemaValidationResult) : SchemaValidationResult;}
            {_queryAnalysisValidationResult = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("queryAnalysisValidationResult"), out var __jsonQueryAnalysisValidationResult) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.QueryAnalysisValidationResult.FromJson(__jsonQueryAnalysisValidationResult) : QueryAnalysisValidationResult;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigrationValidationDatabaseLevelResult" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrationValidationDatabaseLevelResult" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != this._dataIntegrityValidationResult ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) this._dataIntegrityValidationResult.ToJson(null,serializationMode) : null, "dataIntegrityValidationResult" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._schemaValidationResult ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) this._schemaValidationResult.ToJson(null,serializationMode) : null, "schemaValidationResult" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != this._queryAnalysisValidationResult ? (Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode) this._queryAnalysisValidationResult.ToJson(null,serializationMode) : null, "queryAnalysisValidationResult" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.SerializationMode.IncludeReadOnly))
            {
