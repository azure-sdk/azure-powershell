...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview
{
    ...
    public partial class MigrateSchemaSqlServerSqlDbDatabaseInput :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSchemaSqlServerSqlDbDatabaseInput,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSchemaSqlServerSqlDbDatabaseInputInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ISchemaMigrationSetting Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSchemaSqlServerSqlDbDatabaseInputInternal.SchemaSetting { get => (this._schemaSetting = this._schemaSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.SchemaMigrationSetting()); set { {_schemaSetting = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ISchemaMigrationSetting _schemaSetting;

        /// <summary>Database schema migration settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ISchemaMigrationSetting SchemaSetting { get => (this._schemaSetting = this._schemaSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.SchemaMigrationSetting()); set => this._schemaSetting = value; }
...

    {
        ...
        string Name { get; set; }
        /// <summary>Database schema migration settings</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ISchemaMigrationSetting SchemaSetting { get; set; }
        /// <summary>Resource Identifier of a file resource containing the uploaded schema file</summary>
        string SchemaSettingFileId { get; set; }
        /// <summary>Name of the file resource containing the uploaded schema file</summary>
        string SchemaSettingFileName { get; set; }
