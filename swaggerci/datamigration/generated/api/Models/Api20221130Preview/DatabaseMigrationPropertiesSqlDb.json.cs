...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview
{
    ...
    public partial class DatabaseMigrationPropertiesSqlDb
    {
        ...
        internal DatabaseMigrationPropertiesSqlDb(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            {_migrationStatusDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("migrationStatusDetails"), out var __jsonMigrationStatusDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.SqlDbMigrationStatusDetails.FromJson(__jsonMigrationStatusDetails) : MigrationStatusDetail;}
            {_targetSqlConnection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("targetSqlConnection"), out var __jsonTargetSqlConnection) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.SqlConnectionInformation.FromJson(__jsonTargetSqlConnection) : TargetSqlConnection;}
            {_offlineConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("offlineConfiguration"), out var __jsonOfflineConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.SqlDbOfflineConfiguration.FromJson(__jsonOfflineConfiguration) : OfflineConfiguration;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationPropertiesSqlDb.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationPropertiesSqlDb.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationPropertiesSqlDb FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
