...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview
{
    ...
    public partial class DatabaseMigrationPropertiesSqlMi
    {
        ...
        internal DatabaseMigrationPropertiesSqlMi(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
            ...
            __databaseMigrationProperties = new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.DatabaseMigrationProperties(json);
            {_backupConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("backupConfiguration"), out var __jsonBackupConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.BackupConfiguration.FromJson(__jsonBackupConfiguration) : BackupConfiguration;}
            {_offlineConfiguration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("offlineConfiguration"), out var __jsonOfflineConfiguration) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.OfflineConfiguration.FromJson(__jsonOfflineConfiguration) : OfflineConfiguration;}
            {_migrationStatusDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject>("migrationStatusDetails"), out var __jsonMigrationStatusDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.MigrationStatusDetails.FromJson(__jsonMigrationStatusDetails) : MigrationStatusDetail;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationPropertiesSqlMi.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationPropertiesSqlMi.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IDatabaseMigrationPropertiesSqlMi FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
