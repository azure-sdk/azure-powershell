...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview
{
    ...
    public partial class CopyProgressDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.CopyDuration { get => this._copyDuration; set { {_copyDuration = value;} } }

        /// <summary>Internal Acessors for CopyStart</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.CopyStart { get => this._copyStart; set { {_copyStart = value;} } }

        /// <summary>Internal Acessors for CopyThroughput</summary>
        double? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.CopyThroughput { get => this._copyThroughput; set { {_copyThroughput = value;} } }

        /// <summary>Internal Acessors for DataRead</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.DataRead { get => this._dataRead; set { {_dataRead = value;} } }

        /// <summary>Internal Acessors for DataWritten</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.DataWritten { get => this._dataWritten; set { {_dataWritten = value;} } }

        /// <summary>Internal Acessors for ParallelCopyType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.ParallelCopyType { get => this._parallelCopyType; set { {_parallelCopyType = value;} } }

        /// <summary>Internal Acessors for RowsCopied</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.RowsCopied { get => this._rowsCopied; set { {_rowsCopied = value;} } }

        /// <summary>Internal Acessors for RowsRead</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.RowsRead { get => this._rowsRead; set { {_rowsRead = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for TableName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.TableName { get => this._tableName; set { {_tableName = value;} } }

        /// <summary>Internal Acessors for UsedParallelCopy</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.ICopyProgressDetailsInternal.UsedParallelCopy { get => this._usedParallelCopy; set { {_usedParallelCopy = value;} } }
