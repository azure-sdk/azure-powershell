...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview
{
    ...
    public partial class MigrateSqlServerSqlMiSyncTaskOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSqlServerSqlMiSyncTaskOutput.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSqlServerSqlMiSyncTaskOutput
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSqlServerSqlMiSyncTaskOutput.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IMigrateSqlServerSqlMiSyncTaskOutput FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("resultType") )
            {
                ...
                {
                    return new MigrateSqlServerSqlMiSyncTaskOutputMigrationLevel(json);
                }
                case "DatabaseLevelOutput":
                {
                    return new MigrateSqlServerSqlMiSyncTaskOutputDatabaseLevel(json);
                }
                case "ErrorOutput":
                {
                    return new MigrateSqlServerSqlMiSyncTaskOutputError(json);
                }
            }
            return new MigrateSqlServerSqlMiSyncTaskOutput(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject into a new instance of <see cref="MigrateSqlServerSqlMiSyncTaskOutput" />.
        /// </summary>
        ...
        internal MigrateSqlServerSqlMiSyncTaskOutput(Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MigrateSqlServerSqlMiSyncTaskOutput" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="MigrateSqlServerSqlMiSyncTaskOutput" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.Json.JsonNode" />.
        /// </returns>
