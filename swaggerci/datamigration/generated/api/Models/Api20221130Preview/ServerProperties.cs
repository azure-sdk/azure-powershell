...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview
{
    ...
    public partial class ServerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal
    {

        /// <summary>Internal Acessors for ServerDatabaseCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal.ServerDatabaseCount { get => this._serverDatabaseCount; set { {_serverDatabaseCount = value;} } }

        /// <summary>Internal Acessors for ServerEdition</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal.ServerEdition { get => this._serverEdition; set { {_serverEdition = value;} } }

        /// <summary>Internal Acessors for ServerName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal.ServerName { get => this._serverName; set { {_serverName = value;} } }

        /// <summary>Internal Acessors for ServerOperatingSystemVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal.ServerOperatingSystemVersion { get => this._serverOperatingSystemVersion; set { {_serverOperatingSystemVersion = value;} } }

        /// <summary>Internal Acessors for ServerPlatform</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal.ServerPlatform { get => this._serverPlatform; set { {_serverPlatform = value;} } }

        /// <summary>Internal Acessors for ServerVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221130Preview.IServerPropertiesInternal.ServerVersion { get => this._serverVersion; set { {_serverVersion = value;} } }
