...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <summary>
    /// The service tasks resource is a nested, proxy-only resource representing work performed by a DMS instance. This method
    /// cancels a service task if it's currently queued or running.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Cancel=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/serviceTasks/{taskName}/cancel"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzDataMigrationServiceTask_CancelViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The service tasks resource is a nested, proxy-only resource representing work performed by a DMS instance. This method cancels a service task if it's currently queued or running.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Generated]
    public partial class StopAzDataMigrationServiceTask_CancelViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServiceTasksCancel' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServiceTasksCancelViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServiceTasksCancel(InputObject.SubscriptionId ?? null, InputObject.GroupName ?? null, InputObject.ServiceName ?? null, InputObject.TaskName ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StopAzDataMigrationServiceTask_CancelViaIdentity" /> cmdlet class.
        /// </summary>
        public StopAzDataMigrationServiceTask_CancelViaIdentity()
        {
