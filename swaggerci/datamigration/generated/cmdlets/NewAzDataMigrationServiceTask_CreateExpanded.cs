...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// PUT method creates a new service task or updates an existing one, although since service tasks have no mutable custom
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The service tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The PUT method creates a new service task or updates an existing one, although since service tasks have no mutable custom properties, there is little reason to update an existing one.")]
