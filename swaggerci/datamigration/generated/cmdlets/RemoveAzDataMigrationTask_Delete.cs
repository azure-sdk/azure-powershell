...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <summary>
    /// The tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The DELETE
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The DELETE method deletes a task, canceling it first if it's running.")]
