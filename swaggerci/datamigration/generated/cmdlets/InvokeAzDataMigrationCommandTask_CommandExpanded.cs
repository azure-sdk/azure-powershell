...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.ICommandProperties _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.CommandProperties();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.TasksCommand(SubscriptionId, GroupName, ServiceName, ProjectName, TaskName, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,GroupName=GroupName,ServiceName=ServiceName,ProjectName=ProjectName,TaskName=TaskName,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, GroupName=GroupName, ServiceName=ServiceName, ProjectName=ProjectName, TaskName=TaskName, body=_parametersBody })
                    {
