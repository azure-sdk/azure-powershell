...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Description(@"The services resource is the top-level resource that represents the Azure Database Migration Service (classic). The PATCH method updates an existing service. This method can change the kind, SKU, and network of the service, but if tasks are currently running (i.e. the service is busy), this will fail with 400 Bad Request (\""ServiceIsBusy\"").")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesUpdate(InputObject.SubscriptionId ?? null, InputObject.GroupName ?? null, InputObject.ServiceName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
