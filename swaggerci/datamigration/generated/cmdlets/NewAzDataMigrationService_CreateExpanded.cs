...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets
{
    ...
    /// <summary>
    /// The services resource is the top-level resource that represents the Database Migration Service. The PUT method creates
    /// a new service or updates an existing one. When a service is updated, existing child resources (i.e. tasks) are unaffected.
    /// Services currently support a single kind, \"vm\", which refers to a VM-based service, although other kinds may be added
    /// in the future. This method can change the kind, SKU, and network of the service, but if tasks are currently running (i.e.
    /// the service is busy), this will fail with 400 Bad Request (\"ServiceIsBusy\"). The provider will reply when successful
    /// with 200 OK or 201 Created. Long-running operations use the provisioningState property.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDataMigrationService_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzDataMigrationService_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IDataMigrationService _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.DataMigrationService();
        ...
        public string AutoStopDelay { get => _parametersBody.AutoStopDelay ?? null; set => _parametersBody.AutoStopDelay = value; }
        ...
        public global::System.Management.Automation.SwitchParameter DeleteResourcesOnStop { get => _parametersBody.DeleteResourcesOnStop ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.DeleteResourcesOnStop = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualNicId { get => _parametersBody.VirtualNicId ?? null; set => _parametersBody.VirtualNicId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string VirtualSubnetId { get => _parametersBody.VirtualSubnetId ?? null; set => _parametersBody.VirtualSubnetId = value; }
        ...
        /// <returns>a duplicate instance of NewAzDataMigrationService_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Cmdlets.NewAzDataMigrationService_CreateExpanded Clone()
        {
            var clone = new NewAzDataMigrationService_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDataMigrationService_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDataMigrationService_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServicesCreateOrUpdate(SubscriptionId, GroupName, Name, _parametersBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,GroupName=GroupName,Name=Name,body=_parametersBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataMigration.Models.Api20221031Preview.IApiError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, GroupName=GroupName, Name=Name, body=_parametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, GroupName=GroupName, Name=Name, body=_parametersBody })
                    {
