...
online version: https://docs.microsoft.com/en-us/powershell/module/az.attestation/update-azattestationprovider
schema: 2.0.0
---
...
```
Update-AzAttestationProvider -InputObject <IAttestationIdentity>
 [-PublicNetworkAccess <PublicNetworkAccessType>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
