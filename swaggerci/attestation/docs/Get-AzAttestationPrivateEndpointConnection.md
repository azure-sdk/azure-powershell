...
online version: https://docs.microsoft.com/en-us/powershell/module/az.attestation/get-azattestationprivateendpointconnection
schema: 2.0.0
---

# Get-AzAttestationPrivateEndpointConnection
...
### List (Default)
```
Get-AzAttestationPrivateEndpointConnection -ProviderName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAttestationPrivateEndpointConnection -Name <String> -ProviderName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAttestationPrivateEndpointConnection -InputObject <IAttestationIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
