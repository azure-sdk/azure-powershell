...
online version: https://docs.microsoft.com/en-us/powershell/module/az.attestation/remove-azattestationprivateendpointconnection
schema: 2.0.0
---

# Remove-AzAttestationPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzAttestationPrivateEndpointConnection -Name <String> -ProviderName <String>
...
### DeleteViaIdentity
```
Remove-AzAttestationPrivateEndpointConnection -InputObject <IAttestationIdentity> [-DefaultProfile <PSObject>]
