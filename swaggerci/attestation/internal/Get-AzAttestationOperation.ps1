...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601.IOperationList
.Link
https://docs.microsoft.com/en-us/powershell/module/az.attestation/get-azattestationoperation
#>
function Get-AzAttestationOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Attestation.Models.Api20210601.IOperationList])]
