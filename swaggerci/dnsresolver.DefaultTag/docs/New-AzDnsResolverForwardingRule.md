...
online version: https://learn.microsoft.com/powershell/module/az.dnsresolver/new-azdnsresolverforwardingrule
schema: 2.0.0
---
...
New-AzDnsResolverForwardingRule -DnsForwardingRulesetName <String> -Name <String> -ResourceGroupName <String>
 -DomainName <String> -TargetDnsServer <ITargetDnsServer[]> [-SubscriptionId <String>] [-IfMatch <String>]
 [-IfNoneMatch <String>] [-ForwardingRuleState <ForwardingRuleState>] [-Metadata <Hashtable>]
