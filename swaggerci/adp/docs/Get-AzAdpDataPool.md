...
external help file:
Module Name: Az.Adp
online version: https://docs.microsoft.com/en-us/powershell/module/az.adp/get-azadpdatapool
schema: 2.0.0
---
...
### List (Default)
```
Get-AzAdpDataPool -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAdpDataPool -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAdpDataPool -InputObject <IAdpIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
