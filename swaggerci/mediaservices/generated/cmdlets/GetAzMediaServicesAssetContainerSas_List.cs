...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListContainerSas=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaServices/{accountName}/assets/{assetName}/listContainerSas"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMediaServicesAssetContainerSas_List", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Description(@"Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content. The signatures are derived from the storage account keys.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Generated]
    public partial class GetAzMediaServicesAssetContainerSas_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IListContainerSasInput _parameter;

        /// <summary>The parameters to the list SAS request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters to the list SAS request.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The parameters to the list SAS request.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IListContainerSasInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IListContainerSasInput Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetContainerSas">Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetContainerSas</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetContainerSas> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMediaServicesAssetContainerSas_List" /> cmdlet class.
        /// </summary>
        public GetAzMediaServicesAssetContainerSas_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AssetsListContainerSas' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AssetsListContainerSas(SubscriptionId, ResourceGroupName, AccountName, AssetName, Parameter, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, AccountName=AccountName, AssetName=AssetName, body=Parameter })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IAssetContainerSas> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // nested-array / assetContainerSasUrls / <none>
                WriteObject((await response).Url, true);
            }
        }
    }
}