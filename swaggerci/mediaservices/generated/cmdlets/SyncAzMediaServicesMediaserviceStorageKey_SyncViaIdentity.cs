...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SyncStorageKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaservices/{accountName}/syncStorageKeys"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Sync, @"AzMediaServicesMediaserviceStorageKey_SyncViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Description(@"Synchronizes storage account keys for a storage account associated with the Media Service account.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Generated]
    public partial class SyncAzMediaServicesMediaserviceStorageKey_SyncViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20210601.ISyncStorageKeysInput _parameter;

        /// <summary>The input to the sync storage keys request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The input to the sync storage keys request.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The input to the sync storage keys request.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20210601.ISyncStorageKeysInput) })]
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20210601.ISyncStorageKeysInput Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MediaservicesSyncStorageKeys' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MediaservicesSyncStorageKeysViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MediaservicesSyncStorageKeys(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AccountName ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SyncAzMediaServicesMediaserviceStorageKey_SyncViaIdentity" /> cmdlet class.
        /// </summary>
        public SyncAzMediaServicesMediaserviceStorageKey_SyncViaIdentity()
        {
