            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.LocationsCheckNameAvailability(InputObject.SubscriptionId ?? null, InputObject.LocationName ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
