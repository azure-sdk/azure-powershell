...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMediaServicesAssetContainerSas_ListExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzMediaServicesAssetContainerSas_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The SAS URL expiration time. This must be less than 24 hours from the current time.")]
        ...
        public global::System.DateTime ExpiryTime { get => ParametersBody.ExpiryTime ?? default(global::System.DateTime); set => ParametersBody.ExpiryTime = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IListContainerSasInput _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.ListContainerSasInput();

        /// <summary>The parameters to the list SAS request.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IListContainerSasInput ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }

        /// <summary>The permissions to set on the SAS URL.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The permissions to set on the SAS URL.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MediaServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.AssetContainerPermission))]
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.AssetContainerPermission Permission { get => ParametersBody.Permission ?? ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.AssetContainerPermission)""); set => ParametersBody.Permission = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzMediaServicesAssetContainerSas_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzMediaServicesAssetContainerSas_ListExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AssetsListContainerSas(SubscriptionId, ResourceGroupName, AccountName, AssetName, ParametersBody, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, AccountName=AccountName, AssetName=AssetName, body=ParametersBody })
                    {
