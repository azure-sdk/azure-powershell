...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview
{
    ...
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodec"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodec __codec = new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.Codec();
        ...
        public string Label { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodecInternal)__codec).Label; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodecInternal)__codec).Label = value ?? null; }

        /// <summary>The discriminator for derived types.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inherited)]
        public string OdataType { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodecInternal)__codec).OdataType; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodecInternal)__codec).OdataType = value ; }
    ...
    public partial interface IAudio :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodec
    {
        /// <summary>The bitrate, in bits per second, of the output encoded audio.</summary>
    ...
    internal partial interface IAudioInternal :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220501Preview.ICodecInternal
    {
        /// <summary>The bitrate, in bits per second, of the output encoded audio.</summary>
        int? Bitrate { get; set; }
        /// <summary>The number of channels in the audio.</summary>
