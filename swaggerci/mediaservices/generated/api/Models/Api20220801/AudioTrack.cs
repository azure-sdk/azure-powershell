...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801
{
    ...
    public partial class AudioTrack :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAudioTrack,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAudioTrackInternal,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBase"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBase __trackBase = new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.TrackBase();
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IDashSettings _dashSetting;

        /// <summary>The DASH specific setting for the audio track.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IDashSettings DashSetting { get => (this._dashSetting = this._dashSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.DashSettings()); set => this._dashSetting = value; }
        ...
        public string DashSettingRole { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IDashSettingsInternal)DashSetting).Role; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IDashSettingsInternal)DashSetting).Role = value ?? null; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string HlSettingCharacteristic { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettingsInternal)HlsSetting).Characteristic; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettingsInternal)HlsSetting).Characteristic = value ?? null; }

        /// <summary>The default for the HLS setting.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public bool? HlSettingDefault { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettingsInternal)HlsSetting).Default; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettingsInternal)HlsSetting).Default = value ?? default(bool); }

        /// <summary>The forced for the HLS setting.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public bool? HlSettingForced { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettingsInternal)HlsSetting).Forced; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettingsInternal)HlsSetting).Forced = value ?? default(bool); }

        /// <summary>Backing field for <see cref="HlsSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettings _hlsSetting;

        /// <summary>The HLS specific setting for the audio track.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettings HlsSetting { get => (this._hlsSetting = this._hlsSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.HlsSettings()); set => this._hlsSetting = value; }
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAudioTrackInternal.BitRate { get => this._bitRate; set { {_bitRate = value;} } }
        ...
        public string OdataType { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBaseInternal)__trackBase).OdataType; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBaseInternal)__trackBase).OdataType = value ; }
    ...
    public partial interface IAudioTrack :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBase
    {
        /// <summary>The stream bit rate for the audio track.</summary>
    ...
    internal partial interface IAudioTrackInternal :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBaseInternal
    {
        /// <summary>The stream bit rate for the audio track.</summary>
        int? BitRate { get; set; }
        /// <summary>The DASH specific setting for the audio track.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IDashSettings DashSetting { get; set; }
        /// <summary>The role for the DASH setting.</summary>
        string DashSettingRole { get; set; }
        /// <summary>
        /// The display name of the audio track on a video player. In HLS, this maps to the NAME attribute of EXT-X-MEDIA.
        ...
        bool? HlSettingForced { get; set; }
        /// <summary>The HLS specific setting for the audio track.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IHlsSettings HlsSetting { get; set; }
        /// <summary>The RFC5646 language code for the audio track.</summary>
        string LanguageCode { get; set; }
        /// <summary>The MPEG-4 audio track ID for the audio track.</summary>
        int? Mpeg4TrackId { get; set; }
