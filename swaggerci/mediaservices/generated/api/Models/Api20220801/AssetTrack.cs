...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801
{
    ...
    public partial class AssetTrack :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrack,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IHeaderSerializable
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackProperties _property;

        /// <summary>The resource properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.AssetTrackProperties()); set => this._property = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.ProvisioningState? ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackPropertiesInternal)Property).ProvisioningState; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string TrackOdataType { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackPropertiesInternal)Property).TrackOdataType; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackPropertiesInternal)Property).TrackOdataType = value ?? null; }
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
            if (headers.TryGetValues("Azure-AsyncOperation", out var __azureAsyncOperationHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackInternal)this).AzureAsyncOperation = System.Linq.Enumerable.FirstOrDefault(__azureAsyncOperationHeader2) is string __headerAzureAsyncOperationHeader2 ? __headerAzureAsyncOperationHeader2 : (string)null;
            }
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20.IResourceInternal
    {
        ...
        string Location { get; set; }
        /// <summary>The resource properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IAssetTrackProperties Property { get; set; }
        /// <summary>Provisioning state of the asset track.</summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ITrackBase Track { get; set; }
        /// <summary>The discriminator for derived types.</summary>
        string TrackOdataType { get; set; }
