...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801
{
    ...
    public partial class LiveEventTranscription :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventTranscription,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventTranscriptionInternal
    {

        /// <summary>Backing field for <see cref="InputTrackSelection" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventInputTrackSelection[] _inputTrackSelection;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventInputTrackSelection[] InputTrackSelection { get => this._inputTrackSelection; set => this._inputTrackSelection = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventInputTrackSelection) })]
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventInputTrackSelection[] InputTrackSelection { get; set; }
        /// <summary>
        /// Specifies the language (locale) to be used for speech-to-text transcription – it should match the spoken language in the
        /// audio track. The value should be in BCP-47 format (e.g: 'en-US'). See https://go.microsoft.com/fwlink/?linkid=2133742
        /// for more information about the live transcription feature and the list of supported languages.
...

    {
        ...
        /// is reserved for future use, any value set on this property will be ignored.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ILiveEventOutputTranscriptionTrack OutputTranscriptionTrack { get; set; }
        /// <summary>
        /// The output track name. This property is reserved for future use, any value set on this property will be ignored.
        /// </summary>
        string OutputTranscriptionTrackName { get; set; }
