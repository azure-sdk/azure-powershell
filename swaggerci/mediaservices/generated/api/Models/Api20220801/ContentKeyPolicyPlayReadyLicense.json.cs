...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801
{
    ...
    public partial class ContentKeyPolicyPlayReadyLicense
    {
        ...
        internal ContentKeyPolicyPlayReadyLicense(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject json)
        {
            ...
            {_playRight = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("playRight"), out var __jsonPlayRight) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ContentKeyPolicyPlayReadyPlayRight.FromJson(__jsonPlayRight) : PlayRight;}
            {_contentKeyLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("contentKeyLocation"), out var __jsonContentKeyLocation) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ContentKeyPolicyPlayReadyContentKeyLocation.FromJson(__jsonContentKeyLocation) : ContentKeyLocation;}
            ...
            {_securityLevel = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonString>("securityLevel"), out var __jsonSecurityLevel) ? (string)__jsonSecurityLevel : (string)SecurityLevel;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IContentKeyPolicyPlayReadyLicense.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IContentKeyPolicyPlayReadyLicense.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IContentKeyPolicyPlayReadyLicense FromJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._securityLevel)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonString(this._securityLevel.ToString()) : null, "securityLevel" ,container.Add );
