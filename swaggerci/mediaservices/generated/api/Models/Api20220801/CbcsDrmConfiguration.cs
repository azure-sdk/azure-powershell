...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801
{
    ...
    public partial class CbcsDrmConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ICbcsDrmConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ICbcsDrmConfigurationInternal
    {

        /// <summary>Backing field for <see cref="FairPlay" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyFairPlayConfiguration _fairPlay;

        /// <summary>FairPlay configurations</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyFairPlayConfiguration FairPlay { get => (this._fairPlay = this._fairPlay ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.StreamingPolicyFairPlayConfiguration()); set => this._fairPlay = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyWidevineConfiguration Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.ICbcsDrmConfigurationInternal.Widevine { get => (this._widevine = this._widevine ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.StreamingPolicyWidevineConfiguration()); set { {_widevine = value;} } }

        /// <summary>Backing field for <see cref="PlayReady" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyPlayReadyConfiguration _playReady;

        /// <summary>PlayReady configurations</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyPlayReadyConfiguration PlayReady { get => (this._playReady = this._playReady ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.StreamingPolicyPlayReadyConfiguration()); set => this._playReady = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string PlayReadyCustomLicenseAcquisitionUrlTemplate { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyPlayReadyConfigurationInternal)PlayReady).CustomLicenseAcquisitionUrlTemplate; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyPlayReadyConfigurationInternal)PlayReady).CustomLicenseAcquisitionUrlTemplate = value ?? null; }

        /// <summary>Backing field for <see cref="Widevine" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyWidevineConfiguration _widevine;

        /// <summary>Widevine configurations</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyWidevineConfiguration Widevine { get => (this._widevine = this._widevine ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.StreamingPolicyWidevineConfiguration()); set => this._widevine = value; }
    ...
    {
        /// <summary>FairPlay configurations</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyFairPlayConfiguration FairPlay { get; set; }
        /// <summary>All license to be persistent or not</summary>
        bool? FairPlayAllowPersistentLicense { get; set; }
        /// <summary>
        /// Template for the URL of the custom service delivering licenses to end user players. Not required when using Azure Media
        ...
        string FairPlayCustomLicenseAcquisitionUrlTemplate { get; set; }
        /// <summary>PlayReady configurations</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyPlayReadyConfiguration PlayReady { get; set; }
        /// <summary>Custom attributes for PlayReady</summary>
        string PlayReadyCustomAttribute { get; set; }
        /// <summary>
        /// Template for the URL of the custom service delivering licenses to end user players. Not required when using Azure Media
        ...
        string PlayReadyCustomLicenseAcquisitionUrlTemplate { get; set; }
        /// <summary>Widevine configurations</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20220801.IStreamingPolicyWidevineConfiguration Widevine { get; set; }
        /// <summary>
        /// Template for the URL of the custom service delivering licenses to end user players. Not required when using Azure Media
        /// Services for issuing licenses. The template supports replaceable tokens that the service will update at runtime with the
        /// value specific to the request. The currently supported token values are {AlternativeMediaId}, which is replaced with the
