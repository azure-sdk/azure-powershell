...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101
{
    ...
    public partial class AccountEncryption :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccountEncryption,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccountEncryptionInternal
    {

        /// <summary>Backing field for <see cref="Identity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentity _identity;

        /// <summary>The Key Vault identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentity Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.ResourceIdentity()); set => this._identity = value; }
        ...
        public bool? IdentityUseSystemAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentityInternal)Identity).UseSystemAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentityInternal)Identity).UseSystemAssignedIdentity = value ?? default(bool); }

        /// <summary>The user assigned managed identity's ARM ID to use when accessing a resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string IdentityUserAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentityInternal)Identity).UserAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentityInternal)Identity).UserAssignedIdentity = value ?? null; }

        /// <summary>Backing field for <see cref="KeyVaultProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyVaultProperties _keyVaultProperty;

        /// <summary>The properties of the key used to encrypt the account.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyVaultProperties KeyVaultProperty { get => (this._keyVaultProperty = this._keyVaultProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.KeyVaultProperties()); set => this._keyVaultProperty = value; }

        /// <summary>
        /// The current key used to encrypt the Media Services account, including the key version.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string KeyVaultPropertyCurrentKeyIdentifier { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyVaultPropertiesInternal)KeyVaultProperty).CurrentKeyIdentifier; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccountEncryptionInternal.Status { get => this._status; set { {_status = value;} } }
    ...
    {
        /// <summary>The Key Vault identity.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IResourceIdentity Identity { get; set; }
        /// <summary>
        /// Indicates whether to use System Assigned Managed Identity. Mutual exclusive with User Assigned Managed Identity.
        /// </summary>
        bool? IdentityUseSystemAssignedIdentity { get; set; }
        ...
        string IdentityUserAssignedIdentity { get; set; }
        /// <summary>The properties of the key used to encrypt the account.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyVaultProperties KeyVaultProperty { get; set; }
        /// <summary>
        /// The current key used to encrypt the Media Services account, including the key version.
        /// </summary>
