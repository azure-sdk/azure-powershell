...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101
{
    ...
    public partial class MediaServiceAutoGenerated :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IMediaServiceAutoGenerated,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IMediaServiceAutoGeneratedInternal,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IHeaderSerializable
    {
        ...
        /// <summary>Creates an new <see cref="MediaServiceAutoGenerated" /> instance.</summary>
        public MediaServiceAutoGenerated()
        {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IMediaServiceAutoGeneratedInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader0) is string __headerRetryAfterHeader0 ? int.TryParse( __headerRetryAfterHeader0, out int __headerRetryAfterHeader0Value ) ? __headerRetryAfterHeader0Value : default(int?) : default(int?);
            }
            if (headers.TryGetValues("Location", out var __locationHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IMediaServiceAutoGeneratedInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader1) is string __headerLocationHeader1 ? __headerLocationHeader1 : (string)null;
            }
            if (headers.TryGetValues("Azure-AsyncOperation", out var __azureAsyncOperationHeader2))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IMediaServiceAutoGeneratedInternal)this).AzureAsyncOperation = System.Linq.Enumerable.FirstOrDefault(__azureAsyncOperationHeader2) is string __headerAzureAsyncOperationHeader2 ? __headerAzureAsyncOperationHeader2 : (string)null;
            }
        }
    ...
    public partial interface IMediaServiceAutoGenerated :
    ...
    /// A Media Services account.
    internal partial interface IMediaServiceAutoGeneratedInternal :
