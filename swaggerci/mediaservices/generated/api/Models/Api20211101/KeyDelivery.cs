...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101
{
    ...
    public partial class KeyDelivery :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyDelivery,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyDeliveryInternal
    {

        /// <summary>Backing field for <see cref="AccessControl" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccessControl _accessControl;

        /// <summary>The access control properties for Key Delivery.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccessControl AccessControl { get => (this._accessControl = this._accessControl ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.AccessControl()); set => this._accessControl = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string[] AccessControlIPAllowList { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccessControlInternal)AccessControl).IPAllowList; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccessControlInternal)AccessControl).IPAllowList = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for AccessControl</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccessControl Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IKeyDeliveryInternal.AccessControl { get => (this._accessControl = this._accessControl ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.AccessControl()); set { {_accessControl = value;} } }
    ...
    {
        /// <summary>The access control properties for Key Delivery.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IAccessControl AccessControl { get; set; }
        /// <summary>The behavior for IP access control in Key Delivery.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.DefaultAction? AccessControlDefaultAction { get; set; }
        /// <summary>
        /// The IP allow list for access control in Key Delivery. If the default action is set to 'Allow', the IP allow list must
