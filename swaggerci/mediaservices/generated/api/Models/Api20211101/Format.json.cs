...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101
{
    ...
    public partial class Format
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject into a new instance of <see cref="Format" />.
        /// </summary>
        ...
        internal Format(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject json)
        {
            ...
            {_filenamePattern = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonString>("filenamePattern"), out var __jsonFilenamePattern) ? (string)__jsonFilenamePattern : (string)FilenamePattern;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IFormat.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IFormat interface is polymorphic, and the
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IFormat.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IFormat FromJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("@odata.type") )
            {
                ...
                {
                    return new ImageFormat(json);
                }
                case "#Microsoft.Media.JpgFormat":
                {
                    return new JpgFormat(json);
                }
                case "#Microsoft.Media.PngFormat":
                {
                    return new PngFormat(json);
                }
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Format" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Format" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._filenamePattern)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonString(this._filenamePattern.ToString()) : null, "filenamePattern" ,container.Add );
