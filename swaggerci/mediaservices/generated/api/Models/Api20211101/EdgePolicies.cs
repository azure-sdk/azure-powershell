...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101
{
    ...
    public partial class EdgePolicies :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IEdgePolicies,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IEdgePoliciesInternal
    {
...

    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IEdgeUsageDataCollectionPolicy UsageDataCollectionPolicy { get; set; }
        /// <summary>Usage data collection frequency in ISO 8601 duration format e.g. PT10M , PT5H.</summary>
        string UsageDataCollectionPolicyDataCollectionFrequency { get; set; }
        /// <summary>Usage data reporting frequency in ISO 8601 duration format e.g. PT10M , PT5H.</summary>
        string UsageDataCollectionPolicyDataReportingFrequency { get; set; }
        /// <summary>Details of Event Hub where the usage will be reported.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api20211101.IEdgeUsageDataEventHub UsageDataCollectionPolicyEventHubDetail { get; set; }
        /// <summary>
        /// Maximum time for which the functionality of the device will not be hampered for not reporting the usage data.
        /// </summary>
        string UsageDataCollectionPolicyMaxAllowedUnreportedUsageDuration { get; set; }
