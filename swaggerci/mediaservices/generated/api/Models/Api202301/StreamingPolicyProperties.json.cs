...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301
{
    ...
    public partial class StreamingPolicyProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IStreamingPolicyProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonNode node)
        {
        ...
        internal StreamingPolicyProperties(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject json)
        {
            ...
            {_envelopeEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("envelopeEncryption"), out var __jsonEnvelopeEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.EnvelopeEncryption.FromJson(__jsonEnvelopeEncryption) : EnvelopeEncryption;}
            {_commonEncryptionCenc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("commonEncryptionCenc"), out var __jsonCommonEncryptionCenc) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.CommonEncryptionCenc.FromJson(__jsonCommonEncryptionCenc) : CommonEncryptionCenc;}
            {_commonEncryptionCbc = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("commonEncryptionCbcs"), out var __jsonCommonEncryptionCbcs) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.CommonEncryptionCbcs.FromJson(__jsonCommonEncryptionCbcs) : CommonEncryptionCbc;}
            {_noEncryption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Runtime.Json.JsonObject>("noEncryption"), out var __jsonNoEncryption) ? Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.NoEncryption.FromJson(__jsonNoEncryption) : NoEncryption;}
