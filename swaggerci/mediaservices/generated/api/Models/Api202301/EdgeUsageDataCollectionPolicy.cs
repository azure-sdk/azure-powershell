...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301
{
    ...
    public partial class EdgeUsageDataCollectionPolicy :
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataCollectionPolicy,
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataCollectionPolicyInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHub _eventHubDetail;

        /// <summary>Details of Event Hub where the usage will be reported.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHub EventHubDetail { get => (this._eventHubDetail = this._eventHubDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.EdgeUsageDataEventHub()); set => this._eventHubDetail = value; }
        ...
        public string EventHubDetailName { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHubInternal)EventHubDetail).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHubInternal)EventHubDetail).Name = value ?? null; }

        /// <summary>Namespace of the Event Hub where usage will be reported.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string EventHubDetailNamespace { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHubInternal)EventHubDetail).Namespace; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHubInternal)EventHubDetail).Namespace = value ?? null; }

        /// <summary>SAS token needed to interact with Event Hub.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.PropertyOrigin.Inlined)]
        public string EventHubDetailToken { get => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHubInternal)EventHubDetail).Token; set => ((Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHubInternal)EventHubDetail).Token = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHub Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataCollectionPolicyInternal.EventHubDetail { get => (this._eventHubDetail = this._eventHubDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.EdgeUsageDataEventHub()); set { {_eventHubDetail = value;} } }
...

    {
        ...
        string DataReportingFrequency { get; set; }
        /// <summary>Details of Event Hub where the usage will be reported.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Models.Api202301.IEdgeUsageDataEventHub EventHubDetail { get; set; }
        /// <summary>Name of the Event Hub where usage will be reported.</summary>
        string EventHubDetailName { get; set; }
        /// <summary>Namespace of the Event Hub where usage will be reported.</summary>
        string EventHubDetailNamespace { get; set; }
