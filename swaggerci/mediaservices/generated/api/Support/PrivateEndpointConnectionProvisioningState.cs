...
namespace Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.MediaServices.Support.PrivateEndpointConnectionProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
