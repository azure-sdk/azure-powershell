...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/update-azmediaservicesaccountfilter
schema: 2.0.0
---

# Update-AzMediaServicesAccountFilter
...
```
Update-AzMediaServicesAccountFilter -AccountName <String> -FilterName <String> -ResourceGroupName <String>
...
```
Update-AzMediaServicesAccountFilter -InputObject <IMediaServicesIdentity> [-FirstQualityBitrate <Int32>]
