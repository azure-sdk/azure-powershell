...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/get-azmediaservicesliveevent
schema: 2.0.0
---

# Get-AzMediaServicesLiveEvent
...
### List (Default)
```
Get-AzMediaServicesLiveEvent -AccountName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaServicesLiveEvent -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaServicesLiveEvent -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
