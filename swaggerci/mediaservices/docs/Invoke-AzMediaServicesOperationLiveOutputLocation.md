...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesoperationliveoutputlocation
schema: 2.0.0
---

# Invoke-AzMediaServicesOperationLiveOutputLocation
...
### Operation (Default)
```
Invoke-AzMediaServicesOperationLiveOutputLocation -AccountName <String> -LiveEventName <String>
 -LiveOutputName <String> -OperationId <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### OperationViaIdentity
```
Invoke-AzMediaServicesOperationLiveOutputLocation -InputObject <IMediaServicesIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
