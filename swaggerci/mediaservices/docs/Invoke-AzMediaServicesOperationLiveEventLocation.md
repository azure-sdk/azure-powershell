...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesoperationliveeventlocation
schema: 2.0.0
---

# Invoke-AzMediaServicesOperationLiveEventLocation
...
### Operation (Default)
```
Invoke-AzMediaServicesOperationLiveEventLocation -AccountName <String> -LiveEventName <String>
...
```
Invoke-AzMediaServicesOperationLiveEventLocation -InputObject <IMediaServicesIdentity>
