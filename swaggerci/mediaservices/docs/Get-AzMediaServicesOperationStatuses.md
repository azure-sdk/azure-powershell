...
### Get (Default)
```
Get-AzMediaServicesOperationStatuses -AccountName <String> -AssetName <String> -OperationId <String>
...
### GetViaIdentity
```
Get-AzMediaServicesOperationStatuses -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
