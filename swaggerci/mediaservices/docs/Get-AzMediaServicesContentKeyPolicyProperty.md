...
### Get (Default)
```
Get-AzMediaServicesContentKeyPolicyProperty -AccountName <String> -ContentKeyPolicyName <String>
...
### GetViaIdentity
```
Get-AzMediaServicesContentKeyPolicyProperty -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
