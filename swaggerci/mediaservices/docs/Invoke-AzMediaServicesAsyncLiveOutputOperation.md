...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesasyncliveoutputoperation
schema: 2.0.0
---

# Invoke-AzMediaServicesAsyncLiveOutputOperation
...
### Async (Default)
```
Invoke-AzMediaServicesAsyncLiveOutputOperation -AccountName <String> -OperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AsyncViaIdentity
```
Invoke-AzMediaServicesAsyncLiveOutputOperation -InputObject <IMediaServicesIdentity>
...
Parameter Sets: AsyncViaIdentity
Aliases:
