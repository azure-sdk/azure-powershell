...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/update-azmediaservicesasset
schema: 2.0.0
---

# Update-AzMediaServicesAsset
...
```
Update-AzMediaServicesAsset -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AlternateId <String>] [-Container <String>] [-Description <String>]
 [-EncryptionScope <String>] [-StorageAccountName <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzMediaServicesAsset -InputObject <IMediaServicesIdentity> [-AlternateId <String>]
 [-Container <String>] [-Description <String>] [-EncryptionScope <String>] [-StorageAccountName <String>]
