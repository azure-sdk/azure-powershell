...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesasyncstreamingendpointoperation
schema: 2.0.0
---
...
### Async (Default)
```
Invoke-AzMediaServicesAsyncStreamingEndpointOperation -AccountName <String> -OperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AsyncViaIdentity
```
Invoke-AzMediaServicesAsyncStreamingEndpointOperation -InputObject <IMediaServicesIdentity>
