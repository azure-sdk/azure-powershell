...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesstreamingendpoint
schema: 2.0.0
---

# Remove-AzMediaServicesStreamingEndpoint
...
### Delete (Default)
```
Remove-AzMediaServicesStreamingEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaServicesStreamingEndpoint -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
