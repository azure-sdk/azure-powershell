...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/stop-azmediaservicesstreamingendpoint
schema: 2.0.0
---

# Stop-AzMediaServicesStreamingEndpoint
...
### Stop (Default)
```
Stop-AzMediaServicesStreamingEndpoint -AccountName <String> -Name <String> -ResourceGroupName <String>
...
### StopViaIdentity
```
Stop-AzMediaServicesStreamingEndpoint -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
