...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesstatusliveevent
schema: 2.0.0
---

# Invoke-AzMediaServicesStatusLiveEvent
...
### Status (Default)
```
Invoke-AzMediaServicesStatusLiveEvent -AccountName <String> -LiveEventName <String>
...
### StatusViaIdentity
```
Invoke-AzMediaServicesStatusLiveEvent -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
