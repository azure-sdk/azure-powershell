...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesasyncliveeventoperation
schema: 2.0.0
---

# Invoke-AzMediaServicesAsyncLiveEventOperation
...
### Async (Default)
```
Invoke-AzMediaServicesAsyncLiveEventOperation -AccountName <String> -OperationId <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### AsyncViaIdentity
```
Invoke-AzMediaServicesAsyncLiveEventOperation -InputObject <IMediaServicesIdentity>
