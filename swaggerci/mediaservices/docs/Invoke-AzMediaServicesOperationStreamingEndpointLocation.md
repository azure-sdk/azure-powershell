...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicesoperationstreamingendpointlocation
schema: 2.0.0
---

# Invoke-AzMediaServicesOperationStreamingEndpointLocation
...
### Operation (Default)
```
Invoke-AzMediaServicesOperationStreamingEndpointLocation -AccountName <String> -OperationId <String>
...
```
Invoke-AzMediaServicesOperationStreamingEndpointLocation -InputObject <IMediaServicesIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
