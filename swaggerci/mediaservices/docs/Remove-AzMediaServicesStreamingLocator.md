...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesstreaminglocator
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzMediaServicesStreamingLocator -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaServicesStreamingLocator -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
