...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/invoke-azmediaservicestrackliveeventingestheartbeat
schema: 2.0.0
---

# Invoke-AzMediaServicesTrackLiveEventIngestHeartbeat
...
### Track (Default)
```
Invoke-AzMediaServicesTrackLiveEventIngestHeartbeat -AccountName <String> -LiveEventName <String>
...
### TrackViaIdentity
```
Invoke-AzMediaServicesTrackLiveEventIngestHeartbeat -InputObject <IMediaServicesIdentity>
...
Parameter Sets: TrackViaIdentity
Aliases:
