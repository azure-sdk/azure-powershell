...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicescontentkeypolicy
schema: 2.0.0
---

# Remove-AzMediaServicesContentKeyPolicy
...
### Delete (Default)
```
Remove-AzMediaServicesContentKeyPolicy -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMediaServicesContentKeyPolicy -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
