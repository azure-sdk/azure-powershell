...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/get-azmediaservicestrack
schema: 2.0.0
---

# Get-AzMediaServicesTrack
...
### List (Default)
```
Get-AzMediaServicesTrack -AccountName <String> -AssetName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzMediaServicesTrack -AccountName <String> -AssetName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMediaServicesTrack -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
