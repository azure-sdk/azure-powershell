...
online version: https://docs.microsoft.com/en-us/powershell/module/az.mediaservices/remove-azmediaservicesassetfilter
schema: 2.0.0
---

# Remove-AzMediaServicesAssetFilter
...
### Delete (Default)
```
Remove-AzMediaServicesAssetFilter -AccountName <String> -AssetName <String> -FilterName <String>
...
### DeleteViaIdentity
```
Remove-AzMediaServicesAssetFilter -InputObject <IMediaServicesIdentity> [-DefaultProfile <PSObject>]
