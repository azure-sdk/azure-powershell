...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/get-azpostgresqlhyperscalefirewallrule
schema: 2.0.0
---

# Get-AzPostgreSqlHyperscaleFirewallRule
...
### List (Default)
```
Get-AzPostgreSqlHyperscaleFirewallRule -ResourceGroupName <String> -ServerGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzPostgreSqlHyperscaleFirewallRule -Name <String> -ResourceGroupName <String> -ServerGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzPostgreSqlHyperscaleFirewallRule -InputObject <IPostgreSqlHyperscaleIdentity>
