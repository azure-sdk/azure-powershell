...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdbforpostgresql/update-azcosmosdbforpostgresqlcluster
schema: 2.0.0
---
...
Update-AzCosmosDbForPostgreSqlCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-AdministratorLoginPassword <SecureString>] [-CitusVersion <String>]
