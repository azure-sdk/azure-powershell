...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/remove-azpostgresqlhyperscaleservergroup
schema: 2.0.0
---

# Remove-AzPostgreSqlHyperscaleServerGroup
...
### Delete (Default)
```
Remove-AzPostgreSqlHyperscaleServerGroup -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzPostgreSqlHyperscaleServerGroup -InputObject <IPostgreSqlHyperscaleIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
