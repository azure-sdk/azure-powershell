...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/invoke-azpostgresqlhyperscalepromoteservergroup
schema: 2.0.0
---

# Invoke-AzPostgreSqlHyperscalePromoteServerGroup
...
### Promote (Default)
```
Invoke-AzPostgreSqlHyperscalePromoteServerGroup -ResourceGroupName <String> -ServerGroupName <String>
...
### PromoteViaIdentity
```
Invoke-AzPostgreSqlHyperscalePromoteServerGroup -InputObject <IPostgreSqlHyperscaleIdentity>
