...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/remove-azpostgresqlhyperscalefirewallrule
schema: 2.0.0
---

# Remove-AzPostgreSqlHyperscaleFirewallRule
...
### Delete (Default)
```
Remove-AzPostgreSqlHyperscaleFirewallRule -Name <String> -ResourceGroupName <String> -ServerGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzPostgreSqlHyperscaleFirewallRule -InputObject <IPostgreSqlHyperscaleIdentity>
