...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/invoke-azpostgresqlhyperscalepromoteservergroupreadreplica
schema: 2.0.0
---

# Invoke-AzPostgreSqlHyperscalePromoteServerGroupReadReplica
...
### Promote (Default)
```
Invoke-AzPostgreSqlHyperscalePromoteServerGroupReadReplica -ResourceGroupName <String>
 -ServerGroupName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PromoteViaIdentity
```
Invoke-AzPostgreSqlHyperscalePromoteServerGroupReadReplica -InputObject <IPostgreSqlHyperscaleIdentity>
