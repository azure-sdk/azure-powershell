...
online version: https://docs.microsoft.com/en-us/powershell/module/az.cosmosdbforpostgresql/new-azcosmosdbforpostgresqlcluster
schema: 2.0.0
---
...
New-AzCosmosDbForPostgreSqlCluster -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-AdministratorLoginPassword <SecureString>] [-CitusVersion <String>]
 [-CoordinatorEnablePublicIPAccess <CoordinatorEnablePublicIPEnum>] [-CoordinatorServerEdition <String>]
 [-CoordinatorStorageQuotaInMb <Int64>] [-CoordinatorVCore <Int64>] [-EnableHa <EnableHaEnum>]
 [-EnableShardsOnCoordinator <EnableShardsOnCoordinatorEnum>] [-MaintenanceWindowCustomWindow <String>]
 [-MaintenanceWindowDayOfWeek <Int32>] [-MaintenanceWindowStartHour <Int32>]
 [-MaintenanceWindowStartMinute <Int32>] [-NodeCount <Int64>]
 [-NodeEnablePublicIPAccess <NodeEnablePublicIPEnum>] [-NodeServerEdition <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Support.CoordinatorEnablePublicIPEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Support.EnableHaEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Support.EnableShardsOnCoordinatorEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Support.NodeEnablePublicIPEnum
Parameter Sets: (All)
Aliases:
...
### -SourceLocation
The source cluster location to restore from.
It's required for 'PointInTimeRestore' or 'ReadReplica' operations
...
### -SourceResourceId
The source resource id to restore from.
It's required for 'PointInTimeRestore' or 'ReadReplica' operations
...
### Microsoft.Azure.PowerShell.Cmdlets.CosmosDbForPostgreSql.Models.Api20221108.IClusterResponse
