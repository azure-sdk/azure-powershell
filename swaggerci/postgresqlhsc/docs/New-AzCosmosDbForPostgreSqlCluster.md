...
New-AzCosmosDbForPostgreSqlCluster -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-CoordinatorEnablePublicIPAccess] [-CoordinatorServerEdition <String>]
 [-CoordinatorStorageQuotaInMb <Int64>] [-CoordinatorVCore <Int64>] [-EnableHa] [-EnableShardsOnCoordinator]
 [-MaintenanceWindowCustomWindow <String>] [-MaintenanceWindowDayOfWeek <Int32>]
 [-MaintenanceWindowStartHour <Int32>] [-MaintenanceWindowStartMinute <Int32>] [-NodeCount <Int64>]
 [-NodeEnablePublicIPAccess] [-NodeServerEdition <String>] [-NodeStorageQuotaInMb <Int64>]
 [-NodeVCore <Int64>] [-PointInTimeUtc <DateTime>] [-PostgresqlVersion <String>]
...
It's required for creating 'PointInTimeRestore' or 'ReadReplica' operations
...
It's required to create 'ReadReplica'
