...
online version: https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/stop-azpostgresqlhyperscaleservergroup
schema: 2.0.0
---

# Stop-AzPostgreSqlHyperscaleServerGroup
...
### Stop (Default)
```
Stop-AzPostgreSqlHyperscaleServerGroup -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzPostgreSqlHyperscaleServerGroup -InputObject <IPostgreSqlHyperscaleIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
