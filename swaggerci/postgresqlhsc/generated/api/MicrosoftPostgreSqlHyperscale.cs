...
namespace Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale
{
    ...
    public partial class MicrosoftPostgreSqlHyperscale
    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        public async global::System.Threading.Tasks.Task ServerGroupPromoteReadReplica(string subscriptionId, string resourceGroupName, string serverGroupName, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Models.Api20201005Privatepreview.ICloudError>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.ISendAsync sender)
        {
            var apiVersion = @"2020-10-05-privatepreview";
            // Constant Parameters
            using( NoSynchronizationContext )
            {
                ...
                await eventListener.Signal(Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.Events.HeaderParametersAdded); if( eventListener.Token.IsCancellationRequested ) { return; }
                // make the call
                await this.ServerGroupPromoteReadReplica_Call(request,onOk,onDefault,eventListener,sender);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        public async global::System.Threading.Tasks.Task ServerGroupPromoteReadReplicaViaIdentity(global::System.String viaIdentity, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Models.Api20201005Privatepreview.ICloudError>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.ISendAsync sender)
        {
            var apiVersion = @"2020-10-05-privatepreview";
            // Constant Parameters
            using( NoSynchronizationContext )
            {
                ...
                var _match = new global::System.Text.RegularExpressions.Regex("^/subscriptions/(?<subscriptionId>[^/]+)/resourceGroups/(?<resourceGroupName>[^/]+)/providers/Microsoft.DBForPostgreSql/serverGroupsv2/(?<serverGroupName>[^/]+)/promote$", global::System.Text.RegularExpressions.RegexOptions.IgnoreCase).Match(viaIdentity);
                if (!_match.Success)
                {
                    throw new global::System.Exception("Invalid identity for URI '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForPostgreSql/serverGroupsv2/{serverGroupName}/promote'");
                }
        ...
        /// <summary>Actual wire call for <see cref="ServerGroupPromoteReadReplica" /> method.</summary>
        /// <param name="request">the prepared HttpRequestMessage to send.</param>
        /// <param name="onOk">a delegate that is called when the remote service returns 200 (OK).</param>
        /// <param name="onDefault">a delegate that is called when the remote service returns default (any response code not handled
        /// elsewhere).</param>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        internal async global::System.Threading.Tasks.Task ServerGroupPromoteReadReplica_Call(global::System.Net.Http.HttpRequestMessage request, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task> onOk, global::System.Func<global::System.Net.Http.HttpResponseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Models.Api20201005Privatepreview.ICloudError>, global::System.Threading.Tasks.Task> onDefault, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.IEventListener eventListener, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.ISendAsync sender)
        {
            using( NoSynchronizationContext )
            {
                global::System.Net.Http.HttpResponseMessage _response = null;
        ...
        /// <summary>
        /// Validation method for <see cref="ServerGroupPromoteReadReplica" /> method. Call this like the actual call, but you will
        /// get validation events back.
        /// </summary>
        /// <param name="subscriptionId">The ID of the target subscription.</param>
        /// <param name="resourceGroupName">The name of the resource group. The name is case insensitive.</param>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        internal async global::System.Threading.Tasks.Task ServerGroupPromoteReadReplica_Validate(string subscriptionId, string resourceGroupName, string serverGroupName, Microsoft.Azure.PowerShell.Cmdlets.PostgreSqlHyperscale.Runtime.IEventListener eventListener)
        {
            using( NoSynchronizationContext )
            {
                await eventListener.AssertNotNull(nameof(subscriptionId),subscriptionId);
