...
INPUTOBJECT <IPostgreSqlHyperscaleIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/invoke-azpostgresqlhyperscalepromoteservergroup
#>
function Invoke-AzPostgreSqlHyperscalePromoteServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Promote = 'Az.PostgreSqlHyperscale.private\Invoke-AzPostgreSqlHyperscalePromoteServerGroup_Promote';
            PromoteViaIdentity = 'Az.PostgreSqlHyperscale.private\Invoke-AzPostgreSqlHyperscalePromoteServerGroup_PromoteViaIdentity';
        }
