...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresqlhyperscale/invoke-azpostgresqlhyperscalepromoteservergroupreadreplica
#>
function Invoke-AzPostgreSqlHyperscalePromoteServerGroupReadReplica {
...
begin {
    try {
        ...
        $mapping = @{
            Promote = 'Az.PostgreSqlHyperscale.private\Invoke-AzPostgreSqlHyperscalePromoteServerGroupReadReplica_Promote';
            PromoteViaIdentity = 'Az.PostgreSqlHyperscale.private\Invoke-AzPostgreSqlHyperscalePromoteServerGroupReadReplica_PromoteViaIdentity';
        }
