...
online version: https://learn.microsoft.com/powershell/module/az.powerplatform/remove-azpowerplatformprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzPowerPlatformPrivateEndpointConnection -EnterprisePolicyName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzPowerPlatformPrivateEndpointConnection -InputObject <IPowerPlatformIdentity>
