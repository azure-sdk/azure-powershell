...
online version: https://learn.microsoft.com/powershell/module/az.integrationspaces/get-azintegrationspacesinfrastructureresource
schema: 2.0.0
---

# Get-AzIntegrationSpacesInfrastructureResource
...
### List (Default)
```
Get-AzIntegrationSpacesInfrastructureResource -ResourceGroupName <String> -SpaceName <String>
 [-SubscriptionId <String[]>] [-Expand <String[]>] [-Filter <String>] [-Maxpagesize <Int32>]
 [-Orderby <String[]>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzIntegrationSpacesInfrastructureResource -Name <String> -ResourceGroupName <String> -SpaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzIntegrationSpacesInfrastructureResource -InputObject <IIntegrationSpacesIdentity>
