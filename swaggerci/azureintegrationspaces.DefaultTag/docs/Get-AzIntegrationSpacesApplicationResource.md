...
online version: https://learn.microsoft.com/powershell/module/az.integrationspaces/get-azintegrationspacesapplicationresource
schema: 2.0.0
---
...
### List (Default)
```
Get-AzIntegrationSpacesApplicationResource -ApplicationName <String> -ResourceGroupName <String>
 -SpaceName <String> [-SubscriptionId <String[]>] [-Expand <String[]>] [-Filter <String>]
 [-Maxpagesize <Int32>] [-Orderby <String[]>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>]
...
```
Get-AzIntegrationSpacesApplicationResource -ApplicationName <String> -ResourceGroupName <String>
 -ResourceName <String> -SpaceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzIntegrationSpacesApplicationResource -InputObject <IIntegrationSpacesIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
