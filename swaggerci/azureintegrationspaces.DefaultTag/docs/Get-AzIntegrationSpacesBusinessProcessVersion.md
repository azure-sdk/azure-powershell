...
online version: https://learn.microsoft.com/powershell/module/az.integrationspaces/get-azintegrationspacesbusinessprocessversion
schema: 2.0.0
---

# Get-AzIntegrationSpacesBusinessProcessVersion
...
### List (Default)
```
Get-AzIntegrationSpacesBusinessProcessVersion -ApplicationName <String> -BusinessProcessName <String>
 -ResourceGroupName <String> -SpaceName <String> [-SubscriptionId <String[]>] [-Expand <String[]>]
...
```
Get-AzIntegrationSpacesBusinessProcessVersion -ApplicationName <String> -BusinessProcessName <String>
 -BusinessProcessVersion <String> -ResourceGroupName <String> -SpaceName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzIntegrationSpacesBusinessProcessVersion -InputObject <IIntegrationSpacesIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
