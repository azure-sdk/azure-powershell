...
online version: https://learn.microsoft.com/powershell/module/az.integrationspaces/new-azintegrationspacesbusinessprocess
schema: 2.0.0
---

# New-AzIntegrationSpacesBusinessProcess
...
```
New-AzIntegrationSpacesBusinessProcess -ApplicationName <String> -Name <String> -ResourceGroupName <String>
