...
namespace Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>Resource creation was canceled.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Deleting = @"Deleting";

        /// <summary>Resource creation failed.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Provisioning = @"Provisioning";

        /// <summary>Resource has been created.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
