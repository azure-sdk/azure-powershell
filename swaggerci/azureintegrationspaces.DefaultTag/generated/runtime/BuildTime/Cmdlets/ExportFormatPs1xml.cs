...
namespace Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.IntegrationSpaces.Support";
