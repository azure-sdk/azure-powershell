...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlightsailbucket
#>
function Get-AzAwsConnectorLightsailBucket {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailBucket_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailBucket_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailBucket_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailBucket_List1';
        }
