...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlogssubscriptionfilter
#>
function Remove-AzAwsConnectorLogsSubscriptionFilter {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsSubscriptionFilter_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsSubscriptionFilter_DeleteViaIdentity';
        }
