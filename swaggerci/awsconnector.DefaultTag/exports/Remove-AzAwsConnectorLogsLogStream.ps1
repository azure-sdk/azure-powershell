...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlogslogstream
#>
function Remove-AzAwsConnectorLogsLogStream {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsLogStream_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsLogStream_DeleteViaIdentity';
        }
