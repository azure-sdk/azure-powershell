...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticloadbalancingv2listener
#>
function Get-AzAwsConnectorElasticLoadBalancingV2Listener {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2Listener_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2Listener_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2Listener_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2Listener_List1';
        }
