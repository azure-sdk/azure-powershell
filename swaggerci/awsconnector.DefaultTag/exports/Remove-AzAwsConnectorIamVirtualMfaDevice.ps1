...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriamvirtualmfadevice
#>
function Remove-AzAwsConnectorIamVirtualMfaDevice {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamVirtualMfaDevice_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamVirtualMfaDevice_DeleteViaIdentity';
        }
