...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2networkinterface
#>
function Get-AzAwsConnectorEc2NetworkInterface {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkInterface_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkInterface_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkInterface_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkInterface_List1';
        }
