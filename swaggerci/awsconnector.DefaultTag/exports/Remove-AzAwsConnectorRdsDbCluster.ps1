...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorrdsdbcluster
#>
function Remove-AzAwsConnectorRdsDbCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbCluster_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbCluster_DeleteViaIdentity';
        }
