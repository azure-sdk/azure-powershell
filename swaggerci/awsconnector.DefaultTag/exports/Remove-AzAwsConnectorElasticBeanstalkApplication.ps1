...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticbeanstalkapplication
#>
function Remove-AzAwsConnectorElasticBeanstalkApplication {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticBeanstalkApplication_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticBeanstalkApplication_DeleteViaIdentity';
        }
