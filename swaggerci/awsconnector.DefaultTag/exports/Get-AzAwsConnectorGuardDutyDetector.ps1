...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorguarddutydetector
#>
function Get-AzAwsConnectorGuardDutyDetector {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorGuardDutyDetector_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorGuardDutyDetector_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorGuardDutyDetector_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorGuardDutyDetector_List1';
        }
