...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorrdsdbinstance
#>
function Remove-AzAwsConnectorRdsDbInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbInstance_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbInstance_DeleteViaIdentity';
        }
