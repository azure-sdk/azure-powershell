...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoropensearchdomainstatuses
#>
function Get-AzAwsConnectorOpenSearchDomainStatuses {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorOpenSearchDomainStatuses_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorOpenSearchDomainStatuses_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorOpenSearchDomainStatuses_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorOpenSearchDomainStatuses_List1';
        }
