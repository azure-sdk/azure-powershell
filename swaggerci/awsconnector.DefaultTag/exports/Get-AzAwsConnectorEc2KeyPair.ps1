...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2keypair
#>
function Get-AzAwsConnectorEc2KeyPair {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2KeyPair_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2KeyPair_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2KeyPair_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2KeyPair_List1';
        }
