...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IGuardDutyDetector
.Notes
COMPLEX PARAMETER PROPERTIES

To create the parameters described below, construct a hash table containing the appropriate properties. For information on hash tables, run Get-Help about_Hash_Tables.

AWPROPERTYFEATURE <ICfnFeatureConfiguration[]>: Property features
  [AdditionalConfiguration <ICfnFeatureAdditionalConfiguration[]>]: Property additionalConfiguration
    [Name <String>]: Property name
    [Status <String>]: Property status
  [Name <String>]: Property name
  [Status <CfnFeatureConfigurationStatus?>]: Property status

AWPROPERTYTAG <ITagItem[]>: Property tags
  [Key <String>]: Property key
  [Value <String>]: Property value
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorguarddutydetector
#>
function New-AzAwsConnectorGuardDutyDetector {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IGuardDutyDetector])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ICfnFeatureConfiguration[]]
    # Property features
    # To construct, see NOTES section for AWPROPERTYFEATURE properties and create a hash table.
    ${AwPropertyFeature},
    ...
    ${AwPropertyFindingPublishingFrequency},
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IGuardDutyDetectorPropertiesAwsTags]))]
    ...
    [System.Management.Automation.SwitchParameter]
    # Property ebsVolumes
    ${ScanEc2InstanceWithFindingEbsVolume},
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorGuardDutyDetector_CreateExpanded';
        }
