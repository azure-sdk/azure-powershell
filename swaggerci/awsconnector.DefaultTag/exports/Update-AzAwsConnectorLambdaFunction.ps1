...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorlambdafunction
#>
function Update-AzAwsConnectorLambdaFunction {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILambdaFunctionTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorLambdaFunction_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorLambdaFunction_UpdateViaIdentityExpanded';
        }
