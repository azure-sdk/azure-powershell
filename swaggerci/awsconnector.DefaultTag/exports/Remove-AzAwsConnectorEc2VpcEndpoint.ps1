...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorec2vpcendpoint
#>
function Remove-AzAwsConnectorEc2VpcEndpoint {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2VpcEndpoint_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2VpcEndpoint_DeleteViaIdentity';
        }
