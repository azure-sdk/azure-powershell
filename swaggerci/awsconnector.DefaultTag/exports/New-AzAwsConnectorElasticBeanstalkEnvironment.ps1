...
AWPROPERTYOPTIONSETTING <IOptionSetting[]>: Key-value pairs defining configuration options for this environment, such as the instance type.
...
AWPROPERTYTAG <ITagAutoGenerated29[]>: Specifies the tags applied to resources in the environment.
  [Key <String>]: The key name of the tag.
  [Value <String>]: The value for the tag.
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorelasticbeanstalkenvironment
#>
function New-AzAwsConnectorElasticBeanstalkEnvironment {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticBeanstalkEnvironmentPropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorElasticBeanstalkEnvironment_CreateExpanded';
        }
