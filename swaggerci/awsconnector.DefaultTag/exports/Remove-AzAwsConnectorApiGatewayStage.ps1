...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorapigatewaystage
#>
function Remove-AzAwsConnectorApiGatewayStage {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorApiGatewayStage_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorApiGatewayStage_DeleteViaIdentity';
        }
