...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticbeanstalkconfigurationtemplate
#>
function Remove-AzAwsConnectorElasticBeanstalkConfigurationTemplate {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticBeanstalkConfigurationTemplate_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticBeanstalkConfigurationTemplate_DeleteViaIdentity';
        }
