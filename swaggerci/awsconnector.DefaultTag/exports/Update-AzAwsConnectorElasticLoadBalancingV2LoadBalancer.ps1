...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorelasticloadbalancingv2loadbalancer
#>
function Update-AzAwsConnectorElasticLoadBalancingV2LoadBalancer {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticLoadBalancingV2LoadBalancerTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_UpdateViaIdentityExpanded';
        }
