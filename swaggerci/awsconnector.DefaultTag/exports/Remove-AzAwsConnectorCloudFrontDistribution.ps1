...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcloudfrontdistribution
#>
function Remove-AzAwsConnectorCloudFrontDistribution {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudFrontDistribution_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudFrontDistribution_DeleteViaIdentity';
        }
