...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorwafwebaclsummary
#>
function Remove-AzAwsConnectorWafWebAclSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorWafWebAclSummary_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorWafWebAclSummary_DeleteViaIdentity';
        }
