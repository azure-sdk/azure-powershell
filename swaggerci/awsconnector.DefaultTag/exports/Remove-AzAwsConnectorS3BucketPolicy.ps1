...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectors3bucketpolicy
#>
function Remove-AzAwsConnectorS3BucketPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3BucketPolicy_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3BucketPolicy_DeleteViaIdentity';
        }
