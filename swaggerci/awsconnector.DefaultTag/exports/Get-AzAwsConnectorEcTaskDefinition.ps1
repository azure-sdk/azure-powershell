...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorectaskdefinition
#>
function Get-AzAwsConnectorEcTaskDefinition {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEcTaskDefinition_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEcTaskDefinition_List1';
        }
