...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectors3accesscontrolpolicy
#>
function Remove-AzAwsConnectorS3AccessControlPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3AccessControlPolicy_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3AccessControlPolicy_DeleteViaIdentity';
        }
