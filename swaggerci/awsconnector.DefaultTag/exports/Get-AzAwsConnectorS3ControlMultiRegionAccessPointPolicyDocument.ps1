...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectors3controlmultiregionaccesspointpolicydocument
#>
function Get-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_List1';
        }
