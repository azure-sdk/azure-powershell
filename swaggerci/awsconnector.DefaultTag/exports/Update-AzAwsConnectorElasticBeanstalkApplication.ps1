...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorelasticbeanstalkapplication
#>
function Update-AzAwsConnectorElasticBeanstalkApplication {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticBeanstalkApplication])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticBeanstalkApplicationTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticBeanstalkApplication_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticBeanstalkApplication_UpdateViaIdentityExpanded';
        }
