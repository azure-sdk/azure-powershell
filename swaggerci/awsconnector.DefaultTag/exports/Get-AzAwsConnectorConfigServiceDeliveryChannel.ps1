...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorconfigservicedeliverychannel
#>
function Get-AzAwsConnectorConfigServiceDeliveryChannel {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceDeliveryChannel_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceDeliveryChannel_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceDeliveryChannel_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceDeliveryChannel_List1';
        }
