...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcloudwatchalarm
#>
function Remove-AzAwsConnectorCloudWatchAlarm {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudWatchAlarm_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudWatchAlarm_DeleteViaIdentity';
        }
