...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorappsyncgraphqlapi
#>
function Get-AzAwsConnectorAppSyncGraphqlApi {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorAppSyncGraphqlApi_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorAppSyncGraphqlApi_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorAppSyncGraphqlApi_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorAppSyncGraphqlApi_List1';
        }
