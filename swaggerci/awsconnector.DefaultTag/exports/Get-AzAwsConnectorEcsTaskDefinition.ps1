...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorecstaskdefinition
#>
function Get-AzAwsConnectorEcsTaskDefinition {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IEcsTaskDefinition])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEcsTaskDefinition_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEcsTaskDefinition_GetViaIdentity';
        }
