...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriaminstanceprofile
#>
function Remove-AzAwsConnectorIamInstanceProfile {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamInstanceProfile_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamInstanceProfile_DeleteViaIdentity';
        }
