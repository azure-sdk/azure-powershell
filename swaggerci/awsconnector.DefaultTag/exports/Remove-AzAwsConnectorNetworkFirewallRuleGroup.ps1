...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectornetworkfirewallrulegroup
#>
function Remove-AzAwsConnectorNetworkFirewallRuleGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorNetworkFirewallRuleGroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorNetworkFirewallRuleGroup_DeleteViaIdentity';
        }
