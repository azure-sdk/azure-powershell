...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsnstopic
#>
function Remove-AzAwsConnectorSnsTopic {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSnsTopic_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSnsTopic_DeleteViaIdentity';
        }
