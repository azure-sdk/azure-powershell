...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriamgroup
#>
function Get-AzAwsConnectorIamGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamGroup_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamGroup_List1';
        }
