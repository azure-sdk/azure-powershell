...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorredshiftclusterparametergroup
#>
function Update-AzAwsConnectorRedshiftClusterParameterGroup {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRedshiftClusterParameterGroup])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRedshiftClusterParameterGroupTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRedshiftClusterParameterGroup_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRedshiftClusterParameterGroup_UpdateViaIdentityExpanded';
        }
