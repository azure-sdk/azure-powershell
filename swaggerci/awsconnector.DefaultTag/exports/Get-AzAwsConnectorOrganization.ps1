...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectororganization
#>
function Get-AzAwsConnectorOrganization {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganization_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganization_List1';
        }
