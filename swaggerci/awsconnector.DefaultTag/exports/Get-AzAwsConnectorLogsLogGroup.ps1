...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogsloggroup
#>
function Get-AzAwsConnectorLogsLogGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsLogGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsLogGroup_GetViaIdentity';
        }
