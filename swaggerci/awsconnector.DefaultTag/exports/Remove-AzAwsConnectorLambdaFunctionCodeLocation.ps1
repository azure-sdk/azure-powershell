...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlambdafunctioncodelocation
#>
function Remove-AzAwsConnectorLambdaFunctionCodeLocation {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLambdaFunctionCodeLocation_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLambdaFunctionCodeLocation_DeleteViaIdentity';
        }
