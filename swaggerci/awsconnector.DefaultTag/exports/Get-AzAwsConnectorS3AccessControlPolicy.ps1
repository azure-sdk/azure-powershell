...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectors3accesscontrolpolicy
#>
function Get-AzAwsConnectorS3AccessControlPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IS3AccessControlPolicy])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessControlPolicy_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessControlPolicy_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessControlPolicy_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessControlPolicy_List1';
        }
