...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectors3bucket
#>
function Remove-AzAwsConnectorS3Bucket {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3Bucket_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3Bucket_DeleteViaIdentity';
        }
