...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriamaccesskeymetadatainfo
#>
function Get-AzAwsConnectorIamAccessKeyMetadataInfo {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyMetadataInfo_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyMetadataInfo_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyMetadataInfo_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyMetadataInfo_List1';
        }
