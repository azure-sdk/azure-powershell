...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorlogstream
#>
function New-AzAwsConnectorLogStream {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILogsLogStream])]
...
param(
    ...
    # The name must be unique wihtin the log group.
    ${AwPropertyLogStreamName},
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILogsLogStreamPropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorLogStream_CreateExpanded';
        }
