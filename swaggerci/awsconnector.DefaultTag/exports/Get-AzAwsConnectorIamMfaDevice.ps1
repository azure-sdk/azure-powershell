...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriammfadevice
#>
function Get-AzAwsConnectorIamMfaDevice {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IIamMfaDevice])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamMfaDevice_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamMfaDevice_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamMfaDevice_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamMfaDevice_List1';
        }
