...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorefsfilesystem
#>
function Remove-AzAwsConnectorEfsFileSystem {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEfsFileSystem_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEfsFileSystem_DeleteViaIdentity';
        }
