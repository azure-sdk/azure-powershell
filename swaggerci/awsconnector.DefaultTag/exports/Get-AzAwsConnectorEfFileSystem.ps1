...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoreffilesystem
#>
function Get-AzAwsConnectorEfFileSystem {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEfFileSystem_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEfFileSystem_List1';
        }
