...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectornetworkfirewallrulegroup
#>
function Get-AzAwsConnectorNetworkFirewallRuleGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallRuleGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallRuleGroup_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallRuleGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallRuleGroup_List1';
        }
