...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorsagemakernotebookinstancesummary
#>
function Update-AzAwsConnectorSageMakerNotebookInstanceSummary {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ISageMakerNotebookInstanceSummaryTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorSageMakerNotebookInstanceSummary_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorSageMakerNotebookInstanceSummary_UpdateViaIdentityExpanded';
        }
