...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoremrcluster
#>
function Remove-AzAwsConnectorEmrCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEmrCluster_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEmrCluster_DeleteViaIdentity';
        }
