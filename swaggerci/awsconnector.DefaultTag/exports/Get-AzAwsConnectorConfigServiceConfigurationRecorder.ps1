...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorconfigserviceconfigurationrecorder
#>
function Get-AzAwsConnectorConfigServiceConfigurationRecorder {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorder_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorder_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorder_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorder_List1';
        }
