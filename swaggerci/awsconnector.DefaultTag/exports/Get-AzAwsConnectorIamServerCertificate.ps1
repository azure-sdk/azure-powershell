...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriamservercertificate
#>
function Get-AzAwsConnectorIamServerCertificate {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamServerCertificate_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamServerCertificate_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamServerCertificate_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamServerCertificate_List1';
        }
