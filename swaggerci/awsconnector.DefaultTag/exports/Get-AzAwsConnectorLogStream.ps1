...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogstream
#>
function Get-AzAwsConnectorLogStream {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLogStream_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLogStream_List1';
        }
