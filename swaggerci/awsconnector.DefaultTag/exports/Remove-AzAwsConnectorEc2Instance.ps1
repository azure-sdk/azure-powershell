...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorec2instance
#>
function Remove-AzAwsConnectorEc2Instance {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2Instance_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2Instance_DeleteViaIdentity';
        }
