...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticloadbalancingv2loadbalancer
#>
function Remove-AzAwsConnectorElasticLoadBalancingV2LoadBalancer {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_DeleteViaIdentity';
        }
