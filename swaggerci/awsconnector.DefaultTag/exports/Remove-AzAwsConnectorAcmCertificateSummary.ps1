...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoracmcertificatesummary
#>
function Remove-AzAwsConnectorAcmCertificateSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorAcmCertificateSummary_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorAcmCertificateSummary_DeleteViaIdentity';
        }
