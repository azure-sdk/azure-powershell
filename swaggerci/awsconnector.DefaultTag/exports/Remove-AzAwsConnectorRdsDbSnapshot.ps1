...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorrdsdbsnapshot
#>
function Remove-AzAwsConnectorRdsDbSnapshot {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbSnapshot_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbSnapshot_DeleteViaIdentity';
        }
