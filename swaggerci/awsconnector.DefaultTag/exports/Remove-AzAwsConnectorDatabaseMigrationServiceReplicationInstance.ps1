...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectordatabasemigrationservicereplicationinstance
#>
function Remove-AzAwsConnectorDatabaseMigrationServiceReplicationInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_DeleteViaIdentity';
        }
