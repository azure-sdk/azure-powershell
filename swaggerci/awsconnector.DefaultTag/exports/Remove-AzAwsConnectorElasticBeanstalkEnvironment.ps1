...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticbeanstalkenvironment
#>
function Remove-AzAwsConnectorElasticBeanstalkEnvironment {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticBeanstalkEnvironment_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticBeanstalkEnvironment_DeleteViaIdentity';
        }
