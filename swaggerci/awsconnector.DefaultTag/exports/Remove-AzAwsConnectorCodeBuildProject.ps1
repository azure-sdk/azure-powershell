...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcodebuildproject
#>
function Remove-AzAwsConnectorCodeBuildProject {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCodeBuildProject_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCodeBuildProject_DeleteViaIdentity';
        }
