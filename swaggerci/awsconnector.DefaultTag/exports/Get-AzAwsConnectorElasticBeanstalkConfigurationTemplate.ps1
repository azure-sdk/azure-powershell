...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticbeanstalkconfigurationtemplate
#>
function Get-AzAwsConnectorElasticBeanstalkConfigurationTemplate {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkConfigurationTemplate_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkConfigurationTemplate_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkConfigurationTemplate_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkConfigurationTemplate_List1';
        }
