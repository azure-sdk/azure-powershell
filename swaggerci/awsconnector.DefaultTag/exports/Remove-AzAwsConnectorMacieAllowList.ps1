...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectormacieallowlist
#>
function Remove-AzAwsConnectorMacieAllowList {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorMacieAllowList_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorMacieAllowList_DeleteViaIdentity';
        }
