...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectors3controlmultiregionaccesspointpolicydocument
#>
function Update-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IS3ControlMultiRegionAccessPointPolicyDocument])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IS3ControlMultiRegionAccessPointPolicyDocumentTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_UpdateViaIdentityExpanded';
        }
