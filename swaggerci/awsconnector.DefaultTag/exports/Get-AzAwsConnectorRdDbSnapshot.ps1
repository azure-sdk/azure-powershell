...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrddbsnapshot
#>
function Get-AzAwsConnectorRdDbSnapshot {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbSnapshot_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbSnapshot_List1';
        }
