...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsagemakernotebookinstancesummary
#>
function Remove-AzAwsConnectorSageMakerNotebookInstanceSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSageMakerNotebookInstanceSummary_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSageMakerNotebookInstanceSummary_DeleteViaIdentity';
        }
