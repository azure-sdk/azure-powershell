...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorautoscalinggroup
#>
function Get-AzAwsConnectorAutoScalingGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorAutoScalingGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorAutoScalingGroup_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorAutoScalingGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorAutoScalingGroup_List1';
        }
