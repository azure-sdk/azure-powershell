...
AWPROPERTYTAG <ITagAutoGenerated43[]>: Property tags
  [Key <String>]: Property key
  [Value <String>]: Property value

FIREWALLPOLICYSTATEFULRULEGROUPREFERENCE <IStatefulRuleGroupReference[]>: Property statefulRuleGroupReferences
  [OverrideAction <StatefulRuleGroupOverrideAction?>]: Property action
  [Priority <Int32?>]: Property priority
  [ResourceArn <String>]: A resource ARN.

FIREWALLPOLICYSTATELESSCUSTOMACTION <ICustomAction[]>: Property statelessCustomActions
  [ActionName <String>]: Property actionName
  [PublishMetricActionDimension <IDimensionAutoGenerated2[]>]: Property dimensions
    [Value <String>]: Property value

FIREWALLPOLICYSTATELESSRULEGROUPREFERENCE <IStatelessRuleGroupReference[]>: Property statelessRuleGroupReferences
  [Priority <Int32?>]: Property priority
  [ResourceArn <String>]: A resource ARN.
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectornetworkfirewallpolicy
#>
function New-AzAwsConnectorNetworkFirewallPolicy {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.INetworkFirewallPolicyPropertiesAwsTags]))]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRuleVariablesModelRuleVariables]))]
    [System.Collections.Hashtable]
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.StatefulEngineOptionsRuleOrder])]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.StatefulEngineOptionsRuleOrder]
    # Property ruleOrder
    ${StatefulEngineOptionRuleOrder},

    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.StatefulEngineOptionsStreamExceptionPolicy])]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.StatefulEngineOptionsStreamExceptionPolicy]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorNetworkFirewallPolicy_CreateExpanded';
        }
