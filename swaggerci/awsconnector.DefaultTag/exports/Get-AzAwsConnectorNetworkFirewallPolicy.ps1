...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectornetworkfirewallpolicy
#>
function Get-AzAwsConnectorNetworkFirewallPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallPolicy_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallPolicy_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallPolicy_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewallPolicy_List1';
        }
