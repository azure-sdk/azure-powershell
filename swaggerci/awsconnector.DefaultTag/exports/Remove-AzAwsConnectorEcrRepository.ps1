...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorecrrepository
#>
function Remove-AzAwsConnectorEcrRepository {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcrRepository_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcrRepository_DeleteViaIdentity';
        }
