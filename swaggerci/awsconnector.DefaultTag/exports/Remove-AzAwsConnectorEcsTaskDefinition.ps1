...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorecstaskdefinition
#>
function Remove-AzAwsConnectorEcsTaskDefinition {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcsTaskDefinition_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcsTaskDefinition_DeleteViaIdentity';
        }
