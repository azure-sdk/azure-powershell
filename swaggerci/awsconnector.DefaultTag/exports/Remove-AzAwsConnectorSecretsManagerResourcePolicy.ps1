...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsecretsmanagerresourcepolicy
#>
function Remove-AzAwsConnectorSecretsManagerResourcePolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSecretsManagerResourcePolicy_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSecretsManagerResourcePolicy_DeleteViaIdentity';
        }
