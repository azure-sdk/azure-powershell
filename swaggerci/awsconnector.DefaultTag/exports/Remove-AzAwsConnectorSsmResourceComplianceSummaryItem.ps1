...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorssmresourcecompliancesummaryitem
#>
function Remove-AzAwsConnectorSsmResourceComplianceSummaryItem {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSsmResourceComplianceSummaryItem_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSsmResourceComplianceSummaryItem_DeleteViaIdentity';
        }
