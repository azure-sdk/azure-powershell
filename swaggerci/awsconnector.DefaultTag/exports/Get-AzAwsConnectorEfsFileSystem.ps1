...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorefsfilesystem
#>
function Get-AzAwsConnectorEfsFileSystem {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEfsFileSystem_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEfsFileSystem_GetViaIdentity';
        }
