...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectororganizationsorganization
#>
function Update-AzAwsConnectorOrganizationsOrganization {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IOrganizationsOrganizationTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorOrganizationsOrganization_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorOrganizationsOrganization_UpdateViaIdentityExpanded';
        }
