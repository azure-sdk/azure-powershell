...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsagemakerapp
#>
function Get-AzAwsConnectorSageMakerApp {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerApp_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerApp_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerApp_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerApp_List1';
        }
