...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2instance
#>
function Get-AzAwsConnectorEc2Instance {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Instance_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Instance_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Instance_List';
        }
