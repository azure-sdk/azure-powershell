...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorroute53hostedzone
#>
function Remove-AzAwsConnectorRoute53HostedZone {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRoute53HostedZone_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRoute53HostedZone_DeleteViaIdentity';
        }
