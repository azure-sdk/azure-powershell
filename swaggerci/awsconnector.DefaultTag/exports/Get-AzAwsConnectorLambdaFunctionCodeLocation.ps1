...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlambdafunctioncodelocation
#>
function Get-AzAwsConnectorLambdaFunctionCodeLocation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILambdaFunctionCodeLocation])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunctionCodeLocation_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunctionCodeLocation_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunctionCodeLocation_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunctionCodeLocation_List1';
        }
