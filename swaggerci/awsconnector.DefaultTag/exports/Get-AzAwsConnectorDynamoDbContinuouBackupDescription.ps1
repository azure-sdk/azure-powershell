...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectordynamodbcontinuoubackupdescription
#>
function Get-AzAwsConnectorDynamoDbContinuouBackupDescription {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbContinuouBackupDescription_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbContinuouBackupDescription_List1';
        }
