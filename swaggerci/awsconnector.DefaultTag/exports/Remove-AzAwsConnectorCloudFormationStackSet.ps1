...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcloudformationstackset
#>
function Remove-AzAwsConnectorCloudFormationStackSet {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudFormationStackSet_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudFormationStackSet_DeleteViaIdentity';
        }
