...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdsdbsnapshotattributesresult
#>
function Get-AzAwsConnectorRdsDbSnapshotAttributesResult {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbSnapshotAttributesResult_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbSnapshotAttributesResult_GetViaIdentity';
        }
