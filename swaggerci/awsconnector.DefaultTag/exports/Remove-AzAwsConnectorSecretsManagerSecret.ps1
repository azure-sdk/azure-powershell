...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsecretsmanagersecret
#>
function Remove-AzAwsConnectorSecretsManagerSecret {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSecretsManagerSecret_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSecretsManagerSecret_DeleteViaIdentity';
        }
