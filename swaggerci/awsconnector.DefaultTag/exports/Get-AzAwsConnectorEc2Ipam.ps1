...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2ipam
#>
function Get-AzAwsConnectorEc2Ipam {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Ipam_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Ipam_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Ipam_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Ipam_List1';
        }
