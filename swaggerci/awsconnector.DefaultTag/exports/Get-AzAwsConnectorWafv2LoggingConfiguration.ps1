...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorwafv2loggingconfiguration
#>
function Get-AzAwsConnectorWafv2LoggingConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorWafv2LoggingConfiguration_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorWafv2LoggingConfiguration_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorWafv2LoggingConfiguration_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorWafv2LoggingConfiguration_List1';
        }
