...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorconfigserviceconfigurationrecorderstatuses
#>
function Remove-AzAwsConnectorConfigServiceConfigurationRecorderStatuses {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_DeleteViaIdentity';
        }
