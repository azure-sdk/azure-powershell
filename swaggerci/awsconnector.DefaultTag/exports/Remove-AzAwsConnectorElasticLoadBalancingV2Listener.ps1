...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticloadbalancingv2listener
#>
function Remove-AzAwsConnectorElasticLoadBalancingV2Listener {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingV2Listener_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingV2Listener_DeleteViaIdentity';
        }
