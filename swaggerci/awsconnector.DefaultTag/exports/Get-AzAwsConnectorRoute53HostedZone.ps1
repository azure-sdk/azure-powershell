...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorroute53hostedzone
#>
function Get-AzAwsConnectorRoute53HostedZone {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53HostedZone_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53HostedZone_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53HostedZone_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53HostedZone_List1';
        }
