...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorconfigservicedeliverychannel
#>
function Remove-AzAwsConnectorConfigServiceDeliveryChannel {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorConfigServiceDeliveryChannel_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorConfigServiceDeliveryChannel_DeleteViaIdentity';
        }
