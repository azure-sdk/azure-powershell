...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsqsqueue
#>
function Remove-AzAwsConnectorSqsQueue {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSqsQueue_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSqsQueue_DeleteViaIdentity';
        }
