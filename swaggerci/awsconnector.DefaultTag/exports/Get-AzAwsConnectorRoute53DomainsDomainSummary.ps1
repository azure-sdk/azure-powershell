...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorroute53domainsdomainsummary
#>
function Get-AzAwsConnectorRoute53DomainsDomainSummary {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRoute53DomainsDomainSummary])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53DomainsDomainSummary_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53DomainsDomainSummary_GetViaIdentity';
        }
