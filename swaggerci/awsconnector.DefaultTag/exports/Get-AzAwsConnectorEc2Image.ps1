...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2image
#>
function Get-AzAwsConnectorEc2Image {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Image_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Image_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Image_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Image_List1';
        }
