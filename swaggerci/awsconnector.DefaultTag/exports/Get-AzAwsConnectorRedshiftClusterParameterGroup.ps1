...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorredshiftclusterparametergroup
#>
function Get-AzAwsConnectorRedshiftClusterParameterGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftClusterParameterGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftClusterParameterGroup_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftClusterParameterGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftClusterParameterGroup_List1';
        }
