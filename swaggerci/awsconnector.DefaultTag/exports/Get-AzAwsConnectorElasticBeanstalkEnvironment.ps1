...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticbeanstalkenvironment
#>
function Get-AzAwsConnectorElasticBeanstalkEnvironment {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticBeanstalkEnvironment])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkEnvironment_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkEnvironment_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkEnvironment_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkEnvironment_List1';
        }
