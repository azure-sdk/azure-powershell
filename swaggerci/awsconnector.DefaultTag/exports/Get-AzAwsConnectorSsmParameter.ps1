...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorssmparameter
#>
function Get-AzAwsConnectorSsmParameter {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmParameter_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmParameter_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmParameter_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmParameter_List1';
        }
