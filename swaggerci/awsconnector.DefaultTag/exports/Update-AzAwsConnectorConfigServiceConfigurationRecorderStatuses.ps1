...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorconfigserviceconfigurationrecorderstatuses
#>
function Update-AzAwsConnectorConfigServiceConfigurationRecorderStatuses {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IConfigServiceConfigurationRecorderStatusTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_UpdateViaIdentityExpanded';
        }
