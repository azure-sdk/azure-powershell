...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectormacie2jobsummary
#>
function Remove-AzAwsConnectorMacie2JobSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorMacie2JobSummary_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorMacie2JobSummary_DeleteViaIdentity';
        }
