...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriamrole
#>
function Get-AzAwsConnectorIamRole {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamRole_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamRole_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamRole_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamRole_List1';
        }
