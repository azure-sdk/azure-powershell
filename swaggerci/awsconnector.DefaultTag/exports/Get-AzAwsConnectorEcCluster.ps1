...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoreccluster
#>
function Get-AzAwsConnectorEcCluster {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEcCluster_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEcCluster_List1';
        }
