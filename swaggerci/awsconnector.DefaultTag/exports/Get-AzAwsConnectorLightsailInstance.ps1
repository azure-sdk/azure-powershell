...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlightsailinstance
#>
function Get-AzAwsConnectorLightsailInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailInstance_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailInstance_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailInstance_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLightsailInstance_List1';
        }
