...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectordynamodbtable
#>
function Remove-AzAwsConnectorDynamoDbTable {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorDynamoDbTable_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorDynamoDbTable_DeleteViaIdentity';
        }
