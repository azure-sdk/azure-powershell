...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrddbsnapshotattributeresult
#>
function Get-AzAwsConnectorRdDbSnapshotAttributeResult {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbSnapshotAttributeResult_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbSnapshotAttributeResult_List1';
        }
