...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcloudtrail
#>
function Remove-AzAwsConnectorCloudTrail {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudTrail_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudTrail_DeleteViaIdentity';
        }
