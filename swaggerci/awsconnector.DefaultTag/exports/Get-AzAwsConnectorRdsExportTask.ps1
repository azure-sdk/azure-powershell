...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdsexporttask
#>
function Get-AzAwsConnectorRdsExportTask {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsExportTask_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsExportTask_GetViaIdentity';
        }
