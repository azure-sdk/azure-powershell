...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriamrole
#>
function Remove-AzAwsConnectorIamRole {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamRole_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamRole_DeleteViaIdentity';
        }
