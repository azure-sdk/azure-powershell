...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorrdsdbsnapshotattributesresult
#>
function Update-AzAwsConnectorRdsDbSnapshotAttributesResult {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRdsDbSnapshotAttributesResultTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRdsDbSnapshotAttributesResult_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRdsDbSnapshotAttributesResult_UpdateViaIdentityExpanded';
        }
