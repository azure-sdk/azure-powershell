...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcloudformationstack
#>
function Remove-AzAwsConnectorCloudFormationStack {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudFormationStack_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCloudFormationStack_DeleteViaIdentity';
        }
