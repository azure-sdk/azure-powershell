...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorcodebuildsourcecredentialsinfo
#>
function Remove-AzAwsConnectorCodeBuildSourceCredentialsInfo {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorCodeBuildSourceCredentialsInfo_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorCodeBuildSourceCredentialsInfo_DeleteViaIdentity';
        }
