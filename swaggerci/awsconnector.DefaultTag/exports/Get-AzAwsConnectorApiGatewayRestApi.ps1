...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorapigatewayrestapi
#>
function Get-AzAwsConnectorApiGatewayRestApi {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayRestApi_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayRestApi_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayRestApi_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayRestApi_List1';
        }
