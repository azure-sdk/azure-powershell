...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticloadbalancingv2targethealthdescription
#>
function Remove-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_DeleteViaIdentity';
        }
