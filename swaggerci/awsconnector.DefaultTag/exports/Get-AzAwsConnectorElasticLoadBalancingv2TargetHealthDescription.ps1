...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticloadbalancingv2targethealthdescription
#>
function Get-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_List1';
        }
