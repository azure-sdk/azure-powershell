...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorekscluster
#>
function Get-AzAwsConnectorEksCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEksCluster_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEksCluster_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEksCluster_List';
        }
