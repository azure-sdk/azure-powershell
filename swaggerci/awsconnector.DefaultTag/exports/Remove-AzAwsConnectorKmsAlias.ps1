...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorkmsalias
#>
function Remove-AzAwsConnectorKmsAlias {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorKmsAlias_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorKmsAlias_DeleteViaIdentity';
        }
