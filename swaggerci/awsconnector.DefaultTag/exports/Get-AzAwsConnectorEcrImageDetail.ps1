...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorecrimagedetail
#>
function Get-AzAwsConnectorEcrImageDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrImageDetail_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrImageDetail_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrImageDetail_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrImageDetail_List1';
        }
