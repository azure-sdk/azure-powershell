...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorssminstanceinformation
#>
function Get-AzAwsConnectorSsmInstanceInformation {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmInstanceInformation_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmInstanceInformation_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmInstanceInformation_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmInstanceInformation_List1';
        }
