...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriamaccesskeylastused
#>
function Remove-AzAwsConnectorIamAccessKeyLastUsed {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamAccessKeyLastUsed_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamAccessKeyLastUsed_DeleteViaIdentity';
        }
