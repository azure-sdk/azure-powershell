...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriaminstanceprofile
#>
function Get-AzAwsConnectorIamInstanceProfile {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamInstanceProfile_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamInstanceProfile_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamInstanceProfile_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamInstanceProfile_List1';
        }
