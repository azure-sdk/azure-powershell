...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorssmparameter
#>
function Remove-AzAwsConnectorSsmParameter {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSsmParameter_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSsmParameter_DeleteViaIdentity';
        }
