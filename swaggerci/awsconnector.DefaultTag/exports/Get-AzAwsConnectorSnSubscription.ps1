...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsnsubscription
#>
function Get-AzAwsConnectorSnSubscription {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSnSubscription_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSnSubscription_List1';
        }
