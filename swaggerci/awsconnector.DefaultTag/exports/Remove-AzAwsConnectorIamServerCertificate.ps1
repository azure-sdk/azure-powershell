...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriamservercertificate
#>
function Remove-AzAwsConnectorIamServerCertificate {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamServerCertificate_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamServerCertificate_DeleteViaIdentity';
        }
