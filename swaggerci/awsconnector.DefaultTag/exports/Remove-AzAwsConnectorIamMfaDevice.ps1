...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriammfadevice
#>
function Remove-AzAwsConnectorIamMfaDevice {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamMfaDevice_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamMfaDevice_DeleteViaIdentity';
        }
