...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoropensearchdomainstatuses
#>
function Remove-AzAwsConnectorOpenSearchDomainStatuses {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorOpenSearchDomainStatuses_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorOpenSearchDomainStatuses_DeleteViaIdentity';
        }
