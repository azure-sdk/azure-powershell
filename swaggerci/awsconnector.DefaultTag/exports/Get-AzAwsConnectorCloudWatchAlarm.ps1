...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcloudwatchalarm
#>
function Get-AzAwsConnectorCloudWatchAlarm {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudWatchAlarm_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudWatchAlarm_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudWatchAlarm_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudWatchAlarm_List1';
        }
