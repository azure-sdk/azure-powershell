...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdsdbinstance
#>
function Get-AzAwsConnectorRdsDbInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbInstance_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbInstance_GetViaIdentity';
        }
