...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorconfigserviceconfigurationrecorder
#>
function Update-AzAwsConnectorConfigServiceConfigurationRecorder {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IConfigServiceConfigurationRecorderTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorConfigServiceConfigurationRecorder_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorConfigServiceConfigurationRecorder_UpdateViaIdentityExpanded';
        }
