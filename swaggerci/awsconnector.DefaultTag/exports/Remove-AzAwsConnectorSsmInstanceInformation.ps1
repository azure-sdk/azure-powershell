...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorssminstanceinformation
#>
function Remove-AzAwsConnectorSsmInstanceInformation {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSsmInstanceInformation_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSsmInstanceInformation_DeleteViaIdentity';
        }
