...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogsmetricfilter
#>
function Get-AzAwsConnectorLogsMetricFilter {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsMetricFilter_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsMetricFilter_GetViaIdentity';
        }
