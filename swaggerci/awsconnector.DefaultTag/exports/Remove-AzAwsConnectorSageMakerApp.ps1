...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsagemakerapp
#>
function Remove-AzAwsConnectorSageMakerApp {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSageMakerApp_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSageMakerApp_DeleteViaIdentity';
        }
