...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectors3accesspoint
#>
function Remove-AzAwsConnectorS3AccessPoint {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3AccessPoint_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3AccessPoint_DeleteViaIdentity';
        }
