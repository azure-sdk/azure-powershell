...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectoropensearchdomainstatuses
#>
function Update-AzAwsConnectorOpenSearchDomainStatuses {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IOpenSearchDomainStatusTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorOpenSearchDomainStatuses_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorOpenSearchDomainStatuses_UpdateViaIdentityExpanded';
        }
