...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogslogstream
#>
function Get-AzAwsConnectorLogsLogStream {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsLogStream_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsLogStream_GetViaIdentity';
        }
