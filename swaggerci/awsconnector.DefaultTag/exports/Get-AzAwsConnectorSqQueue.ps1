...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsqqueue
#>
function Get-AzAwsConnectorSqQueue {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSqQueue_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSqQueue_List1';
        }
