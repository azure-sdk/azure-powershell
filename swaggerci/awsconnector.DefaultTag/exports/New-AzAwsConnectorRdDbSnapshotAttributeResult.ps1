...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRdsDbSnapshotAttributesResult
.Notes
COMPLEX PARAMETER PROPERTIES

To create the parameters described below, construct a hash table containing the appropriate properties. For information on hash tables, run Get-Help about_Hash_Tables.

AWPROPERTYDBSNAPSHOTATTRIBUTE <IDbSnapshotAttribute[]>: <p>The list of attributes and values for the manual DB snapshot.</p>
  ...
  [AttributeValue <String[]>]: <p>The value or values for the manual DB snapshot attribute.</p> <p>If the <code>AttributeName</code> field is set to <code>restore</code>, then this element returns a list of IDs of the Amazon Web Services accounts that are authorized to copy or restore the manual DB snapshot. If a value of <code>all</code> is in the list, then the manual DB snapshot is public and available for any Amazon Web Services account to copy or restore.</p>
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorrddbsnapshotattributeresult
#>
function New-AzAwsConnectorRdDbSnapshotAttributeResult {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRdsDbSnapshotAttributesResult])]
...
param(
    ...
    # To construct, see NOTES section for AWPROPERTYDBSNAPSHOTATTRIBUTE properties and create a hash table.
    ${AwPropertyDbSnapshotAttribute},

    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [System.String]
    # <p>The identifier of the manual DB snapshot that the attributes apply to.</p>
    ${AwPropertyDbSnapshotIdentifier},
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRdsDbSnapshotAttributesResultPropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorRdDbSnapshotAttributeResult_CreateExpanded';
        }
