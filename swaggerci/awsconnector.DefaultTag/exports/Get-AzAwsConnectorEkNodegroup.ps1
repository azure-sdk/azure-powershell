...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoreknodegroup
#>
function Get-AzAwsConnectorEkNodegroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEkNodegroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEkNodegroup_List1';
        }
