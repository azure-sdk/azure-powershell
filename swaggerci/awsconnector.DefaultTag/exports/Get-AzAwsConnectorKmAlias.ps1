...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorkmalias
#>
function Get-AzAwsConnectorKmAlias {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorKmAlias_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorKmAlias_List1';
        }
