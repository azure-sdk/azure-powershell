...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriampasswordpolicy
#>
function Get-AzAwsConnectorIamPasswordPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPasswordPolicy_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPasswordPolicy_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPasswordPolicy_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPasswordPolicy_List1';
        }
