...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorloggroup
#>
function Get-AzAwsConnectorLogGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLogGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLogGroup_List1';
        }
