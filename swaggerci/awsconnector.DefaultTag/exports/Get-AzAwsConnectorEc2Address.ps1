...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2address
#>
function Get-AzAwsConnectorEc2Address {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Address_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Address_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Address_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Address_List1';
        }
