...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsnssubscription
#>
function Get-AzAwsConnectorSnsSubscription {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ISnsSubscription])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSnsSubscription_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSnsSubscription_GetViaIdentity';
        }
