...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2snapshot
#>
function Get-AzAwsConnectorEc2Snapshot {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Snapshot_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Snapshot_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Snapshot_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Snapshot_List1';
        }
