...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorroute53resourcerecordset
#>
function Remove-AzAwsConnectorRoute53ResourceRecordSet {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRoute53ResourceRecordSet_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRoute53ResourceRecordSet_DeleteViaIdentity';
        }
