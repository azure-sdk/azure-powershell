...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcodebuildsourcecredentialsinfo
#>
function Get-AzAwsConnectorCodeBuildSourceCredentialsInfo {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildSourceCredentialsInfo_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildSourceCredentialsInfo_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildSourceCredentialsInfo_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildSourceCredentialsInfo_List1';
        }
