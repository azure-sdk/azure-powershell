...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriamaccesskeymetadatainfo
#>
function Remove-AzAwsConnectorIamAccessKeyMetadataInfo {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamAccessKeyMetadataInfo_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamAccessKeyMetadataInfo_DeleteViaIdentity';
        }
