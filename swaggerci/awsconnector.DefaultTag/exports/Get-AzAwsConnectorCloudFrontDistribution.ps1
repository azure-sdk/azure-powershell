...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcloudfrontdistribution
#>
function Get-AzAwsConnectorCloudFrontDistribution {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFrontDistribution_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFrontDistribution_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFrontDistribution_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFrontDistribution_List1';
        }
