...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorautoscalinggroup
#>
function Remove-AzAwsConnectorAutoScalingGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorAutoScalingGroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorAutoScalingGroup_DeleteViaIdentity';
        }
