...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectormacieallowlist
#>
function Get-AzAwsConnectorMacieAllowList {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorMacieAllowList_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorMacieAllowList_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorMacieAllowList_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorMacieAllowList_List1';
        }
