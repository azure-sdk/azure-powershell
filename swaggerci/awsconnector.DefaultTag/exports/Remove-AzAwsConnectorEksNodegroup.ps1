...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoreksnodegroup
#>
function Remove-AzAwsConnectorEksNodegroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEksNodegroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEksNodegroup_DeleteViaIdentity';
        }
