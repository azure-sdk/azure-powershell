...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorroute53resourcerecordset
#>
function Get-AzAwsConnectorRoute53ResourceRecordSet {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53ResourceRecordSet_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53ResourceRecordSet_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53ResourceRecordSet_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53ResourceRecordSet_List1';
        }
