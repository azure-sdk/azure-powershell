...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoraccessanalyzer
#>
function Get-AzAwsConnectorAccessAnalyzer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorAccessAnalyzer_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorAccessAnalyzer_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorAccessAnalyzer_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorAccessAnalyzer_List1';
        }
