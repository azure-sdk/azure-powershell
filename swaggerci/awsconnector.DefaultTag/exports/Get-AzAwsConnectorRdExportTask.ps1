...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdexporttask
#>
function Get-AzAwsConnectorRdExportTask {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRdExportTask_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRdExportTask_List1';
        }
