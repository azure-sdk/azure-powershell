...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorec2image
#>
function Update-AzAwsConnectorEc2Image {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IEc2ImageTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorEc2Image_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorEc2Image_UpdateViaIdentityExpanded';
        }
