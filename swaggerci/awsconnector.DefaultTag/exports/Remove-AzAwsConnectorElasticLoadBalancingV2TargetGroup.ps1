...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorelasticloadbalancingv2targetgroup
#>
function Remove-AzAwsConnectorElasticLoadBalancingV2TargetGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingV2TargetGroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorElasticLoadBalancingV2TargetGroup_DeleteViaIdentity';
        }
