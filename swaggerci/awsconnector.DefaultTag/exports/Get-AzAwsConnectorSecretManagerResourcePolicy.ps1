...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsecretmanagerresourcepolicy
#>
function Get-AzAwsConnectorSecretManagerResourcePolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ISecretsManagerResourcePolicy])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretManagerResourcePolicy_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretManagerResourcePolicy_List1';
        }
