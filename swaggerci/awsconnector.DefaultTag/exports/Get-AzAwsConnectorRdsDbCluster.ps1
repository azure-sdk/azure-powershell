...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdsdbcluster
#>
function Get-AzAwsConnectorRdsDbCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbCluster_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbCluster_GetViaIdentity';
        }
