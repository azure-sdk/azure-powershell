...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoreksnodegroup
#>
function Get-AzAwsConnectorEksNodegroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEksNodegroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEksNodegroup_GetViaIdentity';
        }
