...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectordynamodbcontinuousbackupsdescription
#>
function Update-AzAwsConnectorDynamoDbContinuousBackupsDescription {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbContinuousBackupsDescription])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbContinuousBackupsDescriptionTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorDynamoDbContinuousBackupsDescription_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorDynamoDbContinuousBackupsDescription_UpdateViaIdentityExpanded';
        }
