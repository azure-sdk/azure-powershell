...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorec2keypair
#>
function Remove-AzAwsConnectorEc2KeyPair {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2KeyPair_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2KeyPair_DeleteViaIdentity';
        }
