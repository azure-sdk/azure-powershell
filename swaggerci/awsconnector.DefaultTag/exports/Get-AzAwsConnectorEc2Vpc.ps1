...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2vpc
#>
function Get-AzAwsConnectorEc2Vpc {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Vpc_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Vpc_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Vpc_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Vpc_List1';
        }
