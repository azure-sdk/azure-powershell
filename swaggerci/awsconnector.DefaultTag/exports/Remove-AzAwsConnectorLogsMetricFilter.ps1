...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlogsmetricfilter
#>
function Remove-AzAwsConnectorLogsMetricFilter {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsMetricFilter_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsMetricFilter_DeleteViaIdentity';
        }
