...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorsnssubscription
#>
function Remove-AzAwsConnectorSnsSubscription {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorSnsSubscription_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorSnsSubscription_DeleteViaIdentity';
        }
