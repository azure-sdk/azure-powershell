...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorappsyncgraphqlapi
#>
function Remove-AzAwsConnectorAppSyncGraphqlApi {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorAppSyncGraphqlApi_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorAppSyncGraphqlApi_DeleteViaIdentity';
        }
