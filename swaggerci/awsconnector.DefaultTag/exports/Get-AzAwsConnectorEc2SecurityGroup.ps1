...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2securitygroup
#>
function Get-AzAwsConnectorEc2SecurityGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2SecurityGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2SecurityGroup_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2SecurityGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2SecurityGroup_List1';
        }
