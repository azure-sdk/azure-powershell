...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlightsailbucket
#>
function Remove-AzAwsConnectorLightsailBucket {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLightsailBucket_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLightsailBucket_DeleteViaIdentity';
        }
