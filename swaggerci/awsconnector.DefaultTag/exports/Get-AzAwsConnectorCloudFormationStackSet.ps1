...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcloudformationstackset
#>
function Get-AzAwsConnectorCloudFormationStackSet {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStackSet_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStackSet_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStackSet_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStackSet_List1';
        }
