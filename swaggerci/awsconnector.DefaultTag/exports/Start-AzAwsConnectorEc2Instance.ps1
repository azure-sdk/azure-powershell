...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/start-azawsconnectorec2instance
#>
function Start-AzAwsConnectorEc2Instance {
...
begin {
    try {
        ...
        $mapping = @{
            Start = 'Az.AwsConnector.private\Start-AzAwsConnectorEc2Instance_Start';
            StartViaIdentity = 'Az.AwsConnector.private\Start-AzAwsConnectorEc2Instance_StartViaIdentity';
        }
