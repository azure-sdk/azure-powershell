...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorecrimagedetail
#>
function Remove-AzAwsConnectorEcrImageDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcrImageDetail_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcrImageDetail_DeleteViaIdentity';
        }
