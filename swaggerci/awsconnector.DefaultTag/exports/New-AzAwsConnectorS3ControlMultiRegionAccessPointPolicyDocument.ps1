...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectors3controlmultiregionaccesspointpolicydocument
#>
function New-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IS3ControlMultiRegionAccessPointPolicyDocumentPropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_CreateExpanded';
        }
