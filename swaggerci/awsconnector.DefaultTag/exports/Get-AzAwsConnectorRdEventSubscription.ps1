...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdeventsubscription
#>
function Get-AzAwsConnectorRdEventSubscription {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRdEventSubscription_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRdEventSubscription_List1';
        }
