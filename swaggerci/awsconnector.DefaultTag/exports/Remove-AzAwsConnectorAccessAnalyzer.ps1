...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoraccessanalyzer
#>
function Remove-AzAwsConnectorAccessAnalyzer {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorAccessAnalyzer_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorAccessAnalyzer_DeleteViaIdentity';
        }
