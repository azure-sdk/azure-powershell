...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectors3controlmultiregionaccesspointpolicydocument
#>
function Remove-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument_DeleteViaIdentity';
        }
