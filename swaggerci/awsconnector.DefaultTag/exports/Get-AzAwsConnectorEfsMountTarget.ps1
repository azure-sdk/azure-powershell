...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorefsmounttarget
#>
function Get-AzAwsConnectorEfsMountTarget {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEfsMountTarget_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEfsMountTarget_GetViaIdentity';
        }
