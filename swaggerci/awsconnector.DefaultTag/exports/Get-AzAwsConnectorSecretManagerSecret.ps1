...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsecretmanagersecret
#>
function Get-AzAwsConnectorSecretManagerSecret {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretManagerSecret_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretManagerSecret_List1';
        }
