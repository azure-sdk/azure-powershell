...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectororganizationaccount
#>
function Get-AzAwsConnectorOrganizationAccount {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganizationAccount_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganizationAccount_List1';
        }
