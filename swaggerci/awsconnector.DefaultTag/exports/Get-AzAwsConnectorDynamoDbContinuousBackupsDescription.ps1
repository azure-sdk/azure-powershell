...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectordynamodbcontinuousbackupsdescription
#>
function Get-AzAwsConnectorDynamoDbContinuousBackupsDescription {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbContinuousBackupsDescription_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbContinuousBackupsDescription_GetViaIdentity';
        }
