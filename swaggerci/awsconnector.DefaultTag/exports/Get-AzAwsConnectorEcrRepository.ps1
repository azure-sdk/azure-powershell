...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorecrrepository
#>
function Get-AzAwsConnectorEcrRepository {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrRepository_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrRepository_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrRepository_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEcrRepository_List1';
        }
