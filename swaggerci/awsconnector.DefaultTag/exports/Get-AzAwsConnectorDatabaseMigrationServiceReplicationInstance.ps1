...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectordatabasemigrationservicereplicationinstance
#>
function Get-AzAwsConnectorDatabaseMigrationServiceReplicationInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_List1';
        }
