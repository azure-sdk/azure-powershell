...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorelasticloadbalancingv2targethealthdescription
#>
function Update-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticLoadBalancingv2TargetHealthDescriptionTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticLoadBalancingv2TargetHealthDescription_UpdateViaIdentityExpanded';
        }
