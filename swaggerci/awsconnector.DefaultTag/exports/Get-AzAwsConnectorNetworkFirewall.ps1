...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectornetworkfirewall
#>
function Get-AzAwsConnectorNetworkFirewall {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewall_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewall_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewall_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorNetworkFirewall_List1';
        }
