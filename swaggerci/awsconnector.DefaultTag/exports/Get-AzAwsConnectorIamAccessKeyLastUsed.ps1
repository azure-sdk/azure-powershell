...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriamaccesskeylastused
#>
function Get-AzAwsConnectorIamAccessKeyLastUsed {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyLastUsed_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyLastUsed_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyLastUsed_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamAccessKeyLastUsed_List1';
        }
