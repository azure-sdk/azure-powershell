...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2accountattribute
#>
function Get-AzAwsConnectorEc2AccountAttribute {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2AccountAttribute_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2AccountAttribute_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2AccountAttribute_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2AccountAttribute_List1';
        }
