...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorconfigserviceconfigurationrecorder
#>
function Remove-AzAwsConnectorConfigServiceConfigurationRecorder {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorConfigServiceConfigurationRecorder_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorConfigServiceConfigurationRecorder_DeleteViaIdentity';
        }
