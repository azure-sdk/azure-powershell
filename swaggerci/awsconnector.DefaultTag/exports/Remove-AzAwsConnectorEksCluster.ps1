...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorekscluster
#>
function Remove-AzAwsConnectorEksCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEksCluster_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEksCluster_DeleteViaIdentity';
        }
