...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorroute53domainsdomainsummary
#>
function Remove-AzAwsConnectorRoute53DomainsDomainSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRoute53DomainsDomainSummary_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRoute53DomainsDomainSummary_DeleteViaIdentity';
        }
