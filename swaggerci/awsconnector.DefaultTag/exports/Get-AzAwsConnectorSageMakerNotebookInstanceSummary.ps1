...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsagemakernotebookinstancesummary
#>
function Get-AzAwsConnectorSageMakerNotebookInstanceSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerNotebookInstanceSummary_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerNotebookInstanceSummary_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerNotebookInstanceSummary_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSageMakerNotebookInstanceSummary_List1';
        }
