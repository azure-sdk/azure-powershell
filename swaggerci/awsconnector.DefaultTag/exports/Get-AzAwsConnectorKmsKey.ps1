...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorkmskey
#>
function Get-AzAwsConnectorKmsKey {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorKmsKey_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorKmsKey_GetViaIdentity';
        }
