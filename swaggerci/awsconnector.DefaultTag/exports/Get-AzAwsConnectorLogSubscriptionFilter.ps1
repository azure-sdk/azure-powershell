...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogsubscriptionfilter
#>
function Get-AzAwsConnectorLogSubscriptionFilter {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLogSubscriptionFilter_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLogSubscriptionFilter_List1';
        }
