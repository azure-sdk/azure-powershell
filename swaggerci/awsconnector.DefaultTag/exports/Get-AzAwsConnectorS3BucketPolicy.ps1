...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectors3bucketpolicy
#>
function Get-AzAwsConnectorS3BucketPolicy {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IS3BucketPolicy])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorS3BucketPolicy_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorS3BucketPolicy_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorS3BucketPolicy_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorS3BucketPolicy_List1';
        }
