...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticloadbalancingv2targetgroup
#>
function Get-AzAwsConnectorElasticLoadBalancingV2TargetGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2TargetGroup_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2TargetGroup_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2TargetGroup_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2TargetGroup_List1';
        }
