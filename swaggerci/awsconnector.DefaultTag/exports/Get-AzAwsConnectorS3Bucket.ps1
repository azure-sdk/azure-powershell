...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectors3bucket
#>
function Get-AzAwsConnectorS3Bucket {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorS3Bucket_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorS3Bucket_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorS3Bucket_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorS3Bucket_List1';
        }
