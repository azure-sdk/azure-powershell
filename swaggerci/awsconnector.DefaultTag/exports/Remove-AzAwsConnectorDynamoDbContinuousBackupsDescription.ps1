...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectordynamodbcontinuousbackupsdescription
#>
function Remove-AzAwsConnectorDynamoDbContinuousBackupsDescription {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorDynamoDbContinuousBackupsDescription_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorDynamoDbContinuousBackupsDescription_DeleteViaIdentity';
        }
