...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogssubscriptionfilter
#>
function Get-AzAwsConnectorLogsSubscriptionFilter {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILogsSubscriptionFilter])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsSubscriptionFilter_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLogsSubscriptionFilter_GetViaIdentity';
        }
