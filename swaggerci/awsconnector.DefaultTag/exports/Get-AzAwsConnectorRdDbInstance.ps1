...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrddbinstance
#>
function Get-AzAwsConnectorRdDbInstance {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbInstance_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbInstance_List1';
        }
