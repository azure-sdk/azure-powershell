...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2subnet
#>
function Get-AzAwsConnectorEc2Subnet {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Subnet_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Subnet_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Subnet_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Subnet_List1';
        }
