...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorkmsalias
#>
function Get-AzAwsConnectorKmsAlias {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorKmsAlias_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorKmsAlias_GetViaIdentity';
        }
