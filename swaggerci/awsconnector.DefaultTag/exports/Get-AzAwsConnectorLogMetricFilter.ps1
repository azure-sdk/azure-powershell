...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlogmetricfilter
#>
function Get-AzAwsConnectorLogMetricFilter {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLogMetricFilter_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLogMetricFilter_List1';
        }
