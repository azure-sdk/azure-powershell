...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectornetworkfirewallpolicy
#>
function Remove-AzAwsConnectorNetworkFirewallPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorNetworkFirewallPolicy_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorNetworkFirewallPolicy_DeleteViaIdentity';
        }
