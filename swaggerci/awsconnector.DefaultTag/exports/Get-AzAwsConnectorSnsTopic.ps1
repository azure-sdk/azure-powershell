...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsnstopic
#>
function Get-AzAwsConnectorSnsTopic {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSnsTopic_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSnsTopic_GetViaIdentity';
        }
