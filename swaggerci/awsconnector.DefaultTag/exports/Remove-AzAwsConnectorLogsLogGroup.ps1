...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlogsloggroup
#>
function Remove-AzAwsConnectorLogsLogGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsLogGroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLogsLogGroup_DeleteViaIdentity';
        }
