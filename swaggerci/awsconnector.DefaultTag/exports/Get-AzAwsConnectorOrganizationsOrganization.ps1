...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectororganizationsorganization
#>
function Get-AzAwsConnectorOrganizationsOrganization {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganizationsOrganization_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganizationsOrganization_GetViaIdentity';
        }
