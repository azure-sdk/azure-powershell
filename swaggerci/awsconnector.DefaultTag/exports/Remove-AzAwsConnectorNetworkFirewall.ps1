...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectornetworkfirewall
#>
function Remove-AzAwsConnectorNetworkFirewall {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorNetworkFirewall_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorNetworkFirewall_DeleteViaIdentity';
        }
