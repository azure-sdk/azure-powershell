...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorredshiftcluster
#>
function Remove-AzAwsConnectorRedshiftCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRedshiftCluster_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRedshiftCluster_DeleteViaIdentity';
        }
