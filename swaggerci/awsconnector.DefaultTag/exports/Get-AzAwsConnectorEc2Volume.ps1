...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2volume
#>
function Get-AzAwsConnectorEc2Volume {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Volume_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Volume_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Volume_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2Volume_List1';
        }
