...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorrdseventsubscription
#>
function Remove-AzAwsConnectorRdsEventSubscription {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsEventSubscription_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsEventSubscription_DeleteViaIdentity';
        }
