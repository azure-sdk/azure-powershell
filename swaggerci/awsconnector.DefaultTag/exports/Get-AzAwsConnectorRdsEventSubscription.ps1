...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdseventsubscription
#>
function Get-AzAwsConnectorRdsEventSubscription {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsEventSubscription_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsEventSubscription_GetViaIdentity';
        }
