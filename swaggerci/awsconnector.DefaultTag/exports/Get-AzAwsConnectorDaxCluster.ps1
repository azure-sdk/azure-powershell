...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectordaxcluster
#>
function Get-AzAwsConnectorDaxCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorDaxCluster_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorDaxCluster_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorDaxCluster_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorDaxCluster_List1';
        }
