...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorrdsdbsnapshotattributesresult
#>
function Remove-AzAwsConnectorRdsDbSnapshotAttributesResult {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbSnapshotAttributesResult_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRdsDbSnapshotAttributesResult_DeleteViaIdentity';
        }
