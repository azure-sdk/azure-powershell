...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsqsqueue
#>
function Get-AzAwsConnectorSqsQueue {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSqsQueue_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSqsQueue_GetViaIdentity';
        }
