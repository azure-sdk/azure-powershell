...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlightsailinstance
#>
function Remove-AzAwsConnectorLightsailInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLightsailInstance_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLightsailInstance_DeleteViaIdentity';
        }
