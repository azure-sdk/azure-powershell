...
AWSPROPERTY <IAwsLightsailInstanceProperties>: AWS Properties
  [AddOn <IAddOn[]>]: An array of objects representing the add-ons to enable for the new instance.
    [AutoSnapshotAddOnRequestSnapshotTimeOfDay <String>]: The daily time when an automatic snapshot will be created.
    [Status <AddOnStatus?>]: Status of the Addon
  ...
  [HardwareCpuCount <Int32?>]: CPU count of the Instance.
  [HardwareDisk <IDisk[]>]: Disks attached to the Instance.
    [AttachedTo <String>]: Instance attached to the disk.
    [AttachmentState <String>]: Attachment state of the disk.
    [Iop <Int32?>]: IOPS of disk.
    [IsSystemDisk <Boolean?>]: Is the Attached disk is the system disk of the Instance.
  ...
  [HardwareRamSizeInGb <Int32?>]: RAM Size of the Instance.
  [InstanceArn <String>]: Property instanceArn
  ...
  [LocationAvailabilityZone <String>]: The Availability Zone in which to create your instance. Use the following format: us-east-2a (case sensitive). Be sure to add the include Availability Zones parameter to your request.
  [LocationRegionName <String>]: The Region Name in which to create your instance.
  [MonthlyTransferGbPerMonthAllocated <String>]: GbPerMonthAllocated of the Instance.
  [NetworkingPort <IPort[]>]: Ports to the Instance.
    ...
    [Cidr <String[]>]: Property cidrs
    [CidrListAlias <String[]>]: cidr List Aliases
    [CommonName <String>]: CommonName for Protocol of the Instance.
    [FromPort <Int32?>]: From Port of the Instance.
    [Ipv6Cidr <String[]>]: IPv6 Cidrs
    [Protocol <String>]: Port Protocol of the Instance.
    [ToPort <Int32?>]: To Port of the Instance.
  ...
  [StateCode <Int32?>]: Status code of the Instance.
  [StateName <String>]: Status code of the Instance.
  [SupportCode <String>]: Support code to help identify any issues
  [Tag <ITagAutoGenerated39[]>]: An array of key-value pairs to apply to this resource.
...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorlightsailinstance
#>
function New-AzAwsConnectorLightsailInstance {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILightsailInstancePropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorLightsailInstance_CreateExpanded';
        }
