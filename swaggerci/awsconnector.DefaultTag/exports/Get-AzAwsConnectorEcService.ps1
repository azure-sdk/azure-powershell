...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorecservice
#>
function Get-AzAwsConnectorEcService {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IEcsService])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEcService_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEcService_List1';
        }
