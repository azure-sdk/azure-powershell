...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectoriamvirtualmfadevice
#>
function Update-AzAwsConnectorIamVirtualMfaDevice {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IIamVirtualMfaDeviceTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorIamVirtualMfaDevice_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorIamVirtualMfaDevice_UpdateViaIdentityExpanded';
        }
