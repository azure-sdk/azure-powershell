...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2vpcendpoint
#>
function Get-AzAwsConnectorEc2VpcEndpoint {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2VpcEndpoint_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2VpcEndpoint_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2VpcEndpoint_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2VpcEndpoint_List1';
        }
