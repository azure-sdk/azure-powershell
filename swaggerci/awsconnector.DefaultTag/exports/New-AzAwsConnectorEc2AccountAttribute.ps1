...
AWPROPERTYATTRIBUTEVALUE <IAccountAttributeValue[]>: <p>The values for the account attribute.</p>
  [AttributeValue <String>]: <p>The value of the attribute.</p>
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorec2accountattribute
#>
function New-AzAwsConnectorEc2AccountAttribute {
...
param(
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IEc2AccountAttributePropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorEc2AccountAttribute_CreateExpanded';
        }
