...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorkmskey
#>
function Remove-AzAwsConnectorKmsKey {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorKmsKey_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorKmsKey_DeleteViaIdentity';
        }
