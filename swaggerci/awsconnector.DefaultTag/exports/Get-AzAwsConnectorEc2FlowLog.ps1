...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2flowlog
#>
function Get-AzAwsConnectorEc2FlowLog {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2FlowLog_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2FlowLog_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2FlowLog_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2FlowLog_List1';
        }
