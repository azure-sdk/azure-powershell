...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorefsmounttarget
#>
function Remove-AzAwsConnectorEfsMountTarget {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEfsMountTarget_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEfsMountTarget_DeleteViaIdentity';
        }
