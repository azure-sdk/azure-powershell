...
AWPROPERTYTAG <ITagAutoGenerated41[]>: A collection of tags associated with a resource
  [Key <String>]: The tag's key.
  [Value <String>]: The tag's value.
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectormacieallowlist
#>
function New-AzAwsConnectorMacieAllowList {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IMacieAllowList])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Status])]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Status]
    # AllowList status.
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IMacieAllowListPropertiesAwsTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'Az.AwsConnector.private\New-AzAwsConnectorMacieAllowList_CreateExpanded';
        }
