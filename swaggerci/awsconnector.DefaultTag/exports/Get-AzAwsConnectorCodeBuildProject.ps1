...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcodebuildproject
#>
function Get-AzAwsConnectorCodeBuildProject {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildProject_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildProject_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildProject_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCodeBuildProject_List1';
        }
