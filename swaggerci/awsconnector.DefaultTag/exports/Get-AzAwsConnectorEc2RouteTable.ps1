...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2routetable
#>
function Get-AzAwsConnectorEc2RouteTable {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2RouteTable_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2RouteTable_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2RouteTable_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2RouteTable_List1';
        }
