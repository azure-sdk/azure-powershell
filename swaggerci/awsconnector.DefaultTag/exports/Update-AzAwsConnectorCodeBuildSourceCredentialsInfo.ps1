...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorcodebuildsourcecredentialsinfo
#>
function Update-AzAwsConnectorCodeBuildSourceCredentialsInfo {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ICodeBuildSourceCredentialsInfo])]
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ICodeBuildSourceCredentialsInfoTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorCodeBuildSourceCredentialsInfo_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorCodeBuildSourceCredentialsInfo_UpdateViaIdentityExpanded';
        }
