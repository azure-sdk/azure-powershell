...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2instancestatuses
#>
function Get-AzAwsConnectorEc2InstanceStatuses {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2InstanceStatuses_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2InstanceStatuses_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2InstanceStatuses_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2InstanceStatuses_List1';
        }
