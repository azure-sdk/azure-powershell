...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectormacie2jobsummary
#>
function Get-AzAwsConnectorMacie2JobSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorMacie2JobSummary_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorMacie2JobSummary_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorMacie2JobSummary_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorMacie2JobSummary_List1';
        }
