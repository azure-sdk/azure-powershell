...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorredshiftclusterparametergroup
#>
function Remove-AzAwsConnectorRedshiftClusterParameterGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorRedshiftClusterParameterGroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorRedshiftClusterParameterGroup_DeleteViaIdentity';
        }
