...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriamgroup
#>
function Remove-AzAwsConnectorIamGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamGroup_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamGroup_DeleteViaIdentity';
        }
