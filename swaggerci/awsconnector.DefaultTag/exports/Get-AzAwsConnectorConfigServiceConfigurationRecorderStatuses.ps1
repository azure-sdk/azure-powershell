...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorconfigserviceconfigurationrecorderstatuses
#>
function Get-AzAwsConnectorConfigServiceConfigurationRecorderStatuses {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorConfigServiceConfigurationRecorderStatuses_List1';
        }
