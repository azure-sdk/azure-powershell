...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectordynamodbtable
#>
function Get-AzAwsConnectorDynamoDbTable {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbTable_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbTable_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbTable_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorDynamoDbTable_List1';
        }
