...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorec2vpcpeeringconnection
#>
function Remove-AzAwsConnectorEc2VpcPeeringConnection {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2VpcPeeringConnection_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2VpcPeeringConnection_DeleteViaIdentity';
        }
