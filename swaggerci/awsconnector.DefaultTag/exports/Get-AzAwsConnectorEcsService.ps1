...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorecsservice
#>
function Get-AzAwsConnectorEcsService {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEcsService_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEcsService_GetViaIdentity';
        }
