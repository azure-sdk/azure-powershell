...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorecsservice
#>
function Remove-AzAwsConnectorEcsService {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcsService_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcsService_DeleteViaIdentity';
        }
