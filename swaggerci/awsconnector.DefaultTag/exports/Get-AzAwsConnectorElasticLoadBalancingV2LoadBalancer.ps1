...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticloadbalancingv2loadbalancer
#>
function Get-AzAwsConnectorElasticLoadBalancingV2LoadBalancer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticLoadBalancingV2LoadBalancer_List1';
        }
