...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorec2networkacls
#>
function Get-AzAwsConnectorEc2NetworkAcls {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkAcls_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkAcls_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkAcls_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEc2NetworkAcls_List1';
        }
