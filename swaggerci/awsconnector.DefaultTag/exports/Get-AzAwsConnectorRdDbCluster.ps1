...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrddbcluster
#>
function Get-AzAwsConnectorRdDbCluster {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbCluster_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRdDbCluster_List1';
        }
