...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoremrcluster
#>
function Get-AzAwsConnectorEmrCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEmrCluster_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEmrCluster_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEmrCluster_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEmrCluster_List1';
        }
