...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorelasticbeanstalkconfigurationtemplate
#>
function Update-AzAwsConnectorElasticBeanstalkConfigurationTemplate {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IElasticBeanstalkConfigurationTemplateTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticBeanstalkConfigurationTemplate_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorElasticBeanstalkConfigurationTemplate_UpdateViaIdentityExpanded';
        }
