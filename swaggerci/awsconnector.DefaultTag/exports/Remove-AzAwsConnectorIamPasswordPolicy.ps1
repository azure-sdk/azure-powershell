...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriampasswordpolicy
#>
function Remove-AzAwsConnectorIamPasswordPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamPasswordPolicy_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamPasswordPolicy_DeleteViaIdentity';
        }
