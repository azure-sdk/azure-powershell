...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriamvirtualmfadevice
#>
function Get-AzAwsConnectorIamVirtualMfaDevice {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IIamVirtualMfaDevice])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamVirtualMfaDevice_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamVirtualMfaDevice_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamVirtualMfaDevice_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamVirtualMfaDevice_List1';
        }
