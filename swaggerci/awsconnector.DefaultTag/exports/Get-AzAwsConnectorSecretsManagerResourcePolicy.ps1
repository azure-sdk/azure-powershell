...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsecretsmanagerresourcepolicy
#>
function Get-AzAwsConnectorSecretsManagerResourcePolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretsManagerResourcePolicy_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretsManagerResourcePolicy_GetViaIdentity';
        }
