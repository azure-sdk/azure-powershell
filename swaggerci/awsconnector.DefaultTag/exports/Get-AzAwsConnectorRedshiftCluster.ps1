...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorredshiftcluster
#>
function Get-AzAwsConnectorRedshiftCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftCluster_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftCluster_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftCluster_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRedshiftCluster_List1';
        }
