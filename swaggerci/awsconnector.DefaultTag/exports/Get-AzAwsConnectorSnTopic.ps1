...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsntopic
#>
function Get-AzAwsConnectorSnTopic {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSnTopic_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSnTopic_List1';
        }
