...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectoriampolicyversion
#>
function Remove-AzAwsConnectorIamPolicyVersion {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamPolicyVersion_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorIamPolicyVersion_DeleteViaIdentity';
        }
