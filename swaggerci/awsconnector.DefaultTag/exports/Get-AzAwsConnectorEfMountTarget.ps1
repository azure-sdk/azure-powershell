...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorefmounttarget
#>
function Get-AzAwsConnectorEfMountTarget {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorEfMountTarget_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorEfMountTarget_List1';
        }
