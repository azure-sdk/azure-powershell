...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectordaxcluster
#>
function Remove-AzAwsConnectorDaxCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorDaxCluster_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorDaxCluster_DeleteViaIdentity';
        }
