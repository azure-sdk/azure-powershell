...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorlambdafunction
#>
function Remove-AzAwsConnectorLambdaFunction {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorLambdaFunction_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorLambdaFunction_DeleteViaIdentity';
        }
