...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorapigatewaystage
#>
function Get-AzAwsConnectorApiGatewayStage {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayStage_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayStage_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayStage_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorApiGatewayStage_List1';
        }
