...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorrdsdbsnapshot
#>
function Get-AzAwsConnectorRdsDbSnapshot {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbSnapshot_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorRdsDbSnapshot_GetViaIdentity';
        }
