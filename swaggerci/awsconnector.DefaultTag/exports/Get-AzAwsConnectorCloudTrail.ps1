...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcloudtrail
#>
function Get-AzAwsConnectorCloudTrail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudTrail_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudTrail_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudTrail_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudTrail_List1';
        }
