...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorecscluster
#>
function Remove-AzAwsConnectorEcsCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcsCluster_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEcsCluster_DeleteViaIdentity';
        }
