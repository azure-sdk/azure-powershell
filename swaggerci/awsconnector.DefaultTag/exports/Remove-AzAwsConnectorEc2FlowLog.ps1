...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorec2flowlog
#>
function Remove-AzAwsConnectorEc2FlowLog {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2FlowLog_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2FlowLog_DeleteViaIdentity';
        }
