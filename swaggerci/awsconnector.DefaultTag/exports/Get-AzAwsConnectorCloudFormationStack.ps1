...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorcloudformationstack
#>
function Get-AzAwsConnectorCloudFormationStack {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStack_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStack_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStack_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorCloudFormationStack_List1';
        }
