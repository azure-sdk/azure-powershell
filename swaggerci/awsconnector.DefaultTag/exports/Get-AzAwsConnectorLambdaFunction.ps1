...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorlambdafunction
#>
function Get-AzAwsConnectorLambdaFunction {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunction_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunction_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunction_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorLambdaFunction_List1';
        }
