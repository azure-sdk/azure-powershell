...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorecscluster
#>
function Get-AzAwsConnectorEcsCluster {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorEcsCluster_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorEcsCluster_GetViaIdentity';
        }
