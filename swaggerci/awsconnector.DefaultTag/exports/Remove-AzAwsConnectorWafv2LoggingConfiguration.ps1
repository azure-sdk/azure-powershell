...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorwafv2loggingconfiguration
#>
function Remove-AzAwsConnectorWafv2LoggingConfiguration {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorWafv2LoggingConfiguration_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorWafv2LoggingConfiguration_DeleteViaIdentity';
        }
