...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorssmresourcecompliancesummaryitem
#>
function Get-AzAwsConnectorSsmResourceComplianceSummaryItem {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmResourceComplianceSummaryItem_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmResourceComplianceSummaryItem_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmResourceComplianceSummaryItem_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorSsmResourceComplianceSummaryItem_List1';
        }
