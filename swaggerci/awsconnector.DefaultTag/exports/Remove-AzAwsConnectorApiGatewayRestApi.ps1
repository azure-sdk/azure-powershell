...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorapigatewayrestapi
#>
function Remove-AzAwsConnectorApiGatewayRestApi {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorApiGatewayRestApi_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorApiGatewayRestApi_DeleteViaIdentity';
        }
