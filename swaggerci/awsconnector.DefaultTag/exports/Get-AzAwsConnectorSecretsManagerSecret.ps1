...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorsecretsmanagersecret
#>
function Get-AzAwsConnectorSecretsManagerSecret {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretsManagerSecret_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorSecretsManagerSecret_GetViaIdentity';
        }
