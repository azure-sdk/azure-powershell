...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorec2instancestatuses
#>
function Remove-AzAwsConnectorEc2InstanceStatuses {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2InstanceStatuses_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorEc2InstanceStatuses_DeleteViaIdentity';
        }
