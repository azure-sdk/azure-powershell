...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectororganizationsaccount
#>
function Get-AzAwsConnectorOrganizationsAccount {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganizationsAccount_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorOrganizationsAccount_GetViaIdentity';
        }
