...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorwafwebaclsummary
#>
function Get-AzAwsConnectorWafWebAclSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorWafWebAclSummary_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorWafWebAclSummary_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorWafWebAclSummary_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorWafWebAclSummary_List1';
        }
