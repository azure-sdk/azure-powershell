...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorelasticbeanstalkapplication
#>
function Get-AzAwsConnectorElasticBeanstalkApplication {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkApplication_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkApplication_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkApplication_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorElasticBeanstalkApplication_List1';
        }
