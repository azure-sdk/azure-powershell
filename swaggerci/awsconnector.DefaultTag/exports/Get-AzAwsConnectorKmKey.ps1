...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorkmkey
#>
function Get-AzAwsConnectorKmKey {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorKmKey_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorKmKey_List1';
        }
