...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorroute53domainsdomainsummary
#>
function Update-AzAwsConnectorRoute53DomainsDomainSummary {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRoute53DomainsDomainSummaryTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRoute53DomainsDomainSummary_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRoute53DomainsDomainSummary_UpdateViaIdentityExpanded';
        }
