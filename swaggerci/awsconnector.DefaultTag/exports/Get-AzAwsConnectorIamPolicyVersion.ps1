...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoriampolicyversion
#>
function Get-AzAwsConnectorIamPolicyVersion {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IIamPolicyVersion])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPolicyVersion_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPolicyVersion_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPolicyVersion_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorIamPolicyVersion_List1';
        }
