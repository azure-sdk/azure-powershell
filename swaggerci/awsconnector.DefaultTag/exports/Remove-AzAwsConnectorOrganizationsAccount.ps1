...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectororganizationsaccount
#>
function Remove-AzAwsConnectorOrganizationsAccount {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorOrganizationsAccount_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorOrganizationsAccount_DeleteViaIdentity';
        }
