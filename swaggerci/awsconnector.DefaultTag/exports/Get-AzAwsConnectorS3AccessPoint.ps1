...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectors3accesspoint
#>
function Get-AzAwsConnectorS3AccessPoint {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessPoint_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessPoint_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessPoint_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorS3AccessPoint_List1';
        }
