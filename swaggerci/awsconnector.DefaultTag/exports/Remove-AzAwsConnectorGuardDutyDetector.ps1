...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectorguarddutydetector
#>
function Remove-AzAwsConnectorGuardDutyDetector {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorGuardDutyDetector_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorGuardDutyDetector_DeleteViaIdentity';
        }
