...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectordatabasemigrationservicereplicationinstance
#>
function Update-AzAwsConnectorDatabaseMigrationServiceReplicationInstance {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDatabaseMigrationServiceReplicationInstanceTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorDatabaseMigrationServiceReplicationInstance_UpdateViaIdentityExpanded';
        }
