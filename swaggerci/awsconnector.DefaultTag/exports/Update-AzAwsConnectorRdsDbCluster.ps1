...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorrdsdbcluster
#>
function Update-AzAwsConnectorRdsDbCluster {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IRdsDbClusterTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRdsDbCluster_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorRdsDbCluster_UpdateViaIdentityExpanded';
        }
