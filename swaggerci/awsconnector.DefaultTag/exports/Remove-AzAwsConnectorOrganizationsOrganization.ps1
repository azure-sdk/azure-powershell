...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/remove-azawsconnectororganizationsorganization
#>
function Remove-AzAwsConnectorOrganizationsOrganization {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.AwsConnector.private\Remove-AzAwsConnectorOrganizationsOrganization_Delete';
            DeleteViaIdentity = 'Az.AwsConnector.private\Remove-AzAwsConnectorOrganizationsOrganization_DeleteViaIdentity';
        }
