...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectorroute53domainsummary
#>
function Get-AzAwsConnectorRoute53DomainSummary {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53DomainSummary_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorRoute53DomainSummary_List1';
        }
