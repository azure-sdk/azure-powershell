...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/get-azawsconnectoracmcertificatesummary
#>
function Get-AzAwsConnectorAcmCertificateSummary {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.AwsConnector.private\Get-AzAwsConnectorAcmCertificateSummary_Get';
            GetViaIdentity = 'Az.AwsConnector.private\Get-AzAwsConnectorAcmCertificateSummary_GetViaIdentity';
            List = 'Az.AwsConnector.private\Get-AzAwsConnectorAcmCertificateSummary_List';
            List1 = 'Az.AwsConnector.private\Get-AzAwsConnectorAcmCertificateSummary_List1';
        }
