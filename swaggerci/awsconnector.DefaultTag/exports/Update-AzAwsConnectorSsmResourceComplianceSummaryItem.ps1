...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorssmresourcecompliancesummaryitem
#>
function Update-AzAwsConnectorSsmResourceComplianceSummaryItem {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ISsmResourceComplianceSummaryItemTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorSsmResourceComplianceSummaryItem_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorSsmResourceComplianceSummaryItem_UpdateViaIdentityExpanded';
        }
