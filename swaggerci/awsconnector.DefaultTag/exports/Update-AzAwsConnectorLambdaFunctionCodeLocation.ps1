...
.Link
https://learn.microsoft.com/powershell/module/az.awsconnector/update-azawsconnectorlambdafunctioncodelocation
#>
function Update-AzAwsConnectorLambdaFunctionCodeLocation {
...
param(
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILambdaFunctionCodeLocationTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorLambdaFunctionCodeLocation_UpdateExpanded';
            UpdateViaIdentityExpanded = 'Az.AwsConnector.private\Update-AzAwsConnectorLambdaFunctionCodeLocation_UpdateViaIdentityExpanded';
        }
