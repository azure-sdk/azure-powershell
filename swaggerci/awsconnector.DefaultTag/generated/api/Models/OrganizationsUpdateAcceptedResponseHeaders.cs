...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models
{
    ...
    public partial class OrganizationsUpdateAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.IOrganizationsUpdateAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.IOrganizationsUpdateAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.IOrganizationsUpdateAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
            if (headers.TryGetValues("Retry-After", out var __retryAfterHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.IOrganizationsUpdateAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader1) is string __headerRetryAfterHeader1 ? int.TryParse( __headerRetryAfterHeader1, out int __headerRetryAfterHeader1Value ) ? __headerRetryAfterHeader1Value : default(int?) : default(int?);
            }
        }
