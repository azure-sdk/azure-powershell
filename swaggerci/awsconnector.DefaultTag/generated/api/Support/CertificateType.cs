...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support
{
    ...
    {
        /// <summary>CertificateType enum AMAZON_ISSUED</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType AmazonIssued = @"AMAZON_ISSUED";

        /// <summary>CertificateType enum IMPORTED</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType Imported = @"IMPORTED";

        /// <summary>CertificateType enum PRIVATE</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType Private = @"PRIVATE";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType e1, Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.CertificateType e2)
        {
            return !e2.Equals(e1);
        }
