...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin AwsKms = @"AWS_KMS";

        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin External = @"EXTERNAL";

        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin System = @"system";

        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin User = @"user";

        public static Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin UserSystem = @"user,system";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin e1, Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.Origin e2)
        {
            return !e2.Equals(e1);
        }
