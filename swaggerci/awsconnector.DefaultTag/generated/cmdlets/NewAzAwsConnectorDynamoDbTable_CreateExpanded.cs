...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>
    /// Create a DynamoDBTable. Please note that end user resource creation is currently restricted, but it will be enabled in
    /// the future.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrReplace=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/dynamoDBTables/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAwsConnectorDynamoDbTable_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"Create a DynamoDBTable. Please note that end user resource creation is currently restricted, but it will be enabled in the future.")]
    ...
    public partial class NewAzAwsConnectorDynamoDbTable_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.DynamoDbTable();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IAwsDynamoDbTableProperties AwsProperty { get => _resourceBody.AwsProperty ?? null /* object */; set => _resourceBody.AwsProperty = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTablePropertiesAwsTags AwsTag { get => _resourceBody.AwsTag ?? null /* object */; set => _resourceBody.AwsTag = value; }
        ...
        /// <summary>Name of DynamoDBTable</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of DynamoDBTable")]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Name of DynamoDBTable",
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable">Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzAwsConnectorDynamoDbTable_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets.NewAzAwsConnectorDynamoDbTable_CreateExpanded Clone()
        {
            var clone = new NewAzAwsConnectorDynamoDbTable_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAwsConnectorDynamoDbTable_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAwsConnectorDynamoDbTable_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DynamoDbTablesCreateOrReplace' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DynamoDbTablesCreateOrReplace(SubscriptionId, ResourceGroupName, Name, _resourceBody, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IDynamoDbTable
