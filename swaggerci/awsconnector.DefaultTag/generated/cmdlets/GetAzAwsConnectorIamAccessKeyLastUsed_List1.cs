...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>List IamAccessKeyLastUsed resources by resource group</summary>
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/iamAccessKeyLastUseds"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAwsConnectorIamAccessKeyLastUsed_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"List IamAccessKeyLastUsed resources by resource group")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/iamAccessKeyLastUseds", ApiVersion = "2024-12-01")]
    public partial class GetAzAwsConnectorIamAccessKeyLastUsed_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAwsConnectorIamAccessKeyLastUsed_List1" /> cmdlet class.
        /// </summary>
        public GetAzAwsConnectorIamAccessKeyLastUsed_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.IamAccessKeyLastUsedsListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.IamAccessKeyLastUsedsListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
