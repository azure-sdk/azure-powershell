...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAwsConnectorS3AccessPoint_Get")]
    ...
    public partial class GetAzAwsConnectorS3AccessPoint_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAwsConnectorS3AccessPoint_Get" /> cmdlet class.
        /// </summary>
        public GetAzAwsConnectorS3AccessPoint_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.S3AccessPointsGet(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
