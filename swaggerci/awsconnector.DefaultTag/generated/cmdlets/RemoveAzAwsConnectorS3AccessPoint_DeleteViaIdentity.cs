...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>Delete a S3AccessPoint</summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/s3AccessPoints/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzAwsConnectorS3AccessPoint_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"Delete a S3AccessPoint")]
    ...
    public partial class RemoveAzAwsConnectorS3AccessPoint_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzAwsConnectorS3AccessPoint_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets.RemoveAzAwsConnectorS3AccessPoint_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzAwsConnectorS3AccessPoint_DeleteViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'S3AccessPointsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.S3AccessPointsDeleteViaIdentity(InputObject.Id, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.S3AccessPointsDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Name ?? null, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzAwsConnectorS3AccessPoint_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzAwsConnectorS3AccessPoint_DeleteViaIdentity()
        {
