...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>
    /// Create a Ec2Address. Please note that end user resource creation is currently restricted, but it will be enabled in the
    /// future.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrReplace=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/ec2Addresses/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAwsConnectorEc2Address_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"Create a Ec2Address. Please note that end user resource creation is currently restricted, but it will be enabled in the future.")]
    ...
    public partial class NewAzAwsConnectorEc2Address_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IEc2Address _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.Ec2Address();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID representing the allocation of the address.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyAllocationId { get => _resourceBody.AwPropertyAllocationId ?? null; set => _resourceBody.AwPropertyAllocationId = value; }

        /// <summary><p>The ID representing the association of the address with an instance.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID representing the association of the address with an instance.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyAssociationId { get => _resourceBody.AwPropertyAssociationId ?? null; set => _resourceBody.AwPropertyAssociationId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The carrier IP address associated. This option is only available for network interfaces which reside in a subnet in a Wavelength Zone (for example an EC2 instance). </p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyCarrierIP { get => _resourceBody.AwPropertyCarrierIP ?? null; set => _resourceBody.AwPropertyCarrierIP = value; }

        /// <summary><p>The customer-owned IP address.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The customer-owned IP address.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyCustomerOwnedIP { get => _resourceBody.AwPropertyCustomerOwnedIP ?? null; set => _resourceBody.AwPropertyCustomerOwnedIP = value; }

        /// <summary><p>The ID of the customer-owned address pool.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID of the customer-owned address pool.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyCustomerOwnedIpv4Pool { get => _resourceBody.AwPropertyCustomerOwnedIpv4Pool ?? null; set => _resourceBody.AwPropertyCustomerOwnedIpv4Pool = value; }

        /// <summary><p>The ID of the instance that the address is associated with (if any).</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID of the instance that the address is associated with (if any).</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyInstanceId { get => _resourceBody.AwPropertyInstanceId ?? null; set => _resourceBody.AwPropertyInstanceId = value; }
        ...
        /// IP addresses.</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The name of the unique set of Availability Zones, Local Zones, or Wavelength Zones from which Amazon Web Services advertises IP addresses.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyNetworkBorderGroup { get => _resourceBody.AwPropertyNetworkBorderGroup ?? null; set => _resourceBody.AwPropertyNetworkBorderGroup = value; }

        /// <summary><p>The ID of the network interface.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID of the network interface.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyNetworkInterfaceId { get => _resourceBody.AwPropertyNetworkInterfaceId ?? null; set => _resourceBody.AwPropertyNetworkInterfaceId = value; }

        /// <summary>
        /// <p>The ID of the Amazon Web Services account that owns the network interface.</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID of the Amazon Web Services account that owns the network interface.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyNetworkInterfaceOwnerId { get => _resourceBody.AwPropertyNetworkInterfaceOwnerId ?? null; set => _resourceBody.AwPropertyNetworkInterfaceOwnerId = value; }

        /// <summary><p>The private IP address associated with the Elastic IP address.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The private IP address associated with the Elastic IP address.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyPrivateIPAddress { get => _resourceBody.AwPropertyPrivateIPAddress ?? null; set => _resourceBody.AwPropertyPrivateIPAddress = value; }

        /// <summary><p>The Elastic IP address.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The Elastic IP address.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyPublicIP { get => _resourceBody.AwPropertyPublicIP ?? null; set => _resourceBody.AwPropertyPublicIP = value; }

        /// <summary><p>The ID of an address pool.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The ID of an address pool.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string AwPropertyPublicIpv4Pool { get => _resourceBody.AwPropertyPublicIpv4Pool ?? null; set => _resourceBody.AwPropertyPublicIpv4Pool = value; }

        /// <summary><p>Any tags assigned to the Elastic IP address.</p></summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Any tags assigned to the Elastic IP address.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ITagAutoGenerated10[] AwPropertyTag { get => _resourceBody.AwPropertyTag ?? null /* arrayOf */; set => _resourceBody.AwPropertyTag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IEc2AddressPropertiesAwsTags AwsTag { get => _resourceBody.AwsTag ?? null /* object */; set => _resourceBody.AwsTag = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.DomainType))]
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.DomainType DomainValue { get => _resourceBody.DomainValue ?? ((Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.DomainType)""); set => _resourceBody.DomainValue = value; }
        ...
        /// <summary>Name of Ec2Address</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of Ec2Address")]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>a duplicate instance of NewAzAwsConnectorEc2Address_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets.NewAzAwsConnectorEc2Address_CreateExpanded Clone()
        {
            var clone = new NewAzAwsConnectorEc2Address_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAwsConnectorEc2Address_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAwsConnectorEc2Address_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'Ec2AddressesCreateOrReplace' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Ec2AddressesCreateOrReplace(SubscriptionId, ResourceGroupName, Name, _resourceBody, onOk, onDefault, this, Pipeline);
