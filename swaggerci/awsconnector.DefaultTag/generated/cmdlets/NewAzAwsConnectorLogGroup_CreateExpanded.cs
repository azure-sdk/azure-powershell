...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>
    /// Create a LogsLogGroup. Please note that end user resource creation is currently restricted, but it will be enabled in
    /// the future.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrReplace=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/logsLogGroups/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAwsConnectorLogGroup_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"Create a LogsLogGroup. Please note that end user resource creation is currently restricted, but it will be enabled in the future.")]
    ...
    public partial class NewAzAwsConnectorLogGroup_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILogsLogGroup _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.LogsLogGroup();
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.LogGroupClass))]
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.LogGroupClass AwPropertyLogGroupClass { get => _resourceBody.AwPropertyLogGroupClass ?? ((Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Support.LogGroupClass)""); set => _resourceBody.AwPropertyLogGroupClass = value; }

        /// <summary>
        /// The name of the log group. If you don't specify a name, CFNlong generates a unique ID for the log group.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The name of the log group. If you don't specify a name, CFNlong generates a unique ID for the log group.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of days to retain the log events in the specified log group. Possible values are: 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, 2192, 2557, 2922, 3288, and 3653. To set a log group so that its log events do not expire, use [DeleteRetentionPolicy](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DeleteRetentionPolicy.html).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int AwPropertyRetentionInDay { get => _resourceBody.AwPropertyRetentionInDay ?? default(int); set => _resourceBody.AwPropertyRetentionInDay = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "An array of key-value pairs to apply to the log group. For more information, see [Tag](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html).")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ITagAutoGenerated40[] AwPropertyTag { get => _resourceBody.AwPropertyTag ?? null /* arrayOf */; set => _resourceBody.AwPropertyTag = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.ILogsLogGroupPropertiesAwsTags AwsTag { get => _resourceBody.AwsTag ?? null /* object */; set => _resourceBody.AwsTag = value; }
        ...
        /// <returns>a duplicate instance of NewAzAwsConnectorLogGroup_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets.NewAzAwsConnectorLogGroup_CreateExpanded Clone()
        {
            var clone = new NewAzAwsConnectorLogGroup_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAwsConnectorLogGroup_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAwsConnectorLogGroup_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LogsLogGroupsCreateOrReplace' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LogsLogGroupsCreateOrReplace(SubscriptionId, ResourceGroupName, Name, _resourceBody, onOk, onDefault, this, Pipeline);
