...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>
    /// Create a IamPasswordPolicy. Please note that end user resource creation is currently restricted, but it will be enabled
    /// in the future.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrReplace=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/iamPasswordPolicies/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAwsConnectorIamPasswordPolicy_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"Create a IamPasswordPolicy. Please note that end user resource creation is currently restricted, but it will be enabled in the future.")]
    ...
    public partial class NewAzAwsConnectorIamPasswordPolicy_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IIamPasswordPolicy _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IamPasswordPolicy();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies whether IAM users are allowed to change their own password. Gives IAM users permissions to <code>iam:ChangePassword</code> for only their user and to the <code>iam:GetAccountPasswordPolicy</code> action. This option does not attach a permissions policy to each user, rather the permissions are applied at the account-level for all users by IAM.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter AwPropertyAllowUsersToChangePassword { get => _resourceBody.AwPropertyAllowUsersToChangePassword ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyAllowUsersToChangePassword = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Indicates whether passwords in the account expire. Returns true if <code>MaxPasswordAge</code> contains a value greater than 0. Returns false if MaxPasswordAge is 0 or not present.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AwPropertyExpirePassword { get => _resourceBody.AwPropertyExpirePassword ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyExpirePassword = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies whether IAM users are prevented from setting a new password via the Amazon Web Services Management Console after their password has expired. The IAM user cannot access the console until an administrator resets the password. IAM users with <code>iam:ChangePassword</code> permission and active access keys can reset their own expired console password using the CLI or API.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AwPropertyHardExpiry { get => _resourceBody.AwPropertyHardExpiry ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyHardExpiry = value; }

        /// <summary><p>The number of days that an IAM user password is valid.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>The number of days that an IAM user password is valid.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int AwPropertyMaxPasswordAge { get => _resourceBody.AwPropertyMaxPasswordAge ?? default(int); set => _resourceBody.AwPropertyMaxPasswordAge = value; }

        /// <summary><p>Minimum length to require for IAM user passwords.</p></summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Minimum length to require for IAM user passwords.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int AwPropertyMinimumPasswordLength { get => _resourceBody.AwPropertyMinimumPasswordLength ?? default(int); set => _resourceBody.AwPropertyMinimumPasswordLength = value; }

        /// <summary>
        /// <p>Specifies the number of previous passwords that IAM users are prevented from reusing.</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies the number of previous passwords that IAM users are prevented from reusing.</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int AwPropertyPasswordReusePrevention { get => _resourceBody.AwPropertyPasswordReusePrevention ?? default(int); set => _resourceBody.AwPropertyPasswordReusePrevention = value; }

        /// <summary>
        /// <p>Specifies whether IAM user passwords must contain at least one lowercase character (a to z).</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies whether IAM user passwords must contain at least one lowercase character (a to z).</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AwPropertyRequireLowercaseCharacter { get => _resourceBody.AwPropertyRequireLowercaseCharacter ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyRequireLowercaseCharacter = value; }

        /// <summary>
        /// <p>Specifies whether IAM user passwords must contain at least one numeric character (0 to 9).</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies whether IAM user passwords must contain at least one numeric character (0 to 9).</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AwPropertyRequireNumber { get => _resourceBody.AwPropertyRequireNumber ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyRequireNumber = value; }

        /// <summary>
        /// <p>Specifies whether IAM user passwords must contain at least one of the following symbols:</p> <p>! @ # $ % ^ &amp; *
        /// ( ) _ + - = [ ] { } | '</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies whether IAM user passwords must contain at least one of the following symbols:</p> <p>! @ # $ % ^ &amp; * ( ) _ + - = [ ] { } | '</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AwPropertyRequireSymbol { get => _resourceBody.AwPropertyRequireSymbol ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyRequireSymbol = value; }

        /// <summary>
        /// <p>Specifies whether IAM user passwords must contain at least one uppercase character (A to Z).</p>
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "<p>Specifies whether IAM user passwords must contain at least one uppercase character (A to Z).</p>")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AwPropertyRequireUppercaseCharacter { get => _resourceBody.AwPropertyRequireUppercaseCharacter ?? default(global::System.Management.Automation.SwitchParameter); set => _resourceBody.AwPropertyRequireUppercaseCharacter = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Models.Api20241201.IIamPasswordPolicyPropertiesAwsTags AwsTag { get => _resourceBody.AwsTag ?? null /* object */; set => _resourceBody.AwsTag = value; }
        ...
        /// <returns>a duplicate instance of NewAzAwsConnectorIamPasswordPolicy_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets.NewAzAwsConnectorIamPasswordPolicy_CreateExpanded Clone()
        {
            var clone = new NewAzAwsConnectorIamPasswordPolicy_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAwsConnectorIamPasswordPolicy_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAwsConnectorIamPasswordPolicy_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'IamPasswordPoliciesCreateOrReplace' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.IamPasswordPoliciesCreateOrReplace(SubscriptionId, ResourceGroupName, Name, _resourceBody, onOk, onDefault, this, Pipeline);
