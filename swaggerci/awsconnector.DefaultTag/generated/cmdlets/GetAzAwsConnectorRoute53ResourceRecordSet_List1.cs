...
namespace Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Cmdlets
{
    ...
    /// <summary>List Route53ResourceRecordSet resources by resource group</summary>
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/route53ResourceRecordSets"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAwsConnectorRoute53ResourceRecordSet_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Description(@"List Route53ResourceRecordSet resources by resource group")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AwsConnector/route53ResourceRecordSets", ApiVersion = "2024-12-01")]
    public partial class GetAzAwsConnectorRoute53ResourceRecordSet_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AwsConnector.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAwsConnectorRoute53ResourceRecordSet_List1" /> cmdlet class.
        /// </summary>
        public GetAzAwsConnectorRoute53ResourceRecordSet_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.Route53ResourceRecordSetsListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.Route53ResourceRecordSetsListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
