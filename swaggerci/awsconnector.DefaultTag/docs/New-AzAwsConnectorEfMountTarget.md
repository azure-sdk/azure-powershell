...
online version: https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorefmounttarget
schema: 2.0.0
---

# New-AzAwsConnectorEfMountTarget
...
```
New-AzAwsConnectorEfMountTarget -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-Arn <String>] [-AwPropertyFileSystemId <String>] [-AwPropertyId <String>]
 [-AwPropertyIPAddress <String>] [-AwPropertySecurityGroup <String[]>] [-AwPropertySubnetId <String>]
