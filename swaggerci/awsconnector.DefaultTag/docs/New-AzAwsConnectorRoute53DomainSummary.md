...
online version: https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectorroute53domainsummary
schema: 2.0.0
---

# New-AzAwsConnectorRoute53DomainSummary
...
```
New-AzAwsConnectorRoute53DomainSummary -Name <String> -ResourceGroupName <String> -Location <String>
 [-SubscriptionId <String>] [-Arn <String>] [-AwPropertyAutoRenew] [-AwPropertyDomainName <String>]
 [-AwPropertyExpiry <DateTime>] [-AwPropertyTransferLock] [-AwsAccountId <String>] [-AwsRegion <String>]
