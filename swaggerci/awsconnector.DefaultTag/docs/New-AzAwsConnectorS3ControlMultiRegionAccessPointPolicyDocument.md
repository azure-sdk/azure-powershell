...
online version: https://learn.microsoft.com/powershell/module/az.awsconnector/new-azawsconnectors3controlmultiregionaccesspointpolicydocument
schema: 2.0.0
---
...
```
New-AzAwsConnectorS3ControlMultiRegionAccessPointPolicyDocument -Name <String> -ResourceGroupName <String>
 -Location <String> [-SubscriptionId <String>] [-Arn <String>] [-AwsAccountId <String>] [-AwsRegion <String>]
 [-AwsSourceSchema <String>] [-AwsTag <Hashtable>] [-EstablishedPolicy <String>] [-ProposedPolicy <String>]
