# How-To
This document describes how to develop for `Az.MarketplaceBlueprintApi`.

## Building `Az.MarketplaceBlueprintApi`
...
## Testing `Az.MarketplaceBlueprintApi`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.MarketplaceBlueprintApi` into the session.
