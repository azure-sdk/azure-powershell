...
namespace Microsoft.Azure.PowerShell.Cmdlets.MarketplaceBlueprintApi.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MarketplaceBlueprintApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.MarketplaceBlueprintApi.Support";
