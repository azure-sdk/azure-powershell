...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RejectTriageRecommendation=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/resiliencyReviews/{reviewId}/providers/Microsoft.Advisor/triageRecommendations/{recommendationId}/reject"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzAdvisorRejectTriageRecommendation_RejectViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Description(@"Reject an existing triage recommendation for a given id.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/resiliencyReviews/{reviewId}/providers/Microsoft.Advisor/triageRecommendations/{recommendationId}/reject", ApiVersion = "2024-11-18-preview")]
    public partial class InvokeAzAdvisorRejectTriageRecommendation_RejectViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.IRecommendationRejectBody _recommendationRejectBody = new Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.RecommendationRejectBody();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Reason for rejecting recommendation.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.ReasonForRejectionName))]
        public Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.ReasonForRejectionName ReasonForRejection { get => _recommendationRejectBody.ReasonForRejection ?? ((Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.ReasonForRejectionName)""); set => _recommendationRejectBody.ReasonForRejection = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api30.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api30.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api30.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzAdvisorRejectTriageRecommendation_RejectViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzAdvisorRejectTriageRecommendation_RejectViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TriageRecommendationsRejectTriageRecommendation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.TriageRecommendationsRejectTriageRecommendationViaIdentity(InputObject.Id, _recommendationRejectBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.ReviewId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ReviewId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        ...
                        await this.Client.TriageRecommendationsRejectTriageRecommendation(InputObject.SubscriptionId ?? null, InputObject.ReviewId ?? null, InputObject.RecommendationId ?? null, _recommendationRejectBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=_recommendationRejectBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api30.IErrorResponse>(responseMessage, await response);
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_recommendationRejectBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=_recommendationRejectBody })
                    {
