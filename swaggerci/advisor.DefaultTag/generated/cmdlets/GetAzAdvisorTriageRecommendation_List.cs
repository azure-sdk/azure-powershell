...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/resiliencyReviews/{reviewId}/providers/Microsoft.Advisor/triageRecommendations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAdvisorTriageRecommendation_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Description(@"Get list of recommendations for an existing Azure Advisor Resiliency Review Id.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/resiliencyReviews/{reviewId}/providers/Microsoft.Advisor/triageRecommendations", ApiVersion = "2023-09-01-preview")]
    public partial class GetAzAdvisorTriageRecommendation_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of items to skip before starting to collect the result set.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of items to be included in the result.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.ITriageRecommendationCollection">Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.ITriageRecommendationCollection</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.ITriageRecommendationCollection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAdvisorTriageRecommendation_List" /> cmdlet class.
        /// </summary>
        public GetAzAdvisorTriageRecommendation_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TriageRecommendationsList(SubscriptionId, ReviewId, this.InvocationInformation.BoundParameters.ContainsKey("Top") ? Top : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.ITriageRecommendationCollection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.TriageRecommendationsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
