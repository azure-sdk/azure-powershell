...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.HttpPath(Path = "/providers/Microsoft.Advisor/metadata", ApiVersion = "2025-01-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Category of recommendation.")]
        ...
        /// <summary>Sub-category of recommendation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Sub-category of recommendation.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Sub-category of recommendation.",
        SerializedName = @"[control](#control)",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.ParameterCategory.Query)]
        public string Control { get => this._control; set => this._control = value; }
        ...
        /// <summary>Backing field for <see cref="RetirementsFrom" /> property.</summary>
        private string _retirementsFrom;

        /// <summary>
        /// Date from which retirements need to be displayed (applicable only when control is 'ServiceUpgradeAndRetirement').
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Date from which retirements need to be displayed (applicable only when control is 'ServiceUpgradeAndRetirement').")]
        [Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Date from which retirements need to be displayed (applicable only when control is 'ServiceUpgradeAndRetirement').",
        SerializedName = @"retirementsFrom",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.ParameterCategory.Query)]
        public string RetirementsFrom { get => this._retirementsFrom; set => this._retirementsFrom = value; }

        /// <summary>Backing field for <see cref="RetirementsTill" /> property.</summary>
        private string _retirementsTill;

        /// <summary>
        /// Date upto which retirements need to be displayed (applicable only when control is 'ServiceUpgradeAndRetirement').
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Date upto which retirements need to be displayed (applicable only when control is 'ServiceUpgradeAndRetirement').")]
        [Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Date upto which retirements need to be displayed (applicable only when control is 'ServiceUpgradeAndRetirement').",
        SerializedName = @"retirementsTill",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.ParameterCategory.Query)]
        public string RetirementsTill { get => this._retirementsTill; set => this._retirementsTill = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202501.IMetadataEntityListResult">Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202501.IMetadataEntityListResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202501.IMetadataEntityListResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RecommendationMetadataList(this.InvocationInformation.BoundParameters.ContainsKey("Category") ? Category : null, this.InvocationInformation.BoundParameters.ContainsKey("Control") ? Control : null, this.InvocationInformation.BoundParameters.ContainsKey("RetirementsFrom") ? RetirementsFrom : null, this.InvocationInformation.BoundParameters.ContainsKey("RetirementsTill") ? RetirementsTill : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Category=this.InvocationInformation.BoundParameters.ContainsKey("Category") ? Category : null,Control=this.InvocationInformation.BoundParameters.ContainsKey("Control") ? Control : null,RetirementsFrom=this.InvocationInformation.BoundParameters.ContainsKey("RetirementsFrom") ? RetirementsFrom : null,RetirementsTill=this.InvocationInformation.BoundParameters.ContainsKey("RetirementsTill") ? RetirementsTill : null})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202501.IArmErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Category=this.InvocationInformation.BoundParameters.ContainsKey("Category") ? Category : null, Control=this.InvocationInformation.BoundParameters.ContainsKey("Control") ? Control : null, RetirementsFrom=this.InvocationInformation.BoundParameters.ContainsKey("RetirementsFrom") ? RetirementsFrom : null, RetirementsTill=this.InvocationInformation.BoundParameters.ContainsKey("RetirementsTill") ? RetirementsTill : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Category=this.InvocationInformation.BoundParameters.ContainsKey("Category") ? Category : null, Control=this.InvocationInformation.BoundParameters.ContainsKey("Control") ? Control : null, RetirementsFrom=this.InvocationInformation.BoundParameters.ContainsKey("RetirementsFrom") ? RetirementsFrom : null, RetirementsTill=this.InvocationInformation.BoundParameters.ContainsKey("RetirementsTill") ? RetirementsTill : null })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api202501.IMetadataEntityListResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
