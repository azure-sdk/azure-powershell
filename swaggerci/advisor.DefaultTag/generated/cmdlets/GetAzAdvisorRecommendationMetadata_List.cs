...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// The filter to apply to the recommendation metadata.<br>Filter can be applied to properties ['[Category](#category)', '[Control](#control)',
        /// 'RetirementDate'] with operators ['eq', 'and', 'le', 'ge'].<br>Example:<br>- $filter=Category eq 'HighAvailability' and
        /// Control eq 'ServiceUpgradeAndRetirement' and RetirementDate le 2027-01-01T00:00:00Z
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The filter to apply to the recommendation metadata.<br>Filter can be applied to properties ['[Category](#category)', '[Control](#control)', 'RetirementDate'] with operators ['eq', 'and', 'le', 'ge'].<br>Example:<br>- $filter=Category eq 'HighAvailability' and Control eq 'ServiceUpgradeAndRetirement' and RetirementDate le 2027-01-01T00:00:00Z")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RecommendationMetadataList(this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
