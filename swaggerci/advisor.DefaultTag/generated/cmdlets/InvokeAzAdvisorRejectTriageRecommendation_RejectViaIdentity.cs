...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzAdvisorRejectTriageRecommendation_RejectViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzAdvisorRejectTriageRecommendation_RejectViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="RecommendationRejectBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.IRecommendationRejectBody _recommendationRejectBody;

        /// <summary>Recommendation reject body.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Recommendation reject body.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Recommendation reject body.",
        SerializedName = @"recommendationRejectBody",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.IRecommendationRejectBody) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20230901Preview.IRecommendationRejectBody RecommendationRejectBody { get => this._recommendationRejectBody; set => this._recommendationRejectBody = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzAdvisorRejectTriageRecommendation_RejectViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzAdvisorRejectTriageRecommendation_RejectViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.TriageRecommendationsRejectTriageRecommendationViaIdentity(InputObject.Id, RecommendationRejectBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.TriageRecommendationsRejectTriageRecommendation(InputObject.SubscriptionId ?? null, InputObject.ReviewId ?? null, InputObject.RecommendationId ?? null, RecommendationRejectBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RecommendationRejectBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api30.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RecommendationRejectBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RecommendationRejectBody })
                    {
