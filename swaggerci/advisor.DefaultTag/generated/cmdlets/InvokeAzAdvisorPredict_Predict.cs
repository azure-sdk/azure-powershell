...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzAdvisorPredict_Predict", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzAdvisorPredict_Predict : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="PredictionRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.IPredictionRequest _predictionRequest;

        /// <summary>Parameters for predict recommendation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for predict recommendation.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.IPredictionRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.IPredictionRequest PredictionRequest { get => this._predictionRequest; set => this._predictionRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzAdvisorPredict_Predict" /> cmdlet class.
        /// </summary>
        public InvokeAzAdvisorPredict_Predict()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Predict(SubscriptionId, PredictionRequest, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,body=PredictionRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.IArmErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, body=PredictionRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, body=PredictionRequest })
                    {
