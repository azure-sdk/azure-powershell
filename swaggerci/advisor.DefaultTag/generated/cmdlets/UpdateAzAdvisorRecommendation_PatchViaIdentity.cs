...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Patch=>PATCH:"/{resourceUri}/providers/Microsoft.Advisor/recommendations/{recommendationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAdvisorRecommendation_PatchViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Advisor.Description(@"Update the tracked properties of a Recommendation.")]
    ...
    public partial class UpdateAzAdvisorRecommendation_PatchViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.ITrackedRecommendationPropertiesPayload _trackedProperty;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.ITrackedRecommendationPropertiesPayload) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20241118Preview.ITrackedRecommendationPropertiesPayload TrackedProperty { get => this._trackedProperty; set => this._trackedProperty = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RecommendationsPatch' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RecommendationsPatchViaIdentity(InputObject.Id, TrackedProperty, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RecommendationsPatch(InputObject.ResourceUri ?? null, InputObject.RecommendationId ?? null, TrackedProperty, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=TrackedProperty})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzAdvisorRecommendation_PatchViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateAzAdvisorRecommendation_PatchViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api40.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=TrackedProperty })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=TrackedProperty })
                    {
