...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State Approved = @"Approved";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State Completed = @"Completed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State Dismissed = @"Dismissed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State InProgress = @"InProgress";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State Pending = @"Pending";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State Postponed = @"Postponed";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State Rejected = @"Rejected";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State e1, Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.State e2)
        {
            return !e2.Equals(e1);
        }
