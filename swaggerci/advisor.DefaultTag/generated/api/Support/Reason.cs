...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason AlternativeSolution = @"AlternativeSolution";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason ExcessiveInvestment = @"ExcessiveInvestment";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason Incompatible = @"Incompatible";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason RiskAccepted = @"RiskAccepted";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason TooComplex = @"TooComplex";

        public static Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason Unclear = @"Unclear";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason e1, Microsoft.Azure.PowerShell.Cmdlets.Advisor.Support.Reason e2)
        {
            return !e2.Equals(e1);
        }
