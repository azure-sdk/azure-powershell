...
namespace Microsoft.Azure.PowerShell.Cmdlets.Advisor
{
    ...
    public partial class AdvisorManagementClient
    {
        ...
        /// <param name="Filter">The filter to apply to the recommendation metadata.<br>Filter can be applied to properties ['[Category](#category)',
        /// '[Control](#control)', 'RetirementDate'] with operators ['eq', 'and', 'le', 'ge'].<br>Example:<br>- $filter=recommendationCategory
        /// eq 'HighAvailability' and recommendationControl eq 'ServiceUpgradeAndRetirement' and retirementDate ge '2024-01-01' and
        /// retirementDate le '2028-01-01'</param>
        /// <param name="onOk">a delegate that is called when the remote service returns 200 (OK).</param>
        /// <param name="onDefault">a delegate that is called when the remote service returns default (any response code not handled
        /// elsewhere).</param>
        /// <param name="eventListener">an <see cref="Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener" /> instance that will receive events.</param>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the response is completed.
        /// </returns>
        internal async global::System.Threading.Tasks.Task RecommendationMetadataList_Validate(string Filter, Microsoft.Azure.PowerShell.Cmdlets.Advisor.Runtime.IEventListener eventListener)
        {
            using( NoSynchronizationContext )
            {
        ...
        /// eq 'ServiceUpgradeAndRetirement' and RetirementDate le '2024-01-01' and RetirementDate ge '2028-01-01'</param>
