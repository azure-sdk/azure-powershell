...
### List (Default)
```
Get-AzAdvisorRecommendationMetadata [-Category <String>] [-Control <String>] [-RetirementsFrom <String>]
 [-RetirementsTill <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
