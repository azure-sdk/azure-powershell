...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20221001.IOperationEntity
.Link
https://learn.microsoft.com/powershell/module/az.advisor/get-azadvisoroperation
#>
function Get-AzAdvisorOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Advisor.Models.Api20221001.IOperationEntity])]
