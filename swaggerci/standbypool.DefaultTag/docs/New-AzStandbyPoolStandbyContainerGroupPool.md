...
online version: https://learn.microsoft.com/powershell/module/az.standbypool/new-azstandbypoolstandbycontainergrouppool
schema: 2.0.0
---

# New-AzStandbyPoolStandbyContainerGroupPool
...
```
New-AzStandbyPoolStandbyContainerGroupPool -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-ElasticityProfileRefillPolicy <RefillPolicy>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
