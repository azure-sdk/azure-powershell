...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models
{
    ...
    public partial class StandbyPoolIdentity
    {
        ...
        internal StandbyPoolIdentity(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject json)
        {
            ...
            {_subscriptionId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("subscriptionId"), out var __jsonSubscriptionId) ? (string)__jsonSubscriptionId : (string)SubscriptionId;}
            {_resourceGroupName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("resourceGroupName"), out var __jsonResourceGroupName) ? (string)__jsonResourceGroupName : (string)ResourceGroupName;}
            {_standbyContainerGroupPoolName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("standbyContainerGroupPoolName"), out var __jsonStandbyContainerGroupPoolName) ? (string)__jsonStandbyContainerGroupPoolName : (string)StandbyContainerGroupPoolName;}
            {_standbyVirtualMachinePoolName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("standbyVirtualMachinePoolName"), out var __jsonStandbyVirtualMachinePoolName) ? (string)__jsonStandbyVirtualMachinePoolName : (string)StandbyVirtualMachinePoolName;}
            {_runtimeView = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("runtimeView"), out var __jsonRuntimeView) ? (string)__jsonRuntimeView : (string)RuntimeView;}
            {_standbyVirtualMachineName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("standbyVirtualMachineName"), out var __jsonStandbyVirtualMachineName) ? (string)__jsonStandbyVirtualMachineName : (string)StandbyVirtualMachineName;}
