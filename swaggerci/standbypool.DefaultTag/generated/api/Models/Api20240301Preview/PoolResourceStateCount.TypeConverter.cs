...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview
{
    ...
    public partial class PoolResourceStateCountTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="PoolResourceStateCount" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IPoolResourceStateCount ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IPoolResourceStateCount).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
