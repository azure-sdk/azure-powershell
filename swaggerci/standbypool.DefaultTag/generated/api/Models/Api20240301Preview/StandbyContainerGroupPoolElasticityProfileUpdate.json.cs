...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview
{
    ...
    public partial class StandbyContainerGroupPoolElasticityProfileUpdate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IStandbyContainerGroupPoolElasticityProfileUpdate.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IStandbyContainerGroupPoolElasticityProfileUpdate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IStandbyContainerGroupPoolElasticityProfileUpdate FromJson(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonNode node)
        {
        ...
        internal StandbyContainerGroupPoolElasticityProfileUpdate(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject json)
        {
            ...
            {_maxReadyCapacity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonNumber>("maxReadyCapacity"), out var __jsonMaxReadyCapacity) ? (long?)__jsonMaxReadyCapacity : MaxReadyCapacity;}
            {_refillPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonString>("refillPolicy"), out var __jsonRefillPolicy) ? (string)__jsonRefillPolicy : (string)RefillPolicy;}
            AfterFromJson(json);
        }
