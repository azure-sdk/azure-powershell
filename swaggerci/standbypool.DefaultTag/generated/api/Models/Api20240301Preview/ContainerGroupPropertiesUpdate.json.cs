...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview
{
    ...
    public partial class ContainerGroupPropertiesUpdate
    {
        ...
        internal ContainerGroupPropertiesUpdate(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject json)
        {
            ...
            {_containerGroupProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject>("containerGroupProfile"), out var __jsonContainerGroupProfile) ? Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.ContainerGroupProfileUpdate.FromJson(__jsonContainerGroupProfile) : ContainerGroupProfile;}
            {_subnetId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonArray>("subnetIds"), out var __jsonSubnetIds) ? If( __jsonSubnetIds as Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.ISubnet[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.ISubnet) (Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.Subnet.FromJson(__u) )) ))() : null : SubnetId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IContainerGroupPropertiesUpdate.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IContainerGroupPropertiesUpdate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IContainerGroupPropertiesUpdate FromJson(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonNode node)
        {
