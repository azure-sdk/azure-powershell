...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview
{
    ...
    public partial class VirtualMachineInstanceCountSummary :
        Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IVirtualMachineInstanceCountSummary,
        Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IVirtualMachineInstanceCountSummaryInternal
    {

        /// <summary>Backing field for <see cref="InstanceCountsByState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IPoolResourceStateCount[] _instanceCountsByState;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IPoolResourceStateCount[] InstanceCountsByState { get => this._instanceCountsByState; set => this._instanceCountsByState = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IPoolResourceStateCount) })]
        Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301Preview.IPoolResourceStateCount[] InstanceCountsByState { get; set; }
        /// <summary>
        /// The zone that the provided counts are in. This is null if zones are not enabled on the attached VMSS.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Info(
