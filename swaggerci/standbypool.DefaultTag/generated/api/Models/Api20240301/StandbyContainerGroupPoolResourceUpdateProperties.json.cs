...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301
{
    ...
    public partial class StandbyContainerGroupPoolResourceUpdateProperties
    {
        ...
        internal StandbyContainerGroupPoolResourceUpdateProperties(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject json)
        {
            ...
            {_elasticityProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject>("elasticityProfile"), out var __jsonElasticityProfile) ? Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301.StandbyContainerGroupPoolElasticityProfile.FromJson(__jsonElasticityProfile) : ElasticityProfile;}
            {_containerGroupProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Runtime.Json.JsonObject>("containerGroupProperties"), out var __jsonContainerGroupProperties) ? Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301.ContainerGroupProperties.FromJson(__jsonContainerGroupProperties) : ContainerGroupProperty;}
            AfterFromJson(json);
        }
