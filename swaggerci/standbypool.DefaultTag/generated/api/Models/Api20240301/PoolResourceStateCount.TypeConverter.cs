...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301
{
    ...
    public partial class PoolResourceStateCountTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="PoolResourceStateCount" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301.IPoolResourceStateCount ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Models.Api20240301.IPoolResourceStateCount).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
