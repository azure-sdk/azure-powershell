...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPoolTest.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.StandbyPoolTest.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.StandbyPoolTest.Support";
