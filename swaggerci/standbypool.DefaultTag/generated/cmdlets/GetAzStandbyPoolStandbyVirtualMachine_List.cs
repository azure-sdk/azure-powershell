...
namespace Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByStandbyPool=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StandbyPool/standbyVirtualMachinePools/{standbyVirtualMachinePoolName}/standbyVirtualMachines"
    /// </remarks>
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StandbyPool.Description(@"A resource list operation, at the scope of the resource's parent")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StandbyVirtualMachinesListByStandbyPool(SubscriptionId, ResourceGroupName, PoolName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.StandbyVirtualMachinesListByStandbyPool_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
